error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8420.java
text:
```scala
c@@lusterService.submitStateUpdateTask("delete-index [" + request.index + "]", new ClusterStateUpdateTask() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8420.java