error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5004.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5004.java
text:
```scala
private B@@roadcastOperationThreading operationThreading = BroadcastOperationThreading.THREAD_PER_SHARD;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5004.java