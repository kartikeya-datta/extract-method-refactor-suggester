error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5139.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5139.java
text:
```scala
public P@@ageParameters(final Map parameterMap)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5139.java