error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4180.java
text:
```scala
n@@ew SearchFrame((AbstractMailFrameController) getFrameMediator(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4180.java