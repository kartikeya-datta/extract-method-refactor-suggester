error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8134.java
text:
```scala
s@@tats.add(terms(name, fieldName, "global_ordinals_low_cardinality"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8134.java