error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/698.java
text:
```scala
i@@nt detailLevel = grid.getLevelForDistance(args.resolveDistErr(ctx, distErrPct));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/698.java