error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/208.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/208.java
text:
```scala
public v@@oid reset() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/208.java