error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9009.java
text:
```scala
d@@ouble n = length;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9009.java