error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2577.java
text:
```scala
R@@unnablePostTest.class, Vector2dTest.class, SuperKoalio.class, NinePatchTest.class, HexagonalTiledMapTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2577.java