error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1406.java
text:
```scala
i@@f (nextItemIndex < itemCount && ch == '\r' && segmentsText.charAt(itemLimit) == '\n') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1406.java