error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9819.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9819.java
text:
```scala
public static v@@oid load () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9819.java