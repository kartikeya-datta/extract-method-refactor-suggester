error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/750.java
text:
```scala
O@@bject instance = handler.getInterpreter(type);//, "org.columba.core.scripting.PythonInterpreterPlugin", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/750.java