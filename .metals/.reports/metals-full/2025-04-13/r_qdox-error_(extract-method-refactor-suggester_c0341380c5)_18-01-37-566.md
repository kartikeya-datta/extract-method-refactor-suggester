error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7566.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7566.java
text:
```scala
private static final S@@tring TAG = "AvatarLoader";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7566.java