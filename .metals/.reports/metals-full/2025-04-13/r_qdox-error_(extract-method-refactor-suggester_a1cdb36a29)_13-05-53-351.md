error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16157.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16157.java
text:
```scala
public R@@ectangle getTextBounds (int index) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16157.java