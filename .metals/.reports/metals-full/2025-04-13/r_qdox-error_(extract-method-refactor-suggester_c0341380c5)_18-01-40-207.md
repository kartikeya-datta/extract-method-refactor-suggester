error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10758.java
text:
```scala
t@@empFileProvider = TempFileProvider.create("temp", Executors.newScheduledThreadPool(2, threadFactory), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10758.java