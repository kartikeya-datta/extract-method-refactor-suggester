error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6619.java
text:
```scala
i@@f (CharOperation.match(resourceFilters[i], name, true))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6619.java