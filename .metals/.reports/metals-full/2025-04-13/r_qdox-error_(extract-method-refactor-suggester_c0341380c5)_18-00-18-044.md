error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6831.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6831.java
text:
```scala
public final S@@tring baseUrl;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6831.java