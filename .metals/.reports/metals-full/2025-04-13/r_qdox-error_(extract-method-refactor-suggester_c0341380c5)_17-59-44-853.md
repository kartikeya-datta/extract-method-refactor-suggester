error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2535.java
text:
```scala
z@@kCmdExecutor = new ZkCmdExecutor(zkClient.getZkClientTimeout());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2535.java