error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5708.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5708.java
text:
```scala
protected abstract R@@ealPointValuePair doOptimize()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5708.java