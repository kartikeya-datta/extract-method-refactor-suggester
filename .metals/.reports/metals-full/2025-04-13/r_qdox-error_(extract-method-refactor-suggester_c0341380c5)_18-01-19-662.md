error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10672.java
text:
```scala
i@@f (OS.GTK_VERSION < OS.VERSION (2, 10, 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10672.java