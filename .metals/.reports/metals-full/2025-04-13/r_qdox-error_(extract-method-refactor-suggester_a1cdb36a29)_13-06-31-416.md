error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6307.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6307.java
text:
```scala
private W@@izardActivityFilter filter = new WizardActivityFilter();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6307.java