error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6471.java
text:
```scala
S@@ystem.out.println("Finished build of " + currentProject.getName()); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6471.java