error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4314.java
text:
```scala
B@@ytesStreamInput in = new BytesStreamInput(out.bytes().toBytes(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4314.java