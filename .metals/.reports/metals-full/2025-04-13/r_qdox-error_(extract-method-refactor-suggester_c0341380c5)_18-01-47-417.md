error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16902.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16902.java
text:
```scala
+ c@@hild.getId() + "', component=" + child));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16902.java