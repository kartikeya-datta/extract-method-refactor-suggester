error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14993.java
text:
```scala
M@@oduleLoader moduleLoader = Module.getBootModuleLoader();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14993.java