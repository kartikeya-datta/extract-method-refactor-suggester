error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/32.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/32.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/32.java
text:
```scala
public B@@inding binding; //may be aTypeBinding-aFieldBinding-aLocalVariableBinding
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/32.java