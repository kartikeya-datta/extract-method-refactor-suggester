error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3194.java
text:
```scala
S@@et<?> stopWords = Analysis.parseStopWords(env, settings, StopAnalyzer.ENGLISH_STOP_WORDS_SET, version);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3194.java