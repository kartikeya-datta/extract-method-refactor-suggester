error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7522.java
text:
```scala
i@@tem.setText(labelMessage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7522.java