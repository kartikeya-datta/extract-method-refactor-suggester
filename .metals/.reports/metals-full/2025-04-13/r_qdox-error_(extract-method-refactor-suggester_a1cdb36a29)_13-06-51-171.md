error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2961.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2961.java
text:
```scala
public c@@har[][] fullExclusionPatternChars() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2961.java