error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5887.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5887.java
text:
```scala
...
//	AccessRestriction accessRestriction = this.accessRestrictions.get(unresolvedType);
//	if (accessRestriction != null) {
//		this.accessRestrictions.remove(unresolvedType);
//		this.accessRestrictions.put(resolvedType, accessRestriction);
//	}
}
}
```
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5887.java