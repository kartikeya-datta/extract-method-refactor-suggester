error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1884.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.STRUCTURE, Phase.STRUCTURE_SAR_SUB_DEPLOY_CHECK, new SarSubDeploymentProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1884.java