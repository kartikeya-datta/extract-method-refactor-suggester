error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1015.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1015.java
text:
```scala
private final static i@@nt MARGIN = 20;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1015.java