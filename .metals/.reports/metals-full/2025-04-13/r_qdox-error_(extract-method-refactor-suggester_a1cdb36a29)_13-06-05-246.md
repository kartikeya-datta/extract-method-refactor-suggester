error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4594.java
...
```java
offset: 1120
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4594.java
text:
```scala
...
p@@ackage org.jboss.as.managedbean;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4594.java