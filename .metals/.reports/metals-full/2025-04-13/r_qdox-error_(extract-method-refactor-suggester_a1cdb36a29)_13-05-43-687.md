error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10760.java
text:
```scala
I@@D id = IDFactory.getDefault().makeStringID(DataGraphSharing.DATA_GRAPH_SHARING_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10760.java