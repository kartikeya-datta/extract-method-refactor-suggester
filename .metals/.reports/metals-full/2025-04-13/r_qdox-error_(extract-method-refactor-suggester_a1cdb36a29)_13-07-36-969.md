error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7588.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7588.java
text:
```scala
O@@S.objc_msgSend_struct(result, this.id, OS.sel_sizeValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7588.java