error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3089.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3089.java
text:
```scala
public static final P@@athElement STRING_KEYED_JDBC_STORE_PATH = PathElement.pathElement(ModelKeys.STRING_KEYED_JDBC_STORE, ModelKeys.STRING_KEYED_JDBC_STORE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3089.java