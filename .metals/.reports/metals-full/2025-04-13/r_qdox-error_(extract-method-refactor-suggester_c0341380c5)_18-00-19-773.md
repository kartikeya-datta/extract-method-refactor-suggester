error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8497.java
text:
```scala
v@@oid flushBlock() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8497.java