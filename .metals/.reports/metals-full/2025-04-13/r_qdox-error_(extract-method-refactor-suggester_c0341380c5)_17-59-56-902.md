error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/698.java
text:
```scala
m@@arker.setAttribute(IMarker.MESSAGE, Util.bind("build.incompleteClassPath", e.missingClassFile)); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/698.java