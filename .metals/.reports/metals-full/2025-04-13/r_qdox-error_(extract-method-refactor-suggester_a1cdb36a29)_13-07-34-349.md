error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4271.java
text:
```scala
X@@ContentBuilder builder = restContentBuilder(request, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4271.java