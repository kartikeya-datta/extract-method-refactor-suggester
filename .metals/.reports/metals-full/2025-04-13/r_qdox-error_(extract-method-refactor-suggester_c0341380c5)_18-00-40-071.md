error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9714.java
text:
```scala
O@@S.InvalidateRect (handle, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9714.java