error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2078.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2078.java
text:
```scala
static private V@@ector2 temp = new Vector2();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2078.java