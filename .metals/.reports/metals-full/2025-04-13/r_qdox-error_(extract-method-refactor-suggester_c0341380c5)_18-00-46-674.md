error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1704.java
text:
```scala
i@@f (pos == 0 || i % 2 == 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1704.java