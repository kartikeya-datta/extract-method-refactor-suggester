error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1847.java
text:
```scala
c@@at[i] = Logger.getLogger(ct[i].catstr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1847.java