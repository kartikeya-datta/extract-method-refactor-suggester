error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5655.java
text:
```scala
a@@ce=new ArgoConstraintEvaluation(this, me);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5655.java