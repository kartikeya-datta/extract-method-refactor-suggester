error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9322.java
text:
```scala
i@@f (fixWrap) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9322.java