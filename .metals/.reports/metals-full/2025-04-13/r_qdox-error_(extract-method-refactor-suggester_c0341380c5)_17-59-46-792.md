error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10460.java
text:
```scala
T@@ableItem item = parent._getItem (i, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10460.java