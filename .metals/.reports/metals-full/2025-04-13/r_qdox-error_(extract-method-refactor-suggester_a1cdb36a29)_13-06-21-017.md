error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16556.java
text:
```scala
i@@f (!isRunningVersion() || !JMeterContextService.getContext().isSamplingStarted())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16556.java