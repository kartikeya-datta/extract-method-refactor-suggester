error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10349.java
text:
```scala
s@@tyle &= ~(SWT.H_SCROLL | SWT.V_SCROLL | SWT.WRAP | SWT.MULTI);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10349.java