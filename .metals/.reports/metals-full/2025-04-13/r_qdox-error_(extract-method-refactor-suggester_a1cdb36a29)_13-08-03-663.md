error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2695.java
text:
```scala
r@@eturn ProgressMessages.SubTaskInfo_UndefinedTaskName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2695.java