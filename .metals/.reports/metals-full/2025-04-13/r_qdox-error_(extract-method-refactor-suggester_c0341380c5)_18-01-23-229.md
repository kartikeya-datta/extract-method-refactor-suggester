error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4035.java
text:
```scala
a@@ssertAcked(client().admin().indices().prepareCreate("test").addMapping("type", mapping).setTimeout("60s").get());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4035.java