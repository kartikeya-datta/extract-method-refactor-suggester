error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/836.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/836.java
text:
```scala
private final B@@ox2DTest[] tests = { new DebugRendererTest(), new CollisionFiltering(), new Chain(), new Bridge(), new SphereStack(), new Cantilever(), new ApplyForce(), new ContinuousTest(), new Prismatic(), new CharacterCollision(), new BodyTypes(), new SimpleTest(), new Pyramid( ), new OneSidedPlatform(), new VerticalStack(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/836.java