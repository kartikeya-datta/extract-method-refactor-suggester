error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7266.java
text:
```scala
f@@alse), XADATASOURCE_PROPERTIES(Constants.XADATASOURCEPROPERTIES, ModelType.OBJECT, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7266.java