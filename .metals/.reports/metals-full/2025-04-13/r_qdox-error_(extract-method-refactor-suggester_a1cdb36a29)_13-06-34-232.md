error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3931.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3931.java
text:
```scala
public C@@omprefTest(final String name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3931.java