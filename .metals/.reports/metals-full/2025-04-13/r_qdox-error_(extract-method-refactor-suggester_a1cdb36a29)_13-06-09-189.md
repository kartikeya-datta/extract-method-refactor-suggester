error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5917.java
text:
```scala
n@@ew TreeItem (this, parentIter, SWT.NONE, i, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5917.java