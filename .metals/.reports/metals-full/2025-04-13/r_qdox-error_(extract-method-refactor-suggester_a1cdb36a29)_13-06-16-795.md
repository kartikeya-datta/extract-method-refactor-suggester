error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5620.java
text:
```scala
a@@vatarView = (ImageView) view.findViewById(id.iv_avatar);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5620.java