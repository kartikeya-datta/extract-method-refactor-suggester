error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1111.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1111.java
text:
```scala
d@@oc.add(new StringField("id", "" + i, Field.Store.NO));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1111.java