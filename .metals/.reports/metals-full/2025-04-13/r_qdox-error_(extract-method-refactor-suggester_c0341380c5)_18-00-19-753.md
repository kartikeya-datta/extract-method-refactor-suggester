error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5497.java
text:
```scala
d@@urationTimer = duration;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5497.java