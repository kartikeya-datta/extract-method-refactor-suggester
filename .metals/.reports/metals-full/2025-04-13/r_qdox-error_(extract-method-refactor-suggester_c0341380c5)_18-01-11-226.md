error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14352.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14352.java
text:
```scala
static final i@@nt TIMEOUT = 1500;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14352.java