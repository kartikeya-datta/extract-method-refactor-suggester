error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1495.java
text:
```scala
r@@enderer = new MD5Renderer( app.getGraphics(), model, false, true );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1495.java