error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/278.java
text:
```scala
a@@ction.addAttribute("type", "Mark Message");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/278.java