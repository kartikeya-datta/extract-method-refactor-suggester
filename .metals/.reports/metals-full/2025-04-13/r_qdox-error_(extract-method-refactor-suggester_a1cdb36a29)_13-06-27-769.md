error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13055.java
text:
```scala
c@@ase SWT.COLOR_WIDGET_BACKGROUND: OS.GetThemeBrushAsColor((short)(OS.VERSION < 0x1050 ? OS.kThemeBrushButtonFaceActive : OS.kThemeBrushButtonInactiveDarkShadow), (short)getDepth(), true, rgb); break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13055.java