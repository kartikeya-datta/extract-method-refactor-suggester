error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5661.java
text:
```scala
r@@oot.add(new ScrollPane(labels, skin)).expand().fill();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5661.java