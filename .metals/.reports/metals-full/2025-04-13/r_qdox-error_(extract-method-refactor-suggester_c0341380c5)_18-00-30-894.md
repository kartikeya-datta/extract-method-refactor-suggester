error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3741.java
text:
```scala
b@@uilder.append(text, 0, MAX_TEXT).append('\u2026');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3741.java