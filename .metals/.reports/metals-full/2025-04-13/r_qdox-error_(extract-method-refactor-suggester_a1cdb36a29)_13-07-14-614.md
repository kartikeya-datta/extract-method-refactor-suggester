error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13482.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13482.java
text:
```scala
final M@@asterDomainControllerOperationHandlerImpl handler = new MasterDomainControllerOperationHandlerImpl(getExecutor(), getController(), registry, domainController);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13482.java