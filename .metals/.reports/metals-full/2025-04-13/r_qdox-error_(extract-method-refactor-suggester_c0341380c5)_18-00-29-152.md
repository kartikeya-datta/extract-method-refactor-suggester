error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/113.java
text:
```scala
c@@lient.index(indexRequest, new ActionListener<IndexResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/113.java