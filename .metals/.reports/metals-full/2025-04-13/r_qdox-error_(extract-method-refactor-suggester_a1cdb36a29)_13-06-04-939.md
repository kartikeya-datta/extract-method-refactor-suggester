error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6895.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6895.java
text:
```scala
protected W@@ebMarkupContainer newLink(MarkupContainer parent,String linkId, final int index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6895.java