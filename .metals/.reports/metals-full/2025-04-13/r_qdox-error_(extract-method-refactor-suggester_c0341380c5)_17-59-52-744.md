error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1701.java
text:
```scala
l@@ogger.warn("lucene default FieldCache is used, not enabling eager reader based cache eviction");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1701.java