error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15338.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15338.java
text:
```scala
r@@eturn urlFor(IResourceListener.INTERFACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15338.java