error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1296.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1296.java
text:
```scala
s@@erverCommunicationHandler.sendMessage(bytes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1296.java