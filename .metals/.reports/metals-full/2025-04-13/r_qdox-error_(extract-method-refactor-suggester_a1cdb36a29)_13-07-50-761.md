error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/276.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/276.java
text:
```scala
public static final i@@nt version_ = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/276.java