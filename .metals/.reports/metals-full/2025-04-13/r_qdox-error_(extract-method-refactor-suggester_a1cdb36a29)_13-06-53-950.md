error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6699.java
text:
```scala
b@@uilder.field("name", nodeInfo.node().name(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6699.java