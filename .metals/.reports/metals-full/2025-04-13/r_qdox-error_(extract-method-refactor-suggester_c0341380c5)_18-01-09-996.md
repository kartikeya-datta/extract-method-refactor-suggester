error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7083.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7083.java
text:
```scala
i@@f ((state & CANVAS) == 0 || (state & FOREIGN_HANDLE) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7083.java