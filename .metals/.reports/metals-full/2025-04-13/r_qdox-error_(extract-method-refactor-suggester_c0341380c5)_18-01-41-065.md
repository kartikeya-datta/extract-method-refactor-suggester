error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10935.java
text:
```scala
S@@tringBuilder cat = new StringBuilder(str.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10935.java