error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5871.java
text:
```scala
l@@ocale, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5871.java