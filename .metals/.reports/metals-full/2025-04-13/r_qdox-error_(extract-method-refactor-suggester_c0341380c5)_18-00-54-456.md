error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1754.java
text:
```scala
r@@eturn container.getParent().contains(message.getReporter(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1754.java