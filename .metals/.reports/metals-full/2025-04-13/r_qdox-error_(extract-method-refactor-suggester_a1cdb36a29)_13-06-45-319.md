error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4450.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4450.java
text:
```scala
protected final L@@ist<TransformationDescriptionBuilder> children = new ArrayList<TransformationDescriptionBuilder>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4450.java