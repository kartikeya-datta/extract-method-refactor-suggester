error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2725.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2725.java
text:
```scala
static synchronized D@@evice getDevice () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2725.java