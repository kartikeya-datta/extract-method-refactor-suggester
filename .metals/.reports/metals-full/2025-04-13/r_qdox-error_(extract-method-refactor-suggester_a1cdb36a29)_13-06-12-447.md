error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15848.java
text:
```scala
a@@ssertEquals("n/a", settings.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15848.java