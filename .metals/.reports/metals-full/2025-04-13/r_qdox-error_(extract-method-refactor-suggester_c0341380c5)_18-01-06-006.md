error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1685.java
text:
```scala
l@@abel.setIcon(ImageLoader.getIcon("send.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1685.java