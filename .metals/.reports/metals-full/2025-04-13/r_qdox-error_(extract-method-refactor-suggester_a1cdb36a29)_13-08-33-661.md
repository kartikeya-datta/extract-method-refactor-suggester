error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/936.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/936.java
text:
```scala
i@@f(initializer.declarationSourceEnd == initializer.bodyEnd && initializer.declarationSourceStart != initializer.declarationSourceEnd){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/936.java