error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5542.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5542.java
text:
```scala
static final P@@assivationStoreRemove REMOVE_HANDLER = new PassivationStoreRemove(ADD_HANDLER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5542.java