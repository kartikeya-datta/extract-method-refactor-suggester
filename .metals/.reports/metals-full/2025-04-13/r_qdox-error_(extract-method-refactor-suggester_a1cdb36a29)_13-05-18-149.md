error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2574.java
text:
```scala
M@@anifestHeaderProcessor.parseBundleSymbolicName(bm.getSymbolicName()).getAttributes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2574.java