error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14742.java
text:
```scala
j@@ar.addClasses(SimpleStatelessWebserviceEndpointIface.class, SimpleStatelessWebserviceEndpointImpl.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14742.java