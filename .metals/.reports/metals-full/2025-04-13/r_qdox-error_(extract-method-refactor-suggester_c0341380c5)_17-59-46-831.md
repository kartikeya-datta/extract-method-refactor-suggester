error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/567.java
text:
```scala
o@@rg.apache.cassandra.config.avro.KsDef.SCHEMA$.toString().getBytes(UTF_8),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/567.java