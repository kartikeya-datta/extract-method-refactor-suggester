error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10850.java
text:
```scala
g@@rammar.addGlobalSimpleTypeDecl(type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10850.java