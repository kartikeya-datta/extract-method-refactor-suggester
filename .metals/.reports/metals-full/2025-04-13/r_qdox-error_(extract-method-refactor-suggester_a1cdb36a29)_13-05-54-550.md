error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12175.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12175.java
text:
```scala
public static final C@@onsistentHashStrategy DEFAULT = INTRA_CACHE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12175.java