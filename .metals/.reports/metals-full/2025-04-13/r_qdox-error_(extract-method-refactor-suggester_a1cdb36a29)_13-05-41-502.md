error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13635.java
text:
```scala
i@@f (dbd != null && !BeanFactoryUtils.isFactoryDereference(name)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13635.java