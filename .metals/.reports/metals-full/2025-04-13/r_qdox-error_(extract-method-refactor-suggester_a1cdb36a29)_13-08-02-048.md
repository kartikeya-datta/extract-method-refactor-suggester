error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/725.java
text:
```scala
c@@om.badlogic.gdx.physics.bullet.softbody.Material pm = softBody.appendMaterial();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/725.java