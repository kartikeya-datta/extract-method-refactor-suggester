error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/70.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/70.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/70.java
text:
```scala
static final S@@erviceName JBOSS_SERVER_EXECUTOR = JBOSS_AS.append("server-executor");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/70.java