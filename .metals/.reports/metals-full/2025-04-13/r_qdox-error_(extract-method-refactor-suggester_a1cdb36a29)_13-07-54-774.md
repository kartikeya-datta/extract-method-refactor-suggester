error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/176.java
text:
```scala
r@@eturn new StandardResourceDescriptionResolver(keyPrefix, RESOURCE_NAME, HostEnvironmentResourceDefinition.class.getClassLoader(), true, useUnprefixedChildTypes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/176.java