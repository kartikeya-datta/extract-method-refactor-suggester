error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3913.java
text:
```scala
d@@raw(region, x, y, region.getRegionWidth(), region.getRegionHeight());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3913.java