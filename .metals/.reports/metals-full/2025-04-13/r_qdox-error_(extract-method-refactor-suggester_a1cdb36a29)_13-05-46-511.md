error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12755.java
text:
```scala
O@@S.gdk_window_invalidate_rect (window, rect, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12755.java