error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/813.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/813.java
text:
```scala
final C@@ontextService envContextService = new ContextService("env");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/813.java