error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8246.java
text:
```scala
t@@his.allowIdGeneration = settings.getAsBoolean("action.allow_id_generation", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8246.java