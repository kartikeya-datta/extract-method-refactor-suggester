error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7400.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7400.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7400.java
text:
```scala
h@@itField = new InternalSearchHitField(scriptField.name(), new ArrayList<>(2));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7400.java