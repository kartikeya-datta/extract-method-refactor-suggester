error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7495.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7495.java
text:
```scala
public static final S@@tring SETTING_MEMORY_STORAGE_HINT = "memory_storage_hint";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7495.java