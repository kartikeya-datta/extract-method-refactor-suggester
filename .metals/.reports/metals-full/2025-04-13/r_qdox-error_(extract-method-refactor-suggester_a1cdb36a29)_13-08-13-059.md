error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3802.java
text:
```scala
E@@ndPointState epState = Gossiper.instance.getEndpointStateForEndpoint(ep);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3802.java