error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/772.java
text:
```scala
t@@itleCache.setColor(Color.tmp.set(getColor()).mul(style.titleFontColor));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/772.java