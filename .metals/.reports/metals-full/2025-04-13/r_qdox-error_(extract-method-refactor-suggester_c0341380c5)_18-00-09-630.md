error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/397.java
text:
```scala
e@@scapeMementoName(buff, this.parameterTypes[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/397.java