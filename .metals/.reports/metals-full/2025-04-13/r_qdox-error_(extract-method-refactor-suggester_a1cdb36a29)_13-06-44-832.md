error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2295.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2295.java
text:
```scala
d@@ate.setTime(event.getTimeStamp());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2295.java