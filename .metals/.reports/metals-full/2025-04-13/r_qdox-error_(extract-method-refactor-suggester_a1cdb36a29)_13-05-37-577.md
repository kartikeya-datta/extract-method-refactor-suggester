error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1252.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1252.java
text:
```scala
public v@@oid testForewardWithAttachment() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1252.java