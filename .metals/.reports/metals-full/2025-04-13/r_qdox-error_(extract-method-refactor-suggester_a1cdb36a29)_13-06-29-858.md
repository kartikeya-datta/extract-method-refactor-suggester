error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10370.java
text:
```scala
f@@ail();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10370.java