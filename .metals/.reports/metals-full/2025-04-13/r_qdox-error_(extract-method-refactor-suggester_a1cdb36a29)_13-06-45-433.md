error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/202.java
text:
```scala
I@@Problem[] problems = result.getAllProblems();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/202.java