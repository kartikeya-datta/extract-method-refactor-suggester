error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6357.java
text:
```scala
L@@evel prio = cat.getLevel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6357.java