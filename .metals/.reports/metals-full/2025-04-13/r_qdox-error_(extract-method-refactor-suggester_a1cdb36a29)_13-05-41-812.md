error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8652.java
text:
```scala
b@@oolean skip = testSection.getSkipSection().skip(parseContext.getCurrentVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8652.java