error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1499.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[786,1]

error in qdox parser
file content:
```java
offset: 24443
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1499.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1499.java