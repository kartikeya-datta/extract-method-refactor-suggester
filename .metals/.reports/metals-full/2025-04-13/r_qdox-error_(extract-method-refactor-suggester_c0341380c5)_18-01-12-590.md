error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4652.java
text:
```scala
r@@eturn tray = new Tray (this, SWT.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4652.java