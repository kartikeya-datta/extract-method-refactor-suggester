error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15720.java
text:
```scala
w@@aitForDone(10000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15720.java