error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1644.java
text:
```scala
t@@his.expressionType = arrayTb = scope.createArray(referenceTb, dimensions.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1644.java