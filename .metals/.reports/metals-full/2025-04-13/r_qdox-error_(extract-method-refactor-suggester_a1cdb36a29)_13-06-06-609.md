error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18009.java
text:
```scala
g@@Key.setText(Messages.keystoreAndKey);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18009.java