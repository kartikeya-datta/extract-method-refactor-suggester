error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10155.java
text:
```scala
r@@eturn getForField(mapper.names(), mapper.fieldDataType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10155.java