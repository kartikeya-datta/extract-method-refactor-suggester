error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15903.java
text:
```scala
r@@eturn display.editTextInset;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15903.java