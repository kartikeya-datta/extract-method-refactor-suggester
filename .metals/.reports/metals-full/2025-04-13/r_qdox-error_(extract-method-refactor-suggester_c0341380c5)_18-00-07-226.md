error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1270.java
text:
```scala
t@@argetClass="org.jboss.as.clustering.infinispan.subsystem.CacheContainerRemove",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1270.java