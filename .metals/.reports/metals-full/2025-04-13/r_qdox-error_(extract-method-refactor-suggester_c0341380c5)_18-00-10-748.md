error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14397.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14397.java
text:
```scala
final E@@jbJarDescription ejbJarDescription = new EjbJarDescription(moduleDescription, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14397.java