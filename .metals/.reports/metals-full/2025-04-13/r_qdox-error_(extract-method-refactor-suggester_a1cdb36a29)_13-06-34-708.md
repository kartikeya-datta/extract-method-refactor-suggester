error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2286.java
text:
```scala
i@@f (count <= 1) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2286.java