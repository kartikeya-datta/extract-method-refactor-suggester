error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5950.java
text:
```scala
o@@utput.append('<');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5950.java