error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12439.java
text:
```scala
o@@ut.write(message.getBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12439.java