error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9830.java
text:
```scala
p@@ublic abstract class Link<V> extends WebMarkupContainer<V> implements ILinkListener
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9830.java