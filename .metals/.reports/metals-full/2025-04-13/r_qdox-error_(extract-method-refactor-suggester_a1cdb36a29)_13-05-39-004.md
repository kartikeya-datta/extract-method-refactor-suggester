error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2964.java
text:
```scala
I@@ndexSearcher s = new IndexSearcher(dir, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2964.java