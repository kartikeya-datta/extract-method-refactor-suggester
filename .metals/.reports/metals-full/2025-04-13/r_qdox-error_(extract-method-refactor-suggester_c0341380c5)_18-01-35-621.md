error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8523.java
text:
```scala
s@@uper("batch-run", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8523.java