error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9300.java
text:
```scala
M@@ultiTermVectorsItemResponse[] responseItems = requestBuilder.get().getResponses();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9300.java