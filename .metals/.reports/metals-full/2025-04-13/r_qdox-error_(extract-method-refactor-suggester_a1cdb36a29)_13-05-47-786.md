error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16437.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[23,22]

error in qdox parser
file content:
```java
offset: 557
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16437.java
text:
```scala
...
class TaggedTexts {
    ...
    static aspect PC e@@xtends NodeImpl<Tag, Tag> {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16437.java