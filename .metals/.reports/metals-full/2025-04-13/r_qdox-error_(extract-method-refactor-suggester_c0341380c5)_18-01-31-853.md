error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10013.java
text:
```scala
t@@hrow new IllegalArgumentException("argument [f2] cannot be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10013.java