error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2167.java
text:
```scala
a@@ssertThat(fragment, equalTo("the big <b>bad</b> dog"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2167.java