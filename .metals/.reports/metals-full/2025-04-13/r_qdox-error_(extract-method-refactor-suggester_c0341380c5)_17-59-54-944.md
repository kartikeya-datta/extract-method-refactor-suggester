error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10055.java
text:
```scala
p@@ublic class ServiceInfoFactory extends AbstractMetadataFactory
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10055.java