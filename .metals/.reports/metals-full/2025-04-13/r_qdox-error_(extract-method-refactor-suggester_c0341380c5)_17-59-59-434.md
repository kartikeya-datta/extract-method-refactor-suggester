error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6165.java
text:
```scala
S@@tringBuilder sb = new StringBuilder(getClass().getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6165.java