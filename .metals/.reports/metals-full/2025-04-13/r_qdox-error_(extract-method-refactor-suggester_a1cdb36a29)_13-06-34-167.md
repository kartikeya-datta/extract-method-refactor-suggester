error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3017.java
text:
```scala
Q@@ueryParser qp = new QueryParser(Version.LUCENE_CURRENT, "key", analyzer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3017.java