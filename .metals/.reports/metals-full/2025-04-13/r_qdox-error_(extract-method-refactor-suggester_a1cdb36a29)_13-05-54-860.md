error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18004.java
text:
```scala
i@@f (parent.currentItem == this || !isDrawing()) return;
...
NSObject createString (int index) {
	...
	boolean isSelected = ((NSTableView)parent.view).isRowSelected (parent.indexOf (this));
	if (!isSelected) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18004.java