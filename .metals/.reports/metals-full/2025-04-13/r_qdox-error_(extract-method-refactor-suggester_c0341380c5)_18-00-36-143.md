error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15185.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15185.java
text:
```scala
public S@@tring substitute(String string, Map<String, Object> vars)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15185.java