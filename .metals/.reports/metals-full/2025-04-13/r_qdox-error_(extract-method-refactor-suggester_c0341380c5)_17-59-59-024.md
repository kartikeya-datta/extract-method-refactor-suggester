error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7267.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7267.java
text:
```scala
t@@his.paramList = new ArrayList<>(paramList);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7267.java