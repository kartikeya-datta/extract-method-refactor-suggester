error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14350.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14350.java
text:
```scala
i@@nt length = ranges[(i << 1) + 1] - start + 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14350.java