error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1249.java
text:
```scala
b@@aseUrl = GWT.getHostPageBaseURL() + "assets/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1249.java