error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7801.java
text:
```scala
c@@omparator = ExtensionFileComparator.EXTENSION_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7801.java