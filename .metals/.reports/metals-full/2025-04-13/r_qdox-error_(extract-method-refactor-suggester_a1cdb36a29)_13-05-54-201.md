error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15000.java
text:
```scala
a@@ttrs.put("onfocus", onFocus);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15000.java