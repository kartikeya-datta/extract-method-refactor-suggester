error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15169.java
text:
```scala
l@@ist.add(LoggingSubsystemAdd.createOperation(address));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15169.java