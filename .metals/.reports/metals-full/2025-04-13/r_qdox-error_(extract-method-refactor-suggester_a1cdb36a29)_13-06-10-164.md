error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6274.java
text:
```scala
f@@ail(result.asString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6274.java