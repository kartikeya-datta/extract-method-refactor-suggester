error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/482.java
text:
```scala
M@@ultiDocsEnum reset(final EnumWithSlice[] subs, final int numSubs) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/482.java