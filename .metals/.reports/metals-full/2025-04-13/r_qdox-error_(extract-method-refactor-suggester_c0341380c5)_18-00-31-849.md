error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9816.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9816.java
text:
```scala
r@@esult.add(id != null ? factory.getEntityObject(id) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9816.java