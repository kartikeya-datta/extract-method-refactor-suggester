error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2565.java
text:
```scala
i@@f ((bar.style & SWT.HORIZONTAL) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2565.java