error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9284.java
text:
```scala
b@@inding = new PackageBinding(packageBinding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9284.java