error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5059.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5059.java
text:
```scala
final S@@erviceName beanManagerServiceName = BeanManagerService.serviceName(deploymentUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5059.java