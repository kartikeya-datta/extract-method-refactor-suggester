error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9524.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9524.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9524.java
text:
```scala
i@@f (atlas.getPages().size > 1)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9524.java