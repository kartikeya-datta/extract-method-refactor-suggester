error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/694.java
text:
```scala
L@@istAdapter adapterFor(List<Issue> issues) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/694.java