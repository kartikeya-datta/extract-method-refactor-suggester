error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6826.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6826.java
text:
```scala
public v@@oid testGetRecordWithMultiLineValues() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6826.java