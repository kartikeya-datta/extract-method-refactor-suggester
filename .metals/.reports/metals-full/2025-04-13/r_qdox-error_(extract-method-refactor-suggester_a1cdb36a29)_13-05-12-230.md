error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4297.java
text:
```scala
l@@ockFactory = new XNativeFSLockFactory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4297.java