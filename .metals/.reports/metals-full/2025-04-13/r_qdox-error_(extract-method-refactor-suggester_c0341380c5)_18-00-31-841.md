error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18331.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18331.java
text:
```scala
private static final F@@ormatter fmt = new RawFormatter();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18331.java