error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1234.java
text:
```scala
c@@ontext.authenticationComplete(new RealmIdentityAccount(subject, user), ANONYMOUS_MECH, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1234.java