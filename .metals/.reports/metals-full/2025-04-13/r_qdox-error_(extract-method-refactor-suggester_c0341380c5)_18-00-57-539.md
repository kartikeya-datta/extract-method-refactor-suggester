error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2757.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2757.java
text:
```scala
t@@i.setImage(JFaceResources.getImageRegistry().get(Dialog.DLG_IMG_MESSAGE_INFO));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2757.java