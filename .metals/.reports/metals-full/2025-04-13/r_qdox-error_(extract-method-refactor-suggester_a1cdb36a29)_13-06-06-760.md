error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12491.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12491.java
text:
```scala
public P@@arameterContentNegotiationStrategy(Map<String, MediaType> mediaTypes) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12491.java