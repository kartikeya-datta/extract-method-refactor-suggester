error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3620.java
text:
```scala
A@@bstractListenerService<? extends AbstractListenerService> createService(String name, OperationContext context, ModelNode model) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3620.java