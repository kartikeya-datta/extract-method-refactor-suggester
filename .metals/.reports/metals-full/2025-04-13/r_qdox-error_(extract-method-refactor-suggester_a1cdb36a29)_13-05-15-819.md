error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5429.java
text:
```scala
p@@rops.put(Constants.SERVICE_RANKING, new Integer(750));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5429.java