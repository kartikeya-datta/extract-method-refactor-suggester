error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6344.java
text:
```scala
n@@ode.client().admin().indices().prepareCreate("test").setSettings(settingsBuilder().put("index.number_of_shards", 10)).execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6344.java