error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1207.java
text:
```scala
R@@eferenceBinding superType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1207.java