error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/445.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/445.java
text:
```scala
u@@rl = encode(requestCycle, (PageReferenceRequestTarget)requestTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/445.java