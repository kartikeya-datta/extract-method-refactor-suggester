error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12768.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12768.java
text:
```scala
final S@@erviceController<?> service = context.getServiceRegistry().getService(JMSServices.JMS_QUEUE_BASE.append(queueName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12768.java