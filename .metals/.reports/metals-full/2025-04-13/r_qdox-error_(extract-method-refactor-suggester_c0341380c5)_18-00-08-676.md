error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16413.java
text:
```scala
N@@SAttributedString attribStr = createString(items[(int)/*64*/rowIndex], null, fg, SWT.LEFT, false, getEnabled(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16413.java