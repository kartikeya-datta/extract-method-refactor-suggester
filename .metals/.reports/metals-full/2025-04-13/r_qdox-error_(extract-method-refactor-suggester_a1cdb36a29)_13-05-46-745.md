error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15025.java
text:
```scala
i@@f (i == alphaData.length && transparentOffset != -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15025.java