error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6465.java
text:
```scala
S@@ystem.out.println(Main.bind("scanning.done"/*nonNLS*/,f.getAbsolutePath()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6465.java