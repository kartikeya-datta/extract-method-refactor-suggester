error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8839.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8839.java
text:
```scala
static final A@@ttributeDefinition[] READ_ONLY_ATTRIBUTES = {CLASS, MODULE};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8839.java