error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1541.java
text:
```scala
a@@ssertEquals(expected.ig, actual.ig, 0.0000001);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1541.java