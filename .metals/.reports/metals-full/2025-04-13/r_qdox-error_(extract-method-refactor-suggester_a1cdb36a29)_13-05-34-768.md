error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11939.java
text:
```scala
r@@eturn (Queue<E>) decorated();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11939.java