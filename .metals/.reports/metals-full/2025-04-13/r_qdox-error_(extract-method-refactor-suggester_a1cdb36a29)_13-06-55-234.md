error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9497.java
text:
```scala
i@@f (typeBinding == null || typeBinding instanceof ProblemReferenceBinding) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9497.java