error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10440.java
text:
```scala
r@@eturn Byte.valueOf(key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10440.java