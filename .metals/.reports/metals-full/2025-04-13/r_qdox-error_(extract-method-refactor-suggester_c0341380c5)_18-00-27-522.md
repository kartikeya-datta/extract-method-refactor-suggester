error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9915.java
text:
```scala
p@@utValue(SHORT_DESCRIPTION, "Remove Address from Whitelist");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9915.java