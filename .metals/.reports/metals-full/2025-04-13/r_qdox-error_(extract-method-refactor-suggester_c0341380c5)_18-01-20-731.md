error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1108.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1108.java
text:
```scala
i@@nboxFolder.synchronizeHeaderlist();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1108.java