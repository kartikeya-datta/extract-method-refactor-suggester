error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1062.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1062.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1062.java
text:
```scala
M@@anagementResourceRegistration logStoreChild = registration.registerSubModel(new LogStoreDefinition(resource, registerRuntimeOnly));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1062.java