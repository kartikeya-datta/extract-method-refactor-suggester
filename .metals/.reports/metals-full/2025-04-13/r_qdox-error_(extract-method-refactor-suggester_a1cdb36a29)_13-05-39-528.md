error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8234.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8234.java
text:
```scala
final T@@ree tree, final TreeNodeModel node)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8234.java