error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9634.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9634.java
text:
```scala
T@@erms.Order order, BucketCountThresholds bucketCountThresholds, SubAggCollectionMode subAggCollectMode, boolean showTermDocCountError) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9634.java