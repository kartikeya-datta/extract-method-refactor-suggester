error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1763.java
text:
```scala
p@@ublic static class MyValidator extends AbstractValidator
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1763.java