error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4632.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4632.java
text:
```scala
public L@@astButton(final String id, final IWizard wizard)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4632.java