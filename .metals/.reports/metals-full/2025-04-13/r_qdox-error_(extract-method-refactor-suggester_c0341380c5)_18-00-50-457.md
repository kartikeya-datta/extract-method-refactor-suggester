error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10533.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10533.java
text:
```scala
public static final i@@nt MANAGEMENT_MICRO_VERSION = 0;
...
public class Version {
    ...
    public static final int MANAGEMENT_MICRO_VERSION = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10533.java