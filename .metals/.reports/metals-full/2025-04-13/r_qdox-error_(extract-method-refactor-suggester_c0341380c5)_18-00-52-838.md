error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3248.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3248.java
text:
```scala
t@@his.border = new LibraryApplicationBorder(this, "border");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3248.java