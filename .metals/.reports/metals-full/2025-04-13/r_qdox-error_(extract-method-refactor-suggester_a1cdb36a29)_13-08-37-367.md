error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9288.java
text:
```scala
w@@hile (cluster().size() != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9288.java