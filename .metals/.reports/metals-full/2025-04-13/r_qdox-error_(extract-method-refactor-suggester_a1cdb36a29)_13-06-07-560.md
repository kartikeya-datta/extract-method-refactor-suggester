error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11202.java
text:
```scala
p@@ublic class Captcha extends WicketExamplePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11202.java