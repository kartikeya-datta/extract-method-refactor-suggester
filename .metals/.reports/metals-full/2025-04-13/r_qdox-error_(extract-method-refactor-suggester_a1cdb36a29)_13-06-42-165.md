error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4914.java
text:
```scala
e@@xtends BaseRModuleAttribute
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4914.java