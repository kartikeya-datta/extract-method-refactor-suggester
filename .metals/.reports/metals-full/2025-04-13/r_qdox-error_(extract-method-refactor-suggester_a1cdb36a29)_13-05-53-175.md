error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1805.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1805.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1805.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/repository/get";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1805.java