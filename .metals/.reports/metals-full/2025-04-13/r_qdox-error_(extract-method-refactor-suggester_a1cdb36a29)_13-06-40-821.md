error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7395.java
text:
```scala
i@@f (item != null) item.setChecked (!item.getChecked ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7395.java