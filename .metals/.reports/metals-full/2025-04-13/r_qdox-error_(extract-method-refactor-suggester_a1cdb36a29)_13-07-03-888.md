error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13902.java
...
```java
offset: 1109
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13902.java
text:
```scala
...
p@@ackage org.jboss.as.connector.subsystems.datasources;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13902.java