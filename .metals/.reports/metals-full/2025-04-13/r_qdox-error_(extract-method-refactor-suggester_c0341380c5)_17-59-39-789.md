error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13199.java
text:
```scala
i@@f (validation.isValidateOnMatch() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13199.java