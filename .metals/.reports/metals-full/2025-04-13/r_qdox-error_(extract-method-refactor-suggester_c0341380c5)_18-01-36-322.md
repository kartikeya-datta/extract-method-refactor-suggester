error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5612.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5612.java
text:
```scala
protected S@@tring resolveUrlPathInternal(String resourceUrlPath, List<? extends Resource> locations,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5612.java