error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9635.java
text:
```scala
t@@empFile = TempFileStore.createTempFileWithSuffix("txt");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9635.java