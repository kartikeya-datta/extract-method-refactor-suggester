error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3351.java
text:
```scala
C@@ompletionOnMemberAccess fr = new CompletionOnMemberAccess(source, pos, isInsideAnnotation());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3351.java