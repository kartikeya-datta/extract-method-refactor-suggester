error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9196.java
text:
```scala
i@@nt lineNumber = Util.getLineNumber(sourcePos, lineSeparatorPositions, 0, lineSeparatorPositions.length-1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9196.java