error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7103.java
text:
```scala
S@@tring id = ClientPlugin.getDefault().getBundle().getSymbolicName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7103.java