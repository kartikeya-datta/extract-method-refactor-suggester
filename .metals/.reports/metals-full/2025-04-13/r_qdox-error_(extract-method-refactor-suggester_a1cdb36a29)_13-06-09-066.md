error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7399.java
text:
```scala
h@@itField = new InternalSearchHitField(field.name(), new ArrayList<>(2));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7399.java