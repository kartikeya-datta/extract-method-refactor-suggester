error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/299.java
text:
```scala
r@@eturn CharOperation.concat(CODE_SNIPPET_CLASS_NAME_PREFIX, Integer.toString(EvaluationContext.CODE_SNIPPET_COUNTER + 1).toCharArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/299.java