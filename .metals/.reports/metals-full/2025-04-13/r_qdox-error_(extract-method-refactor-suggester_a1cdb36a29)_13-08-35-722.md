error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1311.java
text:
```scala
i@@f(queryShape.relate(cShape) == SpatialRelation.DISJOINT)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1311.java