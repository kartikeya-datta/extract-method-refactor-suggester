error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6969.java
text:
```scala
a@@dd(new PageLink(this, "navigateBackLink", referer));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6969.java