error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5675.java
...
```java
offset: 897
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5675.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5675.java