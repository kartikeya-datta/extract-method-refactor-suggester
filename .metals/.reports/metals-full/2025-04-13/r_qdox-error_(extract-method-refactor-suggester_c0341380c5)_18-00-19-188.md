error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3654.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3654.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3654.java
text:
```scala
protected I@@RemoteServiceRegistration registerService(IRemoteServiceContainerAdapter adapter, String serviceInterface, Object service, Dictionary serviceProperties, int sleepTime) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3654.java