error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7264.java
text:
```scala
i@@f (locals0 == null || locals0.tag != VerificationTypeInfo.ITEM_UNINITIALIZED_THIS) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7264.java