error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1952.java
text:
```scala
i@@f (!eventTarget.sendKeyEvent(nsEvent, type == OS.NSKeyDown ? SWT.KeyDown : SWT.KeyUp)) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1952.java