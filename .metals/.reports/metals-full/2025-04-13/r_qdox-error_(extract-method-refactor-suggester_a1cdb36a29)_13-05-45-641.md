error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7979.java
text:
```scala
r@@eturn this.beanFactory.getBean(dataSourceName, DataSource.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7979.java