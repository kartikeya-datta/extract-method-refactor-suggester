error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9432.java
text:
```scala
s@@tateIndexService.closeIndex(new MetaDataStateIndexService.Request(request.indices()).timeout(request.timeout()).masterTimeout(request.masterNodeTimeout()), new MetaDataStateIndexService.Listener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9432.java