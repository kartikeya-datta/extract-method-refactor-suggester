error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4523.java
text:
```scala
j@@ob.schedule(2000);	 // wait for the startup activity to calm down
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4523.java