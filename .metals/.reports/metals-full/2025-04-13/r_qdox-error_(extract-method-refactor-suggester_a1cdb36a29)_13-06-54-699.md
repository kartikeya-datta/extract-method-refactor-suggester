error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3760.java
text:
```scala
C@@lassFileInfo openableParentInfo = (ClassFileInfo) JavaModelManager.getJavaModelManager().getInfo(openableParent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3760.java