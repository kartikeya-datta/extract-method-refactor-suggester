error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10127.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[83,2]

error in qdox parser
file content:
```java
offset: 2355
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10127.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10127.java