error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15789.java
text:
```scala
c@@lasspath = new Path();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15789.java