error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10664.java
text:
```scala
t@@his.getAndPropagateAttachment(WSAttachmentKeys.JAXWS_ENDPOINTS_KEY, DeploymentJaxws.class, unit, dep);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10664.java