error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/799.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/799.java
text:
```scala
private static final S@@tring MODULE_DEPENDENCIES = "Dependencies: org.javassist export, org.infinispan export,org.hibernate.envers export,org.hibernate\n";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/799.java