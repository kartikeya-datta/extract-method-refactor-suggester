error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9615.java
text:
```scala
t@@his.mustResolve = mustResolve();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9615.java