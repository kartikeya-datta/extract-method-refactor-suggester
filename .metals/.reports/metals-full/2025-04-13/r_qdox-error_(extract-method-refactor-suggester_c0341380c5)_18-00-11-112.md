error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1056.java
text:
```scala
r@@eturn qualification.toString(0)+".super"/*nonNLS*/ ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1056.java