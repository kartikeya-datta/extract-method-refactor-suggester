error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1094.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1094.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1094.java
text:
```scala
S@@tring name = subsystem + "-" + info.getManagementInterfaceMajorVersion() + "." + info.getManagementInterfaceMinorVersion() +"."+info.getManagementInterfaceMicroVersion()+ ".dmr";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1094.java