error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12452.java
text:
```scala
p@@ublic class JNDIManagedRuntime extends AbstractManagedRuntime
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12452.java