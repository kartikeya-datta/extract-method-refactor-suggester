error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2268.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2268.java
text:
```scala
i@@f (rows < 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2268.java