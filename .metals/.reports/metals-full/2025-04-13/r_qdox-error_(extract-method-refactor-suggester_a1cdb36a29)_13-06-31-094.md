error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2077.java
text:
```scala
t@@his.tagBits |= TagBits.IsArgument;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2077.java