error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16813.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16813.java
text:
```scala
static final A@@SDOMImplementationImpl singleton = new ASDOMImplementationImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16813.java