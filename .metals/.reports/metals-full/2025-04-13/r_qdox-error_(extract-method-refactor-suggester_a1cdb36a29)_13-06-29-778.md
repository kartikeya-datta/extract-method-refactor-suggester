error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8859.java
text:
```scala
U@@til.verbose("-> failed to remove " + this.folderPath + " from index because of the following exception:", System.err); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8859.java