error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6621.java
text:
```scala
W@@orldManifold manifold = contact.getWorldManifold();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6621.java