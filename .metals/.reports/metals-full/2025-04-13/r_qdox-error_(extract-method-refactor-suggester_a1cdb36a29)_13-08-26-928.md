error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6092.java
text:
```scala
R@@unNotifier fNotifier;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6092.java