error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6205.java
text:
```scala
c@@urrentNodes = Copy.keepOnlyAncestors(currentNodes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6205.java