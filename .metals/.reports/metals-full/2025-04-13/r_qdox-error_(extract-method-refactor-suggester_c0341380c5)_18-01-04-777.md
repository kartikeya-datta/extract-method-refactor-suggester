error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7762.java
text:
```scala
r@@eturn "NewBuilderType("/*nonNLS*/ + fNewTSEntry.getType().getName() + ")"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7762.java