error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7833.java
text:
```scala
s@@etActivityIntent(EditIssueActivity.createIntent(repo));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7833.java