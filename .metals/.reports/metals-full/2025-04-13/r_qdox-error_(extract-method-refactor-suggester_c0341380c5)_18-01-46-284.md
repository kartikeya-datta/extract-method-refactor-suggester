error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7380.java
text:
```scala
V@@aluesSourceConfig<BytesValuesSource> config = new ValuesSourceConfig<>(BytesValuesSource.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7380.java