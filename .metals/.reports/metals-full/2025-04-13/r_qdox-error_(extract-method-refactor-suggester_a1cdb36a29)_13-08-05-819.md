error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3203.java
text:
```scala
t@@his.stopWords = Analysis.parseStopWords(env, settings, StopAnalyzer.ENGLISH_STOP_WORDS_SET, version);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3203.java