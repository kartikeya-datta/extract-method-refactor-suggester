error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14004.java
text:
```scala
c@@reateRenderers (OS.gtk_tree_view_get_column (handle, 0), Table.FIRST_COLUMN, true, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14004.java