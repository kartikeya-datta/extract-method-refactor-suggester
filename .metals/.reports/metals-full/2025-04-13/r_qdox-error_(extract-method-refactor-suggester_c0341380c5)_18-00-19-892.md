error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3370.java
text:
```scala
s@@canner.taskTags = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3370.java