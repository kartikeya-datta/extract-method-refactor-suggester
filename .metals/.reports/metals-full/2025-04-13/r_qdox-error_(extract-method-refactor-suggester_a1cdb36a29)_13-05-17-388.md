error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4263.java
text:
```scala
C@@lass<? extends MethodInterceptor> interceptor();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4263.java