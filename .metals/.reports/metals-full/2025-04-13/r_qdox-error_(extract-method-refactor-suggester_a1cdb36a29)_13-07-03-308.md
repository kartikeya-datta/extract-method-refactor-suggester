error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11325.java
text:
```scala
t@@estDir = new File("test/io/").getAbsoluteFile();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11325.java