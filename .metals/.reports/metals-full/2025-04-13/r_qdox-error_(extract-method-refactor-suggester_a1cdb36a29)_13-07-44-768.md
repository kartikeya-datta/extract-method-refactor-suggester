error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11626.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[164,2]

error in qdox parser
file content:
```java
offset: 4734
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11626.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11626.java