error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3670.java
text:
```scala
K@@eyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK | ActionEvent.SHIFT_MASK));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3670.java