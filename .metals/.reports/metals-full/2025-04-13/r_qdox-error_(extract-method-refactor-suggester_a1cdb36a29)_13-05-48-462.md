error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11143.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11143.java
text:
```scala
r@@esourceRegistration.registerOperationHandler(WhoAmIOperation.DEFINITION, WhoAmIOperation.INSTANCE, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11143.java