error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14480.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14480.java
text:
```scala
final S@@erviceController<?> service = context.getServiceRegistry().getService(MessagingSubsystemElement.CORE_QUEUE_BASE.append(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14480.java