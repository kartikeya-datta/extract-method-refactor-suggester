error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/889.java
...
```java
offset: 1115
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/889.java
text:
```scala
...
p@@ackage org.jboss.as.ejb3.subsystem;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/889.java