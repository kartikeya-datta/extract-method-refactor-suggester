error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16429.java
text:
```scala
b@@uf.append("<status>").append(StringUtils.escapeForXML(status)).append("</status>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16429.java