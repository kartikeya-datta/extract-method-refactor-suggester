error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/518.java
text:
```scala
r@@eturn Util.bind("operation.createInitializerProgress"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/518.java