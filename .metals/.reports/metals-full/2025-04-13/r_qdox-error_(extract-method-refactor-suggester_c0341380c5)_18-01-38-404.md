error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9218.java
text:
```scala
m@@erged.putAll((Map<K, V>) parent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9218.java