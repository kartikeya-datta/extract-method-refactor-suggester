error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9051.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9051.java
text:
```scala
private R@@oleRegistryEvent roleRegistryEvent;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9051.java