error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11085.java
text:
```scala
O@@S.g_main_context_iteration (0, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11085.java