error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5641.java
text:
```scala
b@@oolean back, forward, navigate = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5641.java