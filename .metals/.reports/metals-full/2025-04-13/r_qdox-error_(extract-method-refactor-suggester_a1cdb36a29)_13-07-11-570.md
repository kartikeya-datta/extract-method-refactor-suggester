error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/230.java
text:
```scala
c@@lass BinaryToRawStream
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/230.java