error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2816.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2816.java
text:
```scala
public b@@oolean useTermQueryWithQueryString() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2816.java