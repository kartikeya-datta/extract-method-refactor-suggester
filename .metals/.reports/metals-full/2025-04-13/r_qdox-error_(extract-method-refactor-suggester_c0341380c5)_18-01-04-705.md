error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7990.java
text:
```scala
r@@eturn canRead(clazz, null, mediaType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7990.java