error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6749.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6749.java
text:
```scala
final S@@et<ClassInfo> subclasses = index.getAllKnownImplementors(SERVER_APPLICATION_CONFIG);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6749.java