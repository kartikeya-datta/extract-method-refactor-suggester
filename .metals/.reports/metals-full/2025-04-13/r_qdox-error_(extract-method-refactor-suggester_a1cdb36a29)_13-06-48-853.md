error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5042.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5042.java
text:
```scala
private final L@@ist<String> values = new ArrayList<String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5042.java