error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11664.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11664.java
text:
```scala
public static L@@ist<WicketTesterHelper.ComponentData> getComponentData(final Page page)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11664.java