error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3837.java
text:
```scala
w@@orkDir = _TestUtil.getTempDir("TestMultiMMap");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3837.java