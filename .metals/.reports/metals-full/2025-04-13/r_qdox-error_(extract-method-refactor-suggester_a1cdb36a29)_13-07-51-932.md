error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12204.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12204.java
text:
```scala
public v@@oid addMockData(String spoutId, Values... valueses) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12204.java