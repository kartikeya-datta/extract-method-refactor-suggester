error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1467.java
text:
```scala
S@@earchResponse mltResponse = client1.moreLikeThis(moreLikeThisRequest("test").type("type1").id("1").minTermFreq(1).minDocFreq(1)).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1467.java