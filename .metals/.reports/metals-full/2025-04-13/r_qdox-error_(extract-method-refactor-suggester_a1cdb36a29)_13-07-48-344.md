error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2721.java
text:
```scala
P@@ath input = fs.makeQualified(new Path(Resources.getResource("wdbc").toURI()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2721.java