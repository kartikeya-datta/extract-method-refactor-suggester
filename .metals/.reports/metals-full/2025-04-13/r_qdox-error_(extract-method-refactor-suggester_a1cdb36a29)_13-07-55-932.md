error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7690.java
text:
```scala
r@@eturn localDestinationSocketBinding.getSocketAddress().getAddress();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7690.java