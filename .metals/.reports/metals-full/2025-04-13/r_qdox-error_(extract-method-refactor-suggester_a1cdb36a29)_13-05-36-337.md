error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/71.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/71.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/71.java
text:
```scala
k@@dcServer = KDCServerAnnotationProcessor.getKdcServer(directoryService, 1024);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/71.java