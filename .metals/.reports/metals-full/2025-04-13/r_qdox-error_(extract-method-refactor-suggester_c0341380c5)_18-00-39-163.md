error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4011.java
text:
```scala
i@@f (aVisibility != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4011.java