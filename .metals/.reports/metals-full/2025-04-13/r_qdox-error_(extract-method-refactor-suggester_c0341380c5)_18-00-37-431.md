error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13672.java
text:
```scala
A@@nnotationAttributes attributes = AnnotationConfigUtils.attributesFor(annDef.getMetadata(), this.scopeAnnotationType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13672.java