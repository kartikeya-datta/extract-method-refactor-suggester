error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9652.java
text:
```scala
r@@eturn System.getProperty("jboss.server.deploy.dir") + "/" + fileName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9652.java