error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10882.java
text:
```scala
r@@eturn superType != null && superType.isAssignableFrom(type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10882.java