error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9640.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9640.java
text:
```scala
abstract i@@nt I.getInt();  // Error expected: Needs to be public
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9640.java