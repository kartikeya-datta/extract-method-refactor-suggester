error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8229.java
text:
```scala
l@@ogger.info("Connected to {}/{} compute service", type, account);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8229.java