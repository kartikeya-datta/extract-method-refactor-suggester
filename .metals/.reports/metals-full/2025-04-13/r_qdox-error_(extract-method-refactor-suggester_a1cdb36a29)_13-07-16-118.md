error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7278.java
text:
```scala
L@@ist<ComplexExplanation> filterExplanations = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7278.java