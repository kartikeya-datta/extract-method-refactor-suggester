error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10008.java
text:
```scala
M@@arkupStream markup = new MarkupStream(parent.getAssociatedMarkup());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10008.java