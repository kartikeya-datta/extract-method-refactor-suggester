error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3594.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3594.java
text:
```scala
r@@eturn activeDesktop.openAndWait(file);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3594.java