error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12677.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12677.java
text:
```scala
final S@@tring reconnectName = ConnectionFactoryAttributes.Pooled.RECONNECT_ATTEMPTS_PROP_NAME;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12677.java