error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14366.java
text:
```scala
t@@ester.assertErrorMessages(new String[] { "id is required", "name is required" });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14366.java