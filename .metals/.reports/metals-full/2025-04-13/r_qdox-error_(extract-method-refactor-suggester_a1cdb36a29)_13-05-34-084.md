error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4611.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4611.java
text:
```scala
r@@eturn new Status(IStatus.ERROR,XmppPlugin.PLUGIN_ID,IStatus.ERROR,"Exception in user search",e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4611.java