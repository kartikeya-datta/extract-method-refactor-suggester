error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3026.java
...
```java
offset: 2997
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3026.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3026.java