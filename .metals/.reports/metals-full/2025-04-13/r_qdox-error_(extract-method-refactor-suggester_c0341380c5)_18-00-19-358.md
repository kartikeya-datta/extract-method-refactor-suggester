error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6686.java
text:
```scala
r@@eturn ModelControllerClient.Factory.create("http-remoting", System.getProperty("node0", "127.0.0.1"), 9990);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6686.java