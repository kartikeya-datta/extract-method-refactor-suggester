error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7932.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7932.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7932.java
text:
```scala
public static final i@@nt MAX_CACHE_DURATION = 60 * 60 * 24 * 365; // one year, maximum recommended cache duration
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7932.java