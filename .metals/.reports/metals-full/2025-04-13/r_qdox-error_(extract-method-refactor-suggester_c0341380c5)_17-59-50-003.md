error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9597.java
text:
```scala
N@@SString str = NSString.stringWith ("");  //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9597.java