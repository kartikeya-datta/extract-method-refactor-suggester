error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6232.java
text:
```scala
s@@cope.problemReporter().undocumentedEmptyBlock(finallyBlock.sourceStart, finallyBlock.sourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6232.java