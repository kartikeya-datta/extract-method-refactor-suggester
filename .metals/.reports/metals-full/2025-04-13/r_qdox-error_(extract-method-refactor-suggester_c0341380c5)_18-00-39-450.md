error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7968.java
text:
```scala
t@@his.minMergeSize = componentSettings.getAsBytesSize("min_merge_size", new ByteSizeValue((long) (LogByteSizeMergePolicy.DEFAULT_MIN_MERGE_MB * 1024 * 1024), ByteSizeUnit.BYTES));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7968.java