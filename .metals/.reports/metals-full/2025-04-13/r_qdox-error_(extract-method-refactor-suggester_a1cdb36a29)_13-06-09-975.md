error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5199.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5199.java
text:
```scala
public C@@lusterRerouteRequest setSource(BytesReference source) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5199.java