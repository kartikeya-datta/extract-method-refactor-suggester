error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3563.java
text:
```scala
i@@f (provider == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3563.java