error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5752.java
text:
```scala
l@@abel.setAlignment(Align.left);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5752.java