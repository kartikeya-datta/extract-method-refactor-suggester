error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5341.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5341.java
text:
```scala
v@@ar = var.replace('/', '.').replace('\\', '.');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5341.java