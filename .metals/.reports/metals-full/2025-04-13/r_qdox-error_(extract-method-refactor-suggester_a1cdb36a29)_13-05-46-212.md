error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/803.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/803.java
text:
```scala
final S@@tring productName = productConfig.resolveName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/803.java