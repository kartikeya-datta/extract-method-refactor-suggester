error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5517.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5517.java
text:
```scala
public v@@oid setConfiguredApplication(Boolean configuredApplication) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5517.java