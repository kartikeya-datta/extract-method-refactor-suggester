error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4237.java
text:
```scala
f@@loat /*double*/ [] color1, color2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4237.java