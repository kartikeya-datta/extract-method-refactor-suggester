error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6293.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6293.java
text:
```scala
public v@@oid transactionalTest() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6293.java