error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7243.java
text:
```scala
t@@his.commentStart = mapNullToDisabled(format.getCommentMarker());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7243.java