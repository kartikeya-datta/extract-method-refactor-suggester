error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10504.java
text:
```scala
...
public class DivertDefinition extends SimpleResourceDefinition {
    ...
    public static final AttributeDefinition[] ATTRIBUTES_WITH_EXPRESSION_ALLOWED_IN_1_2_0 = { ROUTING_NAME, ADDRESS, FORWARDING_ADDRESS, CommonAttributes.FILTER,
            EXCLUSIVE };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10504.java