error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13845.java
...
```java
offset: 881
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13845.java
text:
```scala
...
p@@ackage org.apache.tools.ant.types.selectors.modifiedselector;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13845.java