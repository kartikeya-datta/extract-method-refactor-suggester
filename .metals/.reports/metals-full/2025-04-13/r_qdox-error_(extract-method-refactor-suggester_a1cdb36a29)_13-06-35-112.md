error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1423.java
text:
```scala
a@@ddQueryParser(queryParsers, new WrapperQueryParser());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1423.java