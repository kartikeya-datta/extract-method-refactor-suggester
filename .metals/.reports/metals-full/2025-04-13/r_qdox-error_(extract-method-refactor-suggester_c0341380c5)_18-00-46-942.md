error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4311.java
text:
```scala
t@@ag.put("src", RequestCycle.get().getOriginalResponse().encodeURL(url));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4311.java