error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11652.java
text:
```scala
t@@his.install(context, operation, initialMaxSize, containerName, null, verificationHandler, serviceControllers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11652.java