error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12700.java
text:
```scala
V@@ALUE(ConnectorServiceParamDefinition.VALUE),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12700.java