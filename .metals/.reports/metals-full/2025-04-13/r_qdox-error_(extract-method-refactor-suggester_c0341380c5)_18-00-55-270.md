error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7391.java
text:
```scala
A@@rrayList<FieldMapper> mappers = new ArrayList<>(fieldsNames.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7391.java