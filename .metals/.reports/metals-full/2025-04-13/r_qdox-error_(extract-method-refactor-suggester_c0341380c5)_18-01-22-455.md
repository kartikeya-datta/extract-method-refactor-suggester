error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14898.java
text:
```scala
n@@ew BookmarkablePageLink(this, "customLoadingPageLink", PageWithCustomLoading.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14898.java