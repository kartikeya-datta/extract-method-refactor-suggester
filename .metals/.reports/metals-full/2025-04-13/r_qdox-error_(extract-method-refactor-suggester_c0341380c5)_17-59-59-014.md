error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/549.java
text:
```scala
c@@reateFile(folder, unit.getElementName(), stream, fForce);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/549.java