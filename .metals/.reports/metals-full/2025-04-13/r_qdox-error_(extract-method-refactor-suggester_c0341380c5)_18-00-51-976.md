error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5265.java
text:
```scala
a@@ssertThat(client("server1").admin().cluster().prepareHealth().setWaitForNodes("2").execute().actionGet().timedOut(), equalTo(false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5265.java