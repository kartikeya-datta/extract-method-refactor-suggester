error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2462.java
text:
```scala
a@@ssert consistencyLevel == ConsistencyLevel.EACH_QUORUM;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2462.java