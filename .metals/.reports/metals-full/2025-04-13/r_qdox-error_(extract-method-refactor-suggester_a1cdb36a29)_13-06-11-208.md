error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5008.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5008.java
text:
```scala
public N@@etApp() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5008.java