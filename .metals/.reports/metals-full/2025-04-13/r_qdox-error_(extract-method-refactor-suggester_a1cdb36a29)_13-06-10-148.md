error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13783.java
text:
```scala
C@@lass<?>[] value() default {};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13783.java