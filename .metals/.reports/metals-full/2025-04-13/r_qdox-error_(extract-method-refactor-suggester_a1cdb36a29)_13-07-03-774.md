error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11116.java
text:
```scala
i@@f(rawInput.indexOf(path) != -1)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11116.java