error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2643.java
text:
```scala
S@@tring string = configElement.getAttribute(IWorkbenchRegistryConstants.ATT_ALLOW_MULTIPLE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2643.java