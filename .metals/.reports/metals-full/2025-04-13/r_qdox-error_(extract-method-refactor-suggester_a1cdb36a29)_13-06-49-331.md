error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2192.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2192.java
text:
```scala
private final Q@@Name fAttributeQName = new QName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2192.java