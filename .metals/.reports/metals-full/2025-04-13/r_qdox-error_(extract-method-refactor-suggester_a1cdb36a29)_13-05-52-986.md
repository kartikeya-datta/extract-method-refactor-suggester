error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4519.java
text:
```scala
c@@har[][] exclusionsPatterns = ((PackageFragmentRoot)root).fullExclusionPatternChars();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4519.java