error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/114.java
text:
```scala
S@@ystem.out.println("WARNING:  Eclipse platform not available for trace...using system.out for org.eclipse.ecf.example.collab");
...
public class Trace {
    ...
    static {
        try {
            ...
            isEclipse = true;
            pluginName = ClientPlugin.PLUGIN_ID;
        } catch (Exception e) {
            try {
                String val = System.getProperty(ClientPlugin.PLUGIN_ID+".Trace");
                if (val != null) {
                    setTrace(true);
                    isEclipse = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/114.java