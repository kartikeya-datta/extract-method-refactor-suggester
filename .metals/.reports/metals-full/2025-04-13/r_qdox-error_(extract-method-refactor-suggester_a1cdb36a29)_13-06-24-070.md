error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6600.java
text:
```scala
n@@ew File(location, files[i]).delete();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6600.java