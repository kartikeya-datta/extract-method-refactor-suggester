error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16812.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16812.java
text:
```scala
private static final H@@TMLDOMImplementation _instance = new HTMLDOMImplementationImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16812.java