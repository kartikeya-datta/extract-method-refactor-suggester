error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/595.java
text:
```scala
G@@dx.gl.glScissor(Math.round(scissor.x), Math.round(scissor.y), Math.round(scissor.width), Math.round(scissor.height));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/595.java