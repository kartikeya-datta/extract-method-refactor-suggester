error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5923.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5923.java
text:
```scala
r@@eturn SimpleAttributeDefinitionBuilder.create(name, ModelType.INT, true).setDefaultValue(new ModelNode().set(defaultValue)).setXmlName(attribute.getLocalName()).setValidator(new IntRangeValidator(1, true)).build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5923.java