error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2027.java
text:
```scala
i@@f ("org/apache/openjpa/enhance/PersistenceCapable".equals(name))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2027.java