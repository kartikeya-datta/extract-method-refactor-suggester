error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10108.java
...
```java
offset: 1080
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10108.java
text:
```scala
...
*/
p@@ackage org.jboss.as.webservices.dmr;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10108.java