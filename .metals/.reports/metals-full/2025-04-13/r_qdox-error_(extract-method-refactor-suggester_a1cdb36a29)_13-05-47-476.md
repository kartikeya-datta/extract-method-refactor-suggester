error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9210.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9210.java
text:
```scala
public b@@oolean contains(Class<?> exClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9210.java