error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/125.java
text:
```scala
s@@tage.getBatch().disableBlending();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/125.java