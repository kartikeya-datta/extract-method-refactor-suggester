error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9138.java
text:
```scala
S@@tring[] indices = currentState.metaData().concreteIndices(request.indices(), IndicesOptions.lenientExpandOpen());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9138.java