error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3118.java
text:
```scala
s@@uper(10, 0.75f, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3118.java