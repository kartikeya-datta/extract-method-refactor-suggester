error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1088.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1088.java
text:
```scala
t@@hrow new IllegalStateException("No clusters found. Check your -c path.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1088.java