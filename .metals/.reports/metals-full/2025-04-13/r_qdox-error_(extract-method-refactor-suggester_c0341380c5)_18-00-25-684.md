error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8443.java
text:
```scala
D@@eploymentRemoveHandler dremh = new DeploymentRemoveHandler(contentRepository);
...
public class ServerControllerModelUtil {
    ...
    public static void initOperations(final ManagementResourceRegistration root,
        ...
        root.registerOperationHandler(SpecifiedInterfaceResolveHandler.OPERATION_NAME, SpecifiedInterfaceResolveHandler.INSTANCE, SpecifiedInterfaceResolveHandler.INSTANCE);
        ...
        extensionRegistry.setProfileResourceRegistration(root);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8443.java