error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12790.java
text:
```scala
i@@f (AccessCode.isProperty(fmd.getAccessType()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12790.java