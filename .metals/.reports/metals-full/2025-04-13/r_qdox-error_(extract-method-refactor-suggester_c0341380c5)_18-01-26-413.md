error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3344.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3344.java
text:
```scala
static final S@@tring fileNameFromGeneration(String base, String extension, long gen) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3344.java