error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4169.java
text:
```scala
C@@ommonDescriptions.getResourceDescriptionResolver(ModelDescriptionConstants.DEPLOYMENT_OVERLAY, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4169.java