error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10917.java
text:
```scala
S@@tringBuilder buf = new StringBuilder(sql.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10917.java