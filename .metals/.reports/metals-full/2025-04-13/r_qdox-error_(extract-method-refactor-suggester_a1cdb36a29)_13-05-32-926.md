error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8636.java
text:
```scala
i@@f (Boolean.valueOf(res).booleanValue())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8636.java