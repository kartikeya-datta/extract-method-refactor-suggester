error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3343.java
text:
```scala
s@@uper.setUp(DROP_TABLES, Person.class, Address.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3343.java