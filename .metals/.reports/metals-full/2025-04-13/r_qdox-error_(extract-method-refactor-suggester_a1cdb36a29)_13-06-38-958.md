error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8815.java
text:
```scala
f@@or (int gap=count/2; gap>0; gap/=2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8815.java