error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8390.java
text:
```scala
r@@ightIndex = source.lastIndexOf(")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8390.java