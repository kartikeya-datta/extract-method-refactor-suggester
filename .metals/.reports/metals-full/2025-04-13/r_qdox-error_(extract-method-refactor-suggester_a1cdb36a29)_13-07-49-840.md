error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3131.java
text:
```scala
i@@f (methods != null && methods.length > 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3131.java