error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10416.java
text:
```scala
a@@ssertThat(doc.doc().getFieldable("ip1"), notNullValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10416.java