error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15115.java
text:
```scala
c@@onverter.write(body, null, outputMessage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15115.java