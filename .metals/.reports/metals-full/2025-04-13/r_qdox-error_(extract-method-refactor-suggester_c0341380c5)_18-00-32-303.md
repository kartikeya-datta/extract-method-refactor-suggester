error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2294.java
text:
```scala
a@@ssertTrue(deleteReader.getDeletedDocs().get(0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2294.java