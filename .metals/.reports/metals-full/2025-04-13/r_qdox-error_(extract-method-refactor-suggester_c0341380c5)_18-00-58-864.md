error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14360.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14360.java
text:
```scala
public C@@onversionUtils(ConverterRegistry registry)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14360.java