error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11495.java
text:
```scala
L@@ist modelData = (List)page.get("table").getDefaultModelObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11495.java