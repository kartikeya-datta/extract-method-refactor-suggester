error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2647.java
text:
```scala
s@@uper("org.columba.mail.import", "org/columba/mail/plugin/import.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2647.java