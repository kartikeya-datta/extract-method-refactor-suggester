error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4986.java
text:
```scala
r@@eturn "wicket-default-autocomplete";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4986.java