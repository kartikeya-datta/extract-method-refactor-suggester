error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1975.java
text:
```scala
T@@extButtonTest.class, TextureBindTest.class};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1975.java