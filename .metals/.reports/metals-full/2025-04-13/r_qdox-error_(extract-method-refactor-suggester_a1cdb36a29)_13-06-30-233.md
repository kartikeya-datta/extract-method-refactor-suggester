error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9435.java
text:
```scala
c@@atch (IOException ignored)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9435.java