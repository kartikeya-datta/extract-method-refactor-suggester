error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6330.java
text:
```scala
f@@ilter.process(getSourceFolder(), uid);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6330.java