error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8686.java
text:
```scala
T@@hread t = new Thread(oiThreadGroup, r, "Connection Cleaner");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8686.java