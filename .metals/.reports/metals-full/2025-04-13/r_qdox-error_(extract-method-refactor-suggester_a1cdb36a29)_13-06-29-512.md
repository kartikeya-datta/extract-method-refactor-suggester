error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4050.java
text:
```scala
d@@eps = Array.of(AssetDescriptor.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4050.java