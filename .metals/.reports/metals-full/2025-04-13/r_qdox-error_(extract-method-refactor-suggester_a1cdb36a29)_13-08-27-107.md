error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1496.java
text:
```scala
B@@roker hp = hosts.getPartitionInformation().getBrokerFor(partition);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1496.java