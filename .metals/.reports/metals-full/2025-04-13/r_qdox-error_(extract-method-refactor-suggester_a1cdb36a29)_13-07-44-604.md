error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10444.java
text:
```scala
E@@eSubsystemRootResource.EJB_ANNOTATION_PROPERTY_REPLACEMENT.marshallAsElement(eeSubSystem, writer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10444.java