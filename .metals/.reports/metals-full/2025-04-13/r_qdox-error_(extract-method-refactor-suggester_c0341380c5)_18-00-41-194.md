error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6935.java
text:
```scala
l@@ogger.trace("serving getMapping request based on version {}", state.version());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6935.java