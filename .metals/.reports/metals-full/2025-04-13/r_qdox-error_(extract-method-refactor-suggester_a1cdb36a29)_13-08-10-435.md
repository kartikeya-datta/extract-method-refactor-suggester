error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2841.java
text:
```scala
i@@f (!multiple) SWT.error (SWT.ERROR_NOT_IMPLEMENTED, null, " [multiple displays]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2841.java