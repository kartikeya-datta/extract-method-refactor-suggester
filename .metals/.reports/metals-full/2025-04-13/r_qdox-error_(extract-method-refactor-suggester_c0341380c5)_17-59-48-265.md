error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8650.java
text:
```scala
n@@ormsField = parseContext.indexName(jp.getText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8650.java