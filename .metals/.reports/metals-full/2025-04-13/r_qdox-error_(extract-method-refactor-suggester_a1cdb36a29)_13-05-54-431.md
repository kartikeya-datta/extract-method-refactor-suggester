error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3626.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3626.java
text:
```scala
public static final S@@tring NAME = UidFieldMapper.NAME;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3626.java