error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2949.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2949.java
text:
```scala
public S@@hutdownDialog() throws Exception{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2949.java