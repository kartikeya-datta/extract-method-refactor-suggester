error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13833.java
text:
```scala
r@@esponseHandler.setContext(new ManagementResponseContext(header));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13833.java