error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7039.java
text:
```scala
r@@esponseHandler.setContext(new ManagementResponseContext(header, ManagementChannel.this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7039.java