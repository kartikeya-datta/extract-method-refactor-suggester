error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7170.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7170.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7170.java
text:
```scala
i@@f (forceInitialize && this.storedAnnotations == null && this.scope != null) { // scope null when no annotation cached, and type got processed fully (159631)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7170.java