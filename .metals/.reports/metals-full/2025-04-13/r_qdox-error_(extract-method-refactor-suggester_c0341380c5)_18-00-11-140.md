error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4132.java
text:
```scala
s@@erviceTarget.addService(applicationContextServiceName.append("AppName"), applicationNameBinder).addDependency(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4132.java