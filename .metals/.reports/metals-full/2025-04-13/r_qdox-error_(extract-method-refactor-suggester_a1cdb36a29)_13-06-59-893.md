error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8006.java
text:
```scala
g@@etShell().setVisible(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8006.java