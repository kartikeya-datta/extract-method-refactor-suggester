error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6893.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6893.java
text:
```scala
public v@@oid fling (InputEvent event, float x, float y, int button) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6893.java