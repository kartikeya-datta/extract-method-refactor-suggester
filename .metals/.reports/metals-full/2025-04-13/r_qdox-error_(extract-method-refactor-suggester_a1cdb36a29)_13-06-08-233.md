error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13245.java
text:
```scala
c@@hild.sendSelectionEvent (SWT.Selection, event, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13245.java