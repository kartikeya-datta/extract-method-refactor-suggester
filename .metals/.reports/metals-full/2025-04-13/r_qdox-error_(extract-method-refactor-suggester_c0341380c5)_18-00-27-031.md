error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8740.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8740.java
text:
```scala
B@@lob blob = cloudBlobStore.sync().newBlob(buildBlobPath(blobName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8740.java