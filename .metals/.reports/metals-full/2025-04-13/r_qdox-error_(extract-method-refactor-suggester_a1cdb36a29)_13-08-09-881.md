error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10603.java
text:
```scala
S@@tring propertyName = parserContext.getDelegate().getLocalName(attr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10603.java