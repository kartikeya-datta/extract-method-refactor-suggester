error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9518.java
text:
```scala
i@@f (x < 0 || x >= getWidth() || y < 0 || y >= getHeight()) return null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9518.java