error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8551.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8551.java
text:
```scala
final S@@tring variation = owner.getVariation();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8551.java