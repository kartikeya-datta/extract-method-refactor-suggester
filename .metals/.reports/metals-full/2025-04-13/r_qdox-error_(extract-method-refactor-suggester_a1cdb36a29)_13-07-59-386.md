error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18366.java
text:
```scala
T@@estUtil.runMain("out", "LazyTjp");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18366.java