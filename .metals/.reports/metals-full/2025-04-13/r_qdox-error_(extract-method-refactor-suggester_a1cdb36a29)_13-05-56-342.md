error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12568.java
text:
```scala
i@@nt val = Math.abs(id.host.hashCode() + 23 * id.partition);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12568.java