error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1337.java
text:
```scala
r@@unOnEDT = config.runOnEDT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1337.java