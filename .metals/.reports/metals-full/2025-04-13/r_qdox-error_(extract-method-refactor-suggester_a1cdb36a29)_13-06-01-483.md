error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7446.java
text:
```scala
C@@harOperation.splitOn('/', typeNameChars, /*typeNameChars[0] == '/' ? 1 :*/ 0, typeName.lastIndexOf('/') - 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7446.java