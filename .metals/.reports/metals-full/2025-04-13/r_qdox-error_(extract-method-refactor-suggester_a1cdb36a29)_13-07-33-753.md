error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3027.java
text:
```scala
t@@hrow new IOException("This archives contains unclosed entries.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3027.java