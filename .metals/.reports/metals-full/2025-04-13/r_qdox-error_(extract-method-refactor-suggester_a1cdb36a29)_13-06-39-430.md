error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2549.java
text:
```scala
C@@olumnDefinition newCd = ColumnDefinition.inflate(cd.deflate());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2549.java