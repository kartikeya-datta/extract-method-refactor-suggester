error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13428.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13428.java
text:
```scala
private I@@Content content = new GapContent(100);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13428.java