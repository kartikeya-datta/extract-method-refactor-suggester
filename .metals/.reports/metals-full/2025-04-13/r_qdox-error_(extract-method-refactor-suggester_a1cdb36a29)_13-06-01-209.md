error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7775.java
text:
```scala
l@@og.error("Exception occurred during onEndRequest", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7775.java