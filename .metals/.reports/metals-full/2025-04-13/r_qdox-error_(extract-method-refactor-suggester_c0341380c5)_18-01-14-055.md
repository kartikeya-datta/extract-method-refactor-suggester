error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3875.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3875.java
text:
```scala
i@@f (!indexMetaData.settings().getAsBoolean("index.warmer.enabled", settings.getAsBoolean("index.warmer.enabled", true))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3875.java