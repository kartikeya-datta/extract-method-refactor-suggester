error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11074.java
text:
```scala
s@@b.append("GMM").append(mySet); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11074.java