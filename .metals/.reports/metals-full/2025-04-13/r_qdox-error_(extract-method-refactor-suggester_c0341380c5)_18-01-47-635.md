error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4995.java
text:
```scala
F@@ileSystemBrowser fsb = new FileSystemBrowser(directoryID, listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4995.java