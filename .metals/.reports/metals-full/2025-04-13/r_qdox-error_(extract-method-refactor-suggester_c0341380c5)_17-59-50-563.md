error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4710.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4710.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4710.java
text:
```scala
final D@@eploymentUnit deploymentUnitContext = phaseContext.getDeploymentUnit();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4710.java