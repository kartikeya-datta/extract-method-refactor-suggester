error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3992.java
text:
```scala
T@@ypeBinding referenceType = type.resolveType(scope, true /* check bounds*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3992.java