error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2841.java
text:
```scala
i@@f ( accountItem.isDefault() ) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2841.java