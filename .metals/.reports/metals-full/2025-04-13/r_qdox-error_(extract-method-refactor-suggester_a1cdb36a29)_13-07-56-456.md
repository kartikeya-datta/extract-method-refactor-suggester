error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4011.java
text:
```scala
t@@his.rateLimitingThrottle = componentSettings.getAsBytesSize("throttle.max_bytes_per_sec", new ByteSizeValue(20, ByteSizeUnit.MB));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4011.java