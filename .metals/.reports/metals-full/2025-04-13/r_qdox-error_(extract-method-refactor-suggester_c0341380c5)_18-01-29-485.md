error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2926.java
...
```java
offset: 1120
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2926.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.ejb3.context;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2926.java