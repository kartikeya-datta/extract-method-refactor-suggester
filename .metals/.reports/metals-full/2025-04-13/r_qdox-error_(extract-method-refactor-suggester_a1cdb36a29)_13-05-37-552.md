error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1356.java
text:
```scala
i@@f (fType != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1356.java