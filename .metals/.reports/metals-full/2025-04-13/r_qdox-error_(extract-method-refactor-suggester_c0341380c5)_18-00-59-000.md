error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13002.java
text:
```scala
n@@ew CallAS7("dump-services").resource("core-service", "service-container"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13002.java