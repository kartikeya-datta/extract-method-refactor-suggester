error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1802.java
text:
```scala
f@@Signature = computeSignature("", paramTypes); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1802.java