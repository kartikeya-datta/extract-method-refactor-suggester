error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14909.java
text:
```scala
T@@hread.sleep(10000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14909.java