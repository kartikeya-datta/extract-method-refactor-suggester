error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14003.java
text:
```scala
t@@ag.put("accept-charset", getApplication().getRequestCycleSettings()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14003.java