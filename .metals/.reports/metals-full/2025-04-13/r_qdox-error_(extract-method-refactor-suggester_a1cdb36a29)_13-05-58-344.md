error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5863.java
text:
```scala
h@@ighlightBuilder().postTags(postTags);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5863.java