error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13406.java
text:
```scala
A@@ssert.notNull(elementClass, "Element class must not be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13406.java