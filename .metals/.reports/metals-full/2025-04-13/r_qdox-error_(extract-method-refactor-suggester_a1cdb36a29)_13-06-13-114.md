error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9271.java
text:
```scala
t@@his.matchCompatibility = getMatchRule() & MATCH_COMPATIBILITY_MASK;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9271.java