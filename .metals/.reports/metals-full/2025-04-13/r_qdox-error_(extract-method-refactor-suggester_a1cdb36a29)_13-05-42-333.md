error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2452.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2452.java
text:
```scala
final C@@onstantInitializer<?> c = (ConstantInitializer<?>) obj;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2452.java