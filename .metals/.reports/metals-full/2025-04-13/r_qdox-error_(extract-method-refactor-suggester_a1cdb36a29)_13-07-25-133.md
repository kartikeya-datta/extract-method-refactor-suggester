error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14960.java
text:
```scala
u@@ploadFolder = new Folder(System.getProperty("java.io.tmpdir"), "wicket-uploads");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14960.java