error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10098.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10098.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10098.java
text:
```scala
H@@ttpEntity<MappingJacksonValue> entity = new HttpEntity<MappingJacksonValue>(jacksonValue, entityHeaders);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10098.java