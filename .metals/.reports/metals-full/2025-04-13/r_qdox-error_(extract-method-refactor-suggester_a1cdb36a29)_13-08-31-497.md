error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6876.java
text:
```scala
s@@etRotation(dir, up);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6876.java