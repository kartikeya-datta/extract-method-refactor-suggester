error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3787.java
text:
```scala
r@@eturn key;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3787.java