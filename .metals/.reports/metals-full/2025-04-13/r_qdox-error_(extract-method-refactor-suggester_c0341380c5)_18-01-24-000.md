error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1872.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1872.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1872.java
text:
```scala
final c@@har[] mainTypeName = fileName.substring(0, fileName.length() - 5).toCharArray(); //TODO (jerome) should not hardcode extension length
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1872.java