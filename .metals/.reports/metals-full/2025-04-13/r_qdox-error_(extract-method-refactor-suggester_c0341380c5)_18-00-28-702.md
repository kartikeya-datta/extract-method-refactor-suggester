error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8786.java
text:
```scala
r@@eturn Time.valueOf(milliseconds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8786.java