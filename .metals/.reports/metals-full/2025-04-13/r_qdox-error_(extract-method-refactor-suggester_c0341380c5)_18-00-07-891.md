error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10423.java
...
```java
offset: 860
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10423.java
text:
```scala
...
p@@ackage org.elasticsearch.index.mapper.json;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10423.java