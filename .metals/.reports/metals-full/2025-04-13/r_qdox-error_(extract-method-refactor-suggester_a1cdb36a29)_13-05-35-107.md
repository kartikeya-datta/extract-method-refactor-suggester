error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3686.java
text:
```scala
r@@eturn isSelected();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3686.java