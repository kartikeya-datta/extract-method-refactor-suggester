error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3812.java
text:
```scala
I@@nteger v = (Integer)args.get("setTermIndexInterval");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3812.java