error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7742.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7742.java
text:
```scala
protected v@@oid callUserDataHandlers(Node n, Node c, short operation) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7742.java