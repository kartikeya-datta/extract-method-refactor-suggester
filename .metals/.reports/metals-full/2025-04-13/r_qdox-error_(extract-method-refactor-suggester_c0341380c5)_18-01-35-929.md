error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3299.java
text:
```scala
d@@ata.font = getSystemFont ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3299.java