error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3902.java
text:
```scala
L@@OGGER.debug("New request comming.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3902.java