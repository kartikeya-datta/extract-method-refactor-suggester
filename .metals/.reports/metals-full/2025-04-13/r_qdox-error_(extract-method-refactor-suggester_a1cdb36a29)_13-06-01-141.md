error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9578.java
text:
```scala
b@@oolean helpWanted = request.paramAsBoolean("h", request.paramAsBoolean("help", false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9578.java