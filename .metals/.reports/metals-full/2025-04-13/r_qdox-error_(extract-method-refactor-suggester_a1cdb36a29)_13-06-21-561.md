error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4104.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4104.java
text:
```scala
static i@@nt /*long*/ cdeShell;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4104.java