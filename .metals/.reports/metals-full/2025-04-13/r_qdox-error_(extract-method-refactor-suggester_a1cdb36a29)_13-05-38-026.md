error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6260.java
text:
```scala
s@@uper(id.intern(), model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6260.java