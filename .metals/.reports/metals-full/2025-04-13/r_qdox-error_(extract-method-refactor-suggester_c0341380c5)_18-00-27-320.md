error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7180.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7180.java
text:
```scala
static final O@@perationDefinition DEFINITION = new SimpleOperationDefinitionBuilder(ModelDescriptionConstants.UNDEFINE_ATTRIBUTE_OPERATION, ControllerResolver.getResolver("global"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7180.java