error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3638.java
text:
```scala
i@@f (isAnonymous() || isLocal() || isPrimitive() || isArray() || isNullType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3638.java