error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9796.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9796.java
text:
```scala
private final M@@anifold manifold = new Manifold(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9796.java