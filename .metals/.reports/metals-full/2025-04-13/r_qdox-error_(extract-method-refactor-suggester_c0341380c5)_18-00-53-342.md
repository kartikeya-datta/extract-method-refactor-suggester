error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4089.java
text:
```scala
A@@nnotation annotation = new Annotation(classFileBytes, constantPool, offset + this.readOffset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4089.java