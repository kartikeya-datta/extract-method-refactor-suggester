error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5359.java
text:
```scala
i@@f (!flickScroll) resetFade();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5359.java