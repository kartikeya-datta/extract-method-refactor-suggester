error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8937.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8937.java
text:
```scala
a@@ppender.activate();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8937.java