error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8414.java
text:
```scala
n@@ew CompletionParser(problemReporter, compilerOptions.assertMode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8414.java