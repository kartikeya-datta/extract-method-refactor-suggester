error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3508.java
text:
```scala
C@@ategory.getDefaultHierarchy().disableInfo();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3508.java