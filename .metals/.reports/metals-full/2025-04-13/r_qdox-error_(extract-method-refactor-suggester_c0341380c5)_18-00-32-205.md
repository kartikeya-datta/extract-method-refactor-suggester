error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9970.java
text:
```scala
K@@eystoreAttributes.KEYSTORE_PASSWORD, KeystoreAttributes.KEYSTORE_PATH, KeystoreAttributes.KEYSTORE_RELATIVE_TO
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9970.java