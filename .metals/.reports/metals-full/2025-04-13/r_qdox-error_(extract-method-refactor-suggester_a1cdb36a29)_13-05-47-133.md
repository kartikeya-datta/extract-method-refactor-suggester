error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3875.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3875.java
text:
```scala
public B@@ookmarkablePage(final PageParameters pageParameters)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3875.java