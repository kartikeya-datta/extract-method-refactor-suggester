error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5052.java
text:
```scala
i@@nstance.activate(primaryKey);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5052.java