error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3680.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3680.java
text:
```scala
a@@ssertTextPresent("This example displays how you can work with 'nice' urls for bookmarkable pages.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3680.java