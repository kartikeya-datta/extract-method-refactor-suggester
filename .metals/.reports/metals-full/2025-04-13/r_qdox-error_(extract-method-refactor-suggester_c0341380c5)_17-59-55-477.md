error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6589.java
text:
```scala
r@@otation.setFromAxes(tmp.x, tmp.y, tmp.z, tmp2.x, tmp2.y, tmp2.z, dir.x, dir.y, dir.z);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6589.java