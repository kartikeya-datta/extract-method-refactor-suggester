error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1085.java
text:
```scala
R@@equestCycle.get().replaceCurrentRequestHandler(new RedirectRequestHandler(url));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1085.java