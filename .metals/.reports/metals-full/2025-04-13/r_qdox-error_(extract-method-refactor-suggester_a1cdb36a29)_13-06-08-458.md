error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6276.java
text:
```scala
i@@f (contextServiceListeners == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6276.java