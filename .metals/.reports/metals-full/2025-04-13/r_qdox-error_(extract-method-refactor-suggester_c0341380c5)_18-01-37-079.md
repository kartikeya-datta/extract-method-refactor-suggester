error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/832.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/832.java
text:
```scala
K@@eyStroke.getKeyStroke(KeyEvent.VK_E, ActionEvent.CTRL_MASK | ActionEvent.SHIFT_MASK));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/832.java