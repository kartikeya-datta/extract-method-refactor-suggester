error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18166.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18166.java
text:
```scala
public b@@oolean isStopped() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18166.java