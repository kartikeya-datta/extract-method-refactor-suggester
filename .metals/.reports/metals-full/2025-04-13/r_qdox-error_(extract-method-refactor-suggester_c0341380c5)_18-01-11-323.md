error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3479.java
text:
```scala
r@@esult = parsedCmd.getLastChunkIndex();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3479.java