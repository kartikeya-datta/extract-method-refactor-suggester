error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4028.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4028.java
text:
```scala
r@@ec.signature = st.getBase64();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4028.java