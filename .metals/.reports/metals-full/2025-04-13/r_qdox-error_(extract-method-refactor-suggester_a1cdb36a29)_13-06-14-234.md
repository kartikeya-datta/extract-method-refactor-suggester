error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9247.java
text:
```scala
F@@ieldMapper mapper = parseContext.fieldMapper(field);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9247.java