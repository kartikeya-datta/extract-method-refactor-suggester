error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1378.java
text:
```scala
t@@abWidth = Integer.parseInt((String) options.get(DefaultCodeFormatterConstants.FORMATTER_TAB_LENGTH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1378.java