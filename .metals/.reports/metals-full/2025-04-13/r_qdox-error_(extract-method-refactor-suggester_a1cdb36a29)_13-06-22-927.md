error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4255.java
text:
```scala
a@@rgs.put( "debug", s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4255.java