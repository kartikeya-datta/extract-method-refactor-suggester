error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1747.java
text:
```scala
S@@tring string = new String(buffer, offset, length); // TODO default charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1747.java