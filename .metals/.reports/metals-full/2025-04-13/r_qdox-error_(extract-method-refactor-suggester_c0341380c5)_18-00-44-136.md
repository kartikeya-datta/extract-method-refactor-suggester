error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1865.java
text:
```scala
w@@ar.addAsManifestResource(DatabaseTimerServiceTestCase.class.getPackage(), "jboss-ejb3.xml", "jboss-ejb3.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1865.java