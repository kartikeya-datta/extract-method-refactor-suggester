error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9773.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9773.java
text:
```scala
public R@@estartResponseAtInterceptPageException(final Class<? extends Page> interceptPageClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9773.java