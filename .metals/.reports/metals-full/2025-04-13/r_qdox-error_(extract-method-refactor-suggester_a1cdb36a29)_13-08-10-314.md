error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8678.java
text:
```scala
s@@etUp(Person.class, Employee.class, DROP_TABLES, "openjpa.DetachState",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8678.java