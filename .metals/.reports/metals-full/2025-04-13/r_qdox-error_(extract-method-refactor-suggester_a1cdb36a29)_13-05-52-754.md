error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5417.java
text:
```scala
n@@ew FolderOptionsDialog((MessageFolder) folder,true,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5417.java