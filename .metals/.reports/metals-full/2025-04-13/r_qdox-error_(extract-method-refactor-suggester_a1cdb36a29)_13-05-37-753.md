error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10779.java
text:
```scala
t@@argetClass.getClassLoader().loadClass(org.jgroups.conf.ProtocolConfiguration.protocol_prefix + '.' + value).asSubclass(targetClass).newInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10779.java