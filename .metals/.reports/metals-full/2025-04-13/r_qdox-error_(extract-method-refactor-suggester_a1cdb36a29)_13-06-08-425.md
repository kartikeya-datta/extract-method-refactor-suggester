error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4955.java
text:
```scala
L@@ist getContextBindingDefinitions();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4955.java