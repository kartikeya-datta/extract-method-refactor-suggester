error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3441.java
text:
```scala
C@@reateFilterOnMessageCommand c = new CreateFilterOnMessageCommand(getFrameMediator(), r,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3441.java