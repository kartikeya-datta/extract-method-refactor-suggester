error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10531.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10531.java
text:
```scala
public static final A@@ttachmentKey<AttachmentList<VirtualFile>> DEPLOYMENT_OVERRIDE_LOCATIONS = AttachmentKey.createList(VirtualFile.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10531.java