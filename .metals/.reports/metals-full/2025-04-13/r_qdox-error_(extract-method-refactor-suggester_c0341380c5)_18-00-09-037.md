error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9399.java
text:
```scala
S@@ystem.out.println("PROBLEM FOUND while reconciling : "+problem.getMessage());//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9399.java