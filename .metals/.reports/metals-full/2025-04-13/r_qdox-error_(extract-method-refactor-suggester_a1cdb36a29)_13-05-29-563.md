error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5474.java
text:
```scala
i@@f (declaringType.kind() == IGenericType.ENUM) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5474.java