error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8169.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8169.java
text:
```scala
private S@@tring numberRadioChoice = (String)FormInput.NUMBERS.get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8169.java