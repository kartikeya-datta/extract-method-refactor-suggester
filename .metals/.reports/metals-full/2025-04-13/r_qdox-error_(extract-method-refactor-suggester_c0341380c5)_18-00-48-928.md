error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/975.java
text:
```scala
r@@esp.sendError(HttpServletResponse.SC_FORBIDDEN, "Principal name is printed only for the authenticated users.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/975.java