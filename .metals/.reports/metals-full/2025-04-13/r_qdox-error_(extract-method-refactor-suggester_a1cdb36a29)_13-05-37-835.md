error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12531.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[51,2]

error in qdox parser
file content:
```java
offset: 1790
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12531.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12531.java