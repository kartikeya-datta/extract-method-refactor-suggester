error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16422.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16422.java
text:
```scala
abstract a@@spect AA { declare dominates: AA, (AA+ && !AA); // error: should dominate A
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16422.java