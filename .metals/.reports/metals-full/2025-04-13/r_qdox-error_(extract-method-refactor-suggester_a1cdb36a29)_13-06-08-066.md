error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9854.java
text:
```scala
w@@orld.step( app.getGraphics().getDeltaTime(), 8, 3 );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9854.java