error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7543.java
text:
```scala
S@@tring nodeId = UUID.randomBase64UUID();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7543.java