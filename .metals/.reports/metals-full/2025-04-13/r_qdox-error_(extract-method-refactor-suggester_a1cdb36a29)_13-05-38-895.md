error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15926.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15926.java
text:
```scala
private final L@@abeledWebMarkupContainer component;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15926.java