error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/803.java
text:
```scala
A@@bstractTextComponent(MarkupContainer parent, final String id, final IModel<T> model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/803.java