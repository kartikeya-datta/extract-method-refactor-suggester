error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3926.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3926.java
text:
```scala
public W@@izardLink(final MarkupContainer parent, final String id, final Class wizardClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3926.java