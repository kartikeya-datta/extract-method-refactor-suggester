error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9330.java
text:
```scala
b@@uf.append("1 <> 1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9330.java