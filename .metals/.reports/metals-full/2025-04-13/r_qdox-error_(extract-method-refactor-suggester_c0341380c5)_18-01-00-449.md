error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9730.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9730.java
text:
```scala
static final i@@nt SKIN_NEEDED = 1<<15;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9730.java