error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6789.java
text:
```scala
n@@ew LwjglApplication(new SkeletonModelViewer("data/models/robot-mesh.xml", "data/models/robot.jpg"), "SkeletonModel Viewer", 800, 480,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6789.java