error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1139.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1139.java
text:
```scala
s@@et("gramSize", Integer.toString(gramSize));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1139.java