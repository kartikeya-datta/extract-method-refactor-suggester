error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/405.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/405.java
text:
```scala
public f@@loat getValueForNormalization() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/405.java