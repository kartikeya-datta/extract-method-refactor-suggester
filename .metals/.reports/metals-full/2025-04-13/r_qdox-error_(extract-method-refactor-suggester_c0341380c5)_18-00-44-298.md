error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4501.java
text:
```scala
b@@inding.original().modifiers |= ExtraCompilerModifiers.AccLocallyUsed;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4501.java