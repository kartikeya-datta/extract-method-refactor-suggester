error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3363.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3363.java
text:
```scala
private i@@nt binarySearch(BytesRef b, BytesRef bytesRef, int low,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3363.java