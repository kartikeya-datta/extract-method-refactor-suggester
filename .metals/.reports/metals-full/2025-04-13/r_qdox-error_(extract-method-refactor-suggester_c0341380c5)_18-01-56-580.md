error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6861.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6861.java
text:
```scala
 T@@YPE_GIST.equals(type) && ((GistPayload) payload).getGist() != null //
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6861.java