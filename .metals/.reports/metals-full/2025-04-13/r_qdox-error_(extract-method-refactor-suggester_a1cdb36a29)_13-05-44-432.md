error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9474.java
text:
```scala
b@@atch.draw(texture, 10, 100, width, height, 0, 0, 64, 32, false, false );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9474.java