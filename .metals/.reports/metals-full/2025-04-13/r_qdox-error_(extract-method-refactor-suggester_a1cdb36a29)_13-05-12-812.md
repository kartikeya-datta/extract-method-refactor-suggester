error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12988.java
text:
```scala
r@@eturn widget.menuForEvent(id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12988.java