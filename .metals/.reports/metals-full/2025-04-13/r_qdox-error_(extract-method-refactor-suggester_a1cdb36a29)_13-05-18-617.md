error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1502.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1502.java
text:
```scala
g@@etHandler(ctx.getCharacter()).handle(ctx);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1502.java