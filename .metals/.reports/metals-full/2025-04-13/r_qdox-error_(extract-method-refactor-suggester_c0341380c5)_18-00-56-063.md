error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9150.java
text:
```scala
n@@ew StringBuffer(Util.bind("accept.cannot")) //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9150.java