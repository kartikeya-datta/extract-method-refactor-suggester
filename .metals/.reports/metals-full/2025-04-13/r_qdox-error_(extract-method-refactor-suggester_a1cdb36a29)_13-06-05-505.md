error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10261.java
...
```java
offset: 1174
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10261.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.ejb3.cache;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10261.java