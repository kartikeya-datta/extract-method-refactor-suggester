error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4813.java
text:
```scala
s@@etWindowTitle(WorkbenchMessages.WorkingSetNewWizard_title);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4813.java