error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6912.java
text:
```scala
s@@ound = app.getAudio().newSound( app.getFiles().getInternalFileHandle( "data/shotgun.wav" ) );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6912.java