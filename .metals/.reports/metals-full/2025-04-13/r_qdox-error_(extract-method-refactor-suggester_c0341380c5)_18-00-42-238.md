error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15448.java
text:
```scala
p@@ublic class JavaScriptStripper
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15448.java