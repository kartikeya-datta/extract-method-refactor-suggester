error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2612.java
text:
```scala
r@@eturn getWorkingCopy(new WorkingCopyOwner() {/*non shared working copy*/}, null/*no problem requestor*/, monitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2612.java