error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1794.java
text:
```scala
S@@izeValue maxContentLength = componentSettings.getAsSize("max_content_length", settings.getAsSize("http.max_content_length", new SizeValue(100, SizeUnit.MB)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1794.java