error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3697.java
text:
```scala
r@@eturn isTrue(s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3697.java