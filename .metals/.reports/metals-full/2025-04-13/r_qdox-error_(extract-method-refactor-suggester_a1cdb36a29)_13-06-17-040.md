error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17577.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[297,80]

error in qdox parser
file content:
```java
offset: 7082
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17577.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17577.java