error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13575.java
text:
```scala
S@@tring pageMapName = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13575.java