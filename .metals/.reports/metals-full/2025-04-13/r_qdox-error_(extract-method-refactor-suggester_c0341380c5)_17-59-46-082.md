error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8185.java
text:
```scala
p@@ublic final class FeedbackMessages implements IClusterable, Iterable<FeedbackMessage>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8185.java