error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7746.java
text:
```scala
t@@hrow new ElasticSearchIllegalStateException("No routing state mapped for [" + value + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7746.java