error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13862.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13862.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13862.java
text:
```scala
N@@amespace ns = new Namespace(null, name, name, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13862.java