error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7545.java
text:
```scala
i@@f (knownType == null) knownType = ObjectMap.class;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7545.java