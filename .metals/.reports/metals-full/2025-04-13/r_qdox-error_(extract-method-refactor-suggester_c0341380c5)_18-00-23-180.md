error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1511.java
text:
```scala
i@@f ((flowInfo.tagBits & FlowInfo.UNREACHABLE) != 0) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1511.java