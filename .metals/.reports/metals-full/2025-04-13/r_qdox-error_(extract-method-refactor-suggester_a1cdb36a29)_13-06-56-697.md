error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2356.java
text:
```scala
i@@f ((expressionIsCast = this.expression instanceof CastExpression) == true) this.expression.bits |= DisableUnnecessaryCastCheck; // will check later on
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2356.java