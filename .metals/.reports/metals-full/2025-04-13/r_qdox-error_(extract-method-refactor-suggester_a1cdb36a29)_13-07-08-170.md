error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15371.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15371.java
text:
```scala
public final S@@tring loadStringResource(final Component component, final String key, Locale locale,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15371.java