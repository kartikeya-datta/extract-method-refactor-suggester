error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1418.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1418.java
text:
```scala
r@@esources[i] = childrenOfInterest[i].getResource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1418.java