error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4416.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4416.java
text:
```scala
public static S@@tring forType(String alias) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4416.java