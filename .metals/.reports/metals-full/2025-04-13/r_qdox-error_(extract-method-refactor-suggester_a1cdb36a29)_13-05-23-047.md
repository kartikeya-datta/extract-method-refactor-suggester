error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14322.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14322.java
text:
```scala
static c@@har fixMnemonic (char [] buffer) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14322.java