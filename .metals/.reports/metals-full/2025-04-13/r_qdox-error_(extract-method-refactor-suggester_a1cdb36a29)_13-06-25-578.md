error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2010.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2010.java
text:
```scala
private final i@@nt gcBefore = (int) (System.currentTimeMillis() / 1000) - cfs.metadata.getGcGraceSeconds();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2010.java