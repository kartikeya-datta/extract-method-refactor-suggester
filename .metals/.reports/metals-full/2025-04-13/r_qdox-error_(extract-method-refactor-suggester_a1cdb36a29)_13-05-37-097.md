error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12967.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12967.java
text:
```scala
public abstract I@@ResourceStream getResourceStream();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12967.java