error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17730.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[85,80]

error in qdox parser
file content:
```java
offset: 1965
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17730.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17730.java