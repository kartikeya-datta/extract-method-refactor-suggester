error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7871.java
text:
```scala
p@@ublic interface ICompoundModel<V> extends IModel<V>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7871.java