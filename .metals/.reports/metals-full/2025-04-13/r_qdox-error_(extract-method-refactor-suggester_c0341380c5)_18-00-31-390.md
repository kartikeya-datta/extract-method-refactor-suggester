error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2204.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2204.java
text:
```scala
r@@eturn CharOperation.concat(Evaluator.this.getClassName(), ".java"/*nonNLS*/.toCharArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2204.java