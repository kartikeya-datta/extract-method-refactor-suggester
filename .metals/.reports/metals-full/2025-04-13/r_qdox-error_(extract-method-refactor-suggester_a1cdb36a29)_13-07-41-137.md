error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9277.java
text:
```scala
r@@eturn ((Comparable<Object>) left).compareTo(right);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9277.java