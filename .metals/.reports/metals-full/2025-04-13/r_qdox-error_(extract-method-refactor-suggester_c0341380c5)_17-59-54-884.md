error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1922.java
text:
```scala
M@@ap<String, ? extends Object> map = request.getParameterMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1922.java