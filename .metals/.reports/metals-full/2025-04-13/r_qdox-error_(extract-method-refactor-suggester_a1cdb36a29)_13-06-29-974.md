error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8833.java
text:
```scala
M@@ethodBinding method = messageSend.binding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8833.java