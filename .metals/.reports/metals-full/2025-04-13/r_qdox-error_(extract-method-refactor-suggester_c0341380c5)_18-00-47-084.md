error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1586.java
text:
```scala
l@@ogger.debug("starting recovery from {} ...", shardGateway);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1586.java