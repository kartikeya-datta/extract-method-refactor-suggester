error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4798.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4798.java
text:
```scala
private static volatile J@@taManager jtaManager;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4798.java