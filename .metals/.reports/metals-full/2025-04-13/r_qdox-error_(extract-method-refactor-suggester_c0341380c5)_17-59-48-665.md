error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7068.java
text:
```scala
b@@oolean explicitEnable = Boolean.parseBoolean(prop.getParamValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7068.java