error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/984.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/984.java
text:
```scala
public static G@@C cocoa_new(Drawable drawable, GCData data) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/984.java