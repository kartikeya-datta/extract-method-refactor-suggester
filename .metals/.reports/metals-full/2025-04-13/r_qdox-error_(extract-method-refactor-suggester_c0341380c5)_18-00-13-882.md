error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11753.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11753.java
text:
```scala
p@@ublic class CheckGroupTestPage5 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11753.java