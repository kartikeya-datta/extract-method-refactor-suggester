error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8146.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8146.java
text:
```scala
private final static F@@ile c_cwd;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8146.java