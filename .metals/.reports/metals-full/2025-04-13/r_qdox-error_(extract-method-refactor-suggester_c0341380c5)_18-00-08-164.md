error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5959.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5959.java
text:
```scala
public D@@ualTreeBidiMapTest(final String testName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5959.java