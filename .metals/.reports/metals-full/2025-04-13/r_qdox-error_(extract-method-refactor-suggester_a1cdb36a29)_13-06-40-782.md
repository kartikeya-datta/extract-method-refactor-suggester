error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8708.java
text:
```scala
i@@sVarArgs = arguments[argumentLength-1].isVarArgs();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8708.java