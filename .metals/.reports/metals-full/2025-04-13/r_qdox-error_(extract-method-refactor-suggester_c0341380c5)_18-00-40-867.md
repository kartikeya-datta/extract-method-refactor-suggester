error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13626.java
text:
```scala
M@@ap<String, Object> beans = new HashMap<String, Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13626.java