error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17196.java
text:
```scala
C@@lass.forName("java.util.ServiceLoader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17196.java