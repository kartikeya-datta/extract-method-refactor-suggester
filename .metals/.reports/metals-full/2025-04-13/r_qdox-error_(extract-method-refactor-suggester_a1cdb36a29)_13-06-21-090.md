error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14819.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14819.java
text:
```scala
I@@terable<ViewDescription> views = componentDescription.getViews();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14819.java