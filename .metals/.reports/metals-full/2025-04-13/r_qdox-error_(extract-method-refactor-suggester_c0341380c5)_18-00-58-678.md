error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12704.java
text:
```scala
P@@ropertyResourceDefinition.VALUE.validateAndSet(value, param.getModel());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12704.java