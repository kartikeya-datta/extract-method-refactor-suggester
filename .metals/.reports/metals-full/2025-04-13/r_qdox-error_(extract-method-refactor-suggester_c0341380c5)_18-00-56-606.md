error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9354.java
text:
```scala
b@@yte bytes[] = contents.getBytes(); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9354.java