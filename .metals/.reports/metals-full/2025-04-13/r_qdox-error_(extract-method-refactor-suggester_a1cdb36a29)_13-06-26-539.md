error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5523.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5523.java
text:
```scala
static final i@@nt TableSize = 30, InternalTableSize = 6; //30*6 =210 entries
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5523.java