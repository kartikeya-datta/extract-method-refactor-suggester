error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6012.java
...
```java
offset: 890
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6012.java
text:
```scala
 ...
 */
p@@ackage org.apache.commons.collections4.bidimap;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6012.java