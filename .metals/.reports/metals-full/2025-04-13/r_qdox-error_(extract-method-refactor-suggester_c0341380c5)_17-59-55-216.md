error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14347.java
text:
```scala
t@@hrow MESSAGES.persistenceUnitNotFound(absolutePath, puName, current);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14347.java