error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6324.java
text:
```scala
i@@f (!isConsistent()) { // TODO: (jerome) this code isn't synchronized with regular opening of a working copy
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6324.java