error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3653.java
text:
```scala
r@@eturn new SourceRange(docOffset + start, docEnd - docOffset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3653.java