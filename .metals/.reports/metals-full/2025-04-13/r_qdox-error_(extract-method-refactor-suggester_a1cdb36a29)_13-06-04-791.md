error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6151.java
text:
```scala
s@@hell.setData(BROWSER_COCOA_BUTTON, "true");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6151.java