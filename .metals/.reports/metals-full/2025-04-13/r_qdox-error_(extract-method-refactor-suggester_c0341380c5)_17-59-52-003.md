error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2817.java
text:
```scala
s@@uper(null,(ResolvedTypeX)cflowStackField.getDeclaringType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2817.java