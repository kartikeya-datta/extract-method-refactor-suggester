error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7999.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7999.java
text:
```scala
public s@@hort
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7999.java