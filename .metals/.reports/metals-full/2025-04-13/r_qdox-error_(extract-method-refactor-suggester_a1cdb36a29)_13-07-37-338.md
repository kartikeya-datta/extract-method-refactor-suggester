error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/578.java
text:
```scala
c@@tx.error("Unexpected argument '" + ctx.getArgumentsString() + '\'');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/578.java