error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1393.java
text:
```scala
i@@f (!display.isDisposed()) display.post(event);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1393.java