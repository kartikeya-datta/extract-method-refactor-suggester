error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3807.java
text:
```scala
t@@his.actualReceiverType = scope.enclosingSourceType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3807.java