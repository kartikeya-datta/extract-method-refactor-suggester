error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7401.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7401.java
text:
```scala
A@@rrayList<TextFragment> fragsList = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7401.java