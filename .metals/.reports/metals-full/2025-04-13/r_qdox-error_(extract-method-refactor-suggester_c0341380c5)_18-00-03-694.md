error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1866.java
text:
```scala
b@@.append('\0').append(s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1866.java