error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5671.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5671.java
text:
```scala
s@@hardRequest.add(i, item.type(), item.id(), item.fields(), item.version(), item.versionType(), item.fetchSourceContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5671.java