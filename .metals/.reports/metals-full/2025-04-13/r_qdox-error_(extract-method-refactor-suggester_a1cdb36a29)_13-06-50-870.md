error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1619.java
text:
```scala
n@@ew FileDialog(shell);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1619.java