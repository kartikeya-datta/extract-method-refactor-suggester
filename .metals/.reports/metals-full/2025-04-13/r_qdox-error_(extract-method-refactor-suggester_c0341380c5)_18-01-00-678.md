error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12753.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12753.java
text:
```scala
f@@actory.setBufferRequestBody(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12753.java