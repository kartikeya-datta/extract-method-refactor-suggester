error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6425.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6425.java
text:
```scala
public static final S@@impleAttributeDefinition SOCKET_BINDING = create("socket-binding", STRING)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6425.java