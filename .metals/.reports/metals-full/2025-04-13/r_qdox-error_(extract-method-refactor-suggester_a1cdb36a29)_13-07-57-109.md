error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1499.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1499.java
text:
```scala
F@@ileSystem fs = FileSystem.get(weightsFile.get().toUri(), jobConf);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1499.java