error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10463.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10463.java
text:
```scala
static final A@@ttributeDefinition[] ATTRIBUTES = {OUTBOUND_SOCKET_BINDING_REF, SSL, TLS, USERNAME, PASSWORD};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10463.java