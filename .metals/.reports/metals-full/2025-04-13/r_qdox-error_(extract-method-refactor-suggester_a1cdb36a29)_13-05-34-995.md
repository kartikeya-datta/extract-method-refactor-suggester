error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4652.java
text:
```scala
R@@outingAllocation.Result routingResult = allocationService.reroute(currentState, request.commands, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4652.java