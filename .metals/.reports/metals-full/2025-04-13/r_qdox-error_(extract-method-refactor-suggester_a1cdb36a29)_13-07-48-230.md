error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15950.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15950.java
text:
```scala
private final I@@CryptFactory delegate;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15950.java