error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15929.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15929.java
text:
```scala
private final C@@omponent anchor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15929.java