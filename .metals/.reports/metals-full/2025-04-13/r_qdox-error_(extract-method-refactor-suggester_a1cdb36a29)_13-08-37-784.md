error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1382.java
text:
```scala
G@@dxTest test = new TideMapDirectLoaderTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1382.java