error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13785.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13785.java
text:
```scala
private static final A@@ttributeDefinition[] ATTRIBUTES = {CODE, TYPE, LoginModuleResourceDefinition.MODULE, MODULE_OPTIONS};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13785.java