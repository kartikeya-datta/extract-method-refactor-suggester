error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7280.java
text:
```scala
l@@ist.add( Double.valueOf(one));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7280.java