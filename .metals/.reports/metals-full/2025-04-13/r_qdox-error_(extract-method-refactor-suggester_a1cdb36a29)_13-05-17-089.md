error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6851.java
text:
```scala
s@@etBackground(background, background != null); // Keep padding from last background if new background is null.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6851.java