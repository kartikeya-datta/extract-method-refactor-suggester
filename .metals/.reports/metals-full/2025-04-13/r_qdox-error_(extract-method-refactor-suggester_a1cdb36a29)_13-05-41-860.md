error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15999.java
text:
```scala
i@@f (((FormComponent<?>)component).getForm().getModel() == model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15999.java