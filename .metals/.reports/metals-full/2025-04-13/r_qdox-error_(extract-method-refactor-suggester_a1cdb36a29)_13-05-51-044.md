error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10658.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10658.java
text:
```scala
public v@@oid testCumulativeProbabilityAgainstStackOverflow() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10658.java