error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2857.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2857.java
text:
```scala
i@@f (verbose) System.out.println("replica:" + shard.getValue().getName() + " rstate:"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2857.java