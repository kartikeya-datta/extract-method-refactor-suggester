error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7848.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7848.java
text:
```scala
final c@@har[] source = Util.getResourceContentsAsCharArray(file);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7848.java