error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8231.java
text:
```scala
i@@f (bm.bmBitsPixel == 32 && OS.COMCTL32_MAJOR >= 6) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8231.java