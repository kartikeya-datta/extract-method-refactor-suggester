error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9651.java
text:
```scala
l@@istItem.add(new Label("row", Integer.toString(listItem.getIndex() + 1)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9651.java