error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14150.java
text:
```scala
r@@eturn new CoarseSessionCacheEntry<>(this.externalizer.readObject(input));
...
public class CoarseSessionCacheEntryExternalizer extends AbstractSimpleExternalizer<CoarseSessionCacheEntry<Object>> {
    ...
    public CoarseSessionCacheEntry<Object> readObject(ObjectInput input) throws IOException, ClassNotFoundException {
        return new CoarseSessionCacheEntry<Object>(this.externalizer.readObject(input));
    }
}
```
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14150.java