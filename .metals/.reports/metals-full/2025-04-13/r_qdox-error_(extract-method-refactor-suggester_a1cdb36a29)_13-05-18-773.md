error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6050.java
text:
```scala
s@@t.open();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6050.java