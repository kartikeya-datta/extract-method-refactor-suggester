error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12150.java
text:
```scala
s@@uper(params, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12150.java