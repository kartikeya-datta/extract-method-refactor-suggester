error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5776.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5776.java
text:
```scala
p@@ublic static class ClientPropertiesBean implements Serializable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5776.java