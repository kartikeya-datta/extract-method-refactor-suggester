error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1414.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1414.java
text:
```scala
public static T@@ypeDeclaration buildTypeDeclaration(IType type, CompilationUnitDeclaration compilationUnit, CompilationResult compilationResult)  throws JavaModelException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1414.java