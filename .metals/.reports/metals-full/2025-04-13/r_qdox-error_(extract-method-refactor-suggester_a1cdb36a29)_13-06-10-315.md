error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/238.java
text:
```scala
R@@OOT_LOGGER.debug(this.getComponentName() + " bean is a @Startup (a.k.a init-on-startup) bean, creating/getting the singleton instance");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/238.java