error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3389.java
text:
```scala
d@@efaultOptionsMap.put(JavaCore.CODEASSIST_TIMEOUT_FOR_PARAMETER_NAME_FROM_ATTACHED_JAVADOC, "50"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3389.java