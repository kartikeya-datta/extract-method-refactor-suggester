error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13444.java
text:
```scala
s@@uper(streamId, allOutputFields);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13444.java