error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/772.java
text:
```scala
r@@eturn initIndex(random, newMockDirectory(random), initialCommit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/772.java