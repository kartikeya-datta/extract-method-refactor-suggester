error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5073.java
text:
```scala
i@@nt numberOfUpdates = childIdToParentId.isEmpty() ? 0 : scaledRandomIntBetween(1, 25);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5073.java