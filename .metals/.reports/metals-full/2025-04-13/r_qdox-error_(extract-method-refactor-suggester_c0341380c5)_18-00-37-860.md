error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18290.java
text:
```scala
D@@iffUtil.validatePage(headerContribution, this.getClass(), expectedFile,true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18290.java