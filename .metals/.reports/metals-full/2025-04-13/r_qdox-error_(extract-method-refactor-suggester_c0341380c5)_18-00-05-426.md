error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6216.java
text:
```scala
O@@bject target = JavaModel.getTarget(path, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6216.java