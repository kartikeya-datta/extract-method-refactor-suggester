error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7520.java
text:
```scala
i@@f (lastType == TypeBinding.NULL
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7520.java