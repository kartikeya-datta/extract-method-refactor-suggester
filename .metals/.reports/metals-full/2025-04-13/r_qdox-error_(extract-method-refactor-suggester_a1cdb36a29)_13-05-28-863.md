error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12379.java
text:
```scala
a@@dd(css);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12379.java