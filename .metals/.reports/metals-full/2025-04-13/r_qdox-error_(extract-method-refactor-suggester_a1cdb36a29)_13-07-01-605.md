error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/63.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/63.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/63.java
text:
```scala
I@@PackageFragmentRoot[] roots = project.getAllPackageFragmentRoots();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/63.java