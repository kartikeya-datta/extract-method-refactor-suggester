error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2596.java
text:
```scala
n@@ew Object[] { new Double(abscissa), new Integer(i1), new Integer(i2) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2596.java