error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5653.java
text:
```scala
h@@olderToNotify.handler().handleException(new NodeDisconnectedException(node, holderToNotify.action()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5653.java