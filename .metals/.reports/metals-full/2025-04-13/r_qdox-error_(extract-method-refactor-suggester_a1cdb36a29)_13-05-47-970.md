error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8230.java
text:
```scala
b@@undle.start(Bundle.START_TRANSIENT | Bundle.START_ACTIVATION_POLICY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8230.java