error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1880.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1880.java
text:
```scala
i@@f (currentMethod.declaringClass == type && currentMethod.sourceMethod() != null)	// only report against the currentMethod if its implemented by the type
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1880.java