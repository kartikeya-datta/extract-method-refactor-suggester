error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7237.java
text:
```scala
i@@f (!rootResource.exists() || !rootResource.isAccessible())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7237.java