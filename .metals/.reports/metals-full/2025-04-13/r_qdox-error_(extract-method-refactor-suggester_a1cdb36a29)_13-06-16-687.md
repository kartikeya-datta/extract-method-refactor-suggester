error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2470.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2470.java
text:
```scala
final C@@onstructor<?>[] cons = CharSetUtils.class.getDeclaredConstructors();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2470.java