error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3110.java
text:
```scala
S@@tring cluster = "server";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3110.java