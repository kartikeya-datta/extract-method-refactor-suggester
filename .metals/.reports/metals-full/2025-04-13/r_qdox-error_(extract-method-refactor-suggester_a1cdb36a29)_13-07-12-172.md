error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7210.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7210.java
text:
```scala
t@@hrow new IOException("Parse error: invalid type '" + s + "'");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7210.java