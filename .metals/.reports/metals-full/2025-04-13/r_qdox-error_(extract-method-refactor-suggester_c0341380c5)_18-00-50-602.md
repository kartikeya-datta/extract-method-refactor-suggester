error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5794.java
text:
```scala
a@@vatarHelper.bind(assigneeAvatar, assignee);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5794.java