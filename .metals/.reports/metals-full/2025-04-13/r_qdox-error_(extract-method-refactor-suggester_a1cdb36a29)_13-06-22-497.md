error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6958.java
text:
```scala
r@@eturn "bound_address[" + boundAddress + "], publish_address[" + publishAddress + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6958.java