error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13455.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13455.java
text:
```scala
protected S@@tring getKeyForMethod(String beanName, Method method) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13455.java