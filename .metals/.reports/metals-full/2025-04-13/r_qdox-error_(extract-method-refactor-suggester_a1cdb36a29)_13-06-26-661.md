error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7290.java
text:
```scala
r@@eturn Integer.valueOf(getOptionsFromCoder(coder));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7290.java