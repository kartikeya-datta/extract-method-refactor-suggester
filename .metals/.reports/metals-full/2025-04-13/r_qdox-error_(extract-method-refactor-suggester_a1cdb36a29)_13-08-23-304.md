error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7351.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7351.java
text:
```scala
public S@@tring getPageRelativePath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7351.java