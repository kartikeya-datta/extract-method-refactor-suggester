error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7390.java
text:
```scala
L@@ist<ContextDocIdSet> nestedEntries = new ArrayList<>(docSets.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7390.java