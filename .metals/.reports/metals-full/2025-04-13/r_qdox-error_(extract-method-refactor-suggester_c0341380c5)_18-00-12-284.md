error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8061.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8061.java
text:
```scala
private final i@@nt  fType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8061.java