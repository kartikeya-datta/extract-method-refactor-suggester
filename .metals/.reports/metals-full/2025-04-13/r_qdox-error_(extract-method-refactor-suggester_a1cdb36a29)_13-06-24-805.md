error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7473.java
text:
```scala
m@@yBorder.addToBorderBody(panel1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7473.java