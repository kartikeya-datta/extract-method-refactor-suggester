error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11198.java
text:
```scala
p@@ublic class AdminInternalPage extends BasePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11198.java