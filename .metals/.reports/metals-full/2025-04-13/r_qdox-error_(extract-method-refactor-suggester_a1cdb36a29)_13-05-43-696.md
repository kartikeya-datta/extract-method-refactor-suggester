error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12645.java
text:
```scala
_@@coordinatorState.cleanupBefore(tx.getTransactionId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12645.java