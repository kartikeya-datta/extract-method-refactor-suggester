error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/557.java
text:
```scala
i@@f (serial != Integer.parseInt(expected)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/557.java