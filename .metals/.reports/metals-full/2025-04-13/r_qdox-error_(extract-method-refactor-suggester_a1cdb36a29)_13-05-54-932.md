error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1592.java
text:
```scala
s@@ound = Gdx.audio.newSound(Gdx.files.getFileHandle("data/shot.ogg", FileType.Internal));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1592.java