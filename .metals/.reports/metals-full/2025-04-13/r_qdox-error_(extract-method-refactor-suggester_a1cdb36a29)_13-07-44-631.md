error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3829.java
text:
```scala
V@@iewFactory.extractPrimaryId(viewId));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3829.java