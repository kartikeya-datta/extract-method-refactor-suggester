error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14547.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14547.java
text:
```scala
public static v@@oid expectHeader(final byte actual, int expected) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14547.java