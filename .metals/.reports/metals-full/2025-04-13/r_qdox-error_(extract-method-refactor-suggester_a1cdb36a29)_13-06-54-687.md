error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3378.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3378.java
text:
```scala
protected D@@ataConfig.Entity entity;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3378.java