error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12059.java
text:
```scala
R@@equestCycle.get().replaceAllRequestHandlers(new RedirectRequestHandler(url));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12059.java