error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3542.java
text:
```scala
p@@osincAtt = addAttribute(PositionIncrementAttribute.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3542.java