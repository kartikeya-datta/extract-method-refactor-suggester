error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1676.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1676.java
text:
```scala
t@@docs = _TestUtil.docs(random, tenum, MultiFields.getLiveDocs(reader), tdocs, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1676.java