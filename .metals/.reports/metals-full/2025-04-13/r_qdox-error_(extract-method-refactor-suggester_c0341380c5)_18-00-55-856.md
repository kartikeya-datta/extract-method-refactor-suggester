error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10653.java
...
```java
offset: 1060
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10653.java
text:
```scala
...
*/
p@@ackage org.jboss.as.core.model.test;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10653.java