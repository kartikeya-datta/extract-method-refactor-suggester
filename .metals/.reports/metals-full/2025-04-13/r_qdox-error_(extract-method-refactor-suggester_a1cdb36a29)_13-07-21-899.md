error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5521.java
text:
```scala
Q@@uery query = mapper.fuzzyQuery(term.text(), fuzziness, fuzzyPrefixLength, maxExpansions, transpositions);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5521.java