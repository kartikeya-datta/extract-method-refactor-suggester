error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6788.java
text:
```scala
V@@ertexBufferObjectTest.class, VertexArrayClassTest.class, VertexBufferObjectClassTest.class, LetterBoxTest2.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6788.java