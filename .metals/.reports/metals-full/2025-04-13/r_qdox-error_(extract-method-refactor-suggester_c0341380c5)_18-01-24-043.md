error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3650.java
text:
```scala
t@@his.serverOpenChannels = new OpenChannelsHandler(logger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3650.java