error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3900.java
text:
```scala
t@@hrow new RuntimeException("Management operation: " + op + " was not succesful. Result was: " + modelNodeResult);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3900.java