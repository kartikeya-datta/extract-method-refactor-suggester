error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11233.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11233.java
text:
```scala
public static B@@undleInfo getBundleInfo(final DeploymentUnit context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11233.java