error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5479.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5479.java
text:
```scala
public static final A@@ttachmentKey<Dependencies> KEY = new AttachmentKey<Dependencies>(Dependencies.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5479.java