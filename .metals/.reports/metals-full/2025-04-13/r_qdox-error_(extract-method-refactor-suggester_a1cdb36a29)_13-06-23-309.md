error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17885.java
text:
```scala
i@@f (drawCount == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17885.java