error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5543.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5543.java
text:
```scala
private static final P@@assivationStoreRemove REMOVE = new PassivationStoreRemove(ADD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5543.java