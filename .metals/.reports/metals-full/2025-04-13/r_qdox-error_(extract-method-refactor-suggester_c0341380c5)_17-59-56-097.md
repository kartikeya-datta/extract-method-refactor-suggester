error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7928.java
text:
```scala
C@@ompilationUnit copy = (CompilationUnit)getCompilationUnit();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7928.java