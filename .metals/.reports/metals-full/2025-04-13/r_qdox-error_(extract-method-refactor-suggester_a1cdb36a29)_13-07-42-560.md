error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1657.java
text:
```scala
s@@etText(WorkbenchMessages.EditorPane_pinEditor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1657.java