error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2460.java
text:
```scala
u@@nicastZenPing.addHostsProvider(new AwsEc2UnicastHostsProvider(settings, transportService, ec2Service.client()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2460.java