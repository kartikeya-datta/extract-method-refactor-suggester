error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14496.java
text:
```scala
S@@tringBuilder lined = new StringBuilder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14496.java