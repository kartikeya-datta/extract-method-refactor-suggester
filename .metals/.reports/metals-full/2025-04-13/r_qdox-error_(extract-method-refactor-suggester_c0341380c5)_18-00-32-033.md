error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9802.java
text:
```scala
I@@ntermediateStatefulInterface cmtBean;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9802.java