error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1097.java
text:
```scala
r@@enderer.begin(ShapeType.Line);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1097.java