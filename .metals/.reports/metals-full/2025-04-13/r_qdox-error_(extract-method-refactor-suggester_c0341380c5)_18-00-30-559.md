error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2905.java
text:
```scala
r@@eturn (fProblems.length == 0 ? "" : "*") + "ConvertedCompilationResult(" + fPackageElement + ")"; //$NON-NLS-1$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-4$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2905.java