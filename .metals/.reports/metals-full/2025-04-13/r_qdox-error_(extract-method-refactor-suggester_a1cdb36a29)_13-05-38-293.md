error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3018.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3018.java
text:
```scala
i@@f(!isInsideAnnotationAttribute &&
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3018.java