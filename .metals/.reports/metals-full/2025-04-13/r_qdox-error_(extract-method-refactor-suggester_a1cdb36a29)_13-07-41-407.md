error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12964.java
text:
```scala
W@@ebSocketSession doHandshake(WebSocketHandler webSocketHandler, HttpHeaders headers, URI uri)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12964.java