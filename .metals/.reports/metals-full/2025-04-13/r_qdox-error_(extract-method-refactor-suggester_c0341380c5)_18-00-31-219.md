error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11185.java
text:
```scala
p@@ublic class Clock extends Label
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11185.java