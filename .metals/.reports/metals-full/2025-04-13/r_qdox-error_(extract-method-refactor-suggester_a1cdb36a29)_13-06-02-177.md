error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8312.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8312.java
text:
```scala
abstract public S@@et<String> getActionNames();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8312.java