error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3822.java
text:
```scala
c@@ontainer = getContainerFactory().createContainer(Generic.CONSUMER_CONTAINER_TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3822.java