error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1446.java
text:
```scala
b@@uilder.field("must_not");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1446.java