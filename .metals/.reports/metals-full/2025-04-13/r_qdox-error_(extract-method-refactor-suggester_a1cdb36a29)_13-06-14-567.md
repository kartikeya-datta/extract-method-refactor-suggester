error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3385.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3385.java
text:
```scala
c@@onfig.setHA(HA.resolveModelAttribute(context, operation).asBoolean());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3385.java