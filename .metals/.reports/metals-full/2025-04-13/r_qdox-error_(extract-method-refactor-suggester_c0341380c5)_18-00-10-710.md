error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3297.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3297.java
text:
```scala
public F@@ont font;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3297.java