error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3917.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3917.java
text:
```scala
public H@@ighlitableDataItem(final MarkupContainer parent, final String id, final int index, final IModel model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3917.java