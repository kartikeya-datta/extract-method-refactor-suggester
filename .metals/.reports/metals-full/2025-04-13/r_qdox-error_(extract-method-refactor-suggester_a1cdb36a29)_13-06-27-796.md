error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4328.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[250,2]

error in qdox parser
file content:
```java
offset: 8825
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4328.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4328.java