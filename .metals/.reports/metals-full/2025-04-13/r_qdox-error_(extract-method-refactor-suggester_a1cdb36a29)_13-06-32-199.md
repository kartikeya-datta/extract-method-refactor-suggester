error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12758.java
text:
```scala
i@@f (event instanceof IContainerConnectedEvent || event instanceof IContainerDisconnectedEvent || event instanceof IContainerEjectedEvent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12758.java