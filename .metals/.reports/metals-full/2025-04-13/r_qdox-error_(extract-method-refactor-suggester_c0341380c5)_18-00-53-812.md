error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17595.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[157,80]

error in qdox parser
file content:
```java
offset: 5416
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17595.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17595.java