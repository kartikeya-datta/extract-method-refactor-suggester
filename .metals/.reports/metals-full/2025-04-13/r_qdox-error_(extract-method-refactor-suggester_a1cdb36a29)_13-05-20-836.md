error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5362.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5362.java
text:
```scala
i@@nt width = (int)(0.5f + size.width);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5362.java