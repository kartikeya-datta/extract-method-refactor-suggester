error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4791.java
text:
```scala
s@@cope.problemReporter().unsafeRawInvocation(this, this.binding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4791.java