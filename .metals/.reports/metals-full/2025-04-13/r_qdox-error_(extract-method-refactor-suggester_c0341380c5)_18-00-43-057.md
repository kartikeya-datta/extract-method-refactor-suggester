error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10319.java
text:
```scala
r@@eturn OS.noErr;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10319.java