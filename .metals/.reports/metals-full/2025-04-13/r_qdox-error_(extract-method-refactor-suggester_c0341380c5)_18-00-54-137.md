error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9906.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9906.java
text:
```scala
t@@ype = array.getClass().getComponentType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9906.java