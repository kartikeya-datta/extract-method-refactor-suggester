error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8730.java
text:
```scala
r@@eturn secretCallbackFactory.getOptionalValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8730.java