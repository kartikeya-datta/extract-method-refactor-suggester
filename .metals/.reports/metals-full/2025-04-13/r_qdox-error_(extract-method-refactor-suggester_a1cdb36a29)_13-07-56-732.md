error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9995.java
text:
```scala
b@@ytes.write(buffer, 0, readBytes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9995.java