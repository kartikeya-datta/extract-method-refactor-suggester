error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18336.java
text:
```scala
h@@elperTask.createArg().setValue( arg );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18336.java