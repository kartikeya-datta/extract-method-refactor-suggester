error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6129.java
text:
```scala
s@@earchPath = new Path( getProject() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6129.java