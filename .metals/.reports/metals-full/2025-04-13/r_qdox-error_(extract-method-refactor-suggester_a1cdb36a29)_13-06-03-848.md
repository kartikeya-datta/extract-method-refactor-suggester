error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6949.java
text:
```scala
l@@ogger.debug("Using [keep_only_last] deletion policy");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6949.java