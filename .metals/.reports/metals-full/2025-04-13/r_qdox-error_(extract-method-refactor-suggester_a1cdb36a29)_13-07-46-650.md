error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3940.java
text:
```scala
n@@ew ISourceType[]{sourceType},
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3940.java