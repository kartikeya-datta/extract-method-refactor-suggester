error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3836.java
text:
```scala
i@@f (((ClassScope) scope).detectHierarchyCycle(this.resolvedType, this, null))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3836.java