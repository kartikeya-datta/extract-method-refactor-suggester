error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7805.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7805.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7805.java
text:
```scala
c@@omparator = SizeFileComparator.SIZE_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7805.java