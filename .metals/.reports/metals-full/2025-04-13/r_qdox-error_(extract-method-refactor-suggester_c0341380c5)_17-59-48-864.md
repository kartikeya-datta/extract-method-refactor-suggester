error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11279.java
text:
```scala
p@@ublic abstract class AjaxFallbackOrderByBorder extends Border
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11279.java