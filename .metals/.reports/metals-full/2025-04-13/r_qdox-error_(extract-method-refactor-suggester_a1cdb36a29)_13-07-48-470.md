error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6697.java
text:
```scala
b@@uilder.startObject(indexStats.index(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6697.java