error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5739.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5739.java
text:
```scala
private T@@imeValue timeout = timeValueSeconds(60);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5739.java