error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10349.java
text:
```scala
i@@f (!stateValues.getRoleFiles().isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10349.java