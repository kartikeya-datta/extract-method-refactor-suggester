error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8077.java
text:
```scala
i@@f (("/" + host.getDefaultWebapp()).equals(context.getPath())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8077.java