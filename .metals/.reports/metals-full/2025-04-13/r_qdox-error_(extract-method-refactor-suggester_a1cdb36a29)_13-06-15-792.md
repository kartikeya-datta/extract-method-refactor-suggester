error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4135.java
text:
```scala
l@@oad.invoke(properties, reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4135.java