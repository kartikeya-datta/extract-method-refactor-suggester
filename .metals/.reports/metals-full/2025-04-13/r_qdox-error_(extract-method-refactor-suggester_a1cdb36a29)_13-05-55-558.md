error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5281.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5281.java
text:
```scala
public static R@@equest classes(String collectionName, Class<?>... classes) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5281.java