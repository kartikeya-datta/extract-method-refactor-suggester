error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/950.java
text:
```scala
r@@eturn BytesRef.deepCopyOf(current);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/950.java