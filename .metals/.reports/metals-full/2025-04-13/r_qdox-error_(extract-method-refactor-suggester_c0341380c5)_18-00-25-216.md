error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2241.java
text:
```scala
i@@nt /*long*/ hPen = OS.CreatePen (OS.PS_SOLID, 1, parent.getForegroundPixel ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2241.java