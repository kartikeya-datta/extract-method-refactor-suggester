error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4314.java
text:
```scala
i@@f (currentCompatibleType.id == T_JavaLangObject) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4314.java