error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11515.java
text:
```scala
r@@eplaceComponentTagBody(markupStream, openTag, getDefaultModelObjectAsString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11515.java