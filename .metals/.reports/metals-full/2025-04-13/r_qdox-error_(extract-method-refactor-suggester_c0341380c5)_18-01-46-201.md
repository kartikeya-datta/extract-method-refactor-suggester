error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16784.java
text:
```scala
S@@tringBuilder b = new StringBuilder("-- TREE MODEL --\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16784.java