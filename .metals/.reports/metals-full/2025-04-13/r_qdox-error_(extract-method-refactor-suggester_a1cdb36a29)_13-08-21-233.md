error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8425.java
text:
```scala
c@@odeComplete(cu, cu, offset, requestor, owner, null/*extended context isn't computed*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8425.java