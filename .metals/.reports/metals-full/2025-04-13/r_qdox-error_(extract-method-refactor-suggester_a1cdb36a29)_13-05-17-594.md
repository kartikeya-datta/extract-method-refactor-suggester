error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5780.java
text:
```scala
r@@esourceRegistration.registerSubModel(new SensitivityClassificationTypeResourceDefinition());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5780.java