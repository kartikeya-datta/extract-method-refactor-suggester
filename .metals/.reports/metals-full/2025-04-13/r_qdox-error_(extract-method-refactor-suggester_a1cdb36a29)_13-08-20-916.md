error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7281.java
text:
```scala
c@@alendarFrame.getCalendarView().viewToday();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7281.java