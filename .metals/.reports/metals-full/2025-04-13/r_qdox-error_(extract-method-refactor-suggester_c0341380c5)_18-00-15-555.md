error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3511.java
text:
```scala
i@@f (this.type == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3511.java