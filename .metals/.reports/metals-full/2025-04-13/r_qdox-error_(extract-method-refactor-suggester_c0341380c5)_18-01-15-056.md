error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5050.java
text:
```scala
m@@esh = ModelLoader.loadObj(Gdx.files.readFile("data/cube.obj", FileType.Internal));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5050.java