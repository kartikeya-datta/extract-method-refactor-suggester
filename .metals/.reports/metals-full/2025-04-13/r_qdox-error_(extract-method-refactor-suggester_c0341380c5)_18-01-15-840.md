error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5785.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5785.java
text:
```scala
private static P@@atternFormatter format = new PatternFormatter("%{time:MM/dd/yyyy h:mm:ss a} %{priority} - %{category}: %{message}\n%{throwable}\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5785.java