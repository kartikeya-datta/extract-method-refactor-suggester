error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5180.java
text:
```scala
c@@omponentInfo.getBehaviorId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5180.java