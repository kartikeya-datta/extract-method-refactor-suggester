error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13375.java
text:
```scala
i@@tem.updateCheck ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13375.java