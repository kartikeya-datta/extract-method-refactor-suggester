error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10643.java
text:
```scala
p@@haseContext.getDeploymentUnit().putAttachment(ModuleContextConfig.ATTACHMENT_KEY, new ModuleContextConfig(moduleContextServiceName, moduleContextJndiName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10643.java