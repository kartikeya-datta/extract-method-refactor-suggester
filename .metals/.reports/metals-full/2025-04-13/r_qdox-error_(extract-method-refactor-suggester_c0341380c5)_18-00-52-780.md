error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3365.java
text:
```scala
r@@eturn new Vector3(origin).add(direction.tmp().scl(distance));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3365.java