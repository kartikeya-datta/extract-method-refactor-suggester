error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2334.java
text:
```scala
r@@pcaddrs.add(DatabaseDescriptor.getRpcAddress().getHostAddress());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2334.java