error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14227.java
text:
```scala
S@@erviceName SERVICE_NAME = ServiceName.JBOSS.append("deployment", "chain");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14227.java