error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10941.java
text:
```scala
S@@tringBuilder buf = new StringBuilder(25 + msg.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10941.java