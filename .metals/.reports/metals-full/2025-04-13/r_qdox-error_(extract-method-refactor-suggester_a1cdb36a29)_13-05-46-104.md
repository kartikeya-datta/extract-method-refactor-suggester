error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2670.java
text:
```scala
b@@oolean enabled = factory.addDeploymentDependencies(deploymentServiceName, deploymentUnit.getServiceRegistry(), serviceTarget, factoryBuilder, metaData);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2670.java