error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6504.java
text:
```scala
r@@eturn new IOSFileHandle(new File(internalPath, path), FileType.Internal);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6504.java