error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3681.java
text:
```scala
i@@f ((parent.style & SWT.VIRTUAL) == 0 && !item.cached && !parent.painted) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3681.java