error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/875.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/875.java
text:
```scala
i@@f (cf == null || cf.getColumnNames().size() == 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/875.java