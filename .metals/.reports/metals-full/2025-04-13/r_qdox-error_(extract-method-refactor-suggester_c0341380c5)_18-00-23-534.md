error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15016.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15016.java
text:
```scala
private final C@@oncurrentMap<String, Future<Subject>> subjects
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15016.java