error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9142.java
text:
```scala
s@@cope.problemReporter().typeMismatchError(expressionType, methodType, this.expression, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9142.java