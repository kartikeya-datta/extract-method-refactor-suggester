error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5616.java
text:
```scala
a@@vatar = (ImageView) view.findViewById(id.iv_avatar);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5616.java