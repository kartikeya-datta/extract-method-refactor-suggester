error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3218.java
text:
```scala
f@@ilter = new TermFilter(new Term(TypeFieldMapper.NAME, type));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3218.java