error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1142.java
text:
```scala
c@@ontext.getCounter("NaiveBayes", "Skipped instance: not in label list").increment(1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1142.java