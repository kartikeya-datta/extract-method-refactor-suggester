error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8752.java
text:
```scala
r@@eturn builder.addService(LoggingSubsystemElement.JBOSS_LOGGING.append("logger", "root"), new LoggerLevelService(""));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8752.java