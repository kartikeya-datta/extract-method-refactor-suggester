error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3432.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3432.java
text:
```scala
public static final P@@arameterValidator VALIDATOR = new EnumValidator<ConnectionFactoryType>(ConnectionFactoryType.class, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3432.java