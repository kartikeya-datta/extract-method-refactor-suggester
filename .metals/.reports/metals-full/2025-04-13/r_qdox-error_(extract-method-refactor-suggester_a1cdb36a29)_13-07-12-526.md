error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12552.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,57]

error in qdox parser
file content:
```java
offset: 57
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12552.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12552.java