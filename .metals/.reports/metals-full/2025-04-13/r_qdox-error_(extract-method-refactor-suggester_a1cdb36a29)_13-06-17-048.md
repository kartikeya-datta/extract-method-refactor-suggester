error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6441.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6441.java
text:
```scala
public final l@@ong ramBytesUsed() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6441.java