error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9437.java
text:
```scala
i@@nt MAJOR_VERSION_1_5 = 49; // TODO : (olivier) 1.5. major version value need to be confirmed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9437.java