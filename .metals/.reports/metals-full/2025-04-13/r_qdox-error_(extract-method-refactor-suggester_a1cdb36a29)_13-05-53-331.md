error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11725.java
text:
```scala
i@@f (defaultValue != null && defaultValue.isDefined()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11725.java