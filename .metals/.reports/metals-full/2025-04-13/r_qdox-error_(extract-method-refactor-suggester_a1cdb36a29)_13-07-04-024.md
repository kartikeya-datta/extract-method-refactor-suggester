error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18026.java
text:
```scala
i@@f (nsEvent.clickCount() == 1 && (control.state & Widget.DRAG_DETECT) != 0 && control.hooks (SWT.DragDetect) && control.dragDetect()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18026.java