error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3541.java
text:
```scala
H@@elpViewer.create(docURL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3541.java