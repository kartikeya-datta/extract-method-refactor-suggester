error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2413.java
text:
```scala
v@@isitor.endVisit(this, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2413.java