error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15185.java
text:
```scala
c@@onfiguration.addClientInterceptor(method, StatefulIdentityInterceptor.FACTORY, InterceptorOrder.Client.EJB_EQUALS_HASHCODE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15185.java