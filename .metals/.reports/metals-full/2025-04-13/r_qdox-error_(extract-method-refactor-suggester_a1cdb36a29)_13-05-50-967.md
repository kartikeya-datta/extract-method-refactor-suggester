error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7553.java
text:
```scala
b@@uildFileForReadableName(READABLE_NAMES_FILE+".properties", newLhs, newNonTerminalIndex, newName, tokens);//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7553.java