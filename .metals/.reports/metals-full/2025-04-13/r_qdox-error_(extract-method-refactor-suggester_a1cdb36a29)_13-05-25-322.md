error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15005.java
text:
```scala
t@@hrow new UnsupportedOperationException("remove() method not supported for a NodeListIterator.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15005.java