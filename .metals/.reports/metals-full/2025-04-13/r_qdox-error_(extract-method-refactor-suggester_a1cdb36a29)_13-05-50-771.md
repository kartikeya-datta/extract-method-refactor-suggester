error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7995.java
text:
```scala
r@@eturn context.getBean(viewName, View.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7995.java