error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1350.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1350.java
text:
```scala
static final S@@tring VERSION = "1.9.20031130";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1350.java