error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9929.java
text:
```scala
r@@eturn nodePrefix.matcher(t.getName()).find() || true; // TODO disabled for now
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9929.java