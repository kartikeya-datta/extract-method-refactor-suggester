error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1639.java
text:
```scala
M@@essage message = new Message(StorageService.getLocalStorageEndPoint(), MessagingService.responseStage_, MessagingService.responseVerbHandler_, bos.toByteArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1639.java