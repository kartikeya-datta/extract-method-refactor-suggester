error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11208.java
text:
```scala
M@@ockito.when(serviceRegistry.getService(SubsystemState.SERVICE_NAME)).thenReturn(serviceController);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11208.java