error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9087.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9087.java
text:
```scala
public v@@oid processBatch(List<SampleEvent> samples) throws RemoteException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9087.java