error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5878.java
text:
```scala
s@@ource = "package " + pkg.getElementName() + ";"  + JavaModelManager.LINE_SEPARATOR + JavaModelManager.LINE_SEPARATOR; //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5878.java