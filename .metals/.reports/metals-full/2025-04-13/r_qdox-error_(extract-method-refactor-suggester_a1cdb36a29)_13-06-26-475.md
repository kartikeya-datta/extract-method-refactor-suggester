error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5328.java
text:
```scala
r@@eturn OptionConverter.toPriority(v, Priority.DEBUG);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5328.java