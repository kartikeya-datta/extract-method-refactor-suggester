error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4256.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4256.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4256.java
text:
```scala
S@@tring display = getLocalizer().getString(displayValue, this, displayValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4256.java