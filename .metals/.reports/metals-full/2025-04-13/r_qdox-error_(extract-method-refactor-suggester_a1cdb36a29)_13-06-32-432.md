error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9035.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9035.java
text:
```scala
static i@@nt MINOR_VERSION = 305;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9035.java