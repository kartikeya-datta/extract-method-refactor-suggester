error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2954.java
text:
```scala
s@@uper("org.columba.core.frame", "org/columba/core/plugin/frame.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2954.java