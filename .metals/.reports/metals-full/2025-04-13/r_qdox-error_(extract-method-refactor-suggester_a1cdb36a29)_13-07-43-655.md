error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/425.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/425.java
text:
```scala
protected b@@oolean accept() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/425.java