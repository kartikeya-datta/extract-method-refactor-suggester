error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10896.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10896.java
text:
```scala
public T@@ree(String id, IModel<TreeModel> model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10896.java