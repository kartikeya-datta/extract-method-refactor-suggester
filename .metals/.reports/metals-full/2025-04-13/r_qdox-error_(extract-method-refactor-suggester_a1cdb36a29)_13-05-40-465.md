error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2602.java
text:
```scala
a@@ssertFalse("wrong type", u.equals(new Double(0)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2602.java