error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2325.java
text:
```scala
r@@eturn new LongArrayAtomicFieldData.SingleFixedSet(new long[1], 0, new FixedBitSet(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2325.java