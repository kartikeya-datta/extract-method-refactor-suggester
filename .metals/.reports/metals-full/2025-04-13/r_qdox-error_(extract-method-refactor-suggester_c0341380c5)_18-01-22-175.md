error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5153.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5153.java
text:
```scala
i@@f (!fieldType().indexed() && !fieldType().stored()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5153.java