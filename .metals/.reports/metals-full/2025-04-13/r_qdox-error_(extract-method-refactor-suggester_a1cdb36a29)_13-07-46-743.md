error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17780.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[84,80]

error in qdox parser
file content:
```java
offset: 2539
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17780.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17780.java