error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6689.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6689.java
text:
```scala
public final M@@arkupStream getMarkupStream()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6689.java