error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6926.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6926.java
text:
```scala
private i@@nt previewSize = 50;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6926.java