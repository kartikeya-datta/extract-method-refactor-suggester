error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12411.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12411.java
text:
```scala
public static A@@smHierarchyBuilder asmHierarchyBuilder = new AsmHierarchyBuilder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12411.java