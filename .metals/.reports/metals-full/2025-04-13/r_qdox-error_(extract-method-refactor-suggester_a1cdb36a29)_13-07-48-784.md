error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14750.java
text:
```scala
v@@erifyGroupMembership("TestUserSix", "passwordSix", "GroupSix", "GroupTwo");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14750.java