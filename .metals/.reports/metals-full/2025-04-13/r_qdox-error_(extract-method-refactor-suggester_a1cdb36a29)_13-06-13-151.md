error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7225.java
text:
```scala
t@@ester = new WicketTester(new WebApplication()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7225.java