error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12431.java
text:
```scala
m@@oduleSpecification.addSystemDependency(new ModuleDependency(Module.getBootModuleLoader(), JBOSS_MODULES_ID, false, false, false, false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12431.java