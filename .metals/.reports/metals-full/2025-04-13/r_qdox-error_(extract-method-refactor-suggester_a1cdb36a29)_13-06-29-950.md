error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10203.java
text:
```scala
t@@able.addCell(masterId == null ? "x" : masterId.equals(node.id()) ? "*" : node.masterNode() ? "m" : "-");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10203.java