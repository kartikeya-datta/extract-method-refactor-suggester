error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1208.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1208.java
text:
```scala
private final M@@ap services = new HashMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1208.java