error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10403.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10403.java
text:
```scala
final R@@equestListenerInterface listener = RequestListenerInterface.forName(interfaceName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10403.java