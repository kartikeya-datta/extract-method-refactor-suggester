error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8963.java
text:
```scala
i@@f (Scope.areTypesCompatible(caseTb, testTb))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8963.java