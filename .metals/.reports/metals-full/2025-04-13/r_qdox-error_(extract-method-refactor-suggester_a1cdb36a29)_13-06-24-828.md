error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1531.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1531.java
text:
```scala
private i@@nt offset;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1531.java