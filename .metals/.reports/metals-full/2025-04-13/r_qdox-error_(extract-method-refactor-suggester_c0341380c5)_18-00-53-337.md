error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11335.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11335.java
text:
```scala
private static final A@@ttributeDefinition[] ATTRIBUTES = {CODE, FLAG, LOGIN_MODULE_STACK_REF, MODULE_OPTIONS, LoginModuleResourceDefinition.MODULE};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11335.java