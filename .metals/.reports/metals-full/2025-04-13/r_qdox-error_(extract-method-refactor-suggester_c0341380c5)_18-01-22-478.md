error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5739.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5739.java
text:
```scala
public static final C@@olor COLOR_ODD_ROW = new Color(200, 200, 200);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5739.java