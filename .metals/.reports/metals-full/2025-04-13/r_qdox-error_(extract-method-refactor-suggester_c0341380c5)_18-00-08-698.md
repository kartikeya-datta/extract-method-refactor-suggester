error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2602.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2602.java
text:
```scala
public S@@tring name;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2602.java