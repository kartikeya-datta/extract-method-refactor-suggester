error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11067.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11067.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11067.java
text:
```scala
t@@race("selectConsumerContainers", "endpointDescription=" + endpointDescription); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11067.java