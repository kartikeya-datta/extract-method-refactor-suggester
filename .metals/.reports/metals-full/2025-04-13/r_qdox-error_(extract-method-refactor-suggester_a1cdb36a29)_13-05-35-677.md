error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/836.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/836.java
text:
```scala
 B@@aseTypeBinding.isWidening(fieldType.id, initializationType.id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/836.java