error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12444.java
text:
```scala
i@@f (!sessionBeanComponentDescription.getViews().isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12444.java