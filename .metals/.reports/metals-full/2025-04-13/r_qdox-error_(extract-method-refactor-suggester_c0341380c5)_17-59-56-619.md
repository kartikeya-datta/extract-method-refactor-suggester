error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9001.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9001.java
text:
```scala
i@@f (control == lastActive) setActiveControl (null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9001.java