error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9299.java
text:
```scala
S@@earchMatch match = locator.newFieldReferenceMatch(element, accuracy, reference.sourceStart, reference.sourceEnd+1, reference);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9299.java