error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2206.java
text:
```scala
l@@ogger.debug("using [log_doc] merge policy with merge_factor[{}] min_merge_docs[{}], max_merge_docs[{}], use_compound_file[{}], calibrate_size_by_deletes[{}]",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2206.java