error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9597.java
text:
```scala
i@@f (isModal && stage != null && stage.getRoot().getChildren().peek() == Dialog.this) { // Dialog is top most actor.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9597.java