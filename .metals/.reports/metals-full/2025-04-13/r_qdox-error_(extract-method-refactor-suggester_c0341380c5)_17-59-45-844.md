error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11639.java
text:
```scala
l@@ist.add(Util.getWriteAttributeOperation(address, DIRECTORY_GROUPING, HostResourceDefinition.DIRECTORY_GROUPING.parse(value,reader)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11639.java