error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1878.java
text:
```scala
i@@nt flags = OS.DT_CALCRECT | OS.DT_NOPREFIX;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1878.java