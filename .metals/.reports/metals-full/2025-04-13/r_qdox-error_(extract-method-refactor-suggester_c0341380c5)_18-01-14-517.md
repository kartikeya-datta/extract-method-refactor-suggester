error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/112.java
text:
```scala
S@@ystemTable.setIndexRemoved(metadata.ksName, indexCfs.columnFamily);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/112.java