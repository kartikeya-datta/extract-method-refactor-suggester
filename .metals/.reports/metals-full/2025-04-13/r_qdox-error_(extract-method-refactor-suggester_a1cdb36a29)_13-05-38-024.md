error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9392.java
text:
```scala
t@@extWidths = new int [1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9392.java