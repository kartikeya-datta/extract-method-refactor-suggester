error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2254.java
text:
```scala
S@@tring cleanname = annotationType.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2254.java