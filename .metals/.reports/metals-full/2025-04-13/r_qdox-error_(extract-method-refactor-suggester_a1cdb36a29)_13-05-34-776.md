error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6006.java
text:
```scala
r@@eturn OS.objc_msgSend(this.id, OS.sel_columnAtPoint_, point);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6006.java