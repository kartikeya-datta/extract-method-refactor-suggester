error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/246.java
text:
```scala
R@@OOT_LOGGER.debug("Timer task was cancelled for " + timer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/246.java