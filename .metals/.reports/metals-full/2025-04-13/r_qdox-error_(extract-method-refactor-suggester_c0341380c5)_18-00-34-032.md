error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1019.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1019.java
text:
```scala
public static C@@lassFilter createFilter(Class<?> filteredClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1019.java