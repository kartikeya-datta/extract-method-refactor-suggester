error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7994.java
text:
```scala
O@@bject resolvedValue = (value instanceof String ? evaluate("value", value) : value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7994.java