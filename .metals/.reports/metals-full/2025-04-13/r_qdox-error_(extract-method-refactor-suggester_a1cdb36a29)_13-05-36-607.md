error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3290.java
text:
```scala
p@@rivileges = (PrivilegeNode) privileges.bind( new HashMap(), grantees);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3290.java