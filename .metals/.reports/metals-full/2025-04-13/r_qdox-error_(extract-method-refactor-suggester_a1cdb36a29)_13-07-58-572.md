error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2831.java
text:
```scala
L@@ogs.reportMessage("CSLOOK_SchemasHeader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2831.java