error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13252.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13252.java
text:
```scala
U@@ndertowLogger.ROOT_LOGGER.registeringHandler( httpHandler.getValue(), locationPath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13252.java