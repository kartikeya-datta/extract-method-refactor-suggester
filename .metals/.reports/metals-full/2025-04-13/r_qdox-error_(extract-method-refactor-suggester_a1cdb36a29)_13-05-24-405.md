error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2650.java
text:
```scala
S@@STableWriter writer = new SSTableWriter(path, sortedKeys.size(), cfs.metadata, cfs.partitioner_);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2650.java