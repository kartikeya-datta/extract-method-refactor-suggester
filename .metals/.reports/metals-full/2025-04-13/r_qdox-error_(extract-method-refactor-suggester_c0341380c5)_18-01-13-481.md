error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1250.java
text:
```scala
j@@avaBuilder.javaProject.getOption(JavaCore.CORE_JAVA_BUILD_RECREATE_MODIFIED_CLASS_FILES_IN_OUTPUT_FOLDER, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1250.java