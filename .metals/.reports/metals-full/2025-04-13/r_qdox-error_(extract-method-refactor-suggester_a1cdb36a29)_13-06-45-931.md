error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6702.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6702.java
text:
```scala
v@@oid removeAspectHandler( String name )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6702.java