error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5491.java
text:
```scala
L@@abel ajaxLabel = new Label("linja1", new PropertyModel<Integer>(this, "count"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5491.java