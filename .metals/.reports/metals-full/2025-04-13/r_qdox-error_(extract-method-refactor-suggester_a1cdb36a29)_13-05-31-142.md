error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4348.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4348.java
text:
```scala
public static final l@@ong PRIORITY = DeploymentPhases.PARSE_DESCRIPTORS.plus(500L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4348.java