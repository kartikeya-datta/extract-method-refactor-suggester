error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8217.java
text:
```scala
c@@ompilationUnitScope().recordSuperTypeReference(superType); // to record supertypes
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8217.java