error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/587.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/587.java
text:
```scala
A@@ndroid, Desktop, Applet, WebGL, iOS
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/587.java