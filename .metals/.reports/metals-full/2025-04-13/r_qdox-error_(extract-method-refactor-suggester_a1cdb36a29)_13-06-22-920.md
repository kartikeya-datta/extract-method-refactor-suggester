error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/996.java
text:
```scala
b@@uffer = new Object[size+1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/996.java