error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6078.java
text:
```scala
i@@f (ast.apiLevel >= AST.LEVEL_3_0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6078.java