error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10125.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[529,2]

error in qdox parser
file content:
```java
offset: 17497
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10125.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10125.java