error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/715.java
text:
```scala
i@@f (def.finished())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/715.java