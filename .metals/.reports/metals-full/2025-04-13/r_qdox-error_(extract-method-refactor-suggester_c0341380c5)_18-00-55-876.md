error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/148.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.PARSE, Phase.PARSE_RESOURCE_ADAPTERS, new ResourceAdaptersAttachingProcessor(resourceAdapters));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/148.java