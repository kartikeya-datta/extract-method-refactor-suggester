error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7226.java
text:
```scala
T@@estPage page = (TestPage)tester.getLastRenderedPage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7226.java