error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1990.java
text:
```scala
r@@oot = path.substring(0, next);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1990.java