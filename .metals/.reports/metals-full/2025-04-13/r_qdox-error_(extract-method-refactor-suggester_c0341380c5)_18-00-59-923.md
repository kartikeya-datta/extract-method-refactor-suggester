error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16612.java
text:
```scala
i@@nt gridWidth = parent.linesVisible && columnCount != 0 ? Tree.GRID_WIDTH : 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16612.java