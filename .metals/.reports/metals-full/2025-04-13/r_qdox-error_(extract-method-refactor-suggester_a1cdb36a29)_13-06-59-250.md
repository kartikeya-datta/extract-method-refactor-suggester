error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10081.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10081.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10081.java
text:
```scala
public v@@oid shutdown() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10081.java