error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9658.java
text:
```scala
r@@eturn "super"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9658.java