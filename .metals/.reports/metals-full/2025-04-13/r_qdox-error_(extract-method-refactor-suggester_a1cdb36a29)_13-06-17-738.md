error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3460.java
text:
```scala
r@@eturn	expression.toStringExpression() + " instanceof "/*nonNLS*/ +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3460.java