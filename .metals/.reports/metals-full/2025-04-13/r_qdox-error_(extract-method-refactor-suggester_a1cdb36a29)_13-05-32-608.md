error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6557.java
text:
```scala
i@@f(virtualFile.getLowerCaseName().endsWith(WAR_EXTENSION)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6557.java