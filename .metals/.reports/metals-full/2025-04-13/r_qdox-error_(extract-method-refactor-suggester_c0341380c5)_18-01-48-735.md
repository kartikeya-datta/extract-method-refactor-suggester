error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1981.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1981.java
text:
```scala
final S@@tring fileName = SimpleTextCodec.getPostingsFileName(state.segmentName, state.codecId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1981.java