error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10454.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10454.java
text:
```scala
private S@@ession session;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10454.java