error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4350.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4350.java
text:
```scala
public S@@erverCommunicationHandler getProcessManagerSlave(ServerEnvironment environment, MessageHandler handler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4350.java