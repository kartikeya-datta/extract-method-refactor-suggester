error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1706.java
text:
```scala
_@@state = TransactionalState.newCoordinatorState(conf, (String) conf.get(Config.TOPOLOGY_TRANSACTIONAL_ID), _spout.getComponentConfiguration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1706.java