error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6466.java
text:
```scala
s@@uper ("StaticProperty", "{builtin}StaticProperty");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6466.java