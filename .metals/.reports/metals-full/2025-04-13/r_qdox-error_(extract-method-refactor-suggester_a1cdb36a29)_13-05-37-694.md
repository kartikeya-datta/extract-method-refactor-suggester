error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3475.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3475.java
text:
```scala
private final N@@ormsFormat simpleNormsFormat = new Lucene41NormsFormat();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3475.java