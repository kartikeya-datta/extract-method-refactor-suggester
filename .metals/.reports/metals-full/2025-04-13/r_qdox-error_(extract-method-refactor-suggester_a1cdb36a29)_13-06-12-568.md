error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9465.java
text:
```scala
t@@hrow new IllegalStateException("Jndi entry '" + contextName + "' is not yet registered in context '" + context + "'", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9465.java