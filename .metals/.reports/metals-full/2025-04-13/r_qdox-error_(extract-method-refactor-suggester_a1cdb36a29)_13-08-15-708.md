error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2043.java
text:
```scala
f@@alse);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2043.java