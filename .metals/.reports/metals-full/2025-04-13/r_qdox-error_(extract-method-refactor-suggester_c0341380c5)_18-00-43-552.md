error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2516.java
text:
```scala
t@@arget.add(wmc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2516.java