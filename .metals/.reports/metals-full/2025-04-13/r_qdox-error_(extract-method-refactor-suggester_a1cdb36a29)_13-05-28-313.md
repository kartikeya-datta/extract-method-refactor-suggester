error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17697.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[75,27]

error in qdox parser
file content:
```java
offset: 1898
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17697.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17697.java