error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2059.java
text:
```scala
r@@esult[ i ] = fileSystemManager.resolveFile( context.getBaseDirectory(), element );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2059.java