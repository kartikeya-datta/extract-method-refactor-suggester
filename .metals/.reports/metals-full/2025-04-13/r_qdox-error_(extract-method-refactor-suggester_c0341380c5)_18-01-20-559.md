error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6916.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6916.java
text:
```scala
private static final i@@nt MAX_VERTICES = 2000 * 3;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6916.java