error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9729.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9729.java
text:
```scala
static final i@@nt SKIN_NEEDED = 1<<24;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9729.java