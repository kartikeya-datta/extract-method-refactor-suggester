error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8246.java
text:
```scala
S@@earchParticipant[] participants = SearchEngine.getAvailableSearchParticipants();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8246.java