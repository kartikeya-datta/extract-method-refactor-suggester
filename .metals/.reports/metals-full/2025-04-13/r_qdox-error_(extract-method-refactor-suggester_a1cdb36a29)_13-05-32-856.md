error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1524.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1524.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1524.java
text:
```scala
t@@hrow new GdxRuntimeException("Couldn't shutdown loading thread", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1524.java