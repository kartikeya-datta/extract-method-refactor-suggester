error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/134.java
text:
```scala
r@@eturn "Member type : " + new String(sourceName()) + " " + super.toString(); //$NON-NLS-2$ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/134.java