error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1462.java
text:
```scala
S@@tring sOpType = request.param("op_type");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1462.java