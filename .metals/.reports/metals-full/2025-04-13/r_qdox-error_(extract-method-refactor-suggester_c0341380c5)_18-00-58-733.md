error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17316.java
text:
```scala
p@@rivate final class AutolinkExternalLink extends ExternalLink
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17316.java