error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6285.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6285.java
text:
```scala
h@@Anchor = hInsert = hFirstIndexOf = hLastIndexOf = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6285.java