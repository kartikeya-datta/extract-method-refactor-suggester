error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2511.java
text:
```scala
s@@uite.addTest(InterruptResilienceTest.suite());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2511.java