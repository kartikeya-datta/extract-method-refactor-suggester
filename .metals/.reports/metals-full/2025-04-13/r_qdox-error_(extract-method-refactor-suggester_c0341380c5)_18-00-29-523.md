error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10248.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10248.java
text:
```scala
C@@ONFIRMATION_WINDOW_SIZE, CONNECTION_TTL, CONSUMER_MAX_RATE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10248.java