error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/131.java
text:
```scala
r@@eturn this.expressionType = scope.enclosingSourceType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/131.java