error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10201.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10201.java
text:
```scala
e@@xecutors.put(Names.SNAPSHOT, build(Names.SNAPSHOT, "scaling", groupSettings.get(Names.SNAPSHOT), settingsBuilder().put("keep_alive", "5m").put("size", 5).build()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10201.java