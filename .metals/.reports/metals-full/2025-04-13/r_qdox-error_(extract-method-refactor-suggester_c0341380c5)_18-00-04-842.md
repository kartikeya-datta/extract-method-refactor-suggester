error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3703.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3703.java
text:
```scala
public static final S@@tring RANGE = "RandomTimer.range";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3703.java