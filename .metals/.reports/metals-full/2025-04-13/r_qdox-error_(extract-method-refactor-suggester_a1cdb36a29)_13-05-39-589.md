error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13922.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13922.java
text:
```scala
private final H@@ost host = new Host(this.hostName, Collections.<String>emptyList(), "ROOT.war") {};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13922.java