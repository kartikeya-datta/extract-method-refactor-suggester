error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1777.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1777.java
text:
```scala
@Override protected C@@lusterHealthResponse masterOperation(ClusterHealthRequest request, ClusterState state) throws ElasticSearchException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1777.java