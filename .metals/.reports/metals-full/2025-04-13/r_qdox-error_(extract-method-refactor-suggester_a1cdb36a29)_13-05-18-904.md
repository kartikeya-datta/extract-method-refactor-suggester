error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7575.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7575.java
text:
```scala
public b@@oolean getStoreMapCollectionInEntityAsBlob() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7575.java