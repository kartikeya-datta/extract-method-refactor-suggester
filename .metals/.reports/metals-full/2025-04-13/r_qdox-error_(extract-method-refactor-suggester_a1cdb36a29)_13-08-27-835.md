error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3682.java
text:
```scala
r@@ecoveryStatus.index().startTime(System.currentTimeMillis());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3682.java