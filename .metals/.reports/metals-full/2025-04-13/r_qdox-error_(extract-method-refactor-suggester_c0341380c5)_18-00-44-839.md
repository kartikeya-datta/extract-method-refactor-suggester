error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13754.java
text:
```scala
t@@hrow new IllegalStateException("Invalid event method return value: " + returnValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13754.java