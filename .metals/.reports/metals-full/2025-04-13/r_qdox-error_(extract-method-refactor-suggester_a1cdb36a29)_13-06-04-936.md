error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6336.java
text:
```scala
t@@c.setCellRenderer(new BasicRenderer("columba.subject"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6336.java