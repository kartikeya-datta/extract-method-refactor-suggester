error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6355.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6355.java
text:
```scala
public v@@oid rollover() throws RolloverFailure;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6355.java