error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9203.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9203.java
text:
```scala
public v@@oid setTargetClass(Class<?> targetClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9203.java