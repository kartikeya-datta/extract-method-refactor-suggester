error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2228.java
text:
```scala
n@@f.setMaximumFractionDigits(8);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2228.java