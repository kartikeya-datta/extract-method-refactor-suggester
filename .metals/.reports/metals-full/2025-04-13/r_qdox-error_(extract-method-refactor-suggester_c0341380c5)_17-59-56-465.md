error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/26.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/26.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/26.java
text:
```scala
private static M@@ap<Thread, AtomicLong> threadSleepTimes;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/26.java