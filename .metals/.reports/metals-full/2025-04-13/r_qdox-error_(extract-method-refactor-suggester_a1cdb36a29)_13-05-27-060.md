error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/467.java
text:
```scala
q@@uery = new FilteredQuery(query, parseContext.cacheFilter(childDocMapper.typeFilter(), null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/467.java