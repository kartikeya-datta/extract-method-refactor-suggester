error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8781.java
text:
```scala
e@@nterState('"', QuotesState.QUOTES_INCLUDED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8781.java