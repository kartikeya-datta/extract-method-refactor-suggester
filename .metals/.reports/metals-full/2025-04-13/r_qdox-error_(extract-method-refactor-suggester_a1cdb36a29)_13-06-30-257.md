error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13704.java
text:
```scala
S@@tring ROLE = AspectManager.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13704.java