error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6532.java
text:
```scala
r@@eturn new ArrayBuffer(length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6532.java