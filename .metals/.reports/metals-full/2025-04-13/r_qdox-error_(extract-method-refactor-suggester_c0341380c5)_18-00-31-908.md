error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7749.java
text:
```scala
a@@ssertEquals(1, t.queryForObject("select count(*) from T_TEST", Integer.class).intValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7749.java