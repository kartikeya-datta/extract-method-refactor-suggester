error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8947.java
text:
```scala
i@@f (flags.getDeleted()) result = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8947.java