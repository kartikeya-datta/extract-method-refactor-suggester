error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1547.java
...
```java
offset: 619
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1547.java
text:
```scala
...
******************************************************************************/
p@@ackage org.eclipse.ecf.tests.osgi.services.distribution;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1547.java