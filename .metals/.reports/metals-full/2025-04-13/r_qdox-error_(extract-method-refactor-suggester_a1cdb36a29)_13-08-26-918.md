error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1007.java
text:
```scala
t@@his.codegenBinding = currentScope.enclosingSourceType().getUpdatedMethodBinding(binding, (ReferenceBinding) this.qualifyingType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1007.java