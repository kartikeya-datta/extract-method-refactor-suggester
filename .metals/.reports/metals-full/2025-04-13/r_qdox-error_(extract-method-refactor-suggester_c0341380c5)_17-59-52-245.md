error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15159.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15159.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15159.java
text:
```scala
S@@ystem.out.println("command=" + command);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15159.java