error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11166.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11166.java
text:
```scala
j@@axwsDeployment.addEndpoint(new POJOEndpoint(className, null, urlPattern));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11166.java