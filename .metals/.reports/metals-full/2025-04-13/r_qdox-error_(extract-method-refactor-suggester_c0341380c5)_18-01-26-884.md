error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9276.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9276.java
text:
```scala
protected B@@inaryMember(int type, JavaElement parent, String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9276.java