error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3810.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3810.java
text:
```scala
public E@@TC1Data (int width, int height, ByteBuffer compressedData, int dataOffset) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3810.java