error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2517.java
text:
```scala
t@@hrow new RuntimeException(errorMessage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2517.java