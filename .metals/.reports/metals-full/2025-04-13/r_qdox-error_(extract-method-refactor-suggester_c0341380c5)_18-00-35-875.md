error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2197.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2197.java
text:
```scala
static public R@@andom random = new Random();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2197.java