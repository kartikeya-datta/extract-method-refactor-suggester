error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1842.java
text:
```scala
i@@f (shadowMungers.size() > 0 || typeMungers.size() > 0 || classType.isAspect()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1842.java