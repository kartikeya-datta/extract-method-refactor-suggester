error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10200.java
text:
```scala
t@@his.fields = new LinkedHashMap<String, Field>(fields.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10200.java