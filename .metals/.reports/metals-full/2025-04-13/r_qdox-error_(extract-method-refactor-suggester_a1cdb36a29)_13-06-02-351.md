error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2691.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2691.java
text:
```scala
f@@ilter = smartNameFieldMappers.mapper().fieldFilter(value, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2691.java