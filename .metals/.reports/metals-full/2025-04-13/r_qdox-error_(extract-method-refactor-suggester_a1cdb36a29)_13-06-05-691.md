error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2852.java
text:
```scala
i@@f (this.reportReferenceInfo && this.javadocParser.checkDocComment && this.javadoc != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2852.java