error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6209.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6209.java
text:
```scala
r@@eturn clusterState.routingTable().allActiveShardsGrouped(concreteIndices, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6209.java