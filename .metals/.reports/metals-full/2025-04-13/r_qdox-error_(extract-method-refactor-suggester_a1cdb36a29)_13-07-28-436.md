error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5787.java
text:
```scala
b@@oolean persistentSessions = PersistentSessionsDefinition.isEnabled(context, fullModel.get(PersistentSessionsDefinition.INSTANCE.getPathElement().getKeyValuePair()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5787.java