error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2359.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(false, VALUE), new SecurityRealmChildRemoveHandler(false, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2359.java