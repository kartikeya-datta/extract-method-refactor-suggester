error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8224.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8224.java
text:
```scala
public L@@ist<?> getNodePath() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8224.java