error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/649.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/649.java
text:
```scala
public C@@lassCryptFactory(final Class<?> cryptClass, final String encryptionKey)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/649.java