error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14452.java
text:
```scala
R@@aConfigWriteHandler.INSTANCE, Storage.CONFIGURATION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14452.java