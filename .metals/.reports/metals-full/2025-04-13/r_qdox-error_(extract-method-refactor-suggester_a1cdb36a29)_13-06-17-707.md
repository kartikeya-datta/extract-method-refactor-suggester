error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6561.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6561.java
text:
```scala
S@@tring address = st.getString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6561.java