error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12402.java
text:
```scala
i@@f (formComponent.sameInnermostModel(Form.this))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12402.java