error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7308.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7308.java
text:
```scala
i@@f (data.stringWidth == -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7308.java