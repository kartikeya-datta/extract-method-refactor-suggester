error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8635.java
text:
```scala
X@@MLStreamReader reader = XMLInputFactory.newInstance().createXMLStreamReader(new StreamSource(url.toString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8635.java