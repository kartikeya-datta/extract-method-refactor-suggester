error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6513.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6513.java
text:
```scala
+ ":" + C@@lasses.name(component.getClass()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6513.java