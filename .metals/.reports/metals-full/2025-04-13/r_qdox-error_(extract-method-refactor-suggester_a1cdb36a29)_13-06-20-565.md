error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3603.java
...
```java
offset: 862
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3603.java
text:
```scala
 ...
 */
p@@ackage org.apache.storm.hbase.bolt.mapper;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3603.java