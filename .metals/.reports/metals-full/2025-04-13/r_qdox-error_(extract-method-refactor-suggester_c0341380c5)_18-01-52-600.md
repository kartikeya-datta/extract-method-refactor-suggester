error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7361.java
text:
```scala
K@@eyStroke.getKeyStroke(KeyEvent.VK_A, ActionEvent.CTRL_MASK | ActionEvent.SHIFT_MASK));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7361.java