error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5887.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5887.java
text:
```scala
public i@@nt /*long*/ pIDataObject;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5887.java