error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8617.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8617.java
text:
```scala
final S@@tring[] names = {"ajp", "http", "http-2", "https", "https-2", "ajps"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8617.java