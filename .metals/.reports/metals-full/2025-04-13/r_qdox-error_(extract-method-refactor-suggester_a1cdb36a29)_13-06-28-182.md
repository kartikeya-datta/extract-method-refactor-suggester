error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6388.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6388.java
text:
```scala
t@@itleCache.tint(Color.tmp.set(getColor()).mul(style.titleFontColor));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6388.java