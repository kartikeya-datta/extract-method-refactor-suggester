error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/560.java
text:
```scala
p@@ublic class StatementTriggerExecutor extends GenericTriggerExecutor
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/560.java