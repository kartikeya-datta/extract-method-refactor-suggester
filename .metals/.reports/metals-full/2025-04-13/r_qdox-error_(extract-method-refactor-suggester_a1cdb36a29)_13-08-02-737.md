error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3011.java
text:
```scala
r@@eturn Boolean.valueOf(val).booleanValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3011.java