error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4082.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4082.java
text:
```scala
final v@@oid addLink(AbstractTreeNodeLink link)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4082.java