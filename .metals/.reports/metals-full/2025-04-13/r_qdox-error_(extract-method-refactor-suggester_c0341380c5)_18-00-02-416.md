error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/507.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(INIT_ME, new ResourceAdaptersAttachingProcessor(resourceAdapters), Phase.RESOURCE_ADAPTERS_ATTACHING_PROCESSOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/507.java