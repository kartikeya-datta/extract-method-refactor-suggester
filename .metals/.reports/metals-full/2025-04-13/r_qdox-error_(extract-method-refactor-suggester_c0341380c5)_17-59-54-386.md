error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/757.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/757.java
text:
```scala
public O@@bject getValue() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/757.java