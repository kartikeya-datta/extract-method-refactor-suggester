error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8988.java
text:
```scala
c@@ountRequest.minScore(paramAsFloat(request.param("minScore"), DEFAULT_MIN_SCORE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8988.java