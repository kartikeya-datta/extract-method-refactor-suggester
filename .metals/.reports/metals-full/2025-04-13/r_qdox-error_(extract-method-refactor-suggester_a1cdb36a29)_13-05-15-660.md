error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1614.java
text:
```scala
r@@eturn "(" + (declaringType == null ? "<NO DECLARING TYPE>" : new String(declaringType)) + ")this"; //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1614.java