error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1575.java
text:
```scala
r@@eturn settingsBuilder().put("plugin.types", CustomScriptPlugin.class.getName()).put(super.nodeSettings(nodeOrdinal)).build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1575.java