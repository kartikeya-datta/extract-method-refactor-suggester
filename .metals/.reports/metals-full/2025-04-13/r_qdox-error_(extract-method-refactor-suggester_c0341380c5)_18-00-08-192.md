error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5027.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5027.java
text:
```scala
public A@@nnotationHolder retrieveAnnotationHolder(Binding binding, boolean forceInitialization) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5027.java