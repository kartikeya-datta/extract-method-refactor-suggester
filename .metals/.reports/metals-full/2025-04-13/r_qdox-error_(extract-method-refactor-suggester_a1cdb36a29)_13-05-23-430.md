error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7885.java
text:
```scala
U@@serPreferencesAdapter preferencesAdapter = new UserPreferencesStore(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7885.java