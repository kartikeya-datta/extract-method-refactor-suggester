error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8040.java
text:
```scala
o@@penableParent.openWhenClosed(null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8040.java