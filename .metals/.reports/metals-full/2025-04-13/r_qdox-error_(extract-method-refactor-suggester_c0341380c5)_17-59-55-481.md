error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11340.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11340.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11340.java
text:
```scala
C@@harSequence transform(final Component component, final CharSequence output)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11340.java