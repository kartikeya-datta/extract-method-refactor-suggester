error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15593.java
text:
```scala
M@@arkupContainer container = new WebMarkupContainer(new MockPageWithOneComponent(), "component");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15593.java