error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14056.java
text:
```scala
q@@ueryString = Strings.replaceAll(queryString, "1=", "path=");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14056.java