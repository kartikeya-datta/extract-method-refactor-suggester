error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8386.java
text:
```scala
b@@indInfo.setupLookupInjection(serviceBuilder, injector);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8386.java