error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/541.java
text:
```scala
s@@uper(settings, MultiSearchAction.NAME, threadPool);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/541.java