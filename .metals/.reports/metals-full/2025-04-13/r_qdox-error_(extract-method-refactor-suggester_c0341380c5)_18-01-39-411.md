error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6553.java
text:
```scala
r@@eturn gdxBulletJNI.ContactAddedListenerByValue_onContactAdded(swigCPtr, this, cp, userValue0, partId0, index0, match0, userValue1, partId1, index1, match1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6553.java