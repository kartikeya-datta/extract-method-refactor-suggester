error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1782.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1782.java
text:
```scala
@Override protected P@@utMappingResponse masterOperation(PutMappingRequest request, ClusterState state) throws ElasticSearchException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1782.java