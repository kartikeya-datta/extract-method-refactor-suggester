error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11314.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11314.java
text:
```scala
public I@@ResourceStream getMarkupResourceStream(final MarkupContainer container,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11314.java