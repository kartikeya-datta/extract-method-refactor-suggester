error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4165.java
text:
```scala
i@@f (window != 0) OS.gdk_window_get_user_data (window, user_data);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4165.java