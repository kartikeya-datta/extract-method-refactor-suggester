error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8879.java
text:
```scala
L@@ist<String> gets = Arrays.asList(new String[] { "/app1/wicket/bookmarkable/org.apache.wicket.threadtest.apps.app1.Home" });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8879.java