error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1661.java
text:
```scala
S@@tring signature = key.toSignature();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1661.java