error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2062.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2062.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2062.java
text:
```scala
d@@ocs = termsEnum.docs(acceptDocs, docs, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2062.java