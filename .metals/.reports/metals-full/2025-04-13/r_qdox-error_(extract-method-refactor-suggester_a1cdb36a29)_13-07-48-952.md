error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/251.java
text:
```scala
i@@f (editor == null && this.formattingService != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/251.java