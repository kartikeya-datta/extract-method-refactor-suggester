error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4149.java
text:
```scala
i@@f (vaultReader != null && vaultReader.isVaultFormat(expression)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4149.java