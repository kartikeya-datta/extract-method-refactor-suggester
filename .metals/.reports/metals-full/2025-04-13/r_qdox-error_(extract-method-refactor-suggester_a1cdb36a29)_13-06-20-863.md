error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18205.java
text:
```scala
r@@eturn new EndpointDescription(serviceReference,endpointDescriptionProperties,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18205.java