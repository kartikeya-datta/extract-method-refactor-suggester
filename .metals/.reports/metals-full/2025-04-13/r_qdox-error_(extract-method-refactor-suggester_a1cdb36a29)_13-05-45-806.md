error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10764.java
text:
```scala
r@@eturn String.format(FMT_TO_STRING, Integer.valueOf(System.identityHashCode(this)),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10764.java