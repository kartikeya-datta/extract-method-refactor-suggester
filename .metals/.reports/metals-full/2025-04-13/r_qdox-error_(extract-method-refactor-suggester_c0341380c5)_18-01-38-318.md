error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/171.java
text:
```scala
N@@SPoint pt = gcView.convertPoint_toView_(new NSPoint(), view);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/171.java