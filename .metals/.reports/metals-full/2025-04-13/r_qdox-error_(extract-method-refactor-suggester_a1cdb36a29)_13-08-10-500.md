error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10074.java
text:
```scala
t@@his.context = Args.notNull(context, "context");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10074.java