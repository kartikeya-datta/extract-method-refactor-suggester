error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1474.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1474.java
text:
```scala
static final O@@perationDefinition DEFINITION = new SimpleOperationDefinitionBuilder("reset-peak-usage", PlatformMBeanDescriptions.getResolver(PlatformMBeanConstants.MEMORY_POOL))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1474.java