error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5469.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5469.java
text:
```scala
public b@@oolean canRunOnThisVM() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5469.java