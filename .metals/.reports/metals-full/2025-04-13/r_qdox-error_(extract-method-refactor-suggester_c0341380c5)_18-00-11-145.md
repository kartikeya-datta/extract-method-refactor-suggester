error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6419.java
text:
```scala
t@@his.filter = new QueryWrapperFilter(query);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6419.java