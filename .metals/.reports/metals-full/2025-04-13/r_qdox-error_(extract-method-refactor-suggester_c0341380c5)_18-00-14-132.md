error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3456.java
text:
```scala
t@@extures[i].reset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3456.java