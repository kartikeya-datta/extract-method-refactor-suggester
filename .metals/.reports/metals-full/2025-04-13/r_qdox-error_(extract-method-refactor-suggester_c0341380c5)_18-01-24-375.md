error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12211.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12211.java
text:
```scala
p@@ublic final class Home extends AuthenticatedWebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12211.java