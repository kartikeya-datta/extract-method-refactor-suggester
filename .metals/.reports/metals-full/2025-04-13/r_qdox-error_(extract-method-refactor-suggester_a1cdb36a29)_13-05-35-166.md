error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16075.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16075.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16075.java
text:
```scala
i@@f (parent.sortColumn != this || parent.sortDirection != SWT.NULL) {
	...
	if (OS.COMCTL32_MAJOR < 6) {
		...
		if (image != null) {
			if (sort) {
				...
				hdItem.fmt |= OS.HDF_BITMAP | OS.HDF_BITMAP_ON_RIGHT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16075.java