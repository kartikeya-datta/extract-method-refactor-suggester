error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4146.java
text:
```scala
r@@eturn Version.indexCreated(indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4146.java