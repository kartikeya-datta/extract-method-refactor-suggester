error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10766.java
text:
```scala
i@@f (!getText || !getImage) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10766.java