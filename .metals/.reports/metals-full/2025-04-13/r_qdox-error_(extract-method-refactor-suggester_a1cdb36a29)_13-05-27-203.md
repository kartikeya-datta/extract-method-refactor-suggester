error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14913.java
text:
```scala
v@@oid initialize()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14913.java