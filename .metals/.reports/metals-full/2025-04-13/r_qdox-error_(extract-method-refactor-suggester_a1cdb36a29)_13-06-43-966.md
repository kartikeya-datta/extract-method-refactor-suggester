error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2631.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2631.java
text:
```scala
final S@@tring file = strTok.nextToken();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2631.java