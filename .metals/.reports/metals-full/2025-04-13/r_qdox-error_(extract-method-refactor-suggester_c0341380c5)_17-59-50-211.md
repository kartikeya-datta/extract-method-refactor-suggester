error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12596.java
text:
```scala
t@@hrow new IllegalStateException(MessageFormat.format(CANNOT_REMOVE_MESSAGE, Integer.valueOf(removeIndex)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12596.java