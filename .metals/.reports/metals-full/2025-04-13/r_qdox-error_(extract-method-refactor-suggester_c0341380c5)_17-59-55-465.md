error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1508.java
text:
```scala
i@@f (STARTED.getName().equals(name)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1508.java