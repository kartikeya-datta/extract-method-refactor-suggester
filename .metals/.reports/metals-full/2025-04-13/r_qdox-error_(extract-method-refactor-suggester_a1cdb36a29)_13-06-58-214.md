error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9743.java
text:
```scala
b@@uffer.append(CharOperation.toString(elements[i])).append("\n"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9743.java