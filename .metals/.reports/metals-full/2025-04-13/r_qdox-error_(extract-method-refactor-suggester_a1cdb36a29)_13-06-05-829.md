error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12317.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12317.java
text:
```scala
public W@@ebRequest(final HttpServletRequest httpServletRequest)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12317.java