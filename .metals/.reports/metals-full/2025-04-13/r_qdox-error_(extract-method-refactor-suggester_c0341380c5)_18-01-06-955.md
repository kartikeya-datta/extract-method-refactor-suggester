error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4350.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4350.java
text:
```scala
public static final S@@tring OPTION_ResourceCopyFilter = "org.eclipse.jdt.core.builder.resourceCopyExclusionFilters";//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4350.java