error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10824.java
text:
```scala
p@@p.set("test", "test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10824.java