error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14978.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14978.java
text:
```scala
r@@eturn new ReplicaSharedObjectDescription(getClass(), getID(),getConfig().getHomeContainerID(),map,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14978.java