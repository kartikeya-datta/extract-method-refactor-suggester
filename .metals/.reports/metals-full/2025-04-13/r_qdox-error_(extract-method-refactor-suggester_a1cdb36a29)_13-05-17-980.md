error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15991.java
text:
```scala
T@@hread.sleep(1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15991.java