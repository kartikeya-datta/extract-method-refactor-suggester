error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1600.java
text:
```scala
T@@ransportAddress[] addressesFromString(String address) throws Exception;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1600.java