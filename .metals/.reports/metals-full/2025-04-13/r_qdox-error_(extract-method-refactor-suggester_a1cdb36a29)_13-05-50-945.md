error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/758.java
text:
```scala
R@@ange<RowPosition> range = Util.range("", "");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/758.java