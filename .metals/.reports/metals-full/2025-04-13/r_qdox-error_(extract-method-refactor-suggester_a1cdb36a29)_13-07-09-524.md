error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4449.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4449.java
text:
```scala
h@@eader.getAttributes().put("columba.spam", new Boolean(Collections.binarySearch(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4449.java