error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3570.java
text:
```scala
S@@ystem.out.println(hostResult);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3570.java