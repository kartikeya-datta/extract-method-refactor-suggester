error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/181.java
text:
```scala
g@@raphics = new LwjglGraphics(canvas, useGL2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/181.java