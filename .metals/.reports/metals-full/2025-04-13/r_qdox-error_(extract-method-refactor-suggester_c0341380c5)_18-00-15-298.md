error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5044.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5044.java
text:
```scala
public v@@oid testPasswordBasedUnsuccessfulAuthz() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5044.java