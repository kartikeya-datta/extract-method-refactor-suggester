error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6130.java
text:
```scala
r@@eturn deploymentUnitServiceName.append("marshalling-configuration");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6130.java