error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4000.java
text:
```scala
a@@ssertTrue(pb.getCalls() < 3300);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4000.java