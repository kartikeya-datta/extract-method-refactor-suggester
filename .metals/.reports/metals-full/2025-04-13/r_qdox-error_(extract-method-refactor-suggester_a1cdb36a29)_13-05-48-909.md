error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13510.java
text:
```scala
i@@f (this.payload instanceof byte[]) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13510.java