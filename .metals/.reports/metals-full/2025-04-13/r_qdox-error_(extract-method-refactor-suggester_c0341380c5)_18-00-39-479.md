error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3446.java
text:
```scala
F@@ile testModuleRoot = new File(getModulePath(), "test" + File.separatorChar + moduleName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3446.java