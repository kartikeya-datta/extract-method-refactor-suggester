error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3913.java
text:
```scala
i@@f (camelCaseMatch) matchRule |= SearchPattern.R_CAMELCASE_MATCH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3913.java