error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4266.java
text:
```scala
r@@eturn new ProtocolDescription("jmx-as7");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4266.java