error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14997.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14997.java
text:
```scala
private static final M@@oduleDependency MSC_DEP = new ModuleDependency(Module.getBootModuleLoader(), ModuleIdentifier.create("org.jboss.msc"), false, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14997.java