error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2397.java
text:
```scala
S@@canner scanner = this.getAST().scanner;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2397.java