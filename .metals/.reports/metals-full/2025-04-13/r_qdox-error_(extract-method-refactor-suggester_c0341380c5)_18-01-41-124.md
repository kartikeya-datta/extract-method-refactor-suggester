error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7350.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7350.java
text:
```scala
P@@arser parser = new Parser(lookupEnvironment.problemReporter, true, options.sourceLevel >= CompilerOptions.JDK1_4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7350.java