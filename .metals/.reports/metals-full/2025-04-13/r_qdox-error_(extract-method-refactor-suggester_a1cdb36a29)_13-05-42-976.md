error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8873.java
text:
```scala
w@@rite(container, "\t<script language='JavaScript' type='text/javascript' " + "src='" + container.urlFor(ref.getPath()) + "'></script>\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8873.java