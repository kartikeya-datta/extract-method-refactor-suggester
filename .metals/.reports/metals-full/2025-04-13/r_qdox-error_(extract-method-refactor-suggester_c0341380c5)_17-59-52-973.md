error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1242.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1242.java
text:
```scala
final Q@@uery rewritten = new ConstantScoreQuery(delegate.getFilter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1242.java