error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14630.java
text:
```scala
t@@his.cpioEntry.setName(CPIO_TRAILER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14630.java