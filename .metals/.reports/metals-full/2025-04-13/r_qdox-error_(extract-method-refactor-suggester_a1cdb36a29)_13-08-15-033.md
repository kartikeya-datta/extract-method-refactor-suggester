error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1548.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1548.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1548.java
text:
```scala
private static final S@@tring TAG = "RequestWriter";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1548.java