error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5214.java
text:
```scala
P@@ageableListView table = new PageableListView<String>(this, "table", list, 2)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5214.java