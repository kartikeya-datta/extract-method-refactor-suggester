error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5988.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5988.java
text:
```scala
public static S@@trMatcher charSetMatcher(char... chars) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5988.java