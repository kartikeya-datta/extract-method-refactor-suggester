error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13945.java
text:
```scala
P@@ropertyModel pm2 = Objects.cloneModel(pm);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13945.java