error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18252.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18252.java
text:
```scala
r@@.write("\" alt=\"\"/></span>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18252.java