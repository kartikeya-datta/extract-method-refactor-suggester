error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6038.java
text:
```scala
p@@arentGroup = OS.GetWindowGroupOfClass (OS.kDocumentWindowClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6038.java