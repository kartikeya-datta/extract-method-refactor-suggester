error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2649.java
text:
```scala
S@@STableWriter writer = new SSTableWriter(cfs.getFlushPath(), columnFamilies.size(), cfs.metadata, partitioner);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2649.java