error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/235.java
text:
```scala
t@@hrow new GdxRuntimeException("Error reading " + fileName, e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/235.java