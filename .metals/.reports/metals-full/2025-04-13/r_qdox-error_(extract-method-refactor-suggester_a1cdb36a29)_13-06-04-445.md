error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3532.java
text:
```scala
v@@alidationException = addValidationError("doc must be specified if doc_as_upsert is enabled", validationException);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3532.java