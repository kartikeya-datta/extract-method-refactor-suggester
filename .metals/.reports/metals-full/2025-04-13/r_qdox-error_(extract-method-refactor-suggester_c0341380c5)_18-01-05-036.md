error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2952.java
text:
```scala
i@@r1 = IndexReader.open(dir1, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2952.java