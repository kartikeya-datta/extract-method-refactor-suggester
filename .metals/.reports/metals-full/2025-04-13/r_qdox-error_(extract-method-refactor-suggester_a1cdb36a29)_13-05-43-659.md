error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5130.java
text:
```scala
r@@eturn doGet(attributeName, Class.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5130.java