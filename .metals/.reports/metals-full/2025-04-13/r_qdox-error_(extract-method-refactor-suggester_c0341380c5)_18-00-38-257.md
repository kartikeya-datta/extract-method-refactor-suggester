error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5793.java
text:
```scala
m@@odel = new Model(loader.parseModel(Gdx.files.internal("data/g3d/cubes.g3dj")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5793.java