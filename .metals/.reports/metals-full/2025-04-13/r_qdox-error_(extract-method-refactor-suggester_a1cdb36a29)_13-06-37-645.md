error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15798.java
text:
```scala
r@@esetCache(lineIndex, 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15798.java