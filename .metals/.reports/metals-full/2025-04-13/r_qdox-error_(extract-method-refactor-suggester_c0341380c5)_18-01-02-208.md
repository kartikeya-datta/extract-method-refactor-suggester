error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7698.java
text:
```scala
n@@umToWrite = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7698.java