error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10156.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10156.java
text:
```scala
final i@@nt index = inputAsInt(NULL_VALUE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10156.java