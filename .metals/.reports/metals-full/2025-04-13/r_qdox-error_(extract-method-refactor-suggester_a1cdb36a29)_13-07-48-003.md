error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6320.java
text:
```scala
B@@atchBuilder batchBuilder = updateContext.getServiceTarget();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6320.java