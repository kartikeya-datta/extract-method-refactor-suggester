error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5703.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5703.java
text:
```scala
public O@@bject load(OpenJPAStateManager sm, JDBCStore store, Result res)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5703.java