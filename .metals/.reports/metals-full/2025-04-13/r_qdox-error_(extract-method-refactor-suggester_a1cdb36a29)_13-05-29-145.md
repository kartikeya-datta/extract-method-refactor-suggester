error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5584.java
text:
```scala
A@@jaxFormValidatingBehavior.addToAllFormComponents(form, "onkeyup", Duration.ONE_SECOND);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5584.java