error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5334.java
text:
```scala
F@@orm<Bean> form = new Form<Bean>(this, "form", new CompoundPropertyModel<Bean>(bean));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5334.java