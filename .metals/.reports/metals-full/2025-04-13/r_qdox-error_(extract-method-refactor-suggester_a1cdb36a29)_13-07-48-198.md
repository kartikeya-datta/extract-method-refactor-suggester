error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1241.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1241.java
text:
```scala
public static final V@@ersion V_1_0_0_Beta2 = new Version(V_1_0_0_Beta2_ID, true, org.apache.lucene.util.Version.LUCENE_46);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1241.java