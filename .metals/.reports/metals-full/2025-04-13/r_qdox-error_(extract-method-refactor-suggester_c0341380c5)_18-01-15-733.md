error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/425.java
text:
```scala
v@@oid createHandle (int index) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/425.java