error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13825.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13825.java
text:
```scala
C@@lass<?> clazz;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13825.java