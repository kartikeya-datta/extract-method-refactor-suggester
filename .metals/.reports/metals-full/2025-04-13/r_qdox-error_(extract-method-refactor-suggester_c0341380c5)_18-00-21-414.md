error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5723.java
text:
```scala
t@@his.compress = compress;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5723.java