error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16287.java
text:
```scala
i@@f (getCurrentNode() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16287.java