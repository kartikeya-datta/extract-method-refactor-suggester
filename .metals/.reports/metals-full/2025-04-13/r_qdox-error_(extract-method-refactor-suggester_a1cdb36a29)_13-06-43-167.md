error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7908.java
text:
```scala
o@@utput.append("StringLiteralConcatenation{"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7908.java