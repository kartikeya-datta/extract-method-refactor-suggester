error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8444.java
text:
```scala
P@@atternFilter filterForBoldElements = new PreferencePatternFilter();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8444.java