error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/402.java
text:
```scala
r@@eturn "setTimeout(\"" + getCallbackScript(true) + "\", "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/402.java