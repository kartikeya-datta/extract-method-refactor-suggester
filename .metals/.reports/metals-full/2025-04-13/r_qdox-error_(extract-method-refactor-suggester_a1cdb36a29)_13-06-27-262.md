error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1143.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1143.java
text:
```scala
c@@heckRandomData(random(), analyzer, atLeast(1000));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1143.java