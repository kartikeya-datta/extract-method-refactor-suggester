error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15206.java
text:
```scala
r@@eturn new FieldResourceInjection<V>(field, value, argClass.isPrimitive());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15206.java