error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11778.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11778.java
text:
```scala
public abstract A@@bstractModelUpdate<E, ?> getCompensatingUpdate(E original);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11778.java