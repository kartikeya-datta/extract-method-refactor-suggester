error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14928.java
text:
```scala
p@@ublic class Exp
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14928.java