error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/145.java
text:
```scala
r@@eturn flags == null ? EnumSet.noneOf(Flag.class) : flags.clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/145.java