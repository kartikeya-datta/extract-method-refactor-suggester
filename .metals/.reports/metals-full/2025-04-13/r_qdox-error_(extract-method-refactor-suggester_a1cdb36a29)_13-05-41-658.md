error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7396.java
text:
```scala
l@@og.info("Could not find resources for '"+loc.toString()+"', using '"+resBundLocale.toString()+"'");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7396.java