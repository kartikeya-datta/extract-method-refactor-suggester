error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11646.java
text:
```scala
p@@ublic class XmlPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11646.java