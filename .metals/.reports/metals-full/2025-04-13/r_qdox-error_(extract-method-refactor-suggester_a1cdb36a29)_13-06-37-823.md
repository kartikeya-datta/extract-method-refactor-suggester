error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10205.java
text:
```scala
c@@urrTexture = hwMipMap.isChecked() ? textureHW : textureSW;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10205.java