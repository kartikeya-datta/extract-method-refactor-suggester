error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3491.java
text:
```scala
r@@eturn ((DefaultCallbackHandler)ctx.getParsedCommandLine()).toOperationRequest(ctx);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3491.java