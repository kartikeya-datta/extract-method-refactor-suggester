error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/749.java
text:
```scala
J@@SFCorePlugin.log(vhe, "While acquiring view adapter"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/749.java