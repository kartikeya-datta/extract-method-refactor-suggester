error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15987.java
text:
```scala
_@@last = UUIDGenerator.nextHex(UUIDGenerator.TYPE1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15987.java