error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11307.java
text:
```scala
b@@oolean authorizeAction(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11307.java