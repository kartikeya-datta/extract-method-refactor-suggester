error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14808.java
text:
```scala
r@@eturn DeploymentDescription.getRedeployDeploymentOperation(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14808.java