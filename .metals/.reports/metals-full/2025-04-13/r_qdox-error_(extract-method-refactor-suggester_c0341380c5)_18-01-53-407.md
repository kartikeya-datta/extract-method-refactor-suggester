error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1631.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1631.java
text:
```scala
l@@ong totalTime = ((getElapsedSeconds() * 100) / Math.max(percentageComplete, 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1631.java