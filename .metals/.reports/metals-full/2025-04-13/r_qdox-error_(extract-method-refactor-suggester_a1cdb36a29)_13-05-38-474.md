error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3424.java
text:
```scala
i@@f (flowInfo != FlowInfo.DeadEnd && !flowInfo.isFakeReachable()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3424.java