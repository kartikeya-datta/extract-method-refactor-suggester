error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7703.java
text:
```scala
a@@ssertThat(routing.state(), anyOf(equalTo(ShardRoutingState.RELOCATING), equalTo(ShardRoutingState.STARTED)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7703.java