error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3793.java
text:
```scala
R@@ange range3 = ss.getPrimaryRangeForEndpoint(three);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3793.java