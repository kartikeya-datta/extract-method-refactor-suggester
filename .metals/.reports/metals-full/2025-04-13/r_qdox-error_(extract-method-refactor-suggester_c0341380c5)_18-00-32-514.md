error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13301.java
text:
```scala
t@@hrow new AssertionError(i.previousIndex() + 1 + ""
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13301.java