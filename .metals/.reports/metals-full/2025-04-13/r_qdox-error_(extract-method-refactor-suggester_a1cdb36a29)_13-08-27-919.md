error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9955.java
text:
```scala
M@@oveSpriteExample.class, StbTrueTypeTest.class, SoundTouchTest.class };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9955.java