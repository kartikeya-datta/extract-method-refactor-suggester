error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7326.java
...
```java
offset: 27
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7326.java
text:
```scala
"javascript:validate('" + g@@etCallbackUrl() + "', '" + formComponent.getInputName() + "', this);";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7326.java