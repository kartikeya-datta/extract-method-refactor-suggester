error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12918.java
text:
```scala
i@@nt pixel = background == -1 ? gc.getBackground ().handle : -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12918.java