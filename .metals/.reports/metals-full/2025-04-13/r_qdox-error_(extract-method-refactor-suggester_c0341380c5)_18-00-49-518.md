error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9950.java
text:
```scala
S@@tring containerName = context.getCurrentAddressValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9950.java