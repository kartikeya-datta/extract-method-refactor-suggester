error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1928.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1928.java
text:
```scala
private static final S@@tring TAG = HelpActivity.class.getSimpleName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1928.java