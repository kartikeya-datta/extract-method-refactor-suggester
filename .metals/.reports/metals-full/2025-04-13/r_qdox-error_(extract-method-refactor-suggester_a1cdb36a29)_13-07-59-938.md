error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/88.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/88.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/88.java
text:
```scala
i@@f(previous != TokenNameLESS && previous != TokenNameCOMMA) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/88.java