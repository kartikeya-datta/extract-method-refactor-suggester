error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14891.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14891.java
text:
```scala
private transient I@@TestPageSource testPageSource;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14891.java