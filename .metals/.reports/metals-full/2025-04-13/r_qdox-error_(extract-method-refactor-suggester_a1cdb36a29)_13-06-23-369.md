error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8542.java
...
```java
offset: 726
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8542.java
text:
```scala
 ...
 */
p@@ackage org.springframework.messaging.core;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8542.java