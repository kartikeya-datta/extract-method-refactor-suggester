error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9351.java
text:
```scala
c@@onstructor = getDeclaringType().getDeclaredConstructor(getParameterTypes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9351.java