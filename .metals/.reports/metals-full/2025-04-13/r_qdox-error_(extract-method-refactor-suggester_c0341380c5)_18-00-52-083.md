error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4109.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4109.java
text:
```scala
protected L@@ockType fromAnnotation(final AnnotationInstance annotationInstance, final boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4109.java