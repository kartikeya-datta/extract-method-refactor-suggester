error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12151.java
text:
```scala
s@@uper(params, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12151.java