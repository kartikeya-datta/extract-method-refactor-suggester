error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5290.java
text:
```scala
g@@etRequestCycle().setResponsePage(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5290.java