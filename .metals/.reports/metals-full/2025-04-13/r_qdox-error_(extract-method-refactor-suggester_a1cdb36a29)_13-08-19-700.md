error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11161.java
text:
```scala
w@@indow.setFrame(frame, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11161.java