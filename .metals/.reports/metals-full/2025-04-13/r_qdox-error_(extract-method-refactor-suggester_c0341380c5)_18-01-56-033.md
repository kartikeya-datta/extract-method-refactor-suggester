error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16704.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16704.java
text:
```scala
public T@@ree(String id, IModel<? extends TreeModel> model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16704.java