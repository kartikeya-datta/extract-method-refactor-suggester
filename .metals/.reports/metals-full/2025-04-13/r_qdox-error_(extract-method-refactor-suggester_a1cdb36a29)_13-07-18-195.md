error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/93.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/93.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/93.java
text:
```scala
h@@andler.handleException(new TransportException("", new InternalException(action, request)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/93.java