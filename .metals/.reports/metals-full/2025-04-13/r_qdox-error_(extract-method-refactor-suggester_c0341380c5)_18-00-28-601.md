error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3911.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3911.java
text:
```scala
public B@@oolean getCommitSuceeded() throws RemoteException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3911.java