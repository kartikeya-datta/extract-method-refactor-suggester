error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18314.java
text:
```scala
m@@yName = ((CompoundVariable) values[PARAM_NAME - 1]).execute().trim();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18314.java