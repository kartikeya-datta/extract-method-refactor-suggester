error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17580.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[81,80]

error in qdox parser
file content:
```java
offset: 2478
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17580.java
text:
```scala
...
public class ExceptionErrorPage extends HtmlPage
{
	...
	/**
     * Constructor
     * @param e The markup exception to show
     */
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17580.java