error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1120.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1120.java
text:
```scala
public static S@@earchParticipant[] getAvailableSearchParticipants() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1120.java