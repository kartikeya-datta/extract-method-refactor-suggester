error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12888.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12888.java
text:
```scala
r@@ect.height = layoutManager.defaultLineHeightForFont(nsFont);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12888.java