error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6406.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6406.java
text:
```scala
final B@@ridgeConfiguration bridgeConfiguration = BridgeAdd.createBridgeConfiguration(context, name, model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6406.java