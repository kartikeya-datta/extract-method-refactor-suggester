error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5063.java
text:
```scala
r@@eturn clusterService.operationRouting().searchShards(clusterState, request.indices(), request.queryHint());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5063.java