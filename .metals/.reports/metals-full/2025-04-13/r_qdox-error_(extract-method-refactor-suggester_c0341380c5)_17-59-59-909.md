error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6991.java
text:
```scala
o@@rg.eclipse.jdt.internal.compiler.util.Util.valueOf(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6991.java