error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7483.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7483.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7483.java
text:
```scala
i@@f (markupId == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7483.java