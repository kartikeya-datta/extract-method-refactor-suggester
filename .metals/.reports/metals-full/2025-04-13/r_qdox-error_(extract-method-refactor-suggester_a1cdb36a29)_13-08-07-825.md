error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9224.java
text:
```scala
r@@eturn JFaceResources.getImageRegistry().get(Dialog.DLG_IMG_WARNING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9224.java