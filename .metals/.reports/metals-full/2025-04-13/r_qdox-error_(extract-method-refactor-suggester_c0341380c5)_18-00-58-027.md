error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/763.java
text:
```scala
P@@references prefs = new LwjglPreferences(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/763.java