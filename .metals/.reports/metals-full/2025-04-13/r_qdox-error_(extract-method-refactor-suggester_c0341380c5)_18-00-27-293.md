error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7659.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7659.java
text:
```scala
a@@ssertThat(results.toString(), both(containsString("Antimilos")).and(containsString("ignored test:")).and(containsString("IGNORED TEST 1)")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7659.java