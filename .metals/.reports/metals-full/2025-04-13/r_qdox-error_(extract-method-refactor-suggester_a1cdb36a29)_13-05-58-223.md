error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12713.java
text:
```scala
p@@ublic class UrlResourceStream extends AbstractResourceStream
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12713.java