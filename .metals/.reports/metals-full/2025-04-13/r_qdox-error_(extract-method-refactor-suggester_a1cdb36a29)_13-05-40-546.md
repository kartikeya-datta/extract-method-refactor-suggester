error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3015.java
text:
```scala
i@@nt nonBlankLength = (int)Math.min(remainingNonBlanks, (long)length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3015.java