error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11313.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11313.java
text:
```scala
public S@@tring getCacheKey(final MarkupContainer container, final Class< ? > clazz)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11313.java