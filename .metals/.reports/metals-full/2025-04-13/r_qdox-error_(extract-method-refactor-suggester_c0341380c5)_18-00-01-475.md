error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13212.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13212.java
text:
```scala
public static b@@oolean fileExists(String parent, String child) throws java.io.IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13212.java