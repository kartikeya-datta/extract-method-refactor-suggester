error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8912.java
text:
```scala
c@@ontacts.add(dp.model(it.next()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8912.java