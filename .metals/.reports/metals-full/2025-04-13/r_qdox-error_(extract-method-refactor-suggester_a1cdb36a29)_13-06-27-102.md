error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5223.java
text:
```scala
C@@olumbaLogger.log.info("Save Message Source As... called");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5223.java