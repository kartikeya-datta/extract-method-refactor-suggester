error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8967.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8967.java
text:
```scala
public v@@oid readPerspectives(IExtensionRegistry in, PerspectiveRegistry out)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8967.java