error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2624.java
text:
```scala
s@@uper("ProcessException" + ex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2624.java