error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10017.java
text:
```scala
i@@f (fmd.isEmbeddedPC())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10017.java