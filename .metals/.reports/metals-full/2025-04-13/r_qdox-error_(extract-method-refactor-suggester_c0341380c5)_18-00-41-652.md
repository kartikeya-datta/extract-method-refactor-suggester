error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1899.java
text:
```scala
S@@tring str = "ExtendedStringLiteral{"/*nonNLS*/+ new String(source) +"}"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1899.java