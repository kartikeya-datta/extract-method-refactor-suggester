error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13118.java
text:
```scala
R@@eflectionHelper.convertAllArguments(m.getParameterTypes(), m.isVarArgs(), tc, args);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13118.java