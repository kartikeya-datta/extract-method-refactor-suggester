error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10749.java
text:
```scala
r@@esponse.write("<div style=\"position:absolute;z-index:100;display:none;\" id=\""+id+"-autocomplete\" class=\"wicket-aa\"></div>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10749.java