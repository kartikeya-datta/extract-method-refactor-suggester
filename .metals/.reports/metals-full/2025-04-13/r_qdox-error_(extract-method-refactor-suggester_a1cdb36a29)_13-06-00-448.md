error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10330.java
text:
```scala
L@@istView.this.modelChanged();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10330.java