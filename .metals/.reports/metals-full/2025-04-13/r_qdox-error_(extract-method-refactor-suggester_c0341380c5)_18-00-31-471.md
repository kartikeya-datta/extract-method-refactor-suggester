error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5432.java
text:
```scala
p@@roject.files.add(new ProjectFile("ios/build.gradle", true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5432.java