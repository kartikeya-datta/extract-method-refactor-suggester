error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4053.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4053.java
text:
```scala
L@@ong ttl = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4053.java