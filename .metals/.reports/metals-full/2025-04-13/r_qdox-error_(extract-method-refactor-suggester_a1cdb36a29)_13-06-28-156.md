error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9326.java
text:
```scala
C@@lass<?> handlerType,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9326.java