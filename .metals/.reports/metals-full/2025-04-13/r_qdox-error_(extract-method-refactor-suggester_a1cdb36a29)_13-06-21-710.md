error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5927.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5927.java
text:
```scala
d@@ata[0].setHeight(data[0].getHeight() + 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5927.java