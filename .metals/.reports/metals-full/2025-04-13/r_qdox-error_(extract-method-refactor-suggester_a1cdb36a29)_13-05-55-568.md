error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5946.java
text:
```scala
r@@eturn value.equals(obj.value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5946.java