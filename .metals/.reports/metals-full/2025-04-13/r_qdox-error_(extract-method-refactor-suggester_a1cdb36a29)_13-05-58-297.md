error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1005.java
text:
```scala
r@@eturn PredicatedSet.predicatedSet(set, predicate);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1005.java