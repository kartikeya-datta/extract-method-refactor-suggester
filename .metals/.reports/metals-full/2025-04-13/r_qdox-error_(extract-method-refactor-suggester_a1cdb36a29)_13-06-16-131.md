error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1919.java
text:
```scala
T@@extureRenderTest.class, TiledMapTest.class, TileTest.class, UITest.class, VBOVATest.class, VertexArrayTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1919.java