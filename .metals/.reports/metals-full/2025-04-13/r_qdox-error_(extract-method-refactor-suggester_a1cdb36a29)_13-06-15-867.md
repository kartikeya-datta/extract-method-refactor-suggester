error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12378.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12378.java
text:
```scala
public C@@lass[] getProjectionTypes(StoreQuery q) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12378.java