error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13414.java
text:
```scala
M@@arkupFragment fragment = this.markupProvider.getAssociatedMarkup(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13414.java