error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8271.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8271.java
text:
```scala
final L@@ist<Callable<HTTPSampleResult>> liste = new ArrayList<Callable<HTTPSampleResult>>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8271.java