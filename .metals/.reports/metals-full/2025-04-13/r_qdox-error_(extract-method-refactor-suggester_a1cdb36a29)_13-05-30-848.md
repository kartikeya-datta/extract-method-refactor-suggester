error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4294.java
...
```java
offset: 873
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4294.java
text:
```scala
...
p@@ackage org.elasticsearch.index.fielddata.ordinals;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4294.java