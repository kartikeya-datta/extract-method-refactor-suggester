error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15695.java
text:
```scala
n@@ull, getNullEvaluationHandler(), null, callback, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15695.java