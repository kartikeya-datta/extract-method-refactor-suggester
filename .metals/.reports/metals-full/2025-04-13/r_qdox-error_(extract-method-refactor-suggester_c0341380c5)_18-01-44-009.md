error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3225.java
text:
```scala
i@@nt chord = OS.GetCurrentButtonState ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3225.java