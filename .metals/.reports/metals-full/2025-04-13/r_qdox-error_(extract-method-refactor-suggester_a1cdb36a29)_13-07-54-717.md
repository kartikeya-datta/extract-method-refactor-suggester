error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3615.java
text:
```scala
c@@ontext.removeService(RemotingHttpUpgradeService.SERVICE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3615.java