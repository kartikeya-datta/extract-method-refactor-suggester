error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10730.java
text:
```scala
a@@ssertEquals(value, cache.get(key).get());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10730.java