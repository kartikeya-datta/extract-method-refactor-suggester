error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1847.java
text:
```scala
c@@reateTestDatabase(dbCreationScript_1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1847.java