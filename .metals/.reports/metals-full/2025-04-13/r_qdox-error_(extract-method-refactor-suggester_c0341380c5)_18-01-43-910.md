error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3538.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3538.java
text:
```scala
protected S@@tring name = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3538.java