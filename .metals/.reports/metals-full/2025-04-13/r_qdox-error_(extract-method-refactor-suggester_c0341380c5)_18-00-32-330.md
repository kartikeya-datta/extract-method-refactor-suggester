error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9959.java
text:
```scala
c@@ompilerOptions.produceReferenceInfo = this.produceRefInfo;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9959.java