error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5210.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5210.java
text:
```scala
i@@f (parameters != null && parameters.size() > 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5210.java