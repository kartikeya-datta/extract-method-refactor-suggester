error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12404.java
text:
```scala
I@@NestedModelContainer wrapOnInheritance(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12404.java