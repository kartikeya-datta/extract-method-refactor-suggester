error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/21.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/21.java
...
```java
offset: 56
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/21.java
text:
```scala
 ...
 *
 */
p@@ackage org.jboss.as.domain.controller.plan;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/21.java