error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12744.java
text:
```scala
a@@dd(new CheckBox("fiction", bookModel, "fiction"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12744.java