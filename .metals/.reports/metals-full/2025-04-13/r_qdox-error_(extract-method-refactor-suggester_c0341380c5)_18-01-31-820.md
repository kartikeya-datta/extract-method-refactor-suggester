error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/737.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/737.java
text:
```scala
public v@@oid close() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/737.java