error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3584.java
text:
```scala
a@@ssertFalse(r1.isCurrent());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3584.java