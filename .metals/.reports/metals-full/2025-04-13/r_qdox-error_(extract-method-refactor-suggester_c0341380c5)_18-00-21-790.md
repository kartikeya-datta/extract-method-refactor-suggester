error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2476.java
text:
```scala
r@@eturn CategorizedProblem.CAT_INTERNAL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2476.java