error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1053.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1053.java
text:
```scala
o@@utputProp.store(os,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1053.java