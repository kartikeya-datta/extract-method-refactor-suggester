error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6903.java
text:
```scala
l@@ist.add(ServerSubsystemUpdate.create(update));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6903.java