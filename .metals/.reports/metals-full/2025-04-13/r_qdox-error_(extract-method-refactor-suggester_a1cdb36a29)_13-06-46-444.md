error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10195.java
text:
```scala
s@@uper.destroyWidget ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10195.java