error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4646.java
text:
```scala
c@@ase id.m_delete:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4646.java