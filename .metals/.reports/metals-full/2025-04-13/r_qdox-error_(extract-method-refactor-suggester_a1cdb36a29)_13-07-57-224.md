error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1779.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1779.java
text:
```scala
@Override protected I@@ndicesAliasesResponse masterOperation(IndicesAliasesRequest request, ClusterState state) throws ElasticSearchException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1779.java