error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3968.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3968.java
text:
```scala
public v@@oid handleValidSubmit()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3968.java