error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11381.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11381.java
text:
```scala
public static final E@@scapeSelector ESCAPE_SELECTOR = new EscapeSelector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11381.java