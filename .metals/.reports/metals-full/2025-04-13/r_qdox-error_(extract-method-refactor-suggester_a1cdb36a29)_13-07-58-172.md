error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6816.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6816.java
text:
```scala
public T@@emplate getTemplate(String name) throws ResourceNotFoundException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6816.java