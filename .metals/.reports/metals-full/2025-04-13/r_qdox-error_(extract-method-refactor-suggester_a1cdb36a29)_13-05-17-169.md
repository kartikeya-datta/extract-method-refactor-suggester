error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2007.java
text:
```scala
r@@eturn clusterService.operationRouting().searchShards(clusterState, request.indices(), concreteIndices, null, routingMap, "_local");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2007.java