error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6198.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6198.java
text:
```scala
final C@@harSequence rawMarkup = xmlParser.getInput(lastTag.getPos()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6198.java