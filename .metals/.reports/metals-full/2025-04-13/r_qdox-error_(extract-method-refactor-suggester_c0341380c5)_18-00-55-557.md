error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6572.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6572.java
text:
```scala
protected b@@oolean generateInfos(OpenableElementInfo info, IProgressMonitor pm, Map newElements, IResource underlyingResource, IProblemRequestor problemRequestor) throws JavaModelException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6572.java