error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1681.java
text:
```scala
n@@ull, message, MessageDialog.QUESTION, new String[] { IDialogConstants.OK_LABEL,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1681.java