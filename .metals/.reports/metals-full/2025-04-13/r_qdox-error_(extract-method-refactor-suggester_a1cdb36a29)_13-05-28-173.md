error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4649.java
text:
```scala
w@@idth = (int)Math.ceil (size.width);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4649.java