error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3506.java
text:
```scala
f@@or (FileStatus status : fs.globStatus(new Path(dir, "part-*"))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3506.java