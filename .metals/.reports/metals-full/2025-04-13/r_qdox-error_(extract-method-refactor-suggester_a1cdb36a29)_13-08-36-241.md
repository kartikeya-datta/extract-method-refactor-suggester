error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2842.java
text:
```scala
r@@eturn true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2842.java