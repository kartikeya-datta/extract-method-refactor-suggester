error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9344.java
text:
```scala
s@@ize += HEADERS + 3 * 4 + HEADERS + 2 * identifier.length();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9344.java