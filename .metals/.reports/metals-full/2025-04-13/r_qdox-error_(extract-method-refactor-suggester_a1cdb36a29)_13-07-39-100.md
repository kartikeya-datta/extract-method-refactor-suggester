error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12877.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12877.java
text:
```scala
v@@oid drawWidget (int /*long*/ id, NSRect rect, boolean sendPaint) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12877.java