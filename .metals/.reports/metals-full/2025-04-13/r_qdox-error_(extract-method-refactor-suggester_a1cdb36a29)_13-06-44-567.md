error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15706.java
text:
```scala
L@@ocale loc = new Locale(((Component)e.getSource()).getName(),"");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15706.java