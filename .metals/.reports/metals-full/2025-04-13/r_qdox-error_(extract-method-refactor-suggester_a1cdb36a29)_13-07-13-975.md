error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10329.java
text:
```scala
t@@his.flushThresholdOperations = componentSettings.getAsInt(FLUSH_THRESHOLD_OPS_KEY, componentSettings.getAsInt("flush_threshold", Integer.MAX_VALUE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10329.java