error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5624.java
text:
```scala
b@@oolean supports(Class<?> clazz);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5624.java