error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12690.java
text:
```scala
r@@eturn buildDefault(DiscardPolicy.REJECT_AND_WARN, true, empty);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12690.java