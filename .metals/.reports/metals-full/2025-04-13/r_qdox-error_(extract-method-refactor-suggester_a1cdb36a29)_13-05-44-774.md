error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3537.java
text:
```scala
r@@eturn requestCycle.getOriginalResponse().encodeURL(url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3537.java