error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12177.java
text:
```scala
r@@awInput = StringList.valueOf(input).join(VALUE_SEPARATOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12177.java