error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3989.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3989.java
text:
```scala
final i@@nt versionNumber = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3989.java