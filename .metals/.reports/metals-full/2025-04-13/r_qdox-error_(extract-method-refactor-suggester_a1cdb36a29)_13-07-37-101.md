error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1694.java
text:
```scala
r@@eturn new TypedValue(result, new TypeDescriptor(new MethodParameter(method,-1)).narrowType(result));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1694.java