error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9733.java
text:
```scala
s@@tart - 1 - lastEnd));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9733.java