error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3735.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3735.java
text:
```scala
s@@etShellSize(shell);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3735.java