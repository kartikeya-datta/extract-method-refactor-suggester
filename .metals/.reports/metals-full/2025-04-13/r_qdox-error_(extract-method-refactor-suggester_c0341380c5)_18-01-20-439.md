error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9876.java
text:
```scala
s@@ite.close(new IPresentablePart[]{part});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9876.java