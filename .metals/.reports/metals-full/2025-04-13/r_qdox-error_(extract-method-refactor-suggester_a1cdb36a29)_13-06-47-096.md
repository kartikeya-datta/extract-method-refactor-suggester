error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4382.java
text:
```scala
S@@tringBuilder headers = new StringBuilder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4382.java