error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5428.java
text:
```scala
r@@eturn SynchronizedCollection.synchronizedCollection(new ArrayList<E>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5428.java