error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5815.java
text:
```scala
p@@arseManagement(reader, address, list, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5815.java