error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6736.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6736.java
text:
```scala
public static final S@@tring VERSION = "1.4.2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6736.java