error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5674.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5674.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5674.java
text:
```scala
c@@ommands.add("edit");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5674.java