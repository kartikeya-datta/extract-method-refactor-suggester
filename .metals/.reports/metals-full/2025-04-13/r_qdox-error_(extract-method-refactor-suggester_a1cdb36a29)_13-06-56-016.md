error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7852.java
text:
```scala
S@@tring LIVE_CONNECTOR_REF ="live-connector-ref";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7852.java