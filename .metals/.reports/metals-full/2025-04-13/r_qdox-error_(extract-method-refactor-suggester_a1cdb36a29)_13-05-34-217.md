error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/96.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/96.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/96.java
text:
```scala
c@@lient.admin().cluster().nodesInfo(nodesInfoRequest, new ActionListener<NodesInfoResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/96.java