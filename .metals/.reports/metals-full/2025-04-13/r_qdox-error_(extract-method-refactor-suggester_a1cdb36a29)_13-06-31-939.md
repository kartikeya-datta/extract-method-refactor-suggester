error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6882.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6882.java
text:
```scala
public R@@ows(MarkupContainer parent,String name, List list)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6882.java