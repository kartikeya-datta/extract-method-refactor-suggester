error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5411.java
text:
```scala
r@@eturn state.blocks().indicesBlockedException(ClusterBlockLevel.METADATA, request.indices());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5411.java