error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14536.java
text:
```scala
i@@f (length > 1 && fileName.charAt (0) == '\"') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14536.java