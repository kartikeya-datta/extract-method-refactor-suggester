error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8775.java
text:
```scala
p@@ublic final class WicketComponentTree extends Panel
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8775.java