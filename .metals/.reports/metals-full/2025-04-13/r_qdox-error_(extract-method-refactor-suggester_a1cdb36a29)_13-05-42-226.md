error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/951.java
text:
```scala
c@@tx.getOperationRequestParser().parse(ctx.getArgumentsString(), handler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/951.java