error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12154.java
text:
```scala
n@@ew Bot(entry);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12154.java