error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2552.java
text:
```scala
e@@ventContainer.addPropertyKeys(event.getPropertyKeySet());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2552.java