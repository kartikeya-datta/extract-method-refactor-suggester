error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2443.java
text:
```scala
i@@mplements BoundedMap<K, V>, Serializable {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2443.java