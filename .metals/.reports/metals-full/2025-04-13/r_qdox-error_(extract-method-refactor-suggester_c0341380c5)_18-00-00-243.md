error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6360.java
text:
```scala
S@@tring bodyText = (String) args[1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6360.java