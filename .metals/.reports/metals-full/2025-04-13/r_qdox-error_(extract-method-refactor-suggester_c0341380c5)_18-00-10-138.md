error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1212.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1212.java
text:
```scala
...
/**
 * Executes the {@code java.lang.management.PlatformLoggingMXBean.getParentLoggerName(String loggerName)} method.
 *
...
public class PlatformLoggingMXBeanGetParentLoggerNameHandler implements OperationStepHandler, DescriptionProvider {
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        try {
            Object parent = ManagementFactory.getPlatformMBeanServer().invoke(PlatformMBeanConstants.PLATFORM_LOGGING_OBJECT_NAME,
                    "getParentLoggerName", new String[]{loggerName}, SIGNATURE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1212.java