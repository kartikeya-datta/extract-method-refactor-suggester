error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1543.java
text:
```scala
i@@nternalTickCallback = new TestInternalTickCallback(world.dynamicsWorld);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1543.java