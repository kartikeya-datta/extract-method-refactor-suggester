error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4200.java
text:
```scala
c@@odec.readResults(singly, 0, 100);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4200.java