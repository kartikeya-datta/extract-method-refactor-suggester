error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2798.java
text:
```scala
t@@ester.assertContains("resource/org.apache.wicket.markup.html.image.Home/[$]up[$]/[$]up[$]/border/logo.gif\"");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2798.java