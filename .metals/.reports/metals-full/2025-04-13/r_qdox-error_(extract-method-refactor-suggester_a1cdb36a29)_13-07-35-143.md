error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7326.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7326.java
text:
```scala
private S@@et<CustomSerialMergeScheduler> schedulers = new CopyOnWriteArraySet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7326.java