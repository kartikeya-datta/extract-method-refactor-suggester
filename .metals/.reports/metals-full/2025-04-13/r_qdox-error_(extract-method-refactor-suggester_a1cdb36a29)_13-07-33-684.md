error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2727.java
text:
```scala
t@@imeout [1] = 50000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2727.java