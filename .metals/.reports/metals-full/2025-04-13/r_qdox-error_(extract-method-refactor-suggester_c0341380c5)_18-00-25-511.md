error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9048.java
text:
```scala
t@@rue, // need for field initialization: see bug 40476
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9048.java