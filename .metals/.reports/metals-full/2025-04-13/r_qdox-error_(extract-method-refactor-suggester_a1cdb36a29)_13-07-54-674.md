error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10407.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10407.java
text:
```scala
private final O@@bject nodeToFind;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10407.java