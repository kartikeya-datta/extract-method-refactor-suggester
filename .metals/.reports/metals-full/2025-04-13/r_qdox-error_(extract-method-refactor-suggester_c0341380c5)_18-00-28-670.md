error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4064.java
text:
```scala
o@@p.get("protocol").set(conn.getProtocol());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4064.java