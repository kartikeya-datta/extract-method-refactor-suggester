error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16498.java
text:
```scala
i@@f (takeFocus && (state & CANVAS) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16498.java