error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2647.java
text:
```scala
t@@abFolderPage.layout (controls);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2647.java