error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/446.java
text:
```scala
f@@actoryID = IWorkbenchConstants.DEFAULT_PRESENTATION_ID;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/446.java