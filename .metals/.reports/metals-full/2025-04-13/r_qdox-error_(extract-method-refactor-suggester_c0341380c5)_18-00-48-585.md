error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/206.java
text:
```scala
m@@essage("unable to remove file \"" + fileName + "\": " + e.toString() + "; Will re-try later.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/206.java