error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9247.java
text:
```scala
s@@ignature = base64.fromString(st.remainingTokens());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9247.java