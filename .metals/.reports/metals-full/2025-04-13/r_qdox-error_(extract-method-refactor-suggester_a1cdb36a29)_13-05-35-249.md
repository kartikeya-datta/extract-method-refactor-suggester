error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12001.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12001.java
text:
```scala
final T@@rackingServiceTarget serviceTarget = new TrackingServiceTarget(container.subTarget());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12001.java