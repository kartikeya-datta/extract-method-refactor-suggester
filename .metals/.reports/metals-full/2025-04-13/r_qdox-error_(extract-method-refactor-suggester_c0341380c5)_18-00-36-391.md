error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/144.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/144.java
text:
```scala
i@@nfo.nPage = rect.right - rect.left + 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/144.java