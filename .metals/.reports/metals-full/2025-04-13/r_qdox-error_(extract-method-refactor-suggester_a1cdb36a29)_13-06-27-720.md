error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1727.java
text:
```scala
c@@ache = new SpriteCache(1000, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1727.java