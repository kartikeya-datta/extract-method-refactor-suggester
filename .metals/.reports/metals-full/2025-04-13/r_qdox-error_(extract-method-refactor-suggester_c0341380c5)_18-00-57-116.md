error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12673.java
text:
```scala
x@@mlIgnore = new String[] { ".settings", "EclipseCodeFormat.xml", "src/assembly/bin.xml" };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12673.java