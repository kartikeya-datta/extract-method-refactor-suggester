error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15874.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15874.java
text:
```scala
h@@elperTask.addClasspath( compileClasspath );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15874.java