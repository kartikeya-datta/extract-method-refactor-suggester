error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2860.java
text:
```scala
i@@f (method.equalsIgnoreCase(HttpMethods.POST)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2860.java