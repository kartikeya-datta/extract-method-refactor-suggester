error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1697.java
text:
```scala
i@@f (!(command instanceof Comparable)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1697.java