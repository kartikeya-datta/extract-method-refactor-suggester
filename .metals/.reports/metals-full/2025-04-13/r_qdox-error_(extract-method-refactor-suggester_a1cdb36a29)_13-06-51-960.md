error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3833.java
text:
```scala
T@@ypeBinding type = this.resolvedType = this.qualification.resolveType(scope, true /* check bounds*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3833.java