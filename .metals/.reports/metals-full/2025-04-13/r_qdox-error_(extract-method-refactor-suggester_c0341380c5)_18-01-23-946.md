error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9563.java
text:
```scala
t@@askClass.getConstructor((Class[])null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9563.java