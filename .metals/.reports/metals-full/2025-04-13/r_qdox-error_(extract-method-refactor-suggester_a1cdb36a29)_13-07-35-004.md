error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5747.java
text:
```scala
a@@ssertEquals(BASE32HEX_TEST_CASES[i][1], Base32.encodeBase32HexString(BASE32HEX_TEST_CASES[i][0].getBytes("UTF-8")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5747.java