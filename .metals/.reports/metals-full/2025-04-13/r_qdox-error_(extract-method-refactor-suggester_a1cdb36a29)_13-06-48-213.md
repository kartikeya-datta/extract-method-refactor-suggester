error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3145.java
text:
```scala
E@@rrorDialog.createDialog(e.getMessage(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3145.java