error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14170.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14170.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14170.java
text:
```scala
r@@eturn (getPayloadSize() > 10) ? getPayload().substring(0, 10) + ".." : getPayload();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14170.java