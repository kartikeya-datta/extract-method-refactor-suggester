error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12362.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12362.java
text:
```scala
c@@ookie.setValue(value == null ? "" : value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12362.java