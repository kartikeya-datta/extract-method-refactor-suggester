error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2856.java
text:
```scala
d@@efault: level = Logger.Level.TRACE; break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2856.java