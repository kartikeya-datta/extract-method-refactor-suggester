error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5637.java
text:
```scala
m@@ergeFactor, minMergeSize, maxMergeSize, maxMergeDocs, useCompoundFile, calibrateSizeByDeletes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5637.java