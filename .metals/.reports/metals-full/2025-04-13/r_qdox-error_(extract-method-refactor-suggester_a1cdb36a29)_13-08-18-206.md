error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/758.java
text:
```scala
p@@h = PropertyHelper.getPropertyHelper(getProject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/758.java