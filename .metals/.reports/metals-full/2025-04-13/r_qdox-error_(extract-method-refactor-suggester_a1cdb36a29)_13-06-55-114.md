error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1373.java
text:
```scala
c@@entroid.y = (y1 + y2 + y3) / 3;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1373.java