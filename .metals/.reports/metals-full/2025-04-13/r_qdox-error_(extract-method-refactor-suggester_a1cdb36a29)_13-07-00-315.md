error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1330.java
text:
```scala
r@@eturn new HyphenationCompoundWordTokenFilter(version, tokenStream,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1330.java