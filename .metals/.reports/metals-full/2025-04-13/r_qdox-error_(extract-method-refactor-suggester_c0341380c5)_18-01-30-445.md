error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7919.java
text:
```scala
e@@xps.hasParameterizedInExpression = this.hasParameterizedInExpression;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7919.java