error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1661.java
text:
```scala
d@@e = _TestUtil.docs(random(), te, liveDocs, de, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1661.java