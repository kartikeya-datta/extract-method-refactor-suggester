error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12689.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12689.java
text:
```scala
p@@arams = pq.reparametrize(params, _em.getBroker());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12689.java