error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5700.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5700.java
text:
```scala
public abstract d@@ouble cumulativeProbability(int x) throws MathException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5700.java