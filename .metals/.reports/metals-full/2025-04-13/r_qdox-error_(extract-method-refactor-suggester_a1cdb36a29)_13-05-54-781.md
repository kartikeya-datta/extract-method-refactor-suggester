error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4501.java
text:
```scala
i@@f (postEvent) sendSelectionEvent (doubleClick ? SWT.DefaultSelection : SWT.Selection);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4501.java