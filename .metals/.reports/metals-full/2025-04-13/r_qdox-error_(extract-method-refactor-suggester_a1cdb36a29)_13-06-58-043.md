error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2888.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2888.java
text:
```scala
p@@utValue(SHORT_DESCRIPTION, "Add Address to Blacklist");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2888.java