error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6857.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6857.java
text:
```scala
static i@@nt MINOR_VERSION = 123;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6857.java