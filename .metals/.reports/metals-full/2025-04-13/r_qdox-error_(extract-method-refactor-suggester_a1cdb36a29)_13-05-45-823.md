error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1056.java
text:
```scala
a@@ssertEquals("Num registered TELs for DefaultListenersExampleTestCase.", 5,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1056.java