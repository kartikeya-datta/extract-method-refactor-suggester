error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2057.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2057.java
text:
```scala
public b@@oolean texturePortionEquals (TextureAttribute other) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2057.java