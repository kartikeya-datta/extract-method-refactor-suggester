error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/946.java
text:
```scala
t@@hrow new CommandFormatException("Type '" + typeName + "' not found among child types of '" + ctx.getNodePathFormatter().format(typeAddress) + "'");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/946.java