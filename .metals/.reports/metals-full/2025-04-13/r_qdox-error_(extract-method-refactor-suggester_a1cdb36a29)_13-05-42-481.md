error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13722.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13722.java
text:
```scala
final R@@esource resource = getApplication().getSharedResources().get(resourceReferenceKey);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13722.java