error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1387.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1387.java
text:
```scala
public O@@bject newArray (Class componentType, int size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1387.java