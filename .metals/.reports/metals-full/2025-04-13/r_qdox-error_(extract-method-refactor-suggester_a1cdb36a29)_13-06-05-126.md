error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9998.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9998.java
text:
```scala
t@@hrow new DeploymentUnitProcessingException("Failed to index deployment root for annotations", t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9998.java