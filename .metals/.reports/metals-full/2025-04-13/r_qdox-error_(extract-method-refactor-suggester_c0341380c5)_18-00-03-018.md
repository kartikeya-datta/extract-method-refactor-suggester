error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8403.java
text:
```scala
b@@uilder.startObject("indicesBoost");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8403.java