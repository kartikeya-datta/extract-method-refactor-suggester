error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13659.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13659.java
text:
```scala
private static final S@@tring VERSION = "2.1.20050630";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13659.java