error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1324.java
text:
```scala
r@@owMutationCtx.row_.setKey(rm.key());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1324.java