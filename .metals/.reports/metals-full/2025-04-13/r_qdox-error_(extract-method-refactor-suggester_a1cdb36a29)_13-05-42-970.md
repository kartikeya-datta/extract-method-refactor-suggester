error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8419.java
text:
```scala
q@@ualifiedType = currentType.isGenericType() ? (ReferenceBinding)scope.environment().convertToRawType(currentType, false /*do not force conversion of enclosing types*/) : currentType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8419.java