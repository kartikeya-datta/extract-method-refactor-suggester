error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8279.java
text:
```scala
i@@f (!formComponent.isEnabled())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8279.java