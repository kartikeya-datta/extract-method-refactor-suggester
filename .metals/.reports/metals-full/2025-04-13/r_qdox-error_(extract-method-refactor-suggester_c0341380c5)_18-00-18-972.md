error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5016.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5016.java
text:
```scala
private static final L@@ogger log = Logger.getLogger(EJBComponent.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5016.java