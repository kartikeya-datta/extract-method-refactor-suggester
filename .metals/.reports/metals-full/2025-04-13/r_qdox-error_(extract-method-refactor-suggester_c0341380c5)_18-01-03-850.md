error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/115.java
text:
```scala
S@@ystem.out.println("WARNING:  Eclipse platform not available for trace...overridden by system property org.eclipse.ecf.Trace");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/115.java