error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10178.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10178.java
text:
```scala
private static final i@@nt NUM_SPRITES = (int)Math.sqrt(100000 / 10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10178.java