error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1176.java
text:
```scala
M@@arkupContainer body = border.setBorderBodyContainer(border);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1176.java