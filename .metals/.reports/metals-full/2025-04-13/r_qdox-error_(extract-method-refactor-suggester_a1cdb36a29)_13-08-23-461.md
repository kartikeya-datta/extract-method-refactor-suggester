error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12553.java
text:
```scala
C@@lass<?> type = binding.getType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12553.java