error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7935.java
text:
```scala
r@@eturn getShell().getDisplay().getSystemImage(SWT.ICON_INFORMATION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7935.java