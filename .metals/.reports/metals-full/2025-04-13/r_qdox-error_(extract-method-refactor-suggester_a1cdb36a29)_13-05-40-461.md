error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14619.java
text:
```scala
c@@omponent.setModelValue(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14619.java