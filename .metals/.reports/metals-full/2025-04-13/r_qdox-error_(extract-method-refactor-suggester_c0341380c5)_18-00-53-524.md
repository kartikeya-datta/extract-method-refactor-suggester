error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9299.java
text:
```scala
g@@etLogger().info( "Compiling " + compileList.size() +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9299.java