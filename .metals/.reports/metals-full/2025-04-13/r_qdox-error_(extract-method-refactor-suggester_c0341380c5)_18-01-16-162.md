error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6282.java
text:
```scala
i@@nt lParam = OS.MAKELPARAM (dropDown ? rect.right - 1 : rect.left, y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6282.java