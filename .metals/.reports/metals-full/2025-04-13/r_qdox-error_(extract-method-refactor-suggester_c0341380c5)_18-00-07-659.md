error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2624.java
text:
```scala
p@@roxyController.shutdownNow();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2624.java