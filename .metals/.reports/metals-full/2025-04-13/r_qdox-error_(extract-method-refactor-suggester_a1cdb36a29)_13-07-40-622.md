error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2105.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2105.java
text:
```scala
final M@@arkup markup = application.getMarkupParser().read(markupResource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2105.java