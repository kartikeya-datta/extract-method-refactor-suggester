error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7361.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7361.java
text:
```scala
final O@@bjectIntOpenHashMap<String> allocs = new ObjectIntOpenHashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7361.java