error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2760.java
text:
```scala
a@@pp.getCallbacks().add(new GlfwInputProcessor(inputProcessor));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2760.java