error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3076.java
text:
```scala
t@@his.abortDueToInternalError(errorMessage, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3076.java