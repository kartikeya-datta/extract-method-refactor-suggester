error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3725.java
text:
```scala
s@@of.runWithProgress(progressRunnable);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3725.java