error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10129.java
text:
```scala
r@@esponse.add(new RealmGroup(getRealmName(), current));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10129.java