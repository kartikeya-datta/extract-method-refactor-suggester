error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1649.java
text:
```scala
p@@references.setDefault(CORE_JAVA_BUILD_CLEAN_OUTPUT_FOLDER, CLEAN);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1649.java