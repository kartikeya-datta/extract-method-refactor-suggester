error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9795.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9795.java
text:
```scala
protected v@@oid result (Object object) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9795.java