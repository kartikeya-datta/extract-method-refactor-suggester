error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2366.java
text:
```scala
r@@eturn IGenericType.CLASS_DECL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2366.java