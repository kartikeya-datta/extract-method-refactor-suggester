error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3134.java
text:
```scala
i@@f (lubTypes[k] == type || lubTypes[k].isEquivalentTo(type)) continue nextTypeCheck; // type found, jump to next one
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3134.java