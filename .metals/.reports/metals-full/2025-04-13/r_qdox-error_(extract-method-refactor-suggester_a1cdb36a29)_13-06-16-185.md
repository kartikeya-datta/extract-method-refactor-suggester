error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2969.java
text:
```scala
i@@nt setBounds (int x, int y, int width, int height, boolean move, boolean resize) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2969.java