error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/795.java
text:
```scala
x@@aDataSource.setDatabaseName(getShortDbName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/795.java