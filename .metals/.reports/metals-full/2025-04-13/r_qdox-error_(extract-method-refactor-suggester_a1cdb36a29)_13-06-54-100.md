error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6746.java
text:
```scala
o@@ut.append(format.getRecordSeparator());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6746.java