error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2632.java
text:
```scala
I@@ndexMetaData.Builder indexBuilder = IndexMetaData.builder(indexMetaData).putCustom(IndexWarmersMetaData.TYPE, warmers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2632.java