error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5353.java
text:
```scala
R@@aServicesFactory.createDeploymentService(inactive.getRegistration(), inactive.getConnectorXmlDescriptor(), inactive.getModule(), inactive.getServiceTarget(), inactive.getDeployment(), inactive.getDeployment(), raxml);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5353.java