error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1821.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1821.java
text:
```scala
public static final S@@tring NAME = "indices:admin/aliases/get";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1821.java