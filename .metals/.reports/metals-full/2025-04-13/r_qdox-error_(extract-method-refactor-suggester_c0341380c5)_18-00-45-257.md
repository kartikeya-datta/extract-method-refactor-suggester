error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17925.java
text:
```scala
i@@f (wrapWidth != -1 && lineWidth + run.width > wrapWidth && !run.tab && run.length > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17925.java