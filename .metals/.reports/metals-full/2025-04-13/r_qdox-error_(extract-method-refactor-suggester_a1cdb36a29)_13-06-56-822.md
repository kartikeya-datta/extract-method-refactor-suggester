error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1352.java
text:
```scala
c@@urrentTag = new NLSTag(pos + sourceDelta, end + sourceDelta, currentLine, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1352.java