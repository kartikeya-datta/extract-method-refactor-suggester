error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14805.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14805.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14805.java
text:
```scala
S@@ervletContext sc = getServletContext();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14805.java