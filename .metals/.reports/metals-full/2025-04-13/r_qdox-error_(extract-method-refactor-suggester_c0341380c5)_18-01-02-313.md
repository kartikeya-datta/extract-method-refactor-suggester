error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2891.java
text:
```scala
n@@ew ImportWizardLauncher(getFrameMediator()).launchWizard();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2891.java