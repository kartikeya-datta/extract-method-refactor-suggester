error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7662.java
text:
```scala
p@@roperties.put(Constants.SERVICE_RANKING, new Integer(Integer.MAX_VALUE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7662.java