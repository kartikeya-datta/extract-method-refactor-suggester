error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8783.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8783.java
text:
```scala
private O@@bject newInstance (Class type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8783.java