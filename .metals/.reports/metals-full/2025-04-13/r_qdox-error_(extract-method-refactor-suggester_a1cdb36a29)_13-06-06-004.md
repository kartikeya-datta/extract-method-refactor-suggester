error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5584.java
text:
```scala
i@@f (msg==ControlMessage.eobMessage()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5584.java