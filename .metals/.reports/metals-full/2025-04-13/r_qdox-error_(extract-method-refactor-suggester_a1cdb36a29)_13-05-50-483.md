error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8530.java
text:
```scala
t@@opDocsCollector = sort != null ? TopFieldCollector.create(sort, topN, true, topHitsContext.trackScores(), topHitsContext.trackScores(), false) : TopScoreDocCollector.create(topN, false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8530.java