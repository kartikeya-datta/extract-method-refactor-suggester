error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4416.java
text:
```scala
t@@hrow new IOException(Messages.exception_wrongFormat);
...
public static final String SIGNATURE= "INDEX VERSION 1.015"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4416.java