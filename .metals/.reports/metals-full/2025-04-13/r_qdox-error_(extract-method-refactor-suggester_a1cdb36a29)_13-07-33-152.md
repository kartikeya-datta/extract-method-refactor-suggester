error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5028.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5028.java
text:
```scala
private final M@@ap<String, Object> contextData = new HashMap<String, Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5028.java