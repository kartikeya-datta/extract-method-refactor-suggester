error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11056.java
text:
```scala
r@@eturn JGroupsDescriptions.getSubsystemDescribeDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11056.java