error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9006.java
text:
```scala
r@@eturn "[WebExternalResourceRequestTarget@" + hashCode() + " " + url + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9006.java