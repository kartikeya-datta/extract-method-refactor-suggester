error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7443.java
text:
```scala
L@@ocalizedFormats.UNPARSEABLE_COMPLEX_NUMBER, source);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7443.java