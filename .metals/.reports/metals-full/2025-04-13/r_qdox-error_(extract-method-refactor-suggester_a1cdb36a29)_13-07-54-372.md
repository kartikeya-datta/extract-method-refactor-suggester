error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10280.java
text:
```scala
r@@eturn (isDisposed() ? 0 : 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10280.java