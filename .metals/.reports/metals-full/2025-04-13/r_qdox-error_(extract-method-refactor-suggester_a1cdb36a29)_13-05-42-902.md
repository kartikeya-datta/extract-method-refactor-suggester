error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14020.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14020.java
text:
```scala
private final D@@riverRegistry value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14020.java