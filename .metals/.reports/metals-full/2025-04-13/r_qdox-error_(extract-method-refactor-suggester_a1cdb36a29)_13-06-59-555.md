error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6553.java
text:
```scala
i@@f (virtualFile.getLowerCaseName().endsWith(EAR_EXTENSION)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6553.java