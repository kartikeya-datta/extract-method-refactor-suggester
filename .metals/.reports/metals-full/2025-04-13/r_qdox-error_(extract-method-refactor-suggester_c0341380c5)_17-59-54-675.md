error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14112.java
text:
```scala
r@@esult = (result == null ? null : resolver.resolveStringValue(result));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14112.java