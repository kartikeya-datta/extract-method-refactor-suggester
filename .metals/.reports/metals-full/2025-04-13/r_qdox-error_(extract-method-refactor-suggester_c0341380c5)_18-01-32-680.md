error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11306.java
text:
```scala
i@@f (failure == null && namespaces.isDefined()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11306.java