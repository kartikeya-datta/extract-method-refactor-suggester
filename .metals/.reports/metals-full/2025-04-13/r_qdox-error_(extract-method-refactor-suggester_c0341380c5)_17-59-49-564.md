error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2855.java
text:
```scala
i@@f (comp.compare(array[i], pivotValue) < 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2855.java