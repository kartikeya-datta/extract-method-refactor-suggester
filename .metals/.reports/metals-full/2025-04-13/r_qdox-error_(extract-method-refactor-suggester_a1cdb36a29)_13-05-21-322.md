error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2881.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2881.java
text:
```scala
s@@cope.problemReporter().methodNeedBody(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2881.java