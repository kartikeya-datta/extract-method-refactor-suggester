error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6724.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6724.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6724.java
text:
```scala
i@@ndexShard.flush(new Engine.Flush().refresh(request.refresh()).full(request.full()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6724.java