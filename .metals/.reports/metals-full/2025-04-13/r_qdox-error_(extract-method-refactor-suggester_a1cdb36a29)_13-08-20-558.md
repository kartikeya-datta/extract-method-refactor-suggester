error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2008.java
text:
```scala
C@@ompactionManager.instance.doCompaction(store, sstables, (int) (System.currentTimeMillis() / 1000) - DatabaseDescriptor.getCFMetaData(TABLE1, "Standard1").getGcGraceSeconds());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2008.java