error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7055.java
text:
```scala
I@@ndexService indexService = indicesService.indexServiceSafe(request.index());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7055.java