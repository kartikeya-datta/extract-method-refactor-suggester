error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3512.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3512.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3512.java
text:
```scala
L@@ocale locale = Locale.ROOT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3512.java