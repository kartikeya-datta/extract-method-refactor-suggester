error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4019.java
text:
```scala
I@@MutableCommandHandlerService getMutableCommandHandlerService();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4019.java