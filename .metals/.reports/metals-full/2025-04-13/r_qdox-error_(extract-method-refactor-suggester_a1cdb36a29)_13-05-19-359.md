error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/201.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/201.java
text:
```scala
e@@nv.put(Context.PROVIDER_URL, "http-remoting://" + address + ":8080");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/201.java