error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5371.java
text:
```scala
h@@andle("Unable to delete directory " + d.getAbsolutePath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5371.java