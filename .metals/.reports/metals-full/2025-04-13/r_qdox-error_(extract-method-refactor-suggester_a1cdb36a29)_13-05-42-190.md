error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3343.java
text:
```scala
n@@ew Scanner(false /*comment*/, false /*whitespace*/, false /*nls*/, this.compilerOptions.sourceLevel >= CompilerOptions.JDK1_4 /*assert*/, null /*taskTags*/, null/*taskPriorities*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3343.java