error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/758.java
text:
```scala
r@@eturn lastIndexVersion != indexCommit.getGeneration();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/758.java