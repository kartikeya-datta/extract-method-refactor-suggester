error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6834.java
text:
```scala
P@@latformMBeanUtil.getResolver(PlatformMBeanConstants.OPERATING_SYSTEM));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6834.java