error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13024.java
text:
```scala
d@@estRect.y = Math.max(cellRect.y, cellRect.y + (cellRect.height - imageSize.height)/2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13024.java