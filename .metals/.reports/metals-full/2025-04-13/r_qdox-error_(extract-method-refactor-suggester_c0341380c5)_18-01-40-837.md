error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6830.java
text:
```scala
s@@uper(new Names(NAME, NAME, NAME, NAME), Defaults.BOOST, Defaults.FIELD_TYPE, null, null, null, null, docValuesFormat, null, null, ImmutableSettings.EMPTY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6830.java