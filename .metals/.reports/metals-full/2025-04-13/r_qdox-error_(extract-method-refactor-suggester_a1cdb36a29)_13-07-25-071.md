error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10402.java
text:
```scala
M@@ockito.verify(context).completeStep(OperationContext.RollbackHandler.NOOP_ROLLBACK_HANDLER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10402.java