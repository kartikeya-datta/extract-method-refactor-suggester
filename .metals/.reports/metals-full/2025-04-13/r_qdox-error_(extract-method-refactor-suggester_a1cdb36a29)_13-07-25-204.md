error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8020.java
text:
```scala
S@@tring reqPath = "http://" + System.getProperty("test.bind.address", "localhost") + ":8080/resteasy-osgi-client/rest/echo/" + message;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8020.java