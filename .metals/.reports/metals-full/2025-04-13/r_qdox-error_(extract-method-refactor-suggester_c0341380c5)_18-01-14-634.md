error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3442.java
text:
```scala
r@@rFromWire(NS_CNAME_PTRRecord rec, DNSInput in)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3442.java