error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12985.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12985.java
text:
```scala
final F@@ile instDir = getInstallDirectory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12985.java