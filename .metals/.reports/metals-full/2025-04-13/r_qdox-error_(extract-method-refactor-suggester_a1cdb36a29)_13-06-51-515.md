error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4592.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4592.java
text:
```scala
final S@@tring serverName = entry.getKey().getServerName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4592.java