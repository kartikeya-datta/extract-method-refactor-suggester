error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9846.java
text:
```scala
a@@ddIntegerFields(context, fields, count, valueAndBoost.boost());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9846.java