error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/856.java
text:
```scala
h@@ostTextField.requestFocus();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/856.java