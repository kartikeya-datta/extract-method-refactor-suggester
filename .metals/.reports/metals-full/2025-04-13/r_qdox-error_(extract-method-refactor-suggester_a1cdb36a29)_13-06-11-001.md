error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/709.java
text:
```scala
F@@ieldBinding[] fields = sourceType.unResolvedFields(); // https://bugs.eclipse.org/bugs/show_bug.cgi?id=301683
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/709.java