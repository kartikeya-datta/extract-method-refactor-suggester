error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4018.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4018.java
text:
```scala
public static final i@@nt REMOTE_TRANSACTION_PROPAGATION_INTERCEPTOR = 0x450;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4018.java