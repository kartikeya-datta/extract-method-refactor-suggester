error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3744.java
text:
```scala
S@@creenCaptureTest.class, BitmapFontTest.class, LabelScaleTest.class, GLEEDTest.class, GamepadTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3744.java