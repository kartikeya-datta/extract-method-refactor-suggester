error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7478.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7478.java
text:
```scala
p@@age.isBookmarkable() && page.getStatelessHint())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7478.java