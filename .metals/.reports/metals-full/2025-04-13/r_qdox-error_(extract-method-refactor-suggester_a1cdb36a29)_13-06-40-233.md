error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/534.java
text:
```scala
C@@lusterStateResponse clusterStateResponse = cluster().smartClient().admin().cluster().prepareState().setMasterNodeTimeout("500ms").get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/534.java