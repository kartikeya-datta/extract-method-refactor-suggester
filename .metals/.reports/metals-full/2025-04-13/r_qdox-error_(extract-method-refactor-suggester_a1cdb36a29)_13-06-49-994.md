error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13822.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13822.java
text:
```scala
protected V@@ector<ImageOperation> instructions = new Vector<ImageOperation>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13822.java