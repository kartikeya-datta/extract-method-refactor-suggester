error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2249.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2249.java
text:
```scala
public C@@ollection<Filter> getDeployedServiceImport();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2249.java