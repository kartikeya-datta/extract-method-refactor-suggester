error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10277.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10277.java
text:
```scala
final C@@lass clazz = classLoader.loadClass( "org.apache.myrmidon.Main" );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10277.java