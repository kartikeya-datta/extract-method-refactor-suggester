error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6812.java
text:
```scala
D@@ocIdSet docIdSet = filter.getDocIdSet(hitContext.readerContext(), null); // null is fine, since we filter by hitContext.docId()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6812.java