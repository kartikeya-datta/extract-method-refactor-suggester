error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7456.java
text:
```scala
L@@ist<Terms.Bucket> buckets = new ArrayList<>(((Terms) aggregations.get(0)).getBuckets());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7456.java