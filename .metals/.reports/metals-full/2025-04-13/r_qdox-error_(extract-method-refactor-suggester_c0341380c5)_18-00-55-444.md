error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9928.java
text:
```scala
Q@@ueriesLoaderCollector queryCollector = new QueriesLoaderCollector(PercolatorQueriesRegistry.this, logger, mapperService, indexFieldDataService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9928.java