error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7910.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7910.java
text:
```scala
a@@ssert sizeInBytes >= 0 : "When reducing circuit breaker, it should be adjusted with a number higher or equal to 0 and not [" + sizeInBytes + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7910.java