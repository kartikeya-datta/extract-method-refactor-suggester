error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8209.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8209.java
text:
```scala
d@@eclaringClass = ((ParameterizedTypeBinding) declaringClass).genericType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8209.java