error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13490.java
text:
```scala
a@@ssertEquals(BASE, targetInfo.getReleasePatchID());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13490.java