error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1038.java
text:
```scala
s@@ession.newRequestCycle(request, response).request();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1038.java