error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14389.java
text:
```scala
r@@et = Utility.copyInstruction(ih.getInstruction());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14389.java