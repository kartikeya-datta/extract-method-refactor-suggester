error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13951.java
text:
```scala
c@@onversionService.addGenericConverter(new IdToEntityConverter(conversionService));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13951.java