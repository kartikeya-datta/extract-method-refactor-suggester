error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7260.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7260.java
text:
```scala
private final L@@ist<LifecycleListener> listeners = new CopyOnWriteArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7260.java