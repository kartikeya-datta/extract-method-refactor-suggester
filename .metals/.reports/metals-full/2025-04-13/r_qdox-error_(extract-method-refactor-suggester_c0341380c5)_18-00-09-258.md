error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9853.java
text:
```scala
r@@eturn "JCUNode("/*nonNLS*/ + fUnit.getFileName() + ")"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9853.java