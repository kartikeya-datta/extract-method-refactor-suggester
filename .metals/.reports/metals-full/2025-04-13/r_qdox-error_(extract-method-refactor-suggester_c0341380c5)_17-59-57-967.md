error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7074.java
text:
```scala
i@@f (Cairo.cairo_version () >= Cairo.CAIRO_VERSION_ENCODE(1, 4, 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7074.java