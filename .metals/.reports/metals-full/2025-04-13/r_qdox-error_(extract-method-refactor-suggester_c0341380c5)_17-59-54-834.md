error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9930.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9930.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9930.java
text:
```scala
a@@ssigneeTask.edit(arguments.getString(AssigneeDialogFragment.ARG_SELECTED));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9930.java