error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4263.java
text:
```scala
c@@ycle.getSession().setProperty("signin.user", "jonathan");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4263.java