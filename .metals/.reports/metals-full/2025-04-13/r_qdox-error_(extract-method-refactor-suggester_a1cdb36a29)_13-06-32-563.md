error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10343.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10343.java
text:
```scala
private v@@oid checkEquals(final Object obj, final boolean expected) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10343.java