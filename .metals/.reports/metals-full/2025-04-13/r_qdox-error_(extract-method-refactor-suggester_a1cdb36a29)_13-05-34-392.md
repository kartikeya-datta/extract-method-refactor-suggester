error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3401.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3401.java
text:
```scala
public static final V@@ersion V_1_0_0_Beta1 = new Version(V_1_0_0_Beta1_ID, false, org.apache.lucene.util.Version.LUCENE_45);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3401.java