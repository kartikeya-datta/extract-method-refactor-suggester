error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2061.java
text:
```scala
r@@eturn "SourceElementTable("/*nonNLS*/ + fPackageTable + ")"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2061.java