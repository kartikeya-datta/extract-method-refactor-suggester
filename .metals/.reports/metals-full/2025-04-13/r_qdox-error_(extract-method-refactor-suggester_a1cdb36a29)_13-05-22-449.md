error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15511.java
text:
```scala
r@@eturn lookupEnvironment.createArrayType(makeTypeBinding(typeX), dim);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15511.java