error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11969.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11969.java
text:
```scala
public S@@tatelessSessionComponentConfiguration(final StatelessComponentDescription description) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11969.java