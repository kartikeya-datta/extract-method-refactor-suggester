error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13849.java
text:
```scala
i@@f ((parent.state & CANVAS) == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13849.java