error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/229.java
text:
```scala
S@@ystem.out.println("adding protocol = " + protocol.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/229.java