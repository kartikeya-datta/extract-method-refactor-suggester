error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3145.java
text:
```scala
w@@.shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3145.java