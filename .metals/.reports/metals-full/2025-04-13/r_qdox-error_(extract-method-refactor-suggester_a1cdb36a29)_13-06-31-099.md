error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7621.java
text:
```scala
s@@tackshare.sendShareConsoleSelection(entry.getRoster().getUser().getName(), entry.getUser().getID(), selection.getText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7621.java