error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14949.java
text:
```scala
v@@oid deflate() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14949.java