error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10233.java
text:
```scala
A@@vatar.bind(activity, avatarView, comment.getUser().getLogin(), comment.getUser().getAvatarUrl());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10233.java