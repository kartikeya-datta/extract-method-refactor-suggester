error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10195.java
text:
```scala
r@@eturn (maxInactiveInterval > 0) ? (System.currentTimeMillis() - this.lastAccessedTime.getTime()) > maxInactiveInterval : false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10195.java