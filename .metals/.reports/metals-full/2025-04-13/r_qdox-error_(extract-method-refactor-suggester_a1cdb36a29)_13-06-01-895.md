error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8005.java
text:
```scala
l@@ogger.error("==> Test Failure [{}]", extractTestName(result));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8005.java