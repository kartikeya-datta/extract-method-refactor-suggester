error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/160.java
text:
```scala
c@@at.addAppender(new ConsoleAppender(layout, ConsoleAppender.SYSTEM_OUT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/160.java