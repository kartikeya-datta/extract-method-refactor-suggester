error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5720.java
text:
```scala
i@@f (exclusionPatterns != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5720.java