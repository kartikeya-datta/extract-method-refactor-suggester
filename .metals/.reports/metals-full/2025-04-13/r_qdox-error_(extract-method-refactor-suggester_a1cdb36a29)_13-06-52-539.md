error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7949.java
text:
```scala
c@@.debug("Hello");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7949.java