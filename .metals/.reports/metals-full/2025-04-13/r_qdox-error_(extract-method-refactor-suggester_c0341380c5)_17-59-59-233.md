error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3204.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3204.java
text:
```scala
final b@@oolean restoreConfiguration = PatchResourceDefinition.RESET_CONFIGURATION.resolveModelAttribute(context, operation).asBoolean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3204.java