error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/487.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/487.java
text:
```scala
...
public class BlockedJobsDialog extends IconAndMessageDialog {
 ...
 SWT.RESIZE | SWT.MAX | getDefaultOrientation() | SWT.SHEET);
		// no close button
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/487.java