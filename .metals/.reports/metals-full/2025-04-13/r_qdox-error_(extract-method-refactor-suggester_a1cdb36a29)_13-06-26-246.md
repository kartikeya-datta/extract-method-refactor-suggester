error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9219.java
text:
```scala
m@@erged.addAll((Set<E>) parent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9219.java