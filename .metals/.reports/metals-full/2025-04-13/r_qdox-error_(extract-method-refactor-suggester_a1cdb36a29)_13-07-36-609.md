error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18140.java
text:
```scala
i@@nt flags = SWT.DRAW_MNEMONIC | SWT.DRAW_TRANSPARENT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18140.java