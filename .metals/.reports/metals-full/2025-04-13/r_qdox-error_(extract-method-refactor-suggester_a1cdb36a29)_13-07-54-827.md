error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/42.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/42.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/42.java
text:
```scala
final N@@umericDocValues norms = readerContext.reader().getNormValues(field);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/42.java