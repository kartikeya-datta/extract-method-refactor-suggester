error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1905.java
text:
```scala
a@@dd(new DefaultDataTable("contacts", Arrays.asList(cols), getDataProvider(), 5));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1905.java