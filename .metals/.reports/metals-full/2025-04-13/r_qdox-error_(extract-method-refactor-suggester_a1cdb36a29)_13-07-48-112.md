error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4021.java
text:
```scala
t@@hrow MESSAGES.methodNameIsNull();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4021.java