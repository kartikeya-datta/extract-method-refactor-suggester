error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11994.java
text:
```scala
n@@ew String(unitResult.fileName),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11994.java