error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2938.java
text:
```scala
j@@Edit.getIntegerProperty("history",25));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2938.java