error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3942.java
text:
```scala
i@@f (lastDot != topLevelTypeName.length() || !topLevelTypeName.regionMatches(0, cuName, 0, lastDot))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3942.java