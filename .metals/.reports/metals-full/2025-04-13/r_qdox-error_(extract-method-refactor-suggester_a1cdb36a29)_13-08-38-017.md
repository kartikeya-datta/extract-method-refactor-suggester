error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6508.java
text:
```scala
t@@hrow new BuildException("archive '" + name + "' is empty");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6508.java