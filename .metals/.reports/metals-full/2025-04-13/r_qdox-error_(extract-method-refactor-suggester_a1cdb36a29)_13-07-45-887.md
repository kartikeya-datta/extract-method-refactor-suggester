error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9067.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9067.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9067.java
text:
```scala
protected abstract b@@oolean generateInfos(OpenableElementInfo info, IProgressMonitor pm, Map newElements, IResource underlyingResource) throws JavaModelException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9067.java