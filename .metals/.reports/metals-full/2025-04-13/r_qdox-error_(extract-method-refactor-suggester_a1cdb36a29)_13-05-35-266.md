error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16197.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16197.java
text:
```scala
public V@@etoableCallback getCallback();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16197.java