error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11959.java
text:
```scala
v@@isitFormComponentsPostOrder(new ValidationVisitor()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11959.java