error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9444.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9444.java
text:
```scala
private final C@@SVLexer lexer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9444.java