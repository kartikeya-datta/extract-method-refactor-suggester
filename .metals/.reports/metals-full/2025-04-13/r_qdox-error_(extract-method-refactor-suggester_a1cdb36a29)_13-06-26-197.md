error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1422.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1422.java
text:
```scala
i@@f ((style & SWT.BORDER) == 0) info |= Browser.DOCHOSTUIFLAG_NO3DOUTERBORDER;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1422.java