error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/968.java
text:
```scala
G@@L20 gl = Gdx.gl20;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/968.java