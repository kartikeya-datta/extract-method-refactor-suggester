error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8439.java
text:
```scala
p@@arseContext.addNamedFilter(filterName, new CustomQueryWrappingFilter(parentConstantScoreQuery));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8439.java