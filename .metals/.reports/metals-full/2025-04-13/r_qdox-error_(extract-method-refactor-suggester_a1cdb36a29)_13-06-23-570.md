error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3133.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3133.java
text:
```scala
static v@@oid registerTransformers11x(ResourceTransformationDescriptionBuilder parentBuilder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3133.java