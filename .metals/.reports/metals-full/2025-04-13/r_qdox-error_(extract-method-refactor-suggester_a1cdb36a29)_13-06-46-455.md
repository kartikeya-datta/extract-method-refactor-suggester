error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5429.java
text:
```scala
f@@ilterIterator.setPredicate(NotNullPredicate.notNullPredicate());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5429.java