error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10889.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10889.java
text:
```scala
private final transient B@@yteArrayOutputStream bytearray;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10889.java