error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18160.java
text:
```scala
n@@ew MarkupParserFactory(this, new PrependContextPathHandler()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18160.java