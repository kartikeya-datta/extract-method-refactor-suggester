error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4118.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4118.java
text:
```scala
protected S@@tatefulTimeoutInfo fromAnnotation(final AnnotationInstance annotationInstance, final boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4118.java