error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3583.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3583.java
text:
```scala
r@@eturn deploymentUnitServiceName.append("marshalling");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3583.java