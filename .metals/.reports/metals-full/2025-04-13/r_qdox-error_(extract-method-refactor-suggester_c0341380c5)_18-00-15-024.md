error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2145.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2145.java
text:
```scala
private static final L@@og logger = LogFactory.getLog(ResourceUrlEncodingFilter.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2145.java