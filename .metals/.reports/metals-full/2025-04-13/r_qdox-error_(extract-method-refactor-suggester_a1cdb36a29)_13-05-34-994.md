error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1614.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1614.java
text:
```scala
public b@@oolean sendsNoCacheInstruction() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1614.java