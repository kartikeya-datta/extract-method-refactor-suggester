error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1344.java
text:
```scala
v@@oid setContextBindingDefinitions(List contextBindingDefinitions);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1344.java