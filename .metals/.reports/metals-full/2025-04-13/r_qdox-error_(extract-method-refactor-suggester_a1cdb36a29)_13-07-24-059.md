error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7439.java
text:
```scala
M@@ap<String, Object> map = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7439.java