error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7065.java
text:
```scala
b@@uilder.rawField("_source", source, offset, length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7065.java