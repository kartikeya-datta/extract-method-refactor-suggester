error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5753.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5753.java
text:
```scala
W@@ebFrame mainFrame = result.mainFrame();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5753.java