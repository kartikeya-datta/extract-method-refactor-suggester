error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8080.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8080.java
text:
```scala
w@@hile (++i < buffer2.length && buffer2[i] != ' ') {/*empty*/}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8080.java