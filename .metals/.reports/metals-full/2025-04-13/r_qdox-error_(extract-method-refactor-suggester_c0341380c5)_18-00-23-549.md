error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2972.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2972.java
text:
```scala
b@@ehaviorListener.onRequest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2972.java