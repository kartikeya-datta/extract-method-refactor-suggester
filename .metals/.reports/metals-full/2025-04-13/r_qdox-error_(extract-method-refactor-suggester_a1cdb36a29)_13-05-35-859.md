error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9950.java
text:
```scala
i@@f (filename.toLowerCase().endsWith(".ico")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9950.java