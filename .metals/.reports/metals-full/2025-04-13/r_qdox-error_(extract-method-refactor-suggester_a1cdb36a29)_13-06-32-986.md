error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3567.java
text:
```scala
s@@b.append("    index    : recovered_files [").append(recoveryStatus.index().numberOfFiles()).append("] with total_size [").append(recoveryStatus.index().totalSize()).append("], throttling_wait [").append(recoveryStatus.index().throttlingWaitTime()).append("]\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3567.java