error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16719.java
text:
```scala
i@@nt x = orderedColumns [i].getX () + orderedColumns [i].width - 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16719.java