error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1381.java
text:
```scala
P@@ersistenceUnitMetadataHolder result = new PersistenceUnitMetadataHolder(PUs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1381.java