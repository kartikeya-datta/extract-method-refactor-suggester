error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2328.java
text:
```scala
s@@etDefaultHandler(WordCharacterHandler.IGNORE_LB_ESCAPE_OFF);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2328.java