error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7589.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7589.java
text:
```scala
public static final F@@ieldType TTL_FIELD_TYPE = new FieldType(LongFieldMapper.Defaults.FIELD_TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7589.java