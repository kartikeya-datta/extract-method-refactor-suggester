error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11041.java
text:
```scala
e@@nv = getEnvironmentVariables(client, "slave", "other-two", "other-sockets");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11041.java