error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4287.java
text:
```scala
i@@f (body != null) body.delete();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4287.java