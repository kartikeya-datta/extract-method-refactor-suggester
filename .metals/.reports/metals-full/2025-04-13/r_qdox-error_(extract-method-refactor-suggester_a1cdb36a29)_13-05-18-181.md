error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1471.java
text:
```scala
S@@tring queryID;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1471.java