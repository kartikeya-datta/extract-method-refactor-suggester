error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7703.java
text:
```scala
n@@ew Label(cellItem, componentId, new PropertyModel(rowModel, property));

/*
 * $Id: PropertyPopulator.java 5840 2006-05-24 20:49:09 +0000 (Wed, 24 May 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7703.java