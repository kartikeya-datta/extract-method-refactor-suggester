error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7339.java
text:
```scala
r@@eturn new SpanMultiTermQueryWrapper<>((MultiTermQuery) subQuery);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7339.java