error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1872.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1872.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1872.java
text:
```scala
private A@@novaStats(int dfbg, int dfwg, double F) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1872.java