error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2919.java
text:
```scala
g@@etFrameMediator()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2919.java