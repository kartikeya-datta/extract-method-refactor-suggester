error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3521.java
text:
```scala
S@@tring variant = filterAction.get("markvariant");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3521.java