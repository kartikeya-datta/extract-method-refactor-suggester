error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6764.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6764.java
text:
```scala
public v@@oid receiveEventBatch(String identifier, List eventBatchEntries);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6764.java