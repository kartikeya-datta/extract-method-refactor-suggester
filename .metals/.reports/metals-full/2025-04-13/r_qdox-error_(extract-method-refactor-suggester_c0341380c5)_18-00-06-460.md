error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5706.java
...
```java
offset: 796
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5706.java
text:
```scala
...
p@@ackage org.columba.core.action;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5706.java