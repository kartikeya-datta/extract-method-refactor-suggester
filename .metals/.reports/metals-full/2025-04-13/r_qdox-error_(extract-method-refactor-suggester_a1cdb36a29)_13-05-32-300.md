error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9274.java
text:
```scala
t@@his.categoryId = original.getCategoryId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9274.java