error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11737.java
text:
```scala
p@@ublic class BorderRenderWrappedTestPage_1 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11737.java