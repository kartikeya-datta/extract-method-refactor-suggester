error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9701.java
text:
```scala
l@@ocal.isBlankFinal() ? IProblem.DuplicateFinalLocalInitialization : IProblem.NonBlankFinalLocalAssignment,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9701.java