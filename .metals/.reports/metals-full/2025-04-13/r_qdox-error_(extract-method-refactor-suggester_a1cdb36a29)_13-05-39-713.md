error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2181.java
text:
```scala
b@@uilder.treeLevelsByDistance(DistanceUnit.parse(fieldNode.toString(), DistanceUnit.DEFAULT, DistanceUnit.DEFAULT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2181.java