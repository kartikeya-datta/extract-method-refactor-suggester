error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3560.java
text:
```scala
r@@eturn userService.getUser();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3560.java