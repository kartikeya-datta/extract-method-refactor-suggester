error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9891.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9891.java
text:
```scala
private S@@tring[] headerKeys = { "From", "To", "Date", "Subject" };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9891.java