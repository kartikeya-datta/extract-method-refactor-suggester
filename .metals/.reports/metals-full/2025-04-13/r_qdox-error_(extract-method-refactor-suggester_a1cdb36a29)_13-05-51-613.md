error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14988.java
text:
```scala
p@@ublic final class UTF16Reader
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14988.java