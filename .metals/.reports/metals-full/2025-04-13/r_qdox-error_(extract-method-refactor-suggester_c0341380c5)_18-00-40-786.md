error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2478.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2478.java
text:
```scala
public v@@oid setLengthOfReplacedText(int length) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2478.java