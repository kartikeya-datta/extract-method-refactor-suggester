error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1344.java
text:
```scala
i@@f ((state & CANVAS) != 0) takeFocus = hooksKeys ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1344.java