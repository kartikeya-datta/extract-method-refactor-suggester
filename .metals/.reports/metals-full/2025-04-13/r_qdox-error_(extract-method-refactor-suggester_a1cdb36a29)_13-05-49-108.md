error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8138.java
text:
```scala
i@@nt start = retrieveStartBlockPosition(allocation.anonymousType.sourceEnd, allocation.anonymousType.bodyEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8138.java