error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9244.java
text:
```scala
C@@ollection<?> col = (Collection<?>) mapValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9244.java