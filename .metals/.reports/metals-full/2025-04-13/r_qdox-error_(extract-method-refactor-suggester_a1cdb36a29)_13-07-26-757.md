error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5763.java
text:
```scala
b@@uffer.append(RESOURCES_PATH_PREFIX);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5763.java