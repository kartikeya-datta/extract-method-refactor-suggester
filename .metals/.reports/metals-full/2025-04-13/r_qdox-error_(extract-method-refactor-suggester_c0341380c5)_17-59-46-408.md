error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6899.java
text:
```scala
i@@f (formatter != null && formatter != ValueFormatter.RAW) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6899.java