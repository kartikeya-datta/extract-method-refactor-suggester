error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4885.java
text:
```scala
n@@ull, // don't call beginTask on the monitor (see http://bugs.eclipse.org/bugs/show_bug.cgi?id=3717)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4885.java