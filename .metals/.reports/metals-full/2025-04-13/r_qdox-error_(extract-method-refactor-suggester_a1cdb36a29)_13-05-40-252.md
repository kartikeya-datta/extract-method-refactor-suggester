error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9485.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9485.java
text:
```scala
public final M@@arkupStream getAssociatedMarkupStream(final boolean throwException)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9485.java