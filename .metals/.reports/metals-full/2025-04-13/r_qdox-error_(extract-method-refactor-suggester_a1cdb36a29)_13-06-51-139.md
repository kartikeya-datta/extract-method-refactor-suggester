error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12658.java
text:
```scala
i@@f ((style & SWT.READ_ONLY) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12658.java