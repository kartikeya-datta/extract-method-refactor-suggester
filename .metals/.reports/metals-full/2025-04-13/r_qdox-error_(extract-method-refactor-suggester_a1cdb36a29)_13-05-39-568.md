error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17469.java
text:
```scala
r@@c = XPCOM.NS_NewLocalFile (path.getAddress (), 1, result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17469.java