error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12468.java
text:
```scala
r@@eturn getSortProperty() != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12468.java