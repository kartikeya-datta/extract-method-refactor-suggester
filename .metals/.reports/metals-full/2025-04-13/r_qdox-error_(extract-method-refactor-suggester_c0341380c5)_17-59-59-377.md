error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3312.java
...
```java
offset: 28
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3312.java
text:
```scala
public static synchronized S@@ocketFactory getDefault() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3312.java