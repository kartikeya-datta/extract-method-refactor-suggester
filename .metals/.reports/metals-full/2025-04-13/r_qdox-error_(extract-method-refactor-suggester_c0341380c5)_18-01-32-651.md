error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8123.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8123.java
text:
```scala
m@@arkupId + "\"[^>]*?>.*");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8123.java