error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10179.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10179.java
text:
```scala
private static S@@tring getURLScheme(String str) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10179.java