error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13161.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13161.java
text:
```scala
final M@@arkupContainer parent = current.getParent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13161.java