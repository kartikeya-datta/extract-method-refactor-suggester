error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2102.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2102.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2102.java
text:
```scala
i@@f ((actualExecutionTime.size()*1.25) < expectedNumberOfExecutions) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2102.java