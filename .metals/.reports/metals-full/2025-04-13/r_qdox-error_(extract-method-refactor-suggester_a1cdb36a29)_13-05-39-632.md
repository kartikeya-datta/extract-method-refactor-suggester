error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1826.java
text:
```scala
i@@f (revertChange == null || revertChange.equals("")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1826.java