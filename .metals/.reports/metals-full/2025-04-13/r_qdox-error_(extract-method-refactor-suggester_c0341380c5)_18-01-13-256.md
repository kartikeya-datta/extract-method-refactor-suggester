error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2254.java
text:
```scala
p@@roductName = ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2254.java