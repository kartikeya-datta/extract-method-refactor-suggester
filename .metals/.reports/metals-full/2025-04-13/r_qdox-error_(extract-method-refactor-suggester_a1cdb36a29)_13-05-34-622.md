error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8911.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8911.java
text:
```scala
r@@eturn (List<?>) ((CollectionProperty) prop).getObjectValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8911.java