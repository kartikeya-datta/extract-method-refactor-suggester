error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9216.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9216.java
text:
```scala
volatile C@@lass<?> resolvedElementType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9216.java