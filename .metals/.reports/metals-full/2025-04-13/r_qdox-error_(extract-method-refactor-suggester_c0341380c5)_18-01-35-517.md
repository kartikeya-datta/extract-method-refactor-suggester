error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4118.java
text:
```scala
i@@f (contexts[i] != null || contexts [i] == context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4118.java