error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6913.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6913.java
text:
```scala
public P@@agingNavigationLink(MarkupContainer parent,final String id,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6913.java