error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2117.java
text:
```scala
n@@ew BytesType(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2117.java