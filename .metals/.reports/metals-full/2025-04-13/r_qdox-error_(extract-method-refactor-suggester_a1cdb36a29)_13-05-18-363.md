error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/640.java
text:
```scala
R@@unnablePostTest.class, Vector2dTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/640.java