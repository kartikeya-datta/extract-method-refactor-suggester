error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3986.java
...
```java
offset: 51
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3986.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3986.java