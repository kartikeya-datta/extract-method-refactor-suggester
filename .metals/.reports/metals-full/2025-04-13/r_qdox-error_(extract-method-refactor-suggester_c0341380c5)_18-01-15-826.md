error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9731.java
text:
```scala
i@@f (org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(resourceName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9731.java