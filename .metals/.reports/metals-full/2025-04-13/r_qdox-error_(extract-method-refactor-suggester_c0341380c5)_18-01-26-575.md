error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1373.java
text:
```scala
R@@ModuleIssueTypeManager.removeFromCache(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1373.java