error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8412.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8412.java
text:
```scala
M@@ap<String, Object> getModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8412.java