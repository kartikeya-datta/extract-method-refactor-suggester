error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/562.java
text:
```scala
i@@nB = ZipUtil.adjustToLong(inf.getTotalIn());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/562.java