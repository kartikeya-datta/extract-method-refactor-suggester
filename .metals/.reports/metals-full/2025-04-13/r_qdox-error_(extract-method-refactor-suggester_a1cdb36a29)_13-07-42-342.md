error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2687.java
text:
```scala
b@@oolean fixPaint = findBackgroundControl () != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2687.java