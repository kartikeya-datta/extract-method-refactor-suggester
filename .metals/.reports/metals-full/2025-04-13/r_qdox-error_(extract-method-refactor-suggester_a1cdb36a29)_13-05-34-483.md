error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8729.java
text:
```scala
F@@lowInfo actionInfo = // TODO: shouldn't it use optimized constant here?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8729.java