error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4434.java
text:
```scala
p@@ublic class RetrieveFTCAdapterFactory extends
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4434.java