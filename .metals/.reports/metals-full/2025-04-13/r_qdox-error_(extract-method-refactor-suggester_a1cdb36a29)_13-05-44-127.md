error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9790.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9790.java
text:
```scala
final S@@tring name = header.getId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9790.java