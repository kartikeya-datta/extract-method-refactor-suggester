error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10262.java
text:
```scala
C@@ache<K, T> createCache(String beanName, IdentifierFactory<K> identifierFactory, StatefulObjectFactory<T> factory, PassivationManager<K, T> passivationManager, StatefulTimeoutInfo timeout);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10262.java