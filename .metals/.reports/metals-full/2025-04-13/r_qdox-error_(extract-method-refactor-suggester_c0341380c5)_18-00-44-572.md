error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10545.java
text:
```scala
i@@f (!instance.startup) setTitleText ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10545.java