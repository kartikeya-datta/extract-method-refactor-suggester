error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7678.java
text:
```scala
S@@tring versionID = "0.201.1"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7678.java