error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9672.java
text:
```scala
r@@eturn new org.elasticsearch.index.fielddata.FieldDataType("float");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9672.java