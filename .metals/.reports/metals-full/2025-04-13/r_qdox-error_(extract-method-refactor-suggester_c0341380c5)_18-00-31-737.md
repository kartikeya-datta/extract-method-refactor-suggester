error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12025.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12025.java
text:
```scala
final M@@odelNode submodel = context.readModel(PathAddress.EMPTY_ADDRESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12025.java