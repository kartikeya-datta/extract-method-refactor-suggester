error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2519.java
text:
```scala
t@@gt.add(getPage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2519.java