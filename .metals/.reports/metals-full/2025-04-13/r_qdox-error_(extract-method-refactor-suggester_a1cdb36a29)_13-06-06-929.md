error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4752.java
text:
```scala
c@@ontext.setDepthTest(GL10.GL_LEQUAL, 0, 1, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4752.java