error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1929.java
text:
```scala
r@@eturn 0x7FFFFFFF & (int) itemID ^ (int) (itemID >>> 32);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1929.java