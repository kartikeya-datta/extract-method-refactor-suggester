error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/856.java
text:
```scala
i@@nt pointerIndex = (event.getAction() & MotionEvent.ACTION_POINTER_ID_MASK) >> MotionEvent.ACTION_POINTER_ID_SHIFT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/856.java