error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5026.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5026.java
text:
```scala
private final S@@tatelessSessionComponent component;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5026.java