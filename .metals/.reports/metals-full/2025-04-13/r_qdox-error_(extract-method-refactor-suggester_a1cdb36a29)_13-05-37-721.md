error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1888.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1888.java
text:
```scala
public static final S@@tring START_RECOVERY = "internal:index/shard/recovery/start_recovery";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1888.java