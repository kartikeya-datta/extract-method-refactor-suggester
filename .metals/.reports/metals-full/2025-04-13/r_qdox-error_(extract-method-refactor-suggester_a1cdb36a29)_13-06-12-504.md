error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10085.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10085.java
text:
```scala
final E@@JBRemoteConnectorService service = new EJBRemoteConnectorService((byte) 0x01, new String[] {"river", "java-serial"});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10085.java