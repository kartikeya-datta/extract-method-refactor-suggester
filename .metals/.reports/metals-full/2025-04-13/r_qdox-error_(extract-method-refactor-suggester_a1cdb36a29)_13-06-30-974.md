error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/589.java
text:
```scala
i@@nput.justTouched = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/589.java