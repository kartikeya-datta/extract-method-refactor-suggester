error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7459.java
text:
```scala
H@@ashMap<String, Object> scopes = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7459.java