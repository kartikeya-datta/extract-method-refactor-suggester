error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6612.java
text:
```scala
t@@hrow new RuntimeException(e.getMessage() + " in " + moduleLoader, e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6612.java