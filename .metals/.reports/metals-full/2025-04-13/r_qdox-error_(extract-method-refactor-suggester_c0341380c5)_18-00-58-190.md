error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/478.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/478.java
text:
```scala
N@@SAttributedString attribStr = createString(text, null, foreground, (style & SWT.WRAP) == 0 ? style : 0, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/478.java