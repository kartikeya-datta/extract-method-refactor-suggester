error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6574.java
text:
```scala
t@@emplateContext = Model.ofMap(map);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6574.java