error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3505.java
text:
```scala
r@@eq.getRequestDispatcher( pathPrefix == null ? path : pathPrefix + path ).forward( request, response );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3505.java