error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7349.java
text:
```scala
i@@f (p1.size() != p2.size())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7349.java