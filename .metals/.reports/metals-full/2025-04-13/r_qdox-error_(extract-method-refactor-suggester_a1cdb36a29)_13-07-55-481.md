error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3339.java
text:
```scala
r@@eturn (stats.getTotalTermFreq()+1F) / (stats.getNumberOfFieldTokens()+1F);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3339.java