error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6904.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6904.java
text:
```scala
public F@@ormComponentLabel(MarkupContainer parent,String id, FormComponent fc)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6904.java