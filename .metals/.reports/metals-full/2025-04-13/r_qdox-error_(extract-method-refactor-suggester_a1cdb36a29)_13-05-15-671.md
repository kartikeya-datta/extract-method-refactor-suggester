error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/106.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/106.java
text:
```scala
c@@lient.admin().indices().optimize(optimizeRequest, new ActionListener<OptimizeResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/106.java