error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14858.java
text:
```scala
t@@hrow new IllegalStateException("View of type " + businessInterface + " not found on bean " + this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14858.java