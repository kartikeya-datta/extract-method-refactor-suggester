error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11776.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11776.java
text:
```scala
private static M@@oduleIdentifier JUNIT_ID = ModuleIdentifier.create("org.junit");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11776.java