error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7525.java
text:
```scala
N@@SAutoreleasePool pool = checkGC(CLIPPING | TRANSFORM | FONT | FOREGROUND_FILL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7525.java