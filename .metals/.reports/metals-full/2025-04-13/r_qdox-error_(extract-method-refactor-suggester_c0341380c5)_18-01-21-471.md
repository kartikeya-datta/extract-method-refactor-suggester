error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18313.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18313.java
text:
```scala
private static final R@@andom rand = new Random();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18313.java