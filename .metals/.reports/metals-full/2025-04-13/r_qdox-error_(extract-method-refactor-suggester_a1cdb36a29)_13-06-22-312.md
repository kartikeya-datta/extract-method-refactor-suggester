error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1581.java
text:
```scala
r@@eturn "get [" + index + "][" + type + "][" + id + "]: routing [" + routing + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1581.java