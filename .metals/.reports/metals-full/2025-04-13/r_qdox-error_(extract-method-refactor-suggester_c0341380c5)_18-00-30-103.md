error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15316.java
text:
```scala
r@@eturn Constants.XML_VERSION_ERROR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15316.java