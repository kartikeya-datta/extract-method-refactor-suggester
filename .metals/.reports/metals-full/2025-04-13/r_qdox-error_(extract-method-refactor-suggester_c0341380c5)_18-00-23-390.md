error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9487.java
text:
```scala
a@@dd(new AjaxFallbackLink<Void>("ajaxback")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9487.java