error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/661.java
text:
```scala
p@@ublic final class BoundingBox
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/661.java