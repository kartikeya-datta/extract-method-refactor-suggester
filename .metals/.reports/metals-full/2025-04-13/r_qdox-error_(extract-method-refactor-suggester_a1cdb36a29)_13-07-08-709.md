error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2174.java
text:
```scala
t@@his.bytes = LZFEncoder.encode(result.result, result.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2174.java