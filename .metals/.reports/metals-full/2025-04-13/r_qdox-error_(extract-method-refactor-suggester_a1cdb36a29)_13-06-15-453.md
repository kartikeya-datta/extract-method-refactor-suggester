error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/203.java
text:
```scala
S@@tring str = "ExtendedStringLiteral{"+ new String(source) +"}"; //$NON-NLS-2$ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/203.java