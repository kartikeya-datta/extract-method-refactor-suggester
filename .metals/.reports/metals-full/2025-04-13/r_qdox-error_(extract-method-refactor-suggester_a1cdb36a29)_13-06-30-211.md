error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2085.java
text:
```scala
s@@uper(null, new TestBundleContext(), null, null, null, null, null, null, proxyManager);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2085.java