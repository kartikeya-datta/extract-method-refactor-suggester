error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7239.java
text:
```scala
M@@apBuilder<Action, TransportActionNodeProxy> actionsBuilder = new MapBuilder<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7239.java