error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/876.java
text:
```scala
s@@cope.problemReporter().unnecessaryTypeArgumentsForMethodInvocation(this.binding, this.genericTypeArguments, this.typeArguments);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/876.java