error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/990.java
text:
```scala
i@@f (this.indexSelector == null) { // only check once. As long as this job is used, it will keep the same index picture
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/990.java