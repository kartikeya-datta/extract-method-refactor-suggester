error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2456.java
text:
```scala
S@@tring label = labelText.toString().split("/")[1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2456.java