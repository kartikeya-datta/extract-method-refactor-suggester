error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10305.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10305.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10305.java
text:
```scala
i@@f (type == OS.NSLeftMouseDown && nsEvent.clickCount() == 1 && (control.state & Widget.DRAG_DETECT) != 0 && control.hooks (SWT.DragDetect)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10305.java