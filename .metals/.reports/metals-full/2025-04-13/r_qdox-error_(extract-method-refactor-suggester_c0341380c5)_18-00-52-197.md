error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9817.java
text:
```scala
i@@f(hc != null && hc.isRunning()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9817.java