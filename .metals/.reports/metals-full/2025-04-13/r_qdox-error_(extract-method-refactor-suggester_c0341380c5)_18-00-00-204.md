error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1688.java
text:
```scala
t@@hrow new UnsupportedOperationException("DimensionUtility is just a container for static methods");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1688.java