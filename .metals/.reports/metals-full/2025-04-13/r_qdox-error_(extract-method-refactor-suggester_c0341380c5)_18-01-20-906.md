error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1468.java
text:
```scala
s@@uper(controller, "Show View",controller.getViewItem().get("id"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1468.java