error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/185.java
text:
```scala
T@@ypeCode tc = TypeCode.valueOf(typename.toUpperCase());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/185.java