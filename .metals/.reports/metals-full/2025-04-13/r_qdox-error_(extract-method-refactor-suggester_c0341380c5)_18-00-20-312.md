error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13014.java
text:
```scala
i@@f (defaultCommand == null || defaultCommand.length() == 0) defaultCommand = "open"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13014.java