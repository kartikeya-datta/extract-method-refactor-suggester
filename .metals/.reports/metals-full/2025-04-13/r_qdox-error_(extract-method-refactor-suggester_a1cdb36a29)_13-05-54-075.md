error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/326.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/326.java
text:
```scala
public D@@rawable up, down, checked, over, disabled;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/326.java