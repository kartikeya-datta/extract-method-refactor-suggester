error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9653.java
text:
```scala
a@@ppLock.notifyAll();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9653.java