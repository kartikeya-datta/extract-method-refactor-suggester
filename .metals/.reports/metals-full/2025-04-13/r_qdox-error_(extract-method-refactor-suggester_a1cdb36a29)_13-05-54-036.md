error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6550.java
...
```java
offset: 1090
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6550.java
text:
```scala
...
*/
p@@ackage org.jboss.as.host.controller.mgmt;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6550.java