error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6012.java
text:
```scala
p@@rivate class FileUploadForm extends Form<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6012.java