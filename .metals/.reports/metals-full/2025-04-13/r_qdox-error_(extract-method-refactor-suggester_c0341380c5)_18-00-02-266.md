error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7549.java
text:
```scala
s@@uper(XMLStreamConstants.END_ELEMENT, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7549.java