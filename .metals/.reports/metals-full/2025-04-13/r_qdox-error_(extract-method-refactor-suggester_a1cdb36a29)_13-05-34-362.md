error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4145.java
text:
```scala
a@@ssertSame(Connector.Type.HTTP, new UndertowConnector(new HttpListenerService("", "", options, false, false)).getType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4145.java