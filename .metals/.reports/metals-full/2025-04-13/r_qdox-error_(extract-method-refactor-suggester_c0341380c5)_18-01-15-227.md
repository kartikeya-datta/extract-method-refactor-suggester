error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7995.java
text:
```scala
S@@tatusManager.getManager().addLoggedStatus(handlingState.getStatus());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7995.java