error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16402.java
text:
```scala
r@@eturn OS.objc_msgSend_bool(OS.class_NSBundle, OS.sel_loadNibFile_externalNameTable_withZone_, fileName != null ? fileName.id : 0, context != null ? context.id : 0, zone);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16402.java