error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12196.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12196.java
text:
```scala
static final S@@tring COPYRIGHT = "Copyright (c) 1998-2006 The Apache Software Foundation";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12196.java