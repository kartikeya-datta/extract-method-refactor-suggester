error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8344.java
text:
```scala
s@@tart = typeRef.getStartPosition();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8344.java