error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9227.java
text:
```scala
p@@alette.add(createToolButton(IMAGES + "OCONN", "Split Connection Tool", tool));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9227.java