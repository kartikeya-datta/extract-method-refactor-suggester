error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/602.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/602.java
text:
```scala
@Override protected S@@hardDeleteByQueryResponse shardOperationOnPrimary(ClusterState clusterState, ShardOperationRequest shardRequest) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/602.java