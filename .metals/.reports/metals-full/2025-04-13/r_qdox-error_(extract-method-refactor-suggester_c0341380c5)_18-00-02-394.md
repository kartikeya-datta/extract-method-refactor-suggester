error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5496.java
text:
```scala
i@@f ((local.tagBits & TagBits.IsArgument) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5496.java