error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10547.java
text:
```scala
t@@hrow new IllegalArgumentException("Path must not be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10547.java