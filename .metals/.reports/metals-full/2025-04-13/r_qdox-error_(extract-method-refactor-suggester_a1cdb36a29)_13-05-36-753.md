error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/236.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/236.java
text:
```scala
static final i@@nt MAJOR = 5, MINOR = 80;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/236.java