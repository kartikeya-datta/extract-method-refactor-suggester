error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5175.java
text:
```scala
i@@f (declaringType.kind() == IGenericType.ENUM_DECL) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5175.java