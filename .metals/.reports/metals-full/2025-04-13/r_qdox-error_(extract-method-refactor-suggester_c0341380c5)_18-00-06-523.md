error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3940.java
text:
```scala
i@@f (hasZeroValue && zeroValue == value) return true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3940.java