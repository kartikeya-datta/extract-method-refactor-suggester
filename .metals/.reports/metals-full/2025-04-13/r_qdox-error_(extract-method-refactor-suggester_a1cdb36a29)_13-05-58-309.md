error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1216.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1216.java
text:
```scala
public static final S@@tring BODY_ID = "_<body>";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1216.java