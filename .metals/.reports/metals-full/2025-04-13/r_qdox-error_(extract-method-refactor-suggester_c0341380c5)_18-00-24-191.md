error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2515.java
text:
```scala
t@@arget.add(comp);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2515.java