error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3198.java
text:
```scala
l@@og.errorf(e, "Error unregistering from master");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3198.java