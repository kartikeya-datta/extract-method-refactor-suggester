error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7148.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7148.java
text:
```scala
public final C@@harSequence urlFor(final PageReference id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7148.java