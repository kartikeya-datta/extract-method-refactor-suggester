error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2143.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2143.java
text:
```scala
L@@ockOwner getOwner();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2143.java