error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15887.java
text:
```scala
r@@eturn new HTTPSamplerProxy();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15887.java