error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4246.java
text:
```scala
a@@ssertTrue("Next value should depend on previous genid", nextId >= genId + 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4246.java