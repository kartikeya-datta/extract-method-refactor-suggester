error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2804.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2804.java
text:
```scala
protected S@@OContext makeSharedObjectContext(SOConfig config,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2804.java