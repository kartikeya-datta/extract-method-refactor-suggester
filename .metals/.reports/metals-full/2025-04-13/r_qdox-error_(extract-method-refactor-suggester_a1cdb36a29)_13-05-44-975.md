error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8301.java
text:
```scala
e@@rrorHandler.error("Error occured while sending e-mail notification.", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8301.java