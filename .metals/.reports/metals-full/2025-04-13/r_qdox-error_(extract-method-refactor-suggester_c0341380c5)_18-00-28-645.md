error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6947.java
text:
```scala
l@@ogger.debug("Using [" + type() + "] filter cache with reader_cleaner_schedule[{}]", readerCleanerSchedule);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6947.java