error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9833.java
text:
```scala
M@@essageResolver resolver = builder.severity(Severity.ERROR).code("invalidFormat").arg("label", new ResolvableArgument("mathForm.decimalField"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9833.java