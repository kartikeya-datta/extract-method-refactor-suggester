error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1784.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1784.java
text:
```scala
protected I@@JavaElement[] generateResultHandles() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1784.java