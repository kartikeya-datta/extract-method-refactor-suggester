error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3261.java
text:
```scala
I@@naccessibleBaseClassTest.class
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3261.java