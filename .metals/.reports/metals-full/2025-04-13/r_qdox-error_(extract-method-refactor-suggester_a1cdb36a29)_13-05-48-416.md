error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11142.java
text:
```scala
R@@esolveContext context = resolver.createResolveContext(env, Collections.singleton(resource), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11142.java