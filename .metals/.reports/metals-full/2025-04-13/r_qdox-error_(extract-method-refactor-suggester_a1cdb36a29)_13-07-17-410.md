error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4904.java
text:
```scala
I@@WorkbenchHelpContextIds.TOGGLE_EDITORS_VISIBILITY_ACTION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4904.java