error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/186.java
text:
```scala
c@@harsetName = bodyPart.getHeader().getContentParameter("charset");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/186.java