error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8743.java
text:
```scala
P@@ollingUtils.retryWithTimeout(10000, new PollingUtils.WaitForMBeanTask(mbeanServer, objectName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8743.java