error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5121.java
text:
```scala
r@@eturn Math.max(0.0, (scale - value) / scale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5121.java