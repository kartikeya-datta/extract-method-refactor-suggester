error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10785.java
text:
```scala
c@@omparator = (AbstractFileComparator) DirectoryFileComparator.DIRECTORY_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10785.java