error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9373.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9373.java
text:
```scala
public static final S@@tring ERROR_MESSAGE = "ERROR OCCURRED";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9373.java