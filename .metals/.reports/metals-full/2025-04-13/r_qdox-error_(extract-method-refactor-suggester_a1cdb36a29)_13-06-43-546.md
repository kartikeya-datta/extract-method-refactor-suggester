error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1286.java
text:
```scala
S@@ystem.err.println("NOTE: test params are: codec=" + classEnvRule.codec +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1286.java