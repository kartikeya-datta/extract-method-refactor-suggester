error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15681.java
text:
```scala
p@@rivate static class ChildList extends AbstractList implements IClusterable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15681.java