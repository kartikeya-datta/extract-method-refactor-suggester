error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12951.java
text:
```scala
I@@MarkupFragment markup = cache.getMarkup(component, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12951.java