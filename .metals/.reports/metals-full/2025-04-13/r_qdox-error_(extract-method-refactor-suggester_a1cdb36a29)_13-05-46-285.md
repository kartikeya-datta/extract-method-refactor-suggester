error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7153.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7153.java
text:
```scala
t@@his.tagBits |= type.tagBits & (TagBits.HasTypeVariable | TagBits.HasDirectWildcard | TagBits.HasMissingType | TagBits.ContainsNestedTypeReferences);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7153.java