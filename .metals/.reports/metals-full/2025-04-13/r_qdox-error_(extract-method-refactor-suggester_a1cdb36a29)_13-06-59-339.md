error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2890.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2890.java
text:
```scala
P@@opupSettings popupSettings = new PopupSettings();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2890.java