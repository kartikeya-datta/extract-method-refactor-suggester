error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5955.java
text:
```scala
p@@ublic class SubmitLink extends Button
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5955.java