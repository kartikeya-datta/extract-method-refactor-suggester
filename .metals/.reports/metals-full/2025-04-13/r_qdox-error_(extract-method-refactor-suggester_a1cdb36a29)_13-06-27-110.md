error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8848.java
text:
```scala
F@@lushResponse actionGet = client().admin().indices().prepareFlush().setWaitIfOngoing(true).execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8848.java