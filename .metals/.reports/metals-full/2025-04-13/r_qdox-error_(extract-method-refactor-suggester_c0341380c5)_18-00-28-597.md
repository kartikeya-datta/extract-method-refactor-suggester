error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6856.java
text:
```scala
d@@iffuse.setFilter(TextureFilter.MipMap, TextureFilter.Linear);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6856.java