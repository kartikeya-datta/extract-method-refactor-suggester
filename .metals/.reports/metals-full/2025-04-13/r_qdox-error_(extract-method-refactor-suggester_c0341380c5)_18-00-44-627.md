error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/416.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/416.java
text:
```scala
public static final S@@tring LINE_SEPARATOR = System.getProperty("line.separator"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/416.java