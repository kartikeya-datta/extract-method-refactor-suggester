error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2411.java
text:
```scala
a@@pplication.setHomePage(WicketPanelPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2411.java