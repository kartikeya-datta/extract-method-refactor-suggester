error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2595.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2595.java
text:
```scala
public E@@ditAssigneeTask prompt(User assignee) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2595.java