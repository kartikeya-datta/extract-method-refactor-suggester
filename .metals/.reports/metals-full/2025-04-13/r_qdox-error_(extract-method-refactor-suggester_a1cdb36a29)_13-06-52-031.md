error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/694.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/694.java
text:
```scala
private final static i@@nt HTTP_SERVER_PORT = 8181;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/694.java