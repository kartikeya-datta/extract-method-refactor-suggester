error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15114.java
...
```java
offset: 1049
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15114.java
text:
```scala
 ...
 * MA  02110-1301, USA.
 */
p@@ackage org.jboss.as.server.services.net;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15114.java