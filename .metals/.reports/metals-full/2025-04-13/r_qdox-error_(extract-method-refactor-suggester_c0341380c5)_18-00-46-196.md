error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/795.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/795.java
text:
```scala
public final C@@omponent setEscapeModelStrings(final boolean escapeMarkup)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/795.java