error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2712.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2712.java
text:
```scala
public L@@ist<RawKeyspace> keyspaces;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2712.java