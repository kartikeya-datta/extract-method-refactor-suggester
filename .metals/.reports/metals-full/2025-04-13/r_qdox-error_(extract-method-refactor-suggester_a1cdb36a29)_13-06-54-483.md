error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10994.java
text:
```scala
t@@f.setPriority(value.isDefined() ? new Integer(value.asInt()) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10994.java