error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/959.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/959.java
text:
```scala
public P@@ertApplication() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/959.java