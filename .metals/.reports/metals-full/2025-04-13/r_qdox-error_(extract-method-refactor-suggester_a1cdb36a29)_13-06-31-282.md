error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1538.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1538.java
text:
```scala
r@@eturn "removing from index " + resourceName; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1538.java