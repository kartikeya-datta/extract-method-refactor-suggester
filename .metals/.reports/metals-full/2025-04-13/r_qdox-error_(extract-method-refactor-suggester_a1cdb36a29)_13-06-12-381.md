error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1901.java
text:
```scala
c@@ellItem.add(new Label(componentId, new PropertyModel(rowModel, property)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1901.java