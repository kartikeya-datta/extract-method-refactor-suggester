error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9025.java
text:
```scala
i@@f (event.doit) event.detail = SWT.TRAVERSE_MNEMONIC;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9025.java