error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3306.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3306.java
text:
```scala
protected v@@oid finishedWith(String sourceLocator, CompilationResult result, char[] mainTypeName, ArrayList definedTypeNames, ArrayList duplicateTypeNames) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3306.java