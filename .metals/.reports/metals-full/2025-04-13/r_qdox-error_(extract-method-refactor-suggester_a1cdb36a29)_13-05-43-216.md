error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10403.java
text:
```scala
S@@tring[] cmdAttribs = new String[] {"cmd.exe", "/C", "dir /a /-c " + path};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10403.java