error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18012.java
text:
```scala
f@@tp.setFileType(org.apache.commons.net.ftp.FTP.BINARY_FILE_TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18012.java