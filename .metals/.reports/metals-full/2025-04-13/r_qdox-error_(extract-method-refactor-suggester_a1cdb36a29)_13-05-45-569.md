error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16360.java
text:
```scala
p@@ublic static final class ClosePopupPage extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16360.java