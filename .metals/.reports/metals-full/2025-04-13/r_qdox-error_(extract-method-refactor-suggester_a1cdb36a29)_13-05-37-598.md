error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5742.java
text:
```scala
v@@oid handle(CommandContext ctx) throws CommandFormatException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5742.java