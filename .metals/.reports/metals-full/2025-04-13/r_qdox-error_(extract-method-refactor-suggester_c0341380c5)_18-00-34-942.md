error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12191.java
text:
```scala
r@@esourceResponse.setLastModified(lastModified);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12191.java