error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6627.java
text:
```scala
D@@ocumentMapper documentMapper = context.mapperService().documentMapper(hit.type());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6627.java