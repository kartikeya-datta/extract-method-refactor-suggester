error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1756.java
text:
```scala
a@@ssertNotNull(FieldCache.DEFAULT.getTerms(subR, "ints", false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1756.java