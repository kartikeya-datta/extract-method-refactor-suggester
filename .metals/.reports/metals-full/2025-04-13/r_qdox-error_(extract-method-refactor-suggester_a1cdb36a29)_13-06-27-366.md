error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3609.java
text:
```scala
b@@atchBuilder.addService(SERVICE_NAME, service).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3609.java