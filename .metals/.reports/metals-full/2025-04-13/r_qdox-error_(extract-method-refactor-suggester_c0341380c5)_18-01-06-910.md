error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3646.java
text:
```scala
e@@valuateAndCheckError("0x1220 * 0xffffffffL", Integer.class, SpelMessages.TYPE_CONVERSION_ERROR, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3646.java