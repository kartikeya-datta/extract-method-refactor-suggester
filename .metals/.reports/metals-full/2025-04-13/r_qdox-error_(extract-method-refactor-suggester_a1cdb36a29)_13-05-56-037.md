error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1781.java
text:
```scala
b@@oolean showText = (a.isShowToolBarText() || ALIGNMENT );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1781.java