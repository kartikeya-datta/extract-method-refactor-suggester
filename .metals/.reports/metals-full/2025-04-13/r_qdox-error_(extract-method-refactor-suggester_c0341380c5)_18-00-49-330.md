error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10718.java
text:
```scala
r@@eturn this.helperConverter.matches(sourceType, targetType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10718.java