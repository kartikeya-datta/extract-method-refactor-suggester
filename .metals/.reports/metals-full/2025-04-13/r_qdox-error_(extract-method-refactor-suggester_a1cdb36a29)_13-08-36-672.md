error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8599.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8599.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8599.java
text:
```scala
private transient C@@omponentTag openTag;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8599.java