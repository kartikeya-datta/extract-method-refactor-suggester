error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/859.java
text:
```scala
r@@eturn line(start.x, start.y, end.y, end.y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/859.java