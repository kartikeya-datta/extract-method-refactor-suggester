error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9473.java
text:
```scala
s@@etResponsePage(pageLink.getPage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9473.java