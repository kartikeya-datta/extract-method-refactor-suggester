error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2729.java
text:
```scala
c@@e.setDescription("exp(-0.5*pow(" + valueExpl + ",2.0)/" + -1 * scale + ")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2729.java