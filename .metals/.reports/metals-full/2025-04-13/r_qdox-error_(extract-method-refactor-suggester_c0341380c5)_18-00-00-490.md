error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4946.java
text:
```scala
i@@nput.setInput(new String(html)); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4946.java