error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3465.java
text:
```scala
S@@napshotArray<Actor> children = getChildren();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3465.java