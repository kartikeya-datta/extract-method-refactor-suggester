error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11184.java
text:
```scala
a@@ssertTrue("Expected STOMP MESSAGE, got " + payload, payload.startsWith("MESSAGE\n"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11184.java