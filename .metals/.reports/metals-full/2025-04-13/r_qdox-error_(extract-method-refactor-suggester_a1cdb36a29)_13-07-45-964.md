error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2092.java
text:
```scala
e@@ntries = projectElement.getExpandedClasspath(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2092.java