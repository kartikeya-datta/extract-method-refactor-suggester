error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6493.java
text:
```scala
i@@f ((localType.scope.referenceType().bits & IsReachable) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6493.java