error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4086.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4086.java
text:
```scala
i@@f (component.isAuto() || (!component.isVersioned()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4086.java