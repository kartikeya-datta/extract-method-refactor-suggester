error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2053.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2053.java
text:
```scala
V@@ERSION_ID = "openjpa-" + VERSION_NUMBER + "-r" + REVISION_NUMBER;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2053.java