error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6700.java
text:
```scala
b@@uilder.field("name", nodeStats.node().name(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6700.java