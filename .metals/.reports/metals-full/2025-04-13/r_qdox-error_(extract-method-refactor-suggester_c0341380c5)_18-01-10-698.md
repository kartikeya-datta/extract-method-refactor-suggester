error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3301.java
text:
```scala
b@@uilder.append(column.getString(this)).append(",");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3301.java