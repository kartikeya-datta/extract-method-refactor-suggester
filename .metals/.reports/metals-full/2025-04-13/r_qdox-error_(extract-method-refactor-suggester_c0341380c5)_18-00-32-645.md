error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6213.java
text:
```scala
r@@eturn InetSocketAddress.class.cast(getLocalSocketAddress());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6213.java