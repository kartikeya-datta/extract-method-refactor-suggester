error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17068.java
text:
```scala
r@@eturn getSession().getPageFactory().newPage(c);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17068.java