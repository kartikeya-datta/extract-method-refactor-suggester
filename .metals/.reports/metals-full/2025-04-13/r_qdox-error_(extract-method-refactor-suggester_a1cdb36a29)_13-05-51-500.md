error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18034.java
text:
```scala
i@@nt /*long*/ grabHandle = OS.gtk_grab_get_current ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18034.java