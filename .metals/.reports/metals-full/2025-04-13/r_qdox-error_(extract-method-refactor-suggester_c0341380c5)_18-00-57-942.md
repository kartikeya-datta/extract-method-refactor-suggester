error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9723.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9723.java
text:
```scala
protected C@@omponent newContentComponent(String componentId, BaseTree tree, IModel<?> model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9723.java