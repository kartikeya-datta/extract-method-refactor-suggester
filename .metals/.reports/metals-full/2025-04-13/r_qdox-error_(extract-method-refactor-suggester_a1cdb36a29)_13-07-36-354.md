error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1390.java
text:
```scala
S@@treamInManager.registerFileStatusHandler(message.getFrom(), new FileStatusHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1390.java