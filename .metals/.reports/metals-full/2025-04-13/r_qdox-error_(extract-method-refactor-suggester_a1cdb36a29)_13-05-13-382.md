error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2469.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2469.java
text:
```scala
final b@@yte clearedBit = new BitField(0x40).setByteBoolean((byte) - 63, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2469.java