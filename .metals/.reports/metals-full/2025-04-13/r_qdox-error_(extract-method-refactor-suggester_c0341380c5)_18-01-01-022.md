error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3557.java
text:
```scala
d@@st[i] = src[ii] * scale;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3557.java