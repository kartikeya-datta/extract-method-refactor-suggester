error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6338.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6338.java
text:
```scala
L@@og.d(TAG, "Exception checking if following user", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6338.java