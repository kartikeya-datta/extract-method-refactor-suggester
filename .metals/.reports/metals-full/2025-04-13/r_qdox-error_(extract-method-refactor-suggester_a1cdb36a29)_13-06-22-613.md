error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17314.java
text:
```scala
l@@og.debug("Add " + child.getId() + " to component " + this.getClass().getName()+" with path "+getPath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17314.java