error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11560.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11560.java
text:
```scala
final P@@roperties deploymentProperties = current.getAttachment(Attachments.DEPLOYMENT_PROPERTIES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11560.java