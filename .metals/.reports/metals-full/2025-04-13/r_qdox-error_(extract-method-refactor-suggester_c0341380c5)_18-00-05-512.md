error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2217.java
text:
```scala
I@@nternalOrder order, BucketCountThresholds bucketCountThresholds,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2217.java