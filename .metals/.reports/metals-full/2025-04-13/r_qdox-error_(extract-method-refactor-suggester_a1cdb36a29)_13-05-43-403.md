error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8840.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8840.java
text:
```scala
b@@efore(int i): call(* *.mumble()) && named() && namedWithOneArg(i) { }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8840.java