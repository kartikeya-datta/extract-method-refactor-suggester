error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3942.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3942.java
text:
```scala
public L@@inkomaticTest(final String name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3942.java