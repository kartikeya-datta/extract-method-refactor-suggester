error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1969.java
text:
```scala
r@@egister(aliases.get(a), core, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1969.java