error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9330.java
text:
```scala
E@@numeration<?> propNames = this.mappings.propertyNames();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9330.java