error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1718.java
text:
```scala
r@@eturn this.expressionType = qualificationTb;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1718.java