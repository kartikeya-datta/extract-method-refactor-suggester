error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7037.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7037.java
text:
```scala
D@@efaults.IGNORE_MALFORMED, postingsProvider, docValuesProvider, null, null, fieldDataSettings, indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7037.java