error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5048.java
text:
```scala
A@@ssert.assertEquals(11, operations.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5048.java