error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7529.java
text:
```scala
a@@ssertTrue("over 100 chars", LONG_NAME.length() > 100);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7529.java