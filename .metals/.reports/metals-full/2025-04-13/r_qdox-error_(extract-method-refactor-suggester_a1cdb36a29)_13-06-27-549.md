error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/441.java
text:
```scala
i@@gnoreIndices = IgnoreIndices.fromString(request.param("ignore_indices"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/441.java