error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9217.java
text:
```scala
m@@erged.addAll((List<E>) parent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9217.java