error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9972.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9972.java
text:
```scala
private static final i@@nt MANAGEMENT_API_MINOR_VERSION = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9972.java