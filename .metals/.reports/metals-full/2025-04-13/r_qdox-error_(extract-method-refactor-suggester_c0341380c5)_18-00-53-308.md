error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5050.java
text:
```scala
N@@ame(DataByteInputStream in, Compression c) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5050.java