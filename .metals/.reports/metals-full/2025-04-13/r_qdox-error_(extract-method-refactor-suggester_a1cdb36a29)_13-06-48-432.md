error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14361.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14361.java
text:
```scala
public I@@terator<Contact> iterator(int first, int count)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14361.java