error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4954.java
text:
```scala
s@@uper(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, threadFactory, new EsAbortPolicy());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4954.java