error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2219.java
text:
```scala
M@@ainInterface.config.get("options").getElement("/options/gui/mainfont");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2219.java