error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16184.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16184.java
text:
```scala
public static final S@@tring resourceReferencePrefix = "/resource/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16184.java