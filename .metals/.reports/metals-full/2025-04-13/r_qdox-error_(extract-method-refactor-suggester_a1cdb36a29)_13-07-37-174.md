error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2432.java
text:
```scala
s@@tatusAdapter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2432.java