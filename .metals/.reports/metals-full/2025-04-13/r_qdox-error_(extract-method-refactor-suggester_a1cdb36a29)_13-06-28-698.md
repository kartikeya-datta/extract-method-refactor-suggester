error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5661.java
text:
```scala
r@@eturn new OSTask[] { /* new JEditLauncherOSTask(installer) */ };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5661.java