error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8511.java
text:
```scala
r@@eturn new CustomIntegerNumericField(this, context.sourceLength());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8511.java