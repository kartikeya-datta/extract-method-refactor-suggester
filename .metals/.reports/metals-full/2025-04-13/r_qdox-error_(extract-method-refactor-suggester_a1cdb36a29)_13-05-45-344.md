error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4039.java
text:
```scala
g@@dx2d_get_failure_reason(void);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4039.java