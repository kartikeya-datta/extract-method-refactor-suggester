error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7082.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7082.java
text:
```scala
i@@f (OS.XtIsRealized (topHandle) && !OS.XtIsSubclass (topHandle, OS.shellWidgetClass ())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7082.java