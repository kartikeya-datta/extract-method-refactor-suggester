error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/926.java
text:
```scala
c@@atch (Exception e) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/926.java