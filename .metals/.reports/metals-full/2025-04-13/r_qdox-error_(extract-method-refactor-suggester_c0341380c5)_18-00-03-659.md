error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1898.java
text:
```scala
c@@lusterService.submitStateUpdateTask("reroute post shard-started (" + shardRouting + "), reason [" + reason + "]", Priority.HIGH, new ClusterStateUpdateTask() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1898.java