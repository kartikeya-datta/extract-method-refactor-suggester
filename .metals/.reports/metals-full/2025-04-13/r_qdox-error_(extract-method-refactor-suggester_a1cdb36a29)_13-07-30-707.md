error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1103.java
text:
```scala
c@@hatWindow = new ChatWindow(view, tableView, initText);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1103.java