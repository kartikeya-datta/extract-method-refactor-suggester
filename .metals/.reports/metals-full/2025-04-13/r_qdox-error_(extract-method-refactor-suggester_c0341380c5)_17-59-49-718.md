error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3874.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3874.java
text:
```scala
M@@appingMetaData mappingMd = state.metaData().index(request.index()).mappingOrDefault(request.type());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3874.java