error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4865.java
text:
```scala
i@@f ((length & 1) != 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4865.java