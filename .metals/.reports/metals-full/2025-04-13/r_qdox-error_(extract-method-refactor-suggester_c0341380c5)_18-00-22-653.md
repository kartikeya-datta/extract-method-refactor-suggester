error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8239.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8239.java
text:
```scala
private static final S@@erviceName JBOSS_MESSAGING = ServiceName.JBOSS.append("messaging");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8239.java