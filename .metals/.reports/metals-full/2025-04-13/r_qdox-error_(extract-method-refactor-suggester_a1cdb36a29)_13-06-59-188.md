error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7158.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7158.java
text:
```scala
public b@@oolean matches(ResolvedTypeX matchType, ResolvedTypeX aspectType) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7158.java