error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5839.java
text:
```scala
s@@uper("selection", "SelectionOptions", mediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5839.java