error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3646.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3646.java
text:
```scala
final J@@List list = new JList(GdxTests.getNames().toArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3646.java