error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1024.java
text:
```scala
i@@f (!!!it.next().isInterface()) it.remove();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1024.java