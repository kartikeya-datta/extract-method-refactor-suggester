error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11073.java
text:
```scala
i@@f (context.isNormalServer() && !context.isBooting()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11073.java