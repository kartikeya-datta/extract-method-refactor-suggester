error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2247.java
text:
```scala
S@@ystem.err.println("Stack trace of embedded throwable:"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2247.java