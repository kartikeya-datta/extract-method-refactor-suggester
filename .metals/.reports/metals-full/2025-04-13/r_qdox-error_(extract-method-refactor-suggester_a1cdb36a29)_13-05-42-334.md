error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10063.java
text:
```scala
r@@c = XPCOM.NS_InitXPCOM2(0, localFile.getAddress(), 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10063.java