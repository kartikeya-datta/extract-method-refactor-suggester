error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14188.java
text:
```scala
r@@eturn new PropertyModel(getPage().getModel(), getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14188.java