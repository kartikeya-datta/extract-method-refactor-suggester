error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3714.java
text:
```scala
c@@ompressedData = BufferUtils.newByteBuffer(fileSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3714.java