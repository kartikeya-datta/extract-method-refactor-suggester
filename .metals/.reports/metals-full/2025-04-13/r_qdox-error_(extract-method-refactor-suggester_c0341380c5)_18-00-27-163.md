error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6499.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6499.java
text:
```scala
private volatile b@@oolean passivated;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6499.java