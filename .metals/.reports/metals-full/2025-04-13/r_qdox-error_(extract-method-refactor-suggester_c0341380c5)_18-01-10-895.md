error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10783.java
text:
```scala
c@@omparator = (AbstractFileComparator) DefaultFileComparator.DEFAULT_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10783.java