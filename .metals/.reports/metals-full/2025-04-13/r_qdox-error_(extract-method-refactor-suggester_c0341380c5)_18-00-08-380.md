error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7194.java
text:
```scala
t@@his.produceAttributes = this.referenceBinding.scope.compilerOptions().produceDebugAttributes;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7194.java