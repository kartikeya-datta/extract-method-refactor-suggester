error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17227.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17227.java
text:
```scala
static /*final*/ b@@oolean IS_64 = 0x1FFFFFFFFL == (int /*long*/)0x1FFFFFFFFL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17227.java