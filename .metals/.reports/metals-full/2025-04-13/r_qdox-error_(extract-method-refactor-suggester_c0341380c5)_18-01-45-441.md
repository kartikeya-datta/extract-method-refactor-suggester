error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7625.java
text:
```scala
r@@eturn new StringBuffer("AbstractMethodCollaboratorIndictment("/*nonNLS*/).append(fName).append(")"/*nonNLS*/).toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7625.java