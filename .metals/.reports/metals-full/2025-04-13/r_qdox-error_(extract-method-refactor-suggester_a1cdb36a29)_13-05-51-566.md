error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2947.java
text:
```scala
.@@getThrowable());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2947.java