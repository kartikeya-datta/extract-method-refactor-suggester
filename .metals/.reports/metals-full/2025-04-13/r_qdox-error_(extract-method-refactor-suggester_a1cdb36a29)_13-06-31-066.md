error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3832.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3832.java
text:
```scala
i@@ndexShard.postRecovery("post recovery from gateway");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3832.java