error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1839.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1839.java
text:
```scala
public static final S@@tring NAME = "indices:monitor/segments";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1839.java