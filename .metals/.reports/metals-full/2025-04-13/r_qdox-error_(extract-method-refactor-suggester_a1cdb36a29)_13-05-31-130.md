error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/57.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/57.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/57.java
text:
```scala
R@@esult result= JUnitCore.runClasses(ParallelComputer.classes(), Example1.class, Example2.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/57.java