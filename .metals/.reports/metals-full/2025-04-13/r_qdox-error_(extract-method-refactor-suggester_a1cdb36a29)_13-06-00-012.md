error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10641.java
text:
```scala
M@@odule module = deploymentUnit.getAttachment(Attachments.MODULE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10641.java