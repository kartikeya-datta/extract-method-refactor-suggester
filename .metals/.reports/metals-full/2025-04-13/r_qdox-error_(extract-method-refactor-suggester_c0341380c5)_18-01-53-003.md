error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5714.java
text:
```scala
r@@eturn display.getSystemFont ().handle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5714.java