error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/523.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/523.java
text:
```scala
private static final S@@tring MASKED_MYPASSWORD_VALUE = "MASK-0UWB5tlhOmKYzJVl9KZaPN";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/523.java