error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14189.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14189.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14189.java
text:
```scala
m@@ainPanel.add(createControls(), BorderLayout.CENTER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14189.java