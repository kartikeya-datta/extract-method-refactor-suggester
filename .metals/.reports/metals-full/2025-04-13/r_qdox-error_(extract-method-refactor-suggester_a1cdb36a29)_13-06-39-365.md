error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7541.java
text:
```scala
S@@ampleEvent event = new SampleEvent(res, threadContext.getThreadGroup().getName(),threadVars);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7541.java