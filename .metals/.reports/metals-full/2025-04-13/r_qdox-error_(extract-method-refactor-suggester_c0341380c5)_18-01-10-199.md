error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1829.java
text:
```scala
S@@tring bundleClassName = b == null ? "": b.getClass().getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1829.java