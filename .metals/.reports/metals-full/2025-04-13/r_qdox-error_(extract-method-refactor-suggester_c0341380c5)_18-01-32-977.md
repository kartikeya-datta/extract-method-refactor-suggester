error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6057.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6057.java
text:
```scala
r@@eturn input[0].trim();
			...
			IFormVisitorParticipant
{
	...
	private class MessageSource implements IErrorMessageSource
	{
		...
		/**
		 * Creates a new params map that additionaly contains the default input, name, label
		 * parameters
		 * 
		 * @param params
		 *            original params map
	 ...
	 * convenient for 'business' use, but is also nescesarry as we don't want the form component
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6057.java