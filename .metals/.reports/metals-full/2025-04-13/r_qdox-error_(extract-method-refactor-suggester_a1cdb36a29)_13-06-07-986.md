error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10600.java
text:
```scala
m@@ap.put("number", Integer.valueOf(2));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10600.java