error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/255.java
text:
```scala
O@@S.objc_msgSend_stret(result, this.id, OS.sel_containerSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/255.java