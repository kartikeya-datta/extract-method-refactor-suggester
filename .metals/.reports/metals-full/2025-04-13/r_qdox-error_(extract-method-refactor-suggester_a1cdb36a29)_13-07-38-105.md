error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1281.java
text:
```scala
V@@alidatorFactory validatorFactory = SerializableValidatorFactory.validatorFactory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1281.java