error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18218.java
text:
```scala
i@@mageList = display.getImageList (style & SWT.RIGHT_TO_LEFT, bounds.width, bounds.height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18218.java