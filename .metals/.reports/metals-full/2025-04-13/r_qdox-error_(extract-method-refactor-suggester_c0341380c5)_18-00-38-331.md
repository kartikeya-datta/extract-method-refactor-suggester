error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/100.java
text:
```scala
c@@lient.admin().cluster().state(new ClusterStateRequest(), new ActionListener<ClusterStateResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/100.java