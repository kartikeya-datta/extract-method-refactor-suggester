error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9839.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9839.java
text:
```scala
public S@@tring substitute(String text) throws Exception
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9839.java