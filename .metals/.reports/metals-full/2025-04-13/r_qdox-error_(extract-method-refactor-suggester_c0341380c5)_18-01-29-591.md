error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17851.java
text:
```scala
s@@endMouseEvent (SWT.MouseUp, button [0], true, chord, (short)x, (short)y, modifiers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17851.java