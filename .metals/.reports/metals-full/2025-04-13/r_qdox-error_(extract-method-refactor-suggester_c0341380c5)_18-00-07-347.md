error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6960.java
text:
```scala
r@@emoveIds [removeIds.length - removeCount - 1] = id;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6960.java