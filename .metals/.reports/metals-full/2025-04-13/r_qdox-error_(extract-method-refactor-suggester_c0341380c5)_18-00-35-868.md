error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4275.java
text:
```scala
e@@raseItemRect.width = fullRect.x + fullRect.width;
...
void drawInteriorWithFrame_inView (int /*long*/ id, int /*long*/ sel, int /*long*/ cellFrame, int /*long*/ view) {
	...
	if (columnCount == 0) {
		if (item.customWidth != -1) {
			...
			fullRect.width = (int)contentSize.width;
		}
	} else {
	...
	if (hooks (SWT.PaintItem)) {
		...
		event.width = (int)contentSize.width;
		event.height = (int)fullRect.height;
...
void tableView_willDisplayCell_forTableColumn_row (int /*long*/ id, int /*long*/ sel, int /*long*/ aTableView, int /*long*/ aCell, int /*long*/ aTableColumn, int /*long*/ rowIndex) {
	...
	if (hooks (SWT.MeasureItem)) {
		...
		if (columnCount == 0) {
			int change = event.width - (item.customWidth != -1 ? item.customWidth : (int)contentSize.width);
			if (item.customWidth != -1 || event.width != (int)contentSize.width) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4275.java