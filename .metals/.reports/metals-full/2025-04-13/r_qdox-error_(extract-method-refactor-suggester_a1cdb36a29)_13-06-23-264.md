error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1765.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1765.java
text:
```scala
public i@@nt getSizeInBytes()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1765.java