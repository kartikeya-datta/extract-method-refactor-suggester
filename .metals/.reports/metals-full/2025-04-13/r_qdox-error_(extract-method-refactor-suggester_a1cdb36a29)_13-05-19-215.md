error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3270.java
text:
```scala
O@@S.SetRect (insetRect, rect.left - 1, rect.top - 1, rect.right + 1, rect.bottom + 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3270.java