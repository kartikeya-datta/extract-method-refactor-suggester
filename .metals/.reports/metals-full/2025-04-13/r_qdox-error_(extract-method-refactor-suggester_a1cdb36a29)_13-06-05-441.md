error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7141.java
text:
```scala
p@@t.y = display.getPrimaryFrame().height - pt.y;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7141.java