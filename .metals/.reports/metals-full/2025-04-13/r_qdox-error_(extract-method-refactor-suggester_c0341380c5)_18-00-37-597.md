error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9288.java
text:
```scala
g@@etLogger().info( "Building " + archiveType + ": " + cabFile.getAbsolutePath() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9288.java