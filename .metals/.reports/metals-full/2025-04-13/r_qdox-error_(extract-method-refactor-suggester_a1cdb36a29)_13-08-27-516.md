error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6377.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6377.java
text:
```scala
private transient M@@arkupStream markupStream;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6377.java