error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/603.java
text:
```scala
b@@uilder.addManifestHeader("Dependencies", "org.osgi.core,org.jboss.modules,org.jboss.logging,org.jboss.osgi.framework,deployment.example-xservice-mab-target-bundle");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/603.java