error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5716.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5716.java
text:
```scala
O@@perationBuilder builder = new OperationBuilder(op, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5716.java