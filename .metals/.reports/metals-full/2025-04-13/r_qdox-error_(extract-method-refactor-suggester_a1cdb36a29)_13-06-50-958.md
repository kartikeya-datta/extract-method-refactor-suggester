error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3118.java
text:
```scala
i@@f (replacement == null || replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3118.java