error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3901.java
text:
```scala
L@@OGGER.info("Testing successfull authentication - " + servletURL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3901.java