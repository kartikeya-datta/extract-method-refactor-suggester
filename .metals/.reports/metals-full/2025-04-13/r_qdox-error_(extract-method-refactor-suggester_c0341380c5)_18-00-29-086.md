error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11177.java
text:
```scala
s@@uper.handleRequestInternal(request, response, sockJsSession);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11177.java