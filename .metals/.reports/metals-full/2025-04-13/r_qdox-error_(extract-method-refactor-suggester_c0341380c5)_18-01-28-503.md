error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1988.java
text:
```scala
I@@nteger enabledOp = OPERATORS.get(operation.trim().toUpperCase(Locale.ROOT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1988.java