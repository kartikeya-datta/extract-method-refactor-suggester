error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5563.java
text:
```scala
c@@atch (Exception e)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5563.java