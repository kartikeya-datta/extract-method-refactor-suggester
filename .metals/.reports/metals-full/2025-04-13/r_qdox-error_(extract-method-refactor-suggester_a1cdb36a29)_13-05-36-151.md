error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3655.java
text:
```scala
O@@penable openable = this.locator.handleFactory.createOpenable(paths[i], this.locator.scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3655.java