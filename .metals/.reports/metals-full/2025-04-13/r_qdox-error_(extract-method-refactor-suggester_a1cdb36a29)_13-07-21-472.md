error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10827.java
text:
```scala
S@@tringValue requiredParam = param.get("required");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10827.java