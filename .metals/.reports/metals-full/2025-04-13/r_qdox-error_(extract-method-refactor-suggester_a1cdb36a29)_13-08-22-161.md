error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2583.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2583.java
text:
```scala
s@@uper.drawChildren(batch, parentAlpha);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2583.java