error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1286.java
text:
```scala
T@@ypedValue getRootObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1286.java