error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17187.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17187.java
text:
```scala
public v@@oid checkProxyClass(Class<?> proxyClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17187.java