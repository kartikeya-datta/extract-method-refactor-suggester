error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14854.java
text:
```scala
t@@his.authType = type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14854.java