error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2508.java
text:
```scala
s@@amplingParams.setSamplingThreshold(11000); //force sampling
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2508.java