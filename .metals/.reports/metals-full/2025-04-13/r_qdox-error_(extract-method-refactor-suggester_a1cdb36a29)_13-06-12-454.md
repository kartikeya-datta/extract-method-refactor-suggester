error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7169.java
text:
```scala
c@@ase SWT.COLOR_WIDGET_BACKGROUND: color = NSColor.controlHighlightColor(); break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7169.java