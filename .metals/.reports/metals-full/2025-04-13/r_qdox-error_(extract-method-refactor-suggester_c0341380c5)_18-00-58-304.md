error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12732.java
text:
```scala
a@@rchiveVersionMajor, archiveVersionMinor));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12732.java