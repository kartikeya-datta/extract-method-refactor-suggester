error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16372.java
...
```java
offset: 27
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16372.java
text:
```scala
public final synchronized L@@ist getResourceCollections() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16372.java