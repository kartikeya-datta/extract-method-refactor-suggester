error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12872.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12872.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12872.java
text:
```scala
n@@ull, null, null, extensionsReturnTypeCache, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12872.java