error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3616.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3616.java
text:
```scala
public v@@oid putBrokerFactoryAliases(Map<String, String> aliases);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3616.java