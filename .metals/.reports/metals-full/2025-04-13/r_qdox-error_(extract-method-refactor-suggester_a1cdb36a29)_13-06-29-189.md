error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10582.java
text:
```scala
c@@learBlockSelection(false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10582.java