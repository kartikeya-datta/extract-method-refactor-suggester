error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10815.java
text:
```scala
t@@his(Book.get(parameters.get("id").toLong()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10815.java