error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18250.java
text:
```scala
m@@_value = newInstance( DataType.ROLE, configuration.getName() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18250.java