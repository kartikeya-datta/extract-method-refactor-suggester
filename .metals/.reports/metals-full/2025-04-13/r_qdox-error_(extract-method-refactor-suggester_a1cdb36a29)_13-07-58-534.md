error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11538.java
...
```java
offset: 852
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11538.java
text:
```scala
 ...
 */
p@@ackage org.apache.wicket.model;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11538.java