error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4121.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4121.java
text:
```scala
protected I@@nteger fromAnnotation(final AnnotationInstance annotationInstance, final boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4121.java