error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/443.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/443.java
text:
```scala
private static final C@@LOptionDescriptor[] options =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/443.java