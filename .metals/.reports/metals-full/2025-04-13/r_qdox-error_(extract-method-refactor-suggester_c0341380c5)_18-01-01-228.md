error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14035.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14035.java
text:
```scala
private volatile I@@nboundBridgeRecoveryManager inboundBridgeRecoveryManager;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14035.java