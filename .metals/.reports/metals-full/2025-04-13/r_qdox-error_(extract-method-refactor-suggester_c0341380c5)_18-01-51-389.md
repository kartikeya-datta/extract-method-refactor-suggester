error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2916.java
text:
```scala
i@@ndex.reset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2916.java