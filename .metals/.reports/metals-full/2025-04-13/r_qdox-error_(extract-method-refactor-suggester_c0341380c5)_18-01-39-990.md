error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7446.java
text:
```scala
L@@ocalizedFormats.UNPARSEABLE_3D_VECTOR, source);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7446.java