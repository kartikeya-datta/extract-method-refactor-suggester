error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9874.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9874.java
text:
```scala
t@@op [0] = Math.max (0, Math.min (itemHeight * itemCount + getHeaderHeight () - getClientArea ().height, index * itemHeight));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9874.java