error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6765.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6765.java
text:
```scala
public v@@oid setOwnedTextures(Array<Texture> textures) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6765.java