error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17809.java
text:
```scala
i@@f (formComponent.isInputNullable())
...
public class RequiredValidator extends StringValidator
{
	...
	public final void onValidate(final FormComponent formComponent, final String value)
	{
		...
		if (formComponent.isValueNullable())
		{
			// Check value
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17809.java