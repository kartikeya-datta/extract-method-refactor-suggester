error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9543.java
text:
```scala
w@@indow = window.initWithContentRect(new NSRect(), styleMask, OS.NSBackingStoreBuffered, (style & SWT.ON_TOP) != 0, screen);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9543.java