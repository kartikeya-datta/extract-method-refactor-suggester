error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10825.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10825.java
text:
```scala
final b@@oolean triggerError = parameters.get("trigger").toBoolean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10825.java