error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1864.java
text:
```scala
i@@f (!queuedDeliveries.add(to))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1864.java