error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/754.java
text:
```scala
i@@nt msgStart = i; // to exlude tag use:   int msgStart = nextPos;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/754.java