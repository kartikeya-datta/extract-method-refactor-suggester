error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2631.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2631.java
text:
```scala
final M@@igration m = Migration.deserialize(col.value(), message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2631.java