error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7694.java
text:
```scala
l@@ogger.warn("[{}] failed to add mapping [{}], source [{}]", e, index, mappingType, mappingSource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7694.java