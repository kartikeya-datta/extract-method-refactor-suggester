error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9374.java
text:
```scala
L@@OGGER.error("IOException occurred.", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9374.java