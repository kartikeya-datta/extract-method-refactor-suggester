error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5899.java
text:
```scala
p@@ublic abstract interface IMarkup
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5899.java