error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6706.java
text:
```scala
I@@ClasspathEntry[] classpathEntries = javaProject.getExpandedClasspath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6706.java