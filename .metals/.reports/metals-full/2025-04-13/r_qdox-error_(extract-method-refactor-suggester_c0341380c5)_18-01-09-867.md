error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2619.java
text:
```scala
I@@nputStream input = new ByteArrayInputStream(value.getBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2619.java