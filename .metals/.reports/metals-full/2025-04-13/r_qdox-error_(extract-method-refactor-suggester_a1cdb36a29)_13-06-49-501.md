error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8781.java
text:
```scala
s@@tartActivityForResult(new Intent(this, CreateGistActivity.class), GIST_CREATE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8781.java