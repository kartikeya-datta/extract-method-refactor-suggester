error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1807.java
text:
```scala
r@@eadRegistry(in, PlatformUI.PLUGIN_ID, IWorkbenchConstants.PL_ACTION_SET_PART_ASSOCIATIONS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1807.java