error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4658.java
text:
```scala
p@@roblemBinding.closestMatch(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4658.java