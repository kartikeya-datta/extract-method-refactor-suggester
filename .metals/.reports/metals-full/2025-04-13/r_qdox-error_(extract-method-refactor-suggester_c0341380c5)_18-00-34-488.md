error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6567.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6567.java
text:
```scala
final S@@tring value = container.getApplication().getResourceSettings().getLocalizer()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6567.java