error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2854.java
text:
```scala
i@@nt alternateOperatorSignature = OperatorExpression.OperatorSignatures[operator][(alternateLeftTypeId << 4) + alternateRightTypeId];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2854.java