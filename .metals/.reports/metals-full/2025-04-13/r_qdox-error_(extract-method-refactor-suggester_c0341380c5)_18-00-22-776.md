error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12684.java
text:
```scala
i@@f (superClass == null || superClass.equals(Object.class)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12684.java