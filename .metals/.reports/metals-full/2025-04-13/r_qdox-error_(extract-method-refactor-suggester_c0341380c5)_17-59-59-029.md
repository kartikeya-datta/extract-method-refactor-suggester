error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6091.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6091.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6091.java
text:
```scala
r@@eturn new ProgressTreeContentProvider(viewer, Policy.DEBUG_SHOW_SYSTEM_JOBS) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6091.java