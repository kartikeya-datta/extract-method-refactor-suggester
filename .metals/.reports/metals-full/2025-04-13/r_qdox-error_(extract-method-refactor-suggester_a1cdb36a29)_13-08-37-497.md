error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16446.java
text:
```scala
i@@f (OS.GTK_WIDGET_HAS_FOCUS (focusHandle)) return true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16446.java