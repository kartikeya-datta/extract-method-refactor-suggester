error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12928.java
text:
```scala
M@@ap<UUID, ServerUpdateResult> getDeploymentActionResults();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12928.java