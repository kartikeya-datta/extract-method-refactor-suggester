error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10030.java
text:
```scala
t@@his.setProperty(MONITOR, truth);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10030.java