error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5306.java
text:
```scala
b@@ulkRequest.add(data, contentUnsafe, defaultIndex, defaultType, payload, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5306.java