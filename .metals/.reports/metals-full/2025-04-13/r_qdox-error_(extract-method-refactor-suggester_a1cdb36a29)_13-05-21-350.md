error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8277.java
text:
```scala
S@@tring[] result = splitOn(Signature.C_DOT, name, 0, name.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8277.java