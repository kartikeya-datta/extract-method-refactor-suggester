error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5428.java
text:
```scala
J@@avaModelManager.getJavaModelManager().getPerWorkingCopyInfo(workingCopy, this.path, true/*create if needed*/, true/*record usage*/, this.problemRequestor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5428.java