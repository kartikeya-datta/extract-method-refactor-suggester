error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1711.java
text:
```scala
b@@uilder.addImportPackages(StartLevel.class, BlueprintContainer.class, MBeanServer.class);
 ...
 */
package org.jboss.as.test.integration.osgi.blueprint;
...
import org.jboss.as.test.integration.osgi.blueprint.bundle.BeanA;
import org.jboss.as.test.integration.osgi.blueprint.bundle.BeanB;
import org.jboss.as.test.integration.osgi.blueprint.bundle.ServiceA;
import org.jboss.as.test.integration.osgi.blueprint.bundle.ServiceB;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1711.java