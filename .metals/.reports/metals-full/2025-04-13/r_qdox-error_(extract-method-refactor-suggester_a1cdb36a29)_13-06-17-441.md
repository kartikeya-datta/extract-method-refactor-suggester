error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4791.java
...
```java
offset: 689
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4791.java
text:
```scala
...
p@@ackage org.springframework.web.method;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4791.java