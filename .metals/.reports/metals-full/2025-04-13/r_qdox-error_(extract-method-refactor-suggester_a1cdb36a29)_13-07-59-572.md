error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6510.java
text:
```scala
I@@Resource resource = type.getResource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6510.java