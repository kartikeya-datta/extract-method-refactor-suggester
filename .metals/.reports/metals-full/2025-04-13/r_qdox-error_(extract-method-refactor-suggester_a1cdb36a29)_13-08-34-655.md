error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11303.java
text:
```scala
v@@oid onInstantiation(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11303.java