error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2868.java
text:
```scala
s@@erviceBuilder.addDependency(Services.FRAMEWORK_ACTIVE, BundleContext.class, service.injectedBundleContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2868.java