error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/412.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/412.java
text:
```scala
final F@@ile input = getFile("OSX_ArchiveWithNestedArchive.zip");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/412.java