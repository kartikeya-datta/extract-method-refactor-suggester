error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17755.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[90,80]

error in qdox parser
file content:
```java
offset: 2704
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17755.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17755.java