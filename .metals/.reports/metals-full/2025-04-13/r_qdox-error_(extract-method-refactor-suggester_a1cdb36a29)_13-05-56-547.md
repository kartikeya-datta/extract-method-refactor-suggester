error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17940.java
text:
```scala
p@@jp.proceed( new Object[] { "faked" } );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17940.java