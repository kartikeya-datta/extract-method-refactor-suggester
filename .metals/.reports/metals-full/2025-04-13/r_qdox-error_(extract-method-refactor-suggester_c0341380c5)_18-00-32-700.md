error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7038.java
text:
```scala
L@@ucene.KEYWORD_ANALYZER, Lucene.KEYWORD_ANALYZER, null, null, null, null, null, null); // Only stored.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7038.java