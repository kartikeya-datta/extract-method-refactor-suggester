error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2500.java
text:
```scala
m@@ethodDecl.scope.connectTypeVariables(typeParameters, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2500.java