error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15188.java
text:
```scala
v@@oid onAdded(Component<?> component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15188.java