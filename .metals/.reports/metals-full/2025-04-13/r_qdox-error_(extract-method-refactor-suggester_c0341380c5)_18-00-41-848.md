error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6591.java
text:
```scala
a@@dd(createScopePanel(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6591.java