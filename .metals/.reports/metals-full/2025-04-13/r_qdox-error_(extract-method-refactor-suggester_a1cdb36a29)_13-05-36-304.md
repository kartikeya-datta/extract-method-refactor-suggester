error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7983.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7983.java
text:
```scala
J@@avaModelManager.getJavaModelManager().getDeltaProcessor().addForRefresh(javaProject);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7983.java