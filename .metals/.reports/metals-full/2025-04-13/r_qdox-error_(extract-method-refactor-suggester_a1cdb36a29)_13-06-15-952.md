error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5361.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5361.java
text:
```scala
final J@@avaNamespaceSetup setupAction = new JavaNamespaceSetup(selector, serviceTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5361.java