error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6589.java
text:
```scala
I@@Type type = getType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6589.java