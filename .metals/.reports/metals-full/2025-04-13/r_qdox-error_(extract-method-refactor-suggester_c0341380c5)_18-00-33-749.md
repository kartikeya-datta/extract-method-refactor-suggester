error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10429.java
text:
```scala
f@@ieldName = smartNameFieldMappers.mapper().names().indexName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10429.java