error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8685.java
text:
```scala
i@@ndex.add(new IFileDocument(resource, contents), new BinaryIndexer(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8685.java