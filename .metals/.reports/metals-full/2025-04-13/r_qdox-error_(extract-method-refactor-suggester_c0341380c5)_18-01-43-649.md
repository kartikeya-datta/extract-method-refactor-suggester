error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18352.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18352.java
text:
```scala
private S@@tringBuffer buffer = new StringBuffer(4096);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18352.java