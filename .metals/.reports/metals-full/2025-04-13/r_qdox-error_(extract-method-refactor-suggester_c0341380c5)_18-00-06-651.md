error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1987.java
text:
```scala
S@@tring scenarioId = "org.eclipse.swt " + id;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1987.java