error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8142.java
...
```java
offset: 853
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8142.java
text:
```scala
 ...
 * under the License.
 */
p@@ackage org.elasticsearch.util.yaml.snakeyaml.nodes;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8142.java