error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1912.java
text:
```scala
s@@cope.problemReporter().undocumentedEmptyBlock(finallyBlock);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1912.java