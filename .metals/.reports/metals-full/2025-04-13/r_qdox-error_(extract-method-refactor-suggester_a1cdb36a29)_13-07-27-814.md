error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5345.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5345.java
text:
```scala
s@@tartActivityForResult(EditIssuesFilterActivity.createIntent(filter),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5345.java