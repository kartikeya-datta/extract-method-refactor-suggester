error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9019.java
text:
```scala
b@@uilder.field("mode", sortMode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9019.java