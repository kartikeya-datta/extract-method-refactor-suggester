error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4378.java
text:
```scala
S@@tringBuffer buf = new StringBuffer("MethodIndictment("/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4378.java