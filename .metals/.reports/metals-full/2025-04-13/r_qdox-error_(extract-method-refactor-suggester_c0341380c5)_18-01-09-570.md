error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1384.java
text:
```scala
A@@LLOW_DIRECT_CONNECTIONS_ONLY(ClusterConnectionDefinition.ALLOW_DIRECT_CONNECTIONS_ONLY),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1384.java