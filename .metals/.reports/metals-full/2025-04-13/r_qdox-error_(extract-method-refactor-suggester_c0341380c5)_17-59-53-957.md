error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9366.java
text:
```scala
i@@f (this.compileLoop > 1) { // only optimize files which were recompiled during the dependent pass, see 33990
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9366.java