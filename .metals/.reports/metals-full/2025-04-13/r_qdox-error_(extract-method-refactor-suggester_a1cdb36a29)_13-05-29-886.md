error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8614.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8614.java
text:
```scala
public static final i@@nt UndocumentedEmptyBlockMASK = Bit4;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8614.java