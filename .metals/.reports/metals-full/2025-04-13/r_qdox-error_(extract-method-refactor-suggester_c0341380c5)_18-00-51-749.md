error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12827.java
text:
```scala
b@@oolean isLast) throws DerivativeException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12827.java