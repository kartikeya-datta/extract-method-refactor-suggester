error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1327.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1327.java
text:
```scala
w@@hile (i < cont.length && IndentManipulation.isIndentChar(this.content[i])) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1327.java