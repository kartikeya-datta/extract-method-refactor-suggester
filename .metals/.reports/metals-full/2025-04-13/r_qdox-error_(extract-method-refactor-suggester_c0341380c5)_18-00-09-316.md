error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2473.java
text:
```scala
v@@alues = indexFieldData.load(context).getBytesValues();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2473.java