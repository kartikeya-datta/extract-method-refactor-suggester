error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3169.java
text:
```scala
a@@ssertSame(builder, writer.getBuilder());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3169.java