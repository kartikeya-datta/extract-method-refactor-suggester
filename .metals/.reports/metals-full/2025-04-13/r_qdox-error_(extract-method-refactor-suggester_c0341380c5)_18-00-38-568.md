error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1571.java
text:
```scala
a@@dd(new BookmarkablePageLink("popupLink", Popup.class).setPopupSettings(popupSettings));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1571.java