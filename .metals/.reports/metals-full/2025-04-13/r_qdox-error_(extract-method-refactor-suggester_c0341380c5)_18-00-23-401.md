error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15521.java
text:
```scala
i@@f (parentItem != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15521.java