error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1545.java
text:
```scala
R@@unnablePostTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1545.java