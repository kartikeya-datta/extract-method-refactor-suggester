error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11040.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11040.java
text:
```scala
public v@@oid onSelectionChanged(final Locale newSelection)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11040.java