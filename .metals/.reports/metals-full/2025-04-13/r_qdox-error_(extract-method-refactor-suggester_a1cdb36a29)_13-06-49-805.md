error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9591.java
text:
```scala
c@@lusterHealth = client1.admin().cluster().health(clusterHealthRequest().setWaitForGreenStatus().setWaitForNodes("2")).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9591.java