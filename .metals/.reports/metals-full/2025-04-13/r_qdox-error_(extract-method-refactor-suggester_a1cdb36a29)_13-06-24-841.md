error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15023.java
text:
```scala
t@@hrow new DeploymentUnitProcessingException(MESSAGES.failToParseXMLDescriptor(jbossWebXml, e.getLocation().getLineNumber(), e.getLocation().getColumnNumber()), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15023.java