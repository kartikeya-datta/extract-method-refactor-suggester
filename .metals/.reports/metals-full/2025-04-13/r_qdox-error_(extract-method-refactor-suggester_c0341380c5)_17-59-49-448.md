error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3474.java
text:
```scala
i@@f (!OS.FrameworkElement_IsLoaded (headerHandle)) updateLayout (headerHandle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3474.java