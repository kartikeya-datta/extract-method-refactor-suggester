error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9272.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9272.java
text:
```scala
l@@ong metaTagBits = annotationType.getAnnotationTagBits();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9272.java