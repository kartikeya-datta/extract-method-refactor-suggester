error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7760.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7760.java
text:
```scala
public static final A@@ttributeDefinition[] ATTRIBUTES_WITH_EXPRESSION_AFTER_1_1_0 = { QUEUE_NAME, USE_DUPLICATE_DETECTION,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7760.java