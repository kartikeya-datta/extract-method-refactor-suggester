error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12192.java
text:
```scala
d@@ata.setLastModified(lastModifiedTime);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12192.java