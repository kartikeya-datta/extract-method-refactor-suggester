error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3884.java
text:
```scala
s@@kipExecution = contentItem.getContentType() == ContentType.MISC;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3884.java