error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8625.java
text:
```scala
t@@his.raName = raxml.getArchive().substring(0, raxml.getArchive().indexOf(".rar")).toLowerCase();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8625.java