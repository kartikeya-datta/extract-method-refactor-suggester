error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17903.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17903.java
text:
```scala
final I@@Crypt crypt = application.getCrypt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17903.java