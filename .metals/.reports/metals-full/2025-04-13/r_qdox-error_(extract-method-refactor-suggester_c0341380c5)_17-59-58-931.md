error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11054.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11054.java
text:
```scala
i@@f(c == CONVERT_TO_DEFAULT_TYPE || Boolean.class.isAssignableFrom(c))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11054.java