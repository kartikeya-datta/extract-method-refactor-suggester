error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17471.java
text:
```scala
E@@xp exp = new Exp(7, 7, 0, 7, 0, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17471.java