error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12844.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12844.java
text:
```scala
l@@ogger.trace("Message broker is not running. Ignoring message=" + message);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12844.java