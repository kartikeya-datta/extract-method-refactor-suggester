error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9556.java
text:
```scala
A@@ssert.notNull(getSockJsConfig(), "This transport requires SockJsConfiguration");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9556.java