error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14055.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.CONFIGURE_MODULE, Phase.CONFIGURE_MODULE_WAR, new WarModuleConfigProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14055.java