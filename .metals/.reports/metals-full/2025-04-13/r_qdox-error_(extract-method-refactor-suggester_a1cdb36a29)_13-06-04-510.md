error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5846.java
text:
```scala
i@@f (da.getAspect() == null) da.setAspect(this.inAspect);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5846.java