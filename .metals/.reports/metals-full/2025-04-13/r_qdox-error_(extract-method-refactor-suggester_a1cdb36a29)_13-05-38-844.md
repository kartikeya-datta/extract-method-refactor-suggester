error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5431.java
text:
```scala
r@@eturn new InternalStringTermsFacet(facetName, comparatorType, size, Sets.newHashSet(new InternalStringTermsFacet.StringEntry(indexName, count)), 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5431.java