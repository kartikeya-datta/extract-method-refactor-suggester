error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8235.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8235.java
text:
```scala
public abstract M@@anagementPermission createScopedPermission(Constraint constraint, int constraintIndex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8235.java