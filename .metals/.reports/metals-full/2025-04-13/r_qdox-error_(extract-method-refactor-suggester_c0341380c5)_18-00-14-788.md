error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1786.java
text:
```scala
r@@eturn super.list(suffix);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1786.java