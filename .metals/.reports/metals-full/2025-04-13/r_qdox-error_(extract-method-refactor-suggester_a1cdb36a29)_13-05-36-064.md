error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6298.java
text:
```scala
A@@rquillianService.addService(updateContext.getServiceTarget());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6298.java