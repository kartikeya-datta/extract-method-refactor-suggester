error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9012.java
text:
```scala
O@@rderedMap oldSkin = json.fromJson(OrderedMap.class, oldSkinFile);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9012.java