error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1811.java
text:
```scala
i@@temHeight = hotIndex = -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1811.java