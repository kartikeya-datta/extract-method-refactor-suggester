error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17803.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17803.java
text:
```scala
private transient O@@bject lock = new Object();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17803.java