error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/695.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/695.java
text:
```scala
abstract L@@istAdapter adapterFor(List<E> items);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/695.java