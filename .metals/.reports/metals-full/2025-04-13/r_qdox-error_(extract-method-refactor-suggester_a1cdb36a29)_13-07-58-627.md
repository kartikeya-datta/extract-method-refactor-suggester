error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6703.java
text:
```scala
r@@eturn environment().createRawType((ReferenceBinding) type, type.enclosingType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6703.java