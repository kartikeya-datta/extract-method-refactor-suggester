error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2455.java
text:
```scala
V@@ariablesEvaluator(EvaluationContext context, INameEnvironment environment, Map options, IRequestor requestor, IProblemFactory problemFactory) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2455.java