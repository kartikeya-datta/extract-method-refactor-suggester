error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4646.java
text:
```scala
i@@nt border = (int)Math.ceil (widget.borderWidth ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4646.java