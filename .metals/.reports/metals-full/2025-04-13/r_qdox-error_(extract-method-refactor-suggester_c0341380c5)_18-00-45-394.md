error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12676.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12676.java
text:
```scala
r@@eturn null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12676.java