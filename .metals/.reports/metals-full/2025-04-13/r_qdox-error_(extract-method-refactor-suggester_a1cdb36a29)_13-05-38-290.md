error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3304.java
text:
```scala
d@@ata.font = font != null ? font : Font.win32_new (display, OS.SendMessage (hwnd, OS.WM_GETFONT, 0, 0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3304.java