error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7739.java
text:
```scala
i@@f (config.useGL20 && (major >= 2 || version.contains("2.1"))) { // special case for MESA, wtf...
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7739.java