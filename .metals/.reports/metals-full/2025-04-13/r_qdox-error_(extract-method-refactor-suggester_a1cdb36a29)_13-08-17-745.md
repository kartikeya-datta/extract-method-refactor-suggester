error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5656.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5656.java
text:
```scala
public  L@@ist<VEXNode> getNodes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5656.java