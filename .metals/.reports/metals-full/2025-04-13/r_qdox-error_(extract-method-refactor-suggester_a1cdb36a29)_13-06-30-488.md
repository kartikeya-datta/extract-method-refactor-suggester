error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5147.java
text:
```scala
I@@njector<Executor> getExecutorInjector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5147.java