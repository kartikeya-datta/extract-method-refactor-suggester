error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17823.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17823.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17823.java
text:
```scala
R@@ECT clipRect = item.getBounds (nmcd.dwItemSpec, nmcd.iSubItem, true, false, fullText, false, hDC);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17823.java