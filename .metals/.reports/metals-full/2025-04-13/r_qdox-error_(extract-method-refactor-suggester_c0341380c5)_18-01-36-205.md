error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/310.java
text:
```scala
i@@f (contentHeight [0] < event.height) contentHeight [0] = event.height;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/310.java