error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5099.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5099.java
text:
```scala
public static final A@@ttributeDefinition NAME = SimpleAttributeDefinitionBuilder.create(ModelDescriptionConstants.NAME, ModelType.STRING).setResourceOnly().build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5099.java