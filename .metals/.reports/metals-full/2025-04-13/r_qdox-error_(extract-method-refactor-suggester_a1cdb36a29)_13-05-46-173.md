error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6496.java
text:
```scala
i@@f (isClass() || isInterface() || isEnum() || isAnnotation()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6496.java