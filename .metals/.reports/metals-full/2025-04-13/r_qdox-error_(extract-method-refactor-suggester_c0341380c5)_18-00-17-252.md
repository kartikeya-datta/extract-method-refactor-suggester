error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9735.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9735.java
text:
```scala
C@@omponent getComponent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9735.java