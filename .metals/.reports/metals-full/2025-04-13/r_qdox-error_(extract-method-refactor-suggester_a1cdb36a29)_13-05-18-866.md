error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7060.java
text:
```scala
i@@nt top = this.totalUnits;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7060.java