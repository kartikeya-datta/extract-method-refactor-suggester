error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10097.java
text:
```scala
v@@oid updateControl() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10097.java