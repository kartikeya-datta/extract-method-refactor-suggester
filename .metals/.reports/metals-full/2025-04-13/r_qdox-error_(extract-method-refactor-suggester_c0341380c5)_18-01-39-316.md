error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1950.java
text:
```scala
I@@ndexWriter writer = new IndexWriter(dir, new IndexWriterConfig(TEST_VERSION_CURRENT, analyzer));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1950.java