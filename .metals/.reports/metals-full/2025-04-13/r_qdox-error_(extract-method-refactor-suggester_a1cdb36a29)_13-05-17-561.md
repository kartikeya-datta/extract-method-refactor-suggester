error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17817.java
text:
```scala
r@@eturn versionManager == null ? 1 : versionManager.getVersions()+1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17817.java