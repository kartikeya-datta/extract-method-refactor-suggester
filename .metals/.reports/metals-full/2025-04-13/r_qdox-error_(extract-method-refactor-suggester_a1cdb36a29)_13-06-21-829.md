error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6687.java
text:
```scala
i@@nt semi = charSet.indexOf(';');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6687.java