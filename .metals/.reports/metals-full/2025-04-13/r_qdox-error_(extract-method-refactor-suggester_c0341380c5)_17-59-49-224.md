error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8086.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8086.java
text:
```scala
l@@pti.hwnd = OS.SendMessage (handle, OS.LVM_GETHEADER, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8086.java