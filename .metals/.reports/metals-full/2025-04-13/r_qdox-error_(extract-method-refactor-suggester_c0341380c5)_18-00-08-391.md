error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3936.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3936.java
text:
```scala
s@@etShowToolBarText(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3936.java