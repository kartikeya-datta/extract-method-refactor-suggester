error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16984.java
text:
```scala
S@@tring pageReference = cycle.getApplication().getPages().aliasForClass(pageClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16984.java