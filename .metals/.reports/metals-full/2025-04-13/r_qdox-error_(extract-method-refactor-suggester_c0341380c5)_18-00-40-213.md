error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9626.java
text:
```scala
s@@uper(null,name, (int) (posNom >>> 32), (int) posNom);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9626.java