error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9128.java
text:
```scala
S@@tringBuffer buffer = new StringBuffer(128);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9128.java