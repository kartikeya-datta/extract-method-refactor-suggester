error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2454.java
text:
```scala
B@@ytesStreamInput siBytes = new BytesStreamInput(source, offset, length, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2454.java