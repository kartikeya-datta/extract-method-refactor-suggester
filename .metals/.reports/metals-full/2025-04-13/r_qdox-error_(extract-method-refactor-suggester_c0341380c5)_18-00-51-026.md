error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1250.java
text:
```scala
g@@etComponentInstanceSystemInterceptorFactories().add(interceptorFactory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1250.java