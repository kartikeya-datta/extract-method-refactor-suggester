error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5839.java
text:
```scala
i@@njectionHandle.uninject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5839.java