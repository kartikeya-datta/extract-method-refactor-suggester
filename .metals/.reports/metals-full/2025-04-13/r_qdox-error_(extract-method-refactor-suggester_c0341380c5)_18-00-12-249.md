error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15207.java
text:
```scala
s@@cope.message(IMessage.ERROR, this, "can't find referenced pointcut " + name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15207.java