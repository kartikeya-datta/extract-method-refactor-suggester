error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6923.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6923.java
text:
```scala
i@@f (!format.isCommentingEnabled()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6923.java