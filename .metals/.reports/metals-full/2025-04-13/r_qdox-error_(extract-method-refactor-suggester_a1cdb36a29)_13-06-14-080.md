error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5061.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5061.java
text:
```scala
private final static b@@oolean useNonBlockingMap = Boolean.parseBoolean(System.getProperty("elasticsearch.useNonBlockingMap", "false"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5061.java