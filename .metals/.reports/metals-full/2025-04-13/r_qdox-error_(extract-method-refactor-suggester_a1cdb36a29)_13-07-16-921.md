error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/831.java
text:
```scala
b@@oolean overriding = methDecl == null ? false : (methDecl.binding.modifiers & (AccImplementing|AccOverriding)) != 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/831.java