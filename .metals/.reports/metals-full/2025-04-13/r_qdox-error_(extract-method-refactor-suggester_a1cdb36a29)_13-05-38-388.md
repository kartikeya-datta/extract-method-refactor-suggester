error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/597.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/597.java
text:
```scala
private static final L@@ogger log = LoggerFactory.getLogger(WicketURLDecoder.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/597.java