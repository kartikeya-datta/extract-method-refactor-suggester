error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2334.java
text:
```scala
U@@RL iconURL = GuiMain.class.getResource("/icon/as7_logo_32x32x32.png");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2334.java