error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8230.java
text:
```scala
t@@vItem.mask = OS.TVIF_HANDLE | OS.TVIF_PARAM;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8230.java