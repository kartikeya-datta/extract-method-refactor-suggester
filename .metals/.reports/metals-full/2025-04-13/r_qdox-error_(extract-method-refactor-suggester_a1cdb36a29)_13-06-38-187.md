error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9137.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9137.java
text:
```scala
private I@@ndicesOptions indicesOptions = IndicesOptions.lenientExpandOpen();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9137.java