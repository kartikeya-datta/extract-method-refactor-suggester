error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/904.java
text:
```scala
n@@ew CompletionParser(problemReporter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/904.java