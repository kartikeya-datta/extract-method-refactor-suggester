error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3990.java
text:
```scala
P@@ageA a2 = (PageA)a.getPageMap().get(a.getNumericId(), 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3990.java