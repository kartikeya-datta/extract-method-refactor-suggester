error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1060.java
text:
```scala
m@@oveBy(x - lastX, y - lastY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1060.java