error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6894.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6894.java
text:
```scala
public P@@anel getPanel(MarkupContainer parent, final String panelId)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6894.java