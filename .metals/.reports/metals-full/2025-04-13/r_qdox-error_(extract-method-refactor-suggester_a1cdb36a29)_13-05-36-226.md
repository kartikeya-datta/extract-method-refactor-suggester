error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13035.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13035.java
text:
```scala
private L@@ist<GlobalVarDef> globalVarDefs = new ArrayList<GlobalVarDef>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13035.java