error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2020.java
text:
```scala
s@@cope.problemReporter().typeMismatchError(initializationType, variableType, this.initialization);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2020.java