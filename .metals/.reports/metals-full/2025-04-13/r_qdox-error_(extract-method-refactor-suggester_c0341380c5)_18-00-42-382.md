error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5378.java
text:
```scala
r@@eturn (sharedObjectReceiverIDs==null)?new ID[0]:sharedObjectReceiverIDs;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5378.java