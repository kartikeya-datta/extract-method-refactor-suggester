error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1487.java
text:
```scala
r@@eturn byteArrayToString(address, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1487.java