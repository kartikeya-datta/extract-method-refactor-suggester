error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9096.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9096.java
text:
```scala
S@@tring ROLE = Configurer.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9096.java