error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6513.java
text:
```scala
I@@ndexEngine engine();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6513.java