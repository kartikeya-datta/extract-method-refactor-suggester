error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12920.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12920.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12920.java
text:
```scala
p@@rivate static class LabelModelObject implements IClusterable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12920.java