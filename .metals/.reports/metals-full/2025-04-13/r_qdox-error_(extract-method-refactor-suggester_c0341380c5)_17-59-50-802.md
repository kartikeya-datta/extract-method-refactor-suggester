error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1579.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1579.java
text:
```scala
public M@@odelNode readTransformedModel(ModelVersion modelVersion) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1579.java