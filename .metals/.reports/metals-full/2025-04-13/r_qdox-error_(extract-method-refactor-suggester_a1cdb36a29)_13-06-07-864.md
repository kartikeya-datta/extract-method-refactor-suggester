error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8857.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8857.java
text:
```scala
public synchronized v@@oid reset() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8857.java