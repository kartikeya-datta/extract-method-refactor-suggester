error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1915.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1915.java
text:
```scala
final E@@xtensionAddHandler addExtensionHandler = new ExtensionAddHandler(extensionContext, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1915.java