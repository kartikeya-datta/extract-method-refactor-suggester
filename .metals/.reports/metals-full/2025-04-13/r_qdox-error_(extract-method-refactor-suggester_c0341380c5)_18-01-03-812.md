error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8363.java
text:
```scala
I@@llegalStateException illegalStateArtifactBaseLocation(File dir);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8363.java