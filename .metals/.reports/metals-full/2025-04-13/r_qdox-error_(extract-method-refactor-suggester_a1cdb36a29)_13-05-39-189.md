error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7766.java
text:
```scala
e@@xpandImage.setText("+");//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7766.java