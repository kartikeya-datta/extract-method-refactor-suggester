error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18038.java
text:
```scala
c@@ycle.respond();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18038.java