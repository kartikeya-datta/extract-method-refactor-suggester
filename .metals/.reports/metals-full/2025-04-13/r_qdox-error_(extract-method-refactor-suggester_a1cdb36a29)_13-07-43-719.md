error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6088.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6088.java
text:
```scala
final i@@nt port = AbstractSocketBindingResourceDefinition.PORT.resolveModelAttribute(context, config).asInt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6088.java