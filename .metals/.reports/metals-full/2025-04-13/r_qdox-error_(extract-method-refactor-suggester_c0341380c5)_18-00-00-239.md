error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6515.java
text:
```scala
L@@ist attGroups = getIssueType().getAttributeGroups(module);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6515.java