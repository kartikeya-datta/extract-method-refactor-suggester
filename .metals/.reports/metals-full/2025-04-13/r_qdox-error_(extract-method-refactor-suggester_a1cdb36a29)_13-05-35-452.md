error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2321.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2321.java
text:
```scala
private E@@xecutorService consistencyManager_ = new JMXEnabledThreadPoolExecutor(DatabaseDescriptor.getConsistencyThreads(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2321.java