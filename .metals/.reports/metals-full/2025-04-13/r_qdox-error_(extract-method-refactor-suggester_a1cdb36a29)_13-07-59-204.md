error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9337.java
text:
```scala
i@@f (!repo.generateId().equals(repository.generateId()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9337.java