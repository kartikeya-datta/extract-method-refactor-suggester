error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6010.java
text:
```scala
c@@omponent.getClass(), "test.string", Locale.getDefault(), null, null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6010.java