error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5525.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5525.java
text:
```scala
static i@@nt MINOR_VERSION = 634;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5525.java