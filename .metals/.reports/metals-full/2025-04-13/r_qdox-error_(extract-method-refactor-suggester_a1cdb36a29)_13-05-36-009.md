error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9408.java
text:
```scala
l@@oopingContext.complainOnDeferredChecks(currentScope, flowInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9408.java