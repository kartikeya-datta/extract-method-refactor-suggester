error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4018.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4018.java
text:
```scala
public b@@oolean autoAdd(final Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4018.java