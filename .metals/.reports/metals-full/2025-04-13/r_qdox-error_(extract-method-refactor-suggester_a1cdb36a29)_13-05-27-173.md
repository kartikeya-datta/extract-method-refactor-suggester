error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8358.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8358.java
text:
```scala
final d@@ouble curN = current.getN();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8358.java