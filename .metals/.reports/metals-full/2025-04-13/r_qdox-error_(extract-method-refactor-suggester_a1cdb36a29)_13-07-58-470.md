error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1676.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1676.java
text:
```scala
t@@data.type = gtkSelectionData.type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1676.java