error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17818.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17818.java
text:
```scala
i@@f (behavior instanceof IHeaderContributor && behavior.isEnabled(this))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17818.java