error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10012.java
text:
```scala
s@@uper(false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10012.java