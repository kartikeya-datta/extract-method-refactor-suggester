error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3710.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3710.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3710.java
text:
```scala
public static final S@@tring DATA = "ExampleSampler.data"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3710.java