error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7902.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7902.java
text:
```scala
public T@@extButtonStyle (Drawable up, Drawable down, Drawable checked) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7902.java