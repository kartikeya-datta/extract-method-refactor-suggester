error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9932.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9932.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9932.java
text:
```scala
private static final M@@ap<String, Boolean> requireOpenBodyCloseTag = new HashMap<String, Boolean>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9932.java