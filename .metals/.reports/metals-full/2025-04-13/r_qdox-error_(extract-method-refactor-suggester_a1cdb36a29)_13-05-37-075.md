error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9786.java
text:
```scala
e@@ventContainer.addProperties(event.getProperties());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9786.java