error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4202.java
text:
```scala
R@@eferenceBinding qualifiedType = (ReferenceBinding) this.environment().convertToRawType(typeBinding, false /*do not force conversion of enclosing types*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4202.java