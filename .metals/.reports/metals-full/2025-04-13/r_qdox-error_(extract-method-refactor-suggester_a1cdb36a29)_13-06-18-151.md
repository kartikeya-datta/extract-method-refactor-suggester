error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/771.java
text:
```scala
s@@ession.delegateConnectionEstablished();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/771.java