error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5126.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5126.java
text:
```scala
public v@@oid install(final BatchBuilder builder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5126.java