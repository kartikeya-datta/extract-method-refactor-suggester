error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2430.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2430.java
text:
```scala
c@@heckRandomData(random(), new GermanAnalyzer(TEST_VERSION_CURRENT), 1000*RANDOM_MULTIPLIER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2430.java