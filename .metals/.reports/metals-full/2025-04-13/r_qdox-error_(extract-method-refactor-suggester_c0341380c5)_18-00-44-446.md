error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2469.java
text:
```scala
r@@eturn new ScriptDocValues.Strings(getBytesValues());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2469.java