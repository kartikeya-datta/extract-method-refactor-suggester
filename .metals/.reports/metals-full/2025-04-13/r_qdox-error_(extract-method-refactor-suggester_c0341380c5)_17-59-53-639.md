error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12008.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12008.java
text:
```scala
public i@@nt lineWidth;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12008.java