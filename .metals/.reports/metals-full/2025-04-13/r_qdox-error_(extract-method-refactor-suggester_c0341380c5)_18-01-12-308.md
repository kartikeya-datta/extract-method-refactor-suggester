error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6024.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6024.java
text:
```scala
public synchronized C@@lassReflectionIndex getClassIndex(Class<?> clazz) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6024.java