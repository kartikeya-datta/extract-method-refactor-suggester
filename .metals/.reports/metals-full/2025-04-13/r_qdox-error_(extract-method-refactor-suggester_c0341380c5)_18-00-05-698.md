error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/239.java
text:
```scala
i@@nt lineOptions = OS.kATSLineLastNoJustification | OS.kATSLineUseDeviceMetrics | OS.kATSLineKeepSpacesOutOfMargin;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/239.java