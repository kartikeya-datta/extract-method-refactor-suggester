error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/575.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/575.java
text:
```scala
static final S@@tring RECOVERLUGIN_CLASSNAME = "recovery-plugin-class-name";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/575.java