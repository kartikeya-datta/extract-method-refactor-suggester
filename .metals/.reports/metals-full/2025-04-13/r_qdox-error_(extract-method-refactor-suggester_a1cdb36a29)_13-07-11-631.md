error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/260.java
text:
```scala
r@@eflector.reflect(TermToBytesRefAttribute.class, "bytes", new BytesRef(bytes));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/260.java