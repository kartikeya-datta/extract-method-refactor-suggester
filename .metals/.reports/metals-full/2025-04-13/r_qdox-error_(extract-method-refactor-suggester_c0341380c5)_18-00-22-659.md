error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3415.java
text:
```scala
s@@uper("org.columba.core.menu",null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3415.java