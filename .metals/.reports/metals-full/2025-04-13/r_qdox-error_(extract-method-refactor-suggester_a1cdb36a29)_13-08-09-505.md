error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4508.java
text:
```scala
S@@tring path = jEdit.getProperty("plugin-manager.export-url");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4508.java