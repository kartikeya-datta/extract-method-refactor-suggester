error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2819.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2819.java
text:
```scala
q@@uery.add(new BooleanClause(mapper.termQuery(value, parseContext), BooleanClause.Occur.SHOULD));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2819.java