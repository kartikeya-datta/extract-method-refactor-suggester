error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4504.java
text:
```scala
r@@eturn Integer.parseInt(st.nextToken());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4504.java