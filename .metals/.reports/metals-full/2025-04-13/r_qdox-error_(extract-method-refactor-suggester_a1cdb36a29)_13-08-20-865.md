error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/931.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/931.java
text:
```scala
public v@@oid testSparseIterator() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/931.java