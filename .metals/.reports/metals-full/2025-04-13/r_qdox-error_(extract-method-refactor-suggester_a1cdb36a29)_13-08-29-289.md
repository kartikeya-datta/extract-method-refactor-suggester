error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2227.java
text:
```scala
D@@ocumentProcessor.tokenizeDocuments(input, DefaultAnalyzer.class, output, configuration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2227.java