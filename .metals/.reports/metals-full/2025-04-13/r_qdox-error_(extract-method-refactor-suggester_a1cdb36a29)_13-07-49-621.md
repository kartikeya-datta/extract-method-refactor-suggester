error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1540.java
text:
```scala
a@@dd(new HomePageMapper(new HomePageProvider<Page>(application)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1540.java