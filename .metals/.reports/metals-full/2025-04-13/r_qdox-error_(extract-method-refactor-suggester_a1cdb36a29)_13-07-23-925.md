error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6760.java
text:
```scala
i@@f (progress != null) progress.setCanceled(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6760.java