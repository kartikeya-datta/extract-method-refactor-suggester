error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6891.java
text:
```scala
i@@f (!scheduledExecutorService.isTerminated()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6891.java