error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2333.java
text:
```scala
s@@uper(CommonAttributes.ENTRIES, CommonAttributes.ENTRIES, false, ModelType.STRING, 1, Integer.MAX_VALUE, new String[0], new String[0], new StringLengthValidator(1), null, false,null,AttributeAccess.Flag.RESTART_ALL_SERVICES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2333.java