error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3695.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3695.java
text:
```scala
final i@@nt numSearches = scaledRandomIntBetween(50, 150);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3695.java