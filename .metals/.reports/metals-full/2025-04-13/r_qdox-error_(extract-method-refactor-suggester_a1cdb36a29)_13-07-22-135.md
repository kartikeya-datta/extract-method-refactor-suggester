error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15294.java
text:
```scala
i@@nt /*long*/ context = OS.gtk_drag_begin(control.handle, targetList, actions, 1, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15294.java