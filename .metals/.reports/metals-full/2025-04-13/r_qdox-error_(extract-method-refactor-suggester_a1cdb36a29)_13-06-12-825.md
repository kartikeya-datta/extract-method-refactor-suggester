error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6580.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6580.java
text:
```scala
-F@@loat.MAX_VALUE, Float.MAX_VALUE,locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6580.java