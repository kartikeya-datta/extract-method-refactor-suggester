error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17626.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[104,80]

error in qdox parser
file content:
```java
offset: 2664
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17626.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17626.java