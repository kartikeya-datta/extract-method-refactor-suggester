error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5236.java
text:
```scala
i@@f (child instanceof IParent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5236.java