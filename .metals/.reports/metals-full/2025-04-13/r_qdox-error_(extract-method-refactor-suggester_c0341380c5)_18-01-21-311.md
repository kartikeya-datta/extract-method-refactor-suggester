error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16978.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16978.java
text:
```scala
final S@@tring encryptedPassword = application.getSettings().getCryptInstance().encryptString("test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16978.java