error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8101.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8101.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8101.java
text:
```scala
i@@f (ignoreEmptyLines) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8101.java