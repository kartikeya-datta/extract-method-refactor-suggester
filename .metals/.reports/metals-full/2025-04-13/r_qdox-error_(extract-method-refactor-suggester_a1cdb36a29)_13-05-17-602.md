error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9724.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9724.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9724.java
text:
```scala
i@@f (this.ast.apiLevel == AST.LEVEL_2_0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9724.java