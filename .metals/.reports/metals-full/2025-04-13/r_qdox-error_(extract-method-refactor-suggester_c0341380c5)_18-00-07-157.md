error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7552.java
text:
```scala
s@@witch (((InternalSearchPattern)pattern).kind) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7552.java