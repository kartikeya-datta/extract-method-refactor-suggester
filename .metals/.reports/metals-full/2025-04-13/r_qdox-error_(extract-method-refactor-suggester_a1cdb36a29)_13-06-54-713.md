error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2862.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2862.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2862.java
text:
```scala
r@@eturn new GwtFileHandle(preloader, file + (file.endsWith("/") ? "" : "/") + name, FileType.Internal);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2862.java