error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4514.java
text:
```scala
r@@eturn Strings.replaceAll(stringWriter.toString(),"\t", "    ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4514.java