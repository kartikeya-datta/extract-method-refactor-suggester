error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3510.java
text:
```scala
i@@nt /*long*/ gtk_expose_event (int /*long*/ widget, int /*long*/ eventPtr) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3510.java