error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/882.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/882.java
text:
```scala
final I@@Model previous = getModelImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/882.java