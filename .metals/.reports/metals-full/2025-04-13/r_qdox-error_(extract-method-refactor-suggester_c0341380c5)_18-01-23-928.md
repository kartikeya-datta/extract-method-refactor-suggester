error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3733.java
text:
```scala
b@@uilder.startObject(name).field(type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3733.java