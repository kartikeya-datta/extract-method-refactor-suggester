error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10762.java
text:
```scala
n@@amespace = IDFactory.getDefault().getNamespaceByName(StringID.class.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10762.java