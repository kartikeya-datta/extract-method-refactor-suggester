error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2311.java
text:
```scala
r@@eturn "openjpa.slice";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2311.java