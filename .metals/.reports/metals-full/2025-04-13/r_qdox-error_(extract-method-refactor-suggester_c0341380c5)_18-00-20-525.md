error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6677.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6677.java
text:
```scala
i@@f (url.indexOf("?") >= 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6677.java