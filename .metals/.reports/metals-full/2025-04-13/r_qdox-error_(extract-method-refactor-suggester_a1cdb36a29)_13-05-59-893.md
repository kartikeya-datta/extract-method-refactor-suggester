error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12406.java
text:
```scala
e@@xtends BaseMultivariateOptimizer<DifferentiableMultivariateFunction> {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12406.java