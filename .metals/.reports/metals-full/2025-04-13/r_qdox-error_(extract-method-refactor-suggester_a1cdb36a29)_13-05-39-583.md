error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9731.java
text:
```scala
a@@ssertEquals("x.tar.bz2", BZip2Utils.getCompressedFilename("x.TAR"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9731.java