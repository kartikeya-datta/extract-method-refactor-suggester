error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5909.java
text:
```scala
s@@etActionDefinitionId(IWorkbenchCommandConstants.HELP_HELP_SEARCH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5909.java