error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/841.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/841.java
text:
```scala
public static final S@@tring NAME = "maxscore";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/841.java