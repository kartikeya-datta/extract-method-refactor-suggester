error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2350.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2350.java
text:
```scala
n@@ew LdapAuthenticationAddHandler(), new SecurityRealmChildRemoveHandler(true, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2350.java