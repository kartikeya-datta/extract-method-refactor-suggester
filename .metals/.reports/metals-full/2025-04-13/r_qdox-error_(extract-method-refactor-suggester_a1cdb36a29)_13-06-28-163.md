error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3822.java
text:
```scala
s@@prite  = atlas.createSprite("map");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3822.java