error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2307.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2307.java
text:
```scala
public synchronized S@@tring getMessage() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2307.java