error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10381.java
text:
```scala
i@@f (issue != null && (issue.getPullRequest() == null || issue.getPullRequest().getHtmlUrl() == null))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10381.java