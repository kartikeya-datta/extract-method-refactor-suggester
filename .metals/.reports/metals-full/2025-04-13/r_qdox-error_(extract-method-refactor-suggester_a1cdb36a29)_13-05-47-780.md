error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2445.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2445.java
text:
```scala
i@@mplements Unmodifiable, Serializable {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2445.java