error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1476.java
text:
```scala
R@@owMutation rm = new RowMutation("Keyspace1", key.getBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1476.java