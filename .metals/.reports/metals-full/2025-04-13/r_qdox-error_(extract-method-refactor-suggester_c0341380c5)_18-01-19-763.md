error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/506.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/506.java
text:
```scala
private static L@@ogger logger = LoggerFactory.getLogger(AbstractCompactionIterable.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/506.java