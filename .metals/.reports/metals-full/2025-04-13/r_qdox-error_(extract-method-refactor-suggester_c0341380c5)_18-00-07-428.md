error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5897.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5897.java
text:
```scala
w@@hile (!this.scanner.atEnd() && this.completionNode == null && !this.abort) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5897.java