error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9452.java
text:
```scala
r@@eturn (acceptDocs == null || acceptDocs.get(doc)) && parents.contains(typeCache.idByDoc(doc));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9452.java