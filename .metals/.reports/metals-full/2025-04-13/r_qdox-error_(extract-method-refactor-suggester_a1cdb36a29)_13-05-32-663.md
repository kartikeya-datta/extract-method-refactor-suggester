error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9528.java
text:
```scala
t@@erminal.println("%s", doc.get(docMapper.mappers().smartName("file").mapper().names().indexName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9528.java