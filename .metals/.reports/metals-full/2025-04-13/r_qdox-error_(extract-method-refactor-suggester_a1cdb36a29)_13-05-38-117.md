error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2382.java
text:
```scala
s@@hell.setSize(shell.computeSize(size.x, size.y));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2382.java