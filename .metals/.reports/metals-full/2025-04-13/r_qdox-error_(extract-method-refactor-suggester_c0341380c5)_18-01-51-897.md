error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8575.java
text:
```scala
S@@ystem.arraycopy(b[i], 0, root.getDataRef()[swap[i]], 0, rank);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8575.java