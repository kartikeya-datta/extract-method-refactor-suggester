error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12782.java
text:
```scala
s@@etUp(DROP_TABLES, Node.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12782.java