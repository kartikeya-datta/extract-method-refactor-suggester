error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9987.java
text:
```scala
S@@arMessages.MESSAGES.failedToProcessSarChild(e, deploymentRoot);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9987.java