error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14435.java
text:
```scala
a@@rchive.addAsManifestResource(BeanFactoryTestCase.class.getPackage(), "bf-jboss-beans.xml", "bf-jboss-beans.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14435.java