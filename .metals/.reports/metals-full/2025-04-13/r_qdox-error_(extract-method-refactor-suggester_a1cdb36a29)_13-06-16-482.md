error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7464.java
text:
```scala
t@@his.saveValueVariable.useFlag = LocalVariableBinding.USED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7464.java