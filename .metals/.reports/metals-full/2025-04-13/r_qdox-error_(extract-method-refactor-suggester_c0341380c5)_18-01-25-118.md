error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6631.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6631.java
text:
```scala
public final S@@tring getMountPath()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6631.java