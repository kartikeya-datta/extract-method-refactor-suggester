error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7130.java
text:
```scala
S@@hardIterator shardsIt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7130.java