error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1358.java
text:
```scala
s@@tyle |= SWT.H_SCROLL | SWT.V_SCROLL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1358.java