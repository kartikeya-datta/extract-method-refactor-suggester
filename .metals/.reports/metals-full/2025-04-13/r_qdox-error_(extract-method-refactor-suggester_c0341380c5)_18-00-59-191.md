error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7008.java
text:
```scala
S@@WT.error(SWT.ERROR_NO_GRAPHICS_LIBRARY, t, " [Cairo is required]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7008.java