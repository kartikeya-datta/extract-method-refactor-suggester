error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10984.java
text:
```scala
s@@um = sampler.nextSamplePoint().y;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10984.java