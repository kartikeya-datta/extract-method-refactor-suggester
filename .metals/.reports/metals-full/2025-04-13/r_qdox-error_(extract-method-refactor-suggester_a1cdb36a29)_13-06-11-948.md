error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/146.java
text:
```scala
t@@ests[testIndex].dispose();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/146.java