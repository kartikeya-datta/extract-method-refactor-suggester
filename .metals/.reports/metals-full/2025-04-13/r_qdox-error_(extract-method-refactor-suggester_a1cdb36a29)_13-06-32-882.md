error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3598.java
text:
```scala
s@@tateTransferAddress.add(ModelKeys.STATE_TRANSFER, ModelKeys.STATE_TRANSFER_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3598.java