error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8522.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8522.java
text:
```scala
public v@@oid figureSelectionChanged(DrawingView view) {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8522.java