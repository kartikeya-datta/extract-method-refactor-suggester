error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7027.java
text:
```scala
b@@oolean isFocusItem = parent.focusItem == this && parent.isFocusControl ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7027.java