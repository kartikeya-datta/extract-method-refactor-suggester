error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10913.java
text:
```scala
r@@eturn new WebSession(this, request, response).setStyle("myStyle");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10913.java