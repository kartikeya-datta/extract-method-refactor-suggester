error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14275.java
text:
```scala
C@@oreManagementResourceDefinition.registerDomainResource(rootResource, authorizer.getWritableAuthorizerConfiguration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14275.java