error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6587.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6587.java
text:
```scala
a@@ssertThat("10b", is(new ByteSizeValue(10, ByteSizeUnit.BYTES).toString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6587.java