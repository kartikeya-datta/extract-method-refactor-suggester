error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15614.java
text:
```scala
p@@ublic class Index extends BasePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15614.java