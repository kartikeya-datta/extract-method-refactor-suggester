error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15065.java
text:
```scala
i@@f(!ctx.getParsedArguments().hasArguments()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15065.java