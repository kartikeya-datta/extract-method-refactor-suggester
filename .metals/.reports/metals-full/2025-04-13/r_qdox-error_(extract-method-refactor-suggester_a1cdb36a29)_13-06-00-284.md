error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17016.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17016.java
text:
```scala
: !t@@arget(Aspect) && args(i)  && !target(StringBuffer)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17016.java