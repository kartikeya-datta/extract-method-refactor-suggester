error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3784.java
text:
```scala
i@@f ((keyStrokes.size() > 2) || (isFirstStrokeModified(keyStrokes))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3784.java