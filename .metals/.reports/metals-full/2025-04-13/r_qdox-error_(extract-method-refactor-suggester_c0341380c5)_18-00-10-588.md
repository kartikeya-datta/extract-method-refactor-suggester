error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13003.java
text:
```scala
E@@jbLogger.ROOT_LOGGER.invalidTransactionTypeForSfsbLifecycleMethod(txAttr, methodIdentifier, ejb.getComponentClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13003.java