error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1699.java
text:
```scala
r@@eturn instance(nameType, rt, Languages.ANY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1699.java