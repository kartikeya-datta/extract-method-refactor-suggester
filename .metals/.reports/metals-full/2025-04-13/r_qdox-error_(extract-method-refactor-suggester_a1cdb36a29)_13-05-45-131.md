error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2301.java
text:
```scala
O@@S.UIElement_Visibility (topHandle, visible ? OS.Visibility_Visible : OS.Visibility_Collapsed);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2301.java