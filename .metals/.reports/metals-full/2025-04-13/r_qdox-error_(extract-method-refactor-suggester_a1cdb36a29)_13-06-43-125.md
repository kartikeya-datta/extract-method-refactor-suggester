error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1342.java
text:
```scala
s@@uper (parent, style = checkStyle (style));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1342.java