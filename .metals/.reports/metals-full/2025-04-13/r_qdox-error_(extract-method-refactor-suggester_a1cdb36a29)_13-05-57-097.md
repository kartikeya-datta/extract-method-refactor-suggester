error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4812.java
text:
```scala
r@@eturn convertToVariableDeclarationStatement((LocalDeclaration)statement);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4812.java