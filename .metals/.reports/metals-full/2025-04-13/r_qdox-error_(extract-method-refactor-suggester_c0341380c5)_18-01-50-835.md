error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3651.java
...
```java
offset: 848
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3651.java
text:
```scala
...
p@@ackage org.elasticsearch.deps.lucene;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3651.java