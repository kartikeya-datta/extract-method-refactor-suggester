error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1993.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1993.java
text:
```scala
protected v@@oid onAfterRenderChildren()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1993.java