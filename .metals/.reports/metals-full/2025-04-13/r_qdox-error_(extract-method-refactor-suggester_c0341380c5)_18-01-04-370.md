error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13565.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13565.java
text:
```scala
private S@@tandaloneMockMvcBuilder builder;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13565.java