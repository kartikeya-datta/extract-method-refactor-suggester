error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8820.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8820.java
text:
```scala
public static final S@@tring JSON_TYPE = "_source";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8820.java