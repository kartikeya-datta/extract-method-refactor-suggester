error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4810.java
text:
```scala
c@@omposerController.getContainer().close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4810.java