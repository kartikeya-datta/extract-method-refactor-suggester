error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/590.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/590.java
text:
```scala
t@@hrow new DeploymentUnitProcessingException("Failed to get module attachment for deployment: " + context.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/590.java