error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7034.java
text:
```scala
L@@ucene.KEYWORD_ANALYZER, postingsProvider, docValuesProvider, null, null, fieldDataSettings, indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7034.java