error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9343.java
text:
```scala
t@@hrow new TimeoutException(NLS.bind(Messages.IRCRootContainer_Connect_Timeout, tID.getName()), CONNECT_TIMEOUT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9343.java