error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6359.java
text:
```scala
i@@f (r.getType() == type && name.equals(r.getName()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6359.java