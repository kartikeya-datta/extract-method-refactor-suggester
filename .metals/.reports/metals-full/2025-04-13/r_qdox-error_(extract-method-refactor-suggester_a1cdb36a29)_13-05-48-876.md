error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6778.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6778.java
text:
```scala
public static b@@oolean isPostConstructCalled() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6778.java