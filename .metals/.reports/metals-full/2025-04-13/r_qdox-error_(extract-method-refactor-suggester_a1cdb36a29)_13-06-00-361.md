error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11325.java
text:
```scala
i@@f (getDefaultModelObject() != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11325.java