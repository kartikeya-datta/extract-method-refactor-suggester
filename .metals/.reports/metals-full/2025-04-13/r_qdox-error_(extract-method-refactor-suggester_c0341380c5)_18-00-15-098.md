error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5793.java
text:
```scala
C@@ategory.getDefaultHierarchy().clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5793.java