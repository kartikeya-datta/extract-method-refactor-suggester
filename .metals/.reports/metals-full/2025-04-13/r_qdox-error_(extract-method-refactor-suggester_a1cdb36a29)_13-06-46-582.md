error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12926.java
text:
```scala
r@@eturn count == 0 && scrollWidth == 0 ? handle : hwndParent;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12926.java