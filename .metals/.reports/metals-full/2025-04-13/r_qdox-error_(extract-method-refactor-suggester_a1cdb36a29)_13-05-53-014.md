error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14484.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14484.java
text:
```scala
S@@tringBuilder buildUrl = new StringBuilder(url.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14484.java