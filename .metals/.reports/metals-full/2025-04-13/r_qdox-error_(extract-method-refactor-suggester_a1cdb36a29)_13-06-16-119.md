error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9604.java
...
```java
offset: 876
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9604.java
text:
```scala
...
p@@ackage org.elasticsearch.action.admin.indices.stats;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9604.java