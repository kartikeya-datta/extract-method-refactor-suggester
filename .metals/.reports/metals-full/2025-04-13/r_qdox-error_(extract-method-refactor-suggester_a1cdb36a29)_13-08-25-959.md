error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10153.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10153.java
text:
```scala
final S@@tring indexOrId = getInput();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10153.java