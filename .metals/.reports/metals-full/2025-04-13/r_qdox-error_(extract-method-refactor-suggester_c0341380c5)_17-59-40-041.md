error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2894.java
text:
```scala
a@@nyNonBulkMerges |= merger.getAnyNonBulkMerges();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2894.java