error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10432.java
text:
```scala
S@@ystem.setProperty("aesh.terminal","org.jboss.aesh.terminal.TestTerminal");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10432.java