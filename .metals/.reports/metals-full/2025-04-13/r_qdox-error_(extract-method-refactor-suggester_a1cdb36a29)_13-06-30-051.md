error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6974.java
text:
```scala
e@@xtends BaseAbstractUnivariateSolver<PolynomialFunction>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6974.java