error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7557.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7557.java
text:
```scala
private T@@rieUtils() {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7557.java