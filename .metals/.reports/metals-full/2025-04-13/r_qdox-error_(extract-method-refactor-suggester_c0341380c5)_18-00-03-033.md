error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/438.java
text:
```scala
v@@ertices[idx++] = v;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/438.java