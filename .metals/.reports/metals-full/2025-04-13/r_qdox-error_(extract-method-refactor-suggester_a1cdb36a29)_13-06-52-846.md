error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/378.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/378.java
text:
```scala
protected v@@oid update(final int position, final FilterItemView view, final IssueFilter filter) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/378.java