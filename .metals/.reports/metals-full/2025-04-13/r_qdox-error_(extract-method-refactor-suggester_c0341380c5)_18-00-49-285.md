error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5771.java
text:
```scala
p@@rops.put(Constants.SERVICE_RANKING, new Integer(1000));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5771.java