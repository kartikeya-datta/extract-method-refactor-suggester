error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2395.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2395.java
text:
```scala
final C@@lass homePageClass = requestCycle.getApplication().getHomePage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2395.java