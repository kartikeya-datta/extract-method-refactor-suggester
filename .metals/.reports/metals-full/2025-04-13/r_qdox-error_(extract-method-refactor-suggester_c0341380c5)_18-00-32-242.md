error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3441.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3441.java
text:
```scala
public static final S@@pecifiedInterfaceAddHandler INSTANCE = new SpecifiedInterfaceAddHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3441.java