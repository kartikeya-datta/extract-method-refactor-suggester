error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5144.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5144.java
text:
```scala
a@@ssertTrue((p.waitFor() == 0) == success);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5144.java