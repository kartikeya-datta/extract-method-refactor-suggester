error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5151.java
text:
```scala
r@@eturn null;//throw new DeployException("TODO: We need security context service to implement it!");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5151.java