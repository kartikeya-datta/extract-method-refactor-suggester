error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16872.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16872.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16872.java
text:
```scala
P@@oint size = textExtent (str, wHint != SWT.DEFAULT && (style & SWT.WRAP) != 0 ? wHint : 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16872.java