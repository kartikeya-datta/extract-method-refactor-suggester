error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9799.java
text:
```scala
T@@uple<Settings, Environment> tuple = InternalSettingsPreparer.prepareSettings(pSettings, loadConfigSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9799.java