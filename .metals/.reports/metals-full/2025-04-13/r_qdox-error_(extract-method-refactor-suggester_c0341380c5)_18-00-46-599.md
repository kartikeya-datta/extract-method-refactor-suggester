error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2034.java
text:
```scala
a@@ction.printStatement(tab + 1, output);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2034.java