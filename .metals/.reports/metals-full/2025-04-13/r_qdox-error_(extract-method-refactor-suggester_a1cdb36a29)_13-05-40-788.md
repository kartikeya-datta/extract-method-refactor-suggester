error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14639.java
text:
```scala
I@@Annotation annotation = AnnotationUtils.getAnnotation(WebMethod.class, method);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14639.java