error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13530.java
text:
```scala
t@@hrow new IllegalStateException("peek() or element() called before remove()");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13530.java