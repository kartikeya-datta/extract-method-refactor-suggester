error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7484.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7484.java
text:
```scala
protected I@@nterpolator interpolator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7484.java