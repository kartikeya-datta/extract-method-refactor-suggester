error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1125.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1125.java
text:
```scala
public static final V@@ersion TEST_VERSION_CURRENT = Version.LUCENE_44;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1125.java