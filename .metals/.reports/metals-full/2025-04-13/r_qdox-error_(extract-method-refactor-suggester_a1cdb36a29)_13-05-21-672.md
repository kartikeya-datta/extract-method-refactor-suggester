error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1025.java
text:
```scala
b@@ody.applyCentralImpulse(Vector3.tmp2.set(ray.direction).scl(20f));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1025.java