error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7517.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7517.java
text:
```scala
public static final C@@lass<? extends MergeSchedulerProvider> DEFAULT = ConcurrentMergeSchedulerProvider.class;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7517.java