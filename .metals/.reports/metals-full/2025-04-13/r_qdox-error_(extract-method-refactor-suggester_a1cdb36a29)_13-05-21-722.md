error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11084.java
text:
```scala
p@@roject.addIdReference(id, element);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11084.java