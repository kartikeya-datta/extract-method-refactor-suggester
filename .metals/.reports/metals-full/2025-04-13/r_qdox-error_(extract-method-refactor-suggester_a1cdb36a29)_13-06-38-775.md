error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9191.java
text:
```scala
C@@lass<?>[] types = new Class<?>[callbacks.length];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9191.java