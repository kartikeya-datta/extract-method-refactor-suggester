error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9065.java
text:
```scala
r@@eport((int) (start >>> 32), (int) end, element, accuracy); // extract the start and end from the encoded long positions
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9065.java