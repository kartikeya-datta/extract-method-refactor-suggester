error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8213.java
text:
```scala
I@@Buffer buffer = BufferManager.createBuffer(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8213.java