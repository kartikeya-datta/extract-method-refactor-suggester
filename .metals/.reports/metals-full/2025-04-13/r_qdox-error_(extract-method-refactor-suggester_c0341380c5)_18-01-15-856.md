error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/650.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/650.java
text:
```scala
public C@@ryptFactoryCachingDecorator(final ICryptFactory delegate)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/650.java