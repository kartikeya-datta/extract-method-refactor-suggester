error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1892.java
text:
```scala
S@@tring SUMMARY_FRAGSIZE = CARROT_PREFIX + "fragSize";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1892.java