error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7596.java
text:
```scala
T@@exture texture = new Texture(Gdx.files.internal("data/ninja.jpg"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7596.java