error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7621.java
text:
```scala
r@@eturn this.expressionType = binding.type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7621.java