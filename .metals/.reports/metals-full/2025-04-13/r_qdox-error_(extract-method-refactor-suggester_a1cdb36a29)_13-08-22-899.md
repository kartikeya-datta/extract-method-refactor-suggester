error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14396.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14396.java
text:
```scala
protected S@@tring getServerContainerTypeName() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14396.java