error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2479.java
text:
```scala
S@@tring DEFAULT_PACKAGEROOT_PATH = ""/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2479.java