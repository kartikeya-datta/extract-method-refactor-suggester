error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/269.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/269.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/269.java
text:
```scala
r@@econciler = TimestampReconciler.instance; // default
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/269.java