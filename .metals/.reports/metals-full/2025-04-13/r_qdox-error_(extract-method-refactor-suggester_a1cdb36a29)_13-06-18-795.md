error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12620.java
text:
```scala
S@@tringBuilder retval = new StringBuilder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12620.java