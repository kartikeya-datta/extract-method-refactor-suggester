error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1072.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1072.java
text:
```scala
public abstract S@@olrCoreState getSolrCoreState();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1072.java