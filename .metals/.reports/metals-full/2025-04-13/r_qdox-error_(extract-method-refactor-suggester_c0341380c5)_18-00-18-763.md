error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9556.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9556.java
text:
```scala
public static final M@@arkupResourceData NO_MARKUP = new MarkupResourceData();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9556.java