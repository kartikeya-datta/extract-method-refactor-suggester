error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/292.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/292.java
text:
```scala
private final C@@ommonWebServer webServer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/292.java