error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14355.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14355.java
text:
```scala
private final C@@RC32 crc = new CRC32();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14355.java