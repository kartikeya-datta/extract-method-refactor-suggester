error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1254.java
text:
```scala
n@@ew NamedAnalyzer("_float/max", new NumericFloatAnalyzer(Integer.MAX_VALUE)), provider, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1254.java