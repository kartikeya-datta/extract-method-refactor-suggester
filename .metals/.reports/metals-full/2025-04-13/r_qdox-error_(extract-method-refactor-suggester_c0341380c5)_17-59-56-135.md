error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5771.java
text:
```scala
h@@eaderList.add(strippedHeader, strippedHeader.get("columba.pop3uid"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5771.java