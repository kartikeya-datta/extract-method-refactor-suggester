error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15043.java
text:
```scala
n@@ew SimpleBorder(borderContainer, "myBorder");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15043.java