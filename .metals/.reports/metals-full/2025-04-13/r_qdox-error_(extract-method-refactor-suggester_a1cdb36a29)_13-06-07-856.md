error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12935.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12935.java
text:
```scala
private i@@nt uuid = -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12935.java