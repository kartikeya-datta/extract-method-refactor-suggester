error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5375.java
text:
```scala
r@@eturn new PolymorphicResolver (new QualifiedName ("operatorPlus")).getBestFitCandidates (fdc.findFunctionCandidates (new QualifiedName ("operatorPlus"), fdc.typesForParameters(createEmptyExecutionContext().getTypesystem(), Arrays.asList (params)), false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5375.java