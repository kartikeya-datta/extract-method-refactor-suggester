error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3597.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3597.java
text:
```scala
private static final P@@athElement stateTransferPath = PathElement.pathElement(ModelKeys.STATE_TRANSFER, ModelKeys.STATE_TRANSFER_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3597.java