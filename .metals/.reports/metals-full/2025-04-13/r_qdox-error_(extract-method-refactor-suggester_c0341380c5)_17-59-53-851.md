error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/209.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/209.java
text:
```scala
d@@irectory = FSDirectory.getDirectory(dirName, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/209.java