error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2650.java
text:
```scala
J@@MenuItem japanese = new JMenuItem(JMeterUtils.getResString("ja"), 'J'); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2650.java