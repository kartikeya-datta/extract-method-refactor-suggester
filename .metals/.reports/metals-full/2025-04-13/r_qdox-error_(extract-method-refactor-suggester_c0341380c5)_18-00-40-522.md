error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2044.java
text:
```scala
f@@lowContext.recordUsingNullReference(currentScope, local, this.lhs, FlowInfo.NULL, flowInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2044.java