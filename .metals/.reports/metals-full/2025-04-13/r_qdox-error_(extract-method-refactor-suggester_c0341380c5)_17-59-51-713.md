error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7898.java
...
```java
offset: 906
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7898.java
text:
```scala
...
p@@ackage org.elasticsearch.cluster.ack;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7898.java