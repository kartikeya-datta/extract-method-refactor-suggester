error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/591.java
text:
```scala
i@@f (ie.auto != null && ie._getUrl().startsWith(IE.ABOUT_BLANK) && !ie.untrustedText) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/591.java