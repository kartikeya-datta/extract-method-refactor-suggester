error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5792.java
text:
```scala
F@@ileHandle src = Gdx.files.internal("data/iron.mp3");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5792.java