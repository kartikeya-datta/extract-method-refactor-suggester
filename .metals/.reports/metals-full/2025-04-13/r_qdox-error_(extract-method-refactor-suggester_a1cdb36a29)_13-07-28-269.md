error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2585.java
text:
```scala
m@@arkupId = RequestContext.get().encodeMarkupId(getId() + page.getAutoIndex());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2585.java