error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9060.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9060.java
text:
```scala
public P@@ageParameters(final Map<String, Object> parameterMap)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9060.java