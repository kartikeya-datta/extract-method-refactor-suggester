error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3212.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3212.java
text:
```scala
D@@eleteIndexResponse deleteIndexResponse = client().admin().indices().prepareDelete("_all").execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3212.java