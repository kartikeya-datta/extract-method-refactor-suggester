error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5324.java
text:
```scala
a@@dd(new DatePicker("datePicker3", dateField3, DatePicker.BUTTON_ICON_3));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5324.java