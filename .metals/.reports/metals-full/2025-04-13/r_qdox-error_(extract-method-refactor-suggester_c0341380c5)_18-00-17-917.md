error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1607.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1607.java
text:
```scala
private T@@hreadLocal<HBaseConfiguration> hBconf = new ThreadLocal<HBaseConfiguration>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1607.java