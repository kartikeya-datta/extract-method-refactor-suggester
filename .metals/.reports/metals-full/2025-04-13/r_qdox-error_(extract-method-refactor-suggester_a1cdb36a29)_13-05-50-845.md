error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16602.java
text:
```scala
T@@ypeLib[] getTypeLibs();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16602.java