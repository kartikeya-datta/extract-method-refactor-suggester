error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8074.java
text:
```scala
t@@his.workerCount = componentSettings.getAsInt("worker_count", EsExecutors.boundedNumberOfProcessors(settings) * 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8074.java