error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8489.java
text:
```scala
R@@outingTable routingTable = RoutingTable.builder().build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8489.java