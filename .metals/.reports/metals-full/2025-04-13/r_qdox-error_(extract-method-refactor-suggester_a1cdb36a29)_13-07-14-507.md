error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14393.java
...
```java
offset: 683
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14393.java
text:
```scala
...
p@@ackage org.springframework.cache.support;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14393.java