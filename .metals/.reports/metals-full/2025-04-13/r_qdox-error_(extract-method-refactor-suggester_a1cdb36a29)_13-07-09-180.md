error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7547.java
text:
```scala
s@@uper(XMLStreamConstants.DTD, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7547.java