error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8477.java
text:
```scala
c@@ollector = new FilteredCollector(collector, searchContext.parsedFilter().filter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8477.java