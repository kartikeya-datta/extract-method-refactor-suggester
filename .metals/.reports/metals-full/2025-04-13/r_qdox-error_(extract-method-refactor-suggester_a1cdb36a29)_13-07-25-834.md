error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1578.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1578.java
text:
```scala
private static I@@ndexService createIndex(String index, CreateIndexRequestBuilder createIndexRequestBuilder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1578.java