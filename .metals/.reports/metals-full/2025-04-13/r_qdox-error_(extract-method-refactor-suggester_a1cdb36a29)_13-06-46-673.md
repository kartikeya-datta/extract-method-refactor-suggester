error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7770.java
text:
```scala
s@@ecurityRole.registerOperationHandler(REMOVE, SecurityRoleRemove.INSTANCE, SecurityRoleRemove.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7770.java