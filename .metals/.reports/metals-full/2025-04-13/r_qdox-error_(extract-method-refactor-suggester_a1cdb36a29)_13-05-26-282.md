error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8237.java
text:
```scala
I@@mageLoader.getSmallIcon("preferences-system.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8237.java