error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8378.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[61,2]

error in qdox parser
file content:
```java
offset: 2257
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8378.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8378.java