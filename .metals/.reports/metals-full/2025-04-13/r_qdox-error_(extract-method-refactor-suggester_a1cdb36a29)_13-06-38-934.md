error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7836.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7836.java
text:
```scala
static final f@@loat DAMP = 0.80f;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7836.java