error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4147.java
text:
```scala
i@@f (Strings.hasLength(script) && out.getVersion().onOrAfter(Version.V_1_3_0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4147.java