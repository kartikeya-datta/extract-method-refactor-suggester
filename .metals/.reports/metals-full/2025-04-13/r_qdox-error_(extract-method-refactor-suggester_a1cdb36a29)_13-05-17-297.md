error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6679.java
text:
```scala
r@@equest = request.cloneWithUrl(url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6679.java