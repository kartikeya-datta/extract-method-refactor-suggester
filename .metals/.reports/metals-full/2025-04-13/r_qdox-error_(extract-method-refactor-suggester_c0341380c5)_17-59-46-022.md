error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4858.java
text:
```scala
t@@empDomain = name + "-" + i++;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4858.java