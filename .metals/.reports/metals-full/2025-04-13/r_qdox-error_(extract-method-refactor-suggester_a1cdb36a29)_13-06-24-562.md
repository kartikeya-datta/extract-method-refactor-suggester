error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5002.java
text:
```scala
r@@eturn new Rectangle (column.getX (), parent.getItemY (this) + 1, column.width, parent.itemHeight - 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5002.java