error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/32.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/32.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/32.java
text:
```scala
s@@tage.getViewport().update(width, height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/32.java