error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4125.java
text:
```scala
n@@ewColl = coll.getClass().newInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4125.java