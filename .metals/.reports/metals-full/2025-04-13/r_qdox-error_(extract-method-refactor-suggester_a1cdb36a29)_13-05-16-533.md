error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12737.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12737.java
text:
```scala
final S@@tring proto = serviceInfo.getProtocol();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12737.java