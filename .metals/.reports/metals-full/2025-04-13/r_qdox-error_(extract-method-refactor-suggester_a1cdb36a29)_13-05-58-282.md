error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4576.java
text:
```scala
b@@uilder.addServer().host(value.getResolvedDestinationAddress().getHostAddress()).port(value.getDestinationPort());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4576.java