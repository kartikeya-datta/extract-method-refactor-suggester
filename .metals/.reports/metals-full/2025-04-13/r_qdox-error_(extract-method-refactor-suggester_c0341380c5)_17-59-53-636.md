error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/238.java
text:
```scala
i@@f (isVisibleInHierarchy() && isEnabledInHierarchy())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/238.java