error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15994.java
text:
```scala
S@@tring dname = "cn=" + subject + ", o=JMeter Proxy (TEMPORARY TRUST ONLY)";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15994.java