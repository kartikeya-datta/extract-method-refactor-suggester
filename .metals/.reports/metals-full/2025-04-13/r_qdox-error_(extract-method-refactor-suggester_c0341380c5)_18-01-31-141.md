error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6425.java
text:
```scala
b@@yte[] buffer = new byte[blobStore.bufferSizeInBytes()];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6425.java