error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/175.java
text:
```scala
r@@eturn (pageLink.linksTo(findPage())) ? "selectedTab" : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/175.java