error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6841.java
text:
```scala
f@@ireSelectionChanged( new TableSelectionChangedEvent( folder, getUidArray() ));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6841.java