error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9829.java
text:
```scala
s@@etContentView(layout.issues_filter_list);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9829.java