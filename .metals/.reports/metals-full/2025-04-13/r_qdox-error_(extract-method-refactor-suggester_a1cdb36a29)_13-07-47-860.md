error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8465.java
text:
```scala
t@@hreadPool.info(), transportService.info());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8465.java