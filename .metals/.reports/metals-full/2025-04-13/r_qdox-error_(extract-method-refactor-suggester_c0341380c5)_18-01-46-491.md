error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6276.java
text:
```scala
r@@egistration = endpointValue.getValue().registerService(channelName, this, optionMap);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6276.java