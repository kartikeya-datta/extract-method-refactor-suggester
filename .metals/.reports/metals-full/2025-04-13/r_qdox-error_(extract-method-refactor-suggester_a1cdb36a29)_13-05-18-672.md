error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4606.java
text:
```scala
E@@jbLogger.ROOT_LOGGER.debugf("Registered %s as a listener to EJB client context %s", EJBTransactionRecoveryService.INSTANCE, context);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4606.java