error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1695.java
text:
```scala
r@@eturn other.tableName.equals(tableName)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1695.java