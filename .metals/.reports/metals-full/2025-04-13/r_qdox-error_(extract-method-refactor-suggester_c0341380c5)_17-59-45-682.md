error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16597.java
text:
```scala
C@@ollection rsContainers = selectExistingHostContainers(serviceReference,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16597.java