error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2061.java
text:
```scala
f@@ragListBuilder = field.fragmentOffset() == -1 ? new SimpleFragListBuilder() : new SimpleFragListBuilder(field.fragmentOffset());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2061.java