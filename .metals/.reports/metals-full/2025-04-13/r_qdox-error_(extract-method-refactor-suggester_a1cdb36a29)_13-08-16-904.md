error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7254.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7254.java
text:
```scala
final H@@ashSet<String> set = new HashSet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7254.java