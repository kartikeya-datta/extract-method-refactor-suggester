error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6458.java
text:
```scala
s@@uper ("Collection", "{builtin}Collection");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6458.java