error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1950.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1950.java
text:
```scala
public v@@oid addDefaultCssStyle()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1950.java