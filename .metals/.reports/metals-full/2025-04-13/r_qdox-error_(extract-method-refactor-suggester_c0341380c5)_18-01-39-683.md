error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/840.java
...
```java
offset: 1736
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/840.java
text:
```scala
{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/840.java