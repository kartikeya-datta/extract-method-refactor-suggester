error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2384.java
text:
```scala
l@@oopingContext.complainOnDeferredChecks(scope, actionInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2384.java