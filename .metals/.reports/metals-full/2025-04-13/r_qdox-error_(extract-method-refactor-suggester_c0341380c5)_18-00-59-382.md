error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/121.java
text:
```scala
t@@hrow ThreadsLogger.ROOT_LOGGER.nullExecutor();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/121.java