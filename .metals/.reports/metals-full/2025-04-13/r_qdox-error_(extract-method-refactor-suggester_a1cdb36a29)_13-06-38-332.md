error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13261.java
text:
```scala
c@@ontext.addStep(copy, targetHandler, Stage.MODEL, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13261.java