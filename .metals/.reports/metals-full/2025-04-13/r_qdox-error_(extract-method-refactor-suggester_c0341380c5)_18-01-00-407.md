error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16775.java
text:
```scala
w@@idth += columns [i].getWidth ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16775.java