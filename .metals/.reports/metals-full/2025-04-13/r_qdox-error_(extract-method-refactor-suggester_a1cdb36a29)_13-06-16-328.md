error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10648.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10648.java
text:
```scala
static M@@odelNode convertSecurityRole(final ModelNode camelCase) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10648.java