error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1053.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1053.java
text:
```scala
S@@tring fn = impl.getAbsolutePath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1053.java