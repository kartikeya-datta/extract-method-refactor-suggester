error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10832.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10832.java
text:
```scala
s@@ql.append(sel.getColumnAlias(field.getOrderColumn(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10832.java