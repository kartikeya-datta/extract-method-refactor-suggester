error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4677.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4677.java
text:
```scala
B@@ufferedReader reader = new BufferedReader(new InputStreamReader(Gdx.files.internal("data/level.map").read()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4677.java