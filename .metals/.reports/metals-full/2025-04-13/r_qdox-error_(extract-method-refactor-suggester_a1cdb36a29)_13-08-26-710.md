error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14391.java
text:
```scala
I@@nstruction freshI = (oldI == RANGEINSTRUCTION) ? oldI : Utility.copyInstruction(oldI);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14391.java