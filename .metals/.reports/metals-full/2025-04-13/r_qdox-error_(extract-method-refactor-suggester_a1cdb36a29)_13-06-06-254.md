error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13405.java
text:
```scala
t@@hrow new IllegalArgumentException("Could not lookup jndi name: " + namespaceStrippedJndiName + " in context: " + jndiContext, ne);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13405.java