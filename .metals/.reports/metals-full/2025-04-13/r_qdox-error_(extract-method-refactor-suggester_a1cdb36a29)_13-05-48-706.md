error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17542.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17542.java
text:
```scala
public static final S@@tring DEFAULT_CLASSPATH_ENTRIES =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17542.java