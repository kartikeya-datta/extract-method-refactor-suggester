error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1059.java
text:
```scala
e@@vent.getListenerActor().moveBy(deltaX, deltaY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1059.java