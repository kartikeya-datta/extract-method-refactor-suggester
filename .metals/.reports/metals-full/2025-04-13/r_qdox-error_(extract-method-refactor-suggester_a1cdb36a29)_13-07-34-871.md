error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8830.java
text:
```scala
S@@earchScript searchScript = new SearchScript(context.lookup(), scriptLang, script, vars, parseContext.scriptService());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8830.java