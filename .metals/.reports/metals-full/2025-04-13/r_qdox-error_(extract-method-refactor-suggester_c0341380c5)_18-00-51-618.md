error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17031.java
text:
```scala
i@@f (!lockEx.isFatal()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17031.java