error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6824.java
text:
```scala
X@@SLoader loader = new XSLoaderImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6824.java