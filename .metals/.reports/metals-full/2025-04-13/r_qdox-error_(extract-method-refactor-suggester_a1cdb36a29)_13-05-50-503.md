error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7851.java
text:
```scala
O@@S.SetKeyboardFocus (window, handle, (short) focusPart ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7851.java