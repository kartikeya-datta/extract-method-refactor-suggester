error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15165.java
text:
```scala
v@@erifyKeystorePassword, wrongKeyAlgorithm, keyStoreNotFound;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15165.java