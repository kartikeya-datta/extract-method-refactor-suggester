error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16007.java
text:
```scala
s@@endSelectionEvent (SWT.Selection);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16007.java