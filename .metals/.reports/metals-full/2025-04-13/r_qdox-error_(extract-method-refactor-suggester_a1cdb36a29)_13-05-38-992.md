error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1625.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1625.java
text:
```scala
public F@@ieldBinding resolveTypeFor(FieldBinding field) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1625.java