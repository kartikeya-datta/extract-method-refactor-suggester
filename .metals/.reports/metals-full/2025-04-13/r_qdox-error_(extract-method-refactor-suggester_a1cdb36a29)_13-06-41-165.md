error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8380.java
text:
```scala
I@@Marker.USER_EDITABLE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8380.java