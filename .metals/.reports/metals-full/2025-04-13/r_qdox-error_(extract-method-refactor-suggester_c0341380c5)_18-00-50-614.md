error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3410.java
text:
```scala
i@@nt accessNumber = Session.get().nextAccessNumber();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3410.java