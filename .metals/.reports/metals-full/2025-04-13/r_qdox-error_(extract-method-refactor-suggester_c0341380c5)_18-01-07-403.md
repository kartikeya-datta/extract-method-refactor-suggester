error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/387.java
text:
```scala
f@@TestMethod.getMethod(), getTestClass().getJavaClass()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/387.java