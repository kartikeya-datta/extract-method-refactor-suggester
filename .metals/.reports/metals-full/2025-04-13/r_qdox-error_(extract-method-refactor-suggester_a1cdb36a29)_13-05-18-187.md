error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1406.java
text:
```scala
i@@f (match != null && match.erasure() != match) { // match can be null: interface.findSuperTypeErasingTo(Object)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1406.java