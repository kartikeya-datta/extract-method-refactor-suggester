error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16117.java
text:
```scala
O@@S.class_addProtocol(cls, OS.protocol_NSTextInput);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16117.java