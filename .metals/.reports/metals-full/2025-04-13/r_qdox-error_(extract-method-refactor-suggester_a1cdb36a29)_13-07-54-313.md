error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3167.java
text:
```scala
i@@f (fieldEndPosition == -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3167.java