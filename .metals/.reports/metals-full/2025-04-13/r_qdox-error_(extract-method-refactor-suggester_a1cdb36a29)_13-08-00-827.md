error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1280.java
text:
```scala
r@@eturn this.resolvedType = binding == null ? null : binding.returnType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1280.java