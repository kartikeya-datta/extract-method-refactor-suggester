error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1875.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1875.java
text:
```scala
f@@or (String table : DatabaseDescriptor.getTables())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1875.java