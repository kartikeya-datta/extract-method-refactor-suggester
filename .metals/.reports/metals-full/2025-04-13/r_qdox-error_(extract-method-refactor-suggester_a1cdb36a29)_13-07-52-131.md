error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7718.java
text:
```scala
F@@reeTypeBitmapFontData fontData = generator.generateData(15, FreeTypeFontGenerator.DEFAULT_CHARS, flip);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7718.java