error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9773.java
text:
```scala
i@@f (compUnitDecl != null) this.referenceContext = compUnitDecl;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9773.java