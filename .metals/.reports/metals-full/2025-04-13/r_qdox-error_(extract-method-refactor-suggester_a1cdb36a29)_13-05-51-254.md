error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/716.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/716.java
text:
```scala
public I@@MethodBinding resolveBinding() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/716.java