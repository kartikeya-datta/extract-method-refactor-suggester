error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4748.java
text:
```scala
i@@f(JAVAX_FACES_WEBAPP_FACES_SERVLET.equals(servlet.getServletClass())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4748.java