error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/22.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/22.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/22.java
text:
```scala
public static final S@@tring NAME = "_uid".intern();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/22.java