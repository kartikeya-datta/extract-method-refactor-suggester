error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/332.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/332.java
text:
```scala
r@@eturn copyToString(new InputStreamReader(is, "UTF-8"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/332.java