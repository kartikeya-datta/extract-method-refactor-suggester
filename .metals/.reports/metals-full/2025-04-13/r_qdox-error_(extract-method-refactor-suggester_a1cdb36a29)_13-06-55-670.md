error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8651.java
text:
```scala
i@@f (isFixedLineHeight() && height > maxHeight) break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8651.java