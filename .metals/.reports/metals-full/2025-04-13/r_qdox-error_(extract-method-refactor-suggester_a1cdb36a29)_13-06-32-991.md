error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6020.java
text:
```scala
A@@ssociation association = new AssociationService().getMimeTypeAssociation("text/plain");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6020.java