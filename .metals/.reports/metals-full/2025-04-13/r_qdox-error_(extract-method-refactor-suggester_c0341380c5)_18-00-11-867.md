error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8346.java
text:
```scala
p@@ublic class PasswordTextField extends RequiredTextField
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8346.java