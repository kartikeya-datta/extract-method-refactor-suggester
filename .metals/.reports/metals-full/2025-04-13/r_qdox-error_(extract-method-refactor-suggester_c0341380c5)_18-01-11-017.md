error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1656.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1656.java
text:
```scala
i@@f ((otherType.tagBits & HasDirectWildcard) == 0 && (!this.isMemberType() || !otherType.isMemberType()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1656.java