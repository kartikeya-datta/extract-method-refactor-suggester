error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/547.java
text:
```scala
C@@acheElement element = (CacheElement) findExactSet(name, type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/547.java