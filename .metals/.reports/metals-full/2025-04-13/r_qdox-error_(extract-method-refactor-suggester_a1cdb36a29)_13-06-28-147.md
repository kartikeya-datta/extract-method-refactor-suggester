error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3428.java
text:
```scala
s@@tatResult = new StatisticalSampleResult(e.getResult());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3428.java