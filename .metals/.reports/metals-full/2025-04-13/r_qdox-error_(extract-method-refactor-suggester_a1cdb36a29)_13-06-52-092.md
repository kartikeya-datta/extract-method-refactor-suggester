error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1389.java
text:
```scala
p@@rintKeyOpt).withOption(sizeOpt).withOption(helpOpt).create();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1389.java