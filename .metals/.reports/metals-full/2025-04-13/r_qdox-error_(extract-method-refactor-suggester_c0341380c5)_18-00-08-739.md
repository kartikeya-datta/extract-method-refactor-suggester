error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2324.java
text:
```scala
t@@his(operationName, descriptionResolver, descriptionResolver, null, null, deprecationData, null, parameters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2324.java