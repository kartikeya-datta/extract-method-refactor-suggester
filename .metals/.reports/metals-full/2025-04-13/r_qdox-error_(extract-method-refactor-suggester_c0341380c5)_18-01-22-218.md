error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3355.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3355.java
text:
```scala
s@@tage.draw();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3355.java