error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3591.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3591.java
text:
```scala
public static final S@@erviceName SERVICE_NAME = RouteLocatorService.REGISTRY_SERVICE_NAME.append("entry");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3591.java