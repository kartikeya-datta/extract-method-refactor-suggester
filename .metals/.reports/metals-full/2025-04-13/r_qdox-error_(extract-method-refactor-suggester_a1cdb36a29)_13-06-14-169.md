error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2657.java
text:
```scala
B@@ulletEntity ground;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2657.java