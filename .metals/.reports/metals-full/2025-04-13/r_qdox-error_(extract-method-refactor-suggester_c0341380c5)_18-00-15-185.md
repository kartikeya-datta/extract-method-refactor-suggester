error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6615.java
text:
```scala
c@@ache.draw(batch, color.a * parentAlpha);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6615.java