error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9364.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9364.java
text:
```scala
i@@f (serverEnvironment != null) { // TODO eliminate test cases that result in serverEnvironment == null
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9364.java