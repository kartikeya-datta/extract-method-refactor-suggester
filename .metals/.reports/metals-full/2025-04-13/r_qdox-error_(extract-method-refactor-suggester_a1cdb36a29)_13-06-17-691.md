error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1112.java
text:
```scala
d@@oc.add(new TextField("id", "1", Field.Store.NO));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1112.java