error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3097.java
text:
```scala
i@@f(model.hasDefined(RemoteAcceptorDefinition.SOCKET_BINDING.getName())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3097.java