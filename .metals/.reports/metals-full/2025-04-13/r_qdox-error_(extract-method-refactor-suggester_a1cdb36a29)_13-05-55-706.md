error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8079.java
text:
```scala
r@@eturn new FieldDataType("double", getFieldDataSettings());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8079.java