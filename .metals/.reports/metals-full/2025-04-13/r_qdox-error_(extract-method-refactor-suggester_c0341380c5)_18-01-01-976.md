error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/375.java
text:
```scala
b@@oolean enabled = item.getBooleanWithDefault("header_enabled", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/375.java