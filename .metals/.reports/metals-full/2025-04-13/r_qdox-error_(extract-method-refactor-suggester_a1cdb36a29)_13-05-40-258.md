error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7478.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7478.java
text:
```scala
i@@f (child.getResource() != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7478.java