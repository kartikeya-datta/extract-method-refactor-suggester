error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17539.java
text:
```scala
s@@endMouseEvent (SWT.MouseUp, button [0], display.clickCount, true, chord, (short)x, (short)y, modifiers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17539.java