error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3390.java
text:
```scala
w@@hile (null != (closeTag = (ComponentTag)getNextFilter().nextTag()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3390.java