error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/292.java
text:
```scala
s@@tartIColumn = new SuperColumn(filter.start, null, cf.getClockType()); // ok to not have subcolumnComparator since we won't be adding columns to this object
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/292.java