error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9985.java
text:
```scala
a@@ddToBorder(new ErrorIndicator("errorIndicator"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9985.java