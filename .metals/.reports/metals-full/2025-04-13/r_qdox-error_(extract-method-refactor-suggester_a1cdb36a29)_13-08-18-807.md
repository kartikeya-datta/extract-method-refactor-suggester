error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1714.java
text:
```scala
b@@uilder.addImportPackages(StartLevel.class, SAXParser.class, SAXException.class, DefaultHandler.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1714.java