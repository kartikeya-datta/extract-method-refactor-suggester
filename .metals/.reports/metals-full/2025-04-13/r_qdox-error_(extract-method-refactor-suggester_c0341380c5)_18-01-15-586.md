error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9325.java
...
```java
offset: 59
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9325.java
text:
```scala
public static class MockRunner extends BaseTestRunner {


p@@ackage junit.tests.runner;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9325.java