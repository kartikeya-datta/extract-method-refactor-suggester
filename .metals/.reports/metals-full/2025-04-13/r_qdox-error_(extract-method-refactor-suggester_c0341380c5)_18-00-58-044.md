error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3302.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3302.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3302.java
text:
```scala
public F@@ont font;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3302.java