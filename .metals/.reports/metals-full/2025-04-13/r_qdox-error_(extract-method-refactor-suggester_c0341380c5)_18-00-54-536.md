error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3739.java
text:
```scala
S@@tring[][] parseResult = parser.getRecords();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3739.java