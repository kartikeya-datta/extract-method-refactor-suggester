error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3559.java
text:
```scala
G@@lobalVariable[] variables;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3559.java