error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2125.java
text:
```scala
r@@eturn  IIOPReferenceContextWrapper.getSingleInstance(super.getInitialContext(env));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2125.java