error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4944.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4944.java
text:
```scala
S@@tring text = new String(responseText.getResponseData()); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4944.java