error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1352.java
text:
```scala
S@@crollPaneTest.class, FloatTest.class, FloatTextureTest.class, FrameBufferTest.class, FramebufferToTextureTest.class, FrustumTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1352.java