error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1100.java
...
```java
offset: 12
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1100.java
text:
```scala
@exception j@@ava.io.EOFException The set limit would exceed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1100.java