error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6822.java
text:
```scala
t@@estSupport = DomainTestSuite.createSupport(DirectoryGroupingByTypeTestCase.class.getSimpleName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6822.java