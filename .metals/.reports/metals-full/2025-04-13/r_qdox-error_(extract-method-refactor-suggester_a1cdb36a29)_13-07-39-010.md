error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2245.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2245.java
text:
```scala
private static final S@@tring JPEG = "image/jpeg"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2245.java