error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2448.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2448.java
text:
```scala
public static final S@@tring LUCENE_MAIN_VERSION = ident("4.3.1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2448.java