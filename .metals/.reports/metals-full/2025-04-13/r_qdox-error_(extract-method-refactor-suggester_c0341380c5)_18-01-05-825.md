error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15746.java
text:
```scala
h@@iddenText = message = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15746.java