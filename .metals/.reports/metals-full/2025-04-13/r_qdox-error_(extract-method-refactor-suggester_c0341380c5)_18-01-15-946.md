error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3945.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3945.java
text:
```scala
public R@@epeaterTest(final String name)

/*
 * $Id: RepeaterTest.java 5395 2006-04-16 13:42:28 +0000 (Sun, 16 Apr 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3945.java