error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1233.java
text:
```scala
i@@mporter.dispose();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1233.java