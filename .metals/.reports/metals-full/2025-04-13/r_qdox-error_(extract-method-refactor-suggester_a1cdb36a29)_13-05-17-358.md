error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10822.java
text:
```scala
S@@tring[] added = ObjectUtils.addObjectToArray(this.beanDefinition.getDependsOn(), beanName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10822.java