error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9369.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9369.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9369.java
text:
```scala
t@@hrow new Error("Do not suppress me.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9369.java