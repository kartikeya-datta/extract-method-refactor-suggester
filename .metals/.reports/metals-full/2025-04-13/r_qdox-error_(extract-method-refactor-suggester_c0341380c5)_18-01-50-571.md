error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11028.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11028.java
text:
```scala
+ S@@trings.beforeLastPathComponent(jarResourceReference.getSharedResourceKey(), '/') + "/");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11028.java