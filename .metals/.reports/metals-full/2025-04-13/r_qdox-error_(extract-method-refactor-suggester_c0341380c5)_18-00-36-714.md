error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/867.java
text:
```scala
C@@ompilerOptions.OPTION_ReportEmptyStatement,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/867.java