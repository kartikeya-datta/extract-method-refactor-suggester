error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1300.java
text:
```scala
i@@nt compare = sCompare.compare(new Double(3.0), Long.valueOf(3));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1300.java