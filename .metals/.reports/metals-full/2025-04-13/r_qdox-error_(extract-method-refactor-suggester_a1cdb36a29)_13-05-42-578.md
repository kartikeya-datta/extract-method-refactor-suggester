error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7423.java
text:
```scala
i@@f (typeBinding instanceof BinaryTypeBinding) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7423.java