error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1380.java
text:
```scala
R@@emoveOnCancelScheduledExecutorService.build(target, deploymentUnitServiceName.append(this.name, "expiration"), THREAD_FACTORY)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1380.java