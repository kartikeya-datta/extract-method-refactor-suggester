error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5434.java
text:
```scala
B@@oolean bool = (Boolean) header.get("columba.spam");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5434.java