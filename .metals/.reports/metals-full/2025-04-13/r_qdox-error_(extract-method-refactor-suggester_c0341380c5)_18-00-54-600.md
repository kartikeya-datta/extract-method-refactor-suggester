error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9848.java
text:
```scala
i@@f (OS.IsWindowEnabled (handle)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9848.java