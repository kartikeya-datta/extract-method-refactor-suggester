error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3682.java
text:
```scala
i@@f (input.bool)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3682.java