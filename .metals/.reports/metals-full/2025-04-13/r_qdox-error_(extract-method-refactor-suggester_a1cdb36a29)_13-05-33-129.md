error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9389.java
text:
```scala
i@@f (compilerBinding.kind() == Binding.ARRAY_TYPE) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9389.java