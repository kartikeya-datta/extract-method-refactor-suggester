error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/891.java
text:
```scala
a@@dd(new Label(this,"message", "Hello world! Test: äöü"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/891.java