error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4047.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4047.java
text:
```scala
public static final S@@tring OLD_PROCESS_CONTROLLER_BIND_PORT = "-bind-port";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4047.java