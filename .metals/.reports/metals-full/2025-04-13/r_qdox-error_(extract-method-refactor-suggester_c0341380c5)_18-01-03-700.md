error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1415.java
text:
```scala
I@@Marker.SEVERITY_ERROR,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1415.java