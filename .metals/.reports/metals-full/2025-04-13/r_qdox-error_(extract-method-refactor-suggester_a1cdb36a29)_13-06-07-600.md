error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17721.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[125,2]

error in qdox parser
file content:
```java
offset: 4220
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17721.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17721.java