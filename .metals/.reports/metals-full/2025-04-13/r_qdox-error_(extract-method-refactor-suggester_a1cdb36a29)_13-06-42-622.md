error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2873.java
text:
```scala
S@@tring[] actual = dir.listAll();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2873.java