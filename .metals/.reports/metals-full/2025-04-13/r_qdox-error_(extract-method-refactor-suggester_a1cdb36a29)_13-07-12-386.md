error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5511.java
...
```java
offset: 66
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5511.java
text:
```scala
public interface IContainer extends IAdaptable, IIdentifiable {

p@@ackage org.eclipse.ecf.core;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5511.java