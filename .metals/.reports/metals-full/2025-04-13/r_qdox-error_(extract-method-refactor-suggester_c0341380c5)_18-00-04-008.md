error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6845.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6845.java
text:
```scala
r@@ules.addAttribute("condition", "matchall");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6845.java