error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1489.java
text:
```scala
G@@eoUtils.parseGeoPoint(parser, point);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1489.java