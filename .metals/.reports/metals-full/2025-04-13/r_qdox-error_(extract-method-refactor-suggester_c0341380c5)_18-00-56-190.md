error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7348.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7348.java
text:
```scala
f@@utureResult.asyncCancel(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7348.java