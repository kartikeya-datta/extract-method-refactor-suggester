error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6520.java
text:
```scala
u@@rl = url + "antiCache=" + System.currentTimeMillis();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6520.java