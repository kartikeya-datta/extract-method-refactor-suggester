error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4605.java
text:
```scala
i@@nt result = getContentX (0) - 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4605.java