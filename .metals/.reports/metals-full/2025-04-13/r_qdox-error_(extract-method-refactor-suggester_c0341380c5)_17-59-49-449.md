error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4159.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4159.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4159.java
text:
```scala
J@@avaHelpSupport.enableHelp(wizard, HelpManager.getHelpManager().getHelpBroker());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4159.java