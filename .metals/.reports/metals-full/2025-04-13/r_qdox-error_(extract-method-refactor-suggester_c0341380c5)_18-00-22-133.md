error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9447.java
text:
```scala
l@@og.info("Activating deployment: " + key.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9447.java