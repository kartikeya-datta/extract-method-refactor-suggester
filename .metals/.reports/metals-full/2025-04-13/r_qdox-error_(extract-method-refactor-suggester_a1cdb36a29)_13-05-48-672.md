error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6228.java
text:
```scala
a@@dd(new Label("label", pageParameters.getNamedParameter("id").toString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6228.java