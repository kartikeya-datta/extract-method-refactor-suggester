error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2063.java
text:
```scala
d@@e = _TestUtil.docs(random(), te, liveDocs, de, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2063.java