error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2876.java
text:
```scala
i@@mage = new int[]{OS.CGImageCreateWithJPEGDataProvider(provider, null, true, OS.kCGRenderingIntentDefault), 0};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2876.java