error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/251.java
text:
```scala
F@@uture future = CompactionManager.instance.submitSSTableBuild(localFile.desc, remoteFile.type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/251.java