error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2324.java
text:
```scala
r@@eturn new IntArrayAtomicFieldData.SingleFixedSet(new int[1], 0, new FixedBitSet(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2324.java