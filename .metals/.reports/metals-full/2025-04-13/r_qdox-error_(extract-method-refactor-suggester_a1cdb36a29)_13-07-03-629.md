error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7752.java
text:
```scala
r@@eturn HttpResponseStatus.UNAUTHORIZED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7752.java