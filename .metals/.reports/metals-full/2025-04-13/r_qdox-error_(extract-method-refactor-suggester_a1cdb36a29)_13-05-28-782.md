error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5716.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5716.java
text:
```scala
public v@@oid setVm(String vmLevel) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5716.java