error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4662.java
text:
```scala
F@@lickScrollPane scroll = new FlickScrollPane(table, stage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4662.java