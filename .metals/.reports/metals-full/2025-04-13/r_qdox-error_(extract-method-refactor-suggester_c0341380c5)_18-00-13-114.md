error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6248.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6248.java
text:
```scala
t@@hrow new IllegalStateException("Attempt to set model object on null model of component: "  + getPageRelativePath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6248.java