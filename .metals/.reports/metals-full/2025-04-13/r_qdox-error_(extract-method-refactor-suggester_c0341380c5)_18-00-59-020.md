error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2670.java
text:
```scala
t@@his.bufferSize = componentSettings.getAsSize("bufferSize", new SizeValue(100, SizeUnit.KB));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2670.java