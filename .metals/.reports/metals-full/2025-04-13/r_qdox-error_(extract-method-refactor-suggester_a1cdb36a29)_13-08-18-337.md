error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2971.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2971.java
text:
```scala
i@@f (resource.getName().equalsIgnoreCase("CVS")) return false; // TEMPORARY //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2971.java