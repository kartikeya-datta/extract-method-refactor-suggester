error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4958.java
text:
```scala
g@@atewayRecoveryStatus.index().totalSize(), gatewayRecoveryStatus.index().reusedTotalSize(), gatewayRecoveryStatus.index().currentFilesSize(), gatewayRecoveryStatus.translog().currentTranslogOperations());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4958.java