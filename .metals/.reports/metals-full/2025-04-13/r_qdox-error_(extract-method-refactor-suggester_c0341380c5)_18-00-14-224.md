error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4899.java
text:
```scala
i@@f (oldChild == current && !(newChild instanceof PartPlaceholder)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4899.java