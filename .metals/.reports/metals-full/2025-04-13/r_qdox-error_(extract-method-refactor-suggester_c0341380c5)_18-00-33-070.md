error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14672.java
text:
```scala
n@@ewExtDirs[extDirs.length] = new File(serverEnvironment.getServerBaseDir(), "lib/ext");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14672.java