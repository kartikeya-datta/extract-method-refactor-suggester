error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3807.java
text:
```scala
i@@f (sugword.string.equals(word)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3807.java