error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16443.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16443.java
text:
```scala
private static final S@@tring FTP_RETRIEVE = "ftp://ftp.osuosl.org/pub/eclipse/rt/ecf/2.0/org.eclipse.ecf.examples-2.0.1.v20081006-2232.zip";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16443.java