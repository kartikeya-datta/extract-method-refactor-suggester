error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3679.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3679.java
text:
```scala
private static final A@@ttributeDefinition[] ATTRIBUTE_DEFINITIONS = {GROUP_NAME, ITERATIVE, GROUP_DN_ATTRIBUTE, GROUP_NAME_ATTRIBUTE, SEARCH_BY, BASE_DN, RECURSIVE, PRINCIPAL_ATTRIBUTE};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3679.java