error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5228.java
text:
```scala
b@@ulkRequest.add(Requests.indexRequest("test" + ThreadLocalRandom.current().nextInt(NUMBER_OF_INDICES)).setType("type").setSource("field", "value"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5228.java