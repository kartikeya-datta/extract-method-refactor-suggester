error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15725.java
text:
```scala
S@@tring result = FileUtils.safeReadFully(helper.getAssembledReader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15725.java