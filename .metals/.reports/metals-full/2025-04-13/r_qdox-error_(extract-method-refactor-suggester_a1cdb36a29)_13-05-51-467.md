error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2446.java
text:
```scala
i@@nnerCache.put(key, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2446.java