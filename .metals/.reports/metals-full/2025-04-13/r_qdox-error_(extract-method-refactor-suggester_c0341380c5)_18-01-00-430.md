error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5644.java
text:
```scala
r@@eturn FloatArrayAtomicFieldData.EMPTY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5644.java