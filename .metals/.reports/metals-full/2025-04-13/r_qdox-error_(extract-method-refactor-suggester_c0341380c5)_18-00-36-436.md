error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16888.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16888.java
text:
```scala
i@@nfile=findTestPath("testfiles/test.csv");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16888.java