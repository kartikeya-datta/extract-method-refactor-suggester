error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13297.java
text:
```scala
r@@eturn valueTransformer != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13297.java