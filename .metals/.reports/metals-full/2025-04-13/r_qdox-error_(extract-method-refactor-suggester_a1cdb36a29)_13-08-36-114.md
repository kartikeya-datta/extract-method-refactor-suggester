error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13166.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13166.java
text:
```scala
h@@.addContent( src );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13166.java