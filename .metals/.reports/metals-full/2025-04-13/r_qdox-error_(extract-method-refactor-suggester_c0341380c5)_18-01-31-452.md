error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9260.java
text:
```scala
s@@earchContext.addRewrite(parentFilter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9260.java