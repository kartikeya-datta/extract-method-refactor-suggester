error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7506.java
text:
```scala
r@@esult.matches(), result.count(), tookInMillis, result.reducedFacets()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7506.java