error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9071.java
text:
```scala
i@@f (this.children[i].equals(child))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9071.java