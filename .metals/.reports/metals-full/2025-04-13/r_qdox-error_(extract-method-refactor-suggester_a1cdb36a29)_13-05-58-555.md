error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1984.java
text:
```scala
M@@ultiTermQuery.RewriteMethod method = QueryParsers.parseRewriteMethod(rewriteMethod, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1984.java