error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12547.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[269,2]

error in qdox parser
file content:
```java
offset: 6958
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12547.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12547.java