error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2149.java
text:
```scala
l@@og.warn("redirect to " + url + " failed: " + e.getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2149.java