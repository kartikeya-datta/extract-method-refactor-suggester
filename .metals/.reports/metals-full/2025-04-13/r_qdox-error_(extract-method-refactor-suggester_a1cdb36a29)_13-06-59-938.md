error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/773.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/773.java
text:
```scala
public final static S@@tring SELECTED_BROWSER = "selected_browser";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/773.java