error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12839.java
text:
```scala
J@@MeterUtils.getResString("warning"), JOptionPane.YES_NO_OPTION, // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12839.java