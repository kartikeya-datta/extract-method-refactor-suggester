error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12172.java
text:
```scala
S@@tring filename = sampler.getFilename();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12172.java