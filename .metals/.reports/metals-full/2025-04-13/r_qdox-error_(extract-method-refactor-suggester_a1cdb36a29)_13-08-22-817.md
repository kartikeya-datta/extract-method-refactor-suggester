error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6610.java
text:
```scala
i@@f (ch == '/' && value.charAt(value.length() - 1) != '/') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6610.java