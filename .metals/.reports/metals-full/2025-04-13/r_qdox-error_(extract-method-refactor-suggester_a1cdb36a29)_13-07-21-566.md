error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1119.java
text:
```scala
s@@erviceName = BasicComponent.serviceNameOf(deploymentUnitServiceName, componentName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1119.java