error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3770.java
text:
```scala
b@@shInterpreter = new BeanShellInterpreter(JMeterUtils.getProperty(INIT_FILE), log);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3770.java