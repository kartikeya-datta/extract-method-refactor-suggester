error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3515.java
text:
```scala
m@@essageFont.draw(batch, messageText, x + bgLeftWidth, y + textY + yOffset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3515.java