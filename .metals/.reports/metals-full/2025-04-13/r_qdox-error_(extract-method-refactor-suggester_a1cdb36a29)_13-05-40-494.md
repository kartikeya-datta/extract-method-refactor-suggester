error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9256.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9256.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9256.java
text:
```scala
F@@ieldMapper fieldMapper = context.smartNameFieldMapper(fieldName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9256.java