error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12021.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12021.java
text:
```scala
public v@@oid testReferencePCutInDeclareWarning_pr138215() { runTest("Reference pointcut fails inside @DeclareWarning");}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12021.java