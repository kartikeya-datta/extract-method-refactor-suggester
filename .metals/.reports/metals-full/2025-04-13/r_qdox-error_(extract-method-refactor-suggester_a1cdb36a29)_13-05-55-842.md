error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6384.java
text:
```scala
s@@cope.problemReporter().nonGenericTypeCannotBeParameterized(i, this, currentType, argTypes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6384.java