error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2056.java
text:
```scala
a@@ssert termsEnum.docs(liveDocs, null, false) != null: "termstate found but no term exists in reader";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2056.java