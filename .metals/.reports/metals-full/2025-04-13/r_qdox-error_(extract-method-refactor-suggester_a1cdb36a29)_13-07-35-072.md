error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4516.java
text:
```scala
r@@eturn new CollectionProperty("noname", new LinkedList<Object>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4516.java