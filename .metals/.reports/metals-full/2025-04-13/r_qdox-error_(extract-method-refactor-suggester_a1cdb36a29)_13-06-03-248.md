error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/812.java
text:
```scala
a@@reSimilarMethods(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/812.java