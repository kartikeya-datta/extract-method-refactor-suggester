error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6995.java
text:
```scala
f@@LEType == JAVA_MODEL) { // fix for 1FWNMHH
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6995.java