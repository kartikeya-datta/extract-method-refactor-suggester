error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8733.java
text:
```scala
c@@omponentInterceptors.put(method, Interceptors.getChainedInterceptorFactory(componentConfiguration.getComponentInterceptors(method)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8733.java