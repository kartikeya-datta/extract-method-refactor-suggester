error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7175.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7175.java
text:
```scala
public S@@tring[] getPluginIdList() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7175.java