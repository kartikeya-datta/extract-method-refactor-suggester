error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/452.java
text:
```scala
t@@mpDir != null ? tmpDir : getProject().getBaseDir(), true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/452.java