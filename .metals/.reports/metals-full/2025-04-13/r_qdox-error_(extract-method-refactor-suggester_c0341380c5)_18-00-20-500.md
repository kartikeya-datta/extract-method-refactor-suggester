error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2986.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2986.java
text:
```scala
private final A@@tomicLong count = new AtomicLong();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2986.java