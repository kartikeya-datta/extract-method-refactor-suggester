error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2354.java
text:
```scala
n@@ew SecurityRealmChildRemoveHandler(true, false), OperationEntry.Flag.RESTART_NONE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2354.java