error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2121.java
text:
```scala
r@@esourceResponse.setCacheDuration(Integer.MAX_VALUE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2121.java