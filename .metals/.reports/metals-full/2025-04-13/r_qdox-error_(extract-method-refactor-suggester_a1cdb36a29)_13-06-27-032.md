error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17627.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[63,80]

error in qdox parser
file content:
```java
offset: 1781
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17627.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17627.java