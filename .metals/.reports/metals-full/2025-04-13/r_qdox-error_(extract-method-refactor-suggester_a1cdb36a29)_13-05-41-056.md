error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12022.java
text:
```scala
i@@f(model == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12022.java