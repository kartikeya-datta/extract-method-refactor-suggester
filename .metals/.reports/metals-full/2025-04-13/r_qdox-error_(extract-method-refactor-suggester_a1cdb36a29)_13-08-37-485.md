error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4085.java
text:
```scala
r@@eturn RequestCycle.get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4085.java