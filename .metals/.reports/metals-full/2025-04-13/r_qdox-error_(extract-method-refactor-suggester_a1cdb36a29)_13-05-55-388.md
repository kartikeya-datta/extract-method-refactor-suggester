error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10798.java
text:
```scala
i@@f (from.getAbsolutePath().equals(to.getAbsolutePath())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10798.java