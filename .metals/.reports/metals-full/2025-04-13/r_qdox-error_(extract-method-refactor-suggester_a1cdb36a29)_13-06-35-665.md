error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5687.java
text:
```scala
P@@latform.getDebugOption(PLUGIN_ID + "/debug/semanticCheck")).booleanValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5687.java