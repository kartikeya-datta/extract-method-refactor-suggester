error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8735.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8735.java
text:
```scala
static final S@@ymbolHash fBuiltInTypes = new SymbolHash();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8735.java