error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3139.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3139.java
text:
```scala
private static final W@@SSubsystemReader parser = WSSubsystemReader.getInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3139.java