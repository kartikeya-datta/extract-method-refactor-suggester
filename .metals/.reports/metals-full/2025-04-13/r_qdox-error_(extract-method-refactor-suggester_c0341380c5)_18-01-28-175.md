error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2435.java
text:
```scala
N@@umericUtils.intToPrefixCoded(intValue, 0, bytesRef);   // 0 because of exact match
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2435.java