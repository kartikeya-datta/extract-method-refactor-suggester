error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12817.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12817.java
text:
```scala
private transient b@@oolean runningVersion = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12817.java