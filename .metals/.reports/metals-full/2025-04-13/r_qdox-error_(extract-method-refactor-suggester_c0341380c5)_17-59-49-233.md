error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2131.java
text:
```scala
s@@uper.mouseUp(e, x, y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2131.java