error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6871.java
text:
```scala
S@@tring value = getModelObjectAsString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6871.java