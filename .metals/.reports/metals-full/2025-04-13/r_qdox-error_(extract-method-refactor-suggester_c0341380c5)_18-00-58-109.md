error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2936.java
...
```java
offset: 874
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2936.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2936.java