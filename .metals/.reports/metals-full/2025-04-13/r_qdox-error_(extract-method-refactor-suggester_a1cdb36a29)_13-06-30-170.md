error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8534.java
text:
```scala
S@@tringBuffer buff = new StringBuffer(128);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8534.java