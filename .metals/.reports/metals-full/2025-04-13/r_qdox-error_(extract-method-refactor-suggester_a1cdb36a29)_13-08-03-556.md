error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2601.java
text:
```scala
a@@dd(new Label<String>("message", "Hello world! Test: ���"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2601.java