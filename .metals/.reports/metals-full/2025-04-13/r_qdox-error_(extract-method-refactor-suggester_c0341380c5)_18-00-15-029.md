error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/994.java
text:
```scala
s@@treamWriter.writeEmptyElement(Element.OBJECT_STORE.getLocalName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/994.java