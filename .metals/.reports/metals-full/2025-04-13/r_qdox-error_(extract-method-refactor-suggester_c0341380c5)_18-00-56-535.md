error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3532.java
text:
```scala
c@@fStore.addSSTable(ssTable);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3532.java