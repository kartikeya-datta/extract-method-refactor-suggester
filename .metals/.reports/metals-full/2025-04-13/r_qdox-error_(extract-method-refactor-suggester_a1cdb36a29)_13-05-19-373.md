error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1722.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1722.java
text:
```scala
public R@@awColumnDefinition[] column_metadata = new RawColumnDefinition[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1722.java