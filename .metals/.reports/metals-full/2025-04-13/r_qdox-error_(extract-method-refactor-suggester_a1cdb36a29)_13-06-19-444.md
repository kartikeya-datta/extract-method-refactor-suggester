error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11904.java
text:
```scala
v@@ersion = (String) getXMLVersion.invoke(document, (Object[]) null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11904.java