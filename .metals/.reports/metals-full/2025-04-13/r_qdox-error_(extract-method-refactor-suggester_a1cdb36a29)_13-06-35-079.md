error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10006.java
text:
```scala
s@@etModalDialog ((Dialog) value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10006.java