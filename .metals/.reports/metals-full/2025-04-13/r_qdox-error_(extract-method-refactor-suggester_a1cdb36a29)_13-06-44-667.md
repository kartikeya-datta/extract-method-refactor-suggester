error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6493.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6493.java
text:
```scala
private volatile A@@cceptingChannel<ConnectedSslStreamChannel> sslServer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6493.java