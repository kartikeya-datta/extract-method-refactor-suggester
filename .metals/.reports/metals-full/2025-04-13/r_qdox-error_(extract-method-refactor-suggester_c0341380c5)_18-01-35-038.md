error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7851.java
...
```java
offset: 1041
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7851.java
text:
```scala
enum Element {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7851.java