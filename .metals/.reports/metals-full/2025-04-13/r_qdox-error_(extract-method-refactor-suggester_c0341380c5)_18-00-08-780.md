error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9754.java
text:
```scala
i@@f (format.isQuoting()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9754.java