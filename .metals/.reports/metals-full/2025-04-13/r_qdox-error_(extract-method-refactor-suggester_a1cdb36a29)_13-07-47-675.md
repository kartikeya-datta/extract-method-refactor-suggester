error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3520.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3520.java
text:
```scala
final M@@arkupStream associatedMarkupStream = getAssociatedMarkupStream(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3520.java