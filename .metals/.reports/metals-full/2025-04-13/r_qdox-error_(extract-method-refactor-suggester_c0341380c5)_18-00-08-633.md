error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/882.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/882.java
text:
```scala
public static final F@@ield[] EMPTY_FIELDS = new Field[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/882.java