error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1222.java
text:
```scala
i@@nt length, DataByteInputStream in, Compression c)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1222.java