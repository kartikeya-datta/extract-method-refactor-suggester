error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11794.java
text:
```scala
r@@eturn transformers.transformRootResource(context, root);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11794.java