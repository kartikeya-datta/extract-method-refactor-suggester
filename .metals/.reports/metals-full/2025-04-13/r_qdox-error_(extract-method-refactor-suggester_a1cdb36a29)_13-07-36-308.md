error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3798.java
text:
```scala
i@@f (previousOrgId != org.getId())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3798.java