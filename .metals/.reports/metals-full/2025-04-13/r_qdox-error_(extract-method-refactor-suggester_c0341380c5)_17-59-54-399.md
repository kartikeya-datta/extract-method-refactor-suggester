error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1712.java
text:
```scala
b@@uilder.addImportPackages(StartLevel.class, MBeanServer.class, MBeanProxy.class, TabularData.class);
 ...
 */
package org.jboss.as.test.integration.osgi.jmx;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1712.java