error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4635.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4635.java
text:
```scala
public W@@izardButton(final String id, final IWizard wizard, final String labelResourceKey)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4635.java