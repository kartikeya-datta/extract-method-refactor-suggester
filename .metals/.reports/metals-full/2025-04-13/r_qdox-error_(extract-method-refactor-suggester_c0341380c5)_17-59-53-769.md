error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1540.java
text:
```scala
i@@f (!hasConstructor && !typeDeclaration.isInterface()) {// if was already reduced, then constructor
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1540.java