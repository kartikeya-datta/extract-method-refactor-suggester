error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10000.java
text:
```scala
n@@ameBorder.add(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10000.java