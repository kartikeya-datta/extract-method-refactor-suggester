error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14689.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14689.java
text:
```scala
static final S@@tring NAMESPACE_ID = "ecf.msn.msnp"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14689.java