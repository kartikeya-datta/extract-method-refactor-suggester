error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7725.java
text:
```scala
p@@arent.drawFocus (control, context, hasFocus () && drawFocusRing (), hasBorder (), inset ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7725.java