error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15831.java
text:
```scala
r@@eturn new LibrarySession(LibraryApplication.this, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15831.java