error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3115.java
text:
```scala
r@@eturn new SingleNameReference(CharOperation.NO_CHAR, 0); // dummy reference
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3115.java