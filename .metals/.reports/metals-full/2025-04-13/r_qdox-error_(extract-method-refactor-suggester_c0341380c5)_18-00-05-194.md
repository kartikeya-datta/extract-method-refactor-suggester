error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/559.java
text:
```scala
M@@odelNode model = context.readResourceForUpdate(PathAddress.EMPTY_ADDRESS).getModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/559.java