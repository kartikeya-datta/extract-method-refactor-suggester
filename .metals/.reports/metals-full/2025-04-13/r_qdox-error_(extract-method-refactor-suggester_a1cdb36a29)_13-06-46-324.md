error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4508.java
text:
```scala
c@@achePassword(page.getPasswordKeyFromUserName(connectID),password);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4508.java