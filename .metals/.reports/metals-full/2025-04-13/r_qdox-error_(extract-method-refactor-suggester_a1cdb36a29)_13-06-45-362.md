error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2864.java
text:
```scala
i@@f (maxDf > -1 && (100.0 * df) / vectorCount > maxDf) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2864.java