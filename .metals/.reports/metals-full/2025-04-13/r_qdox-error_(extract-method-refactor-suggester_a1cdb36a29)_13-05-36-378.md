error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10979.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10979.java
text:
```scala
private static final S@@tring methodName = "Euler";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10979.java