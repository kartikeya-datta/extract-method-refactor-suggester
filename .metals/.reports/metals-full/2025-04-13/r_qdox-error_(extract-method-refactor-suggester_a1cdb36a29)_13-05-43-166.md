error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7284.java
text:
```scala
D@@isplay.getDefault().sleep();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7284.java