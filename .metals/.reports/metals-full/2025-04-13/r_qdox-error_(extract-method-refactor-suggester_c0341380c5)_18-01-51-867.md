error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12778.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12778.java
text:
```scala
private static final i@@nt TIMER_CALL_WAITING_MS = 30000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12778.java