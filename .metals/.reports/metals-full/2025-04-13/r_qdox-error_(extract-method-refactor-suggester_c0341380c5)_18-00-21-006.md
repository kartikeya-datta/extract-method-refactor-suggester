error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7791.java
text:
```scala
E@@ngine.Searcher searcher = shardToPurge.acquireSearcher();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7791.java