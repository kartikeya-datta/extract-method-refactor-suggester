error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/80.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/80.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/80.java
text:
```scala
private volatile i@@nt count = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/80.java