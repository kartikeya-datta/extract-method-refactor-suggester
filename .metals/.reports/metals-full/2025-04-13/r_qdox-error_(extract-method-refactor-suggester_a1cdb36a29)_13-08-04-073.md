error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1608.java
...
```java
offset: 878
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1608.java
text:
```scala
...
p@@ackage org.apache.mahout.cf.taste.hadoop.similarity.item.writables;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1608.java