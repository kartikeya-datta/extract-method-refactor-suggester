error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3298.java
text:
```scala
F@@olderCommandReference r = ((MailFrameMediator) getFrameMediator())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3298.java