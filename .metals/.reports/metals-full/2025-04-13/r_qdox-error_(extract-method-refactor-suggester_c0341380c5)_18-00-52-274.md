error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7261.java
text:
```scala
a@@ssertContextPrefix("/link1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7261.java