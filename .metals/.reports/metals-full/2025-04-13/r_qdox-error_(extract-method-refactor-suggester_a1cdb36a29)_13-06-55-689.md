error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8968.java
text:
```scala
i@@f (config.getContext().isGroupManager())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8968.java