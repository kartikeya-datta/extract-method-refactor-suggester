error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6633.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6633.java
text:
```scala
c@@ontentType = ((WebApplication)application).getServletContext()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6633.java