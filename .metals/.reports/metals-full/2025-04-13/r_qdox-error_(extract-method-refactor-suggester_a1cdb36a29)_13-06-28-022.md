error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9889.java
text:
```scala
l@@ong size;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9889.java