error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2633.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2633.java
text:
```scala
T@@runcation t = Truncation.serializer().deserialize(new DataInputStream(buffer), message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2633.java