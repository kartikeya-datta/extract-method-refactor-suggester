error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6409.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6409.java
text:
```scala
S@@tring initialShards = indexMetaData.settings().get("index.recovery.initial_shards", settings.get("index.recovery.initial_shards", this.initialShards));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6409.java