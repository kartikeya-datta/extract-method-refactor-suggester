error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3725.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3725.java
text:
```scala
public l@@ong toLongID(String stringID) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3725.java