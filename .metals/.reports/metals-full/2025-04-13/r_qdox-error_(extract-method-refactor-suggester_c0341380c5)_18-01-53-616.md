error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7773.java
text:
```scala
r@@eturn Double.valueOf(this.value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7773.java