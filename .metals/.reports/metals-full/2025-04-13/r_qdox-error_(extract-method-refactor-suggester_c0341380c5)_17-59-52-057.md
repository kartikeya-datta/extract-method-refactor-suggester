error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6970.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6970.java
text:
```scala
final M@@odelNode model = context.readResource(PathAddress.EMPTY_ADDRESS, false).getModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6970.java