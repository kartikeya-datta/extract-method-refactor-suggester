error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2779.java
text:
```scala
r@@eturn resolver.getMessageCount() > 0 ? resolver.resolve() : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2779.java