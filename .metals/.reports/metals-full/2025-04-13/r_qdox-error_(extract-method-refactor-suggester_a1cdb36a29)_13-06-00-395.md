error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2397.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2397.java
text:
```scala
final S@@tring termsFileName = IndexFileNames.segmentFileName(state.segmentName, state.segmentSuffix, TERMS_EXTENSION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2397.java