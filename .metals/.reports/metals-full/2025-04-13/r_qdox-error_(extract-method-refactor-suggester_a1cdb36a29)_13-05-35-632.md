error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2752.java
text:
```scala
p@@ublic static class CommitLogContext
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2752.java