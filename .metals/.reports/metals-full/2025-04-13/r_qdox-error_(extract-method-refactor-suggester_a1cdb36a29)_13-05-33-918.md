error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7067.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7067.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7067.java
text:
```scala
M@@etaDataService.PutMappingResult result = metaDataService.putMapping(indices, request.type(), request.mappingSource(), request.ignoreConflicts(), request.timeout());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7067.java