error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4996.java
text:
```scala
p@@age = workingSetTypePage = new WorkingSetTypePage(this.descriptors);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4996.java