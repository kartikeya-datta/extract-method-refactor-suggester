error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3019.java
text:
```scala
q@@p = new QueryParser(Version.LUCENE_CURRENT, indexField, new StandardAnalyzer(Version.LUCENE_CURRENT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3019.java