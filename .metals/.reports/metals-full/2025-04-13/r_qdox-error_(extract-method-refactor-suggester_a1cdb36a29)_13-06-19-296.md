error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5571.java
text:
```scala
i@@f (!Scope.areTypesCompatible(testType, IntBinding)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5571.java