error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9137.java
text:
```scala
r@@eturn handle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9137.java