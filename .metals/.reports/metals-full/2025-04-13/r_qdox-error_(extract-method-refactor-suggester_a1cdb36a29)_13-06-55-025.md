error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/466.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/466.java
text:
```scala
public S@@tring getInputName()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/466.java