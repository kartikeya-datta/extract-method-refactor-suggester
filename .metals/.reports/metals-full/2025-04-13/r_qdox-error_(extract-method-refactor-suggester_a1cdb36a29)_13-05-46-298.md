error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7322.java
text:
```scala
c@@ontainer.connect(serverID, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7322.java