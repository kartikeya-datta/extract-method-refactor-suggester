error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14246.java
text:
```scala
i@@f (charsetName == null || charsetName.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14246.java