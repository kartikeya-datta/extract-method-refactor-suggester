error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5699.java
text:
```scala
r@@eturn ""/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5699.java