error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9800.java
...
```java
offset: 849
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9800.java
text:
```scala
...
p@@ackage org.elasticsearch.node.internal;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9800.java