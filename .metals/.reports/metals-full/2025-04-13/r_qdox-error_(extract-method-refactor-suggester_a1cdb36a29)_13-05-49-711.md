error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13943.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13943.java
text:
```scala
o@@riginalModel = Objects.cloneModel(model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13943.java