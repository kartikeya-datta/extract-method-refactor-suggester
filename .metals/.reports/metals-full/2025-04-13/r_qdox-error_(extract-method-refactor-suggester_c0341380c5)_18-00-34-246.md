error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11289.java
text:
```scala
p@@ublic class TestComponent extends Component
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11289.java