error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/769.java
text:
```scala
t@@hrow new RuntimeException("framework error in throwing test exception (IllegalAccess)");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/769.java