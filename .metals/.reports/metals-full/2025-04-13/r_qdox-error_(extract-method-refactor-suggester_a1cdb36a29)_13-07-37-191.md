error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8128.java
text:
```scala
x@@mlFile = new XmlIO(file.toURL());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8128.java