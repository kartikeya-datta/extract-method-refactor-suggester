error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12028.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12028.java
text:
```scala
t@@his.hostPersister = ConfigurationPersisterFactory.createHostXmlConfigurationPersister(configurationFile, environment);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12028.java