error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7063.java
text:
```scala
W@@orkbenchPlugin.log("Unable to restore page - cannot instantiate input factory: " + factoryID); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7063.java