error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9493.java
text:
```scala
s@@elector = new String(method.selector);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9493.java