error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3554.java
text:
```scala
n@@ew JoglApplication(new KeyframedModelViewer("data/models/knight.md2", "data/models/knight.jpg"), "KeframedModel Viewer", 800, 480, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3554.java