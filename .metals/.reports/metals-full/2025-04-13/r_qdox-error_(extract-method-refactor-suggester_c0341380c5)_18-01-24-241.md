error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3836.java
text:
```scala
r@@eturn new SharedResourceRequestTarget(resourceKey, requestParameters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3836.java