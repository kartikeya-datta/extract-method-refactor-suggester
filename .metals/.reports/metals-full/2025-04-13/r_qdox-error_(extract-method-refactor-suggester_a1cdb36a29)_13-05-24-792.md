error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14902.java
text:
```scala
n@@ew DataGridView(this, "rows", columns, new SortableContactDataProvider());

/*
 * $Id: DataGridPage.java 5838 2006-05-24 20:44:49 +0000 (Wed, 24 May 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14902.java