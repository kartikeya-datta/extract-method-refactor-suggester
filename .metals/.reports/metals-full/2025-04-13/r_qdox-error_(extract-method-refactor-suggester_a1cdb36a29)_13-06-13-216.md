error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15721.java
text:
```scala
i@@f (hasFocus()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15721.java