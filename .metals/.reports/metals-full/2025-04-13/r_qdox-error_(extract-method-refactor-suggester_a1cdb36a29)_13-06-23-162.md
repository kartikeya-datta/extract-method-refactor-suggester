error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1570.java
text:
```scala
N@@ested nested = new Nested(parentFilter, childFilter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1570.java