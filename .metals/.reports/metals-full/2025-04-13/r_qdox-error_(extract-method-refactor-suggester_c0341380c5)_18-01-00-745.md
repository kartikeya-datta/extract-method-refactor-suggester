error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6307.java
text:
```scala
M@@ap options = new HashMap(System.getProperties());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6307.java