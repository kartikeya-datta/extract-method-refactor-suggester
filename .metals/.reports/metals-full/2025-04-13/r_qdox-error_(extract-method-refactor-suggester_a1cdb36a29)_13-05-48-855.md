error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15768.java
text:
```scala
d@@rawBackground (gc, 0, 0, width, height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15768.java