error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13415.java
text:
```scala
p@@rinter.printRecord((Object[])lines[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13415.java