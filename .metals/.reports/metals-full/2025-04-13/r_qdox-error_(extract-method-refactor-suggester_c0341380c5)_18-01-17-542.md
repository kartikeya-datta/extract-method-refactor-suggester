error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18301.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18301.java
text:
```scala
private static final l@@ong WAIT_TO_DIE = 5 * 1000; // 5 seconds
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18301.java