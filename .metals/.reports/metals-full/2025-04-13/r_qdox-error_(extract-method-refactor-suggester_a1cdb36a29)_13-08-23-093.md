error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2505.java
text:
```scala
t@@arget.add(getTable());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2505.java