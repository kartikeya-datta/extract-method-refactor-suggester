error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4957.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4957.java
text:
```scala
public b@@oolean visible = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4957.java