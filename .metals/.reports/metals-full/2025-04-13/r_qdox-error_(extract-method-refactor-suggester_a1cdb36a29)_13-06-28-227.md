error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4275.java
text:
```scala
A@@ndroidGL, JoglGL, LWJGL, Angle, WebGL
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4275.java