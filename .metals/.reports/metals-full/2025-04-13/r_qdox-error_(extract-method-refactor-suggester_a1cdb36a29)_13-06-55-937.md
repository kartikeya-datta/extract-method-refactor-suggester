error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/909.java
text:
```scala
b@@uilder.getStringAttributeBuilder().setRejectExpressions("test").end()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/909.java