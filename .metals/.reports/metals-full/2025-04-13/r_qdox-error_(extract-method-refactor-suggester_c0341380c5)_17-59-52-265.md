error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1367.java
text:
```scala
n@@ew CompilationResult(sourceTypes[0].getFileName(), 1, 1, this.options.maxProblemsPerUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1367.java