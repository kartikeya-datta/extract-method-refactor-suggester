error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7382.java
text:
```scala
h@@eaderMapping.put(header[i], Integer.valueOf(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7382.java