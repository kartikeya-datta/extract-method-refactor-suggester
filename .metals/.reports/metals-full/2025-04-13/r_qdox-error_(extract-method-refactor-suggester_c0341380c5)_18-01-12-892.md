error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4973.java
text:
```scala
i@@f (map.containsKey("deleted") && map.get("deleted").equals(Boolean.TRUE)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4973.java