error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5542.java
text:
```scala
i@@f (!flags.getSeen() && !srcFolder.isReadOnly()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5542.java