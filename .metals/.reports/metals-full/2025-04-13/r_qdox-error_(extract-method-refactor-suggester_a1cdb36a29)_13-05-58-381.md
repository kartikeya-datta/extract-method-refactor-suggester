error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1628.java
text:
```scala
S@@tring str = endpointDescription.getContainerID().getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1628.java