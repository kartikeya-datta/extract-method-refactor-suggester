error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13451.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13451.java
text:
```scala
final Q@@ueueService service = new QueueService(address, name, filter, durable != null ? durable : true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13451.java