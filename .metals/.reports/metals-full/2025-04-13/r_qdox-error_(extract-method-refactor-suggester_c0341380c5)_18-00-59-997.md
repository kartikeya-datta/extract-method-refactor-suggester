error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9392.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9392.java
text:
```scala
final l@@ong max = 1l << bits;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9392.java