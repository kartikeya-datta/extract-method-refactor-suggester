error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7065.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7065.java
text:
```scala
final T@@ransformationRule.OperationContext context = new TransformationRule.OperationContext(ctx) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7065.java