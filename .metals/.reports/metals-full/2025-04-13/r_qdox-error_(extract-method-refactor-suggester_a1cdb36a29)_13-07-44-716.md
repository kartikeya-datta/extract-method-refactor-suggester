error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/515.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/515.java
text:
```scala
static i@@nt MINOR_VERSION = 415;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/515.java