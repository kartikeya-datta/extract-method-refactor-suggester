error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9347.java
...
```java
offset: 27
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9347.java
text:
```scala
public final synchronized v@@oid sendMessage(WebSocketMessage<?> message) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9347.java