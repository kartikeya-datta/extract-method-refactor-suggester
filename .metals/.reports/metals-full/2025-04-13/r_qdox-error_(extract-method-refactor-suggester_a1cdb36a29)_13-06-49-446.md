error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4216.java
text:
```scala
a@@ssertEquals(0, handler.getMaximalValueError(), 1.1e-7);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4216.java