error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9221.java
text:
```scala
r@@eturn new ShardCountRequest(shard.shardId(), filteringAliases, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9221.java