error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6781.java
text:
```scala
W@@eldJBossAllConfiguration(Boolean requireBeanDescriptor, Boolean nonPortableMode) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6781.java