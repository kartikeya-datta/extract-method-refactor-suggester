error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3267.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3267.java
text:
```scala
S@@torageService.instance.initServer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3267.java