error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11154.java
text:
```scala
l@@og.error("Error processing Javascript: [" + script + "]\n", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11154.java