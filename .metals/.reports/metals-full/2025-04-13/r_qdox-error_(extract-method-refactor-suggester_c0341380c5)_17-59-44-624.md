error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2027.java
text:
```scala
a@@gent_.connection_.CommitAndRollbackListeners_.put(this,null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2027.java