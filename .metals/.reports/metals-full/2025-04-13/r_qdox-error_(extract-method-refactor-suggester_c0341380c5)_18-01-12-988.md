error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13871.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13871.java
text:
```scala
private final M@@ap<PathAddress, Boolean> addOps = Collections.synchronizedMap(new HashMap<PathAddress, Boolean>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13871.java