error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4981.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4981.java
text:
```scala
protected abstract C@@oncurrentMap<Filter, DocIdSet> buildMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4981.java