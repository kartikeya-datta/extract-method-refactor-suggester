error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6104.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6104.java
text:
```scala
public v@@oid setName(String v) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6104.java