error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12428.java
text:
```scala
i@@nt cgImage = OS.CGImageCreate (width, height, 8, 32, bpr, colorspace, OS.kCGImageAlphaFirst, provider, null, true, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12428.java