error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/863.java
text:
```scala
r@@eturn true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/863.java