error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12168.java
text:
```scala
r@@eturn "[RequestListenerInterface name=" + name + ", method=" + method + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12168.java