error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9900.java
text:
```scala
r@@eturn ensureGreen(indices);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9900.java