error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7376.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7376.java
text:
```scala
public static final S@@tring BODY_ID = "_body_";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7376.java