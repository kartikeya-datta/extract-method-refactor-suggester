error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18239.java
text:
```scala
i@@f (!((data.transparentPixel != -1 && pixel == data.transparentPixel) || (mask != null && maskScanline[x] == 0))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18239.java