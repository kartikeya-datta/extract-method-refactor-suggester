error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7084.java
text:
```scala
a@@ddAlias("bigInt", BigInteger.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7084.java