error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13661.java
text:
```scala
d@@ata.font = item.getFont (index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13661.java