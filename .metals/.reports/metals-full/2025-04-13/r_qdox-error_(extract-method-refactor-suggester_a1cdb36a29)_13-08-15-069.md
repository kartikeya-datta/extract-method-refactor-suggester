error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3192.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3192.java
text:
```scala
public static final S@@tring FACES_ANNOTATIONS_SC_ATTR =  "org.jboss.as.jsf.FACES_ANNOTATIONS";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3192.java