error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7194.java
text:
```scala
S@@ession.get().isSessionInvalidated();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7194.java