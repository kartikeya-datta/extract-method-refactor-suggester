error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16139.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16139.java
text:
```scala
public static R@@equestCycle get()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16139.java