error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9014.java
text:
```scala
I@@mage.SCALE_FAST));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9014.java