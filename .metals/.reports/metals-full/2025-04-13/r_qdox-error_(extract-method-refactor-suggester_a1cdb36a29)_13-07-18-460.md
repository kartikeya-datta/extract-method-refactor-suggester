error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4216.java
text:
```scala
p@@os [0] = (int)/*64*/OS.g_utf8_strlen (ptr, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4216.java