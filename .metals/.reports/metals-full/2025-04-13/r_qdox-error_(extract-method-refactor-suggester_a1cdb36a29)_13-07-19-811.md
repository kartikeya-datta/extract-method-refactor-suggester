error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18103.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18103.java
text:
```scala
public final S@@tring getEvent()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18103.java