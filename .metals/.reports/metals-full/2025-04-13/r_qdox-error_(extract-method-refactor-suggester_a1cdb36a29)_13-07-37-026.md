error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18101.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18101.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18101.java
text:
```scala
p@@ublic interface IMultipartWebRequest
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18101.java