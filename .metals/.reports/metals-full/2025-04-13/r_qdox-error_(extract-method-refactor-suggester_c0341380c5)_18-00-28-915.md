error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15752.java
text:
```scala
i@@f (!classPathShown){// Only dump it once
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15752.java