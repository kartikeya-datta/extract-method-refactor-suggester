error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5783.java
text:
```scala
N@@umericUtils.longToPrefixCoded(val, NumericUtils.PRECISION_STEP_DEFAULT, bytesRef);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5783.java