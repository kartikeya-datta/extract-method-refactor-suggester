error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10221.java
text:
```scala
i@@f (prev == null || prev.getResponseData().length == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10221.java