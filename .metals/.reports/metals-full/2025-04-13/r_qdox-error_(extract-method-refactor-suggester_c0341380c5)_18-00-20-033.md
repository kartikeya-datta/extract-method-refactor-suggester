error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7214.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7214.java
text:
```scala
final A@@tomicArray<BulkItemResponse> responses = new AtomicArray<>(bulkRequest.requests.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7214.java