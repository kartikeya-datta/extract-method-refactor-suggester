error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3890.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3890.java
text:
```scala
L@@ist<String> list = new LinkedList<String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3890.java