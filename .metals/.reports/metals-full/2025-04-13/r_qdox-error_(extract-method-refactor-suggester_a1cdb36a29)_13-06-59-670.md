error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/786.java
text:
```scala
J@@OptionPane.showOptionDialog(null, MailResourceLoader
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/786.java