error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6248.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6248.java
text:
```scala
t@@hrow MESSAGES.failedToCreate(e, "connection-factory");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6248.java