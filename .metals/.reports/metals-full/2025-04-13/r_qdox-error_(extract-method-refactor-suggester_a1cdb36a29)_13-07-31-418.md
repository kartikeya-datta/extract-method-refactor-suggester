error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6626.java
text:
```scala
i@@temsCount = topIndex = horizontalOffset = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6626.java