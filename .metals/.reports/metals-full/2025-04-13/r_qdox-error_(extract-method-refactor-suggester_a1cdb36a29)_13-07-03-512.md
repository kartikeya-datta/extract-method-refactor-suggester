error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3004.java
text:
```scala
l@@ogger.info("AGG COLLECTION MODE: " + aggCollectionMode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3004.java