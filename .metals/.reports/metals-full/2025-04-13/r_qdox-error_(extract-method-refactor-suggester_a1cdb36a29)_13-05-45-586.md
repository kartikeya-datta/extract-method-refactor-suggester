error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4407.java
text:
```scala
F@@olderCommandReference r = (FolderCommandReference) frameMediator.getSelectionManager()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4407.java