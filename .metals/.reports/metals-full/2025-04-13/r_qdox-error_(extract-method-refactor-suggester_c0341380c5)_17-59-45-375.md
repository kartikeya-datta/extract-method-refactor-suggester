error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9371.java
text:
```scala
R@@Rset [] keysets = cache.findAnyRecords(name, Type.KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9371.java