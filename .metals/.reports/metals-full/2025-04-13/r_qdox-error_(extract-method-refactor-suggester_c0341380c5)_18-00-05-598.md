error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3434.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3434.java
text:
```scala
public H@@iddenField(MarkupContainer parent, String id, Class<? extends T> type)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3434.java