error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/582.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/582.java
text:
```scala
private final L@@ist<String> fontNames = Arrays.asList(new String[] { "Helvetica", "Arial",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/582.java