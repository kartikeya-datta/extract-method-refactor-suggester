error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15781.java
text:
```scala
m@@_path = new Path();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15781.java