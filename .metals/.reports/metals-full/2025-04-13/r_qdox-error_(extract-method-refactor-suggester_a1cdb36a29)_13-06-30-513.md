error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5422.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5422.java
text:
```scala
t@@his.location = new File(new File(nodeEnv.nodeLocation(), "indices"), index.name());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5422.java