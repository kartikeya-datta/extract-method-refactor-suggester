error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4845.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4845.java
text:
```scala
r@@eturn this.resolvedType = scope.environment().convertToRawType(this.resolvedType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4845.java