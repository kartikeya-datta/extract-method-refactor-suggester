error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7354.java
...
```java
offset: 686
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7354.java
text:
```scala
 ...
 */
p@@ackage org.springframework.mapping;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7354.java