error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3712.java
text:
```scala
a@@ssertEquals("number of eigenvectors", 10, i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3712.java