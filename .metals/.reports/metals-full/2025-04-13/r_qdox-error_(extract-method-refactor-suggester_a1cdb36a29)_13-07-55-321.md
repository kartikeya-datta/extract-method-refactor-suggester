error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7238.java
text:
```scala
M@@apBuilder<IndicesAction, TransportAction> actionsBuilder = new MapBuilder<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7238.java