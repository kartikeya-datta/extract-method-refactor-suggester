error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6437.java
...
```java
offset: 63
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6437.java
text:
```scala
public class CacheResolverAdapter implements CacheResolver {

p@@ackage org.springframework.cache.jcache.interceptor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6437.java