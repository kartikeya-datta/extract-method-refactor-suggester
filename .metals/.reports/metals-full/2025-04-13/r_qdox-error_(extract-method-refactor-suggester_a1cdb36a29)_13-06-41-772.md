error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10883.java
text:
```scala
i@@f (o instanceof CharSequence)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10883.java