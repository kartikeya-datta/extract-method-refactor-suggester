error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3429.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3429.java
text:
```scala
protected final b@@oolean isRenderAllowed()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3429.java