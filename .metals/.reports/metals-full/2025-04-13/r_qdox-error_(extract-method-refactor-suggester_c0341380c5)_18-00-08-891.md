error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1768.java
text:
```scala
f@@CompilerResources = ResourceBundle.getBundle("org.eclipse.jdt.internal.compiler.problem.messages", locale); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1768.java