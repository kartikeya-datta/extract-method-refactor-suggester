error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17173.java
text:
```scala
f@@ileUploadField.setRequired(param.getNamedParameter("required").toBoolean());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17173.java