error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8422.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8422.java
text:
```scala
protected v@@oid onComponentRendered()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8422.java