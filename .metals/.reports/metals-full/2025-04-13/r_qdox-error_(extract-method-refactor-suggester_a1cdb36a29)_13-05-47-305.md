error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9980.java
text:
```scala
c@@ontroller.getSelectionManager().registerSelectionListener("mail.table", this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9980.java