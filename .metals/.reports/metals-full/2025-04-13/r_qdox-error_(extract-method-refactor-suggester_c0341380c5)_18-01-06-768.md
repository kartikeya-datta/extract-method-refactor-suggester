error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3421.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3421.java
text:
```scala
public static final P@@arameterCorrector LIST_TO_MAP_CORRECTOR = new ParameterCorrector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3421.java