error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7236.java
text:
```scala
M@@apBuilder<Action, TransportAction> actionsBuilder = new MapBuilder<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7236.java