error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10712.java
text:
```scala
C@@lassLoader cl = new URLClassLoader(new URL[] { new File("target/test-classes/testcode.jar").toURI().toURL() },
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10712.java