error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5439.java
text:
```scala
T@@hreadFactory threadFactory = EsExecutors.daemonThreadFactory(this.settings, "[" + name + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5439.java