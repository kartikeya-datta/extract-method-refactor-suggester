error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/683.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/683.java
text:
```scala
i@@f (!LwjglApplicationConfiguration.disableAudio && Gdx.audio == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/683.java