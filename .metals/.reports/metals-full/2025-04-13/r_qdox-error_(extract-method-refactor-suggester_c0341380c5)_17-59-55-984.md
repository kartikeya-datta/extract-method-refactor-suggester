error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9739.java
text:
```scala
p@@utMappingRequest.source(request.contentAsString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9739.java