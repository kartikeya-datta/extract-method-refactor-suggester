error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9956.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9956.java
text:
```scala
t@@his.maxThreadCount = componentSettings.getAsInt("max_thread_count", Math.max(1, Math.min(3, Runtime.getRuntime().availableProcessors() / 2)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9956.java