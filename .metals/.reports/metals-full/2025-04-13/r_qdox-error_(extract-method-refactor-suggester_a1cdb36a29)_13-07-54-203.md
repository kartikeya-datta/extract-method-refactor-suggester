error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11732.java
text:
```scala
i@@n = new InflaterInputStream(inputStream, new Inflater(!parameters.withZlibHeader()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11732.java