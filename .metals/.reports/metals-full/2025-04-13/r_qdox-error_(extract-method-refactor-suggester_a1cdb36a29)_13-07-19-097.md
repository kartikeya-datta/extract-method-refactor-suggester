error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1437.java
text:
```scala
b@@ufferSize = settings.getAsInt("buffer_size", 256);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1437.java