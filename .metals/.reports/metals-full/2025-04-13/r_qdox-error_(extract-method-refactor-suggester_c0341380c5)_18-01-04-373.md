error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8199.java
text:
```scala
t@@hrow new IllegalArgumentException("You tried to add an object of type " +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8199.java