error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18296.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18296.java
text:
```scala
D@@iffUtil.validatePage(document, this.getClass(), "IndexedParamTest_ExpectedResult-2.html",true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18296.java