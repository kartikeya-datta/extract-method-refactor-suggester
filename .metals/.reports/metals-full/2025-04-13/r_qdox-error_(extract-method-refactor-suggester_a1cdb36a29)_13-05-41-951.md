error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9645.java
text:
```scala
a@@rgs.parse(null, line);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9645.java