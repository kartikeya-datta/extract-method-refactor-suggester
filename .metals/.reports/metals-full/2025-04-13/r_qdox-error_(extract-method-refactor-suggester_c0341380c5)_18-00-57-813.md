error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7527.java
text:
```scala
v@@oid drawImageXRender(Image srcImage, int srcX, int srcY, int srcWidth, int srcHeight, int destX, int destY, int destWidth, int destHeight, boolean simple, int imgWidth, int imgHeight, int /*long*/ maskPixmap, int maskType) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7527.java