error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18241.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18241.java
text:
```scala
private static final S@@tring BUNDLE_NAME = "org.eclipse.ecf.internal.provider.discovery.messages"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18241.java