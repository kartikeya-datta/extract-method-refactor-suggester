error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4010.java
text:
```scala
t@@his.maxBytesPerSec = componentSettings.getAsBytesSize("max_bytes_per_sec", componentSettings.getAsBytesSize("max_size_per_sec", new ByteSizeValue(20, ByteSizeUnit.MB)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4010.java