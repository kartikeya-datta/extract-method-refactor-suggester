error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12173.java
text:
```scala
w@@indow = window.initWithContentRect(new NSRect(), styleMask, OS.NSBackingStoreBuffered, true, screen);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12173.java