error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10537.java
text:
```scala
v@@oid setMaxInactiveInterval(int seconds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10537.java