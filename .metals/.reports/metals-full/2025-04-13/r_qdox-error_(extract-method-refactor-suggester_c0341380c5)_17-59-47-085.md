error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3148.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3148.java
text:
```scala
protected T@@ypeBinding internalResolveType(Scope scope) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3148.java