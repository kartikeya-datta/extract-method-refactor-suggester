error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8999.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8999.java
text:
```scala
private final transient H@@TTPJavaImpl hc;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8999.java