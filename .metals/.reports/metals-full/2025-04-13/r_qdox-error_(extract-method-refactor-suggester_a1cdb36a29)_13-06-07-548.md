error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1246.java
text:
```scala
n@@ewRanges[newRanges.length - 1] = end - newRanges[newRanges.length - 2] + 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1246.java