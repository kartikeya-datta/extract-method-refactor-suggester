error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/919.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/919.java
text:
```scala
protected V@@alueMap decodeParameters(String urlFragment, Map<String,? extends Object> urlParameters)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/919.java