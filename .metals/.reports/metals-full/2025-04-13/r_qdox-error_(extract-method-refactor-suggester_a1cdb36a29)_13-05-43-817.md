error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17126.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17126.java
text:
```scala
b@@uffer.append("YAHOO.namespace(\"wicket\");\nfunction init");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17126.java