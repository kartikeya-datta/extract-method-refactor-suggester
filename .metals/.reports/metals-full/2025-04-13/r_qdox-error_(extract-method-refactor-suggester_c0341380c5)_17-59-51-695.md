error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4315.java
text:
```scala
d@@isableSubstitutionOp.get(NAME).set("ejb-annotationr-property-replacement");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4315.java