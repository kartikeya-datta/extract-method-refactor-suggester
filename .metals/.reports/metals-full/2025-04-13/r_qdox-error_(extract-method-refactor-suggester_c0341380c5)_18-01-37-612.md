error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8135.java
text:
```scala
t@@his.calibrateSizeByDeletes = componentSettings.getAsBoolean("calibrate_size_by_deletes", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8135.java