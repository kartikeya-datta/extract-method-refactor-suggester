error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12456.java
text:
```scala
i@@f ((style & SWT.READ_ONLY) != 0 && buttonHandle != 0) return buttonHandle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12456.java