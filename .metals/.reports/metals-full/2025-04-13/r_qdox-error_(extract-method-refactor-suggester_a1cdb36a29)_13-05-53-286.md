error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14911.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14911.java
text:
```scala
s@@leep(10000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14911.java