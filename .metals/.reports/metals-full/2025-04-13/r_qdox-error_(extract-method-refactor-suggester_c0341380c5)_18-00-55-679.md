error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4780.java
text:
```scala
r@@eturn new EnglishPossessiveFilter(version, tokenStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4780.java