error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9469.java
text:
```scala
i@@nt lParam = (nX & 0xFFFF) | ((nY << 16) & 0xFFFF0000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9469.java