error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6210.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6210.java
text:
```scala
r@@eturn clusterState.routingTable().allAssignedShardsGrouped(concreteIndices, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6210.java