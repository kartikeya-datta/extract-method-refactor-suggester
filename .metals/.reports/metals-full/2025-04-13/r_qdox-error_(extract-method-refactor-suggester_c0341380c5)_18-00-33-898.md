error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1979.java
text:
```scala
i@@f (!checkResourceExistence ||externalFile.exists()) return externalFile;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1979.java