error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16807.java
text:
```scala
r@@egistry.put(ClientPluginConstants.DECORATION_DEFAULT_PROVIDER, AbstractUIPlugin.imageDescriptorFromPlugin(PLUGIN_ID, "icons/default_provider_image.gif").createImage()); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16807.java