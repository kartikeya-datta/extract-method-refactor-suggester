error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6279.java
text:
```scala
i@@nt code = OS.LOWORD (wParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6279.java