error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7993.java
text:
```scala
d@@eps = new Array();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7993.java