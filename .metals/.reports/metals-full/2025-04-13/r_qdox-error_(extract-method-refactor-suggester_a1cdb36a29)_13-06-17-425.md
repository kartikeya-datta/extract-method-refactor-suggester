error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9561.java
...
```java
offset: 841
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9561.java
text:
```scala
...
p@@ackage org.elasticsearch.test.unit.action.bulk;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9561.java