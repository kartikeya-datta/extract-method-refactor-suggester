error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3783.java
text:
```scala
C@@olumnFamily cf = getColumnFamilyInternal(nameFilter, gcBefore);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3783.java