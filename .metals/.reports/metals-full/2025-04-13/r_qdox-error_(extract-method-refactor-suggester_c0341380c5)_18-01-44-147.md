error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8023.java
text:
```scala
c@@tx.enterState(EscapeCharacterState.KEEP_ESCAPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8023.java