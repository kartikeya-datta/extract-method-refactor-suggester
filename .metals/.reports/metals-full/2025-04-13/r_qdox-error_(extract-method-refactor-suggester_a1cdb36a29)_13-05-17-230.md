error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8796.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8796.java
text:
```scala
public C@@onstructor<?> getConstructor() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8796.java