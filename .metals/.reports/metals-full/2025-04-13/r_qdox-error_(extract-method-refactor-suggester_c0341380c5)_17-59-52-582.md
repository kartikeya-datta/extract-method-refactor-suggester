error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2663.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2663.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2663.java
text:
```scala
public i@@nt GetTypeInfoCount(int [] pctinfo ){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2663.java