error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4831.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4831.java
text:
```scala
protected v@@oid onComponentTagBody(final MarkupStream markupStream, final ComponentTag openTag)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4831.java