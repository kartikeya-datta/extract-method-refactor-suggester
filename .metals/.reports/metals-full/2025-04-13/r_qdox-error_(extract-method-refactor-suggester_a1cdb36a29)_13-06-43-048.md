error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2907.java
text:
```scala
l@@ocalTransform.set(translation, rotation, scale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2907.java