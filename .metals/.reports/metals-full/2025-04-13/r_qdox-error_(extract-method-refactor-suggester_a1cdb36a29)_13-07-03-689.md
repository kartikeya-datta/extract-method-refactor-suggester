error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3023.java
...
```java
offset: 896
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3023.java
text:
```scala
...
p@@ackage org.elasticsearch.indices.breaker;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3023.java