error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6445.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6445.java
text:
```scala
public static final c@@har[] SUPER = "super".toCharArray(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6445.java