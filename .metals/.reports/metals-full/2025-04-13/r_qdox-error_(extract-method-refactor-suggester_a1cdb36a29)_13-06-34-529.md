error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5426.java
text:
```scala
i@@f (concreteIndices.length == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5426.java