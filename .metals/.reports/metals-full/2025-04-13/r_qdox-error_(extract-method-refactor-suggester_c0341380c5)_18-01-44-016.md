error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7079.java
text:
```scala
r@@eturn style;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7079.java