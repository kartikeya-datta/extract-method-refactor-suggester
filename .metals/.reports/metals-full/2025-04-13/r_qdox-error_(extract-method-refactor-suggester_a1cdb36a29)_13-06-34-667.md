error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7164.java
text:
```scala
t@@hrow new IllegalArgumentException(e.getMessage(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7164.java