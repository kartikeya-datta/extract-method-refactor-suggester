error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2264.java
text:
```scala
S@@ystem.out.println("Exception occurred:"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2264.java