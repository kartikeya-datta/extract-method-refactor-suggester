error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6387.java
text:
```scala
i@@f (item != null && !item.isDisposed()) item.dispose();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6387.java