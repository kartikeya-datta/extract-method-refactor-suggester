error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12149.java
text:
```scala
i@@f (parent.sortColumn == this) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12149.java