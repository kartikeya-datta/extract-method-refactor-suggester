error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17681.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[99,80]

error in qdox parser
file content:
```java
offset: 3023
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17681.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17681.java