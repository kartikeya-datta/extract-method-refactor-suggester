error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4100.java
text:
```scala
c@@lient().prepareUpdate("test", "type", "1").setInlineScript("custom").setScriptLang("native").setScriptParams(params).get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4100.java