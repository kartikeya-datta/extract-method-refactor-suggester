error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7244.java
text:
```scala
a@@ssertFalse(format.isCommentMarkerSet());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7244.java