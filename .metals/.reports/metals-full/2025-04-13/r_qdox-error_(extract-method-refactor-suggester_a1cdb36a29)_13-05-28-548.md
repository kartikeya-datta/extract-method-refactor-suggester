error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2450.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2450.java
text:
```scala
B@@ytesStreamInput siBytes = new BytesStreamInput(data, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2450.java