error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5984.java
text:
```scala
m@@sg.indexOf(interfaceName) != -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5984.java