error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6322.java
text:
```scala
i@@nt lParam = ((dropDown ? rect.right - 1 : rect.left) & 0xFFFF) | ((y << 16) & 0xFFFF0000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6322.java