error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10162.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10162.java
text:
```scala
final R@@esourceAdapterDeploymentService raDeploymentService = new ResourceAdapterDeploymentService(connectorXmlDescriptor, cmd, ijmd, module, deployerServiceName, deploymentUnit.getServiceName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10162.java