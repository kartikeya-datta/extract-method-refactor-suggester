error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3720.java
text:
```scala
O@@S.objc_msgSend(panel.id, OS.sel_setShowsHiddenFiles_, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3720.java