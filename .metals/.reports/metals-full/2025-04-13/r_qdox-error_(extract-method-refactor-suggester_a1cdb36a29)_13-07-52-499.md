error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5951.java
text:
```scala
p@@rivate static class ComponentData implements Serializable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5951.java