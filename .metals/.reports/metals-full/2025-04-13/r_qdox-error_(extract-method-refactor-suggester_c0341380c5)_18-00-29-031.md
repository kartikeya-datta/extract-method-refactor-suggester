error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4033.java
text:
```scala
I@@JavaElement res = findLocalElement(methodBinding.original().sourceStart());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4033.java