error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5352.java
text:
```scala
I@@nactiveResourceAdapterDeploymentService service = new InactiveResourceAdapterDeploymentService(connectorXmlDescriptor, module, deployment, deploymentUnitName, registration, serviceTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5352.java