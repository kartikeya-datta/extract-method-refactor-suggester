error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1386.java
text:
```scala
p@@ublic final class MarkupStream
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1386.java