error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15860.java
text:
```scala
r@@eturn AccessCode.UNKNOWN;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15860.java