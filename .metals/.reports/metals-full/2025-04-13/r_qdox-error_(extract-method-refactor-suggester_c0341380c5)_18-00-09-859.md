error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5997.java
text:
```scala
i@@f (folder != null && folder instanceof Folder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5997.java