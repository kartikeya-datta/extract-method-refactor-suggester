error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10457.java
text:
```scala
I@@TokenSource tokenSource = BasicTokenSource.makeTokenSource(pattern,null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10457.java