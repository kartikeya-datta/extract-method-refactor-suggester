error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2540.java
text:
```scala
r@@eturn Util.bind("operation.createFieldProgress"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2540.java