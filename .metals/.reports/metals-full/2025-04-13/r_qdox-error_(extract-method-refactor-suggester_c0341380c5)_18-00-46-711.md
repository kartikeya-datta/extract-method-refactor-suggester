error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15233.java
text:
```scala
A@@smManager.getDefault().addListener(VIEW_LISTENER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15233.java