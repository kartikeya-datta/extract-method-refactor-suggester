error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4020.java
text:
```scala
j@@ar.closeZipFile();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4020.java