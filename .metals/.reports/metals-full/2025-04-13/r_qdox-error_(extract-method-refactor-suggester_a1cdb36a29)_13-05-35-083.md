error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3643.java
text:
```scala
a@@rchiveName = archiveName + ConnectorServices.RA_SERVICE_NAME_SEPARATOR + identifier;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3643.java