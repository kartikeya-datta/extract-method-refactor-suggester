error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11150.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11150.java
text:
```scala
public static final S@@tring DEFAULT_SERVICE_NAME_PREFIX = "service ";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11150.java