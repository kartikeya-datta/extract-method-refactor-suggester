error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3629.java
text:
```scala
A@@rrayList store = new ArrayList(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3629.java