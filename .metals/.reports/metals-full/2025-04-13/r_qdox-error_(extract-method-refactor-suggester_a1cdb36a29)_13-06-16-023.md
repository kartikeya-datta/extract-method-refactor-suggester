error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3407.java
text:
```scala
C@@ompilationResult compilationResult = new CompilationResult(sourceUnit, 0, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3407.java