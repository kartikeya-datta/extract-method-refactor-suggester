error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13500.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13500.java
text:
```scala
static final S@@impleAttributeDefinition VIRTUAL_NODES =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13500.java