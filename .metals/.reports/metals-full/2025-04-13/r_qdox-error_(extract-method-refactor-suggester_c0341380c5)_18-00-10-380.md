error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14727.java
text:
```scala
r@@eturn "unique key:" + key;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14727.java