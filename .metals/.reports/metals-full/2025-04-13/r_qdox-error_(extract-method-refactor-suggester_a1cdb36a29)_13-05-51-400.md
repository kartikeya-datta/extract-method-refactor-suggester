error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13360.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13360.java
text:
```scala
private static final l@@ong serialVersionUID = -1296043746617791564L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13360.java