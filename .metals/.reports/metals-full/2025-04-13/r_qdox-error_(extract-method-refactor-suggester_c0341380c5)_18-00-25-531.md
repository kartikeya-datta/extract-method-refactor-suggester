error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12828.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12828.java
text:
```scala
public v@@oid noReset() throws DerivativeException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12828.java