error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6224.java
text:
```scala
e@@lse {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6224.java