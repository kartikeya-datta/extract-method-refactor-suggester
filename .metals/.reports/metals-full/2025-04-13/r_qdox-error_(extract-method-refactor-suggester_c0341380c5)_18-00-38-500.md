error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7300.java
text:
```scala
m@@atchers = new HashSet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7300.java