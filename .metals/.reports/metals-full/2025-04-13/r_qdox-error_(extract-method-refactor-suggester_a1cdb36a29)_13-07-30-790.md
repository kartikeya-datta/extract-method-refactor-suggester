error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9511.java
text:
```scala
a@@dd(new AjaxLink<Void>("link")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9511.java