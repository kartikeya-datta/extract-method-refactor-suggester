error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9856.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9856.java
text:
```scala
static i@@nt MINOR_VERSION = 120;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9856.java