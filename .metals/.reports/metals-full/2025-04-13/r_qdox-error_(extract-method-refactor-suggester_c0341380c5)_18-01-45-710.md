error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11928.java
text:
```scala
C@@lientPlugin.getDefault().getPluginPreferences().getBoolean(ClientPlugin.PREF_USE_CHAT_WINDOW);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11928.java