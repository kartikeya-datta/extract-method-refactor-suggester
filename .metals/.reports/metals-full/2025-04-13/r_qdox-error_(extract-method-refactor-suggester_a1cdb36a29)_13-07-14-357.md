error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10331.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10331.java
text:
```scala
c@@urrentStage = Stage.DONE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10331.java