error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2427.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2427.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2427.java
text:
```scala
R@@ecoveryAction recoveryAction = indexService.shardInjectorSafe(shardId).getInstance(RecoveryAction.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2427.java