error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9183.java
text:
```scala
i@@n = ((IFile) resource).getContents(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9183.java