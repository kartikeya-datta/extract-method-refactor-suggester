error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13708.java
text:
```scala
S@@tring ROLE = Deployer.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13708.java