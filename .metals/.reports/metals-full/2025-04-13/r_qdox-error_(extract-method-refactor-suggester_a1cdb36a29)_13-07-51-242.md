error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7259.java
text:
```scala
a@@ssertContextPrefix("/link1=link2");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7259.java