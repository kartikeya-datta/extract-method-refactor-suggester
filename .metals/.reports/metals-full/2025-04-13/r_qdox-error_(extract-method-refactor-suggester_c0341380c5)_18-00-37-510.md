error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11134.java
text:
```scala
i@@f (fileName == null) fileName = inObject.getResolvedTypeX().getName() + ".class";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11134.java