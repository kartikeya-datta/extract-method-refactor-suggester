error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1381.java
text:
```scala
i@@f (sfield != null && schema.getDynamicPattern(sfield.getName()) != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1381.java