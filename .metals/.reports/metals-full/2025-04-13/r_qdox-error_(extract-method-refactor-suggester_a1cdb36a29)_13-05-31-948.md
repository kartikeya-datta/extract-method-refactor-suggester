error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8123.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8123.java
text:
```scala
public v@@oid addAll (long[] array) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8123.java