error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3042.java
text:
```scala
r@@eturn getKey(this, true/*with access flags*/, false/*don't open*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3042.java