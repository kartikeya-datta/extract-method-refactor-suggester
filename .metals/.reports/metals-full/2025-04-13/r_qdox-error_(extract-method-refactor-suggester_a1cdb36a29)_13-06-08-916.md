error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1130.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1130.java
text:
```scala
public S@@tring title = "Lwjgl Application";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1130.java