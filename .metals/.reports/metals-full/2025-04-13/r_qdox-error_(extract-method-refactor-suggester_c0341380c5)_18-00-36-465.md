error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8790.java
text:
```scala
i@@f( StringUtil.join( args, " " ).length() > 4096 )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8790.java