error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2066.java
text:
```scala
J@@oda.forPattern("yyyy/MM/dd HH:mm:ss Z||yyyy/MM/dd Z")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2066.java