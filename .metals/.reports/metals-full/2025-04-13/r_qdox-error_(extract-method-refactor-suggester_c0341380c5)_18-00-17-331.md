error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10238.java
text:
```scala
c@@amera = new OrthographicCamera( app.getGraphics() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10238.java