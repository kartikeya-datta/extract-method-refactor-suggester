error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/597.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/597.java
text:
```scala
final i@@nt status = injectedTransactionManager.getValue().getStatus();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/597.java