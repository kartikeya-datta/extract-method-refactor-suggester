error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/945.java
text:
```scala
T@@ypefaceUtils.setOcticons(iconText);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/945.java