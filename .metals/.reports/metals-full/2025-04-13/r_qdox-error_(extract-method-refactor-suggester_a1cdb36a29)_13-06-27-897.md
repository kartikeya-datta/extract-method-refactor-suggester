error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5512.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5512.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5512.java
text:
```scala
n@@ew SecurityRealmChildRemoveHandler(true),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5512.java