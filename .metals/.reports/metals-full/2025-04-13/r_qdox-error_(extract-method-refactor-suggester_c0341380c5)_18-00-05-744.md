error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4229.java
text:
```scala
j@@ob.schedule(5000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4229.java