error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4013.java
text:
```scala
r@@eturn new DocumentMapperParser(new Index("test"), ImmutableSettings.Builder.EMPTY_SETTINGS, newAnalysisService(), new PostingsFormatService(new Index("test")),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4013.java