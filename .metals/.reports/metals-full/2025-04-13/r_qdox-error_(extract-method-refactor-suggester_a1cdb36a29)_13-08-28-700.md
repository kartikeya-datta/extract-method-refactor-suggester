error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11025.java
...
```java
offset: 47
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11025.java
text:
```scala
public abstract class BatchOutputCollector {

p@@ackage backtype.storm.transactional;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11025.java