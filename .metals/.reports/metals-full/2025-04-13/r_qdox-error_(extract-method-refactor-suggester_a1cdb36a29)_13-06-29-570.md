error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1398.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh("api").force(request.force()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1398.java