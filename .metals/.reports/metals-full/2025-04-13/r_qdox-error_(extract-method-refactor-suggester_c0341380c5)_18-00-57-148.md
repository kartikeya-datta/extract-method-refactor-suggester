error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3014.java
text:
```scala
s@@ubsystem.registerXMLElementWriter(LoggingSubsystemWriter.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3014.java