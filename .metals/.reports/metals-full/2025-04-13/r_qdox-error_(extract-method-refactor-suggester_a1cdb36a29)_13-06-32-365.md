error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10670.java
text:
```scala
r@@eturn super.getModel().clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10670.java