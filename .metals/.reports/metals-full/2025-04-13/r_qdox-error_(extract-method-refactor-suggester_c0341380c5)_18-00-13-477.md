error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7295.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7295.java
text:
```scala
M@@ap<String, String> mimeTypes = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7295.java