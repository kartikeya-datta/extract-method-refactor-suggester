error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10196.java
text:
```scala
r@@eturn getString(key, component, model, defaultValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10196.java