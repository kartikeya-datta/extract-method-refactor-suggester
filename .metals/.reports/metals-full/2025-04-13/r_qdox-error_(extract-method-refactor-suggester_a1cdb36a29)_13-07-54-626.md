error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1941.java
text:
```scala
i@@f (ExtendedBeanInfo.isCandidateWriteMethod(method)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1941.java