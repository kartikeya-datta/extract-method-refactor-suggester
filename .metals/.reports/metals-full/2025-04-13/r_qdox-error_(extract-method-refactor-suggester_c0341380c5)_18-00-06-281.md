error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1741.java
text:
```scala
v@@oid setLogger(Logger logger) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1741.java