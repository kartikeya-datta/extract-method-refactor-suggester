error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6824.java
text:
```scala
s@@uper(new Names(name, name, name, name), 1.0f, fieldType, null, indexAnalyzer, searchAnalyzer, postingsProvider, docValuesProvider,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6824.java