error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2491.java
text:
```scala
r@@eturn Binding.PACKAGE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2491.java