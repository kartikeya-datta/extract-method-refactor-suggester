error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8437.java
text:
```scala
n@@ew IndexSettingsModule(index, EMPTY_SETTINGS),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8437.java