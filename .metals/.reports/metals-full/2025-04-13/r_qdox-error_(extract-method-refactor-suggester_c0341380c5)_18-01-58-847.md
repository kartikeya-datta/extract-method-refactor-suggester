error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3159.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3159.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3159.java
text:
```scala
public final M@@arkupContainer add(final Component child)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3159.java