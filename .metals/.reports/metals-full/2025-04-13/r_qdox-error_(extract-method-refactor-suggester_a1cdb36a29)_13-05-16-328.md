error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13244.java
text:
```scala
s@@endSelectionEvent (SWT.DefaultSelection);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13244.java