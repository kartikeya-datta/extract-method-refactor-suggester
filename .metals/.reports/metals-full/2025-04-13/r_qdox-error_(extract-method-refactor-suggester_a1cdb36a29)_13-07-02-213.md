error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5697.java
text:
```scala
i@@f (Application.get().usesDeploymentConfig())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5697.java