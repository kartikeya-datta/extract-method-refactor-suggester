error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9519.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9519.java
text:
```scala
public static final L@@ogger LOG = LoggerFactory.getLogger(ZkCoordinator.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9519.java