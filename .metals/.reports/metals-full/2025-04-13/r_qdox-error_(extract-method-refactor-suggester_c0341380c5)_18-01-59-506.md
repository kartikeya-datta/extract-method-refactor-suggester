error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6813.java
text:
```scala
m@@arkupId = Strings.replaceAll(markupId, "_", "__").toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6813.java