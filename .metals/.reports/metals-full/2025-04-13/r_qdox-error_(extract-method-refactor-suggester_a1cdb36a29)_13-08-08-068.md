error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9157.java
text:
```scala
A@@jAttribute attr = AjAttribute.read(relatedDelegate.weaverVersion,type,data,relatedDelegate.getSourceContext(),relatedDelegate.getWorld());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9157.java