error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/187.java
text:
```scala
S@@egmentsAndVirtualNodeConverter.virtualNodesToSegments(value), cache, reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/187.java