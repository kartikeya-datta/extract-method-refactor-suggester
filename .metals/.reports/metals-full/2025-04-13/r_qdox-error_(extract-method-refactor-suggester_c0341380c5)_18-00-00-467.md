error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4014.java
text:
```scala
s@@uper(type, null/*no working copies*/, (IJavaSearchScope)null, computeSubtypes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4014.java