error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2730.java
text:
```scala
r@@eturn TransportActions.Admin.Indices.STATS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2730.java