error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9767.java
text:
```scala
o@@peration.get("driver-name").set("mysql-connector-java-5.1.15.jar");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9767.java