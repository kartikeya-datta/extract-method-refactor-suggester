error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15243.java
text:
```scala
s@@uper(directory, 0L, POLL_INTERVAL, env, stdin, stdout, stderr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15243.java