error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4149.java
text:
```scala
b@@uckets.add(histogramFactory.createBucket(rounding.valueForKey(bucketOrds.get(i)), bucketDocCount(i), bucketAggregations(i), keyed, formatter));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4149.java