error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3944.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3944.java
text:
```scala
public C@@ookieTest(final String name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3944.java