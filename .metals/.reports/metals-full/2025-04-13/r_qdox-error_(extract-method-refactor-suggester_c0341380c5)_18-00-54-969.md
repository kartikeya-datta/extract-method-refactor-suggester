error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10915.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10915.java
text:
```scala
public W@@idget findWidget (int /*long*/ handle, int id) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10915.java