error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3155.java
text:
```scala
s@@etText(shorten(value.toString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3155.java