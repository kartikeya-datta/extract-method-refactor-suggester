error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1807.java
text:
```scala
e@@nvironment = new ServerEnvironment(hostControllerName, properties, new HashMap<String, String>(), null, null, ServerEnvironment.LaunchType.DOMAIN, null, new ProductConfig(Module.getBootModuleLoader(), ".", properties));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1807.java