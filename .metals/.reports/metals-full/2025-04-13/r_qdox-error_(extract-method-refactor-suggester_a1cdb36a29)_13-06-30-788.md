error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1419.java
text:
```scala
r@@equest.realtime(), request.version(), request.versionType(), request.fetchSourceContext(), request.ignoreErrorsOnGeneratedFields());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1419.java