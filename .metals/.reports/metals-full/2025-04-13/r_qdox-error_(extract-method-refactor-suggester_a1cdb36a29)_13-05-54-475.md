error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6554.java
text:
```scala
i@@nternalNamePropertyFactory(TypeDeclaration.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6554.java