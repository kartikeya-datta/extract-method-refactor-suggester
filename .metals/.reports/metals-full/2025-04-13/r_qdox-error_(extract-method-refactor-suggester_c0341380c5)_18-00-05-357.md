error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4107.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4107.java
text:
```scala
public L@@ist<String> simpleMatchToIndexNames(String pattern) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4107.java