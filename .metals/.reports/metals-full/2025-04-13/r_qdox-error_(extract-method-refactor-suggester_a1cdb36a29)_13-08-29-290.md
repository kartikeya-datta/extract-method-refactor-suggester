error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2529.java
...
```java
offset: 1043
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2529.java
text:
```scala
enum Namespace {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2529.java