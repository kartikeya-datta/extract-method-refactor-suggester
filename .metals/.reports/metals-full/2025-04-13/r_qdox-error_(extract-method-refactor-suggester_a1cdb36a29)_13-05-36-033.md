error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3397.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,114]

error in qdox parser
file content:
```java
offset: 114
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3397.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3397.java