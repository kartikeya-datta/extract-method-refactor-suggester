error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9522.java
text:
```scala
a@@dd(new BookmarkablePageLink<Void>("link", MockPageParameterPage.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9522.java