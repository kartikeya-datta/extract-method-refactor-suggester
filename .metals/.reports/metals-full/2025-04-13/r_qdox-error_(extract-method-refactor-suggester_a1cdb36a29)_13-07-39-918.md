error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10210.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10210.java
text:
```scala
f@@InternalSubset.append (target);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10210.java