error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9906.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9906.java
text:
```scala
c@@am.position.set(bounds.getCenter().cpy().add(len, len, len));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9906.java