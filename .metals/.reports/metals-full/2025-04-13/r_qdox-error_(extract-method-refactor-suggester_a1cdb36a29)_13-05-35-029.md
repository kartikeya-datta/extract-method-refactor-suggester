error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4406.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4406.java
text:
```scala
private final I@@nteger somevalue = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4406.java