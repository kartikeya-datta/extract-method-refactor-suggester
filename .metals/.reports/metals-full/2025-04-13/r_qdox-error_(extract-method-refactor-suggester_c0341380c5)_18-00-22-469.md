error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10511.java
text:
```scala
C@@ompilationUnit compilationUnit = AnnotationUtils.getASTParser(source, true);//JDTUtils.getCompilationUnit(source);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10511.java