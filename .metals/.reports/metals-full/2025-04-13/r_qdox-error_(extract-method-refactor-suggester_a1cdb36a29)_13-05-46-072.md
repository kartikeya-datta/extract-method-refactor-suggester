error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7975.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7975.java
text:
```scala
public static final S@@tring getMARKER_TYPE() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7975.java