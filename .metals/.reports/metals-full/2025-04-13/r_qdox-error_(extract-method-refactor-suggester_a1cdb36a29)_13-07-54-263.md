error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16938.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16938.java
text:
```scala
/*Member constr = */M@@ember.methodFromString("void Trace.<init>()");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16938.java