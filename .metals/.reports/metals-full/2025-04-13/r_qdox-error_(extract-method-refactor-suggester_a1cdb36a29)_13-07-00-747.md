error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13758.java
text:
```scala
s@@erver = StandaloneServerFactory.create(config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13758.java