error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12288.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12288.java
text:
```scala
static final S@@tring RUN_METHOD = "run"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12288.java