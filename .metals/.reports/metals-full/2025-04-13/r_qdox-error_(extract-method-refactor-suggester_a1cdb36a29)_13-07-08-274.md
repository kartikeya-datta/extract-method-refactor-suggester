error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12634.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12634.java
text:
```scala
S@@tring expectedEcho = SimpleStatelessSessionBean.class.getSimpleName() + "#" + "Echo " + message + " -- (1:Other, 2:Other, 3:Other)" ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12634.java