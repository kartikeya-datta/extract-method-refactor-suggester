error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7439.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7439.java
text:
```scala
private F@@astCosineTransformer(final boolean orthogonal) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7439.java