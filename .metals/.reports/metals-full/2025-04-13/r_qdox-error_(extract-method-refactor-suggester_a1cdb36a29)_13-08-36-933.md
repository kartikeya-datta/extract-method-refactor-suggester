error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10158.java
text:
```scala
r@@eturn component.getInput();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10158.java