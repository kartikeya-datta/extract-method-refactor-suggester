error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10558.java
text:
```scala
r@@eturn classFile.generateMethodInfoAttribute(binding,false,extras);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10558.java