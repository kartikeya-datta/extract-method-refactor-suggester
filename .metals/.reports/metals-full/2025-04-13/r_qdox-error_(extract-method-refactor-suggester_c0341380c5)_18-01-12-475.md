error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15171.java
text:
```scala
b@@oolean shouldDrawInsertionPoint(int /*long*/ id, int /*long*/ sel) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15171.java