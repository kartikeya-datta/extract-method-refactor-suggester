error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14684.java
text:
```scala
H@@ttpGet httpget = new HttpGet(managementClient.getWebUri() + "/" + getContextPath()  + "/login/?username=" + user + "&password=" + pass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14684.java