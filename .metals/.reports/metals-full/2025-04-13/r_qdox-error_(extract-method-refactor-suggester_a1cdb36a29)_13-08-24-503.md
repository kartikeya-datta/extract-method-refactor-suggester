error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8809.java
text:
```scala
a@@ssertEquals("Invalid request URI", "/uri/Z%C3%BCrich", result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8809.java