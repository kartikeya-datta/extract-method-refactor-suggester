error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7730.java
...
```java
offset: 885
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7730.java
text:
```scala
...
p@@ackage org.elasticsearch.transport;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7730.java