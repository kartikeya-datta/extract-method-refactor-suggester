error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1447.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1447.java
text:
```scala
public static final S@@tring NAME = "constant_score";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1447.java