error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3012.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3012.java
text:
```scala
final N@@ewProcessControllerConnectionService processControllerClient = new NewProcessControllerConnectionService(environment, authCode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3012.java