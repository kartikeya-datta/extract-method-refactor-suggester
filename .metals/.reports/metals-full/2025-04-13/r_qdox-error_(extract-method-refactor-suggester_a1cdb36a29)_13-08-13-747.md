error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18045.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18045.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18045.java
text:
```scala
s@@etLayoutControl(OS.kATSULineWidthTag, OS.Long2Fix(Math.max(0, width)), 4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18045.java