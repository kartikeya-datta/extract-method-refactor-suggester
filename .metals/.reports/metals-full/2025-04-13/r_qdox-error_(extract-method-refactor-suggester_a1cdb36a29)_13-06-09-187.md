error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/875.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/875.java
text:
```scala
public static final i@@nt EOF_FLAG = -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/875.java