error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/284.java
text:
```scala
i@@nt numUniqueQueries = between(1, numQueries / 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/284.java