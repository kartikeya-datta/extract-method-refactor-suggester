error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13513.java
text:
```scala
b@@oolean evaluate(T object);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13513.java