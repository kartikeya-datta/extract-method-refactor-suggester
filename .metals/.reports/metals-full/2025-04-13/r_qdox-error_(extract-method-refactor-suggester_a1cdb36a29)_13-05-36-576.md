error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1483.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1483.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1483.java
text:
```scala
public v@@oid install(final DeploymentItemContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1483.java