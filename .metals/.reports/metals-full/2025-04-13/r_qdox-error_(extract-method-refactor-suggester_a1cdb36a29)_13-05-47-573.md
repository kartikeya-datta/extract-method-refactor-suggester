error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/500.java
text:
```scala
r@@eturn Util.bind("operation.renameElementProgress"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/500.java