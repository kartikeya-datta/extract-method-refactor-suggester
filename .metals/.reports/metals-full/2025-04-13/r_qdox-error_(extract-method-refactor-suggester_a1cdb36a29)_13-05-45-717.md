error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/88.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/88.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/88.java
text:
```scala
f@@ield.setStringValue(s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/88.java