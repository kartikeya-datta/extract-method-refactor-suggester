error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10563.java
text:
```scala
r@@eceiver.actualReceiverType =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10563.java