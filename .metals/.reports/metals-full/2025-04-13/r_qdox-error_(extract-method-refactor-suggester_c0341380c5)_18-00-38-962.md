error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5889.java
text:
```scala
t@@hrow new JavaModelException(new JavaModelStatus(IJavaModelStatusConstants.READ_ONLY, e));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5889.java