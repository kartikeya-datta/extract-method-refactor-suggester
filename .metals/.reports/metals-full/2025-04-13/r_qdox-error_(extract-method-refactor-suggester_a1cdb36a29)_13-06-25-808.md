error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1727.java
text:
```scala
r@@eturn "Looping flow context"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1727.java