error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15276.java
text:
```scala
g@@etNext().call();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15276.java