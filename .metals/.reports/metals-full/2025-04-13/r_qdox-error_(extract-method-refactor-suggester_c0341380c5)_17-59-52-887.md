error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10831.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10831.java
text:
```scala
final T@@ransaction transaction = this.transactionsRepository.removeUserTransaction(this.userTransactionID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10831.java