error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/906.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/906.java
text:
```scala
a@@dd(new SignInPanel(this,"signInPanel")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/906.java