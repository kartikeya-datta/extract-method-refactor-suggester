error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14262.java
text:
```scala
s@@uper(JAXRConstants.SUBSYSTEM_NAME, new JAXRExtension());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14262.java