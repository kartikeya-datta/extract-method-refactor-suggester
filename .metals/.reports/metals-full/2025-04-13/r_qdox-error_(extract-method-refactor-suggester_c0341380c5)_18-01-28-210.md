error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7049.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7049.java
text:
```scala
g@@c = new GC (image, style & SWT.RIGHT_TO_LEFT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7049.java