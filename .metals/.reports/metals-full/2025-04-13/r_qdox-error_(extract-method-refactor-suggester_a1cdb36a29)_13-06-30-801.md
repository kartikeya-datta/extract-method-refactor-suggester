error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6304.java
text:
```scala
d@@eploymentElement.getSha1Hash(), updateContext.getServiceTarget(), updateContext.getServiceContainer(), resultHandler, param);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6304.java