error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9720.java
text:
```scala
i@@f ((style & SWT.MAX) != 0) styleMask |= OS.NSResizableWindowMask;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9720.java