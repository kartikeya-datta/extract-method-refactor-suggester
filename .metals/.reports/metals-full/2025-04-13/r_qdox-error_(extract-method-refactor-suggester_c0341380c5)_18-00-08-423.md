error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12817.java
...
```java
offset: 1088
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12817.java
text:
```scala
...
p@@ackage org.jboss.as.ejb3.component;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12817.java