error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10354.java
text:
```scala
t@@his.logger.info("**** " + getClass().getName() + "." + getName() + " is disabled in this environment: "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10354.java