error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5500.java
text:
```scala
s@@rcData [dp + 0] = srcData [dp + 1] = srcData [dp + 2] = srcData [dp + 3] = (byte)0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5500.java