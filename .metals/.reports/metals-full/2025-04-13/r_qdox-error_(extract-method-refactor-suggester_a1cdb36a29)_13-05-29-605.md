error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1167.java
text:
```scala
i@@f (disposed) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1167.java