error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5392.java
text:
```scala
K@@eyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5392.java