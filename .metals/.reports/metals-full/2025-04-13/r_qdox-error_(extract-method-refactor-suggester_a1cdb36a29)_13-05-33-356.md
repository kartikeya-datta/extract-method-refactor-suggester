error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/719.java
text:
```scala
r@@eturn ((X1Logger) Category.getInstance(name, factory));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/719.java