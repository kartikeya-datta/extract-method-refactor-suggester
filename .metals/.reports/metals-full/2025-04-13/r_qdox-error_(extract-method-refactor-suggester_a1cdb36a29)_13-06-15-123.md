error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6916.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6916.java
text:
```scala
public J@@avaScriptReference(MarkupContainer parent,String id, Class referer, String file)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6916.java