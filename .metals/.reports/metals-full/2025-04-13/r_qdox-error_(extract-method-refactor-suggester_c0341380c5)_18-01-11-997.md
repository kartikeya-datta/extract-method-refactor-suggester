error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/804.java
text:
```scala
c@@ardinality = Integer.parseInt(cmd.getOptionValue("C"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/804.java