error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8009.java
text:
```scala
C@@onnectorServices.RESOURCE_ADAPTER_DEPLOYER_SERVICE_PREFIX.append(this.value.getDeployment().getDeploymentName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8009.java