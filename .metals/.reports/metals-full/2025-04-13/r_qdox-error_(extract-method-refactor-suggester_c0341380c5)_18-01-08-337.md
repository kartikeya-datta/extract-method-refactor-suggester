error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6161.java
text:
```scala
S@@tringBuilder sb = new StringBuilder("Child bean with parent '");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6161.java