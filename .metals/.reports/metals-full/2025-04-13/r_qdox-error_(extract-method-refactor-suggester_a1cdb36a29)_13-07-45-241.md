error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7263.java
text:
```scala
a@@ssertContextPrefix("/link1=link2/link3");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7263.java