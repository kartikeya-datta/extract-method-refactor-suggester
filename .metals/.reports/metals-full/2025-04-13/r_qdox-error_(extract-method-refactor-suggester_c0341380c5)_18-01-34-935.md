error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7241.java
text:
```scala
M@@apBuilder<IndicesAction, TransportActionNodeProxy> actionsBuilder = new MapBuilder<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7241.java