error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15723.java
text:
```scala
v@@alue = FileUtils.safeReadFully(reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15723.java