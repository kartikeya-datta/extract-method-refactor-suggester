error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13163.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13163.java
text:
```scala
public A@@bstractServerModelUpdate<R> getServerModelUpdate() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13163.java