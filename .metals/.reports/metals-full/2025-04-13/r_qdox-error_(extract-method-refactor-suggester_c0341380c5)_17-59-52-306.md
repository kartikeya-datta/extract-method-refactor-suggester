error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3997.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3997.java
text:
```scala
final M@@odelNode processId = operation.hasDefined(PROCESS_ID) ? operation.get(PROCESS_ID) : new ModelNode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3997.java