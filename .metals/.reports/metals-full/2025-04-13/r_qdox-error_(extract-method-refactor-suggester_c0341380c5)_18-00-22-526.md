error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5415.java
text:
```scala
M@@atcher matcher = Pattern.compile("[a-zA-Z0-9\\-_]+").matcher("");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5415.java