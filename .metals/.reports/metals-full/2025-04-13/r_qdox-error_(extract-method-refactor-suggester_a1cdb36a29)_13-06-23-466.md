error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8774.java
text:
```scala
t@@extures.put(textureFile.path(), new Texture(textureFile, parameters.generateMipMaps));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8774.java