error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11782.java
text:
```scala
P@@arseUtils.requireNoContent(reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11782.java