error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1461.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1461.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1461.java
text:
```scala
d@@eleteByQueryRequest.queryParserName(request.param("query_parser_name"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1461.java