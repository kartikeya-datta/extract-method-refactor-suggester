error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5743.java
text:
```scala
v@@iewerCompositeData.heightHint = convertHeightInCharsToPixels(10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5743.java