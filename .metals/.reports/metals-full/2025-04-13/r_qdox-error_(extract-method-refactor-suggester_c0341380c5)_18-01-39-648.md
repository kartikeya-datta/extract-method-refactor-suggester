error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1195.java
text:
```scala
s@@uper(name, type, dclass, ttl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1195.java