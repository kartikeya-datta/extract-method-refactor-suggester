error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/486.java
text:
```scala
s@@electedDrawable.draw(batch, x, y + itemY - itemHeight, prefWidth, itemHeight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/486.java