error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3240.java
text:
```scala
t@@extsToHighlight = HighlightUtils.loadFieldValues(mapper, context, hitContext, field.forceSource());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3240.java