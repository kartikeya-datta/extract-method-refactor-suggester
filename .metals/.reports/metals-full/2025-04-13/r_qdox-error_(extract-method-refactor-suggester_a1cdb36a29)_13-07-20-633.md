error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3988.java
text:
```scala
t@@able.addCell(node.getVersion().number());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3988.java