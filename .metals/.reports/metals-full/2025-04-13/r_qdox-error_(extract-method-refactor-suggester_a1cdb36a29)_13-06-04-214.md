error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13383.java
text:
```scala
t@@hrow new IllegalStateException("The encapsulator character and the delimiter cannot be the same ('" + encapsulator + "')");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13383.java