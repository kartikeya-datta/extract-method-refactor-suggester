error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16564.java
text:
```scala
d@@ata.right = new FormAttachment(paste, -5);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16564.java