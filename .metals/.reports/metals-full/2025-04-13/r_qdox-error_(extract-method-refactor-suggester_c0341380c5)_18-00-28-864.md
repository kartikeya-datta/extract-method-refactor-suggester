error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/846.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/846.java
text:
```scala
public v@@oid close() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/846.java