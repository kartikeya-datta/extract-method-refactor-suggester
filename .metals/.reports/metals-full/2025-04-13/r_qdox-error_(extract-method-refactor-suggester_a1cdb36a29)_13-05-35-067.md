error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1436.java
text:
```scala
S@@ortedMap<K, V> prefixMap(K key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1436.java