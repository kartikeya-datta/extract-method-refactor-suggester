error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7052.java
text:
```scala
t@@empDir = new File(System.getProperty("java.io.tmpdir"), "WicketUploadTest");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7052.java