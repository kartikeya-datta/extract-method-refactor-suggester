error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3386.java
text:
```scala
M@@anualBindTest.class, MatrixJNITest.class, MeshMultitextureTest.class, MeshShaderTest.class, MeshTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3386.java