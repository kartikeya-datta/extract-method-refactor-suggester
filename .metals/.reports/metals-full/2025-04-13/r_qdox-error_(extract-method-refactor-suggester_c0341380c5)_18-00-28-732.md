error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14828.java
...
```java
offset: 656
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14828.java
text:
```scala
 ...
 */
p@@ackage org.apache.openjpa.persistence.models.company.idclass;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14828.java