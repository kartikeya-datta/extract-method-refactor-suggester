error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8165.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8165.java
text:
```scala
public static final N@@ode importNode( Node parent, Node child )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8165.java