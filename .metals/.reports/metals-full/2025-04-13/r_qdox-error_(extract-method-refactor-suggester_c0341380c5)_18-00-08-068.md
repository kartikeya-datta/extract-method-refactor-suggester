error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6008.java
text:
```scala
p@@utHandler(OutputTargetState.OUTPUT_REDIRECT_CHAR, GlobalCharacterHandlers.LEAVE_STATE_HANDLER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6008.java