error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6690.java
text:
```scala
s@@ubsystem.registerXMLElementWriter(WeldSubsystem20Parser.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6690.java