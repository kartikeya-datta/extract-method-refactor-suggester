error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13825.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13825.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.STRUCTURE, Phase.STRUCTURE_OSGI_MANIFEST, new OSGiManifestStructureProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13825.java