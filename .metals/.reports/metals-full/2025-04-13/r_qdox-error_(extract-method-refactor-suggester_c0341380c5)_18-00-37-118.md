error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9423.java
text:
```scala
f@@LineTol, Math.ulp(1d));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9423.java