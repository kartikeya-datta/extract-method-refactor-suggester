error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/340.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/340.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/340.java
text:
```scala
s@@ = s + "break "; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/340.java