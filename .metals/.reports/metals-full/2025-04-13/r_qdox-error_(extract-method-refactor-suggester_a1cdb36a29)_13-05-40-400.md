error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3566.java
text:
```scala
T@@ypefaceHelper.setOctocons((TextView) v.findViewById(id.tv_comment_icon));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3566.java