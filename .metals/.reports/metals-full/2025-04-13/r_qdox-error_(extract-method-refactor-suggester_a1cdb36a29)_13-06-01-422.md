error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3854.java
text:
```scala
t@@his.autoCreateIndex = settings.getAsBoolean("action.autoCreateIndex", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3854.java