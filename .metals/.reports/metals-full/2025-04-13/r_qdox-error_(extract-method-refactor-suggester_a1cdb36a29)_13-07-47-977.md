error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5643.java
text:
```scala
r@@eturn DoubleArrayAtomicFieldData.EMPTY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5643.java