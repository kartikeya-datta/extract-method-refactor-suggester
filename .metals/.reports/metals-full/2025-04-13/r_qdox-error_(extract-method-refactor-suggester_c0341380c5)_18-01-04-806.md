error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1137.java
text:
```scala
T@@oastUtils.show(activity, e, string.error_collaborators_load);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1137.java