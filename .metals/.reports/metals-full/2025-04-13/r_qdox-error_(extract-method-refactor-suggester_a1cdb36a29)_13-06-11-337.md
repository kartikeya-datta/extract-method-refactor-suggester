error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14698.java
text:
```scala
r@@oot.registerOperationHandler(GlobalOperationHandlers.VALIDATE_ADDRESS_OPERATION_NAME, GlobalOperationHandlers.VALIDATE_ADDRESS, CommonProviders.VALIDATE_ADDRESS_PROVIDER, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14698.java