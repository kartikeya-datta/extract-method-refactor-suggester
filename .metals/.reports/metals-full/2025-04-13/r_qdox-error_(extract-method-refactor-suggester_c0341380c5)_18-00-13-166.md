error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14399.java
text:
```scala
a@@scent = Math.max(ascent, runAscent + run.style.rise);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14399.java