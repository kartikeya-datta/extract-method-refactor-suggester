error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5952.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5952.java
text:
```scala
public F@@olderChildrenIterator(IMailFolder parent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5952.java