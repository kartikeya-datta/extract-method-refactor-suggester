error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1422.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1422.java
text:
```scala
S@@tring dataCenter = endpointSnitch.getDatacenter(message.getFrom());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1422.java