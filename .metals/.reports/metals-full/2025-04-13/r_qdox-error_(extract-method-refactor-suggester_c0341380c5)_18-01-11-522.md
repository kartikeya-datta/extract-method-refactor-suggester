error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8700.java
text:
```scala
R@@outingNode routingNode = new RoutingNode(node);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8700.java