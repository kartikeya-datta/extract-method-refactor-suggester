error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9442.java
text:
```scala
r@@eturn internedPackageNames.add(CharOperation.subarray(this.qualification, 0, this.packageIndex));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9442.java