error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2993.java
text:
```scala
t@@his.mustResolve = mustResolvePattern;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2993.java