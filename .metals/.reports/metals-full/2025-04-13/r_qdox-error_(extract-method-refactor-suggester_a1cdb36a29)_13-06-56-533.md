error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3050.java
text:
```scala
l@@oader.setMessage(activity.getString(string.loading_collaborators));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3050.java