error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7066.java
text:
```scala
r@@eturn 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7066.java