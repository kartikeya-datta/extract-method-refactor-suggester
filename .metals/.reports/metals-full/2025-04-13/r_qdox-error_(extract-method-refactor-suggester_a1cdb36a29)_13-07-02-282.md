error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16408.java
text:
```scala
r@@eturn OS.objc_msgSend_bool(this.id, OS.sel_runMode_beforeDate_, mode != null ? mode.id : 0, limitDate != null ? limitDate.id : 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16408.java