error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9141.java
text:
```scala
a@@ssertTrue(e.getResult().get(FAILURE_DESCRIPTION).asString().contains("JBAS011630"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9141.java