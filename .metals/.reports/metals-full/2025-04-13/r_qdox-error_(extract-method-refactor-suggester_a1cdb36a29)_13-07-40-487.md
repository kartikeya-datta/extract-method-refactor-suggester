error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16479.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[193,2]

error in qdox parser
file content:
```java
offset: 4106
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16479.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16479.java