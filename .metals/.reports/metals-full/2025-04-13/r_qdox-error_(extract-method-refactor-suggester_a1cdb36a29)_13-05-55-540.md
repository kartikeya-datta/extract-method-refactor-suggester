error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8397.java
...
```java
offset: 73
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8397.java
text:
```scala
public class RangeBuilder extends AbstractRangeBuilder<RangeBuilder> {

p@@ackage org.elasticsearch.search.aggregations.bucket.range;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8397.java