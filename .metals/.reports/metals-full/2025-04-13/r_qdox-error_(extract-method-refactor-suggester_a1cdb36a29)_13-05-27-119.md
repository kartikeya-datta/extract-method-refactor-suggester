error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6072.java
text:
```scala
i@@ndexOut= new SafeRandomAccessFile(this.indexFile, "rw"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6072.java