error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10841.java
...
```java
offset: 877
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10841.java
text:
```scala
 ...
 * under the License.
 */
p@@ackage org.apache.commons.compress;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10841.java