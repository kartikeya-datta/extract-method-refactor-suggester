error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4051.java
text:
```scala
s@@uper(RemoteOutboundConnectionResourceDefinition.ATTRIBUTE_DEFINITIONS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4051.java