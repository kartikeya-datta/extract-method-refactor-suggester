error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7236.java
text:
```scala
t@@ester.assertErrorMessages(new String[] { "'foo' in veld 'integer' moet een geheel getal zijn. " });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7236.java