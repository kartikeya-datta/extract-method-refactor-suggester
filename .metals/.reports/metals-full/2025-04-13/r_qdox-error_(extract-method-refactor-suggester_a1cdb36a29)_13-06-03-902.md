error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7705.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7705.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7705.java
text:
```scala
k@@eyBindingService = new KeyBindingService(getId(), workbenchPartSiteCommandSupport.getMutableCommandHandlerService(), workbenchPartSiteContextSupport.getMutableContextActivationService());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7705.java