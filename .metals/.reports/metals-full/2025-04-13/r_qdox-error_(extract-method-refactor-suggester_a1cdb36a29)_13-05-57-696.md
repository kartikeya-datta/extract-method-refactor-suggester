error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9158.java
text:
```scala
c@@heckMemberValues(this.memberValuePairs == null ? NoValuePairs : this.memberValuePairs, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9158.java