error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10237.java
text:
```scala
l@@ine.open(format, Math.min(2048, samplingRate / 5) * 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10237.java