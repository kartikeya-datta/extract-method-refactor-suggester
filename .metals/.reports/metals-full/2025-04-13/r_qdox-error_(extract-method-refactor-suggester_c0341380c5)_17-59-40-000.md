error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7414.java
text:
```scala
r@@eturn ProfileDescription.getProfileWithIncludesDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7414.java