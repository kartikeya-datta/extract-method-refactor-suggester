error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3860.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3860.java
text:
```scala
final S@@et<String> set = new HashSet<String>(header.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3860.java