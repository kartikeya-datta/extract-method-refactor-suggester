error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6287.java
text:
```scala
r@@eturn o1.compareTo((T) o2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6287.java