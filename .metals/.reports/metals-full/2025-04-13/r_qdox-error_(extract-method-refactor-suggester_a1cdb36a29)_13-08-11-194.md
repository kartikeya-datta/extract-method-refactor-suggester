error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1614.java
text:
```scala
i@@f (type == String.class) return (T)Float.toString(jsonData.asFloat());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1614.java