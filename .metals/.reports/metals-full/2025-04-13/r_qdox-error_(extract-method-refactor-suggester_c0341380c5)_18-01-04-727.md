error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2906.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2906.java
text:
```scala
public O@@bject newArray (Type componentType, int size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2906.java