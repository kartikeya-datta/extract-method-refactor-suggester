error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7025.java
text:
```scala
S@@tring publishHost = HostResolver.resolvePublishHostAddress(settings.get("jmx.publishHost"), settings, LOCAL_IP).getHostAddress();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7025.java