error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6566.java
text:
```scala
r@@eturn new ShardCountRequest(shard.index(), shard.id(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6566.java