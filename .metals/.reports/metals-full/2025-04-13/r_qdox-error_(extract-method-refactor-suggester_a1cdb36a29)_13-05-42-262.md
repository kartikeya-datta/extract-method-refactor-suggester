error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3460.java
text:
```scala
t@@hrow new UnsupportedOperationException("@Value is never required: " + parameter.getMethod());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3460.java