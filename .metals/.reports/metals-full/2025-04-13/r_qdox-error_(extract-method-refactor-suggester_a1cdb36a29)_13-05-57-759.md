error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3723.java
text:
```scala
s@@of.runWithProgress(runnable);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3723.java