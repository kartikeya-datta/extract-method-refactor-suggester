error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6866.java
text:
```scala
B@@lob blob = cloudBlobStore.async().newBlob(buildBlobPath(blobName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6866.java