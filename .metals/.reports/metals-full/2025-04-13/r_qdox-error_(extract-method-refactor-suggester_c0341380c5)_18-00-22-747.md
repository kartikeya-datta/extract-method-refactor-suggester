error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5177.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5177.java
text:
```scala
private S@@ave save;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5177.java