error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6973.java
text:
```scala
t@@erms.trimExcessEntries(reduceContext.cacheRecycler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6973.java