error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10521.java
text:
```scala
A@@ssert.assertEquals("#InterceptorBean##OtherInterceptorBean##BeanParent##BeanWithSimpleInjected#Hello", s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10521.java