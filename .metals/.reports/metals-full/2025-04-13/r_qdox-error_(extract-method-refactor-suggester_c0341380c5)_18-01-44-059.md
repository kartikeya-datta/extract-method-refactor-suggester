error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3284.java
text:
```scala
r@@eturn new InternalSearchRequest("test", 0, 1).source(builder.buildAsBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3284.java