error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3308.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3308.java
text:
```scala
final C@@reateIndexClusterStateUpdateRequest updateRequest = new CreateIndexClusterStateUpdateRequest(request, cause, request.index())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3308.java