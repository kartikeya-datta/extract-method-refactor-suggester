error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8692.java
text:
```scala
t@@ypeInfo = this.classFile.getBinaryTypeInfo((IFile)this.classFile.getResource());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8692.java