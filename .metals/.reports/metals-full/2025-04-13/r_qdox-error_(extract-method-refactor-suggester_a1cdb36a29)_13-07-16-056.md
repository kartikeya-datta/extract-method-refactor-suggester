error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9494.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9494.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9494.java
text:
```scala
a@@dd(new AjaxLink<Void>("checkKittens")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9494.java