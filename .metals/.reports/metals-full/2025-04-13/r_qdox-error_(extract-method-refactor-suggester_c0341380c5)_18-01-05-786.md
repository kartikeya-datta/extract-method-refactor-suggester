error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6299.java
text:
```scala
f@@illImageBackground (nmcd.hdc, control, rect, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6299.java