error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6903.java
text:
```scala
o@@rg.columba.addressbook.folder.AbstractFolder addressbook = org.columba.addressbook.facade.FolderFacade
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6903.java