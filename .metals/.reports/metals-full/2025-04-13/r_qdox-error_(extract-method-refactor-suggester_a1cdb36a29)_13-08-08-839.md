error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13768.java
text:
```scala
i@@f (isVisible ()) update ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13768.java