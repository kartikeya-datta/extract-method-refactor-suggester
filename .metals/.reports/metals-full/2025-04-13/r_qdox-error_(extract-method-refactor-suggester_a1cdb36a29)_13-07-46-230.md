error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7331.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7331.java
text:
```scala
t@@his.indexLookupPath = requestUri.lastIndexOf(lookupPath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7331.java