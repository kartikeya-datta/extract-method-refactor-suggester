error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9291.java
text:
```scala
w@@ipeIndices("test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9291.java