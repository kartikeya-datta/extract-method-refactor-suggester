error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8301.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8301.java
text:
```scala
public final N@@ullProperty clone() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8301.java