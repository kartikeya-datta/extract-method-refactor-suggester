error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3010.java
text:
```scala
i@@f (pmeta.getParameterType(i+1) == Types.BOOLEAN)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3010.java