error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10411.java
text:
```scala
g@@en.addField(f,getSourceLocation());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10411.java