error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3692.java
text:
```scala
r@@eturn number.intValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3692.java