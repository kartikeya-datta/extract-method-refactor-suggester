error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2951.java
text:
```scala
A@@smAdapter.nodeMunger(world.getModel(), this, munger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2951.java