error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4892.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4892.java
text:
```scala
private final static S@@tring PERTIMAGES = "/org/jhotdraw/samples/pert/images/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4892.java