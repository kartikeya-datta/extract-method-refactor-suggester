error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11262.java
text:
```scala
...
public class PrepareStepHandler  implements OperationStepHandler {
    ...
    public PrepareStepHandler(final LocalHostControllerInfo localHostControllerInfo,
        ...
        this.slaveHandler = new OperationSlaveStepHandler(localHostControllerInfo, contentRepository, serverProxies);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11262.java