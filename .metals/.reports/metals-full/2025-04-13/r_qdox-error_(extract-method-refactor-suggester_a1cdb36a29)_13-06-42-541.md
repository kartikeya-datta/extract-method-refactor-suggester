error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16798.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16798.java
text:
```scala
protected static S@@tring CONTAINER_TYPE = "ecf.xmpp";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16798.java