error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1603.java
text:
```scala
F@@ocusRequester.requestFocus(source);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1603.java