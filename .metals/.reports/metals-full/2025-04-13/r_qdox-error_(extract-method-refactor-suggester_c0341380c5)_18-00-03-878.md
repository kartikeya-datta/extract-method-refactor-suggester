error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14591.java
text:
```scala
f@@romArchive, mode, ze.getExtraFields(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14591.java