error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3609.java
text:
```scala
A@@llocationService strategy = new AllocationService(settingsBuilder().put("cluster.routing.allocation.concurrent_recoveries", 10).build());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3609.java