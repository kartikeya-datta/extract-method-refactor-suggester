error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/581.java
text:
```scala
Q@@uery query = indexQueryParser.parse(jp);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/581.java