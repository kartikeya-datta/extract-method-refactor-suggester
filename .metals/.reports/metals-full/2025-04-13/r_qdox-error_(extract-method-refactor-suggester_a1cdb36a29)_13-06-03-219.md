error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11014.java
text:
```scala
a@@rchive.setWebXML(RestEasyIntegrationTestCase.class.getPackage(), "web.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11014.java