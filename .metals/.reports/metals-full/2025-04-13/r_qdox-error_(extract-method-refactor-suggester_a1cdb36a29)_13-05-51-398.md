error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1512.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1512.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1512.java
text:
```scala
s@@uper(up, down, checked, pressedOffsetX, pressedOffsetY, unpressedOffsetX, unpressedOffsetY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1512.java