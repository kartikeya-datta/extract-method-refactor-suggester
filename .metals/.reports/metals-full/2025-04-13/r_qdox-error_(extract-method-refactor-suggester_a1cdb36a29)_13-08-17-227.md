error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11347.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11347.java
text:
```scala
public final S@@tring loadStringResource(final Component component, final String key)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11347.java