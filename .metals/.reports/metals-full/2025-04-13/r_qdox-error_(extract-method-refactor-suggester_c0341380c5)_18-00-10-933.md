error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7433.java
text:
```scala
P@@ackageResource res = (PackageResource) application.getSharedResources().get("wicket.markup.parser.filter.sub.HeaderSectionBorder/cborder.css");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7433.java