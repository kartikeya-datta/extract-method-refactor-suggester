error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2868.java
text:
```scala
i@@conic = minimized || (shell != null && shell.minimized);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2868.java