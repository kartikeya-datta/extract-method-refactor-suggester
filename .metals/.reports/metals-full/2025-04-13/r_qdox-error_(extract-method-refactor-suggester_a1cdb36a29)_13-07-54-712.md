error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8076.java
text:
```scala
h@@ost.setDefaultWebapp(defaultWebModule);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8076.java