error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2186.java
text:
```scala
r@@eturn segmentInfos.size() > 0 ? segmentInfos.info(segmentInfos.size()-1) : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2186.java