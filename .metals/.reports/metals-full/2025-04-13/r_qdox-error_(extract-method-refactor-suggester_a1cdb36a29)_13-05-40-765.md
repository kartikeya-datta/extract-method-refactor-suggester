error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3601.java
text:
```scala
a@@ndroid.linkerFlags += " -lGLESv2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3601.java