error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15923.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15923.java
text:
```scala
private final A@@ction action;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15923.java