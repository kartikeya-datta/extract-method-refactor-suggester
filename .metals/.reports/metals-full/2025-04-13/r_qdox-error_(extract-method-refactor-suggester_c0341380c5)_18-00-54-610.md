error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3583.java
...
```java
offset: 467
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3583.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3583.java