error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13981.java
text:
```scala
t@@his.pageParameters = pageParameters != null ? pageParameters : new PageParameters();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13981.java