error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/114.java
text:
```scala
c@@lient.search(searchRequest, new ActionListener<SearchResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/114.java