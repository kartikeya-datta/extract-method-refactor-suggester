error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5206.java
text:
```scala
i@@f (!isEnabledInHierarchy() || !determineVisibility())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5206.java