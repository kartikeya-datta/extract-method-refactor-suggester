error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4720.java
text:
```scala
M@@oduleDependency dependency = new ModuleDependency(null, dependencyId, optional, export);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4720.java