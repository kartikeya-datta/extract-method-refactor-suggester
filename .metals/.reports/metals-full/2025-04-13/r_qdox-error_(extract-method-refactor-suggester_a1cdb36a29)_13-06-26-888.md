error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8782.java
text:
```scala
n@@ode = nodeBuilder().local(true).settings(settingsBuilder().put("gateway.type", "none")).node();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8782.java