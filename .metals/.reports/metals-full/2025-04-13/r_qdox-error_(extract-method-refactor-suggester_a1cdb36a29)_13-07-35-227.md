error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8366.java
text:
```scala
t@@his.expressionType = BooleanBinding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8366.java