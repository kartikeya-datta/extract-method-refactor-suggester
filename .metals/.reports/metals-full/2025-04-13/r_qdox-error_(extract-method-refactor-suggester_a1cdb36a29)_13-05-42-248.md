error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11108.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11108.java
text:
```scala
s@@etResponsePage(getApplicationSettings().getPageFactory().newPage(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11108.java