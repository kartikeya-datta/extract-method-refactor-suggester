error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5692.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5692.java
text:
```scala
private static final S@@tring TAG = "DatabaseCache";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5692.java