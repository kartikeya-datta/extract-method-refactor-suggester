error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5667.java
text:
```scala
s@@yntheticAccessor = binding.getAccessMethod(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5667.java