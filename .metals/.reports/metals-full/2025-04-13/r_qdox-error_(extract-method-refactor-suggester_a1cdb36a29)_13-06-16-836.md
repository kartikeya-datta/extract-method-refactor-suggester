error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1107.java
text:
```scala
v@@alues[i].clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1107.java