error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3995.java
text:
```scala
E@@ditorElement editorElement = new EditorElement(editors[i], this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3995.java