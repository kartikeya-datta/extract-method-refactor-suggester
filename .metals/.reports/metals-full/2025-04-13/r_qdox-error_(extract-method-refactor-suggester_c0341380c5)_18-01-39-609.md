error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7804.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7804.java
text:
```scala
public final static b@@oolean DEBUG = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7804.java