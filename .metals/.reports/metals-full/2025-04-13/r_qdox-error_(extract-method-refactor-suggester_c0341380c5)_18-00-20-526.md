error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8417.java
text:
```scala
i@@f (to == termnator) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8417.java