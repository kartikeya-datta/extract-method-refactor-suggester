error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1104.java
text:
```scala
F@@ield field = new StringField("dummy", "", Field.Store.NO); // a dummy Field
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1104.java