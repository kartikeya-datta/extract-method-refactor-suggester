error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2702.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2702.java
text:
```scala
t@@ypeDeclaration = new BinaryTypeConverter(this.parser.problemReporter(), compilationResult, null/*no need to remember type names*/).buildTypeDeclaration(type, compilationUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2702.java