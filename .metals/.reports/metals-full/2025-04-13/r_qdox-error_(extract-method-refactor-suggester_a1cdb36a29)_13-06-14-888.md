error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9018.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9018.java
text:
```scala
t@@his.concurrentRecoveries = componentSettings.getAsInt("concurrent_recoveries", 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9018.java