error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3776.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3776.java
text:
```scala
T@@oken fakeToken = ((IPartitioner)StorageService.getPartitioner()).midpoint(range3.left, range3.right);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3776.java