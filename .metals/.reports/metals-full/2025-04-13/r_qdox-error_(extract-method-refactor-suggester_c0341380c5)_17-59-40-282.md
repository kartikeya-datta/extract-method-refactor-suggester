error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8446.java
text:
```scala
S@@ubsystemRegistration registration = context.registerSubsystem(SUBSYSTEM_NAME, 1, 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8446.java