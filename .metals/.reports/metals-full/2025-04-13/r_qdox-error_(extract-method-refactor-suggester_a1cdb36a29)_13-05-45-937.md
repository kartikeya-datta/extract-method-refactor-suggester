error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9616.java
text:
```scala
C@@lass loadedClass= loader.loadClass("junit.tests.runner.LoadedFromJar", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9616.java