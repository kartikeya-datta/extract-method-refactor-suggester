error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1510.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1510.java
text:
```scala
public v@@oid fling (InputEvent event, float velocityX, float velocityY, int pointer, int button) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1510.java