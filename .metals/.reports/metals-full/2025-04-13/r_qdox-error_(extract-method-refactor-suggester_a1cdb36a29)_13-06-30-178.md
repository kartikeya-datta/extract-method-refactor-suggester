error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10384.java
text:
```scala
M@@BeanServerConnection mbeanServer = JMXConnectorFactory.connect(new JMXServiceURL("service:jmx:remotng-jmx://127.0.0.1:9999")).getMBeanServerConnection();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10384.java