error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/760.java
text:
```scala
l@@og.warn("Using HoldSampleSender for this test run, ensure you have configured enough memory (-Xmx) for your test"); // client
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/760.java