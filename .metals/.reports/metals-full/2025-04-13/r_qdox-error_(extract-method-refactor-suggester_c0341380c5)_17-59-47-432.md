error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6652.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6652.java
text:
```scala
final I@@nternalSearchResponse internalResponse = new InternalSearchResponse(new InternalSearchHits(InternalSearchHits.EMPTY, Long.parseLong(this.scrollId.getAttributes().get("total_hits")), 0.0f), null, null, null, false, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6652.java