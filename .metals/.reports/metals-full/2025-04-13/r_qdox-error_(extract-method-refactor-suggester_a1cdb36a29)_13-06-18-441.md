error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4083.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4083.java
text:
```scala
private static final S@@tring HIDDEN_REPLY_START = "<div class=\"email-hidden-reply\" style=\" display:none\">";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4083.java