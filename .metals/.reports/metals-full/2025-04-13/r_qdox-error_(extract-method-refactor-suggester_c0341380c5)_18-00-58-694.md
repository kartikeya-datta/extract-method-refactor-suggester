error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5820.java
...
```java
offset: 668
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5820.java
text:
```scala
 ...
 */
p@@ackage com.github.mobile.ui.gist;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5820.java