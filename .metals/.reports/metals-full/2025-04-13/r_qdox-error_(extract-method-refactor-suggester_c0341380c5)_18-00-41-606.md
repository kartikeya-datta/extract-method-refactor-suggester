error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12214.java
text:
```scala
p@@ublic class AuthenticatedWebPage extends WicketExamplePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12214.java