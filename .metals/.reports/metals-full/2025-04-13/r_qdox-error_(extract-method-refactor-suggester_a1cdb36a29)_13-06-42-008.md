error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5480.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5480.java
text:
```scala
public static A@@ttachmentKey<Module> KEY = new AttachmentKey<Module>(Module.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5480.java