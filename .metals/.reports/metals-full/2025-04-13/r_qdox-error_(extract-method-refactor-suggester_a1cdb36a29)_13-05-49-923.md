error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2696.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2696.java
text:
```scala
m@@odel = AddressbookTreeModel.getInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2696.java