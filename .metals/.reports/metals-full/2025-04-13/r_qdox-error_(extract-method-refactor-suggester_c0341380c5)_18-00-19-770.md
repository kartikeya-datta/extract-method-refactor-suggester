error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11234.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11234.java
text:
```scala
final D@@eployment deployment = OSGiDeploymentAttachment.getDeployment(deploymentUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11234.java