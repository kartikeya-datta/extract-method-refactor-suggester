error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6100.java
text:
```scala
o@@utput.append('<');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6100.java