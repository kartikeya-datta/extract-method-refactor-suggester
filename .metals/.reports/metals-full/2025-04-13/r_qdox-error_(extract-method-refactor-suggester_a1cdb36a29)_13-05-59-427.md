error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/594.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/594.java
text:
```scala
static i@@nt /*long*/ createCGPathRef(NSBezierPath nsPath) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/594.java