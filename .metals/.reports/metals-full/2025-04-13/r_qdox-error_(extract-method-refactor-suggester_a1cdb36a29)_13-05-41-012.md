error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/695.java
text:
```scala
h@@andle = OS.ImageList_Create (32, 32, COLOR_FLAGS | OS.ILC_MASK | OS.ILC_MIRROR, 16, 16);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/695.java