error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10575.java
text:
```scala
s@@tate |= CANVAS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10575.java