error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16745.java
text:
```scala
s@@earchTextInset.bottom = searchTextInset.top;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16745.java