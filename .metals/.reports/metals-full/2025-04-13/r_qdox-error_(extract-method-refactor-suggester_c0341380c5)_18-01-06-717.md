error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1383.java
text:
```scala
S@@tring language = settings.get("language", settings.get("name", "English"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1383.java