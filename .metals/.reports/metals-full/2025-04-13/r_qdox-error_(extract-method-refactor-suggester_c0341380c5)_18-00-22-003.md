error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17659.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[147,2]

error in qdox parser
file content:
```java
offset: 4371
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17659.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17659.java