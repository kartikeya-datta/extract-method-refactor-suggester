error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10835.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10835.java
text:
```scala
public final v@@oid setParent(final MarkupContainer parent)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10835.java