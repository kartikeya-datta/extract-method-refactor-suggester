error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2118.java
text:
```scala
S@@ystem.out.println("-> merging index ("+ Thread.currentThread()+"): "+index.getIndexFile()); //$NON-NLS-1$//$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2118.java