error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14072.java
text:
```scala
n@@ew BinderServiceBuilder<>(bindInfo, name, ServiceProviderRegistrationFactory.class).build(target).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14072.java