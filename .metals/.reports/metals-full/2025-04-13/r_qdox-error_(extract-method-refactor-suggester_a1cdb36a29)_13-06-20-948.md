error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14460.java
text:
```scala
e@@ntityManager = new ExtendedEntityManager(unitName, entityManager1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14460.java