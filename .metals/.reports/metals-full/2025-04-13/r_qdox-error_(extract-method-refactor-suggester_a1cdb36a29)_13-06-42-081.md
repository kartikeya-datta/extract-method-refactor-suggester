error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7790.java
text:
```scala
g@@etResourceSettings().setCachingStrategy(NoOpResourceCachingStrategy.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7790.java