error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3120.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3120.java
text:
```scala
r@@eturn rq || isContinuous;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3120.java