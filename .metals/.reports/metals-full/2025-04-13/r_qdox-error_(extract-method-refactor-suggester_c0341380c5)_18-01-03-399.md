error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4065.java
text:
```scala
d@@efaults.put(Constants.MODIFICATION_TEST_INTERVAL, new ModelNode().set(4));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4065.java