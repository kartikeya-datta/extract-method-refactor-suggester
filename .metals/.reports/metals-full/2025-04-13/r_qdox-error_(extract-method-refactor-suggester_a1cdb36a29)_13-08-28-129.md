error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/906.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/906.java
text:
```scala
S@@ystem.out.println("Creating shared working copy " + workingCopy.toStringWithAncestors()); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/906.java