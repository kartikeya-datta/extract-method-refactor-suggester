error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4774.java
text:
```scala
t@@his.sourceValueType = sourceValueType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4774.java