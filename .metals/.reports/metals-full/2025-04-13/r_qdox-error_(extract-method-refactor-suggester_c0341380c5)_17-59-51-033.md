error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/918.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/918.java
text:
```scala
private M@@ap<String, Object> data = new HashMap<String, Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/918.java