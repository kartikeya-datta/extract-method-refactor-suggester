error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1370.java
text:
```scala
E@@xternalMusicTest.class, SoftKeyboardTest.class, DirtyRenderingTest.class, YDownTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1370.java