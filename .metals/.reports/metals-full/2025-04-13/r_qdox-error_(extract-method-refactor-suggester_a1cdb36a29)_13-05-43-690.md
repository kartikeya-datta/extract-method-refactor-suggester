error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8131.java
text:
```scala
c@@ase id.m_apply:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8131.java