error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3855.java
text:
```scala
r@@eturn "super"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3855.java