error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4297.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4297.java
text:
```scala
private static A@@ttachmentKey<Boolean> WRITTEN_KEY = AttachmentKey.create(Boolean.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4297.java