error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10919.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,168]

error in qdox parser
file content:
```java
offset: 168
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10919.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10919.java