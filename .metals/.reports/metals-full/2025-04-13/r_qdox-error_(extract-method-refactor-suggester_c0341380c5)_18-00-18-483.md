error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12505.java
text:
```scala
s@@ubModel.get(RECOVERY_ENVIRONMENT, RECOVERY_LISTENER).set(operation.get(RECOVERY_ENVIRONMENT, RECOVERY_LISTENER));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12505.java