error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2106.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2106.java
text:
```scala
public b@@oolean closes(final MarkupElement open)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2106.java