error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11332.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11332.java
text:
```scala
T@@reeModel model = (TreeModel)tree.getDefaultModelObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11332.java