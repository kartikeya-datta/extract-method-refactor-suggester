error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4102.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4102.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4102.java
text:
```scala
protected C@@lusteringInfo fromAnnotation(AnnotationInstance annotationInstance, boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4102.java