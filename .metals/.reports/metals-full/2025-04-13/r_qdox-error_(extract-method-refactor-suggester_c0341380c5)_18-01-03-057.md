error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/152.java
text:
```scala
r@@eturn JavaConventions.validateIdentifier(folderName).isOK();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/152.java