error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13644.java
text:
```scala
_@@kafka.put(hostIndex, new SimpleConsumer(hp.host, hp.port, _config.socketTimeoutMs, _config.bufferSizeBytes, kafka.api.OffsetRequest.DefaultClientId()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13644.java