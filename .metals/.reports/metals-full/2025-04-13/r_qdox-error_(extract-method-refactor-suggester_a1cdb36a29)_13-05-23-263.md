error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1854.java
text:
```scala
r@@eturn type.matches(typeToMatch.resolve(shadow.getIWorld()), TypePattern.DYNAMIC);//AVPT was DYNAMIC
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1854.java