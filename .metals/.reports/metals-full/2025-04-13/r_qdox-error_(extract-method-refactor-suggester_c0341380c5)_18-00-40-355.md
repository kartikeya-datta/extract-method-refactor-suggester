error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9723.java
text:
```scala
t@@arget = Name.fromString(st.nextToken(), origin);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9723.java