error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/493.java
text:
```scala
p@@ublic class GrantNode extends DDLStatementNode
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/493.java