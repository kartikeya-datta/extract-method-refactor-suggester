error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11140.java
text:
```scala
c@@ount(ret == -1 ? 0 : 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11140.java