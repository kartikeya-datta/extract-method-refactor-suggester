error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2244.java
text:
```scala
i@@f (Compatibility.equalsIgnoreCase(name, "Courier")) { //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2244.java