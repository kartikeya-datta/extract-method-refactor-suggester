error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/466.java
text:
```scala
f@@ilter = parseContext.cacheFilter(filter, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/466.java