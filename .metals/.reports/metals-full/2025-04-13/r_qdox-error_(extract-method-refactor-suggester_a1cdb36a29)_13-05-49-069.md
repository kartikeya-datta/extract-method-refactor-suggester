error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5867.java
text:
```scala
i@@f (!(original instanceof RandomKey<?>)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5867.java