error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7451.java
text:
```scala
L@@ist<Callable<Void>> tasks = new ArrayList<>(taskCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7451.java