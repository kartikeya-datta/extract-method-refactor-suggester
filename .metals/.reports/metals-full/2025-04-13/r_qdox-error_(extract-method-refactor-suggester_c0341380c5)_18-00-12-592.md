error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7394.java
text:
```scala
i@@nt /*long*/ labelHandle, imageHandle, buttonHandle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7394.java