error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/833.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/833.java
text:
```scala
public static final S@@tring NAME = "boost";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/833.java