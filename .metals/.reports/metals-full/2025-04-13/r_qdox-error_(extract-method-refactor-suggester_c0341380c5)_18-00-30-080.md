error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12182.java
text:
```scala
J@@MeterUtils.getJMeterCopyright(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12182.java