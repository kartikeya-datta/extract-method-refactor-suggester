error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5072.java
text:
```scala
t@@ester.getParametersForNextRequest().put("link", new String[] { "" });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5072.java