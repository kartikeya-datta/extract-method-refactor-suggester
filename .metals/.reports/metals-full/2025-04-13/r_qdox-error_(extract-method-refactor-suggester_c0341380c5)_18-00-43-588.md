error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/307.java
text:
```scala
r@@eturn c1Type.isAssignableFrom(c2Type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/307.java