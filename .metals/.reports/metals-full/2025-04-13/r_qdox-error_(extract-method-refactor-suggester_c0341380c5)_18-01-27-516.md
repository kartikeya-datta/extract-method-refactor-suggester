error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5253.java
text:
```scala
a@@utoAdd(new Label("test", "TEST")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5253.java