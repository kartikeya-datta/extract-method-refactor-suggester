error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5786.java
text:
```scala
L@@ist list = em.createNamedQuery(findOneQName).setParameter("fname", nameOne)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5786.java