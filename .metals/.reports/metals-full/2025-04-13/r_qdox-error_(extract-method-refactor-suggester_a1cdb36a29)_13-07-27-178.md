error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2073.java
text:
```scala
p@@ublic class AbstractSerializationsTester extends CleanupHelper
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2073.java