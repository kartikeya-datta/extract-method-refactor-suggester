error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7839.java
text:
```scala
S@@tring display = getLocalizer().getString(label, this, label);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7839.java