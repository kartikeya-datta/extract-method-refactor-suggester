error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10989.java
...
```java
offset: 867
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10989.java
text:
```scala
...
p@@ackage org.spaceroots.mantissa.roots;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10989.java