error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12012.java
text:
```scala
n@@ew ClassPathResource("org/springframework/jdbc/object/GenericStoredProcedureTests-context.xml"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12012.java