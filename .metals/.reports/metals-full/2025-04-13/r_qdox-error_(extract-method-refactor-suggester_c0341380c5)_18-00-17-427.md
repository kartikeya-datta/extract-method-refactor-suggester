error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/398.java
text:
```scala
r@@eturn "JarEntryFile["+this.zipName+"::"+this.entryName+"]"; //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/398.java