error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3647.java
text:
```scala
r@@eturn (long) file.numBuffers() * (long) BUFFER_SIZE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3647.java