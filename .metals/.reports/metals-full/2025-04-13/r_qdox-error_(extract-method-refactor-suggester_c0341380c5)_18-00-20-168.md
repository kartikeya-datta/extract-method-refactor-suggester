error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8468.java
text:
```scala
G@@L10 gl = Gdx.gl10;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8468.java