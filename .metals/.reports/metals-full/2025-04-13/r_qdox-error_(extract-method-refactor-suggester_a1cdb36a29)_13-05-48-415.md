error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2764.java
text:
```scala
c@@ontroller.registerHandler(DELETE, "/_scripts/{lang}/{id}", this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2764.java