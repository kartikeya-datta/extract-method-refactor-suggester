error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9055.java
text:
```scala
r@@esourceRegistration.registerReadWriteAttribute(parameter.getAttribute(), null, JcaArchiveValidationWriteHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9055.java