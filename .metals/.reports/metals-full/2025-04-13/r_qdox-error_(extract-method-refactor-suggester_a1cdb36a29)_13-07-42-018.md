error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7597.java
text:
```scala
v@@oid deleteByQuery(byte[] querySource, @Nullable String queryParserName, @Nullable String[] filteringAliases, String... types) throws ElasticSearchException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7597.java