error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15531.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15531.java
text:
```scala
i@@f (guid.Equals (XPCOM.NS_IHELPERAPPLAUNCHERDIALOG_IID)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15531.java