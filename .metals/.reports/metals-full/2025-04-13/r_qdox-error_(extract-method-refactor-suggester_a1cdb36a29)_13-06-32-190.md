error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8092.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8092.java
text:
```scala
final E@@jbRequestScopeActivationInterceptor.Factory requestFactory = new EjbRequestScopeActivationInterceptor.Factory(weldServiceName, description instanceof MessageDrivenComponentDescription);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8092.java