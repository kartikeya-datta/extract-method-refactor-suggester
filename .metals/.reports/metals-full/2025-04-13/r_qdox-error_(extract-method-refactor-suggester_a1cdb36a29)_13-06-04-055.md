error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11731.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11731.java
text:
```scala
private static final i@@nt MAX_WAIT = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11731.java