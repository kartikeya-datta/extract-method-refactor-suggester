error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7788.java
text:
```scala
r@@eturn new VirtualFileResource(overlay.getPhysicalFile(), child, path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7788.java