error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12648.java
text:
```scala
r@@eturn "fieldNotEditable";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12648.java