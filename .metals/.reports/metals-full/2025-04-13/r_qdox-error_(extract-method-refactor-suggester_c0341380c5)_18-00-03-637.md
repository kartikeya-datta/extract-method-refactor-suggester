error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/813.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/813.java
text:
```scala
private final C@@ommentPanel commentPanel;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/813.java