error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10071.java
text:
```scala
M@@ap newElements,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10071.java