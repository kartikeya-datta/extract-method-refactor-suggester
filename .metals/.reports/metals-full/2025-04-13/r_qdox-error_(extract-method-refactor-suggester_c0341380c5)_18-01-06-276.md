error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12909.java
text:
```scala
S@@FSBContextHandleImpl sfsbContextHandle = new SFSBContextHandleImpl(sfsb.getId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12909.java