error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12485.java
text:
```scala
r@@eturn UndertowService.LISTENER.append(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12485.java