error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1299.java
text:
```scala
F@@ile persistedFile = new File(getSolrHome() + File.separator + "solr-persist.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1299.java