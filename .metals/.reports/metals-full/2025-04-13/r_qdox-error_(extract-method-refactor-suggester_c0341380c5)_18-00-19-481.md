error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9251.java
text:
```scala
t@@hrow new ParseException("Unknown tag name with Wicket namespace: '"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9251.java