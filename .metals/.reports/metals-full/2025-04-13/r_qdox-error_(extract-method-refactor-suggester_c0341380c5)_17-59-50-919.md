error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9208.java
text:
```scala
C@@lass<?> getPropertyType(String propertyName) throws BeansException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9208.java