error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2812.java
...
```java
offset: 31
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2812.java
text:
```scala
+ " found for dictionary: " + n@@ame + ".  Using WhitespaceAnalzyer.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2812.java