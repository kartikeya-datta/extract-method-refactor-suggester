error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6584.java
text:
```scala
c@@ondition.computeConversion(scope, type, type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6584.java