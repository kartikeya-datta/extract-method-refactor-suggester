error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8266.java
text:
```scala
r@@eservedWordSet.addAll(Arrays.asList(new String[]{ "FILE", "INDEX" }));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8266.java