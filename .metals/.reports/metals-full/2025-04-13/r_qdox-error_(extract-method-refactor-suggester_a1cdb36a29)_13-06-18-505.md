error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4598.java
text:
```scala
s@@hardRequest.add(i, item.type(), item.id(), item.fields(), item.version(), item.versionType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4598.java