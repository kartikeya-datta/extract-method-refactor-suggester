error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1488.java
text:
```scala
v@@ertexAttributes.add(VertexAttribute.Color());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1488.java