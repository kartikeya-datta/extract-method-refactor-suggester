error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/858.java
text:
```scala
t@@abItem.setToolTipText(part.getTitleToolTip());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/858.java