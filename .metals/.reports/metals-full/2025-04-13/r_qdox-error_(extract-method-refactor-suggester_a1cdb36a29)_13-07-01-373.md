error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4041.java
text:
```scala
R@@OOT_LOGGER.unexpectedError(t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4041.java