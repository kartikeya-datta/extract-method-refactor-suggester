error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13420.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13420.java
text:
```scala
static final i@@nt BUTTON_FILL = SWT.COLOR_LIST_BACKGROUND;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13420.java