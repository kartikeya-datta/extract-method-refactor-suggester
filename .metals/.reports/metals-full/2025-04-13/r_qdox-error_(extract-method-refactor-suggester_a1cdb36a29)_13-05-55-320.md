error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10214.java
text:
```scala
e@@xpectedMembers.add(name + "/ee");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10214.java