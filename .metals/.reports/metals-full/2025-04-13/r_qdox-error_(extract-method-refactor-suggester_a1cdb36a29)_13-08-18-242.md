error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/996.java
text:
```scala
i@@f (!valueType.leafComponentType().isAnnotationType()) { // check annotation type and also reject null literal
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/996.java