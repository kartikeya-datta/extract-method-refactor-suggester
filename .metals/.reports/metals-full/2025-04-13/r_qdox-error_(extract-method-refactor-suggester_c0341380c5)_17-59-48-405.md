error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3519.java
text:
```scala
m@@arkupStream = parentWithAssociatedMarkup.getAssociatedMarkupStream(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3519.java