error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8745.java
text:
```scala
P@@ollingUtils.retryWithTimeout(10000, task);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8745.java