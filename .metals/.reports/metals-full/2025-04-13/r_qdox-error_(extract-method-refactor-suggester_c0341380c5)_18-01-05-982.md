error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9239.java
text:
```scala
S@@kin skin = new Skin(Gdx.files.internal("data/uiskin.json"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9239.java