error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7141.java
text:
```scala
m@@enuItem3.setEnabled(stackPresentationSite.isMoveable(null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7141.java