error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7227.java
text:
```scala
P@@age page = tester.getLastRenderedPage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7227.java