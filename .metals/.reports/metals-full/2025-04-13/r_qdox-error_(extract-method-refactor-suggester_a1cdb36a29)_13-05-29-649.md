error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2490.java
text:
```scala
B@@inding binding2 = problemReferenceBinding.closestMatch();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2490.java