error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7581.java
text:
```scala
C@@onfigurationBuilder builder = new ConfigurationBuilder().read(groupCacheConfiguration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7581.java