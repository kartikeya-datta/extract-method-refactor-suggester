error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1366.java
text:
```scala
p@@ublic abstract class ImageButton extends Button implements IResourceListener
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1366.java