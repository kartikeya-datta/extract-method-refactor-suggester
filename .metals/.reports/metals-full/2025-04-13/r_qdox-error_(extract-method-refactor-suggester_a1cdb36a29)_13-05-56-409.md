error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13647.java
text:
```scala
M@@odifiableResourceAdapter resourceAdapter = RaOperationUtil.buildResourceAdaptersObject(name, context, operation, archiveOrModuleName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13647.java