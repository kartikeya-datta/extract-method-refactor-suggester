error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14996.java
text:
```scala
a@@ddTest(1, 0.0f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14996.java