error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5955.java
text:
```scala
i@@f (next.original().typeVariables != Binding.NO_TYPE_VARIABLES) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5955.java