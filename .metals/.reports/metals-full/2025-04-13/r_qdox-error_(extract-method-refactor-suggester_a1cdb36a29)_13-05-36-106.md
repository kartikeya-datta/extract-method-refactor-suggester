error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16810.java
text:
```scala
s@@uper("label", value, parent); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16810.java