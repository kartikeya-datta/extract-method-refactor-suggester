error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1993.java
text:
```scala
a@@ssertTrue(exists("/solr/cores/core[@name='collection1' and @instanceDir='.']", document));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1993.java