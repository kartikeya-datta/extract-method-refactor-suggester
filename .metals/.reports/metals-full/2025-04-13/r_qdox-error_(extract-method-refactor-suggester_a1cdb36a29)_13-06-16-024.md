error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6586.java
text:
```scala
c@@lusterState = new ClusterState(clusterState.version() + 1, clusterState);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6586.java