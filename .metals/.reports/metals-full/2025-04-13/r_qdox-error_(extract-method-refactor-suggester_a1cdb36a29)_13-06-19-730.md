error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11552.java
...
```java
offset: 854
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11552.java
text:
```scala
 ...
 */
p@@ackage org.apache.wicket.request.target.coding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11552.java