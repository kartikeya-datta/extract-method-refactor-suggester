error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5315.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5315.java
text:
```scala
protected final b@@yte[] getImageData(Attributes attributes)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5315.java