error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6253.java
text:
```scala
j@@taEnvironmentBean.setLastResourceOptimisationInterfaceClassName(LastResource.class.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6253.java