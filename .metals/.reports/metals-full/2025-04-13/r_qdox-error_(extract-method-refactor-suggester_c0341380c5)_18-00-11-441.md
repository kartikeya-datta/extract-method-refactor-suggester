error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1395.java
text:
```scala
r@@eturn "[" + index + "][" + type + "][" + id + "], source[" + Unicode.fromBytes(source) + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1395.java