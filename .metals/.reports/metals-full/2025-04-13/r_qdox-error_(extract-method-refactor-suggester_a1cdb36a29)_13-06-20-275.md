error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2847.java
text:
```scala
d@@eleteByQueryRequest.query(request.contentByteArray(), request.contentByteArrayOffset(), request.contentLength(), request.contentUnsafe());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2847.java