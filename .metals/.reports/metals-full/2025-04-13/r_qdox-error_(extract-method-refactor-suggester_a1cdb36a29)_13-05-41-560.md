error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4531.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4531.java
text:
```scala
public static final i@@nt OnlyValueRequiredMASK = Bit6; // TODO: (philippe) should get rid of in boolean codegen
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4531.java