error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14265.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14265.java
text:
```scala
public T@@arArchiveEntry getCurrentEntry() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14265.java