error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6827.java
text:
```scala
P@@latformMBeanUtil.getResolver(BUFFER_POOL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6827.java