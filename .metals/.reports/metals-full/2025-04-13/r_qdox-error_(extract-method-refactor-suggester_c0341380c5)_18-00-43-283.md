error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1334.java
text:
```scala
o@@rg.objectweb.carol.util.configuration.CarolConfiguration.init();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1334.java