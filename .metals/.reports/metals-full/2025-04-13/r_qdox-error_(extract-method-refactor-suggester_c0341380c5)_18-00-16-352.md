error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12819.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12819.java
text:
```scala
private static L@@og log = LogFactory.getLog(Start.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12819.java