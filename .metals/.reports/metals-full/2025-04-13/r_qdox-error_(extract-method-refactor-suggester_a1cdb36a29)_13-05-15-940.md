error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7903.java
text:
```scala
r@@eturn Platform.getExtensionRegistry().getExtensionPoint(PlatformUI.PLUGIN_ID, IWorkbenchRegistryConstants.PL_PERSPECTIVE_EXTENSIONS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7903.java