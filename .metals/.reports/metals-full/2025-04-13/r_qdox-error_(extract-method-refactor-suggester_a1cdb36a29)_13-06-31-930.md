error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1850.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1850.java
text:
```scala
public static final S@@tring NAME = "indices:data/benchmark/abort";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1850.java