error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4162.java
text:
```scala
O@@bject version = m.invoke(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4162.java