error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7024.java
text:
```scala
b@@oolean hasBeenResolved = false; // TODO (philippe) should use a tagBit instead
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7024.java