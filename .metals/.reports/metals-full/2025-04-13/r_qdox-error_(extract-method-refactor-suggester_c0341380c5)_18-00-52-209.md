error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8736.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8736.java
text:
```scala
protected static final L@@ogger log = Logger.getLogger("org.jboss.server.management");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8736.java