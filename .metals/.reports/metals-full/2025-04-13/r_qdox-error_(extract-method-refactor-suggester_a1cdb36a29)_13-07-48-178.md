error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9366.java
text:
```scala
i@@f (socket != null) throw new ServletException("Already bound.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9366.java