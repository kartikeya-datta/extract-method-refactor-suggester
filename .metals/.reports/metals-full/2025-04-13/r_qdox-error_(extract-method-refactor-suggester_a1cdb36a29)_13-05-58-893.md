error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3361.java
text:
```scala
V@@alueRestriction restriction = new ValueRestriction(new String[] { pwd }, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3361.java