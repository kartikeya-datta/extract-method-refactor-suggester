error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8242.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8242.java
text:
```scala
F@@ile file = openFile("../examples/figures-coverage/all.ajsym");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8242.java