error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9171.java
text:
```scala
v@@oid handleReplacement(int skipped, List<T> from, List<T> to);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9171.java