error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10027.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10027.java
text:
```scala
public S@@tring getWicketAjaxBaseUrlFromLastRequest() throws IOException,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10027.java