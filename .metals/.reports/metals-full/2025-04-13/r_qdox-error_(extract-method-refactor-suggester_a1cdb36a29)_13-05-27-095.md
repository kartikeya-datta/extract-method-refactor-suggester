error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9200.java
text:
```scala
B@@ufferManager bufManager = getBufferManager();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9200.java