error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5697.java
text:
```scala
s@@etTitle(string.gists_title);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5697.java