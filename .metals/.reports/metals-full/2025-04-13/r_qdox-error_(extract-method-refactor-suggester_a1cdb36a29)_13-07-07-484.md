error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/285.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/285.java
text:
```scala
t@@raceStack("Exception in multi user chat.leave", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/285.java