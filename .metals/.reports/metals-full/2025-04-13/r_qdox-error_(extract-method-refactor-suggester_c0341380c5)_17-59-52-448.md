error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8001.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8001.java
text:
```scala
P@@ackageBinding currentPackage = unitScope.fPackage; // extra temp to workaround JIT issue (35731)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8001.java