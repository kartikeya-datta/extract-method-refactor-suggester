error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/947.java
text:
```scala
S@@tring args = ctx.getArgumentsString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/947.java