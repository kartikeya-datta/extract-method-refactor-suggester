error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6990.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6990.java
text:
```scala
public static final b@@yte HINT			= 0;
...
public static final byte CACHE			= 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6990.java