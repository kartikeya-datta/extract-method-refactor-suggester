error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17295.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17295.java
text:
```scala
t@@hrow new NoSuchElementException(_loc.get("closed").getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17295.java