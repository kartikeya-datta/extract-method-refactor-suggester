error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3514.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3514.java
text:
```scala
final C@@ollection<ServiceName> serviceNames = ConnectorServices.getResourceAdapterServiceNames(this.resourceAdapterName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3514.java