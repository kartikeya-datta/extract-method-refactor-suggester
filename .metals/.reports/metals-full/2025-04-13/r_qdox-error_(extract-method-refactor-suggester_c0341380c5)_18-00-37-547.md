error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7788.java
text:
```scala
E@@ngine.Searcher searcher = shard.acquireSearcher();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7788.java