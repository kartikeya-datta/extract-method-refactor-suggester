error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4491.java
...
```java
offset: 592
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4491.java
text:
```scala
...
p@@ackage org.eclipse.ecf.tests.presence;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4491.java