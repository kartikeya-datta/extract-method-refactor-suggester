error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5384.java
text:
```scala
m@@ethod = locator.createBinaryMethodHandle(type, methodBinding.selector, parameterTypes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5384.java