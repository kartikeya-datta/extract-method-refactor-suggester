error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3251.java
text:
```scala
e@@mitter.getEmission().setHigh(particleCount / emitter.getLife().getHighMax() * 1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3251.java