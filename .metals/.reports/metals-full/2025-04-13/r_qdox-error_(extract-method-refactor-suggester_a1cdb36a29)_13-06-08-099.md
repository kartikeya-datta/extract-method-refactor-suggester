error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14077.java
text:
```scala
f@@ormToProcess.process(submittingComponent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14077.java