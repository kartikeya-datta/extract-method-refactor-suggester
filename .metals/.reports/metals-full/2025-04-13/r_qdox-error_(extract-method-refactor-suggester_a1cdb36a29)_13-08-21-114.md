error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8504.java
text:
```scala
t@@hrow new SelectionNodeFound(binding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8504.java