error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5686.java
text:
```scala
i@@f ((style & SWT.FLAT) != 0) return this;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5686.java