error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1823.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1823.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1823.java
text:
```scala
public static final S@@tring NAME = "indices:admin/cache/clear";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1823.java