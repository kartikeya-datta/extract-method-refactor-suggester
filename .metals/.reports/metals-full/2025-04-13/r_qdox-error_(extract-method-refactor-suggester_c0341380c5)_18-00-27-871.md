error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5113.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5113.java
text:
```scala
public C@@lass getContainerClass()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5113.java