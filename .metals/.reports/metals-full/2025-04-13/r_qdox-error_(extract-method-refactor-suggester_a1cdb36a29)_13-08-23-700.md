error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8449.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8449.java
text:
```scala
b@@uf.append(event.categoryName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8449.java