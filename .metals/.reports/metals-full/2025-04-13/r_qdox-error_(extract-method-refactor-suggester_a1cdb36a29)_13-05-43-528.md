error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15925.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15925.java
text:
```scala
private final A@@rrayList strategies = new ArrayList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15925.java