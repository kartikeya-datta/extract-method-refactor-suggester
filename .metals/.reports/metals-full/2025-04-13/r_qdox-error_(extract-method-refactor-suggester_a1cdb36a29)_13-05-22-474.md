error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5144.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5144.java
text:
```scala
public static final A@@ttachmentKey<VirtualFile> KEY = AttachmentKey.create(VirtualFile.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5144.java