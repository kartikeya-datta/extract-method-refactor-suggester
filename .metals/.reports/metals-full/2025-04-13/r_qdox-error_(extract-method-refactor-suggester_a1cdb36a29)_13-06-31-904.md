error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16987.java
text:
```scala
i@@f (!(value instanceof Double)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16987.java