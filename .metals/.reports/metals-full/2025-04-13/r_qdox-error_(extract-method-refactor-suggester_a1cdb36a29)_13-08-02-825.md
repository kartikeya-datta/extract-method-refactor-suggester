error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/516.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/516.java
text:
```scala
public G@@ist refreshGist(String id) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/516.java