error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14349.java
text:
```scala
T@@hread thread = new Thread(receiver, "JMS Receiever");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14349.java