error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4444.java
text:
```scala
p@@ublic class PasswordTextField extends TextField
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4444.java