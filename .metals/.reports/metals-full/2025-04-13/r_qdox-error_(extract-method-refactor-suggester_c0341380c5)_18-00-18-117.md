error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4887.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4887.java
text:
```scala
final O@@bject localServiceRegistrationValue = registration.getProperty(Constants.PROXY_SERVICE_REGISTRATION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4887.java