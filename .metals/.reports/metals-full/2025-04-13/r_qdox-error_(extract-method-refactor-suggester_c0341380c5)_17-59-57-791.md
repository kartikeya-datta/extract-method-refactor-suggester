error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16253.java
text:
```scala
i@@f ((handle == OS.GetFocus () || display.getHighContrast ()) && OS.IsWindowEnabled (handle)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16253.java