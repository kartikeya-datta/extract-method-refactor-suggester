error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3032.java
text:
```scala
u@@u = new UnicodeUnescaper(UnicodeUnescaper.PARAM.escapePlus);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3032.java