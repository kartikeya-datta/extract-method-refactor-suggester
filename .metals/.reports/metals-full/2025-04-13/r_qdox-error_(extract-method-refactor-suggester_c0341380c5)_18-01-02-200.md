error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/801.java
text:
```scala
c@@ore.getUpdateHandler().newIndexWriter(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/801.java