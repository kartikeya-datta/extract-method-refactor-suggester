error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12802.java
text:
```scala
c@@onnection = client.connectSync(new PasswordClientCallbackHandler("TestUser", "localhost.localdomain", "TestUserPassword".toCharArray()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12802.java