error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14622.java
text:
```scala
i@@nt /*long*/ row = widget.rowForItem (handle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14622.java