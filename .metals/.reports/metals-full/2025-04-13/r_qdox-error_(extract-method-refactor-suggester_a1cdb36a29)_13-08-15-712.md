error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4094.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4094.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4094.java
text:
```scala
i@@nitializationScope.problemReporter().unsafeRawConversion(this.initialization, initializationType, fieldType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4094.java