error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18046.java
text:
```scala
u@@rl.append("/").append(Classes.simpleName(target.getPageClass())).append("/");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18046.java