error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6900.java
text:
```scala
i@@f (argumentType != parameterType && argumentType.isRawType() && parameterType.isBoundParameterizedType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6900.java