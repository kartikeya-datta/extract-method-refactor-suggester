error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12007.java
text:
```scala
R@@aOperationUtil.installRaServicesAndDeployFromModule(context, verificationHandler, name, resourceAdapter, archiveOrModuleName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12007.java