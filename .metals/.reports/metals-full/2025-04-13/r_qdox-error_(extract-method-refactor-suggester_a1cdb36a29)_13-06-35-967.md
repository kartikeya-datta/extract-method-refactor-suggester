error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1079.java
text:
```scala
j@@ar.addAsManifestResource("META-INF/jboss-ejb-client-receivers.xml", "jboss-ejb-client.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1079.java