error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4016.java
text:
```scala
t@@hrow new RuntimeException("PostConstruct called before @Inject method");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4016.java