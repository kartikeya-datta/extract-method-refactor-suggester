error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10080.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10080.java
text:
```scala
final i@@nt urlDepth = Strings.isEmpty(urlDepthString) ? -1 : Integer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10080.java