error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9549.java
text:
```scala
t@@his(firstWidget, secondWidget, vertical, skin, "default-" + (vertical ? "vertical" : "horizontal"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9549.java