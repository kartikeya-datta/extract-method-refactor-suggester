error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2787.java
text:
```scala
r@@eturn child.determineVisibility();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2787.java