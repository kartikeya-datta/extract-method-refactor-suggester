error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1846.java
text:
```scala
j@@oranInterpreter.addImplicitAction(new NestComponentIA());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1846.java