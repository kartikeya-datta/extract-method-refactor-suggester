error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6323.java
text:
```scala
t@@estClass.getMethod(BaseTestRunner.SUITE_METHODNAME, new Class[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6323.java