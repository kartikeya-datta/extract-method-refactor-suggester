error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16222.java
text:
```scala
p@@ublic abstract class ExamplePage<T> extends WicketExamplePage<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16222.java