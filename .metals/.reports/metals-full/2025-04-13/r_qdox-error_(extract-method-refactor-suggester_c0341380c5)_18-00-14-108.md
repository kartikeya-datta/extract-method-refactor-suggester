error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7206.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7206.java
text:
```scala
private static final F@@ileUtils FILE_UTILS = FileUtils.getFileUtils();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7206.java