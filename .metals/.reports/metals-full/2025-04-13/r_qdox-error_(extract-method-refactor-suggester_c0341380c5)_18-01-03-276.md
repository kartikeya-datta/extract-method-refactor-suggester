error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10792.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10792.java
text:
```scala
private R@@esource delegate = Resource.Factory.create();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10792.java