error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17588.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[148,80]

error in qdox parser
file content:
```java
offset: 5418
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17588.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17588.java