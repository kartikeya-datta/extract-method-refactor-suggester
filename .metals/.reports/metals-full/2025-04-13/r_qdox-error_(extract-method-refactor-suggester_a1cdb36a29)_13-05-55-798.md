error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3627.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3627.java
text:
```scala
public static final S@@tring IMAPSERVER = "imapserver";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3627.java