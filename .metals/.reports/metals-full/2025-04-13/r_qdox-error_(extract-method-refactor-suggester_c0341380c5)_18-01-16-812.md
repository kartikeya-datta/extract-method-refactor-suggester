error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2343.java
text:
```scala
t@@rim.height += tm.tmHeight + CLIENT_INSET + offsetY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2343.java