error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13266.java
text:
```scala
c@@ontext.addStep(targetOperation, LoadMetricAdd.INSTANCE, OperationContext.Stage.MODEL,  true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13266.java