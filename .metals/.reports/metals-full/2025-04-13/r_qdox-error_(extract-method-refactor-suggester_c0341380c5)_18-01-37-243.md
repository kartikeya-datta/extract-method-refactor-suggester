error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3845.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3845.java
text:
```scala
r@@equest.index(metaData.concreteSingleIndex(request.index(), request.indicesOptions()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3845.java