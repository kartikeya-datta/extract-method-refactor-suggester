error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7683.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7683.java
text:
```scala
S@@ingleSignOnService(String domain, String path, boolean httpOnly, boolean secure) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7683.java