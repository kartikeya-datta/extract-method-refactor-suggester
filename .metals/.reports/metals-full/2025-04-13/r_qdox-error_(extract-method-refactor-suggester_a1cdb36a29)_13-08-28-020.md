error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9019.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9019.java
text:
```scala
private static final c@@har[] FAKENAMESUFFIX = " ".toCharArray(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9019.java