error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2858.java
text:
```scala
a@@rchive.addPackage(MSCEnricherExtension.class.getPackage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2858.java