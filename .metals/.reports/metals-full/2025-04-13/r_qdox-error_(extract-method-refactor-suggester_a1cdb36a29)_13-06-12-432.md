error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3342.java
text:
```scala
p@@arams.put(parameterNames[i], urlDecode(pathParts[i]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3342.java