error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2781.java
text:
```scala
b@@uffer.append('|');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2781.java