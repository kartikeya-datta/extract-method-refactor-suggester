error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1367.java
text:
```scala
p@@ublic abstract class SubmitLink<T> extends Button<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1367.java