error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11602.java
text:
```scala
i@@f(!closing) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11602.java