error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/543.java
text:
```scala
s@@uper(settings, SearchScrollAction.NAME, threadPool);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/543.java