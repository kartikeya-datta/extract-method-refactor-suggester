error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5095.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5095.java
text:
```scala
protected P@@arser recoveringParser;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5095.java