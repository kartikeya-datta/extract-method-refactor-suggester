error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10814.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10814.java
text:
```scala
final S@@tring word = parameters.get("word").toOptionalString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10814.java