error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9515.java
text:
```scala
r@@eturn "Member type : "/*nonNLS*/ + new String(sourceName()) + " "/*nonNLS*/ + super.toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9515.java