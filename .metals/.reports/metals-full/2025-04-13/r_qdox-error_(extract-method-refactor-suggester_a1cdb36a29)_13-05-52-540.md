error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4502.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4502.java
text:
```scala
P@@arser parser = new Parser(lookupEnvironment.problemReporter, true, options.sourceLevel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4502.java