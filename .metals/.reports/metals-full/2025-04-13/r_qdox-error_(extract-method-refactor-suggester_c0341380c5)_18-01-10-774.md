error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15617.java
text:
```scala
b@@oolean isNew = !broker.isDetached(pc) && into == null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15617.java