error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2047.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2047.java
text:
```scala
static C@@ategory cat = Category.getInstance(Shallow.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2047.java