error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6881.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6881.java
text:
```scala
protected I@@mage getNodeImage(MarkupContainer parent,final DefaultMutableTreeNode node)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6881.java