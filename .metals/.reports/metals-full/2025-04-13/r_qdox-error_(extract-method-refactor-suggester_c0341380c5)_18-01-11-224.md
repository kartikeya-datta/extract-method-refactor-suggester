error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6291.java
text:
```scala
v@@iewHeaderListAction = new ViewHeaderListAction(t.getFrameController());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6291.java