error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8019.java
text:
```scala
d@@eployers.get(Phase.POST_MODULE).add(new RegisteredProcessor(Phase.POST_MODULE_REFLECTION_INDEX, new InstallReflectionIndexProcessor()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8019.java