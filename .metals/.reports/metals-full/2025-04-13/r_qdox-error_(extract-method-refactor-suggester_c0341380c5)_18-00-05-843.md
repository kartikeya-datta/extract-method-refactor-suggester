error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2232.java
text:
```scala
r@@eturn calculator.getTotalBytes() / (double) count;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2232.java