error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5775.java
text:
```scala
s@@hardTarget, indexShard.acquireSearcher("count"), indexService, indexShard,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5775.java