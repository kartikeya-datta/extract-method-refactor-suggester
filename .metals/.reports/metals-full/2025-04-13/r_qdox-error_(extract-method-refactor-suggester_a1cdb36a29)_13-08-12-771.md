error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7969.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7969.java
text:
```scala
final I@@ResourceStream resource = component.getApplication().getResourceStreamLocator().locate(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7969.java