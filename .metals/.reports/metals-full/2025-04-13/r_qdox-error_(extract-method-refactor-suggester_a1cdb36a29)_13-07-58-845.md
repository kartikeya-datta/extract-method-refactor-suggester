error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10035.java
text:
```scala
A@@ssert.isTrue(name.indexOf('.') == -1, Util.bind("sourcetype.invalidName", name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10035.java