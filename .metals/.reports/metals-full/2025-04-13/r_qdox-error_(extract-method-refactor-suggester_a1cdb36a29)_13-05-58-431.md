error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14394.java
text:
```scala
f@@ocusHandle = embeddedHandle = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14394.java