error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/82.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/82.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/82.java
text:
```scala
r@@eturn request.getHeader(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/82.java