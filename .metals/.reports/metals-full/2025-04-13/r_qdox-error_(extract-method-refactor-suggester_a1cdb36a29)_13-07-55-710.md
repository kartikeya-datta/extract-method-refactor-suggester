error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3667.java
text:
```scala
r@@eturn bitIndex >= 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3667.java