error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2827.java
text:
```scala
a@@ssertThat(clusterState.metaData().index("test").mappings().containsKey("type1"), equalTo(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2827.java