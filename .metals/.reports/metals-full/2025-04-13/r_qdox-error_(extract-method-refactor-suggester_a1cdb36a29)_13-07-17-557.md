error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10610.java
text:
```scala
R@@esource newResource(final String specification, final Locale locale, final String style);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10610.java