error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/379.java
text:
```scala
t@@his.annotationProcessorManager.processAnnotations(null, null, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/379.java