error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/550.java
text:
```scala
i@@f (this.itemHeight < event.height) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/550.java