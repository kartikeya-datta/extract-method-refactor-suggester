error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9342.java
text:
```scala
t@@hrow new TimeoutException(NLS.bind(Messages.IRCChannelContainer_Exception_Connect_Timeout, connectID.getName()), CONNECT_TIMEOUT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9342.java