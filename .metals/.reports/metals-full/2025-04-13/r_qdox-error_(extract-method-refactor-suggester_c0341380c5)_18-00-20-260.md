error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6855.java
text:
```scala
c@@urrentUncompressedChunkPointer = ((long) currentOffsetIdx) * uncompressed.length;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6855.java