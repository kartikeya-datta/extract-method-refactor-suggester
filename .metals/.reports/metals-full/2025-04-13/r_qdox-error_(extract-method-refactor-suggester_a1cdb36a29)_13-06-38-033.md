error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18063.java
text:
```scala
p@@arent = parent.getParent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18063.java