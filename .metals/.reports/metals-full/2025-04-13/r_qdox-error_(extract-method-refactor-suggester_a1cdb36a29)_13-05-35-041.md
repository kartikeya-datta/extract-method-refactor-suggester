error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1.java
text:
```scala
public M@@odelNode readTransformedModel(ModelVersion modelVersion, boolean includeDefaults) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1.java