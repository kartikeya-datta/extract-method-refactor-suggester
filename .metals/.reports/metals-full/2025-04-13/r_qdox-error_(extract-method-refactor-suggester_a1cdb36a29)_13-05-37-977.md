error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9812.java
text:
```scala
c@@lass BrowserTable extends DefaultDataTable<PageWindowDescription>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9812.java