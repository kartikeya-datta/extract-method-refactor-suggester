error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6197.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6197.java
text:
```scala
i@@f ((typeDeclaration.bits & ASTNode.IsLocalType) != 0 || this.parser().methodRecoveryActivated || this.parser().statementRecoveryActivated){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6197.java