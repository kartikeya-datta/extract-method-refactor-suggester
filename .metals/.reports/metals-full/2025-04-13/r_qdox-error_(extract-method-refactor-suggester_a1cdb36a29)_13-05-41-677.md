error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7423.java
text:
```scala
t@@his.headers = new HashMap<>(request.getHeaders());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7423.java