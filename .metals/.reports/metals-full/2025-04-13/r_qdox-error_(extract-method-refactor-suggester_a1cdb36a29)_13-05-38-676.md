error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10776.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10776.java
text:
```scala
C@@opyright (c) 2010 Composent, Inc. and others. All rights reserved. This
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10776.java