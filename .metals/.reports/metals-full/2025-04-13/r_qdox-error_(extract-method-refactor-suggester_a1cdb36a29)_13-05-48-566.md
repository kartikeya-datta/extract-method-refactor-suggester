error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7813.java
text:
```scala
d@@oit = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7813.java