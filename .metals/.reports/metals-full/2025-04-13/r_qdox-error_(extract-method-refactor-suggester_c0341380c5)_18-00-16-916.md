error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8690.java
text:
```scala
m@@essageListView.modelChangedStructure();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8690.java