error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3294.java
text:
```scala
s@@uper("sorting", "SortingOptions",  mediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3294.java