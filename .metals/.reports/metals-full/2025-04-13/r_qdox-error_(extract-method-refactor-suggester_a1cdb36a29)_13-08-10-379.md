error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16122.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16122.java
text:
```scala
F@@orm<?> form = (Form<?>)manageBook.get("form");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16122.java