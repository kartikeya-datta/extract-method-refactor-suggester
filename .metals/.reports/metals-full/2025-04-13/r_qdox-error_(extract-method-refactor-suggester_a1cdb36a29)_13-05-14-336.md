error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13475.java
text:
```scala
v@@isitor.visitKeepCommand(getObject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13475.java