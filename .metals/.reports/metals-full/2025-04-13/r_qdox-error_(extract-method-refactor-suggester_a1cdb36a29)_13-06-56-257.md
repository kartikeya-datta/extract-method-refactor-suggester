error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4797.java
text:
```scala
i@@f (problemRequestor != null && problemRequestor.isActive()){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4797.java