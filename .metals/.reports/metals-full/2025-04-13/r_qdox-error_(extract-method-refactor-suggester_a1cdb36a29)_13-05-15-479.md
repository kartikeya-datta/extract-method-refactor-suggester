error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13134.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13134.java
text:
```scala
final E@@ntityBeanComponentInstance componentInstance = ctx.getComponent().getCache().get(ctx.getPrimaryKeyUnchecked());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13134.java