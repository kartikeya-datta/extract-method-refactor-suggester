error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14327.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14327.java
text:
```scala
private S@@et<String> hosts = new HashSet<String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14327.java