error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3944.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3944.java
text:
```scala
private final C@@hunkEncoder encoder;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3944.java