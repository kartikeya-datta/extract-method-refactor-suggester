error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/811.java
text:
```scala
I@@mageLoader.getSmallImageIcon("stock_convert-32.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/811.java