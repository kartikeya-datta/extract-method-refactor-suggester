error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6655.java
text:
```scala
i@@f (exitCode != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6655.java