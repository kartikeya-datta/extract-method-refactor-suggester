error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4427.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4427.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4427.java
text:
```scala
public  L@@ist<String> getNodeNames();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4427.java