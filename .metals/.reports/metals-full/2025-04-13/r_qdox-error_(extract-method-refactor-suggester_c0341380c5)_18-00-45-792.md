error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3000.java
text:
```scala
i@@f (excluded != null && excluded.contains(new BytesRef(value))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3000.java