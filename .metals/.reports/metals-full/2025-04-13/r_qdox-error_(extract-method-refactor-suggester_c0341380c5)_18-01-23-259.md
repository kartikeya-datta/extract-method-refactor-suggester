error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/512.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/512.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/512.java
text:
```scala
l@@ogger.warn("suspect illegal state: trying to move shard from primary mode to replica mode");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/512.java