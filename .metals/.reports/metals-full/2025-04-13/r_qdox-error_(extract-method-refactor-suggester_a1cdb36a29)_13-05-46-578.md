error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/706.java
text:
```scala
i@@f (def.type == JointType.GearJoint) joint = new GearJoint(this, jointAddr, ((GearJointDef) def).joint1, ((GearJointDef) def).joint2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/706.java