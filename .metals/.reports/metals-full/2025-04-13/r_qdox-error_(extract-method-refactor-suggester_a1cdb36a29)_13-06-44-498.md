error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/776.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/776.java
text:
```scala
i@@f (!ResolvedType.isMissing(typeX)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/776.java