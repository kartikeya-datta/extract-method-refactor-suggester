error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6255.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6255.java
text:
```scala
final M@@odule module = Module.getCurrentModuleLoader().loadModule(modularReference.getModuleIdentifier());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6255.java