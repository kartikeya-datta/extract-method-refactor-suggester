error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/533.java
text:
```scala
R@@esolvedMemberImpl.readResolvedMember(s, context),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/533.java