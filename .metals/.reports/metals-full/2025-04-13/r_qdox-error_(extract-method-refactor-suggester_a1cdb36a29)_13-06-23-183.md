error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3637.java
text:
```scala
r@@eturn String.valueOf(bytes.getLong(bytes.position()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3637.java