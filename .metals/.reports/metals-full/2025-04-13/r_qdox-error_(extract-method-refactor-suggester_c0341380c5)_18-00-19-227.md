error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8417.java
text:
```scala
i@@f(this.parser.problemReporter().options.maxProblemsPerUnit < this.parser.compilationUnit.compilationResult.problemCount) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8417.java