error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14013.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14013.java
text:
```scala
final S@@essionID id = (SessionID) context.getContextData().get(SessionID.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14013.java