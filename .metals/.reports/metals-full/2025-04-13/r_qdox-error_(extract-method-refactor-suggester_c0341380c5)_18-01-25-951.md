error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8234.java
...
```java
offset: 1101
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8234.java
text:
```scala
...
p@@ackage org.jboss.as.controller.access.constraint;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8234.java