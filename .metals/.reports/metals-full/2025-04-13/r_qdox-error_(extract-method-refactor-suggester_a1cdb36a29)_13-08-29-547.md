error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17134.java
text:
```scala
i@@nt /*long*/ gtk_activate (int /*long*/ widget) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17134.java