error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8336.java
...
```java
offset: 36
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8336.java
text:
```scala
" with binary output directory " + b@@inaryFolder.getFullPath().toString(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8336.java