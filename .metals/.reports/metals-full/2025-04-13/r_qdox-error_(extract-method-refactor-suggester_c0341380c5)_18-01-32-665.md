error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3756.java
text:
```scala
r@@eturn "replication_ping {[" + index + "][" + shardId + "]}";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3756.java