error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10477.java
text:
```scala
S@@trBuilder sb = new StrBuilder(ba.length*2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10477.java