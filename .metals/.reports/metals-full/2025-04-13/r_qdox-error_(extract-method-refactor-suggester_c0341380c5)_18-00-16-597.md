error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3278.java
text:
```scala
a@@ssert cf != null : "key " + key + " is missing!";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3278.java