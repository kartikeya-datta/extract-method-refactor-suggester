error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7088.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7088.java
text:
```scala
a@@ssert parser.currentToken() == XContentParser.Token.END_OBJECT : "Expected [END_OBJECT] but was ["  + parser.currentToken() +"]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7088.java