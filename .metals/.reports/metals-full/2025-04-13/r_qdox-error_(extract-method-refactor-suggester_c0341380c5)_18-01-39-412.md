error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7405.java
text:
```scala
a@@dd(new BookmarkablePageLink("page3Link", Page3.class).setParameter("bookmarkparameter", "3++2 & 5  >< space + á"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7405.java