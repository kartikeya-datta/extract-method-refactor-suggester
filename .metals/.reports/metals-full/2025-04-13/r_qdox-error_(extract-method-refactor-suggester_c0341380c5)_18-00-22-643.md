error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10526.java
text:
```scala
l@@ogVerbose(Commandline.describeCommand(newCommandLine));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10526.java