error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7176.java
text:
```scala
I@@nputStream decode(final String archiveName, final InputStream in, long uncompressedLength,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7176.java