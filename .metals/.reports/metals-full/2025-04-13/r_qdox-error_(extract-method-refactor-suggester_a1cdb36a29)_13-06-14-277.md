error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8618.java
text:
```scala
p@@rintln(o.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8618.java