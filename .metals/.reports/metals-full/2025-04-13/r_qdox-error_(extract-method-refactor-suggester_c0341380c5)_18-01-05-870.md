error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9307.java
text:
```scala
d@@eps = new Array();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9307.java