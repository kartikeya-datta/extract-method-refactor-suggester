error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10428.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10428.java
text:
```scala
public b@@oolean hasInExpression;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10428.java