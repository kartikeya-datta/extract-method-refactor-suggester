error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/672.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/672.java
text:
```scala
public C@@ommitLogSegment.CommitLogContext getContext()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/672.java