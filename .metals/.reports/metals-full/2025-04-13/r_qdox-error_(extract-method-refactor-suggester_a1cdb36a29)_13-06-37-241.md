error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4658.java
text:
```scala
p@@ostingsProvider, docValuesProvider, null, null, fieldDataSettings, indexSettings, MultiFields.empty());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4658.java