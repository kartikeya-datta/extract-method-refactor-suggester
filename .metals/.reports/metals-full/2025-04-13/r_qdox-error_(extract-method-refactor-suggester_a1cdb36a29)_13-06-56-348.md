error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5967.java
text:
```scala
i@@f (isMethodUseDeprecated(this.binding, scope, true)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5967.java