error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3259.java
text:
```scala
a@@nimTime += Gdx.graphics.getDeltaTime();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3259.java