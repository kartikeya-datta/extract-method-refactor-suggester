error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3239.java
text:
```scala
S@@earchContext context = new SearchContext(idGenerator.incrementAndGet(), shardTarget, request.searchType(), request.numberOfShards(), request.nowInMillis(), request.timeout(), request.types(), engineSearcher, indexService, scriptService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3239.java