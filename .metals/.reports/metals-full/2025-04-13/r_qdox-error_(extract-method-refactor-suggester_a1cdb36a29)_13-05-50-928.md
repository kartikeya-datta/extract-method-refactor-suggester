error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6860.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6860.java
text:
```scala
public static H@@ashedBytesArray[] splitUidIntoTypeAndId(BytesRef uid) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6860.java