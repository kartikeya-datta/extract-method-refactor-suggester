error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11968.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11968.java
text:
```scala
public S@@tatefulSessionComponentConfiguration(final StatefulComponentDescription description) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11968.java