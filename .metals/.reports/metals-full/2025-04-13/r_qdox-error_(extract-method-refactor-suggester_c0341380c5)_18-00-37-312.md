error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3007.java
text:
```scala
s@@uper(resourceManager, currentResource, typeSystem, vars, globalVars, null, null, null, null, null, null,null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3007.java