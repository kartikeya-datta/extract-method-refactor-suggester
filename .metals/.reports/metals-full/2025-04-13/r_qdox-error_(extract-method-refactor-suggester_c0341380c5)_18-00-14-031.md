error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14.java
text:
```scala
p@@refix = Strings.afterFirst(prefix, '.');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14.java