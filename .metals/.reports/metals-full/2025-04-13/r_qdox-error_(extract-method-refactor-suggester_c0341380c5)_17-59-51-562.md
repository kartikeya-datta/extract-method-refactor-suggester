error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8121.java
text:
```scala
R@@eferenceBinding superclassBinding = (ReferenceBinding)binding.superclass.erasure();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8121.java