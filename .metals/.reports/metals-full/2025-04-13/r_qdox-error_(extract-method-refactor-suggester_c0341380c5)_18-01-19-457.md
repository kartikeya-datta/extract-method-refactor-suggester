error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7999.java
text:
```scala
g@@uiInstance.clearTestPlan((TestElement)tree.getArray()[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7999.java