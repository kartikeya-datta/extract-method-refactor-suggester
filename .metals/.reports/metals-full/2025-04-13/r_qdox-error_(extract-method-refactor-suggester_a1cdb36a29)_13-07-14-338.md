error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9353.java
text:
```scala
i@@f (session.getFlushMode().equals(FlushMode.MANUAL)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9353.java