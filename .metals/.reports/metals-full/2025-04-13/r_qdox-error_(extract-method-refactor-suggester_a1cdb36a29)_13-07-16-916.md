error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/85.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/85.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/85.java
text:
```scala
L@@ist<Object> textsToHighlight = HighlightUtils.loadFieldValues(fieldMapper, context, hitContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/85.java