error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1234.java
text:
```scala
r@@eturn new File(DatabaseDescriptor.getNextAvailableDataLocation() + File.separator + table_, fname).getAbsolutePath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1234.java