error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16930.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16930.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16930.java
text:
```scala
l@@ine[offset1 + 0] = line[offset1 + 1] = line[offset1 + 2] = line[offset1 + 3] = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16930.java