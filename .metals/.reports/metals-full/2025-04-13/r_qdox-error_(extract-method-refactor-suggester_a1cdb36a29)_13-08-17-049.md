error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7032.java
text:
```scala
r@@eplacement.setLocation(getLocation());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7032.java