error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9037.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9037.java
text:
```scala
public static E@@mbeddedDatabaseBuilder relativeTo(Class<?> clazz) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9037.java