error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7794.java
text:
```scala
A@@ssert.notNull(session, "session must not be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7794.java