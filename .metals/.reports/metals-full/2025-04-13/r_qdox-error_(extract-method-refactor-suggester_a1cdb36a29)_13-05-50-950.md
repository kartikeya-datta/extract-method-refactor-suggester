error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6664.java
text:
```scala
r@@eturn new String[] {"Items", "Selection", "ToolTipText", "TopIndex"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6664.java