error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3044.java
text:
```scala
t@@hrow new GdxRuntimeException(ex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3044.java