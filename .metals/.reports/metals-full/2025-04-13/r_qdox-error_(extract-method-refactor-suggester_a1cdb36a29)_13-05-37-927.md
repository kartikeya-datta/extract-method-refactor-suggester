error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10755.java
text:
```scala
I@@D newServerID = IDFactory.getDefault().makeStringID(id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10755.java