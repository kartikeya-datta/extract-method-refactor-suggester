error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10747.java
text:
```scala
p@@ropertiesFactory = new PropertiesFactory(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10747.java