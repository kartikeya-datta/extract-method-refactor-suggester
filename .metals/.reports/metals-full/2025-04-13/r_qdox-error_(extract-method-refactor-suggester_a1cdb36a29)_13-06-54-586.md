error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8030.java
text:
```scala
r@@eturn !outputFolder.getLocation().toString().equalsIgnoreCase(lastState.outputLocationString);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8030.java