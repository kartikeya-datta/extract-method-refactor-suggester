error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3762.java
text:
```scala
n@@ew QueryParser(TEST_VERSION_CURRENT, FIELD, new WhitespaceAnalyzer());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3762.java