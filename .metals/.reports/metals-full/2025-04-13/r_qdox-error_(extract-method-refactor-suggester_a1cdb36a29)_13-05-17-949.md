error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8438.java
text:
```scala
p@@arseContext.addNamedFilter(filterName, new CustomQueryWrappingFilter(childrenConstantScoreQuery));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8438.java