error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14498.java
text:
```scala
S@@tringBuilder sb = new StringBuilder(s.length() * 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14498.java