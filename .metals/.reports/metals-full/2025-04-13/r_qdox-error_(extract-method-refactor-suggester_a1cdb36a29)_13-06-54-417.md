error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6891.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6891.java
text:
```scala
final S@@erviceName threadPoolServiceName = EJB3SubsystemModel.BASE_THREAD_POOL_SERVICE_NAME.append(threadPoolName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6891.java