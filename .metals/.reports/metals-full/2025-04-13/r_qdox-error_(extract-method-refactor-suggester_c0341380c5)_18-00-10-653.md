error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11410.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11410.java
text:
```scala
public V@@elocityConfigurer mvcVelocityConfigurer() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11410.java