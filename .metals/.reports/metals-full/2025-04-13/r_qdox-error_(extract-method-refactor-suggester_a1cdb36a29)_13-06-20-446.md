error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6563.java
text:
```scala
s@@tate = LocalGatewayMetaState.Builder.readFrom(in);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6563.java