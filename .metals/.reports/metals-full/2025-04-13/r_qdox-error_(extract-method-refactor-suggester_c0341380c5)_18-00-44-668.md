error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2452.java
text:
```scala
B@@ytesStreamInput in = new BytesStreamInput(data, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2452.java