error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/787.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/787.java
text:
```scala
public static final S@@tring BACKGROUNDVALIDATIONMILLIS = "background-validation-millis";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/787.java