error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8282.java
text:
```scala
b@@inding.setConstant(NotAConstant);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8282.java