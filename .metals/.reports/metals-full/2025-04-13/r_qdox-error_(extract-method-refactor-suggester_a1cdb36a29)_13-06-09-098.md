error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11768.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11768.java
text:
```scala
public static final A@@ttachmentKey<WarMetaData> ATTACHMENT_KEY = AttachmentKey.create(WarMetaData.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11768.java