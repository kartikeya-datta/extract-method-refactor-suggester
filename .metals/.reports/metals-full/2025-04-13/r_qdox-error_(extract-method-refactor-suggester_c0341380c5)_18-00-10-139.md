error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/294.java
text:
```scala
T@@ypeBinding binding = typeRef.resolvedType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/294.java