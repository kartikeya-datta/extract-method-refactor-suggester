error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9789.java
text:
```scala
M@@essageAdmin.getAdmin().putReply(reply.getJMSMessageID(), reply);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9789.java