error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10328.java
text:
```scala
w@@eaver.getLazyClassGen().getOrCreateWeaverStateInfo(weaver.getReweavableMode());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10328.java