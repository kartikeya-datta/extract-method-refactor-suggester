error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6502.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6502.java
text:
```scala
final b@@oolean enabled = BeanValidationParameters.BEAN_VALIDATION_ENABLED.getAttribute().resolveModelAttribute(context, model).asBoolean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6502.java