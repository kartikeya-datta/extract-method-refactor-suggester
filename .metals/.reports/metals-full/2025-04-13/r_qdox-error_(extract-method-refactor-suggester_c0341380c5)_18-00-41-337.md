error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13000.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13000.java
text:
```scala
public final C@@lass<? extends Page> getResponsePageClass()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13000.java