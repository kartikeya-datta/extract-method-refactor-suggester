error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8800.java
text:
```scala
i@@f (Version.indexCreated(indexSettings).onOrAfter(Version.V_1_4_0_Beta)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8800.java