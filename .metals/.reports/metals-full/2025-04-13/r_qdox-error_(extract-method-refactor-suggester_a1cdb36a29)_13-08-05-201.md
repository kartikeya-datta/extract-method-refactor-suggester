error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7421.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7421.java
text:
```scala
protected I@@Model model(Object object, int index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7421.java