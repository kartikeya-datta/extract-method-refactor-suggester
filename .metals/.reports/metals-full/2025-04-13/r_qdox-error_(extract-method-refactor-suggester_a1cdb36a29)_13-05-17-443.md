error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13171.java
text:
```scala
i@@f(ret == null  || ret.length() == 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13171.java