error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10324.java
text:
```scala
T@@able table = info.createTable(cls, null, info.getSchemaName(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10324.java