error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5466.java
text:
```scala
c@@ache.setColors(color);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5466.java