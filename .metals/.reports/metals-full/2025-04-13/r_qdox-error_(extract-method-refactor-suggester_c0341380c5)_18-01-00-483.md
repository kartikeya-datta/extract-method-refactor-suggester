error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5945.java
text:
```scala
r@@eportSchemaError("PublicSystemOnNotation", null, elmNode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5945.java