error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8282.java
text:
```scala
B@@ytesStreamOutput os = cachedEntry.bytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8282.java