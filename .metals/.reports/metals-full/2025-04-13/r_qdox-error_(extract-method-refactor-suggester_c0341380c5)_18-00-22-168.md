error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15757.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15757.java
text:
```scala
i@@nt /*long*/ ptr = OS.getenv (ascii ("APP_NAME_" + OS.getpid ()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15757.java