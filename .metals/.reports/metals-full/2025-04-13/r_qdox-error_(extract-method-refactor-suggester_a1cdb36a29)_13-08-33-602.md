error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2289.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2289.java
text:
```scala
public t@@estProtocol() {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2289.java