error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13645.java
text:
```scala
j@@di.setGroup(this.group);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13645.java