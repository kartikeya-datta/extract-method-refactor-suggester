error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7430.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7430.java
text:
```scala
b@@uf.append("properties=").append(properties).append("]"); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7430.java