error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2965.java
text:
```scala
a@@ndroid.linkerFlags += " -lGLESv2 -llog";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2965.java