error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9828.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9828.java
text:
```scala
s@@uper(layout.issues_filter_item, inflater, elements);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9828.java