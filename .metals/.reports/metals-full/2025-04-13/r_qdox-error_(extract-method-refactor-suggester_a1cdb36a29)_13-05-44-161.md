error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1792.java
text:
```scala
T@@ypeDeclaration typeDeclaration = TypeConverter.buildTypeDeclaration(type, compilationUnit, compilationResult);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1792.java