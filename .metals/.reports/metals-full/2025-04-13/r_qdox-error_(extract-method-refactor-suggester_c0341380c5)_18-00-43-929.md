error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13009.java
text:
```scala
O@@S.XSendEvent (xDisplay, trayWindow, false, OS.NoEventMask, clientEvent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13009.java