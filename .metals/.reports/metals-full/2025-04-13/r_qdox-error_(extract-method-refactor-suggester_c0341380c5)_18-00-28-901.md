error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/799.java
text:
```scala
b@@all.applyLinearImpulse(impulse, ball.getWorldCenter(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/799.java