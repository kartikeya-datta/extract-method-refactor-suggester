error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8486.java
text:
```scala
t@@able.addCell(stats == null ? null : stats.getOs() == null ? null : stats.getOs().getLoadAverage().length < 1 ? null : stats.getOs().getLoadAverage()[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8486.java