error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3315.java
text:
```scala
I@@ClasspathEntry[] entries = project.getResolvedClasspath(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3315.java