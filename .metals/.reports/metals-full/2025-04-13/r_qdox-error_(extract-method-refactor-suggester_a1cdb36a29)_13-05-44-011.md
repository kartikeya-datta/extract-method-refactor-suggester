error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13779.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13779.java
text:
```scala
private static M@@oduleIdentifier JBOSS_HIBERNATE_ID = ModuleIdentifier.create("org.hibernate");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13779.java