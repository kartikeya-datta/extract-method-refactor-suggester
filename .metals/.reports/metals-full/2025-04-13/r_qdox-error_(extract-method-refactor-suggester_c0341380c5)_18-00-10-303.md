error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5670.java
text:
```scala
r@@equest.realtime(), request.version(), request.versionType(), request.fetchSourceContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5670.java