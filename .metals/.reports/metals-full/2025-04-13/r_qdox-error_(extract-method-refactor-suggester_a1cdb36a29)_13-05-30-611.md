error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3014.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3014.java
text:
```scala
public static b@@oolean shadows = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3014.java