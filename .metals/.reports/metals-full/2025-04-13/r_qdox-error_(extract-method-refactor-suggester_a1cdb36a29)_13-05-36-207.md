error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11954.java
text:
```scala
A@@ssert.assertEquals("Unexpected state returned from stateful session bean", SimpleInterceptor.class.getName() + "#" + state, storedState);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11954.java