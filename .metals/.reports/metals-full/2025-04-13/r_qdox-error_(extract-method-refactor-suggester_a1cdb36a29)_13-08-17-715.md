error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10218.java
text:
```scala
t@@arget.addService(factoryName, new ValueService<>(new ImmediateValue<>(factory))).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10218.java