error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12503.java
text:
```scala
c@@ontainer.get(ModelKeys.ALIASES).add(reader.getElementText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12503.java