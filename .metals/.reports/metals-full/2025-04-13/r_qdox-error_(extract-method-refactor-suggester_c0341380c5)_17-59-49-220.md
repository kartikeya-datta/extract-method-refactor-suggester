error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10183.java
text:
```scala
p@@ublic class DoubleConverter extends AbstractDecimalConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10183.java