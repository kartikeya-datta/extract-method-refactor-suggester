error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/850.java
text:
```scala
T@@ransportWriteAttributeHandler.INSTANCE.registerAttributes(transport);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/850.java