error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6917.java
text:
```scala
p@@ort = "9999";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6917.java