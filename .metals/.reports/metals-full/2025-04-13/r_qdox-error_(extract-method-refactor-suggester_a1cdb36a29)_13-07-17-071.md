error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6060.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6060.java
text:
```scala
public static final T@@ypedValue NULL = new TypedValue(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6060.java