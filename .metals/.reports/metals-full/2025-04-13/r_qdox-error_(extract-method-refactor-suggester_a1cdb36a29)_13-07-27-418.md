error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1561.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1561.java
text:
```scala
i@@f (qualifiedType != null && (qualifiedType.isGenericType() || qualifiedType.isParameterizedType())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1561.java