error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1403.java
text:
```scala
i@@f (delegateThis == null){ // if not found then internal error, field should have been found
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1403.java