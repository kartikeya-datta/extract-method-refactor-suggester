error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1800.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1800.java
text:
```scala
public static final S@@tring NAME = "cluster:monitor/nodes/info";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1800.java