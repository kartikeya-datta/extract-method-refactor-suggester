error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7796.java
text:
```scala
r@@eturn defaultUser ? new UserReceivedNewsFragment() : new OrganizationNewsFragment();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7796.java