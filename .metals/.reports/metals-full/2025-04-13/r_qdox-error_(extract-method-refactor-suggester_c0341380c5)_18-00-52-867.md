error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/147.java
text:
```scala
d@@elta.added(workingCopy, IJavaElementDelta.F_PRIMARY_WORKING_COPY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/147.java