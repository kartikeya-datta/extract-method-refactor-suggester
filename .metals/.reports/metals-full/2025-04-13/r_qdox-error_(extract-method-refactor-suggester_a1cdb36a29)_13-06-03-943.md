error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17565.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[378,80]

error in qdox parser
file content:
```java
offset: 11204
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17565.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17565.java