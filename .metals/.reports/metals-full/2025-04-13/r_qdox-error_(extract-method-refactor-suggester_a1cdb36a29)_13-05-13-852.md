error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2830.java
text:
```scala
t@@his(size, 1, defaultShader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2830.java