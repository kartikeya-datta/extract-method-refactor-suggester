error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4071.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4071.java
text:
```scala
public static final S@@tring ROOT_CACERT_CRT_PFX = "ApacheJMeterTemporaryRootCA"; // $NON-NLS-1$ (do not change)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4071.java