error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6265.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6265.java
text:
```scala
!r@@esult.hasDefined(ModelDescriptionConstants.FAILURE_DESCRIPTION));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6265.java