error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2343.java
text:
```scala
r@@eturn other != null && getClass().equals(other.getClass()) && ((VarLongWritable) other).value == value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2343.java