error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3382.java
text:
```scala
i@@tem.render();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3382.java