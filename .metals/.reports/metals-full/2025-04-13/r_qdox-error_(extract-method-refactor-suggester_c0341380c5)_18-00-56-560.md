error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2621.java
text:
```scala
p@@osition.set(camPos.scl(30));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2621.java