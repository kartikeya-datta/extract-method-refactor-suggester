error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7447.java
text:
```scala
S@@canner scanner;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7447.java