error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18157.java
text:
```scala
T@@able table = new Table(shell, SWT.BORDER | SWT.FULL_SELECTION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18157.java