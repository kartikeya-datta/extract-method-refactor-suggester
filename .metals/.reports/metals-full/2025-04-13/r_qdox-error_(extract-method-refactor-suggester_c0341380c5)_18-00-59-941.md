error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8228.java
text:
```scala
r@@esource.setCacheable(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8228.java