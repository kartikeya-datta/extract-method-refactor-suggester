error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15297.java
text:
```scala
u@@rlPattern = parser.getInputFromPositionMarker(elem.getPos()).toString().trim();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15297.java