error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4173.java
text:
```scala
i@@nt bracketCount2 = StringUtils.countOccurrencesOf(pattern2, "{");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4173.java