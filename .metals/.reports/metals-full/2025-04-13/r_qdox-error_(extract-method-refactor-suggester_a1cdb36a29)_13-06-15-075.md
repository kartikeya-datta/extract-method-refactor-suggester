error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10722.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10722.java
text:
```scala
r@@eturn "A" + (colorName != null && colorName.startsWith("o") ? "n " : " ") + colorName + " " + name;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10722.java