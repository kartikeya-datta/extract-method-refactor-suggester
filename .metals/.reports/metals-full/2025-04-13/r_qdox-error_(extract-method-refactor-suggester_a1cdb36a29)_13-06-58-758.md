error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9593.java
text:
```scala
n@@ew JglfwApplication(test, config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9593.java