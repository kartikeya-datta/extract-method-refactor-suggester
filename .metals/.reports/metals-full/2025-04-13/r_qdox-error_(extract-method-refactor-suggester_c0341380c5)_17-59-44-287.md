error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15055.java
text:
```scala
f@@lights.getFlight().configureBinding(flight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15055.java