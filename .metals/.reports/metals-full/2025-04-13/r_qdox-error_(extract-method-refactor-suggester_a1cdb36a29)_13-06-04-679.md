error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7994.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7994.java
text:
```scala
public static final S@@tring FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_ARGUMENTS = JavaCore.PLUGIN_ID + ".formatter.inset_space_between_empty_arguments";	//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7994.java