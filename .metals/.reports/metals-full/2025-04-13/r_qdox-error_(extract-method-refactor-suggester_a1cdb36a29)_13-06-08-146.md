error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2799.java
text:
```scala
r@@enderer = new MD5Renderer(model, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2799.java