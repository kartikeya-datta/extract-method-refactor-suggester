error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10842.java
text:
```scala
i@@f (!(0 <= index && index < itemCount)) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10842.java