error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13130.java
text:
```scala
t@@hread.start();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13130.java