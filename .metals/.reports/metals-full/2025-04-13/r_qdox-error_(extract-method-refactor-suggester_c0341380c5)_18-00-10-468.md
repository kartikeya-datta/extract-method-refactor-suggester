error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5655.java
text:
```scala
l@@ogger.error("failed to initial shutdown on service wrapper", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5655.java