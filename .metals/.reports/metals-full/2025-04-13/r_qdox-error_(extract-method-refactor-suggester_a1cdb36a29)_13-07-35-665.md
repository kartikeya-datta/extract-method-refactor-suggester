error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10072.java
text:
```scala
r@@eturn this.expressionType = lhsType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10072.java