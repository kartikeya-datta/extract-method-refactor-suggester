error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4941.java
text:
```scala
S@@tring resultData = new String(getResultBody(responseData)); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4941.java