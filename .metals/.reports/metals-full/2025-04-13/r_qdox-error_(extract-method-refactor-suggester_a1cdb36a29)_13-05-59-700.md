error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2877.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2877.java
text:
```scala
S@@tring signature = Util.typeSignature(type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2877.java