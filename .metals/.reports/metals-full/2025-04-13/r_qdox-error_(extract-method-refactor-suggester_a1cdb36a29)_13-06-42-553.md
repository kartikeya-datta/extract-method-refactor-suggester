error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7433.java
text:
```scala
t@@ypeName = typeName.substring(0, typeName.length() - 5); //TODO (jerome) should not hardcode extension length
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7433.java