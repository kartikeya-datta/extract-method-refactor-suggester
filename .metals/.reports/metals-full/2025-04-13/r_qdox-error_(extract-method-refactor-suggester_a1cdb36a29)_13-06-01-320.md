error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8129.java
text:
```scala
e@@ntryOffset += totalRead;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8129.java