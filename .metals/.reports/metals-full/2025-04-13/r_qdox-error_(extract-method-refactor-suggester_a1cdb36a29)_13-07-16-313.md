error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1378.java
text:
```scala
t@@ag.put("href", href.replaceAll("&", "&amp;"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1378.java