error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16696.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16696.java
text:
```scala
I@@nteger serviceRanking = (Integer) props.get(org.eclipse.ecf.remoteservice.Constants.SERVICE_RANKING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16696.java