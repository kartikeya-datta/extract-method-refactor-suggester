error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3489.java
text:
```scala
M@@essage response = msg.getInternalReply(ArrayUtils.EMPTY_BYTE_ARRAY, msg.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3489.java