error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6504.java
text:
```scala
i@@f (alignment == 0 || this.alignment == alignment) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6504.java