error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16497.java
text:
```scala
i@@f (takeFocus && (state & CANVAS) != 0) takeFocus = hooksKeys ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16497.java