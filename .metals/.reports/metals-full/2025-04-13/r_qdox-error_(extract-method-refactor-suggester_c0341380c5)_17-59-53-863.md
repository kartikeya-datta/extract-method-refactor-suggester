error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2626.java
text:
```scala
t@@emp.scl(getInterpolation().apply(Math.min(1, timer / 1f)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2626.java