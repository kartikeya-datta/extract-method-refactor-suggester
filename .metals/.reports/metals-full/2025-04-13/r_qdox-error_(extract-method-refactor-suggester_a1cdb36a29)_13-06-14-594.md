error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3206.java
text:
```scala
w@@idget.setForegroundColor (preeditLabel, control.getForegroundColor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3206.java