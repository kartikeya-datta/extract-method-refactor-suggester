error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/212.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/212.java
text:
```scala
F@@ield f = new org.apache.lucene.document.StoredField(field.getName(), buf, offset, len);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/212.java