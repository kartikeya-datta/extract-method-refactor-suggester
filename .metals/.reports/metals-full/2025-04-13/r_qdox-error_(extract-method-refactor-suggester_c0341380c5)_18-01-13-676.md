error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7164.java
text:
```scala
G@@eoDistance geoDistance = GeoDistance.DEFAULT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7164.java