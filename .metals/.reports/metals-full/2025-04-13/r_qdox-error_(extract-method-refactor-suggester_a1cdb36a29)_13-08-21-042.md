error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9059.java
text:
```scala
i@@f (hit == null && isModal && (!touchable || getTouchable() == Touchable.enabled)) return this;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9059.java