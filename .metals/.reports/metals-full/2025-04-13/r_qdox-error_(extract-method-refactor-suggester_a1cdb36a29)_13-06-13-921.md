error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5989.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5989.java
text:
```scala
public F@@ieldBinding getField(char[] fieldName, boolean needResolve) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5989.java