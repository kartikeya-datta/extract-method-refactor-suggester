error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10651.java
text:
```scala
j@@msManager.removeTopicFromJNDI(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10651.java