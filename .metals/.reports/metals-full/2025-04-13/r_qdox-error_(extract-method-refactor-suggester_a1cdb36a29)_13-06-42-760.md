error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/330.java
text:
```scala
c@@lusterStateRequest.nodes(metrics.contains("nodes") || metrics.contains("master_node"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/330.java