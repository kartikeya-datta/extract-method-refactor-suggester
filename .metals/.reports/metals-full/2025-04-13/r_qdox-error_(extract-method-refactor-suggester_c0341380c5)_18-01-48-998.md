error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7714.java
text:
```scala
h@@andles[count] = new AndroidFileHandle(assets, new File(file, path), type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7714.java