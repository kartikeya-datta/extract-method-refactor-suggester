error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7562.java
text:
```scala
r@@eturn new Well1024a(1001);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7562.java