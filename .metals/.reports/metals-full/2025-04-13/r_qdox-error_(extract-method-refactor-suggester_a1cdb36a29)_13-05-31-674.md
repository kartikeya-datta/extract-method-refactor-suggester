error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2575.java
text:
```scala
t@@emp.mul(getInterpolation().apply(Math.min(1, timer / 1f)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2575.java