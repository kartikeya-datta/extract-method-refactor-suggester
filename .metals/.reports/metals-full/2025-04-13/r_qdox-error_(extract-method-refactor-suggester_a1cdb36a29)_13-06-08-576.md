error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5425.java
text:
```scala
i@@f (force || Util.compare(oldScopeIds, newScopeIds) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5425.java