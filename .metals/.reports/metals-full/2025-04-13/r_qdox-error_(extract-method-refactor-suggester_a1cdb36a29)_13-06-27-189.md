error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1933.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1933.java
text:
```scala
S@@erverControllerModelUtil.initOperations(rootRegistration, null, persister, null, null, null, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1933.java