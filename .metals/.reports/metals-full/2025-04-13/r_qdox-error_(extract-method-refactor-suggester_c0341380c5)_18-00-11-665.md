error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9492.java
text:
```scala
b@@inding = environment().convertToRawType((ReferenceBinding) binding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9492.java