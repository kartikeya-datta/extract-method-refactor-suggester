error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5141.java
text:
```scala
d@@ata = FSTBytesAtomicFieldData.empty();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5141.java