error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8003.java
text:
```scala
o@@riginalModel = (IModel)Objects.cloneModel(model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8003.java