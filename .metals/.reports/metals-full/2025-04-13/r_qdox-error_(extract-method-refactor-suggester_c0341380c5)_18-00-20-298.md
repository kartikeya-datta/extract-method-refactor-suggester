error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3622.java
text:
```scala
S@@tring suffix = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3622.java