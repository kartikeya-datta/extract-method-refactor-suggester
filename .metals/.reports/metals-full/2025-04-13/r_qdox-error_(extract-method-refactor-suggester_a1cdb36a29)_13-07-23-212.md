error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13403.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13403.java
text:
```scala
final T@@ransactionScopedEntityManager result = new TransactionScopedEntityManager(scopedPuName, new HashMap<Object, Object>(), persistenceUnitService.getEntityManagerFactory(), context.synchronization());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13403.java