error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13821.java
text:
```scala
r@@eturn new CoarseSessionEntry<>(entry, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13821.java