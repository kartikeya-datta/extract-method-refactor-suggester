error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17745.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[83,80]

error in qdox parser
file content:
```java
offset: 1927
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17745.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17745.java