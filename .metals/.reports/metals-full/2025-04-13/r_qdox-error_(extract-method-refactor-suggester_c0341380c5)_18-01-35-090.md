error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13751.java
text:
```scala
S@@erviceName serviceName = DataSourceConfigService.SERVICE_NAME_BASE.append(jndiName).append("connection-properties").append(configPropertyName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13751.java