error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8875.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8875.java
text:
```scala
S@@tring url = this.urlFor(null, page, parameters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8875.java