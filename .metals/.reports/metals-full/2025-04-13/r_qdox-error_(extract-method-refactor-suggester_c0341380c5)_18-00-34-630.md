error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6516.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6516.java
text:
```scala
public H@@eaderItemList(IContactItemMap map) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6516.java