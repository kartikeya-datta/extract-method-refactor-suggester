error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5071.java
text:
```scala
t@@extures.put(textureFile.path(), texture);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5071.java