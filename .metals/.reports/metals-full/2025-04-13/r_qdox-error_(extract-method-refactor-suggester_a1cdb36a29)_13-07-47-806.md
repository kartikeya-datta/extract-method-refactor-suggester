error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9884.java
text:
```scala
u@@nitResult.record(problem, context); // TODO: clients are trapping problems either through factory or requestor... is result storing is needed?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9884.java