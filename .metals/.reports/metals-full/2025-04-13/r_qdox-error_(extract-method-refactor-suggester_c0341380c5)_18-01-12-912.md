error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7812.java
text:
```scala
a@@ssertExpression.resolveTypeExpecting(scope, TypeBinding.BOOLEAN);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7812.java