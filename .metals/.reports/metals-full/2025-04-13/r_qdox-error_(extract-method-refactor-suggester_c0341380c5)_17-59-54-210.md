error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8292.java
text:
```scala
c@@lonedElement.setProperty(iter.next().clone());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8292.java