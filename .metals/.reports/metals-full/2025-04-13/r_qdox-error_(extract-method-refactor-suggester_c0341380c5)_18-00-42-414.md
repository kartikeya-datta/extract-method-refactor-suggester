error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3250.java
text:
```scala
e@@nablePositionIncrements = settings.getAsBoolean("enabled_position_increments", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3250.java