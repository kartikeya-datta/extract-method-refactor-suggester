error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3336.java
text:
```scala
r@@eturn clusterState.routingTable().index(request.index()).randomAllShardsIt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3336.java