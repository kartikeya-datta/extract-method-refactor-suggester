error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2456.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2456.java
text:
```scala
final f@@loat anotherVal = other.value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2456.java