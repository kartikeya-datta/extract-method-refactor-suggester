error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7214.java
text:
```scala
I@@LabelDecorator decorator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7214.java