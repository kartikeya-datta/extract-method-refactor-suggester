error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16141.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16141.java
text:
```scala
public v@@oid testPossibleStaticImports_pr113066() { runTest("possible static imports bug");}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16141.java