error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1291.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1291.java
text:
```scala
private S@@tring hostControllerManagementAddress = System.getProperty("jboss.test.host.master.address", "localhost");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1291.java