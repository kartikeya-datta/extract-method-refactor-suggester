error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9112.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9112.java
text:
```scala
final R@@oleInfo roleInfo = new RoleInfo( role, name, type, null );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9112.java