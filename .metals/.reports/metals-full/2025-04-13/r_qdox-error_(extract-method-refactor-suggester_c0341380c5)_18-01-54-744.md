error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10254.java
text:
```scala
o@@ut = new FileOutputStream(destinationFile.getPath(), append); // JDK 1.2 compatibility
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10254.java