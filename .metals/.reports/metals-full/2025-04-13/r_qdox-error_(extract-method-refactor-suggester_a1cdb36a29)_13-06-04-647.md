error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1407.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1407.java
text:
```scala
public v@@oid renderHeaderSections(final HtmlHeaderContainer container);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1407.java