error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9359.java
text:
```scala
r@@equest.filteringAliases(), request.types());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9359.java