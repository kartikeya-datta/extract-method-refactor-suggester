error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1558.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1558.java
text:
```scala
public v@@oid checkLogicalOperationOk()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1558.java