error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6382.java
text:
```scala
I@@CompilationUnit original = (ICompilationUnit)this.getOriginalElement(); // TODO (jerome) shouldn't it use #getPrimary instead ?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6382.java