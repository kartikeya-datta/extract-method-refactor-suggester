error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8347.java
text:
```scala
e@@rror(component, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8347.java