error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3319.java
text:
```scala
t@@hrow new SearchSourceBuilderException("invalid CIDR mask [" + mask + "] in ip_range aggregation [" + getName() + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3319.java