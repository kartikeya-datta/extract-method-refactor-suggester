error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1898.java
text:
```scala
r@@esult.append(this.methodDeclaration.print(tab + 1, result));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1898.java