error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15051.java
text:
```scala
O@@S.SendEventToEventTarget(theEvent, OS.GetApplicationEventTarget());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15051.java