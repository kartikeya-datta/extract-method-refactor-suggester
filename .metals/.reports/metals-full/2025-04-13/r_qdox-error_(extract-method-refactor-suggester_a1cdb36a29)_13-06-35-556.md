error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3926.java
text:
```scala
n@@ew Pattern("configuration/jndiSubstitutionProperty"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3926.java