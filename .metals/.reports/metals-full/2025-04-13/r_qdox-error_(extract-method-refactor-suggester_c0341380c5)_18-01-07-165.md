error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3824.java
text:
```scala
S@@tring sizeStr = formatter.format(info.sizeInBytes(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3824.java