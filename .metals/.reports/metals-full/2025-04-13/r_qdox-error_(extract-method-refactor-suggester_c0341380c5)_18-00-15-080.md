error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9323.java
...
```java
offset: 35
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9323.java
text:
```scala
+"\n\tCould not sanitize URL: " + r@@edirectLocation + "\n\t", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9323.java