error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11767.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11767.java
text:
```scala
private static final A@@ttachmentKey<WarDeploymentMarker> ATTACHMENT_KEY = AttachmentKey.create(WarDeploymentMarker.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11767.java