error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1796.java
text:
```scala
i@@nt /*long*/ response = panel.runModal();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1796.java