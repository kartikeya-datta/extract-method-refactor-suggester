error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18181.java
text:
```scala
i@@f (type != null && type.getTypeCategory() == fType) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18181.java