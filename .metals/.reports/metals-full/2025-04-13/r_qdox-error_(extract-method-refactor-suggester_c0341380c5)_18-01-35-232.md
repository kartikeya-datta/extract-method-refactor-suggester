error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3776.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3776.java
text:
```scala
public v@@oid setLineSeparatorAndIdentationLevel(DefaultCodeFormatterOptions preferences) {
...
public class Scribe {
	...
	public void printEmptyLines(int linesNumber) {
		...
		addInsertEdit(this.scanner.getCurrentTokenEndPosition() + 1, buffer.toString());
	}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3776.java