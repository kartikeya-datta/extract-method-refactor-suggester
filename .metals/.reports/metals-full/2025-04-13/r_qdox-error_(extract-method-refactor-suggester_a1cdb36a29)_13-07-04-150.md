error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7719.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7719.java
text:
```scala
public static final O@@perationStepHandler INSTANCE = new UndefineAttributeHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7719.java