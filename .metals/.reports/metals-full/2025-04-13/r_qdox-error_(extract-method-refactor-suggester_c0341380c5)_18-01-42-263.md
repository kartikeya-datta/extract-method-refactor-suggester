error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/480.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/480.java
text:
```scala
final M@@ixedDomainTestSupport testSupport = MixedDomainTestSupport.create(testClass.getSimpleName(), version.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/480.java