error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4682.java
text:
```scala
r@@ec.key = st.getBase64();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4682.java