error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12161.java
text:
```scala
S@@ystem.arraycopy (items, 0, newItems, 0, itemsCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12161.java