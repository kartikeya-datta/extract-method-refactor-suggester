error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2328.java
text:
```scala
r@@eturn factory.asExpression(toValue(factory, model, q));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2328.java