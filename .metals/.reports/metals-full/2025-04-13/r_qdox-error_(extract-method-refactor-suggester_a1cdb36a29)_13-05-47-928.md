error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2637.java
text:
```scala
S@@treamRequestMessage srm = StreamRequestMessage.serializer().deserialize(new DataInputStream(bufIn), message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2637.java