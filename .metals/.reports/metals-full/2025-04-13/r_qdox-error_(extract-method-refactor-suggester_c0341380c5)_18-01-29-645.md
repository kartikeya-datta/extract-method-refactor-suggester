error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2263.java
text:
```scala
i@@f (concreteMatch != null && environment().methodVerifier().areMethodsCompatible(concreteMatch, compatibleMethod))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2263.java