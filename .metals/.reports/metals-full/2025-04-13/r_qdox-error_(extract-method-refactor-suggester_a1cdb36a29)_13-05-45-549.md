error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4845.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4845.java
text:
```scala
public abstract v@@oid onLinkClicked();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4845.java