error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1613.java
text:
```scala
r@@eturn isOpen() && name.equals(componentName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1613.java