error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8049.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8049.java
text:
```scala
c@@amera.position.set(0, 2, 3).nor().mul(10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8049.java