error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10051.java
text:
```scala
w@@orkbenchContextSupport = new WorkbenchContextSupport(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10051.java