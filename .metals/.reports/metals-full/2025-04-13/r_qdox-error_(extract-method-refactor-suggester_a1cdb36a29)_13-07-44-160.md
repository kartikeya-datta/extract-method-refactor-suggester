error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6523.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6523.java
text:
```scala
protected i@@nt compare(SortableListViewHeader header, Object o1, Object o2)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6523.java