error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13758.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13758.java
text:
```scala
/* private */ K@@ind(String name, int key) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13758.java