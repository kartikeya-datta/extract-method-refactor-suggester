error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10144.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10144.java
text:
```scala
private final P@@ushbackReader reader;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10144.java