error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9398.java
text:
```scala
i@@nput.length() > ctx.getLocation() + 2 &&
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9398.java