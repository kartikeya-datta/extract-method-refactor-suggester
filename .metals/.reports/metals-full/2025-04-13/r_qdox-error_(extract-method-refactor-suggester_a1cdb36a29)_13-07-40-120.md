error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/983.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/983.java
text:
```scala
static public v@@oid freeAll (Array objects) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/983.java