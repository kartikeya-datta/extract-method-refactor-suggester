error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10908.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10908.java
text:
```scala
public static final D@@omainRemoteFileRequestAndHandler INSTANCE = new DomainRemoteFileRequestAndHandler(MAPPER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10908.java