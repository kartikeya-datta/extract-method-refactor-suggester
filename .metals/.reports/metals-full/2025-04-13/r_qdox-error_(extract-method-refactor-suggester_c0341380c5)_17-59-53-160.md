error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1514.java
text:
```scala
L@@ist<LongEntry> ordered = new ArrayList<LongEntry>(map.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1514.java