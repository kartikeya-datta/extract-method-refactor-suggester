error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3184.java
text:
```scala
s@@uper.process();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3184.java