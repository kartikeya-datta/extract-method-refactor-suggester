error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17182.java
text:
```scala
i@@f (vKey == -1 && event.character != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17182.java