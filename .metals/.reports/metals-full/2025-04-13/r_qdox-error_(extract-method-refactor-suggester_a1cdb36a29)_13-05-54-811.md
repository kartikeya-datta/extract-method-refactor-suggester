error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4578.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4578.java
text:
```scala
private static final i@@nt RETRY_COUNT = JMeterUtils.getPropDefault("httpclient4.retrycount", 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4578.java