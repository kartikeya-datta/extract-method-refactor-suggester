error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18287.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18287.java
text:
```scala
public S@@essionSettings(final org.apache.wicket.Application application)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18287.java