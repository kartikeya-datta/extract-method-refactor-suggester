error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3471.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3471.java
text:
```scala
protected v@@oid checkResultComputed() throws IllegalStateException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3471.java