error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10398.java
text:
```scala
s@@uper(index, shardId, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10398.java