error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12158.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12158.java
text:
```scala
public R@@osterEntry(IRosterItem parent, IUser user, IPresence presenceState) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12158.java