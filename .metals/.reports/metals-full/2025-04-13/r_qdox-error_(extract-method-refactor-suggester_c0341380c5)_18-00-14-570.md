error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1113.java
text:
```scala
C@@lientPlugin.log("ECF group server created: "+cont.getConfig().getID().getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1113.java