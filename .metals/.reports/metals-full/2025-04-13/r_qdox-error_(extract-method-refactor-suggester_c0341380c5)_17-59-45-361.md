error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9231.java
text:
```scala
e@@nhancer.setInterfaces(new Class<?>[] {EnhancedConfiguration.class});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9231.java