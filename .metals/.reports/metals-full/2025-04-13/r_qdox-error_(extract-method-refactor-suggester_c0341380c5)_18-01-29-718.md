error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1889.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1889.java
text:
```scala
public static final S@@tring ACTION_NAME = "internal:cluster/nodes/indices/shard/store";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1889.java