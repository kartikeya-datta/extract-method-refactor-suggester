error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17581.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[124,80]

error in qdox parser
file content:
```java
offset: 4440
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17581.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17581.java