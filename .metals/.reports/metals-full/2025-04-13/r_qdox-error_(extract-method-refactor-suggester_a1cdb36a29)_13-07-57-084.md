error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7232.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7232.java
text:
```scala
final A@@tomicReferenceArray<ShardActionResult> shardsResponses = new AtomicReferenceArray<>(groups.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7232.java