error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2732.java
text:
```scala
b@@uilder.field(FilterFacet.TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2732.java