error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15586.java
text:
```scala
t@@emp.requestFocusInWindow();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15586.java