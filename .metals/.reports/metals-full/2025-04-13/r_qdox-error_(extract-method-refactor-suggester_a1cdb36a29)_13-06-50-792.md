error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11145.java
text:
```scala
g@@etMarkupSettings().getMarkupCache().shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11145.java