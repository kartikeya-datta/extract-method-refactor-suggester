error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2298.java
text:
```scala
r@@eturn containers.containsKey(graph);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2298.java