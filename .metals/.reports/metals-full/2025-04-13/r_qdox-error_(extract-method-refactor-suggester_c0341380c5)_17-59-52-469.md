error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/35.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/35.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/35.java
text:
```scala
r@@eturn "<SelectOnType:" + new String(token) + ">" ; //$NON-NLS-2$ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/35.java