error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7846.java
text:
```scala
l@@astException = new IOException("failed to obtain lock on " + dir.getAbsolutePath(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7846.java