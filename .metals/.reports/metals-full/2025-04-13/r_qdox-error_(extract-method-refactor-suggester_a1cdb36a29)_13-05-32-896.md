error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4660.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4660.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4660.java
text:
```scala
A@@ctionEvent.CTRL_MASK | ActionEvent.SHIFT_MASK));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4660.java