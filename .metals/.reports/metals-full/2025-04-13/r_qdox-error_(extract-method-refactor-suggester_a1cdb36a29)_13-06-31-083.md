error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3939.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3939.java
text:
```scala
public H@@elloWorldTest(final String name)

/*
 * $Id: HelloWorldTest.java 5395 2006-04-16 13:42:28 +0000 (Sun, 16 Apr 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3939.java