error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5287.java
text:
```scala
i@@f (!UIUtils.ctrl()) selected.clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5287.java