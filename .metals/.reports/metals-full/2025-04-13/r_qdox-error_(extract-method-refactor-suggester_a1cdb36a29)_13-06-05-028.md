error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9023.java
text:
```scala
d@@.setMinorVersion(1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9023.java