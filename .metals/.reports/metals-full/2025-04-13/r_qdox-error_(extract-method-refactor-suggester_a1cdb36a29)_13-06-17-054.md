error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/273.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/273.java
text:
```scala
r@@eturn Util.bind("operation.createTypeProgress"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/273.java