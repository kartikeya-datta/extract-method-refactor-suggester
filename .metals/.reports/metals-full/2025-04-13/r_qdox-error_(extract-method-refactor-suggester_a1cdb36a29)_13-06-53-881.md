error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10030.java
text:
```scala
i@@f ((this.bits & Binding.FIELD) != 0 && this.binding != null && this.binding.isValidBinding()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10030.java