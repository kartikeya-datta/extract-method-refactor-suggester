error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5684.java
text:
```scala
t@@hrow new IllegalArgumentException("Cannot add Object '" + object + "' - Predicate '" + predicate + "' rejected it");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5684.java