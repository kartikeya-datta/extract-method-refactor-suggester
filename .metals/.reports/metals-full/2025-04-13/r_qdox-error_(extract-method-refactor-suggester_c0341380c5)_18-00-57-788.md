error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3138.java
text:
```scala
s@@uper(PathElement.pathElement(ModelDescriptionConstants.AUTHENTICATION, ModelDescriptionConstants.USERS),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3138.java