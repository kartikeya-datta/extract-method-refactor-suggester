error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4625.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4625.java
text:
```scala
public C@@omponent getHeader(final String componentId)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4625.java