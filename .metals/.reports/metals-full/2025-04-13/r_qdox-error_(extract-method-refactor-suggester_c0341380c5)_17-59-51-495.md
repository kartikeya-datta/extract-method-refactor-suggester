error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3870.java
text:
```scala
c@@ompilationUnitDeclaration = CompilationUnitProblemFinder.process(unit, this, contents, parser, this.owner, perWorkingCopyInfo, problemFactory, false/*don't cleanup cu*/, pm);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3870.java