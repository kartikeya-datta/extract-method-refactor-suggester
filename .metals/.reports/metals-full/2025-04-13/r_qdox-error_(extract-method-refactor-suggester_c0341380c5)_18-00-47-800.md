error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2058.java
text:
```scala
t@@hrow new IllegalStateException(String.format("frame buffer couldn't be constructed: unknown error 0x%04x", result));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2058.java