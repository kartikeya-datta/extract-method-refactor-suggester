error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6419.java
text:
```scala
r@@olloutPlan.addValueConverter("content", ArgumentValueConverter.HEADERS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6419.java