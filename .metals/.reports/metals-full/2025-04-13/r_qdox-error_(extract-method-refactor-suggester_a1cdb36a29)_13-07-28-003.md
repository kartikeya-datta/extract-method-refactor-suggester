error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5066.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5066.java
text:
```scala
protected final v@@oid onBeforeRender()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5066.java