error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9926.java
text:
```scala
r@@ec.target = Name.fromString(nextString(st), origin);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9926.java