error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9861.java
text:
```scala
i@@f (binding.isVarargs()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9861.java