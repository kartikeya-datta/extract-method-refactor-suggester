error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15806.java
text:
```scala
r@@eturn new String(bytes, charset.name());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15806.java