error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2546.java
text:
```scala
i@@f ((wasACase || wasAStatement) && this.preferences.indent_switchstatements_compare_to_cases) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2546.java