error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3736.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3736.java
text:
```scala
private static final L@@ist<Integer> sequence = new ArrayList<Integer>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3736.java