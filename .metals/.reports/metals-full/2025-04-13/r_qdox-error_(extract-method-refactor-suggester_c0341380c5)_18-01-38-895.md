error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1922.java
text:
```scala
p@@kg = new String(parameterPackageNames[i]) + "."; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1922.java