error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6404.java
text:
```scala
i@@f (!this.scope.environment().globalOptions.storeAnnotations)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6404.java