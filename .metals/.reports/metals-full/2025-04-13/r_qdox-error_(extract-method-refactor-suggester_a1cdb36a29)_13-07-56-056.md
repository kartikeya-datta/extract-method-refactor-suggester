error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2036.java
text:
```scala
s@@etScreen(new MainMenuScreen(this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2036.java