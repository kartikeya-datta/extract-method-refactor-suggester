error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18209.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18209.java
text:
```scala
transient C@@hangeListener changeListener;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18209.java