error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6714.java
text:
```scala
E@@ditorAreaHelper.derefPart(toDeref);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6714.java