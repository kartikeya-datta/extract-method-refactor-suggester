error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9536.java
text:
```scala
l@@istener.onResponse(new SearchResponse(internalResponse, scrollId, expectedSuccessfulOps, successulOps.get(), buildTookInMillis(), buildShardFailures()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9536.java