error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17868.java
text:
```scala
i@@f ((control.state & CANVAS) != 0 && (control.style & SWT.EMBEDDED) != 0 && control.getShell () == this) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17868.java