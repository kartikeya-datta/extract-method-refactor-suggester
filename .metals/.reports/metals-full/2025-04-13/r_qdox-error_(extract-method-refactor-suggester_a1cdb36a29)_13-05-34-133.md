error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2994.java
text:
```scala
S@@treamIn.requestRanges(dst, tableName, Collections.singleton(cfstore), ranges, callback, OperationType.AES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2994.java