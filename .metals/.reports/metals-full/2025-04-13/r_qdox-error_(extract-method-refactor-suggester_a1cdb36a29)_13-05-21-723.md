error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1581.java
text:
```scala
a@@ssertEquals("Cell content should be Dear Lord!", "Dear Lord!", cell.getRichStringCellValue().getString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1581.java