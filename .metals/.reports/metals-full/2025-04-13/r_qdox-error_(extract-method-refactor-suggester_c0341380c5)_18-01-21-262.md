error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7727.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7727.java
text:
```scala
static final c@@har LTR_MARK = '\u200E', RTL_MARK = '\u200F';
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7727.java