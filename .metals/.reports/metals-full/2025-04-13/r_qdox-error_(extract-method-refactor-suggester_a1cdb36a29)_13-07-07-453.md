error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2525.java
text:
```scala
t@@arget.add(nextContainer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2525.java