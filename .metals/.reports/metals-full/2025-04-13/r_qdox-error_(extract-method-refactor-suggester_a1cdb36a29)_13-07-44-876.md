error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6834.java
text:
```scala
r@@eturn new FileResourceIterator(getProject(), getDir(getProject()),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6834.java