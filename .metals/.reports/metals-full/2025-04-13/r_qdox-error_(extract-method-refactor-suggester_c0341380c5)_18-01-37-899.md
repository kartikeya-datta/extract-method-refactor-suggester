error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7493.java
text:
```scala
i@@nfo.bounds = typeParameterInfo.bounds;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7493.java