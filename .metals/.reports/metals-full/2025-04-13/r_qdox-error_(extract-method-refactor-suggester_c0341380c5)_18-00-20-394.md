error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12200.java
text:
```scala
S@@erviceBuilder<SingleSignOnManagerFactory> build(ServiceTarget target, ServiceName name, ServiceName hostServiceName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12200.java