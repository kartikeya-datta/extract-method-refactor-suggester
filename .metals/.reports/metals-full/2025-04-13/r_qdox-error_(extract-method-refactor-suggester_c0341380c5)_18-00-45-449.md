error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4182.java
text:
```scala
p@@rintFixableError(declaration.getPosition(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4182.java