error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8675.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8675.java
text:
```scala
private b@@oolean pageIdUniquePerSession = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8675.java