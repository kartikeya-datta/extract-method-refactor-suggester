error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6767.java
text:
```scala
F@@olderCommandReference r = ((MailFrameMediator) getFrameMediator()).getTableSelection();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6767.java