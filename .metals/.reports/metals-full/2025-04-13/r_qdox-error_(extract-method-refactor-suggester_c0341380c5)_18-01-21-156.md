error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/134.java
text:
```scala
r@@eturn Long.valueOf(id).hashCode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/134.java