error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17540.java
text:
```scala
p@@arent.sendMouseEvent (SWT.MouseUp, button [0], display.clickCount, true, chord, (short)x, (short)y, modifiers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17540.java