error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14024.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14024.java
text:
```scala
private volatile S@@tring defaultResourceAdapterName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14024.java