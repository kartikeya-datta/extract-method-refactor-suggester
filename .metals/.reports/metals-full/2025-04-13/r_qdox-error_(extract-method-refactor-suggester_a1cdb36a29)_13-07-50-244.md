error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2094.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2094.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2094.java
text:
```scala
r@@eturn getCFMetaData(tableName, cfName).subcolumnComparator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2094.java