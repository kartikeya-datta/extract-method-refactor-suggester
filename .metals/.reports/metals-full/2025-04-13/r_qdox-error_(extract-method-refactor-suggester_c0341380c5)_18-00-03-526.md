error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5020.java
text:
```scala
S@@tring [] log_domains = {"GLib-GObject", "GLib", "GObject", "Pango", "ATK", "GdkPixbuf", "Gdk", "Gtk", "GnomeVFS", "GIO"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5020.java