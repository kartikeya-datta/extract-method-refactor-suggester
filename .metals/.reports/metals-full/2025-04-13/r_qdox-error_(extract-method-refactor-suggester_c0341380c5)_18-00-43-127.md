error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6641.java
text:
```scala
l@@ocalBinding.useFlag = flowInfo.isReachable() ? LocalVariableBinding.USED : LocalVariableBinding.FAKE_USED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6641.java