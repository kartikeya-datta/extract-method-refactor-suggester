error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18128.java
text:
```scala
n@@ull,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18128.java