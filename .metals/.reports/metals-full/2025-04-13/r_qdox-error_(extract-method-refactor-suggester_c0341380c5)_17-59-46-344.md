error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2802.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2802.java
text:
```scala
public i@@nt getNumberOfShards() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2802.java