error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9700.java
text:
```scala
S@@erviceName tmpDirPath = ServiceName.JBOSS.append("server", "path", "jboss.server.temp.dir");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9700.java