error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12788.java
text:
```scala
I@@AbstractChannelContainerAdapter {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12788.java