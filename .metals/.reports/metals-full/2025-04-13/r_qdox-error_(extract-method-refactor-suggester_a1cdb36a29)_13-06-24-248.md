error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11395.java
text:
```scala
r@@esourceRegistration.registerOperationHandler(RootResourceHack.DEFINITION, RootResourceHack.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11395.java