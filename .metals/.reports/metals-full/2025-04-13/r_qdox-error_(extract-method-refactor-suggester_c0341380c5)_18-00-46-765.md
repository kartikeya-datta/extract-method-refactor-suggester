error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8631.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8631.java
text:
```scala
n@@ew JoglApplication(new KeyframedModelViewer("data/boy.g3dt", argv.length==2?argv[1]:null), "KeframedModel Viewer", 320, 240, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8631.java