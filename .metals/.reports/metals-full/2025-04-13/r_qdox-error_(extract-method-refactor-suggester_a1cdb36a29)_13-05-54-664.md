error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8038.java
text:
```scala
A@@NNOTATION_PROPERTY_REPLACEMENT(EeSubsystemRootResource.ANNOTATION_PROPERTY_REPLACEMENT.getXmlName()),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8038.java