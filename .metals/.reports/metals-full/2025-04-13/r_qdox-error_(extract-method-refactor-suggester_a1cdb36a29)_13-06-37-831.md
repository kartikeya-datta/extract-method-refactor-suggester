error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11135.java
text:
```scala
i@@f (couldMatch(gen.getBcelObjectType(), munger.getTestPointcut())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11135.java