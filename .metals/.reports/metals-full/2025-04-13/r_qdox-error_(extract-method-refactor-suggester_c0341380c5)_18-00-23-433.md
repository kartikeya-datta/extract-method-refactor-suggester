error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/231.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/231.java
text:
```scala
static public final f@@loat PI2 = PI * 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/231.java