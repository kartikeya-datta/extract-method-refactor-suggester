error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3372.java
text:
```scala
C@@lass<?> getFieldType(String field);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3372.java