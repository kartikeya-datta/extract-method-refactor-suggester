error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14353.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14353.java
text:
```scala
private final i@@nt recordSize = DumpArchiveConstants.TP_SIZE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14353.java