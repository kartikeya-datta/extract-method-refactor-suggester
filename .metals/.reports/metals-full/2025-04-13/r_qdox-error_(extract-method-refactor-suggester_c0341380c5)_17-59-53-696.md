error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7444.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7444.java
text:
```scala
protected D@@escription(final String displayName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7444.java