error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/337.java
text:
```scala
h@@ud = new Stage(480, 320, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/337.java