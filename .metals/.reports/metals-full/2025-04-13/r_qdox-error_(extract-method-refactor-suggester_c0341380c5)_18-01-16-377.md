error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3579.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3579.java
text:
```scala
public v@@oid writeSetSpecialRegister(Section section, java.util.ArrayList sqlsttList) throws SqlException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3579.java