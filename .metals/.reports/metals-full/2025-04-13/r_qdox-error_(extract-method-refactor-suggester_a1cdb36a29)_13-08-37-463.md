error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8992.java
text:
```scala
E@@xplanation functionExplanation = filterFunction.function.explainScore(doc, subQueryExpl.getValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8992.java