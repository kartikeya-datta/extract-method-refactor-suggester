error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/531.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/531.java
text:
```scala
i@@d = deploymentUnit.getParent().getName() + "/" + id;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/531.java