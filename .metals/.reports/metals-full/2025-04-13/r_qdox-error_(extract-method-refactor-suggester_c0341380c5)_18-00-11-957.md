error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3318.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3318.java
text:
```scala
t@@hrow new SearchSourceBuilderException("at least one range must be defined for range aggregation [" + getName() + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3318.java