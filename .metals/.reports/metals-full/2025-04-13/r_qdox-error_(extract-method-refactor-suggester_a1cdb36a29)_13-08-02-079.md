error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6115.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6115.java
text:
```scala
public v@@oid moveTo(AbstractFolder newParent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6115.java