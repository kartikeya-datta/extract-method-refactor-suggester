error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5776.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5776.java
text:
```scala
final E@@ngine.Searcher searcher = indexShard.acquireSearcher("suggest");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5776.java