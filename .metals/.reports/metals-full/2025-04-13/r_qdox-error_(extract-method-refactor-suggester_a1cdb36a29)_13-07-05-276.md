error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15173.java
text:
```scala
s@@endResize ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15173.java