error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14293.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14293.java
text:
```scala
p@@arams.put("bootstrap-context", "default");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14293.java