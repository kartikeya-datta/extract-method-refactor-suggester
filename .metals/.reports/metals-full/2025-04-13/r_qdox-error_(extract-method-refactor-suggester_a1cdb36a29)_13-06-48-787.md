error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2629.java
text:
```scala
p@@ublic abstract interface IMarkup extends Iterable<MarkupElement>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2629.java