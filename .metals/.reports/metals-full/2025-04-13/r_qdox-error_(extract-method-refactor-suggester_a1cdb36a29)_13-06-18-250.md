error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1356.java
text:
```scala
r@@eturn getContext().registerService(clazzes, service, (Dictionary) props);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1356.java