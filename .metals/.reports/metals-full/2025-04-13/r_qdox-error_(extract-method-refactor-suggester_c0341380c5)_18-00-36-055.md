error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18047.java
text:
```scala
a@@ssertEquals("mount/point/?a=1&a=2&b=1", path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18047.java