error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13842.java
text:
```scala
I@@terator<String> iterator();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13842.java