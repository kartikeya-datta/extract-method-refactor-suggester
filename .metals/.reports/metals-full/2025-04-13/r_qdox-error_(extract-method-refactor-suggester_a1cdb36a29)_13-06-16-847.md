error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5647.java
text:
```scala
p@@arent = form.findParent(Form.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5647.java