error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16557.java
text:
```scala
i@@ds = Utils.getIds(file.getContents(), "encryption");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16557.java