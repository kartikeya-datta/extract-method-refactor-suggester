error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7741.java
text:
```scala
p@@resentation = factory.createStandaloneViewPresentation(parent, site, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7741.java