error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1809.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1809.java
text:
```scala
public static final S@@tring NAME = "indices:admin/shards/search_shards";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1809.java