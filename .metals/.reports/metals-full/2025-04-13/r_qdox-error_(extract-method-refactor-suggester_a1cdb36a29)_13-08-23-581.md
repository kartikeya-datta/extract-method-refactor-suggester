error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3576.java
text:
```scala
s@@tate |= HANDLE | THEME_BACKGROUND;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3576.java