error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3585.java
text:
```scala
a@@ssertEquals("NOWARN",readAttribute(baseAddress,"track-statements").asString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3585.java