error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5933.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5933.java
text:
```scala
protected A@@bstractSortedBagDecorator(final SortedBag<E> bag) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5933.java