error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5164.java
text:
```scala
s@@uper.setBackgroundImage (hImage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5164.java