error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1604.java
text:
```scala
r@@eturn obj != null && isAssignableFrom(c, obj.getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1604.java