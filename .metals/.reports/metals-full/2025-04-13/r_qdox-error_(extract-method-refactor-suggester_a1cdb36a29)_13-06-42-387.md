error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/750.java
text:
```scala
r@@eturn new GistListAdapter(avatars, getActivity()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/750.java