error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4726.java
text:
```scala
g@@etConfiguration().getRoot().addElement(filterListElement);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4726.java