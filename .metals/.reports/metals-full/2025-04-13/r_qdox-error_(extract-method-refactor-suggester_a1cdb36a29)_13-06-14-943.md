error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5293.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5293.java
text:
```scala
private static final S@@tring UNNAMED = ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5293.java