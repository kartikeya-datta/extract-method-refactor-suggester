error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5821.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(true, NAME), new SecurityRealmChildRemoveHandler(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5821.java