error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6918.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6918.java
text:
```scala
public M@@yLabel(MarkupContainer parent,final String id, final String value)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6918.java