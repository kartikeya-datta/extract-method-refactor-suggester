error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8103.java
text:
```scala
S@@haderMultitextureTest.class, ShadowMappingTest.class, PathTest.class, SimpleAnimationTest.class, SimpleDecalTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8103.java