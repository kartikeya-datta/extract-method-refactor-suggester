error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4037.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4037.java
text:
```scala
final J@@List list = new JList(GdxTests.getNames());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4037.java