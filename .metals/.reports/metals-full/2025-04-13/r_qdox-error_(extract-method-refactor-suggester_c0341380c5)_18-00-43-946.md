error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9382.java
text:
```scala
i@@f (!isSelected || drawSelection) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9382.java