error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4673.java
text:
```scala
s@@tats.stats.fieldData = indexShard.fieldDataStats(request.request.fieldDataFields());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4673.java