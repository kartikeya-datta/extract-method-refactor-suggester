error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/714.java
text:
```scala
C@@onfirmDialogFragment.show(this, REQUEST_CONFIRM_DELETE, "Confirm Delete",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/714.java