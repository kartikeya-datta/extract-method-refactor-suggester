error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6792.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6792.java
text:
```scala
public final v@@oid autoAdd(final Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6792.java