error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6825.java
...
```java
offset: 684
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6825.java
text:
```scala
...
p@@ackage org.springframework.expression;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6825.java