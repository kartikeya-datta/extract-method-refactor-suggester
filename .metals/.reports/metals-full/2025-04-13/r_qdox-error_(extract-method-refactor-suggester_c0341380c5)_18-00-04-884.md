error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2661.java
text:
```scala
a@@ddResources(scope, pattern, resources, new StringBuffer(relativePath.toString()).append(file.getName())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2661.java