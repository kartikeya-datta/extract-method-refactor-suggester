error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/374.java
text:
```scala
w@@hile (((token = parser.nextToken()) != XContentParser.Token.END_OBJECT && token != XContentParser.Token.END_ARRAY)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/374.java