error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4329.java
text:
```scala
p@@age.closeAllPerspectives();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4329.java