error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18200.java
text:
```scala
i@@nt len = java.lang.Math.min(val1.length(sel, ctx,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18200.java