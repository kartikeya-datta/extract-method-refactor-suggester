error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9549.java
text:
```scala
a@@ssertEquals(0, ex.getMessage(Locale.FRENCH).length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9549.java