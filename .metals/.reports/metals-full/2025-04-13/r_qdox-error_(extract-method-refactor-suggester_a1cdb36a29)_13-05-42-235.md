error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8438.java
text:
```scala
C@@lass< ? > containerClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8438.java