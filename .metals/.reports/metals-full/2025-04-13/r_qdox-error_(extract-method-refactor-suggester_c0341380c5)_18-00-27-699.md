error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5714.java
text:
```scala
S@@ignatureWrapper wrapper = new SignatureWrapper(methodSignature, use15specifics);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5714.java