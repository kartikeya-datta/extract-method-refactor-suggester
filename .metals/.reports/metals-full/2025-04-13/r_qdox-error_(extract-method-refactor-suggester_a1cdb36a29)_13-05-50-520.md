error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5865.java
text:
```scala
i@@f (! authenValves.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5865.java