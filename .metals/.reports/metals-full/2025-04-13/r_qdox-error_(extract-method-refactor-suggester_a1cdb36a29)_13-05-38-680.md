error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2638.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2638.java
text:
```scala
public static i@@nt MaxProblemPerUnit = 100;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2638.java