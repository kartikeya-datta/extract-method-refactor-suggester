error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2649.java
text:
```scala
F@@ileSystemUtils.deleteRecursively(dataDirToClean.toArray(new File[0]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2649.java