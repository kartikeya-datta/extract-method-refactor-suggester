error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2110.java
...
```java
offset: 13
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2110.java
text:
```scala
/*package*/ R@@ectangle getParentBounds() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2110.java