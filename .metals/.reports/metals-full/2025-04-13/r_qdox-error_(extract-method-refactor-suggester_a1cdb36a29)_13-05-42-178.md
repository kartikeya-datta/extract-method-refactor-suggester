error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2625.java
text:
```scala
R@@eadResponse result = ReadResponse.serializer().deserialize(new DataInputStream(bufIn), message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2625.java