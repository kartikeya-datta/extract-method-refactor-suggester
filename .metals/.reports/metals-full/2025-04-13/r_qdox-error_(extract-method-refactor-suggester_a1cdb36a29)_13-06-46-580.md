error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6743.java
text:
```scala
A@@rrays.<MessageConverter>asList(new MappingJackson2MessageConverter()), new DefaultContentTypeResolver());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6743.java