error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13168.java
text:
```scala
L@@ogger.getLogger("org.jboss.web.WebParsingDeploymentProcessor").info("parse: " + (System.currentTimeMillis() - time) + "ms");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13168.java