error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12383.java
text:
```scala
s@@etBorder(BorderFactory.createTitledBorder(JMeterUtils.getResString("sample_scope"))); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12383.java