error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14602.java
text:
```scala
r@@eturn new BufferingClientHttpRequestWrapper(request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14602.java