error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13208.java
...
```java
offset: 1062
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13208.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.cli.operation;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13208.java