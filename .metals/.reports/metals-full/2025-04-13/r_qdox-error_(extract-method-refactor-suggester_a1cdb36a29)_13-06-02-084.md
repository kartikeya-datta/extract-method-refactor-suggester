error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8720.java
text:
```scala
d@@iffuse = new Texture(Gdx.files.internal("data/qbob/World_blobbie_blocks.png"), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8720.java