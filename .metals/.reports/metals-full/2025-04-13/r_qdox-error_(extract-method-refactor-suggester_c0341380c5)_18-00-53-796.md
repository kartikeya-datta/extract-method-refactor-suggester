error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6605.java
text:
```scala
i@@f ((style &SWT.CHECK) == 0) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6605.java