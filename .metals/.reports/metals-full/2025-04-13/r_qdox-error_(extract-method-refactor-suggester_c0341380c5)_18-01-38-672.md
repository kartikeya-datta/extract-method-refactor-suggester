error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2875.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2875.java
text:
```scala
private final L@@ockableComponent lockableComponent;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2875.java