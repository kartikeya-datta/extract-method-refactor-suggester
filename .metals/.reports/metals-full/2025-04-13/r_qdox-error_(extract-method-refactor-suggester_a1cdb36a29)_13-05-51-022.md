error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18163.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18163.java
text:
```scala
i@@nvert = (style & SWT.UP) != 0 || (style & SWT.LEFT) != 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18163.java