error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8673.java
text:
```scala
p@@arseSystemProperties(reader, address, list);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8673.java