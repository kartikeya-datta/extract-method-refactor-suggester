error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2956.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2956.java
text:
```scala
final C@@ompilerOptions options = aType.scope.compilerOptions();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2956.java