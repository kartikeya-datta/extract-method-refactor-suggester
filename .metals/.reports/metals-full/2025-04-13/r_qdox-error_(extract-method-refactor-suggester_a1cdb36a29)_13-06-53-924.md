error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1883.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.STRUCTURE, Phase.STRUCTURE_EAR, new EarStructureProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1883.java