error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3941.java
text:
```scala
o@@rg.eclipse.jdt.internal.compiler.util.SimpleSet interfacesSeen = new org.eclipse.jdt.internal.compiler.util.SimpleSet(itsInterfaces.length * 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3941.java