error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2891.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2891.java
text:
```scala
!i@@sDBCPLoaded(getClassLoader())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2891.java