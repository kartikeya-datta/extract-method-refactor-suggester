error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17128.java
text:
```scala
i@@f ((subtype == StoreException.LOCK || subtype == StoreException.QUERY) && errorCode < 30000) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17128.java