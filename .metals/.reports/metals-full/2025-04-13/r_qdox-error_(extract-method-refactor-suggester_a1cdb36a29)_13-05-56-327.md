error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14469.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14469.java
text:
```scala
final S@@erviceController<?> controller = context.getServiceRegistry().getService(DeploymentScannerService.getServiceName(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14469.java