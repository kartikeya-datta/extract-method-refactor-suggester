error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6365.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6365.java
text:
```scala
public static final S@@tring URI_ENCODING = "UTF-8";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6365.java