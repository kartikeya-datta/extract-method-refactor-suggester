error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17485.java
text:
```scala
F@@ileUtils.copyFile( f, d, executionFilters );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17485.java