error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6577.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6577.java
text:
```scala
public v@@oid acceptMethodTypeParameter(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector, int selectorStart, int selcetorEnd, char[] typeParameterName, boolean isDeclaration, int start, int end) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6577.java