error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2571.java
text:
```scala
t@@his.resolvedType = scope.environment().createParameterizedType(classType, new TypeBinding[]{ boxedType }, null/*not a member*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2571.java