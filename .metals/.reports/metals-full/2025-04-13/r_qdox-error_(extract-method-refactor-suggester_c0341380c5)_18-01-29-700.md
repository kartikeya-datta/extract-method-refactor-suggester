error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1992.java
text:
```scala
s@@uper(tokens, positions, true, AccDefault);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1992.java