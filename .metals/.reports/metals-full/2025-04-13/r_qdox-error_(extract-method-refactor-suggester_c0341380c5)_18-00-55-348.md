error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4134.java
text:
```scala
p@@ublic interface BaseMultivariateSimpleBoundsOptimizer<FUNC extends MultivariateFunction>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4134.java