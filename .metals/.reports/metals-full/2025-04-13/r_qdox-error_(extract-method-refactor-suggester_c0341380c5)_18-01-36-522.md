error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/317.java
text:
```scala
r@@eturn IntConstant.fromValue(field.original().id + 1); // (ordinal value + 1) zero should not be returned see bug 141810
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/317.java