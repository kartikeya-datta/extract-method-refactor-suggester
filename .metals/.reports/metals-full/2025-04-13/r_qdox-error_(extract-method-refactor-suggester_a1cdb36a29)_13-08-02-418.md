error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13908.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13908.java
text:
```scala
public L@@ist<PathAddressTransformer> getPathTransformation(final PathAddress address) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13908.java