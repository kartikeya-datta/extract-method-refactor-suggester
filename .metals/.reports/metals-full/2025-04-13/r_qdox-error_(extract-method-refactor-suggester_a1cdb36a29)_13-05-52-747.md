error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3236.java
text:
```scala
b@@locks.addIndexBlock(request.index, MetaDataIndexStateService.INDEX_CLOSED_BLOCK);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3236.java