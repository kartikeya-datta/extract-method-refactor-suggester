error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1859.java
text:
```scala
M@@ap<K, V> removed = this.invoker.invoke(this.cache, operation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1859.java