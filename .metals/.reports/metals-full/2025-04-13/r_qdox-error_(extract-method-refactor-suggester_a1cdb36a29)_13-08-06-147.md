error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8223.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8223.java
text:
```scala
public S@@erviceName readObject(ObjectInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8223.java