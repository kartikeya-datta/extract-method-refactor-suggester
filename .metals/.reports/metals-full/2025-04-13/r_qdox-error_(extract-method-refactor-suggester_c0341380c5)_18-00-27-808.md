error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1458.java
text:
```scala
c@@learIndicesCacheRequest.filterCache(request.paramAsBoolean("filter_cache", clearIndicesCacheRequest.filterCache()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1458.java