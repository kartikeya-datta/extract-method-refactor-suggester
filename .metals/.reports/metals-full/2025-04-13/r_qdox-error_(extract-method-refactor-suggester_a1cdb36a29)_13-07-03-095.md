error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/395.java
text:
```scala
r@@eturn new FileUpdateTask(item, target, backup, modification);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/395.java