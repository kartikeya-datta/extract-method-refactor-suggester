error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6207.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6207.java
text:
```scala
public static S@@tring version = "04-23-2003 cvs";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6207.java