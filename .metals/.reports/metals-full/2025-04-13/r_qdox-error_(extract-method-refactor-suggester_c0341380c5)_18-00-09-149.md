error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9160.java
text:
```scala
J@@avaHelpSupport.enableHelp(wizard, HelpManager.getInstance()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9160.java