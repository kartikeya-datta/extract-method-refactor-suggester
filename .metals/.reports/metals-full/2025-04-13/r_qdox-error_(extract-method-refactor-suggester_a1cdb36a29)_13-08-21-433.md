error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6973.java
text:
```scala
P@@roxyActivityManager.this,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6973.java