error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3827.java
text:
```scala
T@@extButtonTest.class, TextButtonTestGL2.class, TextureBindTest.class, SortedSpriteTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3827.java