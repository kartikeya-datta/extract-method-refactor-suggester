error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/185.java
text:
```scala
r@@eturn Constant.fromValue(field.original().id); // ordinal value
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/185.java