error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9082.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9082.java
text:
```scala
L@@RESULT WM_MOUSELEAVE (int /*long*/ wParam, int /*long*/ lParam) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9082.java