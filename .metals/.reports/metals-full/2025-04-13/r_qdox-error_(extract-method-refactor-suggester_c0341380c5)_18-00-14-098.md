error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6112.java
text:
```scala
t@@his.service.setSessionCookieNeeded(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6112.java