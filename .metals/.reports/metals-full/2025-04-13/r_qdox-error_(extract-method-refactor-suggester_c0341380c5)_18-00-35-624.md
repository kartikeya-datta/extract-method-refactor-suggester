error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13617.java
text:
```scala
F@@uture<?> future = fooService.asyncFoo(1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13617.java