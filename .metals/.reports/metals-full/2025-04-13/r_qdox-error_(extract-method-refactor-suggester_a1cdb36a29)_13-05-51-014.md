error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/369.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/369.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/369.java
text:
```scala
final I@@ResourceStream resource = resourceSettings.getResourceStreamFactory().newResourceStream(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/369.java