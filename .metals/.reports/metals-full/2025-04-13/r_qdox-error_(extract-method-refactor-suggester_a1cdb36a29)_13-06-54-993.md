error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8130.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8130.java
text:
```scala
public i@@nt depth = 16, stencil = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8130.java