error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7793.java
text:
```scala
v@@oid decorateResponse(AbstractResource.ResourceResponse response);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7793.java