error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/730.java
text:
```scala
l@@ongPressFired = listener.longPress(pointer1.x, pointer1.y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/730.java