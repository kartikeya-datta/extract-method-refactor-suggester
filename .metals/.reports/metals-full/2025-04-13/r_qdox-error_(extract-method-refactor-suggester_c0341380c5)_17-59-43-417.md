error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10180.java
text:
```scala
p@@ublic class BooleanConverter extends AbstractConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10180.java