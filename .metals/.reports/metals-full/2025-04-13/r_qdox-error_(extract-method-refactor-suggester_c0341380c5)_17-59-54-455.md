error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1764.java
text:
```scala
t@@his.enablePositionIncrements = settings.getAsBoolean("enable_position_increments", version.onOrAfter(Version.LUCENE_30));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1764.java