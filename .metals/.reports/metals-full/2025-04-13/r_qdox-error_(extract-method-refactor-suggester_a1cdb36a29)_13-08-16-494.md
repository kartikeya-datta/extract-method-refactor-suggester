error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4320.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4320.java
text:
```scala
public W@@eldJBossAllConfiguration(Boolean requireBeanDescriptor, Boolean nonPortableMode) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4320.java