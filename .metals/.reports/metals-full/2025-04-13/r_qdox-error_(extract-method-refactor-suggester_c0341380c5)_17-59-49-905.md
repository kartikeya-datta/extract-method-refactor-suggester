error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2490.java
text:
```scala
t@@hrow new IllegalStateException("field \"" + term.field() + "\" was indexed without position data; cannot run SpanTermQuery (term=" + term.text() + ")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2490.java