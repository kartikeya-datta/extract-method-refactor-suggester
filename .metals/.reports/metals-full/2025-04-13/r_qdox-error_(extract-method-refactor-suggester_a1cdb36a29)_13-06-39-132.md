error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5141.java
text:
```scala
r@@eturn this.indexSelector.getIndexLocations();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5141.java