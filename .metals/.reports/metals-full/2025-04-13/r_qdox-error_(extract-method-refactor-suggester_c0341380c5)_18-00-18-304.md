error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16843.java
text:
```scala
l@@oop.setLoops(LoopController.INFINITE_LOOP_COUNT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16843.java