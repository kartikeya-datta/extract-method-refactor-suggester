error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8490.java
text:
```scala
f@@older.setBackground(colors, new int [] {100}, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8490.java