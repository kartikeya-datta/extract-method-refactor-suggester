error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6250.java
text:
```scala
t@@hrow MESSAGES.failedToCreate(e, "queue");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6250.java