error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9622.java
text:
```scala
H@@TTPAcceptorAdd.INSTANCE.launchServices(context, hornetqServerName, acceptorName, model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9622.java