error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11207.java
text:
```scala
p@@ublic class ExternalLinkPage extends WicketExamplePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11207.java