error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10129.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[200,2]

error in qdox parser
file content:
```java
offset: 7196
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10129.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10129.java