error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10192.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10192.java
text:
```scala
", \"" + e@@vent + "\", function(event) { " + javascript + ";});");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10192.java