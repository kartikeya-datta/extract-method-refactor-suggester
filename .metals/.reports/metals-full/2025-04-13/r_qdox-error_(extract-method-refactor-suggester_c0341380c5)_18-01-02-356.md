error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6189.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6189.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6189.java
text:
```scala
P@@rogressManager.getInstance().shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6189.java