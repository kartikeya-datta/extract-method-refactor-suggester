error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3881.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3881.java
text:
```scala
public v@@oid testVerifyNonExistantUser() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3881.java