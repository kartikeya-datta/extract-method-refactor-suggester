error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1884.java
text:
```scala
S@@tring key = endpoint.getHostAddress();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1884.java