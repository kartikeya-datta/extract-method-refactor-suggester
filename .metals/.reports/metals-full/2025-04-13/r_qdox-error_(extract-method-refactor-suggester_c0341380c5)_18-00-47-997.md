error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2157.java
text:
```scala
s@@egmentInfos, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2157.java