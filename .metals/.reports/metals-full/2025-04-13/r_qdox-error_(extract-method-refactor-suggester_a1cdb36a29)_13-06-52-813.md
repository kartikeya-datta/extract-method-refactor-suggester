error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6785.java
text:
```scala
r@@eturn this.expressionType = enclosingTb.superclass;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6785.java