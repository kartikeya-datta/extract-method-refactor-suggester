error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11045.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11045.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11045.java
text:
```scala
l@@ong total = p_model.getCount();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11045.java