error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4605.java
text:
```scala
c@@odeStream.writeWidePosition(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4605.java