error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3135.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3135.java
text:
```scala
public static b@@oolean launch (String fileName, String workingDirectory) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3135.java