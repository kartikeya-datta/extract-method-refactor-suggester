error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15027.java
text:
```scala
i@@f (o != null && this.marshaller.supports(o.getClass())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15027.java