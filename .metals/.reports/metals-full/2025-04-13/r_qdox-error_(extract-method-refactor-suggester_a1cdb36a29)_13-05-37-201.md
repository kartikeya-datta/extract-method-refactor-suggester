error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2542.java
text:
```scala
s@@etMunger(myMunger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2542.java