error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/999.java
...
```java
offset: 791
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/999.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/999.java