error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1425.java
text:
```scala
f@@or (KSMetaData ksm : DatabaseDescriptor.tables.values())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1425.java