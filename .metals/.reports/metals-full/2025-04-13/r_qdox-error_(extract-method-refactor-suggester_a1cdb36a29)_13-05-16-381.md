error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7022.java
text:
```scala
i@@f (paramMatch.arguments == null || length > paramMatch.arguments.length) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7022.java