error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15540.java
text:
```scala
r@@eturn Math.min(getOf(), getFrom() + table.getRowsPerPage()-1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15540.java