error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2370.java
text:
```scala
i@@f ("script_values_sorted".equals(currentFieldName) || "scriptValuesSorted".equals(currentFieldName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2370.java