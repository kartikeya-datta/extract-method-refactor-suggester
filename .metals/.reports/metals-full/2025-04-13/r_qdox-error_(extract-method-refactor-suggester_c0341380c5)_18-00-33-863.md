error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7835.java
text:
```scala
r@@eturn getBufferAddress(buffer) + buffer.position();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7835.java