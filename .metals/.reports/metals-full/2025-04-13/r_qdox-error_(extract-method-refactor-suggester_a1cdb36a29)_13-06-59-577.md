error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6175.java
text:
```scala
p@@ublic abstract class WizardButton extends Button<String>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6175.java