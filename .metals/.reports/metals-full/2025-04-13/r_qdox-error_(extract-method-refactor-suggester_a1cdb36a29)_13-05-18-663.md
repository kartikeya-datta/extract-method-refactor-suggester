error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2541.java
text:
```scala
r@@eturn item.get(columns[column]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2541.java