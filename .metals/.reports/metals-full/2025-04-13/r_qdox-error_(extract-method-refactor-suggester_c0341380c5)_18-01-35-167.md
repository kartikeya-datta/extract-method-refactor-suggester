error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/193.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/193.java
text:
```scala
public S@@tring androidMinSdkVersion = "5";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/193.java