error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18199.java
text:
```scala
i@@f (fetch != null && fetch.getIsolationLevel() != -1)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18199.java