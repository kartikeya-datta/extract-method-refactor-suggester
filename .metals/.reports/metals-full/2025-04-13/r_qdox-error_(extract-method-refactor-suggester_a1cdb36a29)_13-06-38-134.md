error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7073.java
text:
```scala
r@@eturn AuthenticatedWebSession.get().getRoles().hasAnyRole(roles);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7073.java