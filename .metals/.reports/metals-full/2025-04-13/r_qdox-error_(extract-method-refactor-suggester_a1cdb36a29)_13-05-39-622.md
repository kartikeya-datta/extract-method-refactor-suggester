error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13316.java
text:
```scala
l@@ocalContextName = fieldInfo.declaringClass().name().toString() + "/" + fieldName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13316.java