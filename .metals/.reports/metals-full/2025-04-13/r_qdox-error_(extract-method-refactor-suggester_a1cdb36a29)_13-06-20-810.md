error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5738.java
text:
```scala
L@@ist<Object> subList = new ArrayList(objects.subList(start, end));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5738.java