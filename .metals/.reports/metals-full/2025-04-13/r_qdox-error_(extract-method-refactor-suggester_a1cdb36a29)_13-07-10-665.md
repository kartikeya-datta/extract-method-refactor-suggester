error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4199.java
text:
```scala
a@@ssertEquals(expected.toUpperCase(), new String(actual));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4199.java