error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14461.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14461.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14461.java
text:
```scala
c@@onfiguration.addViewInterceptor(new ImmediateInterceptorFactory(new SingletonComponentInstanceAssociationInterceptor()), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14461.java