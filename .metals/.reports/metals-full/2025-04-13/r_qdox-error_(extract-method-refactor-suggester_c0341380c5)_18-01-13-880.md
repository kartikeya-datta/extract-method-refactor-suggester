error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6007.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6007.java
text:
```scala
final S@@tring style = container.getStyle() + "_" + container.getVariation();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6007.java