error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1031.java
text:
```scala
L@@ogLevel.log( getContext(), m_level, m_message );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1031.java