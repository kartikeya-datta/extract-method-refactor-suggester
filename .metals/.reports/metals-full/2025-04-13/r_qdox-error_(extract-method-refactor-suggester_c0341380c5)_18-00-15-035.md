error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/984.java
text:
```scala
r@@eturn "OldBuilderType(" + fOldTSEntry.getType().getName() + ")"; //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/984.java