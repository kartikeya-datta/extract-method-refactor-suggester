error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6401.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6401.java
text:
```scala
.@@put(settings)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6401.java