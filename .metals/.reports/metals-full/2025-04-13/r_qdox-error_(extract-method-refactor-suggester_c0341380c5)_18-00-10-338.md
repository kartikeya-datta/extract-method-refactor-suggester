error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8062.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8062.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8062.java
text:
```scala
private final C@@MNode fChild;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8062.java