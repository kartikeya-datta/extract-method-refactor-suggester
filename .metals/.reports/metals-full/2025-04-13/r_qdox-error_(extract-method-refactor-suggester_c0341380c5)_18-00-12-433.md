error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3197.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3197.java
text:
```scala
i@@f (count != 0 && !printClient) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3197.java