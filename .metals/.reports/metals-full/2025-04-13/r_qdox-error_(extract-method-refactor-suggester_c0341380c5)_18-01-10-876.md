error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5414.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5414.java
text:
```scala
public static final P@@attern VALID_AGG_NAME = Pattern.compile("[a-zA-Z0-9\\-_]+");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5414.java