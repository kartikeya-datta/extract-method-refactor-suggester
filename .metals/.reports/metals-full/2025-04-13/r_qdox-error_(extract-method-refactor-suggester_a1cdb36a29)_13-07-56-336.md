error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2635.java
text:
```scala
S@@erviceName raServiceName = ConnectorServices.getResourceAdapterServiceName(deploymentName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2635.java