error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8704.java
text:
```scala
r@@eturn "MethodReferencePattern: "; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8704.java