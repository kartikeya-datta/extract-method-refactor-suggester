error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10812.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10812.java
text:
```scala
final i@@nt pageId = parameters.get("pageId").toInt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10812.java