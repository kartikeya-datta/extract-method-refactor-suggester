error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/266.java
text:
```scala
C@@ategory cat = Category._default.getInstance(categoryName,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/266.java