error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1792.java
text:
```scala
S@@tring file = "/" + couchDb + "/_changes?feed=continuous&include_docs=true&heartbeat=10000";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1792.java