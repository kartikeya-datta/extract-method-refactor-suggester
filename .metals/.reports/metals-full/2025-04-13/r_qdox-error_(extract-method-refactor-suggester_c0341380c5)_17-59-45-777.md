error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3939.java
text:
```scala
i@@f (areVerticesClockwise(vertices, 0, vertices.length)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3939.java