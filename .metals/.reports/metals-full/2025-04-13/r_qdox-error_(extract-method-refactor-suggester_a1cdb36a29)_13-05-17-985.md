error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6408.java
text:
```scala
J@@ob job = new Job(Messages.Activator_AnalyzingProgress) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6408.java