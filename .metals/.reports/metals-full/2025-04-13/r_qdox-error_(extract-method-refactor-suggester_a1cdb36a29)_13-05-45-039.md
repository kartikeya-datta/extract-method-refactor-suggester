error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13942.java
text:
```scala
r@@eturn pageClass.newInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13942.java