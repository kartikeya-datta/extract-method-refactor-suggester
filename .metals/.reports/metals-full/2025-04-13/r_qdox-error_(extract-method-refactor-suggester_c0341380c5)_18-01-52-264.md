error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9363.java
text:
```scala
t@@his(new DefaultCodeFormatterOptions(DefaultCodeFormatterConstants.getJavaConventionsSetttings()), JavaCore.getDefaultOptions(), 0, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9363.java