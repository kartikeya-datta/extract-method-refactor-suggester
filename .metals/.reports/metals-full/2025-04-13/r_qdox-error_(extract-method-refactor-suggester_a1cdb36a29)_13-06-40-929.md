error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7327.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7327.java
text:
```scala
r@@eferences[0] = new FolderCommandReference(folder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7327.java