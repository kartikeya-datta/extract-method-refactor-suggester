error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9812.java
text:
```scala
m@@ultiGetRequest.realtime(request.paramAsBoolean("realtime", null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9812.java