error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14353.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14353.java
text:
```scala
protected I@@ResourceStream getResourceStream()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14353.java