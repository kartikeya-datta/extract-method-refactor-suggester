error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1551.java
text:
```scala
d@@irectory.sizeInBytes.getAndAdd(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1551.java