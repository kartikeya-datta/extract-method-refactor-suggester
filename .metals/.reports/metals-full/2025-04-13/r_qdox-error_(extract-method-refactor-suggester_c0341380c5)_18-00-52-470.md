error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/83.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/83.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/83.java
text:
```scala
I@@ndexFieldData build(Index index, @IndexSettings Settings indexSettings, FieldMapper.Names fieldNames, FieldDataType type, IndexFieldDataCache cache);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/83.java