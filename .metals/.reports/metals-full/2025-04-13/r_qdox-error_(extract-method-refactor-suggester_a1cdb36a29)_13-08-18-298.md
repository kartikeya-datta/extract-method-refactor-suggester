error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7158.java
text:
```scala
c@@lient.setSimple("user1", "password1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7158.java