error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4133.java
text:
```scala
i@@f (descriptor == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4133.java