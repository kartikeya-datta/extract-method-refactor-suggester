error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2069.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2069.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2069.java
text:
```scala
G@@L20 gl = Gdx.graphics.getGL20();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2069.java