error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14433.java
text:
```scala
w@@ar.addAsWebInfResource(MappedNameInjectionTestCase.class.getPackage(), "/web.xml","/web.xml");
...
public class MappedNameInjectionTestCase {
    ...
    public static WebArchive createSecondDeployment() {
        ...
        war.addAsWebInfResource("injection/mappedname/web.xml");
        war.toString(true);
        return war;
    }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14433.java