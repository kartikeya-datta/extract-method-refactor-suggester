error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9913.java
text:
```scala
i@@nt avail = base64.available();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9913.java