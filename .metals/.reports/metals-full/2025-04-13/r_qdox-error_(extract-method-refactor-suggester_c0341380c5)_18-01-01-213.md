error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2065.java
text:
```scala
r@@eturn areaHeight;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2065.java