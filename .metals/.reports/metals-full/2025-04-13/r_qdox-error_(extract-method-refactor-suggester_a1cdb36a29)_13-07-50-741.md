error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5245.java
text:
```scala
j@@i.addImplicitAction(new PrintMeImplicitAction());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5245.java