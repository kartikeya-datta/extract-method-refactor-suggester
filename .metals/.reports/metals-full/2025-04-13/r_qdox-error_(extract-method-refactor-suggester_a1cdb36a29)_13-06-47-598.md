error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4694.java
...
```java
offset: 907
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4694.java
text:
```scala
...
p@@ackage org.elasticsearch.gateway.local.state.meta;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4694.java