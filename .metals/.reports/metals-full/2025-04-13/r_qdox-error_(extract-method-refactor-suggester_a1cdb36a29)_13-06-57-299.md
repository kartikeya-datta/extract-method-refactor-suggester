error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7996.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7996.java
text:
```scala
public v@@oid feedIndexRequestor(IIndexSearchRequestor requestor, int[] references, IndexInput input, IJavaSearchScope scope) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7996.java