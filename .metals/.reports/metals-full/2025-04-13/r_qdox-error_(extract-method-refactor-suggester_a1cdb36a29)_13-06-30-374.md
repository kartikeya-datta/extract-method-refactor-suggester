error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1502.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1502.java
text:
```scala
S@@ystem.out.println("INDEX ("+ Thread.currentThread()+"): " + zip.getName()); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1502.java