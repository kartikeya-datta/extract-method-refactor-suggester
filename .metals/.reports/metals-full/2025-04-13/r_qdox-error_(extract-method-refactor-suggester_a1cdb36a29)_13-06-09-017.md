error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14592.java
text:
```scala
e@@xtras = e.getExtraFields(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14592.java