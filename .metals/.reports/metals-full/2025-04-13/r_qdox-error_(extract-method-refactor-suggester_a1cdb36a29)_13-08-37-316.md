error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8359.java
text:
```scala
S@@hadowMunger cm = myMunger.concretize(ResolvedType.MISSING, world, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8359.java