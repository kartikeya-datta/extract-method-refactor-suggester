error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3442.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3442.java
text:
```scala
public static final S@@pecifiedInterfaceRemoveHandler INSTANCE = new SpecifiedInterfaceRemoveHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3442.java