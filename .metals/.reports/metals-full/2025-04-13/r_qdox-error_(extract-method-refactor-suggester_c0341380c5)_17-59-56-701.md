error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13183.java
text:
```scala
e@@mf = createEntityManagerFactory("cache-mode-disable", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13183.java