error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11686.java
text:
```scala
p@@ublic class AjaxPage2 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11686.java