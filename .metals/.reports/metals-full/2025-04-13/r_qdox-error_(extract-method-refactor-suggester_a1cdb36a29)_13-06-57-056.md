error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5458.java
text:
```scala
T@@opChildrenQuery childQuery = new TopChildrenQuery(searchContext, query, childType, parentType, scoreType, factor, incrementalFactor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5458.java