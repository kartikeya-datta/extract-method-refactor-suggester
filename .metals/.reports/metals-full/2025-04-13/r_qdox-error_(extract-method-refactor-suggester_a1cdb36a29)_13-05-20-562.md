error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9806.java
text:
```scala
l@@og("The command attribute is deprecated.\n"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9806.java