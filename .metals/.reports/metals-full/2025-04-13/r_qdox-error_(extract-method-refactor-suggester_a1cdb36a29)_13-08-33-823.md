error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5017.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5017.java
text:
```scala
public static final S@@coreDoc[] EMPTY_SCORE_DOCS = new ScoreDoc[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5017.java