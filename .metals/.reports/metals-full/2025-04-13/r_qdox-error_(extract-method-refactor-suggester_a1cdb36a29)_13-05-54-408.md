error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4329.java
text:
```scala
i@@f (System.getenv("ANDROID_HOME") != null && !params.containsKey("sdkLocation")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4329.java