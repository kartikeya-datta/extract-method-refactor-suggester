error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4006.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4006.java
text:
```scala
protected I@@SynchAsynchConnection makeConnection(ID remoteSpace,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4006.java