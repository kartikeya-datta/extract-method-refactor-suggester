error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9061.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9061.java
text:
```scala
public static final S@@tring PROCESS_STATE = "server-state";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9061.java