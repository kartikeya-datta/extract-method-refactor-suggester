error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8626.java
text:
```scala
i@@f (parent != null && parent.sortColumn == this) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8626.java