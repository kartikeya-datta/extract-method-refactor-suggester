error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6077.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6077.java
text:
```scala
public static S@@tring[] reparentablePlatforms = new String[] {"win32", "gtk", "carbon"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6077.java