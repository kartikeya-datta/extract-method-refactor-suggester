error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1470.java
text:
```scala
t@@his.lookupEnvironment.problemReporter,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1470.java