error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8785.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8785.java
text:
```scala
public F@@ieldDataType getType() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8785.java