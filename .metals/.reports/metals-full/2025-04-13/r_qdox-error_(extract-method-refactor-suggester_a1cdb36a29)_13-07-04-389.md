error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2474.java
text:
```scala
k@@eyValues = keyIndexFieldData.load(context).getBytesValues();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2474.java