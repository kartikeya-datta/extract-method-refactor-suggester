error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/121.java
text:
```scala
i@@f (visualPressedTime > TimeUtils.nanoTime() && Gdx.graphics.isContinuousRendering()) return true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/121.java