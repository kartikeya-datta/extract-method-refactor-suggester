error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3821.java
text:
```scala
i@@f (isCacheable())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3821.java