error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7326.java
text:
```scala
r@@eturn convert(expression.anonymousType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7326.java