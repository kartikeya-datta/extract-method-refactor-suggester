error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6023.java
text:
```scala
r@@eturn getFlag(FLAG_RENDER_BODY_ONLY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6023.java