error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10721.java
text:
```scala
i@@f (arguments != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10721.java