error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1999.java
text:
```scala
D@@erby - Class org.apache.derbyTesting.junit.XATestUtil
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1999.java