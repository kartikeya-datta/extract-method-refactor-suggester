error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2108.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2108.java
text:
```scala
static i@@nt /*long*/ modTime;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2108.java