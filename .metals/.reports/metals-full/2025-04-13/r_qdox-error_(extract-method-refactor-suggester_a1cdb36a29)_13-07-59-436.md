error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8466.java
text:
```scala
t@@hrow new BuildException( "Error starting modern compiler", ex );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8466.java