error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6099.java
text:
```scala
i@@f (OS.SendMessage (hwndHeader, OS.HDM_ORDERTOINDEX, phdn.iItem, 0) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6099.java