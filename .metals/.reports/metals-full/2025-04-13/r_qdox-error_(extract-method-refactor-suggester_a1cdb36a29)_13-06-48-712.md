error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/639.java
...
```java
offset: 878
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/639.java
text:
```scala
...
p@@ackage org.elasticsearch.index.query.json;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/639.java