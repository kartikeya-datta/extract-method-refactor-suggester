error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6605.java
text:
```scala
f@@loat width = font.getBounds(text).width;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6605.java