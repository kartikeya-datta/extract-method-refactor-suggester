error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13697.java
text:
```scala
p@@ointcut pc(): execution(new(..)) && !within(A);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13697.java