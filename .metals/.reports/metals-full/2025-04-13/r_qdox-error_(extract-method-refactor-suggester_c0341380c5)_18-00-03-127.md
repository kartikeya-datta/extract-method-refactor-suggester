error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4341.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4341.java
text:
```scala
r@@eturn (clazz.isPrimitive() && clazz != void.class? primitiveTypeToWrapperMap.get(clazz) : clazz);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4341.java