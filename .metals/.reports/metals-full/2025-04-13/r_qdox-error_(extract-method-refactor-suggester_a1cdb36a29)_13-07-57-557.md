error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8629.java
text:
```scala
c@@ommand.add("-Dorg.jboss.boot.log.file=logs/" + serverConfig.getServerName() + "/boot.log");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8629.java