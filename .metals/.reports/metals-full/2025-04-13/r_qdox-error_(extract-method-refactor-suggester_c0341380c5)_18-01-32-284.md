error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/433.java
text:
```scala
r@@eturn formComponent.getId() + "." + Classes.simpleName(validator.getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/433.java