error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2564.java
text:
```scala
S@@tring rawColumName = CliUtils.unescapeSQLString(statement.getChild(1).getText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2564.java