error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/690.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[70,2]

error in qdox parser
file content:
```java
offset: 2182
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/690.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/690.java