error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13006.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13006.java
text:
```scala
public C@@lass<? extends Page> getPageClass()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13006.java