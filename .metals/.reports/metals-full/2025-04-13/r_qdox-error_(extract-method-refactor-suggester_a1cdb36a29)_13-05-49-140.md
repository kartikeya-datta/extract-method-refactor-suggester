error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13630.java
text:
```scala
M@@ap<?, ?> toMap(String key, Object value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13630.java