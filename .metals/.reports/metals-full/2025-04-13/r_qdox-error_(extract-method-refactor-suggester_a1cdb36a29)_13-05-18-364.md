error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6332.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6332.java
text:
```scala
final S@@tring jndiName = model.get(JNDINAME.getName()).asString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6332.java