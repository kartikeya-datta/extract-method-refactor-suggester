error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10026.java
text:
```scala
r@@eturn new InternalSearchResponse(InternalSearchHits.empty(), null, null, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10026.java