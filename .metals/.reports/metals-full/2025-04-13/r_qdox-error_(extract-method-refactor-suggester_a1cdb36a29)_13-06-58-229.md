error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11542.java
text:
```scala
r@@eturn TypeDescriptor.NULL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11542.java