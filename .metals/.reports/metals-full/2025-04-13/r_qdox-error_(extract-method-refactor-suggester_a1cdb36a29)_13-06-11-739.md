error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9108.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9108.java
text:
```scala
i@@f ("win32".equals (platform) || "wpf".equals (platform)) { //$NON-NLS-1$ $NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9108.java