error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17673.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[93,2]

error in qdox parser
file content:
```java
offset: 2588
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17673.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17673.java