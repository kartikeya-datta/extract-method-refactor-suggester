error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6152.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6152.java
text:
```scala
public static final S@@tring version = "1.0 RC1-test2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6152.java