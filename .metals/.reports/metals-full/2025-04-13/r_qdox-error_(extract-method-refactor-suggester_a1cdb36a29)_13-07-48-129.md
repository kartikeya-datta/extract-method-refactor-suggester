error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3730.java
text:
```scala
t@@hrow MathRuntimeException.createIllegalArgumentException("no data");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3730.java