error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10671.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10671.java
text:
```scala
N@@SRect rect = window.contentView().frame();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10671.java