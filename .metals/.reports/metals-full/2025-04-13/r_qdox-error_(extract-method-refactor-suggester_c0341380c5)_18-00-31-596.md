error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/881.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/881.java
text:
```scala
p@@arent.setScrollBarVisible (this, visible);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/881.java