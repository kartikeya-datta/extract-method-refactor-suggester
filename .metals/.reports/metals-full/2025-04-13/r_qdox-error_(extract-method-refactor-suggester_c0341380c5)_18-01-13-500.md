error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15242.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15242.java
text:
```scala
private final S@@tring element;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15242.java