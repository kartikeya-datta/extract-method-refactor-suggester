error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10090.java
text:
```scala
i@@f (!(getFileUtils().areSame(sourceFile, destFile) || destFile.delete())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10090.java