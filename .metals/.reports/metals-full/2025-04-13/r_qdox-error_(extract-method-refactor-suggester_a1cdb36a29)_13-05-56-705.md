error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13962.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13962.java
text:
```scala
J@@DBCStoreManager.class, JDBCFetchPlanImpl.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13962.java