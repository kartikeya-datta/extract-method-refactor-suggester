error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13439.java
text:
```scala
r@@eturn (this == user ? true : super.equals(user)) && (realm == null ? user.realm == null : realm.equals(user.realm));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13439.java