error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/796.java
text:
```scala
m@@arkupLabel.setEscapeModelStrings(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/796.java