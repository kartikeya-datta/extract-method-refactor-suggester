error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3545.java
text:
```scala
a@@ddComboBox = new DefaultAddressComboBox(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3545.java