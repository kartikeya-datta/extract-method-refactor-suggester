error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12841.java
text:
```scala
r@@eturn container.getAdapter(clazz);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12841.java