error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/855.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/855.java
text:
```scala
final l@@ong t = TimeUtils.nanoTime();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/855.java