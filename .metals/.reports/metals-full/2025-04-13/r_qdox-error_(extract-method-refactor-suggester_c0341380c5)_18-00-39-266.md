error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8084.java
text:
```scala
w@@hile (--index > 0 && string.charAt (index) != '.') {/* empty */}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8084.java