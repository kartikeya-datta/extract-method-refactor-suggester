error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9190.java
text:
```scala
t@@hrow new IllegalArgumentException("Argument beanModel must not be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9190.java