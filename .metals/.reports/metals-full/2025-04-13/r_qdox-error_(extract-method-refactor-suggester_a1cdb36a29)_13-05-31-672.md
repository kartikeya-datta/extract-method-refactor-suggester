error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/406.java
text:
```scala
p@@roblemReporter().superinterfaceMustBeAnInterface(sourceType, superInterfaceRef, superInterface);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/406.java