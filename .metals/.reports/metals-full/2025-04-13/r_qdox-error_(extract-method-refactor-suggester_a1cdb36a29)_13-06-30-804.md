error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6011.java
text:
```scala
p@@age.closeAllPerspectives(true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6011.java