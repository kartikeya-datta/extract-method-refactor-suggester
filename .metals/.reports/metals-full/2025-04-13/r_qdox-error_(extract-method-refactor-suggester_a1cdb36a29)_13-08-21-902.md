error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7569.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7569.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7569.java
text:
```scala
a@@ddTest(18, 18, 270.0f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7569.java