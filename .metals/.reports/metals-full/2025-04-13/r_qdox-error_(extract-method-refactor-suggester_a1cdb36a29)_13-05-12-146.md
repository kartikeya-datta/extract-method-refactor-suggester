error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1997.java
text:
```scala
t@@his.reuseAddress = componentSettings.getAsBoolean("reuse_address", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1997.java