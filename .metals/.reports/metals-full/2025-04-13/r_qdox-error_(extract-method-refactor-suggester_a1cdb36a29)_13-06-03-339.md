error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17025.java
text:
```scala
t@@oCheck = new StringBuffer(response.getResponseHeaders()).append(new String(response.responseDataAsBA())).toString();
   ...
   public static class Test extends junit.framework.TestCase
   {
      ...
      class TestThread extends Thread
      {
         static final String TEST_STRING = "DAbale arroz a la zorra el abad.";
           // Used to be 'dÃ¡bale', but caused trouble on Gump. Reasons unknown.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17025.java