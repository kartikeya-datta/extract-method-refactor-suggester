error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13648.java
text:
```scala
r@@eturn Messages.getString("dialog.addElement.title"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13648.java