error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2189.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2189.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2189.java
text:
```scala
c@@olumns [0].getX (), 0,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2189.java