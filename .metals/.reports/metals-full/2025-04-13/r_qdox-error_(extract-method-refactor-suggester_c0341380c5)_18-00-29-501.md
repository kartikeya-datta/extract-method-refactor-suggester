error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/871.java
text:
```scala
S@@treamOut.transferRanges(srm.target_, srm.table_, srm.ranges_, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/871.java