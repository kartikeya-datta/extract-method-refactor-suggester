error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1969.java
text:
```scala
l@@istener.error(assetDesc, t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1969.java