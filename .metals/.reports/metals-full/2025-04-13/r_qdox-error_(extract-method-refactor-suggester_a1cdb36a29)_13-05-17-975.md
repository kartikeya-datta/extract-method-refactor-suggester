error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2188.java
text:
```scala
t@@hrow new ContainerConnectException(NLS.bind(Messages.IRCRootContainer_Exception_Connect_Failed, connectID.getName()), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2188.java