error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17987.java
text:
```scala
i@@nt index = component.getBehaviorsRawList().indexOf(behaviour);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17987.java