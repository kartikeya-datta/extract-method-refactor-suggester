error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1898.java
text:
```scala
a@@dd(new DataGridView("rows", columns, new SortableContactDataProvider()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1898.java