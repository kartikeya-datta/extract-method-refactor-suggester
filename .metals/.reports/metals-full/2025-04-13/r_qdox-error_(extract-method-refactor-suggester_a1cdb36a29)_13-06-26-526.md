error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8299.java
text:
```scala
p@@ublic class ContactModelPartial extends BasicModelPartial implements
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8299.java