error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16603.java
text:
```scala
p@@arent.header.redraw (getX () + padding, 0, width - padding, parent.getHeaderHeight (), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16603.java