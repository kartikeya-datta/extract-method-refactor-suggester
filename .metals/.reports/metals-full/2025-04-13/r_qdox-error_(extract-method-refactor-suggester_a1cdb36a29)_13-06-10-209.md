error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12863.java
text:
```scala
H@@W.new(String s) { this(); }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12863.java