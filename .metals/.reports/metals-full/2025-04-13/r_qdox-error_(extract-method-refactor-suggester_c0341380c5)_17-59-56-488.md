error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10675.java
text:
```scala
i@@f(subModel.has(attrName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10675.java