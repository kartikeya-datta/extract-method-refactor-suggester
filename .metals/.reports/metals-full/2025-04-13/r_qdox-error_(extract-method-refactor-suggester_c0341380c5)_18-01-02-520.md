error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6457.java
text:
```scala
r@@eturn "BrokerAvailabilityEvent=" + this.brokerAvailable;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6457.java