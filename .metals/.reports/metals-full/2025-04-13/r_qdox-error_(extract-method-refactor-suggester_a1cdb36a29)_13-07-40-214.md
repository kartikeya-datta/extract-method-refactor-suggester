error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10023.java
text:
```scala
a@@ssertThat(routingNode.size(), equalTo(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10023.java