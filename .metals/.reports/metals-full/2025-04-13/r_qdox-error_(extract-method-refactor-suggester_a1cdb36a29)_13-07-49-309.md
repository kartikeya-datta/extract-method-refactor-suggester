error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11341.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11341.java
text:
```scala
public final O@@bject getObject(Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11341.java