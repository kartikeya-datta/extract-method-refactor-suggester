error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4595.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4595.java
text:
```scala
private b@@oolean mailboxSyncEnabled = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4595.java