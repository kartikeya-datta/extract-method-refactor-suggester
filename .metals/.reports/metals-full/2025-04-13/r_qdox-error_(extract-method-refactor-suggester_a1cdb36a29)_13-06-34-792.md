error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7059.java
text:
```scala
M@@ap.Entry<K, V>[] array = entrySet.toArray(new Map.Entry[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7059.java