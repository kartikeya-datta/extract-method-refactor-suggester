error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18106.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18106.java
text:
```scala
n@@ew PageParameters().set("param1",1).set("param2", "test")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18106.java