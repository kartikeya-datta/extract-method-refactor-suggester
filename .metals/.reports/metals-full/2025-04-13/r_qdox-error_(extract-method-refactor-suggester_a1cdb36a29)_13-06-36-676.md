error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4029.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4029.java
text:
```scala
I@@Type typeHandle = sourceType.getHandle();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4029.java