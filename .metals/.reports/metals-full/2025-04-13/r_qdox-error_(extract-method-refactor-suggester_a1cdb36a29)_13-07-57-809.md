error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2790.java
text:
```scala
h@@tmlTable.add(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2790.java