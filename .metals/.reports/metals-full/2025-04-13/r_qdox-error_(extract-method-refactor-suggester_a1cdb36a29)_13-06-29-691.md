error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5134.java
text:
```scala
C@@lassLoader loader = (ClassLoader) cloneConstructor.newInstance(getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5134.java