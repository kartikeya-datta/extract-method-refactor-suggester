error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8717.java
text:
```scala
M@@etaDataService.CreateIndexResult createIndexResult = metaDataService.createIndex(request.index(), request.settings(), request.mappings(), request.timeout());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8717.java