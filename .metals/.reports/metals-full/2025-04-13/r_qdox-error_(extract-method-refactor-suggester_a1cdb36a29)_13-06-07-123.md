error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2514.java
text:
```scala
t@@arget.add(label);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2514.java