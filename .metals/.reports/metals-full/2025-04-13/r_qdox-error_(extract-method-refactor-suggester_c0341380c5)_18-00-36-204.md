error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8287.java
text:
```scala
S@@treamOutput streamOutput = cachedEntry.bytes(CompressorFactory.defaultCompressor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8287.java