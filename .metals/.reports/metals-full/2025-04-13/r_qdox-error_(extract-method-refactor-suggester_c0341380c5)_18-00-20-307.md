error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4636.java
text:
```scala
w@@izard.pack();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4636.java