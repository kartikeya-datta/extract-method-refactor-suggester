error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/262.java
text:
```scala
p@@ublic static class KeyPosition implements Comparable<KeyPosition>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/262.java