error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7752.java
text:
```scala
M@@ethod exportO = unicastClass.getMethod("toStub",  new Class [] { Remote.class });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7752.java