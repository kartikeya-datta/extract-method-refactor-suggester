error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11274.java
text:
```scala
t@@his.tag.setServletRelativeAction(action);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11274.java