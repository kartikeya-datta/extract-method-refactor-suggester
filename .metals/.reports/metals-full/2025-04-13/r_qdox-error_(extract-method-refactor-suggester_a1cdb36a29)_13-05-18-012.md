error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7857.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7857.java
text:
```scala
i@@f (sourceFolder.getFullPath().equals(this.outputFolder.getFullPath())){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7857.java