error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8957.java
text:
```scala
B@@indingAddHandler.installBindingService(context, model, name, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8957.java