error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8431.java
text:
```scala
S@@tring driverName = deploymentUnit.getName() + "_" + driverClassName + "_" + majorVersion +"_" + minorVersion;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8431.java