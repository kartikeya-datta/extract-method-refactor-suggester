error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8208.java
text:
```scala
t@@mp = new File(this.homeDir, "standalone");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8208.java