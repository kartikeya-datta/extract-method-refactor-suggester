error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13765.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13765.java
text:
```scala
d@@oTestResolution( propRef, propRef, m_context );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13765.java