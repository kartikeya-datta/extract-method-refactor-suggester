error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6703.java
text:
```scala
b@@uilder.field("index", shardFailure.index(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6703.java