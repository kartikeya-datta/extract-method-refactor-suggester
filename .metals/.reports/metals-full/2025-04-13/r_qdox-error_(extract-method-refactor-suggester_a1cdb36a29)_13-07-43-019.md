error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1275.java
text:
```scala
d@@nsNSRecord(dnsName _name, short _dclass, int _ttl, MyStringTokenizer st)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1275.java