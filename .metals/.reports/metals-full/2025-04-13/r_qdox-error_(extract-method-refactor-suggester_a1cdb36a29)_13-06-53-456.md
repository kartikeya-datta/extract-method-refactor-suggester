error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3210.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3210.java
text:
```scala
r@@eturn org.eclipse.jdt.internal.core.util.Util.bind("operation.copyElementProgress"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3210.java