error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11283.java
text:
```scala
C@@omponent getHeader(String componentId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11283.java