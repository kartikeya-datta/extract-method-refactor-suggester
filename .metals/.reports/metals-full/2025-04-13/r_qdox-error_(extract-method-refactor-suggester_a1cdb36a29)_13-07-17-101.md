error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7799.java
text:
```scala
t@@hrow new NullPointerException(Messages.BaseChannelConfig_ID_Not_Null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7799.java