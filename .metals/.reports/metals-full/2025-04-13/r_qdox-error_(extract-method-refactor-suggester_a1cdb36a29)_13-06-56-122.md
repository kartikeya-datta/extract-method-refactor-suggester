error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3618.java
text:
```scala
n@@ew CharacterRunAutomaton(new RegExp("[A-Za-zªµºÀ-ÖØ-öø-ˁ]+").toAutomaton());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3618.java