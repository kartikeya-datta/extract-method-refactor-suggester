error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7918.java
text:
```scala
F@@ile indexFile = new File(new File(new File(new File(nodeEnv.nodeDataLocation(), "indices"), shardId.index().name()), Integer.toString(shardId.id())), "index");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7918.java