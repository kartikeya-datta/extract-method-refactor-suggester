error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1420.java
text:
```scala
G@@etResult getResult = indexShard.getService().get(type, id, fields, request.realtime(), version, versionType, fetchSourceContext, request.ignoreErrorsOnGeneratedFields());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1420.java