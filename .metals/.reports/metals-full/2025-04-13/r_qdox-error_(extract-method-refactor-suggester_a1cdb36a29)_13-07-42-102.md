error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8130.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8130.java
text:
```scala
public static final S@@tring COMMAND_ID = IWorkbenchCommandConstants.NAVIGATE_COLLAPSE_ALL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8130.java