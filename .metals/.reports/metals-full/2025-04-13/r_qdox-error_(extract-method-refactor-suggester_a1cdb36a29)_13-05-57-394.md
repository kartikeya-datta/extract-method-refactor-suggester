error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5958.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5958.java
text:
```scala
public D@@ualHashBidiMapTest(final String testName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5958.java