error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11059.java
text:
```scala
n@@ew Status(IStatus.OK, getDefault().getBundle()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11059.java