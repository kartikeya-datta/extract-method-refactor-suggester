error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7609.java
...
```java
offset: 1142
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7609.java
text:
```scala
...
p@@ackage org.jboss.as.connector.subsystems.resourceadapters;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7609.java