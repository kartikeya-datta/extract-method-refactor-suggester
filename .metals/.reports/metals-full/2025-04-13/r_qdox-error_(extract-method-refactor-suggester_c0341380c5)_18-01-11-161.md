error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8467.java
text:
```scala
G@@dx.gl.glClear(GL10.GL_COLOR_BUFFER_BIT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8467.java