error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4301.java
text:
```scala
l@@ong count = indexShard.count(request.minScore(), request.querySource(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4301.java