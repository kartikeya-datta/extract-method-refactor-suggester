error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6579.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6579.java
text:
```scala
-D@@ouble.MAX_VALUE, Double.MAX_VALUE,locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6579.java