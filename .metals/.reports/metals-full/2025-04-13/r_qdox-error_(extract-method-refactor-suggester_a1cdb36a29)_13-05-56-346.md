error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8450.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8450.java
text:
```scala
s@@cope.problemReporter().forbiddenReference(type, this, restriction.getMessageTemplate(), restriction.getProblemId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8450.java