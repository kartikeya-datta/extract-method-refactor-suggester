error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/364.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/364.java
text:
```scala
 S@@WT.RESIZE | SWT.MAX | SWT.MODELESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/364.java