error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/504.java
text:
```scala
e@@ffectiveEncoding = defaultEncoding == null ? "UTF-8" : defaultEncoding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/504.java