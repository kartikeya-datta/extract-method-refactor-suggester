error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6276.java
text:
```scala
n@@ew AntScriptGenerator().generate(new BuildConfig("stbtruetype"), win32home, win32, win64, lin32, lin64, mac);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6276.java