error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5364.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5364.java
text:
```scala
r@@eturn wizard.getContainerConfigurationResult();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5364.java