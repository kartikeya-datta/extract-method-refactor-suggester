error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4681.java
text:
```scala
C@@ompilationResult compilationResult = new CompilationResult(topLevelType.getParent().getElementName().toCharArray(), 1, 1, this.compilerOptions.maxProblemsPerUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4681.java