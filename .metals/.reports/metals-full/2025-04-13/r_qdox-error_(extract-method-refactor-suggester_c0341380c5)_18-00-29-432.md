error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3147.java
text:
```scala
o@@ut.writeBytesReference(content);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3147.java