error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6501.java
text:
```scala
i@@f (pointer == 0 && button == getButton() && isOver(event.getListenerActor(), x, y)) clicked(event, x, y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6501.java