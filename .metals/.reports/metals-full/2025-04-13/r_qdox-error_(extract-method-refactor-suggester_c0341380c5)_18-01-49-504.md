error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5086.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5086.java
text:
```scala
e@@ffect.load(Gdx.files.internal("data/test.p"), Gdx.files.internal("data"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5086.java