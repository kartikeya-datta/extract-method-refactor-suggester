error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2475.java
...
```java
offset: 84
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2475.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2475.java