error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3917.java
text:
```scala
P@@ercolatorExecutor.Response percolate = percolatorService.percolate(new PercolatorExecutor.SourceRequest(request.type(), request.underlyingSource(), request.underlyingSourceOffset(), request.underlyingSourceLength()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3917.java