error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10608.java
text:
```scala
r@@eturn FunctorUtils.<T>copy(iPredicates);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10608.java