error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5725.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5725.java
text:
```scala
final R@@esourceRoot resourceRoot = new ResourceRoot(deploymentRoot, mountHandle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5725.java