error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9043.java
text:
```scala
I@@ndex index = this.manager.getIndex(this.containerPath, true, /*reuse index file*/ false /*create if none*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9043.java