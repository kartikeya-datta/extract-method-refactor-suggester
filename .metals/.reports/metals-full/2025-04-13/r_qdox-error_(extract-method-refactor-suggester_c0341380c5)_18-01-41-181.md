error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8563.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8563.java
text:
```scala
protected T@@rieUtils() {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8563.java