error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12268.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12268.java
text:
```scala
public v@@oid setVariables(Map<String, String> vars);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12268.java