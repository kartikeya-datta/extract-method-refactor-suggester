error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/933.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/933.java
text:
```scala
r@@eturn new CFMetaData(ksName, cfName, ColumnFamilyType.Standard, comp, null).defaultValidator(comp);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/933.java