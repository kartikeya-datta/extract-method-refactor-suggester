error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/528.java
text:
```scala
i@@f (_nullIfFirstParamIsNull && params.size() > 0 && params.get(0) == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/528.java