error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5613.java
text:
```scala
S@@tring resolveUrlPath(String resourcePath, List<? extends Resource> locations, ResourceResolverChain chain);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5613.java