error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9810.java
text:
```scala
g@@etRequest.realtime(request.paramAsBoolean("realtime", null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9810.java