error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/857.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/857.java
text:
```scala
w@@orkbenchPage.showView(IIntroConstants.INTRO_VIEW_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/857.java