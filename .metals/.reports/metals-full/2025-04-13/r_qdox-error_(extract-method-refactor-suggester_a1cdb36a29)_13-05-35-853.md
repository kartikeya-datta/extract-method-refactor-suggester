error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8855.java
text:
```scala
S@@electionEngine engine = new SelectionEngine(environment, requestor, project.getOptions(true), owner);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8855.java