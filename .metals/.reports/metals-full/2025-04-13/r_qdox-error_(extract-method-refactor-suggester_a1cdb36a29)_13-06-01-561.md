error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2989.java
text:
```scala
i@@f (row == null || row.cf == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2989.java