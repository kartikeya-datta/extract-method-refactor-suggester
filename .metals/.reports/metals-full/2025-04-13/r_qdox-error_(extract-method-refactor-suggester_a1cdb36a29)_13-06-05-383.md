error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10492.java
text:
```scala
U@@RL url = AccessController.doPrivileged(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10492.java