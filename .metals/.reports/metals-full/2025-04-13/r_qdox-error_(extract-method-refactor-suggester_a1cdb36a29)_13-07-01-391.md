error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5736.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5736.java
text:
```scala
public abstract i@@nt numDataNodes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5736.java