error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8525.java
text:
```scala
c@@ontext.registerSubsystem(Namespace.MESSAGING_1_0.getUriString(), MessagingSubsystemParser.getInstance());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8525.java