error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/680.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/680.java
text:
```scala
a@@.activateOptions();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/680.java