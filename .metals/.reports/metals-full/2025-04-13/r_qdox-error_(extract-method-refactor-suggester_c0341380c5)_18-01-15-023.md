error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12651.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12651.java
text:
```scala
private static final P@@atchConfigXml_1_0 INSTANCE = new PatchConfigXml_1_0();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12651.java