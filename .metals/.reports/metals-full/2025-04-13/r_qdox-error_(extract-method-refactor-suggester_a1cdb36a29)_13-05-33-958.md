error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4238.java
text:
```scala
v@@oid setBackground (float /*double*/ [] color) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4238.java