error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3597.java
text:
```scala
i@@nt rgb = filterAction.getIntegerWithDefault("rgb", Color.black.getRGB());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3597.java