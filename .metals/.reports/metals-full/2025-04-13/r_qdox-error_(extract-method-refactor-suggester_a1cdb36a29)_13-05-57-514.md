error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1168.java
text:
```scala
c@@olumnIndex = i;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1168.java