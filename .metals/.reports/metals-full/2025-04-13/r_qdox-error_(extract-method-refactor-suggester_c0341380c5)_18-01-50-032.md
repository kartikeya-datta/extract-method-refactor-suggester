error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13959.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13959.java
text:
```scala
static final R@@ejectExpressionValuesChainedTransformer rejectExpressions = new RejectExpressionValuesChainedTransformer(SystemPropertyResourceDefinition.VALUE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13959.java