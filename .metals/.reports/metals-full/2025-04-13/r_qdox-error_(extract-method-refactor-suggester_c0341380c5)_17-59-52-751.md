error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3230.java
text:
```scala
i@@f (button instanceof TextButton && text.contentEquals(((TextButton)button).getText())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3230.java