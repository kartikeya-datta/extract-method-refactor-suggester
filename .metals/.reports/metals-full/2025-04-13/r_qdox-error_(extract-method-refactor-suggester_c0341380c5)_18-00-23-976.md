error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6887.java
text:
```scala
C@@omponent getHeader(MarkupContainer parent, String componentId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6887.java