error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5728.java
text:
```scala
b@@oolean hasLocation, modified, closed, ignoreMatch;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5728.java