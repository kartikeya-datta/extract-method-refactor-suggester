error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3605.java
text:
```scala
v@@alidator.validate("http://java.sun.com/xml/ns/javaee/web-app_2_5.xsd", xmlInput);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3605.java