error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9619.java
text:
```scala
p@@roject.files.add(new ProjectFile("core/CoreGdxDefinition", "core/src/" + mainClass + ".gwt.xml", true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9619.java