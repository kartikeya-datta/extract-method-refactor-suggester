error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6032.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6032.java
text:
```scala
public S@@tate lastState;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6032.java