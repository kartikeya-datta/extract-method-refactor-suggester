error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1204.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1204.java
text:
```scala
s@@tore.setDefault(IPreferenceConstants.VIEW_TAB_POSITION, SWT.TOP);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1204.java