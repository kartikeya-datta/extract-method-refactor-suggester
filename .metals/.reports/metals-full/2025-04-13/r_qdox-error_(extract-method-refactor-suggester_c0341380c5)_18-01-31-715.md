error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1816.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1816.java
text:
```scala
final W@@eight weight = new IndexSearcher(privateContext).createNormalizedWeight(query);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1816.java