error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7351.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7351.java
text:
```scala
private final A@@rrayList<File> files = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7351.java