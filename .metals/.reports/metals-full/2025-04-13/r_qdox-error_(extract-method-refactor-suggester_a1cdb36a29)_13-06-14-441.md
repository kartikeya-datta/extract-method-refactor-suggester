error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5403.java
text:
```scala
t@@his.contents = org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(location.toFile());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5403.java