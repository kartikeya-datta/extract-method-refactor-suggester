error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12163.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12163.java
text:
```scala
i@@f (!behavior.getStatelessHint(this))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12163.java