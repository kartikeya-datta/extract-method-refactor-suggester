error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4532.java
text:
```scala
i@@con = ImageLoader.getUnsafeImageIcon("mime/gnome-text.png");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4532.java