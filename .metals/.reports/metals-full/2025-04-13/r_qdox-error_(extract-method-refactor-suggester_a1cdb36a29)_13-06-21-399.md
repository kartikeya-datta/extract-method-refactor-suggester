error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7255.java
text:
```scala
n@@ewState.recordLocationForType(qualifiedTypeName, sourceLocation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7255.java