error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15184.java
text:
```scala
t@@ag.put("onclick", "window.location.href='" + url + "';return false;");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15184.java