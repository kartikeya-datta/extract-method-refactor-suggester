error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3578.java
text:
```scala
f@@or (DeploymentUnit sub : subDeployments) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3578.java