error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2541.java
text:
```scala
i@@f (arg.equals("-hs")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2541.java