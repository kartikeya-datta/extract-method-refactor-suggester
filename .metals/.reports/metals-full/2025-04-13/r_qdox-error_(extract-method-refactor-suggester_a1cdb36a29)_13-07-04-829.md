error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17884.java
text:
```scala
t@@mp = new File(java.io.File.createTempFile(this.getClass().getName(), ".txt"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17884.java