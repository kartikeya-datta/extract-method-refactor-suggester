error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9194.java
text:
```scala
r@@eturn currentState;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9194.java