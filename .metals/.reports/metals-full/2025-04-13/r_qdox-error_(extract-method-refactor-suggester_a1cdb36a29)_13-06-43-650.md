error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/544.java
text:
```scala
I@@NTEGRATION_METHOD_NEEDS_AT_LEAST_TWO_PREVIOUS_POINTS("{0} method needs at least two previous points"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/544.java