error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15135.java
text:
```scala
n@@ew ClassPathXmlApplicationContext(getClass().getSimpleName() + ".xml", getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15135.java