error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12176.java
text:
```scala
v@@oid around() : target(C) && call(* r*(..)) {  // CE can't apply to methods returning Object
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12176.java