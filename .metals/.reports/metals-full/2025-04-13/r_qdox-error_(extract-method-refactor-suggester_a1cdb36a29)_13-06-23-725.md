error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7569.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7569.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7569.java
text:
```scala
i@@nt port = exchange.getDestinationAddress().getPort();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7569.java