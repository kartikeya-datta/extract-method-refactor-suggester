error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7709.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7709.java
text:
```scala
public v@@oid testEngineGCDeletesSetting() throws InterruptedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7709.java