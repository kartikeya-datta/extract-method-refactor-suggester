error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11319.java
text:
```scala
B@@yteArrayOutputStream bos = new ByteArrayOutputStream(1024);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11319.java