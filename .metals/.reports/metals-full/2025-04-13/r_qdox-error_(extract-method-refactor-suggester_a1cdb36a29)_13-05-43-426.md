error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16985.java
text:
```scala
C@@lass pageClass = application.getPages().classForAlias(bookmarkableName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16985.java