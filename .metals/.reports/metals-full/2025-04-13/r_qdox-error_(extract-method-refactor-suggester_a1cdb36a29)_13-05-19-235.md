error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5015.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5015.java
text:
```scala
private static final l@@ong SLEEP_TIME = 500;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5015.java