error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6188.java
text:
```scala
r@@eturn KeySupport.formatOSX(keyBinding.getKeySequence());
			...
			public String getAcceleratorText(IContributionItem contributionItem) {
				...
				if (commandId == null) {
					...
					if (keyBindings != null) {
						...
						if (keyBinding != null)
							return KeySupport.formatCarbon(keyBinding.getKeySequence());
					}
				} else {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6188.java