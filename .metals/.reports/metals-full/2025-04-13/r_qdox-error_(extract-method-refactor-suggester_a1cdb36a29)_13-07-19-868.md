error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2487.java
text:
```scala
C@@olumnFamily filteredColumnFamily = cf.cloneMeShallow();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2487.java