error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/71.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/71.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/71.java
text:
```scala
f@@or (int i = 0, length = methods.length; i < length; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/71.java