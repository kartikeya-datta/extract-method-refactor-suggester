error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8506.java
text:
```scala
a@@fter() returning: j() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8506.java