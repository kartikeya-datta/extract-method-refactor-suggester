error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6394.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6394.java
text:
```scala
final S@@tring configPropertyValue = CONFIG_PROPERTY_VALUE.resolveModelAttribute(context, recoveryEnvModel).asString();
 ...
 *
 */
public class CDConfigPropertyAdd extends AbstractBoottimeAddStepHandler implements DescriptionProvider {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6394.java