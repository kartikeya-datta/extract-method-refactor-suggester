error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2991.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2991.java
text:
```scala
static private final O@@bjectMap<Application, ControllerManager> managers = new ObjectMap<Application, ControllerManager>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2991.java