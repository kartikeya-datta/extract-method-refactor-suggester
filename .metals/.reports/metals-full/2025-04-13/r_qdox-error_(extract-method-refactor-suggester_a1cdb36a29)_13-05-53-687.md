error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2359.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2359.java
text:
```scala
public static final S@@tring VERSION = "1.3.0";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2359.java