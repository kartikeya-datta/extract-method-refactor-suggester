error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7408.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7408.java
text:
```scala
private final M@@ap<String, IndexField> indexFields = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7408.java