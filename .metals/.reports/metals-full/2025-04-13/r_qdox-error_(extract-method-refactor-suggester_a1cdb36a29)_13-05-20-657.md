error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9619.java
text:
```scala
m@@enuItem.setText(WorkbenchMessages.getString("PartPane.restore")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9619.java