error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3443.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3443.java
text:
```scala
public static final S@@tring SUBSYSTEM_NAME = "threads";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3443.java