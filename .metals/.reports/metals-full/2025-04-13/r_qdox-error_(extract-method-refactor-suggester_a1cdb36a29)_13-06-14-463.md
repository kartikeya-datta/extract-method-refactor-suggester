error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8938.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8938.java
text:
```scala
public I@@D createInstance(Object[] args)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8938.java