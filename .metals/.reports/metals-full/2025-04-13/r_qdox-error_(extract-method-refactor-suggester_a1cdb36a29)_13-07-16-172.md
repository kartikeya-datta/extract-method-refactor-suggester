error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3513.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3513.java
text:
```scala
final S@@uggestionSearchContext context = suggestPhase.parseElement().parseInternal(parser, indexService.mapperService(), request.index(), request.shardId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3513.java