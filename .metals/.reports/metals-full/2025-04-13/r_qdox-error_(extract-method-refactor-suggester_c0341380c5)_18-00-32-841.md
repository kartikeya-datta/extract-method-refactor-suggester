error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3096.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3096.java
text:
```scala
T@@hrowableObjectInputStream ois = new ThrowableObjectInputStream(buffer, settings.getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3096.java