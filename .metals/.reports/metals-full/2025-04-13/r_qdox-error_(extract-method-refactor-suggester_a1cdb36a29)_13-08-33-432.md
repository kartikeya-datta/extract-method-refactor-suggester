error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7523.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7523.java
text:
```scala
private static volatile S@@tring defaultDataSourceName = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7523.java