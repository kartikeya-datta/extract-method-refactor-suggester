error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3601.java
text:
```scala
o@@ptimizer.prepForNextRound();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3601.java