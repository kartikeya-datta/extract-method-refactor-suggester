error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7357.java
text:
```scala
p@@ane.showPaneMenu();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7357.java