error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8509.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8509.java
text:
```scala
L@@ist<? extends IBehavior> behaviors = page.getContainer().getBehaviorsRawList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8509.java