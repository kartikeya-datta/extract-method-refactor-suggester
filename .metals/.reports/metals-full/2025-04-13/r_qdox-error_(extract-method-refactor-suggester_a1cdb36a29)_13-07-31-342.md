error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5184.java
text:
```scala
g@@etParser(JavaCore.getOptions()).parseCompilationUnit(compilationUnit, false/*diet parse*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5184.java