error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10222.java
text:
```scala
i@@f (previousResult == null || previousResult.getResponseData().length == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10222.java