error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14625.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14625.java
text:
```scala
final C@@omponent child = children_get(i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14625.java