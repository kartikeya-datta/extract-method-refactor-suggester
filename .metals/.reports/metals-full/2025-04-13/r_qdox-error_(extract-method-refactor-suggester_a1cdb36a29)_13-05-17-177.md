error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2864.java
text:
```scala
X@@Bundle bundle = depUnit.getAttachment(OSGiConstants.BUNDLE_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2864.java