error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10532.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10532.java
text:
```scala
private v@@oid createKeytab(final String principalName, final String passPhrase, final File keytabFile) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10532.java