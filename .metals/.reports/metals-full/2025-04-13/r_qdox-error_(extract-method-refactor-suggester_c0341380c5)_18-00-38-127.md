error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8363.java
text:
```scala
e@@lse if(charWidth != 0 && !Debug.DISABLE_MONOSPACE_HACK)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8363.java