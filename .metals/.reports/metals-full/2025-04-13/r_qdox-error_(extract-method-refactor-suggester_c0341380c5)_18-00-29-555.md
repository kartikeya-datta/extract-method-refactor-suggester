error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3326.java
text:
```scala
X@@FieldComparatorSource nestedComparatorSource = createFieldComparator("field2", sortMode, -127, createNested(parentFilter, childFilter));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3326.java