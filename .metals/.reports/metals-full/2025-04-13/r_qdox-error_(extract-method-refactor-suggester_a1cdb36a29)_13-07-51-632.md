error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9258.java
text:
```scala
f@@or (Map.Entry<? extends String, ?> entry : map.entrySet()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9258.java