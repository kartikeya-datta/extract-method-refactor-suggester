error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8649.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8649.java
text:
```scala
public static final N@@amespace CURRENT = DOMAIN_1_1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8649.java