error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17103.java
text:
```scala
a@@pplication.getRequiredPageSettings().setHomePage(pageClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17103.java