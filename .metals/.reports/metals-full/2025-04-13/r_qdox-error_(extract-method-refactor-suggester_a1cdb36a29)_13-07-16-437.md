error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11637.java
text:
```scala
p@@ublic class ResourceTestPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11637.java