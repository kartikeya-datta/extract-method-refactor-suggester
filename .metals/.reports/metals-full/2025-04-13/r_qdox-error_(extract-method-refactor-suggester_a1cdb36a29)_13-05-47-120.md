error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4462.java
text:
```scala
A@@ssert.assertEquals(4, cookies.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4462.java