error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1853.java
text:
```scala
S@@tring server = oneUp.getLastElement().getValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1853.java