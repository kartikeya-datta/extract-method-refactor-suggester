error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7048.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7048.java
text:
```scala
public A@@pplicationListener getApplicationListener () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7048.java