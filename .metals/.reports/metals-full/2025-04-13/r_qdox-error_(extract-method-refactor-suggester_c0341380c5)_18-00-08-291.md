error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10140.java
text:
```scala
s@@uper(PathElement.pathElement(ADMIN_OBJECTS_NAME), ResourceAdaptersExtension.getResourceDescriptionResolver(ADMIN_OBJECTS_NAME), readOnly ? null : AdminObjectAdd.INSTANCE, readOnly ? null : ReloadRequiredRemoveStepHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10140.java