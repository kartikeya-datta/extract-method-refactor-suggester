error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14626.java
text:
```scala
r@@eturn isBeanManagedTransaction() ? StatelessAllowedMethodsInformation.INSTANCE_BMT : StatelessAllowedMethodsInformation.INSTANCE_CMT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14626.java