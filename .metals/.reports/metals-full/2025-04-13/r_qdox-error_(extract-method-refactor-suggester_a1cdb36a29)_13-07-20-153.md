error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17792.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[97,80]

error in qdox parser
file content:
```java
offset: 2879
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17792.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17792.java