error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5003.java
text:
```scala
b@@oolean linesVisible, ignoreKey, ignoreDispose, allowItemHeightChange = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5003.java