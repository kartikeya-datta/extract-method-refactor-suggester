error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7700.java
text:
```scala
i@@f ((Integer.MAX_VALUE - size) < firstIndex)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7700.java