error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14015.java
text:
```scala
r@@eturn view.getValue().createInstance(Collections.<Object, Object>singletonMap(SessionID.class, sessionID)).getInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14015.java