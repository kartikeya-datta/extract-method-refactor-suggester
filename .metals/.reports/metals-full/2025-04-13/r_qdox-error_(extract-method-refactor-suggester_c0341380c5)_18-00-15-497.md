error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1790.java
text:
```scala
i@@nt readNow = IOUtils.readFully(is, record);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1790.java