error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9530.java
text:
```scala
i@@f (!diet || dietInt != 0){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9530.java