error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9672.java
text:
```scala
p@@arams.put("security-application", "true");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9672.java