error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12265.java
...
```java
offset: 28
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12265.java
text:
```scala
public static final native i@@nt MAKEWORD(int l, int h);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12265.java