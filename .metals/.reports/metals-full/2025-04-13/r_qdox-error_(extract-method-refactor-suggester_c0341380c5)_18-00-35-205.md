error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11190.java
text:
```scala
l@@ogger.trace("[" + this.beanName + "] send message " + message);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11190.java