error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3885.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3885.java
text:
```scala
@Override public b@@oolean useTermQueryWithQueryString() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3885.java