error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13813.java
text:
```scala
r@@eturn Stringz.className(application.getResourceSettings().getResourceStreamFactory());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13813.java