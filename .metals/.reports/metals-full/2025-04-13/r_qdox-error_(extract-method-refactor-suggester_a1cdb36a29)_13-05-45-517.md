error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2975.java
text:
```scala
i@@nt count = 20;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2975.java