error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1715.java
text:
```scala
O@@ptimizeResponse actionGet = client().admin().indices().prepareOptimize().execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1715.java