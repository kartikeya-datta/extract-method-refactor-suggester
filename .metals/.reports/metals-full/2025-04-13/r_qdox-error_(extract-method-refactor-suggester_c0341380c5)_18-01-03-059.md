error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9554.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9554.java
text:
```scala
final M@@odelNode valueNode = (resolveValue ? FILTER_SPEC.resolveModelAttribute(context, model) : model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9554.java