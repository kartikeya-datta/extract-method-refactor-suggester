error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3775.java
text:
```scala
l@@ayoutTopControl(filteredTree);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3775.java