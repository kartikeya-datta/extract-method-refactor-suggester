error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5492.java
text:
```scala
i@@nt SPRITES = 400 / 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5492.java