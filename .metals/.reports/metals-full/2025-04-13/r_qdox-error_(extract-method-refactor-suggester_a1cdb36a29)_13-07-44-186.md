error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10226.java
text:
```scala
r@@eturn new ShortValuesComparator(indexFieldData, dMissingValue, numHits, reversed);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10226.java