error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5092.java
text:
```scala
i@@f (enclosingInstances[i].type.findSuperTypeOriginatingFrom(targetEnclosingType) != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5092.java