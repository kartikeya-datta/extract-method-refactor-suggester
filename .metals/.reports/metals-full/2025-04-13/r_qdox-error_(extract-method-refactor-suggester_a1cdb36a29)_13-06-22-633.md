error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8508.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8508.java
text:
```scala
public L@@ist<? extends IBehavior> getBehaviors();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8508.java