error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/292.java
text:
```scala
G@@C gc = new GC (image, parent.getStyle() & SWT.RIGHT_TO_LEFT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/292.java