error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16804.java
text:
```scala
i@@f (parent.columns.length < 2 || (parent.style & SWT.FULL_SELECTION) == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16804.java