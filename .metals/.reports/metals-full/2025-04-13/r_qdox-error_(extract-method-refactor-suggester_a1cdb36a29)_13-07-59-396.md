error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11025.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11025.java
text:
```scala
protected final b@@oolean parseRequest()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11025.java