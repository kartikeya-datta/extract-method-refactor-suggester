error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3820.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3820.java
text:
```scala
r@@eturn tabString(tab) + "Recovered statement:\n" + statement.toString(tab + 1); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3820.java