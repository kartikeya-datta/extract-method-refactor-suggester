error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1351.java
text:
```scala
O@@S.gtk_entry_set_text (entryHandle, new byte[1]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1351.java