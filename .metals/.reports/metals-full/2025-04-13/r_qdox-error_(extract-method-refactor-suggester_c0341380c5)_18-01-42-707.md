error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7773.java
text:
```scala
i@@nt	hGlobal = OS.GlobalAlloc(OS.GMEM_FIXED | OS.GMEM_ZEROINIT, UTF8BOM.length + byteCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7773.java