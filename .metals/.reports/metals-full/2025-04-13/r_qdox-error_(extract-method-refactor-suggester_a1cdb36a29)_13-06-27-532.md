error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3495.java
text:
```scala
S@@tringBuffer contents = new StringBuffer(50);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3495.java