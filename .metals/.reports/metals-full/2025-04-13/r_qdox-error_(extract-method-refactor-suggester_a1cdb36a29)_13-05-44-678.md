error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9713.java
text:
```scala
s@@etPage(new ExceptionErrorPage(e, getPage()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9713.java