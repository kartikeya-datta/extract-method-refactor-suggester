error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6049.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6049.java
text:
```scala
public b@@oolean supportsAddFolder(String newFolderType) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6049.java