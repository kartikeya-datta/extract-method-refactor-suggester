error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16386.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16386.java
text:
```scala
private static final S@@tring VERSION = "2.10";
...
public final class JMeterVersion {
     ...
     */
    private static final String VERSION = "2.10-SNAPSHOT";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16386.java