error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/513.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/513.java
text:
```scala
public B@@ufferedWebResponse(final HttpServletResponse httpServletResponse)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/513.java