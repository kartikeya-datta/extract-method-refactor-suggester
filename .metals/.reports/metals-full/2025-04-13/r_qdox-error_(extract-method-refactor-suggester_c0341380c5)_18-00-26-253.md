error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6117.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6117.java
text:
```scala
public static final S@@tring version = "1.0 Milestone M2 Release Candidate";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6117.java