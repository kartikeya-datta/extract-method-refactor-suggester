error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2818.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2818.java
text:
```scala
public Q@@uery termQuery(String value, QueryParseContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2818.java