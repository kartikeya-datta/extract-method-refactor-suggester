error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11777.java
text:
```scala
p@@ublic class EnclosurePage_1 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11777.java