error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14236.java
text:
```scala
e@@xe.setCommandline( m_command );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14236.java