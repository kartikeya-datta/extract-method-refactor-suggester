error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6646.java
text:
```scala
i@@f (!isComparable(fValidatedInfo, currUse.fDefault) || !actualValue.equals(currUse.fDefault.actualValue)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6646.java