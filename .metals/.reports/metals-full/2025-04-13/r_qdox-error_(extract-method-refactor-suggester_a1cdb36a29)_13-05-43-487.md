error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9425.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9425.java
text:
```scala
protected O@@bject convert( Object original, Object context )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9425.java