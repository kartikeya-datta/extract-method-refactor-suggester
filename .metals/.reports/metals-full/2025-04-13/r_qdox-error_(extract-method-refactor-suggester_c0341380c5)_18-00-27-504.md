error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5668.java
text:
```scala
i@@f ((srcIsProject && !Util.isExcluded(res, exclusionPatterns) && Util.isValidFolderNameForPackage(res.getName()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5668.java