error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/62.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/62.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/62.java
text:
```scala
s@@ = s + "default : "/*nonNLS*/ ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/62.java