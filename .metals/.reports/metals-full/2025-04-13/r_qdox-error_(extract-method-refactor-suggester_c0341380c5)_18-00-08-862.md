error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10202.java
text:
```scala
i@@f ((style & SWT.HORIZONTAL) != 0) return bits | OS.TBS_HORZ | OS.TBS_DOWNISLEFT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10202.java