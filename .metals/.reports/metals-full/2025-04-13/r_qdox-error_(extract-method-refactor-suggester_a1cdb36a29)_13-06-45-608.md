error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10506.java
text:
```scala
h@@ornetQService.destroyQueue(new SimpleString(queueConfiguration.getName()), null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10506.java