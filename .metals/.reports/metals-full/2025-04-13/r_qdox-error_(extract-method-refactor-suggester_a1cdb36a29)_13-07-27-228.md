error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3530.java
text:
```scala
S@@tring[] sAttrs = Strings.splitStringToArray(attributes, ';');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3530.java