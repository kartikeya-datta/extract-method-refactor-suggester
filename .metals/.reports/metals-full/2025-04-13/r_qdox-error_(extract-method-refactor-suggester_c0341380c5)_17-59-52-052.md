error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9956.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9956.java
text:
```scala
S@@tring channelName = context.getCurrentAddressValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9956.java