error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6969.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6969.java
text:
```scala
final M@@odelNode submodel = context.readResource(PathAddress.EMPTY_ADDRESS, false).getModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6969.java