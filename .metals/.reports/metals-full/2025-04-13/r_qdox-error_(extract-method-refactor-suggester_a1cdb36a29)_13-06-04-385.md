error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2562.java
text:
```scala
a@@ssertTrue(Double.isNaN(model.getValue("b1shkt70694difsmmmdv0ikmoh", 77)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2562.java