error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1809.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1809.java
text:
```scala
protected L@@ock writeLock;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1809.java