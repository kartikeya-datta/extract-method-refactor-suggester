error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4557.java
text:
```scala
s@@uper(environment, policy, settings, requestor, problemFactory, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4557.java