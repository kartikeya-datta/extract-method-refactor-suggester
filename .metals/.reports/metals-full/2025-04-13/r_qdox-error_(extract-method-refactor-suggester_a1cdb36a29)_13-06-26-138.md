error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2711.java
text:
```scala
f@@older.getConfiguration().set("property", "enable_threaded_view",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2711.java