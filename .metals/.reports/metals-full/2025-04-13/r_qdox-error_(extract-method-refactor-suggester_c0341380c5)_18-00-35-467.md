error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/711.java
...
```java
offset: 605
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/711.java
text:
```scala
...
p@@ackage org.eclipse.ecf.presence.bot.impl;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/711.java