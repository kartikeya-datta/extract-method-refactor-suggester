error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6738.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6738.java
text:
```scala
private static final S@@tring TAG = "FollowingUserTask";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6738.java