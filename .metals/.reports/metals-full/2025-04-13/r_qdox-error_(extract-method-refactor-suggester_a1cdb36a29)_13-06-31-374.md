error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3190.java
text:
```scala
i@@f (!OS.ImmGetCompositionFont (hIMC, oldFont)) oldFont = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3190.java