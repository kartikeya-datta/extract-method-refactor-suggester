error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5186.java
text:
```scala
i@@mmutableCluster().wipeIndices(getConcreteIndexName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5186.java