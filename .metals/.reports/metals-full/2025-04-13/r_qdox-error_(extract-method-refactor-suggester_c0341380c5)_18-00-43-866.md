error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4494.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4494.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4494.java
text:
```scala
i@@f (trueLabel.forwardReferenceCount() > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4494.java