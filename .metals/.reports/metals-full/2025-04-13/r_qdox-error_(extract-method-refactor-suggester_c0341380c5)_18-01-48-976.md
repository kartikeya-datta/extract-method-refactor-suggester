error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2347.java
text:
```scala
r@@esult += ctx.wasCancelCalled() ? "true" : "false";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2347.java