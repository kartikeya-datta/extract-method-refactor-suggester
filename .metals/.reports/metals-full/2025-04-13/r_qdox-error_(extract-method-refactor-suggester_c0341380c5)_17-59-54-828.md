error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4513.java
text:
```scala
t@@ag.put("action", Strings.replaceAll(urlFor(IFormSubmitListener.class),"&", "&amp;"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4513.java