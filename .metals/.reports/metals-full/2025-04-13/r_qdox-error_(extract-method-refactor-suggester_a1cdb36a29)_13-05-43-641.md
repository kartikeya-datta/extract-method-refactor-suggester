error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/829.java
text:
```scala
i@@f (b == null || (b.length > _maxSize && !field.getColumns()[0].isNotNull()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/829.java