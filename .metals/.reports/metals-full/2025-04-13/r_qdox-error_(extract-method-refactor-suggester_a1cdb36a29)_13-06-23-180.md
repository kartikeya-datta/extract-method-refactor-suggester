error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12893.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(MESSAGES.paramNameAndParamValueRequiredForAddParam()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12893.java