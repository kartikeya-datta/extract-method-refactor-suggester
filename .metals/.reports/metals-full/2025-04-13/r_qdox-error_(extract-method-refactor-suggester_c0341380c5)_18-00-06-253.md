error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7184.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7184.java
text:
```scala
final P@@age page = component.findParent(Page.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7184.java