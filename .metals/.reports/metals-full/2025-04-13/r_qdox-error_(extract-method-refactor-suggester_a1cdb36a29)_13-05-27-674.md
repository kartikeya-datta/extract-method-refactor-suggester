error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5107.java
text:
```scala
L@@ist<String> arguments = ctx.getParsedArguments().getOtherProperties();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5107.java