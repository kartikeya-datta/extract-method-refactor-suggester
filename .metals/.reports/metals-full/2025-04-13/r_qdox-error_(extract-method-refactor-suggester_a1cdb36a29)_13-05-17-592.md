error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13706.java
text:
```scala
S@@tring ROLE = ConverterRegistry.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13706.java