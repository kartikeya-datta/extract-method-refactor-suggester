error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5372.java
text:
```scala
A@@ndroidGL, LWJGL, Angle, WebGL, iOSGL, JGLFW
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5372.java