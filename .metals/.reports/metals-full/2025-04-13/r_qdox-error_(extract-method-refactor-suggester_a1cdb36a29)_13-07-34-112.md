error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14903.java
text:
```scala
d@@efinition.getIsolationLevel() != TransactionDefinition.ISOLATION_DEFAULT ?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14903.java