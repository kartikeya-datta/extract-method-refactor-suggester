error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2882.java
text:
```scala
r@@eturn credential != null && principal.getName().equals( credential.toString() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2882.java