error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2779.java
text:
```scala
i@@f (!ignoreDrawFocus && findImageControl () != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2779.java