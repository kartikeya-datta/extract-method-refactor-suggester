error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/335.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/335.java
text:
```scala
i@@f (methodType != null && Scope.areTypesCompatible(expressionType, methodType)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/335.java