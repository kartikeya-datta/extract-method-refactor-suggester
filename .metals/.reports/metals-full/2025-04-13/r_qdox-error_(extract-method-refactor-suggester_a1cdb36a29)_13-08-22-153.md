error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/129.java
text:
```scala
f@@s.delete(outpath, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/129.java