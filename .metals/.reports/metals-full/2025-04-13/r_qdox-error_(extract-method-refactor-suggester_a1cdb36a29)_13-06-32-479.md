error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16893.java
text:
```scala
i@@f (isVisibleInHierarchy() && isRenderAllowed())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16893.java