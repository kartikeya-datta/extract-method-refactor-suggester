error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16111.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16111.java
text:
```scala
public final v@@oid detach(Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16111.java