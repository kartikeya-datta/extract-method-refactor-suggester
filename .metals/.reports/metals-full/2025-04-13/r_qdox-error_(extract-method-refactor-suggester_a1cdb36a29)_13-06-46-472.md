error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6220.java
text:
```scala
g@@etComponentInstantiationListeners().add(new SpringComponentInjector(this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6220.java