error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3378.java
text:
```scala
d@@eployers.get(Phase.DEPENDENCIES).add(new RegisteredProcessor(Phase.DEPENDENCIES_SEAM, new SeamProcessor(serviceTarget)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3378.java