error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1228.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1228.java
text:
```scala
protected static final L@@ogger logger = LoggerFactory.getLogger(Migration.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1228.java