error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10019.java
text:
```scala
m@@essage.getHeader().getAttributes(), message.getFlags());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10019.java