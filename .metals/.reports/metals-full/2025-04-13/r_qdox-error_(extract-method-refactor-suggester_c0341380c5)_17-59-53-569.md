error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/750.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/750.java
text:
```scala
public C@@hoicePattern(Pattern p1, Pattern p2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/750.java