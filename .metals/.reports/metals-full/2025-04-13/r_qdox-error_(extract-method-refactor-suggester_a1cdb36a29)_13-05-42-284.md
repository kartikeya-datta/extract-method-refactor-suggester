error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2815.java
text:
```scala
r@@egion specified by the existing Derby attribute called territory.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2815.java