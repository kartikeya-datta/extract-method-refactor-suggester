error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12763.java
text:
```scala
r@@eturn (file != null && file.exists()) ? file : secondary.getDeploymentRoot(hash);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12763.java