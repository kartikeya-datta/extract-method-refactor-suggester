error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/816.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/816.java
text:
```scala
protected static final s@@hort FLAG_CONVERT_EMPTY_INPUT_STRING_TO_NULL = FLAG_RESERVED1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/816.java