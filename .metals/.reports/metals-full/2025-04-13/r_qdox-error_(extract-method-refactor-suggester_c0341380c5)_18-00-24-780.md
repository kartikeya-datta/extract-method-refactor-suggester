error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14273.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14273.java
text:
```scala
c@@onverted = converter.convert(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14273.java