error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11336.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11336.java
text:
```scala
public b@@oolean resolve(final MarkupContainer container, final MarkupStream markupStream,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11336.java