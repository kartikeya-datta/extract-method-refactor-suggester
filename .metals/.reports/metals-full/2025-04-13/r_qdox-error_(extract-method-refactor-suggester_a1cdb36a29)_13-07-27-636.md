error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16752.java
text:
```scala
r@@eturn "setTimeout(function() { " + getCallbackScript(false, true) + " }, "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16752.java