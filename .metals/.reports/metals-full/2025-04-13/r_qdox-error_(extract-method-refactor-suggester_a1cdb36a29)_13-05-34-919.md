error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1767.java
text:
```scala
a@@dd(new Label("totalSize", "" + Bytes.bytes(session.getSizeInBytes())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1767.java