error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5356.java
text:
```scala
i@@f (!sendKeyEvent (nsEvent, SWT.KeyDown)) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5356.java