error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11627.java
text:
```scala
s@@uper("Required request part '" + partName + "' is not present.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11627.java