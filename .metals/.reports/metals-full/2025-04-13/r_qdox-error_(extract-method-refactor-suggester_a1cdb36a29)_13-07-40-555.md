error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11006.java
text:
```scala
v@@oid checkOpened () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11006.java