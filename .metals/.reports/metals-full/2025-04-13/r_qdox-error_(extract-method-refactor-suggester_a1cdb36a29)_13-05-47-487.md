error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5882.java
text:
```scala
f@@lowContext.recordSettingFinal(binding, this, flowInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5882.java