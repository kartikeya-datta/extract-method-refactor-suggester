error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6627.java
text:
```scala
i@@f (minimized && useNewMinMax && persp != null && this instanceof ViewStack) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6627.java