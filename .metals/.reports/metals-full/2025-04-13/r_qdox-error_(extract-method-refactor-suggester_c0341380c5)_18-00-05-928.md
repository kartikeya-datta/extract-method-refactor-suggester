error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5205.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5205.java
text:
```scala
public final S@@tring getHiddenFieldId()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5205.java