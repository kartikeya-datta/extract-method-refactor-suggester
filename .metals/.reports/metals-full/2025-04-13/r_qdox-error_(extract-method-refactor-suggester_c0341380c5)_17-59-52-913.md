error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9476.java
text:
```scala
r@@eturn new StringTerms(name, order, bucketCountThresholds.getRequiredSize(), bucketCountThresholds.getShardSize(), bucketCountThresholds.getMinDocCount(), Collections.<InternalTerms.Bucket>emptyList(), showTermDocCountError, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9476.java