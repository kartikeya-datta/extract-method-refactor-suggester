error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3328.java
text:
```scala
r@@eturn NO_INVALID_INPUT.equals(invalidInput) ? getModelValue() : invalidInput;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3328.java