error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5302.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5302.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5302.java
text:
```scala
s@@etActionDefinitionId(IWorkbenchCommandConstants.HELP_DYNAMIC_HELP);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5302.java