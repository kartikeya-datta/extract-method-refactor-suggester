error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8510.java
text:
```scala
d@@ocMapper.parse(SourceToParse.source(getResponse.sourceRef().bytes(), getResponse.sourceRef().offset(), getResponse.sourceRef().length()).type(request.type()).id(request.id()), new DocumentMapper.ParseListenerAdapter() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8510.java