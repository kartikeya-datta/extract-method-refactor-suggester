error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2464.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2464.java
text:
```scala
final i@@nt start = index + 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2464.java