error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2919.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2919.java
text:
```scala
final i@@nt port = injectedSocketBinding.getValue().getAbsolutePort();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2919.java