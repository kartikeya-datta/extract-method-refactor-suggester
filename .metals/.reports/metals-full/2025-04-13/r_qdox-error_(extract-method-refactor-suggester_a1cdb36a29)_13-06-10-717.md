error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3598.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3598.java
text:
```scala
static private final S@@tring PERTIMAGES = "/org/jhotdraw/samples/pert/images/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3598.java