error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9898.java
text:
```scala
p@@roject.files.add(new ProjectFile("android/build.gradle", true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9898.java