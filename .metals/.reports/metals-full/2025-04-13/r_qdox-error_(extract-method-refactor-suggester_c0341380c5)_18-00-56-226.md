error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14511.java
text:
```scala
i@@f (!(o instanceof Triplet<?, ?, ?>))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14511.java