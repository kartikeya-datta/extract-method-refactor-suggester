error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8974.java
text:
```scala
f@@Node= new DOMImport(fDocument, sourceRange, importName, onDemand); // TODO (olivier) DOM import should reflect static nature
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8974.java