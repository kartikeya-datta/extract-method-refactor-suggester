error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/931.java
text:
```scala
r@@eturn createDefaultClassFileReader(classfile.getPath().toOSString(), decodingFlag);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/931.java