error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3391.java
text:
```scala
X@@mlTag xmlTag = (XmlTag)getNextFilter().nextTag();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3391.java