error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2113.java
text:
```scala
r@@eturnCF = cfs.filterColumnFamily(cached, keyFilter, cfs.metadata.gcGraceSeconds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2113.java