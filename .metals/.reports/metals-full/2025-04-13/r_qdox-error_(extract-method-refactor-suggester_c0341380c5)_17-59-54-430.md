error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/537.java
text:
```scala
M@@emberImpl.method(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/537.java