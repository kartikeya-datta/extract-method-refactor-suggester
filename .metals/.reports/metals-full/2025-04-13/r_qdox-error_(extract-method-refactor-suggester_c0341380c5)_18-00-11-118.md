error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6090.java
text:
```scala
f@@or (ResourceRoot resourceRoot : allResourceRoots) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6090.java