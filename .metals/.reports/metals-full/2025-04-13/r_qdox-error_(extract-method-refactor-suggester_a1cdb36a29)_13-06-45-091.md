error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14646.java
text:
```scala
t@@extFileChange.addEdit(AnnotationUtils.createAddImportTextEdit(source.findPrimaryType(), WebService.class.getCanonicalName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14646.java