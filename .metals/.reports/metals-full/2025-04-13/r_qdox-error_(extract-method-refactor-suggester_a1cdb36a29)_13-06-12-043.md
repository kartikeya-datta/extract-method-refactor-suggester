error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8377.java
text:
```scala
i@@f (exceptionType.isGenericType() || exceptionType.isBoundParameterizedType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8377.java