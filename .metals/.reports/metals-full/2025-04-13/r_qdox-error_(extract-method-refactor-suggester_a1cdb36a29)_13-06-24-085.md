error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3183.java
text:
```scala
t@@ester.getWicketAjaxBaseUrlEncodedInLastResponse());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3183.java