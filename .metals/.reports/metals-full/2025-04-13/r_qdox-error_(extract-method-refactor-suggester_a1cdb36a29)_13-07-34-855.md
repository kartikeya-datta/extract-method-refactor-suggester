error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4027.java
text:
```scala
A@@udioDeviceTest.class, AudioRecorderTest.class, BitmapFontAlignmentTest.class, BitmapFontFlipTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4027.java