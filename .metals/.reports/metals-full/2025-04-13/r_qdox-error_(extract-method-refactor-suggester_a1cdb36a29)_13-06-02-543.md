error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/703.java
text:
```scala
r@@eturn this.environment.createParameterizedGenericMethod(originalMethod, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/703.java