error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17010.java
text:
```scala
(@@(Page)value).detach();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17010.java