error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15103.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15103.java
text:
```scala
private final P@@ropertiesElement systemProperties = new PropertiesElement(Element.PROPERTY, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15103.java