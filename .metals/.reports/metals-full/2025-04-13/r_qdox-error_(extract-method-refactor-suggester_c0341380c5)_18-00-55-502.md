error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13989.java
text:
```scala
t@@his.slaveHandler = new OperationSlaveStepHandler(localHostControllerInfo, contentRepository, serverProxies);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13989.java