error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12748.java
text:
```scala
p@@anel.setOptions(OS.NSPrintPanelShowsPageSetupAccessory | panel.options());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12748.java