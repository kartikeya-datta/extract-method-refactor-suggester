error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/687.java
...
```java
offset: 2890
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/687.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/687.java