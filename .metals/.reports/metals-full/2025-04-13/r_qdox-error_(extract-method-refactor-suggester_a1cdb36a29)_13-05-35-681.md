error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4306.java
text:
```scala
b@@uffer.append(" onclick=\"window.location.href='").append(url).append("&" + getInputName())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4306.java