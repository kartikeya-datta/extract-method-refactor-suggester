error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2877.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2877.java
text:
```scala
public static final S@@tring PLUGIN_ID = "org.eclipse.ecf.presence"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2877.java