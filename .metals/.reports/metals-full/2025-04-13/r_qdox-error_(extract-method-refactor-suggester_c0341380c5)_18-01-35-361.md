error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1645.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1645.java
text:
```scala
public static final b@@oolean DEFAULT_USE_TAB = true; // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=49081
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1645.java