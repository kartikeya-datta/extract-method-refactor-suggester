error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2556.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2556.java
text:
```scala
protected N@@ullIdeManager ideManager = NullIdeManager.getIdeManager();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2556.java