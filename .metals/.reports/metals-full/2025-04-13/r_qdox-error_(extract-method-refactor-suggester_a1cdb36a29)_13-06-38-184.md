error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11455.java
text:
```scala
p@@ublic final class Home extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11455.java