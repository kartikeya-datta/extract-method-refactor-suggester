error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4737.java
text:
```scala
c@@ached = EsExecutors.newCachedThreadPool(keepAlive, EsExecutors.daemonThreadFactory(settings, "[cached]"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4737.java