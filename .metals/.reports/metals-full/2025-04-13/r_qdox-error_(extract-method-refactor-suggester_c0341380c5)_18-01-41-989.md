error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11023.java
text:
```scala
D@@ataCache cache = _conf.getDataCacheManagerInstance().selectCache(sm);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11023.java