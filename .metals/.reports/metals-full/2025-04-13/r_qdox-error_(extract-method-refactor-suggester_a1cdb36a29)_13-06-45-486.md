error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6210.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6210.java
text:
```scala
i@@f ((bits & IsReturnedValue) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6210.java