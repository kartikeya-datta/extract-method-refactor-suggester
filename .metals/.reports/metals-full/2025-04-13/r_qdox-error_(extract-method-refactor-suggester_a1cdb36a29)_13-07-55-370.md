error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12816.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12816.java
text:
```scala
private transient W@@eakReference listener;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12816.java