error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/98.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/98.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/98.java
text:
```scala
c@@lient.admin().cluster().ping(replicationPingRequest, new ActionListener<ReplicationPingResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/98.java