error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9921.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9921.java
text:
```scala
final C@@harSequence url = getCallbackUrl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9921.java