error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5243.java
text:
```scala
C@@lusterStateResponse stateResponse = client().admin().cluster().prepareState().setIndices(indexName).get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5243.java