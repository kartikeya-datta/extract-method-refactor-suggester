error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6525.java
text:
```scala
s@@tartActivity(IssuesViewActivity.createIntent(issue, repo));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6525.java