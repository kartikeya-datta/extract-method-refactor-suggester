error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8204.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8204.java
text:
```scala
s@@etImageDescriptor(set.getImageDescriptor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8204.java