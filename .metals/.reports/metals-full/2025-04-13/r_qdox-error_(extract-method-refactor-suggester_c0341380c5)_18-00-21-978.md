error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9445.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9445.java
text:
```scala
r@@eturn wrapSmartNameQuery(query, smartNameFieldMappers, parseContext.indexCache());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9445.java