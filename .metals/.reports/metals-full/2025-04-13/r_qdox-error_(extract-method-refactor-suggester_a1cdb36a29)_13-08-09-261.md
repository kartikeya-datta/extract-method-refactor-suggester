error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10443.java
text:
```scala
r@@eturn Short.valueOf(key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10443.java