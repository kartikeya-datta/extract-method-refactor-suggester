error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7728.java
text:
```scala
t@@his.asyncRequest.addTimeoutHandler(timeoutHandler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7728.java