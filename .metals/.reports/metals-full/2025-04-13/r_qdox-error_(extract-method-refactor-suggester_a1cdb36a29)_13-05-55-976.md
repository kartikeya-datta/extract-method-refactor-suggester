error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5789.java
text:
```scala
c@@onfiguration.addViewInterceptorToFront(new ImmediateInterceptorFactory(new SingletonComponentInstanceAssociationInterceptor()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5789.java