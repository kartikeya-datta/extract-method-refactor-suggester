error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2593.java
text:
```scala
d@@ynaBean.set(propertyName, new Double(v));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2593.java