error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2328.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2328.java
text:
```scala
public i@@nt sliceHash(String id, SolrInputDocument sdoc, SolrParams params) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2328.java