error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1516.java
text:
```scala
r@@eturn JavaWorkspaceScope.createScope();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1516.java