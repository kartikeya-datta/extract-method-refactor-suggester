error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3122.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3122.java
text:
```scala
public c@@har [][] getTypeName() { // TODO (kent) should improve since most type references are single names
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3122.java