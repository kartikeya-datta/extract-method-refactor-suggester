error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6357.java
text:
```scala
i@@f (changed && listener != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6357.java