error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15313.java
text:
```scala
p@@ath = JOrphanUtils.substitute(path, "//", "/"); // $NON-NLS-1$// $NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15313.java