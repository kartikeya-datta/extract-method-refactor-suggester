error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7146.java
text:
```scala
p@@ointcut goCut(): !within(Filteraspect) && cflow(within(testclass1)) && !preinitialization(new(..));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7146.java