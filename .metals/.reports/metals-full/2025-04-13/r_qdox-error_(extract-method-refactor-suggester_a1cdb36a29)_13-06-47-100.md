error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1110.java
text:
```scala
I@@ndexWriterConfig iwc = newIndexWriterConfig(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1110.java