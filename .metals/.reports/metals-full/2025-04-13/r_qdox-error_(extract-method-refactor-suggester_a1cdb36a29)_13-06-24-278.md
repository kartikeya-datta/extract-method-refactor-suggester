error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13515.java
text:
```scala
G@@enericOutboundConnectionAdd.INSTANCE, GenericOutboundConnectionRemoveHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13515.java