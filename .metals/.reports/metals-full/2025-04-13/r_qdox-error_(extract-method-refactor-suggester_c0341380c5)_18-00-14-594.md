error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16387.java
text:
```scala
e@@xampleGroup.setBackgroundImage (backgroundModeImageButton.getSelection () ? instance.images[ControlExample.ciParentBackground] : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16387.java