error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16042.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16042.java
text:
```scala
public v@@oid leaveGroup();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16042.java