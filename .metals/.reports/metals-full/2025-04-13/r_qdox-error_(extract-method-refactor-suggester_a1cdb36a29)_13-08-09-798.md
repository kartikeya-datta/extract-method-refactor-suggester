error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/308.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/308.java
text:
```scala
public S@@tring androidTargetSdkVersion = "19";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/308.java