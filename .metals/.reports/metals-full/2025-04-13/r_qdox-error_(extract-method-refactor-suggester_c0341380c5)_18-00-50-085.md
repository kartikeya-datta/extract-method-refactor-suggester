error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1487.java
text:
```scala
b@@oolean isCallerInRole(final String ejbName, final Object mappedRoles, final Map<String, Collection<String>> roleLinks,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1487.java