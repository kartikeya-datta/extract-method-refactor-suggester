error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9282.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9282.java
text:
```scala
public S@@impleJdbcCall returningResultSet(String parameterName, RowMapper<?> rowMapper) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9282.java