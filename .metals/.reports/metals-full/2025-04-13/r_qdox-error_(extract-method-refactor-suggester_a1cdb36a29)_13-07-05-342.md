error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13163.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13163.java
text:
```scala
t@@hrow new WicketRuntimeException("there is no session attached to current thread "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13163.java