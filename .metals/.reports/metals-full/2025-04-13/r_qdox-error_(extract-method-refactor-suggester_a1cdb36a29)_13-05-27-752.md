error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8360.java
text:
```scala
P@@ointcut cp = rp.concretize(ResolvedType.MISSING, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8360.java