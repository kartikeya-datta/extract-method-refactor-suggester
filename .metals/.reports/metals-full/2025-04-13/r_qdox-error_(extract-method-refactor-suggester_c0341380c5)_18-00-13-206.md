error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15121.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15121.java
text:
```scala
final S@@ingleOperationFuture result = new SingleOperationFuture();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15121.java