error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5984.java
text:
```scala
e@@c.addError(new ErrorItem("Could not create layout of type " + className + "]."));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5984.java