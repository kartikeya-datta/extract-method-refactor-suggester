error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13969.java
text:
```scala
O@@bject getBean(String name, Object... args) throws BeansException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13969.java