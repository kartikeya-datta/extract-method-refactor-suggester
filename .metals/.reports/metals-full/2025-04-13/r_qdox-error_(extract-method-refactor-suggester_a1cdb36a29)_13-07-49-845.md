error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4098.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4098.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4098.java
text:
```scala
S@@tring url = getPage().urlFor(resourceReference);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4098.java