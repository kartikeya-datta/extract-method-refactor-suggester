error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10389.java
text:
```scala
M@@ultivariateVectorFunction gradient();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10389.java