error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12992.java
text:
```scala
s@@tringLengthFunction = "LENGTH({0})";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12992.java