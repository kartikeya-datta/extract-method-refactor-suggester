error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5173.java
text:
```scala
n@@ew Object[] { Double.valueOf(argument), Double.valueOf(lower), Double.valueOf(upper) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5173.java