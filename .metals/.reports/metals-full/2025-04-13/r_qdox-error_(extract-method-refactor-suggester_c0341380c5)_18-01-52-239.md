error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10073.java
text:
```scala
c@@omponent.getStoreManager().removeEntity(instance.getEjbContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10073.java