error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12972.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12972.java
text:
```scala
c@@onfiguration.addClientInterceptor(method, new StatefulWriteReplaceInterceptor.Factory(configuration.getViewServiceName().getCanonicalName()), InterceptorOrder.Client.WRITE_REPLACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12972.java