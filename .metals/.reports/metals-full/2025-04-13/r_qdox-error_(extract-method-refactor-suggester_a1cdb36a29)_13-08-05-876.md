error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3399.java
text:
```scala
i@@nt sdkVersion = Integer.parseInt(android.os.Build.VERSION.SDK);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3399.java