error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9311.java
text:
```scala
E@@numeration<?> propNames = props.propertyNames();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9311.java