error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10435.java
text:
```scala
i@@f (_meta.isMapped() || _meta.isAbstract())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10435.java