error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4917.java
text:
```scala
S@@ystem.arraycopy(bytes, 0, bytes = new byte[length*2], 0, length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4917.java