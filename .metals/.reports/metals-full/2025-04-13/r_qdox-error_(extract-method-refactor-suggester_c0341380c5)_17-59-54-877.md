error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/375.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/375.java
text:
```scala
protected v@@oid update(final int position, final CommentItemView view, final Comment comment) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/375.java