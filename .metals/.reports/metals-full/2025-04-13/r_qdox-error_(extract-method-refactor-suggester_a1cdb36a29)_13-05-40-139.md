error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/104.java
text:
```scala
c@@lient.admin().indices().gatewaySnapshot(gatewaySnapshotRequest, new ActionListener<GatewaySnapshotResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/104.java