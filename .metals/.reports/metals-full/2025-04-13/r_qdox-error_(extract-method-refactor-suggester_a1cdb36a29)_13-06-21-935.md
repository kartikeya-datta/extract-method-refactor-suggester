error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/917.java
text:
```scala
t@@his.referenceContext = compUnitDecl;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/917.java