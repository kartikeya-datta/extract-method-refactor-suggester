error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/788.java
text:
```scala
i@@f (org.eclipse.jdt.internal.compiler.util.Util.isArchiveFileName(resName) && this.isClasspathEntryOrOutputLocation(resFullPath, classpath, projectOutput)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/788.java