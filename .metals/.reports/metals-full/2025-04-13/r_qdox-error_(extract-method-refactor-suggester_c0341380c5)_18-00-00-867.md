error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4651.java
text:
```scala
t@@his (parent, SWT.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4651.java