error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9609.java
text:
```scala
t@@ypeDeclaration.createsInternalConstructor(!parser().diet, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9609.java