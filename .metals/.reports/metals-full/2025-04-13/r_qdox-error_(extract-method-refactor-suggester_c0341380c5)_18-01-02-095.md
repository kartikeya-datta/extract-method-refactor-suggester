error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3402.java
text:
```scala
i@@ndexTemplateService.removeTemplates(new MetaDataIndexTemplateService.RemoveRequest(request.name()), new MetaDataIndexTemplateService.RemoveListener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3402.java