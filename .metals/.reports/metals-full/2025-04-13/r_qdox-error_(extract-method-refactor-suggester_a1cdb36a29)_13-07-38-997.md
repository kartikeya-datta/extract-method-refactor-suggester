error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1503.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1503.java
text:
```scala
public v@@oid run(ILocalCluster cluster) throws Exception;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1503.java