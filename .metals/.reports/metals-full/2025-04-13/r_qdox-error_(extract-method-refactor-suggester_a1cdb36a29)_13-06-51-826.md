error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5164.java
text:
```scala
r@@emoteLogger = hierarchy.getLogger(event.categoryName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5164.java