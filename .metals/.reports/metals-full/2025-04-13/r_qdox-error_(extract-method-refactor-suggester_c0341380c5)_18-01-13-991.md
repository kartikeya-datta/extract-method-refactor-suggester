error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15395.java
text:
```scala
r@@eturn component.isEnabled();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15395.java