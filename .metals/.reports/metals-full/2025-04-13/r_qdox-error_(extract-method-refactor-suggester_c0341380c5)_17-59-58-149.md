error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9226.java
text:
```scala
X@@BooleanFilter booleanFilter = (XBooleanFilter) filteredQuery.getFilter();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9226.java