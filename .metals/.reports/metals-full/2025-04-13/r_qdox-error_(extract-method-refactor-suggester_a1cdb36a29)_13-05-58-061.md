error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13333.java
text:
```scala
c@@opy.importUnique(u, _conf.getDBDictionaryInstance());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13333.java