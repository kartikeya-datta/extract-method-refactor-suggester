error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6524.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6524.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6524.java
text:
```scala
s@@tartActivityForResult(IssuesViewActivity.createIntent(created, repository), ISSUE_VIEW);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6524.java