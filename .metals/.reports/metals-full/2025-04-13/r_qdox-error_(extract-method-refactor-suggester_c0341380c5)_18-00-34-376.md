error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12551.java
...
```java
offset: 1048
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12551.java
text:
```scala
interface Constants {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12551.java