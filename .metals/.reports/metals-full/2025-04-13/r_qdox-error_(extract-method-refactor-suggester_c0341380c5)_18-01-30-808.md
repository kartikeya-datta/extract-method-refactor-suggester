error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1726.java
text:
```scala
B@@eanPopulator.getNamedInstance(ObjectStoreEnvironmentBean.class, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1726.java