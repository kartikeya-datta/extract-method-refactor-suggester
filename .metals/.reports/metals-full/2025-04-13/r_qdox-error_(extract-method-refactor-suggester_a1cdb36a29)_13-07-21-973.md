error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14356.java
text:
```scala
i@@f (parent != null && !parent.exists() && !parent.mkdirs()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14356.java