error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1974.java
text:
```scala
r@@eturn TransportActions.Admin.Indices.EXISTS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1974.java