error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2331.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2331.java
text:
```scala
static final A@@ttributeDefinition[] ATTRIBUTES = { CommonAttributes.DESTINATION_ENTRIES, CommonAttributes.SELECTOR, CommonAttributes.DURABLE };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2331.java