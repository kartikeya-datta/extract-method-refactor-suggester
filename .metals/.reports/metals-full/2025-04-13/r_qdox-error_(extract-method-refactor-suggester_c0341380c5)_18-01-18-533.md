error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5659.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5659.java
text:
```scala
r@@eturn (Clipboard)Class.forName("com.badlogic.gdx.scenes.scene2d.ui.utils.DesktopClipboard").newInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5659.java