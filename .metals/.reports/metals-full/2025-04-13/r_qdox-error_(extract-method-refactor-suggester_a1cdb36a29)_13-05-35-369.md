error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6953.java
text:
```scala
l@@ogger.debug("Using [byte_buffer] store with buffer_size[{}], cache_size[{}], direct[{}], warm_cache[{}]",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6953.java