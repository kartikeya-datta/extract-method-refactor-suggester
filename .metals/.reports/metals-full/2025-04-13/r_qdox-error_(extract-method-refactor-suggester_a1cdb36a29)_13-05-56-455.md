error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3562.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3562.java
text:
```scala
private volatile b@@oolean valid;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3562.java