error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/981.java
text:
```scala
e@@ffect.reset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/981.java