error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9425.java
text:
```scala
b@@oolean sourceIsReadOnly = srcFolder.isReadOnly();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9425.java