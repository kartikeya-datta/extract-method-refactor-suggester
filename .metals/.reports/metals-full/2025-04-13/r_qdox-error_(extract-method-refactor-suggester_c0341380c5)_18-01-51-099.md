error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14649.java
text:
```scala
t@@extFileChange.addEdit(AnnotationUtils.createRemoveImportTextEdit(method, WebMethod.class.getCanonicalName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14649.java