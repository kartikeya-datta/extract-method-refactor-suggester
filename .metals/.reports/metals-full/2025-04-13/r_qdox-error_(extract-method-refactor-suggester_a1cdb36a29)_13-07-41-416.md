error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1631.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1631.java
text:
```scala
a@@ctivePage.showView(ProgressManager.PROGRESS_VIEW_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1631.java