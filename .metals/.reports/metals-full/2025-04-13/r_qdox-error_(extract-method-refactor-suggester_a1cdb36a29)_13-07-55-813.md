error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2380.java
text:
```scala
t@@hrow new NotPresentException(Util.bind("element.notPresent"/*nonNLS*/));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2380.java