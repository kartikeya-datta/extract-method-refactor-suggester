error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9856.java
text:
```scala
n@@ew Boolean(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9856.java