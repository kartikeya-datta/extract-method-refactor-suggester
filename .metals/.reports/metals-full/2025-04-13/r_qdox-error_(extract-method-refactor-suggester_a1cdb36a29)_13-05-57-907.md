error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/251.java
text:
```scala
O@@S.objc_msgSend_stret(result, this.id, OS.sel_paperSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/251.java