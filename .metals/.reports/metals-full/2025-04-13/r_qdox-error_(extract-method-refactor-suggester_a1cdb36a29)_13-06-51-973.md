error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9696.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9696.java
text:
```scala
l@@ogger.warn("failed to read commit point [{}]", e, name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9696.java