error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3480.java
text:
```scala
c@@lusterService.state().metaData().concreteIndices(request.indicesOptions(), request.indices());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3480.java