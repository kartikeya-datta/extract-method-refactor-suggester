error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3657.java
text:
```scala
n@@sILocalFile localFile = new nsILocalFile (retVal[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3657.java