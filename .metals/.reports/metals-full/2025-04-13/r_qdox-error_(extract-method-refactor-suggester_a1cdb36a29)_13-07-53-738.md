error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1286.java
text:
```scala
m@@ultiField.declarations[length] = field;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1286.java