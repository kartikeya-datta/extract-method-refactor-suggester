error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9959.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9959.java
text:
```scala
static final A@@ttributeDefinition[] ATTRIBUTES = Logging.join(DEFAULT_ATTRIBUTES, AUTOFLUSH, APPEND, FILE, NAMED_FORMATTER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9959.java