error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2965.java
text:
```scala
i@@f (getBroker().getAutoDetach() == AutoDetach.DETACH_NONE)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2965.java