error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8241.java
text:
```scala
s@@equence = KeySupport.parseSequence(string, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8241.java