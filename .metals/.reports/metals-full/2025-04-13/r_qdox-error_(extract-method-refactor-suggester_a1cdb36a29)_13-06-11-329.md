error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8580.java
text:
```scala
s@@t.open(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8580.java