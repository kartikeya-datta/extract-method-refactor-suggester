error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6583.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6583.java
text:
```scala
public N@@avigatorLabel(final String id, final AbstractDataTable dataView)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6583.java