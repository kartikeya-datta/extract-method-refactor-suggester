error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1310.java
text:
```scala
r@@es.setResponseData(response, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1310.java