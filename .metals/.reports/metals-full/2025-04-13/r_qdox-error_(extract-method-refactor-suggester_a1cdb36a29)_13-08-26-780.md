error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10304.java
text:
```scala
i@@nt x = getPointAtOffset(caretOffset).x;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10304.java