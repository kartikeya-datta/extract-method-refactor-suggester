error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8868.java
text:
```scala
f@@or (Enumeration e = properties.propertyNames(); e.hasMoreElements(); ) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8868.java