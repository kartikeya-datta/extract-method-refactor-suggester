error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3206.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3206.java
text:
```scala
public static final C@@lusterBlock INDEX_CLOSED_BLOCK = new ClusterBlock(4, "index closed", false, false, ClusterBlockLevel.READ_WRITE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3206.java