error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8843.java
text:
```scala
n@@ew AsmHierarchyBuilder(new CompilationResult(cu, 0, 0, 0)).visit(local, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8843.java