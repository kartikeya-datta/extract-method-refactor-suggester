error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3452.java
text:
```scala
a@@llPossibleSubtypes = CharOperation.NO_STRINGS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3452.java