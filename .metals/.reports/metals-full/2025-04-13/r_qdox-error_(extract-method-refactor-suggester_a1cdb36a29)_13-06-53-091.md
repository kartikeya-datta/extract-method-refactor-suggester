error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7056.java
text:
```scala
i@@f (typeParameterNames != null && typeParameterNames.length > 0) { // TODO (jerome) fix once ISourceType's spec & SourceTypeElementInfo match
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7056.java