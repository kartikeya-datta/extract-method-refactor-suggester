error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/587.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/587.java
text:
```scala
i@@f(identifierPtr < 0 && expressionPtr > 0 && expressionStack[expressionPtr] == expression) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/587.java