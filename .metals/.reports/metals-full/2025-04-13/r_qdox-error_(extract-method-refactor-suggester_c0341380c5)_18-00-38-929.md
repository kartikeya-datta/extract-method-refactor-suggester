error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8706.java
text:
```scala
l@@ogger.info("[cluster_shutdown]: done shutting down all nodes except master, proceeding to master");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8706.java