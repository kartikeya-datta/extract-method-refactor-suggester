error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7345.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7345.java
text:
```scala
public static final S@@tring DEFAULT_THEME = "org.eclipse.ui.defaultTheme"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7345.java