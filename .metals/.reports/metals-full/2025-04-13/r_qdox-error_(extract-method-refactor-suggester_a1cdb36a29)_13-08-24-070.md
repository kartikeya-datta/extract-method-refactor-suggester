error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11451.java
text:
```scala
p@@ublic class RadioGroupTestPage2 extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11451.java