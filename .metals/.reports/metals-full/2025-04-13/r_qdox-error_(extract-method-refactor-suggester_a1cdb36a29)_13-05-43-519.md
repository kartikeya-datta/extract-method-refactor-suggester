error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4014.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4014.java
text:
```scala
public static final S@@erviceName SERVICE_NAME_BASE = ServiceName.JBOSS.append("connection-factory").append(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4014.java