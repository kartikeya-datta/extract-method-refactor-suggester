error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12653.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12653.java
text:
```scala
protected P@@atchElementTestStepBuilder internalAddModification(ContentModification modification) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12653.java