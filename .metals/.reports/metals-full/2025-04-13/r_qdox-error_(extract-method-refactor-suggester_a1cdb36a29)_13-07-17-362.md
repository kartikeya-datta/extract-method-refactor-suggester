error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9201.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9201.java
text:
```scala
p@@references.setDefault(COMPILER_PB_SUPERFLUOUS_SEMICOLON, WARNING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9201.java