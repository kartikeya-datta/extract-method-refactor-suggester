error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5856.java
text:
```scala
S@@tring script = Streams.copyToString(new InputStreamReader(new FileInputStream(file), Streams.UTF8));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5856.java