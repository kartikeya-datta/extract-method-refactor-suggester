error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2464.java
text:
```scala
m@@ap.remove(new Long(contact.getId()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2464.java