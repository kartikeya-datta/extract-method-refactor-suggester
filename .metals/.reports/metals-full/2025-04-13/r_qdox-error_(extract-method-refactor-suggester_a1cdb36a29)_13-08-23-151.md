error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2648.java
text:
```scala
t@@hrow MESSAGES.illegalArgumentNull("bundle");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2648.java