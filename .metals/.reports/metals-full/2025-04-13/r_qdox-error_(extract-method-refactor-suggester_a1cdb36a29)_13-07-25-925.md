error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/97.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/97.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/97.java
text:
```scala
i@@f (otherType.isEquivalentTo(this)) return true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/97.java