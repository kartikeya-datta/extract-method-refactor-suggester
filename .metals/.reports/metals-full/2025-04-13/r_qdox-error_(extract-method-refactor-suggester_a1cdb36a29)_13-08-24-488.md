error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/152.java
text:
```scala
e@@nterState('"', QuotesState.QUOTES_INCLUDED_KEEP_ESCAPES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/152.java