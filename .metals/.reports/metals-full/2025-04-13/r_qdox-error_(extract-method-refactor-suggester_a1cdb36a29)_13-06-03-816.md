error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2139.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2139.java
text:
```scala
private v@@oid executeGet(CommonTree ast) throws TException, NotFoundException, InvalidRequestException, UnavailableException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2139.java