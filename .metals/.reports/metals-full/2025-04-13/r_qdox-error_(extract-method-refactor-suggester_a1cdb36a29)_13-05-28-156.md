error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2578.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2578.java
text:
```scala
public K@@oreanFilterFactory(Map<String, String> args) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2578.java