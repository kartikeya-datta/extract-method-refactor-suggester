error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2851.java
text:
```scala
t@@extsToHighlight = lookup.source().extractRawValues(hitContext.getSourcePath(mapper.names().sourcePath()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2851.java