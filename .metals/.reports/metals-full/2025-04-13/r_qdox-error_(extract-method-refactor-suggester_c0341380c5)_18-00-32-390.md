error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4787.java
text:
```scala
L@@og.d(TAG, "Syncing repos for " + org.getLogin());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4787.java