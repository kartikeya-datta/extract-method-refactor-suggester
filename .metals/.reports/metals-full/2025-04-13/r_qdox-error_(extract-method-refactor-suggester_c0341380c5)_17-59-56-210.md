error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1234.java
text:
```scala
C@@hooseTemplateDialog d = new ChooseTemplateDialog(getFrameMediator().getView().getFrame(), list);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1234.java