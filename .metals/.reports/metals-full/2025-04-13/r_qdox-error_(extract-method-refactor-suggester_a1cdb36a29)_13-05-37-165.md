error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1272.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1272.java
text:
```scala
t@@hrow new IllegalStateException("frame buffer couldn't be constructed: unknown error " + result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1272.java