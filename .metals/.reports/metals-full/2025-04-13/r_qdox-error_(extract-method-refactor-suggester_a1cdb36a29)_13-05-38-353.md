error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9528.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9528.java
text:
```scala
public H@@ashableMarshalledValue(T object, MarshallingContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9528.java