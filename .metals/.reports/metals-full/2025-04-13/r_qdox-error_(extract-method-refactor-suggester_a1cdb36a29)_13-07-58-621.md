error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9372.java
text:
```scala
O@@S.ATSUSetHighlightingMethod(layout, OS.kRedrawHighlighting, new ATSUUnhighlightData());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9372.java