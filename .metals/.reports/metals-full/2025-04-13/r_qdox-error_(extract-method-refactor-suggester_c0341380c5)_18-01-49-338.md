error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/721.java
text:
```scala
i@@f (!actionInfo.complainIfUnreachable(action, currentScope, false)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/721.java