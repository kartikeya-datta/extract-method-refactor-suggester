error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/789.java
text:
```scala
n@@ew JoglApplication(test, testName, 800, 480, test.needsGL20());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/789.java