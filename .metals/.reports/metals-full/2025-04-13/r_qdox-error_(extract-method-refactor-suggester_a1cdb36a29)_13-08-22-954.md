error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7657.java
text:
```scala
S@@tring[] indices = currentState.metaData().concreteIndicesIgnoreMissing(request.filteredIndices());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7657.java