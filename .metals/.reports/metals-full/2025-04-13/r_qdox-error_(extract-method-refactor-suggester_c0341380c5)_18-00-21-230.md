error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5549.java
text:
```scala
p@@ostingsProvider, docValuesProvider, null, null, fieldDataSettings, indexSettings, MultiFields.empty(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5549.java