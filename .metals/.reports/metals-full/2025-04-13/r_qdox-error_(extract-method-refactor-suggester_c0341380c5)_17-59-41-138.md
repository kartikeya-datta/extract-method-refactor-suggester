error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/519.java
text:
```scala
Q@@uery query = new DeletionAwareConstantScoreQuery(filter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/519.java