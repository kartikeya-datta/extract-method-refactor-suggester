error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8638.java
text:
```scala
s@@uper(shaderProgram, renderable, false, false, false, 0, 0, 0, numBones);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8638.java