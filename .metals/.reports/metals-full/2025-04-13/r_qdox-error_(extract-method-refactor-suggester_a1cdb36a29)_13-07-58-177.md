error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/750.java
text:
```scala
g@@etBool(CfgProp.SOLR_LOGGING_ENABLED, true),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/750.java