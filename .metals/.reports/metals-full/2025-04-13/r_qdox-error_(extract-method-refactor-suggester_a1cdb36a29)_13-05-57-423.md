error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9570.java
text:
```scala
d@@estDir = destFile.getParentFile();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9570.java