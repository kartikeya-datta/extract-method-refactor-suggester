error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3927.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3927.java
text:
```scala
public static S@@tring stripAccents(String input) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3927.java