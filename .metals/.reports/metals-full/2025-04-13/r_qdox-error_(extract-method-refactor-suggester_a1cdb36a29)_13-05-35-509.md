error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1135.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1135.java
text:
```scala
public v@@oid invalidUsageOfAnnotationDeclarations(TypeDeclaration annotationTypeDeclaration) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1135.java