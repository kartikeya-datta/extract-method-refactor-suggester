error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1717.java
text:
```scala
p@@roperties.add(result.getFieldName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1717.java