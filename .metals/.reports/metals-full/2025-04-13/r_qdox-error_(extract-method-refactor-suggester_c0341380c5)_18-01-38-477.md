error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1983.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1983.java
text:
```scala
public Y@@ellOnFlushAndCloseOutputStream(final OutputStream proxy, final boolean yellForFlush, final boolean yellForClose) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1983.java