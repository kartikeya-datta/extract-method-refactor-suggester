error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3156.java
text:
```scala
_@@cache.removeAll(cls, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3156.java