error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13806.java
text:
```scala
w@@idget.initWithFrame(new NSRect());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13806.java