error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4045.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4045.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4045.java
text:
```scala
r@@eturn PlatformMBeanDescriptions.getGetThreadInfosDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4045.java