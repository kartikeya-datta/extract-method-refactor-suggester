error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16333.java
text:
```scala
r@@eturn PackageResource.get(getScope(), getName(), locale, style);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16333.java