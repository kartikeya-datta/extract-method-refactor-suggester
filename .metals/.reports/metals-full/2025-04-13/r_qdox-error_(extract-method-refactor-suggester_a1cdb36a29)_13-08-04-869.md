error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3477.java
text:
```scala
d@@oTest(10,10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3477.java