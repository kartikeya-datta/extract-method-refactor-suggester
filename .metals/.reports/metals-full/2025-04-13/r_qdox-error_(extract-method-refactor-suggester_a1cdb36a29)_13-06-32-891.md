error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2966.java
text:
```scala
g@@etSite().selectPart(getPartForTab(tabItem));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2966.java