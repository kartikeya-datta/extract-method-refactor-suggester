error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3255.java
text:
```scala
T@@uple<XContentType, Map<String, Object>> mapTuple = XContentHelper.convertToMap(data, dataOffset, dataLength, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3255.java