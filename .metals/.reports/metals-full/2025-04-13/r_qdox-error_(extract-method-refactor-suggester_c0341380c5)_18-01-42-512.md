error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10845.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10845.java
text:
```scala
t@@hrows TaskException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10845.java