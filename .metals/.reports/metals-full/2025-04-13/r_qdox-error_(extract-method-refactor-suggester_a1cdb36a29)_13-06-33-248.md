error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2300.java
text:
```scala
h@@eaders.remove(node);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2300.java