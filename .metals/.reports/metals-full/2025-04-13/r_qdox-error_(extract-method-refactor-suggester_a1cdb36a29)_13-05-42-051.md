error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9733.java
text:
```scala
g@@etMarkup().getMarkupResourceStream().getWicketNamespace());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9733.java