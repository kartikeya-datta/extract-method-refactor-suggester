error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3891.java
text:
```scala
t@@hrow st.exception("invalid unknown RR encoding");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3891.java