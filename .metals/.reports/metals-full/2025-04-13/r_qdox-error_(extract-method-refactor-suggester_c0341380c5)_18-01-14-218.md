error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/262.java
text:
```scala
R@@eferenceBinding match = ((ReferenceBinding)receiverErasure).findSuperTypeWithSameErasure(fieldBinding.declaringClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/262.java