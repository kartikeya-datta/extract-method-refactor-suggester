error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4954.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4954.java
text:
```scala
protected v@@oid lockInternal(OpenJPAStateManager sm, int level, int timeout,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4954.java