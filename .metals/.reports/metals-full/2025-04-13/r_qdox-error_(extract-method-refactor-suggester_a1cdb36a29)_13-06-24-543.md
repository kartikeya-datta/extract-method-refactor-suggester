error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2376.java
text:
```scala
i@@f(renderable.worldTransform.det3x3() == 0) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2376.java