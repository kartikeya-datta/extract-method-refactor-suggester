error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2769.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2769.java
text:
```scala
public v@@oid selectNode(String shortURL)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2769.java