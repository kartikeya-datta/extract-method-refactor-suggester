error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1555.java
text:
```scala
t@@his.binding = scope.findMethod((ReferenceBinding) this.resolvedType, TypeConstants.INIT, pseudoArgs, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1555.java