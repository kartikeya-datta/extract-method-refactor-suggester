error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1803.java
text:
```scala
f@@ieldConfig.getField());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1803.java