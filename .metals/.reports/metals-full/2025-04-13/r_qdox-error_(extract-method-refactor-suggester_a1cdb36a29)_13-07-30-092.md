error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3116.java
text:
```scala
r@@eturn new BroadcastPingResponse(shardsResponses.length(), successfulShards, failedShards, shardFailures);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3116.java