error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5143.java
...
```java
offset: 851
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5143.java
text:
```scala
...
p@@ackage org.elasticsearch.common.recycler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5143.java