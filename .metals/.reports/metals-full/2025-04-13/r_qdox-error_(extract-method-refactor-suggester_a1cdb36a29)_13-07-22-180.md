error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8850.java
text:
```scala
I@@ViewPart view = wp.showView("org.eclipse.ecf.example.collab.ui.CollabRosterView");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8850.java