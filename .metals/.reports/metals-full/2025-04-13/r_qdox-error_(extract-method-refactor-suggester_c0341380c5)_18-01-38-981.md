error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5200.java
text:
```scala
r@@eturn null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5200.java