error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7686.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7686.java
text:
```scala
private static final S@@tring FILE = "data/engine-2.ogg";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7686.java