error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2822.java
text:
```scala
C@@onnector conn = st.getConnector().get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2822.java