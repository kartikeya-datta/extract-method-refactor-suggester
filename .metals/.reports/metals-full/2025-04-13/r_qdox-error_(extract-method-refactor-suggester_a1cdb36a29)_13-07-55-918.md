error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6097.java
text:
```scala
b@@oolean drawGripper (int x, int y, int width, int height, boolean vertical) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6097.java