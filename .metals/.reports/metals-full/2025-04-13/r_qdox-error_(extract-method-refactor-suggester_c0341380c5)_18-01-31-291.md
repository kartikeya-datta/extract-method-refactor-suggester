error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2076.java
text:
```scala
m@@ap.getLayers().addLayer(layer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2076.java