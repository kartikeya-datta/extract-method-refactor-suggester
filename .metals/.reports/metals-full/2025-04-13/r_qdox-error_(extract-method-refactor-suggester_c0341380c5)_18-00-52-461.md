error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4024.java
text:
```scala
r@@eturn ((IResultList) element).getResults().size() + Messages.UserSearchLabelProvider_ContactsFound;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4024.java