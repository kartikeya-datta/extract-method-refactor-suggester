error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7965.java
text:
```scala
b@@uilder.append('-').append(NetworkUtils.getLocalHostName("__default_host__"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7965.java