error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8561.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8561.java
text:
```scala
s@@b.append("Failed to execute phase [").append(phaseName).append("], ").append(msg);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8561.java