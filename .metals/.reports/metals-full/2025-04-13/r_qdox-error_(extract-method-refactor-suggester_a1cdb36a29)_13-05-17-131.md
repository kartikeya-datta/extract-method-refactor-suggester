error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14895.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14895.java
text:
```scala
n@@ew BreadCrumbPanelLink(this, "linkToSecond", this, SecondPanel.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14895.java