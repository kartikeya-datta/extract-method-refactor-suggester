error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13924.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13924.java
text:
```scala
i@@f (!stopped && isEnabled(getComponent()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13924.java