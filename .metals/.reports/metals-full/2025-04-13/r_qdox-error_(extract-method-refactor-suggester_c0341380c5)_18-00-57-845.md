error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6977.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6977.java
text:
```scala
private static final S@@tring DEFAULT_RANGE = "100.0"; // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6977.java