error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7577.java
text:
```scala
i@@nt gdipFont = GC.createGdipFont(hDC, font.handle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7577.java