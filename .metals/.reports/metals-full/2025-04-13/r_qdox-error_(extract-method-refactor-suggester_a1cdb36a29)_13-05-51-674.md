error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7415.java
text:
```scala
i@@f (table == null || table.isDisposed()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7415.java