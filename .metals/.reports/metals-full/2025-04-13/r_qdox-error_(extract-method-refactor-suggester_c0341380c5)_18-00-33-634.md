error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14479.java
text:
```scala
s@@ervice = updateContext.getServiceRegistry().getRequiredService(LogServices.ROOT_LOGGER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14479.java