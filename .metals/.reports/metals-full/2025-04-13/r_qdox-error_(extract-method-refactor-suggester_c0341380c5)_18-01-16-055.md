error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5507.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(true, ATTRIBUTE_DEFINITIONS), new SecurityRealmChildRemoveHandler(true),
...
public class PlugInAuthenticationResourceDefinition extends AbstractPlugInAuthResourceDefinition {
    ...
    public PlugInAuthenticationResourceDefinition() {
        super(PathElement.pathElement(ModelDescriptionConstants.AUTHENTICATION, ModelDescriptionConstants.PLUG_IN),
                ...
                new SecurityRealmChildAddHandler(true, ATTRIBUTE_DEFINITIONS), new SecurityRealmChildRemoveHandler(true, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5507.java