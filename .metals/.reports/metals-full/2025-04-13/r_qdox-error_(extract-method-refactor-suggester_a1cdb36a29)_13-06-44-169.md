error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10456.java
text:
```scala
S@@tring lineSeparator = "\r\n";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10456.java