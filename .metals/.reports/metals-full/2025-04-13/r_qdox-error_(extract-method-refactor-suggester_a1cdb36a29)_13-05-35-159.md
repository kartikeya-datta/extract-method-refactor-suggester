error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13831.java
text:
```scala
S@@tringBuilder buf = new StringBuilder("{containsselector text: ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13831.java