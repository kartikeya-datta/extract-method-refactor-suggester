error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4327.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4327.java
text:
```scala
m@@etaData.getPhysicalFile().getParentFile().getParentFile().toURI().toURL() :
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4327.java