error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9742.java
text:
```scala
n@@ode.client().admin().indices().putMapping(putMappingRequest("test").source(mapping)).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9742.java