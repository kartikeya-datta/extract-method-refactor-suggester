error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3706.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3706.java
text:
```scala
private static final S@@tring SECONDS = "RunTime.seconds"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3706.java