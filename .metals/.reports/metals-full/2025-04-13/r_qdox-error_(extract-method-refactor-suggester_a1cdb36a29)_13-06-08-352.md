error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6909.java
text:
```scala
o@@utput.append("<CompletionOnJavadocParamNameReference:"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6909.java