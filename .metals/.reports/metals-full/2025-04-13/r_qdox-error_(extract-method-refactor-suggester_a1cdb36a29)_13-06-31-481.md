error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10882.java
text:
```scala
b@@uilder.addDependency(DependencyType.OPTIONAL, MBEAN_SERVER_NAME, MBeanServer.class, INSTANCE.getMBeanServerInjector());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10882.java