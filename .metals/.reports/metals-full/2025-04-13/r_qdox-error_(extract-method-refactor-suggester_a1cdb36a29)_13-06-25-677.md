error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8206.java
...
```java
offset: 699
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8206.java
text:
```scala
...
p@@ackage org.springframework.websocket.client;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8206.java