error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12469.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12469.java
text:
```scala
public  L@@ist<VEXElement> getElements();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12469.java