error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11051.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11051.java
text:
```scala
public final T@@extTemplate interpolate(Map variables)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11051.java