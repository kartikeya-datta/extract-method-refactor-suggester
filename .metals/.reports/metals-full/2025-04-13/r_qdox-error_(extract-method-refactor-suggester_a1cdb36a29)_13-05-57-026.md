error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8627.java
text:
```scala
i@@f (columnIndex != columnCount || columnCount == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8627.java