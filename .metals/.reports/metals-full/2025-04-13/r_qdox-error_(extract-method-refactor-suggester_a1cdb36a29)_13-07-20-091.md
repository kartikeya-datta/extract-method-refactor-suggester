error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3581.java
text:
```scala
r@@esponse.renderJavaScriptReference(getYuiLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3581.java