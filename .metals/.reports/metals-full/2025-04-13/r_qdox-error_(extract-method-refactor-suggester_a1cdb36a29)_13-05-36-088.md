error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9279.java
text:
```scala
n@@ull, null, "menu_edit_copy_tooltip"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9279.java