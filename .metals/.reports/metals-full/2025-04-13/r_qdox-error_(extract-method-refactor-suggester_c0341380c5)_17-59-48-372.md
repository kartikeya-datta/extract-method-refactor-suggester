error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/532.java
text:
```scala
t@@his.hierarchy.progressMonitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/532.java