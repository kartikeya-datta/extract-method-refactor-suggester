error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16577.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16577.java
text:
```scala
public v@@oid createProxyObject(ID target,String classname,String name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16577.java