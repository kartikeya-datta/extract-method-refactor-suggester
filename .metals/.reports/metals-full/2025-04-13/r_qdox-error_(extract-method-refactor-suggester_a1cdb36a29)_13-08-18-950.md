error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6962.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6962.java
text:
```scala
c@@ontext.dfsResult().maxDoc(context.searcher().getIndexReader().maxDoc());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6962.java