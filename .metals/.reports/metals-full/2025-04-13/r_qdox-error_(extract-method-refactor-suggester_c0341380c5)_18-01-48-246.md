error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3748.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3748.java
text:
```scala
public v@@oid testDeprecatedPositionIncrementSettingWithVerions() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3748.java