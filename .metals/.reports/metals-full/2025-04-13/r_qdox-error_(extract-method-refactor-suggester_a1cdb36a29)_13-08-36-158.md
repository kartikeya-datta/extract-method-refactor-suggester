error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3037.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3037.java
text:
```scala
final S@@erviceBuilder<?> builder = AsynchronousService.addService(target, CacheService.getServiceName(containerName, cacheName), service)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3037.java