error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8643.java
text:
```scala
s@@uper(AbstractSocketBindingResourceDefinition.CLIENT_MAPPINGS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8643.java