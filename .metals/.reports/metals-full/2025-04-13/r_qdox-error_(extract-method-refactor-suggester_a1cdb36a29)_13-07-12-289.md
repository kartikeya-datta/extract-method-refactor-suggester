error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5058.java
text:
```scala
s@@uper(indices);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5058.java