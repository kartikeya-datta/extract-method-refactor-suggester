error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4713.java
text:
```scala
Q@@uery query = queryParser.parse(querySource, querySourceOffset, querySourceLength).query();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4713.java