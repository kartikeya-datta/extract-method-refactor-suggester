error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7510.java
text:
```scala
S@@trictMaxPoolAdd.INSTANCE.installRuntimeService(context, operation, model, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7510.java