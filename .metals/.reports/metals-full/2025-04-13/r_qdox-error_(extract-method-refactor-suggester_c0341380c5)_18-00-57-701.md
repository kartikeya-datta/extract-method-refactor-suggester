error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3598.java
text:
```scala
G@@uiPackage.getInstance().removeNode(node.getTestElement());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3598.java