error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9003.java
text:
```scala
f@@inal class ProjectEntry
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9003.java