error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5132.java
text:
```scala
a@@ssertEquals("Flash attribute", value, result.getFlashMap().get(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5132.java