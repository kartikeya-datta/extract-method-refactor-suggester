error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2001.java
...
```java
offset: 836
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2001.java
text:
```scala
 ...
 ******************************************************************************/
p@@ackage com.badlogic.gdx.scenes.scene2d.actions;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2001.java