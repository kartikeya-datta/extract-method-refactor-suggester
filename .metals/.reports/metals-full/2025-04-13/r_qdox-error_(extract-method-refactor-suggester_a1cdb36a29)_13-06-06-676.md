error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6172.java
text:
```scala
c@@ategories to <code>null</code>, their additivity flag to
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6172.java