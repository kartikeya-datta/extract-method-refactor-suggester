error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2472.java
text:
```scala
t@@his.hasErrors = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2472.java