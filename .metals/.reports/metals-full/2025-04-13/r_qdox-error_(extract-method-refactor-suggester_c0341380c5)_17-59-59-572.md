error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7964.java
text:
```scala
P@@artialOrder.sort(partiallyComparableAdvisors);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7964.java