error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3722.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3722.java
text:
```scala
final S@@ubsystemRegistration subsystem = context.registerSubsystem(SUBSYSTEM_NAME, 1, 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3722.java