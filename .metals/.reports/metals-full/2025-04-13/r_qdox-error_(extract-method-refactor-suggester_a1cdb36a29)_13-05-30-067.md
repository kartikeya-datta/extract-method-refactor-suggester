error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5647.java
text:
```scala
i@@f (typeBinding2 == null) return null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5647.java