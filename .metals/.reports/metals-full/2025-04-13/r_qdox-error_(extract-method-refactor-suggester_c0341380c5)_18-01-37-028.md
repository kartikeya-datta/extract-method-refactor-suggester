error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3531.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3531.java
text:
```scala
protected V@@iewHoldingListAdapter<PullRequest> adapterFor(List<PullRequest> pullRequests) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3531.java