error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12940.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12940.java
text:
```scala
public S@@OWrapper(SOConfig aConfig, ISharedObject obj, SOContainer cont) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12940.java