error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4264.java
text:
```scala
b@@oolean signedIn = cycle.getSession().getProperty("signin2.user") != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4264.java