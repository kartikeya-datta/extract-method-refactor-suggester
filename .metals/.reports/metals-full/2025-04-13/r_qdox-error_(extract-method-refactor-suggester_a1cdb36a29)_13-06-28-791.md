error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1260.java
text:
```scala
r@@eturn this.expressionType = binding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1260.java