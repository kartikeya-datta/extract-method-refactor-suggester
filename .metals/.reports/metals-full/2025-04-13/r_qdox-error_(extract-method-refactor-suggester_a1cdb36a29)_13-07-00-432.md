error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9022.java
text:
```scala
m@@sg.append("More than one bean of type [");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9022.java