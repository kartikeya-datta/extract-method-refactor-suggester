error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8133.java
text:
```scala
r@@eturn new CacheStats(fieldDataCache.evictions(), filterCache.evictions(), fieldDataCache.sizeInBytes(), filterCache.sizeInBytes(), filterCache.count(), bloomCache.sizeInBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8133.java