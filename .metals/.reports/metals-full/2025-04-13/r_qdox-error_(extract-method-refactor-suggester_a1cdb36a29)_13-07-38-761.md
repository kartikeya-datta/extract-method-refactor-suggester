error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14650.java
text:
```scala
t@@extFileChange.addEdit(AnnotationUtils.createRemoveImportTextEdit(source.findPrimaryType(), WebService.class.getCanonicalName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14650.java