error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5873.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5873.java
text:
```scala
public static final S@@tring ATT_CONTAINER_TYPE_NAME = "containerFactoryName";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5873.java