error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1615.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1615.java
text:
```scala
public W@@ebSocketHandler getDelegate() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1615.java