error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4747.java
text:
```scala
r@@eturn blob.get(pos++) & 0xff;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4747.java