error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8433.java
text:
```scala
t@@his(CacheContainerResourceDefinition.CACHE_CONTAINER_ATTRIBUTES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8433.java