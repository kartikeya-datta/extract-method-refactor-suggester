error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9717.java
text:
```scala
t@@hrow new ResourceStreamNotFoundException("The requested resource was not found: " + url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9717.java