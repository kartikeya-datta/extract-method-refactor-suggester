error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12436.java
text:
```scala
a@@utolinkStatus.push(Boolean.valueOf(autolinking));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12436.java