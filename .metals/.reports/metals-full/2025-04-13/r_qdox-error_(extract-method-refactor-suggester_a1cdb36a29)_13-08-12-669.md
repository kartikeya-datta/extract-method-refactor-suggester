error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/103.java
text:
```scala
s@@tyle = checkBits (style, SWT.PUSH, SWT.ARROW, SWT.CHECK, SWT.RADIO, SWT.TOGGLE, /*COMMAND_LINK ? SWT.COMMAND :*/ 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/103.java