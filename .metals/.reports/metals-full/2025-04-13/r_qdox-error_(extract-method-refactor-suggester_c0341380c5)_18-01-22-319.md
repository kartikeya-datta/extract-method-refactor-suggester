error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10409.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10409.java
text:
```scala
p@@ool = new NSAutoreleasePool(id.integerValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10409.java