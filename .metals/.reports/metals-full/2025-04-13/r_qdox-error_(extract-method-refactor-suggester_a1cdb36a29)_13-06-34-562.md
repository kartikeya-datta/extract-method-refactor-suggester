error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8782.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8782.java
text:
```scala
public E@@ntryResult[] queryIn(Index index) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8782.java