error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6054.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6054.java
text:
```scala
p@@ublic static class NonPageCachingDummyWebApplication extends DummyWebApplication
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6054.java