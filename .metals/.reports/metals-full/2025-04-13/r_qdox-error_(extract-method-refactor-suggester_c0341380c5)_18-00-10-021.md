error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13243.java
text:
```scala
p@@arent.sendSelectionEvent (SWT.Selection, event, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13243.java