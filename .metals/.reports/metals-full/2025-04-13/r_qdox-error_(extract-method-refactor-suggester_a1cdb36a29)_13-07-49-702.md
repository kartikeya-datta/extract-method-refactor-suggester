error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12875.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12875.java
text:
```scala
public G@@uiceInjectorHolder(final Injector injector)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12875.java