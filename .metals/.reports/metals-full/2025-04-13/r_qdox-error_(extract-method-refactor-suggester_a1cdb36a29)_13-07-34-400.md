error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12410.java
text:
```scala
s@@uper(false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12410.java