error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4404.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4404.java
text:
```scala
public static final S@@tring TEMPLATES      = "templates"; // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4404.java