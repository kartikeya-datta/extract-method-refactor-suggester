error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8818.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8818.java
text:
```scala
public static final S@@tring JSON_TYPE = "_all";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8818.java