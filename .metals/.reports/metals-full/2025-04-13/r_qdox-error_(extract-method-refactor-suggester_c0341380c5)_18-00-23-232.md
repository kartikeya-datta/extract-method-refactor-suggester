error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4744.java
text:
```scala
i@@f (iconName == null) iconName = ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4744.java