error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2008.java
text:
```scala
B@@obTest.class, ImageScaleTest.class, TableLayoutTest.class, Box2DTest.class, BulletTestCollection.class, InterpolationTest.class, TouchpadTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2008.java