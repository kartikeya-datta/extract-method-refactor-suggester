error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3271.java
text:
```scala
i@@f (common + 1 == baseUrlSize && urlSegments.isEmpty())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3271.java