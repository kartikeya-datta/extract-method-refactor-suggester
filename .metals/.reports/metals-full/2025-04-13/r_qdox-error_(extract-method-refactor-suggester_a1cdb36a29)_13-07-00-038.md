error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4785.java
text:
```scala
a@@rguments.resolveBindings(scope, bindings, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4785.java