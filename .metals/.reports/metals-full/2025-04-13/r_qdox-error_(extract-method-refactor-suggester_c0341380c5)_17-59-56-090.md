error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9716.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9716.java
text:
```scala
final S@@tring[] nodesIds = state.nodes().resolveNodesIds(request.nodesIds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9716.java