error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6028.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6028.java
text:
```scala
public static final S@@erviceName SERVICE_NAME = ServiceName.JBOSS.append("osgi", "bundlemanager");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6028.java