error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3621.java
text:
```scala
r@@eturn this.resolvedType = scope.enclosingSourceType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3621.java