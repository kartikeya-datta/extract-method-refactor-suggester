error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6442.java
text:
```scala
l@@abel.render(markupStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6442.java