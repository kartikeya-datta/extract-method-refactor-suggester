error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1653.java
text:
```scala
b@@yte[] body = response.getMessageBody();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1653.java