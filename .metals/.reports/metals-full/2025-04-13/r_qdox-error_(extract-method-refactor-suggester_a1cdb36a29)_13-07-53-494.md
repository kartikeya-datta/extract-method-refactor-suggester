error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14675.java
text:
```scala
J@@NDIBasedSecurityManagement securityManagement = new JNDIBasedSecurityManagement();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14675.java