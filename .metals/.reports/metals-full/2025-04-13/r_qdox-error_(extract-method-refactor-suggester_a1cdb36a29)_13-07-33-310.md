error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1528.java
text:
```scala
s@@uper(page, page, Page.REDIRECT_LISTENER_INTERFACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1528.java