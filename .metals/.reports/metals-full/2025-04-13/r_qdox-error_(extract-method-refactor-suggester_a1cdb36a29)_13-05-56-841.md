error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15298.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15298.java
text:
```scala
public v@@oid testFilterPath2() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15298.java