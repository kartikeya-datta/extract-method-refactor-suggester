error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7616.java
text:
```scala
r@@eturn DEVELOPMENT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7616.java