error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10154.java
text:
```scala
c@@hain.startDeferredResultProcessing((DeferredResult<?>) returnValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10154.java