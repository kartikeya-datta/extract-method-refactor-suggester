error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6741.java
text:
```scala
r@@eportDeprecatedType(this.resolvedType, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6741.java