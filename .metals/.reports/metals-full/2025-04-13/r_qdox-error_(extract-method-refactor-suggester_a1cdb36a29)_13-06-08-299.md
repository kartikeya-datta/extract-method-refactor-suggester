error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1738.java
text:
```scala
B@@ytesRef type = parser.utf8Bytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1738.java