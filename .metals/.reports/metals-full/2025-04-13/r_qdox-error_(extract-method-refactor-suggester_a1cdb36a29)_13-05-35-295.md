error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12796.java
text:
```scala
n@@ew OperationValidator(context.getResourceRegistration(), false, false).validateOperation(op);
...
public class ValidateOperationHandler implements OperationStepHandler, DescriptionProvider {
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        if (proxyReg != null) {
            ...
            try {
                new OperationValidator(context.getResourceRegistration()).validateOperation(op);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12796.java