error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8297.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8297.java
text:
```scala
public F@@unctionProperty clone() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8297.java