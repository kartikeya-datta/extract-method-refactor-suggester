error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11811.java
text:
```scala
p@@ublic class InlinePanelPage_8 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11811.java