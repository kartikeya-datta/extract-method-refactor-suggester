error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12261.java
text:
```scala
t@@ouch(FILE_UTILS.resolveFile(getProject().getBaseDir(),mapped[i]), modTime);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12261.java