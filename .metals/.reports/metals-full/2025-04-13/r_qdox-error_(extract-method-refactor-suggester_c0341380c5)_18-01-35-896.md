error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7352.java
text:
```scala
r@@eturn component.getPageRelativePath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7352.java