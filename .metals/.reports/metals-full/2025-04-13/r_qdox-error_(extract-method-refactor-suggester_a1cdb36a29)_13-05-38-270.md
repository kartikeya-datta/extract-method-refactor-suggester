error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15813.java
text:
```scala
C@@lass< ? > clazz = beanTypeCache == null ? null : beanTypeCache.get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15813.java