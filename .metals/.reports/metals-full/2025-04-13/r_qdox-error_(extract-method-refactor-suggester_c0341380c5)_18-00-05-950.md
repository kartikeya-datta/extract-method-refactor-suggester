error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5074.java
text:
```scala
r@@eturn KeyFormatterFactory.getFormalKeyFormatter().format(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5074.java