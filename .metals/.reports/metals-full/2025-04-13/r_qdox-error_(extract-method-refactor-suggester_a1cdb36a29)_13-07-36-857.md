error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10041.java
text:
```scala
c@@md.addLine( m_options );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10041.java