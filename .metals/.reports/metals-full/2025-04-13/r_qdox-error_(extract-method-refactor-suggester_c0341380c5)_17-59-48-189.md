error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5806.java
text:
```scala
W@@icketTagIdentifier.registerWellKnownTagName("panel");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5806.java