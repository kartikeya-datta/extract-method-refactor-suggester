error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1192.java
text:
```scala
r@@eturn "ZipNode("/*nonNLS*/ + fZipFile + ")"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1192.java