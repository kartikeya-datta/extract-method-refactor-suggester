error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8036.java
text:
```scala
r@@eturn WorkbenchMessages.Workbench_undo;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8036.java