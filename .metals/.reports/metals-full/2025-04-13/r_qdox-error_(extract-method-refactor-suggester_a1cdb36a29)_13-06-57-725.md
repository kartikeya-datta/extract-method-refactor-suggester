error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3490.java
text:
```scala
S@@erviceBuilder<SessionIdentifierCodec> build(ServiceTarget target, ServiceName name, String deploymentName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3490.java