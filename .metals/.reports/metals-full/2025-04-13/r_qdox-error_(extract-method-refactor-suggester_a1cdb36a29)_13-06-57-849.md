error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8014.java
text:
```scala
.@@append("}.bind(this));");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8014.java