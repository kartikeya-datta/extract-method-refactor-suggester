error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8543.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8543.java
text:
```scala
public static v@@oid init() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8543.java