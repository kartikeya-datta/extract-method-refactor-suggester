error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7232.java
text:
```scala
f@@or (int i = changes.size() - 1; i >= 0; i--)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7232.java