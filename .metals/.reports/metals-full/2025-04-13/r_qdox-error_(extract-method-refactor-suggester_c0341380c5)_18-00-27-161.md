error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1684.java
text:
```scala
i@@nt suffix = documentPath.toLowerCase().lastIndexOf(SUFFIX_STRING_class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1684.java