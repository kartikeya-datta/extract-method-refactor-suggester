error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5579.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5579.java
text:
```scala
Q@@ueueControlHandler.INSTANCE.registerOperations(registry);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5579.java