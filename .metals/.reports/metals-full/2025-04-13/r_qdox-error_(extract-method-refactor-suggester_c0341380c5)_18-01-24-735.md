error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8853.java
text:
```scala
e@@xistingTypes[existingTypeLength] = type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8853.java