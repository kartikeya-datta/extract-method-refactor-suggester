error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9519.java
text:
```scala
a@@dd(new AjaxLink<Void>("add")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9519.java