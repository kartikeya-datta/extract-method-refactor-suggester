error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9468.java
text:
```scala
i@@nt index = getBehaviorsRawList().indexOf(behaviour);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9468.java