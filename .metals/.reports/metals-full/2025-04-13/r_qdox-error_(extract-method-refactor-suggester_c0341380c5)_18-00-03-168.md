error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5633.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5633.java
text:
```scala
R@@oot(String s) /*throws IOException*/ {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5633.java