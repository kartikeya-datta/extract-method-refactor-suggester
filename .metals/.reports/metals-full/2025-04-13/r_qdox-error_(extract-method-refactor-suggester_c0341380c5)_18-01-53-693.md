error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8400.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8400.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8400.java
text:
```scala
a@@ssertTrue("Invalid serverId: " + serverId, serverId >= 0 && serverId < 1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8400.java