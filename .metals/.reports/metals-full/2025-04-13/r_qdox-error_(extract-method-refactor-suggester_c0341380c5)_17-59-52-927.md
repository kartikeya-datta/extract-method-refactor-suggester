error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4837.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4837.java
text:
```scala
public final v@@oid onSubmit()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4837.java