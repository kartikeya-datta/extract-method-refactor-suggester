error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10752.java
text:
```scala
p@@arams, _pkCols);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10752.java