error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8019.java
text:
```scala
s@@witch (scope.referenceType().kind()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8019.java