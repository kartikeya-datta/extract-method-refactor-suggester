error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4142.java
text:
```scala
t@@his.esVersion = Version.indexCreated(indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4142.java