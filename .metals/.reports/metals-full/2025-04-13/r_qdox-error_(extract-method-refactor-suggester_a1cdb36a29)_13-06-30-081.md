error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/608.java
text:
```scala
i@@f (config.hardKeyboardHidden == Configuration.HARDKEYBOARDHIDDEN_NO) keyboardAvailable = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/608.java