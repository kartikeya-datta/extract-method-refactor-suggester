error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6951.java
text:
```scala
w@@indow.setContentView (topView());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6951.java