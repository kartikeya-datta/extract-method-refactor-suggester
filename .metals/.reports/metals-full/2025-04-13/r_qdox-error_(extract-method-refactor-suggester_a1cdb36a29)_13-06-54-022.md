error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3193.java
text:
```scala
A@@nalysis.parseStopWords(env, settings, NorwegianAnalyzer.getDefaultStopSet(), version),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3193.java