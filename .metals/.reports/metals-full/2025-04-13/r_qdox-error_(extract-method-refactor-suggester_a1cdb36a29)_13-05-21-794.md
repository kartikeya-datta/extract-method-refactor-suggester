error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17065.java
text:
```scala
O@@S.free(pixel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17065.java