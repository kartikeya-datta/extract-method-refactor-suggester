error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/728.java
text:
```scala
b@@oolean ret = Types.isJavaAssignable( rhs, lhs.getClass() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/728.java