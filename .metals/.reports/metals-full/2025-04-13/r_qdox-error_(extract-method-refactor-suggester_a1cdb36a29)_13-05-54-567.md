error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17979.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17979.java
text:
```scala
public R@@eplicaSharedObjectDescription createDescriptionForContainer(ID containerID, ISharedObjectConfig config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17979.java