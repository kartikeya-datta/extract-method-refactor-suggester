error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8679.java
text:
```scala
P@@ublisher.class, Magazine.class, DROP_TABLES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8679.java