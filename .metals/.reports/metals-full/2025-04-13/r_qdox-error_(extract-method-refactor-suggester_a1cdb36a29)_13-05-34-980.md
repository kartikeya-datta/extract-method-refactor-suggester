error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8579.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8579.java
text:
```scala
c@@am.near = 1f;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8579.java