error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10678.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10678.java
text:
```scala
public static final S@@tring PLUGIN_ID = "org.eclipse.ecf.example.collab";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10678.java