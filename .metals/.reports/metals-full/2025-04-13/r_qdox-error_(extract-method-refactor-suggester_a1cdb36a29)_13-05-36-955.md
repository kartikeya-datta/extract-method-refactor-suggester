error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5533.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5533.java
text:
```scala
public v@@oid setListVisible (boolean visible) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5533.java