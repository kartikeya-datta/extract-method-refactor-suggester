error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/713.java
text:
```scala
p@@ool_.reset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/713.java