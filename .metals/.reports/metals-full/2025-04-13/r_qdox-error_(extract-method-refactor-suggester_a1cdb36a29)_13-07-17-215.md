error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6905.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6905.java
text:
```scala
public R@@adioChoice(MarkupContainer parent, final String id, final List choices)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6905.java