error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6052.java
text:
```scala
c@@olors.remove(definition);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6052.java