error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17895.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17895.java
text:
```scala
r@@eturn new String[] {"Selection", "ToolTipText"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17895.java