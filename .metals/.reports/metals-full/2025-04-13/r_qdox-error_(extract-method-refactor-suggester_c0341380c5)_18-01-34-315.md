error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16816.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16816.java
text:
```scala
static final P@@SVIDOMImplementationImpl singleton = new PSVIDOMImplementationImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16816.java