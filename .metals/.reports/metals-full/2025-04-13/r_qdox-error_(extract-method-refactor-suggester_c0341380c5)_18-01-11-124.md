error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/271.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/271.java
text:
```scala
protected b@@oolean execute(TransactionalProtocolClient.TransactionalOperationListener<ServerTaskExecutor.ServerOperation> listener, ServerIdentity server, ModelNode original) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/271.java