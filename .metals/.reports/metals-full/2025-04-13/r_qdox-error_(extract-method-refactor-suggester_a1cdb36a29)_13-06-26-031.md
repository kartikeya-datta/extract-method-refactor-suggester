error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/605.java
text:
```scala
S@@tring url = getPage().urlFor(Form.this, IFormSubmitListener.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/605.java