error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7242.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7242.java
text:
```scala
a@@rchive.addClasses(HttpTestSupport.class, OSGiTestSupport.class, EndpointServlet.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7242.java