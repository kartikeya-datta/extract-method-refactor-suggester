error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11559.java
text:
```scala
O@@C4JClassPreprocessorAdapter adapter = new OC4JClassPreprocessorAdapter(transformer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11559.java