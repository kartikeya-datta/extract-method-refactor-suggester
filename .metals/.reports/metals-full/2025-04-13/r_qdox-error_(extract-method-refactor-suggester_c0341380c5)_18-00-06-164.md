error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11984.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11984.java
text:
```scala
private static final C@@SVFormat format = CSVFormat.EXCEL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11984.java