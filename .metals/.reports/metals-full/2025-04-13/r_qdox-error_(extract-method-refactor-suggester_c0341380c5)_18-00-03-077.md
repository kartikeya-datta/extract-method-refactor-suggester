error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16963.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16963.java
text:
```scala
private static final M@@etaDataKey<Boolean> BROWSER_WAS_POLLED_KEY = new MetaDataKey<Boolean>(Boolean.class)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16963.java