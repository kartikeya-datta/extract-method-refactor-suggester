error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/743.java
text:
```scala
l@@ock.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/743.java