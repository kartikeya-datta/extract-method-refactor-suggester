error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2524.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2524.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2524.java
text:
```scala
P@@hrasePositions pp = new PhrasePositions(tps[i], offsets[i], i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2524.java