error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3348.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3348.java
text:
```scala
r@@enderBatch.render(lights, instances.get(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3348.java