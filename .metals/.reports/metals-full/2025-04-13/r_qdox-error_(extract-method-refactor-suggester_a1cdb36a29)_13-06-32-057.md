error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9794.java
text:
```scala
r@@eturn component.getId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9794.java