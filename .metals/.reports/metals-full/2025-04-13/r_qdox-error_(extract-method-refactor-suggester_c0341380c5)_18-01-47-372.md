error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4570.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4570.java
text:
```scala
private static final l@@ong serialVersionUID = 5409562635656244263L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4570.java