error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9827.java
text:
```scala
s@@b.append("&").append(URLEncoder.encode(entry.getKey(), "UTF-8")).append("=").append(URLEncoder.encode(entry.getValue().toString(), "UTF-8"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9827.java