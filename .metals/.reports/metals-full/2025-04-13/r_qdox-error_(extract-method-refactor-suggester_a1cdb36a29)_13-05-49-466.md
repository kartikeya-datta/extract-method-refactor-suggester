error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7143.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7143.java
text:
```scala
O@@S.object_setInstanceVariable(delegate.id, Display.SWT_OBJECT, jniRef);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7143.java