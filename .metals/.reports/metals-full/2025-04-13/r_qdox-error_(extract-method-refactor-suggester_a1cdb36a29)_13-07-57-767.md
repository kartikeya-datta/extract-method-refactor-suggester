error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1026.java
text:
```scala
b@@tAxisSweep3 broadphase = new btAxisSweep3(Vector3.tmp.set(-1000, -1000, -1000), Vector3.tmp2.set(1000, 1000, 1000), 1024);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1026.java