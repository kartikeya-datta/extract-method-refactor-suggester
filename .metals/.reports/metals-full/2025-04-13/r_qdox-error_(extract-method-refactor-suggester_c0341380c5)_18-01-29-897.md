error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4581.java
text:
```scala
I@@dentifiableObjectOutputStream ioos = new IdentifiableObjectOutputStream(sharedObjectID.getName(),bouts);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4581.java