error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9048.java
...
```java
offset: 629
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9048.java
text:
```scala
...
p@@ackage org.eclipse.ecf.provider.filetransfer.outgoing;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9048.java