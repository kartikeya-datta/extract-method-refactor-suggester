error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5438.java
text:
```scala
r@@eturn MapBackedSet.mapBackedSet(new HashedMap<E, Object>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5438.java