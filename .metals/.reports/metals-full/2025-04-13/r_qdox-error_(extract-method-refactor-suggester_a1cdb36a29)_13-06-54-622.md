error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10865.java
text:
```scala
i@@f (siblings [i] == this) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10865.java