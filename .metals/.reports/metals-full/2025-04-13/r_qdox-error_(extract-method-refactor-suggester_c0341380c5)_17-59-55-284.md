error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7678.java
text:
```scala
I@@llegalStateException couldNotBackUp(@Cause IOException cause, String absolutePath, String absolutePath1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7678.java