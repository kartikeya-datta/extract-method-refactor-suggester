error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8230.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8230.java
text:
```scala
public S@@tring suffixIos = "-ios";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8230.java