error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12508.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[155,2]

error in qdox parser
file content:
```java
offset: 4209
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12508.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12508.java