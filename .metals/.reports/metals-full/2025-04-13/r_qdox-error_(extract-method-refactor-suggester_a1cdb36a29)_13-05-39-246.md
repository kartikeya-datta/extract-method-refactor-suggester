error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16875.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16875.java
text:
```scala
r@@eturn new PolymorphicResolver ("operatorPlus").getBestFitCandidates (fdc.findFunctionCandidates ("operatorPlus", fdc.typesForParameters(createEmptyExecutionContext().getTypesystem(), Arrays.asList (params))));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16875.java