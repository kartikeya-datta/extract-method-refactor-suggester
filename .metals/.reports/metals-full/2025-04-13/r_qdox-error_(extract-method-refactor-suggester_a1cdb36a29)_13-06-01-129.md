error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3882.java
text:
```scala
d@@eclarationSourceStart = sourceStart = bodyStart = block.sourceStart;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3882.java