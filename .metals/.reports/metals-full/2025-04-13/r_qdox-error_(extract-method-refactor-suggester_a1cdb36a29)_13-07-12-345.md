error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7938.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1008,2]

error in qdox parser
file content:
```java
offset: 28573
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7938.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7938.java