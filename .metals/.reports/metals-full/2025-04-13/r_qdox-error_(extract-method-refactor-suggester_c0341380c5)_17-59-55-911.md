error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/342.java
text:
```scala
u@@i = new Stage(Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/342.java