error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6023.java
text:
```scala
H@@ostControllerLogger.ROOT_LOGGER.cannotConnect(localHostInfo.getRemoteDomainControllerHost(), localHostInfo.getRemoteDomainControllerPort(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6023.java