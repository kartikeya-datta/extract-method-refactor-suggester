error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11687.java
text:
```scala
b@@oolean implementsInterface(Class<?> intf);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11687.java