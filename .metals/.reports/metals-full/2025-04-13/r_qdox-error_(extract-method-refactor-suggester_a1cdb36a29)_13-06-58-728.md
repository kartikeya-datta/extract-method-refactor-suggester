error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4014.java
text:
```scala
g@@etJsTimeoutCall(updateInterval), getComponent());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4014.java