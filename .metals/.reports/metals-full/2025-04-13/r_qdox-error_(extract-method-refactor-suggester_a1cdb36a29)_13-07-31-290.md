error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10007.java
text:
```scala
i@@f (user.hasPermission(ScarabSecurity.MODULE__EDIT, module))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10007.java