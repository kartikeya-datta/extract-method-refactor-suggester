error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5195.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5195.java
text:
```scala
public static final S@@tring[] FILE_TYPES= new String[] {"java"/*nonNLS*/};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5195.java