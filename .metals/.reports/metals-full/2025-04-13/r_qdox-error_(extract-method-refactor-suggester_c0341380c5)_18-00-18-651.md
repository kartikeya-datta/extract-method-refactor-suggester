error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4364.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4364.java
text:
```scala
t@@ypeArguments[i] = this.environment.convertToRawType(typeVariables[i].erasure(), false /*do not force conversion of enclosing types*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4364.java