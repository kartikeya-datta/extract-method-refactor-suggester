error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12811.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12811.java
text:
```scala
private transient T@@hreadLocal perTheadNumber;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12811.java