error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6691.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6691.java
text:
```scala
s@@erver = new RemotingConnectorServer(mBeanServer.getValue(), endpoint.getValue(), new ServerInterceptorFactory());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6691.java