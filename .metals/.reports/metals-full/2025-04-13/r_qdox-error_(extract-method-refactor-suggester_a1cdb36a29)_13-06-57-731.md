error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3042.java
text:
```scala
I@@OSGLES20 gl20;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3042.java