error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12459.java
text:
```scala
s@@econds.setText(Long.toString(secsCount));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12459.java