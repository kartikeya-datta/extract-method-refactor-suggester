error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3973.java
text:
```scala
t@@his.form.loadPersistentFormComponentValues();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3973.java