error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2993.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2993.java
text:
```scala
public b@@oolean act (float delta) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2993.java