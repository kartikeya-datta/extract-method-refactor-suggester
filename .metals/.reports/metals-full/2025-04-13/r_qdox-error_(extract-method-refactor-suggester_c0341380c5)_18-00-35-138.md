error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9135.java
text:
```scala
r@@eturn MultiValueMode.MIN.select(atomicFieldData.getOrdinalsValues());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9135.java