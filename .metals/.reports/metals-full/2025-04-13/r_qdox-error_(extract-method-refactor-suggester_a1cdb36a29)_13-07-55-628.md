error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1138.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1138.java
text:
```scala
static final S@@tring VERSION = "2.0.20040608";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1138.java