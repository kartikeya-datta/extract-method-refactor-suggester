error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6934.java
text:
```scala
r@@equestor.acceptLineSeparatorPositions(scanner.getLineEnds());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6934.java