error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7277.java
text:
```scala
L@@ist<DocIdSet> sets = new ArrayList<>(filters.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7277.java