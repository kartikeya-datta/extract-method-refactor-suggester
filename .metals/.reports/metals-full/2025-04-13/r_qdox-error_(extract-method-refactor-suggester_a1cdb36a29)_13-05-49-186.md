error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3213.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3213.java
text:
```scala
public final b@@oolean isInstantiationAuthorized(Class<? extends Component> componentClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3213.java