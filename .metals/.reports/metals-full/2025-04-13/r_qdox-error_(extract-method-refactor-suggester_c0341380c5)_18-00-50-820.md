error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8553.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8553.java
text:
```scala
protected E@@numerationUtils() {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8553.java