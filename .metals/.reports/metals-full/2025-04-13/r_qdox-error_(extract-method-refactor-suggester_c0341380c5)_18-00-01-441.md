error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/344.java
text:
```scala
l@@ong pos = (((long) argTypeRef.sourceStart) << 32) + argTypeRef.sourceEnd;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/344.java