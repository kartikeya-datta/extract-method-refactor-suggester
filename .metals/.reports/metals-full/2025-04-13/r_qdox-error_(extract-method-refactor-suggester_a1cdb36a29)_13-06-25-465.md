error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8100.java
text:
```scala
r@@equest.network(), request.transport(), request.http(), request.plugins());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8100.java