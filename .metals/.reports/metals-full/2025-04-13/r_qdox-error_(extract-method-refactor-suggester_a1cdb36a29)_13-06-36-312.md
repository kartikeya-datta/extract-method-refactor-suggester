error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12990.java
text:
```scala
p@@ublic class Lit
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12990.java