error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8105.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8105.java
text:
```scala
G@@dx.app.debug("Cubocy", "dispose game screen");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8105.java