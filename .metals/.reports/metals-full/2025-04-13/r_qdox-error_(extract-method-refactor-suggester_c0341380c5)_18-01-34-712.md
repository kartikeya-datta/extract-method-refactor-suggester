error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3146.java
text:
```scala
s@@ource.writeTo(streamOutput);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3146.java