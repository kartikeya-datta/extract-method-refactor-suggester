error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5802.java
text:
```scala
S@@ystem.err.println("Unknown type: " + type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5802.java