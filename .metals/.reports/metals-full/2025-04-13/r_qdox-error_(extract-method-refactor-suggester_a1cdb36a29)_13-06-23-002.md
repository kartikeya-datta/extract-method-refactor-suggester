error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8145.java
text:
```scala
A@@ndroidGL, JoglGL, LWJGL, Angle, WebGL, iOSGL
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8145.java