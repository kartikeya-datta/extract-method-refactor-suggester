error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/450.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/450.java
text:
```scala
public B@@ytesRef next() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/450.java