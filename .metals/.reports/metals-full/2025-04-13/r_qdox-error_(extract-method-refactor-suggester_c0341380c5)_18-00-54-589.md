error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3544.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3544.java
text:
```scala
static final i@@nt METHOD = 9; // TODO: (david) is this used?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3544.java