error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1589.java
text:
```scala
r@@eturn ((objectName==null)?"":objectName.toString()) + super.toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1589.java