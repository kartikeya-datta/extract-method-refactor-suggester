error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7509.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7509.java
text:
```scala
n@@umDataNodes = 1,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7509.java