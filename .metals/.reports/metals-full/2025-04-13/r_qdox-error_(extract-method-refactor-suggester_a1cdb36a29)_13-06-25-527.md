error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16301.java
text:
```scala
r@@edraw = getDrawing();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16301.java