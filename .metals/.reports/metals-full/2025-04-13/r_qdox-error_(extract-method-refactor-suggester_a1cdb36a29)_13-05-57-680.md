error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7665.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7665.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7665.java
text:
```scala
n@@ew CheckBox(rememberMeRow, "rememberMe", new PropertyModel<Boolean>(SignInPanel.this,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7665.java