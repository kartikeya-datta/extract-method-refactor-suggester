error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8221.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8221.java
text:
```scala
final S@@tring message = "No Src for " + getContext().getName() + " specified";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8221.java