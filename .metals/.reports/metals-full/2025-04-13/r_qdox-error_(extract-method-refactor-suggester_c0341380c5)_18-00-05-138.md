error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7575.java
text:
```scala
t@@his.problemReporter,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7575.java