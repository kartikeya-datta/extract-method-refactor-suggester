error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9222.java
text:
```scala
r@@eturn new ShardExistsRequest(shard.shardId(), filteringAliases, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9222.java