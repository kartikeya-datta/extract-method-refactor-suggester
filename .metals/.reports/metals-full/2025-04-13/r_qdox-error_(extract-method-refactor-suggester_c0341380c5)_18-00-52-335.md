error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9398.java
text:
```scala
i@@f (AjaxRequestTarget.get() == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9398.java