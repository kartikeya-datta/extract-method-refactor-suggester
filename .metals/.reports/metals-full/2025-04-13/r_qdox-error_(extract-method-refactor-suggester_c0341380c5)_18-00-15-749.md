error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3025.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3025.java
text:
```scala
public static final U@@UID INITIAL_VERSION = new UUID(4096, 0); // has type nibble set to 1, everything else to zero.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3025.java