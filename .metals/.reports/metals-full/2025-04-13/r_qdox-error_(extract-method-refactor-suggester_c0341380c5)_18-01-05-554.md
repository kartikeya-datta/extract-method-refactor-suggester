error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6495.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6495.java
text:
```scala
private final I@@njectedValue<Host> host = new InjectedValue<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6495.java