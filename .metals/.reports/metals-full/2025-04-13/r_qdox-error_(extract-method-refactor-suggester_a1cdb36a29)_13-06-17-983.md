error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4974.java
text:
```scala
i@@nt delimiterIndex = uid.indexOf(DELIMITER); // type is not allowed to have # in it..., ids can
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4974.java