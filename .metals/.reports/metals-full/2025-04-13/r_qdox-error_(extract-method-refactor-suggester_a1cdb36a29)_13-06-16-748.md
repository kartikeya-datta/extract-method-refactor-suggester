error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7359.java
text:
```scala
A@@lignment.STRING_CONCATENATION,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7359.java