error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11754.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11754.java
text:
```scala
public static final A@@ttachmentKey<ModuleContextConfig> ATTACHMENT_KEY = AttachmentKey.create(ModuleContextConfig.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11754.java