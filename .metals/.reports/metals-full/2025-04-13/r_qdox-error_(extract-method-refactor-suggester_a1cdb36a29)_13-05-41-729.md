error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1573.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1573.java
text:
```scala
final I@@Status result[] = { new Status(IStatus.OK,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1573.java