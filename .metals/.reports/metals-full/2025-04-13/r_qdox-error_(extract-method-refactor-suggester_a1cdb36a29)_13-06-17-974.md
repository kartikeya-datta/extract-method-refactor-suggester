error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4227.java
text:
```scala
E@@numeration e = systemP.propertyNames();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4227.java