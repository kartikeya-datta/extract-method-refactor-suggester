error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1808.java
text:
```scala
r@@eturn (red & 0xFF) | ((green & 0xFF) << 8) | ((blue & 0xFF) << 16);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1808.java