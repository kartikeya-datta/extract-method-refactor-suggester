error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8495.java
text:
```scala
i@@f (isAllowExpression() && COMPLEX_TYPES.contains(type) && ParseUtils.containExpression(parameter.asString())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8495.java