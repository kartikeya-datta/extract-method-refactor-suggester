error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2736.java
text:
```scala
b@@uilder.field(QueryFacet.TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2736.java