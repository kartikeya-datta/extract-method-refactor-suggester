error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/938.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/938.java
text:
```scala
public static final L@@ibraryManager libs = new LibraryManager("http://libgdx.googlecode.com/svn/trunk/extensions/gdx-setup-ui/config/config.txt");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/938.java