error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/678.java
text:
```scala
i@@f (parser.isBooleanValue()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/678.java