error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7222.java
text:
```scala
n@@ew PageParameters("=test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7222.java