error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10205.java
text:
```scala
i@@f (cookies != null && body == null && log.isWarnEnabled())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10205.java