error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14108.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14108.java
text:
```scala
s@@rc = a.iterator().next();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14108.java