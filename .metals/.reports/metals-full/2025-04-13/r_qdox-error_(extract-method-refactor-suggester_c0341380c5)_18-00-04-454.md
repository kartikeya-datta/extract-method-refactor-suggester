error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5539.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(MESSAGES.invalidValueTypeKey(key, allowedValues.keySet())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5539.java