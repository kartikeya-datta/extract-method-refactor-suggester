error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11050.java
text:
```scala
d@@ist = new PascalDistribution(25, 0.7);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11050.java