error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17133.java
text:
```scala
c@@ode = accessible.internal_kEventAccessibleGetNamedAttribute (nextHandler, theEvent, userData);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17133.java