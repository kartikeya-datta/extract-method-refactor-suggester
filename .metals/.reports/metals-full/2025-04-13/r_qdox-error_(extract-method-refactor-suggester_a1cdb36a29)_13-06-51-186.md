error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10181.java
text:
```scala
t@@his.invoker.invoke(this.attributeCache, attributeOperation, Flag.IGNORE_RETURN_VALUES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10181.java