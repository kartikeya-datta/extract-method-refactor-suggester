error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15998.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15998.java
text:
```scala
w@@hile (container != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15998.java