error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9364.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9364.java
text:
```scala
t@@ypeName = classFileName.substring(0, classFileName.lastIndexOf('.'))/*remove .class*/.replace('$', enclosingTypeSeparator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9364.java