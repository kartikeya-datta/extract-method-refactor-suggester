error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7395.java
text:
```scala
L@@ist<InternalTermsStatsDoubleFacet.DoubleEntry> doubleEntries = new ArrayList<>(entries.v().size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7395.java