error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2455.java
text:
```scala
S@@treamInput stream = new BytesStreamInput(data, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2455.java