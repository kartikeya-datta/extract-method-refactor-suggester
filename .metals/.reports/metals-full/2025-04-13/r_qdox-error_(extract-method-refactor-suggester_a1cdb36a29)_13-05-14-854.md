error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7686.java
text:
```scala
W@@eakReference<AjType> weakRefToAjType =  ajTypes.get(fromClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7686.java