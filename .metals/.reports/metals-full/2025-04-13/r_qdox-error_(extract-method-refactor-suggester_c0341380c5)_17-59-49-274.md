error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/816.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/816.java
text:
```scala
M@@odelNode getDomainModel();
 ...
 */
public interface NewDomainController extends ModelController {
     ...
     */
    void addClient(final NewHostControllerClient hostControllerClient);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/816.java