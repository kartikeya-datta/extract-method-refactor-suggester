error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1731.java
text:
```scala
e@@xisting.aliases.add(rect);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1731.java