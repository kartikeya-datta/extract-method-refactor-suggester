error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15532.java
text:
```scala
i@@f (guid.Equals (XPCOM.NS_IINPUTSTREAM_IID)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15532.java