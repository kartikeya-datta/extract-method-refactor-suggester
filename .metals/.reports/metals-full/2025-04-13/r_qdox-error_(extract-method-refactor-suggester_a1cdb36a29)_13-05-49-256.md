error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2594.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2594.java
text:
```scala
p@@ublic class AdminBookmarkablePage extends BasePage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2594.java