error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10019.java
...
```java
offset: 1100
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10019.java
text:
```scala
 ...
 */
final class ComponentTypeInjectionSource extends InjectionSource {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10019.java