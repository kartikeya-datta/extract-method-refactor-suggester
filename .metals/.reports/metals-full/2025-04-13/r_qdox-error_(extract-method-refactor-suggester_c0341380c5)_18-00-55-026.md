error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4064.java
text:
```scala
r@@eturn serviceInfoFactory.createServiceInfo(discoveryAdvertiser, endpointDescription);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4064.java