error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8914.java
text:
```scala
c@@omposerController.composerInterface.messageComposer.compose(worker);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8914.java