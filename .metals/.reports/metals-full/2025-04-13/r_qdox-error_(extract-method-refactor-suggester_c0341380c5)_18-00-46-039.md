error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9752.java
text:
```scala
c@@aret.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9752.java