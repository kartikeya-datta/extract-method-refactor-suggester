error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9602.java
text:
```scala
f@@loat color = Color.WHITE.toFloatBits();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9602.java