error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5967.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5967.java
text:
```scala
public S@@ynchronizedSetTest(final String testName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5967.java