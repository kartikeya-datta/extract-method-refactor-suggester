error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3637.java
text:
```scala
A@@syncShardOperationAction(Request request, ActionListener<Response> listener) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3637.java