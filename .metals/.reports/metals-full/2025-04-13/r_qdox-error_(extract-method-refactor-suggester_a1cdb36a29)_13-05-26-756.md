error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8484.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8484.java
text:
```scala
S@@tring imageName = new File(imagePath.replace('\\', '/')).getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8484.java