error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6675.java
text:
```scala
n@@ewFolder.setName(buf.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6675.java