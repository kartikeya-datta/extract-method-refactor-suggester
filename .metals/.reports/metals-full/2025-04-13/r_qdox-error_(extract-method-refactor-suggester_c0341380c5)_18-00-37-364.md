error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1288.java
text:
```scala
W@@orkingCopyOwner owner = new BufferFactoryWrapper(factory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1288.java