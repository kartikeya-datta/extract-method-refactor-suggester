error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13821.java
text:
```scala
V@@ector<FilterChain> filterChains = new Vector<FilterChain>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13821.java