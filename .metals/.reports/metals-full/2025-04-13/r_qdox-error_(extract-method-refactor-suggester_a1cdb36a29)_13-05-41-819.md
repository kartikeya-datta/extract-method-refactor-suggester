error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4247.java
text:
```scala
i@@f (!"java".equalsIgnoreCase(extension) && !"class".equalsIgnoreCase(extension)) { //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4247.java