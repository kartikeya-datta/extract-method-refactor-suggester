error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/526.java
text:
```scala
v@@oid transformResource(Resource resource, PathAddress address, ResourceContext context) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/526.java