error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7991.java
text:
```scala
t@@his.actualParams = actualParams;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7991.java