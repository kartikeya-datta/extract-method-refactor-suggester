error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7.java
text:
```scala
a@@ddRModuleUser(relation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7.java