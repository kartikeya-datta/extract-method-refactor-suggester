error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1801.java
text:
```scala
r@@eturn "SessionConnectedEvent" + this.message;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1801.java