error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/370.java
text:
```scala
I@@ResourceStream stream = ResourceStreamFactory.get().newResourceStream(clazz, path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/370.java