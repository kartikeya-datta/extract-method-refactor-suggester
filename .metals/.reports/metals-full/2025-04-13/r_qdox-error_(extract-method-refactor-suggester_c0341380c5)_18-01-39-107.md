error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/814.java
text:
```scala
s@@tage.getSpriteBatch().disableBlending();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/814.java