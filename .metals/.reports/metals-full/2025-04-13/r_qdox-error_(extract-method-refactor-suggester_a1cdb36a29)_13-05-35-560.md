error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12929.java
text:
```scala
M@@ap<String, ServerUpdateResult> getResultByServer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12929.java