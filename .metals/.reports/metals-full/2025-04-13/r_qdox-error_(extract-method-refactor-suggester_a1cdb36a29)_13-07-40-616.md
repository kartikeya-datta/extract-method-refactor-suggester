error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3696.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3696.java
text:
```scala
private B@@indingResolver resolver; // TODO: (olivier) is this used?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3696.java