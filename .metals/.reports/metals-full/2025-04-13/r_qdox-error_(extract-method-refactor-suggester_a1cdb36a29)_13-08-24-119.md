error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9463.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9463.java
text:
```scala
L@@ocalTypeBinding localType = new LocalTypeBinding(this, enclosingType, this.innermostSwitchCase());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9463.java