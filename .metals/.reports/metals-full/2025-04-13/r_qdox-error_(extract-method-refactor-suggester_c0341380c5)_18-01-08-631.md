error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7380.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7380.java
text:
```scala
static final S@@tring FILEVERSION = "388545";// Expected $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7380.java