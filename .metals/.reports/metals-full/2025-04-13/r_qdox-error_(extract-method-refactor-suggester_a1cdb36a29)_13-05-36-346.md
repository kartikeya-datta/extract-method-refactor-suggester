error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2480.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2480.java
text:
```scala
static i@@nt MINOR_VERSION = 437;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2480.java