error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3588.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3588.java
text:
```scala
J@@avaScriptUtils.writeJavaScript(getResponse(), javascript, id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3588.java