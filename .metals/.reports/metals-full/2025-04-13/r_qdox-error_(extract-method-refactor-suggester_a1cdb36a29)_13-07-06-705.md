error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5754.java
text:
```scala
v@@oid setLogger(String loggerName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5754.java