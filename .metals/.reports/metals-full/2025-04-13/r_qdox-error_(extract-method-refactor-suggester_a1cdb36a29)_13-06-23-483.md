error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2886.java
text:
```scala
t@@his.audio = new IOSAudio(config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2886.java