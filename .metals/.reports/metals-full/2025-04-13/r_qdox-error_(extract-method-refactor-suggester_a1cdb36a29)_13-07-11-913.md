error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12293.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12293.java
text:
```scala
final i@@nt reclength = recmatches.getLength();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12293.java