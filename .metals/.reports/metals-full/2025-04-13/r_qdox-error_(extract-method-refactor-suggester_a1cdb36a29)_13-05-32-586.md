error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5360.java
text:
```scala
i@@nt border = (int)(0.5f + widget.borderWidth ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5360.java