error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6678.java
text:
```scala
l@@ogger.debug("{} Refresh request executed. Force: [{}].", indexShard.shardId(), request.force());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6678.java