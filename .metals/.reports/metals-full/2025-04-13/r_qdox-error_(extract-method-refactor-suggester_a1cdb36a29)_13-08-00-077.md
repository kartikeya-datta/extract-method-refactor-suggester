error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/521.java
text:
```scala
b@@r.copyBytes(term.bytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/521.java