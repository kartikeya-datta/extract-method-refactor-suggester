error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3030.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3030.java
text:
```scala
public final L@@ist<IndexFieldDataCache.Listener> listeners = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3030.java