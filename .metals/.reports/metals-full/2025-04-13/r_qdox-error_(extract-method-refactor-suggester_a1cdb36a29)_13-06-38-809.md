error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7923.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7923.java
text:
```scala
C@@ompilerAdapterFactory.getCompiler( compiler.toString(), getContext() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7923.java