error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9712.java
text:
```scala
r@@eturn "[Page class = " + getClass().getName() + ", id = " + id + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9712.java