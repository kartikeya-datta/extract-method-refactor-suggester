error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7441.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7441.java
text:
```scala
public L@@ookupEnvironment environment;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7441.java