error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10435.java
text:
```scala
s@@uper(ModelType.INT, nullable, allowExpressions, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10435.java