error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4033.java
text:
```scala
H@@TTP_METHOD("HttpMethod"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4033.java