error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3559.java
text:
```scala
R@@emoteOutboundConnectionAdd.INSTANCE.installRuntimeService(context,  operation, model, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3559.java