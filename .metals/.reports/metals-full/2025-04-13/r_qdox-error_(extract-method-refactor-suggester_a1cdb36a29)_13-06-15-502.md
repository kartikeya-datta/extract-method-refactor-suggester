error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5289.java
text:
```scala
c@@ycle.setResponsePage(new Home(PageParameters.NULL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5289.java