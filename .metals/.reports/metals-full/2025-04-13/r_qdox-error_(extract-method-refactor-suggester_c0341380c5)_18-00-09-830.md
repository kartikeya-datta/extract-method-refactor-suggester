error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4753.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4753.java
text:
```scala
r@@eturn new DefaultShader(vertexShader, fragmentShader, renderable, renderable.lights != null, renderable.lights != null && renderable.lights.fog != null, 2, 5, 3, renderable.bones == null ? 0 : 12);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4753.java