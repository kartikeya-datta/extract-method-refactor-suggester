error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7160.java
text:
```scala
e@@xecutor = EsExecutors.newScaling(0, concurrentConnects, 60, TimeUnit.SECONDS, threadFactory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7160.java