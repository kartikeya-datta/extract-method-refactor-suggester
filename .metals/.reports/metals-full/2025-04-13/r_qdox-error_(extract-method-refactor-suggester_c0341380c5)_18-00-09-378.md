error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6709.java
text:
```scala
s@@uper(true, false, ATTRIBUTE_DEFINITIONS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6709.java