error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4343.java
text:
```scala
c@@lassInstanceCreation.typeArguments().add(convertType(allocation.typeArguments[i]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4343.java