error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4750.java
text:
```scala
c@@lient.admin().indices().preparePutMapping(indexName).setType("child").setSource(XContentFactory.jsonBuilder().startObject().startObject("child")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4750.java