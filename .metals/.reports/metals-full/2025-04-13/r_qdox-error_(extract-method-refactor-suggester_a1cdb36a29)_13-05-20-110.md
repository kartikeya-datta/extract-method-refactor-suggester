error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7758.java
text:
```scala
i@@f (OS.IsWinCE && display.runMessages) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7758.java