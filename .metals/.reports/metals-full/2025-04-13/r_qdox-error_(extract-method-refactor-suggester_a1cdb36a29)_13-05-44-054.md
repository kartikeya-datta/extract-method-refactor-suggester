error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12557.java
text:
```scala
n@@f.setMaximumFractionDigits(10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12557.java