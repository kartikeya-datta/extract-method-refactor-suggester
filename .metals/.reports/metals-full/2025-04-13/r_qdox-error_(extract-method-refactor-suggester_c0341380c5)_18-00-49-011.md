error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3920.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3920.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3920.java
text:
```scala
public b@@oolean signIn(final String username, final String password)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3920.java