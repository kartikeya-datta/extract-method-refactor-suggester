error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14454.java
text:
```scala
e@@xchange.getResponseHeaders().put(Headers.CONTENT_TYPE, TEXT_PLAIN + "; charset=" + UTF_8);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14454.java