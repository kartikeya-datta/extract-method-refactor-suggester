error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13730.java
text:
```scala
n@@ew Label(this,"content", content).setEscapeModelStrings(!allowHtml);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13730.java