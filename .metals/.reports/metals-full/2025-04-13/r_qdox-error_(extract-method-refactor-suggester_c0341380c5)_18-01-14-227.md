error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10609.java
text:
```scala
r@@eturn FunctorUtils.<E>copy(iClosures);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10609.java