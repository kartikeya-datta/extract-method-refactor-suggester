error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5195.java
text:
```scala
p@@ublic interface IErrorMessageSource
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5195.java