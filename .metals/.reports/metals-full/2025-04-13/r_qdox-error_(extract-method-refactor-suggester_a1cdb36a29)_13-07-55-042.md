error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9322.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9322.java
text:
```scala
volatile b@@oolean paused;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9322.java