error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2301.java
text:
```scala
s@@tatic class DataRepairHandler implements IAsyncCallback, ICacheExpungeHook<String, String>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2301.java