error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1943.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1943.java
text:
```scala
l@@ong guessedSize = 2L * memsize.value() * 1024*1024; // 2* adds room for keys, column indexes
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1943.java