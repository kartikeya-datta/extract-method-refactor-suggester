error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14590.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14590.java
text:
```scala
e@@mf = createNamedEMF(PU_NAME, "openjpa.MetaDataRepository", "Preload=true");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14590.java