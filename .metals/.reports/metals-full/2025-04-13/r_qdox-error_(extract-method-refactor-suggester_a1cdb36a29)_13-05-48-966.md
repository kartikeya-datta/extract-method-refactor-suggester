error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8362.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8362.java
text:
```scala
final b@@oolean renderAllowed = component.authorize(RENDER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8362.java