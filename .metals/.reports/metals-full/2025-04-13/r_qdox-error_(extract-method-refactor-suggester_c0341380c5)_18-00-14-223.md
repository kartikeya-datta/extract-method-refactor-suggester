error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9965.java
text:
```scala
u@@rl = RequestCycle.get().urlFor(handler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9965.java