error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/714.java
text:
```scala
L@@ink link = (Link)page.get("navigation:1:pageLink");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/714.java