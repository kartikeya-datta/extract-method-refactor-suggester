error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11336.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11336.java
text:
```scala
final c@@har encapsulator = format.getQuoteChar();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11336.java