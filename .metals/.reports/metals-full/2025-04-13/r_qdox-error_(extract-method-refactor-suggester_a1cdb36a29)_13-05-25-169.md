error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10216.java
text:
```scala
O@@S.SetRect (rgnRect, (short) 0, (short) 0, (short) width, (short) height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10216.java