error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9607.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9607.java
text:
```scala
n@@ew ShardSearchRequest(request).types(request.types())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9607.java