error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7094.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7094.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7094.java
text:
```scala
n@@eedToConvert |= !((ReferenceBinding)originalType).isStatic();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7094.java