error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13227.java
text:
```scala
N@@SMenu widget = (NSMenu)new SWTMenu().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13227.java