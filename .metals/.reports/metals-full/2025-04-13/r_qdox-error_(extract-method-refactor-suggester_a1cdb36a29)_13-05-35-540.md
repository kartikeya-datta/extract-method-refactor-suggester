error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5133.java
text:
```scala
i@@f (ExtendedBeanInfo.isNonVoidWriteMethod(method)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5133.java