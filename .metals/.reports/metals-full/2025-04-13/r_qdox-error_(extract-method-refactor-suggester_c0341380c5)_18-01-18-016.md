error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5643.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5643.java
text:
```scala
final M@@arkupContainer add(final Component<T> child)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5643.java