error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11647.java
text:
```scala
p@@ublic final class InspectorPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11647.java