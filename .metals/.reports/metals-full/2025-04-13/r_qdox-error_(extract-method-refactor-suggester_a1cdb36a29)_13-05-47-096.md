error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18073.java
text:
```scala
r@@eturn ((FormComponent)component).getType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18073.java