error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2873.java
text:
```scala
i@@f (!continueToOriginalDestination())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2873.java