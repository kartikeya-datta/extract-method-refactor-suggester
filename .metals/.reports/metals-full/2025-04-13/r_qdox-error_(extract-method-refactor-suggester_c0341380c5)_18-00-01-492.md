error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6181.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6181.java
text:
```scala
private final i@@nt N = 100;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6181.java