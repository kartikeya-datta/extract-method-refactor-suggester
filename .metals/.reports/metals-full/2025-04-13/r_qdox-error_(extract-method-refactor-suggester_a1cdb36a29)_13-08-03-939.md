error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5421.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5421.java
text:
```scala
public F@@ile nodeLocation() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5421.java