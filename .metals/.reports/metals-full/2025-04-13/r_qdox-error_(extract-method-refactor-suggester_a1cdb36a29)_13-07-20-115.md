error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1838.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1838.java
text:
```scala
public static final S@@tring NAME = "indices:admin/refresh";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1838.java