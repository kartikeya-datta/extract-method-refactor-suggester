error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7880.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7880.java
text:
```scala
private static final b@@oolean DUMP_STACK = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7880.java