error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2518.java
text:
```scala
t@@arget.add(listViewContainer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2518.java