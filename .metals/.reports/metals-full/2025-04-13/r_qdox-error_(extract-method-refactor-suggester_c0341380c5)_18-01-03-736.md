error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5023.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5023.java
text:
```scala
private final S@@tatefulSessionComponent component;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5023.java