error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7613.java
text:
```scala
i@@f (invocationType == methodBinding.declaringClass) return true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7613.java