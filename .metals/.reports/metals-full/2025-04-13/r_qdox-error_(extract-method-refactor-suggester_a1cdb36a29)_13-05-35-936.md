error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11037.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11037.java
text:
```scala
a@@ssertEquals(1, ids.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11037.java