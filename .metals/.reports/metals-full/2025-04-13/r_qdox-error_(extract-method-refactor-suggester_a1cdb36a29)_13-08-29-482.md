error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3675.java
...
```java
offset: 13
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3675.java
text:
```scala
@Deprecated C@@LUSTERED_CACHE_REF("clustered-cache-ref"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3675.java