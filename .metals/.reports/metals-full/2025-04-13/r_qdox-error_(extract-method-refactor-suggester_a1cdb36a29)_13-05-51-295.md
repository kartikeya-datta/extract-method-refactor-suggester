error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8416.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8416.java
text:
```scala
static final i@@nt DEFAULT_TREE_WIDGET_PERCENT = 10;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8416.java