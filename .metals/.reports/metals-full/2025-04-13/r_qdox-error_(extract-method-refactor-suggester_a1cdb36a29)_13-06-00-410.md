error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3464.java
text:
```scala
I@@nputListener ignoreTouchDown = new InputListener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3464.java