error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9477.java
text:
```scala
O@@bject valueNotUnDefined = props[i].getValue(GenericTestBeanCustomizer.NOT_UNDEFINED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9477.java