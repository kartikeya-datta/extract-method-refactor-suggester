error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15040.java
text:
```scala
r@@eturn localHome ? cmpComponent.getEJBLocalObject(primaryKey) : cmpComponent.getEJBObject(primaryKey);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15040.java