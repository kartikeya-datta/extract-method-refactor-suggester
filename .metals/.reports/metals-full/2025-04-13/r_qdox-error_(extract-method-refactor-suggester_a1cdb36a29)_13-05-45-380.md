error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11653.java
text:
```scala
m@@odelNode.get("cache", "clustered").remove("name");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11653.java