error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1177.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1177.java
text:
```scala
protected static l@@ong getCPtr(SWIGTYPE_p_btAxisSweep3InternalT_unsigned_short_t__Handle obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1177.java