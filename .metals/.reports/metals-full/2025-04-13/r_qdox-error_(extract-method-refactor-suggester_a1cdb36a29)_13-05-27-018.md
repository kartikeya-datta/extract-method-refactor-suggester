error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2737.java
text:
```scala
P@@arameters params = new Parameters(context.getConfiguration().get("job.parameters", ""));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2737.java