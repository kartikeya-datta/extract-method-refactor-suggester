error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9298.java
text:
```scala
i@@nt randomReplicaNumber = between(0, cluster().size() - 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9298.java