error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15275.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15275.java
text:
```scala
protected I@@RemoteService registerAndGetRemoteService() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15275.java