error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10589.java
text:
```scala
i@@f ((lpwp.flags & OS.SWP_NOSIZE) == 0 || (lpwp.flags & OS.SWP_DRAWFRAME) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10589.java