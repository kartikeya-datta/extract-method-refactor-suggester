error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16831.java
text:
```scala
i@@f (!isActionAuthorized(ENABLE) || !isEnabled() || !group.isEnabled())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16831.java