error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2988.java
text:
```scala
i@@f (drawCount == 0 && header.isVisible ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2988.java