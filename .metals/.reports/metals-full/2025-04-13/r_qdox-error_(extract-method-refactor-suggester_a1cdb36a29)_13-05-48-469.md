error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3843.java
text:
```scala
r@@eturn new SimpleOperationDefinition(name, resolver, attributeResolver, entryType, flags, replyType, replyValueType, false, deprecationData, replyParameters, parameters) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3843.java