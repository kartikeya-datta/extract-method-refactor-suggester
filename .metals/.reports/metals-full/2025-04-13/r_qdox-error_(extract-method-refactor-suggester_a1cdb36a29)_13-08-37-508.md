error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6814.java
text:
```scala
s@@hardStatus.translogOperations = indexShard.translog().numberOfOperations();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6814.java