error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1291.java
text:
```scala
r@@eturn Util.bind("operation.moveElementProgress"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1291.java