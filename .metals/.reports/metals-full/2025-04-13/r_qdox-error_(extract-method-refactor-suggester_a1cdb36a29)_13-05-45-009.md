error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15835.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15835.java
text:
```scala
public static final S@@tring FLAG_OBJECT = "object";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15835.java