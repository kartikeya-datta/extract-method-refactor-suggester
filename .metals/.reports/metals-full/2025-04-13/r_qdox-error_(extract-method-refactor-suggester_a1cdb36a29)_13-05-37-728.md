error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2073.java
text:
```scala
i@@nt nodesLength = nodes.length;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2073.java