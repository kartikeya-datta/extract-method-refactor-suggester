error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12266.java
text:
```scala
I@@terator<?> iter = subTree.list().iterator();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12266.java