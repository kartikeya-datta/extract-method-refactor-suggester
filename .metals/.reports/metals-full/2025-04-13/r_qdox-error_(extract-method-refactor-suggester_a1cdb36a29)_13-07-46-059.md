error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6292.java
text:
```scala
G@@uiMain.start(cmdCtx);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6292.java