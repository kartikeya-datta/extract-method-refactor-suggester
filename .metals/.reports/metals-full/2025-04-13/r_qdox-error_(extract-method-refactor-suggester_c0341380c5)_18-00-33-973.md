error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4169.java
text:
```scala
s@@etResponsePage(getApplication().getHomePage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4169.java