error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15192.java
text:
```scala
l@@ong crc;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15192.java