error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3469.java
text:
```scala
r@@ealmAuthenticationProvider = new RealmAuthenticationProvider(securityRealmInjectedValue.getValue(), serverCallbackValue.getOptionalValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3469.java