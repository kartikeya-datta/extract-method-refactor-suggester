error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10335.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10335.java
text:
```scala
public static S@@tring[][] invert(final String[][] array) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10335.java