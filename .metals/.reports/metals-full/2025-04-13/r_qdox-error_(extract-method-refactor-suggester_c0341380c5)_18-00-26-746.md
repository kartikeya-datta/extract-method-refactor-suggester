error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4749.java
text:
```scala
I@@Problem.Unclassified,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4749.java