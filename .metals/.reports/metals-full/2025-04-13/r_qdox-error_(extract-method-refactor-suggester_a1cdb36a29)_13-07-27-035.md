error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4076.java
text:
```scala
H@@ashMap<String, Integer> dependencyCount = new HashMap<String, Integer>(); // FIXME use ObjectIntMap once its ready.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4076.java