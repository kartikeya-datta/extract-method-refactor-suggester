error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4127.java
text:
```scala
l@@abel.setText("irc://[<user>@]<ircserver[:port]>[/<channel>,<channel2>,...]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4127.java