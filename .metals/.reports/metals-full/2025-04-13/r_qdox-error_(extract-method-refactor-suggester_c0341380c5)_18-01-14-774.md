error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1934.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1934.java
text:
```scala
public l@@ong totalHits;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1934.java