error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17120.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17120.java
text:
```scala
public I@@User getLocalUser() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17120.java