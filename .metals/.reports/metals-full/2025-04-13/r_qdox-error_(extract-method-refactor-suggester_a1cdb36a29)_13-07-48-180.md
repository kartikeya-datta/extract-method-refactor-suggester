error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5352.java
text:
```scala
r@@rToWire(dnsCompression c) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5352.java