error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2610.java
text:
```scala
m@@ainClassLoader = new MainClassLoader(Main.class.getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2610.java