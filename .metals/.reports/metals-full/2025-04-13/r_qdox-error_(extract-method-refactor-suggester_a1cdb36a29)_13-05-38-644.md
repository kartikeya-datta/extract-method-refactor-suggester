error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3342.java
text:
```scala
i@@gnoreErrors = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3342.java