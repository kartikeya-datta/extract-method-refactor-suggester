error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14289.java
text:
```scala
l@@og.error(e.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14289.java