error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5362.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5362.java
text:
```scala
public static v@@oid setJodaTimeContext(JodaTimeContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5362.java