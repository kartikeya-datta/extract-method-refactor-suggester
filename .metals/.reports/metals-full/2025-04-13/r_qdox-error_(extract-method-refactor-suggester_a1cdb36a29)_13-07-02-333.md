error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16928.java
text:
```scala
l@@og.debug("Replacing parent " + this.parent + " with " + parent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16928.java