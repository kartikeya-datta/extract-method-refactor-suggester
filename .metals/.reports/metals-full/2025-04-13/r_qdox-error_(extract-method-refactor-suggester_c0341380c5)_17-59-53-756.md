error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13485.java
text:
```scala
t@@his.patchType = Patch.PatchType.UPGRADE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13485.java