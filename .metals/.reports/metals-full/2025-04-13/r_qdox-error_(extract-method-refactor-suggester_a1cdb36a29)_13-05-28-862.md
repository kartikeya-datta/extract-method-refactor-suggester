error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2797.java
text:
```scala
I@@Type[] types = this.focusType == null ? getAllTypes() : getAllSubtypes(this.focusType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2797.java