error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9221.java
text:
```scala
C@@lass<?> clazz = (Class<?>) getValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9221.java