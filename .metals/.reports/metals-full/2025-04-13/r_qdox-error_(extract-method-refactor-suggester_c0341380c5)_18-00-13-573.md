error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/846.java
text:
```scala
O@@S.PMSetOrientation(pageFormat, printerData.orientation == PrinterData.LANDSCAPE ? OS.kPMLandscape : OS.kPMPortrait, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/846.java