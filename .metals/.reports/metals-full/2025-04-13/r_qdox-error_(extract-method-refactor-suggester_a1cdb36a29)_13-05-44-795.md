error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2810.java
text:
```scala
a@@ctivate(breadCrumbPanelFactory.create(this.getParent(), getId(), breadCrumbModel));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2810.java