error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14103.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14103.java
text:
```scala
public final S@@essionFacade getSessionFacade()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14103.java