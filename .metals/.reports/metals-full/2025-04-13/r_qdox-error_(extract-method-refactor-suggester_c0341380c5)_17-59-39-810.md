error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3668.java
text:
```scala
i@@f (file instanceof IFile && Util.isClassFileName(file.getName())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3668.java