error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1188.java
text:
```scala
r@@eturn NewModelControllerProtocol.EXECUTE_TX_REQUEST;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1188.java