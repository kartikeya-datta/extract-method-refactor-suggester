error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17582.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[137,80]

error in qdox parser
file content:
```java
offset: 4780
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17582.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17582.java