error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8734.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8734.java
text:
```scala
private final f@@loat value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8734.java