error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7615.java
text:
```scala
a@@ssigneeTask.edit(AssigneeDialogFragment.getSelected(arguments));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7615.java