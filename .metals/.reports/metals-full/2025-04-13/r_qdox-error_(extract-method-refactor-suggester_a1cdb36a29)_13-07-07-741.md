error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1358.java
text:
```scala
g@@iven(processor.processAction(this.request, action)).willReturn(action);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1358.java