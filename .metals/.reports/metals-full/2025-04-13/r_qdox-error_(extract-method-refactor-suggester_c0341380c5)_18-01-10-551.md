error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2822.java
text:
```scala
i@@nt index = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2822.java