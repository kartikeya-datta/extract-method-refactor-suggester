error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12178.java
text:
```scala
m@@ojo.compileClasspathElements = new ArrayList<String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12178.java