error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6971.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6971.java
text:
```scala
public static final F@@unction<Repository, String> REPO_NAME = new Function<Repository, String>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6971.java