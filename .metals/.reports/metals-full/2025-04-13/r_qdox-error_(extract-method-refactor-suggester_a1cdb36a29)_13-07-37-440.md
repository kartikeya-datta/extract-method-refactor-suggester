error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6661.java
text:
```scala
s@@uper(parentShell == null ? ProgressManagerUtil.getNonModalShell() : parentShell);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6661.java