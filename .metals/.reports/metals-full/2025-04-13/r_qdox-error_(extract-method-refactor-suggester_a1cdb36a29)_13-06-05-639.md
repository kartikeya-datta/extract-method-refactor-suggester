error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9147.java
text:
```scala
i@@nt /*long*/ children = OS.gtk_container_get_children (vboxHandle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9147.java