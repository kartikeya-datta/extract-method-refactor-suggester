error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8460.java
text:
```scala
t@@hrow new BuildException( "Error", ioe);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8460.java