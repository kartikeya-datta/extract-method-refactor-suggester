error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2026.java
text:
```scala
i@@f (isWorkingCopy() && !isPrimary()) return null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2026.java