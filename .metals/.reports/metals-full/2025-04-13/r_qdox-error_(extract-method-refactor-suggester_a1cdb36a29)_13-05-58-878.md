error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7449.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7449.java
text:
```scala
I@@MailFolder folder = (IMailFolder) dialog.getSelectedFolder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7449.java