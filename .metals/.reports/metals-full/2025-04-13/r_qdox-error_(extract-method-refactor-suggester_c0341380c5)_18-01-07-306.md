error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6858.java
text:
```scala
c@@onstant = Constant.NotAConstant;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6858.java