error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/499.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/499.java
text:
```scala
i@@f (refTypeVariables[0].boundCheck(superType, sourceType) != TypeConstants.OK) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/499.java