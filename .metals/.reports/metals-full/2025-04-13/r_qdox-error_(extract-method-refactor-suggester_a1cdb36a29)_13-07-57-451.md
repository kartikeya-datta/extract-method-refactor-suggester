error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8109.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8109.java
text:
```scala
p@@rinter.printRecords(new List[] { Arrays.asList("r1c1", "r1c2"), Arrays.asList("r2c1", "r2c2") });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8109.java