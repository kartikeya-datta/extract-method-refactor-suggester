error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5761.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5761.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5761.java
text:
```scala
public i@@nt width = 480, height = 320;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5761.java