error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4145.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4145.java
text:
```scala
final T@@okenizerFactory tokenizerFactory = tokenizerFactoryFactory.create(tokenizerName, indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4145.java