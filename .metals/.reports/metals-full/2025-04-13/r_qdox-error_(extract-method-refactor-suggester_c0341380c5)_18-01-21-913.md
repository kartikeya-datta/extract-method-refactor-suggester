error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12891.java
text:
```scala
r@@eturn new URL(file.toURI().toASCIIString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12891.java