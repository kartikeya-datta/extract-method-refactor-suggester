error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3922.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3922.java
text:
```scala
public S@@tockQuoteLabel2(final MarkupContainer parent, final String id, final String symbol)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3922.java