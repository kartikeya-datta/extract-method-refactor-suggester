error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3797.java
text:
```scala
e@@ndpointsnitch = (DatacenterEndPointSnitch) DatabaseDescriptor.getEndpointSnitch();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3797.java