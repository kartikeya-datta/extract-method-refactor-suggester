error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1497.java
text:
```scala
n@@ame, index, Integer.valueOf(values.length)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1497.java