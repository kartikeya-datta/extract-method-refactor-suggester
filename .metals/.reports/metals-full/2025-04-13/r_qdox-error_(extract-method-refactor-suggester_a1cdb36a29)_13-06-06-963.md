error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1775.java
text:
```scala
v@@oid rconfigure(HashTree testTree, String host, File jmxBase, String scriptName) throws RemoteException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1775.java