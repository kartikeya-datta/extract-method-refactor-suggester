error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/315.java
text:
```scala
i@@f (op != SpatialOperation.Intersects)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/315.java