error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2869.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2869.java
text:
```scala
L@@ist<AtomicReaderContext> leaves = readerIn.leaves();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2869.java