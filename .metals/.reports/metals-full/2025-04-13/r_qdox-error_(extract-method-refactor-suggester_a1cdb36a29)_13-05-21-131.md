error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9198.java
text:
```scala
t@@hrow new IllegalArgumentException("Argument resourceKey must be not-null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9198.java