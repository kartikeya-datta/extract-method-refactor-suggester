error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2424.java
text:
```scala
G@@roupShardsIterator groupIt = clusterService.operationRouting().searchShards(clusterState, searchRequest.indices(), searchRequest.queryHint(), searchRequest.routing(), searchRequest.preference());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2424.java