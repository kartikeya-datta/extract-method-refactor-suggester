error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1590.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1590.java
text:
```scala
u@@rl = url + (url.contains("?") ? "&amp;" : "?");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1590.java