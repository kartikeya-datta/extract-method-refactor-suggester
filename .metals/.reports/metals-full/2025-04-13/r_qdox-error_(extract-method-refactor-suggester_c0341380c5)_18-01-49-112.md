error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8505.java
text:
```scala
a@@fter () returning : initialization(new(..)) && !this(A) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8505.java