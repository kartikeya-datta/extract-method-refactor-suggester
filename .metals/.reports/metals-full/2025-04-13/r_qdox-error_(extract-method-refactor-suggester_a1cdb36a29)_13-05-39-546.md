error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1449.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1449.java
text:
```scala
public static final S@@tring NAME = "span_first";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1449.java