error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7744.java
text:
```scala
r@@eturn cu.getPackageDeclaration(this.name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7744.java