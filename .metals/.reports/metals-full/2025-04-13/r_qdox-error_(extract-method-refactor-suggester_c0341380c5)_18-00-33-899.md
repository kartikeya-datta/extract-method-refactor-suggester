error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17992.java
text:
```scala
i@@f (name.equalsIgnoreCase("img")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17992.java