error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2460.java
text:
```scala
n@@ew Thread(runnable, "COMMIT-LOG-WRITER").start();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2460.java