error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2037.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2037.java
text:
```scala
public final static c@@har[] IncompleteHierarchy = new char[] {'h', 'a', 's', ' ', 'i', 'n', 'c', 'o', 'n', 's', 'i', 's', 't', 'e', 'n', 't', ' ', 'h', 'i', 'e', 'r', 'a', 'r', 'c', 'h', 'y'};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2037.java