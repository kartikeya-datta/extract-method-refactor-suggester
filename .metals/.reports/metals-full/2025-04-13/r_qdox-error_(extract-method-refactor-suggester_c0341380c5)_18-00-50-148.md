error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2851.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2851.java
text:
```scala
private T@@PCommitEventProcessor eventProcessor = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2851.java