error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3686.java
text:
```scala
d@@ataBinder.setDisallowedFields("id");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3686.java