error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14161.java
text:
```scala
p@@ublic final class EntityDeclarationImpl extends XMLEventImpl implements
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14161.java