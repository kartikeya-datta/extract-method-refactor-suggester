error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4103.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4103.java
text:
```scala
protected C@@oncurrencyManagementType fromAnnotation(final AnnotationInstance annotationInstance, final boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4103.java