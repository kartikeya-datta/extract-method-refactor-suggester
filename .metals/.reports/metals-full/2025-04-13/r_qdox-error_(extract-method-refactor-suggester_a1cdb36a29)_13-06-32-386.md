error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1844.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1844.java
text:
```scala
public final v@@oid setLocale(final Locale locale)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1844.java