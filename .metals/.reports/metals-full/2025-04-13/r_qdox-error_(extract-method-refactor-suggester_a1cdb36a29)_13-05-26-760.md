error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7912.java
text:
```scala
g@@etPreferenceStore().setDefault(CONTAINER_TYPE, "ecf.generic.client");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7912.java