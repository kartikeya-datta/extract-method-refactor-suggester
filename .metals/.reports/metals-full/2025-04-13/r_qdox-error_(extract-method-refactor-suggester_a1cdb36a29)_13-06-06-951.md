error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1066.java
text:
```scala
r@@eturn attributes.put(key.toLowerCase(), value.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1066.java