error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11619.java
text:
```scala
i@@nt lastChar = in.getLastChar();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11619.java