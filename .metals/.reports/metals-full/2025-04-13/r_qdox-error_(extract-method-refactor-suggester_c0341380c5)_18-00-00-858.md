error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1250.java
text:
```scala
a@@ssert left.equals(token) || contains(token);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1250.java