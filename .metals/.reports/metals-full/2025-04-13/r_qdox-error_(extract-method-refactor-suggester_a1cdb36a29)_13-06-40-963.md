error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1457.java
text:
```scala
A@@ssert.notNull(clientOutboundChannel, "'clientOutboundChannel' must not be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1457.java