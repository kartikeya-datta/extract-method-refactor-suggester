error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4594.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4594.java
text:
```scala
public v@@oid testXmlWrite() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4594.java