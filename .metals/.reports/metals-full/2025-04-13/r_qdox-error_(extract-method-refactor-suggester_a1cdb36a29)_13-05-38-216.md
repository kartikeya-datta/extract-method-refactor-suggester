error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11253.java
text:
```scala
m@@oduleSpecification.addSystemDependency(MSC_DEP);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11253.java