error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10779.java
text:
```scala
v@@iew.selectTab(null, null, null, userID, userName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10779.java