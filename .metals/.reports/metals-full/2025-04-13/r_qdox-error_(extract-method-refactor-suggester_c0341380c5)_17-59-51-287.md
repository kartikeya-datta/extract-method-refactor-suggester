error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3573.java
text:
```scala
d@@eploymentAdd.get(ENABLED).set(enabled);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3573.java