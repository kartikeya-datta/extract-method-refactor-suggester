error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2076.java
text:
```scala
i@@nt id = ((in[0] & 0xFF) << 8) + (in[1] & 0xFF);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2076.java