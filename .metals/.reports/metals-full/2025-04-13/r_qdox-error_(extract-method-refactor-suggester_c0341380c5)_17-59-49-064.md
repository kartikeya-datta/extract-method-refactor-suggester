error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1966.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1966.java
text:
```scala
public i@@nt compare(final File file1, final File file2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1966.java