error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6906.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6906.java
text:
```scala
final F@@ile input = getFile("COMPRESS-114.tar");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6906.java