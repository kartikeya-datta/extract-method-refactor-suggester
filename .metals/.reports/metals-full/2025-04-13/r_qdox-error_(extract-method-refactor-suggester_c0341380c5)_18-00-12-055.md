error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9253.java
text:
```scala
B@@celWorld world = new BcelWorld("../weaver/bin");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9253.java