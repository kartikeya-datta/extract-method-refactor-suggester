error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9644.java
text:
```scala
r@@eturn hwnd == handle || hwnd == hwndText || hwnd == hwndUpDown;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9644.java