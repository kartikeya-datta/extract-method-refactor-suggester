error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/948.java
text:
```scala
S@@tring[] args = ctx.getArgumentsString().split("\\s+");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/948.java