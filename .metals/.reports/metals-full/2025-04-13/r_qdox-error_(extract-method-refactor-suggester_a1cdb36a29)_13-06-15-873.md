error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4794.java
text:
```scala
i@@n.read(rec.addr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4794.java