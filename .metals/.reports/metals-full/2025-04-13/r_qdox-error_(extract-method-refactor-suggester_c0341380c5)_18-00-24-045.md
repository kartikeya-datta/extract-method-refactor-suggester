error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18326.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18326.java
text:
```scala
private static final F@@ileServer FSERVER = FileServer.getFileServer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18326.java