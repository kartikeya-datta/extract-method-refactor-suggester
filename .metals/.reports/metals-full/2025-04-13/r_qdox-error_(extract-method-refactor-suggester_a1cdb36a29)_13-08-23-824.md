error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2531.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2531.java
text:
```scala
m@@ap2.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2531.java