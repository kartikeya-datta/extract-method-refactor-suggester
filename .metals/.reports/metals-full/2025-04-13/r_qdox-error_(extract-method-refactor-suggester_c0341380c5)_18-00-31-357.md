error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8745.java
text:
```scala
K@@inematicBodyTest.class, LifeCycleTest.class, LineDrawingTest.class, ScrollPane2Test.class, ScrollPaneScrollBarsTest.class, ManagedTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8745.java