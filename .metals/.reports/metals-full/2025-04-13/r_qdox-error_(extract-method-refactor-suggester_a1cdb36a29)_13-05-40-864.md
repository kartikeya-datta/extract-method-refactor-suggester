error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10029.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10029.java
text:
```scala
O@@bject myThis = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10029.java