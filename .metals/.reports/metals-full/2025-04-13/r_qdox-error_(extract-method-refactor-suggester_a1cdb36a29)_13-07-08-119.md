error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7624.java
text:
```scala
r@@eturn new SignificantLongTerms(subsetSize, supersetSize, getName(), formatter, requiredSize, minDocCount, buckets);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7624.java