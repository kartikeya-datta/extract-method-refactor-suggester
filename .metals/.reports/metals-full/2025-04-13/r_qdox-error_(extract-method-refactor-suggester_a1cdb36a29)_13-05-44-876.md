error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6751.java
text:
```scala
n@@ew ExternalFolderChange(project, change.oldResolvedClasspath).updateExternalFoldersIfNecessary(true/*refresh if external linked folder already exists*/, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6751.java