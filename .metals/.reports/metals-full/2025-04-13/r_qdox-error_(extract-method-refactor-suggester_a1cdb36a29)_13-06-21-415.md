error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2628.java
text:
```scala
S@@hingleFilter filter = new ShingleFilter(tokenStream, minShingleSize, maxShingleSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2628.java