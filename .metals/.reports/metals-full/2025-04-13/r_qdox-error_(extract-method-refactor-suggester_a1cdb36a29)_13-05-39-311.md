error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9316.java
text:
```scala
C@@lass<?>[] types() default {};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9316.java