error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5114.java
text:
```scala
s@@tartActivity(GistsViewActivity.createIntent(gist));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5114.java