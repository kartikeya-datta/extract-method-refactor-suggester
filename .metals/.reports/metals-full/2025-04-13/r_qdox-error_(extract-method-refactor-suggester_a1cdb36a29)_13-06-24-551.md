error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12544.java
text:
```scala
r@@esourceRegistration.registerSubModel(new MappingProviderModuleDefinition(Constants.PROVIDER_MODULE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12544.java