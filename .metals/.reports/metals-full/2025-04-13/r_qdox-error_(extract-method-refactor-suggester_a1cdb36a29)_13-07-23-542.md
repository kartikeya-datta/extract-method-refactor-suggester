error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9022.java
text:
```scala
t@@hrow new CommandLineException("Failed to resolve host '" + host + "': " + e.getLocalizedMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9022.java