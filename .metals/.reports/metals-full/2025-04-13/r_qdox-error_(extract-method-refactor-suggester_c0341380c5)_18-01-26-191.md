error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12799.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12799.java
text:
```scala
private L@@ist paths = new ArrayList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12799.java