error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15440.java
text:
```scala
u@@rl = component.getPage().urlFor(((SharedResource)resource).getPath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15440.java