error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/179.java
text:
```scala
i@@nt /*long*/ hwndScroll = shell.scrolledHandle ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/179.java