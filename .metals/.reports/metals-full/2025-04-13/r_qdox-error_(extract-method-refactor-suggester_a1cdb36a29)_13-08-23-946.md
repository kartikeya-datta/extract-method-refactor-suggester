error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2398.java
text:
```scala
a@@ssertSearchResponse(response);System.out.println(response);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2398.java