error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15035.java
text:
```scala
a@@pplication.getLastRenderedPage().get("border");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15035.java