error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2459.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2459.java
text:
```scala
public static v@@oid setDefault(final TimeZone tz) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2459.java