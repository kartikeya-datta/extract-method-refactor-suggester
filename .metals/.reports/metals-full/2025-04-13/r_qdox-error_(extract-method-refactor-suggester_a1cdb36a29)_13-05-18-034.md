error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6050.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6050.java
text:
```scala
public static final B@@oundedQueueThreadPoolAdd INSTANCE = new BoundedQueueThreadPoolAdd();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6050.java