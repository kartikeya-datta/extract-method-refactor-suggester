error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3073.java
...
```java
offset: 1033
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3073.java
text:
```scala
enum ConsoleMode {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3073.java