error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2705.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2705.java
...
```java
offset: 946
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2705.java
text:
```scala
...
p@@ackage org.apache.derby.client.am;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2705.java