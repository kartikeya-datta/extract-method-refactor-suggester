error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13250.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13250.java
text:
```scala
public static A@@ttachmentKey<Module> KEY = AttachmentKey.create(Module.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13250.java