error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6407.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6407.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/template/get";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6407.java