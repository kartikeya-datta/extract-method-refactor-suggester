error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11679.java
text:
```scala
c@@ontext.getSubModel().get(THREAD_POOL).set(operation.require(THREAD_POOL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11679.java