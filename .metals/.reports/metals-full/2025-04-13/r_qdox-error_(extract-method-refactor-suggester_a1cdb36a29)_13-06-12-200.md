error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11401.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11401.java
text:
```scala
S@@erverControllerModelUtil.updateCoreModel(rootResource.getModel(), configuration.getServerEnvironment());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11401.java