error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7167.java
text:
```scala
c@@atch (Exception e)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7167.java