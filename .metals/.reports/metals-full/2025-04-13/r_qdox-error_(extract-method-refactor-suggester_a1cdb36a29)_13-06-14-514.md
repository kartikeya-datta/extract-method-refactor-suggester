error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1031.java
text:
```scala
t@@his.locator.lookupEnvironment.buildTypeBindings(unit, null /*no access restriction*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1031.java