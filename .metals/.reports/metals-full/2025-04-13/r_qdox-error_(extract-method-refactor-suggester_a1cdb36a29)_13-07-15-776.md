error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3523.java
text:
```scala
F@@orm< ? > form = (Form< ? >)findParent(Form.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3523.java