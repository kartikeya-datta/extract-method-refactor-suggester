error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2515.java
text:
```scala
m@@ap.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2515.java