error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7346.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7346.java
text:
```scala
private static v@@oid keytool(String command, File keystore, String password, String alias,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7346.java