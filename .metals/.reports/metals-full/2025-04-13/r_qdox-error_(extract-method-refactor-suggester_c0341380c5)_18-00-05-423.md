error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9795.java
text:
```scala
h@@elp.append("Eclipse Communication Framework (ECF) Commands");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9795.java