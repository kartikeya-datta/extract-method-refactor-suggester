error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7926.java
text:
```scala
p@@ath = path.substring(0, 2);  // seems to make it work
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7926.java