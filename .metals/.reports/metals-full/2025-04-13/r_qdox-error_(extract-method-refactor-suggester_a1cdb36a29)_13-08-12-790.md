error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18117.java
text:
```scala
S@@ystem.out.println("proxy call end. result=" + result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18117.java