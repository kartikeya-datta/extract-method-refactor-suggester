error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4960.java
text:
```scala
l@@ocalInterfaceType = classLoader.loadClass(localInterface);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4960.java