error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2401.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2401.java
text:
```scala
m@@ockWebApp.setHomePage(SimpleResponsePageClass.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2401.java