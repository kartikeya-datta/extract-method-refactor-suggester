error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2362.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2362.java
text:
```scala
i@@f (type == null || !type.isValidBinding()) return null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2362.java