error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5262.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5262.java
text:
```scala
public static c@@har[] toAnchor(char[] methodSignature, char[] methodName, boolean isVargArgs) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5262.java