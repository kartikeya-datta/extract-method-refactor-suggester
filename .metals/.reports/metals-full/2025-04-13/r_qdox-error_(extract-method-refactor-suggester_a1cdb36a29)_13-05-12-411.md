error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/455.java
...
```java
offset: 787
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/455.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/455.java