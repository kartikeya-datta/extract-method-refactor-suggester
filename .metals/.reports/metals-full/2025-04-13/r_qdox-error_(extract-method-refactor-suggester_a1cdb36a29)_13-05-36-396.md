error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3277.java
text:
```scala
f@@ileSystemBrowser = Activator.getDefault().getBrowseFileTransfer(url.getProtocol());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3277.java