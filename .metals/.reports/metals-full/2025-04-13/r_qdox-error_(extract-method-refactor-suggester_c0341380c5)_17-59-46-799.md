error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1923.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1923.java
text:
```scala
r@@ootNode = Jackson.defaultObjectMapper().readValue(Classes.getDefaultClassLoader().getResourceAsStream("org/elasticsearch/rest/action/main/quotes.json"), JsonNode.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1923.java