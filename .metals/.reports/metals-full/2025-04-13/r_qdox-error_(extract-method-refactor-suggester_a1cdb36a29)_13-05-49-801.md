error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9336.java
text:
```scala
i@@f(kind == K_BINARY_OPERATOR && info == LESS && this.identifierPtr > -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9336.java