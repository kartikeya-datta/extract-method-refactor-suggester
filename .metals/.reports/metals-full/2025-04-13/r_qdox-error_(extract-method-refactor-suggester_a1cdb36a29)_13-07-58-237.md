error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1615.java
text:
```scala
n@@ew ProgressAdapter() {};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1615.java