error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8768.java
text:
```scala
i@@f ("query_first".equals(value) || "queryFirst".equals(value)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8768.java