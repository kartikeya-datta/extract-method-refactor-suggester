error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9912.java
text:
```scala
i@@nt tokenStart = completionContext.getOffset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9912.java