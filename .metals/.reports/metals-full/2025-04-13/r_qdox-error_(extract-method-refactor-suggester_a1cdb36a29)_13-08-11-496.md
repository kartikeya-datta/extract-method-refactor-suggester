error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/815.java
text:
```scala
S@@priteBatch spriteBatch = (SpriteBatch)stage.getSpriteBatch();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/815.java