error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6489.java
text:
```scala
s@@etEmptyText(string.no_issues);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6489.java