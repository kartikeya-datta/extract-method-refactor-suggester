error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1648.java
text:
```scala
n@@ew Functor("getMeanAsNumber"), new Functor("getMedian"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1648.java