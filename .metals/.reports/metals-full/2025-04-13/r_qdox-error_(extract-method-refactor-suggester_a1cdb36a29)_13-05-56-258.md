error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15557.java
text:
```scala
s@@pacing.width = spacing.height = CELL_GAP;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15557.java