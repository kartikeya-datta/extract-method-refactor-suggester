error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6852.java
text:
```scala
t@@hrow new NonPositiveDefiniteMatrixException(ltI[i], i, absolutePositivityThreshold);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6852.java