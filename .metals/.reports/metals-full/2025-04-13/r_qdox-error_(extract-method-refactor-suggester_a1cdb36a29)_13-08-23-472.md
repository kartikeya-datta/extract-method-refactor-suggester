error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13185.java
text:
```scala
e@@mf = createEntityManagerFactory("cache-mode-enable", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13185.java