error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12464.java
text:
```scala
r@@eturn (getApplication().getAuthorizationStrategy().allowEnabledState(FormComponent.this) && FormComponent.this
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12464.java