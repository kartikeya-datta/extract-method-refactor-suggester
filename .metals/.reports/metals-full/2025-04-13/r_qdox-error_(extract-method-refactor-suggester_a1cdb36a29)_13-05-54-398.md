error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1338.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1338.java
text:
```scala
private static final S@@tring TAG = "HomeActivity";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1338.java