error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/853.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/853.java
text:
```scala
protected S@@tring targetTypeName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/853.java