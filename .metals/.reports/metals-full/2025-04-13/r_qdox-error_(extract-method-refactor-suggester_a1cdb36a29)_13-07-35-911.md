error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6782.java
text:
```scala
i@@f (width <= 0 || height <= 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6782.java