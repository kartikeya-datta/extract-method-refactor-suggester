error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3119.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3119.java
text:
```scala
private volatile b@@oolean specDescriptorPropertyReplacement = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3119.java