error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2655.java
...
```java
offset: 858
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2655.java
text:
```scala
 ...
 *
 */
p@@ackage org.apache.commons.compress.archivers.sevenz;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2655.java