error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9715.java
text:
```scala
c@@onn.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9715.java