error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17990.java
text:
```scala
d@@oTestResolution( propRef, propRef, m_store );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17990.java