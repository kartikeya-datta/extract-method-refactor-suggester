error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/250.java
text:
```scala
r@@eturn JFaceResources.getImageRegistry().get(Dialog.DLG_IMG_LOCKED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/250.java