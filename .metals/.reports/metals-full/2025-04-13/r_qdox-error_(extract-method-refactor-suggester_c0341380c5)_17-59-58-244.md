error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10413.java
text:
```scala
Q@@uery parentConstantScoreQuery = new ParentConstantScoreQuery(query, parentType, childrenFilter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10413.java