error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14855.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14855.java
text:
```scala
public v@@oid test() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14855.java