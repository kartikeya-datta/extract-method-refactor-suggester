error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9989.java
text:
```scala
f@@or (int i = newSize; i < size; i++)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9989.java