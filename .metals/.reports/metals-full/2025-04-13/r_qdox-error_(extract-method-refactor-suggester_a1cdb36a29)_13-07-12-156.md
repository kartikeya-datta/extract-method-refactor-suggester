error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5366.java
text:
```scala
r@@eturn binding != null ? binding.qualifiedSourceName() : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5366.java