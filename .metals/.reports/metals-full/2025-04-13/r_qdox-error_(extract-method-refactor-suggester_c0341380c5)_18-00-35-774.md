error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5080.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5080.java
text:
```scala
protected C@@ategorizedProblem[] problems; // new problems to report against this compilationUnit
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5080.java