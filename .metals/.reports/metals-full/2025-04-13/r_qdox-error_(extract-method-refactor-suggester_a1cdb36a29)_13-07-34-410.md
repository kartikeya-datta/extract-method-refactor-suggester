error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6110.java
text:
```scala
r@@eturn Double.NEGATIVE_INFINITY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6110.java