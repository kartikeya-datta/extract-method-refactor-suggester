error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3265.java
text:
```scala
a@@bsoluteBaseUrl = baseUrl.trim();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3265.java