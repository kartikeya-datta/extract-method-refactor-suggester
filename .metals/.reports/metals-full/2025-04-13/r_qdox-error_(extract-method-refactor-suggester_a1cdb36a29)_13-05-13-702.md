error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4610.java
text:
```scala
i@@f (this.ast.apiLevel >= AST.LEVEL_3_0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4610.java