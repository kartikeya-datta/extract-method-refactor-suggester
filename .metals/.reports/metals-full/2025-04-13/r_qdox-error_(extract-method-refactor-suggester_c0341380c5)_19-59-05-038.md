error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8089.java
text:
```scala
c@@onfiguration.addViewInterceptor(StatefulComponentInstanceInterceptor.FACTORY, InterceptorOrder.View.ASSOCIATING_INTERCEPTOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8089.java