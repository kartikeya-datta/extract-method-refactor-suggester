error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10742.java
...
```java
offset: 1072
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10742.java
text:
```scala
 ...
 *
 */
p@@ackage org.apache.jmeter.protocol.tcp.sampler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10742.java