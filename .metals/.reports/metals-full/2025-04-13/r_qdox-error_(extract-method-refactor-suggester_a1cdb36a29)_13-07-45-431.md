error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3718.java
text:
```scala
f@@uture = threadPool.schedule(interval, ThreadPool.Names.SAME, TranslogBasedFlush.this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3718.java