error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1574.java
text:
```scala
r@@eturn builder().put("gateway.type", "local").build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1574.java