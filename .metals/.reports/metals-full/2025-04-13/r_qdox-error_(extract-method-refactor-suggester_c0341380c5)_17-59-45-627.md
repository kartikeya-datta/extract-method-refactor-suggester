error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2453.java
text:
```scala
l@@astOperationRead = TranslogStreams.readTranslogOperation(new BytesStreamInput(cacheBuffer.array(), 0, opSize, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2453.java