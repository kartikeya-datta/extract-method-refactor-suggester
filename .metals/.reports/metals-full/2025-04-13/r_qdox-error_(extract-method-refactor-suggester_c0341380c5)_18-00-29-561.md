error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7780.java
text:
```scala
H@@elpViewerFactory.create(docURL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7780.java