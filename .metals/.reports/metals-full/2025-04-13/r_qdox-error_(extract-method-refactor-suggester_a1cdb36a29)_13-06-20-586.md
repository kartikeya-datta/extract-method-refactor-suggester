error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1614.java
text:
```scala
R@@esultSet rs = ps.execute(spsActivation, false, 0L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1614.java