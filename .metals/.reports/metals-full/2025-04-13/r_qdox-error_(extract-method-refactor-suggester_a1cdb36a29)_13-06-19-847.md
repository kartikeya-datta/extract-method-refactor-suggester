error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/318.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/318.java
text:
```scala
I@@ndexResponse indexResponse = client1.prepareIndex().setIndex("test").setType("type1").setId("1").setSource(source("1", "test")).setRefresh(true).execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/318.java