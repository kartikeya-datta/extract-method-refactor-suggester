error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5393.java
text:
```scala
t@@ouchEventPool.free(touchEvents);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5393.java