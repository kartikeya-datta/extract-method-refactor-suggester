error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9616.java
text:
```scala
n@@ode.get(ModelConstants.ACTIVATION).set(val.toString().toLowerCase(Locale.ENGLISH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9616.java