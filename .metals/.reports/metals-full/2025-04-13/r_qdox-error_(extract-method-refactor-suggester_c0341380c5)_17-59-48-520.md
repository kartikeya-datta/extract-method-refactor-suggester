error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16045.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16045.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16045.java
text:
```scala
public static final S@@tring DEFAULT_DEPLOYMENT_SERVER = "http://portal.28msec.com/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16045.java