error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3010.java
text:
```scala
i@@nt inset = 4;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3010.java