error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7671.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7671.java
text:
```scala
protected S@@tring hostname = ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7671.java