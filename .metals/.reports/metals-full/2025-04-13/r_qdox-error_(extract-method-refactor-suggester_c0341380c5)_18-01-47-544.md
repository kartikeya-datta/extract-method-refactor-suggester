error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1901.java
text:
```scala
S@@ystem.out.println(Messages.bind(Messages.build_incompleteClassPath, e.missingClassFile));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1901.java