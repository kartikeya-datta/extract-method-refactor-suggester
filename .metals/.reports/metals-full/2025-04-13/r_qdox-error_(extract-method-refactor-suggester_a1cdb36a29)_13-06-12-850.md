error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5049.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5049.java
text:
```scala
public W@@ebMarkupContainer getHeaderPart(int index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5049.java