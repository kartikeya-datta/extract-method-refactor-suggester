error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13619.java
text:
```scala
d@@isplay.setGrabControl (null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13619.java