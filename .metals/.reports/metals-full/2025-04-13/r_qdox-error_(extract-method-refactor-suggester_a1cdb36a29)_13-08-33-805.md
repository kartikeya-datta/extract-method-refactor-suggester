error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/95.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/95.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/95.java
text:
```scala
c@@lient.admin().cluster().health(clusterHealthRequest, new ActionListener<ClusterHealthResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/95.java