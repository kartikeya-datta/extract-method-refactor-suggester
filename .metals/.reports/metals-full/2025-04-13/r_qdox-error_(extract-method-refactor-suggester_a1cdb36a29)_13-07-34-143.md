error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7514.java
text:
```scala
i@@f (overrideRegistration == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7514.java