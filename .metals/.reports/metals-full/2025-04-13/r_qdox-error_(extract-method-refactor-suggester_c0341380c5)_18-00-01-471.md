error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3017.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3017.java
text:
```scala
public static final C@@lusterBlock INDEX_NOT_RECOVERED_BLOCK = new ClusterBlock(3, "index not recovered (not enough nodes with shards allocated found)", ClusterBlockLevel.READ_WRITE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3017.java