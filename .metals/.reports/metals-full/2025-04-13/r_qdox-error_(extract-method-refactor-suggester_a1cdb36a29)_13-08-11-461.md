error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6267.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6267.java
text:
```scala
R@@esource resource = application.getSharedResources().get(scope, name, locale, style, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6267.java