error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6565.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6565.java
text:
```scala
public final static S@@tring KEY_DELIMITER = "\u002B"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6565.java