error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/127.java
text:
```scala
S@@priteBatch spriteBatch = (SpriteBatch)stage.getBatch();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/127.java