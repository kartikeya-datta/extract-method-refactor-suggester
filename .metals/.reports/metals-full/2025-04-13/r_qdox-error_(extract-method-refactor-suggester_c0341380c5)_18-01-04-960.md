error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/806.java
text:
```scala
C@@olumbaLogger.log.info("toolbar-button=" +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/806.java