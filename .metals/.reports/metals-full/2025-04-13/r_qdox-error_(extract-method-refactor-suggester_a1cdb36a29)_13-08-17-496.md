error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2670.java
text:
```scala
L@@ogs.reportMessage("DBLOOK_TablesHeader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2670.java