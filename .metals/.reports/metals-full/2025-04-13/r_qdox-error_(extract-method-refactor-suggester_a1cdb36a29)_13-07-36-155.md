error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/315.java
text:
```scala
r@@eturn ((NSTextView)view).textStorage().paragraphs().count();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/315.java