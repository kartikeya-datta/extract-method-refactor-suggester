error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/572.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/572.java
text:
```scala
c@@har[][] identifiers =	CharOperation.splitOn('.', type, 0, dimStart);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/572.java