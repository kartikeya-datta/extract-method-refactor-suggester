error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9990.java
text:
```scala
u@@nexpectedAttribute(reader, i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9990.java