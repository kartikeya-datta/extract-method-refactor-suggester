error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4030.java
text:
```scala
l@@og.debug(whoAmI() + "\tCreating Java Client");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4030.java