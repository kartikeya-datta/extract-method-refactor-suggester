error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6036.java
text:
```scala
s@@tr = str.toUpperCase(Locale.ENGLISH).trim();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6036.java