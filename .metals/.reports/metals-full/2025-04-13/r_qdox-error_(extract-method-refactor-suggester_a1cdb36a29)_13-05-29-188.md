error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2806.java
text:
```scala
i@@f (!isEnableAllowed() || !isEnabled() || !group.isEnabled() || !group.isEnableAllowed())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2806.java