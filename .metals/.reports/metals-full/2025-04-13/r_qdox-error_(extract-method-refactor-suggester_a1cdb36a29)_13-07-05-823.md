error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2821.java
text:
```scala
t@@his.options.taskPriorities/*taskPriorities*/,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2821.java