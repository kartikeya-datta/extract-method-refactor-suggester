error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1343.java
text:
```scala
f@@or(Values values : rowToTupleMapper.toValues(result)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1343.java