error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/249.java
text:
```scala
s@@canner.resetTo(nextCharacterPosition, selectionEnd + 1 == source.length ? selectionEnd : selectionEnd + 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/249.java