error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11585.java
text:
```scala
r@@eturn isTrue("component '" + path + "' is not visible", component.isVisibleInHierarchy());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11585.java