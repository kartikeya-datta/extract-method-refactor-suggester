error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10235.java
text:
```scala
S@@tring url = req.getUrl().toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10235.java