error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3673.java
text:
```scala
r@@eturn new Lucene3xFields(state.directory, state.fieldInfos, state.segmentInfo, state.context, state.termsIndexDivisor) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3673.java