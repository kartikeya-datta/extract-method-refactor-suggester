error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1937.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1937.java
text:
```scala
r@@eturn new AccessLogHandler(handler, logReceiver, pattern, AccessLogService.class.getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1937.java