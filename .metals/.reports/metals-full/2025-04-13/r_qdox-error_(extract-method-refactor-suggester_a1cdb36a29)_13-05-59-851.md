error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2176.java
text:
```scala
b@@inding = new CaptureBinding((WildcardBinding) binding, null, 0); // TODO (jerome) decode binding key
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2176.java