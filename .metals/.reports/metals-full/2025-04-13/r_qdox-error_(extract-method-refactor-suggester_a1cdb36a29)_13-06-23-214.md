error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3684.java
text:
```scala
F@@ieldType fieldType = new FieldType(DoubleField.TYPE_NOT_STORED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3684.java