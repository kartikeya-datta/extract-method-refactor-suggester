error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9758.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9758.java
text:
```scala
private static O@@perationFailedRuntimeException duplicateElement(final String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9758.java