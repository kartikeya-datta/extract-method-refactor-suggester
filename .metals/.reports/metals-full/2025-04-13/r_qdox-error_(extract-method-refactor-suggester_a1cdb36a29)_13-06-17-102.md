error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/591.java
text:
```scala
i@@f (type == null || this.pattern.selector == null) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/591.java