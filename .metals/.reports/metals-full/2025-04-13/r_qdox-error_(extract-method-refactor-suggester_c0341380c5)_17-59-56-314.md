error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12850.java
text:
```scala
O@@S.class_addIvar(cls, SWT_OBJECT, C.PTR_SIZEOF, (byte)C.PTR_SIZEOF, "^v"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12850.java