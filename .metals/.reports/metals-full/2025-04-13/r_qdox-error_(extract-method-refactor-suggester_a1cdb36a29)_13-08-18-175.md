error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11799.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11799.java
text:
```scala
public static D@@omainDeploymentResourceDefinition createForServerGroup(HostFileRepository fileRepository) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11799.java