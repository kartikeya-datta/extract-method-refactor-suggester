error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3969.java
text:
```scala
A@@TTRIBUTE_CLASS, PrefUtil.getInternalPreferenceStore(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3969.java