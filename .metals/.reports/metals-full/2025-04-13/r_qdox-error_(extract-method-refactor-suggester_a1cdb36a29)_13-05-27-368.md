error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14655.java
text:
```scala
O@@S.gtk_spin_button_set_wrap (handle, (style & SWT.WRAP) != 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14655.java