error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1100.java
text:
```scala
s@@ = s + "throw "; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1100.java