error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9469.java
text:
```scala
W@@eldLogger.DEPLOYMENT_LOGGER.cdiAnnotationsButNotBeanArchive(deploymentUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9469.java