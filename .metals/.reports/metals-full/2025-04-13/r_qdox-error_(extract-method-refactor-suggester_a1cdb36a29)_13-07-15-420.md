error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2473.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2473.java
text:
```scala
final O@@ctalUnescaper oue = new OctalUnescaper();   //.between("1", "377");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2473.java