error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6766.java
text:
```scala
i@@f (childForName != null && childForName.size() != 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6766.java