error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15120.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15120.java
text:
```scala
S@@tring DEFAULT_STACK = "default-stack";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15120.java