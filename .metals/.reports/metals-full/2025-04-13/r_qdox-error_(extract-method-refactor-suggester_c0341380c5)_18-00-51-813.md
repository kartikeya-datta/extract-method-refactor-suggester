error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6156.java
text:
```scala
S@@et<String> autowiredBeanNames, TypeConverter typeConverter) throws BeansException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6156.java