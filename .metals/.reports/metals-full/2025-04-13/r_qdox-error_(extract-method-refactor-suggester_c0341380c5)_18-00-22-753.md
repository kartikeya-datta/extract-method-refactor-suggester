error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6839.java
text:
```scala
S@@ourceMethodElementInfo sourceMethodInfo = (SourceMethodElementInfo) getElementInfo();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6839.java