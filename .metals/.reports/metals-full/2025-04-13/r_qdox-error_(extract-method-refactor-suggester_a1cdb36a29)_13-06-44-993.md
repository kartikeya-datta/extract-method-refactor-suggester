error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8442.java
text:
```scala
t@@his.options.assertMode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8442.java