error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/818.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/818.java
text:
```scala
r@@eturn domainController.getDomainModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/818.java