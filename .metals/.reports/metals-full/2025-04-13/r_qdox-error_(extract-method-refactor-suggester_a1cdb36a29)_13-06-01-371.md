error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1384.java
text:
```scala
t@@his.language = settings.get("language", settings.get("name", "English"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1384.java