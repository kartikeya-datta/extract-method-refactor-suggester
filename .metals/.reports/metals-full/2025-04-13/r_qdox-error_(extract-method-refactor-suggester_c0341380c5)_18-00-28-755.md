error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1684.java
text:
```scala
d@@ocs = te.docs(null, docs, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1684.java