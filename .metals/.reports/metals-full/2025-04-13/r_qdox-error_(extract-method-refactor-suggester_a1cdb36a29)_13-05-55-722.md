error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8755.java
text:
```scala
i@@f (this == otherType || erasure() == otherType)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8755.java