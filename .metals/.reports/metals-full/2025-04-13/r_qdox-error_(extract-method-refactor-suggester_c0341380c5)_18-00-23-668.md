error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7306.java
text:
```scala
A@@rrayList<String> tmpFiles = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7306.java