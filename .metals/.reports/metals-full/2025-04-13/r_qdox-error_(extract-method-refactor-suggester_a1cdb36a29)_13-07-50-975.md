error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1141.java
text:
```scala
t@@his.out.println(Main.bind("configure.incorrectClasspath", this.classpaths[i])); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1141.java