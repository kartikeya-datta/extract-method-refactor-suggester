error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18297.java
text:
```scala
N@@SView widget = (NSView)new SWTCanvasView().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18297.java