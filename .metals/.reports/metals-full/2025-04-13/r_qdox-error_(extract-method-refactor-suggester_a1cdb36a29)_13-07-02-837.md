error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1437.java
text:
```scala
i@@f(protocol != null) connector.get(PROTOCOL).set(protocol);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1437.java