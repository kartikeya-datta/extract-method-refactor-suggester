error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5722.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5722.java
text:
```scala
r@@eturn this.invoker.invoke(this.sessionCache, new LockingFindOperation<String, FineSessionCacheEntry<L>>(id));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5722.java