error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12764.java
text:
```scala
s@@uper("Vex Core Tests");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12764.java