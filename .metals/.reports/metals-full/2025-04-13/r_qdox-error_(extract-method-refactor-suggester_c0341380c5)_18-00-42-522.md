error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9008.java
text:
```scala
r@@eturn "[ComponentRequestTarget@" + hashCode() + " " + component + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9008.java