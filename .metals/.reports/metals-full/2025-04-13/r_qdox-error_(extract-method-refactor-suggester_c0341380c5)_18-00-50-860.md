error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6369.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6369.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6369.java
text:
```scala
M@@essageDialog.openWarning(workbenchWindow.getShell(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6369.java