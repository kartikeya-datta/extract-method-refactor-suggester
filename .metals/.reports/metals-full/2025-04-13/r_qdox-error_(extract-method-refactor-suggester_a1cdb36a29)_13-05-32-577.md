error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7576.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7576.java
text:
```scala
+ " in parent " + p@@arent.getPageRelativePath(), re);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7576.java