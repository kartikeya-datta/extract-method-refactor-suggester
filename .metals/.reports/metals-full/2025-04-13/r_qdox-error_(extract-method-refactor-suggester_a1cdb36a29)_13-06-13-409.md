error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1980.java
text:
```scala
r@@enderBatch.render(instances.get(i), lights);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1980.java