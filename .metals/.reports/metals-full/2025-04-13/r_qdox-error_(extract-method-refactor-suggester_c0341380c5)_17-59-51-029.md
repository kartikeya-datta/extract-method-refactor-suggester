error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14734.java
text:
```scala
r@@emoteProxy = RemoteProxyController.create(handler, PathAddress.EMPTY_ADDRESS, ProxyOperationAddressTranslator.NOOP, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14734.java