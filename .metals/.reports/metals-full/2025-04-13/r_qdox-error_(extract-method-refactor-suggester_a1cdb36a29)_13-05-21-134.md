error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4468.java
text:
```scala
i@@f (!this.force) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4468.java