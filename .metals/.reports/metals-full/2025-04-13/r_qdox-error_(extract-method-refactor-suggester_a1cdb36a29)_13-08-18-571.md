error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13876.java
text:
```scala
I@@ResourceSettings resourceSettings = application.getResourceSettings();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13876.java