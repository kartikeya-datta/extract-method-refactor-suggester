error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5453.java
text:
```scala
i@@f (type.isValidBinding())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5453.java