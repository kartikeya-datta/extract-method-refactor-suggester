error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12919.java
text:
```scala
t@@ab.importUnique(unqs[j], null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12919.java