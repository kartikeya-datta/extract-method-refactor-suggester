error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2391.java
text:
```scala
f@@or (QueryNode child : children) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2391.java