error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7789.java
text:
```scala
E@@ngine.Searcher acquireSearcher();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7789.java