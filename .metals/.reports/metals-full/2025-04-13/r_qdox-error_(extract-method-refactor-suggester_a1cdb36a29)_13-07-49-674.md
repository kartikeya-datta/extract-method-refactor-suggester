error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2526.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2526.java
text:
```scala
enum Attribute {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2526.java