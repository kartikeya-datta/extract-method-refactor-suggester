error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2595.java
text:
```scala
n@@ew Integer(dimension1), new Integer(dimension2)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2595.java