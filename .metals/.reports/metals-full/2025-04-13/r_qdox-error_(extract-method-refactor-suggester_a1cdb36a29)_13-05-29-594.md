error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5208.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5208.java
text:
```scala
public C@@ollection getResults();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5208.java