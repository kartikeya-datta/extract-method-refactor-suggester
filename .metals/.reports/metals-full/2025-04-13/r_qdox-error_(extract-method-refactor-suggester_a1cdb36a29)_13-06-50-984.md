error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2896.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2896.java
text:
```scala
" to type: " + t@@heType.getName() + ". Could not find compatible converter.").setSourceValue(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2896.java