error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10797.java
...
```java
offset: 676
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10797.java
text:
```scala
...
p@@ackage org.springframework.cache.vendor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10797.java