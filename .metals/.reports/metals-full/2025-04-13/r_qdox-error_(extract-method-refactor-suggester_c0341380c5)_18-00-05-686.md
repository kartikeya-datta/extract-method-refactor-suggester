error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9318.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9318.java
text:
```scala
public I@@AnnotationBinding resolveAnnotationBinding() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9318.java