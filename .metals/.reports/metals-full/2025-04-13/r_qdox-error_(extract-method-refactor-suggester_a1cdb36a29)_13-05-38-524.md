error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7477.java
text:
```scala
r@@eturn Discriminator.NULL;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7477.java