error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16859.java
text:
```scala
p@@ublic interface IRequestParameters
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16859.java