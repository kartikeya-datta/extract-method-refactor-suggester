error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7919.java
text:
```scala
i@@nt kind = type.kind();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7919.java