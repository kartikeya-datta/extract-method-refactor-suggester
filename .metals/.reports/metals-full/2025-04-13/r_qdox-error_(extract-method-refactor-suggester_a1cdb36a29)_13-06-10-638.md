error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7500.java
text:
```scala
s@@ortedShardList = searchPhaseController.sortDocs(request, useSlowScroll, queryFetchResults);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7500.java