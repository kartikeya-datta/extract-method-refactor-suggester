error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10453.java
text:
```scala
t@@his(in, size, expectedCrc32 & 0xFFFFffffl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10453.java