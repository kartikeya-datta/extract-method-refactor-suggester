error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4464.java
text:
```scala
a@@ssertEquals("Number of unseen messages in folder", 0, info.getUnseen());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4464.java