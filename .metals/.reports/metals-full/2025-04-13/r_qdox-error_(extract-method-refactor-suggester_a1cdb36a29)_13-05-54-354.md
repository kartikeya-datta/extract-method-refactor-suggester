error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9310.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9310.java
text:
```scala
public N@@oRollbackRuleAttribute(Class<?> clazz) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9310.java