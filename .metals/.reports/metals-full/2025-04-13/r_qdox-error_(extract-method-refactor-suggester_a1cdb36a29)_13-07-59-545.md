error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2106.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2106.java
text:
```scala
c@@har[] classFileChars = type.getElementName().toCharArray();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2106.java