error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12480.java
text:
```scala
i@@f (SWT.getPlatform().equals("carbon")) return "S/S";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12480.java