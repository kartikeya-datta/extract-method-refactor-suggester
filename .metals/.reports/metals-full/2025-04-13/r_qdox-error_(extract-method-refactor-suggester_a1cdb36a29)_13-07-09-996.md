error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6928.java
text:
```scala
i@@f (objectIndex > -1 && (!this.hasMissingSuperClass || this.focusType == null)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6928.java