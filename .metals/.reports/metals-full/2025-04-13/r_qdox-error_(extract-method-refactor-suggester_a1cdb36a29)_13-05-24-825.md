error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6905.java
text:
```scala
i@@f (!candidates[0].declaringClass.isInterface()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6905.java