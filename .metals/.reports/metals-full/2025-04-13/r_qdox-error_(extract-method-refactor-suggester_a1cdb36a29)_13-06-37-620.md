error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7854.java
text:
```scala
T@@ypeBinding exceptionType = this.type.resolveType(scope, true /* check bounds*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7854.java