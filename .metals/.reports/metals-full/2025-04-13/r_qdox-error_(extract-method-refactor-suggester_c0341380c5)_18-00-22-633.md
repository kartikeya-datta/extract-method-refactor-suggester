error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9775.java
text:
```scala
t@@his(parent, id, new Model<String>(label));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9775.java