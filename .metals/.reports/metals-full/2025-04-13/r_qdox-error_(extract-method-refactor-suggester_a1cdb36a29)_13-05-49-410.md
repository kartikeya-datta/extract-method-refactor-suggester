error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/621.java
text:
```scala
p@@ublic class WildcardSetModel<T> extends GenericBaseModel<Set<? extends T>>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/621.java