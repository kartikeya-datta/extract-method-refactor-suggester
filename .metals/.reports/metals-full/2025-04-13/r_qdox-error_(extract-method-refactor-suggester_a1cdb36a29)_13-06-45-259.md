error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2309.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2309.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2309.java
text:
```scala
l@@istItem.add(new CheckBox("activ", new Boolean(value.isActive())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2309.java