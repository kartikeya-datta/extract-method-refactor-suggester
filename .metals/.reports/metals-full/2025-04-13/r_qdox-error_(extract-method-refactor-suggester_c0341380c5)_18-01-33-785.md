error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13918.java
text:
```scala
u@@sername = RemoteOutboundConnectionResourceDefinition.USERNAME.parse(value, reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13918.java