error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10185.java
text:
```scala
p@@ublic class IntegerConverter extends AbstractIntegerConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10185.java