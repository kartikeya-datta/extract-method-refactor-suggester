error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7203.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7203.java
text:
```scala
final O@@bjectOpenHashSet<DiscoveryNode> nodes = new ObjectOpenHashSet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7203.java