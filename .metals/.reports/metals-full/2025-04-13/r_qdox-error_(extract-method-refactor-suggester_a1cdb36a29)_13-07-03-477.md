error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4038.java
text:
```scala
c@@ontext.removeService(hqServiceName.append(HornetQServerAdd.PATH_BASE).append(HornetQServerAdd.DEFAULT_LARGE_MESSAGE_DIR));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4038.java