error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9532.java
text:
```scala
t@@hrow new CommandFormatException("Unexpected argument '" + ctx.getArgumentsString() + '\'');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9532.java