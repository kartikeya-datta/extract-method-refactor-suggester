error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2588.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2588.java
text:
```scala
s@@uper(docsEnums.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2588.java