error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3826.java
text:
```scala
t@@otal += info.sizeInBytes(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3826.java