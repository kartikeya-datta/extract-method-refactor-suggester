error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10015.java
text:
```scala
i@@ndex.remove(this.resourceName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10015.java