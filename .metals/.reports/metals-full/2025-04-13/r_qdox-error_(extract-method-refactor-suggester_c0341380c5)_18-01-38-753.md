error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10395.java
text:
```scala
e@@rror (SWT.ERROR_INVALID_RANGE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10395.java