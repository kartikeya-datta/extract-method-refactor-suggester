error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7562.java
text:
```scala
i@@f (!ignoreDrawFocus && (hooks (SWT.PaintItem) || findImageControl () != null)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7562.java