error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1595.java
text:
```scala
t@@hrow new SearchParseException(context, "No facet type found for [" + facetFieldName + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1595.java