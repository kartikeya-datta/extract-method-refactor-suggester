error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1478.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1478.java
text:
```scala
S@@ystemTable.updateToken(StorageService.getPartitioner().getToken("503545744:0".getBytes()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1478.java