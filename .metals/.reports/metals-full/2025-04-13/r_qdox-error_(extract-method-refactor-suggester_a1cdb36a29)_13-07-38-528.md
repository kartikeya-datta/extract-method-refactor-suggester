error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7171.java
text:
```scala
s@@uper(fullySpecified);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7171.java