error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10044.java
text:
```scala
g@@etObservable().clearMessage(500);	// 500 ms delay
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10044.java