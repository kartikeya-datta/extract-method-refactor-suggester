error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10487.java
text:
```scala
i@@f (next != null && ! (next instanceof IModel))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10487.java