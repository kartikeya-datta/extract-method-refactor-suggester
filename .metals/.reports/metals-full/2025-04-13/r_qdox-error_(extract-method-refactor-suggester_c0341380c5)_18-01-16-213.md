error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1306.java
text:
```scala
t@@ypeParameterInfo.bounds = typeParameterBounds;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1306.java