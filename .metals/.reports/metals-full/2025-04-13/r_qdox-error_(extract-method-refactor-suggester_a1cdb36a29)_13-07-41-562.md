error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14800.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14800.java
text:
```scala
private final L@@ist connectors;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14800.java