error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7645.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7645.java
text:
```scala
public i@@nt samples = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7645.java