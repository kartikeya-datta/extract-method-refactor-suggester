error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12610.java
text:
```scala
r@@esult.add(ConnectionFactoryAdd.getAddOperation(address, property.getValue()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12610.java