error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9294.java
text:
```scala
f@@or (String destination : destinations) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9294.java