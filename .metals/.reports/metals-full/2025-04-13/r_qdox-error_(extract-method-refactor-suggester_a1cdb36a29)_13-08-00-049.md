error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14690.java
text:
```scala
f@@ormComponent.inputChanged();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14690.java