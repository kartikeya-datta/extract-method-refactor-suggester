error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14116.java
text:
```scala
c@@aches.add(new ConcurrentMapCache(""));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14116.java