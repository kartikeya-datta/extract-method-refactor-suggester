error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14660.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14660.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14660.java
text:
```scala
i@@nt tagend = prefix.indexOf('\"', tagstart); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14660.java