error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11752.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11752.java
text:
```scala
public static final A@@ttachmentKey<MountHandle> ATTACHMENT_KEY = AttachmentKey.create(MountHandle.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11752.java