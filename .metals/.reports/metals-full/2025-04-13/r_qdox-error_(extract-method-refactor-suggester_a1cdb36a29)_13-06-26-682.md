error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3283.java
text:
```scala
r@@eturn new TermsFacetCollector(facetName, field, size, context.numberOfShards(), context.fieldDataCache(), context.mapperService(), excluded);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3283.java