error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9645.java
text:
```scala
r@@eturn SharedResources.resourceKey(application, scope, name, locale, style);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9645.java