error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5957.java
text:
```scala
i@@f (dialog.success()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5957.java