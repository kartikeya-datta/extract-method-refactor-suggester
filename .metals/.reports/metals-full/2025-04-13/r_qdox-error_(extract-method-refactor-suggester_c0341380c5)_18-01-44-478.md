error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4441.java
text:
```scala
i@@f (annotationTypePattern.matchesRuntimeType(toMatchAgainst).alwaysTrue()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4441.java