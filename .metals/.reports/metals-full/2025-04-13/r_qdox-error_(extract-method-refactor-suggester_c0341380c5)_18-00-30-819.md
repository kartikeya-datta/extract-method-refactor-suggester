error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11157.java
text:
```scala
r@@eturn sigPattern.matches(rm,world,false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11157.java