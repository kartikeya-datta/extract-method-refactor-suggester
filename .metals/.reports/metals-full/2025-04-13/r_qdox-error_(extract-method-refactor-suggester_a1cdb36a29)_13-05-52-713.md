error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8348.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8348.java
text:
```scala
S@@ystem.out.println("(" + Thread.currentThread() + ") [JarEntryFile.getContents()] Creating ZipFile on " + this.zipName); //$NON-NLS-1$	//$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8348.java