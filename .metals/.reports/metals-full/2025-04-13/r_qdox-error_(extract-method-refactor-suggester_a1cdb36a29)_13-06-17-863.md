error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7326.java
text:
```scala
t@@hrow new IllegalStateException("Invalid modules directory: " + bundlesDir);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7326.java