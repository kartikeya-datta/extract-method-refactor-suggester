error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2014.java
text:
```scala
S@@ystem.err.println("Stack trace of embedded throwable:"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2014.java