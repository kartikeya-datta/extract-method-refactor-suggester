error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6624.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6624.java
text:
```scala
public S@@aveIndex(IPath projectPath, IndexManager manager) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6624.java