error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1460.java
text:
```scala
h@@eader.setFlag(Flags.QR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1460.java