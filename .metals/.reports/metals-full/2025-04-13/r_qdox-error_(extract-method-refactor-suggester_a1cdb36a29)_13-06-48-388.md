error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17913.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17913.java
text:
```scala
public final v@@oid componentRendered(final Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17913.java