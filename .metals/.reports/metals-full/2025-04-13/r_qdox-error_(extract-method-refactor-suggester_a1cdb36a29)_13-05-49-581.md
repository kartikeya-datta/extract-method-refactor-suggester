error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1559.java
text:
```scala
S@@tring start = System.getProperty("user.dir", "");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1559.java