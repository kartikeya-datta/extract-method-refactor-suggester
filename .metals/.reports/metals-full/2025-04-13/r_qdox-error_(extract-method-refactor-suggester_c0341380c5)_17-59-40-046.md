error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9559.java
text:
```scala
C@@lusterChangedEvent clusterChangedEvent = new ClusterChangedEvent(source, clusterState, previousClusterState);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9559.java