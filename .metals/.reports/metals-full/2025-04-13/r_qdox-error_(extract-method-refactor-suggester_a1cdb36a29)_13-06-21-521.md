error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3809.java
text:
```scala
t@@hrow new WicketRuntimeException("The requested resource was not found: " + url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3809.java