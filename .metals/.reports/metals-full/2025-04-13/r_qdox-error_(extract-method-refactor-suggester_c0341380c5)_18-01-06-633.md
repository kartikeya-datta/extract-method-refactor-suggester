error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1651.java
text:
```scala
s@@erver.setCommunicationHandler(DirectServerCommunicationHandler.create(SocketConnection.accepted(socket), processName, new MessageHandler(serverManager), serverManager));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1651.java