error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1010.java
text:
```scala
n@@ew RepeatingView(rowItem, "cols");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1010.java