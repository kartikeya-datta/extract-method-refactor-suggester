error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2175.java
text:
```scala
i@@f (args != null && args.length == 2){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2175.java