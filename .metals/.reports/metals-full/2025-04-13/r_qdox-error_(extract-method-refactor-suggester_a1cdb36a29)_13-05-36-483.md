error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6051.java
text:
```scala
r@@eturn super.convertValue(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6051.java