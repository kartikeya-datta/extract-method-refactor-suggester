error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6456.java
text:
```scala
f@@older.setSimple(traditionalTab);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6456.java