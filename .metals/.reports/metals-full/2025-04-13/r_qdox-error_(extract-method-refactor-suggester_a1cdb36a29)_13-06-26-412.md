error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9475.java
text:
```scala
r@@eturn BooleanTypedValue.TRUE; // no need to evaluate right operand
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9475.java