error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10414.java
text:
```scala
O@@S.SetDataBrowserScrollPosition (handle, Math.max (0, top [0] + rect.top - border - getHeaderHeight ()), left [0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10414.java