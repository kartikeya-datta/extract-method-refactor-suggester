error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/900.java
text:
```scala
S@@tring token = ByteBufferUtil.string(fromdisk, fromdisk.position(), splitPoint - fromdisk.position(), UTF_8);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/900.java