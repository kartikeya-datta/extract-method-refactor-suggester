error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8353.java
text:
```scala
p@@rofileNames = CLITestSuite.serverProfiles.keySet().toArray(new String[CLITestSuite.serverProfiles.size()]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8353.java