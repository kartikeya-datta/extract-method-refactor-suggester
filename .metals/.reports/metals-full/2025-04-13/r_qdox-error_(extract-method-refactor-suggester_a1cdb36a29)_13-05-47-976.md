error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4313.java
text:
```scala
V@@iewElement viewElement = new ViewElement(views[i], this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4313.java