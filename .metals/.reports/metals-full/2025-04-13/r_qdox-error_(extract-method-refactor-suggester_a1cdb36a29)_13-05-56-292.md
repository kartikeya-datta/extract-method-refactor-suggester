error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1388.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1388.java
text:
```scala
i@@f (object == null) continue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1388.java