error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9172.java
text:
```scala
A@@ttributeAccess getAttributeAccess(final ListIterator<PathElement> address, final String attributeName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9172.java