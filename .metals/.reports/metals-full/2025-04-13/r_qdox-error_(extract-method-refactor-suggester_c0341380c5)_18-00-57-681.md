error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6769.java
text:
```scala
i@@f (valueRequired) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6769.java