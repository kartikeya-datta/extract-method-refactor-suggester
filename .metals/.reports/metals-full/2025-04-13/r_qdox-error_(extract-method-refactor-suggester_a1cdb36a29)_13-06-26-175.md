error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/844.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/844.java
text:
```scala
public static final S@@tring NAME = "frange";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/844.java