error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6983.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6983.java
text:
```scala
final I@@SecuritySettings settings = application.getSecuritySettings();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6983.java