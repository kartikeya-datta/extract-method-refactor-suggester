error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9034.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9034.java
text:
```scala
private final M@@ap.Entry<K, V> entry;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9034.java