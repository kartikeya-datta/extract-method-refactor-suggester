error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10554.java
text:
```scala
t@@his.applicationName = applicationName == null ? "" : applicationName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10554.java