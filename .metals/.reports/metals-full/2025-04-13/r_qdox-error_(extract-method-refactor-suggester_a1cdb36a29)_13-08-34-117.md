error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8332.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8332.java
text:
```scala
l@@ong metaTagBits = annotationBinding.getAnnotationTagBits();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8332.java