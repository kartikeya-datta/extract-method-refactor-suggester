error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8644.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8644.java
text:
```scala
private static final l@@ong MODULE_DEPENDENCY_PROCESSOR_ORDER = DeploymentPhases.PARSE_DESCRIPTORS.plus(100L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8644.java