error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2353.java
text:
```scala
r@@eturn c.getSimpleName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2353.java