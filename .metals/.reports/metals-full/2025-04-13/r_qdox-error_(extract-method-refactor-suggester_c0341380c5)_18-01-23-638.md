error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12205.java
text:
```scala
D@@OMAIN_1_3("urn:jboss:domain:1.3") ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12205.java