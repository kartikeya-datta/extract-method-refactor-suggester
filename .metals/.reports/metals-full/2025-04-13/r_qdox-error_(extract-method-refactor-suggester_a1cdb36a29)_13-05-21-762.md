error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8492.java
text:
```scala
N@@odesInfoResponse response = client("server1").admin().cluster().prepareNodesInfo().execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8492.java