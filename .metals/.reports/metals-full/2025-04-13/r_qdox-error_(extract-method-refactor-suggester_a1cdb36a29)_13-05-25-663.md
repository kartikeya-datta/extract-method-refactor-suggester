error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7451.java
text:
```scala
n@@ewUpdate(record.withDClass(DClass.NONE, 0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7451.java