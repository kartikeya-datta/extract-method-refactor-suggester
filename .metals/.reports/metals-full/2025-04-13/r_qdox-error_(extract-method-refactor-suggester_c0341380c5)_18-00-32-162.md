error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10210.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10210.java
text:
```scala
static final S@@tring SUBSYSTEM_XML_FILE = JGroupsSchema.CURRENT.format("subsystem-jgroups-%d_%d.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10210.java