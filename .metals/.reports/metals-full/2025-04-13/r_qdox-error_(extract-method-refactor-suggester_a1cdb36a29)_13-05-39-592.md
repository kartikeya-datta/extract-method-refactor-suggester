error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6847.java
text:
```scala
c@@ommand.addArgument("/parsableErrors");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6847.java