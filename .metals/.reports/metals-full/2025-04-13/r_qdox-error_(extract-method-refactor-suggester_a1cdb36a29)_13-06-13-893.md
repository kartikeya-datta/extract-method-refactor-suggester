error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3676.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3676.java
text:
```scala
i@@f (!destFile.isReadOnly() && newContent != null){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3676.java