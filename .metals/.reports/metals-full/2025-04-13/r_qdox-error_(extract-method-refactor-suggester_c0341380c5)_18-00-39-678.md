error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7537.java
text:
```scala
r@@eturn charContents = org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(location.toFile(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7537.java