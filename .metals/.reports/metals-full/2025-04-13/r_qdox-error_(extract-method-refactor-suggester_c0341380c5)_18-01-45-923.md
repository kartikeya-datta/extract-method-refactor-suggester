error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1597.java
text:
```scala
i@@f (t != null && originalPriority > -1 && t.isAlive())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1597.java