error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12148.java
text:
```scala
i@@f (accelerator != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12148.java