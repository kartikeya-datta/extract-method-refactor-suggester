error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2616.java
text:
```scala
p@@anel.add(new TextField<Object>(field.getFieldName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2616.java