error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13224.java
text:
```scala
S@@ourceTypeBinding invocationType = scope.invocationType(); //enclosingSourceType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13224.java