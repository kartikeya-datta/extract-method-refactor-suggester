error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4324.java
text:
```scala
i@@nitsOnContinue = initsOnContinue.mergedWith(flowInfo.copy().unconditionalInits());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4324.java