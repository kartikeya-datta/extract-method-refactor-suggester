error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1177.java
text:
```scala
s@@etBorderBodyContainer(bodyParent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1177.java