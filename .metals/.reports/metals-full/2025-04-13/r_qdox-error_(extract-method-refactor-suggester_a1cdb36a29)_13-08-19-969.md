error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/385.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/385.java
text:
```scala
protected v@@oid update(final int position, final UserItemView view, final User user) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/385.java