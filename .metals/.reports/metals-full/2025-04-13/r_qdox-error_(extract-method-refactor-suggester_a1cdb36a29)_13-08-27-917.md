error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10551.java
text:
```scala
n@@ew String[] { "classpath:org/springframework/test/context/support/AbstractContextLoaderUtilsTests$BareAnnotations-context.xml" },
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10551.java