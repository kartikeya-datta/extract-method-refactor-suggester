error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9792.java
text:
```scala
t@@ag.setComponentId(getComponentId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9792.java