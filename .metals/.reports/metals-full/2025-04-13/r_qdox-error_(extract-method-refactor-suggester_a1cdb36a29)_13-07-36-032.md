error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2374.java
text:
```scala
c@@ache.draw(batch, parentAlpha);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2374.java