error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14624.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14624.java
text:
```scala
final I@@Model next = nestedModelObject.getNestedModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14624.java