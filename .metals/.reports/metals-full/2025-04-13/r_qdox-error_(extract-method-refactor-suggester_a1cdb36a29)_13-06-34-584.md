error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12005.java
text:
```scala
b@@oolean defaultFg = fg[0] == 0 && fg[1] == 0 && fg[2] == 0 && fg[3] == 1 && gc.data.alpha == 255;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12005.java