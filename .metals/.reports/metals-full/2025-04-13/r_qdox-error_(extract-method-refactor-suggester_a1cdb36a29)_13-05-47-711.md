error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6820.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6820.java
text:
```scala
public static final b@@yte VERSION = 0x0013; // added timestamps to external jars
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6820.java