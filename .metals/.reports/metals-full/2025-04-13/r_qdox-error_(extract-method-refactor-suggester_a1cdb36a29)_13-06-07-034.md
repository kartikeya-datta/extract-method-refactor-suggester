error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5419.java
text:
```scala
i@@f(passwordMode) updateDisplayText();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5419.java