error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13326.java
text:
```scala
i@@nt hIcon = OS.CopyImage (hImage, OS.IMAGE_ICON, width, height, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13326.java