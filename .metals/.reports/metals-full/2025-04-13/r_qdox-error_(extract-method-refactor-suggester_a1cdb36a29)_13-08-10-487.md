error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3117.java
text:
```scala
e@@xecuteScript("ant_condition");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3117.java