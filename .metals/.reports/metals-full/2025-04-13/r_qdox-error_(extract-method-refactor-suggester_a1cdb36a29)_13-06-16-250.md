error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6843.java
text:
```scala
f@@rameMediator.getView().showToolbar();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6843.java