error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10.java
text:
```scala
v@@oid addAction(String commandId, IHandler action);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10.java