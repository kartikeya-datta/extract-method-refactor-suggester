error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3710.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3710.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3710.java
text:
```scala
h@@elpViewer.gotoURL(result.file,true, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3710.java