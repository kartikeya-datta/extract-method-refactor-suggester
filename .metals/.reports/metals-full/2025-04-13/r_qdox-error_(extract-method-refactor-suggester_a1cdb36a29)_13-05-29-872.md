error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2319.java
text:
```scala
r@@eturn new AdaptiveLogisticRegression.TrainingExample(i, null, target, data);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2319.java