error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4540.java
text:
```scala
i@@f (tag2 == null) continue nlsTagsLoop2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4540.java