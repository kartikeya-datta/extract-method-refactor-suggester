error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9545.java
text:
```scala
i@@f (!OS.IsWinCE && transparentPixel != -1 && isDib && bm.bmBitsPixel <= 8) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9545.java