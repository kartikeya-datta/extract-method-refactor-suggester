error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3400.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3400.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3400.java
text:
```scala
a@@tlas = new TextureAtlas(Gdx.files.internal("data/pack"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3400.java