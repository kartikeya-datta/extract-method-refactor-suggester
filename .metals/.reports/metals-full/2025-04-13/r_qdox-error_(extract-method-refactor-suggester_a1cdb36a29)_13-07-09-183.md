error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11011.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11011.java
text:
```scala
final U@@RLClassLoader classLoader = getClassLoaderForFile( file );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11011.java