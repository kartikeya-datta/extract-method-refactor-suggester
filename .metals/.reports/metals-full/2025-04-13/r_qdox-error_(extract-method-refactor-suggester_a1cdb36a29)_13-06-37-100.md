error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4948.java
text:
```scala
T@@oolItem item = items [index];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4948.java