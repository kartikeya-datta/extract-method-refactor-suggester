error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14950.java
text:
```scala
i@@f (Boolean.getBoolean("wicket.replace.expected.results"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14950.java