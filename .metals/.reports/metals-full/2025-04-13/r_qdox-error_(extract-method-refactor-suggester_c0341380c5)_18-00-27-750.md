error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13186.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13186.java
text:
```scala
final M@@odifiableConnDef connectionDefinitionValue = RaOperationUtil.buildConnectionDefinitionObject(context, recoveryEnvModel, poolName, isXa);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13186.java