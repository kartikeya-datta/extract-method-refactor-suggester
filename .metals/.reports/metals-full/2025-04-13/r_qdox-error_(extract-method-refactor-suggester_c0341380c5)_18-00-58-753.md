error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6260.java
text:
```scala
n@@ewMapperService(), new NoneFilterCache(index, EMPTY_SETTINGS), new AnalysisService(index), null, null, null, "test", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6260.java