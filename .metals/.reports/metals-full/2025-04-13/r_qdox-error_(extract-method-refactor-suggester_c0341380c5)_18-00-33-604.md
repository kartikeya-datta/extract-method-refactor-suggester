error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/279.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/279.java
text:
```scala
public v@@oid unnecessaryNLSTags(int sourceStart, int sourceEnd) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/279.java