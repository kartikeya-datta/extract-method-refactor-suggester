error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5745.java
text:
```scala
t@@his.scope.problemReporter().undocumentedEmptyBlock(this.bodyStart-1, this.bodyEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5745.java