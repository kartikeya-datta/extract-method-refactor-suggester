error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4737.java
text:
```scala
r@@eturn ExpressionUtils.convertTypedValue(context, new TypedValue(value), desiredResultType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4737.java