error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4657.java
text:
```scala
e@@vent.createProperties();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4657.java