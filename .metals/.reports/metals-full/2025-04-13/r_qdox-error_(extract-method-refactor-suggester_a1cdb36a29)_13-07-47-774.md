error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8780.java
text:
```scala
i@@f (!injectionTargetType.isAssignableFrom(classType)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8780.java