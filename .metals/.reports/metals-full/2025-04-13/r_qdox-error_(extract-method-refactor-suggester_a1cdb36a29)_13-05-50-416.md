error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3798.java
text:
```scala
l@@ong metaTagBits = annotationBinding.getAnnotationTagBits(); // could be forward reference
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3798.java