error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8394.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8394.java
text:
```scala
private static b@@oolean raggedTrim = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8394.java