error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9412.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9412.java
text:
```scala
c@@ountdownDoneLatch();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9412.java