error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14292.java
text:
```scala
r@@eturn getSSLSocketFactory().createSocket(socket, host, port, autoClose);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14292.java