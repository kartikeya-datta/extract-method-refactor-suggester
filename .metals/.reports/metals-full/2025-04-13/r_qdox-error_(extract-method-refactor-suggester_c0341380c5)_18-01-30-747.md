error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5917.java
text:
```scala
v@@alue = ec.subst(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5917.java