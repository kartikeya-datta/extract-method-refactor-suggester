error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6847.java
text:
```scala
s@@uper(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6847.java