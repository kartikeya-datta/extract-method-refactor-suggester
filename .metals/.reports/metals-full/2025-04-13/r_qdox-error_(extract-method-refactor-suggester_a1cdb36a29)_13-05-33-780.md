error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1420.java
text:
```scala
i@@nboxFolder = (IMAPFolder) srcFolder.findChildWithName("Inbox", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1420.java