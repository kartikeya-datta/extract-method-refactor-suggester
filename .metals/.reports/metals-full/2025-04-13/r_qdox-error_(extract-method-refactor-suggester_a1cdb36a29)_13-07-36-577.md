error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9484.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9484.java
text:
```scala
B@@uildExecutor.executeAnt("jni/build-macosx32.xml", "-v");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9484.java