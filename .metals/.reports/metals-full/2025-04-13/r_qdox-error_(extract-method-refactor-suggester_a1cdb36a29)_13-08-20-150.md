error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2606.java
text:
```scala
i@@f (randomBoolean()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2606.java