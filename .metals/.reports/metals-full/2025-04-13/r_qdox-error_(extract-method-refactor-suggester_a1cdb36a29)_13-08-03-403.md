error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10211.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10211.java
text:
```scala
static final S@@tring VERSION = "1.9.20031207";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10211.java