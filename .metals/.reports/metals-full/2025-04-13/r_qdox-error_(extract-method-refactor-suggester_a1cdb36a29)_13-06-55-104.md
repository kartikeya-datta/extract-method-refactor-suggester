error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18097.java
text:
```scala
i@@f (container != null && container.getConnectedID() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18097.java