error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/474.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/474.java
text:
```scala
public v@@oid document(int docID, StoredFieldVisitor visitor) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/474.java