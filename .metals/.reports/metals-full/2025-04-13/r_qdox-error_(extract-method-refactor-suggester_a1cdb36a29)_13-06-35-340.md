error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/868.java
text:
```scala
l@@ogger.trace("[{}][{}] starting recovery to {}, mark_as_relocated {}", request.shardId().index().name(), request.shardId().id(), request.targetNode(), request.markAsRelocated());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/868.java