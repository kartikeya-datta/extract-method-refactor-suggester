error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17071.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17071.java
text:
```scala
public S@@tring prepareEndpoint(IRemoteCall call, IRemoteCallable callable) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17071.java