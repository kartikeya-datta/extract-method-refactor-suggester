error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8768.java
text:
```scala
z@@e.setName(entryEncoding.decode(fileName), fileName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8768.java