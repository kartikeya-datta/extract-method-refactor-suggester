error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9290.java
text:
```scala
r@@eturn cluster().client(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9290.java