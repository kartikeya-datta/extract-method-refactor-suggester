error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10419.java
text:
```scala
L@@OG.info("Writing " + path + " the data " + data.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10419.java