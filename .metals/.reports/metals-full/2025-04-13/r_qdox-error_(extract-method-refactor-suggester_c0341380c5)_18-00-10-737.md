error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9478.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9478.java
text:
```scala
t@@his.propertyAccessors.add(new ReflectivePropertyAccessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9478.java