error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13886.java
text:
```scala
r@@eturn requiresNew(invocation, component, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13886.java