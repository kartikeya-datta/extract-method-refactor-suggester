error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7791.java
text:
```scala
A@@pplication.get().getResourceSettings().getCachingStrategy().decorateResponse(resourceResponse);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7791.java