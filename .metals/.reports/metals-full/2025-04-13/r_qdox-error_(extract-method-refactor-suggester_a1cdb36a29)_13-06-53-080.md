error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1604.java
text:
```scala
r@@eturn super.getCollection();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1604.java