error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4377.java
text:
```scala
s@@ = s + "break "/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4377.java