error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/269.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/269.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/269.java
text:
```scala
private M@@odelNode transformReadResourceResult(final OperationContext context, ModelNode original, String subsystem, int major, int minor, int micro) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/269.java