error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3187.java
text:
```scala
A@@nalysis.parseStopWords(env, settings, GermanAnalyzer.getDefaultStopSet(), version),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3187.java