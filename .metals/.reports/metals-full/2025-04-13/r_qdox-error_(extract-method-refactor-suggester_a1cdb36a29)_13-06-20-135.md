error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6193.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6193.java
text:
```scala
public M@@odelNode buildRequestWithoutHeaders(CommandContext ctx) throws OperationFormatException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6193.java