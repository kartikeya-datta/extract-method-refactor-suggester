error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9.java
text:
```scala
i@@f (page == null || page.isPageStateless())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9.java