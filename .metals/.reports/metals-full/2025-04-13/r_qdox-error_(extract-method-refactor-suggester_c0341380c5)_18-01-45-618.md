error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/907.java
text:
```scala
t@@his.panel = new SignInPanel(page,"panel")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/907.java