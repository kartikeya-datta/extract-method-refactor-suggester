error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14373.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14373.java
text:
```scala
public v@@oid testIgnoreSurroundingSpacesAreDeleted() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14373.java