error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2190.java
text:
```scala
p@@ublic class RetrieveFileTransferContainerAdapterFactory extends
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2190.java