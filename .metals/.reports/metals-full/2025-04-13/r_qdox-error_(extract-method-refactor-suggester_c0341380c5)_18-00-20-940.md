error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8517.java
text:
```scala
t@@otalSizeInBytes += file.length();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8517.java