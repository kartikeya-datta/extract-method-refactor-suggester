error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5849.java
text:
```scala
i@@mapFolder.ensureFolderIsSynced(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5849.java