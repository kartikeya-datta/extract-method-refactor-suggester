error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6517.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6517.java
text:
```scala
final C@@omponent component = page.get(Strings.afterFirstPathComponent(path, ':'));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6517.java