error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6038.java
...
```java
offset: 888
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6038.java
text:
```scala
 ...
 */
p@@ackage org.apache.commons.io.comparator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6038.java