error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1582.java
text:
```scala
a@@ddApplicationListener(listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1582.java