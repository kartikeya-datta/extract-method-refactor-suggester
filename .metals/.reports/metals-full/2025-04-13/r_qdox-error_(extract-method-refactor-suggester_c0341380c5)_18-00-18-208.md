error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4334.java
text:
```scala
m@@beanServer.getAttribute(objectName, "IntervalSeconds");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4334.java