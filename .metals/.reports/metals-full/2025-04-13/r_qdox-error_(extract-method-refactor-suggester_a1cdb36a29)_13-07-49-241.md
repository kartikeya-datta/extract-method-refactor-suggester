error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17572.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[90,27]

error in qdox parser
file content:
```java
offset: 3049
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17572.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17572.java