error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4415.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4415.java
text:
```scala
private C@@ontentDisposition contentDisposition = ContentDisposition.INLINE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4415.java