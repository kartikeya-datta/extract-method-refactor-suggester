error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11312.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11312.java
text:
```scala
public C@@ontainerInfo(final MarkupContainer container)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11312.java