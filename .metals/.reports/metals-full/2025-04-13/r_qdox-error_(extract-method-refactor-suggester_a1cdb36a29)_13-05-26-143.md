error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5847.java
text:
```scala
s@@ = s + "throw "/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5847.java