error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6141.java
text:
```scala
i@@f(manager.isFiltering() && !manager.isEnabledId(perspID))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6141.java