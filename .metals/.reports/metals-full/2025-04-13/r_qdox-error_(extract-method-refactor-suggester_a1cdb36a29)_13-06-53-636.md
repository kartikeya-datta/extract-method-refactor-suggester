error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7421.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7421.java
text:
```scala
i@@nfos = new ArrayList<>(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7421.java