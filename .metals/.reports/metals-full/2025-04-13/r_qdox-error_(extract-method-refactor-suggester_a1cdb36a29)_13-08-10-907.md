error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2522.java
text:
```scala
t@@arget.add(ajaxLabel2, "ajaxLabel");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2522.java