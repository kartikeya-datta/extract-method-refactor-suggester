error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15094.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15094.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15094.java
text:
```scala
H@@andlerProvider<WebSocketHandler<?>> handler) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15094.java