error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7887.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7887.java
text:
```scala
public S@@tring convertSchemaCase(String objectName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7887.java