error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13430.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13430.java
text:
```scala
H@@ostModelUtil.createRootRegistry(rootRegistration, environment, ignoredRegistry, this, processType, authorizer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13430.java