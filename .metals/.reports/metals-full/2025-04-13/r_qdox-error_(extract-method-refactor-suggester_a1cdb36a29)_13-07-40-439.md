error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8026.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8026.java
text:
```scala
protected v@@oid updateProblemsFor(CompilationResult result) throws CoreException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8026.java