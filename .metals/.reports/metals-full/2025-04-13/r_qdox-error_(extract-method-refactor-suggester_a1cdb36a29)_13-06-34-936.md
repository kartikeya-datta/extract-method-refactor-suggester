error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8969.java
text:
```scala
t@@his.applicationExceptions = Collections.unmodifiableMap(ejbComponentCreateService.getApplicationExceptions().getApplicationExceptions());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8969.java