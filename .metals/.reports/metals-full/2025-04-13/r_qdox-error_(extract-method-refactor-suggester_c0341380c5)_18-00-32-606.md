error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12371.java
...
```java
offset: 662
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12371.java
text:
```scala
...
p@@ackage org.springframework.context.annotation4;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12371.java