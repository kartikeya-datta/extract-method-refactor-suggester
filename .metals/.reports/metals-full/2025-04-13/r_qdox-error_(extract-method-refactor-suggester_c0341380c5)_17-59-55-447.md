error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1811.java
text:
```scala
m@@ap.put("org.apache.cassandra.db.marshal.CounterColumnType", JdbcCounterColumn.instance);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1811.java