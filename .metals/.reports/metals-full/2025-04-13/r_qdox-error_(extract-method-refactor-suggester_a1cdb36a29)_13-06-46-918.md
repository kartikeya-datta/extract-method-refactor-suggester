error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8473.java
text:
```scala
i@@f (maxMergeAtOnceExplicit != TieredMergePolicyProvider.this.maxMergeAtOnceExplicit) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8473.java