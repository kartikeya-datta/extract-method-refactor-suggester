error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4058.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4058.java
text:
```scala
public static final T@@imeValue TCP_DEFAULT_CONNECT_TIMEOUT = new TimeValue(2, TimeUnit.SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4058.java