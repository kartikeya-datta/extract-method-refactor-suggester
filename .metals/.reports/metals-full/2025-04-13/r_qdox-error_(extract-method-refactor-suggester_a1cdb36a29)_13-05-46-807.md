error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2179.java
text:
```scala
i@@f (knownType == null) knownType = HashMap.class;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2179.java