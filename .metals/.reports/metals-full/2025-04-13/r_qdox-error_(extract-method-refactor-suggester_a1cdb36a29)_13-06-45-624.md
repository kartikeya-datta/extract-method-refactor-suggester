error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14084.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14084.java
text:
```scala
private S@@tring redirectUrl = "http://www.theserverside.com";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14084.java