error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14929.java
text:
```scala
t@@his.annotationMetadata = new StandardAnnotationMetadata(beanClass, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14929.java