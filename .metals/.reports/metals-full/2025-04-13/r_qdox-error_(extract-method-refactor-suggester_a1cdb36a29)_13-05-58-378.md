error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5406.java
...
```java
offset: 856
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5406.java
text:
```scala
...
p@@ackage org.apache.jmeter.protocol.jms.sampler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5406.java