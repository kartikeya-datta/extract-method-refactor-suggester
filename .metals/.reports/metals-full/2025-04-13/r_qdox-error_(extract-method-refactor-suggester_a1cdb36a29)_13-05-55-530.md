error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10015.java
text:
```scala
t@@hrow ControllerMessages.MESSAGES.failedToRecoverServices(e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10015.java