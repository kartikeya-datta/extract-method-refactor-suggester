error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7535.java
text:
```scala
a@@pplication.getResourceSettings().addStringResourceLoader(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7535.java