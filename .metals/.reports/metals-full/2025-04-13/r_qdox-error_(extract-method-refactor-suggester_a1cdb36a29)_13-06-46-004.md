error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5769.java
text:
```scala
P@@erspectiveDescriptor desc = new PerspectiveDescriptor(element.getAttribute(IWorkbenchRegistryConstants.ATT_ID), element);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5769.java