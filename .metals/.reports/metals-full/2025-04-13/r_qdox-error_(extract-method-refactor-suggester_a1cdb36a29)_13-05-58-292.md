error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13162.java
text:
```scala
t@@is = new ByteArrayInputStream(text.getBytes("ISO8859_1"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13162.java