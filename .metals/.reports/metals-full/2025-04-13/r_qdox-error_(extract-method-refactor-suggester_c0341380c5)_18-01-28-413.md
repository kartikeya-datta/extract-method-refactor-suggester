error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10220.java
text:
```scala
l@@istener.onFailure(new MasterNotDiscoveredException("waited for [" + timeout + "]"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10220.java