error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17107.java
text:
```scala
a@@pplication.getRequestCycleSettings().getComponentResolvers().add(new ScopedComponentResolver());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17107.java