error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1501.java
text:
```scala
p@@ref = new GwtPreferences(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1501.java