error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6216.java
...
```java
offset: 1113
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6216.java
text:
```scala
...
p@@ackage org.jboss.as.connector.deployers.processors;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6216.java