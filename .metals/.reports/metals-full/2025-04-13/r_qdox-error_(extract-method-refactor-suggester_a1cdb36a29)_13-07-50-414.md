error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/788.java
text:
```scala
i@@f (input.buttons[Input.SHOOT] && !input.oldButtons[Input.SHOOT] || Gdx.input.isTouched()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/788.java