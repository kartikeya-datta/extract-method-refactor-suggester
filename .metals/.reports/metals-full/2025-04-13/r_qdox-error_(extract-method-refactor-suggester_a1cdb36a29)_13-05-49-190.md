error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8208.java
text:
```scala
s@@witch((int)/*64*/user_data) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8208.java