error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6950.java
text:
```scala
l@@ogger.debug("Using [balanced] merge policy with merge_factor[{}], min_merge_size[{}], max_merge_size[{}], max_merge_docs[{}] use_compound_file[{}]",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6950.java