error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3732.java
text:
```scala
n@@ame + "] must be in the [0, 100] range");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3732.java