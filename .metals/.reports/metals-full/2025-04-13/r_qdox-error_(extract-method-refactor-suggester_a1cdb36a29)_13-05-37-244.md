error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2628.java
text:
```scala
c@@odeStream.sendOperator(postIncrement.operator, this.implicitConversion & COMPILE_TYPE_MASK);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2628.java