error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7711.java
text:
```scala
I@@ndexService indexService = indicesService.indexServiceSafe(shardId.getIndex());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7711.java