error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15124.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15124.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15124.java
text:
```scala
o@@peration.get(REQUEST_PROPERTIES, DRIVER_NAME.getName(), REQUIRED).set(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15124.java