error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7335.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7335.java
text:
```scala
public final static b@@oolean NO_TYPE_COMPLETION_ON_EMPTY_TOKEN = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7335.java