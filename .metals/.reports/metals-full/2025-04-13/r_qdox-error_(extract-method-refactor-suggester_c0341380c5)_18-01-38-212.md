error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2847.java
text:
```scala
r@@eturn ""/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2847.java