error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10894.java
text:
```scala
i@@nt /*long*/ gtk_icon_release (int /*long*/ widget, int /*long*/ icon_pos, int /*long*/ event) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10894.java