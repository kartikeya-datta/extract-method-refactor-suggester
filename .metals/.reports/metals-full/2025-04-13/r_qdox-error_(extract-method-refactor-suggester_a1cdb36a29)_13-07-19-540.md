error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11353.java
text:
```scala
p@@ublic class TextTemplateLink extends ResourceLink
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11353.java