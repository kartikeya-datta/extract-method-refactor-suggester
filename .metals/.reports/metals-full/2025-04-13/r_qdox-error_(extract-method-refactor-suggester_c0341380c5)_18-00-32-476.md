error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5071.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5071.java
text:
```scala
public static final R@@eferenceBinding LUB_GENERIC = new ReferenceBinding() { /* used for lub computation */};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5071.java