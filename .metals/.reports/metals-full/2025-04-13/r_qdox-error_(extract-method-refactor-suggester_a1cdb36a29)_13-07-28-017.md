error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6083.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6083.java
text:
```scala
s@@uper.WM_ERASEBKGND (wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6083.java