error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14085.java
text:
```scala
r@@eturn ((ClassLoaderWeavingAdaptor)WeaverContainer.getWeaver(loader, weavingContext)).generatedClassesExistFor(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14085.java