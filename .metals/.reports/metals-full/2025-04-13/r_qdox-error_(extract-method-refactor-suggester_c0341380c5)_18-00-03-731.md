error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10751.java
text:
```scala
a@@ssertNotNull(fixture.removeNamespace(namespace));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10751.java