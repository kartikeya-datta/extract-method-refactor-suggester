error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9555.java
text:
```scala
A@@ssert.notNull(session, "session is required");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9555.java