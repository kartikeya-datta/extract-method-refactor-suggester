error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1895.java
...
```java
offset: 1169
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1895.java
text:
```scala
 ...
 */
p@@ackage org.wildfly.clustering.ejb.infinispan;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1895.java