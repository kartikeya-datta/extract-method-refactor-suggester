error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2434.java
text:
```scala
N@@umericUtils.longToPrefixCoded(longValue, 0, bytesRef);   // 0 because of exact match
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2434.java