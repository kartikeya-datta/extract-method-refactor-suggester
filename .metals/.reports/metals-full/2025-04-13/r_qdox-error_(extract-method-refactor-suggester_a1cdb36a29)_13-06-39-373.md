error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7907.java
text:
```scala
i@@nterfaces.add(new String(ClassFile.translatedName(interfaceSig)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7907.java