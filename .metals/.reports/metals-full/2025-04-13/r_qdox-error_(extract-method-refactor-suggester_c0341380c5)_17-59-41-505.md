error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13231.java
text:
```scala
i@@f (version == AsVersion.AS_7_1_2_FINAL || version == AsVersion.AS_7_1_3_FINAL) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13231.java