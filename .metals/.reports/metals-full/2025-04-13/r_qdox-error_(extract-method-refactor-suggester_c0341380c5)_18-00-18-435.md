error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6480.java
text:
```scala
c@@hild.setMarkupId(replaced);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6480.java