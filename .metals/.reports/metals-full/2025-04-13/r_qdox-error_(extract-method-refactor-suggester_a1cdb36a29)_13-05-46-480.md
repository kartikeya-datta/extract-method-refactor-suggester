error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14684.java
text:
```scala
o@@utputFile = File.createTempFile("ECFTest", "").toURL();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14684.java