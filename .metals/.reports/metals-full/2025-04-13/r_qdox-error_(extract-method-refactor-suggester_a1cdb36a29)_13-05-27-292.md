error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/731.java
text:
```scala
V@@ector3.tmp2.sub(box.max);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/731.java