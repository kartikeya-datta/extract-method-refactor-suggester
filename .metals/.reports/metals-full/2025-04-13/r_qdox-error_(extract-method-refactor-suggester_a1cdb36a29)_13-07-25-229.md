error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10458.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10458.java
text:
```scala
private static final O@@bject lock = new Object();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10458.java