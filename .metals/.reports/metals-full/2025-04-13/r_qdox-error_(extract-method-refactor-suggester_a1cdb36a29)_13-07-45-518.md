error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15085.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15085.java
text:
```scala
public v@@oid setSoftReferenceSize(int size) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15085.java