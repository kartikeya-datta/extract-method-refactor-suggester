error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17359.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17359.java
text:
```scala
private static final S@@tring DEFAULT_EXTENSION = ".bz2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17359.java