error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4048.java
text:
```scala
I@@njector<Endpoint> getEndpointInjector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4048.java