error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/113.java
text:
```scala
C@@ollection<WorkerSlot> availableSlots(Collection<SupervisorDetails> existingSupervisors, Collection<WorkerSlot> usedSlots, Collection<TopologyDetails> topologies);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/113.java