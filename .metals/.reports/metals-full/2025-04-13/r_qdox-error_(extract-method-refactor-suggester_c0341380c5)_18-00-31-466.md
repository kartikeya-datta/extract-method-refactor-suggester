error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14493.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14493.java
text:
```scala
final S@@erviceController<?> service = updateContext.getServiceRegistry().getService(WebSubsystemElement.JBOSS_WEB_HOST.append(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14493.java