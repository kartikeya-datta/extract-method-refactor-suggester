error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4771.java
text:
```scala
L@@ist as = BcelAttributes.readAjAttributes(getDeclaringType().getClassName(),method.getAttributes(), getSourceContext(world),world.getMessageHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4771.java