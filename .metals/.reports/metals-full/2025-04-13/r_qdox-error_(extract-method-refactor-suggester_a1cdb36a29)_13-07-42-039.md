error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12361.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12361.java
text:
```scala
final C@@harSequence url = group.urlFor(IOnChangeListener.INTERFACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12361.java