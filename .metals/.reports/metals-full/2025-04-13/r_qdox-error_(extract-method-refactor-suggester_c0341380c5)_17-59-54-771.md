error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1243.java
text:
```scala
r@@eturn new ConstantScoreQuery(termFilter(value, context));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1243.java