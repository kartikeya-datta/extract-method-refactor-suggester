error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11589.java
text:
```scala
r@@esultHandler.handleFailed(new ModelNode().set("unknown log handler type"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11589.java