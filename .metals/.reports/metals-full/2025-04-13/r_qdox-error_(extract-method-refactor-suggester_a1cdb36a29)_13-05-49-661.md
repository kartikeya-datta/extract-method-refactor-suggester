error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2765.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2765.java
text:
```scala
a@@ssertTrue("readerFactory is not an instanceof " + AlternateDirectoryTest.TestIndexReaderFactory.class, readerFactory instanceof StandardIndexReaderFactory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2765.java