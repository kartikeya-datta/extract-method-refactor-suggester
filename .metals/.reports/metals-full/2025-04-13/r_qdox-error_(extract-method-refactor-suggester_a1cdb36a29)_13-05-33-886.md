error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8635.java
text:
```scala
v@@boBatch = new SpriteBatch(1000, VertexDataType.VertexBufferObject);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8635.java