error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14547.java
text:
```scala
i@@nt /*long*/ findPopupHandle (int /*long*/ oldList) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14547.java