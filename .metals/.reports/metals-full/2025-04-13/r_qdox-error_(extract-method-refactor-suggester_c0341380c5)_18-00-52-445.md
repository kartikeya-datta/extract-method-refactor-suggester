error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10188.java
text:
```scala
p@@ublic class ZeroPaddingIntegerConverter extends AbstractIntegerConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10188.java