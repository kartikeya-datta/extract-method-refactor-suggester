error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8557.java
text:
```scala
T@@HROTTLE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8557.java