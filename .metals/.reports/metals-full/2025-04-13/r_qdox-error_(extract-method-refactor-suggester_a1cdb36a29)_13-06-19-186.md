error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9667.java
text:
```scala
s@@etText(WorkbenchMessages.PartPane_detach);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9667.java