error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7619.java
text:
```scala
P@@ageMap pageMap = pageMapForName(pageMapName, Objects.equal(PageMap.DEFAULT_NAME,pageMapName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7619.java