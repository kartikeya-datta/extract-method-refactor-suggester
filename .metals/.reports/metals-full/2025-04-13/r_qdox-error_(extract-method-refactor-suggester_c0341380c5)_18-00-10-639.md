error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/26.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/26.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/26.java
text:
```scala
i@@nt[] newarray = ArrayUtil.grow(parents, ordinal + 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/26.java