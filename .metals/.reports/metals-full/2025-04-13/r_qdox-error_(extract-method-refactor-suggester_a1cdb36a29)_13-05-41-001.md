error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13421.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13421.java
text:
```scala
r@@eturn HttpRequest.get("http://localhost:8080/jaxrsnoap/" + urlPattern, 10, TimeUnit.SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13421.java