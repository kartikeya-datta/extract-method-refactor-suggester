error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2870.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2870.java
text:
```scala
public E@@EModuleConfiguration(EEModuleDescription description, DeploymentPhaseContext context, final Module module) throws DeploymentUnitProcessingException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2870.java