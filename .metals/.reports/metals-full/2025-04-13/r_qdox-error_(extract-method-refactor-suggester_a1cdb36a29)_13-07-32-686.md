error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16496.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16496.java
text:
```scala
transient C@@ompoundVariable function;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16496.java