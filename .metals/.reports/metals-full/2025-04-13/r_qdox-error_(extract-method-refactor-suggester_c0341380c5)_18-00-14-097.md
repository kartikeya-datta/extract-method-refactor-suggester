error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1812.java
text:
```scala
s@@uper(CommonAttributes.ROOT_LOGGER_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1812.java