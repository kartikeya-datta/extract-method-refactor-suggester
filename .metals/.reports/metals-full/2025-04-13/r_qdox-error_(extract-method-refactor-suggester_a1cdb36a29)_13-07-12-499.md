error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17272.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17272.java
text:
```scala
i@@nt /*long*/ result = OS.objc_msgSend(OS.class_WebPreferences, OS.sel_standardPreferences);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17272.java