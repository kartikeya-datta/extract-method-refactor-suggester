error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2087.java
text:
```scala
a@@ssertEquals("reader=" + reader, 1, reader.leaves().size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2087.java