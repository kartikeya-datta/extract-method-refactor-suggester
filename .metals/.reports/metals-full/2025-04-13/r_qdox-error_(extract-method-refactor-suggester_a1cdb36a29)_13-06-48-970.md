error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13745.java
text:
```scala
a@@dviceMethod = getDeclaringType().getDeclaredMethod(getName(),getParameterTypes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13745.java