error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9649.java
text:
```scala
d@@ecodeModifiers(key[key.length - 1]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9649.java