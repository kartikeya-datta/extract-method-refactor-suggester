error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3507.java
text:
```scala
c@@oreSession.createQueue(QUEUE_EXAMPLE_QUEUE, QUEUE_EXAMPLE_QUEUE, false);
 ...
 */
package org.jboss.as.test.smoke.embedded.demos.messaging;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3507.java