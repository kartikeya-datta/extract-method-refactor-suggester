error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2357.java
text:
```scala
r@@eturn ThreadPool.Names.REFRESH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2357.java