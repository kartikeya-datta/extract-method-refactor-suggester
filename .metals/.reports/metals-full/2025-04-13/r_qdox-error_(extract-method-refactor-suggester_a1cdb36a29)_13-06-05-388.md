error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10187.java
text:
```scala
p@@ublic class ShortConverter extends AbstractIntegerConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10187.java