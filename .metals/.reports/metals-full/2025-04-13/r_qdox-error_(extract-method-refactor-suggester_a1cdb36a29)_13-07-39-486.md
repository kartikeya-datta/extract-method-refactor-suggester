error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5032.java
text:
```scala
s@@uper(node == null ? null : node.name(), node == null ? null : node.address(), action, msg, cause);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5032.java