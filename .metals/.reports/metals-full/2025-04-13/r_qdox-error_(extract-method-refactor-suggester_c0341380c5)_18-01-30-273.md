error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10443.java
text:
```scala
S@@tring EJB_ANNOTATION_PROPERTY_REPLACEMENT = "ejb-annotation-property-replacement";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10443.java