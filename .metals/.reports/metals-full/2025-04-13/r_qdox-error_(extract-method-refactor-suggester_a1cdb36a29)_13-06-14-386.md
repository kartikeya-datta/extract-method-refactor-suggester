error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11402.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11402.java
text:
```scala
public d@@ouble computeObjectiveValue(double[] params) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11402.java