error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9261.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9261.java
text:
```scala
final S@@tring stackTrace = writer.toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9261.java