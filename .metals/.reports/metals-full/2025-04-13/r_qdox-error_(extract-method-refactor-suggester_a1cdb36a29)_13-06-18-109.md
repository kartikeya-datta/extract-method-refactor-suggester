error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3600.java
text:
```scala
r@@eturn "indexing "/*nonNLS*/ + resource.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3600.java