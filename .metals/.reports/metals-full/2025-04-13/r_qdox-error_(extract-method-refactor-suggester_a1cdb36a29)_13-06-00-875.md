error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7253.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7253.java
text:
```scala
public static final S@@tring version = "1.0 Milestone M2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7253.java