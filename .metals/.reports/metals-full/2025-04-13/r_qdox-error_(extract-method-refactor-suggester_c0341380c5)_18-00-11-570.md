error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6480.java
text:
```scala
i@@f (BeanUtils.isSimpleValueType(targetType.getType())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6480.java