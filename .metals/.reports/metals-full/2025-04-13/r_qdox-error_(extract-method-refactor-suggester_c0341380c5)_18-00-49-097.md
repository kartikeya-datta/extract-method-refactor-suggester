error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3589.java
text:
```scala
a@@ssertThat(routingTable.index("test").shard(0).replicaShards().get(0).currentNodeId(), equalTo("node3"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3589.java