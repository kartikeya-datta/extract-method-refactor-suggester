error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/325.java
text:
```scala
f@@loat frameDuration = readFloat(in); // in seconds
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/325.java