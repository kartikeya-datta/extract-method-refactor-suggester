error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1181.java
text:
```scala
p@@roject.saveClasspath(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1181.java