error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/307.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/307.java
text:
```scala
public v@@oid setEndTime(long end) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/307.java