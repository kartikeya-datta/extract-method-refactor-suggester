error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2495.java
text:
```scala
L@@ist<Integer> list = Arrays.asList(new Integer[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2495.java