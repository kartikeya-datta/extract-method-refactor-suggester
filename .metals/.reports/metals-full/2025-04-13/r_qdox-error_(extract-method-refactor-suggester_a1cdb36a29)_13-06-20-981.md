error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8091.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8091.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8091.java
text:
```scala
c@@onfiguration.addClientInterceptor(method, StatelessWriteReplaceInterceptor.factory(configuration.getViewServiceName().getCanonicalName()), InterceptorOrder.Client.WRITE_REPLACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8091.java