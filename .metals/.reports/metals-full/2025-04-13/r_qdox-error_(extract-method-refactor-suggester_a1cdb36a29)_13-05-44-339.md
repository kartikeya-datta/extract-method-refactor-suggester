error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/235.java
text:
```scala
t@@his.registry = new WebMvcStompEndpointRegistry(webSocketHandler, transportRegistration, userSessionRegistry,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/235.java