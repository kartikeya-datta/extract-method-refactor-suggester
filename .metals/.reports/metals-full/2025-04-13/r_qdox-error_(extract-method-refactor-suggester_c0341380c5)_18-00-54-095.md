error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17822.java
text:
```scala
i@@nt position = start [0] + Math.max (0, buffer.length - 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17822.java