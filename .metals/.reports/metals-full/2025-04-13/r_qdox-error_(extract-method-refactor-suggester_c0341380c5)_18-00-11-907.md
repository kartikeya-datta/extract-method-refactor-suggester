error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9355.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9355.java
text:
```scala
I@@ClasspathEntry[] entries= ((JavaProject)getJavaProject()).getExpandedClasspath(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9355.java