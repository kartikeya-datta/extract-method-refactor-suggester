error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1307.java
text:
```scala
s@@r.setResponseData(sb.toString(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1307.java