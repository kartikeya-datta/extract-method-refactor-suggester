error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8808.java
text:
```scala
o@@ut.write(strategy.getLineSeparator());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8808.java