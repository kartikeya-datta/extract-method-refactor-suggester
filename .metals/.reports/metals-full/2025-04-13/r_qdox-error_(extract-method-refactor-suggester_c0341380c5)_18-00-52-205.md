error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4619.java
text:
```scala
I@@ndexTemplateMetaData template = IndexTemplateMetaData.Builder.fromXContentStandalone(parser);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4619.java