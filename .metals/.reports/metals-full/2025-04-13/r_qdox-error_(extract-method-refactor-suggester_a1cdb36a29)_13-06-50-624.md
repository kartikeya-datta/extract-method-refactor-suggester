error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3990.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3990.java
text:
```scala
public P@@ackageBinding getTopLevelPackage(char[] name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3990.java