error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6321.java
text:
```scala
i@@nt pt = (x & 0xFFFF) | ((y << 16) & 0xFFFF0000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6321.java