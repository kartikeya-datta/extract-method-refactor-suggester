error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3439.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3439.java
text:
```scala
public static final O@@perationStepHandler INSTANCE = new NativeManagementWriteAttributeHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3439.java