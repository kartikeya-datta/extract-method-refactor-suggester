error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11297.java
text:
```scala
C@@omponent parent = getComponent().getParent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11297.java