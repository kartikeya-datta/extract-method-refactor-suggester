error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8472.java
text:
```scala
A@@ssert.assertEquals(313, LocalizedFormats.values().length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8472.java