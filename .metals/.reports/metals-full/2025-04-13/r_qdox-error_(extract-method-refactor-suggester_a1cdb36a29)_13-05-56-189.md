error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13800.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13800.java
text:
```scala
final C@@ollection<ServiceName> serviceNames = ConnectorServices.getResourceAdapterDependencies(this.resourceAdapterName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13800.java