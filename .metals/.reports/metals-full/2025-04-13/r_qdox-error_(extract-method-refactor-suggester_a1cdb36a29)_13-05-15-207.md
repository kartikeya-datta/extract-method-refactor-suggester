error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/924.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/924.java
text:
```scala
a@@dd(new Label(this,"txt", "Demo"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/924.java