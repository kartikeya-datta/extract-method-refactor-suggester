error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2207.java
text:
```scala
i@@f (originalMethod.typeVariables == NoTypeVariables || originalMethod.isStatic()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2207.java