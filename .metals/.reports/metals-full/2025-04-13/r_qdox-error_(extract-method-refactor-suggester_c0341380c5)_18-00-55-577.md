error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13381.java
text:
```scala
P@@roxyOperationRegistry(final String valueString, final OperationSubregistry parent, final OperationHandler operationHandler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13381.java