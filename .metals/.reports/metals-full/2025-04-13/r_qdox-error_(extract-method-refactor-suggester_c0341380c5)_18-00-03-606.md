error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7771.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7771.java
text:
```scala
final M@@odelNode depNode = deployments.get(deploymentName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7771.java