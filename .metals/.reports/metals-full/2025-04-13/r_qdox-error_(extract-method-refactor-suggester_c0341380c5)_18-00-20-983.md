error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13206.java
...
```java
offset: 665
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13206.java
text:
```scala
 ...
 */
p@@ackage org.springframework.ui.binding.support;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13206.java