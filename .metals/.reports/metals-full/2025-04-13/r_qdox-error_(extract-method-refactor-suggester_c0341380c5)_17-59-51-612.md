error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7844.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7844.java
text:
```scala
A@@rray<K> keys = this.keys;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7844.java