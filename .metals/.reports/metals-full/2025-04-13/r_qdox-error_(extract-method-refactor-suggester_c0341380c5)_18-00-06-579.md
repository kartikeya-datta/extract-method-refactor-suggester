error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/476.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/476.java
text:
```scala
public v@@oid addField(IndexableField field, FieldInfo fieldInfo) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/476.java