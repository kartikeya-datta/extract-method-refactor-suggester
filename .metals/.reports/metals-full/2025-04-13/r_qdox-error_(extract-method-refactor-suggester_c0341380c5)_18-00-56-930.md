error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4280.java
text:
```scala
o@@nModelClicked("g3d/knight.g3dj");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4280.java