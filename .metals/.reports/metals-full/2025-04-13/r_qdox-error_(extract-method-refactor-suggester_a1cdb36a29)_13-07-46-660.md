error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11933.java
...
```java
offset: 598
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11933.java
text:
```scala
...
p@@ackage org.eclipse.ecf.tests.filetransfer.outgoing;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11933.java