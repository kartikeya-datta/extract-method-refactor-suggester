error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/567.java
text:
```scala
J@@sonBuilder builder = binaryJsonBuilder().prettyPrint()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/567.java