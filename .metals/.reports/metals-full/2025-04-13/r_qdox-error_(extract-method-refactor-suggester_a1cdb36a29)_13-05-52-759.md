error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5851.java
text:
```scala
c@@ontext.getResult().set(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5851.java