error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9888.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9888.java
text:
```scala
public final l@@ong getSizeInBytes()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9888.java