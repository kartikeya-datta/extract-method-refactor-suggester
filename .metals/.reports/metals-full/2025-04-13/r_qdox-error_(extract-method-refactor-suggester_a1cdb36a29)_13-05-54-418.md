error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17719.java
...
```java
offset: 3257
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17719.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17719.java