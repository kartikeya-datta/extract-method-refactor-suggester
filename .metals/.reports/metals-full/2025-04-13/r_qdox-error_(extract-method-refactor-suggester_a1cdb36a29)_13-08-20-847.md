error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14945.java
text:
```scala
u@@rl = url + "wicket:antiCache=" + System.currentTimeMillis();
...
public class NonCachingImage extends Image
{
	...
	protected void onComponentTag(ComponentTag tag)
	{
		...
		url = url + "org.apache.wicket:antiCache=" + System.currentTimeMillis();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14945.java