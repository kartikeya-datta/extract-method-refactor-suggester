error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7911.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7911.java
text:
```scala
private static final S@@tring FILEVERSION = "645912"; // Expected value $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7911.java