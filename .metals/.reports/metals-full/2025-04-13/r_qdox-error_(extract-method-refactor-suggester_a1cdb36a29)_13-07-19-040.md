error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7247.java
text:
```scala
M@@ap<String, String[]> bFilters = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7247.java