error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3750.java
text:
```scala
Q@@ueryParser queryParser = new QueryParser(TEST_VERSION_CURRENT, TEXT_FIELD, new WhitespaceAnalyzer());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3750.java