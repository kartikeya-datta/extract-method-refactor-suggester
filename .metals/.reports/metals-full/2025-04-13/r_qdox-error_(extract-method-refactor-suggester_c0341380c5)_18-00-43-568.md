error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6223.java
text:
```scala
i@@f (!isVisible()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6223.java