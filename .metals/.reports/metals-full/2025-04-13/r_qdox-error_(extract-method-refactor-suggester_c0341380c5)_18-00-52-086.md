error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8580.java
text:
```scala
i@@f (len != 0.f && !MathUtils.isEqual(len, 1f)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8580.java