error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1229.java
text:
```scala
l@@astModified = Time.now();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1229.java