error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/127.java
text:
```scala
t@@hrow ThreadsLogger.ROOT_LOGGER.threadPoolServiceNotFoundForMetrics(serviceNameBase.append(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/127.java