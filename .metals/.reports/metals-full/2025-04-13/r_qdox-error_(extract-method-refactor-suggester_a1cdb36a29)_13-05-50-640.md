error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/287.java
text:
```scala
a@@pplication.getServletRequest().setRequestToRedirectString("?path=0:tree:tree:3:node:junctionLink&interface=ILinkListener");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/287.java