error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2302.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2302.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2302.java
text:
```scala
final W@@orkbenchMenuService menuService = new WorkbenchMenuService(evaluationService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2302.java