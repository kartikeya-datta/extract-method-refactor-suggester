error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12232.java
text:
```scala
C@@ollections.sort(sorted,comparator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12232.java