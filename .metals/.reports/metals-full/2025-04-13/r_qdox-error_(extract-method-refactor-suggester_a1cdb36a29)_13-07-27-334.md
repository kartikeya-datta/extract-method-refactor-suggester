error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9949.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9949.java
text:
```scala
protected S@@hardCountRequest newShardRequest(int numShards, ShardRouting shard, CountRequest request) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9949.java