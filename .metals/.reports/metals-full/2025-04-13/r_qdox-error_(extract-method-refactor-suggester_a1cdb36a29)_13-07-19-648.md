error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2232.java
text:
```scala
o@@ut.writeVInt(shardId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2232.java