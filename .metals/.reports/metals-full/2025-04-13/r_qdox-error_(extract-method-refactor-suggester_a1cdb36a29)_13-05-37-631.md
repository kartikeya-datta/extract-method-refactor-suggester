error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8575.java
text:
```scala
i@@ds[i] = (int)Long.parseLong(array[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8575.java