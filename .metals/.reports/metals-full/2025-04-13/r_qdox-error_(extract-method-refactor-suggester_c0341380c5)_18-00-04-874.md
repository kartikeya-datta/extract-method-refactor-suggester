error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1428.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1428.java
text:
```scala
protected C@@harSequence getDefaultChoice(final Object selected)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1428.java