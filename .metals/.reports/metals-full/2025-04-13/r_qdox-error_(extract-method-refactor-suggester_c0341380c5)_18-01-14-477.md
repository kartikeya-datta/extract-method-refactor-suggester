error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6322.java
text:
```scala
u@@pdateContext.getServiceTarget().addService(RemotingServices.ENDPOINT, endpointService)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6322.java