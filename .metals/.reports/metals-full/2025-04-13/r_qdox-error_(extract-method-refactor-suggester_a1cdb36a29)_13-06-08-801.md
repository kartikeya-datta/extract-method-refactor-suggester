error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1877.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1877.java
text:
```scala
i@@f (module == null && bundleState == BundleState.INSTALLED) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1877.java