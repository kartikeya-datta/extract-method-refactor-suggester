error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6673.java
text:
```scala
i@@f (behavior instanceof IHeaderContributor && isBehaviorAccepted(behavior))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6673.java