error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4741.java
text:
```scala
m@@i.setText("&" + id + " " + workingSet.getLabel()); //$NON-NLS-1$  //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4741.java