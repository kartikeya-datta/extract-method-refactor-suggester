error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2012.java
text:
```scala
p@@roject.files.add(new ProjectFile("android/res/values/strings.xml"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2012.java