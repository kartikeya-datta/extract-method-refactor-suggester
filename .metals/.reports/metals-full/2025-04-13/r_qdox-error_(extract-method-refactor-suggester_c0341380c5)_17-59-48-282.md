error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6914.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6914.java
text:
```scala
public static final S@@impleAttributeDefinition DOMAIN_NAME = SimpleAttributeDefinitionBuilder.create(CommonAttributes.DOMAIN_NAME, ModelType.STRING, true)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6914.java