error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12022.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12022.java
text:
```scala
protected U@@nknownDistributionChiSquareTest testStatistic = new ChiSquareTestImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12022.java