error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10043.java
text:
```scala
t@@his.webSocketSession = new StandardWebSocketSession(null, null, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10043.java