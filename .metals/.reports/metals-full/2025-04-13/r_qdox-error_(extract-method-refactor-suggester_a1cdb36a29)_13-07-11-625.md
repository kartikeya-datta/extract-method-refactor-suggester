error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5495.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5495.java
text:
```scala
static final S@@tring THIS_VALUE_SHOULD_THROW_EXCEPTION = "test ex";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5495.java