error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13432.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[433,2]

error in qdox parser
file content:
```java
offset: 12026
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13432.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13432.java