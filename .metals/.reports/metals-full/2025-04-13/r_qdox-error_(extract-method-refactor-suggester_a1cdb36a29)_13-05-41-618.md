error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9827.java
text:
```scala
p@@ublic class CompoundPropertyModel extends AbstractPropertyModel implements ICompoundModel
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9827.java