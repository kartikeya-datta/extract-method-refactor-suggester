error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2355.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2355.java
text:
```scala
C@@ommandElement commandElement = new CommandElement(commands[i], this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2355.java