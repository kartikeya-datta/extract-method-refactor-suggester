error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9361.java
text:
```scala
r@@eturn Boolean.valueOf(item.isSelected());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9361.java