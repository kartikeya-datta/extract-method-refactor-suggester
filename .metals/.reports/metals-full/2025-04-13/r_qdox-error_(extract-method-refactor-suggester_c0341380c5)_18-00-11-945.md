error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6046.java
text:
```scala
s@@uper(IntroMessages.Intro_action_text);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6046.java