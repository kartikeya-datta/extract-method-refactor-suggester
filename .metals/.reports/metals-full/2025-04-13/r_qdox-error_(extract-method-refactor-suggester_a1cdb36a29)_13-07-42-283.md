error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1236.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1236.java
text:
```scala
protected v@@oid writeObjectRaw(String fieldName, BytesReference content, OutputStream bos) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1236.java