error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/107.java
text:
```scala
c@@lient.admin().indices().refresh(refreshRequest, new ActionListener<RefreshResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/107.java