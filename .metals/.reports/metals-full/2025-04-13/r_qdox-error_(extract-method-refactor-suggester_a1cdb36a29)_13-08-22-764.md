error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1900.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1900.java
text:
```scala
public C@@oarseSessionsKey readObject(ObjectInput input) throws IOException, ClassNotFoundException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1900.java