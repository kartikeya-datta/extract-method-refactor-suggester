error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/110.java
text:
```scala
c@@lient.delete(deleteRequest, new ActionListener<DeleteResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/110.java