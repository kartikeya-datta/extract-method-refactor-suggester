error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7465.java
text:
```scala
s@@b.append(s.substring(i, i + lineLength));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7465.java