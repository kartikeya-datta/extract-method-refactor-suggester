error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9342.java
text:
```scala
i@@f (needRuntimeCheckcast && this.expression.postConversionType(currentScope) != this.resolvedType.erasure()) { // no need to issue a checkcast if already done as genericCast
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9342.java