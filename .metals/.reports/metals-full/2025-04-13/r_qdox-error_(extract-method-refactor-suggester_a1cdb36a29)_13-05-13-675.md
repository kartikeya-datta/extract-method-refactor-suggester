error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2679.java
text:
```scala
t@@his.subReaders =  subReaders;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2679.java