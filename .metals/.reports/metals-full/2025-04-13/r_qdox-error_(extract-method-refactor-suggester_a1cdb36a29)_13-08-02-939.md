error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9695.java
text:
```scala
m@@apper.parseDocument(operations, XMLInputFactory.newInstance().createXMLStreamReader(reader));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9695.java