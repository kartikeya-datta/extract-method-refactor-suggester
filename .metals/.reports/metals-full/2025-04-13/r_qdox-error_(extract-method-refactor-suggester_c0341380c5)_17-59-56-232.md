error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/477.java
text:
```scala
c@@luster2 = new InternalTestCluster(randomLong(), 2, 2, Strings.randomBase64UUID(getRandom()), 0, false, CHILD_JVM_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/477.java