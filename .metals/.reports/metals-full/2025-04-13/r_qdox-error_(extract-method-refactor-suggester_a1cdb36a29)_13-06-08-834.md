error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7283.java
text:
```scala
c@@ursor = new Cursor<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7283.java