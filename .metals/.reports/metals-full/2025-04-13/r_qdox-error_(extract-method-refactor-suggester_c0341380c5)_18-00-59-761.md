error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10087.java
text:
```scala
b@@oolean gdiPlus;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10087.java