error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8306.java
text:
```scala
u@@nitScope.resolvedSingeTypeImports.put(name, type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8306.java