error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13957.java
text:
```scala
e@@xecutionContext.getResourceManager().setFileEncoding (_fileEncoding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13957.java