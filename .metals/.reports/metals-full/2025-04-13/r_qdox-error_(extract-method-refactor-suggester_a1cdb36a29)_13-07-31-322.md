error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6762.java
text:
```scala
r@@eturn answer == null || answer.type == null || !answer.type.isBinary() ? null : answer.type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6762.java