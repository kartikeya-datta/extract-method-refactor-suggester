error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5833.java
text:
```scala
b@@oolean cache = true; // since usually term filter is on repeating terms, cache it by default
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5833.java