error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6178.java
text:
```scala
r@@eturn new String[] {"DoubleClickEnabled", "EchoChar", "Editable", "Message", "Orientation", "Selection", "Tabs", "Text", "TextLimit", "ToolTipText", "TopIndex"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6178.java