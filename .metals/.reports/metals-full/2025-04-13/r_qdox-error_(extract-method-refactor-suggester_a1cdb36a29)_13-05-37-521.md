error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/941.java
text:
```scala
T@@ypefaceUtils.setOcticons((TextView) view.findViewById(id.tv_comment_icon),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/941.java