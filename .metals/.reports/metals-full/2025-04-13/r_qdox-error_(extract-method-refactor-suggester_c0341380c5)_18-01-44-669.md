error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3246.java
text:
```scala
i@@f (parent != null) parent.removeActor(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3246.java