error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8865.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8865.java
text:
```scala
public static final S@@tring COMPILER_PB_UNHANDLED_WARNING_TOKEN = PLUGIN_ID + ".compiler.problem.unhandledWarningToken"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8865.java