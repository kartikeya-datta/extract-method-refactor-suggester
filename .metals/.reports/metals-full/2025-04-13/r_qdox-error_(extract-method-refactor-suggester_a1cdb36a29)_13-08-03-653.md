error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4026.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4026.java
text:
```scala
private final static S@@tring customDesktopLib = null;//"C:\\Xoppa\\code\\libgdx\\extensions\\gdx-bullet\\jni\\vs\\gdxBullet\\Debug\\gdxBullet.dll";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4026.java