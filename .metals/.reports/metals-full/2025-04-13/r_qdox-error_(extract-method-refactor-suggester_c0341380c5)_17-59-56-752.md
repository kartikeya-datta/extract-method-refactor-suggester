error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7533.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7533.java
text:
```scala
final C@@lient client = cluster().smartClient();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7533.java