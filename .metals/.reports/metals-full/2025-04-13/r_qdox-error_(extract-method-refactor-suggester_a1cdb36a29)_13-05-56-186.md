error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16475.java
text:
```scala
F@@ile subdir = new File(System.getProperty("root"), "src/etc/testcases/taskdefs/expected");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16475.java