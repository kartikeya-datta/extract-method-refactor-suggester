error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/115.java
text:
```scala
c@@lient.terms(termsRequest, new ActionListener<TermsResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/115.java