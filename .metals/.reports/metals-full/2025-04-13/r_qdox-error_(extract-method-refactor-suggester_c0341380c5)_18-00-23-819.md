error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10520.java
text:
```scala
n@@ew Locale("th"), new Locale("ru") });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10520.java