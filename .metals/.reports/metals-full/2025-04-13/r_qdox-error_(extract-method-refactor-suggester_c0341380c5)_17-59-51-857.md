error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9934.java
text:
```scala
i@@f (OS.HIVIEW && (OS.VERSION >= 0x1040 || background != null)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9934.java