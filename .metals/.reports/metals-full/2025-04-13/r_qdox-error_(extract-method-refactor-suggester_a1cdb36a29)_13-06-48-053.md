error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/363.java
text:
```scala
v@@oid consolidate () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/363.java