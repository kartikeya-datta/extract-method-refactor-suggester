error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12969.java
text:
```scala
w@@hile (System.currentTimeMillis() <= now + 1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12969.java