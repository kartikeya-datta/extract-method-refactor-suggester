error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6603.java
text:
```scala
i@@f (IJavaModelMarker.JAVA_MODEL_PROBLEM_MARKER.equals(markerType)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6603.java