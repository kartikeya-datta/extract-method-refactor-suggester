error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5505.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5505.java
text:
```scala
private v@@oid consolidate () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5505.java