error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/172.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/172.java
text:
```scala
final R@@esource root = context.readResourceFromRoot(PathAddress.EMPTY_ADDRESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/172.java