error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3499.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3499.java
text:
```scala
i@@nstance.setupContext(context);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3499.java