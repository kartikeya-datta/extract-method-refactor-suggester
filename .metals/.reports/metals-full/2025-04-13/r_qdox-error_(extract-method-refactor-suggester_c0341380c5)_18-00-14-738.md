error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1125.java
text:
```scala
r@@eturn new Well1024a(1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1125.java