error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3899.java
text:
```scala
L@@OGGER.error("Exception occured during SSLContext for TLS syslog server initialization", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3899.java