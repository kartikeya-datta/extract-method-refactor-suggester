error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14439.java
text:
```scala
e@@ar.addAsManifestResource(RarDeploymentTestCase.class.getPackage(), "application.xml", "application.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14439.java