error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7009.java
text:
```scala
S@@WT.error (SWT.ERROR_NO_GRAPHICS_LIBRARY, t, " [GDI+ is required]"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7009.java