error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10787.java
text:
```scala
c@@omparator = (AbstractFileComparator) LastModifiedFileComparator.LASTMODIFIED_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10787.java