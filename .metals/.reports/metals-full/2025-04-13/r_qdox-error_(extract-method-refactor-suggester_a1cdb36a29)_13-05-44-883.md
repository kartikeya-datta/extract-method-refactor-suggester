error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1964.java
text:
```scala
r@@eturn baseType.compare(o2, o1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1964.java