error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4188.java
text:
```scala
c@@apturedArguments[i] = new CaptureBinding((WildcardBinding) argument, contextType, position, scope.compilationUnitScope().nextCaptureID());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4188.java