error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10538.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10538.java
text:
```scala
S@@TATISTICS_ENABLED(ModelKeys.STATISTICS_ENABLED),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10538.java