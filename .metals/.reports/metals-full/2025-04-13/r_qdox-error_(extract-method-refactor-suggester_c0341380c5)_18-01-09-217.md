error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3904.java
text:
```scala
i@@nternalCluster().wipeIndices("idx2");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3904.java