error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5385.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5385.java
text:
```scala
i@@pcHelper.executeCommand(ExternalToolsHelper.getSALearn()+" --ham --dir " + path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5385.java