error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3565.java
text:
```scala
B@@undleStorage storageProvider = (BundleStorage) serviceRegistry.getRequiredService(IntegrationServices.BUNDLE_STORAGE_PLUGIN).getValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3565.java