error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15970.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15970.java
text:
```scala
private final A@@bstractAjaxBehavior timer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15970.java