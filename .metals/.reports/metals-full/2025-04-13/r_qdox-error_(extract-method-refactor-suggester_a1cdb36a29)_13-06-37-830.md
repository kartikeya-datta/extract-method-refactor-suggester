error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2755.java
text:
```scala
r@@eturn clusterState.routingTable().activePrimaryShardsGrouped(concreteIndices, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2755.java