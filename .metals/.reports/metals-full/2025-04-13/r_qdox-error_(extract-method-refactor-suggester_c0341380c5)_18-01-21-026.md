error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12975.java
text:
```scala
r@@eplaceComponentTagBody(markupStream, openTag, bodyContent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12975.java