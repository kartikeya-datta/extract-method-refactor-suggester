error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6671.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6671.java
text:
```scala
f@@or (int i = 2; i < planes.length; i++)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6671.java