error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6929.java
text:
```scala
r@@eturn event.getRenderedMessage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6929.java