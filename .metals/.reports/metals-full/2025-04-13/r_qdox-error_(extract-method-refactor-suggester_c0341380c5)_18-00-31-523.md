error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9319.java
text:
```scala
O@@bject uid = inboxFolder.addMessage(messageStream, message.getHeader().getAttributes(),message.getHeader().getFlags());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9319.java