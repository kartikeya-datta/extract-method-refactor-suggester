error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7997.java
text:
```scala
s@@ = s + "return "/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7997.java