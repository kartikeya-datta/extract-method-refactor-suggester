error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15073.java
text:
```scala
S@@tring ext = container.getMarkupType().getExtension();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15073.java