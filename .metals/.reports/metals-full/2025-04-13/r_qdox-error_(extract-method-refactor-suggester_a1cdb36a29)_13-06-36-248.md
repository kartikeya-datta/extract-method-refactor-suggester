error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14858.java
text:
```scala
g@@etContext().info( file );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14858.java