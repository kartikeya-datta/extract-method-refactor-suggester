error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2922.java
text:
```scala
l@@ogger.debug("Loading hunspell dictionary [{}]...", locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2922.java