error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1349.java
text:
```scala
F@@lags flags = (Flags) ((MessageNode)value).getHeader().getFlags();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1349.java