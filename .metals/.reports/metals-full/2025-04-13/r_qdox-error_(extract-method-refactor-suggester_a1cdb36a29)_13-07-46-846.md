error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3514.java
text:
```scala
r@@eturn new IndexNameFacetExecutor(context.shardTarget().index(), comparatorType, size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3514.java