error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3657.java
text:
```scala
r@@eturn PathAddress.pathAddress(InfinispanSubsystemResourceDefinition.PATH).append(ModelKeys.CACHE_CONTAINER, containerName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3657.java