error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11918.java
text:
```scala
O@@S.gdk_window_focus (window, OS.GDK_CURRENT_TIME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11918.java