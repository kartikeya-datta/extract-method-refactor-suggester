error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1024.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1024.java
text:
```scala
static final c@@har[][] EmptySimpleNames = CharOperation.NO_CHAR_CHAR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1024.java