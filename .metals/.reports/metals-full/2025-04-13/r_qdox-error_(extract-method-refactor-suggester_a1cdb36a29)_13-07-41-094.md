error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3647.java
text:
```scala
b@@yte[] heightMap = PerlinNoiseGenerator.generateHeightMap(voxelWorld.voxelsX, voxelWorld.voxelsZ, min, max, octaveCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3647.java