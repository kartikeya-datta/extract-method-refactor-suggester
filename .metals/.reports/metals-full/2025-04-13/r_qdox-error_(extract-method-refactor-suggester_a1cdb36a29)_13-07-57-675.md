error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7410.java
text:
```scala
p@@arser.parseCompilationUnit(this, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7410.java