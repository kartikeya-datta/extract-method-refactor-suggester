error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2987.java
text:
```scala
i@@f (OS.GetObject(item.fallbackFont, LOGFONT.sizeof, logFont) == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2987.java