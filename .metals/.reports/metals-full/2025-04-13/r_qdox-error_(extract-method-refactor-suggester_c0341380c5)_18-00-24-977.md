error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3911.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3911.java
text:
```scala
s@@etSize(region.getRegion().getRegionWidth(), region.getRegion().getRegionHeight());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3911.java