error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2448.java
text:
```scala
r@@eturn readFrom(new BytesStreamInput(data, false), localNode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2448.java