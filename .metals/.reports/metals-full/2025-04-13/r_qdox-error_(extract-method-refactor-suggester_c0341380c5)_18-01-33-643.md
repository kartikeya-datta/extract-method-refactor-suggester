error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3198.java
text:
```scala
i@@nt count = (int)/*64*/cookies.count ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3198.java