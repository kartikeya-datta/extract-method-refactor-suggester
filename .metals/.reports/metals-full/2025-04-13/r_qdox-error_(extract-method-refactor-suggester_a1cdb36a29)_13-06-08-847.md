error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7078.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7078.java
text:
```scala
public A@@nalyzeRequestBuilder setField(String field) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7078.java