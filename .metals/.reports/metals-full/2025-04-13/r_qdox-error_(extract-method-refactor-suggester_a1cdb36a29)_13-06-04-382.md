error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/102.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/102.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/102.java
text:
```scala
c@@lient.admin().indices().delete(deleteIndexRequest, new ActionListener<DeleteIndexResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/102.java