error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9733.java
text:
```scala
f@@or (File current : stateValues.getUserFiles()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9733.java