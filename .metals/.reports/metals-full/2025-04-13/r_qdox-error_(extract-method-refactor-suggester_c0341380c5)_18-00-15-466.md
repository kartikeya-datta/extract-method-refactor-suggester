error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13637.java
...
```java
offset: 28
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13637.java
text:
```scala
public static final native i@@nt /*long*/ memset(int /*long*/ buffer, int c, int /*long*/ num);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13637.java