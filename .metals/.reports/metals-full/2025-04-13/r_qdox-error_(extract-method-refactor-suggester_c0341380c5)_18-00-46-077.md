error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3475.java
text:
```scala
i@@f (!OS.FrameworkElement_IsLoaded (handle)) updateLayout (handle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3475.java