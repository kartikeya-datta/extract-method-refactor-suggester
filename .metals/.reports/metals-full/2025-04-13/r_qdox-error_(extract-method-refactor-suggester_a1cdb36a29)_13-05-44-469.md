error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2379.java
text:
```scala
g@@etContainerResponse().sendRedirect(url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2379.java