error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8867.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8867.java
text:
```scala
public static final c@@har[] FALL_THROUGH_TAG = "$FALL-THROUGH$".toCharArray(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8867.java