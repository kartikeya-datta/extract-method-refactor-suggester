error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7994.java
text:
```scala
A@@rray<AssetDescriptor> dependencies = new Array();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7994.java