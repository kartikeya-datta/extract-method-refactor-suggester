error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9736.java
text:
```scala
r@@eturn URI.create(PROTOCOL + "://" + getAuthority() + "/");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9736.java