error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9925.java
text:
```scala
.@@getResponse(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9925.java