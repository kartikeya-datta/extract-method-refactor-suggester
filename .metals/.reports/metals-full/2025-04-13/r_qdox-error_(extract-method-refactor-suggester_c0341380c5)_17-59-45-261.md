error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12709.java
text:
```scala
r@@eturn ignoreModulesChanges | overrideAll;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12709.java