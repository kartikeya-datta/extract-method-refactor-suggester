error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5506.java
text:
```scala
i@@f (varSuperType.rank >= typeVariable.rank && varSuperType.declaringElement == typeVariable.declaringElement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5506.java