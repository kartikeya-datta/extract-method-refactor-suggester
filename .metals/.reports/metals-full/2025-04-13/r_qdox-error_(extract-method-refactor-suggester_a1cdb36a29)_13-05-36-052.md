error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7030.java
text:
```scala
S@@erviceName SERVICE_NAME_BASE = ServiceName.JBOSS.append("deployment", "processor");
...
public interface DeploymentUnitProcessor {
    ServiceName DEPLOYMENT_PROCESSOR_SERVICE_NAME = ServiceName.JBOSS.append("deployment", "processor");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7030.java