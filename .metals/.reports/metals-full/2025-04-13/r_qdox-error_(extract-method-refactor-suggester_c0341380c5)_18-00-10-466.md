error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15441.java
text:
```scala
s@@tate &= ~(CANVAS | TRANSPARENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15441.java