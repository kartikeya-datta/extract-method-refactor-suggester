error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3028.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3028.java
text:
```scala
i@@f ("true".equals(params.get(PFPGrowth.USE_FPG2))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3028.java