error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2189.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2189.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2189.java
text:
```scala
t@@his.project.getPerProjectInfo().setClasspath(this.newRawClasspath, this.newOutputLocation, JavaModelStatus.VERIFIED_OK/*format is ok*/, null, null, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2189.java