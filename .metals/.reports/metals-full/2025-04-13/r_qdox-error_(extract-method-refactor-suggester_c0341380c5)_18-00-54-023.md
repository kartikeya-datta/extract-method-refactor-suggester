error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6138.java
text:
```scala
A@@ddressbookFrameController addressbookFrameController = (AddressbookFrameController) frameMediator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6138.java