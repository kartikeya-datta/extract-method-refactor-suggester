error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16116.java
text:
```scala
r@@eturn new String(textField.getPassword());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16116.java