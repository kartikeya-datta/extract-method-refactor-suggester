error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3510.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3510.java
text:
```scala
public v@@oid acceptError(IProblem error) {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3510.java