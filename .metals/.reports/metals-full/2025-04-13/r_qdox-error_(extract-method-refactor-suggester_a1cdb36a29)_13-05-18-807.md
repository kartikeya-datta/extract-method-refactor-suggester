error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9719.java
text:
```scala
m@@odel = MD5Loader.loadModel(Gdx.files.internal("data/zfat.md5mesh").read(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9719.java