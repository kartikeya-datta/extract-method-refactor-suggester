error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6271.java
text:
```scala
i@@f (getResponse.isSourceEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6271.java