error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4600.java
text:
```scala
i@@f (parser.currentToken() != XContentParser.Token.VALUE_NUMBER) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4600.java