error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1019.java
text:
```scala
s@@etColor(currentIndex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1019.java