error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15032.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15032.java
text:
```scala
private E@@ntry bean;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15032.java