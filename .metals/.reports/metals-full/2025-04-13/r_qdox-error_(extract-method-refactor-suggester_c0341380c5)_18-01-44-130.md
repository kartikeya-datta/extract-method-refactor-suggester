error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5444.java
text:
```scala
r@@eturn new FuzzyQuery(names().createIndexNameTerm(value), (float) minSim, prefixLength, maxExpansions);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5444.java