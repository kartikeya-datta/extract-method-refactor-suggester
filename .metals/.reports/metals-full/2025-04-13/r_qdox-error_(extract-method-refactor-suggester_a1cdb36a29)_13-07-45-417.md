error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4771.java
text:
```scala
t@@his.value = new TypedValue(sb.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4771.java