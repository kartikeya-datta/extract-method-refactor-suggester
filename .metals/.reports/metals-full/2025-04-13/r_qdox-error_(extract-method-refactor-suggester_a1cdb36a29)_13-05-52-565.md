error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9308.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9308.java
text:
```scala
static i@@nt MINOR_VERSION = 232;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9308.java