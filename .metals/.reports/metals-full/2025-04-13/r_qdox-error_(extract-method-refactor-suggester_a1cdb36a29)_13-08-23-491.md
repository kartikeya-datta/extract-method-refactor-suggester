error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4315.java
text:
```scala
r@@eturn Application.get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4315.java