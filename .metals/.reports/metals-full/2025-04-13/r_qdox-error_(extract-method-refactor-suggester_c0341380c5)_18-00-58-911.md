error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5435.java
text:
```scala
r@@eturn PredicatedMap.predicatedMap(map, keyPredicate, valuePredicate);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5435.java