error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9289.java
text:
```scala
c@@odeStream.updateLastRecordedEndPC(tryBlock.scope, position);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9289.java