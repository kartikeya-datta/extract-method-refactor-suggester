error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8596.java
text:
```scala
t@@hrow MathRuntimeException.createIllegalArgumentException("function is null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8596.java