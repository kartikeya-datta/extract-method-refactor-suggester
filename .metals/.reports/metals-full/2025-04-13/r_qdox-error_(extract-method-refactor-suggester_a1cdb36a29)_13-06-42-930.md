error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12960.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12960.java
text:
```scala
public S@@treamingServerSockJsSession(String sessionId, SockJsConfiguration config, WebSocketHandler handler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12960.java