error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11075.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11075.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11075.java
text:
```scala
i@@f (beanName == null || "".equals(beanName))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11075.java