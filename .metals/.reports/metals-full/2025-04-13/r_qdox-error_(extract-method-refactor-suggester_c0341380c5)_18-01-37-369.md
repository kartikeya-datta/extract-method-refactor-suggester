error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3416.java
text:
```scala
i@@nfo.setChildren(JavaElementInfo.NO_CHILDREN);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3416.java