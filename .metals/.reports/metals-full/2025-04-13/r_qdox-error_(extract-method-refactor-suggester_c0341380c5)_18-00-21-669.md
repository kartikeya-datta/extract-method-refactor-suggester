error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5078.java
text:
```scala
r@@eturn newPixmap(file.read());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5078.java