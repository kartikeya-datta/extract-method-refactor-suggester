error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15611.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15611.java
text:
```scala
i@@f (_fileEncoding != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15611.java