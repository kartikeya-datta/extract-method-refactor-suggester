error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5234.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5234.java
text:
```scala
public b@@oolean hasChildren() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5234.java