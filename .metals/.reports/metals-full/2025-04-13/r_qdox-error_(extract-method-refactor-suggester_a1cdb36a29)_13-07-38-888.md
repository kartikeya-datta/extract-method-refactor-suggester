error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3791.java
text:
```scala
s@@etToolBarText(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3791.java