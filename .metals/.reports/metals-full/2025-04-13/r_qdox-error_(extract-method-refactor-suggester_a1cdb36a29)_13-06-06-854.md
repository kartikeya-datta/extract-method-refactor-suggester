error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4452.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4452.java
text:
```scala
static S@@TSType toSAMLConfig(OperationContext context, ModelNode fromModel) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4452.java