error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4631.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4631.java
text:
```scala
public o@@rg.elasticsearch.index.fielddata.BytesValues.WithOrdinals getBytesValues(boolean needsHashes) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4631.java