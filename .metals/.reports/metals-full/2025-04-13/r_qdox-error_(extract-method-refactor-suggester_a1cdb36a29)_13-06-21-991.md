error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6816.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6816.java
text:
```scala
@Override public i@@nt numberOfOperations() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6816.java