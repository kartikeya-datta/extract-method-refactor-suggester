error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1916.java
text:
```scala
S@@erverControllerModelUtil.initOperations(rootRegistration, null, persister, environment, processState, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1916.java