error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4488.java
text:
```scala
t@@ypeDeclaration = BinaryTypeConverter.buildTypeDeclaration(type, compilationUnit, compilationResult, null/*no need to remember type names*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4488.java