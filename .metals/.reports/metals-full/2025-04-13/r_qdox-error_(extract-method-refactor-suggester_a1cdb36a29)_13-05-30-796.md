error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5339.java
text:
```scala
s@@b.append("\n"+method+" data:\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5339.java