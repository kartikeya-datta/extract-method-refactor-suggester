error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2808.java
text:
```scala
S@@ystem.out.println(b1.contains(b2)); // false
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2808.java