error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7849.java
text:
```scala
n@@ew BlockJUnit4ClassRunner(getTestClass().getJavaClass()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7849.java