error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15873.java
text:
```scala
e@@xecTask.addClasspath( classpath.concatSystemClasspath() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15873.java