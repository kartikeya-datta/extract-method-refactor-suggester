error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2577.java
...
```java
offset: 886
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2577.java
text:
```scala
 ...
 * under the License.    
 */
p@@ackage org.apache.openjpa.lib.rop;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2577.java