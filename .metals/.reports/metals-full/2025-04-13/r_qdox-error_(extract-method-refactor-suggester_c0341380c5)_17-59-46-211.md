error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7341.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7341.java
text:
```scala
private A@@rrayList<SpanQueryBuilder> clauses = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7341.java