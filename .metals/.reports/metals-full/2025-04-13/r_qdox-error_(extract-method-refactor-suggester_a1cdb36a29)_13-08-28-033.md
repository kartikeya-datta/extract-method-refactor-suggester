error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6048.java
text:
```scala
s@@howOpenURL("Compose SMS?", smsResult.getNumbers()[0], smsResult.getSMSURI());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6048.java