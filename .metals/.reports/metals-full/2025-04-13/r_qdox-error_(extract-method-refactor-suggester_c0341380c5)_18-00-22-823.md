error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/323.java
text:
```scala
f@@ont.draw(batch, "button is 2x1 cm (" + width + "x" + height + "px), ppi: (" + Gdx.graphics.getPpiX() + "," + Gdx.graphics.getPpiY() +"), ppc: (" + Gdx.graphics.getPpcX() + "," + Gdx.graphics.getPpcY()+ ")", 10, 50);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/323.java