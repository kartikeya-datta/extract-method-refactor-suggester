error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8831.java
text:
```scala
t@@his.searchScript = new SearchScript(context.lookup(), scriptLang, script, params, scriptService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8831.java