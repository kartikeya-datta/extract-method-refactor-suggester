error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8955.java
text:
```scala
r@@eturn Boolean.valueOf(constant.booleanValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8955.java