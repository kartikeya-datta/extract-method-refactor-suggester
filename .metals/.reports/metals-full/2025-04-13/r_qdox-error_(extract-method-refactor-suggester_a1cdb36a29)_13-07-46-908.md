error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8729.java
text:
```scala
r@@eturn new ListItem(this, index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8729.java