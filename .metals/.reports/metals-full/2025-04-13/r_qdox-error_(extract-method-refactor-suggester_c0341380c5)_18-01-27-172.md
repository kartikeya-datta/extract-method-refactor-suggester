error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6585.java
text:
```scala
r@@eturn last == this.findPage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6585.java