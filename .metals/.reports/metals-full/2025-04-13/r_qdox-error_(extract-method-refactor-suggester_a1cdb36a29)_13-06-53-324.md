error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5938.java
text:
```scala
r@@emoveBehavior(behavior);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5938.java