error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/996.java
text:
```scala
t@@his.mappingSource = new CompressedString(builder.underlyingBytes(), 0, builder.underlyingBytesLength());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/996.java