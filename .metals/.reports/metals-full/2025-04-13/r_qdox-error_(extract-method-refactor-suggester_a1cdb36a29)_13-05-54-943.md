error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2961.java
text:
```scala
i@@f (control == null && (!above || redrawWindow == 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2961.java