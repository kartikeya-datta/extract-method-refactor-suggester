error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1261.java
text:
```scala
p@@rovider, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1261.java