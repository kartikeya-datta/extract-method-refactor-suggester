error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11263.java
text:
```scala
p@@ublic class StockQuoteLabel2 extends Label
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11263.java