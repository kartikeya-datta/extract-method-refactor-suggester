error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11797.java
text:
```scala
p@@ublic class IncrementalTableNavigationPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11797.java