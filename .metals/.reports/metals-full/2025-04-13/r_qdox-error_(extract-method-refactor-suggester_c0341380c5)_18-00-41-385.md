error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5391.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,187]

error in qdox parser
file content:
```java
offset: 187
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5391.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5391.java