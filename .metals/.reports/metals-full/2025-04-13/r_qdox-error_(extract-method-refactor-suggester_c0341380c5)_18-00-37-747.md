error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/335.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/335.java
text:
```scala
final d@@ouble[] currentPoint = getStartPoint();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/335.java