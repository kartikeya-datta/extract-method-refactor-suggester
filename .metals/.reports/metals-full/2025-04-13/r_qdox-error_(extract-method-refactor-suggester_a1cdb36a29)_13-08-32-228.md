error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1625.java
text:
```scala
t@@mp = new File(this.serverDataDir, "deployments");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1625.java