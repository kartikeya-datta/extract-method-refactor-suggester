error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5020.java
text:
```scala
i@@f (element instanceof ViewDescriptor && WorkbenchActivityHelper.filterItem(element)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5020.java