error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18356.java
text:
```scala
d@@eclare warning: call(* Point.setX(..)): "Illegal call.";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18356.java