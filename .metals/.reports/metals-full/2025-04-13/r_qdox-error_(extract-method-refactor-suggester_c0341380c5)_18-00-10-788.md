error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9427.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9427.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9427.java
text:
```scala
c@@mdCtx = initCommandContext(defaultControllerHost, defaultControllerPort, username, password, false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9427.java