error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3212.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3212.java
text:
```scala
_@@kafka.put(partition, new SimpleConsumer(hp.host, hp.port, _config.socketTimeoutMs, _config.bufferSizeBytes, _config.clientId));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3212.java