error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3588.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3588.java
text:
```scala
t@@hrow new IllegalShardRoutingStateException(this, "Already primary, can't move to replica");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3588.java