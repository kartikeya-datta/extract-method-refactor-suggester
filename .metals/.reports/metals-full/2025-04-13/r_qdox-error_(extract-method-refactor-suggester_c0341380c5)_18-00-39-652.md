error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/288.java
text:
```scala
i@@f (timeLeft <= 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/288.java