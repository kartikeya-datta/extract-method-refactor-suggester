error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9397.java
text:
```scala
i@@nterpreterTable.put(interpreter.getAttribute("name"), PluginLoader.loadExternalPlugin(interpreter.getAttribute("main_class"), pluginManager.getPluginType(id),pluginManager.getJarFile(id),null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9397.java