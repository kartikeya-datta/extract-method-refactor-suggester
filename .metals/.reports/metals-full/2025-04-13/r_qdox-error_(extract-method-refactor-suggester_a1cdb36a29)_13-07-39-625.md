error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10635.java
text:
```scala
r@@eturn getComponentName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10635.java