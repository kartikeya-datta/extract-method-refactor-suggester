error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3376.java
text:
```scala
a@@pplication.getDebugSettings().setAjaxDebugModeEnabled(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3376.java