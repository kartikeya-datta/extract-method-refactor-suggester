error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3183.java
text:
```scala
r@@eturn ArrayBinding.ArrayLength;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3183.java