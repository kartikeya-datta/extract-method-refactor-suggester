error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7895.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7895.java
text:
```scala
public static C@@lass<?>[] getMyClassContext() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7895.java