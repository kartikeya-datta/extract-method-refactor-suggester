error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8591.java
text:
```scala
r@@eturn this.ast.getBindingResolver().resolveExpressionType(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8591.java