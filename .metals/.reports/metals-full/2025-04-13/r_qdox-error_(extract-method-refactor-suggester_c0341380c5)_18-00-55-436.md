error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5539.java
text:
```scala
p@@pcY = ppiY / 2.54f;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5539.java