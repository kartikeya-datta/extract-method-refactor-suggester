error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3606.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3606.java
text:
```scala
protected R@@esolvedTypeX resolveObjectType(TypeX ty) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3606.java