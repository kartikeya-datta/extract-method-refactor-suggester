error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5544.java
text:
```scala
n@@ew Scanner(false /*comment*/, false /*whitespace*/, false /*nls*/, this.compilerOptions.sourceLevel >= CompilerOptions.JDK1_4 /*assert*/, null /*todo*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5544.java