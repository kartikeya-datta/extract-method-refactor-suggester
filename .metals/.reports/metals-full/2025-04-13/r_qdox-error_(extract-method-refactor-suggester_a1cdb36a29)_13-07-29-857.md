error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8107.java
text:
```scala
S@@ystem.exit(ExitCodes.RESTART_PROCESS_FROM_STARTUP_SCRIPT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8107.java