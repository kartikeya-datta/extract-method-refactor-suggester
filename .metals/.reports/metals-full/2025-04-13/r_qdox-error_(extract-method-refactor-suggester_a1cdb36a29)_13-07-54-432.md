error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14665.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14665.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14665.java
text:
```scala
A@@ssert.assertEquals("#InterceptorFromParent##InterceptorBean##OtherInterceptorBean##CDIInterceptor##BeanParent##BeanWithSimpleInjected#Hello#CDIBean#CDIBean", s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14665.java