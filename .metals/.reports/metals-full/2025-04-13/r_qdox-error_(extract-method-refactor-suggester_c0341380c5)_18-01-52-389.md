error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7614.java
text:
```scala
t@@his.concurrentStreamPool = DynamicExecutors.newScalingThreadPool(1, concurrentStreams, TimeValue.timeValueSeconds(5).millis(), EsExecutors.daemonThreadFactory(settings, "[fs_stream]"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7614.java