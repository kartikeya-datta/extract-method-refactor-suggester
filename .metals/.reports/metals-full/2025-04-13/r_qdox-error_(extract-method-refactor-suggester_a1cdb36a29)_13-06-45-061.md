error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/243.java
text:
```scala
l@@ogger.debug("Invocation with id " + invocationToCancel + " has been marked as cancelled, as requested");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/243.java