error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/500.java
text:
```scala
c@@lient.getAliases(request, listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/500.java