error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5067.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5067.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5067.java
text:
```scala
s@@hardsIts = clusterService.operationRouting().searchShards(clusterState, request.indices(), request.queryHint());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5067.java