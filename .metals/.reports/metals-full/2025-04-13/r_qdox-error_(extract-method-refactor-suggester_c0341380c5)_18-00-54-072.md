error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6528.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6528.java
text:
```scala
 B@@aseTypeBinding.isWidening(elementType.id, expressionType.id))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6528.java