error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1293.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1293.java
text:
```scala
public static i@@nt[] VERSION_10_3_3_0=  new int[] {10,3,3,0};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1293.java