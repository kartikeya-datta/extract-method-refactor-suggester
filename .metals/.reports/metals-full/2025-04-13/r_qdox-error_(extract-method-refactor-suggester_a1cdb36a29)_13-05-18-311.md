error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9755.java
text:
```scala
m@@enuBar.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9755.java