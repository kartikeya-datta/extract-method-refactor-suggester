error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8467.java
text:
```scala
D@@eploymentRemoveHandler drh = isMaster ? DeploymentRemoveHandler.createForMaster(contentRepo) : DeploymentRemoveHandler.createForSlave(fileRepository);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8467.java