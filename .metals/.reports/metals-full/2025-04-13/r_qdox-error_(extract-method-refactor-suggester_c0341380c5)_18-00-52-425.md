error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5085.java
text:
```scala
i@@f (methodType != null && expressionType.isCompatibleWith(methodType)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5085.java