error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6879.java
text:
```scala
H@@ashMap<Boolean, MutableInt> occurrences = new HashMap<Boolean, MutableInt>(2); // only two possible values here
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6879.java