error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15231.java
text:
```scala
l@@og.infof("Starting DataSources Service");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15231.java