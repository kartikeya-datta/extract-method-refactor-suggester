error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6399.java
text:
```scala
l@@ong timeout = attribute.resolveModelAttribute(context, model).asLong();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6399.java