error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10351.java
...
```java
offset: 1177
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10351.java
text:
```scala
...
p@@ackage org.jboss.as.ejb3.concurrency;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10351.java