error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4715.java
text:
```scala
t@@hread = new Thread(this, "LWJGL Music");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4715.java