error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2168.java
text:
```scala
S@@et<BundleInfo> resolve (AriesApplication app, ResolveConstraint... constraints) throws ResolverException ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2168.java