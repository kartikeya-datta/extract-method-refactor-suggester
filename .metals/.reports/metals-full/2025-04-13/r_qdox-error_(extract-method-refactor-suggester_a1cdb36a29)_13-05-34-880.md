error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10649.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.INSTALL, Phase.INSTALL_OSGI_DEPLOYMENT, new BundleInstallProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10649.java