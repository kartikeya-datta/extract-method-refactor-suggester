error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3411.java
text:
```scala
D@@erby - Class org.apache.derbyTesting.functionTests.tests.replicationTests.ReplicationRun_CleanUp
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3411.java