error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13968.java
text:
```scala
r@@egistration.registerSubModel(PropertyResourceDefinition.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13968.java