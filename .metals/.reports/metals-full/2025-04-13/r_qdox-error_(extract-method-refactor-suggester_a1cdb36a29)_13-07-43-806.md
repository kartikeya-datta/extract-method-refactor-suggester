error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13812.java
text:
```scala
i@@f (!OS.IsWinCE && OS.WIN32_VERSION >= OS.VERSION (6, 0) && OS.IsAppThemed ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13812.java