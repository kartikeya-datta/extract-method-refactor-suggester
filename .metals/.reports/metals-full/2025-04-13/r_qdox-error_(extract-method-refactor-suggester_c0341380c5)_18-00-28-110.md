error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16364.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16364.java
text:
```scala
public J@@SLPServiceInfo(IServiceInfo aSI) throws IDCreateException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16364.java