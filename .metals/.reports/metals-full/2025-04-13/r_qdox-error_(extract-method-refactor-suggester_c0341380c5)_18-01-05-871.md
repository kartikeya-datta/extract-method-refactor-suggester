error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17024.java
text:
```scala
i@@nt count = 500;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17024.java