error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1304.java
text:
```scala
r@@eturn this.resolvedType = scope.convertToRawType(memberType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1304.java