error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3317.java
text:
```scala
i@@f (this.invocationType == NO_RECEIVER || this.invocationType == NAME_RECEIVER || this.invocationType == SUPER_RECEIVER) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3317.java