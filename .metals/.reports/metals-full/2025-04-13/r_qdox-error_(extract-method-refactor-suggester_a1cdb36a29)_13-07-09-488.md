error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6064.java
text:
```scala
I@@WorkbenchHelpContextIds.SHOW_VIEW_OTHER_ACTION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6064.java