error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9079.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9079.java
text:
```scala
public T@@oolTip getToolTip () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9079.java