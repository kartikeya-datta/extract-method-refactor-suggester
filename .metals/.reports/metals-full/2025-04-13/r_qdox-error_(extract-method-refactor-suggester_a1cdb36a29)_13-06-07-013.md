error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4607.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4607.java
text:
```scala
public v@@oid moveFromPrimary() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4607.java