error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1985.java
text:
```scala
v@@isitor.visit(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1985.java