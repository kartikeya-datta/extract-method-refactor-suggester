error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8452.java
text:
```scala
t@@hrow new GdxRuntimeException("Couldn't load file: " + file, e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8452.java