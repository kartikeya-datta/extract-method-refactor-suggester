error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2999.java
text:
```scala
I@@terator< ? extends T> iterator(int first, int count);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2999.java