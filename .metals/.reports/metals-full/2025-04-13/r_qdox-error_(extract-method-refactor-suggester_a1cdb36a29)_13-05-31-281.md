error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2843.java
text:
```scala
a@@ssertTrue("flush happened too quickly during " + (doIndexing ? "indexing" : "deleting") + " count=" + count, count > 3000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2843.java