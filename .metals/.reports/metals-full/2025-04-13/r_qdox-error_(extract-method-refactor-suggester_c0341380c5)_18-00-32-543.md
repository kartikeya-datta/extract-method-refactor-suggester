error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7136.java
text:
```scala
r@@eturn transport.connectedNodes.size();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7136.java