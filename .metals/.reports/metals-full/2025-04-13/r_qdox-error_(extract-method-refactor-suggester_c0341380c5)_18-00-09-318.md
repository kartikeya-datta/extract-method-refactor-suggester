error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2589.java
text:
```scala
t@@his.resolvedType = scope.enclosingReceiverType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2589.java