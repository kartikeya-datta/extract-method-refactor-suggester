error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9874.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9874.java
text:
```scala
a@@ssertTrue(e.getResult().get(FAILURE_DESCRIPTION).asString().contains("WFLYMSG0019"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9874.java