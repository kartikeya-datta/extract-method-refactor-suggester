error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2336.java
text:
```scala
r@@eturn code;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2336.java