error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4787.java
text:
```scala
e@@xception = exception.resolveBindings(scope, null, false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4787.java