error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10963.java
text:
```scala
e@@lse if (paramAnn.annotationType().getSimpleName().startsWith("Valid")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10963.java