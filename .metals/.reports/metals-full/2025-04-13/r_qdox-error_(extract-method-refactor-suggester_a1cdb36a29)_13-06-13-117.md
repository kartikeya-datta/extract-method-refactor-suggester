error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9224.java
text:
```scala
P@@ercolateShardRequest shardRequest = new PercolateShardRequest(new ShardId(index, shardId));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9224.java