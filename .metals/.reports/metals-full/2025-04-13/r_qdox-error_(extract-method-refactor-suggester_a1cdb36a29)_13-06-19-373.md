error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10313.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10313.java
text:
```scala
public v@@oid addFirst(ClusterStateListener listener) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10313.java