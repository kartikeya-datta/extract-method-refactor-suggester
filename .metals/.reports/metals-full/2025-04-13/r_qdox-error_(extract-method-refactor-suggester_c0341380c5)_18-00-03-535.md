error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3721.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3721.java
text:
```scala
private static volatile S@@erviceRegistry registry;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3721.java