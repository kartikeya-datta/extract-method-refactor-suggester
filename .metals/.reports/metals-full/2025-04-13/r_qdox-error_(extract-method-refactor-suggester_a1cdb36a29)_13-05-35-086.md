error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15249.java
text:
```scala
i@@f (modelNode.hasDefined(NAME)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15249.java