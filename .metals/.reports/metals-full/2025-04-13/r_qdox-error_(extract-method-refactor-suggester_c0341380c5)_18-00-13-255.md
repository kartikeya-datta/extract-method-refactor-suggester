error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14186.java
text:
```scala
a@@sb.append(" if (inputType == 'checkbox' || inputType == 'radio') {\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14186.java