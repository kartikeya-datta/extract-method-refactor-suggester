error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9459.java
text:
```scala
s@@ervice.abortBenchmark(request.benchmarkNames(), listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9459.java