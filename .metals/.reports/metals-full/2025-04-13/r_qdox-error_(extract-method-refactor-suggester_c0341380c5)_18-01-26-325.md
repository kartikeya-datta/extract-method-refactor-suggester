error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10371.java
text:
```scala
r@@oot.get(REQUEST_PROPERTIES, BOOT_TIME, TYPE).set(ModelType.BOOLEAN);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10371.java