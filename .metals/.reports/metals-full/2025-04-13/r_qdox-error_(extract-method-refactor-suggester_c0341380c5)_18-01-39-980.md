error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10780.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10780.java
text:
```scala
public static final S@@erviceName SERVICE_NAME = ServiceName.JBOSS.append(JGroupsExtension.SUBSYSTEM_NAME, "defaults");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10780.java