error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6455.java
text:
```scala
s@@uper (computeName (stereoTypeTypes), computeName(stereoTypeTypes), stereoTypeTypes.toArray (new BackendType[0])); //TODO uniqueRepresentation
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6455.java