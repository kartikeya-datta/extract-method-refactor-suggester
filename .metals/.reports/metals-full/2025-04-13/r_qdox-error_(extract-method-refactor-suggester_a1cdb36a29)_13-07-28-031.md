error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4720.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4720.java
text:
```scala
public static final i@@nt sizeof = OS.SCRIPT_STATE_sizeof ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4720.java