error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2456.java
text:
```scala
d@@nsCNAMERecord(dnsName _name, short _dclass, int _ttl, MyStringTokenizer st)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2456.java