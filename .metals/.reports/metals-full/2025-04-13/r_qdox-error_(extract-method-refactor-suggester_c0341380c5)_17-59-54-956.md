error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2100.java
text:
```scala
F@@uture<Integer> ft = CompactionManager.instance().submit(store);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2100.java