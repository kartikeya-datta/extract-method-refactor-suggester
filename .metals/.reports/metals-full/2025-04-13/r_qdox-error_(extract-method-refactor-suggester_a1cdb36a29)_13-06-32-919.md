error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14472.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14472.java
text:
```scala
final S@@erviceController<?> controller = updateContext.getServiceRegistry().getService(NetworkInterfaceService.JBOSS_NETWORK_INTERFACE.append(interfaceName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14472.java