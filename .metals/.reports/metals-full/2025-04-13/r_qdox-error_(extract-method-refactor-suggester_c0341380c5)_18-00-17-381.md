error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13059.java
text:
```scala
i@@f (items[i] != null) items[i].updateExpanded ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13059.java