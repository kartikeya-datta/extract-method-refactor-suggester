error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1879.java
text:
```scala
t@@his.transportNodeAction = actionName + "[n]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1879.java