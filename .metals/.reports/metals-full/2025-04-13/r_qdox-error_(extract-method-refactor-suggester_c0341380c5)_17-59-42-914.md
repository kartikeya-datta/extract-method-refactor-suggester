error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6802.java
text:
```scala
r@@eturn "StompMessage [" + command + ", headers=" + this.headers + ", payload=" + new String(this.payload) + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6802.java