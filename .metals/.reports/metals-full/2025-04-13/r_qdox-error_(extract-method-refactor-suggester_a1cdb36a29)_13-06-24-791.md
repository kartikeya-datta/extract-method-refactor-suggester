error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/807.java
text:
```scala
i@@f (supportsField(field))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/807.java