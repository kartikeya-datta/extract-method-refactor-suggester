error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8289.java
text:
```scala
X@@ContentBuilder builder = new XContentBuilder(XContentFactory.xContent(contentType), cachedEntry.bytes(), cachedEntry);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8289.java