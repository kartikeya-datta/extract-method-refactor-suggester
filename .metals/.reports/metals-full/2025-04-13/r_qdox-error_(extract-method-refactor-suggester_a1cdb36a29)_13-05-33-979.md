error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2022.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2022.java
text:
```scala
public S@@tring title;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2022.java