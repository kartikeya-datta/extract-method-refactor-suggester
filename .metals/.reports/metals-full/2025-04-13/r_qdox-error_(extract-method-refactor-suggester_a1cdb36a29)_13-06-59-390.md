error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2696.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2696.java
text:
```scala
public i@@nt size() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2696.java