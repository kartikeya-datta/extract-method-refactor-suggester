error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17735.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[71,80]

error in qdox parser
file content:
```java
offset: 1825
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17735.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17735.java