error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1638.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1638.java
text:
```scala
public T@@ransportClientNodesService addTransportAddresses(TransportAddress... transportAddresses) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1638.java