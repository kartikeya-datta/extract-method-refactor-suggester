error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10179.java
text:
```scala
O@@S.class_addMethod(cls, OS.sel_application_openFile_, appProc4, "@:@@");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10179.java