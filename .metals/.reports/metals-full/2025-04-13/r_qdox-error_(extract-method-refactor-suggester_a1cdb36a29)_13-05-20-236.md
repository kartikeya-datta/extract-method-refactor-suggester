error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16672.java
text:
```scala
A@@ssert.assertNotNull(model.getNestedModel().getObject(page));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16672.java