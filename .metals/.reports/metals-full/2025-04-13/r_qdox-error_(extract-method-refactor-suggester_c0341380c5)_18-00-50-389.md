error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2215.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2215.java
text:
```scala
r@@eturn Constant.NotAConstant;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2215.java