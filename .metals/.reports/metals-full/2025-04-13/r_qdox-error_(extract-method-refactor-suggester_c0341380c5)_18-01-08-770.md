error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14377.java
text:
```scala
S@@tring id = getSessionStore().getId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14377.java