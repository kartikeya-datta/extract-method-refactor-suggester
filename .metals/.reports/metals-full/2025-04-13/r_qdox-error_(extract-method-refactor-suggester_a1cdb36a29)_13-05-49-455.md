error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17624.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[80,80]

error in qdox parser
file content:
```java
offset: 2331
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17624.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17624.java