error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5505.java
text:
```scala
n@@ew LdapAuthenticationAddHandler(), new SecurityRealmChildRemoveHandler(true),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5505.java