error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9036.java
text:
```scala
c@@ontext.getFailureDescription().set(e.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9036.java