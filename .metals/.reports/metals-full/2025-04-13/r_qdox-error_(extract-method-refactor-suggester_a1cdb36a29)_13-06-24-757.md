error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10791.java
text:
```scala
r@@eturn new Annotation[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10791.java