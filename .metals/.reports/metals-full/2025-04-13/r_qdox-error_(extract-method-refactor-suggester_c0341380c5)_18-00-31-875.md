error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2984.java
text:
```scala
m@@enuItem.addMouseListener(controller.getContainer().getMouseTooltipHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2984.java