error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7664.java
...
```java
offset: 785
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7664.java
text:
```scala
...
p@@ackage org.columba.core.gui.frame;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7664.java