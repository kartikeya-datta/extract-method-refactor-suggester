error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13839.java
text:
```scala
S@@tringBuilder buf = new StringBuilder("{sizeselector value: ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13839.java