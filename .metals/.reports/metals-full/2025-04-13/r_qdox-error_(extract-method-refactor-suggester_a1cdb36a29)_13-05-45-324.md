error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3586.java
text:
```scala
r@@esponse.renderOnDomReadyJavaScript(callbackScript);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3586.java