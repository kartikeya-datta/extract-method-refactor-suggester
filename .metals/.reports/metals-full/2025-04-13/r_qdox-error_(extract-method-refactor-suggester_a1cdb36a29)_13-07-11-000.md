error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1436.java
text:
```scala
S@@tring[] stemExclusion = settings.getAsArray("stem_exclusion");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1436.java