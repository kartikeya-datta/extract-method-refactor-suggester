error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6791.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6791.java
text:
```scala
final S@@et<?> set = TransformedSet.transformedSet(originalSet, TransformedCollectionTest.STRING_TO_INTEGER_TRANSFORMER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6791.java