error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2093.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2093.java
text:
```scala
r@@eturn readResource("ws-subsystem20.xml"); //for default test
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2093.java