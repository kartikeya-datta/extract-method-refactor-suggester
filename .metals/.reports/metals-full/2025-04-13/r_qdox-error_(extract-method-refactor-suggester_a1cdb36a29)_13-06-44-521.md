error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6130.java
text:
```scala
p@@ath = new Path( getProject() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6130.java