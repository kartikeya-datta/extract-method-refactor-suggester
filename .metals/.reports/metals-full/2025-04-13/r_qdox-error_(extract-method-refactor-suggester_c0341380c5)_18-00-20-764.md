error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3359.java
text:
```scala
a@@ssertTrue(maxError < 4.2e-11);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3359.java