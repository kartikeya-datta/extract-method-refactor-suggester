error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/961.java
text:
```scala
s@@etVisible(true); // Has to happen on OSX before display is created.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/961.java