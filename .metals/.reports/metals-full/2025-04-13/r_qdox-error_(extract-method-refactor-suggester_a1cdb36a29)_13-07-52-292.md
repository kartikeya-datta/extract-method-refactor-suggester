error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5488.java
text:
```scala
t@@sPvs.add("targetBeanName", "person");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5488.java