error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/953.java
text:
```scala
b@@uilder.startObject(nodeStats.node().id(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/953.java