error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/372.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/372.java
text:
```scala
public final v@@oid internalRenderComponent()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/372.java