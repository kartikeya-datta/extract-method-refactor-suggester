error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3752.java
text:
```scala
Q@@ueryParser queryParser = new QueryParser(TEST_VERSION_CURRENT, FIELD_NAME, new WhitespaceAnalyzer());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3752.java