error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1385.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1385.java
text:
```scala
public static final C@@onnectorRefsAttribute CLUSTER_CONNECTION_CONNECTORS = new ConnectorRefsAttribute(CommonAttributes.STATIC_CONNECTORS, false, true, RESTART_ALL_SERVICES);
...
public class ConnectorRefsAttribute extends PrimitiveListAttributeDefinition {
    ...
    public static final ConnectorRefsAttribute BRIDGE_CONNECTORS = new ConnectorRefsAttribute(CommonAttributes.STATIC_CONNECTORS, true, true, RESTART_ALL_SERVICES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1385.java