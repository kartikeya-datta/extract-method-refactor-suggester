error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12283.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12283.java
text:
```scala
public R@@osterEntry(Object parent, IUser user,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12283.java