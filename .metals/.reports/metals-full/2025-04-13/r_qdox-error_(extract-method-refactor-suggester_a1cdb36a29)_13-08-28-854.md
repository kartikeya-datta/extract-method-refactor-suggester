error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5009.java
text:
```scala
L@@abel label = idToLabel.get(id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5009.java