error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3517.java
text:
```scala
i@@f (shellHandle != 0) OS.Window_Owner (shellHandle, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3517.java