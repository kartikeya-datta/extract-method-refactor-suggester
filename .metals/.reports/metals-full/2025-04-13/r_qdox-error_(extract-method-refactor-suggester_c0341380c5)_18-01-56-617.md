error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2328.java
text:
```scala
s@@uper(WorkbenchMessages.WorkbenchEditorsAction_label);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2328.java