error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/595.java
text:
```scala
m@@oduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, SUN_JDK, false, false, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/595.java