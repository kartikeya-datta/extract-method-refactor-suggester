error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13589.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13589.java
text:
```scala
/* measureEvent = */ s@@endMeasureItemEvent (item, (int)/*64*/nmcd.dwItemSpec, nmcd.iSubItem, nmcd.hdc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13589.java