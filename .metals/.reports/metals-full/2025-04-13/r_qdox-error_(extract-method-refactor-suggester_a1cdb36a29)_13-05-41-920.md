error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1560.java
text:
```scala
r@@eturn getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1560.java