error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1802.java
text:
```scala
t@@his.webSocketHandler.setDefaultProtocolHandler(this.defaultHandler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1802.java