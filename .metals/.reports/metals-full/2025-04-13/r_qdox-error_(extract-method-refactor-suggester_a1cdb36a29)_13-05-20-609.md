error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/986.java
text:
```scala
p@@roc.onValue(docId, values[loc]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/986.java