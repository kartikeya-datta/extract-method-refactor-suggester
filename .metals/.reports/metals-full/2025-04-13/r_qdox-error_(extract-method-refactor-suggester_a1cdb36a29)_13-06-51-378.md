error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3923.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3923.java
text:
```scala
protected I@@DOMNode generateElementDOM() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3923.java