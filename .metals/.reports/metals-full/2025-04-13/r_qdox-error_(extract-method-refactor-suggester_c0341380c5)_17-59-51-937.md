error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9555.java
text:
```scala
t@@ypeArguments[i] = this.environment.convertToRawType(typeVariables[i].erasure());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9555.java