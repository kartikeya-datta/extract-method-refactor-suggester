error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2064.java
text:
```scala
f@@alse),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2064.java