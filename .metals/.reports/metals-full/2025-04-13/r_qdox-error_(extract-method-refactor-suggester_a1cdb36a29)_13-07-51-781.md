error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10577.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10577.java
text:
```scala
public T@@reeRow(String componentName, AbstractTree tree, TreeNodeModel nodeModel)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10577.java