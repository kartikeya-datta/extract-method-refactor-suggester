error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14860.java
text:
```scala
i@@f (transformed.get(NAME).asString().equals(BOOT_TIME)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14860.java