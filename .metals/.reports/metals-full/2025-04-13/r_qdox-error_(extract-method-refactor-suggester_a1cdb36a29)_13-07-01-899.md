error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3784.java
text:
```scala
r@@eturn idx;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3784.java