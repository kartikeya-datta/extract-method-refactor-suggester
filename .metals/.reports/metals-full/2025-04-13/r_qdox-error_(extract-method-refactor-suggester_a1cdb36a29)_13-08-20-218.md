error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3636.java
text:
```scala
r@@eturn value.getInt(value.position());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3636.java