error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12649.java
text:
```scala
r@@eturn "fieldNotFound";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12649.java