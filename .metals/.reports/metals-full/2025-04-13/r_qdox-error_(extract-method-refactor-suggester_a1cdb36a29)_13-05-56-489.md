error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1977.java
text:
```scala
D@@erby - Class org.apache.derbyTesting.functionTests.tests.junitTests.derbyNet.CompatibilityTest
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1977.java