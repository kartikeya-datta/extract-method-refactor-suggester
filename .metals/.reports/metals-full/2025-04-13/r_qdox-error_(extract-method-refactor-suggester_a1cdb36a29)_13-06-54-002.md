error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1931.java
text:
```scala
A@@ssert.assertTrue(TimeOfDay.MIDNIGHT.hour() == 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1931.java