error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4768.java
text:
```scala
t@@his.tabs = (List<? extends ITab>)Args.notNull(tabs, "tabs");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4768.java