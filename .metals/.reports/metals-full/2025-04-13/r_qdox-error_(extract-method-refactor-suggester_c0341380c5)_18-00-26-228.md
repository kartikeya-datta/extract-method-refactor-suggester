error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2751.java
text:
```scala
F@@orm form = new Form<Person>(page, "form", new CompoundPropertyModel<Person>(new Person()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2751.java