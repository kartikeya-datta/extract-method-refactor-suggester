error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4894.java
text:
```scala
m@@ethod.abort(ProblemSeverities.AbortType, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4894.java