error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6580.java
text:
```scala
b@@ody.applyCentralImpulse(tmpV2.set(ray.direction).scl(20f));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6580.java