error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15014.java
text:
```scala
S@@tring urlPrefix = getPage().urlFor((String)null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15014.java