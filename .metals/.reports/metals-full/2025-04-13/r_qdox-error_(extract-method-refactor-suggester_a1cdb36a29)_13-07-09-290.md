error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4609.java
text:
```scala
n@@ew LwjglApplication(new SkeletonModelViewer("data/robot-mesh.xml", "data/robot.jpg"), "SkeletonModel Viewer", 800, 480,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4609.java