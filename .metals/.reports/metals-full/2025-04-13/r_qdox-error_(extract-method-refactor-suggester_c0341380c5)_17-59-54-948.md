error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3991.java
text:
```scala
r@@eturn DeploymentDescription.getDeploymentDescription(locale, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3991.java