error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2060.java
...
```java
offset: 881
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2060.java
text:
```scala
...
p@@ackage org.elasticsearch.index.deletionpolicy;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2060.java