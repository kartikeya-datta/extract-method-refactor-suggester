error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/371.java
text:
```scala
c@@ontroller.registerHandler(DELETE, "/{index}/{type}", this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/371.java