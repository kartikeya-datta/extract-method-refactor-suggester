error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/193.java
text:
```scala
S@@tring osPath = resource.getLocation().toOSString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/193.java