error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/346.java
text:
```scala
u@@i = new Stage(Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/346.java