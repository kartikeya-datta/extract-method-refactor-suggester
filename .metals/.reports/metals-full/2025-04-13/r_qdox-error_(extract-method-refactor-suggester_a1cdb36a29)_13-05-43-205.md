error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8621.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8621.java
text:
```scala
private transient F@@ile inputFile = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8621.java