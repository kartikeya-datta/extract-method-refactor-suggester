error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/803.java
text:
```scala
S@@tring LANG_IO_EXCEPTION                                           = "X0X63.S";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/803.java