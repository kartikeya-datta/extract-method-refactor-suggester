error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6895.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6895.java
text:
```scala
private final C@@oncurrentMapLong<SearchContext> activeContexts = ConcurrentCollections.newConcurrentMapLongWithAggressiveConcurrency();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6895.java