error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14868.java
text:
```scala
t@@hrow new InvalidVariableException("Error processing Javascript: [" + script + "]", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14868.java