error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4390.java
text:
```scala
S@@ystem.out.println("Not loading duplicate cool bar item: " + id); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4390.java