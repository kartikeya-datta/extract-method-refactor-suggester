error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15519.java
text:
```scala
r@@es.setStopThread(true); // No point continuing
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15519.java