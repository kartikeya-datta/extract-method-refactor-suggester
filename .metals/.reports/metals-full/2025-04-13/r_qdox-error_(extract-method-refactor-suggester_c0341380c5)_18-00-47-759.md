error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1467.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1467.java
text:
```scala
public static final S@@tring version = "0.13.0";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1467.java