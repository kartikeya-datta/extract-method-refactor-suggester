error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9830.java
text:
```scala
t@@his.listener.dispose( app );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9830.java