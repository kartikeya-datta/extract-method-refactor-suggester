error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11150.java
text:
```scala
l@@og.errorf("Operation (%s) failed - address: (%s) - failure description: %s", operation.get(OP), operation.get(OP_ADDR), response.get(FAILURE_DESCRIPTION));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11150.java