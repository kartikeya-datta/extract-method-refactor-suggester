error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9453.java
text:
```scala
s@@prite.draw(batch, parentAlpha);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9453.java