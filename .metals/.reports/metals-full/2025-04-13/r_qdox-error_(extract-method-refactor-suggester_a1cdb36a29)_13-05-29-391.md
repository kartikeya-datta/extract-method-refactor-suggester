error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6327.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6327.java
text:
```scala
 ...
 */
public final class UnboundedQueueThreadPoolAdd extends AbstractExecutorAdd {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6327.java