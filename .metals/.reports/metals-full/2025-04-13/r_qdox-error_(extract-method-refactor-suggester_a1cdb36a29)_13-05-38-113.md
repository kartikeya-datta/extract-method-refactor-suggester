error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10886.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10886.java
text:
```scala
private final transient S@@ervletContext context;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10886.java