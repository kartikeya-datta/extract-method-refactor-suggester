error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13064.java
text:
```scala
p@@attern = compiler.compile("\\b("+value+")\\b");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13064.java