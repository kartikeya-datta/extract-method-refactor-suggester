error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4321.java
text:
```scala
t@@ouchFocusedChild = stage.getTouchFocus(0) != this ? stage.getTouchFocus(0) : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4321.java