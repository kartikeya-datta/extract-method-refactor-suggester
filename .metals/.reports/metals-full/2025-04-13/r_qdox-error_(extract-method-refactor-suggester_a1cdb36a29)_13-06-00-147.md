error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13541.java
text:
```scala
r@@eturn ManagementClientChannelStrategy.create(hostName, port, executorService, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13541.java