error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2480.java
text:
```scala
C@@artesianTierPlotter ctp = new CartesianTierPlotter( CartesianTierPlotter.bestFit(miles, minTier, maxTier), projector, tierPrefix);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2480.java