error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2229.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2229.java
text:
```scala
private v@@oid setLoaded(int field, boolean isLoaded) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2229.java