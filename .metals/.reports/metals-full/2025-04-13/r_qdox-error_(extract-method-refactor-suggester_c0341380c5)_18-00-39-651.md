error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8501.java
text:
```scala
c@@ase SWT.CURSOR_HAND:			shape = OS.GDK_HAND2; break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8501.java