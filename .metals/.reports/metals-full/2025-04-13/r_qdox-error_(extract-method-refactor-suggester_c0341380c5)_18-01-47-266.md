error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3699.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3699.java
text:
```scala
final b@@oolean enableStatistics = enableStatisticsModel.isDefined() && enableStatisticsModel.asBoolean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3699.java