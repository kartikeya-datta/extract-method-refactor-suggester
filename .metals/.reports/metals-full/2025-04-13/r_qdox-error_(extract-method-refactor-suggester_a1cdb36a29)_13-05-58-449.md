error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12787.java
...
```java
offset: 598
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12787.java
text:
```scala
 ...
 ******************************************************************************/
p@@ackage org.eclipse.ecf.datashare;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12787.java