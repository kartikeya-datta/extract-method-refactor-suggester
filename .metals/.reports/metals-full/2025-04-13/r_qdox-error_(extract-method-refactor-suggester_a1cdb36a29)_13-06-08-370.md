error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4877.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4877.java
text:
```scala
m@@_classpath.addPath( classpath );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4877.java