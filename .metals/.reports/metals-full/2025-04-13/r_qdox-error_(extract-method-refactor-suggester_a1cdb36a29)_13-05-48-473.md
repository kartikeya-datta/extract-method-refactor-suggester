error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6580.java
text:
```scala
e@@vent.doit = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6580.java