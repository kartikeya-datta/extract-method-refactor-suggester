error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8429.java
text:
```scala
i@@f (out.getVersion().before(Version.V_1_4_0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8429.java