error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3352.java
text:
```scala
t@@his.title = title;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3352.java