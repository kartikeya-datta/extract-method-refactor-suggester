error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3727.java
text:
```scala
i@@f (workingCopies == null) return JavaModelManager.NO_WORKING_COPY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3727.java