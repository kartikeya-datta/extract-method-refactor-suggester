error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7828.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7828.java
text:
```scala
public H@@ttpsListenerService(final String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7828.java