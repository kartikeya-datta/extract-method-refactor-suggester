error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10061.java
text:
```scala
i@@f (!workingCopy.isPrimary()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10061.java