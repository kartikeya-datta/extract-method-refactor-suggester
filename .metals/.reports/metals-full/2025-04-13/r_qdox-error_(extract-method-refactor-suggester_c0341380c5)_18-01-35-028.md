error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14651.java
text:
```scala
i@@f (control.hasFocus()) redrawWidget(view, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14651.java