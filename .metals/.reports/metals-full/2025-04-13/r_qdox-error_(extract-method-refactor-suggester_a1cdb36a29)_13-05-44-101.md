error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9459.java
text:
```scala
w@@eaver.getLazyClassGen().getOrCreateWeaverStateInfo(BcelClassWeaver.getReweavableMode());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9459.java