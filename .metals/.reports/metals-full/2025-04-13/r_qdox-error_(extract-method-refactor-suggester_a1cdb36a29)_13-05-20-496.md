error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7577.java
text:
```scala
G@@dx.gl10.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_AMBIENT, getValues(lightVal, ((ColorAttribute)attribute).color), 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7577.java