error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2471.java
text:
```scala
O@@S.SetDataBrowserSelectedItems (handle, 1, new int [] {item.id}, (style & SWT.MULTI) != 0 ? OS.kDataBrowserItemsAdd : OS.kDataBrowserItemsAssign);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2471.java