error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/624.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/624.java
text:
```scala
private static final S@@tring HTTP_RETRIEVE = "http://ftp.osuosl.org/pub/eclipse/rt/ecf/update/features/org.eclipse.ecf.examples_1.2.0.v20071019-1300.jar";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/624.java