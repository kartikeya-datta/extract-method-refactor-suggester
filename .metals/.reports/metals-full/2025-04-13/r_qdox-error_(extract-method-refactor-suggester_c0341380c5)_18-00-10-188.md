error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9.java
text:
```scala
W@@arMetaData warMetaData = deploymentUnit.getAttachment(WarMetaData.ATTACHMENT_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9.java