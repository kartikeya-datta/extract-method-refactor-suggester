error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16846.java
text:
```scala
A@@smManager.getDefault().createNewASM(null); // forget what you know...
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16846.java