error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3409.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3409.java
text:
```scala
D@@erby - Class org.apache.derbyTesting.functionTests.tests.replicationTests.ReplicationRun_Distributed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3409.java