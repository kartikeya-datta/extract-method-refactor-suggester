error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4070.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4070.java
text:
```scala
S@@erviceName svcName = LdapConnectionManagerService.ServiceUtil.createServiceName(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4070.java