error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4023.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4023.java
text:
```scala
b@@uilder.timeValueField(Fields.TIME_IN_MILLIS, Fields.TIME, percolateTimeInMillis);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4023.java