error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3237.java
...
```java
offset: 878
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3237.java
text:
```scala
...
p@@ackage org.elasticsearch.plugin.attachments;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3237.java