error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14964.java
text:
```scala
r@@eturn fileset.getDirectoryScanner();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14964.java