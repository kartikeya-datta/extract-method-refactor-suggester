error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2798.java
text:
```scala
d@@efaultPreference = RandomPicks.randomFrom(random, EnumSet.of(Preference.PRIMARY_FIRST, Preference.LOCAL)).type();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2798.java