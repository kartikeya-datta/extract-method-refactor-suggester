error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3390.java
text:
```scala
s@@erverGroups.registerReadWriteAttribute(PROFILE, null, ServerGroupProfileWriteAttributeHandler.INSTANCE, Storage.CONFIGURATION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3390.java