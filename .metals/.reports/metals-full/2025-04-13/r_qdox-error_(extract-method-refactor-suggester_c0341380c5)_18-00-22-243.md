error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/225.java
text:
```scala
T@@okenStream tokenStream = analyzer.tokenStream("field", "abcd   ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/225.java