error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3886.java
text:
```scala
q@@uery = smartNameFieldMappers.mapper().termQuery(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3886.java