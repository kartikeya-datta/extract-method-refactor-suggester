error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6495.java
text:
```scala
s@@etEmptyText(string.no_members);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6495.java