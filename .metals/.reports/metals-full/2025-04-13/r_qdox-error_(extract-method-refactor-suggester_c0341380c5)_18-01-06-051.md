error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7088.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7088.java
text:
```scala
b@@oolean beforeInvocation() default false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7088.java