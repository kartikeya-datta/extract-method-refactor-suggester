error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14266.java
text:
```scala
a@@rgs.add("out/lib.jar" + File.pathSeparator + AjcTests.aspectjrtClasspath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14266.java