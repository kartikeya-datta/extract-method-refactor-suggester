error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/302.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/302.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/302.java
text:
```scala
a@@ssertEquals(pair.output, output);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/302.java