error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1120.java
...
```java
offset: 1066
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1120.java
text:
```scala
...
*/
p@@ackage org.jboss.as.controller.util;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1120.java