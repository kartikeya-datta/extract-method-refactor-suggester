error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6334.java
text:
```scala
P@@ropertyAdd.INSTANCE.performRuntime(context, operation, model, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6334.java