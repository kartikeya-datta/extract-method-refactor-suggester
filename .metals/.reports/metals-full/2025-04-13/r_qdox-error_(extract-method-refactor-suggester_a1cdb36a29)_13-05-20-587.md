error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8078.java
text:
```scala
c@@heckVersion(SampleSaveConfigurationConverter.class,"408969"); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8078.java