error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15305.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15305.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15305.java
text:
```scala
static i@@nt MINOR_VERSION = 317;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15305.java