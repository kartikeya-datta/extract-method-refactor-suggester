error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8917.java
text:
```scala
.@@StringCompare());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8917.java