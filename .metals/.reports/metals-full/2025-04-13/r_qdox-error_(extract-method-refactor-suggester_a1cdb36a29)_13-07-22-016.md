error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11628.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11628.java
text:
```scala
protected static final S@@tring VIEW_PREFIX = "Chat: ";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11628.java