error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14792.java
text:
```scala
i@@f (!fetch.getEnlistInQueryCache())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14792.java