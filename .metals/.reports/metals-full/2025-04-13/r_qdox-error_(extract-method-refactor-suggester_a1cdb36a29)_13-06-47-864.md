error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/530.java
text:
```scala
M@@etaData.Builder metaDataBuilder = MetaData.builder(currentState.metaData());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/530.java