error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7786.java
text:
```scala
N@@ameLookup nameLookup = ((JavaProject) getJavaProject()).getNameLookup();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7786.java