error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5573.java
text:
```scala
r@@eturn distance / 1000.0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5573.java