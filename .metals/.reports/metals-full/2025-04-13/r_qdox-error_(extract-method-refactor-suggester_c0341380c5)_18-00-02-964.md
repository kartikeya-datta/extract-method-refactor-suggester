error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4601.java
text:
```scala
s@@etModelObject(getConverter().convert(input, type));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4601.java