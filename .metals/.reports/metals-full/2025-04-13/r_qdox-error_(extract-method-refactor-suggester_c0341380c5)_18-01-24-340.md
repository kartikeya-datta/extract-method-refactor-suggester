error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17786.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[105,80]

error in qdox parser
file content:
```java
offset: 2915
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17786.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17786.java