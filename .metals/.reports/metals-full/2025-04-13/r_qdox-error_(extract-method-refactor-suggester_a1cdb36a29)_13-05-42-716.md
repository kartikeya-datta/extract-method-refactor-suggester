error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/934.java
text:
```scala
l@@ogger_.info("Completed flushing " + ssTable.getFilename());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/934.java