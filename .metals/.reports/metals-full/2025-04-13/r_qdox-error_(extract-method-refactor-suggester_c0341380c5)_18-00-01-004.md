error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1575.java
text:
```scala
r@@esolvers.add(new PathExtensionResourceResolver());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1575.java