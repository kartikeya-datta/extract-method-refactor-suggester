error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6363.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6363.java
text:
```scala
public static final F@@ieldBinding ArrayLength = new FieldBinding(LENGTH, IntBinding, AccPublic | AccFinal, null, Constant.NotAConstant);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6363.java