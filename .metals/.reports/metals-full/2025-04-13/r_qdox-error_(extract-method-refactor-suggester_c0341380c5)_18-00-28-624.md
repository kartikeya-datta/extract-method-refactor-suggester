error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3019.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3019.java
text:
```scala
public B@@uilder remoteTemplate(String templateName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3019.java