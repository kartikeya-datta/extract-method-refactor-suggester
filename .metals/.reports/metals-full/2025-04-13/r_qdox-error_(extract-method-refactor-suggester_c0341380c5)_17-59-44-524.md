error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4201.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4201.java
text:
```scala
t@@his.resolvedType = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4201.java