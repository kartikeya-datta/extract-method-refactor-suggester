error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3975.java
text:
```scala
C@@ompilerOptions.OPTION_ReportBooleanMethodThrowingException,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3975.java