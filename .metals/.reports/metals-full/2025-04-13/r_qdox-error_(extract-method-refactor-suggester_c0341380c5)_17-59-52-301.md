error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2367.java
text:
```scala
r@@eturn "image"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2367.java