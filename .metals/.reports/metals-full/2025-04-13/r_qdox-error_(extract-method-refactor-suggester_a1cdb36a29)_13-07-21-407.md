error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12569.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12569.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12569.java
text:
```scala
a@@ssertTrue(controller.latch.await(10, TimeUnit.SECONDS));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12569.java