error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7035.java
text:
```scala
S@@WT.error(SWT.ERROR_NO_GRAPHICS_LIBRARY, t, " [Cairo required]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7035.java