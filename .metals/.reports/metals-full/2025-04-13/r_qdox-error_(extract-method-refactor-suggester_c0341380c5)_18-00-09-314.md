error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2460.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2460.java
text:
```scala
protected N@@amePanel namePanel;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2460.java