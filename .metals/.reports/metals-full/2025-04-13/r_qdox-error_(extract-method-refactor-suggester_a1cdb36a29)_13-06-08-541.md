error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1603.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1603.java
text:
```scala
public M@@ultiEditorInnerPane(EditorPane pane,IEditorReference ref, WorkbenchPage page, EditorStack workbook) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1603.java