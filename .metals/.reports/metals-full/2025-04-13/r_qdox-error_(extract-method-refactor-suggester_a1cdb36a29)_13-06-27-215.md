error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8144.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8144.java
text:
```scala
r@@eturn new TermFacetCollector(facetName, field, size, context.fieldDataCache(), context.mapperService());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8144.java