error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/548.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/548.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/548.java
text:
```scala
M@@anagementRemotingServices.installRemotingManagementEndpoint(serviceTarget, ManagementRemotingServices.MANAGEMENT_ENDPOINT,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/548.java