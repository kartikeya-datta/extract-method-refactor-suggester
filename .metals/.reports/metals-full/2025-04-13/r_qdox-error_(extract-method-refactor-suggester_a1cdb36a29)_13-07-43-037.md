error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/342.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/342.java
text:
```scala
private i@@nt messageBatchSize;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/342.java