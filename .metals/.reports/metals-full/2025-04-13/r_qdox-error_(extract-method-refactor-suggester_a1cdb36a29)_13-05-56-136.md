error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/814.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/814.java
text:
```scala
public static final i@@nt INSTALL_BEAN_CONTAINER                      = 0xB00;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/814.java