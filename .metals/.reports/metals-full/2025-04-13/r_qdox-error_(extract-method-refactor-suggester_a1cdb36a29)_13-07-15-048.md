error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6884.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6884.java
text:
```scala
final M@@oduleIdentifier moduleIdentifier = ModuleIdentifier.create("org.jboss.deployments" + "." + deploymentRoot.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6884.java