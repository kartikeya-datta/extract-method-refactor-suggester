error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4373.java
text:
```scala
t@@his.indentationLevel = getNextIndentationLevel(firstColumn);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4373.java