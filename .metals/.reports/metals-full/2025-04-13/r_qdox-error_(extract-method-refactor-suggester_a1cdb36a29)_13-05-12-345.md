error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9127.java
text:
```scala
i@@f (fontColor != null) label.getStyle().fontColor = fontColor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9127.java