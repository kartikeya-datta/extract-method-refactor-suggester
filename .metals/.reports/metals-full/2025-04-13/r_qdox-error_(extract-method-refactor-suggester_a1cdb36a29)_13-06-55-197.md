error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2315.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2315.java
text:
```scala
protected J@@MDNSServiceTypeID(final Namespace namespace, final String type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2315.java