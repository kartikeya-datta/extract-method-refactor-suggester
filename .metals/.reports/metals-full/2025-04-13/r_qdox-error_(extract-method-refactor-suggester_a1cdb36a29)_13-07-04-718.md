error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7413.java
text:
```scala
M@@ap<String, ContextQuery> querySet = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7413.java