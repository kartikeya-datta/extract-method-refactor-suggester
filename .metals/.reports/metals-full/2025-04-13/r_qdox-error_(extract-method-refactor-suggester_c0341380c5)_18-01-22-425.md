error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2523.java
text:
```scala
t@@arget.add(containerWrapper);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2523.java