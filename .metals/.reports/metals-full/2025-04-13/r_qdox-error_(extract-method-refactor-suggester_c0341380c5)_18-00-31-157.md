error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1482.java
text:
```scala
R@@owMutation hintedMutation = new RowMutation(Table.SYSTEM_TABLE, rm.getTable().getBytes(FBUtilities.UTF8));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1482.java