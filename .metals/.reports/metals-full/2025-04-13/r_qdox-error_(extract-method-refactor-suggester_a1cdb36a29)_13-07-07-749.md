error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7667.java
text:
```scala
c@@lusterService.submitStateUpdateTask("shard-started (" + shardRoutingEntry.shardRouting + "), reason [" + shardRoutingEntry.reason + "]", Priority.URGENT,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7667.java