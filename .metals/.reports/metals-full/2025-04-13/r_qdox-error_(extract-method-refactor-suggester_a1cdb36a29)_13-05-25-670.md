error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1215.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1215.java
text:
```scala
@param h@@ierarchy The {@link org.apache.log4j.Hierarchy} to act on.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1215.java