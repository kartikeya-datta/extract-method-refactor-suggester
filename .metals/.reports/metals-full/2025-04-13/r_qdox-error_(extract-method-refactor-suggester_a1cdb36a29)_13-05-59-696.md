error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4347.java
text:
```scala
r@@eturn "<SelectOnType:"/*nonNLS*/ + new String(token) + ">"/*nonNLS*/ ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4347.java