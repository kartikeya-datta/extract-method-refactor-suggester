error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7775.java
text:
```scala
a@@ssertEquals("10.0", new MutableObject<Double>(Double.valueOf(10)).toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7775.java