error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4125.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4125.java
text:
```scala
final S@@ecurityContext securityContext = exchange.getSecurityContext();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4125.java