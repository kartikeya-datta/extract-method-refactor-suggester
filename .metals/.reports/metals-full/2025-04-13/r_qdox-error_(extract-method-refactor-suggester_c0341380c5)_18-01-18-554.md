error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16278.java
text:
```scala
i@@nt dp = OS.UIElement_VisibilityProperty ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16278.java