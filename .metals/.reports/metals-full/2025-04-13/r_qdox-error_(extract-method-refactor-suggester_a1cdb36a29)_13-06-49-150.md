error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10414.java
text:
```scala
q@@uery = new ParentConstantScoreQuery(innerQuery, parentType, childrenFilter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10414.java