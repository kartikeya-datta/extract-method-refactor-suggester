error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3815.java
text:
```scala
I@@ObjectActivityManager objectManager = window.getWorkbench().getObjectActivityManager(IWorkbenchConstants.PL_VIEWS, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3815.java