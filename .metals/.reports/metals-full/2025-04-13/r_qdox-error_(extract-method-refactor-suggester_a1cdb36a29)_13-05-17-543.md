error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1316.java
...
```java
offset: 636
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1316.java
text:
```scala
...
p@@ackage org.eclipse.ui.internal.commands.older;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1316.java