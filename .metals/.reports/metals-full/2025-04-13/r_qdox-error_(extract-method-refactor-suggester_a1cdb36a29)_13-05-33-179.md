error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8212.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8212.java
text:
```scala
i@@tems [i] = new TreeItem (this, parentItem, SWT.NONE, i, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8212.java