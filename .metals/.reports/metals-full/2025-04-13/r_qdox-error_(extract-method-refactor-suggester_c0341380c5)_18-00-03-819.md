error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6098.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6098.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6098.java
text:
```scala
final b@@oolean onDemand = (importReference.bits & org.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6098.java