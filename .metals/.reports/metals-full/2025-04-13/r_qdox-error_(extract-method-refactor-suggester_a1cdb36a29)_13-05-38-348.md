error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/764.java
text:
```scala
i@@f (!checkedType.isReifiable()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/764.java