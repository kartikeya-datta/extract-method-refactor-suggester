error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8770.java
text:
```scala
n@@otifier.aboutToCompile(units[0]); // just to change the message
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8770.java