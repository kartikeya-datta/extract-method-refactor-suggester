error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3602.java
text:
```scala
r@@otateTime = 1000L * ((Number)conf.get(Config.TOPOLOGY_MESSAGE_TIMEOUT_SECS)).intValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3602.java