error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7634.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7634.java
text:
```scala
private static final S@@tring HTTPS_RETRIEVE = RetrieveTest.HTTPS_RETRIEVE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7634.java