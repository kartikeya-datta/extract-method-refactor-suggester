error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10879.java
text:
```scala
r@@eturn URI.create(PROTOCOLS[0] + "://"/* + USERNAME + "@" */+ getHost() + ":" + PORT + PATH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10879.java