error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8438.java
text:
```scala
t@@his(requestor, problemFactory, new CompilerOptions());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8438.java