error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7348.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7348.java
text:
```scala
public F@@ormCharSetFinder() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7348.java