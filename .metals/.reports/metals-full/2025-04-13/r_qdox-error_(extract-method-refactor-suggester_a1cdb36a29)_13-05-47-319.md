error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7564.java
text:
```scala
s@@criptField.script().setNextReader(hitContext.readerContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7564.java