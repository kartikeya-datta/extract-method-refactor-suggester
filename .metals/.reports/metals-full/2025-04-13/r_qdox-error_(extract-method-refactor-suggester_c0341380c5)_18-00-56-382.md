error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8713.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8713.java
text:
```scala
final C@@hannel mgmtChannel = channel;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8713.java