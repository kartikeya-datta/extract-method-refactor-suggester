error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9367.java
text:
```scala
r@@esult = (IEditorReference) site.getPartReference();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9367.java