error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15010.java
text:
```scala
F@@ile logFile = FILE_UTILS.createTempFileName("spawn","log", project.getBaseDir(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15010.java