error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9883.java
text:
```scala
S@@erviceBuilder<SessionIdentifierCodec> build(ServiceTarget target, ServiceName name, ServiceName deploymentServiceName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9883.java