error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8309.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8309.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8309.java
text:
```scala
T@@reeColumn[] columns = parent.columns;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8309.java