error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3659.java
...
```java
offset: 1096
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3659.java
text:
```scala
...
p@@ackage org.jboss.as.clustering.jgroups.subsystem;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3659.java