error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12237.java
text:
```scala
S@@tructureModel model = Ajde.getDefault().getStructureModelManager().getModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12237.java