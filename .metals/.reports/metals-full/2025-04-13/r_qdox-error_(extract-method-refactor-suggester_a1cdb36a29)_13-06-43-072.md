error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/728.java
text:
```scala
t@@his.scale.y = scale;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/728.java