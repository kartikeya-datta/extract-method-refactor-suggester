error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1292.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1292.java
text:
```scala
final I@@njectionTarget injectionTarget = new MethodInjectionTarget(methodInfo.declaringClass().name().toString(), methodName, methodInfo.returnType().name().toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1292.java