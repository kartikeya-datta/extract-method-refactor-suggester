error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9281.java
text:
```scala
C@@lass<?> propType = this.beanWrapper.getPropertyType(paramName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9281.java