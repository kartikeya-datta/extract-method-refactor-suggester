error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11925.java
text:
```scala
i@@nt startOffset = text.getOffsetAtLocation(new Point(0, pt.y));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11925.java