error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2347.java
text:
```scala
i@@f (initializationType.isRawType() && (fieldType.isBoundParameterizedType() || fieldType.isGenericType())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2347.java