error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5015.java
text:
```scala
i@@f (!cursor.value.equals(metaData2.custom(cursor.key))) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5015.java