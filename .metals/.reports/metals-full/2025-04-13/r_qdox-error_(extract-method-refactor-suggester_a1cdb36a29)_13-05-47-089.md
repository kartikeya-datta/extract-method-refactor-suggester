error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5213.java
text:
```scala
M@@odelChange(final Component<?> component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5213.java