error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2561.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2561.java
text:
```scala
a@@pp.getApplicationMetadata().getApplicationScope(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2561.java