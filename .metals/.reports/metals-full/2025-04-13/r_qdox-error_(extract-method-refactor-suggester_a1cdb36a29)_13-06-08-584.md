error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5666.java
text:
```scala
p@@arent.modifyStyle (parentHandle, style);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5666.java