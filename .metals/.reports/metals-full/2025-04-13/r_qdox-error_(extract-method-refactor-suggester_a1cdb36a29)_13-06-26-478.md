error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8444.java
text:
```scala
r@@eturn DeploymentDescription.getReplaceDeploymentOperation(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8444.java