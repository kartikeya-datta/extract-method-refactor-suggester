error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2000.java
text:
```scala
c@@onstant = FieldReference.getConstantFor(fieldBinding, this, true, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2000.java