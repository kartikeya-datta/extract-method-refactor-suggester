error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5044.java
text:
```scala
i@@f (this.inferredReturnType)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5044.java