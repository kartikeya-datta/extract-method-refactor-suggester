error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6463.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6463.java
text:
```scala
public static final S@@tring VERSION = "1.2.0";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6463.java