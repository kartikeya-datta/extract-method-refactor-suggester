error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/128.java
text:
```scala
t@@hrow ThreadsLogger.ROOT_LOGGER.nullUnit();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/128.java