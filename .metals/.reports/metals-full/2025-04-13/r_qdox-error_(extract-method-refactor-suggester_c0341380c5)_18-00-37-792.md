error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4958.java
text:
```scala
p@@utValue(SMALL_ICON, ImageLoader.getSmallIcon("go-home.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4958.java