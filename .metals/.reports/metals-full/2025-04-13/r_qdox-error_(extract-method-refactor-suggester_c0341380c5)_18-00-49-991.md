error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/837.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/837.java
text:
```scala
public static l@@ong randomLong() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/837.java