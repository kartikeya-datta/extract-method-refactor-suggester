error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3199.java
text:
```scala
S@@et<?> stopWords = Analysis.parseStopWords(env, settings, defaultStopwords, version);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3199.java