error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4558.java
text:
```scala
c@@ontrollers.add(builder.build(ChannelService.getStackServiceName(ChannelService.DEFAULT), ChannelService.getStackServiceName(defaultChannel), ChannelFactory.class).install());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4558.java