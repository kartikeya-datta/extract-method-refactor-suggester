error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1838.java
text:
```scala
i@@f (isEnabled(component))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1838.java