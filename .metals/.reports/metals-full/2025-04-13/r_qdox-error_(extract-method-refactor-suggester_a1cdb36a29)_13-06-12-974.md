error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6925.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6925.java
text:
```scala
", maxPoolSize=" + m@@axPoolSize +
...
public class StrictMaxPoolConfig extends PoolConfig {
    ...
    @Override
    public Pool<?> createPool(final StatelessObjectFactory statelessObjectFactory) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6925.java