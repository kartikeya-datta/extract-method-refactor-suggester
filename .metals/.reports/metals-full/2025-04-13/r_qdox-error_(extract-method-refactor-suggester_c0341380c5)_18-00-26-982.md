error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6573.java
text:
```scala
a@@pplication.getPageSettings().addComponentResolver(new ScopedComponentResolver());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6573.java