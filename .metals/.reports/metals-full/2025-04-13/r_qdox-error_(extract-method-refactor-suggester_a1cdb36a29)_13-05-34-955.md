error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3910.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3910.java
text:
```scala
public v@@oid testSynchronizationSuceeded() throws IOException, NamingException, NotSupportedException, SystemException, RollbackException, HeuristicMixedException, HeuristicRollbackException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3910.java