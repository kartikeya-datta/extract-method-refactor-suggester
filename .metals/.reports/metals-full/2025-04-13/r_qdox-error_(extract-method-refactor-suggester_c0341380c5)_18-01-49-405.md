error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9331.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9331.java
text:
```scala
public static final S@@tring VERSION = "1.2.1";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9331.java