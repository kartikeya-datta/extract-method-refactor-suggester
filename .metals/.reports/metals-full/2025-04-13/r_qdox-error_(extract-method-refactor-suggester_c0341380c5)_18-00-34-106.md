error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1802.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1802.java
text:
```scala
public static final S@@tring TAG_ID = "MultiTermRewriteMethodAttribute";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1802.java