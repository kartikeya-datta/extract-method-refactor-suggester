error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/955.java
text:
```scala
e@@nclosingTypeAt((this.bits & ASTNode.DepthMASK) >> ASTNode.DepthSHIFT)).addSyntheticMethod(codegenField, isReadAccess, false /*not super access*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/955.java