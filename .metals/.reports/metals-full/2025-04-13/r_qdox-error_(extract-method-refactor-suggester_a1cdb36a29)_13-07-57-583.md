error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7147.java
text:
```scala
n@@ew FolderOptionsDialog((Folder) folder, (AbstractMailFrameController) frameMediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7147.java