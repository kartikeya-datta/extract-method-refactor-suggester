error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1154.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1154.java
text:
```scala
protected static l@@ong getCPtr(SWIGTYPE_p_btAlignedObjectArrayT_btDbvtNode_const_p_t obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1154.java