error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15889.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15889.java
text:
```scala
public v@@oid setSelectedTab(int index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15889.java