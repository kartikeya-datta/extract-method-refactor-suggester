error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5621.java
text:
```scala
r@@esourceRegistration.registerSubModel(LdapConnectionResourceDefinition.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5621.java