error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3739.java
text:
```scala
S@@tringResourceModel model = new StringResourceModel("simple.text", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3739.java