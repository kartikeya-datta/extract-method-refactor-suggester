error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4966.java
text:
```scala
r@@eturn super.termsFilter(values, context);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4966.java