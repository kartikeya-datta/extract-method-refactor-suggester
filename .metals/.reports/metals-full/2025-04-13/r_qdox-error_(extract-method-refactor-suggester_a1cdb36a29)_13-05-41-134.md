error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9390.java
text:
```scala
t@@hrow new RuntimeException("Error on getting TX id from BusinessActivityManager", se);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9390.java