error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8960.java
text:
```scala
i@@f (((ClassScope) scope).detectHierarchyCycle(this.resolvedType, this, null)) // must connect hierarchy to find inherited member types
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8960.java