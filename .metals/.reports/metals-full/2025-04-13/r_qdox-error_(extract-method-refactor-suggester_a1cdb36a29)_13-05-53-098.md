error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1346.java
text:
```scala
s@@b.append(config.getRowDelimiter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1346.java