error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/490.java
text:
```scala
r@@eturn file().exists();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/490.java