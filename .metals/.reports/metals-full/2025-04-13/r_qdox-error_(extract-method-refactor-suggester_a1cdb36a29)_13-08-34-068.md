error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4050.java
text:
```scala
i@@nt features = OS.kControlSupportsEmbedding | OS.kControlSupportsFocus;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4050.java