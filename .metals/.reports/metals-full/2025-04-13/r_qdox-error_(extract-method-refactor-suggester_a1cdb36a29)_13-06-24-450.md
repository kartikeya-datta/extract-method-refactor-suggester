error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12896.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12896.java
text:
```scala
P@@ooledConnectionFactoryService.installService(null, null, serviceTarget, pcfName, getHornetQServerName(), connectors,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12896.java