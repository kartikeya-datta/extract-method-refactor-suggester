error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8241.java
text:
```scala
S@@erverMessages.MESSAGES.equivilentNamespacesInJBossXml(entry.getKey(), usedNamespaces.get(attachmentKey));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8241.java