error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8807.java
text:
```scala
A@@bstractHttpServerSockJsSession session) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8807.java