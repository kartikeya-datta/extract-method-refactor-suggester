error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6950.java
text:
```scala
f@@ield.original().modifiers |= AccLocallyUsed;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6950.java