error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/536.java
text:
```scala
s@@uper(settings, MultiGetAction.NAME, threadPool);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/536.java