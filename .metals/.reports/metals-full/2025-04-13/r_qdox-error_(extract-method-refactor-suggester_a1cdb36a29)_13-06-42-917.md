error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1259.java
text:
```scala
D@@efaults.BOOST, fieldType, Defaults.NULL_VALUE, Defaults.IGNORE_MALFORMED, provider, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1259.java