error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7017.java
text:
```scala
r@@esult.set(String.valueOf(endpointMetrics.getAverageProcessingTime()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7017.java