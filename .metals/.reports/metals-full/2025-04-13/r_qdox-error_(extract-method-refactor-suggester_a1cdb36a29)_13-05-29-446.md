error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7995.java
text:
```scala
O@@S.class_addIvar(cls, SWT_OBJECT, C.PTR_SIZEOF, (byte)(Math.log(C.PTR_SIZEOF) / Math.log(2)), "^v"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7995.java