error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3568.java
text:
```scala
b@@oolean isVarArgs, boolean isMethod, boolean isConstructor, int methodId) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3568.java