error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7482.java
text:
```scala
a@@ssertEquals(strategy.getDelimiter(), ',');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7482.java