error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5999.java
text:
```scala
r@@eturn OS.objc_msgSend(this.id, OS.sel_state);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5999.java