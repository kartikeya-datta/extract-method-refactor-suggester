error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7240.java
text:
```scala
M@@apBuilder<ClusterAction, TransportActionNodeProxy> actionsBuilder = new MapBuilder<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7240.java