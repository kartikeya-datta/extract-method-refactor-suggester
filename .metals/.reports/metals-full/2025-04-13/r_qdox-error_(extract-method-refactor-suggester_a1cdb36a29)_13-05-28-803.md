error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6530.java
text:
```scala
i@@f (aggregations.size() == 1 && from == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6530.java