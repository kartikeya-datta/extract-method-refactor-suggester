error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4762.java
text:
```scala
j@@Edit.setBooleanProperty("buffer.encodingAutodetect",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4762.java