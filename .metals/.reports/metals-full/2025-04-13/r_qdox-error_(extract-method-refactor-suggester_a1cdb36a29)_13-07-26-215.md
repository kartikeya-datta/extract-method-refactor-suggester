error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16781.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16781.java
text:
```scala
final I@@TypeConverter converter = get(c);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16781.java