error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6684.java
text:
```scala
t@@hrow new GdxRuntimeException("Not supported in GWT backend");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6684.java