error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6345.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6345.java
text:
```scala
i@@f (filter.equals(STRING_FILTER))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6345.java