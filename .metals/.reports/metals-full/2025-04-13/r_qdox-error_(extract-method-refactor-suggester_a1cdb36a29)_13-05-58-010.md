error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6391.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6391.java
text:
```scala
private static final S@@tring COPYRIGHT = "Copyright (c) 1998-2013 The Apache Software Foundation";
...
public final class JMeterVersion {
     ...
     */
    private static final String VERSION = "2.9-SNAPSHOT";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6391.java