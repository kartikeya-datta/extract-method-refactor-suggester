error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2399.java
text:
```scala
S@@tring[] weaverAwareNames = beanFactory.getBeanNamesForType(LoadTimeWeaverAware.class, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2399.java