error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1495.java
text:
```scala
r@@eturn "behind the EOF\n\n" + new String(source); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1495.java