error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/399.java
text:
```scala
E@@xpressionParser.class, QueryLanguages.class.getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/399.java