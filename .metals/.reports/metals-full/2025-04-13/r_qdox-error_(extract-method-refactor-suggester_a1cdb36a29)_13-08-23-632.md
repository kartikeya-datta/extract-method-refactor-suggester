error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7996.java
text:
```scala
G@@dx.app.log("PixmaPackerTest", "Number of textures: " + atlas.getTextures().size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7996.java