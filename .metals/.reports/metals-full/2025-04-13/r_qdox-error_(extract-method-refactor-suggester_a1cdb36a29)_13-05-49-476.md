error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9286.java
text:
```scala
b@@oolean isWhiteSpace;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9286.java