error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5304.java
text:
```scala
B@@itmapFontFlipTest.class, GroupCullingTest.class,
...
public class GdxTests {
	public static final Class[] tests = {AnimationTest.class, AccelerometerTest.class, ActionTest.class, ActionSequenceTest.class,
		...
		MipMapTest.class,
		// Mpg123Test.class,
		MultitouchTest.class, MusicTest.class, MyFirstTriangle.class, ObjTest.class, OnscreenKeyboardTest.class,
		OrthoCamBorderTest.class, ParallaxTest.class, ParticleEmitterTest.class, PickingTest.class, PixelsPerInchTest.class,
		PixmapBlendingTest.class, PixmapTest.class, PreferencesTest.class, ProjectiveTextureTest.class, Pong.class,
		ProjectTest.class, RemoteTest.class, RotationTest.class, ShaderMultitextureTest.class, ShadowMappingTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5304.java