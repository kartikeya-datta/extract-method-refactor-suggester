error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4952.java
text:
```scala
t@@his(file, listener, delay, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4952.java