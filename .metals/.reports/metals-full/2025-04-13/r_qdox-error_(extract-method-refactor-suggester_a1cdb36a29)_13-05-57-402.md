error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8121.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8121.java
text:
```scala
public v@@oid addAll (char[] array) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8121.java