error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7806.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7806.java
text:
```scala
protected static final S@@tring DISCOVERED_SERVICES = "Services";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7806.java