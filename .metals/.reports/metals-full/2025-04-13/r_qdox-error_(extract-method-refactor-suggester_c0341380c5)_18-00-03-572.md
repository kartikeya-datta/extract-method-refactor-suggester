error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9825.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9825.java
text:
```scala
r@@eturn !isDelimiter(c) && Character.isWhitespace((char) c);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9825.java