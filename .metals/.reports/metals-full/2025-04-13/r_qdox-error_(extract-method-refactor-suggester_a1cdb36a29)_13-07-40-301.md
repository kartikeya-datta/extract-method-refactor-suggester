error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1026.java
text:
```scala
c@@ombo = new Combo(container, SWT.READ_ONLY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1026.java