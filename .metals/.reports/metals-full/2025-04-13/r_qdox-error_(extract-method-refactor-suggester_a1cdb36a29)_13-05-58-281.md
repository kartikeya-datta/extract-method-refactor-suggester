error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5964.java
text:
```scala
r@@eturn Util.equals(workingSet.getName(), getName())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5964.java