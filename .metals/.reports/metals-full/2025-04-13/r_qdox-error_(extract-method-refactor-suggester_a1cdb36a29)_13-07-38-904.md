error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8447.java
text:
```scala
V@@irtualFile virtualFile = phaseContext.getAttachment(Attachments.DEPLOYMENT_ROOT).getRoot();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8447.java