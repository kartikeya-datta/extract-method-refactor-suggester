error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/295.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/295.java
text:
```scala
b@@uf.append(Long.toString(event.getTimeStamp() - LoggingEvent.getStartTime()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/295.java