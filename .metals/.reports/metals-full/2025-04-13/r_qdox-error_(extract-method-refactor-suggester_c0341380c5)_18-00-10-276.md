error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/249.java
text:
```scala
L@@ist<ResourceRoot> resourceRoots = deploymentUnit.getAttachmentList(Attachments.RESOURCE_ROOTS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/249.java