error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2688.java
text:
```scala
a@@dd(name, region, TextureRegion.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2688.java