error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5788.java
text:
```scala
c@@atch (MarkupException ex)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5788.java