error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18153.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18153.java
text:
```scala
private final M@@ap constructorForClass = new ConcurrentHashMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18153.java