error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3726.java
text:
```scala
c@@mdRegistry.registerHandler(new BatchRunHandler(this), "run-batch");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3726.java