error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1138.java
text:
```scala
G@@dx.app.log("Test", "Thread=" + Thread.currentThread().getId() + ", app resized: " + width + "x" + height + ", Graphics says: "+ Gdx.graphics.getWidth() + "x" + Gdx.graphics.getHeight());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1138.java