error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16156.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16156.java
text:
```scala
public R@@ectangle getTextBounds (int columnIndex) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16156.java