error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8880.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8880.java
text:
```scala
L@@ist<String> gets = Arrays.asList(new String[] { "/app2/wicket/bookmarkable/org.apache.wicket.threadtest.apps.app2.Home" });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8880.java