error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1448.java
text:
```scala
b@@uilder.field("norms_field", normsField);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1448.java