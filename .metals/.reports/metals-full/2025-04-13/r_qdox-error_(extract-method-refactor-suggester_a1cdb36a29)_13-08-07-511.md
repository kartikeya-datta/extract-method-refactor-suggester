error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6987.java
text:
```scala
t@@ypeSigs[i] = Signature.C_UNRESOLVED + typeSig.substring(lastIndex + 1, typeSig.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6987.java