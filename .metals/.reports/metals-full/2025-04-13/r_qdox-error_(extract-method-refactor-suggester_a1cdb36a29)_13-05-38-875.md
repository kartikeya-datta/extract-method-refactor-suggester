error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4698.java
text:
```scala
G@@dxTest test = new NewModelTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4698.java