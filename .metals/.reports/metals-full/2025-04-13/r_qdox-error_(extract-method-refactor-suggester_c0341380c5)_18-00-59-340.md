error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1928.java
text:
```scala
s@@etEditable(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1928.java