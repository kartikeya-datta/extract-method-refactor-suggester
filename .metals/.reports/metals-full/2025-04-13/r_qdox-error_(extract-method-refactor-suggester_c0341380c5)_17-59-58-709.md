error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/553.java
text:
```scala
e@@lements.add(new PropertyPathElement(prop.substring(0, start), false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/553.java