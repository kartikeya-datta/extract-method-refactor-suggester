error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2398.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2398.java
text:
```scala
a@@pplication.setHomePage(MarkupInheritanceExtension_4.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2398.java