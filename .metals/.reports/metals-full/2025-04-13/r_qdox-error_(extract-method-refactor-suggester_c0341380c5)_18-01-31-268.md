error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6755.java
text:
```scala
g@@etFrameController().getSelectionManager().setSelection("mail.tree", refs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6755.java