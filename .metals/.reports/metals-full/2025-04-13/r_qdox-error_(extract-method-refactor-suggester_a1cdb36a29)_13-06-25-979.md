error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1090.java
text:
```scala
c@@ontext.startSubsystemElement(Namespace.EE_3_0.getUriString(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1090.java