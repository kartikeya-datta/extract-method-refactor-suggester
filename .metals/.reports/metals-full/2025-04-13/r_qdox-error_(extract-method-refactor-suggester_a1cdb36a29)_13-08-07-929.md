error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4551.java
text:
```scala
C@@lass<?> type = binding.getValueModel().getValueType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4551.java