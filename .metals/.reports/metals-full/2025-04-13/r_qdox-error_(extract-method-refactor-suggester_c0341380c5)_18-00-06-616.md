error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7501.java
text:
```scala
s@@ortedShardList = searchPhaseController.sortDocs(request, useSlowScroll, firstResults);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7501.java