error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/299.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/299.java
text:
```scala
private static final S@@tring VERSION = "2.3.3";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/299.java