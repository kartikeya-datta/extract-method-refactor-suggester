error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/608.java
text:
```scala
i@@f ((fieldBinding.declaringClass.modifiers  & AccInterface) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/608.java