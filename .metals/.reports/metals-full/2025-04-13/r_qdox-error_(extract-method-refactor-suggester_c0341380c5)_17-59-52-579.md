error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/845.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/845.java
text:
```scala
final M@@ap enabledContextTree = workbenchContextSupport.createFilteredContextTreeFor(enabledContextIds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/845.java