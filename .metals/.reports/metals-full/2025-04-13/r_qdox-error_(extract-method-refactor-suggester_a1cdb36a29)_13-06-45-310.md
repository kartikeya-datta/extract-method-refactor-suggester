error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16070.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16070.java
text:
```scala
protected B@@eanShellBeanInfoSupport(Class<?> beanClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16070.java