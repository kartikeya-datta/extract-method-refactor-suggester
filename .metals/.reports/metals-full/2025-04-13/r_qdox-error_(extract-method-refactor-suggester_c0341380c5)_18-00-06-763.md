error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8796.java
text:
```scala
t@@his.resolvedType = this.type.resolveType(scope, true /* check bounds*/); // will check for null after args are resolved
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8796.java