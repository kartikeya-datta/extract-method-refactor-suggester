error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3937.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3937.java
text:
```scala
public W@@ordGeneratorTest(final String message)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3937.java