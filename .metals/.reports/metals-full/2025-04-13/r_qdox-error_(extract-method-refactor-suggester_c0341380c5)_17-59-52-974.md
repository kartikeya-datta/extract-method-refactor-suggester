error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8496.java
text:
```scala
A@@pplyRemoteMasterDomainModelHandler armdmh = new ApplyRemoteMasterDomainModelHandler(extensionContext, fileRepository);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8496.java