error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1656.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,770]

error in qdox parser
file content:
```java
offset: 770
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1656.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1656.java