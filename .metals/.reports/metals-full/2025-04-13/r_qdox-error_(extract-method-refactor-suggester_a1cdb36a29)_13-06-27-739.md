error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5291.java
text:
```scala
r@@eturn TypeBinding.CHAR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5291.java