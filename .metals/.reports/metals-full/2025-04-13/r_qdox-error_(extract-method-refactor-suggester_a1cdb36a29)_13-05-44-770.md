error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12741.java
text:
```scala
S@@tartException startFailedCannotResolveInitialCapability(@Cause Throwable th, String identifier);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12741.java