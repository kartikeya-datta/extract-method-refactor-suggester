error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14909.java
text:
```scala
i@@nt port = Utils.getInt(conf.get(Config.DRPC_PORT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14909.java