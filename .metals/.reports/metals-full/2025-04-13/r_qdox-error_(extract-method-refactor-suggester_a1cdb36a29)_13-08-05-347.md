error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7795.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7795.java
text:
```scala
public v@@oid decorateResponse(AbstractResource.ResourceResponse response)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7795.java