error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7855.java
text:
```scala
c@@hannel.sendResponse(new XContentRestResponse(request, RestStatus.OK, builder));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7855.java