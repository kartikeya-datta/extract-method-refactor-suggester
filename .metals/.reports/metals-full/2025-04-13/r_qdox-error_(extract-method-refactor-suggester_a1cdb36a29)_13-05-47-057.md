error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14294.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14294.java
text:
```scala
private i@@nt value = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14294.java