error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10176.java
text:
```scala
r@@eturn this.invoker.invoke(this.cache, new FindOperation<BeanKey<I>, BeanEntry<G>>(this.createKey(id)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10176.java