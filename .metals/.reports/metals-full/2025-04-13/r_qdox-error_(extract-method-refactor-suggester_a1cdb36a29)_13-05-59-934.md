error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3321.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[156,2]

error in qdox parser
file content:
```java
offset: 4821
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3321.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3321.java