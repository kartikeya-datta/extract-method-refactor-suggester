error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9280.java
text:
```scala
G@@ET, POST, PUT, DELETE, OPTIONS, HEAD
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9280.java