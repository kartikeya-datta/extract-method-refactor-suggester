error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12175.java
text:
```scala
p@@rivileged aspect A {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12175.java