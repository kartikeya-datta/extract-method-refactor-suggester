error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/360.java
text:
```scala
S@@tring baseName = "$anonymous"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/360.java