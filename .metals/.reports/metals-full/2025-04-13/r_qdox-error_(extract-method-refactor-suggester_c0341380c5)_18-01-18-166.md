error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1707.java
text:
```scala
_@@state = TransactionalState.newUserState(conf, (String) conf.get(Config.TOPOLOGY_TRANSACTIONAL_ID), getComponentConfiguration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1707.java