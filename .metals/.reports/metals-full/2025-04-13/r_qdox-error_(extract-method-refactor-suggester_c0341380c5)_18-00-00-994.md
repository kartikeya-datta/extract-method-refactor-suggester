error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6908.java
text:
```scala
s@@creen = new MainMenu(Gdx.app);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6908.java