error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2287.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2287.java
text:
```scala
private L@@ock writeLock;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2287.java