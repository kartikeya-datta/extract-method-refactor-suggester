error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7829.java
text:
```scala
F@@ieldDataType fieldDataType = new FieldDataType("string", ImmutableSettings.builder().put("global_values", "fixed").put("cache", "node"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7829.java