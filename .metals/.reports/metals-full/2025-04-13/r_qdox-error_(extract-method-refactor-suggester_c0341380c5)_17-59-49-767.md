error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18221.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18221.java
text:
```scala
public C@@ursor getCursor () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18221.java