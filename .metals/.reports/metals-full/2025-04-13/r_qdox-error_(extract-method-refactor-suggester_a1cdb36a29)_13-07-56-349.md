error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5851.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5851.java
text:
```scala
static S@@tring libgdxVersion = "1.1.0";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5851.java