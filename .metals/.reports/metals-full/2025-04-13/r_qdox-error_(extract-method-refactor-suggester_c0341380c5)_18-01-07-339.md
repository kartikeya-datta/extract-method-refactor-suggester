error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1979.java
text:
```scala
m@@odelBatch.render(instance, lights);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1979.java