error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7221.java
text:
```scala
r@@eturn new PrimaryResponse<>(shardRequest.request, response, op);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7221.java