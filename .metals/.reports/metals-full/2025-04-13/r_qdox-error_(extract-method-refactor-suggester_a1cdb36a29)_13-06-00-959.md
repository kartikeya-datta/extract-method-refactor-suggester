error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4093.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4093.java
text:
```scala
s@@uper.setUp(Person.class, Address.class, CLEAR_TABLES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4093.java