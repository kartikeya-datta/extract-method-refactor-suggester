error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7159.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7159.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7159.java
text:
```scala
 B@@aseTypeBinding.isWidening(lhsType.id, rhsType.id))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7159.java