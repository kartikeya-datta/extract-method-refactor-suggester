error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3214.java
text:
```scala
M@@appingJacksonValue jsv = new MappingJacksonValue(bean, MyJacksonView1.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3214.java