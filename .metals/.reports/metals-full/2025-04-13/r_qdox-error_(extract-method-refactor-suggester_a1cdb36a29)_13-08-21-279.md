error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9329.java
text:
```scala
i@@f (fieldType.indexOptions().compareTo(IndexOptions.DOCS_AND_FREQS_AND_POSITIONS) >= 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9329.java