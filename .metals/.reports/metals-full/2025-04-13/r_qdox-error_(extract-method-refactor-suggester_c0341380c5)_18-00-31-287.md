error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14163.java
...
```java
offset: 700
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14163.java
text:
```scala
...
p@@ackage org.springframework.web.socket.sockjs.transport.session;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14163.java