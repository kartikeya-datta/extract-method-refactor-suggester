error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/375.java
text:
```scala
l@@ogger.info("Applying migration {} {}", newVersion.toString(), toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/375.java