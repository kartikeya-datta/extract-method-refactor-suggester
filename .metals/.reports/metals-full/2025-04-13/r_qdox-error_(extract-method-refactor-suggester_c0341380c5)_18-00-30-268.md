error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6909.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6909.java
text:
```scala
public H@@tmlHeaderContainer(MarkupContainer parent,final String id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6909.java