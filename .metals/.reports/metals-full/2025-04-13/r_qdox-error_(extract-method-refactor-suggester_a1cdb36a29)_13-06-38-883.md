error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2484.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2484.java
text:
```scala
static final b@@oolean RTL_SUPPORT_ENABLE = "win32".equals(SWT.getPlatform()) || "gtk".equals(SWT.getPlatform());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2484.java