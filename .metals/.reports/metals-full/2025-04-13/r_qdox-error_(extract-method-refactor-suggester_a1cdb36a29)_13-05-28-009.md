error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7887.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh().force(TransportGetAction.REFRESH_FORCE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7887.java