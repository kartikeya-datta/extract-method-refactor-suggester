error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3595.java
text:
```scala
i@@f (type instanceof IntBuffer) ((IntBuffer)type).put(typeTmp.get(0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3595.java