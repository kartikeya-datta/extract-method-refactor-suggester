error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9325.java
text:
```scala
_@@commandLine.addArgument( argument );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9325.java