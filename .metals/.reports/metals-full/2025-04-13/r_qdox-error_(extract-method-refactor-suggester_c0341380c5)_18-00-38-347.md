error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8605.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8605.java
text:
```scala
static final b@@yte VERSION = 0x0013; // added timestamps to external jars
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8605.java