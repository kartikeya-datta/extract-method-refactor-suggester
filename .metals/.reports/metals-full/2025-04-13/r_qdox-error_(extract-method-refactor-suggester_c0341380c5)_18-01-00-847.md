error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2964.java
text:
```scala
A@@ndroidGL, LWJGL, Angle, WebGL, iOSGL, JGLFW, Mock
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2964.java