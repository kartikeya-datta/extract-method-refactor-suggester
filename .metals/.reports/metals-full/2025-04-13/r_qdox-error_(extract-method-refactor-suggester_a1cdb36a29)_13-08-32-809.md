error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11750.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11750.java
text:
```scala
private static final A@@ttachmentKey<DataSources> ATTACHMENT_KEY = AttachmentKey.create(DataSources.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11750.java