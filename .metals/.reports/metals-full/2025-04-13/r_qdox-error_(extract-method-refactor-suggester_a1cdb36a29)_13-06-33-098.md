error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5032.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5032.java
text:
```scala
private final M@@ap<Class<?>, ApplicationExceptionDetails> applicationExceptions = new HashMap<Class<?>, ApplicationExceptionDetails>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5032.java