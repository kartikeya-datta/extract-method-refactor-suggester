error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8497.java
text:
```scala
i@@f (display.isPainting.containsObject(view)) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8497.java