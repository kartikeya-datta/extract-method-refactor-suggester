error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/666.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/666.java
text:
```scala
public b@@oolean equals(final Object obj)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/666.java