error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/54.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/54.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/54.java
text:
```scala
public static final S@@erviceName SERVICE_NAME = InfinispanRouteLocatorService.REGISTRY_SERVICE_NAME.append("entry");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/54.java