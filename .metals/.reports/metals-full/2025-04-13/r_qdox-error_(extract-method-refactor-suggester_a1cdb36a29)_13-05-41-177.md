error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7962.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7962.java
text:
```scala
protected P@@ackageFragment(PackageFragmentRoot root, String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7962.java