error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1650.java
text:
```scala
M@@essage tokenUpdateMessage = new Message( new EndPoint(FBUtilities.getHostAddress(), port_), "", StorageService.tokenVerbHandler_, bos.toByteArray() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1650.java