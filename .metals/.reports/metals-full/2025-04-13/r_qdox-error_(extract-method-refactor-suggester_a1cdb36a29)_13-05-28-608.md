error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3360.java
text:
```scala
i@@f (!JavaProject.hasJavaNature(prereqProject)) continue nextEntry; // if project doesn't have java nature or is not accessible
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3360.java