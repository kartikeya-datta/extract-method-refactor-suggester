error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8539.java
text:
```scala
t@@hrow new GdxRuntimeException("Using null for the data not possible, blame LWJGL");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8539.java