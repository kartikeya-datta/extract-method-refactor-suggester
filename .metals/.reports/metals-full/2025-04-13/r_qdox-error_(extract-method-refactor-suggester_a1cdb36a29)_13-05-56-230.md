error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11758.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11758.java
text:
```scala
public static final A@@ttachmentKey<ManagedBeanConfigurations> ATTACHMENT_KEY = AttachmentKey.create(ManagedBeanConfigurations.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11758.java