error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6701.java
text:
```scala
b@@uffer.append(this.getKey());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6701.java