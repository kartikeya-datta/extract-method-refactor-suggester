error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8127.java
text:
```scala
f@@older = new PartTabFolder(page, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8127.java