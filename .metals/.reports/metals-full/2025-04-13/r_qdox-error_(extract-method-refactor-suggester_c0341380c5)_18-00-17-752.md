error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6551.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6551.java
text:
```scala
final S@@tring deploymentRootName = deploymentRoot.getLowerCaseName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6551.java