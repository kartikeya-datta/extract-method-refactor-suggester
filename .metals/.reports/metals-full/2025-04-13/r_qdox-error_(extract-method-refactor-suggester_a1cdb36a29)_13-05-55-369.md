error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/562.java
text:
```scala
d@@ata = new Hashtable(3);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/562.java