error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5660.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5660.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5660.java
text:
```scala
F@@lickScrollPane scroll = new FlickScrollPane(table);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5660.java