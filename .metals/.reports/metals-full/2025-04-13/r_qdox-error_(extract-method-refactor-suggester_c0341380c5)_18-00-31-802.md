error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9334.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9334.java
text:
```scala
@Override protected v@@oid moveToSecondPhase() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9334.java