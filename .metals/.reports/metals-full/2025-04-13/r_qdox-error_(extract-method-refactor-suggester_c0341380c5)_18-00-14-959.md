error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9838.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9838.java
text:
```scala
public b@@oolean detectHierarchyCycle(TypeBinding superType, TypeReference reference) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9838.java