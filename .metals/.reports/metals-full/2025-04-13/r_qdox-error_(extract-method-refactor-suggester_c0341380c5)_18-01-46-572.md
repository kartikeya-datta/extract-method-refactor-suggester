error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2866.java
text:
```scala
r@@eaderContexts = reader.leaves();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2866.java