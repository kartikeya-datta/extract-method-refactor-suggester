error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11151.java
text:
```scala
r@@egistry.registerReadOnlyAttribute(attr, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11151.java