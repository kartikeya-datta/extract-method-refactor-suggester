error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11139.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11139.java
text:
```scala
public static final S@@tring COMPENSATABLE_ANNOTATION = "org.jboss.narayana.compensations.api.Compensatable";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11139.java