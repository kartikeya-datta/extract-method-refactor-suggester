error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2999.java
text:
```scala
b@@uffer.append(segmentsFile).append(":").append(segmentInfos.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2999.java