error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1967.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1967.java
text:
```scala
public b@@oolean accept(final File file) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1967.java