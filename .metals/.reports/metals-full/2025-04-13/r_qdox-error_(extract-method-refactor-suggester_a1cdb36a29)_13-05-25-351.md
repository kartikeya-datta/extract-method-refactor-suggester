error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1298.java
text:
```scala
D@@irectory directory = new MockRAMDirectory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1298.java