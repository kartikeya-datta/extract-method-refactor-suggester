error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10164.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10164.java
text:
```scala
final I@@nterceptorFactory interceptorFactory = new ImmediateInterceptorFactory(new NamespaceContextInterceptor(selector, context.getDeploymentUnit().getServiceName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10164.java