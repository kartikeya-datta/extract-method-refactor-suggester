error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18019.java
text:
```scala
r@@eturn new File(xmlFile).length();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18019.java