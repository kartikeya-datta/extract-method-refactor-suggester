error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/580.java
text:
```scala
H@@elpManager.getInstance().enableHelpOnButton(this, topicID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/580.java