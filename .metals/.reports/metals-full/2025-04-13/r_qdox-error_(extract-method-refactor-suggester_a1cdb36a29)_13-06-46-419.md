error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6826.java
text:
```scala
s@@uper(new Names(Defaults.NAME), Defaults.PRECISION_STEP, Defaults.BOOST, fieldType, null, Defaults.NULL_VALUE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6826.java