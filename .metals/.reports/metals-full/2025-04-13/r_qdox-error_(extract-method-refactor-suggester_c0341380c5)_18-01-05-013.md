error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8565.java
text:
```scala
T@@hreadPool threadPool = new ThreadPool(getClass().getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8565.java