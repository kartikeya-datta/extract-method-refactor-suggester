error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5393.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5393.java
text:
```scala
protected E@@ndpointDescription createExportEndpointDescription(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5393.java