error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4905.java
text:
```scala
p@@ublic class NoopOutputTransformerContainer extends AbstractOutputTransformerContainer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4905.java