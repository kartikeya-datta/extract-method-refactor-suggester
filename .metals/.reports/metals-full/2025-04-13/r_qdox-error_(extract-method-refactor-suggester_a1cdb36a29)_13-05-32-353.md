error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8195.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8195.java
text:
```scala
public final static S@@tring   DESCRIPTOR_NAME     = "META-INF/ant-descriptor.xml";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8195.java