error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5539.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5539.java
text:
```scala
private static final S@@tring VERSION = "2.3.20070902";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5539.java