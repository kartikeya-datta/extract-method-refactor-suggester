error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11752.java
text:
```scala
p@@ublic class CheckGroupDisabledTestPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11752.java