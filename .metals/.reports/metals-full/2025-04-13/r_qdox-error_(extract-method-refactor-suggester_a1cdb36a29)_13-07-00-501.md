error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17271.java
text:
```scala
i@@nt /*long*/ result = OS.objc_msgSend(this.id, OS.sel_printOperationWithPrintInfo_, printInfo != null ? printInfo.id : 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17271.java