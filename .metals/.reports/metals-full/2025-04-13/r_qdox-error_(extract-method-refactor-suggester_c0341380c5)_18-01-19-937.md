error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1916.java
text:
```scala
s@@endSelectionEvent (clickCount == 2 ? SWT.DefaultSelection : SWT.Selection);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1916.java