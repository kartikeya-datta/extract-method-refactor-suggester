error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17468.java
text:
```scala
p@@revModel = prevModel.getNestedModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17468.java