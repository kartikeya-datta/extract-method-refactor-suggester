error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6884.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6884.java
text:
```scala
public final B@@readCrumbPanel create(MarkupContainer parent, String componentId, IBreadCrumbModel breadCrumbModel)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6884.java