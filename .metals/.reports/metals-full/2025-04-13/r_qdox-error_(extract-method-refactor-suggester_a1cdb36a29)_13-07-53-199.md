error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14948.java
...
```java
offset: 78
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14948.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14948.java