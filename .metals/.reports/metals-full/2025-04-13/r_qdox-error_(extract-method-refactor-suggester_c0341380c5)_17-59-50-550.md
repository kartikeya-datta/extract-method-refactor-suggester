error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10446.java
text:
```scala
U@@RI nullURI= new URI(EFS.SCHEME_NULL, null, "/", null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10446.java