error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6954.java
text:
```scala
l@@ogger.debug("Using [heap] Store with buffer_size[{}], cache_size[{}], warm_cache[{}]",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6954.java