error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7680.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7680.java
text:
```scala
S@@tring[] result = Signature.getSimpleNames(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7680.java