error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6565.java
text:
```scala
a@@dd(new Label("defaultLocale", "" + application.getApplicationSettings().getDefaultLocale()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6565.java