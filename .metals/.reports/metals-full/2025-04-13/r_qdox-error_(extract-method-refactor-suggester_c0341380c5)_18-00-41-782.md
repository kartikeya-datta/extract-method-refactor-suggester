error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8007.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8007.java
text:
```scala
public static final S@@tring version = "0.10.1";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8007.java