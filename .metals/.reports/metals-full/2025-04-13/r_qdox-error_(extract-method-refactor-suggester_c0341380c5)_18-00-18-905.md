error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/901.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/901.java
text:
```scala
public O@@bject[] getUids() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/901.java