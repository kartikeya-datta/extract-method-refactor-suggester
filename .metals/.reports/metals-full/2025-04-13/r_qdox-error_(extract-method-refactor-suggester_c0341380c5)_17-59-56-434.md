error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3507.java
text:
```scala
p@@ublic class CheckGroupSelector<T> extends WebMarkupContainer<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3507.java