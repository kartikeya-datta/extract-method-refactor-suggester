error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1812.java
text:
```scala
r@@eturn prop;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1812.java