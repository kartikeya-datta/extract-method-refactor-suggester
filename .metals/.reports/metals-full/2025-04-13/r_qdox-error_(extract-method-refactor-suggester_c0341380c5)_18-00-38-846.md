error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12831.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12831.java
text:
```scala
public v@@oid NottestFindIsolateResources() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12831.java