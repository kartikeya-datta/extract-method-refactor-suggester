error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8753.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8753.java
text:
```scala
G@@dxTest test = new TextureBindTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8753.java