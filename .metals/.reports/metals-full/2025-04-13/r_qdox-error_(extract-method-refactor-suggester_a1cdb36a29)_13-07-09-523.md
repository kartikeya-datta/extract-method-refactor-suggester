error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16317.java
text:
```scala
L@@istChoice<String> listChoice = new ListChoice<String>(form, "site", ListChoicePageInput.SITES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16317.java