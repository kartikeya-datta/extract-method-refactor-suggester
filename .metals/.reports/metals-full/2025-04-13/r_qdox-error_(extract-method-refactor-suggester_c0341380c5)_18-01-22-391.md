error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1856.java
text:
```scala
p@@arent.sendMouseEvent (SWT.MouseUp, button [0], chord, (short)x, (short)y, modifiers, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1856.java