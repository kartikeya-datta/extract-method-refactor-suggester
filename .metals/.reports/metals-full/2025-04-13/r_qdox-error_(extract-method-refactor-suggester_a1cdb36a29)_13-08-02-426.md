error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2871.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2871.java
text:
```scala
public R@@esolutionContext(final boolean compUsesModule, final String componentName, final String moduleName, final String applicationName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2871.java