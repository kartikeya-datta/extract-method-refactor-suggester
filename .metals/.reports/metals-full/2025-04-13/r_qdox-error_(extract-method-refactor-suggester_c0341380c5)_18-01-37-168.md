error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1505.java
text:
```scala
i@@f (topology_conf.containsKey(Config.TOPOLOGY_GROUPS) && topology_conf.get(Config.TOPOLOGY_GROUPS) != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1505.java