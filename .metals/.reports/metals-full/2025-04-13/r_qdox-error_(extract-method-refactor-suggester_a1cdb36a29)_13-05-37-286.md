error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2480.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2480.java
text:
```scala
public static final A@@ttributeDefinition[] ATTRIBUTES_WITH_EXPRESSION_ALLOWED_IN_1_2_0 = { ADDRESS, CommonAttributes.FILTER, CommonAttributes.DURABLE };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2480.java