error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10724.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10724.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10724.java
text:
```scala
e@@xpected[i], actual, 1.3e-8 * expected[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10724.java