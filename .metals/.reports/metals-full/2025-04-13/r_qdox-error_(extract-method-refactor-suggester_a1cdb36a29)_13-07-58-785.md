error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3376.java
text:
```scala
i@@f (!s.isDir() && !s.getPath().getName().startsWith("_")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3376.java