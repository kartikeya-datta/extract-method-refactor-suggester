error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3026.java
text:
```scala
s@@b.append("-----node_id[").append(nodeId).append("]\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3026.java