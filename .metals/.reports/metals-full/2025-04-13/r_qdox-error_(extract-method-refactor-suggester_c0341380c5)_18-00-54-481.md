error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7021.java
text:
```scala
m@@essage = MessageBuilder.withPayloadAndHeaders(message.getPayload(), headers).build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7021.java