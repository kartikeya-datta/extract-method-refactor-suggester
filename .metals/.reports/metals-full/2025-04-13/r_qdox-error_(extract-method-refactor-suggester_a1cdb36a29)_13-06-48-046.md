error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1246.java
text:
```scala
l@@ogger.info("Listening for avro clients...");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1246.java