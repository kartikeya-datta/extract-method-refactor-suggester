error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15618.java
text:
```scala
s@@etPen(-1, -1, style, -1, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15618.java