error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2630.java
text:
```scala
P@@NG writer = new PNG((int)(pixmap.getWidth() * pixmap.getHeight() * 1.5f));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2630.java