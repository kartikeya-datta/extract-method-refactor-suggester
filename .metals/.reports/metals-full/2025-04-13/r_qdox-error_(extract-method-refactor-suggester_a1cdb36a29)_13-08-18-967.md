error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3883.java
text:
```scala
i@@f(! target.mkdir() && ! target.isDirectory()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3883.java