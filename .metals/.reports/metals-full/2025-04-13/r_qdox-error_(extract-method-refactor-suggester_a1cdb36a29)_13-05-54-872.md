error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14810.java
text:
```scala
l@@ink.createLink(zipURI, IResource.REPLACE, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14810.java