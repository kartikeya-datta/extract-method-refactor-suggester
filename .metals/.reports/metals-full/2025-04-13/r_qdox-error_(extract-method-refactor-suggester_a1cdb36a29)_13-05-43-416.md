error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8775.java
text:
```scala
t@@hrow new IndexAlreadyExistsException(new Index(request.index), "already exists as alias");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8775.java