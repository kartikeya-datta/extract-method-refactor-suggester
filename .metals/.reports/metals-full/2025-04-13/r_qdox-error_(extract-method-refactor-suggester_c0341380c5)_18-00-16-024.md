error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10478.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10478.java
text:
```scala
private static final d@@ouble TOO_SMALL = 10E-12;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10478.java