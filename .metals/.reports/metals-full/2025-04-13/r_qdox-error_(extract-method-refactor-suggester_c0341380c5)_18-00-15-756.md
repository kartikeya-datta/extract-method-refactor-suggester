error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8649.java
text:
```scala
i@@f (scope.compilerOptions().sourceLevel >= ClassFileConstants.JDK1_5) { // below 1.5, already reported as syntax error
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8649.java