error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5225.java
text:
```scala
a@@ssertThat(searchResponse.getHits().totalHits(), equalTo(1l));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5225.java