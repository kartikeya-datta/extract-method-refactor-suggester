error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1454.java
text:
```scala
t@@his.syncToDisk = componentSettings.getAsBoolean("sync_to_disk", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1454.java