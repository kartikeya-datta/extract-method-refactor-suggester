error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7290.java
text:
```scala
f@@alse); // no further cycle check
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7290.java