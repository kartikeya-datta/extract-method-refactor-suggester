error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/824.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/824.java
text:
```scala
public static final V@@ersion V_0_90_0_RC2 = new Version(V_0_90_0_RC2_ID, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/824.java