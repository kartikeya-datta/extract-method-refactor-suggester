error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9986.java
text:
```scala
a@@ssert request.versionType().validateVersionForWrites(request.version());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9986.java