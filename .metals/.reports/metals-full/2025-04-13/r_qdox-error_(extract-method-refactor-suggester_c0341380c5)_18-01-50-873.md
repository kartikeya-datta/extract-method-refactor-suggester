error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2715.java
text:
```scala
B@@oolean paramAsBooleanOptional(String key, Boolean defaultValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2715.java