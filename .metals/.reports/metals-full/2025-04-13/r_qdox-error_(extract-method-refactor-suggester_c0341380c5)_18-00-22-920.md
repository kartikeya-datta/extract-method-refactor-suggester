error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1612.java
text:
```scala
r@@eturn world.resolve(UnresolvedType.forSignature(className.replace('.','/')));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1612.java