error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2756.java
text:
```scala
p@@ublic class ColumnFamilyStore implements ColumnFamilyStoreMBean
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2756.java