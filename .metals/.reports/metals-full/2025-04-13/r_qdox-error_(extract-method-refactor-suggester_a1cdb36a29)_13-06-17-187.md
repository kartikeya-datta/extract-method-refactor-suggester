error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18107.java
text:
```scala
t@@ester.startPage(A.class, new PageParameters().set("file", "umlaut-\u00E4-\u00F6-\u00FC"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18107.java