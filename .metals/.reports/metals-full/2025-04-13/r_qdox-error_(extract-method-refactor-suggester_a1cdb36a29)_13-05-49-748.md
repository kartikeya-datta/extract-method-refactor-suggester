error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3721.java
text:
```scala
t@@hrow new MissingClassFileException(missingClassFile);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3721.java