error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1621.java
text:
```scala
H@@elpManager.getInstance().getHelpBroker());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1621.java