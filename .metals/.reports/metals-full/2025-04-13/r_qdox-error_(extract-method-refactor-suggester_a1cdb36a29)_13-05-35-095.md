error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5161.java
text:
```scala
i@@f (!fieldType.stored()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5161.java