error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17110.java
text:
```scala
a@@pplication.getRequiredPageSettings().setHomePage(PagedTableNavigatorWithLabelProviderPage.class);
...
public class PagedTableNavigatorWithLabelProviderTest extends TestCase
{
	...
	public void testPagedTable() throws Exception
	{
		...
		application.getPages().setHomePage(PagedTableNavigatorWithLabelProviderPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17110.java