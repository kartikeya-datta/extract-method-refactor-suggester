error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3925.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3925.java
text:
```scala
protected W@@ebRequest newWebRequest(final HttpServletRequest servletRequest)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3925.java