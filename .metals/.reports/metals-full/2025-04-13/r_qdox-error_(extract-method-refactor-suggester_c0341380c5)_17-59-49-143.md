error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1985.java
text:
```scala
c@@ontext.reader().document(doc, fieldVisitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1985.java