error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1129.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1129.java
text:
```scala
public S@@tringBuilder getText () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1129.java