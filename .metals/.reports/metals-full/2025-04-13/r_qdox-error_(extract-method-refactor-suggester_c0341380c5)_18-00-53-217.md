error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10056.java
text:
```scala
C@@lass delegateClass = Class.forName("org.aspectj.weaver.reflect.Java15ReflectionBasedReferenceTypeDelegate");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10056.java