error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9896.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9896.java
text:
```scala
i@@f (window != 0) OS.gdk_window_set_back_pixmap (window, pixmap, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9896.java