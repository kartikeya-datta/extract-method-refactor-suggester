error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15312.java
text:
```scala
d@@omainModel = Resource.Tools.readModel(context.readResourceFromRoot(PathAddress.EMPTY_ADDRESS, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15312.java