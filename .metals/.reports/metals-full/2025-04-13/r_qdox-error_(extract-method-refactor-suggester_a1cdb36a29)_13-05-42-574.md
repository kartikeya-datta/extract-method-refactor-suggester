error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16858.java
text:
```scala
p@@ublic interface IRequestHandler
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16858.java