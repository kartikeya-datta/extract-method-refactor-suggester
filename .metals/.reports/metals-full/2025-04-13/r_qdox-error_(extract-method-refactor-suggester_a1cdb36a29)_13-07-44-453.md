error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16650.java
text:
```scala
N@@SAttributedString attribStr = parent.createString(text, null, parent.foreground, SWT.CENTER, false, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16650.java