error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7992.java
text:
```scala
A@@rray<AssetDescriptor> deps = new Array();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7992.java