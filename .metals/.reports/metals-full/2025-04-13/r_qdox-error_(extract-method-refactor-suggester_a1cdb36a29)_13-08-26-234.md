error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1391.java
text:
```scala
s@@coreMode = FiltersFunctionScoreQuery.ScoreMode.Sum;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1391.java