error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4682.java
text:
```scala
t@@his.graphics = new IOSGraphics(getBounds(null), this, config, input, gl20);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4682.java