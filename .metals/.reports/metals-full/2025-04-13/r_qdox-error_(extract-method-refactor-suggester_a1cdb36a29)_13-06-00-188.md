error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8631.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8631.java
text:
```scala
s@@uper(name, xmlName, allowNull, false, minSize, maxSize, valueType.getValidator(), alternatives, requires, attributeMarshaller, resourceOnly, deprecated, flags);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8631.java