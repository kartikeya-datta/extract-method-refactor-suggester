error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7367.java
text:
```scala
i@@f (!isFocusControl ()) forceFocus ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7367.java