error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8290.java
text:
```scala
S@@treamOutput stream = cachedEntry.handles();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8290.java