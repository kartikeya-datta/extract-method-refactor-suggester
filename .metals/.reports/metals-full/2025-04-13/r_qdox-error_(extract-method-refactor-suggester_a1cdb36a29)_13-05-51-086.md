error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2598.java
text:
```scala
f@@or (int i = 0; i < app.executedRunnables.size; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2598.java