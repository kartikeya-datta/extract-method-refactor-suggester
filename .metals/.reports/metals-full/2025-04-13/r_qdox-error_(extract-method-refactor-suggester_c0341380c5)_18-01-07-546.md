error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10395.java
text:
```scala
t@@hrow new IllegalArgumentException("count must not be negative or greater than " + MAXIMUM_CACHE_SIZE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10395.java