error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/481.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/481.java
text:
```scala
t@@hrows IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/481.java