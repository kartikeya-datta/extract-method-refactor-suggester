error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15038.java
text:
```scala
L@@ist<String> modelData = (List)page.get("table").getModelObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15038.java