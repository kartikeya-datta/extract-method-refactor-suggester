error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3311.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3311.java
text:
```scala
public A@@bortWithHttpErrorCodeException(final int errorCode, final String message)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3311.java