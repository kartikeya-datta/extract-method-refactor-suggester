error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/578.java
text:
```scala
r@@eturn Boolean.valueOf(entry.checked);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/578.java