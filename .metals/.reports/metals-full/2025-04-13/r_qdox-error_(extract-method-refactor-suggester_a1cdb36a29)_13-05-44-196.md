error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8981.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8981.java
text:
```scala
private O@@bject readResolve(){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8981.java