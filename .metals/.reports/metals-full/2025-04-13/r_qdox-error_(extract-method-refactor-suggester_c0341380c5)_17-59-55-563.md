error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14059.java
text:
```scala
c@@omponentConfiguration = componentDescription.createConfiguration(classIndex.classIndex(componentDescription.getComponentClassName()), module.getClassLoader(), module.getModuleLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14059.java