error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3931.java
text:
```scala
R@@eferenceBinding outerDeclaringClass = (ReferenceBinding)declaringClass.erasure();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3931.java