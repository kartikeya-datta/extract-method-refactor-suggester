error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15719.java
text:
```scala
W@@ebResponse webResponse = application.newWebResponse(webRequest,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15719.java