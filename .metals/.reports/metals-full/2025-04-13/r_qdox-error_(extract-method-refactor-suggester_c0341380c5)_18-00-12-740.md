error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3788.java
text:
```scala
r@@eturn key;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3788.java