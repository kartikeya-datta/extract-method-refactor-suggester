error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3411.java
text:
```scala
r@@eturn new HttpOpenListener(getBufferPool().getValue(), OptionMap.builder().addAll(commonOptions).addAll(listenerOptions).set(UndertowOptions.ENABLE_CONNECTOR_STATISTICS, getUndertowService().isStatisticsEnabled()).getMap(), getBufferSize());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3411.java