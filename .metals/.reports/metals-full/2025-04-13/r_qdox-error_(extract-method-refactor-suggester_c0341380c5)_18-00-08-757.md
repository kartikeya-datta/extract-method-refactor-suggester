error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3345.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3345.java
text:
```scala
S@@egmentInfo(Directory dir, int format, IndexInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3345.java