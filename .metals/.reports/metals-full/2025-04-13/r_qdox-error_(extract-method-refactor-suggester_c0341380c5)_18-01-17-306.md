error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7063.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7063.java
text:
```scala
static final S@@tring SUBSYSTEM_NAME = "infinispan";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7063.java