error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5858.java
text:
```scala
C@@alendar calendar = new GregorianCalendar(TimeZone.getTimeZone("UTC"), Locale.ROOT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5858.java