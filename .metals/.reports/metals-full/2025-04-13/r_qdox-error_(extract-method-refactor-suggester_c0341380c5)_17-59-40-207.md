error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13613.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13613.java
text:
```scala
public final M@@arkupContainer add(final Component... childs)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13613.java