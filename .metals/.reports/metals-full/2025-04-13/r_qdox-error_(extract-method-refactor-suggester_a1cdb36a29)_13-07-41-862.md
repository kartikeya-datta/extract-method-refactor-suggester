error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10415.java
text:
```scala
c@@onnection.setFollowRedirects(httpRequest.getFollowRedirects());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10415.java