error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1582.java
text:
```scala
F@@ileUtils.delete(f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1582.java