error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3400.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3400.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3400.java
text:
```scala
i@@f ((style & (SWT.PUSH | SWT.TOGGLE)) == 0) state |= THEME_BACKGROUND;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3400.java