error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/79.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/79.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/79.java
text:
```scala
public static final i@@nt BUFFER_SIZE = 32768;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/79.java