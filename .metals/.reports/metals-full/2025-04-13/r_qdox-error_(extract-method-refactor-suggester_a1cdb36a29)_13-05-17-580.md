error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/473.java
text:
```scala
l@@istener.onResponse(new SearchResponse(InternalSearchResponse.empty(), null, 0, 0, System.currentTimeMillis() - startTime, ShardSearchFailure.EMPTY_ARRAY));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/473.java