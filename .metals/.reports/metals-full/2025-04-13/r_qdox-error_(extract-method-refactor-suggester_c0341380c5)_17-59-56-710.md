error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12331.java
...
```java
offset: 30
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12331.java
text:
```scala
protected final synchronized v@@oid checkEntry() throws BuildException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12331.java