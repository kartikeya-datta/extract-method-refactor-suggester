error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2288.java
text:
```scala
p@@ublic class executeUpdate
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2288.java