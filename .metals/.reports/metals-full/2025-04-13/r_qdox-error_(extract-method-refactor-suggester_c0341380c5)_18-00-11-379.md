error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6440.java
text:
```scala
l@@ocalType.enclosingType().constantPoolName(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6440.java