error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1203.java
text:
```scala
r@@eturn "FlowInfo<true: " + initsWhenTrue.toString() + ", false: " + initsWhenFalse.toString() + ">"; //$NON-NLS-1$ //$NON-NLS-3$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1203.java