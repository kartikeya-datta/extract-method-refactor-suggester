error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7182.java
text:
```scala
C@@lusterRegistryImpl_Cluster cstub = new ClusterRegistryImpl_Cluster(r);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7182.java