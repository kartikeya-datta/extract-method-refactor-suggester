error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7632.java
text:
```scala
a@@dd(new Label("multiplyLabel", new PropertyModel(getModel(), "multiply")).setComponentBorder(BeforeAndAfterBorder.INSTANCE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7632.java