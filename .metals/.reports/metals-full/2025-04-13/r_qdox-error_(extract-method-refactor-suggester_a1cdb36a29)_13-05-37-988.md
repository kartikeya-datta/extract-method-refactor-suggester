error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1182.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1182.java
text:
```scala
public static v@@oid resolveAnnotations(BlockScope scope, Annotation[] annotations, Binding recipient) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1182.java