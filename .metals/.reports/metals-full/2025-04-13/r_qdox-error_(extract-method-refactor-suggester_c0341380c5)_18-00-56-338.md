error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8957.java
text:
```scala
f@@rameMediator.fireClosed();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8957.java