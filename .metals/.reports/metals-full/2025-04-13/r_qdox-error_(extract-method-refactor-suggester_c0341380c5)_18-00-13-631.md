error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10230.java
text:
```scala
A@@dvancedCache<String, Map<Object, Object>> sessionCache = container.<String, Map<Object, Object>>getCache(name).getAdvancedCache();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10230.java