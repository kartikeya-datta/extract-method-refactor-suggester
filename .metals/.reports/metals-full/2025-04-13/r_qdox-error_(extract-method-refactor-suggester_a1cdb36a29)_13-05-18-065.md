error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11672.java
text:
```scala
s@@tatefulEJBLocator = new StatefulEJBLocator(componentView.getViewClass(), applicationName, moduleName, beanName, distinctName, sessionID, statefulSessionComponent.getCache().getStrictAffinity(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11672.java