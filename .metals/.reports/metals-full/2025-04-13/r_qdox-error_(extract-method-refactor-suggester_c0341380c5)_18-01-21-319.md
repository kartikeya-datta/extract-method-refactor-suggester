error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3529.java
text:
```scala
S@@impleSet newIntersectedNames = new SimpleSet(3);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3529.java