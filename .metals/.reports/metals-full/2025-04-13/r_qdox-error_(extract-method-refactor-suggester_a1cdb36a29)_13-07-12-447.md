error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6374.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6374.java
text:
```scala
final S@@tring url = urlFor(IOnChangeListener.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6374.java