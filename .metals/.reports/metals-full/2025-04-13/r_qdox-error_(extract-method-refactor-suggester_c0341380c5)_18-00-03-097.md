error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/729.java
text:
```scala
p@@artIndices[k] = (short)value.asInt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/729.java