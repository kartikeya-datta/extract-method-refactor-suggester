error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16649.java
text:
```scala
N@@SAttributedString str = parent.createString(string, font, null, 0, false, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16649.java