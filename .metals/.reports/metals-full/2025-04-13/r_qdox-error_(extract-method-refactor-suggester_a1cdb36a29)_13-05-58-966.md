error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3482.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3482.java
text:
```scala
public R@@eferenceContext referenceContext;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3482.java