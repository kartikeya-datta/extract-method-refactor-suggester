error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16927.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16927.java
text:
```scala
private transient O@@bject _userObject;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16927.java