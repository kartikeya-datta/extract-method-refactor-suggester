error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1917.java
text:
```scala
r@@eturn getStore().getHeaders(uid, keys, getImapPath() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1917.java