error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5774.java
text:
```scala
n@@ull, indexShard.acquireSearcher("validate_query"), indexService, indexShard,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5774.java