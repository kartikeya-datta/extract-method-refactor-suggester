error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5177.java
text:
```scala
r@@eturn Double.valueOf(o.toString()).doubleValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5177.java