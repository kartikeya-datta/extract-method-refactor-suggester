error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2983.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2983.java
text:
```scala
public v@@oid addAll (boolean... array) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2983.java