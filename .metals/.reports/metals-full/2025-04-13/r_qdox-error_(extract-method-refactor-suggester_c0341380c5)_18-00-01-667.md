error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7230.java
text:
```scala
l@@istener = new ThreadedActionListener<>(threadPool, listener, logger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7230.java