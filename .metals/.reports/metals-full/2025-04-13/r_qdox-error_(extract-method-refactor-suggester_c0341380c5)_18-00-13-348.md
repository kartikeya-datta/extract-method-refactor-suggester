error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17087.java
text:
```scala
I@@ResourceStream resourceStream = Application.get().getResourceSettings().getResourceStreamLocator().locate(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17087.java