error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6367.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6367.java
text:
```scala
: B@@ufferManager.createBuffer(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6367.java