error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1116.java
text:
```scala
l@@osAngeles.add(new StringField("name", "Los Angeles", Field.Store.YES));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1116.java