error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/395.java
text:
```scala
i@@f (exactType.isParameterizedType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/395.java