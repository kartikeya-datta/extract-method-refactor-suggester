error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8829.java
text:
```scala
S@@electBox camera = new SelectBox(new String[] {"Camera", "Light"}, skin.getStyle(SelectBoxStyle.class), "camera");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8829.java