error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8520.java
text:
```scala
s@@witch (this.pattern.typeSuffix) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8520.java