error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13653.java
text:
```scala
t@@his.chars = chars.clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13653.java