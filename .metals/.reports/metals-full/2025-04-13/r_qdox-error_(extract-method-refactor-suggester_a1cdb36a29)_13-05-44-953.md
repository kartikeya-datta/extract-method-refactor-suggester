error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13834.java
text:
```scala
r@@eturn num == -1 ? -1 : oneBuf[0] & BYTE_MASK;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13834.java