error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3100.java
text:
```scala
b@@2World* world = new b2World( b2Vec2( gravityX, gravityY ), doSleep );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3100.java