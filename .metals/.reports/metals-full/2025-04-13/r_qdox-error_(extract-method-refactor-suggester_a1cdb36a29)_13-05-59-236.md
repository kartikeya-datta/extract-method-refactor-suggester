error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9371.java
text:
```scala
i@@f (labelHandle != 0) OS.g_signal_connect_closure_by_id (labelHandle, display.signalIds [MNEMONIC_ACTIVATE], 0, display.closures [MNEMONIC_ACTIVATE], false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9371.java