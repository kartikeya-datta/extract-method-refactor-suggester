error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2057.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2057.java
text:
```scala
o@@ptions.assertMode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2057.java