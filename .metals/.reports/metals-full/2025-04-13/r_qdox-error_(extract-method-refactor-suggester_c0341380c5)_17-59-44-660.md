error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3069.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3069.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3069.java
text:
```scala
p@@ublic class PageInstanceMapper extends AbstractComponentMapper
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3069.java