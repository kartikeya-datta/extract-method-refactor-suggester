error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2394.java
text:
```scala
l@@ong available = entrySize - entryOffset;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2394.java