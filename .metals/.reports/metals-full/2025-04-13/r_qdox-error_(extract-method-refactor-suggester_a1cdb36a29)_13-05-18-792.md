error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2332.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2332.java
text:
```scala
static final b@@oolean IMAGE_AND_TEXT = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2332.java