error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6407.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6407.java
text:
```scala
final D@@ivertConfiguration divertConfiguration = DivertAdd.createDivertConfiguration(context, name, model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6407.java