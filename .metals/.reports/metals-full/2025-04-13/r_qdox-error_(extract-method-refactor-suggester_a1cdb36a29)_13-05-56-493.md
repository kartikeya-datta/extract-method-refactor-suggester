error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1160.java
text:
```scala
d@@efaultOptionsMap.put(JavaCore.CODEASSIST_DISCOURAGED_REFERENCE_CHECK, JavaCore.DISABLED); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1160.java