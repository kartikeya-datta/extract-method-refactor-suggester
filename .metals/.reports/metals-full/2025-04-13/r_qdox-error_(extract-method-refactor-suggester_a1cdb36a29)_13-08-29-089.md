error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15033.java
text:
```scala
n@@ew SimpleBorder(this, "myBorder");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15033.java