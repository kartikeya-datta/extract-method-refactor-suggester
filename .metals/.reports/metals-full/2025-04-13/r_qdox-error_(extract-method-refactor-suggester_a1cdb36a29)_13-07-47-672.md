error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12777.java
text:
```scala
R@@OOT_LOGGER.debugf("Reloading properties file '%s'", propertiesFile.getAbsolutePath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12777.java