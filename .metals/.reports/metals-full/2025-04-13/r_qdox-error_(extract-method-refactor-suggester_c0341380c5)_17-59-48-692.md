error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1382.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1382.java
text:
```scala
public C@@lientHttpResponse executeInternal() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1382.java