error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7766.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7766.java
text:
```scala
public static final V@@ersion V_0_18_0 = new Version(V_0_18_0_ID, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7766.java