error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15132.java
text:
```scala
A@@bstractSelect select = findParent(AbstractSelect.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15132.java