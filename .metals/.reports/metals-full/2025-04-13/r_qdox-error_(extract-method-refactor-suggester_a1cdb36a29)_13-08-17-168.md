error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9952.java
text:
```scala
s@@b.append("    translog : number_of_operations [").append(recoveryStatus.translog().currentTranslogOperations()).append("], took [").append(recoveryStatus.translog().took()).append("]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9952.java