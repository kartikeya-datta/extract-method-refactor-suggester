error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7133.java
text:
```scala
i@@f (dispatch && down) application.sendEvent(event);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7133.java