error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5234.java
text:
```scala
S@@tring scaledPackFileName = rootSettings.scaledPackFileName(packFileName, i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5234.java