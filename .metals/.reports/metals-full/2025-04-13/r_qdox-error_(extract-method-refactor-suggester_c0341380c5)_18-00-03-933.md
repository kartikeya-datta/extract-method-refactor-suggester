error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9274.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9274.java
text:
```scala
private C@@lass<?> makeArrayIfNecessary(Class<?> clazz) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9274.java