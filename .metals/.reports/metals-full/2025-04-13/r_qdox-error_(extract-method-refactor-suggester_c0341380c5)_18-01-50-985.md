error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15349.java
...
```java
offset: 841
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15349.java
text:
```scala
 ...
 * under the License.    
 */
p@@ackage org.apache.openjpa.kernel;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15349.java