error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3022.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3022.java
text:
```scala
private b@@oolean moreExclude = excludeSpans.next();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3022.java