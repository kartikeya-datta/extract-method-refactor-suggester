error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12417.java
text:
```scala
m@@odcluster.stopContext(contexthost.webhost, contexthost.webcontext, contexthost.waittime);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12417.java