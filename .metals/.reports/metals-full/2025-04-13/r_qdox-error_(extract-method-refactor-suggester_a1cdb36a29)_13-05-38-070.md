error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3650.java
text:
```scala
r@@eturn otherCommit.getDirectory().equals(getDirectory()) && otherCommit.getVersion() == getVersion();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3650.java