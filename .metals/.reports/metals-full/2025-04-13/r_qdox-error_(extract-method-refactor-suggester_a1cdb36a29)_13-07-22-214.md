error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3737.java
text:
```scala
i@@f (!Session.get().getAuthorizationStrategy().isInstantiationAuthorized(component.getClass()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3737.java