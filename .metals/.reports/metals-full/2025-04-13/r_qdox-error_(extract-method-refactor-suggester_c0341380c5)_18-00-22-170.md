error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5092.java
text:
```scala
r@@eturn issueService.getIssues();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5092.java