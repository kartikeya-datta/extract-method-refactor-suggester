error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15841.java
text:
```scala
O@@S.DrawText (hDC, buffer, -1, rect, flags);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15841.java