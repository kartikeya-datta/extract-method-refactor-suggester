error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4854.java
text:
```scala
r@@eturn ProgressManagerUtil.exceptionStatus(exception);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4854.java