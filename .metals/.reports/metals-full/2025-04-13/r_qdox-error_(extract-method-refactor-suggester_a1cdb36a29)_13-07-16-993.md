error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6426.java
text:
```scala
i@@nt availableWidth = Math.max(0, rect.width - 2*hIndent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6426.java