error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5190.java
text:
```scala
i@@f (this.expressionType.isBaseType() && this.expressionType != NullBinding) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5190.java