error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7381.java
text:
```scala
b@@oolean optional = parseOptionalExportParams(dependencyParts, "optional");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7381.java