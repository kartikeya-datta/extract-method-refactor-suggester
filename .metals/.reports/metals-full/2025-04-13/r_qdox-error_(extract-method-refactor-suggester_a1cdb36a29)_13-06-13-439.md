error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3195.java
text:
```scala
r@@eturn RequestCycle.get().getApplication().getSecuritySettings().getCookieValuePersisterSettings();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3195.java