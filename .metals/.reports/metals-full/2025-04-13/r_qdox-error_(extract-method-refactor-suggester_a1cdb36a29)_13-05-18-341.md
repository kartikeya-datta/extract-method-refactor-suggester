error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3180.java
text:
```scala
n@@ew ViewMessageCommand(getFrameController(),getFrameController().getSelectionManager().getSelection("mail.table")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3180.java