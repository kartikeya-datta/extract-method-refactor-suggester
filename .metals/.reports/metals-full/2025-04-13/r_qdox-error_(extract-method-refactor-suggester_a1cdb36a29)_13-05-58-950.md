error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4464.java
text:
```scala
S@@tringBuilder sb = new StringBuilder("BindStatus: ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4464.java