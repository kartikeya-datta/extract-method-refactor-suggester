error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11118.java
text:
```scala
C@@harSequence path = requestCodingStrategy.pathForTarget(homepageTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11118.java