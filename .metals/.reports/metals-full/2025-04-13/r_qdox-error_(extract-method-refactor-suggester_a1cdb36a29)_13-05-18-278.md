error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14343.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14343.java
text:
```scala
static final b@@oolean RTL_SUPPORT_ENABLE = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14343.java