error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9173.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9173.java
text:
```scala
static S@@tring getHandlerType(OperationContext context, ModelNode elementNode) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9173.java