error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7715.java
...
```java
offset: 621
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7715.java
text:
```scala
 ...
 *****************************************************************************/
p@@ackage org.eclipse.ecf.tests.osgi.services.distribution.generic;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7715.java