error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12588.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12588.java
text:
```scala
public static D@@omainClient create(final InetAddress address, int port) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12588.java