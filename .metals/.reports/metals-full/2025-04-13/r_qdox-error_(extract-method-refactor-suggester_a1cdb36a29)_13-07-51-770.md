error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15246.java
text:
```scala
S@@cope scope = (beanDefinition != null ? getRegisteredScope(beanDefinition.getScope()) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15246.java