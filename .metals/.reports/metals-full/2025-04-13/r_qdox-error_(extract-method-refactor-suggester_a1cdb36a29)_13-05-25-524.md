error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6387.java
text:
```scala
c@@ache.tint(color);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6387.java