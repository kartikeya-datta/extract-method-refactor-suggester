error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9063.java
text:
```scala
C@@lass renderedClass = Class.forName(renderedClassName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9063.java