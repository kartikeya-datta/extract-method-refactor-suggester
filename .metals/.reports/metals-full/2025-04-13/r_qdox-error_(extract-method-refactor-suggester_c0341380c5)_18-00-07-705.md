error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5035.java
text:
```scala
i@@f (newColumns [i] != null && !newColumns [i].isDisposed ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5035.java