error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14252.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14252.java
text:
```scala
_@@emitter.emitBatch(attempt, input.getValue(1), _collector);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14252.java