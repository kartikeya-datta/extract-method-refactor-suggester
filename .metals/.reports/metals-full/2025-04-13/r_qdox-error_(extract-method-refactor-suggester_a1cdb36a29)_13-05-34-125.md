error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1244.java
text:
```scala
R@@aOperationUtil.activate(context, name, svh);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1244.java