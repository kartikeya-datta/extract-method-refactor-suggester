error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1808.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1808.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/settings/update";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1808.java