error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8885.java
text:
```scala
m@@arkEnclosingMemberWithLocalType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8885.java