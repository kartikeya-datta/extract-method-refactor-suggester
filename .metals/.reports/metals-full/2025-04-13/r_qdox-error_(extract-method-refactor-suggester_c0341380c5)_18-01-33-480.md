error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3005.java
text:
```scala
C@@onstants.JNDI_NAME.getName().equals(attributeName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3005.java