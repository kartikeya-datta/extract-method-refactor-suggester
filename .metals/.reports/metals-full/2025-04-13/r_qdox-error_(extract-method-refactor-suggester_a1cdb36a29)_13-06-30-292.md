error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13526.java
text:
```scala
r@@eturn stateValues.groupPropertiesFound() ? new PromptGroupsState(theConsole, stateValues)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13526.java