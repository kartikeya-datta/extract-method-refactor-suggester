error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/947.java
text:
```scala
q@@ueries.put(BytesRef.deepCopyOf(id), parseQuery);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/947.java