error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1294.java
text:
```scala
c@@ommunicationHandler.sendMessage(cmd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1294.java