error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4983.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4983.java
text:
```scala
P@@latform.getDebugOption(PLUGIN_ID + "/debug/documentPartitioner")).booleanValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4983.java