error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4044.java
text:
```scala
r@@eturn PlatformMBeanDescriptions.getGetThreadInfoDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4044.java