error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6523.java
text:
```scala
r@@et = Types.getAssignableForm( ret, returnType );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6523.java