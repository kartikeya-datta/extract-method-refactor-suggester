error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3998.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3998.java
text:
```scala
private S@@et<TestSection> testSections = Sets.newTreeSet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3998.java