error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5175.java
text:
```scala
n@@ew Object[] { Double.valueOf(abscissa), Integer.valueOf(i1), Integer.valueOf(i2) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5175.java