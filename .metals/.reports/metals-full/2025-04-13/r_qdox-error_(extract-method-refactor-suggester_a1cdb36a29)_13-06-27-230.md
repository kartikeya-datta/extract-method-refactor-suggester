error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5903.java
text:
```scala
d@@efault : //octal (well-formed: ended by a ' )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5903.java