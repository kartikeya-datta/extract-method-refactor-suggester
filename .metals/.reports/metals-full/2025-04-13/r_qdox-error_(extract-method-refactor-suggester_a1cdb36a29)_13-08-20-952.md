error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1718.java
text:
```scala
r@@eturn String.format("#<User %s groups=%s>", username, groups);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1718.java