error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5318.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5318.java
text:
```scala
i@@f (scrollbarsOnTop && scrollX) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5318.java