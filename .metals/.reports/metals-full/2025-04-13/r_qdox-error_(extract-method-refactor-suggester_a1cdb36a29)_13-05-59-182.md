error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4074.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4074.java
text:
```scala
abstract I@@Path getProjectRelativePath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4074.java