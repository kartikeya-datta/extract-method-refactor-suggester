error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7815.java
text:
```scala
A@@syncAction.this.addShardFailure(new ShardSearchFailure(t));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7815.java