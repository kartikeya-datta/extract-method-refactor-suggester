error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3215.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3215.java
text:
```scala
public M@@arkupContainer add(final Component child)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3215.java