error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7329.java
text:
```scala
a@@spect A pertarget(target(Object) && !target(A)) {  // was a warning in 1.0
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7329.java