error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3230.java
text:
```scala
r@@eturn new WeldClassFileInfo(key, index, annotationClassAnnotationsCache, moduleClassLoader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3230.java