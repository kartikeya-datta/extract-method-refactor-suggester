error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9147.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9147.java
text:
```scala
final S@@tring[] concreteIndices = clusterService.state().metaData().concreteIndices(indices, IndicesOptions.lenientExpandOpen());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9147.java