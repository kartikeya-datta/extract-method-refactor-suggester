error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5019.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5019.java
text:
```scala
public static final P@@ingResponse[] EMPTY = new PingResponse[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5019.java