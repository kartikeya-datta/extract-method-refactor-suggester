error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10784.java
text:
```scala
p@@ublishedServices.put(getServiceID().getName(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10784.java