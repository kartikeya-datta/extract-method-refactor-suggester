error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5021.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5021.java
text:
```scala
protected C@@omponent newFeedbackPanel(final String id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5021.java