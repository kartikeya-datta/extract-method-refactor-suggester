error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12661.java
...
```java
offset: 1078
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12661.java
text:
```scala
 ...
 * MA  02110-1301, USA.
 */
p@@ackage org.jboss.as.controller.persistence;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12661.java