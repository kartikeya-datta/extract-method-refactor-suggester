error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3602.java
text:
```scala
M@@odelTest.class, Basic3DTest.class, ShaderTest.class, SkeletonTest.class, HexagonalTiledMapTest.class, FogTest.class, TimerTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3602.java