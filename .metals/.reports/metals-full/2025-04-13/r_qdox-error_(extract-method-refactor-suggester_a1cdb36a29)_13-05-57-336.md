error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1828.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1828.java
text:
```scala
public synchronized v@@oid checkAborted(Directory dir) throws MergeAbortedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1828.java