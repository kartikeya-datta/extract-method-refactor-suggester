error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8784.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8784.java
text:
```scala
final C@@onnectorXmlDescriptor connectorXmlDescriptor = phaseContext.getDeploymentUnitContext().getAttachment(ConnectorXmlDescriptor.ATTACHMENT_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8784.java