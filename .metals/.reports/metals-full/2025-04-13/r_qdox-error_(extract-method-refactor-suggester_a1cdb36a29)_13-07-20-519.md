error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/517.java
text:
```scala
r@@eturn new DeletionAwareConstantScoreQuery(filter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/517.java