error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12365.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12365.java
text:
```scala
protected final C@@harSequence getURL()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12365.java