error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12784.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12784.java
text:
```scala
private final S@@tring id = (new UID()).toString().replace(':', '_').replace('-','_');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12784.java