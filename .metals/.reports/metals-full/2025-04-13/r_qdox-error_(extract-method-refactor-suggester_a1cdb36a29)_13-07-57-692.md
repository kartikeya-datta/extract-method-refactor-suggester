error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/867.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/867.java
text:
```scala
private S@@tring modulePath = System.getProperty("module.path");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/867.java