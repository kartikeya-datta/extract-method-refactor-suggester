error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5185.java
text:
```scala
r@@eturn new Rectangle (x, parent.getItemY (this), width, parent.itemHeight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5185.java