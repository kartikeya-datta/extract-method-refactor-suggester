error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1485.java
text:
```scala
r@@eturn superClass == null ? null : ReflectionCache.forName(superClass.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1485.java