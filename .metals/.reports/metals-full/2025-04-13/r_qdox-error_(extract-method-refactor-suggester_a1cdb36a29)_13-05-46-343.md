error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6037.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6037.java
text:
```scala
t@@his.collection.checkNPE(currentScope, flowContext, flowInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6037.java