error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6193.java
text:
```scala
l@@ocation = requestCycle.getUrlRenderer().renderContextRelativeUrl(redirectUrl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6193.java