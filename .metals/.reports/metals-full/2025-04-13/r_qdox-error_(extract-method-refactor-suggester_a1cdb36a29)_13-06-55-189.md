error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/519.java
text:
```scala
t@@hrow EjbLogger.ROOT_LOGGER.timerIsActive(timer.getId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/519.java