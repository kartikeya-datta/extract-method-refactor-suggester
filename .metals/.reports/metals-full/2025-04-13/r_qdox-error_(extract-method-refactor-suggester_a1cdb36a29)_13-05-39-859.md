error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/617.java
text:
```scala
S@@ettings settings = ImmutableSettings.builder().put(requiredSettings()).put("client.transport.nodes_sampler_interval", "1s")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/617.java