error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11766.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11766.java
text:
```scala
public static final A@@ttachmentKey<TldsMetaData> ATTACHMENT_KEY = AttachmentKey.create(TldsMetaData.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11766.java