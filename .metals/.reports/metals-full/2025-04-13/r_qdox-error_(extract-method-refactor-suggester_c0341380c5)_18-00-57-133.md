error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/32.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/32.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/32.java
text:
```scala
C@@ompactionManager.instance.submitMinorIfNeeded(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/32.java