error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10247.java
text:
```scala
C@@OMPRESS_LARGE_MESSAGES, CONFIRMATION_WINDOW_SIZE, CONNECTION_TTL, CONSUMER_MAX_RATE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10247.java