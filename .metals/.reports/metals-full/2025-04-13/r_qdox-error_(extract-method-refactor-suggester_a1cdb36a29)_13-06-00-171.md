error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6332.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6332.java
text:
```scala
public b@@oolean isInstantiationAuthorized(final Class<? extends Component> componentClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6332.java