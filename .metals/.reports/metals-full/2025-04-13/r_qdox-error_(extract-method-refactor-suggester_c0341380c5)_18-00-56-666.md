error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/941.java
text:
```scala
S@@ystem.out.println(";; TSIG verify: " + ok);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/941.java