error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10811.java
text:
```scala
v@@oid addDeploymentProcessor(Phase phase, int priority, DeploymentUnitProcessor processor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10811.java