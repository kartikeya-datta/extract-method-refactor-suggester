error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2411.java
text:
```scala
B@@yteBuffer.wrap(org.apache.cassandra.avro.KsDef.SCHEMA$.toString().getBytes(UTF_8)),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2411.java