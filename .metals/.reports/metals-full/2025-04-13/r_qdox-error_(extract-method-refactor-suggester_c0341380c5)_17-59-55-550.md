error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7631.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7631.java
text:
```scala
private static final i@@nt SCROLL_HYSTERESIS = 500; // milli seconds
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7631.java