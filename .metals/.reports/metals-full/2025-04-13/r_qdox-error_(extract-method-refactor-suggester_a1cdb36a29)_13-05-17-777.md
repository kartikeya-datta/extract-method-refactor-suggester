error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14550.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14550.java
text:
```scala
public v@@oid tearDown(ManagementClient managementClient, String containerId) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14550.java