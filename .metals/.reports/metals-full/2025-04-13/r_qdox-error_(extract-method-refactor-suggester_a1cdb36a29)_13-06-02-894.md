error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10554.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,151]

error in qdox parser
file content:
```java
offset: 151
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10554.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10554.java