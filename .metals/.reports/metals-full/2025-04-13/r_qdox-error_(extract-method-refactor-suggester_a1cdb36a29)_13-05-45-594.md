error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2589.java
text:
```scala
t@@his(deleteByQuery.source(), deleteByQuery.filteringAliases(), deleteByQuery.types());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2589.java