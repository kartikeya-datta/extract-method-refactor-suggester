error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8114.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8114.java
text:
```scala
public static I@@nteger ROOT_KEY = new Integer(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8114.java