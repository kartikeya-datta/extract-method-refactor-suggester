error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5235.java
text:
```scala
t@@his.parser().pushOnEnumConstantPartStack(memberTypeDeclaration.getKind() == IGenericType.ENUM);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5235.java