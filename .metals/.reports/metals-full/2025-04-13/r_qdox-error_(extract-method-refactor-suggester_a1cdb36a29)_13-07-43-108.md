error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8220.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8220.java
text:
```scala
final S@@tring message = "Problem creating " + getContext().getName() +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8220.java