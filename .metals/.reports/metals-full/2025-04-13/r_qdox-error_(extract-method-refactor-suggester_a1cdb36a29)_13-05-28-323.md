error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4036.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4036.java
text:
```scala
static final S@@impleAttributeDefinition USE_MANAGEMENT_ENDPOINT = new SimpleAttributeDefinitionBuilder(CommonAttributes.USE_MANAGEMENT_ENDPOINT, ModelType.BOOLEAN, true)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4036.java