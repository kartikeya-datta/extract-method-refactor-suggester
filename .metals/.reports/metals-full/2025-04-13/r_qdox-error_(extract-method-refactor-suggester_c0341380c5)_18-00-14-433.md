error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3010.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3010.java
text:
```scala
public S@@tring canavsId;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3010.java