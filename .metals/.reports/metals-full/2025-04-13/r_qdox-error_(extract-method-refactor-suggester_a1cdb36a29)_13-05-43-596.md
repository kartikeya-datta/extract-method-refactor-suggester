error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6151.java
text:
```scala
S@@tringBuilder sb = new StringBuilder("ReflectiveMethodInvocation: ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6151.java