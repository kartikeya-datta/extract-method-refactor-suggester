error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1761.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1761.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1761.java
text:
```scala
S@@tringBuffer buf = new StringBuffer("MethodIndictment("); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1761.java