error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8117.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8117.java
text:
```scala
private S@@tring typeName = "class";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8117.java