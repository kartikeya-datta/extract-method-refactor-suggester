error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6017.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6017.java
text:
```scala
private static final S@@tring BUNDLE_NAME = "org.eclipse.jst.ws.internal.jaxws.ui.JAXWSUIMessages"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6017.java