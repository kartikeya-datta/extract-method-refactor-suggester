error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3430.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3430.java
text:
```scala
static final H@@ornetQServerControlHandler INSTANCE = new HornetQServerControlHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3430.java