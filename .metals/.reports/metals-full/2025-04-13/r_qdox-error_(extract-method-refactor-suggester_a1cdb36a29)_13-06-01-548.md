error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8661.java
text:
```scala
t@@his.leafComponentType = env.convertUnresolvedBinaryToRawType(resolvedType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8661.java