error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2728.java
text:
```scala
i@@f (bar != null && bar.getEnabled ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2728.java