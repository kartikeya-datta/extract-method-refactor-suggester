error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9814.java
text:
```scala
r@@eturn Collections.singleton(value != null ? factory.getEntityObject(value) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9814.java