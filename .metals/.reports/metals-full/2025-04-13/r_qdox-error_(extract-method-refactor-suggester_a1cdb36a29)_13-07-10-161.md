error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11054.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11054.java
text:
```scala
r@@eturn InfinispanDescriptions.getSubsystemDescribeDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11054.java