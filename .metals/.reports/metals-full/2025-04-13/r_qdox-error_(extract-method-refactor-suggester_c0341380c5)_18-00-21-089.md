error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3484.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3484.java
text:
```scala
r@@equest.indices(clusterService.state().metaData().concreteIndices(request.indicesOptions(), request.indices()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3484.java