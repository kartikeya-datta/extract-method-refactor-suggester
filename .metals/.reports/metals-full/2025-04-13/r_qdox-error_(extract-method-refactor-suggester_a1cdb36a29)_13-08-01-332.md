error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17696.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[251,27]

error in qdox parser
file content:
```java
offset: 8179
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17696.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17696.java