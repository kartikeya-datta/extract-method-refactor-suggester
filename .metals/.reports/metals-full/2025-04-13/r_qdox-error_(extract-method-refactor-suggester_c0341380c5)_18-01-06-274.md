error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5682.java
text:
```scala
e@@xtends Receiver implements SocketNodeEventListener, PortBased {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5682.java