error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6617.java
text:
```scala
b@@uffer.append(tabString(tab));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6617.java