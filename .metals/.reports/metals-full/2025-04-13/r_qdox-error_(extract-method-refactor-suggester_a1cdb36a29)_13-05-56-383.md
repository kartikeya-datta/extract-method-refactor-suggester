error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3911.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3911.java
text:
```scala
O@@bject info = JavaModelManager.getJavaModelManager().peekAtInfo(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3911.java