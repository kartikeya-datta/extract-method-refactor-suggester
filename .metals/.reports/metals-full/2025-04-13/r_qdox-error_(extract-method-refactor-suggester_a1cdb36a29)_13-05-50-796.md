error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2664.java
text:
```scala
b@@uffer.append("<input name=\"" + getInputName() + "\"" + " type=\"radio\""
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2664.java