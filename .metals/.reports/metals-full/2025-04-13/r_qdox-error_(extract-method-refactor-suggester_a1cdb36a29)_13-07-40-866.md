error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14165.java
text:
```scala
p@@ublic final class ProcessingInstructionImpl extends XMLEventImpl implements
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14165.java