error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10020.java
text:
```scala
i@@nt lastTime, lastButton, clickCount = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10020.java