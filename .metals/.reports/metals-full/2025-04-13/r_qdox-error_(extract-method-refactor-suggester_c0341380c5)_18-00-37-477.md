error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7574.java
text:
```scala
s@@uper(new TextureRegion(texture), Scaling.none, Align.CENTER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7574.java