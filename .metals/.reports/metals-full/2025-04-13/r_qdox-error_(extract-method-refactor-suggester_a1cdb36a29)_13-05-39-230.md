error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14283.java
text:
```scala
U@@til.copyModel(existingModel,newModel,MailSubsystemModel.JNDI_NAME,MailSubsystemModel.DEBUG,MailSubsystemModel.FROM);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14283.java