error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3174.java
text:
```scala
s@@tate.set(btp.getFormalIndex(),annvar);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3174.java