error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5174.java
text:
```scala
I@@nteger.valueOf(dimension1), Integer.valueOf(dimension2)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5174.java