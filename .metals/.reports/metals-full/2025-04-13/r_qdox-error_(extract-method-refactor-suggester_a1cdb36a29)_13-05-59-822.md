error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2802.java
text:
```scala
N@@STextView feAsTextView = new NSTextView(fieldEditor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2802.java