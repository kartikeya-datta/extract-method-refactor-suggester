error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4781.java
text:
```scala
t@@his.locator.parser.scanner.setSource(source);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4781.java