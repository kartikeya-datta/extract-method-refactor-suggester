error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5042.java
text:
```scala
t@@his.mesh = new Mesh(false, maxVertices, maxIndices, new VertexAttribute(VertexAttributes.Usage.Position, 3,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5042.java