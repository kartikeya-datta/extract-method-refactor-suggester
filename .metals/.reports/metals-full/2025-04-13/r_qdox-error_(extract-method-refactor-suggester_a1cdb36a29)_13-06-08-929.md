error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6851.java
text:
```scala
S@@tring result = HttpRequest.post("http://localhost:8080/ejbws-example/SingletonEndpoint", message, 10, SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6851.java