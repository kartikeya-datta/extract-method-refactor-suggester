error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12902.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(NamingLogger.ROOT_LOGGER.jndiViewNotAvailable()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12902.java