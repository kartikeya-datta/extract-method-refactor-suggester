error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4034.java
text:
```scala
E@@TC1Data (int width, int height, ByteBuffer compressedData, int dataOffset) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4034.java