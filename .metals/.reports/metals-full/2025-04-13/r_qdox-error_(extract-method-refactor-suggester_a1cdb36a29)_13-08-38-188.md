error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2158.java
text:
```scala
i@@f (((TreeSelectionChangedEvent) evt).getSelected().length > 0 && ((TreeSelectionChangedEvent) evt).getSelected()[0] instanceof AbstractMessageFolder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2158.java