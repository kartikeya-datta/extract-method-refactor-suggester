error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3761.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3761.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3761.java
text:
```scala
Q@@uery q = (new QueryParser(TEST_VERSION_CURRENT, field, new WhitespaceAnalyzer())).parse(queryText);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3761.java