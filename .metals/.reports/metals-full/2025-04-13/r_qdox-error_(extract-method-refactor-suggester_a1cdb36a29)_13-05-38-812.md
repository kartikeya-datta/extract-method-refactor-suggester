error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1686.java
text:
```scala
D@@ocsEnum docs = termsEnum.docs(MultiFields.getLiveDocs(r), null, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1686.java