error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4417.java
text:
```scala
J@@drRunner runner = new JdrRunner(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4417.java