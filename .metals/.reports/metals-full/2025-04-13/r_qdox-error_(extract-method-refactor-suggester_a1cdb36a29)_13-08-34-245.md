error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8633.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8633.java
text:
```scala
R@@untime.getRuntime().halt(0); // Because fuck you, deadlock causing Swing shutdown hooks.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8633.java