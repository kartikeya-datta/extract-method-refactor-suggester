error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8600.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8600.java
text:
```scala
final C@@ontrolledProcessState processState = new ControlledProcessState(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8600.java