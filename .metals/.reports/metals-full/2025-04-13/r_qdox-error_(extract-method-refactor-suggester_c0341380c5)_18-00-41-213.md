error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4157.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4157.java
text:
```scala
final I@@njectionTarget injectionTarget = new FieldInjectionTarget(fieldInfo.declaringClass().name().toString(), fieldName,  fieldInfo.type().name().toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4157.java