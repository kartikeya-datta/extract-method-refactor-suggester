error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6809.java
text:
```scala
l@@ogger.debug("Using hosts {}", hosts);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6809.java