error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11278.java
text:
```scala
p@@ublic abstract class IndicatingAjaxButton extends AjaxButton implements IAjaxIndicatorAware
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11278.java