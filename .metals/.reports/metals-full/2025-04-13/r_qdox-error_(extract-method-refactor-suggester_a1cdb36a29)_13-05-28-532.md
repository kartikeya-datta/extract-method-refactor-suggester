error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5513.java
text:
```scala
n@@ew SecurityRealmChildRemoveHandler(false),
...
public class SSLServerIdentityResourceDefinition extends SimpleResourceDefinition {
    ...
    public SSLServerIdentityResourceDefinition() {
        super(PathElement.pathElement(ModelDescriptionConstants.SERVER_IDENTITY, ModelDescriptionConstants.SSL),
                ...
                new SecurityRealmChildRemoveHandler(false, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5513.java