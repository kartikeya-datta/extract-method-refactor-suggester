error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2853.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2853.java
text:
```scala
protected b@@oolean isDigit(char c) throws InvalidInputException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2853.java