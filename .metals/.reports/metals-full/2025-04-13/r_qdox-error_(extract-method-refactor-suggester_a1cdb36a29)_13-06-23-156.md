error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4281.java
text:
```scala
i@@f (!fetch.getQueryCacheEnabled())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4281.java