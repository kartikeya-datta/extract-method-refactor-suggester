error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10221.java
text:
```scala
r@@eturn new ByteValuesComparator(indexFieldData, dMissingValue, numHits, reversed);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10221.java