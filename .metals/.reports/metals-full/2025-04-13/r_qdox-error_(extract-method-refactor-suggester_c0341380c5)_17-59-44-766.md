error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3259.java
text:
```scala
t@@hrow ServerMessages.MESSAGES.equivalentNamespacesInJBossXml(entry.getKey(), usedNamespaces.get(attachmentKey));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3259.java