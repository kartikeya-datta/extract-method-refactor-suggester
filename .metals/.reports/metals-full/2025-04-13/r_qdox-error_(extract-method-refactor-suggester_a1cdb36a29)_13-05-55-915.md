error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12640.java
text:
```scala
i@@f (isExecutable(fileName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12640.java