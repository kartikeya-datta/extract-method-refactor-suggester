error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11757.java
...
```java
offset: 1087
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11757.java
text:
```scala
...
p@@ackage org.jboss.as.deployment.unit;
 ...
 */
public interface DeploymentUnitProcessorContext extends Attachable {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11757.java