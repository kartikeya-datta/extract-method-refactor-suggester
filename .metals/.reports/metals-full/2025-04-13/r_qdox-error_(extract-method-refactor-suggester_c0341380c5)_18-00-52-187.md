error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9684.java
text:
```scala
d@@efinition.getPropertyValues().addPropertyValue("order", Ordered.LOWEST_PRECEDENCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9684.java