error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1372.java
text:
```scala
C@@hangeList previous = changeListStack.peek();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1372.java