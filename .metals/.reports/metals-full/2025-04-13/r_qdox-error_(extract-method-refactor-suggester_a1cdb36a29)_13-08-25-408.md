error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2653.java
text:
```scala
S@@tring[] headers = {"src/bullet/", "src/custom/", "src/extras/serialize"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2653.java