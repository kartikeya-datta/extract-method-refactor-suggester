error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5497.java
text:
```scala
p@@vs.add("applicationEventClass", TestEvent.class.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5497.java