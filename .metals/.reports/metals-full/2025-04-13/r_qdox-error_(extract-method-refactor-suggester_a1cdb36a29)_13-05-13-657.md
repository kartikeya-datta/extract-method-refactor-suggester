error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8476.java
text:
```scala
F@@ilter facetFilter = context.queryParserService().parseInnerFilter(parser).filter();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8476.java