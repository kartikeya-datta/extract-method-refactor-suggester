error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/242.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/242.java
text:
```scala
E@@jbLogger.ROOT_LOGGER.debug("Registered " + EJBTransactionRecoveryService.INSTANCE + " as a listener to EJB client context " + context);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/242.java