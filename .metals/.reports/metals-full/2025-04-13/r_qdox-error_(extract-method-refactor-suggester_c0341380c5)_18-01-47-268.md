error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4084.java
text:
```scala
t@@ick((lastTick - t) * nano2seconds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4084.java