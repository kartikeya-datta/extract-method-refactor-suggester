error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8141.java
text:
```scala
C@@ategory.defaultHierarchy.clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8141.java