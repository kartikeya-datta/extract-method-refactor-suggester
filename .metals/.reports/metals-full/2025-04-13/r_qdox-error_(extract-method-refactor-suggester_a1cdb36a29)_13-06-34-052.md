error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2371.java
text:
```scala
i@@f ("script_values_unique".equals(currentFieldName) || "scriptValuesUnique".equals(currentFieldName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2371.java