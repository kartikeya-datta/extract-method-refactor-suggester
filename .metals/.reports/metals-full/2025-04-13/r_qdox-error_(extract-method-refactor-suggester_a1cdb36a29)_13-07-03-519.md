error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2839.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2839.java
text:
```scala
public S@@tring getCacheKey(MarkupContainer container, Class containerClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2839.java