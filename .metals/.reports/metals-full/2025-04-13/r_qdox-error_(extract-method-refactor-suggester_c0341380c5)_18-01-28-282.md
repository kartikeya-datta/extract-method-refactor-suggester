error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4866.java
text:
```scala
I@@CommandHandlerService getCommandHandlerService();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4866.java