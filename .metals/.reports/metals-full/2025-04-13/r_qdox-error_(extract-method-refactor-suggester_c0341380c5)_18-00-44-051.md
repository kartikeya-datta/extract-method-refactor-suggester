error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/444.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/444.java
text:
```scala
private O@@nCompletionListener onCompletionListener;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/444.java