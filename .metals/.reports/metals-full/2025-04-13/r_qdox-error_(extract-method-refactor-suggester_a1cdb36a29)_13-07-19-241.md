error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/448.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/448.java
text:
```scala
public I@@ndexInput openFullSlice() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/448.java