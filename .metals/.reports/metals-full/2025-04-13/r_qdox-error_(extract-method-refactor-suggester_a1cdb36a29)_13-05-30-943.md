error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10206.java
text:
```scala
f@@or (int i = 0; i < newIndices.length; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10206.java