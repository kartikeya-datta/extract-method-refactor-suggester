error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2182.java
...
```java
offset: 924
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2182.java
text:
```scala
...
p@@ackage org.apache.jmeter.engine;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2182.java