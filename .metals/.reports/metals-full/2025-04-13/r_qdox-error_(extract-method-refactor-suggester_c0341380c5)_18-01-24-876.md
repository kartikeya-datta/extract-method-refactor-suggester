error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17617.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[146,80]

error in qdox parser
file content:
```java
offset: 5061
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17617.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17617.java