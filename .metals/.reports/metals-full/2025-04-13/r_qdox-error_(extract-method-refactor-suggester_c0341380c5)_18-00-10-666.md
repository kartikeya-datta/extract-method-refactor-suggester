error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17096.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17096.java
text:
```scala
final C@@lass homePageClass = requestCycle.getApplication().getRequiredPageSettings().getHomePage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17096.java