error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13900.java
text:
```scala
f@@or (AttributeDefinition ad : AccessAuthorizationResourceDefinition.CONFIG_ATTRIBUTES) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13900.java