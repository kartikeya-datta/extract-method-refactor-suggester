error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1794.java
text:
```scala
r@@eturn handle != null ? (int)/*64*/handle.id : 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1794.java