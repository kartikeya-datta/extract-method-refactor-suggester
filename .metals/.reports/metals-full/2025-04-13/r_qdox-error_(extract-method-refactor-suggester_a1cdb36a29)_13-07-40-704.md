error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/382.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/382.java
text:
```scala
protected v@@oid update(final int position, final RepositoryItemView view, final Repository repository) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/382.java