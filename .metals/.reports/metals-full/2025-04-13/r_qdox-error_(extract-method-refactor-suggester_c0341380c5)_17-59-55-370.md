error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6042.java
text:
```scala
I@@nclude include = new Include();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6042.java