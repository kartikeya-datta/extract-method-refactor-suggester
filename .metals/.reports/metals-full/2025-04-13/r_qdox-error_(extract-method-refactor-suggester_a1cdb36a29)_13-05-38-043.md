error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7605.java
text:
```scala
S@@tring tchome=ctx.getContextManager().getInstallDir();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7605.java