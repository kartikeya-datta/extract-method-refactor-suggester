error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7012.java
text:
```scala
i@@f (value) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7012.java