error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17020.java
text:
```scala
n@@ew EclipseAttributeAdapter(new AjAttribute.MethodDeclarationLineNumberAttribute(declarationStartLine, this.sourceStart())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17020.java