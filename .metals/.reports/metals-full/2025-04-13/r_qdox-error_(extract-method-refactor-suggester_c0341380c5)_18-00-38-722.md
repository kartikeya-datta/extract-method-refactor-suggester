error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8082.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8082.java
text:
```scala
s@@etEventHandler(this.rewriter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8082.java