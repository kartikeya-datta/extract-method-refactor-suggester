error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12099.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12099.java
text:
```scala
static i@@nt MINOR_VERSION = 313;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12099.java