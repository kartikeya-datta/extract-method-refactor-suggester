error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6163.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6163.java
text:
```scala
public i@@nt GetTimeStamp(int /*long*/[] aTimeStamp) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6163.java