error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5628.java
text:
```scala
t@@ex2 = new Texture(Gdx.files.internal("data/planet_heavyclouds.jpg"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5628.java