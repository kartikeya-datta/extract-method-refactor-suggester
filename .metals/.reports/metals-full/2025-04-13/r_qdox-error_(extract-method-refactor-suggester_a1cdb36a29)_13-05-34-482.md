error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7837.java
text:
```scala
C@@LEAR_TABLES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7837.java