error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5570.java
text:
```scala
i@@f (Regex.simpleMatch(setting.getKey(), dynamicSetting)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5570.java