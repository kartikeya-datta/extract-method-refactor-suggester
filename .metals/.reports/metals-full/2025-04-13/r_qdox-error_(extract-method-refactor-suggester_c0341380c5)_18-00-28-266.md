error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3894.java
text:
```scala
A@@ssert.fail("Expected a application exception");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3894.java