error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5721.java
text:
```scala
r@@eturn super.wmColorChild (wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5721.java