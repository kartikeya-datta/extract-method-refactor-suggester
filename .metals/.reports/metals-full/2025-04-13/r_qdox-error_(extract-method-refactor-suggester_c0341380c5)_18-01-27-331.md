error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10893.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10893.java
text:
```scala
final i@@nt ulps = 3;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10893.java