error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7016.java
text:
```scala
f@@or (DocumentMapper documentMapper : parseContext.mapperService().docMappers(false)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7016.java