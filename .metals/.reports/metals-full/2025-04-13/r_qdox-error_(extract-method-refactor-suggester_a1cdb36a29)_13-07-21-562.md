error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8802.java
text:
```scala
v@@oid updateControl() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8802.java