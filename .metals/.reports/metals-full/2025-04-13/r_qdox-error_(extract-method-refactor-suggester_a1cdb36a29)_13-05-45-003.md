error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1179.java
text:
```scala
i@@f (queuedData.length() == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1179.java