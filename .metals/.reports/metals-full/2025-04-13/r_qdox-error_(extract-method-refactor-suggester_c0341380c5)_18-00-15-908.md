error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11488.java
text:
```scala
p@@ublic class DownloadPage extends WebPage
 ...
 */
public class DownloadPage extends WebPage<Void>
{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11488.java