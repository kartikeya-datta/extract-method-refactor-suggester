error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5013.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5013.java
text:
```scala
public static final b@@oolean REFRESH_FORCE = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5013.java