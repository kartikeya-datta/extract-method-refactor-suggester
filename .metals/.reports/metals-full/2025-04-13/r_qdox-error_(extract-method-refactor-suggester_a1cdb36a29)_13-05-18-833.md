error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2777.java
text:
```scala
i@@f (!this.action.complainIfUnreachable(actionInfo, scope, false)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2777.java