error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1001.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1001.java
text:
```scala
S@@tring pHeaders = request.param("h");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1001.java