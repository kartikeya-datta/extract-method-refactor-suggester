error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13939.java
text:
```scala
A@@ssert.assertEquals(6, operations.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13939.java