error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8737.java
text:
```scala
G@@dxTest test = new JsonModelLoaderTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8737.java