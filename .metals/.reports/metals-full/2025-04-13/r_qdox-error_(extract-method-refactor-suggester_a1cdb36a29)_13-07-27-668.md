error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/638.java
text:
```scala
I@@ExtensionPoint point = registry.getExtensionPoint(PlatformUI.PLUGIN_ID, IWorkbenchConstants.PL_STARTUP);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/638.java