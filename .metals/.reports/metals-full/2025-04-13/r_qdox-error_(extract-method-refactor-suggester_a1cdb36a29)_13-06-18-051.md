error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13919.java
text:
```scala
g@@etClass(), filepath, component.getStyle(), component.getLocale(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13919.java