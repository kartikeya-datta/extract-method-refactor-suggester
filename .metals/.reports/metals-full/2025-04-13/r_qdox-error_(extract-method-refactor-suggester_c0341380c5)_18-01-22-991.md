error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1835.java
text:
```scala
t@@raversedContext.recordReturnFrom(flowInfo.unconditionalInits());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1835.java