error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/854.java
text:
```scala
t@@hrow StandardException.newException( SQLState.SERVICE_DIRECTORY_CREATE_ERROR, ioe, dataDirectory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/854.java