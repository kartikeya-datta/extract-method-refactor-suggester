error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/591.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/591.java
text:
```scala
final S@@tring deploymentName = key.getName().replace('.', '_');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/591.java