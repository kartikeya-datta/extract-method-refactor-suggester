error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7136.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7136.java
text:
```scala
final S@@ervletInfo jspServlet = jspConfig != null ? jspConfig.createJSPServletInfo() : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7136.java