error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4674.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4674.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4674.java
text:
```scala
F@@ieldDataStats fieldDataStats(String... fields);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4674.java