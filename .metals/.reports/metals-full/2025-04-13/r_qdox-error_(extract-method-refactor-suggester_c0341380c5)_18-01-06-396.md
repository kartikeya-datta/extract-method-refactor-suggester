error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2880.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2880.java
text:
```scala
0,@@ 32);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2880.java