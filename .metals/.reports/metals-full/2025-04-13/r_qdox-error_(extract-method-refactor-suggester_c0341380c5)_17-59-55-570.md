error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9375.java
text:
```scala
d@@estDir = getProject().resolveFile(".");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9375.java