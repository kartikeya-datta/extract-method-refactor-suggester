error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6725.java
text:
```scala
i@@f (this.pattern.parameterSimpleNames != null && (!this.pattern.varargs || ((node.bits & ASTNode.InsideJavadoc) != 0))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6725.java