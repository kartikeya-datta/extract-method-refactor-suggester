error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2864.java
text:
```scala
R@@unnablePostTest.class, Vector2dTest.class, SuperKoalio.class, NinePatchTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2864.java