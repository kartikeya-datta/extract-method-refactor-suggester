error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5795.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5795.java
text:
```scala
private final D@@ataService service;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5795.java