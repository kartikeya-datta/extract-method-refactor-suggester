error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6462.java
text:
```scala
T@@hread.sleep(3000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6462.java