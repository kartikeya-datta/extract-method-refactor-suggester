error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12447.java
text:
```scala
r@@eturn TestApp1.get().getContactsDB();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12447.java