error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/993.java
text:
```scala
i@@f (isDisabled && style.disabledFontColor != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/993.java