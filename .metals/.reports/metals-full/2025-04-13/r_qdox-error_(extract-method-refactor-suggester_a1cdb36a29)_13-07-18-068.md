error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13686.java
text:
```scala
t@@estPanelSource.getTestPanel(this, TEST_PANEL_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13686.java