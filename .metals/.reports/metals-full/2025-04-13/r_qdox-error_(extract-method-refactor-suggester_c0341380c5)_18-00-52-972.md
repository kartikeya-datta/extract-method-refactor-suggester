error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4785.java
text:
```scala
c@@ompilerOptions.sourceLevel >= CompilerOptions.JDK1_4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4785.java