error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3921.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3921.java
text:
```scala
public v@@oid setLinkClickCount(final int linkClickCount)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3921.java