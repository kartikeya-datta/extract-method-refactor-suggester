error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1705.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1705.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1705.java
text:
```scala
l@@istener.surfaceCreated( app );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1705.java