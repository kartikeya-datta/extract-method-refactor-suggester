error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17457.java
text:
```scala
C@@lientPlugin.log("ECF: Autostarting containerType="+details.getContainerType()+",uri="+details.getTargetURI()+",nickname="+details.getNickname());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17457.java