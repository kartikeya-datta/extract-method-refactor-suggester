error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3877.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3877.java
text:
```scala
r@@eturn 96.0f / 160;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3877.java