error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1844.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1844.java
text:
```scala
S@@tring urlString = System.getProperty("jmx.service.url", "service:jmx:rmi:///jndi/rmi://" + NetworkUtils.formatPossibleIpv6Address(host) + ":" + port + "/jmxrmi");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1844.java