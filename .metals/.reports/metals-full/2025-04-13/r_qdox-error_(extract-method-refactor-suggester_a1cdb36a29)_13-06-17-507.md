error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8640.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8640.java
text:
```scala
public v@@oid testSpecificationExamples() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8640.java