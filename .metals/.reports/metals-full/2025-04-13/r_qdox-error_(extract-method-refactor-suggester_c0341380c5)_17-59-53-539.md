error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14014.java
text:
```scala
S@@essionID sessionID = (SessionID) contextData.get(SessionID.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14014.java