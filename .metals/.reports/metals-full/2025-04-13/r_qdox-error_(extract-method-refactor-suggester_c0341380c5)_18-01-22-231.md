error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17756.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[70,80]

error in qdox parser
file content:
```java
offset: 2125
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17756.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17756.java