error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6631.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6631.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh().force(TransportGetAction.REFRESH_FORCE).source("refresh_flag_mget"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6631.java