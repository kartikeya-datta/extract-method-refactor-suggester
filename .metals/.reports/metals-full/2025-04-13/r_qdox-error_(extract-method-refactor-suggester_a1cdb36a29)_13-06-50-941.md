error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2765.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2765.java
text:
```scala
c@@ontroller.registerHandler(GET, "/_scripts/{lang}/{id}", this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2765.java