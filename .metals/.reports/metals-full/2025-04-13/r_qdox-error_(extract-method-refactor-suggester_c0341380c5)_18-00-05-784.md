error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16993.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16993.java
text:
```scala
static i@@nt MINOR_VERSION = 612;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16993.java