error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7363.java
text:
```scala
s@@electedFields = new HashSet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7363.java