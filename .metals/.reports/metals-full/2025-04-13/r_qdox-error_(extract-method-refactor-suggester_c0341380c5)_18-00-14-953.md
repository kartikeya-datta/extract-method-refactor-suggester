error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8738.java
text:
```scala
L@@ogger.getLogger("org.jboss.web").info("starting context " + context.getName() + ": " + (System.currentTimeMillis() - time));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8738.java