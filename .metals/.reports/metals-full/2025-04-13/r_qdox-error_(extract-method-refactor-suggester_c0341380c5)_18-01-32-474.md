error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4550.java
text:
```scala
c@@odeStream.updateLastRecordedEndPC((this.thenStatement instanceof Block) ? ((Block) this.thenStatement).scope : currentScope, position);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4550.java