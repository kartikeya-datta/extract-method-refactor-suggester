error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13633.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13633.java
text:
```scala
c@@ontext.getServiceTarget().addService(NetworkInterfaceService.JBOSS_NETWORK_INTERFACE.append(name),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13633.java