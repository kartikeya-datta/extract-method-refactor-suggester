error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5061.java
text:
```scala
t@@hrow ProtocolMessages.MESSAGES.nullVar("connectTask");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5061.java