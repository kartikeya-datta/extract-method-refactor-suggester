error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13826.java
...
```java
offset: 1107
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13826.java
text:
```scala
...
p@@ackage org.jboss.as.osgi.deployment;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13826.java