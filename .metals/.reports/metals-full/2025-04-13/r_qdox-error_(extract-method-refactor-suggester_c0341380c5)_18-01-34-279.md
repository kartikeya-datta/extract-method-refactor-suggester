error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6654.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6654.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6654.java
text:
```scala
m@@ultiSearchRequest.add(request.content(), request.contentUnsafe(), indices, types, request.param("search_type"), request.param("routing"), ignoreIndices, allowExplicitIndex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6654.java