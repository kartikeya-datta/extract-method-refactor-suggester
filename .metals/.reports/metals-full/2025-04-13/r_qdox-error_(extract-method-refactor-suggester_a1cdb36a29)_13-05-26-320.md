error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2277.java
text:
```scala
s@@tore.setDefault(IPreferenceConstants.SHOW_TRADITIONAL_STYLE_TABS, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2277.java