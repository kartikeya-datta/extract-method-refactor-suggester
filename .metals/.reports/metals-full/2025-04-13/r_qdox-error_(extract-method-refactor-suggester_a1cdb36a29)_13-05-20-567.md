error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5223.java
text:
```scala
C@@lusterState state = node.client().admin().cluster().prepareState().setLocal(true).execute().actionGet().getState();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5223.java