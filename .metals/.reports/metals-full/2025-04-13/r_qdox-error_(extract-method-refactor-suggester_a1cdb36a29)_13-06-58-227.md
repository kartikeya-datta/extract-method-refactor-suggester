error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9536.java
text:
```scala
s@@yntheticField = sourceType.addSyntheticFieldForClassLiteral(targetType, currentScope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9536.java