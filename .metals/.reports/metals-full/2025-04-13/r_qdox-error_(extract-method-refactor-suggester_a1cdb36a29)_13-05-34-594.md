error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15172.java
text:
```scala
i@@f (!oldRect.equals (newRect)) sendResize ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15172.java