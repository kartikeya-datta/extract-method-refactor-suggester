error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7790.java
text:
```scala
f@@or (short i = 0; i < length; i++)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7790.java