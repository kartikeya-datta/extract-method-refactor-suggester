error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3613.java
text:
```scala
O@@S.GTK_WIDGET_SET_FLAGS (topHandle, flags);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3613.java