error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9435.java
text:
```scala
i@@f (WeldDeploymentMarker.isWeldDeployment(deploymentUnit)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9435.java