error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13241.java
text:
```scala
t@@ip.sendSelectionEvent (SWT.Selection);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13241.java