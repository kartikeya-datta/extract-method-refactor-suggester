error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8705.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8705.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8705.java
text:
```scala
t@@hrow new GdxRuntimeException("Invalid version "+VERSION, t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8705.java