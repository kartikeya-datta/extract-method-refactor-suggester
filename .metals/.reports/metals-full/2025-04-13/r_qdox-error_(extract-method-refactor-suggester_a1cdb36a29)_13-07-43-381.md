error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6854.java
text:
```scala
i@@f (!build.isMultiValued() && CommonSettings.removeOrdsOnSingleValue(fieldDataType)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6854.java