error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14897.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14897.java
text:
```scala
n@@ew PageLink(this, "navigateBackLink", referer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14897.java