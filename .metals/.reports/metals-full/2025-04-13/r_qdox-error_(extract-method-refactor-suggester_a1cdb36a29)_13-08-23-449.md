error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4231.java
text:
```scala
r@@eturn "FlowInfo.DeadEnd"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4231.java