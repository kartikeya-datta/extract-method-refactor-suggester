error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5073.java
text:
```scala
R@@eturns the option names for this component.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5073.java