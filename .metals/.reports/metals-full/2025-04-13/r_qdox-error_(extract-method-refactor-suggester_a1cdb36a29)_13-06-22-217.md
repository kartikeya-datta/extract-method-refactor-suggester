error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7606.java
text:
```scala
p@@pcY = ppcY / 2.54f;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7606.java