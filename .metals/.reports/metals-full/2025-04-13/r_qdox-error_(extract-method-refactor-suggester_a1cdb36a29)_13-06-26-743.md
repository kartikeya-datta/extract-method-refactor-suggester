error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3824.java
text:
```scala
a@@dd(new DeleteRequest(index, type, id).parent(parent).routing(routing));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3824.java