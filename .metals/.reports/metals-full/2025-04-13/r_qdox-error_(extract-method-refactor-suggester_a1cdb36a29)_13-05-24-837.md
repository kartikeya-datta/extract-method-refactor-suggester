error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17578.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[86,80]

error in qdox parser
file content:
```java
offset: 1943
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17578.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17578.java