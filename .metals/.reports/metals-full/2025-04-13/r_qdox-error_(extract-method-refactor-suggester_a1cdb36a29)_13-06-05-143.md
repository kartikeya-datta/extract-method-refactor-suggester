error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13864.java
text:
```scala
g@@c.fillRectangle ((int) (rect.x + pt.x), (int) (rect.y + pt.y), (int) rect.width, (int) rect.height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13864.java