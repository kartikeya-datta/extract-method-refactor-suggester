error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2702.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2702.java
text:
```scala
d@@ocs = termsEnum.docs(acceptDocs, docs, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2702.java