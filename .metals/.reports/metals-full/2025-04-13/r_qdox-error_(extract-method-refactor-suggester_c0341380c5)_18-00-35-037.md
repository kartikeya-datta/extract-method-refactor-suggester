error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14147.java
text:
```scala
i@@f (toolTipText == null) return super.expansionFrameWithFrame_inView(id, sel, cellRect, view);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14147.java