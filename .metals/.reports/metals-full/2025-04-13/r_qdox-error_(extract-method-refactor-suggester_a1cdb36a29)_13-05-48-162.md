error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1991.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1991.java
text:
```scala
public L@@ist<String> getMajoritySide() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1991.java