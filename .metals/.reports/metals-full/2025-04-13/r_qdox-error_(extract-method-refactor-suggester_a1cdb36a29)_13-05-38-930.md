error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/275.java
text:
```scala
s@@uper(window,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/275.java