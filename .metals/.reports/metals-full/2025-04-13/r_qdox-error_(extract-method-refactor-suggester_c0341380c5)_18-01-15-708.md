error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12743.java
text:
```scala
e@@ar.addAsManifestResource(new StringAsset("Dependencies: org.hibernate\n"), "MANIFEST.MF");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12743.java