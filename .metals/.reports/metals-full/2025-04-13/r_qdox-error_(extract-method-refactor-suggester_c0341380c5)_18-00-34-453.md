error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14800.java
text:
```scala
O@@bject itemsObject = evaluate("items", items);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14800.java