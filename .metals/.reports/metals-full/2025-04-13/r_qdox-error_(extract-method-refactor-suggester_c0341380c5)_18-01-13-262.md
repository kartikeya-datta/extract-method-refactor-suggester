error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6463.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6463.java
text:
```scala
s@@uper ("Map", "{builtin}Map");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6463.java