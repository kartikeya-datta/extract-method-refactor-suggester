error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3836.java
text:
```scala
D@@ocument doc = docMapper.parse(json).rootDoc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3836.java