error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9222.java
text:
```scala
i@@f (tag instanceof WicketTag)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9222.java