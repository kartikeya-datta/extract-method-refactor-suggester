error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4190.java
text:
```scala
i@@f ("jar".equalsIgnoreCase(ext) || "zip".equalsIgnoreCase(ext)) {//$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4190.java