error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3270.java
text:
```scala
d@@ouble weightOfVectorB, long numberOfColumns) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3270.java