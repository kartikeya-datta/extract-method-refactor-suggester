error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2407.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2407.java
text:
```scala
final B@@eanWithSimpleInjected bean = LookupService.getBean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2407.java