error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3636.java
text:
```scala
s@@ = s + "continue "/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3636.java