error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3699.java
text:
```scala
l@@og.debug("Read 1 Cluster from {}", clusterPath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3699.java