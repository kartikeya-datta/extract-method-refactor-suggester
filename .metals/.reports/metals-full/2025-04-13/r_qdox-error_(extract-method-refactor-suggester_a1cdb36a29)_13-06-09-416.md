error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12179.java
text:
```scala
p@@ublic abstract class AbstractMapper implements IRequestMapper
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12179.java