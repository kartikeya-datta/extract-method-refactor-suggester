error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2533.java
text:
```scala
i@@f (size < 3) size = 3;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2533.java