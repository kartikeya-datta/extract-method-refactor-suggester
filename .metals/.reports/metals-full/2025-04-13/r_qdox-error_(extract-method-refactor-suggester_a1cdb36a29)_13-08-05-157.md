error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8012.java
text:
```scala
e@@xtensionRegistry.setSubsystemParentResourceRegistrations(profile, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8012.java