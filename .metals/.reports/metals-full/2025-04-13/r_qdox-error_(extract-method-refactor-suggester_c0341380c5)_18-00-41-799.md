error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5089.java
text:
```scala
s@@ubject = new String(MailResourceLoader.getString("dialog","composer","composer_no_subject")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5089.java