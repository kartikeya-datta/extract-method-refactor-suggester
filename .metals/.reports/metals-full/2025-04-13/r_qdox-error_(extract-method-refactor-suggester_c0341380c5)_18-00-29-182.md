error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10031.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10031.java
text:
```scala
public v@@oid click (Actor button, float x, float y) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10031.java