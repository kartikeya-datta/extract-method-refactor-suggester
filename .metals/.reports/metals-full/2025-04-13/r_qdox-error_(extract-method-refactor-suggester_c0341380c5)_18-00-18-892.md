error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10860.java
text:
```scala
r@@eturn new JavascriptStripper().stripCommentsAndWhitespace(original);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10860.java