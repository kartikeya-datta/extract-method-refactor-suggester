error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6467.java
text:
```scala
s@@uper ("String", "{builtin}String");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6467.java