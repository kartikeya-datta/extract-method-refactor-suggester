error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5482.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5482.java
text:
```scala
public static final A@@ttachmentKey<JBossServiceXmlDescriptor> ATTACHMENT_KEY = new AttachmentKey<JBossServiceXmlDescriptor>(JBossServiceXmlDescriptor.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5482.java