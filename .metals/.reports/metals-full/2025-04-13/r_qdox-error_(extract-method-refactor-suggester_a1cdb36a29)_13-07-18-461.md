error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4277.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4277.java
text:
```scala
private static final S@@tring FILEVERSION = "1545089"; // Expected value $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4277.java