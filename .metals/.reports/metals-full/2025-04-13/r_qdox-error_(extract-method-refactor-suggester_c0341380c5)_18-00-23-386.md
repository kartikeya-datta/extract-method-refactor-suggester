error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9575.java
text:
```scala
i@@f (!forWrite && (!isPersistent() || (isNew() && !isFlushed())  || isDeleted()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9575.java