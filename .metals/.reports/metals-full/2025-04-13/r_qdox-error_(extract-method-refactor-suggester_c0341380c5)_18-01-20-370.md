error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6117.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6117.java
text:
```scala
final S@@tring endpointClassName = ASHelper.getEndpointClassName(servletMD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6117.java