error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13755.java
text:
```scala
t@@hrow new IOException(e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13755.java