error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1782.java
text:
```scala
s@@tartedLatch.await(5, TimeUnit.SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1782.java