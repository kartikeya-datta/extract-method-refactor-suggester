error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1822.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1822.java
text:
```scala
public static final S@@tring NAME = "indices:admin/analyze";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1822.java