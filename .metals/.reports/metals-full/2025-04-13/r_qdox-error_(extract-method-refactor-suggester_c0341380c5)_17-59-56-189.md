error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3171.java
text:
```scala
a@@ssertXPath("//body/span[@wicket:id='message']", "Hello World!");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3171.java