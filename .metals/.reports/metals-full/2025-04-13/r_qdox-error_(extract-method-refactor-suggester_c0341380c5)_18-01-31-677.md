error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9832.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9832.java
text:
```scala
K@@eySequence keySequence = KeySequence.getInstance(KeySupport.convertAcceleratorToKeyStroke(accelerator));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9832.java