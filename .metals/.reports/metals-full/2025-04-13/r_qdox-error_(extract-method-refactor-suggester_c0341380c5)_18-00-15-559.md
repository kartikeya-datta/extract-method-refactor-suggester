error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14941.java
text:
```scala
S@@tringBuilder tmp = new StringBuilder("CASE ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14941.java