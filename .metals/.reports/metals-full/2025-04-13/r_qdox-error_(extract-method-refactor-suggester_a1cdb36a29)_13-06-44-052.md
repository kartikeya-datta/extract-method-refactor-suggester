error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16060.java
text:
```scala
i@@nt buttonHandle = Cocoa.objc_msgSend(Cocoa.objc_msgSend(Cocoa.C_NSButton, Cocoa.S_alloc), Cocoa.S_initWithFrame, new NSRect());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16060.java