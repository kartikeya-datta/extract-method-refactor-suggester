error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2313.java
text:
```scala
c@@odeStream.updateLastRecordedEndPC(currentScope, position);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2313.java