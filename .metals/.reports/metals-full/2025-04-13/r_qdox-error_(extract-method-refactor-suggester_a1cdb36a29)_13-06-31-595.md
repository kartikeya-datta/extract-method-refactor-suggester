error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8718.java
text:
```scala
I@@ObjectActivityManager manager = window.getWorkbench().getObjectActivityManager(IWorkbenchConstants.PL_NEW, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8718.java