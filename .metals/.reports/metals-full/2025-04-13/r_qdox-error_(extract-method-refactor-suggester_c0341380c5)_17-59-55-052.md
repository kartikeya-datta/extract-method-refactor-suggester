error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9005.java
text:
```scala
d@@ouble n0 = n;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9005.java