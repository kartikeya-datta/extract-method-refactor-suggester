error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2130.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2130.java
text:
```scala
public static final S@@tring DEFAULT_REPO_NAME="repository.xml";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2130.java