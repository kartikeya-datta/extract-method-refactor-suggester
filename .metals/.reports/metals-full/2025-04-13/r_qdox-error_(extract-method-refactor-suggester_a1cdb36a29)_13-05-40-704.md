error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4308.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4308.java
text:
```scala
t@@ag.put("onclick", "window.location.href='" + url + "';");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4308.java