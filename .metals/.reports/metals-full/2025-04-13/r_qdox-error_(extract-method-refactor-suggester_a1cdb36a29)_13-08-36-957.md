error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9537.java
text:
```scala
d@@eploymentResourceManager = new FileResourceManager(resourcesRoot.getPhysicalFile(), 1024 * 1024);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9537.java