error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2066.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2066.java
text:
```scala
public E@@ditorHistory getEditorHistory() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2066.java