error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1509.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1509.java
text:
```scala
t@@hrow new IllegalArgumentException("Duplicate element " + element);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1509.java