error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/562.java
text:
```scala
w@@riter = file.writer(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/562.java