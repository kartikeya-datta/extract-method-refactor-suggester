error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1446.java
text:
```scala
i@@nfo = ClassFileReader.read(zip, entryName, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1446.java