error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7566.java
text:
```scala
r@@eturn "body_contains";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7566.java