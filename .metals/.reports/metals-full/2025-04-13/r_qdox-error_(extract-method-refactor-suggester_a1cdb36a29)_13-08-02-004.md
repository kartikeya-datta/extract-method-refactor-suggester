error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4270.java
text:
```scala
r@@eturn LRESULT.ZERO;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4270.java