error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4074.java
text:
```scala
s@@crollPane.setOverscroll(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4074.java