error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/953.java
text:
```scala
i@@f (this.ast.apiLevel == AST.JLS3 && packageDeclaration.getJavadoc() == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/953.java