error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3582.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3582.java
text:
```scala
public S@@impleLoggerFA() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3582.java