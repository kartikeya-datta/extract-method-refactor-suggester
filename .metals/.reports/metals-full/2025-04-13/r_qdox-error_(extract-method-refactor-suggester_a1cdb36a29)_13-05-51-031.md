error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/679.java
text:
```scala
i@@f (!getFlag(FLAG_VERSIONED))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/679.java