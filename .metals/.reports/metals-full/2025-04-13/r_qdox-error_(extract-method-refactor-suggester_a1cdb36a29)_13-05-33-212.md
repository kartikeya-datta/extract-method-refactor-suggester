error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9618.java
text:
```scala
w@@riter.writeAttribute(Attribute.FLAG.getLocalName(), module.get(Constants.FLAG).asString().toLowerCase(Locale.ENGLISH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9618.java