error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/59.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/59.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/59.java
text:
```scala
static final S@@erviceName HC_EXECUTOR_SERVICE_NAME = HC_SERVICE_NAME.append("executor");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/59.java