error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1300.java
text:
```scala
S@@tring key = target.getHostAddress() + ":" + message.getMessageId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1300.java