error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/126.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/126.java
text:
```scala
public final v@@oid registerNewUserInput()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/126.java