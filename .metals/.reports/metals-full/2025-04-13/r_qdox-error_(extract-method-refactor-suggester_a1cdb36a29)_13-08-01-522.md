error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17488.java
text:
```scala
i@@nt /*long*/ code = callWindowProc (handle, OS.WM_SETREDRAW, wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17488.java