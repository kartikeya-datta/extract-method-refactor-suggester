error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/842.java
text:
```scala
i@@sWhitespace(), isNamespace(), isTolerant(), isQuiet(), showWarnings() , reportErrors(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/842.java