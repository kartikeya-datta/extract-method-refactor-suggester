error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4632.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4632.java
text:
```scala
public v@@oid marshallAsElement(ModelNode resourceModel,final boolean marshalDefault, XMLStreamWriter writer) throws XMLStreamException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4632.java