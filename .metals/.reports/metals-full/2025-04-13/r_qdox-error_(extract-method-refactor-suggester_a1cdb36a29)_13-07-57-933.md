error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3231.java
...
```java
offset: 917
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3231.java
text:
```scala
...
p@@ackage org.elasticsearch.cloud.aws.blobstore;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3231.java