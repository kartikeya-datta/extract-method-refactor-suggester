error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2866.java
text:
```scala
e@@nsureGreen();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2866.java