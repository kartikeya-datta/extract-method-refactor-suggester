error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12792.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12792.java
text:
```scala
private C@@lass type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12792.java