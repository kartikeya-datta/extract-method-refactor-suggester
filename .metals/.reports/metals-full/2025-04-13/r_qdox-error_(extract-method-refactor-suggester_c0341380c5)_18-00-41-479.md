error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11906.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11906.java
text:
```scala
t@@ag.setId("_wicket_" + tag.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11906.java