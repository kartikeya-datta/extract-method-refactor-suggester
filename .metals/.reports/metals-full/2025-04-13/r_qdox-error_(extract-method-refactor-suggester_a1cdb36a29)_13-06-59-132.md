error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10311.java
text:
```scala
f@@or (Iterator<?> iterator = remotelySetProperties.keySet().iterator(); iterator.hasNext();) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10311.java