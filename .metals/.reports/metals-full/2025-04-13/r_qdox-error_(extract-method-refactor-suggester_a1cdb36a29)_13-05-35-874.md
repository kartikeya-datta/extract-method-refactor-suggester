error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14783.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14783.java
text:
```scala
public synchronized i@@nt getWindowSize() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14783.java