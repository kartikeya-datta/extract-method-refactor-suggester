error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3353.java
text:
```scala
r@@eturn this.@com.badlogic.gdx.backends.gwt.soundmanager2.SMSound::jsSound.setPosition(position);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3353.java