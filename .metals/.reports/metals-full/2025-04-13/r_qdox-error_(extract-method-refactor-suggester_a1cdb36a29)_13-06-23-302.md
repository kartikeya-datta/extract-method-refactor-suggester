error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5386.java
text:
```scala
m@@ultiplier += 0.2f;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5386.java