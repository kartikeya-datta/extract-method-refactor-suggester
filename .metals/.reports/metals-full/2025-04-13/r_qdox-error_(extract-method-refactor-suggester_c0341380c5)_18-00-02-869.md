error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8132.java
text:
```scala
i@@f ( (node != null) && (folder != null) ) folder.setLastSelection(node);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8132.java