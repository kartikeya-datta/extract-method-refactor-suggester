error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7417.java
text:
```scala
i@@f (tree == null || tree.isDisposed()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7417.java