error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4061.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4061.java
text:
```scala
final C@@lassLoader classLoader = buildClassLoader( context );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4061.java