error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1625.java
text:
```scala
B@@ooleanScorer bs = new BooleanScorer(sim, 1, Arrays.asList(scorers), null, scorers.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1625.java