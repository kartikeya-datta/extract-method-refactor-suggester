error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2958.java
text:
```scala
r@@outingTable = strategy.applyFailedShard(clusterState, routingNodes.node("node1").shardsWithState(INITIALIZING).get(0)).routingTable();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2958.java