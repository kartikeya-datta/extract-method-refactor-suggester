error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9480.java
text:
```scala
i@@nt implicitValue = AccPublic | AccStatic | AccFinal | AccEnum;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9480.java