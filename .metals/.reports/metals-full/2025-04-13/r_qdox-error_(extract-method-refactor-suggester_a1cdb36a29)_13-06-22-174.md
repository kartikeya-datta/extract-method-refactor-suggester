error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6024.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6024.java
text:
```scala
public I@@Status run(IProgressMonitor monitor) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6024.java