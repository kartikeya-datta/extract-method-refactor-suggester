error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5039.java
text:
```scala
s@@etOrigin(region.originalWidth / 2f, region.originalHeight / 2f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5039.java