error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10667.java
text:
```scala
L@@ist<E> choices = this.choices.getObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10667.java