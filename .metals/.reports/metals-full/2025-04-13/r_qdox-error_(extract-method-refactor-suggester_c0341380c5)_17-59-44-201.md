error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1078.java
text:
```scala
s@@uper();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1078.java