error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9935.java
text:
```scala
g@@etJavaProject().getOptions(true)); // cannot use workspace options if external jar is 1.5 jar and workspace options are 1.4 options
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9935.java