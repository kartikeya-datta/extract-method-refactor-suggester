error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2440.java
text:
```scala
t@@his.kind = SOURCE_PARSER | TEXT_PARSE | TEXT_VERIF;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2440.java