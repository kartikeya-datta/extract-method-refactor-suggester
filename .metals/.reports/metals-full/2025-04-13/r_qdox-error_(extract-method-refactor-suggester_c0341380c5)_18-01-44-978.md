error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9734.java
text:
```scala
e@@xpectedDisplayText(MESSAGES.addedUser(values.getUserName(), values.getUserFiles().get(0).getCanonicalPath())).
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9734.java