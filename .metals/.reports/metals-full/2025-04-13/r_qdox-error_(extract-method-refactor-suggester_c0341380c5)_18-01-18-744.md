error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9030.java
text:
```scala
m@@ = g + (d - g) /2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9030.java