error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1487.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1487.java
text:
```scala
public L@@ist<InetAddress> getEndPoint(byte[] key)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1487.java