error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3234.java
text:
```scala
f@@ont.drawMultiLine(batch, message, 20, Gdx.graphics.getHeight() - 20, Color.WHITE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3234.java