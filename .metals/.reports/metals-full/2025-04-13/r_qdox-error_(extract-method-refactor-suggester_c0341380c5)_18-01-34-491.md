error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5140.java
text:
```scala
L@@ist getStringResourceLoaders();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5140.java