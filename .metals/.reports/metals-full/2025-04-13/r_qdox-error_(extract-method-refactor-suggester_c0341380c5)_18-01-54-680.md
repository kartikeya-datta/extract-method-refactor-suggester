error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4935.java
text:
```scala
i@@nt middle = (start + end) >>> 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4935.java