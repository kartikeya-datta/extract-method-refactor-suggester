error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3618.java
text:
```scala
e@@nv.put(Context.PROVIDER_URL, "remote://" + address + ":4447");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3618.java