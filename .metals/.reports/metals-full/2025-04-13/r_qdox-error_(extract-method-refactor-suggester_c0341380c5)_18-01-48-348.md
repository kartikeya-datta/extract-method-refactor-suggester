error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9643.java
text:
```scala
s@@etEnterHandler(GlobalCharacterHandlers.CONTENT_CHARACTER_HANDLER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9643.java