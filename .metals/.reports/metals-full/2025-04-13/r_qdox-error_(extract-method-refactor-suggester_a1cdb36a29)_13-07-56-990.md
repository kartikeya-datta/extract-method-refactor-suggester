error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13314.java
text:
```scala
h@@dItem.mask = OS.HDI_FORMAT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13314.java