error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9140.java
text:
```scala
A@@jBuildConfig ajbc = element.getBuildConfig();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9140.java