error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/79.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/79.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/79.java
text:
```scala
r@@outingNode.add(shardRouting);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/79.java