error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4506.java
text:
```scala
I@@Marker[] markers = p.findMarkers(IJavaModelMarker.BUILDPATH_PROBLEM_MARKER, false, IResource.DEPTH_ZERO);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4506.java