error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4267.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4267.java
text:
```scala
r@@eturn Util.bind("operation.moveResourceProgress"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4267.java