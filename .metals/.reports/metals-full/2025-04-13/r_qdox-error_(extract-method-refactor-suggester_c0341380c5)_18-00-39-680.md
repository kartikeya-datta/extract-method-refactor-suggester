error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5766.java
text:
```scala
P@@ixmapTest.class, PolygonRegionTest.class, PolygonSpriteTest.class, PreferencesTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5766.java