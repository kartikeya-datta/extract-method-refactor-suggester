error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5616.java
text:
```scala
t@@ypeDeclaration.bits |= ASTNode.IsMemberType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5616.java