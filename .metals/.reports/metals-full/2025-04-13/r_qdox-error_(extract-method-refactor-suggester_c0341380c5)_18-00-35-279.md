error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12404.java
text:
```scala
p@@ublic interface BaseMultivariateOptimizer<FUNC extends MultivariateFunction>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12404.java