error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2791.java
text:
```scala
l@@istItem.add(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2791.java