error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2655.java
text:
```scala
T@@estCompiler compiler = new TestCompiler(testing);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2655.java