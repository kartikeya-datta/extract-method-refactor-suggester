error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10752.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10752.java
text:
```scala
public static final i@@nt STRUCTURE_SAR                               = 0x1580;
...
public enum Phase {
    ...
    public static final int STRUCTURE_SAR                               = 0x1550;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10752.java