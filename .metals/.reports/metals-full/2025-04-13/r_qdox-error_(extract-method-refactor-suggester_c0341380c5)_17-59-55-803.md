error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2184.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2184.java
text:
```scala
final M@@arkup markup = application.getMarkupParser().readAndParse(markupResource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2184.java