error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2778.java
text:
```scala
r@@eturn containerPath;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2778.java