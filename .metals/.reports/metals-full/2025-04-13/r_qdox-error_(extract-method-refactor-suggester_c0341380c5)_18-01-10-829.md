error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3564.java
text:
```scala
j@@a.addClass(DeployTestCase.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3564.java