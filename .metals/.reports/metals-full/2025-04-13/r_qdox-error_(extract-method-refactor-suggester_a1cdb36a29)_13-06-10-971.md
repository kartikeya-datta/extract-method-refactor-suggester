error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7392.java
text:
```scala
i@@f (visible && bar != null && !barVisible) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7392.java