error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7069.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7069.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7069.java
text:
```scala
p@@utMappingRequest.ignoreConflicts(request.paramAsBoolean("ignoreConflicts", putMappingRequest.ignoreConflicts()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7069.java