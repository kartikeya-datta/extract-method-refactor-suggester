error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5457.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5457.java
text:
```scala
public static final P@@rocessTypeHandler SLAVE = new ProcessTypeHandler(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5457.java