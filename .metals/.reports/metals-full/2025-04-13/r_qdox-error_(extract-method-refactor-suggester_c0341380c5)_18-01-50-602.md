error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9642.java
text:
```scala
i@@f(!ctx.getParsedCommandLine().hasProperties()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9642.java