error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9905.java
text:
```scala
a@@ssertThat("Unexpected ShardFailures: " + Arrays.toString(searchResponse.getShardFailures()), searchResponse.getShardFailures().length, equalTo(0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9905.java