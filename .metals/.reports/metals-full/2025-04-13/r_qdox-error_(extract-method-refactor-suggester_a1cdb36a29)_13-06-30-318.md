error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/479.java
text:
```scala
s@@b.append("query[").append(context.parsedQuery().query()).append("],from[").append(context.from()).append("],size[").append(context.size()).append("]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/479.java