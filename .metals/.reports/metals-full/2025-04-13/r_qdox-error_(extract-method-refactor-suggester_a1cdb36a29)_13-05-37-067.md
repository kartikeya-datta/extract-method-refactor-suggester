error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4146.java
text:
```scala
s@@uper(name, serverName, listenerOptions, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4146.java