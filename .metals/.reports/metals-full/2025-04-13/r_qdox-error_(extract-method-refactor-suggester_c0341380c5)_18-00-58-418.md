error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7199.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7199.java
text:
```scala
public v@@oid tearDown(final ManagementClient managementClient, final String containerId) throws IOException, MgmtOperationException {
...
public class MultipleObjectActivationTestCase extends ArquillianResourceMgmtTestBase {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7199.java