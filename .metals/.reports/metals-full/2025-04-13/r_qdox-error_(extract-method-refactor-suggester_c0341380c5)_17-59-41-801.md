error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5667.java
text:
```scala
C@@olor color = tempColor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5667.java