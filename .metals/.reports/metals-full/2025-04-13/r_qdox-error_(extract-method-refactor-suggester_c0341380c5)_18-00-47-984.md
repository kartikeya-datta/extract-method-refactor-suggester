error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12898.java
text:
```scala
a@@ssertEquals("The name or regex attribute is required", be1.getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12898.java