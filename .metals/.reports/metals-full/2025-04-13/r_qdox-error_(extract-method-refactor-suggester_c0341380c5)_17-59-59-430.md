error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8709.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8709.java
text:
```scala
0.@@25f, -1f, 0.6f,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8709.java