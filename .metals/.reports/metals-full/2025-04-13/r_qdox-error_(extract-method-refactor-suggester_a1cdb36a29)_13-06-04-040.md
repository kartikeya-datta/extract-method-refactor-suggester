error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2091.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2091.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2091.java
text:
```scala
i@@f (newSearcher.getIndexReader().leaves().size() == 1)  {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2091.java