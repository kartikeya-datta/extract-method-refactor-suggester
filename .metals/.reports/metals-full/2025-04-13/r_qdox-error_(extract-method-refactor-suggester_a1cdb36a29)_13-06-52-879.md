error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7011.java
text:
```scala
c@@ommandService[0], evaluationService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7011.java