error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6961.java
text:
```scala
c@@ountRequest.minScore(request.paramAsFloat("minScore", DEFAULT_MIN_SCORE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6961.java