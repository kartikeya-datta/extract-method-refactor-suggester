error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16913.java
text:
```scala
N@@SView child = (NSView) new NSView().alloc().init();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16913.java