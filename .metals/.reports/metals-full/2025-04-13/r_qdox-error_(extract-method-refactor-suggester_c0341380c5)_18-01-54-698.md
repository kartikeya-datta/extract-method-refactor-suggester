error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/105.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/105.java
text:
```scala
public d@@ouble documentWeight(Model model, String label, String[] document);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/105.java