error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10646.java
text:
```scala
S@@tring VIRTUAL_HOST = "virtualhost";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10646.java