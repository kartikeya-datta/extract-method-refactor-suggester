error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5770.java
text:
```scala
S@@erviceName managerServiceName = name.append("distributable");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5770.java