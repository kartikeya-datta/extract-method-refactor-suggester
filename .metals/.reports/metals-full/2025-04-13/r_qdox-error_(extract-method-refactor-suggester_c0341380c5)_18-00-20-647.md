error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14513.java
text:
```scala
p@@rop = prop.substring("openjpa.".length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14513.java