error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4273.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4273.java
text:
```scala
m@@apper = MapperTestUtils.newParser().parse(null, null, defaultMapping);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4273.java