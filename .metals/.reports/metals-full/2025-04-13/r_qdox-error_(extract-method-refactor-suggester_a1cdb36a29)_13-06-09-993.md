error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13255.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13255.java
text:
```scala
final C@@haracterHandler handler = getHandler(ctx.getCharacter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13255.java