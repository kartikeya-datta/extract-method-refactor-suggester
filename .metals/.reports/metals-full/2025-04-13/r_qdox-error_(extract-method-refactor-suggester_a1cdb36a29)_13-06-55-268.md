error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9110.java
text:
```scala
t@@ester.assertContains("src=\"test/wicket:interface/default:0:frame::IResourceListener::\"");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9110.java