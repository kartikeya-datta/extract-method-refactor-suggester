error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4844.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4844.java
text:
```scala
public A@@ssistParser(ProblemReporter problemReporter, long sourceLevel) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4844.java