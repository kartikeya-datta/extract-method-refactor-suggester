error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/294.java
text:
```scala
M@@apperQueryParser queryParser = parseContext.singleQueryParser(qpSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/294.java