error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8574.java
text:
```scala
A@@nalyzeResponse analyzeResponse = client.admin().indices().prepareAnalyze("test", "this is a test").execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8574.java