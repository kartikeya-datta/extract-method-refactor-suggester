error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5482.java
text:
```scala
i@@f((Gdx.input.isKeyPressed(Keys.SPACE) || followButton) && stateTime > 0.5f) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5482.java