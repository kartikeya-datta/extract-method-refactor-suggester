error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5778.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5778.java
text:
```scala
final E@@ngine.Searcher searcher = indexShard.acquireSearcher("term_vector");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5778.java