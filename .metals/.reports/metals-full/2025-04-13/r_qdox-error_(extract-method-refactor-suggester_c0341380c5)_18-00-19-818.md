error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9600.java
text:
```scala
l@@istener.onResponse(new SearchResponse(internalResponse, scrollId, expectedSuccessfulOps, successfulOps.get(), buildTookInMillis(), buildShardFailures()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9600.java