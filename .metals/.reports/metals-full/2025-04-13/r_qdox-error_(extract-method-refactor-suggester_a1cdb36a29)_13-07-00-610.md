error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3447.java
text:
```scala
r@@eturn new UnmodifiableBoundedCollection<E>((BoundedCollection<E>) coll);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3447.java