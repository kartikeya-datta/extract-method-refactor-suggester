error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1760.java
text:
```scala
n@@ew JoglApplication(new StillModelViewer("data/test_section_02.dae", "data/world_blobbie_blocks.png"), "StillModel Viewer", 800, 480, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1760.java