error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15276.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15276.java
text:
```scala
public J@@MDNSDiscoveryContainer(InetAddress addr) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15276.java