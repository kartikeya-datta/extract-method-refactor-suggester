error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7114.java
text:
```scala
r@@eturn new UndoPageVersionManager(page, 20);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7114.java