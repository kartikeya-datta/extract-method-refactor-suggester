error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4938.java
text:
```scala
a@@ssertTrue(FileUtils.getFileUtils().contentEquals(in, out, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4938.java