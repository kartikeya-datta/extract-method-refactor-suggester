error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11945.java
text:
```scala
S@@tring ROLE = AspectHandler.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11945.java