error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4644.java
text:
```scala
c@@ase id.m_random:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4644.java