error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14856.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14856.java
text:
```scala
private L@@ogLevel m_level = LogLevel.INFO;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14856.java