error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6825.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6825.java
text:
```scala
i@@nt[][] intervalToSkip = org.eclipse.jdt.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6825.java