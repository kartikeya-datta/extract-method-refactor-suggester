error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3750.java
...
```java
offset: 27
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3750.java
text:
```scala
public final synchronized v@@oid setMetaData(final MetaDataKey key, final Serializable object)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3750.java