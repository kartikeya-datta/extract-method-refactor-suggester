error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2599.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2599.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2599.java
text:
```scala
r@@eturn new Double(o.toString()).doubleValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2599.java