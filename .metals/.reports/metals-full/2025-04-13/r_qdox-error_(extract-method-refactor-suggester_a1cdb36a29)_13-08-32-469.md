error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3416.java
text:
```scala
t@@hrow new QueryPhaseExecutionException(searchContext, "", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3416.java