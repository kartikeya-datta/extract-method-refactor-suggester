error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9568.java
text:
```scala
r@@eturn new Point (width, rbBand.cyMaxChild);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9568.java