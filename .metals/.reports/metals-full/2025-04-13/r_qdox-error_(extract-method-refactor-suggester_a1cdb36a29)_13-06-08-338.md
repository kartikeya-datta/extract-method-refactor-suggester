error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3235.java
text:
```scala
b@@ind(MetaDataIndexStateService.class).asEagerSingleton();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3235.java