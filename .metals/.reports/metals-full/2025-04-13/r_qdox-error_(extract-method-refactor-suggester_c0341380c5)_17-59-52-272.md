error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10211.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10211.java
text:
```scala
private final I@@nfinispanNodeFactory factory;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10211.java