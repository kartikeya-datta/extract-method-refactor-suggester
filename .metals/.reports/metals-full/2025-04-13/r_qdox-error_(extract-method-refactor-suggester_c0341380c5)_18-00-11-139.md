error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3665.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3665.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3665.java
text:
```scala
i@@f (dataCenter.equals(localDataCenter))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3665.java