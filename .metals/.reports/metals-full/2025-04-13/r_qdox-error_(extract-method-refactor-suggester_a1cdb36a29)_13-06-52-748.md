error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/511.java
text:
```scala
t@@hrow StandardException.newException(SQLState.NO_CURRENT_ROW);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/511.java