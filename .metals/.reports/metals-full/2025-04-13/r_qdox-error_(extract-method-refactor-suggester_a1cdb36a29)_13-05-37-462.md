error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9370.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9370.java
text:
```scala
public static final i@@nt DEFAULT_METHOD_THROWS_CLAUSE_ALIGNMENT = Alignment.M_COMPACT_SPLIT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9370.java