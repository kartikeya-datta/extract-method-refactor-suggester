error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3895.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3895.java
text:
```scala
t@@hrow new RuntimeException("Expected a EJBTransactionRequiredException");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3895.java