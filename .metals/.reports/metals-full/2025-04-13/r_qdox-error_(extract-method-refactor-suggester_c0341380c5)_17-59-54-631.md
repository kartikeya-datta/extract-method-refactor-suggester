error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5990.java
text:
```scala
r@@eturn OS.objc_msgSend(this.id, OS.sel_runModalForWindow_, theWindow != null ? theWindow.id : 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5990.java