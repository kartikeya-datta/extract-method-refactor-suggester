error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8231.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8231.java
text:
```scala
private static final P@@attern VALID_KEY_PATTERN = Pattern.compile("\\*{2}+|[_a-zA-Z](?:[-_a-zA-Z0-9]*[_a-zA-Z0-9])?");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8231.java