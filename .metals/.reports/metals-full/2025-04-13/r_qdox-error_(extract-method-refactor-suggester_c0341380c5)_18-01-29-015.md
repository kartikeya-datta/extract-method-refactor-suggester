error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12752.java
text:
```scala
m@@arkupStream.skipComponent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12752.java