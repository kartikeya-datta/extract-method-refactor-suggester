error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9684.java
text:
```scala
i@@f (((ClassScope) scope).detectHierarchyCycle(currentType, this, argTypes))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9684.java