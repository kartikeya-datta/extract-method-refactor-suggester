error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7128.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7128.java
text:
```scala
public v@@oid testMacrodefWrappedTask() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7128.java