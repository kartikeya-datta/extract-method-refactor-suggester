error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4133.java
text:
```scala
s@@erviceTarget.addService(moduleContextServiceName.append("ModuleName"), moduleNameBinder).addDependency(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4133.java