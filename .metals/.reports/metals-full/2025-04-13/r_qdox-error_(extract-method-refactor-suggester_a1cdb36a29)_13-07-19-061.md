error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14006.java
text:
```scala
v@@oid init(IAppletServer server, Container container, Object model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14006.java