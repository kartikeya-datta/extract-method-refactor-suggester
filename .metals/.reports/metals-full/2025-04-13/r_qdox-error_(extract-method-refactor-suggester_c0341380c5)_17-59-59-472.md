error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6576.java
text:
```scala
E@@TC1.encodeImagePKM(pixmap).write(new FileHandle(inputFile.outputFile));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6576.java