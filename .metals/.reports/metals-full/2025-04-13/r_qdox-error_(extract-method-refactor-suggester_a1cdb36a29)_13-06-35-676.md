error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8810.java
text:
```scala
r@@eturn null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8810.java