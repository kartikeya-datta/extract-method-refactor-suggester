error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2935.java
text:
```scala
r@@eturn LibrarySession.get().isSignedIn();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2935.java