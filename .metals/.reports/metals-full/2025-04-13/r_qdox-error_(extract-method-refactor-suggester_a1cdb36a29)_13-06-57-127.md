error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1227.java
text:
```scala
c@@ontextSnapshot = realHandlerService.getFullContextSnapshot();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1227.java