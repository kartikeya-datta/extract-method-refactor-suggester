error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6915.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6915.java
text:
```scala
public C@@omponentFeedbackPanel(MarkupContainer parent,String id, Component filter)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6915.java