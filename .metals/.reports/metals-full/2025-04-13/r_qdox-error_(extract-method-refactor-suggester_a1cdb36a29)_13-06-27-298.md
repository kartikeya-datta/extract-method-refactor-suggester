error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8347.java
text:
```scala
T@@ransformUtils.scaleArray(x, FastMath.sqrt(0.5 * (x.length-1)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8347.java