error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13397.java
text:
```scala
P@@oint pt = getParent().toDisplay (location.x, location.y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13397.java