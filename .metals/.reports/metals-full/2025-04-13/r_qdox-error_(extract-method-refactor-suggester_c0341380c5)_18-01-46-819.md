error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1046.java
text:
```scala
d@@eclare warning : initialization(*.new(..)) : "just-init";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1046.java