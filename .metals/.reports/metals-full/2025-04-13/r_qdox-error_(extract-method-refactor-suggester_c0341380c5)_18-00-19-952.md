error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12017.java
text:
```scala
I@@terator< ? extends IBehavior> tagBehaviors = tag.getBehaviors();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12017.java