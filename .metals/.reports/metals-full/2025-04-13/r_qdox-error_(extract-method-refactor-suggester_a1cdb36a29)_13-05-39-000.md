error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14077.java
text:
```scala
n@@ewControllers.addAll(LoggerAssignHandler.addHandlers(HANDLERS, model, context, name, verificationHandler));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14077.java