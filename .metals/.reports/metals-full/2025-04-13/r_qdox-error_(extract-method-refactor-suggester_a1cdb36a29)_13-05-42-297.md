error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2155.java
text:
```scala
M@@essage msg = new Message(host, StorageService.Verb.REPLICATION_FINISHED, new byte[0], MessagingService.version_);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2155.java