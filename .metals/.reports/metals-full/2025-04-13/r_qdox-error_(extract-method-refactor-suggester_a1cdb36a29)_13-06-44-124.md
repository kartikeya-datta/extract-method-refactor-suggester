error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4604.java
text:
```scala
i@@f (rowSelected >=0 && rowSelected < table.getRowCount()-1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4604.java