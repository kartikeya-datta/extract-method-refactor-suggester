error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1408.java
text:
```scala
C@@onfiguration config = getConfiguration();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1408.java