error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3923.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3923.java
text:
```scala
public v@@oid setSymbol(final String symbol)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3923.java