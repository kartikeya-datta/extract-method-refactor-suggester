error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5233.java
text:
```scala
p@@ercolateRequestBuilder.setSortByScore(true).setSize(numQueries);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5233.java