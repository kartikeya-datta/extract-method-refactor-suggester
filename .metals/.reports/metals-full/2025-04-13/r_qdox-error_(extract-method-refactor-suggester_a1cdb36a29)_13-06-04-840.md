error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4973.java
text:
```scala
P@@atchingTasks.rollback(info.original.getPatchId(), info.original.getModifications(), info.rollback.getModifications(), foo, ContentItemFilter.MISC_ONLY, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4973.java