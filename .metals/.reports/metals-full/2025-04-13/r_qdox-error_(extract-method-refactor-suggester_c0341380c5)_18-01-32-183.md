error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8624.java
text:
```scala
w@@asPaused = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8624.java