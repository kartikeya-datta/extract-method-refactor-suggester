error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2551.java
text:
```scala
t@@exture = new Texture(Gdx.files.internal("data/resource1.jpg"), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2551.java