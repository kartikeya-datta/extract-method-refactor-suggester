error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1253.java
text:
```scala
F@@ile path = _TestUtil.createTempFile("mmap" + chunkSize, "tmp", workDir);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1253.java