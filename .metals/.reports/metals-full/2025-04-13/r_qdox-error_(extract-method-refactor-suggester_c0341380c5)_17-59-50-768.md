error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6392.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6392.java
text:
```scala
final S@@tring configPropertyValue = XADATASOURCE_PROPERTY_VALUE.resolveModelAttribute(context, recoveryEnvModel).asString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6392.java