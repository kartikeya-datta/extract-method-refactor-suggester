error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/630.java
text:
```scala
t@@ry { getDeployer().deployType( Task.ROLE, name, file ); }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/630.java