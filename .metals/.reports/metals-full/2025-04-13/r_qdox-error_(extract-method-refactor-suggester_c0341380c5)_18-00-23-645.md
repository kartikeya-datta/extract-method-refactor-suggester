error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4307.java
text:
```scala
i@@f (entry.bytes().bytes().length() > BYTES_LIMIT) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4307.java