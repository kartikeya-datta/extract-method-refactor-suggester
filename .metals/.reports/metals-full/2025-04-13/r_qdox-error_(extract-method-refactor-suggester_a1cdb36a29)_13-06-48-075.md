error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8452.java
text:
```scala
r@@eturn !controller.getAccountItem().getPopItem()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8452.java