error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/94.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/94.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/94.java
text:
```scala
i@@f (IndexManager.VERBOSE) System.out.println("-> merging index : "+index.getIndexFile()); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/94.java