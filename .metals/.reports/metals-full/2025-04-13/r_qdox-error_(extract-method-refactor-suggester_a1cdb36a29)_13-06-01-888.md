error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17552.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[47,80]

error in qdox parser
file content:
```java
offset: 1553
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17552.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17552.java