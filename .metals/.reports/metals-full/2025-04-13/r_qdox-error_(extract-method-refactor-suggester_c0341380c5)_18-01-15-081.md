error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6142.java
text:
```scala
s@@cope.problemReporter().cannotUseSuperInCodeSnippet(this.sourceStart, this.sourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6142.java