error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9964.java
text:
```scala
t@@his.compoundName = new char[][] {getKey().toCharArray()};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9964.java