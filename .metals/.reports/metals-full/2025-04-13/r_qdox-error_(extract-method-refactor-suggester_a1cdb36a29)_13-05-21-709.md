error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5121.java
text:
```scala
r@@eturn getResolvedSignature().getGenericReturnType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5121.java