error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13596.java
text:
```scala
T@@argetSource getTargetSource(Class<?> beanClass, String beanName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13596.java