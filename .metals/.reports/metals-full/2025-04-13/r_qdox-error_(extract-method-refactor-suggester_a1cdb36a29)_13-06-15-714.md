error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1506.java
text:
```scala
e@@lse if (!pattern1.contains("{") && match(pattern1, pattern2)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1506.java