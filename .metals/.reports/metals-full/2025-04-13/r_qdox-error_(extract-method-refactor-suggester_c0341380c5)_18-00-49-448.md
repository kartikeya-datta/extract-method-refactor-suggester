error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1911.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1911.java
text:
```scala
private final M@@ap nestedComponents = new HashMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1911.java