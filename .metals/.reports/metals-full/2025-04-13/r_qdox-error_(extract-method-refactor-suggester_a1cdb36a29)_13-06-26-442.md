error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9817.java
text:
```scala
l@@ineEnd = nextStart - 1; // If no characters to break, show all.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9817.java