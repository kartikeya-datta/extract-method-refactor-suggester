error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10156.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10156.java
text:
```scala
public o@@rg.elasticsearch.index.fielddata.FieldDataType fieldDataType() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10156.java