error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9239.java
text:
```scala
v@@folder.getConfiguration().setInteger("property", "source_uid",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9239.java