error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1048.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1048.java
text:
```scala
protected v@@oid consumeTypeParameter1() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1048.java