error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2384.java
text:
```scala
G@@dxTest test = new InputTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2384.java