error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9969.java
text:
```scala
d@@oHandle(ctx);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9969.java