error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9785.java
text:
```scala
i@@f (drop == isDropped () || !isVisible()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9785.java