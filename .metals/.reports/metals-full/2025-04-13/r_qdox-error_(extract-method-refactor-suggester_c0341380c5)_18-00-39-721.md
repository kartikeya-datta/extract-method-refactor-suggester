error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9191.java
text:
```scala
K@@eyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.CTRL_MASK),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9191.java