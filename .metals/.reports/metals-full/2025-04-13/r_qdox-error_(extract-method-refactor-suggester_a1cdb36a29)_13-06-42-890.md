error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6681.java
text:
```scala
r@@esourceRegistration.registerSubModel(new StateTransferResource());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6681.java