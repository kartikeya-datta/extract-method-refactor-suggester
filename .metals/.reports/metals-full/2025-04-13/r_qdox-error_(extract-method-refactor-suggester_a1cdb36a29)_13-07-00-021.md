error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2003.java
text:
```scala
l@@ookup = new SearchLookup(mapperService(), indexCache().fieldData(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2003.java