error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9042.java
text:
```scala
b@@yte [] key, byte other[])
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9042.java