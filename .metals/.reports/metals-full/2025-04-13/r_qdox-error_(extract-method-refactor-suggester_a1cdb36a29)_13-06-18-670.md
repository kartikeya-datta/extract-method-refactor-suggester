error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17644.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[143,2]

error in qdox parser
file content:
```java
offset: 4401
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17644.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17644.java