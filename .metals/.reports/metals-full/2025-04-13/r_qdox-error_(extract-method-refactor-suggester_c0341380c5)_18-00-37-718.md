error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15709.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15709.java
text:
```scala
"&amp;" + g@@etInputName()).append("=").append(id).append("';\"");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15709.java