error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/969.java
text:
```scala
T@@HRESHOLD = cfs.getMemtableThroughputInMB() * 1024L * 1024L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/969.java