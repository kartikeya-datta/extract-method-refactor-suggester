error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/276.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/276.java
text:
```scala
public v@@oid sendMail(String from, List<String> vEmails, String subject, String attText, String smtpHost)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/276.java