error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8539.java
text:
```scala
g@@etSettings().configure("development", "src/java");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8539.java