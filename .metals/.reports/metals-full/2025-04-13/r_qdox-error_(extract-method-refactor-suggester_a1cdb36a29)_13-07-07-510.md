error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7021.java
text:
```scala
l@@ong count = Lucene.count(searcher, mltQuery);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7021.java