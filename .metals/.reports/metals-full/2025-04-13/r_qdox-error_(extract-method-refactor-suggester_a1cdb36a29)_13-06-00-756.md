error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1700.java
text:
```scala
G@@dx.gl = Gdx.gl20;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1700.java