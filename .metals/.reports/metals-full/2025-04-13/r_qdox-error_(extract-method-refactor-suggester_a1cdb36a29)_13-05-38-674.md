error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3488.java
text:
```scala
A@@ppender out = new ConsoleAppender(layout, ConsoleAppender.SYSTEM_OUT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3488.java