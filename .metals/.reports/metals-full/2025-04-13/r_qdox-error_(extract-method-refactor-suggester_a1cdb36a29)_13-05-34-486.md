error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3011.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3011.java
text:
```scala
private static final S@@tring HTTP_RETRIEVE = "http://ftp.osuosl.org/pub/eclipse/rt/ecf/3.2/3.6/site.p2/features/org.eclipse.ecf.core_3.2.0.v20100219-1253.jar";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3011.java