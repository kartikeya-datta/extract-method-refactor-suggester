error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12332.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12332.java
text:
```scala
+ "|(?:EMBED|OBJECT)" + S@@EP + "(?:SRC|CODEBASE|DATA)" + VALUE
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12332.java