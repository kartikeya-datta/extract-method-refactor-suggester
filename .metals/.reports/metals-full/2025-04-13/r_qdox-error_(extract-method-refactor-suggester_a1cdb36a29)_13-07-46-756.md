error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16318.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16318.java
text:
```scala
s@@etModel(new CompoundPropertyModel<Input>(input));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16318.java