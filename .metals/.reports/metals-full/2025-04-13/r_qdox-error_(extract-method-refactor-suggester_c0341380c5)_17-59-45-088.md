error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10070.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10070.java
text:
```scala
r@@equestCycle.setRequestTarget(EmptyRequestTarget.getInstance());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10070.java