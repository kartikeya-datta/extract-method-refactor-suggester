error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3776.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3776.java
text:
```scala
r@@eturn wrapSmartNameFilter(filter, smartNameFieldMappers, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3776.java