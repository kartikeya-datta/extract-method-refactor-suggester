error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9550.java
text:
```scala
S@@lider slider = new Slider(0, 100, 100, false, skin);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9550.java