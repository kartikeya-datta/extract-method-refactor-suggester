error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15066.java
text:
```scala
L@@ist<String> arguments = ctx.getParsedArguments().getOtherArguments();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15066.java