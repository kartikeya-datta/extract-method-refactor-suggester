error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2105.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2105.java
text:
```scala
public final static i@@nt defaultPrefixLength = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2105.java