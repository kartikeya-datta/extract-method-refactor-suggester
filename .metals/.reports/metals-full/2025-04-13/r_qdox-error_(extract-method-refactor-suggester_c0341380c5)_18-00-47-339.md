error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6547.java
text:
```scala
i@@f (scope.compilerOptions().originalSourceLevel >= ClassFileConstants.JDK1_5) { // below 1.5, already reported as syntax error
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6547.java