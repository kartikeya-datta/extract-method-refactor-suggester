error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12654.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12654.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12654.java
text:
```scala
protected P@@atchingTestStepBuilder internalAddModification(ContentModification modification) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12654.java