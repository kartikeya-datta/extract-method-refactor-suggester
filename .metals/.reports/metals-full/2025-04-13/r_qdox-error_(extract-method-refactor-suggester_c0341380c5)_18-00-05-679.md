error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16412.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16412.java
text:
```scala
public synchronized v@@oid setParameters(Collection parameters)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16412.java