error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1273.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1273.java
text:
```scala
b@@tRigidBody body = btRigidBody.upcast(objs.at(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1273.java