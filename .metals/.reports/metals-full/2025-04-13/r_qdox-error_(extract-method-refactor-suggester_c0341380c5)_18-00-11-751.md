error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3238.java
text:
```scala
d@@eploymentManager = ServerDeploymentManager.Factory.create(address, PORT, callbackHandler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3238.java