error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5942.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5942.java
text:
```scala
private final J@@TextField filename = new JTextField(10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5942.java