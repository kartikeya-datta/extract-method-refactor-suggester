error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1016.java
text:
```scala
t@@his.startPosOffset = buffer.length();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1016.java