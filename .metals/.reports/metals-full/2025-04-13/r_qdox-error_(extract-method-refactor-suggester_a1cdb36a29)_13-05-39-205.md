error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1032.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1032.java
text:
```scala
@Override protected v@@oid draw (SpriteBatch batch, float parentAlpha) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1032.java