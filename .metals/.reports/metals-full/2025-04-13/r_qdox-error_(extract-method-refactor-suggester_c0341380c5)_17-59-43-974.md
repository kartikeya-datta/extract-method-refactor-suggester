error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1678.java
text:
```scala
D@@ocsEnum de = _TestUtil.docs(random(), reader, "foo", new BytesRef("test"), null, null, DocsEnum.FLAG_FREQS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1678.java