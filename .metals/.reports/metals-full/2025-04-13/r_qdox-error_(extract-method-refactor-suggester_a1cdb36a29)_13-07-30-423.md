error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6770.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6770.java
text:
```scala
@Override public G@@eoDistanceSortBuilder order(SortOrder order) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6770.java