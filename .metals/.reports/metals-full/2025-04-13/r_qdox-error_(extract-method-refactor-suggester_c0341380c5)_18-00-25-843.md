error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6821.java
text:
```scala
t@@hrow new AbortType(this.scope.referenceCompilationUnit().compilationResult, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6821.java