error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1055.java
text:
```scala
r@@eturn delegate.requireChild(element);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1055.java