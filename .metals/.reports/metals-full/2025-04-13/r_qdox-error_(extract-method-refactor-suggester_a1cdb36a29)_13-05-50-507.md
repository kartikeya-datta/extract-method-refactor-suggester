error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7366.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7366.java
text:
```scala
private L@@ist<AggregatorFactory> factories = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7366.java