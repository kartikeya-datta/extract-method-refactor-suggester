error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14119.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14119.java
text:
```scala
private static final b@@oolean RECOMPUTE_TABLES_AT_RUNTIME = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14119.java