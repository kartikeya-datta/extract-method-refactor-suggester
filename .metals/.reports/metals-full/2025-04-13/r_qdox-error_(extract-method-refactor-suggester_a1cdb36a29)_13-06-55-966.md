error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3616.java
text:
```scala
i@@f (!control.isDisposed() && !control.getSize().equals(ZERO)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3616.java