error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10022.java
text:
```scala
a@@ssertThat(clusterState.getRoutingNodes().node("NODE_" + i).size(), Matchers.anyOf(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10022.java