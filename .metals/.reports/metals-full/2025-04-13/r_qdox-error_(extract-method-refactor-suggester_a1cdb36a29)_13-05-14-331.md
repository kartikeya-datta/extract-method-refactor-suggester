error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8642.java
text:
```scala
i@@f (rawTypeBinding.genericType().isBinaryBinding()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8642.java