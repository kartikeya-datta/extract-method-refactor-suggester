error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11147.java
text:
```scala
a@@ddAsWebInfResource(ServiceIface.class.getPackage(), "wsdl/SecurityService-sign.wsdl", "wsdl/SecurityService.wsdl").
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11147.java