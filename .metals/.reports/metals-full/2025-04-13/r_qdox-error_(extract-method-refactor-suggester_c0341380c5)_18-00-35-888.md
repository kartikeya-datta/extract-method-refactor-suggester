error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6122.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6122.java
text:
```scala
T@@estUtils.assertEquals(testVector, m.operate(new ArrayFieldVector<Fraction>(testVector)).toArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6122.java