error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5002.java
text:
```scala
i@@f (editor == null && conversionService != null && convertedValue != null && typeDescriptor != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5002.java