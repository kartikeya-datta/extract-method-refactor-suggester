error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3793.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3793.java
text:
```scala
public v@@oid startExternalSubset(XMLResourceIdentifier identifier,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3793.java