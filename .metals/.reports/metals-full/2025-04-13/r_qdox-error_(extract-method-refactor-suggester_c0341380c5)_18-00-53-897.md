error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/44.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/44.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/44.java
text:
```scala
i@@f (!Signature.getReturnType(method.getSignature()).equals("V")) { //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/44.java