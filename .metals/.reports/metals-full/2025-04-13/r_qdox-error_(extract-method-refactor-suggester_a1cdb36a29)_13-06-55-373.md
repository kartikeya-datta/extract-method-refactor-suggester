error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8536.java
text:
```scala
i@@f (!routingNodes.routingTable().index(shard.index()).shard(shard.id()).primaryAllocatedPostApi()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8536.java