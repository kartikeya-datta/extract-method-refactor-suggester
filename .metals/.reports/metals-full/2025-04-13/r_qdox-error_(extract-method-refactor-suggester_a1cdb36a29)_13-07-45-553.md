error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4997.java
text:
```scala
r@@eturn stateEstimation.toArray();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4997.java