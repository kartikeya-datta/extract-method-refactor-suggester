error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18169.java
text:
```scala
r@@eturn new QueryBuilderImpl(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18169.java