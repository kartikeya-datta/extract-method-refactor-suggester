error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4656.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4656.java
text:
```scala
i@@f (cfiles != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4656.java