error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2604.java
text:
```scala
C@@onfigHelper.setColumnFamily(job.getConfiguration(), KEYSPACE, COLUMN_FAMILY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2604.java