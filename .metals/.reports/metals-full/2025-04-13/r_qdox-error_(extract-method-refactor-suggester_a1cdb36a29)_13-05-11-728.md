error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8618.java
text:
```scala
c@@am.getPosition().set(WIDTH*32/2, HEIGHT*32/2,0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8618.java