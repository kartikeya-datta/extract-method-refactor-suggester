error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4142.java
text:
```scala
s@@ession = getSessionFactory().newSession(request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4142.java