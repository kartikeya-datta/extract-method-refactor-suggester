error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/566.java
text:
```scala
i@@f (args.length >= 2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/566.java