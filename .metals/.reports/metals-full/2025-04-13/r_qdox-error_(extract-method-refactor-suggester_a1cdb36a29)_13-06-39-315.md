error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6774.java
text:
```scala
a@@ctivate(deploymentName, runtimeName, deploymentHash, deploymentServiceName, new ServiceActivatorContextImpl(batchBuilder, serviceContainer), serviceContainer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6774.java