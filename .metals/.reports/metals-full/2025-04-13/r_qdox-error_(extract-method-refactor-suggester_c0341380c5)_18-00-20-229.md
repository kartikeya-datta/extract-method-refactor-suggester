error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6989.java
text:
```scala
c@@ontext.setTypeConverter(new StandardTypeConverter(conversionService));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6989.java