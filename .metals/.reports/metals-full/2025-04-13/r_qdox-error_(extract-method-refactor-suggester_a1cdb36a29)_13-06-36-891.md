error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5172.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5172.java
text:
```scala
protected final R@@andom random;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5172.java