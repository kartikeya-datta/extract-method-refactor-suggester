error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/236.java
text:
```scala
r@@eturn Double.longBitsToDouble(readLong());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/236.java