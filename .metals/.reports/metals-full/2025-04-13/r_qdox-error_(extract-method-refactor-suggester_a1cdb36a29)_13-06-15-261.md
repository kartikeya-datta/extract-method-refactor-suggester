error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/873.java
text:
```scala
a@@dd(new Label("style", session.getStyle() == null ? "[None]" : session.getStyle()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/873.java