error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9908.java
...
```java
offset: 869
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9908.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9908.java