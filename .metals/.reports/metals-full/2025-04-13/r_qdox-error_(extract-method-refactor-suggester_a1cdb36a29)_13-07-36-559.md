error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12528.java
text:
```scala
r@@eturn TypeDescriptor.nullSafeAnnotations(this.field.getAnnotations());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12528.java