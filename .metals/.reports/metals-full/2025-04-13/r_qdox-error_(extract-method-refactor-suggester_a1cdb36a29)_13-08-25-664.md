error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2477.java
text:
```scala
s@@b.append(expire);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2477.java