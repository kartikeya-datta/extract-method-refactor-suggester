error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3087.java
text:
```scala
M@@ap codeFormatterOptionsMap = DefaultCodeFormatterConstants.getJavaConventionsSettings(); // code formatter defaults
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3087.java