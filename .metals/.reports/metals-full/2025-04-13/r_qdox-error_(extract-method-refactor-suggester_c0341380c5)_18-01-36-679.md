error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1113.java
text:
```scala
p@@ublic class EnhancedButton extends RolloverButton
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1113.java