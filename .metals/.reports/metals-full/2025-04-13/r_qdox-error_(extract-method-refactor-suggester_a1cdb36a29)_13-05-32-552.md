error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7876.java
text:
```scala
i@@nt widgetClass = OS.applicationShellWidgetClass ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7876.java