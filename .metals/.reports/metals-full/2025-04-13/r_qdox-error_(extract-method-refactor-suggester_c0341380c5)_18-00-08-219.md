error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4586.java
text:
```scala
a@@s.addAll(AtAjAttributes.readAj5FieldAttributes(field, this, world.resolve(getDeclaringType()), getSourceContext(world), world.getMessageHandler()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4586.java