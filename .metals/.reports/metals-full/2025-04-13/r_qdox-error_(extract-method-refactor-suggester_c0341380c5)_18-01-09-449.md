error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2659.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2659.java
text:
```scala
static S@@tring forType(String alias) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2659.java