error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1883.java
text:
```scala
r@@eturn this.children.length != 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1883.java