error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17358.java
text:
```scala
p@@ublic class BookmarkablePageLink extends Link
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17358.java