error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10423.java
text:
```scala
i@@f (modelObject != null && !(modelObject instanceof Collection))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10423.java