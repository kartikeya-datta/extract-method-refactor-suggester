error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/980.java
text:
```scala
s@@erver.enqueue(msgs, e.getRemoteAddress().toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/980.java