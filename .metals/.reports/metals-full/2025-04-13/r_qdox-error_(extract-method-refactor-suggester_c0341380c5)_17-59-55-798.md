error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7034.java
text:
```scala
r@@eturn one.typeVariables != NoTypeVariables && !one.areTypeVariableErasuresEqual(substituteTwo.original());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7034.java