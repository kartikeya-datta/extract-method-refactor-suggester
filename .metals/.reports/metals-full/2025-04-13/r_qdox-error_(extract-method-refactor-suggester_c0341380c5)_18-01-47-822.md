error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15772.java
text:
```scala
b@@aseUrl.url = ConversionUtils.makeRelativeURL(baseUrl.url, baseref);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15772.java