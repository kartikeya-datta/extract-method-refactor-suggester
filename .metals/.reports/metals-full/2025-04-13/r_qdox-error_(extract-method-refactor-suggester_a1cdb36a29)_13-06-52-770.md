error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6373.java
text:
```scala
C@@lassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("org/springframework/context/conversionservice/conversionService.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6373.java