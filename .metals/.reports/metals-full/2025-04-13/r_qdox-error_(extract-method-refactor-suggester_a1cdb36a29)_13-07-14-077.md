error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9870.java
text:
```scala
I@@mageScaleTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9870.java