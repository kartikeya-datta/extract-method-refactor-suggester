error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9893.java
text:
```scala
t@@hrow new QueryPhaseExecutionException(searchContext, "Failed to execute main query", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9893.java