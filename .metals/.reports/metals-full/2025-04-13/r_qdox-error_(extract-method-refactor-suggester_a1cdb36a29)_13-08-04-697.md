error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4761.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4761.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4761.java
text:
```scala
i@@f (checkOwner && cu.isPrimary()) return this;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4761.java