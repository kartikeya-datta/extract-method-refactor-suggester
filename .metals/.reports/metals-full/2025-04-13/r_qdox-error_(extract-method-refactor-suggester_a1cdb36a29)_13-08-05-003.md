error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7948.java
text:
```scala
m@@ultiGetRequest.add(request.param("index"), request.param("type"), sFields, defaultFetchSource, request.param("routing"), request.content(), allowExplicitIndex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7948.java