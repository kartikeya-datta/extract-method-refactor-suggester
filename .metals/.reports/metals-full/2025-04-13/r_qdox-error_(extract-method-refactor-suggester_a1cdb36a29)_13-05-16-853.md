error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4633.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4633.java
text:
```scala
public v@@oid marshallAsElement(ModelNode resourceModel, final boolean marshalDefault, XMLStreamWriter writer)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4633.java