error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1666.java
text:
```scala
C@@omponent component = requestTarget.getTarget();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1666.java