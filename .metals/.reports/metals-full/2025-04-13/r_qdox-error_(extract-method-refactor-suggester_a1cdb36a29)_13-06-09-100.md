error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6499.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[43,2]

error in qdox parser
file content:
```java
offset: 1431
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6499.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6499.java