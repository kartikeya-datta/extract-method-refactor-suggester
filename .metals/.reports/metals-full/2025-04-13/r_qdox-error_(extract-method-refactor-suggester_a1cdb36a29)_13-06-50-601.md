error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/254.java
text:
```scala
i@@nitsOnBreak = initsOnBreak.mergedWith(flowInfo.copy().unconditionalInits());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/254.java