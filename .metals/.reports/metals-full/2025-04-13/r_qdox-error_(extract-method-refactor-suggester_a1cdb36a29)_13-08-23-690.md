error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2755.java
text:
```scala
p@@ublic class SuperColumn implements IColumn, IColumnContainer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2755.java