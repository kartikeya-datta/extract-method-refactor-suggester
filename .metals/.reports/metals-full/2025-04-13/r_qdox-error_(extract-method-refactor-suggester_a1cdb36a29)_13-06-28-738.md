error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3325.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3325.java
text:
```scala
public static final i@@nt TICK_TIME = 1000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3325.java