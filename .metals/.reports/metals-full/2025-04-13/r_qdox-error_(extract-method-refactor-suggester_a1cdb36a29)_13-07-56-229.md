error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1699.java
text:
```scala
O@@nCompletionListener onCompletionListener;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1699.java