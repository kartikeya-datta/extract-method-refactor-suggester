error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2457.java
text:
```scala
B@@ytesStreamInput in = new BytesStreamInput(out.copiedByteArray(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2457.java