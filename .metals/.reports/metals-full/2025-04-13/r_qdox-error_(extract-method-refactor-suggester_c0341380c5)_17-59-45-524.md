error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9971.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9971.java
text:
```scala
private final static i@@nt MARGIN = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9971.java