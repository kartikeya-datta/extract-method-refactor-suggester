error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9954.java
text:
```scala
P@@athAddress address = context.getCurrentAddress();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9954.java