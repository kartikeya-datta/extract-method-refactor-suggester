error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16374.java
text:
```scala
c@@lass DefaultConfigurationState
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16374.java