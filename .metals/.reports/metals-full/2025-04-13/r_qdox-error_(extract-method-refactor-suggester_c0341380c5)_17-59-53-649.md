error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10843.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,108]

error in qdox parser
file content:
```java
offset: 108
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10843.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10843.java