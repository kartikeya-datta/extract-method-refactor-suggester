error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10376.java
text:
```scala
r@@eturn new JMXServiceURL("service:jmx:remoting-jmx://" + mgmtAddress + ":" + mgmtPort);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10376.java