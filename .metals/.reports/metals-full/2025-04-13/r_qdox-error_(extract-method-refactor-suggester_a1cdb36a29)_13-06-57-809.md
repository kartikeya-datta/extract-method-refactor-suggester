error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12356.java
text:
```scala
g@@etResponse().write(element.toCharSequence());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12356.java