error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16473.java
text:
```scala
i@@f (new File(System.getProperty("root"), "src/etc/testcases/taskdefs/optional/junitreport/test/html/junit-noframes.html").exists())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16473.java