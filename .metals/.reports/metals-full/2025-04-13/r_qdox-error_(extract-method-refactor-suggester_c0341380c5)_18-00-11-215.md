error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15388.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15388.java
text:
```scala
public final F@@ormComponent setRequired(final boolean required)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15388.java