error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5204.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5204.java
text:
```scala
u@@pdateSettingsService.updateSettings(request.getSettings(), request.getIndices(), new MetaDataUpdateSettingsService.Listener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5204.java