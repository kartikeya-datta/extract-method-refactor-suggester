error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10447.java
text:
```scala
E@@JB_ANNOTATION_PROPERTY_REPLACEMENT(EeSubsystemRootResource.EJB_ANNOTATION_PROPERTY_REPLACEMENT.getXmlName()),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10447.java