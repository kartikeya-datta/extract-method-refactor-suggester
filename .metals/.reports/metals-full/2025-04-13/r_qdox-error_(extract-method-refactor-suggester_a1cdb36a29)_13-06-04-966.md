error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5429.java
text:
```scala
i@@nt prefixLength = this.compoundName[this.compoundName.length - 1].length + 1; // enclosing$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5429.java