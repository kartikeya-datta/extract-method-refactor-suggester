error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14470.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14470.java
text:
```scala
final S@@erviceController<?> controller = context.getServiceRegistry().getService(DeploymentScannerService.getServiceName(path));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14470.java