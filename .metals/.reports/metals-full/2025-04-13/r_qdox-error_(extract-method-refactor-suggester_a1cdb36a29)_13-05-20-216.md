error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5960.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5960.java
text:
```scala
public T@@reeBidiMapTest(final String testName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5960.java