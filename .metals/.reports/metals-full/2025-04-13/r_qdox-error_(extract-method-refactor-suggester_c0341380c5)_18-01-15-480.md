error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17988.java
text:
```scala
a@@ddProxy("composent.com",3129,"foo\\bar","password");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17988.java