error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2433.java
text:
```scala
C@@ompactionManager.instance.disableAutoCompaction();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2433.java