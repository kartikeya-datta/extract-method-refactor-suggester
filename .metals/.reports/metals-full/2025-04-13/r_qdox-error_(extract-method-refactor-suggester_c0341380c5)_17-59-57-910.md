error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2279.java
text:
```scala
t@@abWidth = Integer.parseInt((String) options.get(DefaultCodeFormatterConstants.FORMATTER_TAB_SIZE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2279.java