error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8357.java
text:
```scala
U@@nresolvedType[] ifBounds = aTypeVariable.getAdditionalInterfaceBounds();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8357.java