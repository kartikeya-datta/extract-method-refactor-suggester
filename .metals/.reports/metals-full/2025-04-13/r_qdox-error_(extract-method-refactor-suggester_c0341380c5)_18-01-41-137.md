error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14202.java
text:
```scala
p@@ublic interface IResourceListener extends IRequestListener
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14202.java