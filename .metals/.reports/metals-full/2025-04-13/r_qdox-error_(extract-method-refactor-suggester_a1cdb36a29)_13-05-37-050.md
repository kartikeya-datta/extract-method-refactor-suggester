error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14168.java
text:
```scala
O@@S.WideCharToMultiByte (getCodePage (), 0, chars, chars.length, bytes, bytes.length, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14168.java