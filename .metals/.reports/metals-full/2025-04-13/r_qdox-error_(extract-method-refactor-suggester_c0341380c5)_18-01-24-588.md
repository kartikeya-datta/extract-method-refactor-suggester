error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6281.java
text:
```scala
r@@eturn getDeclaringType() != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6281.java