error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3943.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3943.java
text:
```scala
private final C@@hunkDecoder decoder;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3943.java