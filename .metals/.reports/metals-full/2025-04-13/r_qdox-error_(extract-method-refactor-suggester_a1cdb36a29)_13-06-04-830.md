error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6712.java
text:
```scala
w@@izard.pack();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6712.java