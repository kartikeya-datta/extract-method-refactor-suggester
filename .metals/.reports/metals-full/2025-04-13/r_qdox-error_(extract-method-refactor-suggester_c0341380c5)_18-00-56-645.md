error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9010.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9010.java
text:
```scala
public b@@oolean isIosIncluded = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9010.java