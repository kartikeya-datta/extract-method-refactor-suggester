error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3878.java
text:
```scala
r@@eturn DoubleArrayAtomicFieldData.empty(reader.maxDoc());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3878.java