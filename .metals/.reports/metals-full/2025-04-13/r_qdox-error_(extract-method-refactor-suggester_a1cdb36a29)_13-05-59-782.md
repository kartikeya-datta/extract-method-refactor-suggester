error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15204.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15204.java
text:
```scala
l@@ong SIZE_UNKNOWN = -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15204.java