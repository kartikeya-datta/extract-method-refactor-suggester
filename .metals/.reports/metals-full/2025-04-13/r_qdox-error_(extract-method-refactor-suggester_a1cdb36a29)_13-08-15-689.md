error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9312.java
text:
```scala
s@@+= ">";//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9312.java