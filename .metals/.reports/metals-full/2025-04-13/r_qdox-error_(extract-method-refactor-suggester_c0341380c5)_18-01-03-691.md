error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14532.java
text:
```scala
O@@bjects.cloneModel((Serializable)cloneMe);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14532.java