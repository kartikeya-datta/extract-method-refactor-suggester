error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11324.java
text:
```scala
p@@ublic class ContextImage extends WebComponent
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11324.java