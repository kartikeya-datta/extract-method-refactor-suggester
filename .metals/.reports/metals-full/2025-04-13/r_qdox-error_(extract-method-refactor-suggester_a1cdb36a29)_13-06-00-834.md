error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15024.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15024.java
text:
```scala
private static final S@@tring FILEVERSION = "327020";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15024.java