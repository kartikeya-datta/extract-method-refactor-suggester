error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13816.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13816.java
text:
```scala
i@@nt grow = redraw ? 4 : Math.max (4, items.length * 3 / 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13816.java