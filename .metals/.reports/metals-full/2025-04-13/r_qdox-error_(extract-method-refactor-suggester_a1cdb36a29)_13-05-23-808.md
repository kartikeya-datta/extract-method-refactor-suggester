error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5048.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5048.java
text:
```scala
protected final M@@arkupStream getAssociatedMarkupStream()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5048.java