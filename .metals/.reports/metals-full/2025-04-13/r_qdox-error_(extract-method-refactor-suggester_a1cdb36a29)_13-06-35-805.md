error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15047.java
text:
```scala
t@@his.wsSession = this.client.doHandshake(new TextWebSocketHandlerAdapter(), headers, new URI(this.wsUrl)).get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15047.java