error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2104.java
text:
```scala
t@@hrow new IndexOutOfBoundsException("argument [page]="+page+", must be 0<=page<="+getPageCount());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2104.java