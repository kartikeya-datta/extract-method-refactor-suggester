error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13786.java
text:
```scala
r@@eturn "#BeanWithSimpleInjected#" + context.proceed();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13786.java