error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4719.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4719.java
text:
```scala
public static final i@@nt sizeof = OS.SCRIPT_PROPERTIES_sizeof ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4719.java