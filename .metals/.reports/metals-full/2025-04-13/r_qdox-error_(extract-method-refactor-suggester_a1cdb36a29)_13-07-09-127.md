error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1798.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1798.java
text:
```scala
@Override public O@@bject getValue(Object test) throws CouldNotGenerateValueException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1798.java