error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14452.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14452.java
text:
```scala
public T@@reeRow(String componentName, Tree tree, TreeNodeModel nodeModel)
...
public final class TreeRow extends Panel
{
     ...
     */
    public TreeRow(String componentName, Tree tree, NodeModel nodeModel)
    {
        super(componentName);
        if(nodeModel != null)
        {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14452.java