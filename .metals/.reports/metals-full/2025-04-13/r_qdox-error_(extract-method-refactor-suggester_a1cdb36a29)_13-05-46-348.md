error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8248.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8248.java
text:
```scala
n@@ew Rfc822Parser().parse(decryptedBodyPart, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8248.java