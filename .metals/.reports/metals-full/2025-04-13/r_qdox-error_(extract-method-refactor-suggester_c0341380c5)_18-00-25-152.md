error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3772.java
text:
```scala
r@@eturn "ecftcp://<server>:<port>/<groupname>";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3772.java