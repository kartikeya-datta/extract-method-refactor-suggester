error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10950.java
text:
```scala
S@@tringBuilder tmp = new StringBuilder("NEW ").append(_cls.getName())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10950.java