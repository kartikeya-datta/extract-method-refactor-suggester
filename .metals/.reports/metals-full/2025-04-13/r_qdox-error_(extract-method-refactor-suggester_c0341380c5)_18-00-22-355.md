error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12899.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(ModClusterLogger.ROOT_LOGGER.contextOrHostNotFound(webHost, webContext)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12899.java