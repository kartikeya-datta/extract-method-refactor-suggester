error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3201.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3201.java
text:
```scala
S@@tring testLstFile = AjdeTests.TESTDATA_PATH + "/StructureModelRegressionTest/example.lst";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3201.java