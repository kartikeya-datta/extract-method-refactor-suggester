error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15161.java
text:
```scala
I@@D serverID = IDFactory.getDefault().createStringID("ecftcp://localhost:3282/server"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15161.java