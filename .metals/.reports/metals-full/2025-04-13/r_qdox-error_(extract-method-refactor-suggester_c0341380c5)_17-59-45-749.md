error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2769.java
text:
```scala
b@@oolean isSuper = cfDef.column_type.equals("Super");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2769.java