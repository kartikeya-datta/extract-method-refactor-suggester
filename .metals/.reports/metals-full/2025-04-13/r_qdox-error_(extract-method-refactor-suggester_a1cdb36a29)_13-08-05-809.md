error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8433.java
text:
```scala
i@@f (!getWorkbenchConfigurer().getSaveAndRestore()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8433.java