error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2339.java
text:
```scala
v@@oid setResourceStreamFactory(IResourceStreamFactory resourceStreamFactory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2339.java