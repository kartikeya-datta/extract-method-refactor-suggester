error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12663.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12663.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12663.java
text:
```scala
public v@@oid handleRequestInternal(ServerHttpRequest request, ServerHttpResponse response,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12663.java