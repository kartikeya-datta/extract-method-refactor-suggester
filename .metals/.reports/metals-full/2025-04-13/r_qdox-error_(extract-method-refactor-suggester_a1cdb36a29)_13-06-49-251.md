error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1876.java
text:
```scala
r@@esult = new LowerCaseFilter(matchVersion, result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1876.java