error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3699.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3699.java
text:
```scala
final i@@nt elements = scaledRandomIntBetween(100, 1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3699.java