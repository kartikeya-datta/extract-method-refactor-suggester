error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7598.java
text:
```scala
t@@ranslog.add(new Translog.DeleteByQuery(new byte[]{4}, null, null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7598.java