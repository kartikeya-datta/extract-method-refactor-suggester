error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9873.java
text:
```scala
i@@f (offset == lineEnd) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9873.java