error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1402.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh("post_gateway").force(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1402.java