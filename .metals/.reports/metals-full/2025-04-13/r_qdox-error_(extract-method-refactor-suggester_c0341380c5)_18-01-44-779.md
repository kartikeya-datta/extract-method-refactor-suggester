error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1749.java
text:
```scala
R@@elativePathService.addService(pathService, path, false, relativeTo, serviceTarget, newControllers, listeners);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1749.java