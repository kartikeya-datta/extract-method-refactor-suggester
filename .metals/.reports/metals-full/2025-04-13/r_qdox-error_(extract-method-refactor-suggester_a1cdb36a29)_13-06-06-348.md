error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9452.java
text:
```scala
i@@f (auditManager != null && !mergedMetaData.isDisableAudit()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9452.java