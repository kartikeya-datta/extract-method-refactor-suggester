error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1782.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1782.java
text:
```scala
public i@@nt getSize();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1782.java