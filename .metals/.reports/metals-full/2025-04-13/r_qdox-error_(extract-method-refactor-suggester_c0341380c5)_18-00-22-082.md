error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4986.java
text:
```scala
l@@ocator,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4986.java