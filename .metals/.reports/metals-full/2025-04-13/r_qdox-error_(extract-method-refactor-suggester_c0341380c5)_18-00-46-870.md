error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9250.java
text:
```scala
F@@ieldMapper mapper = context.smartNameFieldMapper(fieldsNames[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9250.java