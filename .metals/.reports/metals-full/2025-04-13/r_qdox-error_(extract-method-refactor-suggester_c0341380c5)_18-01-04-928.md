error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15592.java
text:
```scala
n@@ew MyLabel(new MockPageWithOneComponent(), "component");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15592.java