error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6311.java
text:
```scala
i@@f (methDecl.isMethod()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6311.java