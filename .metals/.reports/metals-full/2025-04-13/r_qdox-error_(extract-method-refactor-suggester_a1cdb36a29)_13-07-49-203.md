error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12430.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12430.java
text:
```scala
M@@oduleDependency dependency = new ModuleDependency(moduleLoader, POJO_MODULE, false, false, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12430.java