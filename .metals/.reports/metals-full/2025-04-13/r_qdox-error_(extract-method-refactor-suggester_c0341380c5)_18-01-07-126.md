error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2172.java
text:
```scala
q@@uery = Queries.newMatchNoDocsQuery();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2172.java