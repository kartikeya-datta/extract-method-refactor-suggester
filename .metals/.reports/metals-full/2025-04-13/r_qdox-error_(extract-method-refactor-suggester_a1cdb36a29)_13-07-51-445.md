error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1223.java
text:
```scala
P@@referenceRegistry(IPreferenceStore preferenceStore) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1223.java