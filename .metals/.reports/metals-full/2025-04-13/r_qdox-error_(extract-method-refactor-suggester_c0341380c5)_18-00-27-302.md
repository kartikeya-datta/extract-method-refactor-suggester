error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7363.java
text:
```scala
c@@ontainer.autoAdd(enclosure, markupStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7363.java