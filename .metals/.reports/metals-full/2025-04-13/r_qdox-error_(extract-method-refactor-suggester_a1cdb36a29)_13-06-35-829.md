error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7493.java
text:
```scala
e@@lse if (isNewPageInstance() == false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7493.java