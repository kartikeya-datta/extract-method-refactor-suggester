error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3626.java
text:
```scala
M@@axCountExceededException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3626.java