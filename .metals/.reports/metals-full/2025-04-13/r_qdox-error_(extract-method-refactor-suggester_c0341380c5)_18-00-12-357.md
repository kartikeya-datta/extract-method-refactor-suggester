error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3788.java
text:
```scala
i@@f (trackedId != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3788.java