error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7996.java
text:
```scala
v@@oid _setVisible (boolean visible) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7996.java