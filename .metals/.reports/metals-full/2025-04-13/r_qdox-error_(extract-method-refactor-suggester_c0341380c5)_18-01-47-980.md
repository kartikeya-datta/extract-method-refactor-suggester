error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8317.java
text:
```scala
i@@nt /*long*/ code = OS.CallWindowProc (EditProc, hwnd, msg, wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8317.java