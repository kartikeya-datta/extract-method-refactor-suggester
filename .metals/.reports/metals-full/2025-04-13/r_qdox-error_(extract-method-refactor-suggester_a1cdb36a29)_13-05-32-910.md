error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4093.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4093.java
text:
```scala
v@@erify(mockResponse, times(1)).getOutputStream();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4093.java