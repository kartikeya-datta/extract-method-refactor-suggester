error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/391.java
text:
```scala
b@@uilder.field("_scope", scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/391.java