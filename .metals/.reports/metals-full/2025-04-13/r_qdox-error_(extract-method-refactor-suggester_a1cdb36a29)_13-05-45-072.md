error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7595.java
text:
```scala
n@@ew JoglApplication(new SkeletonModelViewer("data/robot-mesh.xml", "data/robot.jpg"), "SkeletonModel Viewer", 800, 480, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7595.java