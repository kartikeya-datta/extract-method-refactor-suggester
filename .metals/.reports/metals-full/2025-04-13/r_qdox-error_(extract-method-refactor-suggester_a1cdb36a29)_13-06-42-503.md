error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6991.java
text:
```scala
a@@ssertTrue(DiffUtil.validatePage(document, this.getClass(), "PagedTablePageExpectedResult.html"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6991.java