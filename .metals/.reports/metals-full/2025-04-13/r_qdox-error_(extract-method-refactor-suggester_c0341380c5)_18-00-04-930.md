error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4222.java
text:
```scala
v@@iewer = new ProgressViewer(root, SWT.NO_FOCUS,5, 72) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4222.java