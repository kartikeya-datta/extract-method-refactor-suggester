error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9609.java
text:
```scala
c@@ontext.getServiceBuilder().addListener(new ModuleRemoveListener(deploymentModuleLoader, module));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9609.java