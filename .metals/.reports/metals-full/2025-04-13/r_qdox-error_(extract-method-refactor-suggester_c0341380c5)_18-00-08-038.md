error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3368.java
text:
```scala
r@@val = (T) cls.getDeclaredMethod("getInstance").invoke(new Object[] {null, null});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3368.java