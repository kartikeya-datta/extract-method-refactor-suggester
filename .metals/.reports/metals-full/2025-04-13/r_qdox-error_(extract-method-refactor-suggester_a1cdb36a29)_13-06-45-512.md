error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3537.java
text:
```scala
p@@athFilter = constructor.newInstance(conf, keyPrefix, options, writer, charset, fs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3537.java