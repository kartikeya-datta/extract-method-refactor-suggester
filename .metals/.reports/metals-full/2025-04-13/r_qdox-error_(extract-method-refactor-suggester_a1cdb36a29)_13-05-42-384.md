error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1278.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1278.java
text:
```scala
public v@@oid unregisterRemoteHost(String id, Long remoteConnectionId, boolean cleanShutdown) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1278.java