error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8083.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8083.java
text:
```scala
public v@@oid close() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8083.java