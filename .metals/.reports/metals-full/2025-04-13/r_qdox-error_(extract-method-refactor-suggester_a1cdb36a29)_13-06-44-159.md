error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3603.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3603.java
text:
```scala
protected final v@@oid dirty()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3603.java