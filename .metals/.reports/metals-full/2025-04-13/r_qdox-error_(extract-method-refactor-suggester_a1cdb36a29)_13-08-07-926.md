error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9258.java
text:
```scala
c@@onfig.height = 241;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9258.java