error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12690.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12690.java
text:
```scala
private final Q@@Name fAttrQName = new QName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12690.java