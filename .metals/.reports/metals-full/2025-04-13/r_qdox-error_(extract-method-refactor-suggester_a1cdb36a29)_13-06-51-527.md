error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7916.java
text:
```scala
r@@eturn _repos.getMetaData(f.getDeclaringClass(), null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7916.java