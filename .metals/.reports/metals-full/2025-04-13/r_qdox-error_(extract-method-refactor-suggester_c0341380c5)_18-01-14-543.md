error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10176.java
text:
```scala
M@@oveSpriteExample.class, SoundTouchTest.class, Mpg123Test.class, WavTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10176.java