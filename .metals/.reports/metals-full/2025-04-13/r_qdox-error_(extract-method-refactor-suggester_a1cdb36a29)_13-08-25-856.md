error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15547.java
text:
```scala
C@@olor background = control.getBackgroundColor ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15547.java