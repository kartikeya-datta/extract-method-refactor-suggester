error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5516.java
text:
```scala
i@@ndexShard.start("post recovery from gateway");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5516.java