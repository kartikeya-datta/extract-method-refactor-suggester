error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1807.java
text:
```scala
i@@nt pixel = 0x00000000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1807.java