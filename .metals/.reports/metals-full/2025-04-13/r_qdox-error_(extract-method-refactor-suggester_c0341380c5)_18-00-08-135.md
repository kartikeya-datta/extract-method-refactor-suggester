error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2571.java
text:
```scala
a@@gent_.connection_.CommitAndRollbackListeners_.add(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2571.java