error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3892.java
text:
```scala
t@@hrow new Error("Do not supress me.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3892.java