error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8349.java
text:
```scala
t@@hrow PlatformMBeanMessages.MESSAGES.badReadAttributeImpl8(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8349.java