error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3466.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3466.java
text:
```scala
public f@@loat scorePayload(String fieldName, byte[] payload, int offset, int length) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3466.java