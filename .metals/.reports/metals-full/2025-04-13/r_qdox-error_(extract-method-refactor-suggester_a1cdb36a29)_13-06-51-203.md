error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4382.java
text:
```scala
p@@ublic class NevilleInterpolator implements UnivariateInterpolator,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4382.java