error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4203.java
...
```java
offset: 593
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4203.java
text:
```scala
 ...
 ******************************************************************************/
p@@ackage org.eclipse.ecf.internal.provider.discovery;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4203.java