error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6723.java
text:
```scala
i@@nt COUNT = 2000000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6723.java