error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4945.java
text:
```scala
S@@tring contents = new String(html); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4945.java