error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15891.java
text:
```scala
p@@ublic class FragmentResolver implements IComponentResolver
...
public class InlinePanelResolver implements IComponentResolver
{
			...
			final ComponentTag tag)
	{
		...
		if (tag instanceof WicketTag)
		{
			...
			// If <wicket:fragment ...>
			if (wTag.isFragementTag(markupStream.getWicketNamespace()))
			{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15891.java