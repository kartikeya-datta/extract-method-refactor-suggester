error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2359.java
text:
```scala
c@@olumns.add(new Column(ByteBufferUtil.bytes(columnName)).setValue(columnValue).setTimestamp(System.currentTimeMillis()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2359.java