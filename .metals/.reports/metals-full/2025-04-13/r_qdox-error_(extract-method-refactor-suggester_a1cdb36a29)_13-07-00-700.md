error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/365.java
text:
```scala
S@@tring content = FileUtils.readFully(reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/365.java