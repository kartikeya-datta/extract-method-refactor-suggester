error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15946.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15946.java
text:
```scala
private final i@@nt maxEntries;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15946.java