error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14141.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14141.java
text:
```scala
final M@@ap<String, ?> variables)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14141.java