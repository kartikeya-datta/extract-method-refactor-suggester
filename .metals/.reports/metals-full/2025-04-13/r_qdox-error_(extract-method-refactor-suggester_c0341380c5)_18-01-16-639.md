error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3413.java
text:
```scala
o@@nlyLongestMatch = settings.getAsBoolean("only_longest_match", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3413.java