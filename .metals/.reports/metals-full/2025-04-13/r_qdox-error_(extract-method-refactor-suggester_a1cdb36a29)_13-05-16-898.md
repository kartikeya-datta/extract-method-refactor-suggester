error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1405.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1405.java
text:
```scala
private S@@tring javaVmArguments = System.getProperty("server.jvm.args", "-Xmx512m");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1405.java