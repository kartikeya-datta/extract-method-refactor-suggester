error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2074.java
text:
```scala
F@@ullRunningAverageAndStdDevWritable.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2074.java