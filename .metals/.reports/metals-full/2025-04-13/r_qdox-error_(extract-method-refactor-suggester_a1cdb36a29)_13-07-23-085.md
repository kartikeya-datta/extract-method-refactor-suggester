error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16863.java
text:
```scala
p@@ublic interface IApplicationSettings
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16863.java