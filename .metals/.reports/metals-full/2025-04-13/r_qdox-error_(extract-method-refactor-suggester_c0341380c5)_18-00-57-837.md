error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16066.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16066.java
text:
```scala
...
public abstract class SimplePageAuthorizationStrategy extends AbstractPageAuthorizationStrategy
{
	 ...
	 */
	@Override
	protected <T extends Component<?>> boolean isPageAuthorized(final Class<T> pageClass)
	{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16066.java