error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1924.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1924.java
text:
```scala
s@@uper(componentDescription, viewClassName, methodIntf, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1924.java