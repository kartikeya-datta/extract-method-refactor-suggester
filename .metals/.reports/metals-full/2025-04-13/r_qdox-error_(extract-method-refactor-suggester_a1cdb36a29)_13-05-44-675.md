error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13105.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13105.java
text:
```scala
r@@eturn child.getAbsolutePath().substring(parent.getAbsolutePath().length()+1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13105.java