error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4009.java
text:
```scala
n@@ew ISourceType[] {sourceType}, // ignore secondary types, to improve laziness
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4009.java