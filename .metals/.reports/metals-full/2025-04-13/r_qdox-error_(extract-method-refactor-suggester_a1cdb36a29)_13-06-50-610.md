error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10760.java
text:
```scala
l@@og.infof("started ResourceAdapterService %s", context.getController().getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10760.java