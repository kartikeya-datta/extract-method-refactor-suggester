error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3428.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3428.java
text:
```scala
protected H@@andler handler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3428.java