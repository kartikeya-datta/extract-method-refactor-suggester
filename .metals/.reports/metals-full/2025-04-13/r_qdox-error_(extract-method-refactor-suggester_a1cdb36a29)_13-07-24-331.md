error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10089.java
text:
```scala
r@@eturn password.getInput();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10089.java