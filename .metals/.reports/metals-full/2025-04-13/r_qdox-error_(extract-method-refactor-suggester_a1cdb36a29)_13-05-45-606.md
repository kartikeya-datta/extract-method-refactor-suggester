error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6040.java
text:
```scala
a@@ssignableTypeBinding = BinaryTypeBinding.resolveType(assignableTypeBinding, lookupEnvironment, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6040.java