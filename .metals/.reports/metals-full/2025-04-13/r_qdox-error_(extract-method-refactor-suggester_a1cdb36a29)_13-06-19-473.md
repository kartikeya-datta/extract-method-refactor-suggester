error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3499.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3499.java
text:
```scala
r@@equest.index(clusterState.metaData().concreteSingleIndex(request.index()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3499.java