error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7187.java
text:
```scala
R@@equestCycle.get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7187.java