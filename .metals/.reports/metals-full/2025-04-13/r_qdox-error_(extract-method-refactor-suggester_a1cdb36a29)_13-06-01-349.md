error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/27.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/27.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/27.java
text:
```scala
r@@eturn Collections.emptyList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/27.java