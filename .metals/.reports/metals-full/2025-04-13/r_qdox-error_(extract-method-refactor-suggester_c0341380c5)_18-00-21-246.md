error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8042.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8042.java
text:
```scala
final b@@oolean replacement = deploymentUnit.getAttachment(Attachments.ANNOTATION_PROPERTY_REPLACEMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8042.java