error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17344.java
text:
```scala
i@@f (i == 132 || i == 133 || i == 318) continue; // avoid printing to printer
...
public class SnippetLauncher {
	...
	public static void main (String [] args) {
		...
		for (int i = 1; i < count; i++) {
			if (i == 132 || i == 133 || i == 292 || i == 318) continue; // avoid printing to printer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17344.java