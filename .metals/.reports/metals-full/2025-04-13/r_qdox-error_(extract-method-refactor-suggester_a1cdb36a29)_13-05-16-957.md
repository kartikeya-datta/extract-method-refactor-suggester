error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4662.java
text:
```scala
O@@utputStreamWriter osw = new OutputStreamWriter(fos, Manifest.JAR_ENCODING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4662.java