error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/838.java
text:
```scala
s@@et.add("jboss.server.temp.dir");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/838.java