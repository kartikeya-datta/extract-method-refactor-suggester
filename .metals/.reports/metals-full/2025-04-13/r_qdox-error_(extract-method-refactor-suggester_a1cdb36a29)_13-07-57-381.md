error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11757.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11757.java
text:
```scala
p@@ublic class NestedFormsPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11757.java