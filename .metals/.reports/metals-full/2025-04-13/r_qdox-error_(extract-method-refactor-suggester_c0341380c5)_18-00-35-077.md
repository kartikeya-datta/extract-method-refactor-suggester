error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8652.java
...
```java
offset: 5
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8652.java
text:
```scala
 !t@@his.codegenBinding.declaringClass.canBeSeenBy(currentScope))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8652.java