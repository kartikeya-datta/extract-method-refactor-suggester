error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2990.java
text:
```scala
i@@f (subScorer != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2990.java