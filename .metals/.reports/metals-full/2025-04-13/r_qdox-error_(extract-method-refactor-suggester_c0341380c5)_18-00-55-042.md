error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5938.java
text:
```scala
i@@f (match.getBinding().getKeySequence().isChildOf(mode, false))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5938.java