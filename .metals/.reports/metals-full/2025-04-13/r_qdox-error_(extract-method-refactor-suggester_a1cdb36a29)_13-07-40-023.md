error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6409.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6409.java
text:
```scala
E@@NTRIES.resolveModelAttribute(context, model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6409.java