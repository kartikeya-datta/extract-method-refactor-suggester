error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3639.java
text:
```scala
r@@eturn commandName + ":{flags="+flags+", version="+version;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3639.java