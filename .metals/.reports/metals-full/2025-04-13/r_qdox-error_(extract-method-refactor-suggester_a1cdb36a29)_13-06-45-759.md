error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10788.java
text:
```scala
c@@omparator = (AbstractFileComparator) NameFileComparator.NAME_INSENSITIVE_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10788.java