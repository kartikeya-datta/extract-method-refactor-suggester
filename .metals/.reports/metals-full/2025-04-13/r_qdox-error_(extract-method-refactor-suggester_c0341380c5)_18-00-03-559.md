error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1973.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1973.java
text:
```scala
public C@@loseShieldOutputStream(final OutputStream out) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1973.java