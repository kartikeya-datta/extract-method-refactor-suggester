error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16331.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16331.java
text:
```scala
p@@ublic interface IValidator extends Serializable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16331.java