error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5194.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5194.java
text:
```scala
private static final S@@tring TAG = "GHARW";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5194.java