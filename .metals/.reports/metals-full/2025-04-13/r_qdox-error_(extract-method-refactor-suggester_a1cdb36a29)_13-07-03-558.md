error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10583.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10583.java
text:
```scala
c@@heckVersion(TestElementPropertyConverter.class, "1.5");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10583.java