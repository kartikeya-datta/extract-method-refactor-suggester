error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2483.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2483.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2483.java
text:
```scala
i@@f (elementConverter == NoOpConversionExecutor.INSTANCE) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2483.java