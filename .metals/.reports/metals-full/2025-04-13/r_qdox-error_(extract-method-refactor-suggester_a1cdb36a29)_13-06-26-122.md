error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2624.java
text:
```scala
c@@nt.set(min).add(max).scl(0.5f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2624.java