error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6254.java
text:
```scala
i@@f (fieldMappingMetaDataEntry.getValue().isNull()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6254.java