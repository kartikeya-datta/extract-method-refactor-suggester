error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3404.java
text:
```scala
c@@onf.setPersistenceUnitRootUrl(pui.getPersistenceUnitRootUrl());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3404.java