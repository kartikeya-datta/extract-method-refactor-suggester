error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6729.java
text:
```scala
s@@uper(new Names(Defaults.NAME), Defaults.PRECISION_STEP,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6729.java