error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15073.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15073.java
text:
```scala
private static final l@@ong serialVersionUID = -2729718980002476794L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15073.java