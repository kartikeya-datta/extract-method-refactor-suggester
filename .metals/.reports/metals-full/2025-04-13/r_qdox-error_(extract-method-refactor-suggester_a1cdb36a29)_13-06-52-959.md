error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5450.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5450.java
text:
```scala
i@@f (!scope.getWorld().getCoreType(TypeX.THROWABLE).isAssignableFrom(excType)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5450.java