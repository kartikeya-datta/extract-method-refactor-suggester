error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/282.java
text:
```scala
i@@nt skipInterval = _TestUtil.nextInt(seedRandom, 2, 10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/282.java