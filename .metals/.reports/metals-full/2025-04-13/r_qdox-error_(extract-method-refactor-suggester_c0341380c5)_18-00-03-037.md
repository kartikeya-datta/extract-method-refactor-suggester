error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4342.java
text:
```scala
b@@indInfo.setupLookupInjection(serviceBuilder, injector, phaseContext.getDeploymentUnit());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4342.java