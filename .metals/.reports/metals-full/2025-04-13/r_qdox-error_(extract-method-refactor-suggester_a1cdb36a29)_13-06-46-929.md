error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7021.java
text:
```scala
r@@eturn "Unresolved type "/*nonNLS*/ + ((compoundName != null) ? CharOperation.toString(compoundName) : "UNNAMED"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7021.java