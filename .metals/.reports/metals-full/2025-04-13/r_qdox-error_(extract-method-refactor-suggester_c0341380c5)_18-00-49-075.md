error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6468.java
text:
```scala
s@@uper ("Type", "{builtin}Type");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6468.java