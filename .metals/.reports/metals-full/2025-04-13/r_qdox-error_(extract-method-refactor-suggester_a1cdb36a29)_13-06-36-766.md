error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3471.java
text:
```scala
I@@nternalAggregations aggregations;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3471.java