error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7333.java
text:
```scala
t@@hrow MESSAGES.couldNotCreateURI(uri,e.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7333.java