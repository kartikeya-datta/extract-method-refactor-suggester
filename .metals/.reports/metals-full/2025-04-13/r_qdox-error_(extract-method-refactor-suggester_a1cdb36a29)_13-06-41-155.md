error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6922.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6922.java
text:
```scala
public S@@impleTestPanel(MarkupContainer parent,String name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6922.java