error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4747.java
text:
```scala
i@@nt FORCE_IMMEDIATE_SEARCH = IJob.ForceImmediate;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4747.java