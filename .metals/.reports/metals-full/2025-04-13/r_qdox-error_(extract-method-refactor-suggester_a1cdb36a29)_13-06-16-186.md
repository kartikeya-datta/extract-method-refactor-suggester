error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11161.java
text:
```scala
p@@rovidedEnvironment = new ServerEnvironment(properties, System.getenv(), null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11161.java