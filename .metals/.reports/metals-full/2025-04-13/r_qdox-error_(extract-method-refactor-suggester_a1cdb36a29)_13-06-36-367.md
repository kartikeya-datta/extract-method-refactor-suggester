error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1341.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1341.java
text:
```scala
r@@eportDeprecatedType(memberType, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1341.java