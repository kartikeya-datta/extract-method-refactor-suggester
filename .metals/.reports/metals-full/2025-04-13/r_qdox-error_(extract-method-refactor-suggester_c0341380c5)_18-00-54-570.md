error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1768.java
text:
```scala
g@@etPage().getPageMap().remove(getPage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1768.java