error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12310.java
...
```java
offset: 719
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12310.java
text:
```scala
...
p@@ackage org.springframework.aop.aspectj.annotation;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12310.java