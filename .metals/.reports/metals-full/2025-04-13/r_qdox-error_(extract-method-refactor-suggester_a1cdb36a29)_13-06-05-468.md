error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2820.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2820.java
text:
```scala
i@@f (del.super_column == null && DatabaseDescriptor.getColumnFamilyType(rm.getTable(), cfName) == ColumnFamilyType.Super)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2820.java