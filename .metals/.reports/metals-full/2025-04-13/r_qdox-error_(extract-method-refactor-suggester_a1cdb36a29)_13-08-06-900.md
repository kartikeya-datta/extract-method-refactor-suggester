error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17040.java
text:
```scala
C@@harSequence transform(final Component component, final CharSequence output) throws Exception;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17040.java