error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5313.java
text:
```scala
C@@ollection<Cookie> cookies = tester.getLastResponse().getCookies();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5313.java