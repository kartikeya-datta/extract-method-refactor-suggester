error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13807.java
text:
```scala
a@@ssertNull(status);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13807.java