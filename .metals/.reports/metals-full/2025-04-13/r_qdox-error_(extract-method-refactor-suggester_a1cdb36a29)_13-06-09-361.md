error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3626.java
text:
```scala
a@@lpha [y*width+x] = data [y*stride+x*4+3];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3626.java