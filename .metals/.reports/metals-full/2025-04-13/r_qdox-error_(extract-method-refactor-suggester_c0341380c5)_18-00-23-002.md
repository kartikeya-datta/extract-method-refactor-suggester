error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/865.java
text:
```scala
C@@ullTest.class, DeltaTimeTest.class, EdgeDetectionTest.class, ETC1Test.class, ExitTest.class, FilesTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/865.java