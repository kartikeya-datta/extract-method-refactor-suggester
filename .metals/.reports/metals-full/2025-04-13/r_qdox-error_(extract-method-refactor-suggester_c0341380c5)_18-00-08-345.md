error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6068.java
text:
```scala
h@@andleElementText(reader, element, bridgeAdd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6068.java