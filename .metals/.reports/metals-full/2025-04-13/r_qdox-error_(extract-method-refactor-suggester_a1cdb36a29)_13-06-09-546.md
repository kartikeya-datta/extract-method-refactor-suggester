error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7236.java
text:
```scala
i@@f (cli != null) cli.quit();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7236.java