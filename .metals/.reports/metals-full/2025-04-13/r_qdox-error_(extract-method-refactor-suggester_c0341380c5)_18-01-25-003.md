error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5206.java
text:
```scala
i@@ndexTemplateService.putTemplate(new MetaDataIndexTemplateService.PutRequest(request.cause(), request.getName())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5206.java