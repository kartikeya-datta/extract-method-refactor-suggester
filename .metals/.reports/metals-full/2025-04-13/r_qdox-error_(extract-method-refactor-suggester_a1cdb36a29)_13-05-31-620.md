error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3231.java
text:
```scala
f@@or (String table : DatabaseDescriptor.getNonSystemTables())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3231.java