error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3726.java
text:
```scala
O@@bject uriObj = createMethod.invoke(null, new Object[] {encodeURI(uri)});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3726.java