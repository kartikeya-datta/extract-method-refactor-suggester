error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11740.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11740.java
text:
```scala
s@@uper(nullable, true, false, ModelType.OBJECT, findModelTypes(attributes));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11740.java