error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6518.java
text:
```scala
t@@his(true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6518.java