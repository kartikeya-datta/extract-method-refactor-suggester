error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3154.java
text:
```scala
c@@lasspath.add( attributes.getClasspath() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3154.java