error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1304.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,78]

error in qdox parser
file content:
```java
offset: 78
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1304.java
text:
```scala
/* TODO: enable new BasicModelBE(), */ /* TODO: enable new BasicModelD(), */ n@@ew BasicModelG(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1304.java