error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1681.java
text:
```scala
T@@reeItem (Tree parent, int style, int hParent, int hInsertAfter, int hItem) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1681.java