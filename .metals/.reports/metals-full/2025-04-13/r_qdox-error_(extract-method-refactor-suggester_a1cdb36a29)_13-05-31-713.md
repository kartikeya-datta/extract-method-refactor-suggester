error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10402.java
...
```java
offset: 900
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10402.java
text:
```scala
...
p@@ackage org.elasticsearch.action.bulk;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10402.java