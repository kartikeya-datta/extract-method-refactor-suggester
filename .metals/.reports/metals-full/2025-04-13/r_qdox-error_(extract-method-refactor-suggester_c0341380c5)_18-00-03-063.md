error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1529.java
text:
```scala
T@@extureAttribute.createDiffuse((Texture)null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1529.java