error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2244.java
text:
```scala
w@@ovenClass.getBundleWiring().getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2244.java