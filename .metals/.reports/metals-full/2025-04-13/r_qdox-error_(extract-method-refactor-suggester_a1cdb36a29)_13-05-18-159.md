error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1556.java
text:
```scala
g@@raphics = new LwjglGraphics(canvas) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1556.java