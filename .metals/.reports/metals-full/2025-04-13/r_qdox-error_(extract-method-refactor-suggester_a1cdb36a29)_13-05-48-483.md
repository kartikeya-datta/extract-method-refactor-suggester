error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/645.java
text:
```scala
h@@ostname = FindResolver.find1();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/645.java