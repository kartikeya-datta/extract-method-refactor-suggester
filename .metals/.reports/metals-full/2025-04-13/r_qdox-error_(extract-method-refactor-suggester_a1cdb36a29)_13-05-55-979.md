error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1386.java
text:
```scala
v@@alue = buffer.toString().intern();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1386.java