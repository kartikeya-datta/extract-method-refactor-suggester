error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7247.java
text:
```scala
r@@eturn CharOperation.NO_STRINGS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7247.java