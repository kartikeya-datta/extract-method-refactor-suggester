error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12740.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12740.java
text:
```scala
a@@sb.append(" if (!(inputNode.className.indexOf('wicket-'+markupId)===0)) continue;\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12740.java