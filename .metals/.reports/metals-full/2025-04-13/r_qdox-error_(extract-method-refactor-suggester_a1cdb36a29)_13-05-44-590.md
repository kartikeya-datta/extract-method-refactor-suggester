error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8560.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8560.java
text:
```scala
protected Q@@ueueUtils() {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8560.java