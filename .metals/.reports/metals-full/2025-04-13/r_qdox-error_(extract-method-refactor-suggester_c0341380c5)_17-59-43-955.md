error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8679.java
text:
```scala
a@@syncAppender.activate();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8679.java