error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15782.java
text:
```scala
m@@apper = new Mapper();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15782.java