error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14693.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14693.java
text:
```scala
public v@@oid run(final TestEJBRunnable task) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14693.java