error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18187.java
text:
```scala
t@@his(id, null, nrOfStars, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18187.java