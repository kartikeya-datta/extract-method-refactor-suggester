error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7090.java
text:
```scala
l@@ogger.debug("primary shard [{}] is not yet active or we do not know the node it is assigned to [{}]. Scheduling a retry.", shard.shardId(), shard.currentNodeId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7090.java