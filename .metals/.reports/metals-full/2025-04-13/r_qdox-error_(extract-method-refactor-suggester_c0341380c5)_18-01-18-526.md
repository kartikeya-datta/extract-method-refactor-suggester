error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9011.java
text:
```scala
i@@f (!item.isDisposed ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9011.java