error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9699.java
text:
```scala
r@@eturn ScriptDocValues.EMPTY_DOUBLES;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9699.java