error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5690.java
text:
```scala
i@@ndexRandom(true, indexBuilders.toArray(new IndexRequestBuilder[indexBuilders.size()]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5690.java