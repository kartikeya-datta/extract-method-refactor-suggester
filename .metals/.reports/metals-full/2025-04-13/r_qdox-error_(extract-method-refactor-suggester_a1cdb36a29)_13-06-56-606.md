error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17560.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[66,80]

error in qdox parser
file content:
```java
offset: 1583
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17560.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17560.java