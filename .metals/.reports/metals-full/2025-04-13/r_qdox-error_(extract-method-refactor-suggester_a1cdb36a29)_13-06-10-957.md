error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4042.java
text:
```scala
H@@asParentFilter parentFilter = HasParentFilter.create(executionType, query, parentType, searchContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4042.java