error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14741.java
text:
```scala
T@@ransactionAttributeType txAttr = ejbComponentDescription.getTransactionAttributes().getAttribute(methodIntf, className, methodName, toString(method.getParameterTypes()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14741.java