error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7970.java
text:
```scala
r@@eturn (!fieldErrors.isEmpty() ? fieldErrors.get(0) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7970.java