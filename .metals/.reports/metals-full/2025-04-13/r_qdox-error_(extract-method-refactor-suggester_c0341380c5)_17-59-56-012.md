error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3135.java
text:
```scala
t@@his.scanner = new Scanner(false, false, false, true, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3135.java