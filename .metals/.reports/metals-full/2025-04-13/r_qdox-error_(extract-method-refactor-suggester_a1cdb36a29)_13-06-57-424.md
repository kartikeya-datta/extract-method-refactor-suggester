error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2054.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2054.java
text:
```scala
public abstract D@@ocsEnum docs(FieldInfo fieldInfo, BlockTermState state, Bits skipDocs, DocsEnum reuse, boolean needsFreqs) throws IOException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2054.java