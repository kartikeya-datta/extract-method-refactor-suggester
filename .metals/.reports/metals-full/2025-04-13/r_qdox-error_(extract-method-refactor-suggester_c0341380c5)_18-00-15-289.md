error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8316.java
text:
```scala
r@@eturn new Model();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8316.java