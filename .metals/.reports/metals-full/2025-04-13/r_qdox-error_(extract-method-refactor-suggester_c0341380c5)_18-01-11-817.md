error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9479.java
text:
```scala
F@@ile indexFile = new File(nodeEnv.shardLocation(shardId), "index");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9479.java