error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9836.java
text:
```scala
C@@ollection<Cache> getCaches();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9836.java