error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9011.java
text:
```scala
b@@uildEnterpriseBeanMetaData(wsEjbsMD, ejbEndpoint, jbossWebservicesMD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9011.java