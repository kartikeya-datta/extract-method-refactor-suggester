error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2.java
text:
```scala
r@@eturn c.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2.java