error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12141.java
text:
```scala
o@@nValidate(getInput());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12141.java