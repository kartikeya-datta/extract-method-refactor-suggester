error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9780.java
text:
```scala
t@@olerance, 100,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9780.java