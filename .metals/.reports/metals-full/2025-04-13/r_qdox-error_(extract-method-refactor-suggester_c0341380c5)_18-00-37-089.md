error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9821.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9821.java
text:
```scala
public static final i@@nt STRUCTURE_BUNDLE_SUB_DEPLOYMENT             = 0x1450;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9821.java