error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/863.java
text:
```scala
a@@ctor.size(amountWidth * percentDelta, amountHeight * percentDelta);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/863.java