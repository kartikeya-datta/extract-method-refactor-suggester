error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8741.java
text:
```scala
b@@ootstrap.bootstrap(configuration, startServices);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8741.java