error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10394.java
text:
```scala
b@@oolean setRadioFocus (boolean tabbing) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10394.java