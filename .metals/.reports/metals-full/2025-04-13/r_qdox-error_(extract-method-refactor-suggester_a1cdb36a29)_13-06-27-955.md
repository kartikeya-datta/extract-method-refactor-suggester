error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9851.java
text:
```scala
c@@luster2 = new TestCluster(randomLong(), 2, 2, cluster().getClusterName() + "-2");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9851.java