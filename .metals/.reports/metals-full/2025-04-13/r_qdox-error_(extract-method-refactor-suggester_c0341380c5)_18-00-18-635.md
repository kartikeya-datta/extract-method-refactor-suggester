error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1527.java
text:
```scala
i@@f (interfaceName.equals(Page.REDIRECT_LISTENER_INTERFACE.getName()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1527.java