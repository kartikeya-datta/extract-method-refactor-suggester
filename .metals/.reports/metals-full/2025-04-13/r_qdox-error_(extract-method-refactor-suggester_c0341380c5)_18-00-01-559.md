error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4310.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4310.java
text:
```scala
final b@@yte[] data = cachedEntry.bytes().bytes().copyBytesArray().toBytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4310.java