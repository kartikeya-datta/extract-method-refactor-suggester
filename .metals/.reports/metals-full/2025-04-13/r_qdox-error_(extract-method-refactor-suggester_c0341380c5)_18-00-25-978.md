error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1040.java
text:
```scala
l@@og.info("Leader's attempt to sync with shard failed, moving to the next candidate");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1040.java