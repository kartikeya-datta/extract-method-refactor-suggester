error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7803.java
text:
```scala
T@@ermContext termContext = TermContext.build(indexReaderContext, terms[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7803.java