error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3701.java
text:
```scala
n@@umRuns = scaledRandomIntBetween(3, 10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3701.java