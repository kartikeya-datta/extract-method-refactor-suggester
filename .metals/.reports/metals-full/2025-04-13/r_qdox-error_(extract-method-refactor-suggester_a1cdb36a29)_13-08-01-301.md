error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5216.java
text:
```scala
i@@f ((System.currentTimeMillis() - cachedStats.getTimestamp()) > refreshInterval.millis()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5216.java