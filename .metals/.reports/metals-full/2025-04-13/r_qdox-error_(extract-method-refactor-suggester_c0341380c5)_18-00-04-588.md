error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15303.java
text:
```scala
p@@rotected static final class LocatorProxy
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15303.java