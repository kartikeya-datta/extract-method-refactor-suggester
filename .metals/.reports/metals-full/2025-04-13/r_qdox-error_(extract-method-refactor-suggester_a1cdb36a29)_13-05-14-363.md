error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/293.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/293.java
text:
```scala
public static final i@@nt EJB_SET_CONTEXT_METHOD_INVOCATION_INTERCEPTOR = 0x800;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/293.java