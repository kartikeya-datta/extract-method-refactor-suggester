error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8653.java
text:
```scala
r@@eturn new StatefulEJBLocator<T>(viewType, appName, moduleName, beanName, distinctName, sessionID, statefulComponent.getCache().getStrictAffinity(), this.getNodeName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8653.java