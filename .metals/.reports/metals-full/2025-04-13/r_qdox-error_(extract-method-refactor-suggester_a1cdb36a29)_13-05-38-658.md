error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5008.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5008.java
text:
```scala
public S@@tring site = SITES.get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5008.java