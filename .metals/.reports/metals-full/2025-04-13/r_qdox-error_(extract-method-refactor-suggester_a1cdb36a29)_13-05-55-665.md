error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4622.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4622.java
text:
```scala
protected S@@tring getTextValue(final Object object)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4622.java