error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15764.java
text:
```scala
m@@gr.addSharedObject(id, result, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15764.java