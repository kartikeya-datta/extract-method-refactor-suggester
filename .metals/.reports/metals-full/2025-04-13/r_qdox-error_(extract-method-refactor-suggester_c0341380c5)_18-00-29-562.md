error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2470.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2470.java
text:
```scala
final B@@ytesValues values = fieldData.load(context).getBytesValues(); // load fielddata
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2470.java