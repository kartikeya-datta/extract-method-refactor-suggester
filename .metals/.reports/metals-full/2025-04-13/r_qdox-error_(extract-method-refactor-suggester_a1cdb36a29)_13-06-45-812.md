error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9215.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9215.java
text:
```scala
r@@eturn NumericType.LONG;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9215.java