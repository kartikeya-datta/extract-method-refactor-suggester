error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10013.java
text:
```scala
s@@uper(false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10013.java