error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6568.java
text:
```scala
t@@hrow new RemoteException(e.toString(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6568.java