error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2952.java
text:
```scala
m@@anager.addBinary((IFile) value, this.folder.getFullPath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2952.java