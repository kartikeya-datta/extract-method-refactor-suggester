error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6608.java
text:
```scala
t@@his.pattern.getMatchRule());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6608.java