error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5419.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5419.java
text:
```scala
public C@@ompositeSet(Set<E>... sets) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5419.java