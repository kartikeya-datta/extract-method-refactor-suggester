error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7775.java
text:
```scala
i@@f (exceptionType.isBoundParameterizedType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7775.java