error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12183.java
text:
```scala
u@@nit = "hour";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12183.java