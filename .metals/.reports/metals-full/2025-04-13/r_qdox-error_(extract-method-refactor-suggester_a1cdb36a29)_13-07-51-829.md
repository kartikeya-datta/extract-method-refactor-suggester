error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/42.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/42.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/42.java
text:
```scala
g@@etWebResponse().getHttpServletResponse().addCookie(cookie);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/42.java