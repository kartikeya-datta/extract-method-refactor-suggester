error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13982.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13982.java
text:
```scala
t@@his.pageParameters = pageParameters;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13982.java