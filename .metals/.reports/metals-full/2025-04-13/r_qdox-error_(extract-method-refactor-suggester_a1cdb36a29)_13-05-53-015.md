error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/642.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/642.java
text:
```scala
public D@@ouble convertToObject(final String value, final Locale locale)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/642.java