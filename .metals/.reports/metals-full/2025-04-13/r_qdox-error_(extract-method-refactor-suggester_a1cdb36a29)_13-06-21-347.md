error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3595.java
text:
```scala
i@@f (has(factory, CommonAttributes.TRANSACTION_BATCH_SIZE)){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3595.java