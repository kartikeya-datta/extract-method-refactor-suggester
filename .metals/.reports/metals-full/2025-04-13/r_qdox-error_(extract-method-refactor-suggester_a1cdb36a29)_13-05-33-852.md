error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1791.java
text:
```scala
Q@@uery query = new TopChildrenQuery(parentChildIndexFieldData, childQuery, "child", "parent", scoreType, 1, 1, NonNestedDocsFilter.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1791.java