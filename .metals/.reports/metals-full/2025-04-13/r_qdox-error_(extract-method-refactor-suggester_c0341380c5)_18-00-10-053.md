error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6383.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6383.java
text:
```scala
public v@@oid testBundleDeployment() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6383.java