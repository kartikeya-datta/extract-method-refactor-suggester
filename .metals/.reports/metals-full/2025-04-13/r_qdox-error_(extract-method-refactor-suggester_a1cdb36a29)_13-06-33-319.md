error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4964.java
text:
```scala
i@@f (actor != null && login.equals(actor.getLogin()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4964.java