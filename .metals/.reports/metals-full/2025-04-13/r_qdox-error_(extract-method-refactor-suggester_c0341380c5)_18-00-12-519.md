error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10007.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10007.java
text:
```scala
final d@@ouble result = 0.5*Erf.erfc(ref[i][0]/FastMath.sqrt(2));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10007.java