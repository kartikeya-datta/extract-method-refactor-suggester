error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12020.java
text:
```scala
e@@xpectLogContaining("zipEmptyCreate", "Note: creating empty");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12020.java