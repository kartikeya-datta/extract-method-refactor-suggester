error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/347.java
text:
```scala
U@@tils.getInt(conf.get(Config.STORM_ZOOKEEPER_CONNECTION_TIMEOUT)),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/347.java