error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2405.java
text:
```scala
a@@pplication.setHomePage(PagedTableNavigatorWithLabelProviderPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2405.java