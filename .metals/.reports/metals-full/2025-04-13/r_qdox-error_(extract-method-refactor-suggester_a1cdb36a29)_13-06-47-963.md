error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1136.java
text:
```scala
s@@uper(streamId, null, allOutputFields);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1136.java