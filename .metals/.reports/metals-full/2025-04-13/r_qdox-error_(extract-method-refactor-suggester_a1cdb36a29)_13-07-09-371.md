error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9389.java
text:
```scala
t@@hrow new RuntimeException("Unable to lookup existing business activity", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9389.java