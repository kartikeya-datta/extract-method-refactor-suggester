error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14821.java
text:
```scala
s@@uper(new Properties(), false, System.in, System.out, System.err, "Test", InetAddress.getLocalHost(), 0, InetAddress.getLocalHost(), 0, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14821.java