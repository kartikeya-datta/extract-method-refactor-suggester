error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9778.java
text:
```scala
S@@tring encoding = this.compilerOptions.defaultEncoding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9778.java