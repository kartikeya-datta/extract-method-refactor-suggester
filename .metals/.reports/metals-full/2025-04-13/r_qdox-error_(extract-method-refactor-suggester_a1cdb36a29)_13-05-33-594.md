error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9945.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9945.java
text:
```scala
protected S@@hardRefreshRequest newShardRequest(int numShards, ShardRouting shard, RefreshRequest request) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9945.java