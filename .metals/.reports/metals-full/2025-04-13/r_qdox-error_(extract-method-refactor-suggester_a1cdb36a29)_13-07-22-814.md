error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7121.java
text:
```scala
t@@his.runnable.run(progressMonitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7121.java