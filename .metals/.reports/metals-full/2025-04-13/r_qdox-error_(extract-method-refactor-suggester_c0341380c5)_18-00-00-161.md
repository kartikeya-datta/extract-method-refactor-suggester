error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1336.java
text:
```scala
O@@bject targetElement = this.conversionService.convert(sourceElement, sourceType.getElementTypeDescriptor().applyIndexedObject(sourceElement), targetType.getElementTypeDescriptor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1336.java