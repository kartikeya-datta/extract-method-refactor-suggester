error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2441.java
...
```java
offset: 29
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2441.java
text:
```scala
private static synchronized c@@har[] scannedIdentifier(String id) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2441.java