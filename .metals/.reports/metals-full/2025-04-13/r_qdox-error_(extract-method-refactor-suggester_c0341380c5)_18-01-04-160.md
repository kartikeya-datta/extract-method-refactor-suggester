error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2982.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2982.java
text:
```scala
public v@@oid addAll (T... array) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2982.java