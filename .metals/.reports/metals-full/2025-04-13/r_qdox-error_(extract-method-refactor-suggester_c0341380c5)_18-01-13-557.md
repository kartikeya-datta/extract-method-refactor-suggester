error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4267.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4267.java
text:
```scala
l@@og.warn("access-control/default is missing operations: " + accessControl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4267.java