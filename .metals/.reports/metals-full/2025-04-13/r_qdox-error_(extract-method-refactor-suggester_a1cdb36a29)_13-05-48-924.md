error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13039.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13039.java
text:
```scala
public L@@ist<VEXNode> getNodes(int startOffset, int endOffset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13039.java