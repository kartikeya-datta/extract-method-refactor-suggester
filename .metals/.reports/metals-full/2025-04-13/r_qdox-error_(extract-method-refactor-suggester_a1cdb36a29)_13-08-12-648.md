error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14914.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[92,2]

error in qdox parser
file content:
```java
offset: 2522
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14914.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14914.java