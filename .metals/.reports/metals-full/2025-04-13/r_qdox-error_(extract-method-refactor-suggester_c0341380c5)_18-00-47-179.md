error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/826.java
text:
```scala
b@@uilder.field(entry.getKey(), entry.getValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/826.java