error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3939.java
text:
```scala
r@@eturn "FlowInfo.DeadEnd"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3939.java