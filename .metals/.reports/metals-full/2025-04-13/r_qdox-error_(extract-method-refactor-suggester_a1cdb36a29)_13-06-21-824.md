error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7014.java
text:
```scala
a@@ssertEquals(CloseStatus.SESSION_NOT_RELIABLE, session2.getCloseStatus());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7014.java