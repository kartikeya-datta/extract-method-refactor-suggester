error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5485.java
text:
```scala
s@@uper(name, factories, valuesSource, format, estimatedBucketCount, null, bucketCountThresholds, aggregationContext, parent, SubAggCollectionMode.DEPTH_FIRST, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5485.java