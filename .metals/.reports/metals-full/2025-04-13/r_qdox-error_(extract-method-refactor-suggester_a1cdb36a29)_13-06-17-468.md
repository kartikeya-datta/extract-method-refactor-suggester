error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3215.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3215.java
text:
```scala
I@@ndexBufferObjectClassTest.class, TreeTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3215.java