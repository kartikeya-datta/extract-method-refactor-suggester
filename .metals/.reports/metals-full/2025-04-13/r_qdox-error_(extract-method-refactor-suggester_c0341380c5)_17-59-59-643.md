error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/82.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/82.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/82.java
text:
```scala
o@@penable = this.handleFactory.createOpenable(pathString, this.scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/82.java