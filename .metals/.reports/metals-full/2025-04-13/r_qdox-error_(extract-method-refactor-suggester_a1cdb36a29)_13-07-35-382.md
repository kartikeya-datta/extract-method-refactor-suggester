error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3338.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3338.java
text:
```scala
t@@ranslog.add(new Translog.DeleteByQuery(new byte[]{4}, null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3338.java