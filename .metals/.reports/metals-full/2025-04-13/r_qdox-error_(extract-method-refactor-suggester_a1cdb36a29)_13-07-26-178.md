error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8449.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8449.java
text:
```scala
public A@@jaxCheckBox(MarkupContainer parent, final String id, final IModel<Boolean> model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8449.java