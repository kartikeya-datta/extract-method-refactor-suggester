error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6370.java
text:
```scala
w@@hile (param.length() == 1 && Signature.C_ARRAY == param.charAt(0)) { // backward compatible with 3.0 mementos
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6370.java