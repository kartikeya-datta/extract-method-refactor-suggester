error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6193.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6193.java
text:
```scala
public static final S@@tring EMPTY_STRING = ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6193.java