error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3359.java
text:
```scala
t@@hrow new ActionNotFoundTransportException(action);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3359.java