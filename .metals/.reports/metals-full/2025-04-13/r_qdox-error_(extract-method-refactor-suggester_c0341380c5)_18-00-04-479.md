error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2946.java
text:
```scala
p@@utValue(SMALL_ICON, ImageLoader.getMiscIcon("viewsource.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2946.java