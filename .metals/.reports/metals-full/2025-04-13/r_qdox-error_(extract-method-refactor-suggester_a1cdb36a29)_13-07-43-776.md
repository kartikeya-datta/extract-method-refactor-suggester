error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6353.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6353.java
text:
```scala
static final A@@ttributeDefinition PREDICATE = new SimpleAttributeDefinitionBuilder("predicate", ModelType.STRING)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6353.java