error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9179.java
text:
```scala
C@@lass<?>[] getInterfaces();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9179.java