error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6832.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6832.java
text:
```scala
private A@@rrayList<InputProcessor> processors = new ArrayList<InputProcessor>(4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6832.java