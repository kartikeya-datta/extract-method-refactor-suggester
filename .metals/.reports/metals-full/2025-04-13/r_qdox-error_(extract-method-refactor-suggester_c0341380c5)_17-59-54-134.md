error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/125.java
text:
```scala
t@@hrow ThreadsLogger.ROOT_LOGGER.scheduledThreadPoolExecutorUninitialized();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/125.java