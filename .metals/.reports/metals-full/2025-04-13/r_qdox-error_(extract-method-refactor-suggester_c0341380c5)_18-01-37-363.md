error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6447.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6447.java
text:
```scala
public T@@okenStream tokenStream(Analyzer analyzer, TokenStream previous) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6447.java