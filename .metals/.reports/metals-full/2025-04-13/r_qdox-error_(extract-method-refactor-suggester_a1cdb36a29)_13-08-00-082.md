error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6595.java
text:
```scala
s@@ynchroVariable.setConstant(NotAConstant); // not inlinable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6595.java