error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9713.java
text:
```scala
t@@his.format.validate();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9713.java