error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5486.java
text:
```scala
s@@uper(name, factories, valuesSource, estimatedBucketCount, null, bucketCountThresholds, includeExclude, aggregationContext, parent, SubAggCollectionMode.DEPTH_FIRST, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5486.java