error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2522.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2522.java
text:
```scala
protected static final L@@ogger logger_ = Logger.getLogger(AbstractStrategy.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2522.java