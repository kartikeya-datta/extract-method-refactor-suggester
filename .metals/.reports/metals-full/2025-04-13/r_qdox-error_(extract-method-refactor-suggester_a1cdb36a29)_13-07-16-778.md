error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7991.java
text:
```scala
t@@his.fileChunkSize = componentSettings.getAsBytesSize("file_chunk_size", new ByteSizeValue(100, ByteSizeUnit.KB));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7991.java