error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16768.java
...
```java
offset: 13
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16768.java
text:
```scala
"[;\\?&]" + q@@uotedArg + "=([^\"'>&\\s;\\\\]*)[&\\s\"'>;]?$?" +  // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16768.java