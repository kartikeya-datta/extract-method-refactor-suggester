error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3593.java
text:
```scala
p@@ublic class Box2DTest implements RenderListener, InputListener
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3593.java