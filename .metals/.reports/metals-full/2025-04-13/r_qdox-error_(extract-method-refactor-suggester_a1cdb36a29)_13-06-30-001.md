error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5101.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5101.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5101.java
text:
```scala
static final S@@tring WRAP_XA_RESOURCE = "wrap-xa-resource";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5101.java