error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11117.java
text:
```scala
C@@harSequence pathForTarget(IRequestTarget requestTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11117.java