error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2771.java
text:
```scala
o@@ut = new FileWriter(copy);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2771.java