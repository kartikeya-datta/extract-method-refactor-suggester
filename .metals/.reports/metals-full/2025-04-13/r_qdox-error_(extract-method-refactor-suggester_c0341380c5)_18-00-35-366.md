error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12965.java
text:
```scala
i@@s = unscaledImageResource.getResourceStream().getInputStream();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12965.java