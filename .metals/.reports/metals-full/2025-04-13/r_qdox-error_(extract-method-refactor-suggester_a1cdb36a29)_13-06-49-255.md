error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15458.java
text:
```scala
w@@indowProc = OS.GetWindowLongPtr (handle, OS.GWL_WNDPROC);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15458.java