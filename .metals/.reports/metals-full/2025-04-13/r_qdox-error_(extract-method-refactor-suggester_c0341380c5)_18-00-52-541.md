error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6469.java
text:
```scala
G@@dxTest test = new SuperKoalio();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6469.java