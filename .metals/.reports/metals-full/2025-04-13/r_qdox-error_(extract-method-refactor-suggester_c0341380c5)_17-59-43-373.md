error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9313.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9313.java
text:
```scala
public static final H@@ttpEntity<?> EMPTY = new HttpEntity<Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9313.java