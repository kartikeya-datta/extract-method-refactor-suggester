error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11550.java
text:
```scala
R@@esourceBundle resbundle = OSGiDescriptionProviders.getResourceBundle(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11550.java