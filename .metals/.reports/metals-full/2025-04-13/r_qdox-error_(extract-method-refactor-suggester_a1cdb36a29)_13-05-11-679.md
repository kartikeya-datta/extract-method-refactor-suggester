error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5237.java
text:
```scala
l@@ogger.trace("{} {}: {}", Thread.currentThread().getName(), component, message);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5237.java