error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8869.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8869.java
text:
```scala
o@@s.write("HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\n".getBytes()); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8869.java