error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2351.java
text:
```scala
m@@odel.getBoundingBox(boundingBox);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2351.java