error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6835.java
text:
```scala
r@@eturn new FileResourceIterator(getProject(), dir,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6835.java