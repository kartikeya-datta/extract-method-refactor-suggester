error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3992.java
text:
```scala
S@@tring username, char[] password, boolean initConsole, final int connectionTimeout) throws CliInitializationException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3992.java