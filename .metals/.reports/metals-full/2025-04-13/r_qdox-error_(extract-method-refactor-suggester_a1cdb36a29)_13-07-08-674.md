error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2471.java
text:
```scala
v@@alues[i] = indexFieldDatas[i].load(context).getBytesValues();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2471.java