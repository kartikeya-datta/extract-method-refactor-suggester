error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7414.java
text:
```scala
i@@f (parent != null && !parent.isDisposed()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7414.java