error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/422.java
...
```java
offset: 623
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/422.java
text:
```scala
...
p@@ackage org.eclipse.ui.internal.activities;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/422.java