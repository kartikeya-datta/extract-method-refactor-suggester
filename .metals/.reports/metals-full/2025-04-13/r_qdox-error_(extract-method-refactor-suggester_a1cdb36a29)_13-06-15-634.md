error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8751.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8751.java
text:
```scala
final L@@oggingSubsystemElement subsystemElement = new LoggingSubsystemElement(reader.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8751.java