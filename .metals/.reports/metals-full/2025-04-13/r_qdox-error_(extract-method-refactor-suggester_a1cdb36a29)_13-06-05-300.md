error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10034.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10034.java
text:
```scala
public v@@oid methodNeedBody(AbstractMethodDeclaration methodDecl) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10034.java