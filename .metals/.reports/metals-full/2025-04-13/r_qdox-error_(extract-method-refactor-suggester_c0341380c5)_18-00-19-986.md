error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6147.java
text:
```scala
r@@eturn (ColumbaHeader) headerList.getHeader(uid);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6147.java