error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12009.java
text:
```scala
C@@airo.cairo_set_line_width(cairo, Math.max (1, width));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12009.java