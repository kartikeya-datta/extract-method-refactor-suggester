error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1601.java
text:
```scala
a@@rrayPool.freeAll(usedArrays);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1601.java