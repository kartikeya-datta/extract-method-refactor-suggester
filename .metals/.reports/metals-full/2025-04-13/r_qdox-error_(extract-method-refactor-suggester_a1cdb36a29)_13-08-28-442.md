error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/306.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/306.java
text:
```scala
public v@@oid forceTableCleanup();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/306.java