error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13043.java
text:
```scala
n@@ew ContainerStateMonitor(container),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13043.java