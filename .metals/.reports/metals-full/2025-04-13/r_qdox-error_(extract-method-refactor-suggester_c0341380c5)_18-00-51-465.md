error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3217.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3217.java
text:
```scala
static final S@@tring VERSION = "2.1.20041006";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3217.java