error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5307.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5307.java
text:
```scala
public final static S@@tring DELAY_INT = "delay";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5307.java