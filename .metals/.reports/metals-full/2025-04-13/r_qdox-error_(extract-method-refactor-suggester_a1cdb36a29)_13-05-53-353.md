error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/658.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/658.java
text:
```scala
public final c@@har charAt(final int pos)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/658.java