error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5759.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5759.java
text:
```scala
static final I@@nfinispanModel CURRENT = VERSION_2_0_0;
...
public enum InfinispanModel {
    ...
    VERSION_2_0_0(2, 0, 0),
    ;
    public static final InfinispanModel CURRENT = VERSION_2_0_0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5759.java