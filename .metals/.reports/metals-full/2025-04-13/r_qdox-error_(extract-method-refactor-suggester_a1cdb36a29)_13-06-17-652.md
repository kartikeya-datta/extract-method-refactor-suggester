error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/334.java
text:
```scala
t@@his.flushThresholdPeriod = componentSettings.getAsTime("flush_threshold_period", TimeValue.timeValueMinutes(30));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/334.java