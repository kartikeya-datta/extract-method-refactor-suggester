error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13029.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13029.java
text:
```scala
protected S@@tring _stringRepresentation = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13029.java