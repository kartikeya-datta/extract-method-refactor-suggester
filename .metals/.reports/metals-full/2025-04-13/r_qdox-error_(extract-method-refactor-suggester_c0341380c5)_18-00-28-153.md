error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6390.java
text:
```scala
r@@eturn new NameEnvironmentAnswer(new CompilationUnit(null, fullSourcePath, fileEncoding), null /* no access restriction */);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6390.java