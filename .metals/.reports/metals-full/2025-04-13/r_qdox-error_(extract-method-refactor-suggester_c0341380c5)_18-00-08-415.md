error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5576.java
text:
```scala
n@@ew TransportConfigOperationHandlers.BasicTransportConfigAdd(isAcceptor, attrs),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5576.java