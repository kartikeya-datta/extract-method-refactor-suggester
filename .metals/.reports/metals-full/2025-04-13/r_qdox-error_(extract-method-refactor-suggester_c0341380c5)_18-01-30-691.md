error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2878.java
text:
```scala
e@@numDeclaration.enumConstants().add(convert(nextEnumConstant));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2878.java