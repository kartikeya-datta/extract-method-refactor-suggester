error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9406.java
text:
```scala
B@@eanUtils.instantiateClass(this.executorType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9406.java