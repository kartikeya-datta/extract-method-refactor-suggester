error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6278.java
text:
```scala
i@@nt code = OS.HIWORD (wParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6278.java