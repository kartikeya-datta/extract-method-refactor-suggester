error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9085.java
text:
```scala
f@@unc.compiledComponents = (LinkedList<Object>) compiledComponents.clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9085.java