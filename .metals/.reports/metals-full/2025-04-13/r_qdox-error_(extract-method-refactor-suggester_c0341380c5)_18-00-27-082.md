error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2934.java
text:
```scala
i@@nt forePixel = getForegroundPixel ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2934.java