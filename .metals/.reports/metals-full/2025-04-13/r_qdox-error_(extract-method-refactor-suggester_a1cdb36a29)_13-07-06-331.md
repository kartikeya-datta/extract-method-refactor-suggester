error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10035.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10035.java
text:
```scala
public v@@oid containmentHierarchyUpdated(AspectJModel model) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10035.java