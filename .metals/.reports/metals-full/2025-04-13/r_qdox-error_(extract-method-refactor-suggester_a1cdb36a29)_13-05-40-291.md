error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1443.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1443.java
text:
```scala
private static final S@@tring FILEVERSION = "505365";// Expected value $NON-NLS-1$
...
public class SaveService {
	...
	private static final String FILEVERSION = "502750";// Expected value $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1443.java