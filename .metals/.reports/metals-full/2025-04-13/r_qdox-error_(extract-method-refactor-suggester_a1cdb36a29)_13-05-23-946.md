error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4328.java
text:
```scala
T@@ypeBinding checkedType = type.resolveType(scope, true /* check bounds*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4328.java