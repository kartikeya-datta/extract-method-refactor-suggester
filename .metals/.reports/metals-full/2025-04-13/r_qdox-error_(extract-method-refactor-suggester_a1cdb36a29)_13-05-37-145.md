error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2476.java
text:
```scala
t@@his.reconnectInterval = componentSettings.getAsTime("reconnect_interval", TimeValue.timeValueSeconds(10));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2476.java