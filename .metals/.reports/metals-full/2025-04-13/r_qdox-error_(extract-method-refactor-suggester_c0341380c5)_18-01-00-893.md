error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3518.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,86]

error in qdox parser
file content:
```java
offset: 86
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3518.java
text:
```scala
+ "the structure of (i,j,value) for representing a graph in text. Input line was: '"+v@@alue+"'.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3518.java