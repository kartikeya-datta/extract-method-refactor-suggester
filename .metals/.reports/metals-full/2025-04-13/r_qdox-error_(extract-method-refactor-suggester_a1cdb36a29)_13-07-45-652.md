error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17015.java
text:
```scala
f@@ield.onDetach();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17015.java