error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12769.java
text:
```scala
t@@arget.addService(JMSServices.JMS_MANAGER, service)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12769.java