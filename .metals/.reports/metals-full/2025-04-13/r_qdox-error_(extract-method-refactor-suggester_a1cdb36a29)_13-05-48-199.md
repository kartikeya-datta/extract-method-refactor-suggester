error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13892.java
text:
```scala
c@@lass ProcessMonitor
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13892.java