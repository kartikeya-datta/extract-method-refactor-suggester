error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1472.java
text:
```scala
t@@2, convergenceDelta, maxIterations, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1472.java