error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/139.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/139.java
text:
```scala
public static R@@GB getColorValue(String rawValue) throws DataFormatException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/139.java