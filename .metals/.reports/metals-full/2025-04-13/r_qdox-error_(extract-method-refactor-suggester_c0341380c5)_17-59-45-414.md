error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10324.java
text:
```scala
s@@ervice.setTarget(Target.fromString(target.asString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10324.java