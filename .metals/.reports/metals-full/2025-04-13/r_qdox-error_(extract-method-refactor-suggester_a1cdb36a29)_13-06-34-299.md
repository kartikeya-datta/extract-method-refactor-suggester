error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10325.java
text:
```scala
s@@ervice.setRotateSize(ModelParser.parseSize(rotateSizeNode));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10325.java