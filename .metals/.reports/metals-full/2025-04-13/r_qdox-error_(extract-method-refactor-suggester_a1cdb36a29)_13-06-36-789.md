error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7039.java
text:
```scala
p@@ostingsProvider, docValuesProvider, null, null, fieldDataSettings, indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7039.java