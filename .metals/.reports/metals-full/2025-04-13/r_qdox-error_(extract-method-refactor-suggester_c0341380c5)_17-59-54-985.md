error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6806.java
text:
```scala
h@@eader.setBounds (0, 0, 0, fontHeight + 2 * getHeaderPadding ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6806.java