error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/873.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/873.java
text:
```scala
public static final T@@hreadLocal<ThreadLocals.CleanableValue<ChunkEncoder>> cachedEncoder = new ThreadLocal<ThreadLocals.CleanableValue<ChunkEncoder>>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/873.java