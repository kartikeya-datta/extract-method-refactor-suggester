error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2654.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2654.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2654.java
text:
```scala
o@@ut.scale(scale.x, scale.y, scale.z);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2654.java