error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1850.java
text:
```scala
s@@ubsystem, MOCK_IGNORED_DOMAIN_RESOURCE_REGISTRY, TransformationTarget.TransformationTargetType.SERVER, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1850.java