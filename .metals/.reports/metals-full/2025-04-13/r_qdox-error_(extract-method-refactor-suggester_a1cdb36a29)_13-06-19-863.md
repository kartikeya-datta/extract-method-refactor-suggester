error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17550.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[283,2]

error in qdox parser
file content:
```java
offset: 7815
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17550.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17550.java