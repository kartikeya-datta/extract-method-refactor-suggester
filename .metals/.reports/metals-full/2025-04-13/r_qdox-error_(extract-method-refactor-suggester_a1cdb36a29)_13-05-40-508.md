error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17698.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[58,80]

error in qdox parser
file content:
```java
offset: 1508
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17698.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17698.java