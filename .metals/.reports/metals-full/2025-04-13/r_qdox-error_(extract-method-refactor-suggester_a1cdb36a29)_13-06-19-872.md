error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7959.java
text:
```scala
t@@his.defaultAccessTimeoutProvider = ejbComponentCreateService.getDefaultAccessTimeoutService();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7959.java