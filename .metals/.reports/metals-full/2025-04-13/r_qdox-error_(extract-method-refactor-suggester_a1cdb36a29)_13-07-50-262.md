error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/460.java
text:
```scala
L@@RESULT wmSysChar (int hwnd, int wParam, int lParam) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/460.java