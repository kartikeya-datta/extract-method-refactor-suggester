error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13238.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13238.java
text:
```scala
final S@@tring stack = CommonAttributes.DEFAULT_STACK.resolveModelAttribute(context, model).asString() ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13238.java