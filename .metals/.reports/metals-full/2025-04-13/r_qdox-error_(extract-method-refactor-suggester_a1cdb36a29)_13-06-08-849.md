error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10479.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10479.java
text:
```scala
public A@@nyPredicate(final Predicate<? super T>... predicates) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10479.java