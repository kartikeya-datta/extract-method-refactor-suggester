error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9488.java
text:
```scala
s@@uper(node.name(), node.address(), action, msg, cause);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9488.java