error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1899.java
text:
```scala
g@@raphics = new AndroidGraphicsLiveWallpaper(this, config.useGL20, config.resolutionStrategy==null?new FillResolutionStrategy():config.resolutionStrategy);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1899.java