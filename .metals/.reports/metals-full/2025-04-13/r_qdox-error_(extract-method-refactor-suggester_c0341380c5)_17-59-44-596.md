error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3024.java
text:
```scala
S@@etResponse cached = cache.lookupRecords(name, type, dclass, cred);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3024.java