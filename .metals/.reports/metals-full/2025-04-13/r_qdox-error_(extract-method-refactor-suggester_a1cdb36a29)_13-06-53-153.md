error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/963.java
text:
```scala
i@@f (!sessionCache.getCacheConfiguration().invocationBatching().enabled()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/963.java