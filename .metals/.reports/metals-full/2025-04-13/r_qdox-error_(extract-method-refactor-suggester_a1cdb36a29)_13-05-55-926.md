error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8293.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8293.java
text:
```scala
c@@onfigureTabPager();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8293.java