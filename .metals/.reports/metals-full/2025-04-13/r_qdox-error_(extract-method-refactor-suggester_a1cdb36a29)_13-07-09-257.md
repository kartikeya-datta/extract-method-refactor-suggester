error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10549.java
text:
```scala
i@@f (OS.gtk_widget_get_child_visible (item.handle) && item.setFocus ()) return result;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10549.java