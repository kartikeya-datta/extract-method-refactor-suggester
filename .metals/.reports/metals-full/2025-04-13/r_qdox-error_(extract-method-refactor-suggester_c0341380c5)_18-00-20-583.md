error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8537.java
text:
```scala
r@@outingTableBuilder.addAsRecovery(indexMetaData);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8537.java