error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1992.java
text:
```scala
f@@ailIfFound("solr/@persistent");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1992.java