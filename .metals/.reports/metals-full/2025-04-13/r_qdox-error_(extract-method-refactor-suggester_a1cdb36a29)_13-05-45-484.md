error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5200.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5200.java
text:
```scala
public l@@ong tagBits = 0; // See values in the interface TagBits below
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5200.java