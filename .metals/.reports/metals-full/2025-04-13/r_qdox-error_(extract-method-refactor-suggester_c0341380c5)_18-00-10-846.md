error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6325.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6325.java
text:
```scala
public static A@@rray<Geometry> readGeometries (Element root) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6325.java