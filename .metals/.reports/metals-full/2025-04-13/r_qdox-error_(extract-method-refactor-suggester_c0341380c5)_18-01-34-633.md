error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8284.java
text:
```scala
S@@treamOutput out = cachedEntry.handles();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8284.java