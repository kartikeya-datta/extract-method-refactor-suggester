error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5765.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5765.java
text:
```scala
c@@ontext.startSubsystemElement(JGroupsSchema.CURRENT.getNamespaceUri(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5765.java