error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6769.java
text:
```scala
e@@xecutors.put(Names.REFRESH, build(Names.REFRESH, "scaling", groupSettings.get(Names.REFRESH), settingsBuilder().put("keep_alive", "5m").put("size", 10).build()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6769.java