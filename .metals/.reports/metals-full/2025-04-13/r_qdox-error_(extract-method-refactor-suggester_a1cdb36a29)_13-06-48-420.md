error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9803.java
text:
```scala
M@@enuItem orientationItem = new MenuItem(menu, SWT.CASCADE, index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9803.java