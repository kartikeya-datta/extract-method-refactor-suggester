error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14950.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14950.java
text:
```scala
private final b@@yte[] SINGLE = new byte[1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14950.java