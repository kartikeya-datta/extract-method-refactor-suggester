error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2374.java
text:
```scala
S@@ystem.arraycopy (children, 0, newItems, 0, Math.min (count, itemCount));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2374.java