error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4233.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4233.java
text:
```scala
public static l@@ong getCPtr(SWIGTYPE_p_f_r_btManifoldPoint_p_q_const__btCollisionObjectWrapper_int_int_p_q_const__btCollisionObjectWrapper_int_int__bool obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4233.java