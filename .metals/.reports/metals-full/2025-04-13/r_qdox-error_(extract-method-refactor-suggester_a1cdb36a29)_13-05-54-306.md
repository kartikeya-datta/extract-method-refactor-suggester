error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10541.java
text:
```scala
I@@WrapModel wrapOnAssignment(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10541.java