error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1756.java
text:
```scala
s@@uper.setUp(DROP_TABLES, EntityA.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1756.java