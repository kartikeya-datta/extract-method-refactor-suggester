error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9319.java
text:
```scala
a@@ssertEquals(expected, visitor.formComponent(new IFormVisitorParticipant()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9319.java