error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5380.java
text:
```scala
f@@ound = (((AntTypeDefinition) (i.next())).getExposedClass(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5380.java