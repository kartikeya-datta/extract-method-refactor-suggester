error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13507.java
text:
```scala
r@@eturn ManagementDescription.getAddNativeRemotingManagementDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13507.java