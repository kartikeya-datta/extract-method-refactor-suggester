error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16761.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16761.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16761.java
text:
```scala
i@@f (index != -1 && index != getSelectionIndex ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16761.java