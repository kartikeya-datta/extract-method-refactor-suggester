error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5876.java
text:
```scala
i@@f (index > 0 && currentMethod.declaringClass.isInterface()) // only check when inherited methods are from interfaces
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5876.java