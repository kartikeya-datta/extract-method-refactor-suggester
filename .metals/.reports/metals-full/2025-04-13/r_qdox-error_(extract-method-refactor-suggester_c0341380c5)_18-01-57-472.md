error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3371.java
text:
```scala
s@@uper(CharOperation.concat(name, FAKENAMESUFFIX), sourceStart, sourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3371.java