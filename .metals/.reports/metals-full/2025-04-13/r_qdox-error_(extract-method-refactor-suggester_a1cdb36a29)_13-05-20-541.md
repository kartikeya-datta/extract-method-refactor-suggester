error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5178.java
text:
```scala
a@@dvisor.internalBasicInitialize(getWorkbenchConfigurer());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5178.java