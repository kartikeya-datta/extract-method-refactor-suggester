error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7750.java
text:
```scala
f@@or (AttributeDefinition attr : TransportResource.TRANSPORT_ATTRIBUTES) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7750.java