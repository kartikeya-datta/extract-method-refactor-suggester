error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6342.java
text:
```scala
c@@lient("node1").admin().indices().prepareCreate("test").setSettings(ImmutableSettings.settingsBuilder().put("index.number_of_shards", 1).put("index.number_of_replicas", 2)).execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6342.java