error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3530.java
text:
```scala
C@@ollections.sort(result, ByValueRecommendedItemComparator.getInstance());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3530.java