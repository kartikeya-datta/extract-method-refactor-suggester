error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1714.java
text:
```scala
r@@eturn buildUrl(port, "/solr");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1714.java