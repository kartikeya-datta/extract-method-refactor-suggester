error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1408.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1408.java
text:
```scala
public static final S@@tring DEFAULT_PACKAGE_NAME = ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1408.java