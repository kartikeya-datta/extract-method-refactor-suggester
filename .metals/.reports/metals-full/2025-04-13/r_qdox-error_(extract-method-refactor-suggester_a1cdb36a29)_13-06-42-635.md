error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16907.java
text:
```scala
o@@ut = new FileOutputStream(getPathWithoutEscapes(url.getPath()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16907.java