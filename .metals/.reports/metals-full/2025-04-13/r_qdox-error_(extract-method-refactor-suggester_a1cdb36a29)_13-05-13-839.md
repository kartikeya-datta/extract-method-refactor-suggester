error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9597.java
text:
```scala
i@@nt midIndex =  left + (right - left) / 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9597.java