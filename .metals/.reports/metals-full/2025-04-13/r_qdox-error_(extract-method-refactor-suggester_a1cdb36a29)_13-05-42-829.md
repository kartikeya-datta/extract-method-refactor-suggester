error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3782.java
text:
```scala
T@@ermsLookup termsLookup = new TermsLookup(fieldMapper, lookupIndex, lookupType, lookupId, lookupPath, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3782.java