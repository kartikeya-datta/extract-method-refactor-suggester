error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7343.java
text:
```scala
d@@ocIdSets = new IdentityHashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7343.java