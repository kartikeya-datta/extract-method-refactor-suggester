error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1548.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1548.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1548.java
text:
```scala
p@@ublic abstract class Resource implements IResourceListener
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1548.java