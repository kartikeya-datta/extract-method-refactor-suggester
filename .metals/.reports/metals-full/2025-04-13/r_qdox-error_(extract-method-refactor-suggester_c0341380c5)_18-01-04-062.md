error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5471.java
text:
```scala
r@@eturn MockRamDirectoryService.class;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5471.java