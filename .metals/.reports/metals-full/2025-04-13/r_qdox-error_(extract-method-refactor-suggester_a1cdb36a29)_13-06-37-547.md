error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5193.java
text:
```scala
i@@nput = new ObjectInputStream(new GZIPInputStream(new FileInputStream(dir.getFD()), 8192));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5193.java