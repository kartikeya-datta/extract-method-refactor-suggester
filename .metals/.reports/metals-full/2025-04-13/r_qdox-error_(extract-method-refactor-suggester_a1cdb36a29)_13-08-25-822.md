error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9943.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9943.java
text:
```scala
t@@hrow new CommandLineException("Failed to resolve host '" + host + "'",e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9943.java