error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/582.java
text:
```scala
s@@tatic class Word
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/582.java