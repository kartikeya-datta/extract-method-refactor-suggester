error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3296.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3296.java
text:
```scala
d@@ata.font = Font.win32_new(this, OS.GetCurrentObject(handle, OS.OBJ_FONT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3296.java