error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3522.java
...
```java
offset: 896
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3522.java
text:
```scala
...
p@@ackage org.elasticsearch.common.io;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3522.java