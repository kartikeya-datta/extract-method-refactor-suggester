error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7835.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7835.java
text:
```scala
public i@@nt parameterCompatibilityLevel(MethodBinding method, TypeBinding[] arguments) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7835.java