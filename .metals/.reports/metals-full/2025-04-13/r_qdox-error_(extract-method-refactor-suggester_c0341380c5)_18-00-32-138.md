error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7033.java
text:
```scala
D@@EPENDENCY_INJECTION("setSessionContext"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7033.java