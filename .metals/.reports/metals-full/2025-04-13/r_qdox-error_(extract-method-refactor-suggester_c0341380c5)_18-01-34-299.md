error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6932.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6932.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6932.java
text:
```scala
d@@eps = new Array<AssetDescriptor>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6932.java