error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2747.java
text:
```scala
p@@ublic class StorageService implements IEndPointStateChangeSubscriber, StorageServiceMBean
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2747.java