error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14628.java
text:
```scala
S@@tring escapedValue = urlEncode(entry.getValue().toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14628.java