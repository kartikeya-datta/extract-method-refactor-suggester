error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2493.java
text:
```scala
A@@boutInfo aboutInfo = ((Workbench) PlatformUI.getWorkbench()).getConfigurationInfo().getAboutInfo();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2493.java