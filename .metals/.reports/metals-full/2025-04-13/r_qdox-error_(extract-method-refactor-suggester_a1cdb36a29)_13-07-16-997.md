error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13882.java
text:
```scala
r@@eturn Integer.valueOf(REPEAT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13882.java