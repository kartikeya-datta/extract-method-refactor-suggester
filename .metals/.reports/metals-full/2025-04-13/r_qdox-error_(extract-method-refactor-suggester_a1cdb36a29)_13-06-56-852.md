error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/648.java
text:
```scala
D@@erby interface for identifying the format id for the
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/648.java