error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6118.java
text:
```scala
i@@f (initializationType.isRawType() && (variableType.isBoundParameterizedType() || variableType.isGenericType())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6118.java