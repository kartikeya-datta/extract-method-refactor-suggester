error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8865.java
text:
```scala
B@@utton singleButton, multiButton, horizontalButton, verticalButton;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8865.java