error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9996.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9996.java
text:
```scala
public b@@oolean vSyncEnabled = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9996.java