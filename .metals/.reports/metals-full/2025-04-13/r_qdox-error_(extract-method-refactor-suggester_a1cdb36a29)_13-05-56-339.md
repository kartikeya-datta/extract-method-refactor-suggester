error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6712.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(false, true, NAME), new SecurityRealmChildRemoveHandler(false),
...
public class PlugInAuthorizationResourceDefinition extends AbstractPlugInAuthResourceDefinition {
    ...
    public PlugInAuthorizationResourceDefinition() {
        super(PathElement.pathElement(ModelDescriptionConstants.AUTHORIZATION, ModelDescriptionConstants.PLUG_IN),
                ...
                new SecurityRealmChildAddHandler(true, NAME), new SecurityRealmChildRemoveHandler(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6712.java