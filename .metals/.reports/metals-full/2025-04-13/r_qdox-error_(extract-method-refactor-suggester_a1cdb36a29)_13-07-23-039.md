error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6962.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6962.java
text:
```scala
R@@ectangle bounds = getMonitor ().getBounds ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6962.java