error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8504.java
text:
```scala
t@@ester.setupRequestAndResponse(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8504.java