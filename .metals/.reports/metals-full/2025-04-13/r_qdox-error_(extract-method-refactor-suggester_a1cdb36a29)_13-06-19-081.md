error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11377.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11377.java
text:
```scala
private final S@@erviceContainer serviceContainer = ServiceContainer.Factory.create("host-controller");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11377.java