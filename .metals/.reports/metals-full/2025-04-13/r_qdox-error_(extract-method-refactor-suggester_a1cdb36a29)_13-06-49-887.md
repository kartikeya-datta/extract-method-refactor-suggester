error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2953.java
text:
```scala
r@@eturn (float)(track.getCurrentTime() * 1000.0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2953.java