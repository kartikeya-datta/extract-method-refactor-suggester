error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5038.java
text:
```scala
i@@f (!master && latestDiscoNodes.masterNode() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5038.java