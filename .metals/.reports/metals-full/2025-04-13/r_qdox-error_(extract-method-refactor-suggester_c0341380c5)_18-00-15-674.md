error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12109.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12109.java
text:
```scala
protected F@@ile makeFile(File dir, String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12109.java