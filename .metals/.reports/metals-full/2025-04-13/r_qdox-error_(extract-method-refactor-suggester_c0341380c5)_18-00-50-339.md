error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7228.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7228.java
text:
```scala
final M@@ap<String, List<Suggest.Suggestion>> groupedSuggestions = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7228.java