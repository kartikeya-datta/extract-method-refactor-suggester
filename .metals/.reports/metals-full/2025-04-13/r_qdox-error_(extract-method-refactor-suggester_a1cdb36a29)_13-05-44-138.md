error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1902.java
text:
```scala
u@@i = new Stage(480, 320, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1902.java