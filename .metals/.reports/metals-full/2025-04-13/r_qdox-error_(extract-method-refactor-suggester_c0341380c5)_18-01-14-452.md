error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1788.java
text:
```scala
i@@nt /*long*/ setDirectionProc (int /*long*/ widget, int /*long*/ direction) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1788.java