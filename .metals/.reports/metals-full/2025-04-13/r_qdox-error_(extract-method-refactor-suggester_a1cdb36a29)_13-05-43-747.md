error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5909.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5909.java
text:
```scala
static i@@nt MINOR_VERSION = 526;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5909.java