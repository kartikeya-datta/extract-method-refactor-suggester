error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2202.java
text:
```scala
c@@ontainer.addColumn(subColumn);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2202.java