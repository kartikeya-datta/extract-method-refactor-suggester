error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2904.java
text:
```scala
b@@eginTask(Util.bind("workingCopy.commit"), 2); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2904.java