error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2589.java
text:
```scala
r@@eturn new Integer(TabbedPanel.this.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2589.java