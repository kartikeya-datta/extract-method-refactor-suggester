error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8004.java
text:
```scala
J@@dkORBExtension.getResourceDescriptionResolver(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8004.java