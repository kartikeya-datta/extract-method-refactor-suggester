error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12922.java
text:
```scala
s@@uper(PathElement.pathElement(SUBSYSTEM), CommonDescriptions.getResourceDescriptionResolver(EXTENSION, SUBSYSTEM));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12922.java