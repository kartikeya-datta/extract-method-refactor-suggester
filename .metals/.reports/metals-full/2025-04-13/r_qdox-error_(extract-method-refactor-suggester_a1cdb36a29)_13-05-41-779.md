error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2336.java
text:
```scala
i@@f (file instanceof IFile && org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(file.getName())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2336.java