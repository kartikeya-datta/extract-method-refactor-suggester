error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1037.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1037.java
text:
```scala
r@@eturn tabString(tab) + "Recovered import: " + importReference.toString(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1037.java