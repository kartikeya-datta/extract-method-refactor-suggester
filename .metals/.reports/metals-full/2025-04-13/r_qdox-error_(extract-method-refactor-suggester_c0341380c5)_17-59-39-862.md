error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10328.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10328.java
text:
```scala
public static final V@@ersion V_0_90_7 = new Version(V_0_90_7_ID, false, org.apache.lucene.util.Version.LUCENE_45);
...
public class Version implements Serializable {
    ...
    public static final Version V_0_90_7 = new Version(V_0_90_7_ID, true, org.apache.lucene.util.Version.LUCENE_45);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10328.java