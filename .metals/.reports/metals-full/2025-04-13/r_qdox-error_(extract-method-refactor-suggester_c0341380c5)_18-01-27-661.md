error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2488.java
text:
```scala
r@@eturn "PostingsFormat(name=" + name + ")";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2488.java