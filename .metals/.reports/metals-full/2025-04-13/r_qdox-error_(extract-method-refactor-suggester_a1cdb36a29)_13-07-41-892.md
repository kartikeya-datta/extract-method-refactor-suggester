error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16174.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16174.java
text:
```scala
protected M@@arkupElement onComponentTag(final ComponentTag tag) throws ParseException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16174.java