error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14809.java
text:
```scala
r@@eturn DeploymentDescription.getUndeployDeploymentOperation(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14809.java