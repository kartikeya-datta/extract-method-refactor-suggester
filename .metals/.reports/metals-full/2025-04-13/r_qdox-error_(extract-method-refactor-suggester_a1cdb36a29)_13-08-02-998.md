error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2807.java
text:
```scala
o@@ut.append(" | ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2807.java