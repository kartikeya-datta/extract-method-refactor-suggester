error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7445.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7445.java
text:
```scala
M@@ap<Integer, Long> controlDocToOrdinal = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7445.java