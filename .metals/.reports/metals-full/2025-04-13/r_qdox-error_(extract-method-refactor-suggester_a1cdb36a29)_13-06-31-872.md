error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8286.java
text:
```scala
X@@ContentBuilder builder = XContentFactory.contentBuilder(XContentType.JSON, cachedEntry.bytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8286.java