error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1006.java
text:
```scala
r@@eturn PredicatedSortedSet.predicatedSortedSet(new TreeSet<E>(), testPredicate);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1006.java