error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8744.java
text:
```scala
b@@yte[] bytes = Version.CURRENT.toString().getBytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8744.java