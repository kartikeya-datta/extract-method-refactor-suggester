error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11256.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11256.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11256.java
text:
```scala
p@@ublic final class SignIn2 extends WicketExamplePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11256.java