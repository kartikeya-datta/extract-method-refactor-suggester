error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15627.java
text:
```scala
i@@f (mod && !supportsModOperator)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15627.java