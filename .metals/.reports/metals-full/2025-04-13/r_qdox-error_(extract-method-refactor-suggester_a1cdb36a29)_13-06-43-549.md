error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17646.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[162,1]

error in qdox parser
file content:
```java
offset: 4998
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17646.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17646.java