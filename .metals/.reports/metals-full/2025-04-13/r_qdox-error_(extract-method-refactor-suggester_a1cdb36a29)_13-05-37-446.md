error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8327.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8327.java
text:
```scala
O@@S.CGEnableEventStateCombining(1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8327.java