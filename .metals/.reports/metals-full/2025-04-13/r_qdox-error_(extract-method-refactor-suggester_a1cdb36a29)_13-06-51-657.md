error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4982.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4982.java
text:
```scala
i@@f (referenceType != null && (referenceType.isBoundParameterizedType() || referenceType.isGenericType() || referenceType.isTypeVariable())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4982.java