error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/978.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/978.java
text:
```scala
public static final S@@tring MSG = " Processing Document # ";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/978.java