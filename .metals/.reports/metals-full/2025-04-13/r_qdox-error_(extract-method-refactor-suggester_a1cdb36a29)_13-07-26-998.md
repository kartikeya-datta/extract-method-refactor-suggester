error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/863.java
text:
```scala
a@@ssertEquals("Jozef's address is unknown.", performCall("api/person/Jozef/address"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/863.java