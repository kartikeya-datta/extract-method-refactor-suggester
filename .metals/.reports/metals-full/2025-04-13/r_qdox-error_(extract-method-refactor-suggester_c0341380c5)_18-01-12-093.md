error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4338.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4338.java
text:
```scala
final S@@tring content = waitBeforeRedirectInSeconds + ";URL=" + url;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4338.java