error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11692.java
text:
```scala
p@@ublic class ComponentCreateTag_4 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11692.java