error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4979.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4979.java
text:
```scala
public C@@lass<?> getClass(JDBCStore store, ClassMapping base, Result result)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4979.java