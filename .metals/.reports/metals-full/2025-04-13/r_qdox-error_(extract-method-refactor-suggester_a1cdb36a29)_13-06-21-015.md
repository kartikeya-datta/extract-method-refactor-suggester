error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5205.java
text:
```scala
i@@ndexTemplateService.removeTemplate(new MetaDataIndexTemplateService.RemoveRequest(request.getName()), new MetaDataIndexTemplateService.RemoveListener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5205.java