error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15079.java
text:
```scala
t@@his(store.getConfiguration().getMappingRepositoryInstance().getMapping
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15079.java