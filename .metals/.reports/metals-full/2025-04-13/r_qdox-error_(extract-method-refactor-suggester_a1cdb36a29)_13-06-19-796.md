error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3534.java
text:
```scala
r@@eturn ThreadPool.Names.INDEX;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3534.java