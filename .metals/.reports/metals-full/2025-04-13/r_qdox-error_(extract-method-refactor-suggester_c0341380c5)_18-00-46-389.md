error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5420.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5420.java
text:
```scala
@Override public final b@@oolean incrementToken() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5420.java