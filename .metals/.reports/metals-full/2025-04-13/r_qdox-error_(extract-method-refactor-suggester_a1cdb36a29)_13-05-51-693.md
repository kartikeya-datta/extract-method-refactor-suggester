error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2144.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2144.java
text:
```scala
private static final L@@og logger = LogFactory.getLog(ResponseBodyAdviceChain.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2144.java