error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5577.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5577.java
text:
```scala
static i@@nt MINOR_VERSION = 212;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5577.java