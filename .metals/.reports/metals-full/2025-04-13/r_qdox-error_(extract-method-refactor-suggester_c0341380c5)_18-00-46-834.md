error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17213.java
text:
```scala
c@@ycle.setPage(cycle.getPageFactory().newPage(BookDetails.class, parameters));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17213.java