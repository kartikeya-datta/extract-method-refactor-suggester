error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8763.java
text:
```scala
t@@his.resolvedType = ((this.bits & IsStrictlyAssignedMASK) == 0) ? elementType.capture(scope, this.sourceEnd) : elementType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8763.java