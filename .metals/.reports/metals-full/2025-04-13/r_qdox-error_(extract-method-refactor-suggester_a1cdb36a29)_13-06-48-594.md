error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8367.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8367.java
text:
```scala
public b@@oolean isAffected(IJavaElementDelta delta) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8367.java