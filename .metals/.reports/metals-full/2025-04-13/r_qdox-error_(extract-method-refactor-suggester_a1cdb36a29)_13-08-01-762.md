error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1839.java
text:
```scala
i@@f (!(i.next() instanceof FileProvider)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1839.java