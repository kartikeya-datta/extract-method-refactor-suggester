error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8905.java
text:
```scala
p@@repareForRender(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8905.java