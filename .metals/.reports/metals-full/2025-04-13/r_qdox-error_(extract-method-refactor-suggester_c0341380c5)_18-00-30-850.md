error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1960.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1960.java
text:
```scala
public R@@eferenceBinding[] handledExceptions;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1960.java