error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4666.java
text:
```scala
w@@ordList = Analysis.getWordSet(env, settings, "word_list");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4666.java