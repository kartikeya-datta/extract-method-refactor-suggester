error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/503.java
text:
```scala
B@@uildExecutor.executeAnt("jni/build-windows32home.xml", "-Dhas-compiler=true clean postcompile -v");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/503.java