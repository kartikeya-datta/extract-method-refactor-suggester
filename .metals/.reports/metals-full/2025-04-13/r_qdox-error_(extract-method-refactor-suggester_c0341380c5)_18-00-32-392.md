error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6559.java
text:
```scala
T@@estUtils.assertEquals(statistic.evaluate(repeatedValues),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6559.java