error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4009.java
text:
```scala
A@@smAdaptor.nodeMunger(world.getModel(), this, munger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4009.java