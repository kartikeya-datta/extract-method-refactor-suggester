error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2387.java
text:
```scala
i@@f (statements[i] instanceof Block || statements[i] instanceof EmptyStatement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2387.java