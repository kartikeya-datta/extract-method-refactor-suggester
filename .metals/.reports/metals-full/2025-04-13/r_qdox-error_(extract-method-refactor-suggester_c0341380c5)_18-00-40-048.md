error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8863.java
text:
```scala
t@@hrow new ConverterNotFoundException(sourceType, targetElementType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8863.java