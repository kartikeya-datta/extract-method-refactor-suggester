error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4363.java
text:
```scala
l@@og.info(war.toString(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4363.java