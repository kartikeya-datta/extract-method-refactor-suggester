error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/630.java
text:
```scala
o@@mitNorms = mapper.omitNorms();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/630.java