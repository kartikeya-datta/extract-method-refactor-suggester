error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11044.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11044.java
text:
```scala
protected v@@oid onSelectionChanged(String newSelection)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11044.java