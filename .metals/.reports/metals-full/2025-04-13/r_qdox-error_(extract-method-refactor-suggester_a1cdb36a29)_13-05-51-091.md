error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14679.java
text:
```scala
r@@eturn HttpRequest.get(managementClient.getWebUri() + "/hibernate3_test/" + urlPattern + "?input=" + param, 10, SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14679.java