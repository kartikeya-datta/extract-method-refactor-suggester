error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5326.java
text:
```scala
p@@age.openEditor(editor.getEditorInput(), editorId, true, WorkbenchPage.MATCH_NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5326.java