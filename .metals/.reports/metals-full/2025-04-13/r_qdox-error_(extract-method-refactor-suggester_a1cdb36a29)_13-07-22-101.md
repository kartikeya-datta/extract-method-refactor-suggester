error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5382.java
text:
```scala
s@@uper(layout.repo_search_item, inflater, elements);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5382.java