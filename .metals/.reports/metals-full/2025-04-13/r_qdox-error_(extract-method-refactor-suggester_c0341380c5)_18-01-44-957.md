error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10397.java
text:
```scala
r@@eturn new ShardGatewaySnapshotRequest(shard.index(), shard.id(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10397.java