error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6111.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6111.java
text:
```scala
i@@f (enclosingType != null && (enclosingType.isGenericType() || enclosingType.isParameterizedType())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6111.java