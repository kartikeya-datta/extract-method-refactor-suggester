error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5176.java
text:
```scala
n@@ew Object[] { Integer.valueOf(maxIterations) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5176.java