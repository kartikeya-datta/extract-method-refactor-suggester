error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6466.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6466.java
text:
```scala
public static i@@nt BYTES_LIMIT = 1 * 1024 * 1024; // don't cache entries that are bigger than that...
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6466.java