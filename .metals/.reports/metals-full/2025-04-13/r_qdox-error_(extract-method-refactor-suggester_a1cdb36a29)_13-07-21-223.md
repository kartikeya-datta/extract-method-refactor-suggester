error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3459.java
text:
```scala
u@@seDisMax = jp.getIntValue() != 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3459.java