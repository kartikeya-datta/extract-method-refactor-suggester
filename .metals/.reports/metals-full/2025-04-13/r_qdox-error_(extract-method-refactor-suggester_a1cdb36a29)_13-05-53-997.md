error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9673.java
text:
```scala
i@@f (!MapperService.DEFAULT_MAPPING.equals(mappingType) && !PercolatorService.TYPE_NAME.equals(mappingType) && mappingType.charAt(0) == '_') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9673.java