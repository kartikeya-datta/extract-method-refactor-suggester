error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8857.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8857.java
text:
```scala
r@@eturn "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8857.java