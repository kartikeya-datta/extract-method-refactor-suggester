error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3858.java
text:
```scala
R@@eplica tempSourceLeader = zkStateReader.getLeaderRetry(tempSourceCollectionName, tempSourceSlice.getName(), 60000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3858.java