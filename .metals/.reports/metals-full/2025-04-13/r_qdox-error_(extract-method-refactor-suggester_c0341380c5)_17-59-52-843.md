error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3709.java
text:
```scala
i@@f (extension != null && (extension.toLowerCase().equals("java") || extension.toLowerCase().equals("class"))) { //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3709.java