error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8770.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8770.java
text:
```scala
final O@@bject replacementValue = getReplaceModel().getObject(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8770.java