error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4013.java
text:
```scala
C@@onnectorServices.MANAGEMENT_REPOSITORY_SERVICE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4013.java