error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12976.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12976.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12976.java
text:
```scala
e@@rror(component, resourceKey(component), map);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12976.java