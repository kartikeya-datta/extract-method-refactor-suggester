error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1397.java
text:
```scala
S@@impleStageCullingTest.class, SoundTest.class, SpriteCacheTest.class, SpriteCacheOffsetTest.class, LetterBoxTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1397.java