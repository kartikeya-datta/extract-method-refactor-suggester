error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1819.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1819.java
text:
```scala
r@@eturn (Function) ((Class) functions.get(functionName)).newInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1819.java