error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16173.java
text:
```scala
t@@his(id, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16173.java