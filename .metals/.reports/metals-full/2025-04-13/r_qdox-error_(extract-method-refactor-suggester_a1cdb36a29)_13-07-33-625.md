error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/124.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/124.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/124.java
text:
```scala
t@@hrow ThreadsLogger.ROOT_LOGGER.unsupportedScheduledThreadPoolMetric(attributeName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/124.java