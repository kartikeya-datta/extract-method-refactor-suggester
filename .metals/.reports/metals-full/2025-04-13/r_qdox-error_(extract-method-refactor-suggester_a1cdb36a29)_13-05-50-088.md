error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5358.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5358.java
text:
```scala
public B@@rokerHosts hosts;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5358.java