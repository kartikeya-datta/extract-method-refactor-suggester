error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9347.java
text:
```scala
s@@cope.problemReporter().forwardReference(this, 0, fieldBinding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9347.java