error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10734.java
text:
```scala
p@@arent.registerSubResource(pathElement, pathTransformation, resourceTransformer, operationTransformer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10734.java