error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5840.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5840.java
text:
```scala
U@@til.safeCopy(handlersByCommandId, String.class, IHandler.class, false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5840.java