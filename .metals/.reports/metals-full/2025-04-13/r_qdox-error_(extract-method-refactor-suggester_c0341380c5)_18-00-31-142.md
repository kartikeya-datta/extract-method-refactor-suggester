error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9629.java
text:
```scala
c@@hild.draw(batch, parentAlpha);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9629.java