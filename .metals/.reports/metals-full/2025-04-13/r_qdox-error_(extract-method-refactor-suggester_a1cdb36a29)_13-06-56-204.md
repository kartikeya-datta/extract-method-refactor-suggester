error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/147.java
text:
```scala
u@@pdateContext.addDeploymentProcessor(Phase.PARSE, new DataSourcesAttachmentProcessor(datasources), Phase.PARSE_DATA_SOURCES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/147.java