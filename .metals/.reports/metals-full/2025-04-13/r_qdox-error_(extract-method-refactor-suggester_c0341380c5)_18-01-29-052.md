error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6202.java
text:
```scala
i@@f (comparison > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6202.java