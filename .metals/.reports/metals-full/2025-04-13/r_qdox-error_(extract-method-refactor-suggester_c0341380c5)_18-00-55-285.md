error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2144.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2144.java
text:
```scala
public C@@ompatibilitySpace createCompatibilitySpace(LockOwner owner);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2144.java