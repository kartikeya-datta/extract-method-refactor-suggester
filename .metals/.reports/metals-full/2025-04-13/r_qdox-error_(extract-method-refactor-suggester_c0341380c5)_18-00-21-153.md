error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6480.java
text:
```scala
s@@hardInjector.getInstance(Translog.class).close(delete);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6480.java