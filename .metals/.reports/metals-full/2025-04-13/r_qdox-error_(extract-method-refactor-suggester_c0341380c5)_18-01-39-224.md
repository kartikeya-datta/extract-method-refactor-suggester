error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5604.java
text:
```scala
i@@f (WorkbenchPlugin.getDefault().isDebugging()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5604.java