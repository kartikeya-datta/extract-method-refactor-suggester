error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10863.java
text:
```scala
O@@S.GetEventParameter (event [0], OS.kEventParamModalClickResult, OS.typeModalClickResult, null, 4, null, clickResult);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10863.java