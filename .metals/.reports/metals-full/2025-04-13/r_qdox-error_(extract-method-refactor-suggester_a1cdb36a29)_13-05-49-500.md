error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/181.java
text:
```scala
d@@ata = new HashMap(2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/181.java