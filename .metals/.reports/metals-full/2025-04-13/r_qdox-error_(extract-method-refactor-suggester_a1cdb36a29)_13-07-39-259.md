error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7188.java
text:
```scala
r@@eturn this.problemId;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7188.java