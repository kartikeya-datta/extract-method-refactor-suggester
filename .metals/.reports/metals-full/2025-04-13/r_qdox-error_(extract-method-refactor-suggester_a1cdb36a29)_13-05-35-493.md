error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6940.java
text:
```scala
c@@ompensatingOperation.get(OP).set("enable");
 ...
 */
class NewDeploymentScannerDisable implements ModelUpdateOperationHandler, RuntimeOperationHandler {

    static final NewDeploymentScannerDisable INSTANCE = new NewDeploymentScannerDisable();

    private NewDeploymentScannerDisable() {
        //
    }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6940.java