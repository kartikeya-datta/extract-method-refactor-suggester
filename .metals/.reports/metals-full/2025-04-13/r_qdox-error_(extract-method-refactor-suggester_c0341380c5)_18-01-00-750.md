error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15937.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15937.java
text:
```scala
private final S@@tring document;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15937.java