error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7797.java
text:
```scala
i@@f ( !getFileName().endsWith("."+extension) ) return Messages.NewExtXptResourceWizardPage_Error+extension;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7797.java