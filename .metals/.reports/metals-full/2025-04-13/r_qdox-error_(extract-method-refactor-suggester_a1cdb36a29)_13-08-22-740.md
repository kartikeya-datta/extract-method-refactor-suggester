error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9540.java
text:
```scala
m@@enu.release (true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9540.java