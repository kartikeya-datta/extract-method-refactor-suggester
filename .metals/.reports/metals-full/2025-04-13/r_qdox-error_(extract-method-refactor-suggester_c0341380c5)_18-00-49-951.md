error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5193.java
text:
```scala
i@@f (this.isOpen() && this.getKind() != IPackageFragmentRoot.K_SOURCE) return null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5193.java