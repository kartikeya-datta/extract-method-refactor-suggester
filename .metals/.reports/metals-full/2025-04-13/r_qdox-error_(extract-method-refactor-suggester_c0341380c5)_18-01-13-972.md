error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/980.java
text:
```scala
D@@erby - Class org.apache.derby.iapi.util.DoubleProperties
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/980.java