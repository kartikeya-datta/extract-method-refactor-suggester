error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2937.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2937.java
text:
```scala
r@@eturn this.id.hashCode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2937.java