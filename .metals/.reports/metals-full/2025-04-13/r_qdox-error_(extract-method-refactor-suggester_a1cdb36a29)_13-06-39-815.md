error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13709.java
text:
```scala
S@@tring ROLE = Embeddor.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13709.java