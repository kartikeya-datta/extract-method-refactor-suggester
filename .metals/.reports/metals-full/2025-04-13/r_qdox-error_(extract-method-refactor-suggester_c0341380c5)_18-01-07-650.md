error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2673.java
...
```java
offset: 703
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2673.java
text:
```scala
 ...
 *
 */
p@@ackage org.apache.tools.ant.dispatch;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2673.java