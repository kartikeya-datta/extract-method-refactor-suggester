error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1259.java
text:
```scala
l@@ong position = ((long)start << 32) + end;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1259.java