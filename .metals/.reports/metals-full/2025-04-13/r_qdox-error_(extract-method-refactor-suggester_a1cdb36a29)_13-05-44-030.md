error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/608.java
text:
```scala
i@@nt count = OS.GetControl32BitMaximum (handle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/608.java