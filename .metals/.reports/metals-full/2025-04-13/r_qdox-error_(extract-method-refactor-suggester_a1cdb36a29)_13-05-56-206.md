error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10148.java
text:
```scala
h@@eader = new FileHandle("assets/licence-header.txt").readString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10148.java