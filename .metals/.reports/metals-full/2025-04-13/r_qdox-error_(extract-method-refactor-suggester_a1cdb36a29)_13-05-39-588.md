error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13495.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[77,2]

error in qdox parser
file content:
```java
offset: 2761
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13495.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13495.java