error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3310.java
text:
```scala
T@@hread.sleep(Math.max(10000, attemptCount * retryDelay));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3310.java