error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2069.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2069.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2069.java
text:
```scala
S@@tring resourceName = resource.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2069.java