error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1831.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1831.java
text:
```scala
public static final S@@tring NAME = "indices:admin/mappings/fields/get";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1831.java