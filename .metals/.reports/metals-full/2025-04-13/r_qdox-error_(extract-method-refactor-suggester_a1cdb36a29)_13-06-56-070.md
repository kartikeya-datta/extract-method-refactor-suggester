error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9682.java
text:
```scala
C@@ollection activePerspectives = manager.getEnabledObjects();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9682.java