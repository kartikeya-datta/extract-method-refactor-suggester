error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2971.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2971.java
text:
```scala
i@@f (fieldType().stored() != Defaults.SIZE_FIELD_TYPE.stored() && enabledState.enabled) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2971.java