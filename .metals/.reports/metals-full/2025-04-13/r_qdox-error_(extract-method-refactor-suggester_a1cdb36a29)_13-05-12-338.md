error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7111.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7111.java
text:
```scala
t@@his.findMarkupStream().getWicketNamespace()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7111.java