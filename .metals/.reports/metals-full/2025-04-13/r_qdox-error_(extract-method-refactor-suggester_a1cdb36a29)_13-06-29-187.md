error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8602.java
text:
```scala
c@@hannel.sendResponse(new StringMessage("hello " + request.message), TransportResponseOptions.options().withCompress(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8602.java