error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13797.java
text:
```scala
t@@hrow SarMessages.MESSAGES.nullVar("name");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13797.java