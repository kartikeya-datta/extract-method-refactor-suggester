error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6886.java
text:
```scala
c@@e.setDescription("exp(- " + valueExpl + " * " + -1 * scale + ")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6886.java