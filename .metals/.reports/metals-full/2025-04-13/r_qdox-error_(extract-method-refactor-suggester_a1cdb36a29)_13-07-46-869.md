error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/797.java
text:
```scala
c@@onfiguration.addViewInterceptor(method, ComponentTypeIdentityInterceptorFactory.INSTANCE, InterceptorOrder.View.SESSION_BEAN_EQUALS_HASHCODE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/797.java