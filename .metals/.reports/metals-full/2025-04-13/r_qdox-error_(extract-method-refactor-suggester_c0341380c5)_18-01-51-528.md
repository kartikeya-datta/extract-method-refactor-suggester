error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6283.java
text:
```scala
s@@witchStatement.setExpression(convert(statement.expression));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6283.java