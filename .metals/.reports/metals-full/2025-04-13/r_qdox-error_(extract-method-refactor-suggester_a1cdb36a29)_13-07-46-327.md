error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3455.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3455.java
text:
```scala
static i@@nt MINOR_VERSION = 606;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3455.java