error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4191.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4191.java
text:
```scala
private S@@tring jbossHome = System.getProperty("jboss.home");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4191.java