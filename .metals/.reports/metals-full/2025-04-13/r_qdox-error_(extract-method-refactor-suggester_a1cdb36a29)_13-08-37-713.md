error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1970.java
text:
```scala
i@@f(cases[i].isEnumConstant && cases[i].constantExpression instanceof SingleNameReference) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1970.java