error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2900.java
text:
```scala
M@@athConfigurationException ex = new MathConfigurationException(cause, pattern, arguments);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2900.java