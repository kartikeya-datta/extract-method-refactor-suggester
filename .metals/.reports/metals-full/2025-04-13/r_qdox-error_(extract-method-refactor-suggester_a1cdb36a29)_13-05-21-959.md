error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7601.java
text:
```scala
i@@f (true) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7601.java