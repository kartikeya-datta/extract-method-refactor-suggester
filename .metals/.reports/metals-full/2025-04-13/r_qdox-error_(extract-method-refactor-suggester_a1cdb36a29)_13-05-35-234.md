error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12939.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12939.java
text:
```scala
private final S@@tring[] tokenizedPattern;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12939.java