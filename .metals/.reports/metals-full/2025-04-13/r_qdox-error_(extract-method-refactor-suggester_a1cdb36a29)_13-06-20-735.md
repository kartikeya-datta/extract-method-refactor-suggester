error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12702.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12702.java
text:
```scala
i@@f (sm.isNew() && !sm.isDeleted())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12702.java