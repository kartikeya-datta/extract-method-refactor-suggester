error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1946.java
text:
```scala
a@@ssertThat("Expected id: " + ids[i] + " at position " + i + " but wasn't." + shardStatus, hit.getId(), equalTo(ids[i]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1946.java