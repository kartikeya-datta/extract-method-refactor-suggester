error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5844.java
...
```java
offset: 825
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5844.java
text:
```scala
...
public class LwjglAudioRecorder implements AudioRecorder {
	...
	public LwjglAudioRecorder (int samplingRate, boolean isMono) {
		try {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5844.java