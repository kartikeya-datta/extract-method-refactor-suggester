error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9522.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9522.java
text:
```scala
public I@@MailboxInfo getMessageFolderInfo();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9522.java