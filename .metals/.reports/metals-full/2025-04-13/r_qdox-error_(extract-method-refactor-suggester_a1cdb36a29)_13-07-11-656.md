error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12668.java
text:
```scala
S@@erviceController<?> controller = AsynchronousService.addService(target, JVM_ROUTE_REGISTRY_SERVICE_NAME, new RegistryService(cache, providerValue))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12668.java