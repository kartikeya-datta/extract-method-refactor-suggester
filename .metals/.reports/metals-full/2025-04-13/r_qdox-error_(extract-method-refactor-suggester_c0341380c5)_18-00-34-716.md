error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2498.java
text:
```scala
i@@f (!result.isDigestQuery())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2498.java