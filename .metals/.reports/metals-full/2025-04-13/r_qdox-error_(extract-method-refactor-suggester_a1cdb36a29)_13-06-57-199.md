error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17273.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17273.java
text:
```scala
public f@@loat /*double*/ drawXOffset, drawYOffset;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17273.java