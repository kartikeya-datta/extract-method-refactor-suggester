error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1302.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1302.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1302.java
text:
```scala
public C@@olumn(byte[] name, byte[] value)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1302.java