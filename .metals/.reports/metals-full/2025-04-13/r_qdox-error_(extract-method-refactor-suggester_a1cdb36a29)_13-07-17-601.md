error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9345.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9345.java
text:
```scala
p@@ublic abstract class AbstractStringResourceLoader  implements IStringResourceLoader
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9345.java