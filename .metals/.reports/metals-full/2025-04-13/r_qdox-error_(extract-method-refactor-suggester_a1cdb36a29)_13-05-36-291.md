error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9619.java
text:
```scala
i@@f (args.length > 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9619.java