error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15245.java
text:
```scala
r@@eturn "setTimeout(function() { " + getCallbackScript(false) + " }, "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15245.java