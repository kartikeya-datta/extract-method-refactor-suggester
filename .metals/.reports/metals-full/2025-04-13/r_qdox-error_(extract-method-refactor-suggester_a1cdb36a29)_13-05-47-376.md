error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10372.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10372.java
text:
```scala
public v@@oid onEntryChosenForEviction(DomainInfo arg0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10372.java