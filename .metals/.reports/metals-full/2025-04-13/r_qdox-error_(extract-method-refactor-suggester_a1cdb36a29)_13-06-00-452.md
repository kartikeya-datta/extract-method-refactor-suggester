error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10143.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1871,2]

error in qdox parser
file content:
```java
offset: 72750
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10143.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10143.java