error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7804.java
text:
```scala
c@@omparator = PathFileComparator.PATH_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7804.java