error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7886.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh().force(request.force()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7886.java