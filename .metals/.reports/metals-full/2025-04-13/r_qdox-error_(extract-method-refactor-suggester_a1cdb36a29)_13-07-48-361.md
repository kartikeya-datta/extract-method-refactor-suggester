error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10788.java
...
```java
offset: 602
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10788.java
text:
```scala
...
******************************************************************************/
p@@ackage org.eclipse.ecf.tests.sharedobject;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10788.java