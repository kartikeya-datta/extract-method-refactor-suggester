error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8725.java
text:
```scala
r@@eturn ThreadPool.Names.LISTENER;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8725.java