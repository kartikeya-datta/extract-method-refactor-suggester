error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7678.java
text:
```scala
i@@nt fontHeight = info.ascent + info.descent + info.leading;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7678.java