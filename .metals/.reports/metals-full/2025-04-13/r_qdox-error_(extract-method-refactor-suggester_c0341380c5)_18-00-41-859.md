error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10175.java
text:
```scala
s@@etValue(this.conversionService.convert(text, this.targetDescriptor));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10175.java