error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/645.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/645.java
text:
```scala
public L@@ong convertToObject(final String value, final Locale locale)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/645.java