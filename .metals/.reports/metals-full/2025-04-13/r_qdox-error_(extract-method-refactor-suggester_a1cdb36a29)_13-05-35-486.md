error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1568.java
text:
```scala
d@@ata.widthHint = convertHorizontalDLUsToPixels(IDialogConstants.MINIMUM_MESSAGE_AREA_WIDTH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1568.java