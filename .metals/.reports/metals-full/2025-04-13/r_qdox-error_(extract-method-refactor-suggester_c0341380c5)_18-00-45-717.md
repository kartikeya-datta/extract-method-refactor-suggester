error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16817.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16817.java
text:
```scala
static final X@@SImplementationImpl singleton = new XSImplementationImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16817.java