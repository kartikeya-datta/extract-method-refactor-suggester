error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1800.java
text:
```scala
r@@eturn "SessionConnectEvent" + this.message;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1800.java