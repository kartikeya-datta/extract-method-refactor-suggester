error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2617.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2617.java
text:
```scala
public v@@oid sendRequest(TrunkRequest request) throws IOException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2617.java