error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/387.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[491,2]

error in qdox parser
file content:
```java
offset: 15155
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/387.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/387.java