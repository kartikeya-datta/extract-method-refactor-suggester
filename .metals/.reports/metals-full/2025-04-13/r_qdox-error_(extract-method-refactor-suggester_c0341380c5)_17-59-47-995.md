error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2224.java
text:
```scala
s@@uite.addTest(SecurityPolicyReloadingTest.suite());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2224.java