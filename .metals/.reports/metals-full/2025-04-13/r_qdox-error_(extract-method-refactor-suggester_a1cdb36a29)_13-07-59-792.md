error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3313.java
text:
```scala
r@@eturn hash(name, originalForm, WORD_LIKE_VALUE_HASH_SEED + i, data.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3313.java