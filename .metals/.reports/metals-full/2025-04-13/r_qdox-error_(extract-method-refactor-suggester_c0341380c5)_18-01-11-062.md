error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14889.java
text:
```scala
n@@umberFormat = newNumberFormat(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14889.java