error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6829.java
text:
```scala
s@@uper(new Names(name, indexName, indexName, name), boost, fieldType, null, Lucene.KEYWORD_ANALYZER,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6829.java