error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16072.java
text:
```scala
f@@ilePanel = new FilePanel(JMeterUtils.getResString("html_assertion_file"), ".txt"); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16072.java