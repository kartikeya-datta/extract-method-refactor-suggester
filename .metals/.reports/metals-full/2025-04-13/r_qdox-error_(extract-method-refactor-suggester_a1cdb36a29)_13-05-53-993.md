error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12550.java
text:
```scala
t@@hrow new IOException("This archive contains unclosed entries.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12550.java