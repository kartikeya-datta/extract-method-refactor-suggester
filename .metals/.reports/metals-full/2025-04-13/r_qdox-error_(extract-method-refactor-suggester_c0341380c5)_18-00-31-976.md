error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3276.java
text:
```scala
i@@f ((targetType = type.resolveType(scope, true /* check bounds*/)) == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3276.java