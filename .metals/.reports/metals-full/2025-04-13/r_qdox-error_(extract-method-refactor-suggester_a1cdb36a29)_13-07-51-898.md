error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3178.java
text:
```scala
i@@dentifiers = OS.CFArrayCreateMutable (OS.kCFAllocatorDefault, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3178.java