error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/475.java
text:
```scala
I@@Resource file = classFile.resource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/475.java