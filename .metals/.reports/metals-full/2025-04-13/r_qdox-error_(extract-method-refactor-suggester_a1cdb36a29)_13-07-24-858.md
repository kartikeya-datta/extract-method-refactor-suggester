error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/264.java
text:
```scala
r@@eturn new StringBuffer("CompilationUnit(").append(getFileName()).append(")").toString(); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/264.java