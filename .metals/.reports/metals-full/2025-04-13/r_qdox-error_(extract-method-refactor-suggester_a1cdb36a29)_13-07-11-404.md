error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3161.java
text:
```scala
p@@ercolateRequest.source(request.content(), request.contentUnsafe());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3161.java