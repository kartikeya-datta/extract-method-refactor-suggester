error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4088.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4088.java
text:
```scala
l@@istSelectedIndex = (int) ((getHeight() - style.listBackground.getTopHeight() - y) / itemHeight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4088.java