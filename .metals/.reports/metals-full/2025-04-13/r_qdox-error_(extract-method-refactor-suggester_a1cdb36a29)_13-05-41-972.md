error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1958.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[115,2]

error in qdox parser
file content:
```java
offset: 3733
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1958.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1958.java