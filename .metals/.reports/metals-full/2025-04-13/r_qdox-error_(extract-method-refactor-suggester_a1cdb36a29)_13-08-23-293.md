error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13419.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13419.java
text:
```scala
static i@@nt WindowClassCount;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13419.java