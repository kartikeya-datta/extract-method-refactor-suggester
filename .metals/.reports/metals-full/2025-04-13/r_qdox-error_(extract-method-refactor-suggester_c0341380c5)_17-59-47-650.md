error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3151.java
text:
```scala
S@@tring bodySettings = request.content().toUtf8();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3151.java