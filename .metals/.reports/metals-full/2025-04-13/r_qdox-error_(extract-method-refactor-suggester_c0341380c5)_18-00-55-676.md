error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5752.java
text:
```scala
v@@erticalBar.postEvent (SWT.Selection, event);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5752.java