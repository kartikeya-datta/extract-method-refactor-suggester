error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12227.java
text:
```scala
r@@eturn new ServiceURL(stid.getInternal() + "://" + getLocation().getScheme() + "://" + getLocation().getAuthority(), ServiceURL.LIFETIME_PERMANENT); //$NON-NLS-1$ //$NON-NLS-2$
...
public class JSLPServiceInfo extends ServiceInfo implements IServiceInfo {
	...
	public ServiceURL getServiceURL() throws ServiceLocationException {
		...
		return new ServiceURL(stid.getInternal() + "://" + getLocation().getScheme() + "://" + getLocation().getAuthority(), ServiceURL.LIFETIME_PERMANENT); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
}
```
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12227.java