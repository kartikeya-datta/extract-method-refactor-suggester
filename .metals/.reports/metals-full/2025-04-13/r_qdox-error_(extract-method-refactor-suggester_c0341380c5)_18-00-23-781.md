error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5505.java
text:
```scala
c@@odeStream.recordPositionsFrom(0, this.declarationSourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5505.java