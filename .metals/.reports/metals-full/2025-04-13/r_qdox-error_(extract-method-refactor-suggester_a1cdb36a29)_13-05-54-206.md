error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6407.java
text:
```scala
n@@ew XmlPullParser(getSettings().getDefaultMarkupEncoding()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6407.java