error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13717.java
text:
```scala
t@@hrow new BrowseFileTransferException("HttpClient Provider is not configured to support NTLM proxy authentication.", HttpClientOptions.NTLM_PROXY_RESPONSE_CODE); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13717.java