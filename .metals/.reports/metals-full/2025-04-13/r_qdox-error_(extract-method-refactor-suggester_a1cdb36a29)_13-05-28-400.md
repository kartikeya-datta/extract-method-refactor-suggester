error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14194.java
...
```java
offset: 1088
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14194.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.test.integration.osgi.configadmin.bundle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14194.java