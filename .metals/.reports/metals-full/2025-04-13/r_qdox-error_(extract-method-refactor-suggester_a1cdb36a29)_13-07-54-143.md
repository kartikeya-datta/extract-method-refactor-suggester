error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1423.java
text:
```scala
i@@f (endpointsnitch.getDatacenter(localEndpoint).equals(endpointsnitch.getDatacenter(message.getFrom())))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1423.java