error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17981.java
text:
```scala
i@@f (tag == null  || tag.getId() != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17981.java