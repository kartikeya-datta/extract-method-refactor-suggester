error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5582.java
text:
```scala
S@@electFolderDialog dialog = new SelectFolderDialog(getFrameMediator());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5582.java