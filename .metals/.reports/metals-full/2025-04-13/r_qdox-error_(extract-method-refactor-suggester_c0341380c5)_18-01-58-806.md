error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3344.java
text:
```scala
b@@adlogicSmall.getRegion().flip(true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3344.java