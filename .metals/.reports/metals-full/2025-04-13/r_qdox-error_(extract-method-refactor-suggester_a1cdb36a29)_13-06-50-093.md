error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/85.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/85.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/85.java
text:
```scala
b@@ody.setStringValue(sb.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/85.java