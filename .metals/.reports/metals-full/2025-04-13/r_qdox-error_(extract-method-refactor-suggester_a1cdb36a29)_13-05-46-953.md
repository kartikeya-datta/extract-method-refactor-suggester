error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1806.java
text:
```scala
S@@ystem.out.println(new ProductConfig(Module.getBootModuleLoader(), jbossHome, null).getPrettyVersionString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1806.java