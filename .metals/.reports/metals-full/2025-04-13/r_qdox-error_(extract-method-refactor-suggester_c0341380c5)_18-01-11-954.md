error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6486.java
text:
```scala
s@@etEmptyText(string.no_news);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6486.java