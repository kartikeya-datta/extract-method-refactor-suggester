error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3545.java
text:
```scala
l@@ogger_.info("PHI for " + ep + " : " + phi);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3545.java