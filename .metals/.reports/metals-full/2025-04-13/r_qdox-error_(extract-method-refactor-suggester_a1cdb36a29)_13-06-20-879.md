error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9787.java
text:
```scala
g@@enericSignature = CharOperation.replaceOnCopy(genericSignature, '/', '.');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9787.java