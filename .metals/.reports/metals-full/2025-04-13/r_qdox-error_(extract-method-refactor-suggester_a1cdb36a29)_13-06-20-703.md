error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12995.java
text:
```scala
p@@arent.updateColumnWidth (this, width);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12995.java