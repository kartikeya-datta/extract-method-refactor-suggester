error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11975.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11975.java
text:
```scala
private static final L@@og logger = LogFactory.getLog("_" + ConcurrentWebSocketSessionDecorator.class.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11975.java