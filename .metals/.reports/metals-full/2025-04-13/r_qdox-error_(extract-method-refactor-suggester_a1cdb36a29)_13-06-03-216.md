error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1829.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1829.java
text:
```scala
public static final S@@tring NAME = "indices:admin/flush";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1829.java