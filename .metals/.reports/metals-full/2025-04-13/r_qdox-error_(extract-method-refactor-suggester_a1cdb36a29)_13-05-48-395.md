error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4101.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4101.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4101.java
text:
```scala
i@@f (actor != null && !actor.isDescendantOf(this)) previousScrollFocus = actor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4101.java