error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8762.java
text:
```scala
i@@nput = new AndroidInput(this, this.getService(), null, config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8762.java