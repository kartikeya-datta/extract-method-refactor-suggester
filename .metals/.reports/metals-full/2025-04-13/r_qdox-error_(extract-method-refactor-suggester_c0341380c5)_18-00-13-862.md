error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1429.java
text:
```scala
I@@OUtils.closeSafely(false, cfsdir);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1429.java