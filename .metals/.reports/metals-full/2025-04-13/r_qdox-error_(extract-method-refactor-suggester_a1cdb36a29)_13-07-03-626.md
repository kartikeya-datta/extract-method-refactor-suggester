error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6981.java
text:
```scala
g@@etResourceSettings().setResourcePollFrequency(Duration.ONE_SECOND);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6981.java