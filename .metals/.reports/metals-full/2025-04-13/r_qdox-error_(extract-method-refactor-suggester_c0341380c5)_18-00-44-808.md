error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2454.java
text:
```scala
c@@ontext.write(new Text(key.toString().split("/")[1]), new VectorWritable(result));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2454.java