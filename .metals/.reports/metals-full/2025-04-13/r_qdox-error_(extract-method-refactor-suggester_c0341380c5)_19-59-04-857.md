error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5492.java
text:
```scala
i@@f (parameter == TypeBinding.LONG || parameter == TypeBinding.DOUBLE) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5492.java