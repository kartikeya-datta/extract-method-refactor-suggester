error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1717.java
...
```java
offset: 60
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1717.java
text:
```scala
public class UserComparator implements Comparator<User> {

p@@ackage com.github.mobile.android.repo;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1717.java