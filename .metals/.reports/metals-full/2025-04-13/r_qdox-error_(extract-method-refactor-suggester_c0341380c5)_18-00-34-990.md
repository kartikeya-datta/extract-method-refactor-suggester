error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1874.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1874.java
text:
```scala
public static final S@@tring NAME = "indices:data/read/msearch";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1874.java