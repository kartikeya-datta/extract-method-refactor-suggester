error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1183.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1183.java
text:
```scala
protected static l@@ong getCPtr(SWIGTYPE_p_btDiscreteCollisionDetectorInterface__Result obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1183.java