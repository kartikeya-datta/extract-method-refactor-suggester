error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4630.java
text:
```scala
f@@ield.name = fieldHandle.getElementName().toCharArray();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4630.java