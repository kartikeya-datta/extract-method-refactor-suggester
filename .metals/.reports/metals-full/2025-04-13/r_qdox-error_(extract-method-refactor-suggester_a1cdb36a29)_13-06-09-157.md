error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6996.java
text:
```scala
b@@ucketOrds = new LongHash(initialCapacity, aggregationContext.bigArrays());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6996.java