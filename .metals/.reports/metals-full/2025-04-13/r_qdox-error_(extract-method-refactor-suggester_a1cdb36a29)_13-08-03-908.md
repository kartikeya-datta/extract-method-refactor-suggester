error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6447.java
text:
```scala
a@@dd(new Label("c1", "some border title"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6447.java