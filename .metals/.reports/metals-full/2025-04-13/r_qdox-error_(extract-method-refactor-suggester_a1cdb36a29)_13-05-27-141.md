error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3973.java
text:
```scala
t@@raversedContext.recordReturnFrom(flowInfo.unconditionalInits());//TODO: (philippe) not only if distinct from target?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3973.java