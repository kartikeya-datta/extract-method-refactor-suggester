error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3225.java
text:
```scala
i@@f (!Scope.areTypesCompatible(thisTb, expectedTb)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3225.java