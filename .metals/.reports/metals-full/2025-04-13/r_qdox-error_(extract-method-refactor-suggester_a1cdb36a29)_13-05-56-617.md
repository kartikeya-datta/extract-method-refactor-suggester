error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/381.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/381.java
text:
```scala
protected v@@oid update(final int position, final RepositoryItemView view, final SearchRepository repository) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/381.java