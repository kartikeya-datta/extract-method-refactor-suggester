error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5300.java
text:
```scala
i@@f (!isVisible())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5300.java