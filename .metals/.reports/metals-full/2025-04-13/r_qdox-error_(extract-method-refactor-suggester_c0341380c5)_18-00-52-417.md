error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11573.java
text:
```scala
p@@ublic class MockPageWithFormAndAjaxFormSubmitBehavior extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11573.java