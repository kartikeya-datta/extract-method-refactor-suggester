error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3837.java
text:
```scala
T@@ext text = new Text(tabFolder1, SWT.WRAP | SWT.MULTI);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3837.java