error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16916.java
text:
```scala
c@@lass GuiceInjectorHolder implements IClusterable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16916.java