error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7129.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7129.java
text:
```scala
public static b@@oolean isPullRequest(final Issue issue) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7129.java