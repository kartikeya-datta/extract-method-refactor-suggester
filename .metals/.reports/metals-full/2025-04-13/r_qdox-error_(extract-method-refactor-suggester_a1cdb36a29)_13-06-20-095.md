error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10914.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10914.java
text:
```scala
final i@@nt port = AbstractSocketBindingResourceDefinition.PORT.resolveModelAttribute(context, config).asInt(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10914.java