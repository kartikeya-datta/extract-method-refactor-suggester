error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10366.java
text:
```scala
S@@earchByClass<Integer> searcher = new SearchByClass<Integer>(Integer.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10366.java