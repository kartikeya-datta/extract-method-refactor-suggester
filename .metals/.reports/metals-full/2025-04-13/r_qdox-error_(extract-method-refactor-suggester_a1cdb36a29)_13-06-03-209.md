error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3393.java
text:
```scala
c@@heckVersion(SampleSaveConfigurationConverter.class,"549936"); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3393.java