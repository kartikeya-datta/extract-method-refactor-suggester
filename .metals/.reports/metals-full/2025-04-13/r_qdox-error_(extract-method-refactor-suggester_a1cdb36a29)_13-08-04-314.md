error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4125.java
text:
```scala
l@@ogger.info("[partial_cluster_shutdown]: done shutting down [{}]", ((Object) nodesIds));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4125.java