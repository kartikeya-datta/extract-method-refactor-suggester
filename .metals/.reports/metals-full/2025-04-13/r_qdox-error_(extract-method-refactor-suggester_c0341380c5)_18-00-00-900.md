error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3480.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3480.java
text:
```scala
protected A@@rgumentWithoutValue helpArg = new ArgumentWithoutValue(this, "--help", "-h");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3480.java