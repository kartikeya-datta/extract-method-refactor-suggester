error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3372.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3372.java
text:
```scala
static final S@@tring COPYRIGHT = "Copyright (c) 1998-2008 The Apache Software Foundation";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3372.java