error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6372.java
text:
```scala
r@@eturn new ServiceURL(stid.getInternal() + "://" + getLocation().getScheme() + "://" + getLocation().getAuthority(), ServiceURL.LIFETIME_PERMANENT); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6372.java