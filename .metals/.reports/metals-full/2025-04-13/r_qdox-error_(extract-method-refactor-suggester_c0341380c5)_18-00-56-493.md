error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3502.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3502.java
text:
```scala
S@@STableMetadata.createCollector());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3502.java