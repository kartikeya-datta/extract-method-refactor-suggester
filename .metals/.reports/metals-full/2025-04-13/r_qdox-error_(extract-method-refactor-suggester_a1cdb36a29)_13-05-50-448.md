error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2734.java
text:
```scala
i@@f(this.levelToMatch.equals(event.level)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2734.java