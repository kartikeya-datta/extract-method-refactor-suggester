error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9152.java
text:
```scala
a@@ssertTrue(document.contains("umlaut-&#228;-&#246;-&#252;"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9152.java