error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9961.java
text:
```scala
i@@f (!flags.getSeen())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9961.java