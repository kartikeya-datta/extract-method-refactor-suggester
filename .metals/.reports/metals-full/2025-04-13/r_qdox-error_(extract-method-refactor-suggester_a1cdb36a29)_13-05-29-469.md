error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7543.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7543.java
text:
```scala
final I@@ResourceStream resource = Application.get().getResourceSettings().getResourceStreamFactory().newResourceStream(this.getClass(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7543.java