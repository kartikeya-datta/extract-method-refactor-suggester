error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11684.java
text:
```scala
n@@ew ProducesRequestCondition(annotation.produces(), annotation.headers()), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11684.java