error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/912.java
text:
```scala
i@@f (component.getApplicationException(ex.getClass(), context.getMethod()) != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/912.java