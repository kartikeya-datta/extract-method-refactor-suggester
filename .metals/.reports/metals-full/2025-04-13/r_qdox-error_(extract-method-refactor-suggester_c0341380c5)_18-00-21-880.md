error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9253.java
text:
```scala
M@@apperService.SmartNameFieldMappers smartMappers = context.smartFieldMappers(fieldName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9253.java