error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12876.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12876.java
text:
```scala
public T@@estComponent(final String id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12876.java