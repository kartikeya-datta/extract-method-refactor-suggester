error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10112.java
text:
```scala
s@@hortName = getClassLoaderName().replace('$','.');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10112.java