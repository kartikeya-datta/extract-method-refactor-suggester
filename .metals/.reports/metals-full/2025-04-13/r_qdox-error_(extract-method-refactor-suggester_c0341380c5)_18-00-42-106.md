error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3405.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3405.java
text:
```scala
public X@@mlSecurityCertificate(String type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3405.java