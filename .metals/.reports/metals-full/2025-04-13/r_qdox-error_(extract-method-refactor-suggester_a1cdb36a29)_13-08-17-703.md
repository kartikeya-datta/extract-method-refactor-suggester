error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4186.java
text:
```scala
I@@ClasspathEntry[] classpath = project.getResolvedClasspath(true/*ignoreUnresolvedEntry*/, false/*don't generateMarkerOnError*/, false/*don't returnResolutionInProgress*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4186.java