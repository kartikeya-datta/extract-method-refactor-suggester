error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8012.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8012.java
text:
```scala
private static final S@@tring VERSION = "3.0-SNAPSHOT";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8012.java