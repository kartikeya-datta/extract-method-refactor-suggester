error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12230.java
text:
```scala
m@@arkupStream.skipToMatchingCloseTag(openTag);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12230.java