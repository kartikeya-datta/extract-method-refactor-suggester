error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9670.java
text:
```scala
i@@f(node.hasDefined(localName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9670.java