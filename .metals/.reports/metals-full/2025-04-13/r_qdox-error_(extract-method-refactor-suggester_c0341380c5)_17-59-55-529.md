error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1058.java
text:
```scala
v@@alue.getBytes(), System.currentTimeMillis(), ConsistencyLevel.ONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1058.java