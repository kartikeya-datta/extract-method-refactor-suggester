error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7169.java
text:
```scala
r@@eturn this.getWorkingCopy(null, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7169.java