error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/138.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/138.java
text:
```scala
public b@@oolean framed = true; // cassandra server's framed transport
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/138.java