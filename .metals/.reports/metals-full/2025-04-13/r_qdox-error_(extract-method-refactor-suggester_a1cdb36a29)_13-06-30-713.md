error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2522.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2522.java
text:
```scala
public C@@ollection<SwitchState> getSwitchingFunctions();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2522.java