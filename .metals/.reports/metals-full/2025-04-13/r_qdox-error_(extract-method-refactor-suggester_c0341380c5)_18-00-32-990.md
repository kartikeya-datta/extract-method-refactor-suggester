error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2768.java
text:
```scala
c@@ons[0].newInstance((Object[])strs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2768.java