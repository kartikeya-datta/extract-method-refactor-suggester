error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3890.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3890.java
text:
```scala
t@@hrow new IllegalStateException(String.format("Batch job '%s' did not complete withing allotted time.", jobXml));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3890.java