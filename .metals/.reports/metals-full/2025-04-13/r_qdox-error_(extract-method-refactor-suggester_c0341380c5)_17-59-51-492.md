error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13442.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13442.java
text:
```scala
private i@@nt startupTimeoutInSeconds = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13442.java