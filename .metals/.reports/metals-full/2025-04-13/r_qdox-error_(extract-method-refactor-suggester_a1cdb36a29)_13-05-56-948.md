error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9951.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9951.java
text:
```scala
v@@oid setForeground (float /*double*/ [] color) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9951.java