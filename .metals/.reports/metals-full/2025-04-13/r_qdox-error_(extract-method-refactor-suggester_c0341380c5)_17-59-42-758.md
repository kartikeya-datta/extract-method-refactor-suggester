error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1781.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1781.java
text:
```scala
@Override protected D@@eleteIndexResponse masterOperation(DeleteIndexRequest request, ClusterState state) throws ElasticSearchException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1781.java