error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10310.java
text:
```scala
I@@mmutableMap<String,BlobMetaData> listBlobsByPrefix(String container, String keyPath, String prefix) throws URISyntaxException, StorageException, ServiceException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10310.java