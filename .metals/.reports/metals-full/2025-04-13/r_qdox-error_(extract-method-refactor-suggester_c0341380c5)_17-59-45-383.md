error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14507.java
text:
```scala
i@@f (!(targetObject instanceof Collection<?>))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14507.java