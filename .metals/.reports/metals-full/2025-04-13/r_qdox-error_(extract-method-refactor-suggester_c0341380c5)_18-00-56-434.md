error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/537.java
text:
```scala
s@@uper(settings, PutIndexedScriptAction.NAME, threadPool, transportService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/537.java