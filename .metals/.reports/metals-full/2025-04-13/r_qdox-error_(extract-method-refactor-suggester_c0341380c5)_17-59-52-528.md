error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4979.java
text:
```scala
r@@eturn new InternalRangeFacet(facetName, "_na", "_na", entries);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4979.java