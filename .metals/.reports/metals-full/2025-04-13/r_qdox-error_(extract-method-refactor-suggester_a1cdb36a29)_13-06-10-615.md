error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8781.java
text:
```scala
i@@f (role != null) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8781.java