error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11667.java
text:
```scala
p@@rivate static class MyMockPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11667.java