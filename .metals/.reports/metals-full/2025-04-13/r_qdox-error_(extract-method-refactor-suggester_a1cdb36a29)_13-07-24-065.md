error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2647.java
text:
```scala
b@@uilder.prettyPrint();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2647.java