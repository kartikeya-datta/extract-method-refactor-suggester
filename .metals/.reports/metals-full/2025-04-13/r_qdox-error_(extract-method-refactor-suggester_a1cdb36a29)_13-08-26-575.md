error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/829.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/829.java
text:
```scala
public static final S@@tring NAME = "term";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/829.java