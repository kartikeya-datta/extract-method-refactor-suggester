error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8324.java
text:
```scala
C@@lass type = path.getType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8324.java