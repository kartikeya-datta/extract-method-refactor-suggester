error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9486.java
text:
```scala
s@@uper.handleErrorFlush(output);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9486.java