error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5346.java
text:
```scala
i@@f (enabled == getEnabled ()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5346.java