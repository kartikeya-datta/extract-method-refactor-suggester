error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2689.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2689.java
text:
```scala
public f@@loat frameDuration;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2689.java