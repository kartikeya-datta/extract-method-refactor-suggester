error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14967.java
text:
```scala
a@@ppendFiles( files, fs.getDirectoryScanner() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14967.java