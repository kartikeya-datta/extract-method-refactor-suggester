error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8971.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8971.java
text:
```scala
public v@@oid renderHead(HtmlHeaderContainer container)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8971.java