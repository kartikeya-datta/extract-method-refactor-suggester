error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10392.java
text:
```scala
L@@ist<StandaloneUpdateResult<?>> applyUpdates(List<AbstractServerModelUpdate<?>> updates);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10392.java