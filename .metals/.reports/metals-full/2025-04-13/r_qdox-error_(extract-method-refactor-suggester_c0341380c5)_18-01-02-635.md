error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5782.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5782.java
text:
```scala
private static final S@@tring VERSION = "2.1.1";
...
public class JMeterVersion {
	 ...
	 */
	private static final String VERSION = "2.1.1.20050922";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5782.java