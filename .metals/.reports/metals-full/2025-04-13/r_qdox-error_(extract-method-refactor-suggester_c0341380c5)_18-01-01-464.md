error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9441.java
text:
```scala
r@@eturn wrapSmartNameFilter(prefixFilter, smartNameFieldMappers, parseContext.indexCache());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9441.java