error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12864.java
text:
```scala
p@@arams.add(key, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12864.java