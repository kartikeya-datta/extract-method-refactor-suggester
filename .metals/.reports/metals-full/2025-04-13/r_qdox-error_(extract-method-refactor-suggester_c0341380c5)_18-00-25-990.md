error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14380.java
text:
```scala
l@@og.infof("Registered messaging subsystem under: %s", messagingNamespace);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14380.java