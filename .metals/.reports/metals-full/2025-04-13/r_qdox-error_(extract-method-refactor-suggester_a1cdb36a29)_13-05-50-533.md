error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1045.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1045.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1045.java
text:
```scala
a@@ssertEquals(builder, writer.getBuilder());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1045.java