error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10240.java
text:
```scala
i@@nvalidateVisibleRegion (handle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10240.java