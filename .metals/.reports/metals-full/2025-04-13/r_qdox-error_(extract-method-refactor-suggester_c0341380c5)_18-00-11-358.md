error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4033.java
text:
```scala
l@@og.debug("SampleSaveConfiguration = " + saveConfig);// $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4033.java