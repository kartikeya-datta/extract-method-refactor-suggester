error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9188.java
text:
```scala
C@@lass<?> beanClass = beanFactory.getType(this.targetBeanName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9188.java