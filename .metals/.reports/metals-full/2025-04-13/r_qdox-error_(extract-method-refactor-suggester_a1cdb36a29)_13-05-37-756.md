error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11188.java
text:
```scala
i@@tem.add(new Label("name", item.getDefaultModelObjectAsString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11188.java