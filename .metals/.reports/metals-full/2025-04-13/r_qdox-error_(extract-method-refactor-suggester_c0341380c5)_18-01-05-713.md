error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7633.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7633.java
text:
```scala
private static final S@@tring VERSION = "2.4";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7633.java