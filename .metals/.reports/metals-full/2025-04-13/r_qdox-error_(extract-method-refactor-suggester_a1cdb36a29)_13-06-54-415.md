error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17156.java
text:
```scala
c@@ycle.setPage(getPageFactory().newPage(BookDetails.class, parameters));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17156.java