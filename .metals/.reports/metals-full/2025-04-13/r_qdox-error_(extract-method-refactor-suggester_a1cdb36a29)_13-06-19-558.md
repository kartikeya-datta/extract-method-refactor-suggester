error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12414.java
text:
```scala
r@@eturn this.listener.getBinding().getValue().getAbsolutePort();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12414.java