error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6969.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6969.java
text:
```scala
protected v@@oid viewIssue(Issue issue, Repository repository) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6969.java