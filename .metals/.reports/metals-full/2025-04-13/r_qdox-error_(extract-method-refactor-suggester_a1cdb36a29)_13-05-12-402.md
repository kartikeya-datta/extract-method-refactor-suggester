error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5070.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5070.java
text:
```scala
final C@@lass<?> applicationClass = loader.loadClass(applicationClassName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5070.java