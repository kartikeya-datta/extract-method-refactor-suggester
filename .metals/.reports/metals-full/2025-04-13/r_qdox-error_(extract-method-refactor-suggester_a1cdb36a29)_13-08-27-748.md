error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/702.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/702.java
text:
```scala
private static final L@@ist<? extends SimplePersistentResourceDefinition> CHILDREN = Collections.unmodifiableList(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/702.java