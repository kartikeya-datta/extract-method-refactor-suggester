error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16470.java
text:
```scala
F@@ileReader r = new FileReader(new File(System.getProperty("root"), filename));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16470.java