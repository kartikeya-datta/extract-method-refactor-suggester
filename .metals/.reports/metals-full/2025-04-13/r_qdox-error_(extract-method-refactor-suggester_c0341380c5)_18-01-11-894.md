error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6598.java
text:
```scala
c@@lient = new URIClientConnectAction(containerType,groupName,nickName,password,project,false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6598.java