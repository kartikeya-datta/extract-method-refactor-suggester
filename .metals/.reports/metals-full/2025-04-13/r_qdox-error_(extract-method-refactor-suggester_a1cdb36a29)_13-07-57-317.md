error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7063.java
text:
```scala
i@@f (useMipMaps) MipMapGenerator.generateMipMap(target, pixmap, pixmap.getWidth(), pixmap.getHeight());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7063.java