error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15390.java
text:
```scala
l@@ong rand = min + (long) (Math.random() * (max - min + 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15390.java