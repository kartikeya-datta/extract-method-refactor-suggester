error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3169.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3169.java
text:
```scala
private final L@@ist words;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3169.java