error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/456.java
text:
```scala
F@@ile logFile = FILE_UTILS.createTempFile("spawn","log", project.getBaseDir(), false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/456.java