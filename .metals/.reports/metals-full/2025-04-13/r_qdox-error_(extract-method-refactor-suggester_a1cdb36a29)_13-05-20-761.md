error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/849.java
text:
```scala
C@@ollections.sort(keys);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/849.java