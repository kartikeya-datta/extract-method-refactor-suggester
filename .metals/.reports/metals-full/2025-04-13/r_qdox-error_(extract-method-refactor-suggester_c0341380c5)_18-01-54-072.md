error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4083.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4083.java
text:
```scala
p@@t.y = widget.frameOfCellAtColumn(0, row).y;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4083.java