error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1807.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1807.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/reroute";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1807.java