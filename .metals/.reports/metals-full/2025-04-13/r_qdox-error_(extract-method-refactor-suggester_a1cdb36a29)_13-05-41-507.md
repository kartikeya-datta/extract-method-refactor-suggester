error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2703.java
text:
```scala
r@@emember(suppliedTypes[i], binaryBindings[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2703.java