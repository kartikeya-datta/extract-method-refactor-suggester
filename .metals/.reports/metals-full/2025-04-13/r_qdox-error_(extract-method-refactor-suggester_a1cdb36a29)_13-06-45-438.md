error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9811.java
text:
```scala
i@@f (methodBinding.declaringClass.isInterface()) { // interface or annotation type
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9811.java