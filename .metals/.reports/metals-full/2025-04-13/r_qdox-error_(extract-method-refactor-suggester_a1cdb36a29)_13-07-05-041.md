error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16878.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16878.java
text:
```scala
public static S@@tring qualify(Identifier name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16878.java