error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10947.java
text:
```scala
S@@tringBuilder tmp = new StringBuilder(OPEN_BRACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10947.java