error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14740.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14740.java
text:
```scala
S@@SLManager.manager = new JsseSSLManager(SSLManager.sslProvider);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14740.java