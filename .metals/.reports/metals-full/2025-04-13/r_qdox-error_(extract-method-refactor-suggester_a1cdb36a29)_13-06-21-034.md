error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10183.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10183.java
text:
```scala
protected final E@@SLogger logger;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10183.java