error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9335.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9335.java
text:
```scala
private v@@oid innerFinishHim() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9335.java