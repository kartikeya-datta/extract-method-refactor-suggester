error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7741.java
text:
```scala
i@@f (nextSecurityDomain == null || nextSecurityDomain.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7741.java