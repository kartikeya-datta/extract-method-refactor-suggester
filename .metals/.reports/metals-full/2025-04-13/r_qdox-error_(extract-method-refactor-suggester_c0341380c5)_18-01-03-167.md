error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8527.java
text:
```scala
c@@ontext.registerSubsystem(Namespace.REMOTING_1_0.getUriString(), RemotingSubsystemParser.getInstance());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8527.java