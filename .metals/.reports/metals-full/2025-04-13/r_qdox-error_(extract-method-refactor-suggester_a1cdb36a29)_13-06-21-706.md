error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13921.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13921.java
text:
```scala
public v@@oid testUpdateReplicatedObjects() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13921.java