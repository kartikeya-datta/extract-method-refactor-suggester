error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12602.java
text:
```scala
s@@erviceTarget.addService(NewProcessControllerConnectionService.SERVICE_NAME, processControllerClient).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12602.java