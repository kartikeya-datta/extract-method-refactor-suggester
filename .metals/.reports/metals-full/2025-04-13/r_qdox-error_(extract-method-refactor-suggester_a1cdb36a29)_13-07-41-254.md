error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9266.java
text:
```scala
n@@odesFD.updateNodes(buildNodesForA(true), -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9266.java