error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3142.java
text:
```scala
t@@his.beanFactory = new XmlBeanFactory(new ClassPathResource("org/springframework/aop/target/commonsPoolTests.xml"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3142.java