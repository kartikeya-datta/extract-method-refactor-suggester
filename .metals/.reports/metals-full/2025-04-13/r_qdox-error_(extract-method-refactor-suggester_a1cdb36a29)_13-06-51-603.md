error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7106.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7106.java
text:
```scala
public final static S@@tring PERSPECTIVES = "perspectives"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7106.java