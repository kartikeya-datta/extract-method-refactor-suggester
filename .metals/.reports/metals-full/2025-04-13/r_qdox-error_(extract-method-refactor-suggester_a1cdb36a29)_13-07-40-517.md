error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6194.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6194.java
text:
```scala
public M@@odelNode buildRequestWithoutHeaders(CommandContext ctx)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6194.java