error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5881.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5881.java
text:
```scala
I@@mageLoader.getSmallImageIcon("stock_preferences-32.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5881.java