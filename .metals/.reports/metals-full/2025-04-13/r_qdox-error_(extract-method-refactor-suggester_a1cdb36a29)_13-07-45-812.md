error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1264.java
text:
```scala
L@@ucene.KEYWORD_ANALYZER, Lucene.KEYWORD_ANALYZER, postingsFormat, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1264.java