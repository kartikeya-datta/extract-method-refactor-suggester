error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3628.java
text:
```scala
c@@hannel.sendResponse(new XContentRestResponse(request, response.status(), builder));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3628.java