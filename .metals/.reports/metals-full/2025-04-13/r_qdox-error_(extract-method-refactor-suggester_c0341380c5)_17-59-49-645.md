error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9309.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9309.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9309.java
text:
```scala
r@@eturn new Array();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9309.java