error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17034.java
text:
```scala
r@@eturn super.gtk_realize (widget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17034.java