error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5747.java
text:
```scala
i@@f (args != null && !matchesTypeReference(this.pattern.parameterSimpleNames[i], ((Argument) args[i]).type)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5747.java