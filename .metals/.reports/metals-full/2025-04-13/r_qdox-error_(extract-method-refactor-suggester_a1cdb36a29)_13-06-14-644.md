error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5580.java
text:
```scala
m@@ergePolicy = new EnableMergeLogByteSizeMergePolicy(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5580.java