error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9380.java
text:
```scala
i@@nt sum = processor.subtract(34, 13);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9380.java