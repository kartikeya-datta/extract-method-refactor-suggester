error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/626.java
text:
```scala
a@@ssertTitleEquals("Wicket Examples - linkomatic");
 ...
 */
public class LinkomaticTest extends WebTestCase
{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/626.java