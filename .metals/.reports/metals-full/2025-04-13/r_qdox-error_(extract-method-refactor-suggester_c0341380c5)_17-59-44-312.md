error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13936.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13936.java
text:
```scala
f@@orm = findParent(Form.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13936.java