error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11394.java
text:
```scala
t@@hrow alreadyRegistered();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11394.java