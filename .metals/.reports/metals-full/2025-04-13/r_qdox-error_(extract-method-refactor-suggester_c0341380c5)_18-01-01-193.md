error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4953.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4953.java
text:
```scala
private final N@@odeList nodeList;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4953.java