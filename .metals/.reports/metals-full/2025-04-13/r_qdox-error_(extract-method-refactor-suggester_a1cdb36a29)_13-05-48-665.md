error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7957.java
text:
```scala
i@@nt b = array[i] & 0xFF;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7957.java