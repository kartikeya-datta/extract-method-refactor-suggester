error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14621.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14621.java
text:
```scala
public static L@@ist<UserValue> single(String property, Object value) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14621.java