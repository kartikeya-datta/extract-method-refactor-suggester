error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2586.java
text:
```scala
S@@kin skin = new Skin(Gdx.files.internal("data/uiskin.json"), Gdx.files.internal("data/uiskin.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2586.java