error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3205.java
text:
```scala
s@@etForegroundColor (handle, color);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3205.java