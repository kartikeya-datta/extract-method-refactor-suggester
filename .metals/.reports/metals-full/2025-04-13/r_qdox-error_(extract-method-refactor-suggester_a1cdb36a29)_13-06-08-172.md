error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3151.java
text:
```scala
r@@eturn new DefaultOperationDescriptionProvider(getName(), resolver, attributeResolver, replyType, replyValueType, replyAllowNull, deprecationData, replyParameters, params, accessConstraints).getModelDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3151.java