error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8965.java
text:
```scala
r@@eturn this.container.getCacheManagerConfiguration().globalJmxStatistics().cacheManagerName() + "." + this.cacheName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8965.java