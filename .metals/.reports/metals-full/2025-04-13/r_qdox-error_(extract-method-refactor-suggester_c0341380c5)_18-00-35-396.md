error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2859.java
text:
```scala
m@@anagementResource.registerChild(AccessAuthorizationResourceDefinition.PATH_ELEMENT, AccessAuthorizationResourceDefinition.RESOURCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2859.java