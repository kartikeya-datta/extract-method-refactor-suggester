error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7834.java
text:
```scala
o@@ut.print(usage("standalone"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7834.java