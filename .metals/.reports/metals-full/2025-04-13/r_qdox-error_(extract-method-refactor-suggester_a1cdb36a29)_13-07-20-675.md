error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7904.java
text:
```scala
m@@ac.libraries = "-framework CoreServices -framework Carbon -framework IOKit";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7904.java