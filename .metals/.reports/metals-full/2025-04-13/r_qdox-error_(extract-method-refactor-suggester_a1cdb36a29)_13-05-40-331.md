error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9206.java
text:
```scala
l@@ogger.debug("All shards failed for phase: [{}]", firstPhaseName(), t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9206.java