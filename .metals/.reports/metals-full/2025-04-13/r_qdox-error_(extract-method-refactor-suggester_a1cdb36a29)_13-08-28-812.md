error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6957.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6957.java
text:
```scala
private static final S@@tring ERROR_NO_XML = "No nested XML specified";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6957.java