error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12669.java
text:
```scala
i@@f (color1 [i] != color2 [i]) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12669.java