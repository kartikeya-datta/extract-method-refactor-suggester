error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6613.java
text:
```scala
i@@f (currentCompatibleType.id == T_Object) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6613.java