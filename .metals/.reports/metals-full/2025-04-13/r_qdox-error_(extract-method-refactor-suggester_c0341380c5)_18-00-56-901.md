error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1972.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1972.java
text:
```scala
t@@his.refreshInterval = componentSettings.getAsTime("refresh_interval", TimeValue.timeValueSeconds(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1972.java