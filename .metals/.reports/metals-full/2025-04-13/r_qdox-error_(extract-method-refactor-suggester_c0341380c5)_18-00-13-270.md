error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2603.java
text:
```scala
)@@.build(mapperParser);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2603.java