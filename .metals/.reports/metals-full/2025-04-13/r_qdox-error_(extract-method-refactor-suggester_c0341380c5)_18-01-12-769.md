error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4755.java
text:
```scala
G@@dxTest test = new ProgressiveJPEGTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4755.java