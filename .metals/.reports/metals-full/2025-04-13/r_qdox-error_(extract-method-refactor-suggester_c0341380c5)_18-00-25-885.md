error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3315.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3315.java
text:
```scala
public static R@@esolvedTypeMunger readField(VersionedDataInputStream s, ISourceContext context) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3315.java