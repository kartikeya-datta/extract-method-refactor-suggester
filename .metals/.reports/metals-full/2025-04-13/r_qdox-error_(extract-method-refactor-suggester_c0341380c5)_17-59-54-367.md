error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2436.java
text:
```scala
b@@uffer[i] = (char)(b[off + i] & 0xff);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2436.java