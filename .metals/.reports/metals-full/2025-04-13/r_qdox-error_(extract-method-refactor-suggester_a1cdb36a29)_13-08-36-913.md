error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6435.java
text:
```scala
a@@ssert fieldname.equals(indexFieldData.getFieldNames().indexName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6435.java