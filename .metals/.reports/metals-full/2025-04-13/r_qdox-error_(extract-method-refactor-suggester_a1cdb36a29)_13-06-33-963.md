error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12060.java
text:
```scala
s@@tack.replaceAllRequestHandlers(handler3);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12060.java