error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2514.java
text:
```scala
c@@ounts.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2514.java