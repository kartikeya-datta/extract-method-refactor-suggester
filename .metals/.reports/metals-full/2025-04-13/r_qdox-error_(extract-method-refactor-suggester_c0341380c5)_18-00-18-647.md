error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8502.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8502.java
text:
```scala
s@@pare.supersetDf = termsAggFactory.getBackgroundFrequency(spare.termBytes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8502.java