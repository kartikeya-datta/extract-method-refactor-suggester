error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4075.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4075.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4075.java
text:
```scala
protected v@@oid openWhenClosed(IProgressMonitor pm, IBuffer buffer) throws JavaModelException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4075.java