error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3572.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3572.java
text:
```scala
e@@xtension.initialize(extensionContext.createTracking(module));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3572.java