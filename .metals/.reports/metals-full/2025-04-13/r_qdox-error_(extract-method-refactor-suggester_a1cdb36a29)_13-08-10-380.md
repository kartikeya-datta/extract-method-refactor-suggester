error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3170.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3170.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3170.java
text:
```scala
public v@@oid testHangmanLoseGame() throws Exception
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3170.java