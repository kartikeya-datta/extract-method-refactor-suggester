error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6615.java
text:
```scala
C@@ollection<String> getMenuCategories();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6615.java