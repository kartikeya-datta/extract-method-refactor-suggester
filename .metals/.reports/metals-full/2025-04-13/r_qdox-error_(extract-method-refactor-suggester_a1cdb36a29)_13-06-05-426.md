error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5935.java
text:
```scala
A@@smAdviceRelationshipProvider.checkerMunger(world.getModel(), shadow);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5935.java