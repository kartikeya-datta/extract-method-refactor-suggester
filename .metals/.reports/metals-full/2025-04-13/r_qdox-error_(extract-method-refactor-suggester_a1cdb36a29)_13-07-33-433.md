error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6452.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6452.java
text:
```scala
a@@dd(brdr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6452.java