error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6135.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6135.java
text:
```scala
final L@@ist<CommandArgument> allArgs = candidatesProvider.getProperties(ctx, parsedCmd.getOperationName(), ctx.getPrefix());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6135.java