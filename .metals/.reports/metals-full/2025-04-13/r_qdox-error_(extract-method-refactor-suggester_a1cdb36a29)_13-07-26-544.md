error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4112.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4112.java
text:
```scala
public B@@aseTree(String id, IModel<? extends TreeModel> model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4112.java