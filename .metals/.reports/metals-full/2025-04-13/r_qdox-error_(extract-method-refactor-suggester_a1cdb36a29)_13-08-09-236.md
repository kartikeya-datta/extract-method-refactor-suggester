error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3039.java
text:
```scala
o@@ut.write(address.toBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3039.java