error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16936.java
...
```java
offset: 33
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16936.java
text:
```scala
/*ResolvedMember initMethod = */m@@unger.getInitMethod(aspectType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16936.java