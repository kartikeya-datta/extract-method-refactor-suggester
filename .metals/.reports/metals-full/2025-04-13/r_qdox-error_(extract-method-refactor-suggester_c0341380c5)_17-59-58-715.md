error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11039.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11039.java
text:
```scala
protected v@@oid onSelectionChanged(final String newSelection)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11039.java