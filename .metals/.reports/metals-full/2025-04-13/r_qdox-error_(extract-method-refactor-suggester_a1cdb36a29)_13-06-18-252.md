error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13986.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13986.java
text:
```scala
public i@@nt type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13986.java