error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8852.java
text:
```scala
l@@og.warn("Not storing invalid cookie: <"+cookieHeader+"> for URL "+url+" ("+e.getLocalizedMessage()+")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8852.java