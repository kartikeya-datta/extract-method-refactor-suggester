error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5175.java
text:
```scala
r@@eturn ThreadPool.Names.GET;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5175.java