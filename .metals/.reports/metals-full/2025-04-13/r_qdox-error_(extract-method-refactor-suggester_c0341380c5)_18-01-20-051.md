error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/573.java
text:
```scala
s@@ubModel.get(COORDINATOR_ENVIRONMENT, DEFAULT_TIMEOUT).set(coordinatorDefaultTimeout);  // store the default so we write it -- TODO store all the defaults
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/573.java