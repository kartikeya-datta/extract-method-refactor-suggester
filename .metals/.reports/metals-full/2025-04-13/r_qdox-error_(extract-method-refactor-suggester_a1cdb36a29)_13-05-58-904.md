error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9060.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9060.java
text:
```scala
public v@@oid testWindowsEncodedPath() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9060.java