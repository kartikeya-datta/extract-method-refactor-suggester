error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14857.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14857.java
text:
```scala
public static i@@nt length(CharSequence str) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14857.java