error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/387.java
text:
```scala
r@@eturn (float)(track.getCurrentTime());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/387.java