error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12937.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12937.java
text:
```scala
public i@@nt processDir(final File srcDir, final String[] srcNames,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12937.java