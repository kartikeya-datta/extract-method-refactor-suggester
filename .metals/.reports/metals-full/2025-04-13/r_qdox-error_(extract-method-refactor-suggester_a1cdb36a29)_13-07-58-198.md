error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6215.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6215.java
text:
```scala
private static final S@@tring SOCKET_REF = CommonAttributes.SOCKET_BINDING.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6215.java