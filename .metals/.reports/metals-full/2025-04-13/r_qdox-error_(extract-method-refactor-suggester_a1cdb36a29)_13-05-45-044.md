error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5274.java
text:
```scala
r@@eturn indexSettings.get(IndexMetaData.SETTING_UUID, IndexMetaData.INDEX_UUID_NA_VALUE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5274.java