error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12811.java
...
```java
offset: 1099
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12811.java
text:
```scala
...
p@@ackage org.jboss.as.jpa.processor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12811.java