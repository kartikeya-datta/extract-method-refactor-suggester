error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1869.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1869.java
text:
```scala
f@@or (Extension extension : Module.loadServiceFromCallerModuleLoader(ModuleIdentifier.fromString(module), Extension.class)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1869.java