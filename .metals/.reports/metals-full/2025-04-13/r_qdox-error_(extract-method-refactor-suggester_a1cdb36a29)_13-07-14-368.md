error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9071.java
text:
```scala
A@@tomicReference<byte[]> sessionIdReference = (AtomicReference<byte[]>) context.getContextData().get(StatefulSessionComponent.SESSION_ID_REFERENCE_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9071.java