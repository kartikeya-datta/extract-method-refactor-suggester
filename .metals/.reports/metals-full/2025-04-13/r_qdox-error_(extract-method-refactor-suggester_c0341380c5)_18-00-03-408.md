error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17873.java
text:
```scala
e@@lse if(oldestEntry != null) // TODO is this not a hack around another problem? Access Stack and pages not in sync?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17873.java