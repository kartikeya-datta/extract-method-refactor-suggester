error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5011.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5011.java
text:
```scala
private S@@tring numberRadioChoice = FormInput.NUMBERS.get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5011.java