error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1978.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1978.java
text:
```scala
public D@@efaultFileComparatorTest(final String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1978.java