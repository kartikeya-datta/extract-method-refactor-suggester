error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7099.java
text:
```scala
S@@tring folderLocation = sourceFolders[j].getLocation().addTrailingSeparator().toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7099.java