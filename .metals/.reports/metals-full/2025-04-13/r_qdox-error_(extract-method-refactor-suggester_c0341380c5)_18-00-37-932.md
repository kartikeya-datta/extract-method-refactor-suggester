error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10815.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10815.java
text:
```scala
final C@@SVFormat format = CSVFormat.DEFAULT.withDelimiter(';').withQuoteChar('\'').withCommentStart('!');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10815.java