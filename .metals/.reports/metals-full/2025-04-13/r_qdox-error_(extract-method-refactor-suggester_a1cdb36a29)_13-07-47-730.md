error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3796.java
text:
```scala
s@@etShellStyle(SWT.NO_TRIM | SWT.ON_TOP );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3796.java