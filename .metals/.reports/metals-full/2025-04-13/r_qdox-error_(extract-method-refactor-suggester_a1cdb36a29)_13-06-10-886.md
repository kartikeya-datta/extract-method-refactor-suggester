error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5187.java
text:
```scala
H@@ierarchy h = new Hierarchy(new RootCategory(Level.DEBUG));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5187.java