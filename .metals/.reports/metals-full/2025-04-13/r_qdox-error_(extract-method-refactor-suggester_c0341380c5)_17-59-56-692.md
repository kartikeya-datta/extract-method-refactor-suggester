error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7488.java
text:
```scala
i@@f (!Boolean.TRUE.equals(node.getAttribute(FigureAttributeConstant.LOCATION))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7488.java