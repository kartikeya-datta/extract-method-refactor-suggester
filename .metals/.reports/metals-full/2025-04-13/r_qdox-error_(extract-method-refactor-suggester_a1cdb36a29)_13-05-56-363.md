error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8135.java
text:
```scala
m@@enuItem.setText(WorkbenchMessages.getString("PartPane.maximize")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8135.java