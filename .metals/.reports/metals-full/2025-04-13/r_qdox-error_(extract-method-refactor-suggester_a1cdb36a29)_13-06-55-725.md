error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6900.java
text:
```scala
r@@ootObject("person")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6900.java