error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6845.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,121]

error in qdox parser
file content:
```java
offset: 121
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6845.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6845.java