error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/458.java
text:
```scala
C@@ounter bytesUsed, IOContext context, float acceptableOverheadRatio) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/458.java