error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/539.java
text:
```scala
s@@ource = this.document.getCharContents();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/539.java