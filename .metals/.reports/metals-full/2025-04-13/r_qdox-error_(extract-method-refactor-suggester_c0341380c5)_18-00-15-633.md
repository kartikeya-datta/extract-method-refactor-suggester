error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18172.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[56,2]

error in qdox parser
file content:
```java
offset: 1678
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18172.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18172.java