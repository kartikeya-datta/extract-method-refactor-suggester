error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9774.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9774.java
text:
```scala
final C@@lass<? extends Page> signInPageClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9774.java