error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2733.java
text:
```scala
b@@uilder.startObject(GeoDistanceFacet.TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2733.java