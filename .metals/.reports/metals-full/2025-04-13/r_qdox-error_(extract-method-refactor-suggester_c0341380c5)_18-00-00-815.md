error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2949.java
text:
```scala
i@@nt /*long*/ setFrameProc = OS.CALLBACK_webView_setFrame_(proc4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2949.java