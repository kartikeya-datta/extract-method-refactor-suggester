error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3159.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3159.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3159.java
text:
```scala
i@@ndexRequest.source(request.content(), request.contentUnsafe());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3159.java