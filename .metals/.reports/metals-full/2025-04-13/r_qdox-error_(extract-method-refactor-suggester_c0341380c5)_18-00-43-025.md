error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1902.java
text:
```scala
a@@ssertRemoveSubsystemResources(servicesB);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1902.java