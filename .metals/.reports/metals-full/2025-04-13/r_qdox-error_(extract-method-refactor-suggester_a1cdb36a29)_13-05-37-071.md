error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9047.java
text:
```scala
S@@tring distingushedName = groupRefValues.next();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9047.java