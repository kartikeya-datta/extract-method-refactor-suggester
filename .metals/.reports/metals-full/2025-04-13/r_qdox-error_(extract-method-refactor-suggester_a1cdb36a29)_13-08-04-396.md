error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3188.java
text:
```scala
r@@eturn wmCaptureChanged (handle, wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3188.java