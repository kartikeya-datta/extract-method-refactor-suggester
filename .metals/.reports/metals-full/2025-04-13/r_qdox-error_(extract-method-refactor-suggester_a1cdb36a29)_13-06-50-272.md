error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4100.java
text:
```scala
I@@WorkspaceRoot root = ResourcesPlugin.getWorkspace()	.getRoot();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4100.java