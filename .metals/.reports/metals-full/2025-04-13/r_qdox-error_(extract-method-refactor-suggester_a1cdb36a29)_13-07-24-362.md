error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/752.java
text:
```scala
A@@syncAction.this.addShardFailure(shardIndex, shardTarget, t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/752.java