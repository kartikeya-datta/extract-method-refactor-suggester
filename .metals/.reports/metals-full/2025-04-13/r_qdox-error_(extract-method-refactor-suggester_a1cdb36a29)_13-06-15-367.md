error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6955.java
text:
```scala
l@@ogger.debug("Using [ram] Store");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6955.java