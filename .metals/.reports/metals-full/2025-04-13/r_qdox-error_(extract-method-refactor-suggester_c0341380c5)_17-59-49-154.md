error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3417.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3417.java
text:
```scala
public static final A@@rgumentValueState INSTANCE = new ArgumentValueState();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3417.java