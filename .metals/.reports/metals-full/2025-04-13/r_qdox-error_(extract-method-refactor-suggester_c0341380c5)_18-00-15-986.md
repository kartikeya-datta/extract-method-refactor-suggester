error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1308.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1308.java
text:
```scala
i@@f ((fileName.indexOf("sql") > 0) || (fileName.indexOf("txt") > 0) || (fileName.indexOf(".view") > 0) || (fileName.indexOf(".multi") > 0) || (fileName.indexOf(".properties") > 0))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1308.java