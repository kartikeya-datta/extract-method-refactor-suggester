error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3216.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3216.java
text:
```scala
native static v@@oid consoleLog(String message) /*-{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3216.java