error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9061.java
text:
```scala
p@@ublic class WebComponent extends Component
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9061.java