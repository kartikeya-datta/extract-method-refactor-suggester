error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1814.java
...
```java
offset: 25
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1814.java
text:
```scala
private static volatile i@@nt LAST_POSITION_DEFAULT = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1814.java