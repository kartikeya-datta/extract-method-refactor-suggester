error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8482.java
text:
```scala
m@@etamataHome = resolveFile( metamataHome.getPath() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8482.java