error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10312.java
text:
```scala
i@@f (guid.Equals (nsIFilePicker_1_8.NS_IFILEPICKER_IID)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10312.java