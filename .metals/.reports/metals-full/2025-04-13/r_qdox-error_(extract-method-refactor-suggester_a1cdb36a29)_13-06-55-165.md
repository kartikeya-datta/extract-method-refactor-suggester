error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7245.java
text:
```scala
M@@ap<Integer, List<String>> nrReplicasChanged = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7245.java