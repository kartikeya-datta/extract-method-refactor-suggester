error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8335.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8335.java
text:
```scala
i@@f (input == null && !isInputNullable() && !isEnabledInHierarchy())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8335.java