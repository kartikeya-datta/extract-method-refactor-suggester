error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18041.java
text:
```scala
_@@exe = new Execute( handler );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18041.java