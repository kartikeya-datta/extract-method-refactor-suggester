error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4587.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4587.java
text:
```scala
public static final l@@ong PRIORITY = DeploymentPhases.MODULARIZE.plus(100L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4587.java