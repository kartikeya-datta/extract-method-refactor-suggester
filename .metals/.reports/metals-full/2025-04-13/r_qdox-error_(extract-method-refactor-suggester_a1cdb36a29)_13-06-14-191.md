error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2882.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2882.java
text:
```scala
0,@@ 64);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2882.java