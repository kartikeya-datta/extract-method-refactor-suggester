error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7894.java
text:
```scala
r@@eturn immutableCluster().dataNodes() - 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7894.java