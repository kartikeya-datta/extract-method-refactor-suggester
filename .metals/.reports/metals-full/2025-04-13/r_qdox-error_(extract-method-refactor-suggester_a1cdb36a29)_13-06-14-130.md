error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8000.java
text:
```scala
s@@b.append("query[").append(context.originalQuery()).append("],from[").append(context.from()).append("],size[").append(context.size()).append("]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8000.java