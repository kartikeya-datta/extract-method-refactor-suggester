error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3146.java
text:
```scala
m@@_referenceFiles.add( path );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3146.java