error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2423.java
text:
```scala
r@@eturn coefficients.dotProduct(new ArrayRealVector(point, false)) + constantTerm;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2423.java