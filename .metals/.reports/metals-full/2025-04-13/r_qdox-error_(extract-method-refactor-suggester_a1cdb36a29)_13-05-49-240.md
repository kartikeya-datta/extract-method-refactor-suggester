error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5700.java
text:
```scala
r@@eturn item.getBooleanWithDefault("overwrite", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5700.java