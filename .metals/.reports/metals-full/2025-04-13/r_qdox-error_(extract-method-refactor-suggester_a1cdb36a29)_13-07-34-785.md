error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9659.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9659.java
text:
```scala
T@@oStringBuilder.setDefaultStyle(ToStringStyle.DEFAULT_STYLE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9659.java