error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/468.java
text:
```scala
M@@atchOnlyTermScorer(Weight weight, DocsEnum td, Similarity.ExactSimScorer docScorer) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/468.java