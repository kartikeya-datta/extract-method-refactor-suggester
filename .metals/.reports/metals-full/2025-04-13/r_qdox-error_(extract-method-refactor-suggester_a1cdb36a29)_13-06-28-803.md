error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4394.java
text:
```scala
t@@hrow new DeploymentUnitProcessingException("SecurityDomain value on bean class: " + componentDescription.getEJBClassName() + " cannot be an empty string");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4394.java