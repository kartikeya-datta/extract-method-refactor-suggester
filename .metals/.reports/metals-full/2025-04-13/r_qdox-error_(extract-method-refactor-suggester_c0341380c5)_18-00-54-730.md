error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3941.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3941.java
text:
```scala
public L@@ibraryTest(final String name)

/*
 * $Id: LibraryTest.java 5395 2006-04-16 13:42:28 +0000 (Sun, 16 Apr 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3941.java