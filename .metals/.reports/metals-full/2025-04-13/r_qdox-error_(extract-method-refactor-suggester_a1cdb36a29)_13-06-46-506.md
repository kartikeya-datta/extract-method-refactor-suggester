error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1790.java
text:
```scala
T@@opChildrenQuery query = new TopChildrenQuery(parentChildIndexFieldData, innerQuery, childType, parentType, scoreType, factor, incrementalFactor, nonNestedDocsFilter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1790.java