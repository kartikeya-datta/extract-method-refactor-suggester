error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/139.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/139.java
text:
```scala
s@@uper(isAny ? Element.ANY : Element.NOT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/139.java