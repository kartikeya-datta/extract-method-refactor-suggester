error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6460.java
text:
```scala
s@@uper ("Function", "{builtin}Function");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6460.java