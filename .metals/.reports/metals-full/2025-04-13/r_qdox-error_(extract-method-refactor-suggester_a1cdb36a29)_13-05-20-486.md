error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4685.java
text:
```scala
B@@ytesRef termBytes;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4685.java