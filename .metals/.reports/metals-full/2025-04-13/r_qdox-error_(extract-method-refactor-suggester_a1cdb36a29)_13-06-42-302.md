error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14613.java
text:
```scala
p@@age.detach();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14613.java