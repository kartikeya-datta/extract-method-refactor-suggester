error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/480.java
text:
```scala
N@@SAttributedString str = parent.createString(string, font, null, 0, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/480.java