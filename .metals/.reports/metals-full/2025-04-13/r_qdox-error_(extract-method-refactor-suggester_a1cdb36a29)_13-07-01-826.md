error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9451.java
text:
```scala
F@@astMath.abs(h), minStep, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9451.java