error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2388.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2388.java
text:
```scala
public v@@oid onStreamCompletion(InetAddress host, PendingFile pendingFile, FileStatus streamStatus) throws IOException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2388.java