error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1477.java
text:
```scala
w@@orkingSet.setId("org.eclipse.ui.resourceWorkingSetPage"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1477.java