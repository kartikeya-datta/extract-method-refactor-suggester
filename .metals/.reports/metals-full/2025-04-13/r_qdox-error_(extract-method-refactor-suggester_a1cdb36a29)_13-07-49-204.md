error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1682.java
text:
```scala
D@@ocsEnum docsEnum = _TestUtil.docs(random(), ctermsEnum, bits, null, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1682.java