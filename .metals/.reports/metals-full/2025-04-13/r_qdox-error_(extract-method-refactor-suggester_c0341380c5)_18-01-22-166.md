error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7055.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7055.java
text:
```scala
public static b@@oolean supportsProtocol(String protocolString) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7055.java