error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5027.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5027.java
text:
```scala
private static final T@@hreadLocalStack<InvocationContext> stack = new ThreadLocalStack<InvocationContext>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5027.java