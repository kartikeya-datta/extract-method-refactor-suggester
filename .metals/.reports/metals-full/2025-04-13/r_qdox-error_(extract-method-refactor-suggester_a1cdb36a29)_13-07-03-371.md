error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4788.java
text:
```scala
b@@oolean order = item.getBooleanWithDefault("order", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4788.java