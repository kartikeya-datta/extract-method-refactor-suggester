error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12818.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12818.java
text:
```scala
private transient C@@ollection savedValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12818.java