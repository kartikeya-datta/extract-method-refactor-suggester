error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4049.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4049.java
text:
```scala
A@@rray<AssetDescriptor> deps = Array.of(AssetDescriptor.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4049.java