error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/810.java
text:
```scala
l@@istener.onFailure(new ReduceSearchPhaseException("fetch", "", e, buildShardFailures()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/810.java