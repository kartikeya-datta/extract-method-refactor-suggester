error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6119.java
text:
```scala
m@@_ClearToolDir = getProject().translatePath( dir );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6119.java