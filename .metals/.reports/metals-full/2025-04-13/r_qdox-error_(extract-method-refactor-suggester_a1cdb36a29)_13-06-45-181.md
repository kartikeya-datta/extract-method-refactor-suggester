error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1550.java
text:
```scala
s@@izeInBytes.getAndAdd(-existing.sizeInBytes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1550.java