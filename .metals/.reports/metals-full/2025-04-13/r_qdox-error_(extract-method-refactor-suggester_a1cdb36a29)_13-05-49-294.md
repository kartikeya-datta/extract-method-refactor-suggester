error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6183.java
text:
```scala
e@@xtends BaseAttribute
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6183.java