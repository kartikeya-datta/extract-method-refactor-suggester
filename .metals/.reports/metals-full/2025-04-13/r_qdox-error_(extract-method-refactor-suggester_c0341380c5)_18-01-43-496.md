error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6100.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6100.java
text:
```scala
public static final S@@tring NAME = "ecf.namespace.local"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6100.java