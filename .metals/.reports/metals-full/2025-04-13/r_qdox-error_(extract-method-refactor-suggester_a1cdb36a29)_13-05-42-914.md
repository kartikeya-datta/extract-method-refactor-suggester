error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9307.java
text:
```scala
g@@etLogger().info( "Created dir: " + dir.getAbsolutePath() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9307.java