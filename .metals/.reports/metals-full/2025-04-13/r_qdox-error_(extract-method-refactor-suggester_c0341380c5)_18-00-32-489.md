error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13600.java
text:
```scala
r@@edrawBackgroundImage ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13600.java