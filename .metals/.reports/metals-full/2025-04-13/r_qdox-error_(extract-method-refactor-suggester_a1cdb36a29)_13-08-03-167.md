error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/410.java
text:
```scala
g@@etClient(0).getConnectedID(), IConcatService.class.getName(), customizeProperties(null), 5000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/410.java