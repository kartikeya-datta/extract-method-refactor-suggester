error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13938.java
text:
```scala
t@@ext = DurationFormatUtils.formatDurationWords(i * 24 * 60 * 60 * 1000L, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13938.java