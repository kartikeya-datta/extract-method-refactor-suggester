error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/196.java
text:
```scala
p@@rivate static class ObjectPair
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/196.java