error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15319.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15319.java
text:
```scala
final R@@esource subsystemRootResource = context.readResourceFromRoot(ourAddress.subAddress(0, ourAddress.size() - 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15319.java