error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8175.java
text:
```scala
t@@his.parser = new MatchLocatorParser(problemReporter, options.sourceLevel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8175.java