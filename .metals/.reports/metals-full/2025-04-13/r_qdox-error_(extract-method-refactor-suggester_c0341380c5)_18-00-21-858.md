error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9468.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9468.java
text:
```scala
r@@eturn acceptDocs.get(doc) && parents.contains(typeCache.idByDoc(doc));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9468.java