error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7622.java
text:
```scala
E@@xceptionHandler handler = ExceptionHandler.getInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7622.java