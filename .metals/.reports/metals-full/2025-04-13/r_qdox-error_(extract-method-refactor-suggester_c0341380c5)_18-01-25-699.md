error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1677.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1677.java
text:
```scala
public v@@oid onClick(AjaxRequestTarget target)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1677.java