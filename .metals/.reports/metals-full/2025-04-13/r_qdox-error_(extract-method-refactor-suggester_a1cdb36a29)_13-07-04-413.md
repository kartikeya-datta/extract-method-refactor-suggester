error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3283.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3283.java
text:
```scala
public B@@undleConversion convert (IDirectory parentEba, IFile fileInEba) throws ConversionException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3283.java