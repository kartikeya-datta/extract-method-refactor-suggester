error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13929.java
text:
```scala
N@@ameType(final String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13929.java