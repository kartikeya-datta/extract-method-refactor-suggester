error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6127.java
text:
```scala
C@@olumbaHeader header = (ColumbaHeader) message.getHeader();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6127.java