error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7756.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7756.java
text:
```scala
final W@@eldStartService weldStartService = new WeldStartService(setupActions, module.getClassLoader(), Utils.getRootDeploymentUnit(deploymentUnit).getServiceName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7756.java