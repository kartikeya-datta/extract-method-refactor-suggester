error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14068.java
text:
```scala
n@@ew BinderServiceBuilder<>(ChannelFactoryService.createChannelFactoryBinding(name), ChannelFactoryService.getServiceName(name), ChannelFactory.class).build(target).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14068.java