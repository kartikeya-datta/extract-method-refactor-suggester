error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3505.java
text:
```scala
p@@ublic abstract class SortableDataProvider<T> implements IDataProvider<T>, ISortStateLocator
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3505.java