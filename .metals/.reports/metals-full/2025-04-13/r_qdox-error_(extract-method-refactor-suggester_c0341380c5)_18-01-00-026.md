error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4577.java
text:
```scala
d@@estinationAddress = binding.getResolvedDestinationAddress();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4577.java