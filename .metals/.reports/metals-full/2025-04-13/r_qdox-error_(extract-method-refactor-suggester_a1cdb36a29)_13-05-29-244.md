error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2330.java
text:
```scala
s@@uper(CommonAttributes.CONNECTOR, CommonAttributes.CONNECTOR, null, OBJECT, true, false, null, null, null, false, new String[] { CommonAttributes.DISCOVERY_GROUP_NAME }, new String[0], RESTART_ALL_SERVICES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2330.java