error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12426.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12426.java
text:
```scala
private transient C@@ompoundVariable varName, minimum, maximum;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12426.java