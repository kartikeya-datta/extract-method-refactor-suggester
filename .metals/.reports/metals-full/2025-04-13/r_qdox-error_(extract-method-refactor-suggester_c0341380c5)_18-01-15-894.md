error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13423.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13423.java
text:
```scala
public static final M@@odelQueryOperationHandler READ_RESOURCE = new ModelQueryOperationHandler() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13423.java