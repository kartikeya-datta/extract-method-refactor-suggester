error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7827.java
text:
```scala
f@@ilter = fieldMapper.termsFilter(parseContext, terms, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7827.java