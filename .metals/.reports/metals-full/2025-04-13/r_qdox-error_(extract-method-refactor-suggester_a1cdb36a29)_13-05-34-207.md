error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14470.java
text:
```scala
S@@tringBuilder out = new StringBuilder(s.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14470.java