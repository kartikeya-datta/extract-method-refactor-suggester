error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1476.java
text:
```scala
P@@latformMBeanDescriptions.getResolver(PlatformMBeanConstants.RUNTIME));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1476.java