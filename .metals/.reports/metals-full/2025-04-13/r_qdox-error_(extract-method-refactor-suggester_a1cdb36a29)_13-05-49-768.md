error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1580.java
text:
```scala
s@@yncStrategy = new SyncStrategy(core.getCoreDescriptor().getCoreContainer());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1580.java