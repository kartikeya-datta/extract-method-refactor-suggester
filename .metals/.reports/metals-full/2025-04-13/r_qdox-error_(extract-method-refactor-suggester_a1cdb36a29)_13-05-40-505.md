error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7986.java
text:
```scala
r@@eturn query;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7986.java