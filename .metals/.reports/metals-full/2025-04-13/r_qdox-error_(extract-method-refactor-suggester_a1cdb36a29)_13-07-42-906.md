error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1677.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1677.java
text:
```scala
public static C@@lipboard getDefaultClipboard() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1677.java