error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2987.java
text:
```scala
m@@ap.setOwnedResources(textures.values().toArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2987.java