error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13611.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13611.java
text:
```scala
i@@f (!condition) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13611.java