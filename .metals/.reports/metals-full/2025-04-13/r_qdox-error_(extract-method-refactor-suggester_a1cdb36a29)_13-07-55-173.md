error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3839.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3839.java
text:
```scala
public static final L@@ist<Locale> LOCALES = Arrays.asList(new Locale[] { Locale.ENGLISH,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3839.java