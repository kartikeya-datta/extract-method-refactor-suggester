error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8572.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8572.java
text:
```scala
i@@f (referenceType != null && !referenceType.isReifiable()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8572.java