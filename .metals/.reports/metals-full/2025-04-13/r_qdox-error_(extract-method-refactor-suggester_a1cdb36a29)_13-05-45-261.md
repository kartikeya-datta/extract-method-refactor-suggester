error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3488.java
text:
```scala
M@@essage response = message.getReply(FBUtilities.getLocalAddress(), bytes, message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3488.java