error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4123.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4123.java
text:
```scala
a@@pplication.mountPage("Aparameter", A.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4123.java