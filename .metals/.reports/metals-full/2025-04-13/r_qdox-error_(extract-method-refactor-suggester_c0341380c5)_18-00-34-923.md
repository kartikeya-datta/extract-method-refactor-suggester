error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9671.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9671.java
text:
```scala
private static final S@@tring BOOTSTRAPCONTEXT_NAME = "bootstrap-context";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9671.java