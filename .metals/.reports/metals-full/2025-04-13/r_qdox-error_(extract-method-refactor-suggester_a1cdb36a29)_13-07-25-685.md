error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2976.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2976.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2976.java
text:
```scala
public M@@ergeScheduler buildMergeScheduler() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2976.java