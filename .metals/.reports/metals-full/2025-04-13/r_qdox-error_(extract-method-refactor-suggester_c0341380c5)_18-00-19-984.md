error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4306.java
...
```java
offset: 618
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4306.java
text:
```scala
public class ActionHandler implements org.eclipse.ui.commands.IHandler {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4306.java