error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9834.java
text:
```scala
c@@ontext.getModelNodeRegistrationForUpdate().registerSubModel(PathElement.pathElement(HOST, hostName), registration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9834.java