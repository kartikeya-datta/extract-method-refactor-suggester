error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17480.java
text:
```scala
s@@endDragEvent (1, (short) (lParam & 0xFFFF), (short) (lParam >> 16));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17480.java