error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6464.java
text:
```scala
E@@ngine.GetResult get(Engine.Get get) throws ElasticSearchException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6464.java