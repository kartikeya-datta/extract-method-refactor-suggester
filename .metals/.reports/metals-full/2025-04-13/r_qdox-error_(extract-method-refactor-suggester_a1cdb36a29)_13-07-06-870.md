error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13814.java
text:
```scala
r@@esourceStream = Application.get().getResourceSettings().getResourceStreamFactory().locate(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13814.java