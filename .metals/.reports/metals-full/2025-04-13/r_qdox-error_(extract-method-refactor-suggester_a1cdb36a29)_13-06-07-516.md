error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14977.java
text:
```scala
s@@canner.setBasedir( getDir() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14977.java