error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14021.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14021.java
text:
```scala
private final R@@esourceAdapterDeploymentRegistry value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14021.java