error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9321.java
text:
```scala
s@@ignature = DSASignature.toDNS(dsakey.getParams(), signature);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9321.java