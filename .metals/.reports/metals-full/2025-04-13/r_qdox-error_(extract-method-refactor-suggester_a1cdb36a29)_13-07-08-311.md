error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6162.java
text:
```scala
n@@ew URL(this.wsdlLocation), new QName(clientAnn.targetNamespace(), clientAnn.name()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6162.java