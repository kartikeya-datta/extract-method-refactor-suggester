error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14264.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14264.java
text:
```scala
public A@@rchiveEntry getNextEntry() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14264.java