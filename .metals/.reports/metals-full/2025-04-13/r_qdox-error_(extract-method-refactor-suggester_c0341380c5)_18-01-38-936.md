error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1569.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1569.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1569.java
text:
```scala
public b@@oolean statisticsEnabled() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1569.java