error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1416.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1416.java
text:
```scala
0,@@ 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1416.java