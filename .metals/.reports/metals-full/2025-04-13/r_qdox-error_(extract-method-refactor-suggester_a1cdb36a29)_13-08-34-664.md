error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4941.java
text:
```scala
r@@ec.ttl = ttl;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4941.java