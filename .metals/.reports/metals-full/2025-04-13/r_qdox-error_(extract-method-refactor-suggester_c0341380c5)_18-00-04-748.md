error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7785.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7785.java
text:
```scala
public static S@@tring JNDI_NAME = "java:/EJBSecurityManager";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7785.java