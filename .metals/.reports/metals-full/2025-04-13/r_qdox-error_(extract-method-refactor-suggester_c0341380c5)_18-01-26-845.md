error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2910.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2910.java
text:
```scala
S@@tring depSymbolicName = deploymentMetadata.getApplicationSymbolicName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2910.java