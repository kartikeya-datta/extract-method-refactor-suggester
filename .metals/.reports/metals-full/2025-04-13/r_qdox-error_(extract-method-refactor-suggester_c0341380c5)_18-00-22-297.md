error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6528.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6528.java
text:
```scala
private final H@@ttpImageGetter imageGetter;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6528.java