error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17036.java
text:
```scala
i@@f (isVisible() && !getFlag(FLAG_RENDERING) && !getFlag(FLAG_PREPARED_FOR_RENDER))
...
public abstract class Component implements IClusterable, IConverterLocator
{
	 ...
	 * {@link #setMarkupId(String)}, id attribute defined in the markup, or an
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17036.java