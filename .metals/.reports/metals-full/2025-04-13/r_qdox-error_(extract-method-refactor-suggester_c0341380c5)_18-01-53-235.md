error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/980.java
text:
```scala
a@@nimTime += Gdx.graphics.getDeltaTime() / 10;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/980.java