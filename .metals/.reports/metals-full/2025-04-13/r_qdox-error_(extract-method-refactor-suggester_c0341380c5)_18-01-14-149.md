error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3475.java
text:
```scala
S@@tring[] concreteIndices = state.metaData().concreteIndices(request.indicesOptions(), request.indices());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3475.java