error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2544.java
text:
```scala
s@@etMunger(myMunger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2544.java