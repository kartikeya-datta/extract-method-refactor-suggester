error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8050.java
text:
```scala
p@@rocessorTarget.addDeploymentProcessor(JPAExtension.SUBSYSTEM_NAME, Phase.STRUCTURE, Phase.STRUCTURE_REGISTER_JBOSS_ALL_JPA,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8050.java