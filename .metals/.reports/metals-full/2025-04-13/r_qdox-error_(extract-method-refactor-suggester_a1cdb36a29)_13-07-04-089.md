error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6835.java
text:
```scala
P@@latformMBeanUtil.getResolver("platform-mbeans"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6835.java