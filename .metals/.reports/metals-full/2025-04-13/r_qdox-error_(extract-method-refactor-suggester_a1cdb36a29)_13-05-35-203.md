error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/155.java
text:
```scala
l@@ogger.info("DigestMismatchException: " + ex.getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/155.java