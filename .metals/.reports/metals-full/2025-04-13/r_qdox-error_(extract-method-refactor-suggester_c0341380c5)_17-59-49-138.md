error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4639.java
text:
```scala
L@@ist invitationsReceived = new ArrayList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4639.java