error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4663.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4663.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4663.java
text:
```scala
i@@f (child.getCorrespondingResource() != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4663.java