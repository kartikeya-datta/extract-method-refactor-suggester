error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17649.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[103,27]

error in qdox parser
file content:
```java
offset: 3283
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17649.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17649.java