error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5453.java
text:
```scala
S@@toreFileMetaData toMetaData = new StoreFileMetaData(to, fromMetaData.length(), fromMetaData.lastModified(), fromMetaData.checksum());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5453.java