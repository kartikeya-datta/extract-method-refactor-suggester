error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8104.java
text:
```scala
c@@onnection.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8104.java