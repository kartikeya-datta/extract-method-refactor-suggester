error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1288.java
text:
```scala
e@@ndpoint.addConnectionProvider("remote", new RemoteConnectionProviderFactory(), OptionMap.EMPTY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1288.java