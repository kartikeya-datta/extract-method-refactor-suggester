error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17530.java
text:
```scala
b@@oolean focused = hasFocus();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17530.java