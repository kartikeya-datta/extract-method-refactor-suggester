error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1066.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1066.java
text:
```scala
public static final f@@loat PI2 = PI * 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1066.java