error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8033.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8033.java
text:
```scala
public static final V@@ersion V_0_19_0_RC3 = new Version(V_0_19_0_RC3_ID, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8033.java