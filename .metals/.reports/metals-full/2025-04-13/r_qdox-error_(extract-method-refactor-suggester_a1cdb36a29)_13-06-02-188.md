error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14704.java
...
```java
offset: 1177
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14704.java
text:
```scala
...
p@@ackage org.jboss.as.server.client.api.deployment;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14704.java