error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9891.java
text:
```scala
p@@ack();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9891.java