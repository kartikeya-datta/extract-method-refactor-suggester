error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6030.java
text:
```scala
I@@Resource[] members = ((IContainer) project.getResource()).members();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6030.java