error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/916.java
text:
```scala
r@@eturn ((LocalTypeBinding) leafComponentType).createArrayType(dimensionCount, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/916.java