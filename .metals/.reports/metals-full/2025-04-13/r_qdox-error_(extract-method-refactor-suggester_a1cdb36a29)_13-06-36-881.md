error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13228.java
text:
```scala
N@@SProgressIndicator widget = (NSProgressIndicator)new SWTProgressIndicator().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13228.java