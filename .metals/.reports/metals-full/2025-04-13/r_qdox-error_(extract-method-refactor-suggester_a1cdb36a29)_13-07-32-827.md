error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/38.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/38.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/38.java
text:
```scala
c@@heckHits(q(queryCenter, radiusDeg*3 + smallRadius/2), points.size(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/38.java