error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/751.java
text:
```scala
A@@syncAction.this.addShardFailure(shardIndex, dfsResult.shardTarget(), t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/751.java