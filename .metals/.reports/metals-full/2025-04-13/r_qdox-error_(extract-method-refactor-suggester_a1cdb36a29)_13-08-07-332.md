error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2462.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2462.java
text:
```scala
final S@@tring[][] newarray = new String[array.length][2];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2462.java