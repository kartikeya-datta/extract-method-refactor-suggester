error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5170.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5170.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5170.java
text:
```scala
c@@onvertInput();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5170.java