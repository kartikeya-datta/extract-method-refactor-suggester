error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10623.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10623.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10623.java
text:
```scala
public static M@@oduleIdentifier APACHE_SCOUT = ModuleIdentifier.create("org.apache.juddi.scout");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10623.java