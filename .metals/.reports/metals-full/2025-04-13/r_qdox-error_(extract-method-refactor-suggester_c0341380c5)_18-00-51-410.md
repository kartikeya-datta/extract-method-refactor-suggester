error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8758.java
text:
```scala
i@@nt uid = folder.getConfiguration().getInteger("uid");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8758.java