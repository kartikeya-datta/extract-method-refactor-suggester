error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11940.java
text:
```scala
w@@hile (index <= count && hItem != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11940.java