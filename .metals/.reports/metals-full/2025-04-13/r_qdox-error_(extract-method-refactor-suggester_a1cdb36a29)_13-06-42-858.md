error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9563.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9563.java
text:
```scala
public N@@LSLine currentLine= null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9563.java