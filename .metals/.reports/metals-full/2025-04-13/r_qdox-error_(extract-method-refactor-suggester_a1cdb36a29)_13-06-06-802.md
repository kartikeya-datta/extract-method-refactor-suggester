error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17164.java
text:
```scala
a@@pplication.getPages().setHomePage(AttributeModifierComponentPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17164.java