error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18347.java
text:
```scala
c@@ache = new MarkupCache();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18347.java