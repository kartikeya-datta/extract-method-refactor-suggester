error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3607.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3607.java
text:
```scala
public v@@oid testCustomCharsetBadName() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3607.java