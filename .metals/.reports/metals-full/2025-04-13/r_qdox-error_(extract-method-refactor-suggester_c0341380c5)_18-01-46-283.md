error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6053.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6053.java
text:
```scala
i@@nt accelerator = KeySupport.convertEventToUnmodifiedAccelerator(e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6053.java