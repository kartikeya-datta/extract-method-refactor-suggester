error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1471.java
text:
```scala
C@@lusterBlocks.Builder blocks = ClusterBlocks.builder().blocks(currentState.blocks()).removeGlobalBlock(discoverySettings.getNoMasterBlock());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1471.java