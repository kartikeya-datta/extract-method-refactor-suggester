error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8940.java
text:
```scala
s@@etText(WorkbenchMessages.PartPane_closeAll);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8940.java