error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1466.java
text:
```scala
t@@his.tickDuration = componentSettings.getAsTime("tick_duration", timeValueMillis(100));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1466.java