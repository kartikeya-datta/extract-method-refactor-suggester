error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8419.java
text:
```scala
t@@hrow new OperationFailedException(ModClusterLogger.ROOT_LOGGER.contextOrHostNotFound(webHost, webContext));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8419.java