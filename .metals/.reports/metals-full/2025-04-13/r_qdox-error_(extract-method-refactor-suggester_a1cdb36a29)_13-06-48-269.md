error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4152.java
text:
```scala
r@@eturn new DoubleTerms.Bucket(value, bucket.docCount, bucket.aggregations, bucket.showDocCountError, bucket.docCountError, bucket.formatter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4152.java