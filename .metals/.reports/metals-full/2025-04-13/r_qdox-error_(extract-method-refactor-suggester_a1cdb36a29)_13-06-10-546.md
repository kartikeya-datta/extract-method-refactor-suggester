error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4187.java
text:
```scala
b@@indServices(factory,deploymentUnit, serviceTarget, moduleDescription, component.getComponentName(), compContextServiceName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4187.java