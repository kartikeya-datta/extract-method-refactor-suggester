error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12968.java
text:
```scala
S@@tring protocol, WebSocketHandler webSocketHandler) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12968.java