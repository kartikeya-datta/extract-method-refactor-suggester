error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17609.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[51,80]

error in qdox parser
file content:
```java
offset: 1836
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17609.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17609.java