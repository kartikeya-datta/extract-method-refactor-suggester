error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15277.java
text:
```scala
O@@bject result = getNext().call();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15277.java