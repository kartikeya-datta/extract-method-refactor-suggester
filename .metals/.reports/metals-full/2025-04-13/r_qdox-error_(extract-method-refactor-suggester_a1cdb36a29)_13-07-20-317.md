error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/77.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/77.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/77.java
text:
```scala
i@@nitsOnBreak = initsOnBreak.mergedWith(flowInfo.unconditionalInits());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/77.java