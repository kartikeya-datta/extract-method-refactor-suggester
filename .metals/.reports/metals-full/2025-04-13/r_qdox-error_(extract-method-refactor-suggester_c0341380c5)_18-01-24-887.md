error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/989.java
text:
```scala
c@@lonedOp.get(OPERATION_HEADERS, DomainControllerLockIdUtils.DOMAIN_CONTROLLER_LOCK_ID).set(CurrentOperationIdHolder.getCurrentOperationID());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/989.java