error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10803.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10803.java
text:
```scala
static i@@nt MINOR_VERSION = 636;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10803.java