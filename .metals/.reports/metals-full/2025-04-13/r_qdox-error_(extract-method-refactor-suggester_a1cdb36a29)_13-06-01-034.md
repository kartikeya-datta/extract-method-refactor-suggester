error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14264.java
text:
```scala
i@@f (result != null) return result;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14264.java