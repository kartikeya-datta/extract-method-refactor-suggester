error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7314.java
text:
```scala
k@@eyBindingService = new KeyBindingService(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7314.java