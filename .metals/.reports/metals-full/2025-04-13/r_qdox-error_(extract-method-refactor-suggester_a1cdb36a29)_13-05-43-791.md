error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4736.java
text:
```scala
L@@ogger cat = LogManager.exists(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4736.java