error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/953.java
text:
```scala
n@@ame = ctx.getOtherArguments().get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/953.java