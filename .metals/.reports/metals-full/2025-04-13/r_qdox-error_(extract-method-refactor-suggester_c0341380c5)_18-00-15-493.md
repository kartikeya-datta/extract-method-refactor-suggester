error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/942.java
text:
```scala
a@@ttrs.add(REDIRECT_SOCKET);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/942.java