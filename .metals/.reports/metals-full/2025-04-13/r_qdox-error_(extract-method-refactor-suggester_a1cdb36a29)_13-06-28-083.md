error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7636.java
text:
```scala
F@@unctor[] writeFunctors, Class<?>[] editorClasses) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7636.java