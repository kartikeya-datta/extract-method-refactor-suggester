error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5620.java
text:
```scala
i@@f ((style & SWT.SAVE) != 0) OS.SaveFileDialog_OverwritePrompt (dialog, overwritePrompt);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5620.java