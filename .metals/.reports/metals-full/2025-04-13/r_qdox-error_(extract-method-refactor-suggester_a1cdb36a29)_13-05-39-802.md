error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4962.java
...
```java
offset: 849
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4962.java
text:
```scala
...
p@@ackage com.badlogic.gdx.tests.box2d;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4962.java