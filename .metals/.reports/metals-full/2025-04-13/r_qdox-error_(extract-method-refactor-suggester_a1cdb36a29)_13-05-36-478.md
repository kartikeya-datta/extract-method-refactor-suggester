error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/753.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/753.java
text:
```scala
public G@@roupPattern(Pattern p1, Pattern p2) {

package org.kohsuke.rngom.binary;

import org.kohsuke.rngom.binary.visitor.*;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/753.java