error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18253.java
text:
```scala
i@@nt /*long*/ enterWindow = OS.gdk_window_new (parentWindow, attributes, OS.GDK_WA_X | OS.GDK_WA_Y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18253.java