error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3891.java
text:
```scala
L@@ist<String> nodes = internalCluster().startNodesAsync(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3891.java