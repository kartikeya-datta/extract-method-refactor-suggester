error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3112.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3112.java
text:
```scala
protected P@@ageableListViewNavigation newNavigation(IPageableComponent table)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3112.java