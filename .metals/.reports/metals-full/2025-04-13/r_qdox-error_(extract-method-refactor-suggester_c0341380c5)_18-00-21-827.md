error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7198.java
text:
```scala
s@@ession.getApplication().getSessionSettings().getPageMapEvictionStrategy().evict(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7198.java