error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6076.java
text:
```scala
i@@f (_exps != null && _type == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6076.java