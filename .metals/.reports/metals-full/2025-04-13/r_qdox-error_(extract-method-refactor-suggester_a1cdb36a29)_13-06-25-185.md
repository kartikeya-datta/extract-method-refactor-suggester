error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8245.java
text:
```scala
O@@S.gtk_tree_view_set_drag_dest_row(handle, 0, OS.GTK_TREE_VIEW_DROP_BEFORE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8245.java