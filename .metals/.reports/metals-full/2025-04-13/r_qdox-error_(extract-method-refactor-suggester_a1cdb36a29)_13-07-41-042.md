error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2931.java
text:
```scala
M@@anifest mf = ManifestUtils.getOrCreateManifest(archive);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2931.java