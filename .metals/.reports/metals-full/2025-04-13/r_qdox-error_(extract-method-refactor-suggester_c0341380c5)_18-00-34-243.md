error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5546.java
text:
```scala
S@@tring componentPart = Strings.afterFirstPathComponent(componentPath, Component.PATH_SEPARATOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5546.java