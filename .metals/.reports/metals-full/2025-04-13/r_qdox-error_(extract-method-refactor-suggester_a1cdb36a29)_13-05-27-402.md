error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2894.java
text:
```scala
s@@uper("not symmetric matrix");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2894.java