error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7744.java
text:
```scala
s@@etRule(project.getProject().getWorkspace().getRoot());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7744.java