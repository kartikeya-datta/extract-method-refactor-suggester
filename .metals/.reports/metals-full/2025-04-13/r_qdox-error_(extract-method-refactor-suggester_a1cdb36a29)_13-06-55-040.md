error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13184.java
text:
```scala
e@@mf = createEntityManagerFactory("cache-mode-empty", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13184.java