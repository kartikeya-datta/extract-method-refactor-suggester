error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/576.java
text:
```scala
i@@f (job.getResult() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/576.java