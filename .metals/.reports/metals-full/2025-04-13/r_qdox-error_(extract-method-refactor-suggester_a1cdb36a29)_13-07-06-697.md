error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3297.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3297.java
text:
```scala
public v@@oid visitSubScorers(Query parent, Occur relationship,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3297.java