error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11955.java
text:
```scala
S@@tring expectedEcho = SimpleInterceptor.class.getName() + "#" + SimpleStatelessSessionBean.class.getName() + "#" + "Echo " + message + " -- (1:Other, 2:Other, 3:Other)" ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11955.java