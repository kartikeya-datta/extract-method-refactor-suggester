error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5971.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5971.java
text:
```scala
b@@eginTask(Util.bind("operation.createUnitProgress"), 2); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5971.java