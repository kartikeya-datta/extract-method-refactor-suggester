error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/340.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/340.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/340.java
text:
```scala
M@@odelTestModelControllerService svc = TestModelControllerService.create(processType, runningModeControl, persister, validateOperations, type, modelInitializer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/340.java