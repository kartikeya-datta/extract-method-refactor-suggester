error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6607.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6607.java
text:
```scala
n@@ewControllers.add(FrameworkBootstrapService.addService(serviceTarget, resource, deploymentTracker, extensions, verificationHandler));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6607.java