error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/901.java
text:
```scala
S@@chema schema = Schema.parse(ByteBufferUtil.string(value));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/901.java