error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7503.java
text:
```scala
t@@his.blockingServer = componentSettings.getAsBoolean("memcached.blocking_server", settings.getAsBoolean(TCP_BLOCKING_SERVER, settings.getAsBoolean(TCP_BLOCKING, false)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7503.java