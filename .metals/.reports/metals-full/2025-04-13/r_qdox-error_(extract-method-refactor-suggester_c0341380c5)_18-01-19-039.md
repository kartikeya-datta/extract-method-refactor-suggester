error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7405.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7405.java
text:
```scala
private static T@@hreadLocal<SearchContext> current = new ThreadLocal<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7405.java