error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6637.java
text:
```scala
d@@ocument.removeAllIndexEntries(); // in case the document was already indexed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6637.java