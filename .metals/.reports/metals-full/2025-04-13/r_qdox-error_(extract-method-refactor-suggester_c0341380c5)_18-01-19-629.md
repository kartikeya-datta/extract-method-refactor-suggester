error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8108.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8108.java
text:
```scala
r@@eturn pointcut1.concretize1(null, null, new IntMap());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8108.java