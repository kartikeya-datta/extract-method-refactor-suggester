error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2048.java
text:
```scala
t@@his.useFlag = USED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2048.java