error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7383.java
text:
```scala
i@@nt width = clientAreaWidth - leftMargin - rightMargin - getCaretWidth();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7383.java