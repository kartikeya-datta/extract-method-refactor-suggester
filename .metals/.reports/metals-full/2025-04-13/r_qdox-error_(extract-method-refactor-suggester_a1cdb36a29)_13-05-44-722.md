error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10638.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10638.java
text:
```scala
final I@@ndex index = phaseContext.getDeploymentUnit().getAttachment(Attachments.ANNOTATION_INDEX);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10638.java