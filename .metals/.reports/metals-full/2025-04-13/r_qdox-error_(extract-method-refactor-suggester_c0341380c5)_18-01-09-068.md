error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/350.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/350.java
text:
```scala
private static final l@@ong serialVersionUID = -3094696765038308799L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/350.java