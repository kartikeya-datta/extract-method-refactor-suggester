error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9767.java
text:
```scala
i@@f (this == otherType || erasure() == otherType) // https://bugs.eclipse.org/bugs/show_bug.cgi?id=329588
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9767.java