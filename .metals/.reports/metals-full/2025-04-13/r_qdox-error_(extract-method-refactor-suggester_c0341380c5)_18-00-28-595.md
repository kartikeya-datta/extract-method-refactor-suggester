error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2752.java
text:
```scala
P@@ropertyModel pm = new PropertyModel(new TextField<String>(new EmptyPage(), "test",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2752.java