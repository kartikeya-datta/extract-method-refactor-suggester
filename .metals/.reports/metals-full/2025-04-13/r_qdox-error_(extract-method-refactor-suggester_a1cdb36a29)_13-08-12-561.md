error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3644.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3644.java
text:
```scala
public M@@ultiple(Properties props, String disambiguator) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3644.java