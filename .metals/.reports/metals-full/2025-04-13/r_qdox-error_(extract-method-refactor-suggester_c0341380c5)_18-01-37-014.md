error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2396.java
text:
```scala
C@@lass homePageClass = application.getHomePage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2396.java