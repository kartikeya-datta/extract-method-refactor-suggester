error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9793.java
text:
```scala
i@@f (tag.getComponentId() == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9793.java