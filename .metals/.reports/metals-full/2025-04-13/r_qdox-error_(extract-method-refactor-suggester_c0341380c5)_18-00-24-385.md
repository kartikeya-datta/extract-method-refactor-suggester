error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8543.java
text:
```scala
p@@ublic class GenericMessagingTemplate extends AbstractDestinationResolvingMessagingTemplate<MessageChannel>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8543.java