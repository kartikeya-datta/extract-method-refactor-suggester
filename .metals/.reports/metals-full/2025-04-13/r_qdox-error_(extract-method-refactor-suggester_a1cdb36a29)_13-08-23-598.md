error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8383.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[37,2]

error in qdox parser
file content:
```java
offset: 1340
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8383.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8383.java