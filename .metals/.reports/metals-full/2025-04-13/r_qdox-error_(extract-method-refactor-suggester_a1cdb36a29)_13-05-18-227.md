error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1780.java
text:
```scala
r@@eturn contribution.getPluginId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1780.java