error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14537.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14537.java
text:
```scala
final E@@numSet<Attribute> required = EnumSet.of(Attribute.NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14537.java