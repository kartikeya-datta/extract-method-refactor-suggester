error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7305.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7305.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7305.java
text:
```scala
S@@ortedMap<Character, Byte> typeMap = new TreeMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7305.java