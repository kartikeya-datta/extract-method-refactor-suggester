error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/205.java
text:
```scala
T@@hread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e.getCause());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/205.java