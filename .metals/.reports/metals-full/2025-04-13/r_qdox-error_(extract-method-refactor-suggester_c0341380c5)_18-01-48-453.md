error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7596.java
text:
```scala
S@@ystem.out.println("UPDATING Model with Delta: ["+Thread.currentThread()+":" + delta + "]:");//$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7596.java