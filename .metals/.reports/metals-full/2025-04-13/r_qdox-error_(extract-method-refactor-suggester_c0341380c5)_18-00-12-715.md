error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12007.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12007.java
text:
```scala
O@@S.CGContextSetLineWidth(handle, Math.max(1, width));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12007.java