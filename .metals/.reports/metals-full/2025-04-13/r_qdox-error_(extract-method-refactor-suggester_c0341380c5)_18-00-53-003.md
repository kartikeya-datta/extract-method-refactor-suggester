error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8632.java
text:
```scala
r@@eturn new RamAccountingTermsEnum(filteredEnum, breaker, this, "parent/child id cache");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8632.java