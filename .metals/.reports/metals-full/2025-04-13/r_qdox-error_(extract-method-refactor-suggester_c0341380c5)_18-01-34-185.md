error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2175.java
text:
```scala
L@@ZFStreamInput lzf = new LZFStreamInput(null, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2175.java