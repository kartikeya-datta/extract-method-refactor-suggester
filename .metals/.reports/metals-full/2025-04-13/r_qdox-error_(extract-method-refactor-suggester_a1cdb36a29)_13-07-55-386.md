error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2155.java
text:
```scala
t@@hrow new OperationFailedException(NamingLogger.ROOT_LOGGER.jndiViewNotAvailable());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2155.java