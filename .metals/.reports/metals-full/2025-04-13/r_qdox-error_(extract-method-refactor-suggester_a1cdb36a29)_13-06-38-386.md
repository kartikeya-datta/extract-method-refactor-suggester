error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/175.java
text:
```scala
s@@uper(parent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/175.java