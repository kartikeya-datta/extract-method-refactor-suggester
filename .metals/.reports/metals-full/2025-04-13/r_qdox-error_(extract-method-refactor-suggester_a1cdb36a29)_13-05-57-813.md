error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17038.java
text:
```scala
i@@f (OS.CGCursorIsVisible ()) OS.CGDisplayHideCursor (OS.CGMainDisplayID ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17038.java