error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6731.java
text:
```scala
D@@efaults.PRECISION_STEP, Defaults.BOOST, fieldType,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6731.java