error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5885.java
text:
```scala
p@@ublic class WicketServlet extends HttpServlet
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5885.java