error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17848.java
text:
```scala
i@@f (parent == null || !((Shell)parent).window.isMiniaturized()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17848.java