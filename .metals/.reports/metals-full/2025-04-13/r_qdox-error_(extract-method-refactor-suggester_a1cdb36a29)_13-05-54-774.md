error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/783.java
text:
```scala
s@@uper(name, xmlName, null, ModelType.OBJECT, allowNull, false, null, corrector, new ObjectTypeValidator(allowNull, valueTypes), false, alternatives, requires, flags);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/783.java