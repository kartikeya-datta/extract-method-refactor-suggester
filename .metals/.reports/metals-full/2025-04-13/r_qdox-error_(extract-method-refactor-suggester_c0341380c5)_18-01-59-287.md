error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3830.java
text:
```scala
p@@roject.getPackageFragmentRoot(project.getResource());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3830.java