error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7139.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7139.java
text:
```scala
f@@ieldBindings[count++] = new FieldBinding(IncompleteHierarchy, IntBinding, AccPrivate, referenceContext.binding, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7139.java