error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/380.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/380.java
text:
```scala
protected v@@oid update(final int position, final RecentRepositoryItemView view, final Repository repository) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/380.java