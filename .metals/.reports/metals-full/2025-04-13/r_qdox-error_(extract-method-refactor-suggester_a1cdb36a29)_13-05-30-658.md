error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2282.java
text:
```scala
r@@eturn ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2282.java