error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11938.java
text:
```scala
r@@eturn (List<E>) decorated();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11938.java