error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3704.java
text:
```scala
p@@arameterSignatures[0] = Signature.getTypeErasure(enclosingDeclaringTypeSignature);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3704.java