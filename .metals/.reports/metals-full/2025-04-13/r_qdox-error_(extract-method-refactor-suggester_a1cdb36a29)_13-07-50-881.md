error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15070.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15070.java
text:
```scala
public static M@@odel valueOf(final Map map)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15070.java