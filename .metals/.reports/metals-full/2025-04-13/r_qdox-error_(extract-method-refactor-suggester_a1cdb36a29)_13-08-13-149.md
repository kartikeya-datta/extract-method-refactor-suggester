error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5840.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5840.java
text:
```scala
v@@oid uninject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5840.java