error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/160.java
text:
```scala
t@@able.pad(10).defaults().expandX().space(4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/160.java