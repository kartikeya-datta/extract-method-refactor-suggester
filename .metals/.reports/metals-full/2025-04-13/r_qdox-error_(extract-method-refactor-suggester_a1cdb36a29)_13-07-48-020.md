error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4079.java
text:
```scala
B@@ox2DTest.class, InterpolationTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4079.java