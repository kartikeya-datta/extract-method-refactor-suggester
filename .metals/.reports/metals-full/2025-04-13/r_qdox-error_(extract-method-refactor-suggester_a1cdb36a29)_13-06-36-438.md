error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/603.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/603.java
text:
```scala
protected L@@istAdapter adapterFor(List<Issue> issues) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/603.java