error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2431.java
text:
```scala
j@@sonTexture.fileName = materialDir + (materialDir.endsWith("/") ? "" : "/") + fileName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2431.java