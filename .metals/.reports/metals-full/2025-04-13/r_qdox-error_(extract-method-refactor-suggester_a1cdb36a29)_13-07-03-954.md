error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1642.java
text:
```scala
s@@tr.append("TypedValue: ").append(this.value).append(" of ").append(this.getTypeDescriptor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1642.java