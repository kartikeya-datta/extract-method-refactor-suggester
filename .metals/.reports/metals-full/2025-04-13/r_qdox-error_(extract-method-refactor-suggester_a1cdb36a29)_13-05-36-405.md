error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/343.java
text:
```scala
S@@tring requestUri = this.urlPathHelper.getOriginatingRequestUri(request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/343.java