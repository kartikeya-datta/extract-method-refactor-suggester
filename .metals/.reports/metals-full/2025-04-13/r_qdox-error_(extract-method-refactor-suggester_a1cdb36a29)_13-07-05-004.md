error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3435.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3435.java
text:
```scala
public static final O@@perationAssociation INSTANCE = new OperationAssociation();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3435.java