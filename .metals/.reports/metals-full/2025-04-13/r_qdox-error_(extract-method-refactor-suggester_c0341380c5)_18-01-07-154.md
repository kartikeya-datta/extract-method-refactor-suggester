error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/550.java
text:
```scala
t@@erm.copyChars(val);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/550.java