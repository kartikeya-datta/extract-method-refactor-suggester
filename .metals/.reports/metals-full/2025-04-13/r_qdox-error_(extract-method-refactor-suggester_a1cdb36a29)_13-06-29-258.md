error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2899.java
text:
```scala
U@@til.verbose("-> waiting end of current background job - " + currentJob); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2899.java