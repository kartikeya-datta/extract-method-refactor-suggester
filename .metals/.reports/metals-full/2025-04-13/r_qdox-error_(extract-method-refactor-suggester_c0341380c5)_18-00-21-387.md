error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2059.java
text:
```scala
s@@uper(reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2059.java