error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/967.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/967.java
text:
```scala
final A@@rray<btTypedConstraint> constraints = new Array<btTypedConstraint>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/967.java