error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/600.java
text:
```scala
C@@lass[] jaxrsType = GetRestful.getSubResourceClasses(componentClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/600.java