error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1923.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1923.java
text:
```scala
public static final i@@nt SESSION_REMOVE_INTERCEPTOR                              = 0x700;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1923.java