error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/679.java
text:
```scala
s@@cope.enclosingCase = this; // record entering in a switch case block
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/679.java