error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14985.java
text:
```scala
p@@ublic final class Latin1Reader
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14985.java