error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/688.java
text:
```scala
s@@uper(dir, a, create, mfl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/688.java