error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14154.java
text:
```scala
C@@oarseSSOCacheEntry<?> entry = new CoarseSSOCacheEntry<>();
...
public class CoarseSSOCacheEntryExternalizer extends AbstractSimpleExternalizer<CoarseSSOCacheEntry<?>> {
    ...
    public CoarseSSOCacheEntry<?> readObject(ObjectInput input) throws IOException, ClassNotFoundException {
        CoarseSSOCacheEntry<?> entry = new CoarseSSOCacheEntry<Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14154.java