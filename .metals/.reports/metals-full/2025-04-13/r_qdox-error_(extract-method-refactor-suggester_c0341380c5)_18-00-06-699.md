error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3173.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,240]

error in qdox parser
file content:
```java
offset: 240
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3173.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3173.java