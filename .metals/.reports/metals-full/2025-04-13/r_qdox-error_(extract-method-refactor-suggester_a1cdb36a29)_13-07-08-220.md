error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5446.java
text:
```scala
s@@hell.setSize(350, 550);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5446.java