error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9116.java
text:
```scala
a@@ddBeans( getContext().getProperties() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9116.java