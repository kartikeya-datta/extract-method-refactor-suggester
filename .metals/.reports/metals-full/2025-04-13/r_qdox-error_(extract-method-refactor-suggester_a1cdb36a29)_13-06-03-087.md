error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13447.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13447.java
text:
```scala
public v@@oid scan(String... basePackages) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13447.java