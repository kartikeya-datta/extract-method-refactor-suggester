error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2154.java
text:
```scala
m@@essage = rm.makeRowMutationMessage(StorageService.Verb.BINARY, MessagingService.version_);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2154.java