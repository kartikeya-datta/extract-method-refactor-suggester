error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10991.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10991.java
text:
```scala
p@@ublic abstract class AbstractDestinationResolvingMessagingTemplate<D> extends AbstractReceivingMessagingTemplate<D>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10991.java