error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/775.java
text:
```scala
t@@his(controller, channelAssociation, new Subject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/775.java