error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5467.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5467.java
text:
```scala
public C@@harSequence decorateScript(Component c, CharSequence script)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5467.java