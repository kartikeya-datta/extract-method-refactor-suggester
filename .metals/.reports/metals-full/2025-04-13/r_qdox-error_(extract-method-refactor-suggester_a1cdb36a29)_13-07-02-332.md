error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4232.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4232.java
text:
```scala
public static l@@ong getCPtr(SWIGTYPE_p_f_r_btBroadphasePair_r_btCollisionDispatcher_r_q_const__btDispatcherInfo__void obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4232.java