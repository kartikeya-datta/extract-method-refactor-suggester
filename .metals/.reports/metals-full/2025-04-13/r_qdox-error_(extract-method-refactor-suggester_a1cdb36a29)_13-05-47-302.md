error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10562.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10562.java
text:
```scala
public O@@bject getAsyncResult(long timeToWait) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10562.java