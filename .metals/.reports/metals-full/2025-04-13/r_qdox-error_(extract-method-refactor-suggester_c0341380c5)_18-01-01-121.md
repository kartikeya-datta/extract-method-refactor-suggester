error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4062.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4062.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4062.java
text:
```scala
C@@olumbaLogger.log.severe("Not yet implemented!");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4062.java