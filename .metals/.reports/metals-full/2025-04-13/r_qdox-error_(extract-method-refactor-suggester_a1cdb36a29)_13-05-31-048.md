error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12071.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12071.java
text:
```scala
private final A@@jaxIndicatorAppender indicatorAppender = new AjaxIndicatorAppender();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12071.java