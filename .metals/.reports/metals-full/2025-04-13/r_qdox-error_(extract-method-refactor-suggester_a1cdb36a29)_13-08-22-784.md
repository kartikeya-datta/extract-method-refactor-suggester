error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10560.java
text:
```scala
r@@eturn classFile.generateMethodInfoAttribute(binding, false, AstUtil.getAjSyntheticAttribute());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10560.java