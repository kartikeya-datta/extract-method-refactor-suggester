error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1124.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1124.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1124.java
text:
```scala
r@@eturn new NGramTokenFilter(luceneMatchVersion, input, minGramSize, maxGramSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1124.java