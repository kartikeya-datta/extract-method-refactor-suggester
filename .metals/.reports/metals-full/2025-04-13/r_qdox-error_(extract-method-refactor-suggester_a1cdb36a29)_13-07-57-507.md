error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11629.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11629.java
text:
```scala
public final v@@oid validate(IValidatable validatable)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11629.java