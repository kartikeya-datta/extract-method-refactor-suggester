error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6943.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6943.java
text:
```scala
public F@@ragmentWithAssociatedMarkupStream(MarkupContainer parent, final String id, final String markupId)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6943.java