error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1873.java
text:
```scala
R@@esultPrinter printer= new TestResultPrinter(new PrintStream(output)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1873.java