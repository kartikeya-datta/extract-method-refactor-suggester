error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6735.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6735.java
text:
```scala
a@@ssertThat(failure.reason(), containsString("[twitter] [has_child] unsupported in delete_by_query api"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6735.java