error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9707.java
text:
```scala
n@@ew String[]{excType.getName()},
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9707.java