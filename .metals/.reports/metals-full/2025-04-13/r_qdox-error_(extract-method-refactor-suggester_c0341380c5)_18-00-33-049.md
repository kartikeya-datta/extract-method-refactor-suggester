error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9100.java
text:
```scala
t@@hrow VAJLocalUtil.createBuildException("VA Exception occurred: ", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9100.java