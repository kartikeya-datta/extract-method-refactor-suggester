error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7817.java
...
```java
offset: 12
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7817.java
text:
```scala
" with " + s@@uper.toString(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7817.java