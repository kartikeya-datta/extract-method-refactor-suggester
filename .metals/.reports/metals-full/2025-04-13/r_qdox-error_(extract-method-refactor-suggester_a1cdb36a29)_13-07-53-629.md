error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1372.java
text:
```scala
m@@ethod.returnType = scope.environment().createParameterizedType(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1372.java