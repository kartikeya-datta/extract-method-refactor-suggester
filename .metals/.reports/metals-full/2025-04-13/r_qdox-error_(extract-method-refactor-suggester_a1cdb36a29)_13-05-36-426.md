error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6472.java
text:
```scala
t@@his.maxMergedSegment = componentSettings.getAsBytesSize("max_merged_segment", componentSettings.getAsBytesSize("max_merge_segment", new ByteSizeValue(5, ByteSizeUnit.GB)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6472.java