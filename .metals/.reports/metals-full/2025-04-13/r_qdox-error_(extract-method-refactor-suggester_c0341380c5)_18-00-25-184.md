error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1809.java
text:
```scala
t@@ext = GestureSupport.formatSequence(sequence, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1809.java