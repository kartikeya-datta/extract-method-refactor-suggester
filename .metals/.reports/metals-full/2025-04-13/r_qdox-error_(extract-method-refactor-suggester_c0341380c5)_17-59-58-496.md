error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4980.java
text:
```scala
t@@his.sockJsSession.afterSessionInitialized(wsSession);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4980.java