error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/669.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/669.java
text:
```scala
public v@@oid stop(final R result)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/669.java