error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2389.java
text:
```scala
J@@avaCore.PLUGIN_ID,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2389.java