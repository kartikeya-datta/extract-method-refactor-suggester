error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12781.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12781.java
text:
```scala
private static final i@@nt TIMER_CALL_WAITING_S = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12781.java