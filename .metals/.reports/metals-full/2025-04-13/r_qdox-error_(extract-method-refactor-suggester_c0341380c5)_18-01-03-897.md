error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5804.java
text:
```scala
a@@ssertTrue(replacer.containsKey("server"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5804.java