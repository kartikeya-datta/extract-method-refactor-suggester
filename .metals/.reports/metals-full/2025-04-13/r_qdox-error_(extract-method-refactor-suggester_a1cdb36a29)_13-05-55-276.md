error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1441.java
text:
```scala
n@@ew Bot(entry);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1441.java