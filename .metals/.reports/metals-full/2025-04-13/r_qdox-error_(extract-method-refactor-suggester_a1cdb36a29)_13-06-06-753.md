error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1387.java
text:
```scala
t@@cr.setForeground(UIManager.getColor("Table.foreground"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1387.java