error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6168.java
text:
```scala
.@@remove(service);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6168.java