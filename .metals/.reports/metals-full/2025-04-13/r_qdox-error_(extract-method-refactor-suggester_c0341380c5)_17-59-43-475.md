error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3783.java
text:
```scala
F@@ilter filter = lookup.getFieldMapper().termsFilter(values, lookup.getQueryParseContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3783.java