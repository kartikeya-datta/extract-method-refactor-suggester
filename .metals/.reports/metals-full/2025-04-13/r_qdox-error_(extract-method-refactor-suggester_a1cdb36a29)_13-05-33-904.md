error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18249.java
text:
```scala
i@@f( m_type != null && !m_type.isInstance( object ) )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18249.java