error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3272.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3272.java
text:
```scala
S@@elect<?> select = findParent(Select.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3272.java