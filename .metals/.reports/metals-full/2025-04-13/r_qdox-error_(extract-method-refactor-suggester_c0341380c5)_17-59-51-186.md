error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7617.java
text:
```scala
S@@tring document = application.getLastResponseAsString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7617.java