error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11726.java
text:
```scala
p@@ublic class SimplePage_13 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11726.java