error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5790.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5790.java
text:
```scala
+ i@@mportedFile + "\n", Project.MSG_VERBOSE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5790.java