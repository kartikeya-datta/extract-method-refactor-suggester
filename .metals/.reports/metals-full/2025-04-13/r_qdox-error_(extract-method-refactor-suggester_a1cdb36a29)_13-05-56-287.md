error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1418.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1418.java
text:
```scala
private static final S@@tring VERSION = "2.1.20050422";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1418.java