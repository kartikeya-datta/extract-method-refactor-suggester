error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1789.java
text:
```scala
c@@atch (ClassNotFoundException t)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1789.java