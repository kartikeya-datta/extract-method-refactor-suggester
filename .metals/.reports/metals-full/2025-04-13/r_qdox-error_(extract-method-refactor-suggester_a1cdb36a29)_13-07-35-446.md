error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5296.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5296.java
text:
```scala
d@@ouble value = widget.doubleValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5296.java