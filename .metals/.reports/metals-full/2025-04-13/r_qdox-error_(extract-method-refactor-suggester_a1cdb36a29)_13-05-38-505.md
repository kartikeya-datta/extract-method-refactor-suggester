error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13989.java
text:
```scala
p@@ostEvent(SWT.Selection);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13989.java