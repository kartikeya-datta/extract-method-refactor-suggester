error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2117.java
text:
```scala
f@@ileName.toLowerCase(Locale.ENGLISH).endsWith(".p12") ? PKCS12 : "JKS"); // otherwise use the name
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2117.java