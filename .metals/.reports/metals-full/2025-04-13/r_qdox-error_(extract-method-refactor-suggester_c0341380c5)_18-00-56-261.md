error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/955.java
text:
```scala
l@@oadingView = getLayoutInflater().inflate(layout.comment_load_item, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/955.java