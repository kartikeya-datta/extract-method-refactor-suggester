error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15784.java
text:
```scala
_@@referenceFiles = new Path();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15784.java