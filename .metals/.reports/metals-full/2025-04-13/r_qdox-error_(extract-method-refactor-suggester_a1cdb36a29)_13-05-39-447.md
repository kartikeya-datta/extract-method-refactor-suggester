error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9363.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9363.java
text:
```scala
public R@@esourceNameIterator(final String path, final String style, final String variation,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9363.java