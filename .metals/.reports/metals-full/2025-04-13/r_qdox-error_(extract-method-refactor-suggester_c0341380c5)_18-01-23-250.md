error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/846.java
text:
```scala
S@@canner scanner = new Scanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/, assertMode, null/*todo*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/846.java