error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7755.java
text:
```scala
i@@nternedQualifiedNames = ReferenceCollection.internQualifiedNames(internedQualifiedNames, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7755.java