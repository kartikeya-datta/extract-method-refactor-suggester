error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/900.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/900.java
text:
```scala
t@@ypeBinding = ((TypeReference)reference).resolvedType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/900.java