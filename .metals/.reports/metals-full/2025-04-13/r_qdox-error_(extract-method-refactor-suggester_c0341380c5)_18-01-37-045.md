error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7606.java
text:
```scala
S@@ession<L> session = this.factory.createSession(id, this.factory.createValue(id, null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7606.java