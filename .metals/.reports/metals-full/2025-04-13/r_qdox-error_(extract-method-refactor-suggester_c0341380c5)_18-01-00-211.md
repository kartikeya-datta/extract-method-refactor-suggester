error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/67.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/67.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/67.java
text:
```scala
i@@f (sortPolarity != null && sortPolarity.equals("desc"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/67.java