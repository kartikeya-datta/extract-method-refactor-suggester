error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8277.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8277.java
text:
```scala
public final I@@CompoundRequestMapper getRootRequestMapperAsCompound()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8277.java