error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/373.java
text:
```scala
t@@ypeString = field.substring(1+index, field.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/373.java