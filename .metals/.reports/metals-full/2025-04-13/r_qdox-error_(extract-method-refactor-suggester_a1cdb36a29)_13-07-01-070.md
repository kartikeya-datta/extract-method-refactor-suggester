error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8499.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8499.java
text:
```scala
s@@uper(MESSAGES.passwordNotLongEnough(desiredLength));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8499.java