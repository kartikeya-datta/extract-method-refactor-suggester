error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1942.java
text:
```scala
r@@eturn System.currentTimeMillis() > creationTime + cfs.getMemtableFlushAfterMins() * 60 * 1000L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1942.java