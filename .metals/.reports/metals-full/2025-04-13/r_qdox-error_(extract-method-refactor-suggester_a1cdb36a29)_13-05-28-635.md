error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4024.java
text:
```scala
i@@f(OperatingSystem.isMacOSLF())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4024.java