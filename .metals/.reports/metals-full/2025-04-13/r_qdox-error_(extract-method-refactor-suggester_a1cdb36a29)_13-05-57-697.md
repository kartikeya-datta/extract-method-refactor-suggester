error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/521.java
text:
```scala
s@@earchHeaderField = new String("columba.spam");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/521.java