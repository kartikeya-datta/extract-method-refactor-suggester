error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2231.java
text:
```scala
i@@f ((operationTypeID = (implicitConversion & IMPLICIT_CONVERSION_MASK) >> 4) == T_JavaLangString) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2231.java