error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1403.java
text:
```scala
s@@hard.refresh(new Engine.Refresh("percolator_load_queries").force(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1403.java