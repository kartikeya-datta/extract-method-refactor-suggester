error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2640.java
text:
```scala
S@@tring REDIRECT_PORT = "redirect-port";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2640.java