error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2346.java
text:
```scala
F@@ieldMetaData[] fmds = sm.getMetaData().getFields();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2346.java