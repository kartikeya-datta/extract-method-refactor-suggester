error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13556.java
text:
```scala
a@@lert.beginSheetModalForWindow(parent.view.window (), delegate, OS.sel_panelDidEnd_returnCode_contextInfo_, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13556.java