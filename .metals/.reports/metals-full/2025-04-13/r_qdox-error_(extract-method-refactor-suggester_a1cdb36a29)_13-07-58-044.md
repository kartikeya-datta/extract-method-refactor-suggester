error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16403.java
text:
```scala
r@@eturn OS.objc_msgSend_bool(this.id, OS.sel_wraps);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16403.java