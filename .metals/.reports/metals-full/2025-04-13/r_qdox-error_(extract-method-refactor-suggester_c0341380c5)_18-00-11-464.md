error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5438.java
text:
```scala
r@@eturn localAnchorA.set(joint.getLocalAnchorB().x, joint.getLocalAnchorB().y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5438.java