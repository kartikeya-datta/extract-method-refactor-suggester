error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/707.java
text:
```scala
a@@ssertThat(ttl0, greaterThan(-purgeInterval));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/707.java