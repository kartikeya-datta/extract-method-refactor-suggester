error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9622.java
text:
```scala
R@@eferenceBinding context = ((ClassScope)this).referenceType().binding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9622.java