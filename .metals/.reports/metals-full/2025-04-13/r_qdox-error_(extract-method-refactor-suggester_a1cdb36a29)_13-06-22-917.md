error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3778.java
text:
```scala
r@@anges.add((Range) Range.serializer().deserialize(dis));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3778.java