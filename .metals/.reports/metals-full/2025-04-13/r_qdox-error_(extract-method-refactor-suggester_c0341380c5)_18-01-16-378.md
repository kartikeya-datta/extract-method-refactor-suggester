error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8330.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8330.java
text:
```scala
public S@@haredObjectDescription[] getReplicaDescriptions(ID [] remotes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8330.java