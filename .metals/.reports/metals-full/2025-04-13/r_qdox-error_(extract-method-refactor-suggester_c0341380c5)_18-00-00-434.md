error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7286.java
text:
```scala
r@@eturn new Wrapped<>(callable, priority);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7286.java