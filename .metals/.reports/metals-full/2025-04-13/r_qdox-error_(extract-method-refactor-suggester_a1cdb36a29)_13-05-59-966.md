error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9419.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9419.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9419.java
text:
```scala
E@@ditorSashContainer ea = ((EditorPane) pane).getWorkbook().getEditorArea();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9419.java