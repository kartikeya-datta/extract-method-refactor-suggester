error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14992.java
text:
```scala
T@@hread.sleep(targetTime - curTime);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14992.java