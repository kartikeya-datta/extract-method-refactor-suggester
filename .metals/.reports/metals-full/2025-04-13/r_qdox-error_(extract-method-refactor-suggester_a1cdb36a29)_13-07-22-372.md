error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8300.java
text:
```scala
i@@f (ProgressManagerUtil.rescheduleIfModalShellOpen(this))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8300.java