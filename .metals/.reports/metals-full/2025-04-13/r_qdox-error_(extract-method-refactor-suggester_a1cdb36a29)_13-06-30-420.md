error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3454.java
text:
```scala
f@@iltered.retainAll(objectManager.getEnabledObjects());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3454.java