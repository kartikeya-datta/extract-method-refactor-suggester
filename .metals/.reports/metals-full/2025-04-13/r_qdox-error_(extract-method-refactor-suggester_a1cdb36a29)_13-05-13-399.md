error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17293.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17293.java
text:
```scala
_@@loc.get("source-tracker-file-unknown").getMessage() :
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17293.java