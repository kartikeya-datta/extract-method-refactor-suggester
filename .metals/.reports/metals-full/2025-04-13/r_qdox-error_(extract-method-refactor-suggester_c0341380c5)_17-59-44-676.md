error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/910.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/910.java
text:
```scala
p@@ublic abstract class SortableDataProvider<V> implements IDataProvider<V>, ISortStateLocator
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/910.java