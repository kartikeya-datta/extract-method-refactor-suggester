error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3015.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3015.java
text:
```scala
public v@@oid parseSingleRescoreContext(XContentParser parser, SearchContext context) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3015.java