error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2447.java
text:
```scala
r@@eturn new StringBuffer("CompilationUnit("/*nonNLS*/).append(getFileName()).append(")"/*nonNLS*/).toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2447.java