error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/533.java
text:
```scala
r@@eturn encodeUriVariableValues ? UriUtils.encodeUriComponent(variableValueString, uriComponent) :
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/533.java