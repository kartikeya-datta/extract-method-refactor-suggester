error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15254.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[111,2]

error in qdox parser
file content:
```java
offset: 3402
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15254.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15254.java