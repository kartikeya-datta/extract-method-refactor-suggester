error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7065.java
text:
```scala
S@@tring classpath = classpaths[i].getPath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7065.java