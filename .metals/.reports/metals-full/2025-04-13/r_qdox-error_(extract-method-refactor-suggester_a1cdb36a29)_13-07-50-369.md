error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3881.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3881.java
text:
```scala
r@@eturn PackedArrayAtomicFieldData.empty(reader.maxDoc());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3881.java