error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8924.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8924.java
text:
```scala
protected static final s@@hort FLAG_CONVERT_EMPTY_STRING_TO_NULL = 0x0020;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8924.java