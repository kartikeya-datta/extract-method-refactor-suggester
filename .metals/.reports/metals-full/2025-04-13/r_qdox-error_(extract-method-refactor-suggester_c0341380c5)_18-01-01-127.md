error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3433.java
text:
```scala
c@@onstant = Boolean.valueOf(constantSource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3433.java