error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10828.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10828.java
text:
```scala
a@@dd(new Label("label", pageParameters.get("id").toString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10828.java