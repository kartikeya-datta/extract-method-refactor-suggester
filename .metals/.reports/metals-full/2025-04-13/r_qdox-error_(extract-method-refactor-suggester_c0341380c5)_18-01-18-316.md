error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8947.java
text:
```scala
r@@eturn fLocator.getXMLVersion();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8947.java