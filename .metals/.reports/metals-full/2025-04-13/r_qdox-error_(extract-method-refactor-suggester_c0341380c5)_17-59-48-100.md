error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10071.java
text:
```scala
c@@mpInstance.getComponent().getStoreManager().removeEntity(cmpInstance.getEjbContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10071.java