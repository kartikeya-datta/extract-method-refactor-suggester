error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4734.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(ConnectorLogger.ROOT_LOGGER.failedToInvokeOperation(e.getLocalizedMessage())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4734.java