error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9304.java
text:
```scala
g@@etLogger().info( "Ignored reference. It cannot be used in non XML report." );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9304.java