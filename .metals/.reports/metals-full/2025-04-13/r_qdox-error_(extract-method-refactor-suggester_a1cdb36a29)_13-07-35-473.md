error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2404.java
text:
```scala
d@@ocValues = load(state.fieldInfos, state.segmentInfo.name, state.segmentInfo.docCount, state.dir, state.context);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2404.java