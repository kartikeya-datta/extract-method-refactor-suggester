error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7455.java
text:
```scala
h@@ostRegistration.registerOperationHandler(XmlMarshallingHandler.DEFINITION, xmh);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7455.java