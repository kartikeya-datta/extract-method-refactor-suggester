error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2865.java
text:
```scala
i@@f (depUnit.hasAttachment(OSGiConstants.BUNDLE_KEY))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2865.java