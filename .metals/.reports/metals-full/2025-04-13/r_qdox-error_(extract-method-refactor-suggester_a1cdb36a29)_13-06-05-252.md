error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5875.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5875.java
text:
```scala
s@@igner = Name.fromString(st.nextToken(), origin);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5875.java