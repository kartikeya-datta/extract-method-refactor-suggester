error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16982.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16982.java
text:
```scala
S@@tring pageReference = application.getPages().aliasForClass(pageClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16982.java