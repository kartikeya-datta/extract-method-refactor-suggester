error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7288.java
text:
```scala
r@@eturn services.remove(cl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7288.java