error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1851.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1851.java
text:
```scala
protected i@@nt OnUIDeactivate(int fUndoable) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1851.java