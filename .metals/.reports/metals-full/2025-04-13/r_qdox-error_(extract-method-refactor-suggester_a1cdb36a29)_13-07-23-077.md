error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3887.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3887.java
text:
```scala
public I@@nspectorBug(final MarkupContainer parent, final String id, final WebPage page)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3887.java