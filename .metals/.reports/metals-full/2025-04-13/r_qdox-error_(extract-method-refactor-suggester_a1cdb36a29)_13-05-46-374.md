error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6951.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6951.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6951.java
text:
```scala
private A@@ctivityRegistryEvent activityRegistryEvent;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6951.java