error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3132.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3132.java
text:
```scala
protected b@@oolean delegate (float delta) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3132.java