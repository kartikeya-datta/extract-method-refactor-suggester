error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2041.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2041.java
text:
```scala
public L@@wjglApplet (final ApplicationListener listener) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2041.java