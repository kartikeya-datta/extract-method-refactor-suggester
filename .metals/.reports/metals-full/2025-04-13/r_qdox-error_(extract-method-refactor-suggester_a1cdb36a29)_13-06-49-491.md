error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8448.java
text:
```scala
i@@f (submit.getForm().getRootForm() == Form.this
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8448.java