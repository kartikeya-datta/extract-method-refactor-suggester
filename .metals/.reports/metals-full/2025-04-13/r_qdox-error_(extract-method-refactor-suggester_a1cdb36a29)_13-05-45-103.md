error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7662.java
text:
```scala
i@@f (isEndOfFile(lastChar) || (!isDelimiter(lastChar) && isEndOfFile(c))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7662.java