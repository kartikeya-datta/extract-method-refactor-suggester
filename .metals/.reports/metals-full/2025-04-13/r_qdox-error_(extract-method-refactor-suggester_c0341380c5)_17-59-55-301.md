error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3900.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3900.java
text:
```scala
public R@@eportList(final int size)

/*
 * $Id: ReportList.java 5394 2006-04-16 13:36:52 +0000 (Sun, 16 Apr 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3900.java