error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5634.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5634.java
text:
```scala
final S@@tring specification = Strings.replaceHtmlEscapeNumber(valueParser.getSpecification());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5634.java