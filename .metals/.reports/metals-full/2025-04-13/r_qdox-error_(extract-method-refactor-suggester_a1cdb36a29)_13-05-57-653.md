error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1798.java
text:
```scala
r@@eturn "BrokerAvailabilityEvent[available=" + this.brokerAvailable + ", " + getSource() + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1798.java