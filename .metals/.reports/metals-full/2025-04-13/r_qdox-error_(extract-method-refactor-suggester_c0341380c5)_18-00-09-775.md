error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6421.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6421.java
text:
```scala
m@@asterOperation(request, clusterService.state(), listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6421.java