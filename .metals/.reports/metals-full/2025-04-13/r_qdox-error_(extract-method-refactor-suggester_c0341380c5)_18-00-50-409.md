error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9829.java
text:
```scala
i@@f (entries.containsKey(vPath)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9829.java