error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11596.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11596.java
text:
```scala
final C@@SVParser parser = CSVParser.parse(url, Charset.forName("UTF-8"), CSVFormat.EXCEL.withHeader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11596.java