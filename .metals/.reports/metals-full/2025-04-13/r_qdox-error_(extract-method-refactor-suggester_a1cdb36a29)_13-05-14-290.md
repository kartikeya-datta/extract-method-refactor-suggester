error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4031.java
text:
```scala
i@@njector.getInstance(MapperService.class).merge("person", mapping, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4031.java