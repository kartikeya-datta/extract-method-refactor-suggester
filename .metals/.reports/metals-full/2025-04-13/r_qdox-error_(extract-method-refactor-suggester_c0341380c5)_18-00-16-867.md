error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6551.java
text:
```scala
l@@ogger.debug("Using [" + type() + "] filter cache with readerCleanerSchedule [{}]", readerCleanerSchedule);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6551.java