error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5663.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5663.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5663.java
text:
```scala
s@@uper("filter", "FilterOptions", mediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5663.java