error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13744.java
text:
```scala
i@@f (t.indexOf('*') ==0){// e.g. *.apache.org // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13744.java