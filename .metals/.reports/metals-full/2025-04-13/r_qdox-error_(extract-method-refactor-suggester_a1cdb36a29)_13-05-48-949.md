error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1849.java
text:
```scala
o@@utput.append(this.name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1849.java