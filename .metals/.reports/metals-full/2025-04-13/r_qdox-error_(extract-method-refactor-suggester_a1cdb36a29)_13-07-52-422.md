error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3926.java
text:
```scala
b@@uilder.rawField("_source", XContentFactory.contentBuilder(type).startObject().field("s_field", "s_value").endObject().copiedBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3926.java