error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13473.java
text:
```scala
v@@isitor.visitDeleteCommand(getObject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13473.java