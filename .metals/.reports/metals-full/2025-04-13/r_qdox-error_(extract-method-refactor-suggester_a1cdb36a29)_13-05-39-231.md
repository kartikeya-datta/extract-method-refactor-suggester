error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1883.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1883.java
text:
```scala
public static final S@@tring NAME = "indices:data/read/mtv";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1883.java