error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17525.java
text:
```scala
i@@f (part.matches("<([a-zA-Z]+:)?[a-zA-Z]*>.*"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17525.java