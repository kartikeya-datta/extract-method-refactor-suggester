error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/493.java
text:
```scala
O@@S.gtk_paint_focus(style, data.drawable, OS.GTK_STATE_NORMAL, null, data.device.shellHandle, new byte[1], x, y, width, height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/493.java