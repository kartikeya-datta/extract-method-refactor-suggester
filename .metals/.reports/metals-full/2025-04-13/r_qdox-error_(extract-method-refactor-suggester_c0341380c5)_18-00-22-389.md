error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9791.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9791.java
text:
```scala
+ g@@etReporter().getId() + ", level = " + getLevelAsString() + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9791.java