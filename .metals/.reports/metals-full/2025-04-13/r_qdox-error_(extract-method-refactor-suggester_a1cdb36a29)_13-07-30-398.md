error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9849.java
text:
```scala
D@@eployerChainAddHandler.addDeploymentProcessor(SERVER_NAME, Phase.STRUCTURE, Phase.STRUCTURE_JBOSS_DEPLOYMENT_STRUCTURE, new DeploymentStructureDescriptorParser());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9849.java