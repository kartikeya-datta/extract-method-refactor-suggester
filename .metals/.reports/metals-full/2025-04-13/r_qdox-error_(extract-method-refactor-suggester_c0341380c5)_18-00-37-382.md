error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10024.java
text:
```scala
n@@ew InfoStep(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10024.java