error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1616.java
text:
```scala
i@@f (cu == null || cu.isPrimary()) return this;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1616.java