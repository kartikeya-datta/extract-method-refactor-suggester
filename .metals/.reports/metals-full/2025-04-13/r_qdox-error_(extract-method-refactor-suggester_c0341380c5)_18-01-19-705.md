error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/681.java
text:
```scala
r@@eturn this.binding.isInterface() && !this.binding.isTypeVariable() && !this.binding.isWildcard();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/681.java