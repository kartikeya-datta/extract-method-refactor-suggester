error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3491.java
text:
```scala
s@@b.append((char)c);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3491.java