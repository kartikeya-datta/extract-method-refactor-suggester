error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3630.java
text:
```scala
t@@extLineStart = Util.getLineNumber(this.scanner.currentPosition-1, this.lineEnds, textLineStart, this.maxLines);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3630.java