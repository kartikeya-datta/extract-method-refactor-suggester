error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4511.java
text:
```scala
i@@f (str.isKindOfClass (OS.class_NSAttributedString)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4511.java