error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11664.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11664.java
text:
```scala
final P@@atchingResult result = runner.rollback(patchId, ContentVerificationPolicy.STRICT, false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11664.java