error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9303.java
text:
```scala
a@@ctionsBuilder.put((Action) action, new TransportActionNodeProxy(settings, action, transportService));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9303.java