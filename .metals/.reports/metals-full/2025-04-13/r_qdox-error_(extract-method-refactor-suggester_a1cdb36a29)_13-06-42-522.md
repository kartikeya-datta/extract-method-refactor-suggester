error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15064.java
text:
```scala
c@@omponent.setRequiresFullRender(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15064.java