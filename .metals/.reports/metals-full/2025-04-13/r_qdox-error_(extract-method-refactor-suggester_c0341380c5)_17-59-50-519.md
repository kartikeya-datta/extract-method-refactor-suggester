error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1899.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1899.java
text:
```scala
a@@dd(new SignInPanel("signInPanel")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1899.java