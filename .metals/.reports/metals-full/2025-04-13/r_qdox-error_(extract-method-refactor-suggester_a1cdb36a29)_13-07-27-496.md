error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12508.java
text:
```scala
n@@ew DurationFormatUtils.Token(DurationFormatUtils.S, 3),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12508.java