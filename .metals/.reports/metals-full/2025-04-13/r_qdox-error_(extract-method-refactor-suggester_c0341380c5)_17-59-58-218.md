error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4414.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4414.java
text:
```scala
I@@QueryResult[] results = index.queryInDocumentNames(this.folderPath); // all file names belonging to the folder or its subfolders
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4414.java