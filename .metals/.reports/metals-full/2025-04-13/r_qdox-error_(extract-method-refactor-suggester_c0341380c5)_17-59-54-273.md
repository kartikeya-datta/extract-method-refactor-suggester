error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2719.java
text:
```scala
v@@aluesLoaded = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2719.java