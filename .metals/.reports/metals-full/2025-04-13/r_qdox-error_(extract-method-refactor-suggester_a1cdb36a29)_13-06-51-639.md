error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6886.java
text:
```scala
i@@nitializationScope.problemReporter().typeMismatchError(initializationType, fieldType, this.initialization);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6886.java