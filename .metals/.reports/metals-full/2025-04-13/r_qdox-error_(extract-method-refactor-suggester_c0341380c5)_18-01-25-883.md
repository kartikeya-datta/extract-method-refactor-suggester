error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14564.java
text:
```scala
o@@rg.jboss.as.host.controller.SystemExiter.initialize(new ServerManagerNoopExiter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14564.java