error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1146.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1146.java
text:
```scala
public S@@tring getDisplayValue(T object);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1146.java