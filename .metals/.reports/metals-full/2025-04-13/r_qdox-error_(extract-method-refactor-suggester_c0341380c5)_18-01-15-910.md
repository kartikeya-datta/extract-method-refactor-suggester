error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8432.java
text:
```scala
n@@ew IndexSettingsModule(new Index("test"), ImmutableSettings.Builder.EMPTY_SETTINGS),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8432.java