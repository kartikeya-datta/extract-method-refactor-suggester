error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6584.java
text:
```scala
r@@eturn doesNotRequireCloseTag.get(name.toLowerCase()) == null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6584.java