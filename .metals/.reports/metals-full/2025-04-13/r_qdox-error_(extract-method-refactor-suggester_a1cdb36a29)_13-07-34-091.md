error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6379.java
text:
```scala
i@@f (this.currentElement == null) this.lastJavadocEnd = commentSourceEnd;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6379.java