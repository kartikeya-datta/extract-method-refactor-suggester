error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15613.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15613.java
text:
```scala
final P@@age page = getPage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15613.java