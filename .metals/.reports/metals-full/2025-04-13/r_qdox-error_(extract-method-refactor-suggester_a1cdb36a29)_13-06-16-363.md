error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/835.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/835.java
text:
```scala
private final b@@oolean initialized;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/835.java