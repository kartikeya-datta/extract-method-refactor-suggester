error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/438.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/438.java
text:
```scala
+ C@@lasses.simpleName(component.getClass()) + "@" + component.hashCode() + ")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/438.java