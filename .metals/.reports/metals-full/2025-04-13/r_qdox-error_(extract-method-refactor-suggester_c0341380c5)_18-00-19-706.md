error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8725.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[82,2]

error in qdox parser
file content:
```java
offset: 2233
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8725.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8725.java