error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5391.java
text:
```scala
l@@ogger.warn("Received a join request for an existing node [{}]", node);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5391.java