error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7080.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7080.java
text:
```scala
O@@S.UIElement_IsEnabled (handle, enabled);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7080.java