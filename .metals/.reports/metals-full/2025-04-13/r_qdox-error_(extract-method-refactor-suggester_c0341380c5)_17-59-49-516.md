error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11682.java
text:
```scala
p@@ublic class AjaxBehaviorEnabledPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11682.java