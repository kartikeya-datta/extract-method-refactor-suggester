error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/306.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/306.java
text:
```scala
public static i@@nt calculateMinShouldMatch(int optionalClauseCount, String spec) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/306.java