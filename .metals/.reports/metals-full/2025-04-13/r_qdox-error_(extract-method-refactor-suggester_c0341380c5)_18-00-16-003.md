error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13547.java
text:
```scala
l@@ong cksum = 17L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13547.java