error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2570.java
text:
```scala
S@@WT.error (SWT.ERROR_NO_HANDLES, null, " [gtk_init_check() failed]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2570.java