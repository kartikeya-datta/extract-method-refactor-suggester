error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17088.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17088.java
text:
```scala
S@@tring txt = Application.get().getMarkupSettings().getLocalizer().getString("ServerAndClientTimeFilter.statustext", null, Model.valueOf(map), Session.get().getLocale(), Session.get().getStyle(), defaultValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17088.java