error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2311.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2311.java
text:
```scala
public v@@oid handleRequest(RestRequest request, RestChannel channel, Client client) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2311.java