error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3521.java
text:
```scala
c@@assandraServer.logout();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3521.java