error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6400.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6400.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6400.java
text:
```scala
final l@@ong defaultAccessTimeout = EJB3SubsystemRootResourceDefinition.DEFAULT_SINGLETON_BEAN_ACCESS_TIMEOUT.resolveModelAttribute(context, model).asLong();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6400.java