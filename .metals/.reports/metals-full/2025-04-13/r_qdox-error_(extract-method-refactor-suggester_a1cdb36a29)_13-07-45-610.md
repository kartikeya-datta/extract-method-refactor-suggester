error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3546.java
text:
```scala
r@@eceiver.checkNullStatus(currentScope, flowContext, flowInfo, FlowInfo.NON_NULL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3546.java