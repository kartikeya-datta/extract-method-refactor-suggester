error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/291.java
text:
```scala
I@@Container folder = (IContainer) pkg.getResource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/291.java