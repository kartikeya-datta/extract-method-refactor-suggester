error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1702.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1702.java
text:
```scala
i@@f( p != null && p.endsWith( "/" ) && p.length() > 1 )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1702.java