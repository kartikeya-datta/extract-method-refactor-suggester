error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9590.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9590.java
text:
```scala
t@@hrow MESSAGES.jaxRpcNotSupported();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9590.java