error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8783.java
text:
```scala
p@@rocessorTarget.addDeploymentProcessor(MessagingExtension.SUBSYSTEM_NAME, Phase.POST_MODULE, Phase.POST_MODULE_JMS_DEFINITION_DEPLOYMENT, new MessagingJMSDefinitionDeploymentProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8783.java