error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13869.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13869.java
text:
```scala
public static final S@@tring OPERATION_NAME = "remove";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13869.java