error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3513.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3513.java
text:
```scala
public static final K@@eyStroke FUNCTIONS         = KeyStroke.getKeyStroke(KeyEvent.VK_F1, CONTROL_MASK | InputEvent.SHIFT_DOWN_MASK);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3513.java