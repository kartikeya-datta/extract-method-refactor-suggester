error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13493.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13493.java
text:
```scala
private static final S@@tring TEST2_CONTENT = "<?xml version = '1.0'?>\r\n<!DOCTYPE"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13493.java