error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8771.java
text:
```scala
P@@rojectiveTextureTest.class, Pong.class, ProjectTest.class, RemoteTest.class, RotationTest.class, DragAndDropTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8771.java