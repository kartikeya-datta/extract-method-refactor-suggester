error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8406.java
text:
```scala
r@@eturn scheme != null && scheme.equals("https");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8406.java