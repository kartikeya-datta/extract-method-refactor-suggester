error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3350.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3350.java
text:
```scala
R@@esult res = new StreamResult(tofile);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3350.java