error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12831.java
text:
```scala
t@@hrow new NamingException("Managed bean does not exist with name: " + managedBeanName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12831.java