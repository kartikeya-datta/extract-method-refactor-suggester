error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4057.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4057.java
text:
```scala
i@@f (result.exists()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4057.java