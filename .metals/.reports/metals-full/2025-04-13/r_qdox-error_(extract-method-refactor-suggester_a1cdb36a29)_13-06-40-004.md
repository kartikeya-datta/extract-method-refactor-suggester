error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7556.java
text:
```scala
s@@cript = AbstractDefaultAjaxBehavior.throttleScript(script, ts.getId(), ts.getDelay());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7556.java