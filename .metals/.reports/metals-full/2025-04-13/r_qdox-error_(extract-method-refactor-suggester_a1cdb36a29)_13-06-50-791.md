error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7248.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7248.java
text:
```scala
private final L@@ist<CustomAttributesProvider> customAttributesProviders = new CopyOnWriteArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7248.java