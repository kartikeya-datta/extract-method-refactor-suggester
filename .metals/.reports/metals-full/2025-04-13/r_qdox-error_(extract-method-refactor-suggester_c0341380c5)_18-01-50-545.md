error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1612.java
text:
```scala
c@@ontainer.removeDeployment(deploymentInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1612.java