error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9520.java
text:
```scala
a@@dd(new AjaxLink<Void>("ajaxRefresh")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9520.java