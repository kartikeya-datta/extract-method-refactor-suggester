error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2923.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2923.java
text:
```scala
e@@xtends BaseActivity
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2923.java