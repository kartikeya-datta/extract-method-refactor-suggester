error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16794.java
text:
```scala
i@@f ((style & SWT.WRAP) != 0) OS.gtk_text_view_set_wrap_mode (handle, OS.GTK_WRAP_WORD_CHAR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16794.java