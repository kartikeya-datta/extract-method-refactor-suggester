error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7850.java
text:
```scala
i@@f (OS.SetKeyboardFocus (window, handle, (short) focusPart ()) == OS.noErr) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7850.java