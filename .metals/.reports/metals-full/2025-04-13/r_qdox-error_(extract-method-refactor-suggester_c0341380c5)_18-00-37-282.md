error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2913.java
text:
```scala
n@@ew SimpleListAttributeDefinition.Builder(Constants.ALIAS,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2913.java