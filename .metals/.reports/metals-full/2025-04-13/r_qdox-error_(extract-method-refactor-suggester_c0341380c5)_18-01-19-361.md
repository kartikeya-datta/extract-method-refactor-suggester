error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6625.java
text:
```scala
D@@ocumentMapper docMapper = indexService.mapperService().documentMapper(request.type());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6625.java