error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1762.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1762.java
text:
```scala
public static final S@@tring version = "0.10.0";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1762.java