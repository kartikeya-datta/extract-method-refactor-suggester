error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10380.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10380.java
text:
```scala
final M@@BeanServerConnection mbeanServer = JMXConnectorFactory.connect(new JMXServiceURL("service:jmx:remoting-jmx://localhost:9999")).getMBeanServerConnection();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10380.java