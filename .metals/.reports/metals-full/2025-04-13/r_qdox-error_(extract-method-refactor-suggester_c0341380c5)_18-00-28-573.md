error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2351.java
text:
```scala
i@@f( key.equalsIgnoreCase(EJB_CONTEXT_KEY) == true )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2351.java