error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12438.java
...
```java
offset: 701
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12438.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12438.java