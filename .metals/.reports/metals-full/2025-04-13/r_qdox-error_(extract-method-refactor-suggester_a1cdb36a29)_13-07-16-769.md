error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10336.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10336.java
text:
```scala
public i@@nt translate(final CharSequence input, final int index, final Writer out) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10336.java