error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/601.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/601.java
text:
```scala
S@@tring urlPrefix = getPage().urlFor("");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/601.java