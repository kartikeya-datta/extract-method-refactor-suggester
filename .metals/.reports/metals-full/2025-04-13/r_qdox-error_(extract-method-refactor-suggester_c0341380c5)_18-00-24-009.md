error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1418.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1418.java
text:
```scala
G@@etResult getResult = indexShard.getService().get(result, request.id(), request.type(), request.fields(), request.fetchSourceContext(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1418.java