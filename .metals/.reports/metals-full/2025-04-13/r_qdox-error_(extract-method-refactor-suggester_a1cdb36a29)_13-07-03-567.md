error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15303.java
text:
```scala
u@@rlStr = htmlEscape(urlStr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15303.java