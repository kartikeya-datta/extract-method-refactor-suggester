error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1698.java
text:
```scala
r@@eturn getFullyQualifiedParameterizedName(getFullyQualifiedName('.'), this.uniqueKey);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1698.java