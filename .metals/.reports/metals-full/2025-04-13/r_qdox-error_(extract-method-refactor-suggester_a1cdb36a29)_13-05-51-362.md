error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18202.java
text:
```scala
i@@f (property [0] == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18202.java