error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/757.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/757.java
text:
```scala
S@@hardRouting shardRouting = shardIterator.nextOrNull();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/757.java