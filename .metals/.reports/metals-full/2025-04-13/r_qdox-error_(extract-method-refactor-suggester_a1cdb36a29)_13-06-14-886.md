error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7870.java
text:
```scala
M@@ap<String, String> map = new HashMap<String, String>(4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7870.java