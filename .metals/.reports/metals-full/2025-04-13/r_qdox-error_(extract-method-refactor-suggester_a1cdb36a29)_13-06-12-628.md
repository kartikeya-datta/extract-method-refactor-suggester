error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10219.java
text:
```scala
i@@f (resultData.length == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10219.java