error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3897.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3897.java
text:
```scala
L@@OGGER.error("IOException occured.", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3897.java