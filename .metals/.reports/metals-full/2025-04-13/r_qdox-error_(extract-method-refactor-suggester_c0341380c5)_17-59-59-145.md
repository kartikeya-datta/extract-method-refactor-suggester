error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2058.java
text:
```scala
v@@oid drawWidget (int /*long*/ id, NSGraphicsContext context, NSRect rect) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2058.java