error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10215.java
...
```java
offset: 611
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10215.java
text:
```scala
 ...
 ******************************************************************************/
p@@ackage org.eclipse.ecf.datashare.events;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10215.java