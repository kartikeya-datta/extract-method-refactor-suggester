error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1628.java
text:
```scala
I@@ResponseResolver<Row> readResponseResolver = new ReadResponseResolver(table_, replicas_.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1628.java