error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8224.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8224.java
text:
```scala
public U@@UID readObject(ObjectInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8224.java