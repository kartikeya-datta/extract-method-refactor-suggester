error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2736.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2736.java
text:
```scala
public I@@Renderable createCell(TreeTable treeTable, TreeNode node, int level) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2736.java