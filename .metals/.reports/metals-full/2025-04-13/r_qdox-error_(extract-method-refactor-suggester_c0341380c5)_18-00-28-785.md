error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7693.java
text:
```scala
e@@jbJar.addClasses(EJBResource.class, EjbInterceptor.class, EjbInterface.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7693.java