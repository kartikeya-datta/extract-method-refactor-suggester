error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7393.java
text:
```scala
M@@ode initialMode = (policy == Activation.LAZY ? Mode.ON_DEMAND : Mode.PASSIVE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7393.java