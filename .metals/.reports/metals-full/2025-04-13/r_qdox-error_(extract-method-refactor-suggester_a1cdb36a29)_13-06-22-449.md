error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5577.java
text:
```scala
L@@abelDrawableSpan.setText(labelsArea, labels);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5577.java