error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2447.java
text:
```scala
r@@otation.setFromAxes(tmp.x, tmp2.x, dir.x, tmp.y, tmp2.y, dir.y, tmp.z, tmp2.z, dir.z);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2447.java