error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7203.java
text:
```scala
r@@eturn (Serializable)key.get(metaData);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7203.java