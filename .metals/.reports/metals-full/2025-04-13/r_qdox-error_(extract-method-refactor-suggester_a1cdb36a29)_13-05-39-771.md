error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10048.java
text:
```scala
S@@tring document = tester.getLastResponse().getTextResponse().toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10048.java