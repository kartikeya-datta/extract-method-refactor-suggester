error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13542.java
text:
```scala
r@@eturn new NewModelControllerClientOperationHandler(executor, modelController);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13542.java