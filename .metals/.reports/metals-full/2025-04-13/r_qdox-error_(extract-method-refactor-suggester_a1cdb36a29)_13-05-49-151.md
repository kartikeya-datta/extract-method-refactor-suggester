error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3949.java
text:
```scala
S@@tring bodyOnLoadUpdateScript = "Wicket.Event.add(window, \"load\", function() { " + updateScript + ";});";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3949.java