error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13894.java
text:
```scala
a@@spect MultiExec extends Multi { declare dominates: MultiExec, MultiCall;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13894.java