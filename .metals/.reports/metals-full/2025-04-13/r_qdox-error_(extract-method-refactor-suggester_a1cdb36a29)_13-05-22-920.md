error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9813.java
text:
```scala
r@@eturn map.get(ref);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9813.java