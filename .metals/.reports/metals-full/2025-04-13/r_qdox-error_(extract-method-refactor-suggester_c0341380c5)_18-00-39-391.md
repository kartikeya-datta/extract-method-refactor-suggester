error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6526.java
text:
```scala
p@@ublic abstract class Component<T> implements Serializable, IConverterLocator
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6526.java