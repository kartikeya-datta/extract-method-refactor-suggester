error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2573.java
text:
```scala
d@@nsMXRecord(dnsName _name, short _dclass, int _ttl, MyStringTokenizer st)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2573.java