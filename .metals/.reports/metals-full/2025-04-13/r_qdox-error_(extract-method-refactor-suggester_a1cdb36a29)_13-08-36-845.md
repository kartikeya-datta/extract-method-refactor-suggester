error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3833.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3833.java
text:
```scala
public D@@ocument rootDoc() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3833.java