error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1219.java
text:
```scala
O@@S.memmove(data, buffer, stride * height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1219.java