error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5575.java
text:
```scala
r@@eturn "subject_contains";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5575.java