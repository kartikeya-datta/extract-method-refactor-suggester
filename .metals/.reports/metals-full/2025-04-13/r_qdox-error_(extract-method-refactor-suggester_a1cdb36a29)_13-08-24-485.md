error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6823.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6823.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6823.java
text:
```scala
s@@uper(names, 1, fieldType, null, null, null, postingsProvider, docValuesProvider, null, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6823.java