error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2330.java
text:
```scala
r@@eturn cfs.table.name;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2330.java