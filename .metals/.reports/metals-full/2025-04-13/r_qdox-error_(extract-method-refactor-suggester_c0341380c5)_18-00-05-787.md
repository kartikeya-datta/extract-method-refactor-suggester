error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10022.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10022.java
text:
```scala
public I@@D createInstance(Object[] parameters) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10022.java