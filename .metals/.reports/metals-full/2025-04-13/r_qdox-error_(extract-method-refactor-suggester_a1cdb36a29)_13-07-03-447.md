error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1217.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1217.java
text:
```scala
static final T@@estRuleSetupAndRestoreClassEnv classEnvRule;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1217.java