error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7888.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7888.java
text:
```scala
r@@eturn this.expressionType = scope.getJavaLangClass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7888.java