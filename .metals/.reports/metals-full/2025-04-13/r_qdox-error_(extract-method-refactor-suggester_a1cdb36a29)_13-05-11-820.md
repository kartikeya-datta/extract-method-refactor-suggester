error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2038.java
text:
```scala
M@@ailInterface.mailCheckingManager.checkAll();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2038.java