error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1550.java
text:
```scala
i@@nput = AndroidInputFactory.newAndroidInput(this, this.getService(), null, config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1550.java