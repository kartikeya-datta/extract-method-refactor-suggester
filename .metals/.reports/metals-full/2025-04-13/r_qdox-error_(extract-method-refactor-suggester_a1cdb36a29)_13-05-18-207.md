error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6505.java
text:
```scala
i@@f (velocityValue.active && velocityValue.active) updateFlags |= UPDATE_VELOCITY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6505.java