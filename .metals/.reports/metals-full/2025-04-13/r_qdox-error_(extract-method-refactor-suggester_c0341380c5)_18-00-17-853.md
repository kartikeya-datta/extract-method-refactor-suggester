error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3422.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3422.java
text:
```scala
public static final P@@ropagatingCorrector INSTANCE = new PropagatingCorrector();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3422.java