error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15811.java
text:
```scala
r@@eturn application.getRequestLogger();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15811.java