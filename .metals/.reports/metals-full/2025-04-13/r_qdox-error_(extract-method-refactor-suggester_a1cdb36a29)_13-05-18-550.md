error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12256.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12256.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12256.java
text:
```scala
r@@eturn Boolean.toString(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12256.java