error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3864.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3864.java
text:
```scala
public W@@icketExampleHeader(final MarkupContainer parent, final String id, final String exampleTitle)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3864.java