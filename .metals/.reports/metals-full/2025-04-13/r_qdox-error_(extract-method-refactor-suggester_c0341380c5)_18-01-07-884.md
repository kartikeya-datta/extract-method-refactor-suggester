error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3316.java
text:
```scala
l@@ogger.warn("setting live ratio to maximum of 64 instead of {}", newRatio);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3316.java