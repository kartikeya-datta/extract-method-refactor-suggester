error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6035.java
text:
```scala
b@@uffer.append("style=\"width: 0px; height: 0px; position: absolute; left:-100px;\"");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6035.java