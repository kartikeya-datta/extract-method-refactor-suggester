error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1671.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1671.java
text:
```scala
0)@@;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1671.java