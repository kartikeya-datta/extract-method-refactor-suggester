error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1180.java
text:
```scala
i@@f (text != null && text.length() != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1180.java