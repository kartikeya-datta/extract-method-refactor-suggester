error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2575.java
text:
```scala
s@@tore.setDefault(IPreferenceConstants.RUN_IN_BACKGROUND,false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2575.java