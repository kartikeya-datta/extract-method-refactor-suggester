error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12418.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12418.java
text:
```scala
e@@vent.height = Math.max(event.height, extent.y + 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12418.java