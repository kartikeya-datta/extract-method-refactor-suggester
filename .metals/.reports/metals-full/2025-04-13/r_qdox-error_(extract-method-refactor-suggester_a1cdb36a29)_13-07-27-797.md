error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1526.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1526.java
text:
```scala
public I@@njectedValue<JMSServerManager> getJmsServer() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1526.java