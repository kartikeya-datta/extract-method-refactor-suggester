error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18015.java
text:
```scala
t@@hrow new ContainerCreateException(Messages.RPC_COULD_NOT_CREATE_CONTAINER, e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18015.java