error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7360.java
text:
```scala
P@@ointValuePair optimum =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7360.java