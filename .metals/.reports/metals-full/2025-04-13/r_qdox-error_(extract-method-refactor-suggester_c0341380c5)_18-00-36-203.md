error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8293.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8293.java
text:
```scala
public A@@bstractProperty clone() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8293.java