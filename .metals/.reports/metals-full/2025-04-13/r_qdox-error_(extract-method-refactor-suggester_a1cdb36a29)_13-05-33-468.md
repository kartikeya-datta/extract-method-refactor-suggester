error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1618.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1618.java
text:
```scala
final M@@ap<ServiceController<?>, String> currentFailedControllers = new HashMap<ServiceController<?>, String>(failedControllers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1618.java