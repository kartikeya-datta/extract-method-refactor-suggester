error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13763.java
text:
```scala
i@@f (dialogStyle == OS.XmDIALOG_MODELESS) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13763.java