error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10343.java
text:
```scala
J@@oda.forPattern("yyyy/MM/dd HH:mm:ss||yyyy/MM/dd")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10343.java