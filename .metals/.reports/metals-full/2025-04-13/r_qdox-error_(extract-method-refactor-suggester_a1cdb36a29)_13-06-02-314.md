error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2348.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2348.java
text:
```scala
O@@S.memmove (fsRef, dataPtr, actualSize [0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2348.java