error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/598.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/598.java
text:
```scala
public final v@@oid after() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/598.java