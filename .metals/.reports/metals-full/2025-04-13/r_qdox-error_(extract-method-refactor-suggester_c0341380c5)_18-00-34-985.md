error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8362.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8362.java
text:
```scala
s@@tep.get(CONTENT).get(0).get(INPUT_STREAM_INDEX).set(stream++);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8362.java