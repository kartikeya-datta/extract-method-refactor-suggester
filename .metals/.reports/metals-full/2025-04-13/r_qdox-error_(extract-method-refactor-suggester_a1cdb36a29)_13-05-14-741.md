error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5808.java
text:
```scala
i@@f (meshPart.primitiveType != com.badlogic.gdx.graphics.GL20.GL_TRIANGLES)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5808.java