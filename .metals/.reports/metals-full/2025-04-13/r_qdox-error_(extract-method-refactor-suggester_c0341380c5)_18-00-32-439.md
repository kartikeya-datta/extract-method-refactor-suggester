error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/747.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/747.java
text:
```scala
private static final S@@tring Base64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/747.java