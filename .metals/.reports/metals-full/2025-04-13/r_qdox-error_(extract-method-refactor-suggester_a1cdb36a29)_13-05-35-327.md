error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4739.java
text:
```scala
d@@efaultOptions.put(CORE_ENCODING, ""/*ResourcesPlugin.getEncoding()*/); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4739.java