error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9261.java
text:
```scala
s@@earchContext.addRewrite(childQuery);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9261.java