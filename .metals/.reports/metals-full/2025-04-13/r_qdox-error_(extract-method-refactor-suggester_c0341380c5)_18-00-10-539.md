error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6708.java
text:
```scala
c@@urrentLights = maxLightsCount < 0 ? null : new Light[maxLightsCount];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6708.java