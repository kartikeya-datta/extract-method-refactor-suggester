error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10361.java
text:
```scala
r@@eturn new SecondLevelCacheSessionStore(this, new FilePageStore());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10361.java