error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9763.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9763.java
text:
```scala
private static final S@@tring BODY_ID = "_body";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9763.java