error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18312.java
text:
```scala
S@@tring varName = ((CompoundVariable) values[0]).execute().trim();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18312.java