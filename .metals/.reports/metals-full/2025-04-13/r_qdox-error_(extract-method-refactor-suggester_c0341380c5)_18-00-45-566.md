error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9903.java
text:
```scala
i@@nitialize(new HdfsBlobStore(settings, fileSystem, hPath), clusterName, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9903.java