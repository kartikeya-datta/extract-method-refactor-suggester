error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7541.java
text:
```scala
s@@etExpression(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7541.java