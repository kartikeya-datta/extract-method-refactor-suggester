error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3777.java
text:
```scala
s@@etToolBarText(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3777.java