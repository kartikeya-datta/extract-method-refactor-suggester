error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7086.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7086.java
text:
```scala
c@@lusterService.submitStateUpdateTask("delete-index [" + request.index + "]", Priority.URGENT, new ClusterStateUpdateTask() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7086.java