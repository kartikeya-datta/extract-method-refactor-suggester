error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/141.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/141.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/141.java
text:
```scala
A@@ccPrivate | AccStatic | AccSynthetic,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/141.java