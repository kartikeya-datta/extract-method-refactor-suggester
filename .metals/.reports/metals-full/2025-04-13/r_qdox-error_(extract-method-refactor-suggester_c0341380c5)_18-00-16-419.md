error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15020.java
text:
```scala
i@@mplements ArchiveEntry {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15020.java