error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3839.java
text:
```scala
m@@anagementClient = new ManagementClient(modelControllerClient, config.getManagementAddress().getHostAddress());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3839.java