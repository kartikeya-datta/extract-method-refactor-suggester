error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3435.java
text:
```scala
k@@eyBindingService = new KeyBindingService(getActionService(), getContextService());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3435.java