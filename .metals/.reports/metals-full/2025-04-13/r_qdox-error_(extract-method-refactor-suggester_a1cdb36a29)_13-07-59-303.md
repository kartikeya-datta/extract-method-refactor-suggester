error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/999.java
text:
```scala
b@@atchBuilder.addService(MBeanServerService.SERVICE_NAME, new MBeanServerService())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/999.java