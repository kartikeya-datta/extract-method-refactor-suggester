error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1598.java
text:
```scala
t@@hrow new IOException(e != null ? e.getMessage() : pae.getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1598.java