error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7865.java
...
```java
offset: 1125
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7865.java
text:
```scala
 ...
 *
 */
p@@ackage org.apache.jmeter.util;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7865.java