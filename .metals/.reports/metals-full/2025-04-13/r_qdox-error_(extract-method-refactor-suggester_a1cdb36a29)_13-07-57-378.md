error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5257.java
text:
```scala
t@@his.paths.add(documentPath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5257.java