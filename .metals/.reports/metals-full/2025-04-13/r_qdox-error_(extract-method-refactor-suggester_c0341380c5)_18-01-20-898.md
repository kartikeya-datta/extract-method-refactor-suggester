error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1389.java
text:
```scala
d@@estroyJoint(body.getJointList().get(i).joint);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1389.java