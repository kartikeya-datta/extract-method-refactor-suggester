error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10160.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[247,2]

error in qdox parser
file content:
```java
offset: 6235
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10160.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10160.java