error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4343.java
text:
```scala
i@@f (allowPassByReference && (target.isPrimitive() || target.isAssignableFrom(object.getClass()))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4343.java