error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7801.java
text:
```scala
i@@f (termsEnum.seekExact(uidSpare)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7801.java