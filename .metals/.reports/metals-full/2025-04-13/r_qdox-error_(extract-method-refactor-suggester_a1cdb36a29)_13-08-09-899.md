error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8354.java
text:
```scala
e@@lse if (attributeConstant.equals(FigureAttributeConstant.ARROW_MODE)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8354.java