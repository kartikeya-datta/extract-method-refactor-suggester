error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11935.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11935.java
text:
```scala
protected I@@ManageablePage findPage(final int id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11935.java