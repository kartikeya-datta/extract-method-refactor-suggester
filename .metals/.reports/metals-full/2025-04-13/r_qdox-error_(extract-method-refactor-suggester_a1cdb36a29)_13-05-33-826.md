error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6066.java
text:
```scala
i@@f (submittedValue == null || submittedValue.length() == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6066.java