error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13937.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13937.java
text:
```scala
C@@lientPropertiesBean propertiesBean = getModelObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13937.java