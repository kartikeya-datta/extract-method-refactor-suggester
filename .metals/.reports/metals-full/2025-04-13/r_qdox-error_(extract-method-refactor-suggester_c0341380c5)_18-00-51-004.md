error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6702.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6702.java
text:
```scala
b@@uilder.startObject(indexDeleteByQueryResponse.index(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6702.java