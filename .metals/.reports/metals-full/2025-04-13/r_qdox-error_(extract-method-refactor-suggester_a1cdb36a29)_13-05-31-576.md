error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2741.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2741.java
text:
```scala
public C@@ategory [] getCategories();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2741.java