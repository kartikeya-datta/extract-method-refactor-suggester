error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2597.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2597.java
text:
```scala
protected L@@ist<User> run(Account account) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2597.java