error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5402.java
text:
```scala
r@@eturn this.resolvedType = lhsType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5402.java