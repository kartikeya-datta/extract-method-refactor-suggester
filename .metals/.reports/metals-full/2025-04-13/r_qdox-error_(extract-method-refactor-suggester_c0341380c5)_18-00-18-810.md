error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4239.java
text:
```scala
i@@nt /*long*/ accessibilityAttributeNames(int /*long*/ id, int /*long*/ sel) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4239.java