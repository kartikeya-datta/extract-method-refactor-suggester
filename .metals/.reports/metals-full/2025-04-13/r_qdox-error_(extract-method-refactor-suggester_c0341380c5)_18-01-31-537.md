error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13431.java
text:
```scala
r@@esourceRegistration.registerOperationHandler(WhoAmIOperation.DEFINITION, WhoAmIOperation.createOperation(authorizer), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13431.java