error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5329.java
text:
```scala
s@@uper(WorkbenchMessages.ImportExportAction_text);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5329.java