error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1658.java
text:
```scala
r@@eturn keyBinding.getKeySequence().format();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1658.java