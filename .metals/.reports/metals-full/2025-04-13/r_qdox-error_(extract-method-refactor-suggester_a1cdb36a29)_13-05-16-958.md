error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/150.java
text:
```scala
r@@eturn "Unresolved type " + ((compoundName != null) ? CharOperation.toString(compoundName) : "UNNAMED"); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/150.java