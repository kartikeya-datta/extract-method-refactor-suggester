error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7613.java
text:
```scala
t@@ransform.setToRotation(new Vector3(1, 0, 1).nor(), rotAngle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7613.java