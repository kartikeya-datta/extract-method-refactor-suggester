error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1629.java
text:
```scala
i@@f (stroked && (data.lineWidth == 0 || (data.lineWidth % 2) == 1)) offset = 0.5;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1629.java