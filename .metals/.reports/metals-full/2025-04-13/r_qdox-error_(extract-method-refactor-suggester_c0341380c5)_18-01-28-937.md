error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7046.java
text:
```scala
c@@losestMatch.original().modifiers |= AccPrivateUsed;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7046.java