error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10513.java
text:
```scala
s@@uper (parent, checkStyle (style));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10513.java