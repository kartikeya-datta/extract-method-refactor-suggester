error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9379.java
text:
```scala
r@@ec = Record.newRecord(name, type, dclass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9379.java