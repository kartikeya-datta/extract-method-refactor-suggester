error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16378.java
text:
```scala
i@@f (isVisible() && isRenderAllowed())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16378.java