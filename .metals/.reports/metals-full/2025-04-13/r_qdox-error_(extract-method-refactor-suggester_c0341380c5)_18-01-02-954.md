error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15289.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15289.java
text:
```scala
static final S@@tring OPERATION_NAME = "add-jvm-option";
...
final class JVMOptionAddHandler implements OperationStepHandler, DescriptionProvider {
    ...
    static final String OPERATION_NAME = JvmAttributes.ADD_JVM_OPTION;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15289.java