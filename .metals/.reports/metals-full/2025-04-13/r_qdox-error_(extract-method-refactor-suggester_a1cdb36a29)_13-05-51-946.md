error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2882.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2882.java
text:
```scala
 c@@ == '|' || c == '&' || c == '/') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2882.java