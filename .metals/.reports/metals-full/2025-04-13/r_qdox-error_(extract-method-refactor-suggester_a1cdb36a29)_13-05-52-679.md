error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7632.java
text:
```scala
e@@ntry = new InternalFullHistogramFacet.FullEntry(bucket, 0, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7632.java