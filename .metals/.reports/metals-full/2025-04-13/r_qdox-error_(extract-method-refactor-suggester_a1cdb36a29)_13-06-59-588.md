error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5290.java
...
```java
offset: 692
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5290.java
text:
```scala
...
p@@ackage com.badlogic.gdx.imagepacker;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5290.java