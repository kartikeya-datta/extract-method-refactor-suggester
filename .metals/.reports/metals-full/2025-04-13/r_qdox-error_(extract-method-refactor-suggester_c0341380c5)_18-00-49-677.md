error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1884.java
text:
```scala
a@@dd(new Label("message", "Hello world! Test: äöü"));
...
public class Home extends WicketExamplePage
{
	...
	{
		add(new Label(this,"message", "Hello world! Test: äöü"));
	}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1884.java