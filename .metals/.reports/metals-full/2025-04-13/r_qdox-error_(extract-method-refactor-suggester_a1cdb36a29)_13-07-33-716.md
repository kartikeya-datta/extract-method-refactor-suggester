error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10379.java
text:
```scala
i@@f (!MapperService.DEFAULT_MAPPING.equals(mappingType) && mappingType.charAt(0) == '_') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10379.java