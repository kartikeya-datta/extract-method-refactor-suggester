error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16740.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16740.java
text:
```scala
H@@eader responseHeader = httpMethod.getResponseHeader(HEADER_CONTENT_ENCODING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16740.java