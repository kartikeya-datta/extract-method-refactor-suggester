error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4598.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4598.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4598.java
text:
```scala
i@@f (((ReferenceBinding)enclosingInstances[i].type).findSuperTypeWithSameErasure(targetEnclosingType) != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4598.java