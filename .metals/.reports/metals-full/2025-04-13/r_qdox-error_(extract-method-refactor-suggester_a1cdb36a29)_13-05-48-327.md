error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12724.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12724.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12724.java
text:
```scala
private static final i@@nt recordSize = DumpArchiveConstants.TP_SIZE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12724.java