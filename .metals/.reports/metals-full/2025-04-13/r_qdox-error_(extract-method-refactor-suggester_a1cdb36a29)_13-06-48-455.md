error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7527.java
text:
```scala
F@@ilter filter = ((NumberFieldMapper) mapper).rangeFilter(parseContext.indexCache().fieldData(), from, to, includeLower, includeUpper, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7527.java