error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12675.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12675.java
text:
```scala
public S@@ession newSession(Request request)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12675.java