error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2967.java
text:
```scala
i@@f ((style & SWT.VIRTUAL) == 0) return items [index];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2967.java