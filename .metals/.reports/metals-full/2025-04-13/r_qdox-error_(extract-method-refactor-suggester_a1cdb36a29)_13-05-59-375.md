error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9012.java
text:
```scala
b@@uildEnterpriseBeanMetaData(wsEjbsMD, jbossEjbMD, jbossWebservicesMD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9012.java