error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12235.java
text:
```scala
s@@uper(ModelDescriptionConstants.INCLUDES, Element.INCLUDE.getLocalName(), true, 0, Integer.MAX_VALUE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12235.java