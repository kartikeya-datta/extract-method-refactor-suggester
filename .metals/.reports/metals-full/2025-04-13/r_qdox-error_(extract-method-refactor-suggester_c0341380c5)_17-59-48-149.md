error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2148.java
text:
```scala
M@@yStringTokenizer st) throws IOException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2148.java