error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/411.java
text:
```scala
b@@ytes[length++] = b;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/411.java