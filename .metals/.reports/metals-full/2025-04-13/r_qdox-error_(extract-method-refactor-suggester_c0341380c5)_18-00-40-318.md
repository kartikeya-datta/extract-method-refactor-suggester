error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10479.java
text:
```scala
r@@esult.setBytes(content.getBytes().length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10479.java