error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3149.java
text:
```scala
c@@reateIndexRequest.source(request.content());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3149.java