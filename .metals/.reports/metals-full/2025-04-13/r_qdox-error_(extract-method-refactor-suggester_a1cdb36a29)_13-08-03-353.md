error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5773.java
text:
```scala
E@@ngine.Searcher searcher = indexShard.acquireSearcher("indices_status");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5773.java