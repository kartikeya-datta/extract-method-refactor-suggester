error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1050.java
text:
```scala
C@@DATA cdata = (CDATA) e7.getContent().get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1050.java