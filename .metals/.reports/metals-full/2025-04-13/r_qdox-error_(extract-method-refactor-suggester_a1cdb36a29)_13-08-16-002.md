error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4040.java
text:
```scala
r@@eader.readWorkingSets(Platform.getExtensionRegistry(), this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4040.java