error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9966.java
text:
```scala
r@@eturn getRequestCycle().urlFor(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9966.java