error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14687.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14687.java
text:
```scala
final private A@@tomicReference<Serializable> sessionIdReference;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14687.java