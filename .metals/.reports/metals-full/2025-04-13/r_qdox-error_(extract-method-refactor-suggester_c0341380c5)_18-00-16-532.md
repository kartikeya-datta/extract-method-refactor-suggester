error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7565.java
text:
```scala
i@@f (System.getProperties().containsKey(TEST_TRANSFORMERS_EAP)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7565.java