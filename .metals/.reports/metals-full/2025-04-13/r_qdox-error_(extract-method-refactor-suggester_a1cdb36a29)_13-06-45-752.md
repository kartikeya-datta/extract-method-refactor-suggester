error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9493.java
text:
```scala
l@@ogoSprite.flip(false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9493.java