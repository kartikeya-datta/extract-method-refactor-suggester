error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7789.java
text:
```scala
M@@odelNode toValidate = validateOpsFilter.adjustForValidation(op);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7789.java