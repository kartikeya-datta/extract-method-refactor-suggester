error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15200.java
text:
```scala
t@@hrow new IllegalArgumentException("Application cannot be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15200.java