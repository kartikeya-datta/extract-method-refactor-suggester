error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3811.java
text:
```scala
t@@his.resolved = (annotationType instanceof ResolvedTypeX);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3811.java