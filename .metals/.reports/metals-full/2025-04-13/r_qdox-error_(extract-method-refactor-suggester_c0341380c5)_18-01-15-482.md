error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1716.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1716.java
text:
```scala
protected A@@ctivity activity;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1716.java