error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6986.java
text:
```scala
m@@ain.bold(repoName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6986.java