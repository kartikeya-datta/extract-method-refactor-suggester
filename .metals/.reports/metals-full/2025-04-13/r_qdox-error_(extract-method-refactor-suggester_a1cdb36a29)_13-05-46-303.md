error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6819.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6819.java
text:
```scala
o@@wner.setUseTimestamp(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6819.java