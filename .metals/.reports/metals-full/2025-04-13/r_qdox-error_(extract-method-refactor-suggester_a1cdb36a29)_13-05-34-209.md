error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3385.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3385.java
text:
```scala
public I@@RequestCycleProcessor getRequestCycleProcessor()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3385.java