error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8742.java
text:
```scala
 ...
 */
package org.jboss.as.test.embedded.demos.rar;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8742.java