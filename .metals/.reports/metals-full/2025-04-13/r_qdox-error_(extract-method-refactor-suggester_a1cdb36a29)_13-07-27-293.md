error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14089.java
...
```java
offset: 1133
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14089.java
text:
```scala
...
p@@ackage org.jboss.as.test.clustering.extended.ejb2.stateful.remote.failover;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14089.java