error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2634.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2634.java
text:
```scala
protected static final S@@tring TYPE = "category";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2634.java