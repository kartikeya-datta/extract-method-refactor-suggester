error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1683.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1683.java
text:
```scala
private static final i@@nt MIN_DIMENSION_TO_RECUR = 100;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1683.java