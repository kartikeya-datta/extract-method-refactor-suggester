error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1624.java
text:
```scala
C@@ocoa.objc_msgSend (handle, Cocoa.S_release);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1624.java