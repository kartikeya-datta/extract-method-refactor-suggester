error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10868.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10868.java
text:
```scala
public v@@oid draw(GC gc, int x, int y, int selectionStart, int selectionEnd, Color selectionForeground, Color selectionBackground, int flags) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10868.java