error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2484.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2484.java
text:
```scala
i@@f (text == null) text = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2484.java