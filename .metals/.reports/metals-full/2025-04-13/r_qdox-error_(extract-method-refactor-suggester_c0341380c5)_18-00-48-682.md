error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8560.java
...
```java
offset: 780
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8560.java
text:
```scala
...
//
//All Rights Reserved.
p@@ackage org.columba.core.command;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8560.java