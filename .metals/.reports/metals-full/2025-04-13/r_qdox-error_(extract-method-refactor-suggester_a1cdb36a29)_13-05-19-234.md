error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8895.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8895.java
text:
```scala
static final b@@oolean DEVELOPMENT_MODE = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8895.java