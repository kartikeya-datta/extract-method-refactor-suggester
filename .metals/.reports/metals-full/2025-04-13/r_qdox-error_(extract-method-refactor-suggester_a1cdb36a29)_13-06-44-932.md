error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6498.java
text:
```scala
t@@his.publishClusterState = new PublishClusterStateAction(settings, transportService, this, new NewClusterStateListener(), discoverySettings, clusterName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6498.java