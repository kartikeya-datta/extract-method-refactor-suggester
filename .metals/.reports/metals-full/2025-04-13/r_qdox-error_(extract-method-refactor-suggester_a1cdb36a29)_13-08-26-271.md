error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5006.java
text:
```scala
B@@roadcastOperationThreading operationThreading = BroadcastOperationThreading.fromString(request.param("operationThreading"), BroadcastOperationThreading.THREAD_PER_SHARD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5006.java