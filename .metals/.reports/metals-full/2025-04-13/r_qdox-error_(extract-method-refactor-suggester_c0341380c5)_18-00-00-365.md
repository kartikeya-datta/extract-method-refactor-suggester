error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5448.java
text:
```scala
i@@f (binding.isInterface()) return getResolvedTypeX().getWorld().getCoreType(TypeX.OBJECT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5448.java