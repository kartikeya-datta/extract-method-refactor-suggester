error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9276.java
text:
```scala
i@@f (id == view.id || (view instanceof NSControl && ((NSControl)view).cell() != null && ((NSControl)view).cell().id == id)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9276.java