error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8328.java
text:
```scala
i@@nt sourceStart; // used by computeUniqueKey to uniquely identify this binding
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8328.java