error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9926.java
text:
```scala
i@@ndexShard.acquireSearcher("delete_by_query", IndexShard.Mode.WRITE), indexService, indexShard, scriptService, cacheRecycler));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9926.java