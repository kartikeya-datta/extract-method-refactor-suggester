error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7408.java
text:
```scala
s@@etText(WorkbenchMessages.PartPane_closeOthers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7408.java