error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9219.java
text:
```scala
r@@eturn new ShardRefreshRequest(shard.shardId(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9219.java