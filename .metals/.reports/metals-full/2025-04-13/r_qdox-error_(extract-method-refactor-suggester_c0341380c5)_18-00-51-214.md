error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4163.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4163.java
text:
```scala
public v@@oid selectionChanged(DrawingView view) {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4163.java