error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4611.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4611.java
text:
```scala
public A@@ctor hit (float x, float y, boolean touchable) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4611.java