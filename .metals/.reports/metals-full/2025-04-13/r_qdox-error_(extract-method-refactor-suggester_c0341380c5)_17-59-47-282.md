error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2081.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2081.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2081.java
text:
```scala
P@@ixmapBlendingTest.class, PixmapTest.class, PixmapPackerTest.class, PolygonRegionTest.class, PolygonSpriteTest.class, PreferencesTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2081.java