error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14755.java
text:
```scala
t@@hrow ThreadsMessages.MESSAGES.unsupportedScheduledThreadPoolMetric(attributeName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14755.java