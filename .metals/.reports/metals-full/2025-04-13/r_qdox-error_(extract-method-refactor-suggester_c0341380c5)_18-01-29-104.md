error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1535.java
text:
```scala
i@@f (!Signature.getReturnType(method.getSignature()).equals("V"/*nonNLS*/)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1535.java