error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10115.java
text:
```scala
s@@endEvent (SWT.Arm);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10115.java