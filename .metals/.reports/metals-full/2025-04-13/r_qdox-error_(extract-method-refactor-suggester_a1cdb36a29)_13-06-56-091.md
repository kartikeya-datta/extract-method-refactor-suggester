error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/533.java
text:
```scala
F@@ileHandle src = Gdx.files.internal("data/8.12.mp3");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/533.java