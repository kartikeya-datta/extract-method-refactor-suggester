error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4278.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4278.java
text:
```scala
final S@@ecurityContext securityContext = exchange.getAttachment(SecurityContext.ATTACHMENT_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4278.java