error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6167.java
text:
```scala
v@@oid onBeforeRenderChildren()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6167.java