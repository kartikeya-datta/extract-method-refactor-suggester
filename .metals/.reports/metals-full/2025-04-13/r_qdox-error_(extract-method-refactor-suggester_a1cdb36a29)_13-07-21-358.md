error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1441.java
text:
```scala
S@@tring dynamicMappingLocation = componentSettings.get("dynamic_mapping_location");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1441.java