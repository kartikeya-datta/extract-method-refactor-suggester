error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1998.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1998.java
text:
```scala
t@@his(font, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1998.java