error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2655.java
text:
```scala
n@@ewIndexWriterConfig(TEST_VERSION_CURRENT, stopAnalyzer));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2655.java