error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1046.java
text:
```scala
i@@f ((this.genericTypeArguments[i] = this.typeArguments[i].resolveType(scope, true /* check bounds*/)) == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1046.java