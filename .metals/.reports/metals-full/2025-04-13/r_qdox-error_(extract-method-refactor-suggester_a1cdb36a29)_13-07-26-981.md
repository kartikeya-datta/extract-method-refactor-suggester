error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1800.java
text:
```scala
i@@nt hitPart = (int)/*64*/((NSScroller)view).hitPart();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1800.java