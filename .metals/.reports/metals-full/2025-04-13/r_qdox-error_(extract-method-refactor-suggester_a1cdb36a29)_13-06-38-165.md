error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3150.java
text:
```scala
m@@_path.add( path );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3150.java