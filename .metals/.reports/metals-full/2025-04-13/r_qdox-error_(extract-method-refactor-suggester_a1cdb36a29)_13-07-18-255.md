error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5657.java
text:
```scala
i@@f (NO_RAW_INPUT == rawInput)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5657.java