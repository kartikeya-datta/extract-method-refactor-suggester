error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1706.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1706.java
text:
```scala
final P@@rogressDialog dialog = LightProgressDialog.create(this, string.login_activity_authenticating);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1706.java