error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2848.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2848.java
text:
```scala
public I@@BufferFactory factory; // TODO remove before 3.0
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2848.java