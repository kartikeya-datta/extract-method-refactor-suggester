error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4878.java
text:
```scala
s@@milies = messageviewer.addSubElement("smilies");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4878.java