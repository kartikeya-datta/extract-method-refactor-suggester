error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3348.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3348.java
text:
```scala
r@@eturn "<matchAllDocs field='*' term='*'/>";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3348.java