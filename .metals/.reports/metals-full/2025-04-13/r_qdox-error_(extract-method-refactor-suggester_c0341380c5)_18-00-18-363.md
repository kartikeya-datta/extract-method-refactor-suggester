error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15731.java
text:
```scala
L@@azyMethodGen clinit = gen.getAjcClinit(); //StaticInitializer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15731.java