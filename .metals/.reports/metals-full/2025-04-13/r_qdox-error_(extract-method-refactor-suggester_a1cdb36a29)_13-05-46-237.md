error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2084.java
text:
```scala
r@@eturn v == null ? 0 : v;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2084.java