error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9669.java
text:
```scala
t@@his(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9669.java