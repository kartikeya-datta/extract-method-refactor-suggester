error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1078.java
text:
```scala
i@@nt line = comment.getPosition();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1078.java