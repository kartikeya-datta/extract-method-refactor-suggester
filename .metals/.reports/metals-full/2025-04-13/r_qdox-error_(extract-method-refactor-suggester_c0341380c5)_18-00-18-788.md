error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/652.java
text:
```scala
s@@cope.problemReporter().unqualifiedFieldAccess(this, field);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/652.java