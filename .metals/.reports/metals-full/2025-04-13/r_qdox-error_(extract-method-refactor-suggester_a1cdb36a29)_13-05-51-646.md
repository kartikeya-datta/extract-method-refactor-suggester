error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14966.java
text:
```scala
c@@ontext.setSubsystemXmlMapping(SUBSYSTEM_NAME, namespace.getUri(), namespace.getReader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14966.java