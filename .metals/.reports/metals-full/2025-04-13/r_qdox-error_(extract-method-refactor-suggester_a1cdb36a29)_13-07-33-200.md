error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6337.java
text:
```scala
i@@f(!CharOperation.prefixEquals(argumentSource, argument))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6337.java