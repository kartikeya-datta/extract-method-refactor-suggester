error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/684.java
text:
```scala
d@@st[ii] = src[i] * scale;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/684.java