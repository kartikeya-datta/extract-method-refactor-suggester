error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/402.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/402.java
text:
```scala
public v@@oid reset(Reader input) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/402.java