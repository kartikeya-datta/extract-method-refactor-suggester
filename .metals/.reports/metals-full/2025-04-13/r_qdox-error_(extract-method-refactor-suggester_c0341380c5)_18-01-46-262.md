error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7440.java
text:
```scala
R@@egionFactory rf = (RegionFactory) LocalSessionFactoryBean.getConfigTimeRegionFactory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7440.java