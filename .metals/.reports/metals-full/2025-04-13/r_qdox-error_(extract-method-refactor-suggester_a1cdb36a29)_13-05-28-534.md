error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12238.java
text:
```scala
b@@uildItem.setIcon((Icon)AjdeUIManager.getDefault().getIconRegistry().getIcon(IProgramElement.Kind.FILE_LST).getIconResource());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12238.java