error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4688.java
text:
```scala
m@@odules.add(new ScriptModule(settings));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4688.java