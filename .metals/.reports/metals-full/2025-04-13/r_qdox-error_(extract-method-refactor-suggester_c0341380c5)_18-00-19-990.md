error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6985.java
text:
```scala
t@@his.logger = TransformersLogger.getLogger(originalModel.target);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6985.java