error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8021.java
text:
```scala
l@@ong end = System.currentTimeMillis() + 10000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8021.java