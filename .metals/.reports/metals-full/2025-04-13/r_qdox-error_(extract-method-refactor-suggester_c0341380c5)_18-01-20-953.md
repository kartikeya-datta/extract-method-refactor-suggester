error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2056.java
text:
```scala
o@@ut.writeVLong(DfsSearchResult.plusOne(stats.totalTermFreq()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2056.java