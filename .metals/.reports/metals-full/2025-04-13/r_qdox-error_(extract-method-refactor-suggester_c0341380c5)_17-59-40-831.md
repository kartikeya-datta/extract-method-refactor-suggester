error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9432.java
text:
```scala
A@@ssert.state(index != -1, "Failed to determine lookup path: " + requestUrl);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9432.java