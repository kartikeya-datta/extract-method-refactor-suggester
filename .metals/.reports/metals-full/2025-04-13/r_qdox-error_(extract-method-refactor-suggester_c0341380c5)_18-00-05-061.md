error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7162.java
text:
```scala
C@@SVRecord result = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7162.java