error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12720.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12720.java
text:
```scala
public F@@ineSessionCacheEntry<Object> readObject(ObjectInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12720.java