error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8697.java
text:
```scala
r@@eturn pageable.getCurrentPage() * pageable.getItemsPerPage() + 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8697.java