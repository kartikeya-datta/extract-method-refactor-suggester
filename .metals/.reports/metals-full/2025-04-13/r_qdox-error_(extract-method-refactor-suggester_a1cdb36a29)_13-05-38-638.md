error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11393.java
text:
```scala
i@@f (operationObject.hasDefined(name)&&isDeprecated()){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11393.java