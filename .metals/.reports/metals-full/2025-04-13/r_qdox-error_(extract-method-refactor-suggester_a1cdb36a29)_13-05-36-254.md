error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13670.java
text:
```scala
P@@roject.MSG_VERBOSE, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13670.java