error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17354.java
text:
```scala
m@@nemonics = new int [length / 4 + 1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17354.java