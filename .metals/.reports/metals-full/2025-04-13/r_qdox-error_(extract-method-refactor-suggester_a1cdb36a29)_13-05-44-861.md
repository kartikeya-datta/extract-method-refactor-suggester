error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5342.java
text:
```scala
A@@ssert.assertEquals("There should be 3 default loaders", 3, loaders.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5342.java