error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2975.java
text:
```scala
I@@ndexReader reader = IndexReader.open(dir, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2975.java