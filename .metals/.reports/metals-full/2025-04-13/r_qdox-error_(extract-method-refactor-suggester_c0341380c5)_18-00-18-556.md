error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1623.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1623.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1623.java
text:
```scala
C@@onstructor<?>[] cons = DateFormatUtils.class.getDeclaredConstructors();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1623.java