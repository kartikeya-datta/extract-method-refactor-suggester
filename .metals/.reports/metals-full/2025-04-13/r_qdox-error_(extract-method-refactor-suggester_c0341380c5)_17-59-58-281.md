error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5980.java
text:
```scala
p@@ublic abstract class AbstractDecimalConverter<N extends Number> extends AbstractNumberConverter<N>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5980.java