error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15336.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15336.java
text:
```scala
+ u@@rlFor(IResourceListener.INTERFACE) + "\"/>"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15336.java