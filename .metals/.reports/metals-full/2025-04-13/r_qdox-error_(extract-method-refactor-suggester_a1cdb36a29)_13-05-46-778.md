error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5268.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5268.java
text:
```scala
l@@.intensity = 4;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5268.java