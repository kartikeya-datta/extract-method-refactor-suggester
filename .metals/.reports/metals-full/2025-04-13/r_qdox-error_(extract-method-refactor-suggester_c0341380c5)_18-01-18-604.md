error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3351.java
text:
```scala
r@@emainder = requireInt(args, "remainder");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3351.java