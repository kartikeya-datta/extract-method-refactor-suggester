error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13896.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13896.java
text:
```scala
i@@nt /*long*/ hwndInsertAfter = OS.GetWindow (hwnd, OS.GW_HWNDPREV);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13896.java