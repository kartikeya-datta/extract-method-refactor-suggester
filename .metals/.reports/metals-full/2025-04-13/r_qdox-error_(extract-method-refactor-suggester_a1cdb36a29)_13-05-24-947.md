error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6934.java
text:
```scala
X@@Bundle bundle = depUnit.getAttachment(OSGiConstants.INSTALLED_BUNDLE_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6934.java