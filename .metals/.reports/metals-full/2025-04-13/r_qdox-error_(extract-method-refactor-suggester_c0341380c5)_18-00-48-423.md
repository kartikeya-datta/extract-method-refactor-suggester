error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8528.java
text:
```scala
r@@eturn $(deltaX, deltaY, duration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8528.java