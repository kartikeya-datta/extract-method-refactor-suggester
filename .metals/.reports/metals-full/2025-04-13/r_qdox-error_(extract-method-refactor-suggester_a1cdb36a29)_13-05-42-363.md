error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9788.java
text:
```scala
s@@ession.cleanupRenderedFeedbackMessages();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9788.java