error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4602.java
text:
```scala
c@@ontainerClass = containerClass.getSuperclass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4602.java