error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/293.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/293.java
text:
```scala
c@@f.addColumn(column("col1", "val1", new TimestampClock(1L)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/293.java