error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/485.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/485.java
text:
```scala
public v@@oid testQueryParameterEntity() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/485.java