error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13174.java
text:
```scala
i@@f (isEnabled()) closeWidget ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13174.java