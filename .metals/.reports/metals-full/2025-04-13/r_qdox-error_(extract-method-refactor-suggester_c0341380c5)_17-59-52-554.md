error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1486.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1486.java
text:
```scala
public L@@ist<InetAddress> getNaturalEndpoints(String table, byte[] key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1486.java