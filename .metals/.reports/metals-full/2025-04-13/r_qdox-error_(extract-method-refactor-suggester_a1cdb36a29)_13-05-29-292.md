error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14032.java
text:
```scala
c@@ontainerID = mutex.waitForSubscription(10000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14032.java