error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7343.java
text:
```scala
r@@eturn Binding.TYPE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7343.java