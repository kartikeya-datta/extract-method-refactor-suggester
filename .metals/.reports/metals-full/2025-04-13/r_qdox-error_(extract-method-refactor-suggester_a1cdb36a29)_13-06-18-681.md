error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3774.java
text:
```scala
r@@eturn getSequence(conn);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3774.java