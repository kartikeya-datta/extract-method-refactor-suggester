error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12267.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12267.java
text:
```scala
private L@@inkedList<Object> objects = new LinkedList<Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12267.java