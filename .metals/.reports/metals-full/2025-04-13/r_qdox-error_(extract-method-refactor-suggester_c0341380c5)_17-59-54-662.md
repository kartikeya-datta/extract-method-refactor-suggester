error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9207.java
text:
```scala
m@@odules.add(new IndexShardModule(indexSettings, shardId));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9207.java