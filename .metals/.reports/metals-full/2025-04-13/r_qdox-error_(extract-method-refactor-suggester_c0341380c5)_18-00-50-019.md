error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12240.java
text:
```scala
s@@uite.addTestSuite(ResourceCopyTestCase.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12240.java