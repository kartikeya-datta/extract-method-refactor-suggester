error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6009.java
text:
```scala
s@@cope, absolutePath, null, null, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6009.java