error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6410.java
text:
```scala
c@@hannel.sendResponse(new JsonHttpResponse(request, BAD_REQUEST, JsonBuilder.jsonBuilder().startObject().field("error", t.getMessage()).endObject()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6410.java