error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1665.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1665.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1665.java
text:
```scala
d@@ocsEnum = termsEnum.docs(acceptDocs, docsEnum, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1665.java