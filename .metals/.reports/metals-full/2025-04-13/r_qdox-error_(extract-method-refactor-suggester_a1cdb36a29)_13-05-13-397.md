error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7013.java
text:
```scala
r@@eturn new FontData[] {FontData.win32_new(logFont, device.computePoints(logFont, handle))};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7013.java