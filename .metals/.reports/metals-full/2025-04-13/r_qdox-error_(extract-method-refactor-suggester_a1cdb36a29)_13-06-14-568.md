error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11952.java
text:
```scala
r@@equestParameters.getInterfaceName(), requestParameters.getVersionNumber());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11952.java