error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5565.java
text:
```scala
N@@SString emptyStr = NSString.string();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5565.java