error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6742.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6742.java
text:
```scala
public T@@ypeBinding resolveType(BlockScope blockScope, boolean checkBounds) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6742.java