error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16702.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16702.java
text:
```scala
public F@@ormComponent setRequired(final boolean required)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16702.java