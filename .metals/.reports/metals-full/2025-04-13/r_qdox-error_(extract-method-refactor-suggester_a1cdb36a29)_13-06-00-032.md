error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7469.java
text:
```scala
S@@et<String> nodes = new HashSet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7469.java