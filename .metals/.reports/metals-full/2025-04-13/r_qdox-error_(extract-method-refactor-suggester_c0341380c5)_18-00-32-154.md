error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3746.java
text:
```scala
Q@@ueryParser parser = new QueryParser(TEST_VERSION_CURRENT, "contents", analyzer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3746.java