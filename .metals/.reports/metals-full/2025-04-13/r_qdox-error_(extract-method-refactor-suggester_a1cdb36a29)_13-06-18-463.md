error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/505.java
text:
```scala
i@@f (isPrimary || (root.validateOnClasspath().isOK() && isIncluded && resource.isAccessible() && Util.isValidCompilationUnitName(workingCopy.getElementName()))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/505.java