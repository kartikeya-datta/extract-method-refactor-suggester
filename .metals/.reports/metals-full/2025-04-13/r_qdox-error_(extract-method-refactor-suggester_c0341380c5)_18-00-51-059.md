error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15347.java
text:
```scala
p@@ublic static interface IVisitor
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15347.java