error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1348.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1348.java
text:
```scala
public C@@lass getDestinationIdentity()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1348.java