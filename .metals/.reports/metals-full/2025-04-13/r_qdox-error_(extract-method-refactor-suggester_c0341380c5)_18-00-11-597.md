error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4611.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4611.java
text:
```scala
J@@drRunner runner = new JdrRunner();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4611.java