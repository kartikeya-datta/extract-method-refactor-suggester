error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3009.java
text:
```scala
i@@f (!((rec.flags & (FLAG_NOKEY)) == (FLAG_NOKEY)))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3009.java