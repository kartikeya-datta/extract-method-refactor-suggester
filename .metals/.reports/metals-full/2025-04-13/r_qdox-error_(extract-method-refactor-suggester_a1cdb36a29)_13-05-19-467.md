error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5513.java
text:
```scala
O@@bject[] arguments = { Long.valueOf(responseTime), Long.valueOf(duration) };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5513.java