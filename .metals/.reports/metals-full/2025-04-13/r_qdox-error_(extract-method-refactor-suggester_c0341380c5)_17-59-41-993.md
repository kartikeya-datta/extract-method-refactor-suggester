error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7641.java
text:
```scala
i@@f (oneParam.needsUncheckedConversion(two.declaringClass.isRawType() ? twoParam : two.original().parameters[i]))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7641.java