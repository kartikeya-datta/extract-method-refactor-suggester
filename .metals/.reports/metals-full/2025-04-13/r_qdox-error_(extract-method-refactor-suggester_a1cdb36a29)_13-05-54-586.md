error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4292.java
text:
```scala
r@@eturn numDocs;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4292.java