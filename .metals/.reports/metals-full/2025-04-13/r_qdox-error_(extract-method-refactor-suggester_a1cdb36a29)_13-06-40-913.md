error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7365.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7365.java
text:
```scala
final S@@et<Resource.ResourceEntry> deploymentResource = context.getOperationContext().readResourceFromRoot(PathAddress.EMPTY_ADDRESS, false).getChildren(DEPLOYMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7365.java