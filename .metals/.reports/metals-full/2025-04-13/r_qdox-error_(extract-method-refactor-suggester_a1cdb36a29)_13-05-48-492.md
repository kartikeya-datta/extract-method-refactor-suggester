error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2966.java
text:
```scala
p@@ublic abstract class AbstractTextComponent extends FormComponent
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2966.java