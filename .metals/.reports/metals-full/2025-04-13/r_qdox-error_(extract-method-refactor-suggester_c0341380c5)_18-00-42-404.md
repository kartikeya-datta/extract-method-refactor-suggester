error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2111.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2111.java
text:
```scala
t@@his.columns = (ResultColumnDescriptor[]) ArrayUtil.copy( columns );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2111.java