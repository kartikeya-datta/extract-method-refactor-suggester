error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11798.java
text:
```scala
p@@ublic class PagedTableNavigatorPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11798.java