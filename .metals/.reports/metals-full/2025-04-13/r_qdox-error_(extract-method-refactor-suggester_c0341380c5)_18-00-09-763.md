error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12755.java
text:
```scala
e@@xecutor.setCorePoolSize(maxThreads);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12755.java