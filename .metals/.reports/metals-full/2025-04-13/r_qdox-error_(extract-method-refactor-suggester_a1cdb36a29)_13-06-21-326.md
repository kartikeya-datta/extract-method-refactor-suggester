error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9156.java
text:
```scala
r@@esolveAnnotations(this.annotations,  this.staticInitializerScope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9156.java