error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5076.java
text:
```scala
e@@xclusionPatterns = ((ClasspathEntry)entry).fullExclusionPatternChars();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5076.java