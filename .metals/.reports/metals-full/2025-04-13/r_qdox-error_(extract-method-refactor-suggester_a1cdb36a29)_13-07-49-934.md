error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2958.java
text:
```scala
I@@ndexReader reader = IndexReader.open(rd, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2958.java