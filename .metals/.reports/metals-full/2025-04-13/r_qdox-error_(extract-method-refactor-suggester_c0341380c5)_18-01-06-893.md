error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12751.java
text:
```scala
c@@lasses.put(clazz, index = new ClassReflectionIndex<T>(clazz, this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12751.java