error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8915.java
text:
```scala
i@@f ((style & SWT.ARROW) != 0 && (style & SWT.UP) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8915.java