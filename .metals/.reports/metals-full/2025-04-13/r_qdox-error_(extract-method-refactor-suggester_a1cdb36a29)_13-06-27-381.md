error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2667.java
text:
```scala
L@@ogs.reportMessage("DBLOOK_SchemasHeader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2667.java