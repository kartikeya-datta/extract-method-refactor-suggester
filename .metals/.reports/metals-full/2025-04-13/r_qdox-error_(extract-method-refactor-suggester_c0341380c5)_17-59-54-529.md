error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3383.java
text:
```scala
p@@osRights = bigArrays.resize(posRights, tops.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3383.java