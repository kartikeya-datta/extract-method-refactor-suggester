error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11641.java
text:
```scala
l@@isteners.remove(listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11641.java