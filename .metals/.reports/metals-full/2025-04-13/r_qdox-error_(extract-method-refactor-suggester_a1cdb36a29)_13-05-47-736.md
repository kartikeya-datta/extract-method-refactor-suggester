error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15046.java
text:
```scala
c@@omponent.getEJBLocalObject(context.getParameters()[0]).remove();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15046.java