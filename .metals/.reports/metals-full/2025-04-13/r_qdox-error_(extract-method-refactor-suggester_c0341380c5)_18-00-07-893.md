error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6515.java
text:
```scala
n@@ame = Strings.lastPathComponent(name, ':');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6515.java