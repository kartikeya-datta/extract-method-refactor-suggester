error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5449.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5449.java
text:
```scala
P@@luginJAR[] jars = jEdit.getPluginJARs();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5449.java