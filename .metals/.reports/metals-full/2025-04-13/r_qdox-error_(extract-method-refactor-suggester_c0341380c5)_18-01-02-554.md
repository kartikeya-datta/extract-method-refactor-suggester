error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10085.java
text:
```scala
u@@rl = url + ((url.indexOf("?") >= 0) ? "&amp;" : "?");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10085.java