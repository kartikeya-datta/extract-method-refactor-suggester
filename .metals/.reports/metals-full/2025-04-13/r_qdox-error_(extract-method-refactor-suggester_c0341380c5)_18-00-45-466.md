error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7772.java
text:
```scala
f@@ilter = smartNameFieldMappers.mapper().rangeFilter(from != null ? from.utf8ToString() : null, to != null ? to.utf8ToString() : null, includeLower, includeUpper, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7772.java