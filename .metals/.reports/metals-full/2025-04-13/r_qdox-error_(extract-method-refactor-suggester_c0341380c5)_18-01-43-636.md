error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17656.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[112,80]

error in qdox parser
file content:
```java
offset: 2991
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17656.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17656.java