error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4707.java
text:
```scala
n@@ode.setFlags(node.getFlags() | ASTNode.MALFORMED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4707.java