error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3404.java
text:
```scala
t@@his.exposed = method.getAnnotation(Exposed.class) != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3404.java