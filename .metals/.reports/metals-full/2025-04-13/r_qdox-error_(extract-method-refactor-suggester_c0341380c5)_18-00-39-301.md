error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5511.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(true, ATTRIBUTE_DEFINITIONS), new SecurityRealmChildRemoveHandler(false),
...
public class PropertiesAuthorizationResourceDefinition extends PropertiesFileResourceDefinition {
    ...
    public PropertiesAuthorizationResourceDefinition() {
        super(PathElement.pathElement(ModelDescriptionConstants.AUTHORIZATION, ModelDescriptionConstants.PROPERTIES),
                ...
                new SecurityRealmChildAddHandler(true, ATTRIBUTE_DEFINITIONS), new SecurityRealmChildRemoveHandler(true, true),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5511.java