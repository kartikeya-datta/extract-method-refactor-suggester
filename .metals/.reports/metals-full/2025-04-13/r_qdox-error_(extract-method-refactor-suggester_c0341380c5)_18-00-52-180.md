error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18216.java
text:
```scala
i@@mageList = new ImageList (style & SWT.RIGHT_TO_LEFT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18216.java