error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9711.java
text:
```scala
i@@f (annotationTypes == null || method.getAnnotations().length!=annotations.length) { // sometimes the list changes underneath us!
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9711.java