error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7314.java
text:
```scala
A@@rrayList<FieldMapper> list = new ArrayList<>(fieldMappers.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7314.java