error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6025.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6025.java
text:
```scala
private static i@@nt DECORATOR_ARRAY_SIZE = 6;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6025.java