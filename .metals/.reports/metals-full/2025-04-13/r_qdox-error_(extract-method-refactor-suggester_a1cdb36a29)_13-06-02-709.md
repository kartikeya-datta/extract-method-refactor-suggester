error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3508.java
text:
```scala
_@@optional = ("optional".equals(attributes.get("availability:")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3508.java