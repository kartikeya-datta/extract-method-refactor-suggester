error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4642.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4642.java
text:
```scala
public final static i@@nt Bit4 = 0x8; 						// return type (operator) | first assignment to local (local decl) | undocumented empty block (block, type and method decl)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4642.java