error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5059.java
text:
```scala
C@@onstant condConstant = this.condition.optimizedBooleanConstant(); //TODO: wrong, cannot use optimizedBoolean here (initializationTest#71).
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5059.java