error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1644.java
text:
```scala
i@@f (conn!=null) conn.disconnect();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1644.java