error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7022.java
text:
```scala
l@@ong count = Lucene.count(searcher.searcher(), query);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7022.java