error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/635.java
text:
```scala
r@@eturn new ChildPropertyDescriptor(nodeClass, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/635.java