error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2839.java
text:
```scala
r@@eturn new EngineSearcherTotalHitsMatcher(Queries.newMatchAllQuery(), totalHits);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2839.java