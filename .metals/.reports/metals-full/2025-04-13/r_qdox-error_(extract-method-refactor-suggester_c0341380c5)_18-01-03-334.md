error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16769.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16769.java
text:
```scala
public L@@istItem(final int index, final IModel model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16769.java