error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8432.java
text:
```scala
o@@peration.get("driver-name").set("mysql-connector-java-5.1.15.jar_com.mysql.jdbc.Driver_5_1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8432.java