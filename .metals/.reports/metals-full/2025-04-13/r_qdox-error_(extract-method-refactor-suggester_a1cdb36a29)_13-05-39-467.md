error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8627.java
text:
```scala
r@@eturn flowInfo.mergedWith(assertInfo.nullInfoLessUnconditionalCopy());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8627.java