error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6382.java
text:
```scala
S@@ystem.exit(restart ? ExitCodes.RESTART_PROCESS_FROM_STARTUP_SCRIPT : ExitCodes.NORMAL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6382.java