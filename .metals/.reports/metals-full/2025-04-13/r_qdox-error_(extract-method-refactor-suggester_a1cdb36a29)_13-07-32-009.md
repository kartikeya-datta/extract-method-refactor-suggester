error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4729.java
text:
```scala
i@@f (instance != null && instance.isRunning()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4729.java