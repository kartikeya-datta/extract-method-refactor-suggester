error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6090.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6090.java
text:
```scala
public T@@ypeBinding capture(Scope scope, int position) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6090.java