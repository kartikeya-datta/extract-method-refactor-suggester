error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6848.java
text:
```scala
M@@ethodBinding methodBinding = object.getExactMethod(selector, argumentTypes, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6848.java