error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10437.java
text:
```scala
s@@uper(ModelType.STRING, nullable, allowExpressions, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10437.java