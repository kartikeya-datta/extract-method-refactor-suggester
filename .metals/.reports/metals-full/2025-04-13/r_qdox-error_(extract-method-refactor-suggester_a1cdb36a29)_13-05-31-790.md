error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5622.java
text:
```scala
s@@etUserProperty(MagicNames.PROJECT_NAME,  name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5622.java