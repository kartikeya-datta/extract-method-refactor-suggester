error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7196.java
text:
```scala
T@@ime.now();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7196.java