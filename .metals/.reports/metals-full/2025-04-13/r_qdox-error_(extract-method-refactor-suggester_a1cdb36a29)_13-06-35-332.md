error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3908.java
text:
```scala
i@@f ("benchmark".equals(feature) && ElasticsearchIntegrationTest.cluster().numBenchNodes() > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3908.java