error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11255.java
text:
```scala
f@@or (ModuleDependency dependency : bdmSpec.getSystemDependencies()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11255.java