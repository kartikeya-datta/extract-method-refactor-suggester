error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16809.java
text:
```scala
c@@ontainer = ContainerFactory.getDefault().createContainer("ecf.discovery.jmdns"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16809.java