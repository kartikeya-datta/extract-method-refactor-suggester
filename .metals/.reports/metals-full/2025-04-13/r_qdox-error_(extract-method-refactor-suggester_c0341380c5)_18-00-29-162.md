error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9056.java
text:
```scala
r@@esourceRegistration.registerReadWriteAttribute(parameter.getAttribute(), null, JcaBeanValidationWriteHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9056.java