error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3315.java
text:
```scala
t@@hrow new SearchSourceBuilderException("[interval] must be defined for histogram aggregation [" + getName() + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3315.java