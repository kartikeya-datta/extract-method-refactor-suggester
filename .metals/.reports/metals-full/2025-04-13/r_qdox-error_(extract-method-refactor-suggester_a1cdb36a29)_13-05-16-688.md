error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2849.java
text:
```scala
i@@f (typeBinding != null && isTypeUseDeprecated(typeBinding, scope))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2849.java