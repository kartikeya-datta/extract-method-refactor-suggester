error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/817.java
text:
```scala
r@@eturn next();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/817.java