error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6639.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6639.java
text:
```scala
public v@@oid add(ColumbaHeader header)  {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6639.java