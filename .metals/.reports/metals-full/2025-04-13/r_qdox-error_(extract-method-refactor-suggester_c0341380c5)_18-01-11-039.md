error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/270.java
text:
```scala
i@@f (isMethodUseDeprecated(this.binding, scope, this.accessMode != ImplicitSuper))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/270.java