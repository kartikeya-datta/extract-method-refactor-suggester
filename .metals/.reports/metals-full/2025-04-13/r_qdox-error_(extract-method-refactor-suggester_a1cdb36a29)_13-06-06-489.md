error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5555.java
text:
```scala
t@@his.formatterCommentParser = new FormatterCommentParser(this.scanner.sourceLevel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5555.java