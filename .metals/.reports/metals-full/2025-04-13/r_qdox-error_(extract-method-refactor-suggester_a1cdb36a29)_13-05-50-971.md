error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3029.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3029.java
text:
```scala
private v@@oid executeTruncate(String columnFamily) throws TException, InvalidRequestException, UnavailableException, TimedOutException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3029.java