error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9890.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9890.java
text:
```scala
public l@@ong size;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9890.java