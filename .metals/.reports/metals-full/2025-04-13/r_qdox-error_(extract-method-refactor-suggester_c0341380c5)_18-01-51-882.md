error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7040.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7040.java
text:
```scala
public v@@oid record(CategorizedProblem problem, CompilationResult unitResult, ReferenceContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7040.java