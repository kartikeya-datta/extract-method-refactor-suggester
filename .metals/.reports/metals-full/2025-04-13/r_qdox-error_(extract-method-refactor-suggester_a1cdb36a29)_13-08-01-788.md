error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12728.java
text:
```scala
a@@ssertTrue((getProject().<Object> getReference("test1")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12728.java