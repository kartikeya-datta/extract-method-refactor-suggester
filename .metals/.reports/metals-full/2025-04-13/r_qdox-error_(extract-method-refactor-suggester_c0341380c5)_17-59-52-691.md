error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9946.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9946.java
text:
```scala
protected I@@ndexShardSegmentRequest newShardRequest(int numShards, ShardRouting shard, IndicesSegmentsRequest request) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9946.java