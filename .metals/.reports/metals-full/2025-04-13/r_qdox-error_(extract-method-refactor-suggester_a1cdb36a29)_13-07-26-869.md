error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3851.java
text:
```scala
t@@ermVectorRequest.index(clusterState.metaData().concreteSingleIndex(termVectorRequest.index(), termVectorRequest.indicesOptions()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3851.java