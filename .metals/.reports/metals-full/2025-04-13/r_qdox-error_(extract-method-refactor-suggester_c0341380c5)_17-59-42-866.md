error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8451.java
text:
```scala
l@@astIdentifierEnd = scanner.currentPosition - 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8451.java