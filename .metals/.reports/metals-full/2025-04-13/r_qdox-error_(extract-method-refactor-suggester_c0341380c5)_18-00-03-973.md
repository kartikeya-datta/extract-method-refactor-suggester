error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14138.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14138.java
text:
```scala
public T@@extTemplate interpolate(final Map<String, ?> variables)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14138.java