error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4172.java
...
```java
offset: 840
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4172.java
text:
```scala
...
p@@ackage org.apache.commons.math.stat.clustering;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4172.java