error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5052.java
text:
```scala
t@@his.mesh = new Mesh(false, 6 * 4 * rects.size(), 0, new VertexAttribute(VertexAttributes.Usage.Position, 2,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5052.java