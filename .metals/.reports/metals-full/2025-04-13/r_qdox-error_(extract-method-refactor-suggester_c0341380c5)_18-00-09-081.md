error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/672.java
text:
```scala
s@@rcFolder.expungeFolder(worker);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/672.java