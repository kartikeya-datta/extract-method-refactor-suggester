error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/50.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/50.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/50.java
text:
```scala
I@@terator stepIterator();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/50.java