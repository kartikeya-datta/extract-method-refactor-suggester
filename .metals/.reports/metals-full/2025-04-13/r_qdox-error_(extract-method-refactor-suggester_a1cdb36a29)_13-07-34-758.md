error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11800.java
text:
```scala
r@@esourceRegistration.registerSubModel(new ServerGroupResourceDefinition(isMaster, hostControllerInfo, fileRepository, runtimeIgnoreTransformationRegistry));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11800.java