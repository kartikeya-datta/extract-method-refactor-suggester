error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4826.java
text:
```scala
l@@og.info(port + "Empty request, ignored");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4826.java