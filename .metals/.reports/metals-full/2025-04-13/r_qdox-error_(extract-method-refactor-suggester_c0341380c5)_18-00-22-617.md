error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5664.java
text:
```scala
r@@eturn untranslateOffset(offset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5664.java