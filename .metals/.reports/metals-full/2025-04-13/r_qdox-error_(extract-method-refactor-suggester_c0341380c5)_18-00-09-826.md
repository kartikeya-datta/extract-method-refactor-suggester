error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13104.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13104.java
text:
```scala
public static final i@@nt INSTALL_EE_COMPONENT = 0x0E00;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13104.java