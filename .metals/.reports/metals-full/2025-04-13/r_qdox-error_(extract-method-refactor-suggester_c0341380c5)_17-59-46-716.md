error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9044.java
text:
```scala
t@@his.stripWicketTag = settings.getStripWicketTags();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9044.java