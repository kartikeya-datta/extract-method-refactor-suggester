error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8556.java
text:
```scala
C@@achedHeaderfields.getUserDefinedHeaderfields();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8556.java