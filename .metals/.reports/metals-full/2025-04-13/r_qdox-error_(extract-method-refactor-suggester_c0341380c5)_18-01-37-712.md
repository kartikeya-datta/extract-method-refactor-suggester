error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/499.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/499.java
text:
```scala
c@@lient.aliasesExist(request, listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/499.java