error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8814.java
text:
```scala
i@@f (columnCount > 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8814.java