error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14121.java
text:
```scala
F@@ileProvider fp = r.as(FileProvider.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14121.java