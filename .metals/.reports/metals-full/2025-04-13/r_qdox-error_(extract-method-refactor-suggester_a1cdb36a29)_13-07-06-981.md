error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4447.java
text:
```scala
m@@oduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, PICKETBOX_ID, false, false, false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4447.java