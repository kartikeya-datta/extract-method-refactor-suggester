error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8977.java
text:
```scala
s@@uper(1, 3, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8977.java