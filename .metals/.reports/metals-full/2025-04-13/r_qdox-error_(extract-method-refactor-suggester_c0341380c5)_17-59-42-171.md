error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10268.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10268.java
text:
```scala
c@@ontext.reloadRequired();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10268.java