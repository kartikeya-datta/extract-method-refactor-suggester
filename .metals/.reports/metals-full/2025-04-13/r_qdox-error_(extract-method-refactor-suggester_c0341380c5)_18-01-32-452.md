error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4503.java
text:
```scala
c@@ontacts.add(dp.model((Contact)it.next()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4503.java