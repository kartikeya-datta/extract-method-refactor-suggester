error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2917.java
text:
```scala
a@@rgumentTypes[i] = (value==null?Object.class:value.getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2917.java