error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10640.java
text:
```scala
p@@haseContext.getDeploymentUnit().putAttachment(IronJacamarXmlDescriptor.ATTACHMENT_KEY, xmlDescriptor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10640.java