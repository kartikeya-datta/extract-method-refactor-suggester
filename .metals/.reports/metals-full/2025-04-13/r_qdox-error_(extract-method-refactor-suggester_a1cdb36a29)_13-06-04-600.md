error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2642.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2642.java
text:
```scala
public S@@yntheticArgumentBinding getSyntheticArgument(ReferenceBinding targetEnclosingType, boolean onlyExactMatch) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2642.java