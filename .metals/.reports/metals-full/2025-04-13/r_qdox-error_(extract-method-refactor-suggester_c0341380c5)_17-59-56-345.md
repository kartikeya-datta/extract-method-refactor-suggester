error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2233.java
text:
```scala
r@@eturn Gdx.graphics.getHeight() - Mouse.getY();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2233.java