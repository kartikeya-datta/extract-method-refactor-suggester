error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7226.java
text:
```scala
q@@ueryFetchResults = new AtomicArray<>(firstResults.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7226.java