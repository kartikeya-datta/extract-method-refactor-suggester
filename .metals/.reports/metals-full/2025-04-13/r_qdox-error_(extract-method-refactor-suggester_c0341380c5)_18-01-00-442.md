error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2018.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2018.java
text:
```scala
public N@@SButton standardWindowButton(int b) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2018.java