error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2000.java
text:
```scala
c@@ubemap = new Cubemap(root.child(name + "_PX.png"), null,// root.child(name+"_NX.png"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2000.java