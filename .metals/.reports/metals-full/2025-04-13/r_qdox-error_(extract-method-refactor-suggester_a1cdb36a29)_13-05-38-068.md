error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7797.java
text:
```scala
a@@ssertEquals("\"0da1ed070012f304e47b83c81c48ad620\"", this.response.getHeaders().getETag());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7797.java