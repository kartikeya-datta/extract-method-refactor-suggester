error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12668.java
text:
```scala
n@@ew ISourceLocation[]{this.getSourceLocation()},true,0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12668.java