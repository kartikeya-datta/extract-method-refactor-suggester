error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/596.java
...
```java
offset: 593
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/596.java
text:
```scala
 ...
 ******************************************************************************/
p@@ackage org.eclipse.ecf.internal.provider.jslp;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/596.java