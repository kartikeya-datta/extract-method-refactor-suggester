error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10355.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10355.java
text:
```scala
i@@f (!String.class.equals(type))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10355.java