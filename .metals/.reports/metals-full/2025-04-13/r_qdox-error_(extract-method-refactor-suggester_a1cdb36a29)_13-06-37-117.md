error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1828.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1828.java
text:
```scala
T@@hrowable cause = error.getCause();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1828.java