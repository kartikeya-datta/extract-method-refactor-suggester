error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4345.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4345.java
text:
```scala
c@@ontext.removeService(LogServices.ROOT_LOGGER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4345.java