error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2451.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2451.java
text:
```scala
public static M@@ap newInstance(final int maxEntries)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2451.java