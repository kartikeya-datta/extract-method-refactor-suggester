error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8005.java
text:
```scala
i@@f (alwaysCreate && !closed) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8005.java