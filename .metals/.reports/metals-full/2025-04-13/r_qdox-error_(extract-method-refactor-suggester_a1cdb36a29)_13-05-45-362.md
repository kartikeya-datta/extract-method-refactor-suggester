error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14484.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14484.java
text:
```scala
final S@@erviceController<?> service = context.getServiceRegistry().getService(JMSSubsystemElement.JMS_TOPIC_BASE.append(topicName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14484.java