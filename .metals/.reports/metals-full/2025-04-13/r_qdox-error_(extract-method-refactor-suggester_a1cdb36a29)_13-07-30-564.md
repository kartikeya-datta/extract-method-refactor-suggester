error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/905.java
text:
```scala
P@@ROTOCOL, KeystoreAttributes.KEYSTORE_PASSWORD, KeystoreAttributes.KEYSTORE_PATH, KeystoreAttributes.KEYSTORE_RELATIVE_TO, KeystoreAttributes.ALIAS, KeystoreAttributes.KEY_PASSWORD
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/905.java