error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7735.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7735.java
text:
```scala
v@@oid aspectSettings( Parameters parameters, Configuration[] children )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7735.java