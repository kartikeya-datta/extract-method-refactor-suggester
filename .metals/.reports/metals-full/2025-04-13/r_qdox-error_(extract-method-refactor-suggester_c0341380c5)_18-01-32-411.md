error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1284.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1284.java
text:
```scala
public static final P@@athElement PATH = PathElement.pathElement(CommonAttributes.CONNECTOR_SERVICE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1284.java