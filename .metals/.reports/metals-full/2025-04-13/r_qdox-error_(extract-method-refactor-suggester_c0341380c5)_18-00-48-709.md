error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4065.java
text:
```scala
i@@f (leafComponentType.isBoundParameterizedType() || leafComponentType.isTypeVariable()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4065.java