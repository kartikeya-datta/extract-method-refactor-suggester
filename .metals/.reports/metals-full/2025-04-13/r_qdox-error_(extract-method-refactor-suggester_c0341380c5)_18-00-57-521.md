error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9376.java
text:
```scala
t@@ouch(getProject().resolveFile(mapped[i]), modTime);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9376.java