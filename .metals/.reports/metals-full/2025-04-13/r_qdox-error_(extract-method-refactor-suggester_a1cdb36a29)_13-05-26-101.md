error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/974.java
text:
```scala
M@@essagingExtension.getResourceDescriptionResolver(false, CommonAttributes.SECURITY_SETTING),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/974.java