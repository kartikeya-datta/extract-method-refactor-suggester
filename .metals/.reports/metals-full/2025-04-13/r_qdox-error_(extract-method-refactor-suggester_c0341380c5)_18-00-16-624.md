error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7315.java
text:
```scala
i@@f ((int)/*64*/OS.SendMessage (hwnd, OS.LVM_GETBKCOLOR, 0, 0) != OS.CLR_NONE) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7315.java