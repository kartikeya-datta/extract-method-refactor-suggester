error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15918.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15918.java
text:
```scala
private final S@@tring name;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15918.java