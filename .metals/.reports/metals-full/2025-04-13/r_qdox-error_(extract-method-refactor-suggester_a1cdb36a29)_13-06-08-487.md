error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6701.java
text:
```scala
b@@uilder.startObject(indexMetaData.index(), XContentBuilder.FieldCaseConversion.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6701.java