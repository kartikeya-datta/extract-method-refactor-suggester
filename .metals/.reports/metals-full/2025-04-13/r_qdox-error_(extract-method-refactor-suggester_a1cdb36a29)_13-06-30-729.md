error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1083.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1083.java
text:
```scala
p@@arser.scanner.setSource(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1083.java