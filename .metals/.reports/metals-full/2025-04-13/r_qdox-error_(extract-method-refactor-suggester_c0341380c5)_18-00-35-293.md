error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10350.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10350.java
text:
```scala
i@@f (stateValues.rolePropertiesFound() && stateValues.getRoles() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10350.java