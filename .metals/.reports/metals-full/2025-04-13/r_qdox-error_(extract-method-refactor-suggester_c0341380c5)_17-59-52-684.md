error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13916.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13916.java
text:
```scala
static R@@egistrationPolicy valueOf(int registrationBehavior) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13916.java