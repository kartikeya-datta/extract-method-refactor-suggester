error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9828.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9828.java
text:
```scala
private static final S@@tring VERSION = "2.8";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9828.java