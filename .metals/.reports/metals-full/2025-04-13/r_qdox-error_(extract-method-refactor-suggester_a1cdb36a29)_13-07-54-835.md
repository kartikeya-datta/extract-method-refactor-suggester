error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6344.java
text:
```scala
i@@f (filter.equals(REMARK_NODE_FILTER))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6344.java