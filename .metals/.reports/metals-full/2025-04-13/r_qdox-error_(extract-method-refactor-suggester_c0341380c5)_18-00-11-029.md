error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8112.java
text:
```scala
r@@eturn set.equals(other.set);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8112.java