error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5809.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5809.java
text:
```scala
public H@@ashedMap(final Map<? extends K, ? extends V> map) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5809.java