error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/117.java
text:
```scala
e@@xtends BaseAttributeValuePeer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/117.java