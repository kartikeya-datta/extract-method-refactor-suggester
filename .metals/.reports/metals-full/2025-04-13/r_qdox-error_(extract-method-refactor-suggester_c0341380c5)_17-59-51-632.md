error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9997.java
text:
```scala
i@@f (this != otherParamType.type())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9997.java