error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/664.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/664.java
text:
```scala
public X@@SLTResourceStream(final IResourceStream xsltResource, final IResourceStream xmlResource)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/664.java