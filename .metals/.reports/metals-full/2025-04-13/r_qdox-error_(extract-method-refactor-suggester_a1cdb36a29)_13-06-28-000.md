error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/83.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/83.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/83.java
text:
```scala
M@@oduleDependency dependency = new ModuleDependency(null, dependencyId, optional, export, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/83.java