error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9736.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9736.java
text:
```scala
final C@@omponent component = (Component)serviceValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9736.java