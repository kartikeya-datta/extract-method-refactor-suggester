error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1413.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1413.java
text:
```scala
...
public class ConnectorServiceParamRemove extends AbstractRemoveStepHandler implements DescriptionProvider {
    ...
    private ConnectorServiceParamRemove() {
        super();
    }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1413.java