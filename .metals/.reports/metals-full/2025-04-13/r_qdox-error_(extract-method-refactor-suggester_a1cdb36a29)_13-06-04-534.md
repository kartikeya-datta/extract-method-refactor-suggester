error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17119.java
text:
```scala
l@@oadRegisteredClassMetaData(envLoader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17119.java