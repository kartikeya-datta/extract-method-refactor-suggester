error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7330.java
text:
```scala
c@@ontrol.fillBackground (view, context, rect, imgHeight, data.view, offsetX, offsetY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7330.java