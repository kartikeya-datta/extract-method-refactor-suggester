error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3132.java
text:
```scala
r@@osterView.handleRosterEntryUpdate(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3132.java