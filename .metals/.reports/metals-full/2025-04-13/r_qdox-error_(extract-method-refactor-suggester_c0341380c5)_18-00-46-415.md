error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10147.java
text:
```scala
i@@f (gc.lastGc() != null && lastJvmStats.gc.collectors()[i].lastGc() != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10147.java