error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16955.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16955.java
text:
```scala
protected static final S@@tring DEFAULT_ENCODING
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16955.java