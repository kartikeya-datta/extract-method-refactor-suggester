error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/717.java
text:
```scala
i@@f ( ev.getSelected() != null && ev.getSelected().length == 1 && ev.getSelected()[0] != null && ev.getSelected()[0].getAllowsChildren()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/717.java