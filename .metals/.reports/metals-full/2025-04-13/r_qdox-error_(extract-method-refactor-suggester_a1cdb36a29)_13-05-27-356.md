error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3888.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3888.java
text:
```scala
public P@@ageMapView(final MarkupContainer parent, final String id, final IPageMap pageMap)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3888.java