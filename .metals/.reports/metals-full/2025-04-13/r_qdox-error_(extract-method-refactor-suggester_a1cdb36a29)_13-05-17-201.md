error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10011.java
text:
```scala
a@@nnotationTypeMemberDeclaration.modifiers = this.intStack[this.intPtr--] | AccSemicolonBody;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10011.java