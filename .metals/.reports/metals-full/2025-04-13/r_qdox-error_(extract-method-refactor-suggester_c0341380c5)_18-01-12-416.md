error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9250.java
text:
```scala
H@@ashtable<String, String> keys = new Hashtable<String, String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9250.java