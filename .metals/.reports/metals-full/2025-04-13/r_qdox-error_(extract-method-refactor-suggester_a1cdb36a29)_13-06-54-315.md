error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6945.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6945.java
text:
```scala
public H@@eaderSectionMyLabel(MarkupContainer parent,final String id, final String label)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6945.java