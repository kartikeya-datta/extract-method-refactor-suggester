error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3329.java
text:
```scala
B@@ufferedReader listFile = new BufferedReader(new InputStreamReader(is, "UTF-8"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3329.java