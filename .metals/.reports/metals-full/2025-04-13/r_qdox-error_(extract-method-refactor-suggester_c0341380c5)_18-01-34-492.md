error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/290.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/290.java
text:
```scala
public final static S@@qlCode disconnectError = new SqlCode(40000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/290.java