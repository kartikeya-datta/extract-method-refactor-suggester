error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3278.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3278.java
text:
```scala
protected b@@oolean compareServiceProperties(IServiceProperties p1, IServiceProperties p2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3278.java