error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5058.java
text:
```scala
t@@his.wrappedConstantValue = Boolean.valueOf(fieldConstant.booleanValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5058.java