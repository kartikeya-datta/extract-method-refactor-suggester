error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9150.java
text:
```scala
b@@oolean hooksPaint = hooks (SWT.Paint) || filters (SWT.Paint);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9150.java