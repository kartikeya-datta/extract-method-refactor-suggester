error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5909.java
text:
```scala
i@@f (!securityManager.isCallerInRole(ejbComponent.getSecurityMetaData().getSecurityRoles(), allowedRoles.toArray(new String[allowedRoles.size()]))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5909.java