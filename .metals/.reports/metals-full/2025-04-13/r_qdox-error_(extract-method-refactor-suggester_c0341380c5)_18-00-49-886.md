error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3503.java
text:
```scala
r@@eturn new NameEnvironment(getProject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3503.java