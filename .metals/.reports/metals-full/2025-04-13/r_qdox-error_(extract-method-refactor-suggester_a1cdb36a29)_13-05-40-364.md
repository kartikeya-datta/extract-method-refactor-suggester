error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2101.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2101.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2101.java
text:
```scala
r@@eturn "Switch flow context"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2101.java