error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12860.java
text:
```scala
s@@tate.pushActiveContextObject(new TypedValue(entry,TypeDescriptor.valueOf(Map.Entry.class)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12860.java