error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5307.java
text:
```scala
b@@uffer.put(indices, offset, count);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5307.java