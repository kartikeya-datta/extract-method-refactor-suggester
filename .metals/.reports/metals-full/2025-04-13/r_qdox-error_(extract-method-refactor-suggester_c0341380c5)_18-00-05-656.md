error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4607.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4607.java
text:
```scala
l@@ogger.debugf("Invocation with id %s has been marked as cancelled, as requested", invocationToCancel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4607.java