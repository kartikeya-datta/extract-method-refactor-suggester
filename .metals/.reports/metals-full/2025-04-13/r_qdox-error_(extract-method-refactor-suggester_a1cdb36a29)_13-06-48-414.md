error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2403.java
text:
```scala
a@@pplication.setHomePage(IncrementalTableNavigationPage.class);
...
public class IncrementalTableNavigationTest extends TestCase
{
	...
	public void testPagedTable() throws Exception
	{
		...
		application.getRequiredPageSettings().setHomePage(IncrementalTableNavigationPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2403.java