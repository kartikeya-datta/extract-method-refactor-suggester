error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5442.java
text:
```scala
r@@eturn names().createIndexNameTerm(uid);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5442.java