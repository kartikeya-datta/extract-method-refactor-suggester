error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1605.java
text:
```scala
p@@arameterTypes[i] = parameters[i].getClazz();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1605.java