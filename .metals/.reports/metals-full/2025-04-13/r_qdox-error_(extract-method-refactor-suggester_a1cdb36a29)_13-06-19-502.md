error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12589.java
...
```java
offset: 1108
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12589.java
text:
```scala
...
p@@ackage org.jboss.as.domain.client.api.deployment;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12589.java