error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11350.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11350.java
text:
```scala
public S@@tring loadStringResource(final Component component, final String key)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11350.java