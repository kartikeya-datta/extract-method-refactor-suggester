error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17035.java
text:
```scala
a@@rgs[j++] = "-keepgenerated";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17035.java