error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12794.java
text:
```scala
M@@ap map = new HashMap(4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12794.java