error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2960.java
text:
```scala
r@@eturn new ExecutorHolder(MoreExecutors.directExecutor(), new Info(name, type));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2960.java