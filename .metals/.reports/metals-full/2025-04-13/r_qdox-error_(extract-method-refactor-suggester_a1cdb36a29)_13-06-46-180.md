error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4717.java
text:
```scala
i@@nt interval = item.getIntegerWithDefault("mailcheck_interval", 10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4717.java