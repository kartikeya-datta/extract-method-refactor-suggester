error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5941.java
text:
```scala
o@@rg.eclipse.jdt.core.dom.CompilationUnit cu = AST.convertCompilationUnit(astLevel, unit, contents, options, computeProblems, this, pm);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5941.java