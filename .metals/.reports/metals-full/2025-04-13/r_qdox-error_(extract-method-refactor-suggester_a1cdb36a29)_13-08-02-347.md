error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3281.java
text:
```scala
t@@his.utf8 = CESU8 ? null : new BytesRef();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3281.java