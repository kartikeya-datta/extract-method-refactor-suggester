error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2316.java
text:
```scala
A@@ction action = association.getActionByVerb("open");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2316.java