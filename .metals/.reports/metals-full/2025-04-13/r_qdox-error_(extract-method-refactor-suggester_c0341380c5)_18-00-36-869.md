error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2358.java
text:
```scala
n@@ew SecurityRealmChildRemoveHandler(false, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2358.java