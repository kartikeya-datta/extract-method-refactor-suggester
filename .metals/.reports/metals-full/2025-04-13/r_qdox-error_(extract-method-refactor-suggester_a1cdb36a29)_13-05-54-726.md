error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1347.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1347.java
text:
```scala
i@@f ((state & CANVAS) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1347.java