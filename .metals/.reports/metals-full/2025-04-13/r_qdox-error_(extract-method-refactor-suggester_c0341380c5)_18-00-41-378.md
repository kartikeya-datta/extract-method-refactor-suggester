error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9868.java
text:
```scala
M@@ap<String, ? extends Property> getProperties (ExecutionContext ctx);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9868.java