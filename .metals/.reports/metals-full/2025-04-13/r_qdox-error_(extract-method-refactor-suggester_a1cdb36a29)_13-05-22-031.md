error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11280.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11280.java
text:
```scala
protected W@@ebMarkupContainer newSortableHeader(String borderId, String property,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11280.java