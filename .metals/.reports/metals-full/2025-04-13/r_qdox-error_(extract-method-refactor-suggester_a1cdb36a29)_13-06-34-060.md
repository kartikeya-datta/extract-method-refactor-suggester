error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6905.java
text:
```scala
i@@nstructions.add(MESSAGES.argShortServerConfig());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6905.java