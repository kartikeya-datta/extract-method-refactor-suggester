error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9909.java
text:
```scala
F@@etchConfiguration fetch)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9909.java