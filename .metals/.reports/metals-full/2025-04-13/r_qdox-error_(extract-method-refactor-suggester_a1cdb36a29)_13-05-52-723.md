error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1140.java
text:
```scala
i@@f( !displayName.equals("") ) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1140.java