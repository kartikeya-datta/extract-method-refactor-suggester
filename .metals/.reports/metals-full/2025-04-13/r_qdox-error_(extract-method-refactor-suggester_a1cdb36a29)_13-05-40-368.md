error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8735.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8735.java
text:
```scala
t@@reeNode.createChildren();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8735.java