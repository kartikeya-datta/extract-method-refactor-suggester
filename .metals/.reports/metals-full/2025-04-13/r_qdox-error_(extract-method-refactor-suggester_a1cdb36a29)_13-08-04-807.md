error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3440.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3440.java
text:
```scala
public static final O@@perationDefinition DEFINITION = new SimpleOperationDefinitionBuilder(NAME, null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3440.java