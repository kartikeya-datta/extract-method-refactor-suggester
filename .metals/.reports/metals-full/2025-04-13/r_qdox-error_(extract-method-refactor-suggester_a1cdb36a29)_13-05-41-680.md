error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6690.java
text:
```scala
r@@esponse.write("new Wicket.AutoComplete('" + id + "','" + getCallbackUrl() + "');");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6690.java