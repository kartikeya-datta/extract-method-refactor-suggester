error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4647.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4647.java
text:
```scala
public v@@oid recordReturnFrom(FlowInfo flowInfo) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4647.java