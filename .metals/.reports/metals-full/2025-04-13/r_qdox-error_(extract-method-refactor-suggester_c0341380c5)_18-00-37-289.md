error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3794.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3794.java
text:
```scala
public L@@ist<MutableShardRouting> shardsWithState(ShardRoutingState... state) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3794.java