error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7367.java
text:
```scala
L@@ist<Aggregator> collectables = new ArrayList<>(subAggregators.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7367.java