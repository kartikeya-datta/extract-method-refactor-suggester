error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5790.java
text:
```scala
s@@witch (typeDeclaration.kind()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5790.java