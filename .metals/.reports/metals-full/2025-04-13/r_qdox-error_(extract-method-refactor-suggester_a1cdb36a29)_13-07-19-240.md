error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4506.java
text:
```scala
r@@eturn dc;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4506.java