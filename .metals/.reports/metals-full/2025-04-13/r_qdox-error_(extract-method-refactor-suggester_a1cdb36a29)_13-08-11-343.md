error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17633.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[122,27]

error in qdox parser
file content:
```java
offset: 4083
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17633.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17633.java