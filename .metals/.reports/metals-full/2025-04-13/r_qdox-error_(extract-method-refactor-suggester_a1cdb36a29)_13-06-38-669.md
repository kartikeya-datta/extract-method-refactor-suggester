error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3786.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3786.java
text:
```scala
public synchronized v@@oid response(Message msg)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3786.java