error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12752.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12752.java
text:
```scala
final S@@erviceName ejbServiceName = ContextNames.serviceNameOfContext(moduleDescription.getApplicationName(),moduleDescription.getModuleName(),moduleDescription.getModuleName(),ejb.lookup());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12752.java