error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7306.java
text:
```scala
i@@f (this.recordStringLiterals && this.checkExternalizeStrings && !this.statementRecoveryActivated) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7306.java