error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15179.java
text:
```scala
s@@upportsLockingWithSelectRange = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15179.java