error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1862.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1862.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1862.java
text:
```scala
S@@tring option = this.getJavaProject().getOption(JavaCore.ENABLE_JAVADOC_ATTACHMENTS_ACCESSES, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1862.java