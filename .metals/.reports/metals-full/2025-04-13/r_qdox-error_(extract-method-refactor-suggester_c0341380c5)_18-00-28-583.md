error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1484.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1484.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1484.java
text:
```scala
r@@eturn BufferedImage.TYPE_4BYTE_ABGR_PRE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1484.java