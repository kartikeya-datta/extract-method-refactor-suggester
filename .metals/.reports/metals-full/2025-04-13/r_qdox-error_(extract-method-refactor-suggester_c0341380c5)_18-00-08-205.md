error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8396.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8396.java
text:
```scala
private static final S@@tring DEFAULT_MSG = "Welcome to Chainsaw v2!";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8396.java