error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3088.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3088.java
text:
```scala
public static final P@@athElement STORE_PATH = PathElement.pathElement(ModelKeys.STORE, ModelKeys.STORE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3088.java