error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2517.java
text:
```scala
s@@tatic class BinaryMemtableFlusher implements Runnable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2517.java