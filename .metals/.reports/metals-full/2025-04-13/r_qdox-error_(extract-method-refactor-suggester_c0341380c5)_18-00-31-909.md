error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14151.java
text:
```scala
I@@njectedValue<Cache> cache = new InjectedValue<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14151.java