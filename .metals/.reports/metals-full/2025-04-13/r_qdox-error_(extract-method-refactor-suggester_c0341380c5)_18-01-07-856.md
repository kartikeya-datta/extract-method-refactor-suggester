error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7399.java
text:
```scala
e@@ndpointBuilder.setInitialMode(ServiceController.Mode.ACTIVE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7399.java