error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/518.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/518.java
text:
```scala
public final static Q@@uery MATCH_ALL_QUERY = new DeletionAwareConstantScoreQuery(new MatchAllDocsFilter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/518.java