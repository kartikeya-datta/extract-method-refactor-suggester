error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1052.java
text:
```scala
T@@oastUtils.show(activity, e, string.error_assignee_update);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1052.java