error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3157.java
text:
```scala
d@@eleteByQueryRequest.query(request.content(), request.contentUnsafe());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3157.java