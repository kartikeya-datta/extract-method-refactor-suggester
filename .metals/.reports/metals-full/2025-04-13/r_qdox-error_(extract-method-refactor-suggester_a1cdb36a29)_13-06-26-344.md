error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4452.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4452.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4452.java
text:
```scala
protected b@@oolean equalsDOMNode(IDOMNode node) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4452.java