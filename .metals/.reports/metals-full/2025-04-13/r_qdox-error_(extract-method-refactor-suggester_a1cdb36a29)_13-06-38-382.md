error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2861.java
text:
```scala
F@@ilter mainQueryFilter = docs.getTopFilter(); // This returns a filter that only matches documents matching with q param and fq params
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2861.java