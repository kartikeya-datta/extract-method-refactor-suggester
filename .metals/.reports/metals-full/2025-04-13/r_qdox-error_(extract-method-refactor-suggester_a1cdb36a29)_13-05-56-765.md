error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14086.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,64]

error in qdox parser
file content:
```java
offset: 64
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14086.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14086.java