error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/442.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/442.java
text:
```scala
public final v@@oid bind()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/442.java