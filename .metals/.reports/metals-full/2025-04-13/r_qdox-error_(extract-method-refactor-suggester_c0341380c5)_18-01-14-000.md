error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1692.java
text:
```scala
r@@eturn mcfOk || aoOk;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1692.java