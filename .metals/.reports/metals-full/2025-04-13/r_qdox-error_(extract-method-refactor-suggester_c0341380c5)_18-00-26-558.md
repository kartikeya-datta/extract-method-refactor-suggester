error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7006.java
text:
```scala
c@@riteriaAccountUid = f.getIntegerWithDefault("account.uid", -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7006.java