error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1254.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1254.java
text:
```scala
F@@ile tmpInputFile = _TestUtil.createTempFile("IndexInput", "tmpFile", TEMP_DIR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1254.java