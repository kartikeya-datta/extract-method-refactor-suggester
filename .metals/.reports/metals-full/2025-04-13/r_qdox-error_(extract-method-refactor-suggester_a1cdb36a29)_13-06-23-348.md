error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10247.java
text:
```scala
t@@ry { m_tskDeployer.deployTasklet( name, url.toString(), url ); }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10247.java