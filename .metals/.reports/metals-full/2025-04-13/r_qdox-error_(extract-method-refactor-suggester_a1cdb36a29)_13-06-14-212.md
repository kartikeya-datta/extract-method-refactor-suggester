error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14623.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14623.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14623.java
text:
```scala
r@@eturn result;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14623.java