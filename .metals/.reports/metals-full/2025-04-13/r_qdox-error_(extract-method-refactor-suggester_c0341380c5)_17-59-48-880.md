error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16517.java
text:
```scala
c@@onnection = new XMPPConnection(serverName, serverPort,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16517.java