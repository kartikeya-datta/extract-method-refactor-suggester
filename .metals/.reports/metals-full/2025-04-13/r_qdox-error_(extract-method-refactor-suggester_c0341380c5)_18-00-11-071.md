error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3811.java
text:
```scala
w@@ar.addAsWebInfResource(getWebXml(),"web.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3811.java