error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1072.java
text:
```scala
r@@eturn Gdx.graphics.getHeight() - 1 - Mouse.getY();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1072.java