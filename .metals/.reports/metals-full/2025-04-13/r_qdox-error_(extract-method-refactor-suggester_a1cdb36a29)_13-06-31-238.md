error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14535.java
text:
```scala
D@@ouble.POSITIVE_INFINITY, 1.0e-6 * step, 1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14535.java