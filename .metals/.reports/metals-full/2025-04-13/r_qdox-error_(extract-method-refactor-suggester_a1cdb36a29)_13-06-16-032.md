error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16842.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16842.java
text:
```scala
final M@@arkup markup = application.newMarkupParser().readAndParse(markupResource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16842.java