error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3777.java
text:
```scala
r@@eturn new RangeSliceReply(rows);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3777.java