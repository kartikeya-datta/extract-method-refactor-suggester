error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6063.java
text:
```scala
r@@eturn new TypedValue(flibbles);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6063.java