error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11957.java
text:
```scala
F@@ield inputStreamsField = FileUpload.class.getDeclaredField("inputStreamsToClose");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11957.java