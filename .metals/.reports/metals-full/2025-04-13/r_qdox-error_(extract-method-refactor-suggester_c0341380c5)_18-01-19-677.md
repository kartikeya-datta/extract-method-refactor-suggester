error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5779.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5779.java
text:
```scala
public v@@oid onSelectionChanged(Locale newSelection)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5779.java