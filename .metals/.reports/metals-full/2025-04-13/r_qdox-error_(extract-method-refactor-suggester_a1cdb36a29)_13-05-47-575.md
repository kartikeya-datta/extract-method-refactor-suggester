error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8241.java
text:
```scala
l@@ogger.warn("[{}][{}] recovery from [{}] failed", e, request.shardId().index().name(), request.shardId().id(), request.sourceNode());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8241.java