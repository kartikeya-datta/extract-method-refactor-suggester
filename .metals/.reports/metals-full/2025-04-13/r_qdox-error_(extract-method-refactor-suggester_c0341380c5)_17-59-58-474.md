error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15053.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15053.java
text:
```scala
private i@@nt lastItemIndex = -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15053.java