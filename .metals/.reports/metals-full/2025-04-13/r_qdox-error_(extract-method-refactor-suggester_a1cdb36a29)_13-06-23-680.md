error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12423.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12423.java
text:
```scala
private final M@@ap<String, UnifiedServiceRefMetaData> references = new HashMap<String, UnifiedServiceRefMetaData>(8);
...
public final class WSReferences {
    ...
    public static WSReferences newInstance() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12423.java