error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/476.java
text:
```scala
a@@ssert currentState == stage : "Expected stage " + stage + " but was stage " + currentState;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/476.java