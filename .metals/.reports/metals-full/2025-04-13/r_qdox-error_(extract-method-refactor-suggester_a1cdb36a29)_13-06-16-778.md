error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14892.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14892.java
text:
```scala
public final I@@Crypt newCrypt()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14892.java