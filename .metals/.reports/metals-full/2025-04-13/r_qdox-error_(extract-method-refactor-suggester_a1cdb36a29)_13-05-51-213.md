error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1103.java
text:
```scala
l@@ong freq = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1103.java