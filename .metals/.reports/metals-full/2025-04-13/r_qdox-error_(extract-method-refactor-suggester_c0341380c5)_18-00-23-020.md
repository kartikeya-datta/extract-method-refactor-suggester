error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13980.java
text:
```scala
r@@eturn Objects.equal(this.scope.getName(), that.scope.getName()) && Objects.equal(this.name, that.name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13980.java