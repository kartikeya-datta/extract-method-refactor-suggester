error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3897.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3897.java
text:
```scala
protected O@@bject escapeColumnValue(final Object value)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3897.java