error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1362.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1362.java
text:
```scala
S@@tring baseName = "$anonymous"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1362.java