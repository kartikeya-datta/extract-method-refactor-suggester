error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2919.java
text:
```scala
c@@ell.free();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2919.java