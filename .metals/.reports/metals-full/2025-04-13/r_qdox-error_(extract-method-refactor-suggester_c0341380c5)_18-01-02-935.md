error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16941.java
text:
```scala
g@@en = classType.getLazyClassGen(); //new LazyClassGen(classType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16941.java