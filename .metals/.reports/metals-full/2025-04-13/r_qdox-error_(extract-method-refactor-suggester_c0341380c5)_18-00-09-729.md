error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6837.java
text:
```scala
F@@ileResourceIterator result = new FileResourceIterator(getProject(), getDir());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6837.java