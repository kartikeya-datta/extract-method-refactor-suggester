error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11316.java
text:
```scala
I@@ResourceStream getMarkupResourceStream(final MarkupContainer container,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11316.java