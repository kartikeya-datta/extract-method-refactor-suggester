error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8095.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8095.java
text:
```scala
v@@ertexAttributes.add(VertexAttribute.ColorUnpacked());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8095.java