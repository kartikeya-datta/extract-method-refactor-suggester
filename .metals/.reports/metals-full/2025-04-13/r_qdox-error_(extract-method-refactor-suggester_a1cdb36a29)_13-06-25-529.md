error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11464.java
text:
```scala
...
public class ModClusterGetProxyInfo implements OperationStepHandler, DescriptionProvider{
    ...
    public ModelNode getModelDescription(Locale locale) {
        return ModClusterSubsystemDescriptions.getProxyInfoDescription(locale);
    }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11464.java