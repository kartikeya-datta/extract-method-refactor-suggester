error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/512.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/512.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/512.java
text:
```scala
b@@oolean result = store.forceCompaction(ranges, new EndPoint("127.0.0.1", 9150), 0, fileList);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/512.java