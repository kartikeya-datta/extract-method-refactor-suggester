error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4039.java
text:
```scala
S@@tring MAX_ATTEMPTS = "max-attempts";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4039.java