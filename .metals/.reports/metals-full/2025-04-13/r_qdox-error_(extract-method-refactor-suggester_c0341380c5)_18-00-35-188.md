error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6908.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6908.java
text:
```scala
public H@@tmlBodyContainer(MarkupContainer parent,final String id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6908.java