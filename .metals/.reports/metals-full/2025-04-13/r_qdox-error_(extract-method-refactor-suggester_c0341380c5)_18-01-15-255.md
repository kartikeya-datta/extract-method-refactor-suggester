error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5989.java
text:
```scala
J@@AXRConfiguration config = JAXRConfiguration.INSTANCE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5989.java