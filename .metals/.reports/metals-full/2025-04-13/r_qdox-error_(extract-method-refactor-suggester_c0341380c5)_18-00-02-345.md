error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4778.java
text:
```scala
t@@hrow new XMLStreamException(MESSAGES.invalidTargetName(EnumSet.allOf(Target.class)), reader.getLocation());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4778.java