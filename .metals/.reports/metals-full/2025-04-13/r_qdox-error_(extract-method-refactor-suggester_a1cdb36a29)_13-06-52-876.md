error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13047.java
text:
```scala
i@@f (fileAlign != 0 && !"mcs".equals(getExecutable())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13047.java