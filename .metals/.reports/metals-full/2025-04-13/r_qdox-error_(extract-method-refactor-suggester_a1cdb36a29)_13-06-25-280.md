error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2576.java
text:
```scala
g@@etLogger().info("Skipping rollover for non-existent file {}", toRenameStr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2576.java