error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7309.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7309.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7309.java
text:
```scala
r@@eturn event.getLevel().isGreaterOrEqual(Level.ERROR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7309.java