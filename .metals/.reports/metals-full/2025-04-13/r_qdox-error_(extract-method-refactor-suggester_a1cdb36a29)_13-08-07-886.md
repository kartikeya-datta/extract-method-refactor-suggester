error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7937.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7937.java
text:
```scala
V@@irtualFile virtualFile = phaseContext.getDeploymentUnit().getAttachment(Attachments.DEPLOYMENT_ROOT).getRoot();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7937.java