error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8157.java
text:
```scala
r@@eturn this.resolvedType = qualificationTb;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8157.java