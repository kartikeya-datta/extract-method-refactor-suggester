error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5840.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5840.java
text:
```scala
b@@oolean isVarArgs, boolean isMethod, boolean isConstructor, String methodId) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5840.java