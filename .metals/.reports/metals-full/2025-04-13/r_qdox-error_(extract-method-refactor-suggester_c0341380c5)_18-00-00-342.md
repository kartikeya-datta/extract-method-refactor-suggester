error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/848.java
text:
```scala
i@@f (saveConfig.saveTimestamp()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/848.java