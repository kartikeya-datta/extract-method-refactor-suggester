error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14678.java
text:
```scala
r@@eturn HttpRequest.get(managementClient.getWebUri() + "/" + ARCHIVE_NAME + "/" + urlPattern + "?input=" + param, 100, SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14678.java