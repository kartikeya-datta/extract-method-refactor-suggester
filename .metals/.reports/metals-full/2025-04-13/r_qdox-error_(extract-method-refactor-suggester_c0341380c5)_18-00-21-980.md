error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8267.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8267.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8267.java
text:
```scala
a@@jOptions.noWeave,ajOptions.proceedOnError);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8267.java