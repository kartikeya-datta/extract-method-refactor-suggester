error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7157.java
text:
```scala
G@@dxTest test = new Box2DTestCollection();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7157.java