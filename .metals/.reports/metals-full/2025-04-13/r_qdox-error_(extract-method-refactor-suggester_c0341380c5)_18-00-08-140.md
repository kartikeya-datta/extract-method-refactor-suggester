error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2025.java
...
```java
offset: 1046
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2025.java
text:
```scala
...
p@@ackage org.elasticsearch.action.deletebyquery;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2025.java