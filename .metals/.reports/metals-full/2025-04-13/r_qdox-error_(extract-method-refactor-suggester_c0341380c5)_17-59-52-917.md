error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15066.java
text:
```scala
u@@rls = parser.getEmbeddedResourceURLs(responseData, res.getURL(), res.getDataEncodingWithDefault());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15066.java