error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2479.java
text:
```scala
a@@ctionBar.setSubtitle(string.repositories);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2479.java