error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4250.java
text:
```scala
c@@onstraints.get(i).delete();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4250.java