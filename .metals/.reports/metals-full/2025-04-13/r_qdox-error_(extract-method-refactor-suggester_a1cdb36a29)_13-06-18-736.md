error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3522.java
text:
```scala
t@@hrow new IllegalStateException("Method does not exist " + method);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3522.java