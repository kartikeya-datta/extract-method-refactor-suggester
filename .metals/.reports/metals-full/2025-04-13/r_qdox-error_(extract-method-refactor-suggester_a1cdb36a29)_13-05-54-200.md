error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12771.java
text:
```scala
r@@eturn string;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12771.java