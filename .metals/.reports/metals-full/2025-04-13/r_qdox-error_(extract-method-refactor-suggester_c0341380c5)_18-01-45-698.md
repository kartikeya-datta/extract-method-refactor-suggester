error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2023.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2023.java
text:
```scala
public C@@harSequence getPageTitle(final int position) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2023.java