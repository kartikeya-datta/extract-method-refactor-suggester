error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5877.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5877.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5877.java
text:
```scala
final N@@amingStoreService contextService = new NamingStoreService(new ServiceBasedNamingStore(phaseContext.getServiceRegistry(),moduleContextServiceName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5877.java