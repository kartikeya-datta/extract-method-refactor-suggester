error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5866.java
text:
```scala
i@@f (! (another instanceof RandomKey<?>))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5866.java