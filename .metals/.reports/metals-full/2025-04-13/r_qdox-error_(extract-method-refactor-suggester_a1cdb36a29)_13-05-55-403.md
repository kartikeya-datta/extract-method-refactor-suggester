error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15241.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15241.java
text:
```scala
private final S@@tring attribute;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15241.java