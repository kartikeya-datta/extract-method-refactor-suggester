error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5656.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5656.java
text:
```scala
a@@rgSize = methodDeclaringClass.enclosingInstancesSlotSize;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5656.java