error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14073.java
text:
```scala
n@@ew BinderServiceBuilder<>(bindInfo, name, RegistryFactory.class).build(target).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14073.java