error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3688.java
text:
```scala
r@@eturn number.byteValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3688.java