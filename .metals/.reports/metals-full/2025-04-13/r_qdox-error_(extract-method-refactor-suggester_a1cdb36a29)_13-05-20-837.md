error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2519.java
text:
```scala
i@@f (type.isMember() && method.isConstructor() && !Flags.isStatic(type.getFlags())) { // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=48261
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2519.java