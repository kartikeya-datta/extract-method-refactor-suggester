error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7043.java
text:
```scala
i@@f (offset < 0 || count < 1 || offset + count > numIndices) throw new GdxRuntimeException("Not enough indices");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7043.java