error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8713.java
text:
```scala
B@@oundedTreeSet<InternalStringTermsFacet.StringEntry> ordered = new BoundedTreeSet<InternalStringTermsFacet.StringEntry>(comparatorType.comparator(), size * numberOfShards);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8713.java