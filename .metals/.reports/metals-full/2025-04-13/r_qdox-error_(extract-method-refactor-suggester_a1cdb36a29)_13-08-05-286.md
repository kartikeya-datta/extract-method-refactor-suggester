error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9434.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9434.java
text:
```scala
public final v@@oid putAll(Map<? extends String, ?> map)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9434.java