error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10395.java
...
```java
offset: 899
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10395.java
text:
```scala
...
p@@ackage org.elasticsearch.action.admin.indices.exists.types;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10395.java