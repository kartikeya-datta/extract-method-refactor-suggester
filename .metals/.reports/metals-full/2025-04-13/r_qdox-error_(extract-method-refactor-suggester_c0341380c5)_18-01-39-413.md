error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3143.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3143.java
text:
```scala
public R@@ealVector getOffendingVector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3143.java