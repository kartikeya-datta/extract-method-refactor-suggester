error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5806.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5806.java
text:
```scala
public P@@ackageBinding defaultPackage;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5806.java