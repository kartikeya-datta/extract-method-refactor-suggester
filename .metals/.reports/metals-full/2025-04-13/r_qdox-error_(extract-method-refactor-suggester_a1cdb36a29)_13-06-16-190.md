error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10630.java
text:
```scala
S@@erviceController<?> service = context.getServiceRegistry(false).getRequiredService(Services.JBOSS_AS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10630.java