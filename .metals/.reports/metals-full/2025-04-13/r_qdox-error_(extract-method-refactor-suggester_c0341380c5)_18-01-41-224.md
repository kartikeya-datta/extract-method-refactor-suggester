error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9089.java
text:
```scala
r@@eturn (clazz.getMethod("clone", (Class []) null).invoke(value, (Object []) null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9089.java