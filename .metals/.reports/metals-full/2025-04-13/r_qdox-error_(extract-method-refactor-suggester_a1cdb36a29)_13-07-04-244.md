error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2095.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2095.java
text:
```scala
t@@hrow new RuntimeException("Couldn't acquire the shard lock");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2095.java