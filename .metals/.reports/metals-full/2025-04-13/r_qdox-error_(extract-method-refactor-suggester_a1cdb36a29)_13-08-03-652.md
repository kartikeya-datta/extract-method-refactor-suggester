error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1533.java
text:
```scala
S@@torageService.instance().updateForeignTokenUnsafe(new BigIntegerToken(new BigInteger(values[0])), address);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1533.java