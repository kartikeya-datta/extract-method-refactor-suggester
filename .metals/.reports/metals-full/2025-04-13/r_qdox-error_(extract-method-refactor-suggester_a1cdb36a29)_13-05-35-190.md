error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6770.java
text:
```scala
D@@eltaProcessingState state = JavaModelManager.getDeltaState();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6770.java