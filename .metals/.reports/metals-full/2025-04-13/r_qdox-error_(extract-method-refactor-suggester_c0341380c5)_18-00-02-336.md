error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12666.java
text:
```scala
r@@eturn (binding.getAnnotationTagBits() & TagBits.AnnotationRuntimeRetention)!=0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12666.java