error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9907.java
text:
```scala
i@@ndexRandom(false, false, false, Arrays.asList(builders));  // this one
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9907.java