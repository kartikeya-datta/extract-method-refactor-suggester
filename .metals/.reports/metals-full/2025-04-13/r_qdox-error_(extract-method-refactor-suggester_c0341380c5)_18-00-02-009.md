error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/442.java
text:
```scala
i@@f (this.useCount == 0) { // was destroyed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/442.java