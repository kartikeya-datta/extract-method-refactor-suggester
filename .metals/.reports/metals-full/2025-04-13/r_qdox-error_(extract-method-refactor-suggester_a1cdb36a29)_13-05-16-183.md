error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5925.java
text:
```scala
s@@uper(APP_CLIENT_COMPONENT_NAME, componentClassName, moduleDescription, deploymentUnitServiceName);
...
public final class ApplicationClientComponentDescription extends ComponentDescription {
    ...
    public ComponentConfiguration createConfiguration(final ClassIndex classIndex) {
        final ComponentConfiguration configuration =  super.createConfiguration(classIndex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5925.java