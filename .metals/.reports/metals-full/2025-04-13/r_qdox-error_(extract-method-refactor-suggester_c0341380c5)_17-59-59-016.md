error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1268.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1268.java
text:
```scala
s@@tartActivityForResult(IssuesViewActivity.createIntent(items, position - getListAdapter().getHeadersCount()),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1268.java