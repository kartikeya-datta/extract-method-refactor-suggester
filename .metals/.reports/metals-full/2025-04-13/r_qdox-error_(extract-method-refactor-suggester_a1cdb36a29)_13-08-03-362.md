error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10480.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10480.java
text:
```scala
public N@@onePredicate(final Predicate<? super T>... predicates) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10480.java