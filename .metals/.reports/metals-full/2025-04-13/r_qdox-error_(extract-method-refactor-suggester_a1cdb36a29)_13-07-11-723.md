error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13944.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13944.java
text:
```scala
M@@odel model = new Model(list);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13944.java