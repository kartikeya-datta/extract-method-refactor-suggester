error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1031.java
text:
```scala
r@@oot.draw(batch, 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1031.java