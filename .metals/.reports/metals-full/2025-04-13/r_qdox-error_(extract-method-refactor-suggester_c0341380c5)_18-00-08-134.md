error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3473.java
text:
```scala
u@@pdateLayout (shellHandle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3473.java