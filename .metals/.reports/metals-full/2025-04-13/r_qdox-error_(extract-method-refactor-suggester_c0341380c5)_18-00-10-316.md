error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9207.java
text:
```scala
i@@f (glyphs[i] == fp.wgDefault) break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9207.java