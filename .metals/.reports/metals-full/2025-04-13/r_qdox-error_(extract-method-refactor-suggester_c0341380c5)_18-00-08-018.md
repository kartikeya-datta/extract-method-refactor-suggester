error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5061.java
text:
```scala
i@@nt index = test.getName().lastIndexOf('.');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5061.java