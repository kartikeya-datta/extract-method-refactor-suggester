error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3435.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3435.java
text:
```scala
public R@@equiredTextField(MarkupContainer parent, final String id, final Class<? extends T> type)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3435.java