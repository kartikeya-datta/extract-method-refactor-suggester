error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3228.java
text:
```scala
L@@ist as = BcelAttributes.readAjAttributes(method.getAttributes(), getSourceContext(world),world.getMessageHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3228.java