error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3749.java
...
```java
offset: 776
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3749.java
text:
```scala
...
//
//All Rights Reserved.
p@@ackage org.columba.addressbook.folder;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3749.java