error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/585.java
text:
```scala
f@@s = FileSystem.get(output.toUri(), conf);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/585.java