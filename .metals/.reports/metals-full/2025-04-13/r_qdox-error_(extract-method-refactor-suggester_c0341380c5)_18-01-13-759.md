error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/606.java
text:
```scala
S@@electBox dropdown = new SelectBox(new String[] {"Android", "Windows", "Linux", "OSX","Android", "Windows", "Linux", "OSX","Android", "Windows", "Linux", "OSX","Android", "Windows", "Linux", "OSX","Android", "Windows", "Linux", "OSX","Android", "Windows", "Linux", "OSX","Android", "Windows", "Linux", "OSX"}, skin);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/606.java