error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4928.java
text:
```scala
T@@est.this.notifyAll();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4928.java