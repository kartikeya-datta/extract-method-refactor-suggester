error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12604.java
text:
```scala
r@@egistration.registerSubModel(new PropertyResourceDefinition());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12604.java