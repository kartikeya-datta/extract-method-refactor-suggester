error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3369.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3369.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3369.java
text:
```scala
S@@tring LANG_OPERATION_NOT_ALLOWED_ON_SESSION_SCHEMA_TABLES = "XCL51.S";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3369.java