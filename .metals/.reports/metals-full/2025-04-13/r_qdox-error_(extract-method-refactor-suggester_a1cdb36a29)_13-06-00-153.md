error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4087.java
text:
```scala
i@@nt lastEventTime, visibleCount = 10;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4087.java