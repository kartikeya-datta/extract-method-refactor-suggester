error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5174.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5174.java
text:
```scala
private L@@oopbackOutputStream os;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5174.java