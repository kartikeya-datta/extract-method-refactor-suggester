error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16238.java
text:
```scala
c@@ontentLength = Integer.parseInt(contentLengthHeaderValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16238.java