error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3486.java
text:
```scala
r@@eturn originalMessage.getReply(FBUtilities.getLocalAddress(), data, originalMessage.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3486.java