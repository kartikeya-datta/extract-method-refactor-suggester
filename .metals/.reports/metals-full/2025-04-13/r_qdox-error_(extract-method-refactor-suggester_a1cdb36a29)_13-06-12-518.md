error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1813.java
text:
```scala
i@@f(deploymentUnit.getAttachment(Attachments.SERVICES).getServiceImplementations(ServiceActivator.class.getName()).isEmpty())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1813.java