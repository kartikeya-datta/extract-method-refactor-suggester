error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5861.java
text:
```scala
r@@eturn CommandContextFactory.getInstance().newCommandContext("http-remoting", serverAddr, serverPort, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5861.java