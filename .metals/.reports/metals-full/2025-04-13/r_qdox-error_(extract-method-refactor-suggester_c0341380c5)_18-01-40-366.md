error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3200.java
text:
```scala
f@@ullyQualifiedFile.endsWith("/examples/declare-warning/apackage/SomeClass.java"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3200.java