error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14.java
text:
```scala
i@@f (_committedTo != lastCompletedOffset) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14.java