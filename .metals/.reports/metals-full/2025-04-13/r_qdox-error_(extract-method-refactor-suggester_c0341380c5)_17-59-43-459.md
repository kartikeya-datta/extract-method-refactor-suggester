error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3300.java
text:
```scala
o@@ptimize(1, doWait);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3300.java