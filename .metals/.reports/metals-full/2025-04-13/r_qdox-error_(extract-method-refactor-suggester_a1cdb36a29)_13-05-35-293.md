error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6446.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6446.java
text:
```scala
public T@@okenStream tokenStream(Analyzer analyzer, TokenStream previous) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6446.java