error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2946.java
text:
```scala
S@@impleVertexShader.class, ShapeRendererTest.class, MoveSpriteExample.class, UISimpleTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2946.java