error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1430.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1430.java
text:
```scala
public v@@oid consumeParameterizedGenericMethod() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1430.java