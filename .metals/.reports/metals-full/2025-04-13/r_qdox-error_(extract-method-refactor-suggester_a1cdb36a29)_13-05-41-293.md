error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3241.java
text:
```scala
b@@f = BloomFilter.getFilter(keyCount, 15);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3241.java