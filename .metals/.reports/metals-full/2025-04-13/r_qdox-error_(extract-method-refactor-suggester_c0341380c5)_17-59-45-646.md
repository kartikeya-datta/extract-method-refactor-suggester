error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1198.java
text:
```scala
t@@his.optimizedBooleanConstant = BooleanConstant.fromValue(!cst.booleanValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1198.java