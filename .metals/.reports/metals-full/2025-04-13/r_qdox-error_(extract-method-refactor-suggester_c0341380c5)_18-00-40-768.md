error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6645.java
text:
```scala
.@@getNamespace(), 0,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6645.java