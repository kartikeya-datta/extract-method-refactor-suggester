error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9948.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9948.java
text:
```scala
protected S@@hardValidateQueryRequest newShardRequest(int numShards, ShardRouting shard, ValidateQueryRequest request) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9948.java