error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1675.java
text:
```scala
C@@olumbaLogger.log.info("item=" + item.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1675.java