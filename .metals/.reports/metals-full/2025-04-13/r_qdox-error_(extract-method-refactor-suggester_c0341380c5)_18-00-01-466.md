error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6405.java
text:
```scala
a@@ppend(message, date.minute, 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6405.java