error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/58.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/58.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/58.java
text:
```scala
L@@ist getComponentResolvers();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/58.java