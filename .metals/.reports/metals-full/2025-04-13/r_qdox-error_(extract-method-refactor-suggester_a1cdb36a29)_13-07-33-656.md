error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1116.java
text:
```scala
i@@f (isCustomResize ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1116.java