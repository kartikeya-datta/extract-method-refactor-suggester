error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9215.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9215.java
text:
```scala
private static C@@lass<?> closeableInterface;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9215.java