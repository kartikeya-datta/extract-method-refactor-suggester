error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3918.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3918.java
text:
```scala
public v@@oid testEncode() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3918.java