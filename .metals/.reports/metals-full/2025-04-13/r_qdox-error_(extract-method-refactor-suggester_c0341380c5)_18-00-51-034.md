error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/798.java
text:
```scala
M@@essageService.getTextMessage(MessageId.OBJECT_CLOSED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/798.java