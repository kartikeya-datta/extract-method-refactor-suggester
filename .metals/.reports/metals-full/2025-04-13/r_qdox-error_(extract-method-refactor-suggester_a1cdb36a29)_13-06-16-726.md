error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7843.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7843.java
text:
```scala
static i@@nt /*long*/ createPixbuf(Image image) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7843.java