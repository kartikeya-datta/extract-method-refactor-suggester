error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7075.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7075.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7075.java
text:
```scala
G@@dxTest test = new TiledMapDirectLoaderTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7075.java