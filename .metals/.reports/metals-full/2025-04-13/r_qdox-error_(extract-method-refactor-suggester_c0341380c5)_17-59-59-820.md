error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3300.java
text:
```scala
b@@yte[] defaultFont = device.systemFont.handle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3300.java