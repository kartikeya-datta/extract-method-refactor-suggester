error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6606.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6606.java
text:
```scala
public S@@tring getTitleToolTipText() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6606.java