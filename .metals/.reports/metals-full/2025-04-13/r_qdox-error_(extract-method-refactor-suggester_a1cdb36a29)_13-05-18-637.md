error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16990.java
text:
```scala
w@@idth = Math.max (width, parent.calculateWidth (handle, iter, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16990.java