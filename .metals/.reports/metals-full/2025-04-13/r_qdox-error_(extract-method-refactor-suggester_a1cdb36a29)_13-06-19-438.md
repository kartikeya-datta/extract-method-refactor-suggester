error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10890.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10890.java
text:
```scala
e@@lse if (s instanceof StringBuilder)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10890.java