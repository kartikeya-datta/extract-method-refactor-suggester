error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8068.java
text:
```scala
S@@erviceController<?> controller = context.getServiceRegistry(false).getService(serviceNameBase.append(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8068.java