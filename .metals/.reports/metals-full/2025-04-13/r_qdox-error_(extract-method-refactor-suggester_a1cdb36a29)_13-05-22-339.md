error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15599.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15599.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15599.java
text:
```scala
i@@nt idx = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15599.java