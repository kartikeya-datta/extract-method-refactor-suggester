error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/571.java
text:
```scala
J@@sonBuilder generator = RestJsonBuilder.restJsonBuilder(request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/571.java