error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2592.java
text:
```scala
d@@eleteByQueryRequest.query(RestActions.parseQuerySource(request));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2592.java