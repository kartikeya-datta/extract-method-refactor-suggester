error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3266.java
text:
```scala
r@@eturn client_map.get(key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3266.java