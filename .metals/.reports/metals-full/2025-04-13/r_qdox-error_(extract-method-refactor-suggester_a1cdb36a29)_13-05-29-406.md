error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2672.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2672.java
text:
```scala
private static final S@@tring BUNDLE_NAME = "org.eclipse.ecf.internal.remoteservice.rpc.messages"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2672.java