error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3819.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3819.java
text:
```scala
d@@isplay.isPainting.removeObjectIdenticalTo(view);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3819.java