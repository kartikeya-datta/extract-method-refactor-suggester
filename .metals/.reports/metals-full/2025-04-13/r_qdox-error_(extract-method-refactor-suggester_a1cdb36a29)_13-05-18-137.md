error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1957.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[89,2]

error in qdox parser
file content:
```java
offset: 2530
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1957.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1957.java