error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5218.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5218.java
text:
```scala
public l@@ong getTotalHits() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5218.java