error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1049.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1049.java
text:
```scala
i@@f(message != null && message.indexOf("Connection reset") != -1)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1049.java