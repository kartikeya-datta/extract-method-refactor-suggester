error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2835.java
text:
```scala
h@@ash = Util.combineHashCodes(hash, fParameterTypes[i].hashCode());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2835.java