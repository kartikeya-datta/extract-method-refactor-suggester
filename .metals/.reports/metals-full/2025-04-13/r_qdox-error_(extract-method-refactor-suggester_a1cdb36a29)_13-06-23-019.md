error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12443.java
text:
```scala
i@@nt squigglyThickness = underlineThickness;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12443.java