error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9931.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9931.java
text:
```scala
final I@@nternalAggregations aggs = InternalAggregations.reduce(subAggregationsList, reduceContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9931.java