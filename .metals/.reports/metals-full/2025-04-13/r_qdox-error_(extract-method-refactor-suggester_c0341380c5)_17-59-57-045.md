error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14617.java
text:
```scala
t@@ag.put("size", Math.min(maxRows, getChoices().size()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14617.java