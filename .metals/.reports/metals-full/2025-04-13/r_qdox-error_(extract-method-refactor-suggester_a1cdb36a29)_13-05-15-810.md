error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1232.java
text:
```scala
c@@onstraints.get(i).dispose();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1232.java