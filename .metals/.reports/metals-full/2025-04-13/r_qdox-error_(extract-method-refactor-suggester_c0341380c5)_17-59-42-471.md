error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4107.java
text:
```scala
i@@f (substituteReturnType.actualType() != existingReturnType.actualType())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4107.java