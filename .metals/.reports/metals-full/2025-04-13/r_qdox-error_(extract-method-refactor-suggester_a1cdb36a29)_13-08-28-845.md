error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13492.java
text:
```scala
t@@kn.type = COMMENT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13492.java