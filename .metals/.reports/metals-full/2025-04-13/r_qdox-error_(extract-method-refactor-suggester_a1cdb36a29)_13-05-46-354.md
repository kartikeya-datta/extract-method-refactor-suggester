error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9808.java
text:
```scala
i@@f (currentManager!=null && currentManager.getSize() > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9808.java