error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6931.java
text:
```scala
A@@rray<AssetDescriptor> deps = new Array<AssetDescriptor>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6931.java