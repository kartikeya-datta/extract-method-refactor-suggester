error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11636.java
text:
```scala
A@@ssert.assertEquals(SpelMessage.TYPE_NOT_FOUND,sEx.getMessageCode());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11636.java