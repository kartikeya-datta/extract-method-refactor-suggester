error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3472.java
text:
```scala
u@@pdateLayout (topHandle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3472.java