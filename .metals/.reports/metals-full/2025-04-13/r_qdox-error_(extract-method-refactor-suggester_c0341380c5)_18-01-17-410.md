error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9901.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9901.java
text:
```scala
private static final S@@tring TAG = "LoginActivity";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9901.java