error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7323.java
text:
```scala
S@@tring servletURL = externalFormURL.substring(0, externalFormURL.length() - 1) + ".war" + PolicyContextTestServlet.SERVLET_PATH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7323.java