error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8706.java
text:
```scala
t@@his.ast = AST.convertCompilationUnit(this.astLevel, unit, contents, options, true/*isResolved*/, workingCopy, this.progressMonitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8706.java