error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1349.java
text:
```scala
i@@f (Gdx.input.isTouched()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1349.java