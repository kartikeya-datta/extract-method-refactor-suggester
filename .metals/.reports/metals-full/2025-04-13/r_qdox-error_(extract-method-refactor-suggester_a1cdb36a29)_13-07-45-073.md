error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16031.java
text:
```scala
i@@f (value < 0) error (SWT.ERROR_INVALID_ARGUMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16031.java