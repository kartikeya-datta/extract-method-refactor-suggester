error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6861.java
text:
```scala
r@@eturn "null"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6861.java