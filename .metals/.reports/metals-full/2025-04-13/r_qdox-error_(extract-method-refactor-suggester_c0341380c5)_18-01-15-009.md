error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4440.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4440.java
text:
```scala
public b@@oolean isConsistent() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4440.java