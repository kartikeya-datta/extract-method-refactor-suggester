error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5417.java
text:
```scala
w@@hile (menu.cascade != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5417.java