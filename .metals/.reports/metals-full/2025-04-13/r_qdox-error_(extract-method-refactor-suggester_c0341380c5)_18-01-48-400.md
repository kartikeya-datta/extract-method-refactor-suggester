error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10767.java
text:
```scala
r@@eturn sb.append("![").append(getChild(0).toStringAST()).append("]").toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10767.java