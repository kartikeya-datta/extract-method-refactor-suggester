error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10376.java
text:
```scala
s@@earchSourceBuilder.explain(request.paramAsBoolean("explain", null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10376.java