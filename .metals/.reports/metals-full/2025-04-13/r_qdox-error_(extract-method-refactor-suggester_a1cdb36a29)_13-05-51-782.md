error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2893.java
text:
```scala
s@@uper("not positive definite matrix");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2893.java