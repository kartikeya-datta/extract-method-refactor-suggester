error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4142.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4142.java
text:
```scala
public M@@ethodBinding memberBinding; // unique member method binding
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4142.java