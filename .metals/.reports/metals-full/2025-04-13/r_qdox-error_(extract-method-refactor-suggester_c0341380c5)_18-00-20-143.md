error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6744.java
text:
```scala
s@@etBackground(background);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6744.java