error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9969.java
text:
```scala
t@@ester.getRequest().setUrl(tester.getRequestCycle().mapUrlFor(invalidResource, null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9969.java