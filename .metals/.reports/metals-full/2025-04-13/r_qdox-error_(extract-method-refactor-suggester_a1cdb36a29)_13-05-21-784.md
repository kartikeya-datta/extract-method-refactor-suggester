error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17641.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[135,27]

error in qdox parser
file content:
```java
offset: 4785
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17641.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17641.java