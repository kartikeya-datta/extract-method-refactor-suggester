error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3575.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3575.java
text:
```scala
public static final V@@ersion V_2_0_0 = new Version(V_2_0_0_ID, true, org.apache.lucene.util.Version.LUCENE_4_10_0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3575.java