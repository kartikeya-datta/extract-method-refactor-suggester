error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5672.java
...
```java
offset: 903
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5672.java
text:
```scala
...
p@@ackage org.elasticsearch.index.analysis;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5672.java