error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8985.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8985.java
text:
```scala
public b@@oolean supports(Class<?> clazz) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8985.java