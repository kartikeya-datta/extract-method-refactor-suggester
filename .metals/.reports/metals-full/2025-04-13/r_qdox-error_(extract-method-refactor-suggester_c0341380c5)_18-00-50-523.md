error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5584.java
text:
```scala
s@@priteSheet = new SpriteSheet(Gdx.files.internal("data"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5584.java