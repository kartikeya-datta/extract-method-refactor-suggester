error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1440.java
text:
```scala
r@@ect.right = Math.max (rect.right, itemRect.right);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1440.java