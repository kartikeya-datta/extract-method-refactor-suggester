error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14802.java
text:
```scala
n@@ew Class[] { String.class }, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14802.java