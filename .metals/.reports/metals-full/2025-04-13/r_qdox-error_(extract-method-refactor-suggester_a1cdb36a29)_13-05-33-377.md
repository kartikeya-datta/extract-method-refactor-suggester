error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2846.java
text:
```scala
c@@ountRequest.query(request.contentByteArray(), request.contentByteArrayOffset(), request.contentLength(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2846.java