error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/457.java
text:
```scala
I@@OContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/457.java