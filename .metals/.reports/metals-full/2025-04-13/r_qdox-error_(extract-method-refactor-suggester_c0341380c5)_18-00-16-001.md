error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16885.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16885.java
text:
```scala
public I@@Converter getConverter(Class< ? > type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16885.java