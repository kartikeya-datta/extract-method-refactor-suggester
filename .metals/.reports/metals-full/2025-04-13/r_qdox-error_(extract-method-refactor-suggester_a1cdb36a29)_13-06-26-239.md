error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1313.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1313.java
text:
```scala
public O@@bject initializeTransaction(long txid, Object prevMetadata) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1313.java