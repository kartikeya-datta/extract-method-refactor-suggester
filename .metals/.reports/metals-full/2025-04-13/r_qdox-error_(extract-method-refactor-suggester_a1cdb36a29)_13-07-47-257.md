error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6403.java
text:
```scala
O@@bject uid = folder.addMessage(message.getSource());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6403.java