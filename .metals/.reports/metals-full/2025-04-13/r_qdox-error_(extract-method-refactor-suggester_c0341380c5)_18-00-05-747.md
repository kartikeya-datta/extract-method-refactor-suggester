error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3422.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3422.java
text:
```scala
final D@@istance precision = new Distance(1+(randomDouble() * 9), randomFrom(Arrays.asList(DistanceUnit.MILLIMETERS, DistanceUnit.METERS, DistanceUnit.KILOMETERS)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3422.java