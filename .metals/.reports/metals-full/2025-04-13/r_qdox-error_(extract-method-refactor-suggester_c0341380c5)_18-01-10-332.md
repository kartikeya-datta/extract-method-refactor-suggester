error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1689.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1689.java
text:
```scala
G@@dxTest test = new TimerTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1689.java