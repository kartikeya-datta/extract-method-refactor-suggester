error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8533.java
text:
```scala
t@@his(input, CSVFormat.RFC4180_EMPTY_LINES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8533.java