error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6952.java
text:
```scala
i@@f (!newText.equals (oldText)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6952.java