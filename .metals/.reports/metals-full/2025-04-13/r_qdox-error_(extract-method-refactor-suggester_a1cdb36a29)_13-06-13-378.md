error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7929.java
text:
```scala
J@@MeterUtils.getResString("save?"),  // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7929.java