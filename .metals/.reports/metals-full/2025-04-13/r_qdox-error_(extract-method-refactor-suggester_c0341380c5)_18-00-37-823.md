error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4624.java
text:
```scala
P@@ixmapPacker packer =  new PixmapPacker(256, 256, Format.RGBA8888, 2, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4624.java