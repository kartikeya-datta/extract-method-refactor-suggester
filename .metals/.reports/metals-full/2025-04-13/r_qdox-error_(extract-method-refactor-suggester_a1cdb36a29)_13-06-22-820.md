error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5363.java
text:
```scala
S@@ettings.getInstance().setStdOut(consoleOutput);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5363.java