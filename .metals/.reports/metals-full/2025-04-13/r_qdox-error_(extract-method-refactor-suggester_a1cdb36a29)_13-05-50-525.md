error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10526.java
text:
```scala
M@@BeanServerConnectionProvider provider = new MBeanServerConnectionProvider(InetAddress.getByName("127.0.0.1"), 1090);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10526.java