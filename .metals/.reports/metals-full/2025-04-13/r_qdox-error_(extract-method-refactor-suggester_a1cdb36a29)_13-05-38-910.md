error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8418.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8418.java
text:
```scala
public I@@Resource getResource()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8418.java