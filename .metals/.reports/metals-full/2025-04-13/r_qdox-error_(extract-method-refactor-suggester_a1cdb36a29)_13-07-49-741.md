error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9725.java
text:
```scala
r@@eturn Math.exp(0.5 * Math.pow(value, 2.0) / scale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9725.java