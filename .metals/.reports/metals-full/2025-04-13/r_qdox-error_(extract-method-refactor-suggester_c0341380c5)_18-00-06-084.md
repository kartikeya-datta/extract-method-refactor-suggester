error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3727.java
text:
```scala
i@@f (server.hasDefined(SOCKET_BINDING_PORT_OFFSET) && server.get(SOCKET_BINDING_PORT_OFFSET).asInt() > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3727.java