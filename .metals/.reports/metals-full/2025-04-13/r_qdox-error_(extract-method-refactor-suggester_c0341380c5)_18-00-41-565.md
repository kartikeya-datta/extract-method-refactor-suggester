error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14859.java
text:
```scala
i@@f (editor == null && convertedValue == newValue) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14859.java