error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1759.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1759.java
text:
```scala
public static final S@@tring version = "1.0 Milestone M1";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1759.java