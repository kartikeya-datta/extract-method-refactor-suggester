error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14381.java
text:
```scala
l@@Param = (pt.x & 0xFFFF) | ((pt.y << 16) & 0xFFFF0000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14381.java