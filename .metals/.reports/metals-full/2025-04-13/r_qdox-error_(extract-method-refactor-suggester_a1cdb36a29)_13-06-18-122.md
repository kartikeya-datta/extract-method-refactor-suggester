error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1057.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1057.java
text:
```scala
Q@@ueueConnectionFactory qcf = lookup(utils, "RemoteConnectionFactory", QueueConnectionFactory.class);
...
import org.jboss.as.demos.jms.client.mbean.FakeJndi;
...
public class ExampleRunner {
    ...
    private static <T> T lookup(DeploymentUtils utils, String name, Class<T> expected) throws Exception {
        ...
        ObjectName objectName = new ObjectName("jboss:name=test,type=jmsclient-fakejndi");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1057.java