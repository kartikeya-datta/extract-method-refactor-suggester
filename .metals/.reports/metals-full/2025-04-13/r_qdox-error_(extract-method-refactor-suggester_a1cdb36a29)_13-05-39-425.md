error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/179.java
text:
```scala
S@@egmentInfo info = writer.newestSegment();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/179.java