error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6838.java
text:
```scala
C@@ombineFunction combineFunction = CombineFunction.MULT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6838.java