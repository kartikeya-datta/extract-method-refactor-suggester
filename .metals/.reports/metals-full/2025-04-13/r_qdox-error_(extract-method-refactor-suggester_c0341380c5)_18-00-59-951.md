error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12887.java
text:
```scala
r@@eturn super.executeInternal();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12887.java