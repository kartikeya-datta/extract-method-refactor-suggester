error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3580.java
text:
```scala
r@@eturn new ArrayRealVector(out, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3580.java