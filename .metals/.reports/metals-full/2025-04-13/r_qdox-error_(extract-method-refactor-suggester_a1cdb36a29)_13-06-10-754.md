error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9976.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9976.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9976.java
text:
```scala
S@@tring sessionId, String transport) throws SockJsException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9976.java