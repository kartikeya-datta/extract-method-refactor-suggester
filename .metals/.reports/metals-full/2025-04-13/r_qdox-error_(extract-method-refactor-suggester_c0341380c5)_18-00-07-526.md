error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7588.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7588.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7588.java
text:
```scala
public static final F@@ieldType SIZE_FIELD_TYPE = new FieldType(IntegerFieldMapper.Defaults.FIELD_TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7588.java