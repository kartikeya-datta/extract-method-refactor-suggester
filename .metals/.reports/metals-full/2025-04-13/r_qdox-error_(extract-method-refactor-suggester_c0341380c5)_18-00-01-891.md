error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4153.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4153.java
text:
```scala
s@@pare = new LongTerms.Bucket(0, 0, null, showTermDocCountError, 0, formatter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4153.java