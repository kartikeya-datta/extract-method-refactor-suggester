error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8525.java
text:
```scala
S@@corer subQueryScorer = subQueryWeight.scorer(context, scoreDocsInOrder, false, acceptDocs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8525.java