error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9437.java
text:
```scala
i@@ndexTemplateService.removeTemplates(new MetaDataIndexTemplateService.RemoveRequest(request.name()).masterTimeout(request.masterNodeTimeout()), new MetaDataIndexTemplateService.RemoveListener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9437.java