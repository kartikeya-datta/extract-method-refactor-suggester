error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1547.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1547.java
text:
```scala
private static final S@@tring TAG = "RequestReader";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1547.java