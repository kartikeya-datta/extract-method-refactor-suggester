error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2880.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2880.java
text:
```scala
f@@ilter = fieldMapper.fieldDataTermsFilter(terms, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2880.java