error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3506.java
text:
```scala
c@@onn = qcf.createQueueConnection("guest", "guest");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3506.java