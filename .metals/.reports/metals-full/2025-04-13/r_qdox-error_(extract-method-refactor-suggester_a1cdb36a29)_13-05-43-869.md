error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6848.java
text:
```scala
t@@hrow new ElasticsearchIllegalArgumentException("the field [" + highlighterContext.fieldName + "] should be indexed with positions and offsets in the postings list to be used with postings highlighter");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6848.java