error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12942.java
text:
```scala
r@@eturn "new Ajax.Updater('counter', '" + urlFor(ILinkListener.INTERFACE)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12942.java