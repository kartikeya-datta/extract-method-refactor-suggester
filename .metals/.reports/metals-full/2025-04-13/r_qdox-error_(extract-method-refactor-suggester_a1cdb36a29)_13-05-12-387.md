error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6604.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6604.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6604.java
text:
```scala
t@@his.mul(tmpMat.setToTranslation(-position.x, -position.y, -position.z));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6604.java