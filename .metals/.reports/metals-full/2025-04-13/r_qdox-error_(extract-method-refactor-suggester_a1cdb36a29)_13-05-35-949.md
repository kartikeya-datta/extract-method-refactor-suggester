error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12711.java
text:
```scala
i@@f (deploymentUnitName.endsWith(".war") || deploymentUnitName.endsWith(".wab") || deploymentUnitName.endsWith(".jar") || deploymentUnitName.endsWith(".ear") || deploymentUnitName.endsWith(".rar")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12711.java