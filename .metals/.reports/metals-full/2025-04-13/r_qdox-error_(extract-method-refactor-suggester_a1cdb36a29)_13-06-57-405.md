error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2882.java
text:
```scala
b@@uf.append("params=").append(parameters == null ? "" : Arrays.asList(parameters)).append(";");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2882.java