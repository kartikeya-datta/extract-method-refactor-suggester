error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4262.java
text:
```scala
b@@oolean signedIn = cycle.getSession().getProperty("signin.user") != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4262.java