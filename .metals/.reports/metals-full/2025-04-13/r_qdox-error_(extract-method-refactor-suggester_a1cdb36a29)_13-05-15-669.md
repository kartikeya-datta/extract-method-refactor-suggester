error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5033.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,35]

error in qdox parser
file content:
```java
offset: 35
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5033.java
text:
```scala
"Invalid configuration type: '" + c@@onfigurationType + "'.  Must be \"development\" or \"deployment\".");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5033.java