error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9544.java
text:
```scala
m@@ultiplyLabel.add(new BeforeAndAfterBorder());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9544.java