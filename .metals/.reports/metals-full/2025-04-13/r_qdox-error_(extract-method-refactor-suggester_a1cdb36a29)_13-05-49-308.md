error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17901.java
text:
```scala
a@@pplication.getWicketServlet().doGet(servletRequest, servletResponse);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17901.java