error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2462.java
text:
```scala
c@@heckVersion(SampleSaveConfigurationConverter.class,"515417"); // $NON-NLS-1$
...
public class SaveService {
    ...
    static boolean checkVersions() {
        ...
        checkVersion(SampleSaveConfigurationConverter.class,"515348"); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2462.java