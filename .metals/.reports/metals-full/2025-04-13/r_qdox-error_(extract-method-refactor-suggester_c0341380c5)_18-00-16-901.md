error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16867.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16867.java
text:
```scala
final T@@ypeFactory typeFactory = getTypeFactory( AspectHandler.class );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16867.java