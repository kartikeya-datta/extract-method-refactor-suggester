error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8113.java
text:
```scala
i@@con = new ImageIcon(((ImageIcon)icon).getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8113.java