error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/954.java
text:
```scala
a@@utoAdd(new Label(this,"test", "TEST")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/954.java