error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5814.java
text:
```scala
f@@or (int i = 0, n = capacity + stashSize; i < n; i++)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5814.java