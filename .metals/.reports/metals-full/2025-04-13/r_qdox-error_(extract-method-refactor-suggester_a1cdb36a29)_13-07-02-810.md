error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3483.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3483.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3483.java
text:
```scala
M@@essage response = message.getInternalReply(tokenString.getBytes(Charsets.UTF_8), message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3483.java