error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3420.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3420.java
text:
```scala
public static S@@tring JNDI_NAME = "java:/SimpleRealmMapping";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3420.java