error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8222.java
text:
```scala
i@@f (serialized && iter.hasNext()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8222.java