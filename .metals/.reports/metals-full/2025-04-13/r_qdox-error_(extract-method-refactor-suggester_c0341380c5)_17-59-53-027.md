error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10079.java
text:
```scala
r@@eturn readResource("undertow-1.1.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10079.java