error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6315.java
text:
```scala
c@@ontext.getServiceTarget().addService(MessagingSubsystemElement.CORE_QUEUE_BASE.append(name), service)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6315.java