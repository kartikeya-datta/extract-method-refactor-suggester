error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9735.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9735.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9735.java
text:
```scala
r@@emoteSupportedConfigs, connectTargetID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9735.java