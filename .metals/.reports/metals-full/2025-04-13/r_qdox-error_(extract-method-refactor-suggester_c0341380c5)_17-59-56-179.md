error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12425.java
text:
```scala
N@@SPoint viewLoc = control.view.convertPoint_fromView_(windowLoc, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12425.java