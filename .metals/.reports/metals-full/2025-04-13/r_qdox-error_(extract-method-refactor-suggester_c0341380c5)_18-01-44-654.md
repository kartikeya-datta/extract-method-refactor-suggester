error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9439.java
text:
```scala
M@@apperQueryParser queryParser = new MapperQueryParser(fieldName, analyzer, parseContext.mapperService(), parseContext.indexCache());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9439.java