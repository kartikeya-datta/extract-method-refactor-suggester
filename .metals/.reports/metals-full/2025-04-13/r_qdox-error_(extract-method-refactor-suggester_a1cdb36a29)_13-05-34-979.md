error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9491.java
text:
```scala
a@@dd(new BookmarkablePageLink<Void>("customLoadingPageLink", PageWithCustomLoading.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9491.java