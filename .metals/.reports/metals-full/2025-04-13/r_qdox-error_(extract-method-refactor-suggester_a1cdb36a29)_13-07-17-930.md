error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1001.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1001.java
text:
```scala
D@@erby - Class org.apache.derbyTesting.functionTests.harness.ibm16
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1001.java