error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17092.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17092.java
text:
```scala
final S@@tring value = container.getApplication().getMarkupSettings().getLocalizer().getString(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17092.java