error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6393.java
text:
```scala
s@@etTitle("Columba - version: " + org.columba.core.main.MainInterface.version);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6393.java