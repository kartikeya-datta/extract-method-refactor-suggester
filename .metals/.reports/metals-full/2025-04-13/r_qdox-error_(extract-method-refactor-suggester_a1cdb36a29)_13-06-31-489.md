error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4194.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4194.java
text:
```scala
final I@@Crypt crypt = new SunJceCrypt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4194.java