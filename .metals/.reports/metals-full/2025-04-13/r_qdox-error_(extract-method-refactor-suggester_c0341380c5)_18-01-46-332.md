error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8617.java
text:
```scala
i@@nt /*long*/ handle = ((LONG)data [0]).value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8617.java