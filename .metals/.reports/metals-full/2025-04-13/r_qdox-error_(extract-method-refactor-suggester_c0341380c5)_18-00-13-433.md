error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13402.java
text:
```scala
i@@f (vars != null && varName.length() > 0) {// vars will be null on TestPlan
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13402.java