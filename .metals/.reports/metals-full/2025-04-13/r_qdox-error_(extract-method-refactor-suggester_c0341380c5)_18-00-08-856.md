error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5908.java
text:
```scala
r@@eturn utilities.getSecurityManager().isCallerInRole(securityMetaData.getSecurityRoles(), roleName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5908.java