error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2644.java
text:
```scala
r@@edrawWidget(topView (), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2644.java