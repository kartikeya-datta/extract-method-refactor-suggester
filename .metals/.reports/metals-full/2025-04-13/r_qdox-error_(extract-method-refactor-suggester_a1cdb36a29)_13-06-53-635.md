error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6498.java
text:
```scala
j@@arRoot.getWorkspace().getRoot().setPersistentProperty(jarRoot.getSourceAttachmentPropertyName(), null); // lose info - will be recomputed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6498.java