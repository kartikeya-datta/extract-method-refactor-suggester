error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14268.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14268.java
text:
```scala
I@@mage foregroundImage, backgroundImage;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14268.java