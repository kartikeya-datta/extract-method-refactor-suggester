error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18150.java
text:
```scala
i@@f ((state & CANVAS) != 0 && socketHandle == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18150.java