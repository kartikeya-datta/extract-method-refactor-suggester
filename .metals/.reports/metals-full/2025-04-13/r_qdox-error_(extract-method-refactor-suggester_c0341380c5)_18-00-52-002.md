error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7027.java
text:
```scala
D@@irtyRenderingTest.class, FreeTypeTest.class, YDownTest.class};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7027.java