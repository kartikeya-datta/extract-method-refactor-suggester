error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5834.java
text:
```scala
B@@obTest.class, ImageScaleTest.class, TableLayoutTest.class, Box2DTest.class, BulletTest.class, InterpolationTest.class, TouchpadTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5834.java