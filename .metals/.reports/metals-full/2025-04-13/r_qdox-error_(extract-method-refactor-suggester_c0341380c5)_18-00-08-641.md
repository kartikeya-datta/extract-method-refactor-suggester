error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6239.java
text:
```scala
r@@ecordComment(TokenNameCOMMENT_LINE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6239.java