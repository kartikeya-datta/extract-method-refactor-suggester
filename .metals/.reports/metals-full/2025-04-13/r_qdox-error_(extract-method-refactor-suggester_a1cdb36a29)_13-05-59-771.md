error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5915.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5915.java
text:
```scala
public S@@tring getRuleName() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5915.java