error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/321.java
text:
```scala
i@@f (!this.name.equals(name)) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/321.java