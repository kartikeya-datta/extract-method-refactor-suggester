error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5639.java
text:
```scala
G@@dxTest test = new TiledMapBench();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5639.java