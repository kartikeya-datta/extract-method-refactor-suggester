error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3509.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3509.java
text:
```scala
p@@ublic class DummyComponent<T> extends Component<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3509.java