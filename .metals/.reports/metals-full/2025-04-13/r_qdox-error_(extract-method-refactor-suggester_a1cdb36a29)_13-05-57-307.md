error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5266.java
text:
```scala
a@@llInterfaces.add(intf);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5266.java