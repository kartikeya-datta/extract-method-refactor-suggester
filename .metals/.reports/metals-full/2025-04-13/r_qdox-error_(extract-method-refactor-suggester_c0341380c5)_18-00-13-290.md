error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4705.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4705.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4705.java
text:
```scala
i@@f (atlasFile.exists()) atlasFilePath = atlasFile.path();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4705.java