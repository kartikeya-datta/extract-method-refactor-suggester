error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15234.java
text:
```scala
r@@eturn gamma.getShape() * 2.0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15234.java