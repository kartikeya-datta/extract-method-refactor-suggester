error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14250.java
text:
```scala
t@@hrow new DecoderException("Invalid URL encoding: ", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14250.java