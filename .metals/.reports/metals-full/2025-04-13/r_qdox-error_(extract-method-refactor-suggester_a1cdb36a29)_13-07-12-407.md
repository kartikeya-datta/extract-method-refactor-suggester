error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3164.java
text:
```scala
i@@f (type.isRawType() && (this.bits & IgnoreRawTypeCheck) == 0 && scope.compilerOptions().reportRawTypeReference) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3164.java