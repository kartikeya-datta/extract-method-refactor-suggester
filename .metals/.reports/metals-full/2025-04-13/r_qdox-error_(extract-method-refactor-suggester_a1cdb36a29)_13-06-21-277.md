error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10666.java
text:
```scala
r@@eturn PropertyVariableInterpolator.interpolate(string, model.getObject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10666.java