error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9943.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9943.java
text:
```scala
protected S@@hardOptimizeRequest newShardRequest(int numShards, ShardRouting shard, OptimizeRequest request) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9943.java