error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1795.java
text:
```scala
v@@oid drawWidget (int /*long*/ id, NSRect rect) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1795.java