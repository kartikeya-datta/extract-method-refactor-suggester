error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/90.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/90.java
...
```java
offset: 677
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/90.java
text:
```scala
...
p@@ackage org.apache.commons.math;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/90.java