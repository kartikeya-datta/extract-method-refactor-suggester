error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13237.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13237.java
text:
```scala
public I@@mageResource imageResource(final String label)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13237.java