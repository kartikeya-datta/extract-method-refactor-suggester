error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3128.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3128.java
text:
```scala
private final M@@ap<String, Boolean> singletonNames = new ConcurrentHashMap<String, Boolean>(64);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3128.java