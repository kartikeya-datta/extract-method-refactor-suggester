error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9852.java
text:
```scala
i@@f (refs == null || refs.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9852.java