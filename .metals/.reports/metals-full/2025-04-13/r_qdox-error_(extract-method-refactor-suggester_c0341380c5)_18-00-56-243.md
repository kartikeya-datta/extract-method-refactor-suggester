error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5104.java
text:
```scala
w@@ebRequest.getResponse().setStatus(this.responseStatus.value());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5104.java