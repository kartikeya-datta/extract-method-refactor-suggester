error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4672.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4672.java
text:
```scala
public I@@OleInPlaceObject(int /*long*/ address) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4672.java