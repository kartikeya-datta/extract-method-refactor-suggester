error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2472.java
text:
```scala
o@@utlineView.selectRowIndexes (set, (style & SWT.MULTI) != 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2472.java