error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10165.java
text:
```scala
N@@odeIndicesStats stats();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10165.java