error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5704.java
text:
```scala
i@@nt index = (int)/*64*/headerView.columnAtPoint (location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5704.java