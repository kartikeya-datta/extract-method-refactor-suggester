error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/208.java
text:
```scala
m@@id = tab[lo0 + (hi0 - lo0) / 2];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/208.java