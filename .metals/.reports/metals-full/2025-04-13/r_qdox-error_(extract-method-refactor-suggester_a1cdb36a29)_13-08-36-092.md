error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1820.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1820.java
text:
```scala
r@@esult.get(0, TimeUnit.MILLISECONDS); // throws the exception if one occurred during the invocation
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1820.java