error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1578.java
...
```java
offset: 1125
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1578.java
text:
```scala
 ...
 */
p@@ackage org.wildfly.clustering.web.undertow.session;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1578.java