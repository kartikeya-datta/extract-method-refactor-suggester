error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6221.java
text:
```scala
c@@luster().wipeIndices("test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6221.java