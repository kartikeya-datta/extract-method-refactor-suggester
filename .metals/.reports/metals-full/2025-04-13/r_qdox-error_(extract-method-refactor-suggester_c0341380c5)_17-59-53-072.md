error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10235.java
text:
```scala
D@@ocument doc = docMapper.parse(json).masterDoc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10235.java