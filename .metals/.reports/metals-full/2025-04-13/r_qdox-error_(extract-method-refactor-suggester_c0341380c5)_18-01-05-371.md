error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3269.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3269.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3269.java
text:
```scala
i@@nt closingPosition = retrieveRightBraceOrSemiColonPosition(methodDeclaration.bodyEnd + 1, methodDeclaration.declarationSourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3269.java