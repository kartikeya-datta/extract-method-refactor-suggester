error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/755.java
text:
```scala
c@@ell.setLayout(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/755.java