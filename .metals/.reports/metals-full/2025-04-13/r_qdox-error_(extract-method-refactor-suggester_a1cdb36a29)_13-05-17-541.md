error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5756.java
text:
```scala
I@@mageScaleTest.class, TableLayoutTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5756.java