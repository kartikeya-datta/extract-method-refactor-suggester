error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/424.java
text:
```scala
a@@dd(contentTable = new Table(skin)).expand().fill();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/424.java