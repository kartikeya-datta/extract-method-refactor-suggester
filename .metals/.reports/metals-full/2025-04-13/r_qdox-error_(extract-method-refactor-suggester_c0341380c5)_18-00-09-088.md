error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8471.java
text:
```scala
s@@tore.setDefault(IPreferenceConstants.SHOW_FLOATING_PROGRESS,false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8471.java