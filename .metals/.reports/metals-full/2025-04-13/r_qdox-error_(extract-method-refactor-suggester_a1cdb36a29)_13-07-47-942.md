error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1957.java
text:
```scala
P@@ixmap, Compressed,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1957.java