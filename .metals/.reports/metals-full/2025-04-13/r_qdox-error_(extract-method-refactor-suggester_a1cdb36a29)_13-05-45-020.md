error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3515.java
text:
```scala
O@@S.gtk_entry_set_icon_from_stock (handle, OS.GTK_ENTRY_ICON_SECONDARY, OS.GTK_STOCK_CLEAR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3515.java