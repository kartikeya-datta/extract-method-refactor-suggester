error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9736.java
text:
```scala
s@@uper.draw(batch, parentAlpha);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9736.java