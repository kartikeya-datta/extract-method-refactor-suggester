error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3104.java
text:
```scala
M@@ethodDeclaration method = (MethodDeclaration) ((DefaultBindingResolver) this.resolver).bindingTables.bindingsToAstNodes.get(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3104.java