error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8581.java
...
```java
offset: 1111
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8581.java
text:
```scala
 ...
 */
public class InVMConnectorSpec extends AbstractTransportSpecification<InVMConnectorSpec> {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8581.java