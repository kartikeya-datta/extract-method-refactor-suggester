error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11257.java
text:
```scala
I@@nterceptorOrder.assertEquals(InterceptorParent.class, InterceptorChild.class, MethodInterceptorParent.class, MethodInterceptorChild.class, CDIInterceptor.class, BeanParent.class, BeanChild.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11257.java