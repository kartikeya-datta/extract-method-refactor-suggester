error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5014.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5014.java
text:
```scala
public static final T@@imeValue DEFAULT_MASTER_NODE_TIMEOUT = TimeValue.timeValueSeconds(30);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5014.java