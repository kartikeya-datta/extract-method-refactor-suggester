error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/369.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/369.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/369.java
text:
```scala
r@@eference.bits &= ~AstNode.RestrictiveFlagMASK;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/369.java