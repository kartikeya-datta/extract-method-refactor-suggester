error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4748.java
text:
```scala
n@@ew ISourceType[]{outerType},
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4748.java