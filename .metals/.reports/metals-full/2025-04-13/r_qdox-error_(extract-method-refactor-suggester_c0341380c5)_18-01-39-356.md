error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15085.java
text:
```scala
H@@andlerProvider<WebSocketHandler<?>> webSocketHandler, AbstractSockJsSession session)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15085.java