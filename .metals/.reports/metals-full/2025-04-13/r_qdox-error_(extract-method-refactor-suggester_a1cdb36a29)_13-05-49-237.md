error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9646.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9646.java
text:
```scala
#i@@nclude <gdx2d/gdx2d.h>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9646.java