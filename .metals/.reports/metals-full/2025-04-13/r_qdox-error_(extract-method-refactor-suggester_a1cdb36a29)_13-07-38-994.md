error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12243.java
text:
```scala
s@@etId(getPageMap().nextId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12243.java