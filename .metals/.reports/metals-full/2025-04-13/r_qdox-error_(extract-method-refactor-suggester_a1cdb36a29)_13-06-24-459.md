error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5113.java
text:
```scala
i@@f(!BuildExecutor.executeAnt("jni/build-macosx32.xml", "-Dhas-compiler=true -v postcompile")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5113.java