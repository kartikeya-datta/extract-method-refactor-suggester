error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18238.java
text:
```scala
a@@ssertTrue(mex.toString().contains("SimplePanel_1.html"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18238.java