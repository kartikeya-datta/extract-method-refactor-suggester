error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6919.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6919.java
text:
```scala
public T@@estLink(MarkupContainer parent,String id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6919.java