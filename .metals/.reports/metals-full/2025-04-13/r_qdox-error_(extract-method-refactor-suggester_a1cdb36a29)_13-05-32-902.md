error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4081.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4081.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4081.java
text:
```scala
t@@hrow new ElasticSearchParseException("failed to update mapping", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4081.java