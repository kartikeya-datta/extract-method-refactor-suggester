error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11733.java
text:
```scala
t@@his.out = new DeflaterOutputStream(outputStream, new Deflater(parameters.getCompressionLevel(), !parameters.withZlibHeader()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11733.java