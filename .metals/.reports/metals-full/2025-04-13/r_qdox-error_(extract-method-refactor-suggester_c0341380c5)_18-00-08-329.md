error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5367.java
text:
```scala
p@@ointcut.parameterizeWith(typeMap,newDeclaringType.getWorld())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5367.java