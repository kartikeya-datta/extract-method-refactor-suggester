error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10592.java
text:
```scala
I@@nteger.valueOf(VALUE.intValue()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10592.java