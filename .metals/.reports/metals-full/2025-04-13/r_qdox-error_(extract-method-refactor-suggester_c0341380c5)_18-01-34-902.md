error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3558.java
text:
```scala
t@@ranslate(tmpVec.set(-tmpVec.x, -tmpVec.y, -tmpVec.z));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3558.java