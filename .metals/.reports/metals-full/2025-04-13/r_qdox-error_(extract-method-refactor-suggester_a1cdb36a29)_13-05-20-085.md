error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1859.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1859.java
text:
```scala
private static final S@@tring ACTION_NAME = DeleteByQueryAction.NAME + "[s]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1859.java