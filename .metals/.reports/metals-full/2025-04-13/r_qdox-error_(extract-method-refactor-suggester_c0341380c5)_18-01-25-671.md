error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9236.java
text:
```scala
t@@his(text, skin.get(TextButtonStyle.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9236.java