error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/998.java
...
```java
offset: 793
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/998.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/998.java