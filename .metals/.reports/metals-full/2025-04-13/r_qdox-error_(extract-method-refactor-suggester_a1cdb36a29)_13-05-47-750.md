error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/183.java
text:
```scala
i@@f (bindingName.startsWith("java:") || bindingDescription.isAbsoluteBinding()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/183.java