error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8289.java
text:
```scala
i@@f (String.class.equals(theType))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8289.java