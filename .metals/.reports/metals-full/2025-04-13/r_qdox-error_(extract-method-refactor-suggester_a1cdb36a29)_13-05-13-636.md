error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4620.java
text:
```scala
A@@ddressbookInterface.addressbookTreeModel = new AddressbookTreeModel(AddressbookConfig.get(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4620.java