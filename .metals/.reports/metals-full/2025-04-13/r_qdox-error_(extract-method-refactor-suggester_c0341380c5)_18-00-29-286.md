error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7256.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7256.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7256.java
text:
```scala
l@@ocalType.enclosingCase = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7256.java