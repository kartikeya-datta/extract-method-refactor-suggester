error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1500.java
text:
```scala
S@@impleVertexShader.class, ShapeRendererTest.class, MoveSpriteExample.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1500.java