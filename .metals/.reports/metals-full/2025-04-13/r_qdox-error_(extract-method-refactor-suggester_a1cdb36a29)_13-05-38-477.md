error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4190.java
text:
```scala
c@@ompilationUnit = AnnotationUtils.getASTParser(source, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4190.java