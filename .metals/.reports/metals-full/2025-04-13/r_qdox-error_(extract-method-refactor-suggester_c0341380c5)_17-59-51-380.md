error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2476.java
text:
```scala
d@@ata.width = Globals.COMBO_LARGE_WIDTH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2476.java