error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3623.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3623.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3623.java
text:
```scala
D@@ocsEnum de = _TestUtil.docs(random(), te, null, null, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3623.java