error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/380.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/380.java
text:
```scala
protected D@@irectory create(String path) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/380.java