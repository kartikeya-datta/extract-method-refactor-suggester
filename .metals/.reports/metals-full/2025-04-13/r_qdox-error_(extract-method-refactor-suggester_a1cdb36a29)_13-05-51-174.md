error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5335.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5335.java
text:
```scala
_@@ct = new CollectionChangeTrackerImpl(this, false, ordered,false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5335.java