error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9213.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9213.java
text:
```scala
+ c@@omponent.getId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9213.java