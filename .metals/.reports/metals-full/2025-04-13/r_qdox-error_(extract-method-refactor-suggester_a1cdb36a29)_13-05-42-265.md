error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5168.java
text:
```scala
c@@onvertInput();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5168.java