error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6948.java
text:
```scala
l@@ogger.debug("Using [keep_last_n] deletion policy with num_to_keep[{}]", numToKeep);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6948.java