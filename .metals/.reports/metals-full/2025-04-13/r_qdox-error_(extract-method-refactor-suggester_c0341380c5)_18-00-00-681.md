error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2693.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2693.java
text:
```scala
public abstract l@@ong size() throws IOException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2693.java