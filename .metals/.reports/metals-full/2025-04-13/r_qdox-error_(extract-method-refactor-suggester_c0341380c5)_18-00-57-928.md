error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11915.java
text:
```scala
i@@f (component.renderAllowed && component.isVisible())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11915.java