error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1127.java
text:
```scala
G@@dxTest test = new MusicTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1127.java