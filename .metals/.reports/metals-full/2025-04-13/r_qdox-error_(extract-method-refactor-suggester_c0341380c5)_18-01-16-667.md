error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5758.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5758.java
text:
```scala
public i@@nt[] dashes;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5758.java