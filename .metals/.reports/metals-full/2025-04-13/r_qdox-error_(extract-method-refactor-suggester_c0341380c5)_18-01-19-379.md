error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1415.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1415.java
text:
```scala
public v@@oid dirty(final boolean isInitialization)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1415.java