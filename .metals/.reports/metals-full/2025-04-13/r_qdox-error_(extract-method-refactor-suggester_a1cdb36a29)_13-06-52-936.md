error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2618.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2618.java
text:
```scala
final L@@ist<MethodInterceptorConfiguration> interceptorConfigurations = componentConfiguration.getClassInterceptorConfigs();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2618.java