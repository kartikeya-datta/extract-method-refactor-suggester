error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6470.java
text:
```scala
r@@eturn org.eclipse.xtend.backend.types.emf.EObjectType.INSTANCE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6470.java