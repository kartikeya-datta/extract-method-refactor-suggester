error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5733.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5733.java
text:
```scala
final i@@nt numNodes = immutableCluster().numDataNodes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5733.java