error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3712.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3712.java
text:
```scala
public C@@odeSnippetReturnStatement(Expression expr, int s, int e) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3712.java