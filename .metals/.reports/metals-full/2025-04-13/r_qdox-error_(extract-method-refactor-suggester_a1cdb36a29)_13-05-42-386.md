error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17575.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[88,80]

error in qdox parser
file content:
```java
offset: 2456
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17575.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17575.java