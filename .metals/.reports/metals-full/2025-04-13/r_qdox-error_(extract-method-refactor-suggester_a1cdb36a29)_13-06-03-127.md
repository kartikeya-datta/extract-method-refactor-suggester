error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4124.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4124.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4124.java
text:
```scala
public static final S@@tring ICON_FOLLOW = "\uf21C";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4124.java