error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7689.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7689.java
text:
```scala
t@@his.actualReceiverType = this.receiverType = receiver.resolveType(scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7689.java