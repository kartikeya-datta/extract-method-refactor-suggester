error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8898.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8898.java
text:
```scala
public static final S@@tring HEADER_ID = Component.AUTO_COMPONENT_PREFIX + "<header>";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8898.java