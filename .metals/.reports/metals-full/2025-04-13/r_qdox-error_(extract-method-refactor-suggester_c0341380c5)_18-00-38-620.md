error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2511.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2511.java
text:
```scala
t@@arget.add(getComponent());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2511.java