error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1605.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1605.java
text:
```scala
public b@@oolean isIntercepted() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1605.java