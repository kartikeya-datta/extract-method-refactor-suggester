error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16280.java
text:
```scala
n@@ew Locale("nl"), Locale.GERMAN, Locale.SIMPLIFIED_CHINESE, Locale.JAPANESE });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16280.java