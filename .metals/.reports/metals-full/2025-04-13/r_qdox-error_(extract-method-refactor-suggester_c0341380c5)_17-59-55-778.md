error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10885.java
text:
```scala
f@@libbles = (Integer) context.getTypeConverter().convertValue(newValue, TypeDescriptor.forObject(newValue), TypeDescriptor.valueOf(Integer.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10885.java