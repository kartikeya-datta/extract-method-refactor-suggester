error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/24.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/24.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/24.java
text:
```scala
C@@loseables.close(writer, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/24.java