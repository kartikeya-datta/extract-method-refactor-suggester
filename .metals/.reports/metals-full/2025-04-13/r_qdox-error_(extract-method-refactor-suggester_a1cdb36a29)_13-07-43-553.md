error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/828.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/828.java
text:
```scala
public static final S@@tring NAME = "parent";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/828.java