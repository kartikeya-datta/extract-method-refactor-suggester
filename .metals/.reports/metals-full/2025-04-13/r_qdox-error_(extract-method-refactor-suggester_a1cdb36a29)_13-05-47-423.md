error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2323.java
text:
```scala
r@@eturn dataImporter == null ? null : dataImporter.getCore();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2323.java