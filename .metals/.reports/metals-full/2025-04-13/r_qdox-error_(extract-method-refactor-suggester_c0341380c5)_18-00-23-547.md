error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6915.java
text:
```scala
l@@ogger.warn("Received response for a request that has timed out, action [{}], node [{}], id [{}]", timeoutInfoHolder.action(), timeoutInfoHolder.node(), requestId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6915.java