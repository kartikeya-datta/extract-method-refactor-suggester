error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4770.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4770.java
text:
```scala
public c@@har[] computeUniqueKey(boolean withAccessFlags) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4770.java