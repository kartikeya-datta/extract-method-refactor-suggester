error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7365.java
text:
```scala
t@@rimDropTarget = new TrimDropTarget(parent, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7365.java