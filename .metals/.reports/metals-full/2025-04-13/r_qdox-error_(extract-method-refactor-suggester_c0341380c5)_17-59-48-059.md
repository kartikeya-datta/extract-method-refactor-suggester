error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2929.java
text:
```scala
a@@rgs[0] = proxyManager.unwrap(targetObject).call();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2929.java