error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6898.java
text:
```scala
r@@eturn AnnotationUtils.findAnnotation(this.bridgedMethod, annotationType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6898.java