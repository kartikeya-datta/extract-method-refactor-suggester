error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/706.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/706.java
text:
```scala
final P@@atchTool tool = PatchTool.Factory.loadFromRoot(jbossHome);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/706.java