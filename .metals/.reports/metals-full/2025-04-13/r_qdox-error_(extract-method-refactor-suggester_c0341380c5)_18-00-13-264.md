error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8515.java
text:
```scala
S@@impleLookupTable deltas = new SimpleLookupTable(prereqOutputFolders.elementSize + 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8515.java