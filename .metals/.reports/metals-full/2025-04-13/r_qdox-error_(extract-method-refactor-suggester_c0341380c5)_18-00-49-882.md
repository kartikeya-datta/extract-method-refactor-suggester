error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5111.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5111.java
text:
```scala
p@@roperties.setProperty(ServerEnvironment.HOME_DIR, SecurityActions.getSystemProperty("jboss.home.dir"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5111.java