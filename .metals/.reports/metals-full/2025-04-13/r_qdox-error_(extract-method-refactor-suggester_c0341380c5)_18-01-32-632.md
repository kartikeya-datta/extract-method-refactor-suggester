error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7132.java
text:
```scala
l@@og.error("Unable to redirect to: " + url + ", HTTP Response has already been committed.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7132.java