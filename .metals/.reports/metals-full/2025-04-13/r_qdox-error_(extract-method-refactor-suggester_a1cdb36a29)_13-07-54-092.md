error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3395.java
text:
```scala
I@@CompoundCommandHandlerService getCompoundCommandHandlerService();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3395.java