error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14639.java
text:
```scala
r@@esourceRegistration.registerSubModel(new ExtensionResourceDefinition(extensionRegistry, true, false, !isMaster));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14639.java