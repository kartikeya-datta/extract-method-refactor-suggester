error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11158.java
text:
```scala
s@@ignature.matches(shadow.getEnclosingCodeSignature(), shadow.getIWorld(), false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11158.java