error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9614.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9614.java
text:
```scala
private final L@@ist<Object> mockObjects = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9614.java