error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2718.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2718.java
text:
```scala
@Override public B@@oolean paramAsBooleanOptional(String key, Boolean defaultValue) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2718.java