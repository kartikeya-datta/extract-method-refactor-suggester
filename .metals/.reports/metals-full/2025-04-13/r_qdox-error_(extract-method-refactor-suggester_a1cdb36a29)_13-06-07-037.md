error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3248.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3248.java
text:
```scala
n@@ew NativeCodeGenerator().generate("src", "bin", "jni");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3248.java