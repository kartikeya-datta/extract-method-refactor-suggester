error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/66.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/66.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/66.java
text:
```scala
s@@kipRemainder(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/66.java