error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7795.java
text:
```scala
s@@tartActivity(ViewIssuesActivity.createIntent(items, position - getListAdapter().getHeadersCount()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7795.java