error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3865.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3865.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3865.java
text:
```scala
C@@lusterHealthResponse clusterHealth = node.client().admin().cluster().health(clusterHealthRequest().waitForGreenStatus()).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3865.java