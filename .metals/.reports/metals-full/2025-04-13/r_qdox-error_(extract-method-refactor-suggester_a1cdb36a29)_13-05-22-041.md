error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7956.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7956.java
text:
```scala
i@@f (isImageParser() && (SampleResult.TEXT).equals(res.getDataType()) && res.isSuccessful()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7956.java