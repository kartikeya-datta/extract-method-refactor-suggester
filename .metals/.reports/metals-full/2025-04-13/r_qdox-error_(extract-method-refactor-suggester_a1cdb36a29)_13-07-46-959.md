error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/485.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/485.java
text:
```scala
 e@@xtension.equals("fnt") || extension.equals("pack") || extension.equals("obj");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/485.java