error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9526.java
text:
```scala
t@@his.compression = settings.getAsBoolean("http.compression", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9526.java