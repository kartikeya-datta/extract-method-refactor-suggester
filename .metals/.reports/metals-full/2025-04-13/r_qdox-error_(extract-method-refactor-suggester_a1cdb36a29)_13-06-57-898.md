error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10920.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10920.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10920.java
text:
```scala
S@@tringBuilder disc = new StringBuilder(lstate.discValue.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10920.java