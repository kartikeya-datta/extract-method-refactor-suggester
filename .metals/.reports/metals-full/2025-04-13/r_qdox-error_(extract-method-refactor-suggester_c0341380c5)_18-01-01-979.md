error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1804.java
text:
```scala
F@@loat boost = fieldBoostMapAttr.getFieldBoostMap().get(fieldConfig.getField());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1804.java