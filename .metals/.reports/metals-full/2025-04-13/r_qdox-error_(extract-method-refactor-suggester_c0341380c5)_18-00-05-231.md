error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8861.java
text:
```scala
s@@etIcon(folder.getIcon());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8861.java