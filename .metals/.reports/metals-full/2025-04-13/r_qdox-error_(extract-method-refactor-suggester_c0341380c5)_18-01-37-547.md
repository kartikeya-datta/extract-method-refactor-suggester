error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8674.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8674.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8674.java
text:
```scala
final D@@eferredResult<Object> deferredResult = new DeferredResult<Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8674.java