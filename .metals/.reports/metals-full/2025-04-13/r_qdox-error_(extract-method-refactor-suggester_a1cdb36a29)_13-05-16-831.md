error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5870.java
text:
```scala
n@@ull, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5870.java