error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2759.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2759.java
text:
```scala
t@@his.scribe.printNextToken(TerminalTokens.TokenNameIdentifier, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2759.java