error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8620.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8620.java
text:
```scala
public static b@@oolean fileExists(String parent, String child) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8620.java