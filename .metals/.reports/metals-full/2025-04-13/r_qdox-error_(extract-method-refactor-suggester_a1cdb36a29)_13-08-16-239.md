error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8746.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8746.java
text:
```scala
final S@@erviceContainer container = bootstrap.bootstrap(configuration, Collections.<ServiceActivator>emptyList()).get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8746.java