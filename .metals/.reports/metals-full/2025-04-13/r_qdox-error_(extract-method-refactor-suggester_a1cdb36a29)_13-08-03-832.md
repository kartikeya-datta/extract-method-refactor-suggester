error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7980.java
...
```java
offset: 863
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7980.java
text:
```scala
...
p@@ackage org.apache.lucene.store;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7980.java