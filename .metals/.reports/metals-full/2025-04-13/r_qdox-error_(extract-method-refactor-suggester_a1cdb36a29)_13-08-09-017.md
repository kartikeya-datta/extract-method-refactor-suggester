error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2271.java
text:
```scala
I@@MailFolder destFolder = (IMailFolder) dialog.getSelectedFolder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2271.java