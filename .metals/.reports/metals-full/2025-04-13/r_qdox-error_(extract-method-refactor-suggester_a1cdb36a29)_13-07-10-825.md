error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2047.java
text:
```scala
D@@ocsEnum de = _TestUtil.docs(random(), te, null, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2047.java