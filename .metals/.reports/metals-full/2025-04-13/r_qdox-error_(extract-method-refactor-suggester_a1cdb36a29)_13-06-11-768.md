error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16996.java
text:
```scala
h@@eight = (int)newRect.height;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16996.java