error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13882.java
text:
```scala
s@@uite.addTestSuite(FormInputTest.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13882.java