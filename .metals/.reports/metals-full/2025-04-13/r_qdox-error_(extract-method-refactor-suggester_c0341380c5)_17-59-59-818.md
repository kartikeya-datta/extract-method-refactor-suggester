error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10334.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[46,2]

error in qdox parser
file content:
```java
offset: 2175
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10334.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10334.java