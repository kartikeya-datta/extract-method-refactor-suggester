error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2617.java
text:
```scala
t@@ester.assertListView("comments", new ArrayList<Comment>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2617.java