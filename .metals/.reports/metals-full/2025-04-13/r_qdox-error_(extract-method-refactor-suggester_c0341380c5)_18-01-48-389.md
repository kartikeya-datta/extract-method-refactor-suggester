error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6933.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6933.java
text:
```scala
B@@undleInfo info = depUnit.getAttachment(OSGiConstants.BUNDLE_INFO_KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6933.java