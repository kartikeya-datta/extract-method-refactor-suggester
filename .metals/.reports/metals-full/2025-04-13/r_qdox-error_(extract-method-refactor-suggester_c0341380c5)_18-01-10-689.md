error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2221.java
text:
```scala
t@@his(settings, new NoneGatewayAllocator(), new BalancedShardsAllocator(settings));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2221.java