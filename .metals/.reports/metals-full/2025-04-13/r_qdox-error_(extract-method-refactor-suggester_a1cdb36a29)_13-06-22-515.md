error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7586.java
text:
```scala
P@@ostingsFormatProvider postingsFormat = mapperService.indexName(field).mapper().postingsFormatProvider();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7586.java