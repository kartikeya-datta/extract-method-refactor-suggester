error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5971.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5971.java
text:
```scala
e@@lse return Math.abs(val.hashCode()) % numPartitions;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5971.java