error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6303.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6303.java
text:
```scala
public v@@oid process(IFormSubmitter submittingComponent)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6303.java