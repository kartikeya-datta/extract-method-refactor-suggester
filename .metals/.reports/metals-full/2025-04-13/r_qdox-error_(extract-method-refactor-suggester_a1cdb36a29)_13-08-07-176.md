error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/857.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/857.java
text:
```scala
r@@eturn isAssignableFrom(c, obj.getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/857.java