error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5432.java
text:
```scala
r@@eturn SynchronizedList.synchronizedList(new ArrayList<E>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5432.java