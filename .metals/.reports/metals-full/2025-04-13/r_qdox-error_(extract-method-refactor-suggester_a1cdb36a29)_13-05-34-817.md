error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9585.java
text:
```scala
r@@eturn this;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9585.java