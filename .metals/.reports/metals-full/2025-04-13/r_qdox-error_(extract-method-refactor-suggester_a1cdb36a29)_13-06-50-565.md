error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5809.java
text:
```scala
b@@inding = environment().convertToRawType(referenceBinding, false /*do not force conversion of enclosing types*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5809.java