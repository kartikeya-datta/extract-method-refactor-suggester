error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7831.java
text:
```scala
t@@his.maxMergedSegment = componentSettings.getAsBytesSize("max_merge_segment", new ByteSizeValue(20, ByteSizeUnit.GB));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7831.java