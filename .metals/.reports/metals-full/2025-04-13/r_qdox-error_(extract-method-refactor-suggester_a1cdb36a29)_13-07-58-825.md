error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7893.java
text:
```scala
C@@ollectionProperty threadLists = new CollectionProperty(UserParameters.THREAD_VALUES, new ArrayList<Object>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7893.java