error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1597.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1597.java
text:
```scala
private final M@@ap<String, String> params;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1597.java