error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4182.java
text:
```scala
u@@tils = new DeploymentUtils("ds-mbean.sar", true, Test.class.getPackage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4182.java