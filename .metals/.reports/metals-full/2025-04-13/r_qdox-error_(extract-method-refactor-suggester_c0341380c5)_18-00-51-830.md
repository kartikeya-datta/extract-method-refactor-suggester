error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2876.java
text:
```scala
b@@yte[] rowhash = FBUtilities.hash("SHA-256", row.key.key, row.buffer.getData());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2876.java