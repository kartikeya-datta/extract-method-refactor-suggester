error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10182.java
text:
```scala
p@@ublic class CharacterConverter extends AbstractConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10182.java