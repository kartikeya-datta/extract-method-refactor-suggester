error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7858.java
text:
```scala
g@@etApplicationSettings().getDefaultPageFactory().newPage(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7858.java