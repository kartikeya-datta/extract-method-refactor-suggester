error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3953.java
text:
```scala
r@@eturn "<CompleteOnType:"/*nonNLS*/ + new String(token) + ">"/*nonNLS*/ ;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3953.java