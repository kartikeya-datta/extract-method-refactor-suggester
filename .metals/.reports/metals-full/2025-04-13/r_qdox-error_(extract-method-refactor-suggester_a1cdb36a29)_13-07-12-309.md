error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10046.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10046.java
text:
```scala
public static final l@@ong WAIT_LINETIMEOUT = 1500;
...
public class AbstractCliTestBase {
    ...
    public static final long WAIT_LINETIMEOUT = 10000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10046.java