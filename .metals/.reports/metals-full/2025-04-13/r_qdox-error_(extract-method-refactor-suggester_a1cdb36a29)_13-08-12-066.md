error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10438.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10438.java
text:
```scala
final b@@oolean replacement = deploymentUnit.getAttachment(org.jboss.as.ee.structure.Attachments.EJB_ANNOTATION_PROPERTY_REPLACEMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10438.java