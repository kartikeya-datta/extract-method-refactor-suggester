error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3413.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3413.java
text:
```scala
private static final S@@tring PROPVERSION = "2.5";// Expected version $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3413.java