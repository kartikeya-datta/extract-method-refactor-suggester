error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/82.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/82.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/82.java
text:
```scala
f@@ield.setStringValue(df.format(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/82.java