error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3661.java
text:
```scala
i@@mportName+=".*"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3661.java