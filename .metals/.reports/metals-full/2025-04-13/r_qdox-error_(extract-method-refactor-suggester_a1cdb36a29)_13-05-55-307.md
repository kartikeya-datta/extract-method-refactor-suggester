error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8707.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8707.java
text:
```scala
private volatile A@@cceptingChannel<SslConnection> sslServer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8707.java