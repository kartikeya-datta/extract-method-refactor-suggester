error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9050.java
text:
```scala
n@@ew ConfigurationClassBeanDefinitionReader(registry, this.sourceExtractor).loadBeanDefinitions(parser.getConfigurationClasses());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9050.java