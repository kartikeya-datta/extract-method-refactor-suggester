error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15700.java
text:
```scala
r@@eturn Double.valueOf(key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15700.java