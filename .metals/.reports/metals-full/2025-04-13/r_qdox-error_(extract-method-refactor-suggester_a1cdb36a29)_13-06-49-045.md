error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11359.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11359.java
text:
```scala
public v@@oid registrationComplete(ManagementChannelHandler handler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11359.java