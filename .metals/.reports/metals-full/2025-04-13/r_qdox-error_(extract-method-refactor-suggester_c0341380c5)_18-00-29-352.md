error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13597.java
text:
```scala
l@@rs = em.detachCopy(lrs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13597.java