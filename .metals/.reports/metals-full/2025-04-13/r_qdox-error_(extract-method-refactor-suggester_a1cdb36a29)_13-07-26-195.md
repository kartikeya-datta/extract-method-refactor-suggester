error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/64.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/64.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/64.java
text:
```scala
i@@f (test > 0) { //traditional and javadoc comment
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/64.java