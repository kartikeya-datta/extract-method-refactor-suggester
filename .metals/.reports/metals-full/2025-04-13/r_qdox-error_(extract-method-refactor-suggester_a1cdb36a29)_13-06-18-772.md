error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7612.java
text:
```scala
i@@f (!isCtrlPressed()) selected.clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7612.java