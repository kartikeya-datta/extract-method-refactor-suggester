error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9963.java
text:
```scala
r@@eturn createParameterizedType((ReferenceBinding) mec.erasure(), bestArguments, mec.enclosingType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9963.java