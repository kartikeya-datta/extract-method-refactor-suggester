error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1051.java
text:
```scala
F@@ile indexDir = _TestUtil.getTempDir("testSetBufferSize");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1051.java