error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1811.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1811.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/snapshot/delete";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1811.java