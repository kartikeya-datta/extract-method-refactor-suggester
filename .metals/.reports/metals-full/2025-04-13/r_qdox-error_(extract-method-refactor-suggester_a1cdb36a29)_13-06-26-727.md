error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4758.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4758.java
text:
```scala
@Override protected v@@oid beforeStart() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4758.java