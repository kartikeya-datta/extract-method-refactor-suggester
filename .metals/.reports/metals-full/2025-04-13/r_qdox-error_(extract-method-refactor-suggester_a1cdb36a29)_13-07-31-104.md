error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/272.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/272.java
text:
```scala
private static S@@tring PROGRESS_VIEW_ID = "org.eclipse.ui.views.ProgressView"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/272.java