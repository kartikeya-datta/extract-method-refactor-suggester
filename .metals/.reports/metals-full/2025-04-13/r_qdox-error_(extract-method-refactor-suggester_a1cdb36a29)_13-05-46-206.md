error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8749.java
text:
```scala
s@@uper(elementName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8749.java