error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1790.java
text:
```scala
b@@reakLabel.initialize(codeStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1790.java