error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7553.java
text:
```scala
s@@uper(NOTATION_DECLARATION, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7553.java