error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8058.java
text:
```scala
r@@esponse.getBody().write("ok".getBytes(UTF8_CHARSET));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8058.java