error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9761.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9761.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9761.java
text:
```scala
t@@his.contents = org.eclipse.jdt.internal.compiler.util.Util.getFileByteContent(resource.getLocation().toFile());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9761.java