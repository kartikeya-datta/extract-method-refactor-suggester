error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/538.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/538.java
text:
```scala
s@@uper(settings, MoreLikeThisAction.NAME, threadPool);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/538.java