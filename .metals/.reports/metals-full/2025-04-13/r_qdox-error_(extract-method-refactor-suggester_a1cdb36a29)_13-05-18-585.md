error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4989.java
...
```java
offset: 28
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4989.java
text:
```scala
private transient volatile F@@TPClient savedClient; // used for interrupting the sampler
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4989.java