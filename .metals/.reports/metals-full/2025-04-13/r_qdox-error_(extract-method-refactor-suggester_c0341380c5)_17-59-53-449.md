error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17171.java
text:
```scala
a@@pplication.getPages().setHomePage(MockPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17171.java