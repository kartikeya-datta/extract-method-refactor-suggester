error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6389.java
text:
```scala
z@@e.setName(entryEncoding.decode(fileName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6389.java