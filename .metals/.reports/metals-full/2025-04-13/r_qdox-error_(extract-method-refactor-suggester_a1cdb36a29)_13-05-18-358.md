error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6343.java
text:
```scala
r@@emoveModule("org/jboss/ironjacamar/ra16out1", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6343.java