error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2257.java
text:
```scala
h@@ += filt.hashCode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2257.java