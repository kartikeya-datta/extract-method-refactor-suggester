error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15729.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15729.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15729.java
text:
```scala
C@@XFCreationUIMessages.JAVA2WS_PAGE_TITLE, new Object[]{context.getCxfRuntimeEdition(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15729.java