error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15107.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15107.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15107.java
text:
```scala
p@@ublic class WeatherStation implements Serializable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15107.java