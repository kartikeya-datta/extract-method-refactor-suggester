error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9361.java
text:
```scala
i@@f(! target.mkdirs() && ! target.isDirectory()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9361.java