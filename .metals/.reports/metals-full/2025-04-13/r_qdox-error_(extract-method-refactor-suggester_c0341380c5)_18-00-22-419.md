error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7676.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7676.java
text:
```scala
public b@@oolean alias = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7676.java