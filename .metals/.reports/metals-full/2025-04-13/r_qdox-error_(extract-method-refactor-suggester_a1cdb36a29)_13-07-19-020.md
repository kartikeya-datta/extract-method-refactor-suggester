error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2594.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2594.java
text:
```scala
n@@ew Object[] { new Double(argument), new Double(lower), new Double(upper) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2594.java