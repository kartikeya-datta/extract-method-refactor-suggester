error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18219.java
text:
```scala
S@@WTTextField textWidget = (SWTTextField)new SWTTextField().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18219.java