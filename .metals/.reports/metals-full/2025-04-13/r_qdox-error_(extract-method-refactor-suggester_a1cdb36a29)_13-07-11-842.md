error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/402.java
text:
```scala
i@@ndexService = indicesService.createIndex(indexMetaData.index(), indexMetaData.settings(), clusterService.localNode().id());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/402.java