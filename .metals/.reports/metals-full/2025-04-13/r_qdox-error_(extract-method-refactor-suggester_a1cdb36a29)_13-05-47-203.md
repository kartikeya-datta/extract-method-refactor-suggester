error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8984.java
text:
```scala
e@@ngine.optimize(new Engine.Optimize().maxNumSegments(-1).waitForMerge(false).flush(false).refresh(false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8984.java