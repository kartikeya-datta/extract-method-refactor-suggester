error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10243.java
text:
```scala
C@@ommonAttributes.FILTER, HA, CommonAttributes.MIN_LARGE_MESSAGE_SIZE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10243.java