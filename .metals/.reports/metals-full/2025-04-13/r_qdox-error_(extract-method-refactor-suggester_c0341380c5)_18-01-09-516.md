error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2420.java
text:
```scala
f@@or (int i = 0, n = actions.size; i < n; i++)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2420.java