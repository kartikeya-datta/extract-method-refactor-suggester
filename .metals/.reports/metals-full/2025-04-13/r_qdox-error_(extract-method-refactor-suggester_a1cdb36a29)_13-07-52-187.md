error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4297.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4297.java
text:
```scala
final i@@nt Ignore = 256; // during handling only
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4297.java