error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7160.java
text:
```scala
S@@et<String> getDefaultProfiles();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7160.java