error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8492.java
text:
```scala
T@@hreadsSubsystemThreadPoolOperationUtils.addThreadFactoryDependency(params.getThreadFactory(), serviceName, serviceBuilder, service.getThreadFactoryInjector(), target, params.getName() + "-threads");
 ...
 */
public class ScheduledThreadPoolAdd implements ModelAddOperationHandler {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8492.java