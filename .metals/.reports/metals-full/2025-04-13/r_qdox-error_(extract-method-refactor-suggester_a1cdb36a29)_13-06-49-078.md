error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14562.java
text:
```scala
i@@nt SERVER_TO_HOST_CONTROLLER_OPERATION = Byte.MAX_VALUE; // TODO: Correct
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14562.java