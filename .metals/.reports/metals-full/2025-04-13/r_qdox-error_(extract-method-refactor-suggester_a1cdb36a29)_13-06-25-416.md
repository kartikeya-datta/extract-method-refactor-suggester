error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8207.java
text:
```scala
c@@ommand.add("-Dorg.jboss.boot.log.file=domain/servers/" + serverName + "/logs/boot.log");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8207.java