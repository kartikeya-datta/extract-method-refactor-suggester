error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13529.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13529.java
text:
```scala
private c@@har mapNullToDisabled(final Character c) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13529.java