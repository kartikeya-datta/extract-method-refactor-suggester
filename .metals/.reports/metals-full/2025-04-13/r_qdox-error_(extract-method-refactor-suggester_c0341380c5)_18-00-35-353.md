error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1375.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1375.java
text:
```scala
private static final l@@ong serialVersionUID = 3;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1375.java