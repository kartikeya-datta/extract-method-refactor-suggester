error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11456.java
text:
```scala
i@@f (isActive()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11456.java