error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4213.java
text:
```scala
I@@mageLoader.getSmallImageIcon("stock_preferences.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4213.java