error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9220.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9220.java
text:
```scala
private static S@@tring ellipsis = ProgressMessages.ProgressFloatingWindow_EllipsisValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9220.java