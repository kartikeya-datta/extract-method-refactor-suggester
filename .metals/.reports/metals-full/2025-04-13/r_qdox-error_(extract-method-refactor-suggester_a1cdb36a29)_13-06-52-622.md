error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13701.java
text:
```scala
r@@eturn IS_GTK || IS_CARBON || BidiUtil.isBidiPlatform() || isMirrored;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13701.java