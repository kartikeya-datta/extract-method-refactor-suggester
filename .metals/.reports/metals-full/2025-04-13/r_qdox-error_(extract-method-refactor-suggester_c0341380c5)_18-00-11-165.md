error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14583.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14583.java
text:
```scala
public I@@Status startup(IProgressMonitor monitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14583.java