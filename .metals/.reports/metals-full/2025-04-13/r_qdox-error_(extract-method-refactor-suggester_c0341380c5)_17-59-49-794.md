error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12131.java
text:
```scala
n@@ameBorder.addToBody(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12131.java