error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2427.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2427.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2427.java
text:
```scala
i@@f ("jar".equalsIgnoreCase(ext) || "zip".equalsIgnoreCase(ext)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2427.java