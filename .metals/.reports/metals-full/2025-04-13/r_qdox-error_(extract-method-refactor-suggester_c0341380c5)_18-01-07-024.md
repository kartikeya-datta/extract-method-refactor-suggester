error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4732.java
text:
```scala
i@@f (scope.compilerOptions().complianceLevel < ClassFileConstants.JDK1_4) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4732.java