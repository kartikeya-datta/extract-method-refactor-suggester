error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8764.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8764.java
text:
```scala
public static S@@tringBuffer getConstants(byte[] bytes)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8764.java