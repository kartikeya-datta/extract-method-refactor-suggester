error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15927.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15927.java
text:
```scala
private final L@@ocalizedImageResource localizedImageResource = new LocalizedImageResource(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15927.java