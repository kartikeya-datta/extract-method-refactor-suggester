error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4374.java
text:
```scala
S@@tringBuilder sb = new StringBuilder(40);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4374.java