error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8747.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8747.java
text:
```scala
public static final S@@tring VERSION = "1.3.2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8747.java