error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3199.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3199.java
text:
```scala
private static final S@@tring TEST_DATA_PATH = AjdeTests.TESTDATA_PATH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3199.java