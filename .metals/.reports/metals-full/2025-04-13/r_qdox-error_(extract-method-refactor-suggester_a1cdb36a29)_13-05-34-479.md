error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11997.java
text:
```scala
r@@eturn OS.Colors_Transparent;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11997.java