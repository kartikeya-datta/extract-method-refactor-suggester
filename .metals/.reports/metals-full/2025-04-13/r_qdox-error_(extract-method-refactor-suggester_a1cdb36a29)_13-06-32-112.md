error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2232.java
text:
```scala
T@@ProtocolFactory tProtocolFactory = new TBinaryProtocol.Factory(true,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2232.java