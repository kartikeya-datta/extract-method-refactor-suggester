error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6358.java
text:
```scala
I@@mageList getImageListToolBar (int width, int height) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6358.java