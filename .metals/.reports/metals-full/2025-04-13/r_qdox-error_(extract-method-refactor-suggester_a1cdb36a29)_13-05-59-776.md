error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1131.java
text:
```scala
b@@reak; // no-op, we always need a position bound in gles
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1131.java