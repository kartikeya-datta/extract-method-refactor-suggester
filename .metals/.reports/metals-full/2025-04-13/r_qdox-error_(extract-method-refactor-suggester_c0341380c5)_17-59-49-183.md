error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5922.java
text:
```scala
r@@eturn this.resolvedType = binding.type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5922.java