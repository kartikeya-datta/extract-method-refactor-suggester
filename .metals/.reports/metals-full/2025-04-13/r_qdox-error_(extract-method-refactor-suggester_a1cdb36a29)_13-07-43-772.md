error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17672.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[45,2]

error in qdox parser
file content:
```java
offset: 1427
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17672.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17672.java