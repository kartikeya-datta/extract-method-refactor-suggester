error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7442.java
text:
```scala
S@@et<String> expected = new HashSet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7442.java