error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6791.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6791.java
text:
```scala
a@@nnotationTypeMemberDeclaration.modifiers |=  AccAnnotationDefault;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6791.java