error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10708.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[25,9]

error in qdox parser
file content:
```java
offset: 1141
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10708.java
text:
```scala
...
package o@@rg.jboss.as.controller;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10708.java