error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3207.java
text:
```scala
s@@etForegroundColor (labelHandle, color);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3207.java