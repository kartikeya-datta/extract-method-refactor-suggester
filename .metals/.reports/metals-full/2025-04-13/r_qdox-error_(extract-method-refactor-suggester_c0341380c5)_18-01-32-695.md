error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1438.java
text:
```scala
m@@axTokenLength = settings.getAsInt("max_token_length", StandardAnalyzer.DEFAULT_MAX_TOKEN_LENGTH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1438.java