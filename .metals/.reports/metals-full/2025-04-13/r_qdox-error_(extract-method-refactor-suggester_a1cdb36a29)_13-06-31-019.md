error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12348.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12348.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12348.java
text:
```scala
private final P@@rojectListener    m_listener;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12348.java