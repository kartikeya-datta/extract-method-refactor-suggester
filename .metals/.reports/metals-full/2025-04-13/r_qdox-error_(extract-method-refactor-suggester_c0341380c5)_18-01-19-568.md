error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5546.java
text:
```scala
p@@rocessorTarget.addDeploymentProcessor(Constants.SUBSYSTEM_NAME, Phase.INSTALL, Phase.INSTALL_APPLICATION_CLIENT, new ApplicationClientStartProcessor(hostUrl, connectionPropertiesUrl, parameters == null ? new String[0] : parameters.toArray(EMPTY_STRING)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5546.java