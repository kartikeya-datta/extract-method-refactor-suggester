error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14098.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14098.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14098.java
text:
```scala
public b@@oolean isBatchMode(CommandContext ctx) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14098.java