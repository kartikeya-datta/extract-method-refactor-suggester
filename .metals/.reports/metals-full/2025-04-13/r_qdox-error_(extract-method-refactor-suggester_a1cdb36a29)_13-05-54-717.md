error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3442.java
text:
```scala
S@@tringBuilder hostName = new StringBuilder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3442.java