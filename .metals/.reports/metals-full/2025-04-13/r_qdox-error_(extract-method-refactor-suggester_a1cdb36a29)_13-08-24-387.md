error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10488.java
text:
```scala
i@@nt[] curve = new int[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10488.java