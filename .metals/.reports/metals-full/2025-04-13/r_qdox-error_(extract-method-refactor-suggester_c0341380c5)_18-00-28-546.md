error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13642.java
text:
```scala
r@@eturn Float.compare(value, anotherVal);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13642.java