error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1837.java
text:
```scala
r@@eturn behavior.isEnabled(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1837.java