error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4860.java
text:
```scala
t@@his.codegenBinding.tagBits |= TagBits.ClearPrivateModifier;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4860.java