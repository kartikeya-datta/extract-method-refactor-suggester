error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1885.java
text:
```scala
a@@dd(new PageLink("start", Guess.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1885.java