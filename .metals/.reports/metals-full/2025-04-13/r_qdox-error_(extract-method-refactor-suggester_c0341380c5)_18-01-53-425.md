error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5642.java
text:
```scala
r@@eturn this.resolvedType = receiverType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5642.java