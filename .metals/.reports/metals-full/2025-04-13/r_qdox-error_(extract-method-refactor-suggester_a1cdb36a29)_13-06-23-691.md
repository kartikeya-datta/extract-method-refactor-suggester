error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3270.java
text:
```scala
r@@eturn request.bufferForBody().arrayOffset() + request.bufferForBody().position();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3270.java