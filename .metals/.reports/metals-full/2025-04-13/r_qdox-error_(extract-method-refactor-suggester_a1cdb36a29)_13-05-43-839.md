error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14226.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14226.java
text:
```scala
static i@@nt MINOR_VERSION = 539;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14226.java