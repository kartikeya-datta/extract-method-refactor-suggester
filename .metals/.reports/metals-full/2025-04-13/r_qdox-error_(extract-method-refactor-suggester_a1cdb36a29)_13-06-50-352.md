error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15129.java
text:
```scala
C@@ontentModification moduleAdded = new ContentModification(new ModuleItem(moduleName, newHash), NO_CONTENT, ADD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15129.java