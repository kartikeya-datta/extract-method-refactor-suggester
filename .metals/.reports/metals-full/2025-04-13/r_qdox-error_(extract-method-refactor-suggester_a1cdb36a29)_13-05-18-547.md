error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3630.java
text:
```scala
S@@corer scorer = scorer(reader, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3630.java