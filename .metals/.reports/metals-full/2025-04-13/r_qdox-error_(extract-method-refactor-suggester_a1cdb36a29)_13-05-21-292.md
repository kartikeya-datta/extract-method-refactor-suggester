error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4743.java
text:
```scala
r@@eturn new GroupAwareCache<K, V, UUID, SerializationGroupMember<K, V, UUID>>(backingCache, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4743.java