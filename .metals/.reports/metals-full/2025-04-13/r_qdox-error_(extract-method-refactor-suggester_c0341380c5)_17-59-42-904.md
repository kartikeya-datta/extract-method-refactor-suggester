error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11280.java
text:
```scala
a@@dd.get(CRITERIA).get("inet-address").set("127.0.0.1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11280.java