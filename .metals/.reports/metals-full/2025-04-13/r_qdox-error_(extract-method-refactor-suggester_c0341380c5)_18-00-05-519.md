error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12805.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12805.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12805.java
text:
```scala
T@@hread.sleep(100);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12805.java