error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4259.java
text:
```scala
r@@esponseHeaders.add(LOCATION, redirectTo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4259.java