error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/692.java
text:
```scala
w@@orld.constructors.put("bar", new BulletConstructor(barMesh, 0f)); // mass = 0: static body
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/692.java