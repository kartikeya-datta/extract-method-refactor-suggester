error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6794.java
text:
```scala
r@@eturn;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6794.java