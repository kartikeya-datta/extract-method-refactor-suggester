error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11647.java
text:
```scala
r@@eturn init().read(b, off, len);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11647.java