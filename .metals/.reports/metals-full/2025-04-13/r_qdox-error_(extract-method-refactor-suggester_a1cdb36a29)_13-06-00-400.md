error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15167.java
text:
```scala
r@@eturn context.getProcessType().isServer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15167.java