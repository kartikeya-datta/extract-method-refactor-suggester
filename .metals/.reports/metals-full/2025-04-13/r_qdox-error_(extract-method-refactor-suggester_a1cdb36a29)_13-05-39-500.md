error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/57.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/57.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/57.java
text:
```scala
a@@ssertEquals(20, JDBC.assertDrainResults(rs));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/57.java