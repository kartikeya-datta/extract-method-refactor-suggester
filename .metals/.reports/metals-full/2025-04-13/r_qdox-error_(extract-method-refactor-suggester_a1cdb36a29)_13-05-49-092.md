error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5212.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5212.java
text:
```scala
private transient b@@oolean dirty = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5212.java