error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6326.java
text:
```scala
g@@etFrameMediator().fireClosed();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6326.java