error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11432.java
text:
```scala
p@@ublic class BorderRenderWrappedTestPage_1 extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11432.java