error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2583.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2583.java
text:
```scala
E@@rrorDialog.openError(window.getShell(), WorkbenchMessages.NewWizardShortcutAction_errorTitle,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2583.java