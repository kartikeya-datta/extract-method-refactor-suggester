error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16575.java
text:
```scala
c@@hatRoom = manager.createChatRoomContainer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16575.java