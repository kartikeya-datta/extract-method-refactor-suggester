error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14320.java
text:
```scala
t@@hrow new WicketRuntimeException("The component(s) below failed to render. A common problem is that you have added a component in code but forgot to reference it in the markup (thus the component will never be rendered).\n\n"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14320.java