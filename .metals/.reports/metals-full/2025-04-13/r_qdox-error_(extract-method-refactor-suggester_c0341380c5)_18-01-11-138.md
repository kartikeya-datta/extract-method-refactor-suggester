error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3576.java
text:
```scala
l@@ogger.debug("{}: failed to executed [{}]", t, shard != null ? shard.shortSummary() : shardIt.shardId(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3576.java