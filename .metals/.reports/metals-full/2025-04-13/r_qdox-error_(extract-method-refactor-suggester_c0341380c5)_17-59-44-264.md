error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8265.java
text:
```scala
S@@tring[] paths = index.queryDocumentNames(this.folderPath.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8265.java