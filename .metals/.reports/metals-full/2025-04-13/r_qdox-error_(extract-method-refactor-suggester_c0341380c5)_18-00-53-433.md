error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11299.java
text:
```scala
C@@omponent component = getComponent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11299.java