error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7552.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7552.java
text:
```scala
private M@@ultiMapUtils() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7552.java