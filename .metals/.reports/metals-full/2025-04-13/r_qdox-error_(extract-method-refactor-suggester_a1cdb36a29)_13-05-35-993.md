error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10576.java
text:
```scala
i@@f (input == null && !isInputNullable())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10576.java