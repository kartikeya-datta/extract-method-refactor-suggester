error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/937.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/937.java
text:
```scala
s@@erviceObject = (T) Utils.getServicePrivileged(ctx, ref);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/937.java