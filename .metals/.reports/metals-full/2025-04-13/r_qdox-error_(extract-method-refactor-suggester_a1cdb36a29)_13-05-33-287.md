error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17274.java
text:
```scala
f@@loat /*double*/ defaultFlatness = NSBezierPath.defaultFlatness();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17274.java