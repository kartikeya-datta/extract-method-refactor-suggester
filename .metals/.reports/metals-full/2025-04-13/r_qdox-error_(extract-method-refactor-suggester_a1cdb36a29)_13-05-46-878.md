error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2558.java
text:
```scala
r@@esponse = IOUtils.toString(stream, "UTF-8");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2558.java