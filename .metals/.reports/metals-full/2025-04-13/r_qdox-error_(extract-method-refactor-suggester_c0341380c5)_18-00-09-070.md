error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/532.java
text:
```scala
s@@uper("data-source-remove", true);
 ...
 */
public class DataSourceRemoveHandler extends BatchModeCommandHandler {
    ...
    public DataSourceRemoveHandler() {
        ...
        name = new ArgumentWithValue(this, new DefaultCompleter(new DefaultCompleter.CandidatesProvider() {
            ...
            public List<String> getAllCandidates(CommandContext ctx) {
                ...
                return Util.getDatasources(ctx.getModelControllerClient(), profileArg);
                }
            }), 0, "--name") {
            @Override
            public boolean canAppearNext(CommandContext ctx) throws CommandFormatException {
    ...
    public ModelNode buildRequest(CommandContext ctx) throws CommandFormatException {
        ...
        builder.addNode("data-source", name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/532.java