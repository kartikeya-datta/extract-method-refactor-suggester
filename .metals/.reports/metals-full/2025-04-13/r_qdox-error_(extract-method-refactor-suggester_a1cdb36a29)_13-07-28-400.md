error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1854.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1854.java
text:
```scala
public b@@oolean score(Collector c, int end, int firstDocID) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1854.java