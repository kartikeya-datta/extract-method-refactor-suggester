error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6820.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6820.java
text:
```scala
o@@wner.setUseTimestamp(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6820.java