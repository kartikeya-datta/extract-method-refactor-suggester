error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/715.java
text:
```scala
r@@eturn TypeBinding.FLOAT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/715.java