error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3693.java
text:
```scala
p@@opulateAddModel(operation, model, CONNECTION_PROPERTIES.getName(), DATASOURCE_ATTRIBUTE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3693.java