error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/20.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/20.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/20.java
text:
```scala
i@@f (this.focusType != null && this.focusType.getElementName().equals(simpleName)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/20.java