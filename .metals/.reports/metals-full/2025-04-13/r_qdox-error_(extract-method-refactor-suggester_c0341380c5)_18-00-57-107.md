error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/793.java
text:
```scala
r@@esponse.setCacheDuration(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/793.java