error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6258.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6258.java
text:
```scala
public v@@oid startReceiving() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6258.java