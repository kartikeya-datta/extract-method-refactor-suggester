error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13942.java
text:
```scala
b@@yte FETCH_DOMAIN_CONFIGURATION_REQUEST = 0x57;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13942.java