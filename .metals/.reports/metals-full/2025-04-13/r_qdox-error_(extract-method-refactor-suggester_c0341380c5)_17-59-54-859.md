error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1251.java
text:
```scala
s@@uper(names, 1.0f, fieldType, null, null, provider, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1251.java