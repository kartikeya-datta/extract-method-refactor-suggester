error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17611.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[256,2]

error in qdox parser
file content:
```java
offset: 9698
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17611.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17611.java