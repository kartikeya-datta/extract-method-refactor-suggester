error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14554.java
text:
```scala
s@@b.append(form.getHiddenFieldId(Form.HIDDEN_FIELD_FAKE_SUBMIT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14554.java