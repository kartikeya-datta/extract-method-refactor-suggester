error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8481.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8481.java
text:
```scala
n@@ewSnapshot.seekForward(memorySnapshot.position());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8481.java