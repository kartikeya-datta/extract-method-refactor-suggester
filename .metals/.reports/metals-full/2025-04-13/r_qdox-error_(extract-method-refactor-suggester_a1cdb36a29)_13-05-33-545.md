error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7517.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7517.java
text:
```scala
public static final S@@erviceName SERVICE_NAME = ServiceName.of("jbosgi", "xservice", InitialContext.class.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7517.java