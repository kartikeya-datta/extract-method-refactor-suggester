error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8666.java
text:
```scala
a@@dd(new Label("headline", (String)null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8666.java