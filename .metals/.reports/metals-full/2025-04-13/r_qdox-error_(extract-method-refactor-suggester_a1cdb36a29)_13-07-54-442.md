error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10550.java
text:
```scala
u@@rlshare.sendURL(entry.getRoster().getUser().getName(),entry.getUser().getID());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10550.java