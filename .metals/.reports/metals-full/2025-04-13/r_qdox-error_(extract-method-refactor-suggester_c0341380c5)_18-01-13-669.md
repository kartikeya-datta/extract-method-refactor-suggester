error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11222.java
text:
```scala
d@@ata.add(new Object[] {new TransformersTestParameters(ModelVersion.create(1, 3, 0), TestControllerVersion.V7_1_3_FINAL)});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11222.java