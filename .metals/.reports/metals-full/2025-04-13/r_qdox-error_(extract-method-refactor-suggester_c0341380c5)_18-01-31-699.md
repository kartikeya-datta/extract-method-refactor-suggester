error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5636.java
text:
```scala
r@@eturn new PersistenceUnitInjectionSource(puServiceName, deploymentUnit, injectionTypeName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5636.java