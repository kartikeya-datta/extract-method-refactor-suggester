error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7161.java
text:
```scala
t@@his.concurrentStreamPool = EsExecutors.newScaling(1, concurrentStreams, 60, TimeUnit.SECONDS, EsExecutors.daemonThreadFactory(settings, "[fs_stream]"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7161.java