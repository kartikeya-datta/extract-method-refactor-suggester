error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18162.java
text:
```scala
n@@ew MarkupParserFactory(application, new PrependContextPathHandler()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18162.java