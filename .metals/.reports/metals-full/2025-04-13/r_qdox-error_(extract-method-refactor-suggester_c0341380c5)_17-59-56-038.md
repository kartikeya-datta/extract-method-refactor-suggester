error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7807.java
text:
```scala
A@@tomicReader reader = SlowCompositeReaderWrapper.wrap(DirectoryReader.open(writer, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7807.java