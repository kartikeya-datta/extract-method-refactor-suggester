error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11015.java
text:
```scala
s@@uper(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11015.java