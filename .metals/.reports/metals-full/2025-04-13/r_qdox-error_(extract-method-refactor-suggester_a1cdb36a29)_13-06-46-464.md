error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7347.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7347.java
text:
```scala
final M@@anagementResourceRegistration rootResource = subsystem.registerSubsystemModel(EeSubsystemRootResource.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7347.java