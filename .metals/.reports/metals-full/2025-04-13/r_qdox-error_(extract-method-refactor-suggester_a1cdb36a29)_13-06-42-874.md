error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8067.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8067.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8067.java
text:
```scala
e@@xecutor = executor == null ? threadPool.generic() : executor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8067.java