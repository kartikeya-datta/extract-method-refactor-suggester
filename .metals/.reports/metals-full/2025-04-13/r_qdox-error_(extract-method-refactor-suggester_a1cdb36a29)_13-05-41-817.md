error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8558.java
text:
```scala
T@@HROTTLE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8558.java