error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9519.java
text:
```scala
i@@f(!BuildExecutor.executeAnt("jni/build-windows32home.xml", "-Dhas-compiler=true postcompile -v")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9519.java