error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6342.java
text:
```scala
s@@uper(WorkbenchMessages.OpenPreferences_text);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6342.java