error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14594.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14594.java
text:
```scala
P@@rintDialog dialog = new PrintDialog(shell, SWT.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14594.java