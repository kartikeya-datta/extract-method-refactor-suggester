error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12397.java
text:
```scala
t@@his(LocalizedFormats.UNSUPPORTED_OPERATION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12397.java