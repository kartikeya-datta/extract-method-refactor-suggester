error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3114.java
text:
```scala
i@@f(events.size() == amountOfEventsToExpect) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3114.java