error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9353.java
text:
```scala
o@@utPipe.write( line.getBytes() ); // TODO - charset?
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9353.java