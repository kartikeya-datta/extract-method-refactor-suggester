error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16152.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16152.java
text:
```scala
public v@@oid testAddBinaryFile()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16152.java