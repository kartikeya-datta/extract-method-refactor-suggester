error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2805.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2805.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2805.java
text:
```scala
l@@ogger_.debug("Discarding {}", cfId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2805.java