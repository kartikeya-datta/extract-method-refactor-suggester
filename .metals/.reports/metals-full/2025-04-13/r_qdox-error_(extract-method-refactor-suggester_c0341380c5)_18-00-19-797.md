error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10154.java
text:
```scala
i@@f (!Strings.isEmpty(button.getInput())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10154.java