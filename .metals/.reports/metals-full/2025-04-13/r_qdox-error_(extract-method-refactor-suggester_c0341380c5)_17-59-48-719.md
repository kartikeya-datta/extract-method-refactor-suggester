error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2208.java
text:
```scala
l@@ogger.trace("using [serial] merge scheduler");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2208.java