error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13721.java
text:
```scala
r@@eturn getApplication().getSharedResources().get(Application.class, getId(), getLocale(), getStyle());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13721.java