error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11926.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11926.java
text:
```scala
public v@@oid unregisterRemoteHost(String id, Long remoteConnectionId) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11926.java