error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6229.java
text:
```scala
E@@lement properties = tileElement.getChildByName("properties");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6229.java