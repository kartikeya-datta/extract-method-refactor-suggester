error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5040.java
text:
```scala
S@@cope scope,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5040.java