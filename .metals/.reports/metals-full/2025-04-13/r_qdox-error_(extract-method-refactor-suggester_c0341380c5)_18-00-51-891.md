error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14025.java
text:
```scala
a@@ssertValid("builtin", built_in);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14025.java