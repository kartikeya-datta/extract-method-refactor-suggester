error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1504.java
...
```java
offset: 680
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1504.java
text:
```scala
 ...
 */
p@@ackage org.springframework.ui.binding.binder;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1504.java