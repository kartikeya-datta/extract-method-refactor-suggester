error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10181.java
text:
```scala
p@@ublic class ByteConverter extends AbstractIntegerConverter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10181.java