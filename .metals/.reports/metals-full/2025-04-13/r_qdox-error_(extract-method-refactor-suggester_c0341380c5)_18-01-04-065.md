error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3169.java
text:
```scala
c@@hunkSize = new SizeValue(1, SizeUnit.GB);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3169.java