error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12363.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12363.java
text:
```scala
protected C@@harSequence getURL()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12363.java