error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14438.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14438.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14438.java
text:
```scala
a@@rchive.addAsManifestResource(TypeBeansTestCase.class.getPackage(), "type-jboss-beans.xml", "type-jboss-beans.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14438.java