error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12347.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12347.java
text:
```scala
static i@@nt MINOR_VERSION = 113;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12347.java