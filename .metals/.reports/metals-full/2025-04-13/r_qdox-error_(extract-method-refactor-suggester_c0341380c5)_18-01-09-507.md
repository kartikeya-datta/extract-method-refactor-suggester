error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13999.java
text:
```scala
i@@f (!checkEvent (e)) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13999.java