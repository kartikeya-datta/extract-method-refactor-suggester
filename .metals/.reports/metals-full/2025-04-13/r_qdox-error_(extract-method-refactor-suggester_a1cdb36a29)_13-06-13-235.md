error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3955.java
text:
```scala
i@@f (sValue != null && sValue.endsWith("%")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3955.java