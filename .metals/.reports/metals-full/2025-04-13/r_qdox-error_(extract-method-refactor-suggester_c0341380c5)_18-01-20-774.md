error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16471.java
text:
```scala
g@@etFiles(new File(System.getProperty("root"), "src/etc/testcases/taskdefs/xmlproperty/inputs"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16471.java