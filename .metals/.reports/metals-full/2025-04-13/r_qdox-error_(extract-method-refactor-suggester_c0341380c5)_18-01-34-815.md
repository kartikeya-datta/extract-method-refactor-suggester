error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17257.java
text:
```scala
i@@nt /*long*/ result = OS.objc_msgSend(OS.class_NSMutableURLRequest, OS.sel_requestWithURL_, URL != null ? URL.id : 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17257.java