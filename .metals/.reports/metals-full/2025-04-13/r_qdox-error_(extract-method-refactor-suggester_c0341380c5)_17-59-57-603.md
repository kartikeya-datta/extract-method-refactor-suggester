error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12693.java
text:
```scala
a@@ssertTrue(mex.getMessage().indexOf("has to contain part '<wicket:panel>'") != -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12693.java