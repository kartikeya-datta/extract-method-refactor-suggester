error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1820.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1820.java
text:
```scala
public static final S@@tring NAME = "indices:admin/aliases/exists";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1820.java