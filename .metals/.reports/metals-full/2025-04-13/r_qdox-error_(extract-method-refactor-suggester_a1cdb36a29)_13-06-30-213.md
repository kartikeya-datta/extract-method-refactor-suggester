error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5128.java
text:
```scala
c@@har[] source = Signature.removeCapture(typeSignature.toCharArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5128.java