error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/476.java
text:
```scala
P@@luginJAR jar = jEdit.getPluginJAR(plugin);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/476.java