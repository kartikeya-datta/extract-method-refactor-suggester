error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13222.java
text:
```scala
c@@omponent.internalRenderHead(headerResponse);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13222.java