error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6931.java
text:
```scala
S@@tring protocol = null; // https://github.com/sockjs/sockjs-client/issues/130
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6931.java