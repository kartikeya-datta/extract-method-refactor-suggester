error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5355.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5355.java
text:
```scala
final S@@erverStartTask startTask = new ServerStartTask(0, serviceActivators, updates, environment);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5355.java