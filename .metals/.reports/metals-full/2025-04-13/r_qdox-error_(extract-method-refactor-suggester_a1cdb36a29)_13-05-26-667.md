error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15745.java
text:
```scala
l@@og.warn("Using HoldSampleSender for this test run, ensure you have configured enough memory (-Xmx) for your test"); // server
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15745.java