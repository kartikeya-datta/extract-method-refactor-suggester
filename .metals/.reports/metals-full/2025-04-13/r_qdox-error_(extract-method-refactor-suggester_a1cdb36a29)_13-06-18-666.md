error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8367.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8367.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8367.java
text:
```scala
i@@f (source.length() != 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8367.java