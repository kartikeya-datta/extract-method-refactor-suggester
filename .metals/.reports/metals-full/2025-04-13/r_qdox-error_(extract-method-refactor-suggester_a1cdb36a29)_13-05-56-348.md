error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8083.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8083.java
text:
```scala
 a@@ccessBinding.accessType == SyntheticAccessMethodBinding.SuperMethodAccess){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8083.java