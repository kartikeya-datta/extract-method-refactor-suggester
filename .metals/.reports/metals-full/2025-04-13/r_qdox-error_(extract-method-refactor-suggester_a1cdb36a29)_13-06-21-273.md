error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/166.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/166.java
text:
```scala
p@@arams.set("distrib", "false");               // not a top-level request
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/166.java