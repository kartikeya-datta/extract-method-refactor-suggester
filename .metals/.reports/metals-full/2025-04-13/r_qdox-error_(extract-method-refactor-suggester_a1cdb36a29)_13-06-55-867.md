error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1919.java
...
```java
offset: 68
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1919.java
text:
```scala
public final class MockSepPostingsFormat extends PostingsFormat {

p@@ackage org.apache.lucene.codecs.mocksep;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1919.java