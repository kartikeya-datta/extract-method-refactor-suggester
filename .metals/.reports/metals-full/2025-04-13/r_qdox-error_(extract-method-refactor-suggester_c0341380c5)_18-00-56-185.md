error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18090.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18090.java
text:
```scala
public v@@oid init(final IAppletServer server, final Container container, final Object modelObject)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18090.java