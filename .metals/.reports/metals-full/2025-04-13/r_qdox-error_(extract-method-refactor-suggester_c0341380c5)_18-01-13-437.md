error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10914.java
text:
```scala
b@@oolean replicated = SliceImplHelper.isReplicated(pc, getConfiguration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10914.java