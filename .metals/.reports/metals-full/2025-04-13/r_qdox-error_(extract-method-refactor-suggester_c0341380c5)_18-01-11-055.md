error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6887.java
text:
```scala
c@@e.setDescription("max(0.0, ((" + scale + " - " + valueExpl + ")/" + scale + ")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6887.java