error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17587.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[182,80]

error in qdox parser
file content:
```java
offset: 5777
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17587.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17587.java