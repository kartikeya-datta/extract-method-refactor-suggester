error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2010.java
text:
```scala
i@@f (hit == null || !hit.isDescendantOf(actor)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2010.java