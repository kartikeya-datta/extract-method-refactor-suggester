error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5303.java
text:
```scala
i@@f ((style & SWT.MULTI) != 0 || hooks (SWT.EraseItem) || hooks (SWT.PaintItem)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5303.java