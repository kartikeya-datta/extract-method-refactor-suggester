error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9206.java
text:
```scala
r@@esultList.addAll(partialResultList.getResults());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9206.java