error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2106.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2106.java
text:
```scala
U@@RL url = new URL( "http://svn.apache.org/repos/asf/lucene/dev/trunk/" );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2106.java