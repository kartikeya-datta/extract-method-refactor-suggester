error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5103.java
text:
```scala
s@@uper(type, (IJavaSearchScope)null, computeSubtypes, null/*no working copies*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5103.java