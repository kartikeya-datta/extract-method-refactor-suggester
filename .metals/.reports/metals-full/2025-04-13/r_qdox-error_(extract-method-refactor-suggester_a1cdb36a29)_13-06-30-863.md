error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9591.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9591.java
text:
```scala
private transient P@@ublisher PUB = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9591.java