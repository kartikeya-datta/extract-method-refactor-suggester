error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6938.java
text:
```scala
r@@eturn org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsCharArray(stream, -1, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6938.java