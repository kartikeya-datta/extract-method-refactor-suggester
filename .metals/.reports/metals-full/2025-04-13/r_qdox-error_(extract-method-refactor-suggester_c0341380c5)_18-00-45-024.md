error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7989.java
text:
```scala
B@@uildExecutor.executeAnt(JNI_DIR + "/build-windows32.xml", "");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7989.java