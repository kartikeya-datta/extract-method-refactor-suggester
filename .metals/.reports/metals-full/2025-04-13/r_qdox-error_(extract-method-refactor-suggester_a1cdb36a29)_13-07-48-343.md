error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/199.java
text:
```scala
n@@extIndex = currentIndex;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/199.java