error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4744.java
text:
```scala
E@@JB3_2_0("urn:jboss:domain:ejb3:2.0"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4744.java