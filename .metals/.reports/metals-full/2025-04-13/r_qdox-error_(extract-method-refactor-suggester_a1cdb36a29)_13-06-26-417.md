error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11298.java
text:
```scala
C@@omponent myComponent = getComponent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11298.java