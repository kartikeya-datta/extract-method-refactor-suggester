error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12412.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12412.java
text:
```scala
private i@@nt rows = Integer.MAX_VALUE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12412.java