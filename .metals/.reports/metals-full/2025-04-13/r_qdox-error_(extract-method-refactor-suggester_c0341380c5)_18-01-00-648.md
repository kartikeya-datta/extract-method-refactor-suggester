error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7416.java
text:
```scala
i@@f (tableTree == null || tableTree.isDisposed()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7416.java