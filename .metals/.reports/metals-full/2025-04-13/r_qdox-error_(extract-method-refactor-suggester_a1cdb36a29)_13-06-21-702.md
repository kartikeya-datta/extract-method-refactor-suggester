error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1700.java
text:
```scala
f@@or (String component : SSTable.components)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1700.java