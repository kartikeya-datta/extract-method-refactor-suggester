error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2154.java
text:
```scala
t@@hrow new OperationFailedException(MESSAGES.paramNameAndParamValueRequiredForAddParam());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2154.java