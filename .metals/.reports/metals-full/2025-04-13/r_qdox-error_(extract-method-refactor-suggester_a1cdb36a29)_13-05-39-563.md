error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8091.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8091.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8091.java
text:
```scala
t@@ranslog.closeWithDelete();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8091.java