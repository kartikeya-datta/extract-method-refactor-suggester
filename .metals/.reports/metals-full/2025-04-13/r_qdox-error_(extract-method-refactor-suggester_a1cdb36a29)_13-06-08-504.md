error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11310.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11310.java
text:
```scala
public v@@oid onComponentTag(final Component component, final ComponentTag tag)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11310.java