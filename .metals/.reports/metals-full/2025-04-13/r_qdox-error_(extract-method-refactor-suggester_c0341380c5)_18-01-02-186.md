error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6485.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6485.java
text:
```scala
static public final b@@oolean disableAudio = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6485.java