error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6185.java
text:
```scala
a@@ssertThat("10", is(new SizeValue(10, SizeUnit.BYTES).toString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6185.java