error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3126.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3126.java
text:
```scala
R@@RSIGRecord(Name name, int dclass, long ttl, int covered, int alg, long origttl,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3126.java