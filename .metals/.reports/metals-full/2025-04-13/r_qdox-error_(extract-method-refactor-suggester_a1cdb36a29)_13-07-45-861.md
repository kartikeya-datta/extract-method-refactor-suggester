error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8731.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8731.java
text:
```scala
private b@@oolean dropOnStop=false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8731.java