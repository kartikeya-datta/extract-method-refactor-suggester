error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/762.java
text:
```scala
r@@eturn inflater.inflate(layout.comment_list_view, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/762.java