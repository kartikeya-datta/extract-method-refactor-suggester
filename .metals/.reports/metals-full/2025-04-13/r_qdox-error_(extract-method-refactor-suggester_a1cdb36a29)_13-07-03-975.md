error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7577.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7577.java
text:
```scala
final M@@odelNode subModel = context.getSubModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7577.java