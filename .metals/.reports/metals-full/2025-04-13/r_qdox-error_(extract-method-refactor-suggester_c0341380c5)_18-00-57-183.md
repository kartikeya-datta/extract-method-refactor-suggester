error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2336.java
text:
```scala
m@@avContainer.addAttribute(Conventions.getVariableName(returnValue), returnValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2336.java