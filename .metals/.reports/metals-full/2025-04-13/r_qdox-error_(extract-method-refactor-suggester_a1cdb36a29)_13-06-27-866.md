error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/523.java
text:
```scala
t@@arget.copyBytes(bytesRef);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/523.java