error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9723.java
text:
```scala
i@@f (nodesIds == null || nodesIds.length == 0 || (nodesIds.length == 1 && nodesIds[0].equals("_all"))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9723.java