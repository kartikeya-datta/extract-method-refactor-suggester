error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10616.java
text:
```scala
v@@oid detach();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10616.java