error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/270.java
text:
```scala
...
public class ListChoicePage extends WicketExamplePage
{
	...
	public ListChoicePage()
	{
		...
		// Add a list choice component that uses Input's 'site' property to designate the
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/270.java