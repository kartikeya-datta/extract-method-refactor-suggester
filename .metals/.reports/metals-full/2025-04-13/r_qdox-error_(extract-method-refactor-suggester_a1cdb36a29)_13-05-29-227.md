error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7551.java
text:
```scala
s@@uper(ENTITY_REFERENCE, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7551.java