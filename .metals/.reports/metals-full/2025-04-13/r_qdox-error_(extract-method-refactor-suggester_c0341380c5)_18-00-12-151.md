error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12836.java
text:
```scala
c@@lassname = new JLabeledTextField(JMeterUtils.getResString("tcp_classname")); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12836.java