error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7128.java
text:
```scala
r@@eturn inflater.inflate(layout.comment_list, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7128.java