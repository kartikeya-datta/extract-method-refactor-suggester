error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6503.java
text:
```scala
d@@isplay.sleep();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6503.java