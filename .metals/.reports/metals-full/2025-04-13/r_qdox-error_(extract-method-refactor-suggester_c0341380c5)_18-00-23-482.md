error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6685.java
text:
```scala
r@@eturn new InternalCountAndTotalHistogramFacet(facetName, fieldName, fieldName, interval, comparatorType, histoProc.counts(), histoProc.totals());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6685.java