error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3111.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3111.java
text:
```scala
g@@etMenuBarManager().updateAll(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3111.java