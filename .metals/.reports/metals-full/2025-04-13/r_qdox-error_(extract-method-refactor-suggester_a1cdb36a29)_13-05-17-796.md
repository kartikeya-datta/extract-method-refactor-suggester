error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4011.java
text:
```scala
M@@DR_LOGGER.debugf("Starting service MDR");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4011.java