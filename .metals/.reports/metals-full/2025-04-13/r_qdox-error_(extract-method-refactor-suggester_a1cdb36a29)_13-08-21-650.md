error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1396.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1396.java
text:
```scala
protected S@@tring[] indices;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1396.java