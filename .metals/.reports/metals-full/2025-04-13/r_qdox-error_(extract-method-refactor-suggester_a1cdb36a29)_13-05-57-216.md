error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17751.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[113,80]

error in qdox parser
file content:
```java
offset: 2597
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17751.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17751.java