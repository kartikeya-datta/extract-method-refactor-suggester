error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6106.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6106.java
text:
```scala
C@@ONTAINER_CONFIG(Constants.CONFIGURATION),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6106.java