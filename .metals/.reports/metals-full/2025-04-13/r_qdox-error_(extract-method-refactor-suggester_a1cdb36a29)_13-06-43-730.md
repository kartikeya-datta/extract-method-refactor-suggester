error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7675.java
text:
```scala
r@@egistration.registerXMLElementWriter(RemotingSubsystem11Parser.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7675.java