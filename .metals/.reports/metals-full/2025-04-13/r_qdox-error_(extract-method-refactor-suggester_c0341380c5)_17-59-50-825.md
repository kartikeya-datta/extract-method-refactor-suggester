error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4608.java
text:
```scala
s@@hardEntry.moveFromPrimary();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4608.java