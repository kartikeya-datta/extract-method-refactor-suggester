error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18307.java
text:
```scala
v@@arName = ((CompoundVariable) values[1]).execute().trim();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18307.java