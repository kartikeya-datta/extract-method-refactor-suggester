error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2940.java
text:
```scala
c@@am.position.set(10f, 10f, 10f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2940.java