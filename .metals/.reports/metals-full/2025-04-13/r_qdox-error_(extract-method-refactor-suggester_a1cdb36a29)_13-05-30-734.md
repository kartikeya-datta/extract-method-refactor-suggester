error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9997.java
text:
```scala
a@@ddToBorder(brdr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9997.java