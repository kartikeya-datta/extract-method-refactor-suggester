error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6697.java
text:
```scala
H@@Q_SERVER, IP_ADDRESS, ModelType.STRING, true, ModelType.STRING, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6697.java