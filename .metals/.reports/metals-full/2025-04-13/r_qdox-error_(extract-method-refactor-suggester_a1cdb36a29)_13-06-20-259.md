error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3188.java
text:
```scala
r@@eturn StyledCellLabelProvider.styleDecoratedString(decorated, null, string);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3188.java