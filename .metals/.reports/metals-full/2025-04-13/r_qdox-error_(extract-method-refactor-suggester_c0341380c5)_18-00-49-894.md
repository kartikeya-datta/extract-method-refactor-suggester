error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12635.java
text:
```scala
S@@erverEnvironment serverEnvironment = determineEnvironment(args, new Properties(SecurityActions.getSystemProperties()), SecurityActions.getSystemEnvironment(), ServerEnvironment.LaunchType.STANDALONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12635.java