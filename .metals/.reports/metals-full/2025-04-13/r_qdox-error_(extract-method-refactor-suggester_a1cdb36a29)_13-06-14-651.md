error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18077.java
text:
```scala
i@@f (shadow.getSourceLocation() == null || checker.getSourceLocation() == null) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18077.java