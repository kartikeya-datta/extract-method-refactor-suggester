error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5522.java
text:
```scala
b@@oxedType = new ProblemReferenceBinding(JAVA_LANG_VOID, null, ProblemReasons.NotFound);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5522.java