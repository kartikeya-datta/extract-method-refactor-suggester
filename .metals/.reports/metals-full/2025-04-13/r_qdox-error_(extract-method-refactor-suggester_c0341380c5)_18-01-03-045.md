error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9647.java
text:
```scala
i@@f (currentControl != null && !currentControl.isDisposed()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9647.java