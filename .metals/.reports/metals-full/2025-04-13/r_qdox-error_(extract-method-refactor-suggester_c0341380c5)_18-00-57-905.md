error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1720.java
...
```java
offset: 715
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1720.java
text:
```scala
...
p@@ackage org.springframework.jmx.access;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1720.java