error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2064.java
text:
```scala
t@@extureDesc.minFilter = textureDesc.minFilter = Texture.TextureFilter.Nearest;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2064.java