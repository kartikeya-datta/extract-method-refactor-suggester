error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6386.java
text:
```scala
p@@luginHandler = MainInterface.pluginManager.getHandler("org.columba.mail.filter");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6386.java