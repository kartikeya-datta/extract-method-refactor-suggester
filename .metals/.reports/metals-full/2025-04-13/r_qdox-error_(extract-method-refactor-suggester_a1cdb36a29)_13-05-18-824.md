error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13001.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13001.java
text:
```scala
r@@eturn Double.parseDouble(o.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13001.java