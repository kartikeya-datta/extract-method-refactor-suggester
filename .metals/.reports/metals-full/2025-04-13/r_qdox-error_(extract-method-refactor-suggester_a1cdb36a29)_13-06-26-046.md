error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16366.java
text:
```scala
p@@arent.remove(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16366.java