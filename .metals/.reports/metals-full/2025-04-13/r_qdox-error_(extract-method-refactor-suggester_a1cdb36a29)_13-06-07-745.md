error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2012.java
text:
```scala
i@@f (maxLevel <= levelFloor)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2012.java