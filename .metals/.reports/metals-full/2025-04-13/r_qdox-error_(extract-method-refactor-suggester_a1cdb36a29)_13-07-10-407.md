error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/980.java
text:
```scala
i@@f (augs != null && augs.getItem(Constants.CHAR_REF_PROBABLE_WS) == Boolean.TRUE) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/980.java