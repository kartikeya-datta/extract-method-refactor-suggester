error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14942.java
text:
```scala
r@@eturn "wicket-ajax-indicator";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14942.java