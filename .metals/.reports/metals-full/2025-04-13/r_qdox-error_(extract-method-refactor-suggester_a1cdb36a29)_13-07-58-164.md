error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4220.java
text:
```scala
i@@nt last = qualifiedPackageName.lastIndexOf(File.separatorChar);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4220.java