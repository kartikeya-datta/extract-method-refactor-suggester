error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12786.java
text:
```scala
k@@eysym = key;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12786.java