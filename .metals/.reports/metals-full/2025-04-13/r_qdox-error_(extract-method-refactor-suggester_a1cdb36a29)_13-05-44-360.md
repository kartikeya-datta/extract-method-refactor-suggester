error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4138.java
text:
```scala
c@@ontainer.init(properties);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4138.java