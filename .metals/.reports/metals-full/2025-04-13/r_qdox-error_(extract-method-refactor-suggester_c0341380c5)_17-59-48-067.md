error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13908.java
text:
```scala
g@@etSite().getPage().showView("org.eclipse.m2t.common.recipe.recipeBrowser.RecipeBrowserView");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13908.java