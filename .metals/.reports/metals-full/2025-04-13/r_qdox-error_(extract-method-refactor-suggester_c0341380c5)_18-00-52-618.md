error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5087.java
text:
```scala
i@@f (boost == -1 && rewrite == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5087.java