error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4051.java
text:
```scala
A@@rray<AssetDescriptor> dependencies = Array.of(AssetDescriptor.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4051.java