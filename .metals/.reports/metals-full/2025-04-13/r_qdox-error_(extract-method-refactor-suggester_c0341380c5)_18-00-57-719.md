error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5618.java
text:
```scala
c@@reatorAvatar = (ImageView) headerView.findViewById(id.iv_avatar);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5618.java