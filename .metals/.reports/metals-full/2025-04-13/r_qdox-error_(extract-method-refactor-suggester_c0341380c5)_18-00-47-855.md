error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7435.java
text:
```scala
L@@ist<String> list = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7435.java