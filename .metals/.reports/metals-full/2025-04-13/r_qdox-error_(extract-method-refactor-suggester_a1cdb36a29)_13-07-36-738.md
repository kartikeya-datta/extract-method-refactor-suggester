error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1929.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1929.java
text:
```scala
"g3d/knight.g3dj",@@ "g3d/knight.g3db"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1929.java