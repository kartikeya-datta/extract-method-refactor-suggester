error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1240.java
text:
```scala
n@@ew AnnotProxyFieldValueFactory(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1240.java