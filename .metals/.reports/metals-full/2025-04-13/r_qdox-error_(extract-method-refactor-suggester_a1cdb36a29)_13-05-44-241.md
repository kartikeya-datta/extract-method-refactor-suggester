error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17456.java
text:
```scala
i@@f (traceString.indexOf("java.lang.reflect") < 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17456.java