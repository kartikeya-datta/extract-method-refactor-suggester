error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5281.java
text:
```scala
d@@ebugRenderer.render(world, camera.combined);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5281.java