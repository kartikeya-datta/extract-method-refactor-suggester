error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11308.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11308.java
text:
```scala
public I@@RequestTarget newRequestTarget(Page page, Component component,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11308.java