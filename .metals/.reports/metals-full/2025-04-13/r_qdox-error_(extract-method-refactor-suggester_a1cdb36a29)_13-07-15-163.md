error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3135.java
text:
```scala
n@@odePath = new ArgumentWithValue(this, OperationRequestCompleter.ARG_VALUE_COMPLETER, 0, "--node-path");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3135.java