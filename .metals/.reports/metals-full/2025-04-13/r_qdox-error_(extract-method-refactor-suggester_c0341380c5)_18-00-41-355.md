error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9273.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9273.java
text:
```scala
private static final i@@nt NUMBER_OF_MENU_ITEMS = 9;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9273.java