error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16478.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[68,2]

error in qdox parser
file content:
```java
offset: 1592
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16478.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16478.java