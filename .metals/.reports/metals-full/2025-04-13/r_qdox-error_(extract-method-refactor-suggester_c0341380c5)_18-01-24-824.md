error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6954.java
text:
```scala
L@@ist bodyParts = bodyParent.getChilds();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6954.java