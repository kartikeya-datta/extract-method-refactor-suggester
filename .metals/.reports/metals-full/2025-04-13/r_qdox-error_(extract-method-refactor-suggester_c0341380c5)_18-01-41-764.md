error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11364.java
...
```java
offset: 1102
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11364.java
text:
```scala
...
p@@ackage org.jboss.as.ejb3.component.stateful;
 ...
 * @author Jaikiran Pai
 */
class EJBClientContextIdentifierObjectTable implements ObjectTable {
    @Override
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11364.java