error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6283.java
text:
```scala
i@@nt lParam = OS.MAKELPARAM (nX, nY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6283.java