error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8801.java
text:
```scala
t@@his.useSortedNumericDocValues = v.onOrAfter(Version.V_1_4_0_Beta);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8801.java