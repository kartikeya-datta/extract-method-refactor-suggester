error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6002.java
text:
```scala
r@@eturn OS.objc_msgSend(this.id, OS.sel_hitPart);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6002.java