error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8532.java
text:
```scala
t@@hrow new DeploymentUnitProcessingException("Could not configure component " + componentDescription.getComponentName(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8532.java