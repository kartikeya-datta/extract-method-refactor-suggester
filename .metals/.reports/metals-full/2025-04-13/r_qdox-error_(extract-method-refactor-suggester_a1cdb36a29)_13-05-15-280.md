error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/685.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[66,2]

error in qdox parser
file content:
```java
offset: 1963
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/685.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/685.java