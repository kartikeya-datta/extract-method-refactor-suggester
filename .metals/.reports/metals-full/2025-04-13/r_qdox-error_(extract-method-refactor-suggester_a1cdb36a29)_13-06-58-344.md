error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6423.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6423.java
text:
```scala
 S@@WT.V_SCROLL | SWT.BORDER, new WizardPatternFilter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6423.java