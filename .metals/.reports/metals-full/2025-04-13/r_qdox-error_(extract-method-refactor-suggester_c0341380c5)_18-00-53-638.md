error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9451.java
text:
```scala
f@@ile.create(new ByteArrayInputStream(bytes), IResource.FORCE, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9451.java