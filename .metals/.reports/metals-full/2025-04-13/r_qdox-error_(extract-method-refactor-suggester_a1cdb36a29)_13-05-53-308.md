error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11405.java
text:
```scala
A@@ssert.assertEquals(9, operations.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11405.java