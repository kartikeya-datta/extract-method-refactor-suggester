error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1140.java
text:
```scala
S@@tring builtMapping = docMapper.buildSource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1140.java