error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18291.java
text:
```scala
D@@iffUtil.validatePage(document, this.getClass(), filename,true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18291.java