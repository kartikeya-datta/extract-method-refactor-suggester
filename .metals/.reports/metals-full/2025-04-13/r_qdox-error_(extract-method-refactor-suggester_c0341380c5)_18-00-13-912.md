error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1798.java
text:
```scala
i@@nt response = (int)/*64*/alert.runModal();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1798.java