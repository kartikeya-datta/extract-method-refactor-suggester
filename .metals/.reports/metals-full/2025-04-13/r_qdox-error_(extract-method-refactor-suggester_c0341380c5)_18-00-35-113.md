error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17695.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[84,27]

error in qdox parser
file content:
```java
offset: 2562
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17695.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17695.java