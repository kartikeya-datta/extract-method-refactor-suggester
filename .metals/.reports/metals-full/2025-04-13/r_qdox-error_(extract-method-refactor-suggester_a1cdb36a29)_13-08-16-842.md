error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4637.java
text:
```scala
M@@ap<String, String> params = new HashMap<String, String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4637.java