error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13115.java
text:
```scala
m@@oduleSpec.addDependency(new ModuleDependency(moduleLoader, parentModule, false, false, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13115.java