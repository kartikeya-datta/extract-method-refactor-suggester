error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/331.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/331.java
text:
```scala
d@@ynamicMappingSource = Streams.copyToString(new InputStreamReader(dynamicMappingUrl.openStream(), "UTF-8"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/331.java