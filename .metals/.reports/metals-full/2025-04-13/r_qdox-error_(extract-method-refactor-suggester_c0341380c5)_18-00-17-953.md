error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1770.java
text:
```scala
r@@esult.setSourceRange(this.getStartPosition(), this.getLength());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1770.java