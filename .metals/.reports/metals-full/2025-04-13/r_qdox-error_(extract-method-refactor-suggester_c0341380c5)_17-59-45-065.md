error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5945.java
text:
```scala
T@@ypeBinding collectionType = this.collection == null ? null : this.collection.resolveType(scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5945.java