error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13746.java
text:
```scala
m@@ethod = getDeclaringType().getDeclaredMethod(getName(),getParameterTypes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13746.java