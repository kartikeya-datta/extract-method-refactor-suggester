error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6109.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6109.java
text:
```scala
final S@@tring idAttr = getMarkupId() + "-" + id;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6109.java