error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6624.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6624.java
text:
```scala
static final C@@onsistentHashStrategy DEFAULT = INTRA_CACHE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6624.java