error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2527.java
...
```java
offset: 1041
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2527.java
text:
```scala
enum Element {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2527.java