error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7413.java
text:
```scala
b@@oolean convertVFS = (false == JPAService.isDefaultVFS()); // convert VFS url to FILE based url if JPA_ENABLE_VFS_URLS == false
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7413.java