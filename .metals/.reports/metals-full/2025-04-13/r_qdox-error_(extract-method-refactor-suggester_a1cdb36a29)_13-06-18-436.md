error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10959.java
text:
```scala
R@@emotingConnectorBindingInfoService.install(context.getChildTarget(), context.getController().getName().getSimpleName(), getSocketBinding(), Protocol.REMOTE.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10959.java