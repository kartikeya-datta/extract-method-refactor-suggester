error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2218.java
text:
```scala
a@@ssert references.get() <= 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2218.java