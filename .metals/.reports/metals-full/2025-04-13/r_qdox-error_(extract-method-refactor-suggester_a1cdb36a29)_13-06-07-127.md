error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8813.java
text:
```scala
i@@f (columnCount > 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8813.java