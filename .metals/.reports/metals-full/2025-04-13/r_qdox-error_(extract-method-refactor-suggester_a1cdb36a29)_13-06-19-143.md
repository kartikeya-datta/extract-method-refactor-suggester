error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6706.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(false, false, ATTRIBUTE_DEFINITIONS), new SecurityRealmChildRemoveHandler(false));
...
/**
 * A {@link org.jboss.as.controller.ResourceDefinition} for advanced searches for a users distinguished name.
 *
 * @author <a href="mailto:darran.lofthouse@jboss.com">Darran Lofthouse</a>
 */
public class AdvancedUserSearchResourceDefintion extends BaseLdapUserSearchResource {

    public static final SimpleAttributeDefinition FILTER = new SimpleAttributeDefinitionBuilder(ModelDescriptionConstants.FILTER, ModelType.STRING, false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6706.java