error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7513.java
text:
```scala
c@@heckModelAgainstDefinition(services, ModelVersion.create(1, 3));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7513.java