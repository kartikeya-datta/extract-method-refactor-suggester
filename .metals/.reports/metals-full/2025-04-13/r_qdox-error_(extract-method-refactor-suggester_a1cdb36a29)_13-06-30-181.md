error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/740.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/740.java
text:
```scala
public h@@macSigner(byte [] key) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/740.java