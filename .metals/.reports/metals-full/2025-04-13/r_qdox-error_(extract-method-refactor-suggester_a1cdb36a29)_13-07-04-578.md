error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13808.java
text:
```scala
a@@ddComponentInstantiationListener(new ComponentInjector());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13808.java