error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7669.java
text:
```scala
b@@oolean isShared = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7669.java