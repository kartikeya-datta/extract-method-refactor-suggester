error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14917.java
text:
```scala
i@@nt /*long*/ type = nsEvent.type ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14917.java