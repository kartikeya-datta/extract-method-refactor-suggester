error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1911.java
...
```java
offset: 63
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1911.java
text:
```scala
final class AppendingPostingsFormat extends PostingsFormat {

p@@ackage org.apache.lucene.codecs.appending;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1911.java