error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12431.java
text:
```scala
i@@f( JavaVersion.JAVA1_2  != JavaVersion.getCurrentJavaVersion() )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12431.java