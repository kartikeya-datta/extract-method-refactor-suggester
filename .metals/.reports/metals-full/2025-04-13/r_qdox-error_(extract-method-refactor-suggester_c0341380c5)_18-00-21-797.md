error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14794.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14794.java
text:
```scala
public v@@oid eventFired(BrokerFactoryEvent event);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14794.java