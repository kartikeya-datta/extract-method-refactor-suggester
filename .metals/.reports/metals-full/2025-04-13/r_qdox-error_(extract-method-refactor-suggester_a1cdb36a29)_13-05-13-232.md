error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/555.java
text:
```scala
s@@hapes.rect(x, y, originX, originY, width - 1, height - 1, scaleX, scaleY, rotation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/555.java