error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7012.java
text:
```scala
f@@Runner = Request.classWithoutSuiteMethod(newTestClass).getRunner();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7012.java