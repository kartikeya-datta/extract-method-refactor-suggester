error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7848.java
text:
```scala
p@@ublic class CompoundPropertyModel<T> extends AbstractPropertyInheritableModel<T> implements IInheritableModel<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7848.java