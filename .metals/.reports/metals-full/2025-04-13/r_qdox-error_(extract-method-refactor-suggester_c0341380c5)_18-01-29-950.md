error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4796.java
text:
```scala
l@@ogger.debug(shardIt.shardId() + ": Failed to execute [{}]", failure, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4796.java