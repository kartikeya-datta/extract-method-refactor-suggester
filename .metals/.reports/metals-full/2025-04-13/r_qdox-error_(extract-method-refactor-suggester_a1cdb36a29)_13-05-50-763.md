error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1475.java
text:
```scala
P@@latformMBeanDescriptions.getResolver(PlatformMBeanConstants.MEMORY_POOL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1475.java