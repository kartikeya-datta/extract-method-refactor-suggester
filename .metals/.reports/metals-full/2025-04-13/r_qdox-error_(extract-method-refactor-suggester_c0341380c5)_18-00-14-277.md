error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13047.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13047.java
text:
```scala
final S@@ocketBindingElement socketBinding = new SocketBindingElement(name, group.getDefaultInterface());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13047.java