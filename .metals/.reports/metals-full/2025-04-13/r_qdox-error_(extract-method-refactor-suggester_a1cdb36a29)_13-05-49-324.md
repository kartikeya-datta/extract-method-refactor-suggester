error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8833.java
text:
```scala
t@@his.valueScript = new SearchScript(context.lookup(), scriptLang, valueScript, params, context.scriptService());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8833.java