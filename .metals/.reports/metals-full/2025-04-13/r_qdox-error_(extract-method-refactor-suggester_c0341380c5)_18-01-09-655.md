error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1793.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1793.java
text:
```scala
public I@@ndexOutput createOutput(String name) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1793.java