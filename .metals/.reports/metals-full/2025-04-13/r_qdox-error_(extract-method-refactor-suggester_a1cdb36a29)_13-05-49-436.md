error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/208.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/208.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/208.java
text:
```scala
D@@irectory rd = FSDirectory.getDirectory(indexDir, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/208.java