error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1574.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1574.java
text:
```scala
public b@@oolean willTransform(HttpServletRequest request, Resource original) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1574.java