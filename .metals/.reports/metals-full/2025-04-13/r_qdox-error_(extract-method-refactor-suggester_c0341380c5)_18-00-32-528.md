error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4253.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4253.java
text:
```scala
final B@@ulletConstructor sceneConstructor = new BulletConstructor(sceneModel, 0f, new btBvhTriangleMeshShape(true, sceneModel));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4253.java