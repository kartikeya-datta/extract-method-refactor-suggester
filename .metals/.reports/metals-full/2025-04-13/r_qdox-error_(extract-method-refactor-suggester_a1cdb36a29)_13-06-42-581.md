error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13204.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13204.java
text:
```scala
final S@@erviceContainer container = ServiceContainer.Factory.create("jbossas");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13204.java