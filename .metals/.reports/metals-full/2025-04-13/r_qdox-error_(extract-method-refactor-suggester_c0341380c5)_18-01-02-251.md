error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1457.java
text:
```scala
b@@uilder.field("cluster_name", result.clusterName().value());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1457.java