error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15767.java
text:
```scala
n@@ew HashMap());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15767.java