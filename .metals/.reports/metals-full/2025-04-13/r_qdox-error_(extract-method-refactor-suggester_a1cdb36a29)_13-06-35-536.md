error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/982.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/982.java
text:
```scala
g@@roupPool.freeAll(usedGroups);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/982.java