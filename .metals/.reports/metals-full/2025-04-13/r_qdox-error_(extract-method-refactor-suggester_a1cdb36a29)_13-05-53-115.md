error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7760.java
text:
```scala
c@@learCustomWidths (item.items[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7760.java