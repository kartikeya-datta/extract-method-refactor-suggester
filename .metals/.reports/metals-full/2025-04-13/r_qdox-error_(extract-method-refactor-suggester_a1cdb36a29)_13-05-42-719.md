error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3901.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3901.java
text:
```scala
public v@@oid setMessage(final String message)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3901.java