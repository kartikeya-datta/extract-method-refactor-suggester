error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6158.java
text:
```scala
i@@f (this.targetMapClass != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6158.java