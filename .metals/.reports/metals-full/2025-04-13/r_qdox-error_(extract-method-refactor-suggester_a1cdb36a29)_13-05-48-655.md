error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14948.java
text:
```scala
n@@odeName = EJBManagementUtil.getNodeName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14948.java