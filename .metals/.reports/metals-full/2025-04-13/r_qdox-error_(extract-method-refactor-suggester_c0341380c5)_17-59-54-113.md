error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10748.java
text:
```scala
s@@uper(application.getResourceSettings());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10748.java