error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/412.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/412.java
text:
```scala
r@@eturn new StringBuffer("AbstractMethodCollaboratorIndictment(").append(fName).append(")").toString(); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/412.java