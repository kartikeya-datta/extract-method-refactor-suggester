error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7998.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7998.java
text:
```scala
i@@f (mask == Cocoa.NSControlKeyMask) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7998.java