error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17676.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[118,80]

error in qdox parser
file content:
```java
offset: 4201
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17676.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17676.java