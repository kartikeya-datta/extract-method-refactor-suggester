error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4155.java
text:
```scala
s@@ourcePriorities |= ISources.ACTIVE_PART_ID;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4155.java