error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1342.java
text:
```scala
G@@dxTest test = new AssetManagerTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1342.java