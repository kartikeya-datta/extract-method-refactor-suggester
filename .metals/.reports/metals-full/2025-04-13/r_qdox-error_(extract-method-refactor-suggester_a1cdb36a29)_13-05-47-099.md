error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1339.java
text:
```scala
i@@f(servers == null || servers.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1339.java