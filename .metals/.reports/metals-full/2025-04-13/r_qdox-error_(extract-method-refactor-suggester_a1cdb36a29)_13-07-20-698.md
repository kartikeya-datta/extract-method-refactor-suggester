error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4989.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4989.java
text:
```scala
public static S@@tandaloneClient create(final InetAddress address, int port) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4989.java