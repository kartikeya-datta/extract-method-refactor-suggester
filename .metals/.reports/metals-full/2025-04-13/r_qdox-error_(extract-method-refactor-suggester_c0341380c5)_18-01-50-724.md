error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9476.java
text:
```scala
r@@eturn BooleanTypedValue.FALSE;  // null is not an instanceof anything
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9476.java