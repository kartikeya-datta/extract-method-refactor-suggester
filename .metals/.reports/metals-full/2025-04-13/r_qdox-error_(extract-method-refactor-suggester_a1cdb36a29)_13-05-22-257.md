error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/321.java
text:
```scala
D@@irectory dir = solrCore.getDirectoryFactory().get(solrCore.getIndexDir(), DirContext.DEFAULT, solrCore.getSolrConfig().indexConfig.lockType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/321.java