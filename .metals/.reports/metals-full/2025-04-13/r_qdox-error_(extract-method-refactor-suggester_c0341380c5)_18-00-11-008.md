error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1837.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1837.java
text:
```scala
public static final S@@tring NAME = "indices:monitor/recovery";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1837.java