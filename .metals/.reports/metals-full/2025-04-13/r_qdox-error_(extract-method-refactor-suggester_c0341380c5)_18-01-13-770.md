error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1984.java
text:
```scala
r@@m = RowMutation.serializer().deserialize(new DataInputStream(bufIn), MessagingService.version_, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1984.java