error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/245.java
text:
```scala
k@@ey, sql, userParams));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/245.java