error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2509.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2509.java
text:
```scala
p@@arams.setSamplingThreshold(60);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2509.java