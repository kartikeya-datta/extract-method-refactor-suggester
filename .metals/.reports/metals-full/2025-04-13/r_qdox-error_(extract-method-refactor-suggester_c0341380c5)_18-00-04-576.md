error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13229.java
text:
```scala
N@@SView widget = (NSView)new SWTView().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13229.java