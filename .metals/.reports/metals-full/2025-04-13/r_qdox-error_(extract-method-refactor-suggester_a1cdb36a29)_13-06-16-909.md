error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15439.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15439.java
text:
```scala
public static C@@ompositeTypesystem createJustEmf () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15439.java