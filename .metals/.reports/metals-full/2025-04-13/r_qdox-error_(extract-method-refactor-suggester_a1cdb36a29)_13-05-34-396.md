error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8585.java
text:
```scala
p@@rocessorTarget.addDeploymentProcessor(Phase.INSTALL, Phase.INSTALL_PERSISTENTUNIT, new PersistenceUnitDeploymentProcessor(persistenceUnitRegistry));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8585.java