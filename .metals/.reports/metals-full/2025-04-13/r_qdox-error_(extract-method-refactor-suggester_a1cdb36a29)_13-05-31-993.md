error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13065.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13065.java
text:
```scala
final P@@age page = (Page)component.findParent(Page.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13065.java