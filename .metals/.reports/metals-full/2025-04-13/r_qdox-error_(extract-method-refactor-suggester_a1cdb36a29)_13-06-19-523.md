error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2847.java
text:
```scala
l@@og("Warning: the task name <javadoc2> is deprecated. Use <javadoc> instead.", Project.MSG_WARN);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2847.java