error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7961.java
text:
```scala
v@@alueBytes = smartNameFieldMappers.mapper().indexedValueForSearch(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7961.java