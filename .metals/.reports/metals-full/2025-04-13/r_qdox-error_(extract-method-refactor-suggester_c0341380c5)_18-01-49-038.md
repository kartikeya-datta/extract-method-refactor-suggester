error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1545.java
text:
```scala
c@@ss_.out.printf("=> (column=%s, value=%s, timestamp=%d)\n", new String(column.name, "UTF-8"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1545.java