error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/776.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/776.java
text:
```scala
public I@@ContactItem get(Object uid) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/776.java