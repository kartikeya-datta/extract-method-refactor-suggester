error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18151.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18151.java
text:
```scala
public M@@apProperty(String name, Map<?,?> value) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18151.java