error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7217.java
text:
```scala
r@@eturn new PrimaryResponse<>(shardRequest.request, response, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7217.java