error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5831.java
...
```java
offset: 835
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5831.java
text:
```scala
...
p@@ackage org.columba.mail.config;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5831.java