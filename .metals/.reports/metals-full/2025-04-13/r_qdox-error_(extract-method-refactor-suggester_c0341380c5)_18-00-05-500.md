error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6577.java
text:
```scala
B@@ulkShardRequest bulkShardRequest = new BulkShardRequest(shardId.index().name(), shardId.id(), bulkRequest.refresh(), requests.toArray(new BulkItemRequest[requests.size()]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6577.java