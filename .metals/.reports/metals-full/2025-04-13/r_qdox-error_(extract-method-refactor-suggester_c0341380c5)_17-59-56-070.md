error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8260.java
text:
```scala
l@@ogger.setLevel(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8260.java