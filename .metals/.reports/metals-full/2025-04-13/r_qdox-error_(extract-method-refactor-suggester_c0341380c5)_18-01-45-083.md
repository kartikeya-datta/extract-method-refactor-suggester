error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9346.java
text:
```scala
c@@urrentControl.sendMouseEvent (NSApplication.sharedApplication().currentEvent(), SWT.MouseHover, trackingControl != null && !trackingControl.isDisposed());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9346.java