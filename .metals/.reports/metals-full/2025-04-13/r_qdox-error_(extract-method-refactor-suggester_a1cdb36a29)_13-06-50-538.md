error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9864.java
text:
```scala
l@@ist.add(new BulkItemRequest(i, new DeleteRequest(deleteRequest)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9864.java