error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3889.java
text:
```scala
i@@f (socket != null) throw new ServletException("Allready boud.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3889.java