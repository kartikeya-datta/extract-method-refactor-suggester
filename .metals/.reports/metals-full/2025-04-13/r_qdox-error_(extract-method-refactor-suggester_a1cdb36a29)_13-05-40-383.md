error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5165.java
text:
```scala
O@@S.MoveMemory (lParam, nmcd, NMTVCUSTOMDRAW.sizeof);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5165.java