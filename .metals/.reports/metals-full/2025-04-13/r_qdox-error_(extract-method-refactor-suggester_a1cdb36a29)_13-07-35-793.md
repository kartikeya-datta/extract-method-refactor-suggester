error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5914.java
text:
```scala
w@@idget.reflectScrolledClipView (id, sel, arg0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5914.java