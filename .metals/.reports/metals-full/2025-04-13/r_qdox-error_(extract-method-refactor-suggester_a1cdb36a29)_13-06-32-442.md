error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1692.java
text:
```scala
J@@Frame frame = new JFrame("GDX - Jogl Test Launcher");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1692.java