error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3154.java
text:
```scala
c@@odeStream.fieldAccess(Opcodes.OPC_getstatic, this.assertionSyntheticFieldBinding, null /* default declaringClass */);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3154.java