error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5301.java
text:
```scala
p@@ropertiesLoader.add(new XmlFilePropertiesLoader("properties.xml"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5301.java