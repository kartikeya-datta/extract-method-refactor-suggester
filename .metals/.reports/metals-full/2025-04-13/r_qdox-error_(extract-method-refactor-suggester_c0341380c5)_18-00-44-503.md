error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5695.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5695.java
text:
```scala
public static final S@@tring MANAGEMENT_SUBSYSTEM_ENDPOINT = "management-subsystem-endpoint";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5695.java