error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5393.java
text:
```scala
c@@ompilationUnitDeclaration = parser.parseCompilationUnit(source, true /*full parse to find local elements*/, pm);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5393.java