error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12430.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12430.java
text:
```scala
final I@@Model previous = this.model;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12430.java