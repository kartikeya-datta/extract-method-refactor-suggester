error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8082.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8082.java
text:
```scala
T@@reeItem item = parent._getItem (ids [i], false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8082.java