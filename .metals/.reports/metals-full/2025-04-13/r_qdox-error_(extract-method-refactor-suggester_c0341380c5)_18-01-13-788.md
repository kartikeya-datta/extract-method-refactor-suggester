error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1771.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1771.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1771.java
text:
```scala
d@@oc.add(new TextField("contents", is));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1771.java