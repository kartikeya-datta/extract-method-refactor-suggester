error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4517.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4517.java
text:
```scala
static i@@nt MINOR_VERSION = 615;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4517.java