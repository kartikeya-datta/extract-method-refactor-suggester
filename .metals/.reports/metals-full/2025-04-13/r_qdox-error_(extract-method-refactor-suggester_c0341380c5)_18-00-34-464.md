error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15178.java
text:
```scala
I@@ServiceID sid = (IServiceID) getConnectNamespace().createInstance(new Object[] {st, ""}); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15178.java