error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8586.java
text:
```scala
M@@ap<String, Object> vars = new HashMap<String, Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8586.java