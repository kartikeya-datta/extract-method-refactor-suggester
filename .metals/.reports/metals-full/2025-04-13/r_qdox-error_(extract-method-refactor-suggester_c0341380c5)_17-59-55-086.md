error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1186.java
text:
```scala
S@@SOBaseCase.executeNoAuthSingleSignOnTest(new URL(baseURL1, "/"), new URL(baseURL2, "/"), log);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1186.java