error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16655.java
text:
```scala
m@@arkup = markup.find(child.getId(), 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16655.java