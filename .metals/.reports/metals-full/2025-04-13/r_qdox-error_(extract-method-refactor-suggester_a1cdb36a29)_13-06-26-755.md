error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6985.java
text:
```scala
c@@atches.put("request", tuple("4xx|5xx", allOf(greaterThanOrEqualTo(400), not(equalTo(404)), not(equalTo(409)), not(equalTo(403)))));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6985.java