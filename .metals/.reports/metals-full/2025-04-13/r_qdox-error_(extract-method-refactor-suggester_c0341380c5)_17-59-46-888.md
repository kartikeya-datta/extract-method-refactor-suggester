error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7691.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7691.java
text:
```scala
G@@roupShardsIterator group = clusterService.operationRouting().deleteByQueryShards(clusterService.state(), request.index(), request.routing());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7691.java