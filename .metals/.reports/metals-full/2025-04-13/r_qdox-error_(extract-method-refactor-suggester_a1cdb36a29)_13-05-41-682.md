error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1945.java
text:
```scala
S@@topAnalyzer newStop = new StopAnalyzer(TEST_VERSION_CURRENT, stopWordsSet);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1945.java