error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3764.java
text:
```scala
t@@his.binding = this.anonymousType.createDefaultConstructorWithBinding(inheritedBinding, 	(this.bits & ASTNode.Unchecked) != 0 && this.genericTypeArguments == null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3764.java