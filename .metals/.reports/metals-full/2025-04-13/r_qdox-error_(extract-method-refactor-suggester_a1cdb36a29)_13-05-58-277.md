error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1333.java
text:
```scala
a@@nd is used internally by the Derby optimizer to estimate cost
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1333.java