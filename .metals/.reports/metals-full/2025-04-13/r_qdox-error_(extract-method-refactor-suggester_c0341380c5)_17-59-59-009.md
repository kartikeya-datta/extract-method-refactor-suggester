error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1789.java
text:
```scala
b@@yte [] flatStyle = Converter.wcsToMbcs (null, "style \"swt-flat\" { GtkToolbar::shadow-type = none } widget \"*.swt-toolbar-flat\" style : highest \"swt-flat\"", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1789.java