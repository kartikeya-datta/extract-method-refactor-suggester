error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1514.java
text:
```scala
c@@olumnNames = CachedHeaderfields.getDefaultHeaderfields();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1514.java