error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/626.java
text:
```scala
i@@nt total = count = Math.min(available, count);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/626.java