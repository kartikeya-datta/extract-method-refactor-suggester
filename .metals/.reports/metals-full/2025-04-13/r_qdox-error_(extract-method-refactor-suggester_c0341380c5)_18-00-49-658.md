error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17181.java
text:
```scala
i@@f (isMultiPart())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17181.java