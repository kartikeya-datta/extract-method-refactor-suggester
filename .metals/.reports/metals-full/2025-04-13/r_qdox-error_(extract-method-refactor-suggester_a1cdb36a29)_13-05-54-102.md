error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5750.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5750.java
text:
```scala
public v@@oid updateViewFor(final User user) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5750.java