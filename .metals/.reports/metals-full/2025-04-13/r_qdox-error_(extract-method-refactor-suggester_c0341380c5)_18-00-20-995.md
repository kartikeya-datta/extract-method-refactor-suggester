error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3779.java
text:
```scala
r@@eturn id;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3779.java