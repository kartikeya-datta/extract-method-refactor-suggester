error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/360.java
text:
```scala
r@@eturn  FileUtils.readFully(r);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/360.java