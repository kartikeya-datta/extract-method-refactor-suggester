error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4645.java
text:
```scala
r@@eturn new Rectangle((int)rect.x, (int)rect.y, (int)Math.ceil(rect.width), (int)Math.ceil(rect.height));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4645.java