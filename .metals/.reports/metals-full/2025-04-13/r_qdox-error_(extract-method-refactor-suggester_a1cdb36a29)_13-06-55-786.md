error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5798.java
...
```java
offset: 773
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5798.java
text:
```scala
...
//
//All Rights Reserved.
p@@ackage org.columba.addressbook.model;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5798.java