error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8.java
text:
```scala
c@@om.badlogic.gdx.physics.bullet.softbody.btSoftBody.Material pm = softBody.appendMaterial();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8.java