error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6509.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6509.java
text:
```scala
public c@@har[] getCurrentTokenSourceString() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6509.java