error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6470.java
text:
```scala
m@@apperParser.putTypeParser(JsonAttachmentMapper.JSON_TYPE, new JsonAttachmentMapper.TypeParser());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6470.java