error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8535.java
text:
```scala
r@@eturn getBoolean("enabled", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8535.java