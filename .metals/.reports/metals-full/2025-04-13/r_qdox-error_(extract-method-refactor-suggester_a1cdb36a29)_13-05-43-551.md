error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/280.java
text:
```scala
c@@ontentType = XContentFactory.xContentType(request.contentByteArray(), request.contentByteArrayOffset(), request.contentLength());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/280.java