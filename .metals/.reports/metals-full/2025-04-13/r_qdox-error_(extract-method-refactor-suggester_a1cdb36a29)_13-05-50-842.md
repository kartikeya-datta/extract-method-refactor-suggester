error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3811.java
text:
```scala
I@@DOMPackage pkg = fFactory.createPackage("package " + Util.concatWith(pkgName, '.') + ";" + org.eclipse.jdt.internal.compiler.util.Util.LINE_SEPARATOR); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3811.java