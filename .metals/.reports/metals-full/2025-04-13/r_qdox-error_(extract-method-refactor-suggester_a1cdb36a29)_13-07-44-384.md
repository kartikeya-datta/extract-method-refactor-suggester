error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4087.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4087.java
text:
```scala
public synchronized v@@oid discardJobsUntilNextProjectAddition(String jobFamily) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4087.java