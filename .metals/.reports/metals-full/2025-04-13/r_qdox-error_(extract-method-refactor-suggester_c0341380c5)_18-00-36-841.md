error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5278.java
text:
```scala
w@@rite(out, new File(filename).getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5278.java