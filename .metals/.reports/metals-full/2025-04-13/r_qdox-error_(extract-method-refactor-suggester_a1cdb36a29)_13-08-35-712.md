error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10475.java
text:
```scala
h@@andleError(new ValidationErrorMessage(this, error));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10475.java