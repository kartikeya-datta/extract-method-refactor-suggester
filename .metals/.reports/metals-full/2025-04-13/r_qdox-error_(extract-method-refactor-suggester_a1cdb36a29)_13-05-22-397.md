error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7044.java
text:
```scala
g@@etCred(int section, boolean isAuth) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7044.java