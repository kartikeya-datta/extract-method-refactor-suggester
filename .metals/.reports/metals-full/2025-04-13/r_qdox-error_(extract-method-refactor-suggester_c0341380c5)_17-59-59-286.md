error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/727.java
text:
```scala
s@@etScreen(new GameScreen(this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/727.java