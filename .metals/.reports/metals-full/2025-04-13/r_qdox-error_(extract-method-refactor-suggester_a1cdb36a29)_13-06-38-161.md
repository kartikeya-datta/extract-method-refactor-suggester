error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10838.java
text:
```scala
o@@p.get("protocol").set("HTTP/1.1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10838.java