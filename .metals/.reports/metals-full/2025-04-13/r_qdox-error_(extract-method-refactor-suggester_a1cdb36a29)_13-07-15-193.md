error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/713.java
text:
```scala
e@@scapeMementoName(buff, getElementName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/713.java