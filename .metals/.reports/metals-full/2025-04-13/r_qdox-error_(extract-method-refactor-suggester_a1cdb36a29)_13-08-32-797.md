error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13820.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13820.java
text:
```scala
r@@unningModeControl = configuration.getRunningModeControl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13820.java