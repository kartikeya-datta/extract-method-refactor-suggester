error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12744.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12744.java
text:
```scala
private static final S@@tring MODULE_DEPENDENCIES ="Dependencies: org.infinispan,org.hibernate\n";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12744.java