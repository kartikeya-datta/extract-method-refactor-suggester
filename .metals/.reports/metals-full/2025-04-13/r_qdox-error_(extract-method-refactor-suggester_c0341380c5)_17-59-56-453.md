error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9615.java
text:
```scala
w@@riter.writeAttribute(Attribute.VALUE.getLocalName(), node.get(OVERFLOW_ACTION.getName()).asString().toLowerCase(Locale.ENGLISH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9615.java