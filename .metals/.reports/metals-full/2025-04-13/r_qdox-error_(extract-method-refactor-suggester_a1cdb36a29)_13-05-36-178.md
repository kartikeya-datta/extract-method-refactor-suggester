error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15916.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15916.java
text:
```scala
private final I@@Model model;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15916.java