error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15039.java
text:
```scala
n@@ew PagingNavigation(this, "navigation", table);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15039.java