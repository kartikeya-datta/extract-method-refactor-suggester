error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13488.java
text:
```scala
t@@his.patchType = PatchType.UPGRADE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13488.java