error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13681.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13681.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13681.java
text:
```scala
i@@f (encoding != null && !fEntityScanner.fCurrentEntity.isEncodingExternallySpecified()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13681.java