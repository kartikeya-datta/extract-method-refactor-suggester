error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16416.java
text:
```scala
n@@ew TableItem (this, SWT.NONE, i, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16416.java