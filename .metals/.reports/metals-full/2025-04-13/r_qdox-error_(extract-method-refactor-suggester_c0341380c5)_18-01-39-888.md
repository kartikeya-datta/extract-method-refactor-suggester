error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12378.java
...
```java
offset: 666
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12378.java
text:
```scala
...
p@@ackage org.springframework.jdbc.core.namedparam;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12378.java