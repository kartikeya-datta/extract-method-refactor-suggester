error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13516.java
text:
```scala
L@@ocalOutboundConnectionAdd.INSTANCE, LocalOutboundConnectionRemoveHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13516.java