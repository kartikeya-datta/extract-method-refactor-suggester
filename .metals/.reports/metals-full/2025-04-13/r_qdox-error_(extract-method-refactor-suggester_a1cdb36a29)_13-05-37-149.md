error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1426.java
text:
```scala
t@@hrow new OperationFailedException(PatchManagementMessages.MESSAGES.failedToLoadIdentity(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1426.java