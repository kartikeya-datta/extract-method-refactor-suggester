error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5841.java
text:
```scala
S@@tring suffix = "b";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5841.java