error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10335.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,84]

error in qdox parser
file content:
```java
offset: 84
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10335.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10335.java