error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2321.java
text:
```scala
r@@eturn new DoubleArrayAtomicFieldData.SingleFixedSet(new double[1], 0, new FixedBitSet(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2321.java