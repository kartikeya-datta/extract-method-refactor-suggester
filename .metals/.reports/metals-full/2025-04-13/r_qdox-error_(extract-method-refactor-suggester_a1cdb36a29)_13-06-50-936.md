error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4755.java
text:
```scala
r@@eturn getString(key, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4755.java