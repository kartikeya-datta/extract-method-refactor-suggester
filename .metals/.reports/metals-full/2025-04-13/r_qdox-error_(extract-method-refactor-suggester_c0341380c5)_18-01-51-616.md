error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9741.java
text:
```scala
i@@f (originalBinding != this.binding && originalBinding.returnType != this.binding.returnType) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9741.java