error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9102.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9102.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9102.java
text:
```scala
b@@uildConfig.setOutxmlName(org.aspectj.bridge.Constants.AOP_AJC_XML);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9102.java