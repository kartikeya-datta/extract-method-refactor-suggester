error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7422.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7422.java
text:
```scala
s@@tats = new ArrayList<>(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7422.java