error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7692.java
text:
```scala
s@@hardsIts = clusterService.operationRouting().searchShards(clusterState, request.indices(), request.queryHint(), request.routing());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7692.java