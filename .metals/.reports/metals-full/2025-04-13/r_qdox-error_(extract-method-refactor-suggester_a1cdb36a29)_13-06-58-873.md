error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6293.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6293.java
text:
```scala
i@@f (Application.exists())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6293.java