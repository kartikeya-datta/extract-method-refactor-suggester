error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7423.java
text:
```scala
S@@tring prop = (String) refs[i].getProperty(IServiceConstants.SYNCSTRATEGY_PROVIDER_PROPETY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7423.java