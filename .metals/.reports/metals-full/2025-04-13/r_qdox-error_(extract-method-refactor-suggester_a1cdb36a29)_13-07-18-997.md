error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15960.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15960.java
text:
```scala
private final A@@ppendingStringBuffer buffer = new AppendingStringBuffer(128);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15960.java