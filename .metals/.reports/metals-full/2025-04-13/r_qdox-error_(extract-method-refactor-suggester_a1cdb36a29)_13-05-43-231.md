error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10177.java
text:
```scala
C@@oarseSessionCacheEntry<L> entry = this.invoker.invoke(this.sessionCache, new FindOperation<String, CoarseSessionCacheEntry<L>>(id));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10177.java