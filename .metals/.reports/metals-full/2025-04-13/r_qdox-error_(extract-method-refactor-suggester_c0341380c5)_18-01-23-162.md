error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5365.java
text:
```scala
p@@roject.setRawClasspath(fileEntries, null, true, false, project.getExpandedClasspath(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5365.java