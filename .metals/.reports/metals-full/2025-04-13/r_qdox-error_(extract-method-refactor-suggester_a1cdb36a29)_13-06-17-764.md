error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11500.java
text:
```scala
p@@ublic class InlinePanelPage_5 extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11500.java