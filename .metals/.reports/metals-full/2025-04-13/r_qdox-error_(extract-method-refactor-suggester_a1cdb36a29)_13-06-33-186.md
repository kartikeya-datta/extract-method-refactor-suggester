error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7329.java
text:
```scala
v@@oid initializeExtraSubystemsAndModel(ExtensionContext extensionContext, Resource rootResource, ManagementResourceRegistration rootRegistration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7329.java