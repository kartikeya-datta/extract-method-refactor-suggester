error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11354.java
text:
```scala
p@@ublic class DummyHomePage extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11354.java