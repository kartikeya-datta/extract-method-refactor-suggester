error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1287.java
text:
```scala
T@@ypedValue execute(EvaluationContext context, Object target, Object... arguments) throws AccessException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1287.java