error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12066.java
text:
```scala
g@@etCallbackUrl(true)).append(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12066.java