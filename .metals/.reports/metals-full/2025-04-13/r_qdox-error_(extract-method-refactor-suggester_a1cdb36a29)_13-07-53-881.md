error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5568.java
text:
```scala
s@@ize.width = NSWindow.minFrameWidthWithTitle(NSString.string(), styleMask);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5568.java