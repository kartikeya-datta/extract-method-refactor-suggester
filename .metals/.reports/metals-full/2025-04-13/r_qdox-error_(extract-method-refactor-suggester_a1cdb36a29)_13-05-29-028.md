error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6074.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6074.java
text:
```scala
c@@onstant = FieldReference.getConstantFor(binding, receiver == ThisReference.ThisImplicit, this, scope, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6074.java