error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/138.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/138.java
text:
```scala
i@@f (annotationDecl.getAttributeNS(uri, localpart).length() != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/138.java