error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/15.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/15.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/15.java
text:
```scala
C@@ircle, Edge, Polygon, Chain,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/15.java