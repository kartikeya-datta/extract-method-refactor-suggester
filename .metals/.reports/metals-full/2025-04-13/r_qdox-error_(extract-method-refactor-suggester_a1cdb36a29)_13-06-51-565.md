error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/34.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/34.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/34.java
text:
```scala
private final S@@impleDocValuesFormat defaultDVFormat = SimpleDocValuesFormat.forName("Lucene41");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/34.java