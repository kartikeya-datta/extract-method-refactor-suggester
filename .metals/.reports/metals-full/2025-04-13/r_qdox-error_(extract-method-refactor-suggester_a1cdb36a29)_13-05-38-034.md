error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8809.java
text:
```scala
l@@og.warn("cannot convert url: " + url + " to file (" + ex.getMessage() +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8809.java