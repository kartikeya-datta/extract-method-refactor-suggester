error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18286.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18286.java
text:
```scala
public S@@ecuritySettings(final org.apache.wicket.Application application)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18286.java