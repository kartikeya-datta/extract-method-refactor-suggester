error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18357.java
text:
```scala
S@@tring decWarnMessage = "declare warning: \"Illegal call.\"";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18357.java