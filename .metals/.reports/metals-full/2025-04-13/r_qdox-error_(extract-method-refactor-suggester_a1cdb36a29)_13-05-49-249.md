error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1560.java
text:
```scala
s@@hardsIts = clusterService.operationRouting().searchShards(clusterState, request.indices(), concreteIndices, routingMap, request.preference());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1560.java