error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7889.java
text:
```scala
r@@eturn new BaseChannel((ISharedObjectTransactionConfig) args[0],
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7889.java