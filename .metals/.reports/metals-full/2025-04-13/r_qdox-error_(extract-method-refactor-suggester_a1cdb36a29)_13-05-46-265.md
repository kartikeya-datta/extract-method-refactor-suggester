error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11785.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11785.java
text:
```scala
public A@@bstractDomainModelUpdate<?> getCompensatingUpdate(final DomainModel original) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11785.java