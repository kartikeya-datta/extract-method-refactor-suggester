error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2409.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2409.java
text:
```scala
a@@pplication.setHomePage(pageClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2409.java