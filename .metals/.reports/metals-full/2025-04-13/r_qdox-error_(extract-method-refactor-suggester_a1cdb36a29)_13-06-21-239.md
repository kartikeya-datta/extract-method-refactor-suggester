error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/969.java
text:
```scala
M@@essagingExtension.getResourceDescriptionResolver(false, CommonAttributes.CONNECTOR_SERVICE),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/969.java