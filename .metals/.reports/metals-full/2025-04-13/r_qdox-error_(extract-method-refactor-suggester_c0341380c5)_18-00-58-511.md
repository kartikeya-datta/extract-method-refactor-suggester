error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/277.java
text:
```scala
t@@hrow new IllegalStateException("rrset is empty");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/277.java