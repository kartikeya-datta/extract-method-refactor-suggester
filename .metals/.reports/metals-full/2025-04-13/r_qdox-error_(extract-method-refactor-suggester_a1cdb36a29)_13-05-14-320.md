error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/377.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/377.java
text:
```scala
protected v@@oid update(final int position, final DashboardIssueView view, final RepositoryIssue issue) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/377.java