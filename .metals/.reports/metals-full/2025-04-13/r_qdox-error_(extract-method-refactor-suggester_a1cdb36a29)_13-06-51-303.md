error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/775.java
text:
```scala
b@@uffer.append("[MarkupContainer super = ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/775.java