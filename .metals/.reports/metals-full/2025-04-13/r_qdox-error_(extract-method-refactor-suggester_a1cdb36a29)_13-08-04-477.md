error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3282.java
text:
```scala
S@@earchContext context = new SearchContext(idGenerator.incrementAndGet(), shardTarget, request.numberOfShards(), request.timeout(), request.types(), engineSearcher, indexService, scriptService);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3282.java