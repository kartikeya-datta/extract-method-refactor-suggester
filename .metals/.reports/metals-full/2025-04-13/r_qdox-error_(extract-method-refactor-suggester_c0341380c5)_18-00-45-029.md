error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1231.java
text:
```scala
A@@jde.getDefault().getBuildManager().build(); // was buildStructure...
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1231.java