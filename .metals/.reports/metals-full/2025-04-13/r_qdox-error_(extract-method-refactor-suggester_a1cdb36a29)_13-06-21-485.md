error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4146.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4146.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4146.java
text:
```scala
i@@f (!onDemand && ((f.bits & ASTNode.OnDemand) == 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4146.java