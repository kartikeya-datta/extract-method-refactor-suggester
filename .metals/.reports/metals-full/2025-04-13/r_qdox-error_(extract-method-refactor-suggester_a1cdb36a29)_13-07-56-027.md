error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9589.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9589.java
text:
```scala
public v@@oid XtestDirsetPathWithoutPackagenames() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9589.java