error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3365.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3365.java
text:
```scala
protected abstract b@@oolean match(int doc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3365.java