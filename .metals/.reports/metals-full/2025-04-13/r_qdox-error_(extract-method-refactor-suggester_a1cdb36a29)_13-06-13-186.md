error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6569.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6569.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6569.java
text:
```scala
C@@lass internalErrorPageClass = application.getApplicationSettings().getInternalErrorPage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6569.java