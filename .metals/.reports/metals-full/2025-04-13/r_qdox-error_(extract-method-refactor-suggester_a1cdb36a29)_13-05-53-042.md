error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/912.java
text:
```scala
a@@dd(new DefaultDataTable(this,"contacts", Arrays.asList(cols), getDataProvider(), 5));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/912.java