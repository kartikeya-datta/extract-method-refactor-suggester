error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9165.java
text:
```scala
l@@ong getLineNumber() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9165.java