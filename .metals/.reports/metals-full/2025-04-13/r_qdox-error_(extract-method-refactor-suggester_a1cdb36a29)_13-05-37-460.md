error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3037.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3037.java
text:
```scala
final l@@ong t = System.nanoTime();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3037.java