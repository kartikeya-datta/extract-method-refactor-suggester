error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/312.java
text:
```scala
f@@or (int i = 0; i < 100*_TestUtil.getRandomMultiplier(); i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/312.java