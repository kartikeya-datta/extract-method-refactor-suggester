error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8090.java
text:
```scala
S@@essionID sessionId = context.getPrivateData(SessionID.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8090.java