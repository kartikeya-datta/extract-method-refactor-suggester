error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1740.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1740.java
text:
```scala
Q@@uery query = highlighterContext.query.originalQuery();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1740.java