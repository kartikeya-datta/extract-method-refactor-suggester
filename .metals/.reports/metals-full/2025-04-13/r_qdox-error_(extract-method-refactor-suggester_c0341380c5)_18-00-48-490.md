error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2025.java
text:
```scala
r@@eturn (byte) f;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2025.java