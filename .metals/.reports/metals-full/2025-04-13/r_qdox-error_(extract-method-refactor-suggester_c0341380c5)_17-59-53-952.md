error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4151.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4151.java
text:
```scala
private static final L@@ist<Bucket> BUCKETS = Collections.emptyList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4151.java