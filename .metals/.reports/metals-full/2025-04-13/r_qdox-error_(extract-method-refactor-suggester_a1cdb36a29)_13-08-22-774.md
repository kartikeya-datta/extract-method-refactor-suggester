error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13914.java
text:
```scala
n@@orthPanel.setLayout(new VerticalLayout(5, VerticalLayout.BOTH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13914.java