error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9496.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9496.java
text:
```scala
private static final L@@ist<String> SUPPORTED = Lists.newArrayList("regex", "gtelte");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9496.java