error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10602.java
text:
```scala
c@@ontext.setResult(this.methodInvoker.invoke());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10602.java