error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/647.java
text:
```scala
D@@erby interface for creating a stored form for
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/647.java