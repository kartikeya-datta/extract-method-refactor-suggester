error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1380.java
text:
```scala
r@@eturn getBinary( "nohref" );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1380.java