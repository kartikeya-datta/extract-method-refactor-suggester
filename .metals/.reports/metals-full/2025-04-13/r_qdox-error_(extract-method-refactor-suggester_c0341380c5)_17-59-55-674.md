error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6917.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6917.java
text:
```scala
public S@@tyleSheetReference(MarkupContainer parent,String id, Class referer, String file)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6917.java