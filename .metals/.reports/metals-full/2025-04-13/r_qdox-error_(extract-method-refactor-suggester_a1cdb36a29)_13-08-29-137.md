error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15430.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15430.java
text:
```scala
r@@eturn XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 1, getAddress(), uuid, result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15430.java