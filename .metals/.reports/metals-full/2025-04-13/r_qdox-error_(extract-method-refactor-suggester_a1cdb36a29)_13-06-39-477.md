error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15065.java
text:
```scala
i@@nt /*long*/[] result = new int /*long*/[1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15065.java