error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9474.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9474.java
text:
```scala
private final static S@@tring bundleName = "org.eclipse.jdt.internal.core.messages"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9474.java