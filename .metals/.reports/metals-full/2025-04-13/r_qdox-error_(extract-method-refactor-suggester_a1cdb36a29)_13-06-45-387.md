error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2647.java
text:
```scala
t@@hrow MESSAGES.cannotParseOSGiMetadata(ex, xserviceFile);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2647.java