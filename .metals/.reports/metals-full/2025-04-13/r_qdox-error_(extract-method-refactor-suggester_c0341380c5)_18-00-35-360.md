error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9968.java
text:
```scala
r@@eturn new UserPagerAdapter(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9968.java