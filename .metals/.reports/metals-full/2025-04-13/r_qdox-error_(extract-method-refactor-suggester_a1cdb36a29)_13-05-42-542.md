error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/819.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/819.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/819.java
text:
```scala
g@@etFrameMediator().getStatusBar().cancelDisplayedWorker();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/819.java