error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5472.java
text:
```scala
r@@eplaceChild(this.expression, expression, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5472.java