error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/463.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/463.java
text:
```scala
public final v@@oid maybeRefreshBlocking() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/463.java