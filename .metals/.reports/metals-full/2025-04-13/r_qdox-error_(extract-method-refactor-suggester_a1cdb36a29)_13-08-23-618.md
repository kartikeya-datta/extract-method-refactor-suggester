error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9543.java
text:
```scala
r@@eturn TypeBinding.LONG;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9543.java