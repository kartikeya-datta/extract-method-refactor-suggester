error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2586.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2586.java
text:
```scala
protected R@@esponse getRealResponse()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2586.java