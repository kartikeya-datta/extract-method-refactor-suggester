error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5319.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5319.java
text:
```scala
static public v@@oid free (Array objects) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5319.java