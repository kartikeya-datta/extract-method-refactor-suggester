error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3709.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3709.java
text:
```scala
private static final S@@tring[] LANGUAGE_TAGS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3709.java