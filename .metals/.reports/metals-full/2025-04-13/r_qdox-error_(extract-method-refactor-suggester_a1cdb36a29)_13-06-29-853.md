error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3115.java
text:
```scala
w@@hile ((c = reader.read()) != -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3115.java