error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6974.java
text:
```scala
e@@ffect.start();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6974.java