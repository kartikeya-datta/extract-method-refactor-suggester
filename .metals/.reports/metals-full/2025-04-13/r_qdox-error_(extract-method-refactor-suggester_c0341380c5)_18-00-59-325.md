error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13545.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13545.java
text:
```scala
public v@@oid DISABLEDtestBug50799() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13545.java