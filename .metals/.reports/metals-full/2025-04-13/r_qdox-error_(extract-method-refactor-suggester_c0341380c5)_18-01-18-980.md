error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1058.java
text:
```scala
a@@ctor.sizeBy(amountWidth * percentDelta, amountHeight * percentDelta);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1058.java