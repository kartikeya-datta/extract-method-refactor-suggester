error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5977.java
text:
```scala
d@@oReadElement(reader, builder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5977.java