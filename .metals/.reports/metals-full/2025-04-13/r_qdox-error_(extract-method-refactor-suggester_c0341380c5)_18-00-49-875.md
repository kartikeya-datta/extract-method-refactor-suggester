error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5429.java
text:
```scala
r@@eturn new InternalStatisticalFacet(facetName, min, max, total, sumOfSquares, count);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5429.java