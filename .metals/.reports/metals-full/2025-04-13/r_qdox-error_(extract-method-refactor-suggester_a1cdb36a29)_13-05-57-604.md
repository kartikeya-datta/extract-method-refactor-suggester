error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14478.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14478.java
text:
```scala
final S@@erviceController<?> controller = updateContext.getServiceRegistry().getRequiredService(LogServices.loggerName(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14478.java