error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8998.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8998.java
text:
```scala
f@@orm.visitChildren(FormComponent.class, new IVisitor<FormComponent<?>>()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8998.java