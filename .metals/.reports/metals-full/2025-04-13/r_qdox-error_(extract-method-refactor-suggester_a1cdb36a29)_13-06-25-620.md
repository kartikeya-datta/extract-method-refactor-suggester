error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7814.java
text:
```scala
d@@oit = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7814.java