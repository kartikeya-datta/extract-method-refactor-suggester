error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12734.java
text:
```scala
t@@hrow new IOException(String.format("Invalid %d bit code 0x%x", codeSize, code));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12734.java