error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13580.java
text:
```scala
v@@oid setTempClassLoaderFactory(TempClassLoaderFactory tempClassLoaderFactory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13580.java