error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5853.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5853.java
text:
```scala
public final C@@harSequence urlFor(final IPageMap pageMap, final Class pageClass,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5853.java