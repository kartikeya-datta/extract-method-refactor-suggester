error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9223.java
text:
```scala
r@@eturn new PercolateShardRequest(shard.shardId(), numShards, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9223.java