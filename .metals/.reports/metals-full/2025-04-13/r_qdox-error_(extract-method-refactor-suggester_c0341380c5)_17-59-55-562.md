error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7572.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7572.java
text:
```scala
w@@hile (this.pcToSourceMapSize >= 2 && this.pcToSourceMap[this.pcToSourceMapSize - 2] > this.position) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7572.java