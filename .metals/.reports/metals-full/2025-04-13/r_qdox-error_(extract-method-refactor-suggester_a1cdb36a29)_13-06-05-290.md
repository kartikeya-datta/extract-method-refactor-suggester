error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16358.java
text:
```scala
t@@estFile2 =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16358.java