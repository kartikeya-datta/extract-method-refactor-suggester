error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1567.java
text:
```scala
T@@hread.sleep(40000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1567.java