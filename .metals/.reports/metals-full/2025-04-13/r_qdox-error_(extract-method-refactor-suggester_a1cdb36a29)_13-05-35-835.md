error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4617.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4617.java
text:
```scala
public static S@@tring TRACK_STREAM = "TrackerAggregator/track";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4617.java