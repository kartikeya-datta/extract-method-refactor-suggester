error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12417.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12417.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12417.java
text:
```scala
i@@f ((!OS.IsWinCE && OS.WIN32_VERSION >= OS.VERSION (6, 0)) || (style & SWT.VIRTUAL) != 0 || hooks (SWT.EraseItem) || hooks (SWT.PaintItem)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12417.java