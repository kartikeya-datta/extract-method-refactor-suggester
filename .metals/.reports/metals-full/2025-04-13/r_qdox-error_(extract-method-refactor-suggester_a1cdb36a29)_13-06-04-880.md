error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/769.java
text:
```scala
B@@aseDirectoryWrapper dir = newDirectory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/769.java