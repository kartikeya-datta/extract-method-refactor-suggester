error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5847.java
text:
```scala
i@@f (!exactType.isAspect() && !pi.isIncludeSubtypes() && !exactType.isTypeVariableReference()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5847.java