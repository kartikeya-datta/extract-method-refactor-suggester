error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/804.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/804.java
text:
```scala
public static L@@ist<String> readRefs(final Properties properties) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/804.java