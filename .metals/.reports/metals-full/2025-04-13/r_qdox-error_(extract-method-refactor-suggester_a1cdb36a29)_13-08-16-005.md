error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6092.java
text:
```scala
n@@ew AjaxLink(page, "ajaxLink")
...
public class AjaxLinkClickTest extends WicketTestCase
{
	...
	public void testBasicAjaxLinkClick()
	{
		...
		AjaxLink ajaxLink = new AjaxLink(page, "ajaxLink")
		{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6092.java