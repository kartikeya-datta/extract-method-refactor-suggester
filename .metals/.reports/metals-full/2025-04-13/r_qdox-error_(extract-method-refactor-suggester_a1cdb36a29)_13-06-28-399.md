error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14474.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14474.java
text:
```scala
final S@@erviceController<?> controller = updateContext.getServiceRegistry().getService(SocketBinding.JBOSS_BINDING_NAME.append(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14474.java