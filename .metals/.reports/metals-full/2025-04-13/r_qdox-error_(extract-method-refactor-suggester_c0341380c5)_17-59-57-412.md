error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/535.java
text:
```scala
c@@ontext.getFailureDescription().set(new ModelNode().set("No handler for operation address " + address));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/535.java