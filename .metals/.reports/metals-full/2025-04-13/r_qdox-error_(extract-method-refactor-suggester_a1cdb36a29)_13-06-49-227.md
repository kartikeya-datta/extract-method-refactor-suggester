error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5088.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5088.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5088.java
text:
```scala
public F@@ile shardIndexLocation(ShardId shardId) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5088.java