error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/188.java
text:
```scala
C@@ompilationUnitResolver.parse(source, JavaCore.getOptions()); // no better custom options
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/188.java