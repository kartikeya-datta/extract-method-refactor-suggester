error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1606.java
text:
```scala
A@@rray<Asset> assets = new Array<Asset>(lines.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1606.java