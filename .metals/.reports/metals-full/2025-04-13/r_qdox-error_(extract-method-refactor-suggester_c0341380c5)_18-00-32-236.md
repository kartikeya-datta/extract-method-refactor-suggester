error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12429.java
text:
```scala
I@@Model model;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12429.java