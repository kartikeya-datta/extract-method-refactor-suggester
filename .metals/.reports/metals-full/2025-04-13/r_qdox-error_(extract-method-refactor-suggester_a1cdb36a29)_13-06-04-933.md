error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8684.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8684.java
text:
```scala
s@@uper(anonymous);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8684.java