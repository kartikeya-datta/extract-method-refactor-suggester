error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3651.java
text:
```scala
o@@utputWriter.getContents().indexOf("incremental mode only handles source files using -sourceroots") != -1);	;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3651.java