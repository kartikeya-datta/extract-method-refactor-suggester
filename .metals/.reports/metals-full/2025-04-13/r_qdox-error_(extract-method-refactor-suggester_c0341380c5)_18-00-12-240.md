error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2460.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2460.java
text:
```scala
final s@@hort anotherVal = other.value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2460.java