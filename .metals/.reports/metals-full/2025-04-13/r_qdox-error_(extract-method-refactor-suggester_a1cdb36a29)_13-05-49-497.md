error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/764.java
text:
```scala
c@@ollisionCenter.set(collisionPoints.get(2)).scl(0.5f).add(collisionPoints.get(0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/764.java