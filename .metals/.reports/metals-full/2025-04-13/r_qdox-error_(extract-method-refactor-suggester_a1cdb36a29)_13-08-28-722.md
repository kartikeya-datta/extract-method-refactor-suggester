error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7560.java
text:
```scala
R@@aOperationUtil.removeIfActive(context, raName, idName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7560.java