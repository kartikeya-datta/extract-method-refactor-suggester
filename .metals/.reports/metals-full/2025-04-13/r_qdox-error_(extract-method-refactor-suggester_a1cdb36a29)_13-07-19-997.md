error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7979.java
text:
```scala
g@@etProjections(exps, ((NewInstanceSelection<?>)s).getSelectionItems(), projections, aliases,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7979.java