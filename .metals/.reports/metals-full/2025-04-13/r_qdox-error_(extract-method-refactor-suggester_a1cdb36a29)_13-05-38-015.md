error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1861.java
text:
```scala
r@@eturn "/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1861.java