error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15183.java
text:
```scala
r@@eturn SWT.NO_FOCUS | (style & mask);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15183.java