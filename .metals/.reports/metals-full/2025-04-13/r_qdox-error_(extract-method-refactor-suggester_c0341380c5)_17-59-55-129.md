error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5959.java
text:
```scala
p@@ane.showSystemMenu();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5959.java