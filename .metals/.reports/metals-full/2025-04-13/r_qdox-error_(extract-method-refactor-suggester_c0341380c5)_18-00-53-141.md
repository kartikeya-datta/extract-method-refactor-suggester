error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2999.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2999.java
text:
```scala
protected S@@tringEncoder createStringEncoder() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2999.java