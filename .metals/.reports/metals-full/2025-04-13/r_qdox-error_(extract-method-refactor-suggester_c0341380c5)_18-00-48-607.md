error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/399.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/399.java
text:
```scala
private i@@nt startupTimeoutInSeconds = 120;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/399.java