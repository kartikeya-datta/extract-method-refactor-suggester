error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14905.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14905.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14905.java
text:
```scala
r@@edrawWidget (scrolledHandle, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14905.java