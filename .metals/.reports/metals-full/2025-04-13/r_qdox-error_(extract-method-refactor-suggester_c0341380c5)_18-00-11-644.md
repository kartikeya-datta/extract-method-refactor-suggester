error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7989.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7989.java
text:
```scala
public abstract b@@oolean setUrl (String url, String postData, String[] headers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7989.java