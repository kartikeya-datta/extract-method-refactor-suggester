error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3392.java
text:
```scala
p@@arser.add(new HtmlProblemFinder(HtmlProblemFinder.ERR_THROW_EXCEPTION),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3392.java