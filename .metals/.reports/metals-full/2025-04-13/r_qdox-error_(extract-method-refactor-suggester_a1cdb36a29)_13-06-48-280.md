error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11914.java
text:
```scala
i@@f (!newColumns [i].isDisposed ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11914.java