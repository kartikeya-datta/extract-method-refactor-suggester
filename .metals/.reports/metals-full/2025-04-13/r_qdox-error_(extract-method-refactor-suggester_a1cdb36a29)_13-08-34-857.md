error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/23.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/23.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/23.java
text:
```scala
public C@@lass< ? extends Component< ? >> getComponentClass()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/23.java