error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/713.java
text:
```scala
l@@ogger.info("recovered [{}] indices into cluster_state", clusterState.metaData().indices().size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/713.java