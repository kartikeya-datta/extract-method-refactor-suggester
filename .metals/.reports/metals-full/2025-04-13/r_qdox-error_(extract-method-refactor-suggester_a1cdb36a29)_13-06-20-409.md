error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13673.java
text:
```scala
l@@og.tracef("Scheduling request %s with future %s", this, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13673.java