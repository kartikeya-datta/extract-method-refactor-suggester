error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2597.java
text:
```scala
a@@dd(new Label<String>("messageLabel", message));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2597.java