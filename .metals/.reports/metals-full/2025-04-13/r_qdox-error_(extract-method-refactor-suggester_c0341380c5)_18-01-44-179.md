error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5371.java
text:
```scala
S@@tring[] concreteIndices = clusterState.metaData().concreteIndices(searchRequest.indices(), false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5371.java