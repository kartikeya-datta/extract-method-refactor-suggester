error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9230.java
text:
```scala
t@@his(items, skin.get(ListStyle.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9230.java