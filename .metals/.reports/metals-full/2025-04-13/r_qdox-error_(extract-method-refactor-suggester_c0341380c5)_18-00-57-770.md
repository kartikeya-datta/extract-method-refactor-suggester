error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3686.java
text:
```scala
i@@nt iters = scaledRandomIntBetween(1000, 10000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3686.java