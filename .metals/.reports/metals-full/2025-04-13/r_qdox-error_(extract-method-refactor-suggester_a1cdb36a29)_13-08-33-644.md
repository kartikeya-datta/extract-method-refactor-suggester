error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2765.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2765.java
text:
```scala
synchronized (@@this) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2765.java