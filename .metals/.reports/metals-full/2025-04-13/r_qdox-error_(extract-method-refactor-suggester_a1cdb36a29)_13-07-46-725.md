error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2739.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2739.java
text:
```scala
public v@@oid updatedGUI() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2739.java