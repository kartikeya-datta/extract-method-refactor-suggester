error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3440.java
text:
```scala
S@@tring file = args[1] + File.separator + "Bloom-Filter-" + i + ".dat";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3440.java