error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9652.java
text:
```scala
s@@witchStatement.expression = expressionStack[expressionPtr--];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9652.java