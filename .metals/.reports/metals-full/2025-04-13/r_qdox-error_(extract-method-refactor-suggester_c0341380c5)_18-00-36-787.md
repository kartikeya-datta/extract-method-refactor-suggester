error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8767.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8767.java
text:
```scala
final B@@ook book = (Book)getModelObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8767.java