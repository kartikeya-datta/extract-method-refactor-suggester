error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3425.java
text:
```scala
n@@ew StringBuffer(Util.bind("accept.cannot"/*nonNLS*/))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3425.java