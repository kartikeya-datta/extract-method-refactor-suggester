error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5200.java
text:
```scala
i@@f (!(ex instanceof PageExpiredException))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5200.java