error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6699.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6699.java
text:
```scala
public static final i@@nt COMPONENT_CMT_INTERCEPTOR                                   = 0x410;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6699.java