error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11279.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11279.java
text:
```scala
private final M@@ean[] means;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11279.java