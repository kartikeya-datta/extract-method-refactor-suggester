error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6827.java
text:
```scala
v@@iewCertButton.setText(Compatibility.getMessage("SWT_ViewCertificate")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6827.java