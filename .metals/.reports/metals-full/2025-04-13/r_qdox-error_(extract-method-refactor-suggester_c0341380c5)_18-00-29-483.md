error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8439.java
text:
```scala
H@@eaderPartContainer< ? > newHeaderPartContainer(String id, String scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8439.java