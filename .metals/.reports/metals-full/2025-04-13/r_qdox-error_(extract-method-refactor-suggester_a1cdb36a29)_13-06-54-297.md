error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1102.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1102.java
...
```java
offset: 899
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1102.java
text:
```scala
 ...
 *
 */
p@@ackage org.apache.tools.ant.types.resources;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1102.java