error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2883.java
text:
```scala
c@@am.position.set(bounds.getCenter().cpy().add(len*2, len*2, len*2));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2883.java