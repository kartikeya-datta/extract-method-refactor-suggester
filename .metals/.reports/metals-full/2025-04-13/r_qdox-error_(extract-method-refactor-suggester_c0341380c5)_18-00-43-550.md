error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13253.java
text:
```scala
t@@hrow new IOException("failed to skip file name in"
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13253.java