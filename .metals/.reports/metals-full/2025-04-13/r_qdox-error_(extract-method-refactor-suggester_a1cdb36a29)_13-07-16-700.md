error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15031.java
text:
```scala
S@@impleAttributeDefinition USE_PARENT_HANDLERS = new SimpleAttributeDefinitionBuilder("use-parent-handlers", ModelType.BOOLEAN, true).
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15031.java