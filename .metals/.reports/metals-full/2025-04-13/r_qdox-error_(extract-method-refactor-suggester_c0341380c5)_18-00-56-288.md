error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11900.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11900.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11900.java
text:
```scala
public v@@oid testDoctype_InheritedPage() throws Exception
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11900.java