error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10552.java
text:
```scala
r@@eturn new QuickStartSession(QuickStartApplication.this, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10552.java