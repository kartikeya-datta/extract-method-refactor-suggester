error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1778.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1778.java
text:
```scala
@Override protected C@@lusterStateResponse masterOperation(ClusterStateRequest request, ClusterState state) throws ElasticSearchException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1778.java