error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8290.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8290.java
text:
```scala
public static G@@C gtk_new(int /*long*/ handle, GCData data) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8290.java