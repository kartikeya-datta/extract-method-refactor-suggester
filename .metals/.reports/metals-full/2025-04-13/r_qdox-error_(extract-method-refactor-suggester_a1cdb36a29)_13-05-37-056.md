error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4489.java
text:
```scala
r@@eceiver.checkNPE(currentScope, flowContext, flowInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4489.java