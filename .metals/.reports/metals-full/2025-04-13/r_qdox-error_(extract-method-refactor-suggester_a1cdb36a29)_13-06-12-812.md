error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14413.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14413.java
text:
```scala
final D@@estination destination = (Destination) ctx.lookup("java:jboss/jms/queue/test");
 ...
 */
package org.jboss.as.test.spec.ejb3.mdb;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14413.java