error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9760.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9760.java
text:
```scala
private static final S@@tring UNNAMED = "UNNAMED";//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9760.java