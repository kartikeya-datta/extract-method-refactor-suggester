error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3920.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3920.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3920.java
text:
```scala
i@@f (entry.bytes().underlyingBytes().length > BYTES_LIMIT) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3920.java