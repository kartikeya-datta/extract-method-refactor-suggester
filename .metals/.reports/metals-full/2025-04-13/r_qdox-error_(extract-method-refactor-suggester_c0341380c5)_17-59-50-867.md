error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14714.java
text:
```scala
S@@tring text = parse (getText ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14714.java