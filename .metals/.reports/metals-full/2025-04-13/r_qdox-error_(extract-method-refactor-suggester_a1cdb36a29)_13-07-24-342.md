error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1574.java
text:
```scala
d@@ocWriter = new DocumentsWriter(directory, this, conf.getIndexingChain(), conf.getMaxThreadStates());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1574.java