error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3643.java
text:
```scala
c@@olumnName,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3643.java