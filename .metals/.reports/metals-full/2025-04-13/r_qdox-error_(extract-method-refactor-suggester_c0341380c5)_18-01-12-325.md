error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9550.java
text:
```scala
e@@xtends Component, Loggable, Contextualizable, Runnable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9550.java