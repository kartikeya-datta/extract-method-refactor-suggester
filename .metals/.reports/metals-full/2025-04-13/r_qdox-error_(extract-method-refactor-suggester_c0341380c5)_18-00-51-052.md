error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2838.java
text:
```scala
p@@arsedQuery(ParsedQuery.parsedMatchAllQuery());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2838.java