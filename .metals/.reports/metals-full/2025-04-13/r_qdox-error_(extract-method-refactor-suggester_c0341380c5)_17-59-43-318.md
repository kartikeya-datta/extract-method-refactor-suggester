error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7593.java
text:
```scala
t@@hrow new ElasticSearchIllegalStateException("Can't create an index [" + sIndexName + "], node is closed");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7593.java