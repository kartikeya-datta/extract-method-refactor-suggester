error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6620.java
text:
```scala
C@@ontentResolver.addPeriodicSync(account, GITHUB_PROVIDER_AUTHORITY, new Bundle(), 15L * 60L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6620.java