error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5112.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5112.java
text:
```scala
public static final S@@tring APPLICATION_CLASSIFICATION = "application-classification";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5112.java