error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6402.java
text:
```scala
c@@lient = new TransportClient(ImmutableSettings.settingsBuilder().put("discovery.enabled", true).build());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6402.java