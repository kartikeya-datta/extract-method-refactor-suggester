error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7249.java
text:
```scala
i@@f (!(binding instanceof TypeBinding)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7249.java