error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12913.java
text:
```scala
T@@CHAR buffer = new TCHAR (getCodePage (), parse (text), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12913.java