error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1907.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1907.java
text:
```scala
protected P@@ackageFragmentRoot(IResource resource, JavaProject project, String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1907.java