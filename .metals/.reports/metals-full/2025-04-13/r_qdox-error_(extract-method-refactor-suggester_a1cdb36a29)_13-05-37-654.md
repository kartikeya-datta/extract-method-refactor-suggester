error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2679.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2679.java
text:
```scala
i@@f (!someArgument.isWildcard() || !((WildcardBinding) someArgument).isEquivalentToUnboundWildcard()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2679.java