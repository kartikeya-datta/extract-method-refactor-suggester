error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1582.java
text:
```scala
i@@f (region == null) throw new GdxRuntimeException(String.format("Could not find font region " + name + " in atlas "+ parameter.atlasName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1582.java