error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14033.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14033.java
text:
```scala
private final I@@njectedValue<com.arjuna.ats.jbossatx.jta.TransactionManagerService> injectedArjunaTM = new InjectedValue<com.arjuna.ats.jbossatx.jta.TransactionManagerService>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14033.java