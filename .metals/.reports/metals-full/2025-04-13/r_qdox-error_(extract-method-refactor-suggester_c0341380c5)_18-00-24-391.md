error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16954.java
text:
```scala
w@@indow.becomeKeyWindow();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16954.java