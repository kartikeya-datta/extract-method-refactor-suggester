error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4684.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4684.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4684.java
text:
```scala
final i@@nt bucketDocCount = bucketOrd < 0 ? 0 : bucketDocCount(bucketOrd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4684.java