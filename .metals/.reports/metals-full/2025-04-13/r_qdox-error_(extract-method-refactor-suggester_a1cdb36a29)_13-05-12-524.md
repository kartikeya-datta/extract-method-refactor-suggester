error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1169.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1169.java
text:
```scala
protected static l@@ong getCPtr(SWIGTYPE_p_btAlignedObjectArrayT_btSolverConstraint_t obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1169.java