error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13637.java
text:
```scala
s@@ubsystem.get(ATTRIBUTES).setEmptyObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13637.java