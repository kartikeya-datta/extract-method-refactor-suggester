error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/301.java
text:
```scala
i@@f (currentMethod.declaringClass.isInterface() || inheritedMethod.isStatic()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/301.java