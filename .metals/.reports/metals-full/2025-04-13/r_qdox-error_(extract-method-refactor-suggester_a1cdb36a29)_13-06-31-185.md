error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9029.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9029.java
text:
```scala
n@@ew FolderOptionsDialog((Folder) r[0].getFolder(), true, (AbstractMailFrameController) frameMediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9029.java