error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3219.java
text:
```scala
i@@w.shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3219.java