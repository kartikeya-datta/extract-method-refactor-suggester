error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3467.java
text:
```scala
f@@loat color = Float.intBitsToFloat((intBits & 0xfeffffff));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3467.java