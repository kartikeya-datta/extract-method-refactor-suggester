error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9942.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9942.java
text:
```scala
protected S@@hardFlushRequest newShardRequest(int numShards, ShardRouting shard, FlushRequest request) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9942.java