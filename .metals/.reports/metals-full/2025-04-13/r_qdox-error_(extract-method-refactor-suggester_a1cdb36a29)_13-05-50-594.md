error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/739.java
...
```java
offset: 806
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/739.java
text:
```scala
...
public class LetterBoxTest extends GdxTest {
	...
	public void resize (int width, int height) {
		stage.setViewport(300, 200, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/739.java