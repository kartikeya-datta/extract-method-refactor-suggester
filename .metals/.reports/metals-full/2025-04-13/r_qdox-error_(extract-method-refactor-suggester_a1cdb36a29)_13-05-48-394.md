error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5136.java
text:
```scala
b@@ytes[j] = (byte)(value & 0xff);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5136.java