error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4095.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4095.java
text:
```scala
h@@andle.fullExclusionPatternChars());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4095.java