error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5613.java
text:
```scala
m@@arker.setAttribute(IMarker.SEVERITY, IMarker.SEVERITY_WARNING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5613.java