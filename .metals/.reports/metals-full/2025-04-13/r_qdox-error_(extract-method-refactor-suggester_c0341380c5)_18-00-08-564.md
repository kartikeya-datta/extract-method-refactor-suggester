error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1336.java
text:
```scala
S@@treamInput streamIn = ChannelBufferStreamInputFactory.create(buffer, size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1336.java