error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1469.java
text:
```scala
L@@uceneTestCase.assumeTrue("Nested suite class ignored (started as stand-alone).",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1469.java