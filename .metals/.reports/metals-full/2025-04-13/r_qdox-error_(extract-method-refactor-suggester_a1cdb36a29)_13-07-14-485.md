error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3078.java
text:
```scala
N@@ewRemoteProxyController proxyController = NewRemoteProxyController.create(channels.getExecutorService(), PathAddress.pathAddress(), ProxyOperationAddressTranslator.HOST, channels.getClientChannel());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3078.java