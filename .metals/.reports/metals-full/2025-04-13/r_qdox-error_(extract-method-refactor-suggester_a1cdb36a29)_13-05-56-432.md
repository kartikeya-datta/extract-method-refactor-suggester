error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4980.java
text:
```scala
t@@his(Name.root, payloadSize,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4980.java