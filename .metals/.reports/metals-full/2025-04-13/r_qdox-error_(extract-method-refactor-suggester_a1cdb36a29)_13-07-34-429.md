error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2554.java
text:
```scala
J@@MeterUtils.getResString("url"),  //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2554.java