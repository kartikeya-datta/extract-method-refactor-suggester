error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/479.java
text:
```scala
S@@tring[] resultArray = testList.toArray(new String[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/479.java