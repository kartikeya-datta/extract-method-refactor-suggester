error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6814.java
text:
```scala
t@@p.setTestPlanClasspathArray(browseJar.getFiles());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6814.java