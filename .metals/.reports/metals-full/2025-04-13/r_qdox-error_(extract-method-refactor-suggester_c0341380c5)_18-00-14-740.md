error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3946.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3946.java
text:
```scala
public S@@ignin2Test(final String name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3946.java