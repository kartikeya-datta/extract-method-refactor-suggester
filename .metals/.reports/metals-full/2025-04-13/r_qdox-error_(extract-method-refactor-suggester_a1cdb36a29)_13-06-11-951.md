error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2844.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2844.java
text:
```scala
i@@f (hasZeroValue && Math.abs(zeroValue - value) <= epsilon) return true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2844.java