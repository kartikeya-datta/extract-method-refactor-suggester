error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3387.java
text:
```scala
s@@hardGatewayService.snapshot("api");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3387.java