error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11629.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11629.java
text:
```scala
private static final L@@og logger = LogFactory.getLog(EmbeddedDatabaseFactory.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11629.java