error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17852.java
text:
```scala
p@@arent.sendMouseEvent (SWT.MouseUp, button [0], true, chord, (short)x, (short)y, modifiers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17852.java