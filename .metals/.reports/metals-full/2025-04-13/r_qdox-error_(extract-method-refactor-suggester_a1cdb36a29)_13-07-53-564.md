error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5224.java
text:
```scala
c@@lient1.admin().indices().create(createIndexRequest("test1").setSettings(settingsBuilder().putArray("index.aliases", "test"))).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5224.java