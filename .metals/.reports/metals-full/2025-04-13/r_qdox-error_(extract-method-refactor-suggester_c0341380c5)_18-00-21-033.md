error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4242.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4242.java
text:
```scala
i@@nt /*long*/ nsColumnIndex = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4242.java