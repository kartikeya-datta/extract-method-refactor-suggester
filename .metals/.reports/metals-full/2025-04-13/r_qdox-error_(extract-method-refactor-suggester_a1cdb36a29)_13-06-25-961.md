error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1638.java
text:
```scala
s@@etShellSize(instance, shell);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1638.java