error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9372.java
text:
```scala
S@@tring pluginName = themeConfig.getAttribute("name", "Plastic");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9372.java