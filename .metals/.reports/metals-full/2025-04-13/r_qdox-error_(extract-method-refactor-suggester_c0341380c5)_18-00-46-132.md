error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/961.java
text:
```scala
M@@yTree tree = new MyTree(this,"tree", treeModel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/961.java