error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13407.java
text:
```scala
t@@hrow new NoSuchElementException("Exhausted all iterators");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13407.java