error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/786.java
text:
```scala
I@@nstalledDriver driverMetadata = new InstalledDriver(driverName, driverClass.getName(), null, null, majorVersion,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/786.java