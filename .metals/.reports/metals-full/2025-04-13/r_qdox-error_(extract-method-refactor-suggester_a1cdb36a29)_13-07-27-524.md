error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1972.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1972.java
text:
```scala
public abstract v@@oid processDelta(IJavaElementDelta delta, int eventType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1972.java