error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1565.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1565.java
text:
```scala
p@@roblemReporter().illegalModifierForAnnotationMember((AbstractMethodDeclaration) referenceContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1565.java