error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9813.java
text:
```scala
i@@f (!copy.isPrimary()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9813.java