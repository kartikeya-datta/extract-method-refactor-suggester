error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14510.java
text:
```scala
i@@f (!(o instanceof Pair<?, ?>))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14510.java