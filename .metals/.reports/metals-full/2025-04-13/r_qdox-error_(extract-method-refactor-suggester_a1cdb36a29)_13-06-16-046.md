error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7283.java
text:
```scala
r@@eturn OS.SendMessage (hwndText, OS.EM_GETLIMITTEXT, 0, 0) & 0x7FFFFFFF;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7283.java