error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3043.java
text:
```scala
l@@ong keepAlive = keepAliveSpec == null ? Long.MAX_VALUE : keepAliveSpec.getUnit().toMillis(keepAliveSpec.getDuration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3043.java