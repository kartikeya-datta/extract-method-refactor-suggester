error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9653.java
text:
```scala
i@@f (JvmAttributes.PERMGEN_SIZE.isMarshallable(jvmElement) || JvmAttributes.MAX_PERMGEN_SIZE.isMarshallable(jvmElement)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9653.java