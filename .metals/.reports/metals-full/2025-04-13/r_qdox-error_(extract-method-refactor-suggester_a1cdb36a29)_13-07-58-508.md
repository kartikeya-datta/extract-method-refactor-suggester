error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10907.java
text:
```scala
d@@ouble stdDev = Math.sqrt((accum - (Math.pow(accum2, 2) / length)) /
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10907.java