error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18130.java
text:
```scala
r@@eturn getContext().registerService(clazzes, service, props);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18130.java