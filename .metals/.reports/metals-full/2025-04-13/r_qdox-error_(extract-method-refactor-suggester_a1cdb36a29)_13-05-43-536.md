error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/75.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/75.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/75.java
text:
```scala
s@@uper(path, metadata.dataLength, metadata.compressedFileLength);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/75.java