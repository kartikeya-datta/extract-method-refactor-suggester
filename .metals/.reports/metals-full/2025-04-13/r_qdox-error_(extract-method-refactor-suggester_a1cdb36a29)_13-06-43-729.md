error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8359.java
text:
```scala
i@@f (this.type != null) type.traverse(visitor, scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8359.java