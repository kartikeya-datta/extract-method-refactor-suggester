error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6709.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6709.java
text:
```scala
public static final N@@ame HMAC		= Name.fromConstantString
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6709.java