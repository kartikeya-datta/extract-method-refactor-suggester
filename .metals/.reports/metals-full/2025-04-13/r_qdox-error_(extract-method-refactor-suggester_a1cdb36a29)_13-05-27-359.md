error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17086.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17086.java
text:
```scala
final L@@ist componentResolvers = this.getApplication().getRequestCycleSettings().getComponentResolvers();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17086.java