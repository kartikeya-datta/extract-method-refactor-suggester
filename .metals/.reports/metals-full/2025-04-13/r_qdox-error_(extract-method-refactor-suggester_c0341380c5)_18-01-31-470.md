error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5539.java
text:
```scala
v@@iewer = new DetailedProgressViewer(parent, SWT.MULTI | SWT.H_SCROLL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5539.java