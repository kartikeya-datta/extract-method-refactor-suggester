error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14125.java
text:
```scala
T@@hreadContext.setSession(session);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14125.java