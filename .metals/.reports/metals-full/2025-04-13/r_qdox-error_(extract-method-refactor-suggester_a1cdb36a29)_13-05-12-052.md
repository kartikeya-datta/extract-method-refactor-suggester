error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10384.java
...
```java
offset: 901
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10384.java
text:
```scala
...
p@@ackage org.elasticsearch.action.admin.cluster.node.hotthreads;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10384.java