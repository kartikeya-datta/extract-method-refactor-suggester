error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14035.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14035.java
text:
```scala
"yahoo/yahoo.js")@@);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14035.java