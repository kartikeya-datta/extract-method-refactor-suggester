error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2387.java
text:
```scala
F@@ileStatus streamStatus = FileStatus.serializer().deserialize(new DataInputStream(bufIn));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2387.java