error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13773.java
text:
```scala
S@@WT.error(SWT.ERROR_NO_HANDLES, null, " [MOZILLA_FIVE_HOME may not point at an embeddable GRE] [NS_InitEmbedding " + mozillaPath + " error " + rc + "]"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13773.java