error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2870.java
text:
```scala
r@@eturn !isParameterizedMethod() && !isGenericMethod();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2870.java