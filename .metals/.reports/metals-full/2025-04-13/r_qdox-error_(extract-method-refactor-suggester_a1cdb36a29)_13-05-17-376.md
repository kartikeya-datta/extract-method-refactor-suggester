error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15814.java
text:
```scala
r@@eturn new Date(parse(getDateFormat(locale), value, locale).getTime());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15814.java