error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2325.java
text:
```scala
T@@argetAttribute targetAttribute = new TargetAttribute("test", null, new ModelNode(), targetResource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2325.java