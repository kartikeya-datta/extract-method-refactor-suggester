error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8236.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8236.java
text:
```scala
public M@@anagementPermission createScopedPermission(Constraint constraint, int constraintIndex) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8236.java