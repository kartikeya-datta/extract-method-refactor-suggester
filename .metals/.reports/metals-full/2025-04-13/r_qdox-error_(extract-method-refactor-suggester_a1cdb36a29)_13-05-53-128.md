error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13736.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13736.java
text:
```scala
protected R@@esult checkUsability(final Component component, boolean throwException)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13736.java