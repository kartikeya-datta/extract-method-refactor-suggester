error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12644.java
text:
```scala
S@@tring.valueOf(table.getColumns().size()))));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12644.java