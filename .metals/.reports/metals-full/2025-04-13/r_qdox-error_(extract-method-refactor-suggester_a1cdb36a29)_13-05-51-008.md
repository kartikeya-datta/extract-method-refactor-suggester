error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1602.java
text:
```scala
r@@eturn new LRUMemoryMapState(_maxSize, _id + partitionIndex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1602.java