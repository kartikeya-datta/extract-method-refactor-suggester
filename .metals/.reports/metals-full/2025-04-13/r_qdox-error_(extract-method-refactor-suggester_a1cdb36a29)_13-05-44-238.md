error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6605.java
text:
```scala
i@@nt largestLocalUid =  localUids.size() > 0 ? ((Integer)localUids.get(localUids.size()-1)).intValue() : -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6605.java