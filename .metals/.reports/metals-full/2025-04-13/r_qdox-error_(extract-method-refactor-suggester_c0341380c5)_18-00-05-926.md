error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2578.java
text:
```scala
C@@ollisionJNI.btCollisionDispatcher_defaultNearCallback(btBroadphasePair.getCPtr(collisionPair), collisionPair, btCollisionDispatcher.getCPtr(dispatcher), dispatcher, btDispatcherInfo.getCPtr(dispatchInfo), dispatchInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2578.java