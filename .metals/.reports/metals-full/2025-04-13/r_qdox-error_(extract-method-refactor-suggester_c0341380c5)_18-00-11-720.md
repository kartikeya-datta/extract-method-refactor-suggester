error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8113.java
text:
```scala
s@@uggest = Suggest.readSuggest(Suggest.Fields.SUGGEST, in);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8113.java