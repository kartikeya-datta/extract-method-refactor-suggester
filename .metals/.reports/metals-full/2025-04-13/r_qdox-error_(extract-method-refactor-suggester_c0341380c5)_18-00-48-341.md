error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2408.java
text:
```scala
a@@pplication.setHomePage(SimpleTablePage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2408.java