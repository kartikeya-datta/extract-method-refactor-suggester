error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13414.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13414.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13414.java
text:
```scala
public v@@oid testInitializeRuntimeEx() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13414.java