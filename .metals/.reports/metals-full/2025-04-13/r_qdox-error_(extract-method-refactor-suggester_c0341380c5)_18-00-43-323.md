error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3216.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3216.java
text:
```scala
public final v@@oid dirty()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3216.java