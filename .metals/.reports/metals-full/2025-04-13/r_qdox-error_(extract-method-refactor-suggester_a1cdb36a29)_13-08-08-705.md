error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6579.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6579.java
text:
```scala
s@@etText(WorkbenchMessages.PartPane_close);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6579.java