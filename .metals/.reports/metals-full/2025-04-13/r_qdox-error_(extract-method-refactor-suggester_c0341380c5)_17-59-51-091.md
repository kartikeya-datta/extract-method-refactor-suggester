error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9812.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9812.java
text:
```scala
public C@@hromosome mutate(final Chromosome original) throws MathIllegalArgumentException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9812.java