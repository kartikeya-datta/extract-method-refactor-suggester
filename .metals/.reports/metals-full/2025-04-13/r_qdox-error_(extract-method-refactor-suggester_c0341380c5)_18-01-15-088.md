error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3304.java
text:
```scala
r@@eturn Long.MIN_VALUE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3304.java