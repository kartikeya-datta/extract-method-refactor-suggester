error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16043.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16043.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16043.java
text:
```scala
i@@f ((state & ACC.STATE_DISABLED) == 0) ATK.atk_state_set_add_state (set, ATK.ATK_STATE_ENABLED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16043.java