error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1827.java
text:
```scala
A@@nnotationAwareOrderComparator.sort(conditions);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1827.java