error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2486.java
text:
```scala
i@@nstance.associate(primaryKey);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2486.java