error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9850.java
text:
```scala
t@@hrow st.exception("Invalid type " + t.value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9850.java