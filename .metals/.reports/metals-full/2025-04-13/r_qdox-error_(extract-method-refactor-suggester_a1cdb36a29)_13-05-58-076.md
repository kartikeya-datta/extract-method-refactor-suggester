error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/756.java
text:
```scala
A@@ppender so = new ConsoleAppender(layout, "System.out");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/756.java