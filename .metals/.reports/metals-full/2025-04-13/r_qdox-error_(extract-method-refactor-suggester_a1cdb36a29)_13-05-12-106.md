error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5198.java
text:
```scala
r@@eturn nodeService.stats(request.isIndices(), request.isOs(), request.isProcess(), request.isJvm(), request.isThreadPool(), request.isNetwork(), request.isFs(), request.isTransport(), request.isHttp());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5198.java