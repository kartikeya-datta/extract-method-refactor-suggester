error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5381.java
text:
```scala
i@@f (CharOperation.prefixEquals(prefix, possibleTags[k][i], false)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5381.java