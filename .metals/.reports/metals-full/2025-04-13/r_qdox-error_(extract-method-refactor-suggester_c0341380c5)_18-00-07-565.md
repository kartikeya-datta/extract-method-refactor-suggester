error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1831.java
text:
```scala
v@@alue.getBytes(), System.currentTimeMillis(), 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1831.java