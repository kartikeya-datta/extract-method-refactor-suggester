error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5953.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5953.java
text:
```scala
private static final S@@tring XMPP_ROOM_PROTOCOL = "xmpp.muc";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5953.java