error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1459.java
text:
```scala
O@@MIT_TF('F', "Omit Term Frequencies & Positions"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1459.java