error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6464.java
text:
```scala
s@@uper ("Property", "{builtin}Property");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6464.java