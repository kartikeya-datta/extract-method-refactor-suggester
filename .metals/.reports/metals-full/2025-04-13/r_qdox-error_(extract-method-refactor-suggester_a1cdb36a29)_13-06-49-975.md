error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7699.java
text:
```scala
f@@rustum.update(invProjectionView);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7699.java