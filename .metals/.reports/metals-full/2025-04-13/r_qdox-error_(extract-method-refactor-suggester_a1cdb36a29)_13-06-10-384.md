error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10424.java
text:
```scala
r@@eturn smartMapper.fieldMappers().mapper().names().indexName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10424.java