error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10087.java
text:
```scala
l@@og.error("Received unknown command: " + b.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10087.java