error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10040.java
text:
```scala
S@@tring[] args = { jEdit.getVersion(), System.getProperty("java.version") };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10040.java