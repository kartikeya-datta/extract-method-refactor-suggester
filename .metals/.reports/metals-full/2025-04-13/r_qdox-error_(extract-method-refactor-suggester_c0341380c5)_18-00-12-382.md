error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/971.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/971.java
text:
```scala
static A@@ttributeDefinition[] ATTRIBUTES = { CommonAttributes.FACTORY_CLASS, SOCKET_BINDING };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/971.java