error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7779.java
text:
```scala
s@@lidingPlaneNormal.set( newPosition ).sub( packet.getIntersectionPoint() ).nor();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7779.java