error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4575.java
text:
```scala
b@@uilder.addPlaceHolderValue("sys.login.ajax", "/foo");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4575.java