error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7228.java
text:
```scala
P@@ackageResource res = (PackageResource) tester.getApplication().getSharedResources().get("wicket.markup.parser.filter.sub.HeaderSectionBorder/cborder.css");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7228.java