error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6490.java
text:
```scala
s@@uper(MessageDrivenComponentInstance.this.getComponent(), MessageDrivenComponentInstance.this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6490.java