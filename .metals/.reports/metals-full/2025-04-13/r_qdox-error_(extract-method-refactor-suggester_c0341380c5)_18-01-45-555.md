error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4022.java
text:
```scala
i@@f (useTCP || out.length > udpLength)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4022.java