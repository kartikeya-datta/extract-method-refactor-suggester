error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13524.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13524.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13524.java
text:
```scala
r@@eturn MessagingDescriptions.getAddJndiOperation(locale, "jms-topic");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13524.java