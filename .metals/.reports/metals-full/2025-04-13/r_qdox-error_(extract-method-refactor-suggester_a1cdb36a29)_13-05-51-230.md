error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3192.java
text:
```scala
M@@enuItem item = new MenuItem(menu, SWT.NONE, index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3192.java