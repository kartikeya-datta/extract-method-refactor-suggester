error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/340.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/340.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/340.java
text:
```scala
public static final S@@tring DEFAULT_WICKET_NAMESPACE = MarkupParser.WICKET;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/340.java