error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8934.java
text:
```scala
O@@bject[] args)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8934.java