error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4054.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4054.java
text:
```scala
public static final i@@nt PARSE_LIFECYCLE_ANNOTATION                  = 0x3200;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4054.java