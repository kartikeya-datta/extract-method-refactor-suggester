error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2840.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2840.java
text:
```scala
public final l@@ong	modifiedRowCount() { return rowCount + RowUtil.getRowCountBase(); }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2840.java