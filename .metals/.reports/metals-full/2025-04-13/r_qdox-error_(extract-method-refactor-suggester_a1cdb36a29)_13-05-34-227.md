error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10847.java
text:
```scala
e@@.printStackTrace();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10847.java