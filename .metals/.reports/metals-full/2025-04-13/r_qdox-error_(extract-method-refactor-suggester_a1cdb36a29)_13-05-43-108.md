error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3888.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3888.java
text:
```scala
c@@lient(), new String[] {INDEX_NAME}, internalCluster().size(), null)).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3888.java