error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9946.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9946.java
text:
```scala
public static final l@@ong PRIORITY = DeploymentPhases.PARSE_DESCRIPTORS.plus(320L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9946.java