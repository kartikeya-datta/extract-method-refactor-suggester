error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5498.java
text:
```scala
t@@ext.bold(segments[segments.length - 1]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5498.java