error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11250.java
text:
```scala
p@@ublic abstract class ExamplePage extends WicketExamplePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11250.java