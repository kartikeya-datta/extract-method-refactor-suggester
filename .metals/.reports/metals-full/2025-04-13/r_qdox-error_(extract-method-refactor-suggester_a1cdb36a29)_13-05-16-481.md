error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10533.java
...
```java
offset: 668
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10533.java
text:
```scala
 ...
 */
p@@ackage org.apache.xerces.impl.dv.xs;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10533.java