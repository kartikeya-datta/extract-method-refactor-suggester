error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10223.java
text:
```scala
d@@oReadElement(reader, builder, factory.getOriginalIdentity());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10223.java