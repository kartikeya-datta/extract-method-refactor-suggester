error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3221.java
text:
```scala
s@@uper(type, "something");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3221.java