error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12014.java
text:
```scala
t@@hrow new IllegalArgumentException("Argument 'component' cannot be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12014.java