error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12390.java
text:
```scala
h@@bConfig.set(key, String.valueOf(map.get(key)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12390.java