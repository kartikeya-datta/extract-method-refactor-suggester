error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7254.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7254.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7254.java
text:
```scala
public v@@oid applyUpdateBootAction(final UpdateContext updateContext) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7254.java