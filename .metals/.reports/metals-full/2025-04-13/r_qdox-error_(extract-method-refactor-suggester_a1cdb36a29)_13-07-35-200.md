error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5435.java
text:
```scala
i@@f (breakLabel.forwardReferenceCount > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5435.java