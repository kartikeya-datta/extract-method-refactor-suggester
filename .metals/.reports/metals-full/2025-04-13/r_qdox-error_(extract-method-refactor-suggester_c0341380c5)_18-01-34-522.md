error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3752.java
text:
```scala
g@@c.drawImage (image, 0, 0, bounds.width, bounds.height, rect.left - inset + 1, y, size.x, size.y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3752.java