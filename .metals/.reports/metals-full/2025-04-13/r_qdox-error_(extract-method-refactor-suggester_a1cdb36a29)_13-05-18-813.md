error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17787.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[50,80]

error in qdox parser
file content:
```java
offset: 1433
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17787.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17787.java