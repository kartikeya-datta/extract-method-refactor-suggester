error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3997.java
text:
```scala
i@@f (!erasure.isInterface()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3997.java