error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1851.java
text:
```scala
s@@etPreferenceStore(workbench.getPreferenceStore());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1851.java