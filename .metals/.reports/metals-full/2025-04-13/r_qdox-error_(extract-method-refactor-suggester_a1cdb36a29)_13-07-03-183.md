error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7325.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7325.java
text:
```scala
private S@@et<CustomConcurrentMergeScheduler> schedulers = new CopyOnWriteArraySet<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7325.java