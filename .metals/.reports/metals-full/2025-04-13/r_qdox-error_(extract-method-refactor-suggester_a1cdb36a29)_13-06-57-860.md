error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5957.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5957.java
text:
```scala
public H@@ashBagTest(final String testName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5957.java