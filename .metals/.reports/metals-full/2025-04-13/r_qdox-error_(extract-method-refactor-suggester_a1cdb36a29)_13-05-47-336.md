error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6701.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6701.java
text:
```scala
private final A@@rrayList m_conditions = new ArrayList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6701.java