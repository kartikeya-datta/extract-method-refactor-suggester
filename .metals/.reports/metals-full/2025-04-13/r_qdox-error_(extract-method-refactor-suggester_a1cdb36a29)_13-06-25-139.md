error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3085.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3085.java
text:
```scala
public static final P@@athElement MIXED_KEYED_JDBC_STORE_PATH = PathElement.pathElement(ModelKeys.MIXED_KEYED_JDBC_STORE, ModelKeys.MIXED_KEYED_JDBC_STORE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3085.java