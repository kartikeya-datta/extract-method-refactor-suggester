error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12292.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12292.java
text:
```scala
public final C@@omponent reAttach()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12292.java