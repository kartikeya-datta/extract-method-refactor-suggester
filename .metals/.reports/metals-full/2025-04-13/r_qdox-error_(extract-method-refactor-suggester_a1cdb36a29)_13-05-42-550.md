error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/90.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/90.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/90.java
text:
```scala
A@@ctionListener, TreeSelectionListener, ISelectFolderDialog {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/90.java