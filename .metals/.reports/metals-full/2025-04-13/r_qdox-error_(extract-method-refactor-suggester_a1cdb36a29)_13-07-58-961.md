error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8768.java
text:
```scala
F@@ileItem item = (FileItem)fileModel.getObject(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8768.java