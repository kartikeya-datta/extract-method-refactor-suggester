error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18142.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,254]

error in qdox parser
file content:
```java
offset: 254
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18142.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18142.java