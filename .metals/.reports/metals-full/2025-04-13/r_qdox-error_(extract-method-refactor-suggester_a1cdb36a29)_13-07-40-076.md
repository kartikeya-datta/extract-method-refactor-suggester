error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1998.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1998.java
text:
```scala
private static final i@@nt xborder = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1998.java