error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/300.java
text:
```scala
r@@eturn getXmlData().length();// so we don't generate chunked encoding
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/300.java