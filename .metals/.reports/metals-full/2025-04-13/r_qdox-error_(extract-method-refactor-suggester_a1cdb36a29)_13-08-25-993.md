error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4022.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4022.java
text:
```scala
final I@@nterceptorFactory tcclInterceptorFactory = new ImmediateInterceptorFactory(new TCCLInterceptor(componentConfiguration.getModuleClassLoader()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4022.java