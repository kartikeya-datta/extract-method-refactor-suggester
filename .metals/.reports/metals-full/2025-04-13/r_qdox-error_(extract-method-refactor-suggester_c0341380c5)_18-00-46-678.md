error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/552.java
text:
```scala
M@@anagementRemotingServices.installRemotingManagementEndpoint(serviceTarget, ManagementRemotingServices.MANAGEMENT_ENDPOINT, hostName, EndpointService.EndpointType.MANAGEMENT, OPTIONS, verificationHandler, newControllers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/552.java