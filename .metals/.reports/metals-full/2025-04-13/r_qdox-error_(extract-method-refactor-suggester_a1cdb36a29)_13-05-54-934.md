error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1169.java
text:
```scala
c@@olumnIndex = i;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1169.java