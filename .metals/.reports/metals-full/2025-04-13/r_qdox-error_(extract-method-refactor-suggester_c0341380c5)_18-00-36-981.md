error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9862.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9862.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9862.java
text:
```scala
C@@omponent component = Border.this.get(id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9862.java