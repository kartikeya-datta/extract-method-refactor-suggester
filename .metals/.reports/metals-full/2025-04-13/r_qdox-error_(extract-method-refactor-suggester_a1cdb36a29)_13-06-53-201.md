error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9967.java
text:
```scala
r@@eturn "batch-" + threadPoolName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9967.java