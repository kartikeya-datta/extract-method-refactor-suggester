error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5426.java
text:
```scala
r@@eturn isDisposed () || (runMessages && runAsyncMessages (false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5426.java