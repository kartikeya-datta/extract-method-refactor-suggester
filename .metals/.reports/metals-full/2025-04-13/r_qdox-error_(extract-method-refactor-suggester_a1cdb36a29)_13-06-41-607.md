error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1760.java
text:
```scala
p@@rivate static class MarkupCachingAssumingComponent extends Panel
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1760.java