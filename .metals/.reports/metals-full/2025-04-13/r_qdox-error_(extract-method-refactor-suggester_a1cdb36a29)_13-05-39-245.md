error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3357.java
text:
```scala
i@@nt boundExceptionLength = (md.binding == null) ? 0 : md.binding.thrownExceptions.length;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3357.java