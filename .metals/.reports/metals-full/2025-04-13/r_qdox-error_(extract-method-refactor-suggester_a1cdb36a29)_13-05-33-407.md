error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4741.java
text:
```scala
r@@eturn ESLoggerFactory.getLogger(parentLogger.getPrefix(), getLoggerName(parentLogger.getName() + s));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4741.java