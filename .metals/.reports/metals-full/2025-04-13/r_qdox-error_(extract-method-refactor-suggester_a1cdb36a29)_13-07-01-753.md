error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6430.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6430.java
text:
```scala
t@@hrow new OperationFailedException(ConnectorLogger.ROOT_LOGGER.failedToSetAttribute(e.getLocalizedMessage()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6430.java