error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9920.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9920.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9920.java
text:
```scala
g@@etCallbackUrl()).append(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9920.java