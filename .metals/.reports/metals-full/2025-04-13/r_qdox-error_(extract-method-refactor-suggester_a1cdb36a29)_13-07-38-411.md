error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3002.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3002.java
text:
```scala
private final C@@onvergenceChecker<PAIR> checker;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3002.java