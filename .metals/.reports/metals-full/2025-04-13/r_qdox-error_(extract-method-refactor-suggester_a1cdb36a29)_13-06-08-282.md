error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/859.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/859.java
text:
```scala
public static volatile A@@ttribute<Account,Person> owner;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/859.java