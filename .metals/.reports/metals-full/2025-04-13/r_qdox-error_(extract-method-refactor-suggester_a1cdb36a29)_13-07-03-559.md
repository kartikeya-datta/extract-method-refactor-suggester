error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3971.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3971.java
text:
```scala
protected v@@oid updateModel()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3971.java