error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9356.java
text:
```scala
i@@f (isRunning()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9356.java