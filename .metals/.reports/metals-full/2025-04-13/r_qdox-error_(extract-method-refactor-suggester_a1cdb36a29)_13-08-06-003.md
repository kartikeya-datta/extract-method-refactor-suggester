error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/601.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/601.java
text:
```scala
@Override protected D@@eleteResponse shardOperationOnPrimary(ClusterState clusterState, ShardOperationRequest shardRequest) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/601.java