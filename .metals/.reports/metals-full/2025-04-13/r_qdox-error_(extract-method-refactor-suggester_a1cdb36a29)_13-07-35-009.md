error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7295.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7295.java
text:
```scala
t@@hrow new RuntimeException("Error getting reflective information for " + clazz + " with ClassLoader " + clazz.getClassLoader(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7295.java