error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3113.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3113.java
text:
```scala
t@@arget.addService(factoryName, new ValueService<>(new ImmediateValue<>(factory)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3113.java