error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12269.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12269.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12269.java
text:
```scala
I@@terator<?> iter = guiPackage.getTreeModel().getNodesOfType(Clearable.class).iterator();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12269.java