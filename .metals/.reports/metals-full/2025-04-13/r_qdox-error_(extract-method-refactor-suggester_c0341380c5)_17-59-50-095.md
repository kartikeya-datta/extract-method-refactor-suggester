error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5065.java
text:
```scala
r@@eturn clusterService.operationRouting().deleteByQueryShards(clusterService.state(), request.index());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5065.java