error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2098.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2098.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2098.java
text:
```scala
C@@ompactionManager.instance().submitMajor(cfStore, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2098.java