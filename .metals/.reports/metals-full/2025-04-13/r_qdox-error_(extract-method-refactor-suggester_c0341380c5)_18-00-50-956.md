error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1333.java
text:
```scala
r@@eturn new ResourceCompilationUnit(file, file.getLocationURI()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1333.java