error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8224.java
text:
```scala
r@@eturn this.resolvedType = currentCompatibleType.superclass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8224.java