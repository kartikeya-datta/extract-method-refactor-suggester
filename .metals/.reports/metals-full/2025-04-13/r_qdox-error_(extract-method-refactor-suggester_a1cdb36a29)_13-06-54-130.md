error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15750.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15750.java
text:
```scala
public v@@oid testJUnit() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15750.java