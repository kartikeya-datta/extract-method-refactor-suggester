error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8576.java
text:
```scala
i@@nt /*long*/ code = callWindowProc (handle, OS.WM_WINDOWPOSCHANGED, wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8576.java