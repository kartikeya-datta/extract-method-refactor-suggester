error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7014.java
text:
```scala
c@@onstant = FieldReference.getConstantFor(binding, this, receiver.isImplicitThis(), scope);
...
public TypeBinding resolveType(BlockScope scope) {
	...
	constant = FieldReference.getConstantFor(binding, receiver.isImplicitThis(), this, scope, 0);
	if (!receiver.isThis())
		constant = NotAConstant;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7014.java