error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9838.java
text:
```scala
f@@orceReload();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9838.java