error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6928.java
text:
```scala
R@@ELATIVE_TO(PathDefinition.RELATIVE_TO),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6928.java