error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3520.java
text:
```scala
M@@odelAndView mav = exceptionResolver.resolveException(request, response, null, ex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3520.java