error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6184.java
text:
```scala
m@@yLock.release(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6184.java