error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/87.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/87.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/87.java
text:
```scala
l@@inkPage.setDescription(ResourceMessages.getString("NewLink.folderDescription")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/87.java