error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/527.java
text:
```scala
M@@etaData.Builder metaData = MetaData.builder(currentState.metaData())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/527.java