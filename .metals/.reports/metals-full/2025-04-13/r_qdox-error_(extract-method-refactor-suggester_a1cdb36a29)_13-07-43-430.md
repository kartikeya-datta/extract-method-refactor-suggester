error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2890.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2890.java
text:
```scala
protected I@@nputListener ignoreTouchDown = new InputListener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2890.java