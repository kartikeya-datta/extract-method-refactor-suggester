error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4469.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4469.java
text:
```scala
private R@@eferenceBinding enclosingType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4469.java