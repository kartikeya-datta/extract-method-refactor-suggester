error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6616.java
text:
```scala
J@@avaModelManager.getIndexManager().reset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6616.java