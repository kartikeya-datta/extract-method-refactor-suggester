error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2403.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2403.java
text:
```scala
public v@@oid files(Directory dir, SegmentInfo info, Set<String> files) throws IOException {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2403.java