error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9506.java
text:
```scala
t@@his.leafComponentType = env.convertToRawType(resolvedType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9506.java