error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3334.java
text:
```scala
l@@og.error( "Could not start Solr. Check solr/home property and the logs", t);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3334.java