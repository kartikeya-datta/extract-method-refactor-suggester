error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1894.java
text:
```scala
n@@ewState.tagAsStructurallyChanged();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1894.java