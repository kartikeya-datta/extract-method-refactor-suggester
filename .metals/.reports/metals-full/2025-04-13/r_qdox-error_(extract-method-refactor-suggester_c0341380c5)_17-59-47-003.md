error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9184.java
text:
```scala
C@@omponent buttonBar = getForm().get(BUTTONS_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9184.java