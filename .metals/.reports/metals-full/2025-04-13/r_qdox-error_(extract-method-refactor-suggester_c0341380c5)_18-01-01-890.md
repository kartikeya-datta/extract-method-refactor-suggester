error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15799.java
text:
```scala
s@@erialMode = false;//serial;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15799.java