error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/570.java
text:
```scala
o@@riginalField.isStatic() ? originalField.type : parameterizedDeclaringClass.substitute(originalField.type),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/570.java