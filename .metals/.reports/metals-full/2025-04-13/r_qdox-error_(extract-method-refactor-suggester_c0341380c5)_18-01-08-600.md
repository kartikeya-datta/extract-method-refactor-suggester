error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12917.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12917.java
text:
```scala
final A@@ction shareSomethingAction = new Action("Share something") {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12917.java