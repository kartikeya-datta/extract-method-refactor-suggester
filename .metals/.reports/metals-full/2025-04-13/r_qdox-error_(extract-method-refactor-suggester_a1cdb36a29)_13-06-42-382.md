error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12737.java
text:
```scala
a@@ddress.add(HOST, "master");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12737.java