error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12969.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12969.java
text:
```scala
P@@oint closeSize = renderer.computeSize(CTabFolderRenderer.PART_CLOSE_BUTTON, SWT.SELECTED, gc, SWT.DEFAULT, SWT.DEFAULT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12969.java