error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6837.java
text:
```scala
C@@SVLexer(final CSVFormat format, final ExtendedBufferedReader in) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6837.java