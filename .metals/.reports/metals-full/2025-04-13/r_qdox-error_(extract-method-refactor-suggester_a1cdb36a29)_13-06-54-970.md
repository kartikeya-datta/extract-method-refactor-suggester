error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3132.java
text:
```scala
t@@his.bound = env.convertToRawType(resolvedType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3132.java