error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14987.java
...
```java
offset: 854
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14987.java
text:
```scala
...
p@@ackage org.apache.xerces.impl.io;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14987.java