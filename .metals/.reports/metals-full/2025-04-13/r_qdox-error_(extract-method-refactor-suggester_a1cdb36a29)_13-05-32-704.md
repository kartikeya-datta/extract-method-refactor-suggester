error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14338.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14338.java
text:
```scala
public S@@hadowMunger parameterizeWith(ResolvedType declaringType,Map typeVariableMap) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14338.java