error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8474.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8474.java
text:
```scala
public static final S@@tring RESOURCE_NAME = ControllerResolver.class.getPackage().getName() + ".LocalDescriptions";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8474.java