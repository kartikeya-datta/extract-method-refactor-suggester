error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2610.java
text:
```scala
D@@isplay.update(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2610.java