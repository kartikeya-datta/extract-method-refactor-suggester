error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6266.java
text:
```scala
g@@etStyle(), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6266.java