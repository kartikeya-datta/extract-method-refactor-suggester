error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3006.java
text:
```scala
n@@ull, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3006.java