error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16621.java
text:
```scala
S@@tring getCacheKey(final MarkupContainer container, Class containerClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16621.java