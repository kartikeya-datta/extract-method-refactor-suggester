error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11642.java
text:
```scala
p@@ublic class ModalContent1Page extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11642.java