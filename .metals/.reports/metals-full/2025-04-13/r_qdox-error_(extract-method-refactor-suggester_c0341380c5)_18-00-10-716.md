error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4589.java
text:
```scala
d@@ist = new EmpiricalDistributionImpl(5, (RandomGenerator) null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4589.java