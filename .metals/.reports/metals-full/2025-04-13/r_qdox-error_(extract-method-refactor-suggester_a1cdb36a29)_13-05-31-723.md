error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/621.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/621.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/621.java
text:
```scala
c@@hanged((ChangeEvent)event, event.getTarget());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/621.java