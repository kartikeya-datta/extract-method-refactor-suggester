error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9163.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9163.java
text:
```scala
i@@ = -1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9163.java