error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10042.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10042.java
text:
```scala
public static final S@@tring SIGNATURE= "INDEX VERSION 1.124"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10042.java