error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1642.java
text:
```scala
e@@ncoding = new String(contents, start, index2 - start, org.eclipse.jdt.internal.compiler.util.Util.UTF_8);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1642.java