error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3456.java
text:
```scala
o@@rg.columba.addressbook.facade.IModelFacade.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3456.java