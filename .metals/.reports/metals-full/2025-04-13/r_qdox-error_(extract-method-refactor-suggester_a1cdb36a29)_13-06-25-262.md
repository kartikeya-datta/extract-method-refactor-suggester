error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10789.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10789.java
text:
```scala
c@@omparator = (AbstractFileComparator) PathFileComparator.PATH_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10789.java