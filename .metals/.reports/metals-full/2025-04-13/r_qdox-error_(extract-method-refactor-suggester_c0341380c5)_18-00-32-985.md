error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18247.java
text:
```scala
m@@_aspectHandler = (AspectHandler)newInstance( AspectHandler.ROLE, typeName );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18247.java