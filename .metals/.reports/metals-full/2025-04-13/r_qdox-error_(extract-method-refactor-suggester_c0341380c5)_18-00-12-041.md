error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3594.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3594.java
text:
```scala
f@@or (int i = 0; i < 1; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3594.java