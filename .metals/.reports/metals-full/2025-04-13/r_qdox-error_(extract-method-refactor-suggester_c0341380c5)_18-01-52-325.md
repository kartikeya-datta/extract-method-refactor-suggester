error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3100.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3100.java
text:
```scala
private static final T@@ransformer<Object, String> INSTANCE = new StringValueTransformer<Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3100.java