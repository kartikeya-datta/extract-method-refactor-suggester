error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8596.java
text:
```scala
s@@crollId = TransportSearchHelper.buildScrollId(request.searchType(), queryResults.values(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8596.java