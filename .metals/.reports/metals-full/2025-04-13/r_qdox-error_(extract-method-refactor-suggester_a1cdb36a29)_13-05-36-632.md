error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7839.java
text:
```scala
i@@ndexRandom("test", true, builders);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7839.java