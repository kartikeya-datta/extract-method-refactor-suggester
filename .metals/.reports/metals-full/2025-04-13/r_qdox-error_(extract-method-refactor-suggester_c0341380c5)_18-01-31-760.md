error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7536.java
text:
```scala
c@@har[] suffix =  CharOperation.concat(new char[]{'}'}, source.substring(insertion).toCharArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7536.java