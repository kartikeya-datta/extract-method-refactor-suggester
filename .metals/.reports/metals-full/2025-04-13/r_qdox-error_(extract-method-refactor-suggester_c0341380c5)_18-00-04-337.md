error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12435.java
text:
```scala
b@@uffer.append(" " + next + "=\"" +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12435.java