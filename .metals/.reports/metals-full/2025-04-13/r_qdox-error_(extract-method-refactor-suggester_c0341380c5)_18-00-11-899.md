error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12453.java
text:
```scala
p@@ublic class SunOneManagedRuntime extends AbstractManagedRuntime
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12453.java