error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6744.java
text:
```scala
r@@eturn ProgressMessages.PendingUpdateAdapter_PendingLabel;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6744.java