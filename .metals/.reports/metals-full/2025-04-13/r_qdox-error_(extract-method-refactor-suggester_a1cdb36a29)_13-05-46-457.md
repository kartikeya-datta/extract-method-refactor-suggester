error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8184.java
text:
```scala
A@@ssert.assertTrue(failureDescription.startsWith("WFLYCTL0212: Duplicate resource"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8184.java