error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10642.java
text:
```scala
p@@haseContext.getDeploymentUnit().putAttachment(JBossServiceXmlDescriptor.ATTACHMENT_KEY, xmlDescriptor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10642.java