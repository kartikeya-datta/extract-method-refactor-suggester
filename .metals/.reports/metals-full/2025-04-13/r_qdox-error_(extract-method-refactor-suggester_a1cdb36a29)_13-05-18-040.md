error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8979.java
text:
```scala
O@@S.gtk_tree_store_set (parent.modelHandle, handle, Tree.ID_COLUMN, -1, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8979.java