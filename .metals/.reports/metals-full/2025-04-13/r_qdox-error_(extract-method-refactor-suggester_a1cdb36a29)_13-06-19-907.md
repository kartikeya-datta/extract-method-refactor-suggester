error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4105.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4105.java
text:
```scala
r@@eturn nodePrefix.matcher(t.getName()).find();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4105.java