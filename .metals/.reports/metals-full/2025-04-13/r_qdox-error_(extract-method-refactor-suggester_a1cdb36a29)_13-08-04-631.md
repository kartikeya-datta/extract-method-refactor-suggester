error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15358.java
text:
```scala
S@@tringBuffer sb = new StringBuffer("LongID["); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15358.java