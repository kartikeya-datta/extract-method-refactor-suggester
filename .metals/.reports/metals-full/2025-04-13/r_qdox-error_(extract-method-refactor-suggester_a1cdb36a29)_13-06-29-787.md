error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1885.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1885.java
text:
```scala
private static final S@@tring ACTION_NAME = MultiTermVectorsAction.NAME + "[shard]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1885.java