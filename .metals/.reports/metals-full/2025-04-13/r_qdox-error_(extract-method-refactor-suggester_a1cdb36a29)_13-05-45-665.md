error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12637.java
text:
```scala
S@@TANDALONE,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12637.java