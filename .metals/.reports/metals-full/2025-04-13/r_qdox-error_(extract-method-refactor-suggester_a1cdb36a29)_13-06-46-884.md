error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2930.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2930.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2930.java
text:
```scala
final R@@esource resource = context.readResource(PathAddress.EMPTY_ADDRESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2930.java