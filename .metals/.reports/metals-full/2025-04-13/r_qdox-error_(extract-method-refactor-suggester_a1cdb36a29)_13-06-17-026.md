error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4630.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4630.java
text:
```scala
public P@@anelCachingTab(final ITab delegate)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4630.java