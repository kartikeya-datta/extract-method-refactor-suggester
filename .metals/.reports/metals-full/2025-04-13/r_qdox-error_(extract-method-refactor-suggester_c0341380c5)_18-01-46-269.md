error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4956.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4956.java
text:
```scala
i@@f (explicitConstructorCall != null && explicitConstructorCall.accessMode != ExplicitConstructorCall.ImplicitSuper) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4956.java