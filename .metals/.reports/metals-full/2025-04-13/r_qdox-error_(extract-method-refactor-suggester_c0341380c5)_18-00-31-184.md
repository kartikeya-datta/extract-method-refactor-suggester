error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9382.java
text:
```scala
S@@tring.valueOf(((int)(lineCount * 10000.0 / time)) / 10.0)}));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9382.java