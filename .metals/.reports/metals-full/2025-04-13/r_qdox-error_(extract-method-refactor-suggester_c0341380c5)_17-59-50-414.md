error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2245.java
text:
```scala
w@@riter = new OSGiFriendlyClassWriter(ClassWriter.COMPUTE_FRAMES, loader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2245.java