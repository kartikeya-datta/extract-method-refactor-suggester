error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5649.java
text:
```scala
r@@eturn isStarting && isRunning();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5649.java