error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8907.java
text:
```scala
s@@uper("threadedview", "ThreadedViewOptions", mediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8907.java