error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14726.java
text:
```scala
r@@esult[i] = a[i].getCanonicalName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14726.java