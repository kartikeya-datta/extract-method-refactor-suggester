error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5782.java
text:
```scala
r@@eturn contentBuilder(XContentType.YAML);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5782.java