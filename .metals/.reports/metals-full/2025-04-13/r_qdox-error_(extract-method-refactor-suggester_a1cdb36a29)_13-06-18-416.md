error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8148.java
text:
```scala
i@@f (selection instanceof IStructuredSelection && !selection.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8148.java