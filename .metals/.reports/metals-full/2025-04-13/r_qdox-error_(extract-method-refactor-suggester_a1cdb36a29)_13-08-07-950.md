error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6383.java
text:
```scala
T@@hread.sleep(5000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6383.java