error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11634.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11634.java
text:
```scala
e@@valuateAndCheckError("'abc'+true",SpelMessage.OPERATOR_NOT_SUPPORTED_BETWEEN_TYPES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11634.java