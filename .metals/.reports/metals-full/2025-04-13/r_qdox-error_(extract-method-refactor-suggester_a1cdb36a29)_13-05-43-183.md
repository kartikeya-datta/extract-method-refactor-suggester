error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3614.java
text:
```scala
r@@eturn this.refresh();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3614.java