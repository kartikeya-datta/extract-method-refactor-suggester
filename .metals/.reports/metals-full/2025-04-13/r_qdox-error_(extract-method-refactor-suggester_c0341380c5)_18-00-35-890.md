error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5235.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5235.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5235.java
text:
```scala
i@@f (cancelTouchFocus && payload != null) source.getActor().getStage().cancelTouchFocus(this, source.getActor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5235.java