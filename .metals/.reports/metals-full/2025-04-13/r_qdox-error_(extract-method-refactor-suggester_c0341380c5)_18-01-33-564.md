error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7786.java
text:
```scala
s@@hardTarget, indexShard.acquireSearcher(), indexService, indexShard,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7786.java