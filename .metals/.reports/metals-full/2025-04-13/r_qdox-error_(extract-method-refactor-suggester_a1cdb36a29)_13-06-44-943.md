error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7488.java
text:
```scala
p@@arent.setItemCount (this, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7488.java