error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5567.java
text:
```scala
w@@idget.setTitle(NSString.string());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5567.java