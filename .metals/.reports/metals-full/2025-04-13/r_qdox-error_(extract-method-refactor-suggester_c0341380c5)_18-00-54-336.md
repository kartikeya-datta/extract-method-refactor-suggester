error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12970.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12970.java
text:
```scala
final S@@tring m = "" + (pEntry.getLastModified());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12970.java