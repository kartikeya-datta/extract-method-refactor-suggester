error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3266.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3266.java
text:
```scala
public C@@reateIndexRequestBuilder addMapping(String type, Map<String, Object> source) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3266.java