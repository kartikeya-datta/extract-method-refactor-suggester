error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6010.java
text:
```scala
i@@f (isPrimary || (root.isOnClasspath() && resource.isAccessible())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6010.java