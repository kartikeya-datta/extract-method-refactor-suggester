error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/803.java
text:
```scala
f@@ilter.add(new PrefixFilter(new Term(UidFieldMapper.NAME, Uid.createUid(queryType, value))), BooleanClause.Occur.SHOULD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/803.java