error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8724.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8724.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8724.java
text:
```scala
s@@igner.toWireCanonical(out);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8724.java