error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1534.java
text:
```scala
a@@dd(new Link<Void>("displayPageViewLink")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1534.java