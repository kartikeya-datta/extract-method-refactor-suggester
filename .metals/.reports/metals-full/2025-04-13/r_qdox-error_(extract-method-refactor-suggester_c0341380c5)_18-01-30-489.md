error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2904.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2904.java
text:
```scala
private static final V@@ersion LUCENE_VERSION = Version.LUCENE_42;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2904.java