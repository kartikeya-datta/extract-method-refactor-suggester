error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6297.java
text:
```scala
S@@ystem.err.println(getStracktraceAsString(new Exception()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6297.java