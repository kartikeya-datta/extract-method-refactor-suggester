error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5370.java
text:
```scala
i@@f (actualValueClassName.startsWith("org.elasticsearch") || actualValueClassName.startsWith("org.apache.lucene")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5370.java