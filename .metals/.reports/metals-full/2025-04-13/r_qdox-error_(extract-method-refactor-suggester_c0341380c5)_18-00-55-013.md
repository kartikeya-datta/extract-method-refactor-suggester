error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7578.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7578.java
text:
```scala
st@@atic {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7578.java