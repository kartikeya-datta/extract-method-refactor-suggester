error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7382.java
text:
```scala
L@@ist<ContextDocIdSet> filteredEntries = new ArrayList<>(docSets.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7382.java