error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3697.java
text:
```scala
s@@uper(agentContext, "org.osgi.service.useradmin.UserAdmin");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3697.java