error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17975.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[55,2]

error in qdox parser
file content:
```java
offset: 1724
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17975.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17975.java