error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3238.java
text:
```scala
i@@f (page > 0 && page >= getPageCount())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3238.java