error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8196.java
text:
```scala
i@@f (ExternalFoldersManager.isInternalPathForExternalFolder(folder.getFullPath())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8196.java