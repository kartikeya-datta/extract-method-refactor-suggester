error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15780.java
text:
```scala
P@@ath cp = new Path();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15780.java