error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14541.java
text:
```scala
i@@f (!nonMatching.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14541.java