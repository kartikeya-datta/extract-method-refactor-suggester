error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5510.java
text:
```scala
I@@ntrospectionUtils.setProperty( elem, name, value1 );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5510.java