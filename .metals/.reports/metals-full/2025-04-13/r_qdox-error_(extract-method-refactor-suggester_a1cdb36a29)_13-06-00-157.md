error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1247.java
text:
```scala
i@@f (styles.length == 2 && styles[0].style == null && ascent == -1 && descent == -1 && segments == null) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1247.java