error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14354.java
text:
```scala
i@@f (tag.getType() != XmlTag.Type.CLOSE)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14354.java