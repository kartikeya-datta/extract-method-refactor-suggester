error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8389.java
text:
```scala
S@@tring containerName = Operations.getPathAddress(operation).getLastElement().getValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8389.java