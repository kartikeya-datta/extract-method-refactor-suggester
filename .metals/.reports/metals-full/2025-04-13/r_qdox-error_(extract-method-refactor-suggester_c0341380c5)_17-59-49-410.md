error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10846.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10846.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10846.java
text:
```scala
i@@f (!discardChecker.isDiscardExpressions() && attributeValue.getType() == ModelType.EXPRESSION) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10846.java