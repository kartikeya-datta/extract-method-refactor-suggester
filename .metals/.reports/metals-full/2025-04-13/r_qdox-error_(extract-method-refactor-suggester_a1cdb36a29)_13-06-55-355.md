error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5115.java
text:
```scala
s@@tartActivityForResult(GistsViewActivity.createIntent(items, position), GIST_VIEW);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5115.java