error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11755.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11755.java
text:
```scala
public static final A@@ttachmentKey<NamespaceBindings> ATTACHMENT_KEY = AttachmentKey.create(NamespaceBindings.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11755.java