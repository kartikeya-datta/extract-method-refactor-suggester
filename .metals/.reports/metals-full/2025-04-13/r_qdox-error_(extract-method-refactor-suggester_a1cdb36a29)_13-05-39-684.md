error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15904.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15904.java
text:
```scala
private static final S@@tring FILEVERSION = "836188"; // Expected value $NON-NLS-1$
...
public class SaveService {
    ...
    private static final String FILEVERSION = "812306"; // Expected value $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15904.java