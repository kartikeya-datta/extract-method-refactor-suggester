error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9772.java
text:
```scala
c@@olors = new float /*double*/ [SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT + 1][];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9772.java