error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10646.java
text:
```scala
g@@etLogger().debug( "Using SUN rmic compiler" );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10646.java