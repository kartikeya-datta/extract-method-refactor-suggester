error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7866.java
...
```java
offset: 842
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7866.java
text:
```scala
...
p@@ackage org.apache.jmeter.util.keystore;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7866.java