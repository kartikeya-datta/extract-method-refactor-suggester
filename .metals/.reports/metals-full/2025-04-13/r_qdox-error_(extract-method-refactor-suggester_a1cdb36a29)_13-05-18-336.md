error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3491.java
text:
```scala
i@@tem.index(clusterState.metaData().concreteSingleIndex(item.index()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3491.java