error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2174.java
text:
```scala
i@@f (siteDown && (sample.getTime() != -1) && !successMsgSent)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2174.java