error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4186.java
text:
```scala
u@@tils.addWarDeployment("ws-example.war", true, EndpointImpl.class.getPackage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4186.java