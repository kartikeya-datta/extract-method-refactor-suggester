error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2597.java
text:
```scala
L@@ist attGroups = module.getAttributeGroups(getIssueType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2597.java