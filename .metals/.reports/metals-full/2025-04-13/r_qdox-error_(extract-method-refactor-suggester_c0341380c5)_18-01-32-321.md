error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3330.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3330.java
text:
```scala
static final i@@nt DRAG_DETECT = 1<<14;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3330.java