error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1848.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1848.java
text:
```scala
final X@@mlTag closeTag = new XmlTag();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1848.java