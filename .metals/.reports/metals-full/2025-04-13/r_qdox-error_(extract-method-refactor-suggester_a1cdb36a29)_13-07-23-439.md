error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3952.java
text:
```scala
l@@ogin = account.getUsername();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3952.java