error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10077.java
text:
```scala
A@@jaxyImagesPage page = tester.startPage(AjaxyImagesPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10077.java