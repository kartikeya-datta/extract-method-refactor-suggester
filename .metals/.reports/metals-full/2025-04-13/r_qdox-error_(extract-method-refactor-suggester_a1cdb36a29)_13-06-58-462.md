error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12722.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12722.java
text:
```scala
public C@@oarseSSOCacheEntry<?> readObject(ObjectInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12722.java