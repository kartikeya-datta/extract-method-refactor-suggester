error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7215.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7215.java
text:
```scala
c@@oncreteAspect.getWorld().compareByPrecedence(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7215.java