error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6994.java
text:
```scala
t@@hrow new InvalidVariableException("BeanShell not found", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6994.java