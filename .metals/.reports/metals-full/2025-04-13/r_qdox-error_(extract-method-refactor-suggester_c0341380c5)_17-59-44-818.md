error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9887.java
text:
```scala
i@@f (!stroked) OS.PathGeometry_FillRule(path, data.fillRule == SWT.FILL_EVEN_ODD ? OS.FillRule_EvenOdd : OS.FillRule_Nonzero);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9887.java