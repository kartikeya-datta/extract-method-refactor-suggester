error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2220.java
text:
```scala
b@@ind(ShardsAllocator.class).to(shardsAllocator == null ? BalancedShardsAllocator.class : shardsAllocator).asEagerSingleton();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2220.java