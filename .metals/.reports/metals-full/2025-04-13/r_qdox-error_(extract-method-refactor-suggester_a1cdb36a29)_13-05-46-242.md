error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14939.java
...
```java
offset: 865
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14939.java
text:
```scala
 ...
 * under the License.    
 */
p@@ackage org.apache.openjpa.persistence.query.common.apps;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14939.java