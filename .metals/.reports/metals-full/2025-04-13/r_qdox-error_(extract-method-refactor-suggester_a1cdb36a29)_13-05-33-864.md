error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/983.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/983.java
text:
```scala
r@@eturn new EnclosingBall<Euclidean3D, Vector3D>(Vector3D.ZERO, Double.NEGATIVE_INFINITY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/983.java