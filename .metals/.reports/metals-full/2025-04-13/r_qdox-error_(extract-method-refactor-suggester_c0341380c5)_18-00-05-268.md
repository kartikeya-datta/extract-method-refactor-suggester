error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17867.java
text:
```scala
v@@ariables.put("additionalJavascript", Strings.replaceAll(script, "${calendar}",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17867.java