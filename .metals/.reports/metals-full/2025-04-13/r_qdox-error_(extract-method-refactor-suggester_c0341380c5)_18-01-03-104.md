error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3765.java
...
```java
offset: 50
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3765.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3765.java