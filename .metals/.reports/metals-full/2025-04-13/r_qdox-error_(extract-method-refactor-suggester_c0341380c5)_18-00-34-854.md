error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8525.java
text:
```scala
s@@econds.setText(Long.toString(secsCount)); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8525.java