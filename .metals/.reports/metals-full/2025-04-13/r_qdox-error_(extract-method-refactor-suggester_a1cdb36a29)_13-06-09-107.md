error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7607.java
...
```java
offset: 1152
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7607.java
text:
```scala
 ...
 */
p@@ackage org.wildfly.clustering.web.infinispan.session;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7607.java