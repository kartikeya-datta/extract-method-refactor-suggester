error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7216.java
text:
```scala
m@@onitor
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7216.java