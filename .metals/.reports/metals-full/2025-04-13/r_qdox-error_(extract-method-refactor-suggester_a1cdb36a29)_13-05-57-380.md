error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/719.java
text:
```scala
O@@bject lookup = iniCtx.lookup("java:jboss");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/719.java