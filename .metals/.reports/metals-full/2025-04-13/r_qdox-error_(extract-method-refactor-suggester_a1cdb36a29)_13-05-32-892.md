error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13298.java
text:
```scala
c@@ode += e == null ? 0 : e.hashCode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13298.java