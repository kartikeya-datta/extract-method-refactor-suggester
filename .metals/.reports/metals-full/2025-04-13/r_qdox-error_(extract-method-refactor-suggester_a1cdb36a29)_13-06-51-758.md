error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18171.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[64,2]

error in qdox parser
file content:
```java
offset: 1927
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18171.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18171.java