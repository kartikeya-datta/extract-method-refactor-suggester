error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/908.java
text:
```scala
c@@ellItem.add(new Label(cellItem,componentId, new PropertyModel(rowModel, property)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/908.java