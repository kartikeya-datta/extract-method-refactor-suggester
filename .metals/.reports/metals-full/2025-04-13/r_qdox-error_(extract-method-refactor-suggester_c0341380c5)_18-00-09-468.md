error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5440.java
text:
```scala
r@@eturn new AllTermQuery(names().createIndexNameTerm(value));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5440.java