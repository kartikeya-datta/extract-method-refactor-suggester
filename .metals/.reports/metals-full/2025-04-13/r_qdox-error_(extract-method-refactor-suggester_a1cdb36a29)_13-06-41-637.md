error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7182.java
text:
```scala
r@@ootRegistration.registerOperationHandler(ValidateAddressOperationHandler.DEFINITION, ValidateAddressOperationHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7182.java