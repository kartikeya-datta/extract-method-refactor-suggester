error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1687.java
text:
```scala
G@@dxTest test = new SoundTouchTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1687.java