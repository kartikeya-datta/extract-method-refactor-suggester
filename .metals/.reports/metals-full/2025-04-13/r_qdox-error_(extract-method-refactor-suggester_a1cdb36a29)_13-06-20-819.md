error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11136.java
text:
```scala
s@@uper("Unable to convert value \"" + value + "\" from type '" + sourceType.getName() +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11136.java