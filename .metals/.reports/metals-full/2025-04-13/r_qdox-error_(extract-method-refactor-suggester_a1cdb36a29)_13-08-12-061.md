error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9529.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9529.java
text:
```scala
transient b@@oolean savedValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9529.java