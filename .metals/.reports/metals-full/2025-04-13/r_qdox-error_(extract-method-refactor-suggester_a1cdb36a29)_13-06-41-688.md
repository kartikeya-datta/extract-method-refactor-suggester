error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5230.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5230.java
text:
```scala
protected Q@@uaternion rotation = new Quaternion();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5230.java