error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5402.java
text:
```scala
f@@rameBuffer = new FrameBuffer(Format.RGB565, 128, 128, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5402.java