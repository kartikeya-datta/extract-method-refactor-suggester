error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2320.java
...
```java
offset: 548
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2320.java
text:
```scala
...
p@@ackage org.eclipse.ecf.provider.generic;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2320.java