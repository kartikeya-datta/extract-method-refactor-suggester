error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17039.java
text:
```scala
i@@f (!OS.CGCursorIsVisible ()) OS.CGDisplayShowCursor (OS.CGMainDisplayID ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17039.java