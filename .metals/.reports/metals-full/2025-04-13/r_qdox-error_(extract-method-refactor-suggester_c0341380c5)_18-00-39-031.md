error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9647.java
text:
```scala
n@@ew InitialContext().getEnvironment();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9647.java