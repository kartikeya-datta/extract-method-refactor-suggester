error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14796.java
text:
```scala
i@@f(status!=null && tx.equals(status.attempt)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14796.java