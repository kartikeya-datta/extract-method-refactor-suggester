error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/177.java
text:
```scala
r@@eturn this.resolvedType = enclosingTb.superclass;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/177.java