error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9476.java
text:
```scala
O@@utputStream logstr = new LogOutputStream( m_attributes.hackGetLogger(), true );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9476.java