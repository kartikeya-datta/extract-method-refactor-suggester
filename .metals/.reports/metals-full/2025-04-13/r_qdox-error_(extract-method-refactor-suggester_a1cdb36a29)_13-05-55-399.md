error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8011.java
text:
```scala
s@@erviceTarget.addService(ConnectorServices.RESOURCE_ADAPTER_DEPLOYER_SERVICE_PREFIX.append(name), Service.NULL).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8011.java