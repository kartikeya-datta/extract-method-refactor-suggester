error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6828.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6828.java
text:
```scala
D@@efaults.BOOST, fieldType, null, Defaults.NULL_VALUE, ignoreMalformed,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6828.java