error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7962.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7962.java
text:
```scala
public S@@impleElementValue(int type,int idx,ConstantPool cpool) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7962.java