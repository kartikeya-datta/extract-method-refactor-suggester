error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1515.java
text:
```scala
L@@ist<StringEntry> ordered = new ArrayList<StringEntry>(map.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1515.java