error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3289.java
text:
```scala
r@@eturn new ProblemFieldBinding(field /* closest match*/, field.declaringClass, fieldName, NotVisible);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3289.java