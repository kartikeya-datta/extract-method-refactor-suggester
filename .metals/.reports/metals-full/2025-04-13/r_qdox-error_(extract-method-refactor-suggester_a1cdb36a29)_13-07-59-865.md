error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1174.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1174.java
text:
```scala
final i@@nt AccEnumConstant = ASTNode.Bit20;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1174.java