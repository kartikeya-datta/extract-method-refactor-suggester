error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7847.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7847.java
text:
```scala
public static final i@@nt DEPENDENCIES_BUNDLE_CONTEXT_BINDING         = 0x1900;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7847.java