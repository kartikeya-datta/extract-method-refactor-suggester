error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14362.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14362.java
text:
```scala
public v@@oid generate(Collection<Contact> collection, int count)

/*
 * $Id: ContactGenerator.java 5394 2006-04-16 13:36:52 +0000 (Sun, 16 Apr 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14362.java