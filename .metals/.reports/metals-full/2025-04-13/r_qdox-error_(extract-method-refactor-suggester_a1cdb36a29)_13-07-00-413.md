error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/488.java
text:
```scala
r@@eturn getType(file1) - getType(file2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/488.java