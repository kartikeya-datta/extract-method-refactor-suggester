error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2871.java
text:
```scala
T@@hread.sleep(3000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2871.java