error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9947.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9947.java
text:
```scala
public static final l@@ong PRIORITY = DeploymentPhases.PARSE_DESCRIPTORS.plus(330L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9947.java