error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/960.java
text:
```scala
i@@f (reader != null) return new NameEnvironmentAnswer(reader, null /*no access restriction*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/960.java