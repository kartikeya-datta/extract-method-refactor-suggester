error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9977.java
text:
```scala
i@@f (binding.getBindingStatus() == BindingStatus.DIRTY) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9977.java