error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9796.java
text:
```scala
b@@oundSignatures[j] = Signature.createCharArrayTypeSignature(bounds[j], false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9796.java