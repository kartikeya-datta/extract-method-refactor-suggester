error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7610.java
text:
```scala
j@@ar.addAsManifestResource(OrderByQueryTestCase.class.getPackage(), "jbosscmp-jdbc-"+OrderByQueryTestCase.class.getSimpleName()+".xml", "jbosscmp-jdbc.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7610.java