error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6960.java
text:
```scala
f@@lushRequest.refresh(request.paramAsBoolean("refresh", flushRequest.refresh()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6960.java