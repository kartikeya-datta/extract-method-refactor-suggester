error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9388.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9388.java
text:
```scala
public B@@oolean getCommitSucceeded() throws RemoteException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9388.java