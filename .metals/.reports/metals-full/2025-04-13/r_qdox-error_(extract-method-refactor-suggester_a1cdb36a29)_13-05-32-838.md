error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1488.java
text:
```scala
S@@tring option = this.getJavaProject().getOption(JavaCore.TIMEOUT_FOR_PARAMETER_NAME_FROM_ATTACHED_JAVADOC, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1488.java