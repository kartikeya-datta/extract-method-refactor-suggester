error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1357.java
text:
```scala
n@@ew Boolean(true),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1357.java