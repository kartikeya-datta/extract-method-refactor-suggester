error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10337.java
text:
```scala
G@@dxTest test = new WavTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10337.java