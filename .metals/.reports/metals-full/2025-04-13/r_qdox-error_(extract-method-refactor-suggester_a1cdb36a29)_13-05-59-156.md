error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10785.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10785.java
text:
```scala
public synchronized v@@oid serviceTypeDiscovered(IServiceTypeEvent anEvent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10785.java