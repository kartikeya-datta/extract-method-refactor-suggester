error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17479.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17479.java
text:
```scala
s@@endDragEvent (1, pt.x, pt.y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17479.java