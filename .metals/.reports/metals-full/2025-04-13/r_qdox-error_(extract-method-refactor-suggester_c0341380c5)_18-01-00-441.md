error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11320.java
text:
```scala
p@@ublic class CheckGroupSelector extends LabeledWebMarkupContainer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11320.java