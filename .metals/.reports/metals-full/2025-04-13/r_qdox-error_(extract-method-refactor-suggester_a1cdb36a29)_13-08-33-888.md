error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2040.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2040.java
text:
```scala
s@@uper("org.columba.mail.folder", "org/columba/mail/plugin/folder.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2040.java