error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10884.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10884.java
text:
```scala
protected transient W@@icketFilter wicketFilter;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10884.java