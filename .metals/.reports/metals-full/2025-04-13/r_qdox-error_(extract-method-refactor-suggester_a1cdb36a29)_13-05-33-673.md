error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3137.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3137.java
text:
```scala
final S@@tring line = "s";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3137.java