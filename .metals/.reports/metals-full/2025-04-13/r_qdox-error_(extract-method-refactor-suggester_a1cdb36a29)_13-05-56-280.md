error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1473.java
text:
```scala
P@@latformMBeanDescriptions.getResolver(PlatformMBeanConstants.MEMORY_MANAGER));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1473.java