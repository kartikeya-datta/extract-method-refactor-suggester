error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8758.java
text:
```scala
U@@idFilter filter = new UidFilter(types, ids);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8758.java