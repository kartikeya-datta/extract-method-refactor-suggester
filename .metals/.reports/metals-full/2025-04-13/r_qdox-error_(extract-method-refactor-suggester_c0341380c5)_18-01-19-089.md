error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2123.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2123.java
text:
```scala
a@@ssertSame(context.getBean("cacheResolver"), ci.getCacheResolver());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2123.java