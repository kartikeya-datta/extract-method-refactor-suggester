error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8601.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8601.java
text:
```scala
 B@@aseTypeBinding.isWidening(variableType.id, initializationType.id)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8601.java