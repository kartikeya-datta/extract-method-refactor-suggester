error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9195.java
text:
```scala
C@@lass<?> clazz = method.getDeclaringClass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9195.java