error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8001.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8001.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8001.java
text:
```scala
r@@eturn declaration instanceof AspectDeclaration;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8001.java