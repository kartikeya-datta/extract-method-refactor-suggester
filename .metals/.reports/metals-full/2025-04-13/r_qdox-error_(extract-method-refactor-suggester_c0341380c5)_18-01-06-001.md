error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8927.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8927.java
text:
```scala
C@@onnectionFactory.getDefault().addDescription(cd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8927.java