error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5935.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5935.java
text:
```scala
protected E@@ditCommand(final T object) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5935.java