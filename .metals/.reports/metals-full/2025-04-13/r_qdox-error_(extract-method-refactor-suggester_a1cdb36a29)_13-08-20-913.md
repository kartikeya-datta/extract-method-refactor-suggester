error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14029.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14029.java
text:
```scala
private volatile I@@SecurityManagement securityManagement;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14029.java