error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/144.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/144.java
text:
```scala
public static final S@@tring IGNORED = "ignored-by-unaffected-host-controller";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/144.java