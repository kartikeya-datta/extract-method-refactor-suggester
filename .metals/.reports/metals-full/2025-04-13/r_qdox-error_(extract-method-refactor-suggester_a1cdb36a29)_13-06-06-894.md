error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2056.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2056.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2056.java
text:
```scala
m@@_engine.getRegistry().register( name, locator );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2056.java