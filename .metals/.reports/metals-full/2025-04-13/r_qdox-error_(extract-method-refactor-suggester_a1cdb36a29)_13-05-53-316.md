error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8450.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8450.java
text:
```scala
O@@perationResult execute(ModelNode operation, ResultHandler handler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8450.java