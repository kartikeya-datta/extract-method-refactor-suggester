error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5031.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5031.java
text:
```scala
private static final M@@ap<Class<?>, Class<?>> primitives = new HashMap<Class<?>, Class<?>>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5031.java