error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8409.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8409.java
text:
```scala
D@@eploymentFullReplaceHandler dfrh = isMaster ? new DeploymentFullReplaceHandler(contentRepo) : new DeploymentFullReplaceHandler(fileRepository);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8409.java