error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1961.java
text:
```scala
r@@em = ring[ring.length + index - count];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1961.java