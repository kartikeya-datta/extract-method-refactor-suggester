error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13628.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13628.java
text:
```scala
a@@ssembler.setManagedInterfaces(new Class<?>[] {IAdditionalTestMethods.class});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13628.java