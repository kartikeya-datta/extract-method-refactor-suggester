error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1772.java
text:
```scala
c@@heckComponentTag(tag, "form");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1772.java