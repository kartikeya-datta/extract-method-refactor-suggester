error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9446.java
text:
```scala
r@@eturn wrapSmartNameFilter(filter, smartNameFieldMappers, parseContext.indexCache());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9446.java