error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2470.java
text:
```scala
r@@eturn req.getParameterMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2470.java