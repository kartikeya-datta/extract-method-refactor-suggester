error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17477.java
text:
```scala
a@@ssertEquals("when mucking about with ABC\nwhen fiddling XYZ\n",CompilationAndWeavingContext.getCurrentContext());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17477.java