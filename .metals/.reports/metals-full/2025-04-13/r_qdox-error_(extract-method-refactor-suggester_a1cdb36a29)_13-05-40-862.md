error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/187.java
text:
```scala
k@@ey = (int)/*64*/OS.CharUpper ((short) key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/187.java