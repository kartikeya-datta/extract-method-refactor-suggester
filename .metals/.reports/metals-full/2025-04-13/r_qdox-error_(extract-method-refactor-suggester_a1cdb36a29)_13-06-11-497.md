error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1981.java
text:
```scala
S@@earchableEnvironment environment = project.newSearchableNameEnvironment(owner);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1981.java