error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9241.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9241.java
text:
```scala
protected C@@lass<?> getBeanClass(Element element) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9241.java