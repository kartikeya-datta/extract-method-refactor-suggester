error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/37.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/37.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/37.java
text:
```scala
s@@tage = new Stage();;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/37.java