error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2388.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2388.java
text:
```scala
private final C@@omparator<? super E> comparator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2388.java