error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9257.java
text:
```scala
p@@rojection.setToOrtho(zoom * -viewportWidth / 2, zoom * (viewportWidth / 2), zoom * -(viewportHeight / 2), zoom
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9257.java