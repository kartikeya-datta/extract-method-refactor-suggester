error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7603.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7603.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7603.java
text:
```scala
s@@uper("filter", "org/columba/mail/filter/filter.xml", "filterlist");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7603.java