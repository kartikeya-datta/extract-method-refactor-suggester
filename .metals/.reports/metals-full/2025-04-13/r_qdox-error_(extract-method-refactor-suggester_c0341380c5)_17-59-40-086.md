error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8186.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8186.java
text:
```scala
protected static final b@@oolean verbose = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8186.java