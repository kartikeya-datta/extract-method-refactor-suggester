error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2699.java
text:
```scala
n@@ew Label(border, "label", "I am the label");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2699.java