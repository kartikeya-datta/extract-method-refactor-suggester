error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2143.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2143.java
text:
```scala
i@@nitsOnReturn = initsOnReturn.mergedWith(flowInfo.copy().unconditionalInits());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2143.java