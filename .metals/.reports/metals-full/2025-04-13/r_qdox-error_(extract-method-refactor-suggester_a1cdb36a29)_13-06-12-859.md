error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2593.java
text:
```scala
t@@his.closeWriter();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2593.java