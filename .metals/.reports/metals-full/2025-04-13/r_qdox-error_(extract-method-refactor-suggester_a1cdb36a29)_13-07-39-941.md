error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4330.java
text:
```scala
l@@oopContext.complainOnFinalAssignmentsInLoop(scope, actionInfo);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4330.java