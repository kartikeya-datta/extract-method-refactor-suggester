error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10638.java
text:
```scala
s@@haredResources.add(scope, path, null, null, packageResource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10638.java