error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13289.java
text:
```scala
r@@eturn this.index < this.endIndex;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13289.java