error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4181.java
text:
```scala
p@@rintFixableError(mirror.getPosition(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4181.java