error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15282.java
text:
```scala
S@@ecurityActions.setSystemProperty(ServerEnvironment.JBOSS_BIND_ADDRESS_PREFIX + logicalName, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15282.java