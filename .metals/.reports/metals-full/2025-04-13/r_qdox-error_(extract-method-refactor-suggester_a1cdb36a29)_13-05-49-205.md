error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17066.java
text:
```scala
S@@tring exp = var.execute();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17066.java