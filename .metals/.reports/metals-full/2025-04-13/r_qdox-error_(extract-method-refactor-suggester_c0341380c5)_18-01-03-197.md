error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2491.java
text:
```scala
A@@dditionalModuleSpecification module = new AdditionalModuleSpecification(identifier, resourceRoot);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2491.java