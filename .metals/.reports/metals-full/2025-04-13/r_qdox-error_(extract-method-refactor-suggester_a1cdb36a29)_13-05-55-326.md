error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4495.java
text:
```scala
i@@f (parent.currentItem == this) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4495.java