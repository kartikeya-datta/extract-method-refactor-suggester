error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/476.java
text:
```scala
n@@ew Throwable[] { cce }, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/476.java