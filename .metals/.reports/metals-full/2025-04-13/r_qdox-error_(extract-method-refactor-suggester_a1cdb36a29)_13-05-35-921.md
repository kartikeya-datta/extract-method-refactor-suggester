error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10845.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10845.java
text:
```scala
h@@ttpService.registerServlet("/example-interceptor/servlet", servlet, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10845.java