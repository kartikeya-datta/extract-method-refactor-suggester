error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5913.java
text:
```scala
t@@oModel.get(ModelKeys.MODE).set(CacheMode.LOCAL.name());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5913.java