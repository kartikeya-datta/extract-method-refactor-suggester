error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4595.java
text:
```scala
r@@eUseConnection.setSelected(element.getPropertyAsBoolean(TCPSampler.RE_USE_CONNECTION, TCPSampler.RE_USE_CONNECTION_DEFAULT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4595.java