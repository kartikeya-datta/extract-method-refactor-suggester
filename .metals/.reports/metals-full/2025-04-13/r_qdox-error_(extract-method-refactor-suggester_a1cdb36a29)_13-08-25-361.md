error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5494.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5494.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5494.java
text:
```scala
s@@b.append("    index    : files           [").append(recoveryStatus.index().numberOfFiles()).append("] with total_size [").append(new ByteSizeValue(recoveryStatus.index().totalSize())).append("], took[").append(TimeValue.timeValueMillis(recoveryStatus.index().time())).append("]\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5494.java