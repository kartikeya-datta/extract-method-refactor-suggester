error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15187.java
text:
```scala
S@@tring substitute(String string, Map<String, Object> vars) throws IllegalStateException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15187.java