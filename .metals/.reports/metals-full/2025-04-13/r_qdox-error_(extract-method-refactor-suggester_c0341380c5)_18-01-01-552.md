error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7558.java
text:
```scala
a@@udio = new OpenALAudio(16, config.audioDeviceBufferCount, config.audioDeviceBufferSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7558.java