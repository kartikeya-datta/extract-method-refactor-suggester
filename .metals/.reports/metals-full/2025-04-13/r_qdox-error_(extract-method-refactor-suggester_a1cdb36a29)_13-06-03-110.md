error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3695.java
text:
```scala
s@@qlType
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3695.java