error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5470.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5470.java
text:
```scala
private static final S@@tring DEFAULT_BREAKER_LIMIT = "60%";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5470.java