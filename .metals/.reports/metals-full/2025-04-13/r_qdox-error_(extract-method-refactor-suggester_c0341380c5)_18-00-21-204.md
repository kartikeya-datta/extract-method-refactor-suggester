error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5520.java
text:
```scala
q@@uery = smartNameFieldMappers.mapper().fuzzyQuery(value, minSimilarity, prefixLength, maxExpansions, transpositions);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5520.java