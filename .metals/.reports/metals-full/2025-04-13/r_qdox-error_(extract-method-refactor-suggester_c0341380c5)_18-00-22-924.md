error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1467.java
text:
```scala
i@@f (PlatformMBeanUtil.JVM_MAJOR_VERSION > 6 && PlatformMBeanConstants.OBJECT_NAME.getName().equals(name)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1467.java