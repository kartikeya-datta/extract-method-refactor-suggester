error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5342.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5342.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5342.java
text:
```scala
v@@iew = LayoutInflater.from(context).inflate(layout.loading_item, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5342.java