error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11057.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11057.java
text:
```scala
i@@nt /*long*/ [] indexBuffer = new int /*long*/ [count];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11057.java