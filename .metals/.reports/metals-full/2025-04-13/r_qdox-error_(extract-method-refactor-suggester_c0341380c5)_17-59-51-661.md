error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5591.java
text:
```scala
i@@f (treeEvent.getSelected()[0] != null && treeEvent.getSelected()[0] instanceof AbstractMessageFolder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5591.java