error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4109.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4109.java
text:
```scala
public A@@jaxTabbedPanel(String id, List<ITab> tabs)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4109.java