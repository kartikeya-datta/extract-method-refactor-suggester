error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11590.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11590.java
text:
```scala
final S@@tring name = address.get(address.asInt() - 1).asProperty().getValue().asString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11590.java