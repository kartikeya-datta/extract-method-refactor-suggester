error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8232.java
text:
```scala
i@@f (!hasSelection || fg != selectionForeground.handle) OS.DeleteObject(newPen);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8232.java