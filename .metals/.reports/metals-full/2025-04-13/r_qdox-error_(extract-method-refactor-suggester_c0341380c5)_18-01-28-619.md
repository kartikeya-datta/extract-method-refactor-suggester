error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2538.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2538.java
text:
```scala
n@@ew BinaryIndexer(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2538.java