error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10057.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10057.java
text:
```scala
private v@@oid configureFilterRef(final ModelNode model, ServiceBuilder<LocationService> builder, LocationService service) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10057.java