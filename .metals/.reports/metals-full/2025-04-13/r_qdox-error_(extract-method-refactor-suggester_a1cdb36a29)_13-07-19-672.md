error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5691.java
...
```java
offset: 50
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5691.java
text:
```scala
"An error occurred while performing action \"" + a@@ction.getText() + "\"", new Status(IStatus.ERROR,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5691.java