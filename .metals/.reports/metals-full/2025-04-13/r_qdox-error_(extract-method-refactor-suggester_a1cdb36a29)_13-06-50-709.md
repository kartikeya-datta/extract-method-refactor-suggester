error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1382.java
text:
```scala
p@@ublic class ImageSequenceTimer extends ToolBarButton implements ActionListener,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1382.java