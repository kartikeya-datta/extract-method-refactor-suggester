error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3719.java
text:
```scala
H@@ttpManagementAddHandler.installHttpManagementServices(context.getRunningMode(), context.getServiceTarget(), hostControllerInfo, environment, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3719.java