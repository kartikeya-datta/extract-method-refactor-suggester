error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15309.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15309.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15309.java
text:
```scala
l@@og.warn(msg, e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15309.java