error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7768.java
text:
```scala
S@@tring label = '&' + desc.getLabel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7768.java