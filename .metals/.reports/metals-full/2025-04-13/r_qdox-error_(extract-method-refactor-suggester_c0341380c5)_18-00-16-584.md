error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4782.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4782.java
text:
```scala
s@@essionID = statefulSessionComponent.createSessionRemote();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4782.java