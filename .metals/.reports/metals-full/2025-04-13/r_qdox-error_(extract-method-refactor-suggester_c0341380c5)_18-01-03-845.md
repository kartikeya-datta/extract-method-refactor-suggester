error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17733.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[108,80]

error in qdox parser
file content:
```java
offset: 3003
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17733.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17733.java