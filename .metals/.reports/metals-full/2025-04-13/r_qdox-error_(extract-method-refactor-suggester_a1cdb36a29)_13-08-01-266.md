error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16032.java
text:
```scala
i@@f (digits < 0) error (SWT.ERROR_INVALID_ARGUMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16032.java