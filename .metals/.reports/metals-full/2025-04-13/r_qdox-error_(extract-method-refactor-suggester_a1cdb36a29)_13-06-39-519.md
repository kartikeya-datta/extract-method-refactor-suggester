error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12801.java
text:
```scala
p@@ublic interface ICompoundModel extends IModel
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12801.java