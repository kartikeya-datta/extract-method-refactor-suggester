error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13265.java
text:
```scala
v@@oid drawWidget (int /*long*/ id, NSGraphicsContext context, NSRect rect, boolean sendPaint) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13265.java