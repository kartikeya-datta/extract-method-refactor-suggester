error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6075.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6075.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6075.java
text:
```scala
S@@tring path = sql.getPCPathString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6075.java