error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1444.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1444.java
text:
```scala
private final T@@hreadLocal<Map<String, Object>> threadScope =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1444.java