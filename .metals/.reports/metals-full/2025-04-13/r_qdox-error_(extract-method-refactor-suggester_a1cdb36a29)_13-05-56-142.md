error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9501.java
text:
```scala
r@@esult.matches(), result.count(), tookInMillis, result.reducedFacets(), result.reducedAggregations()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9501.java