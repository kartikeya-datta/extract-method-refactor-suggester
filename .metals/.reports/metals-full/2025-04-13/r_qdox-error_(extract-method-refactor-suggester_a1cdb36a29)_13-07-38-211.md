error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12372.java
text:
```scala
d@@ropDown.urlFor(IOnChangeListener.INTERFACE).toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12372.java