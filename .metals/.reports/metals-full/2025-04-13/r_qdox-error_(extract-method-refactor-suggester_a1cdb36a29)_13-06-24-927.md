error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3890.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3890.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3890.java
text:
```scala
a@@ssertThat(clusterStateResponse.getState().nodes().nodes().size(), is(cluster().size()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3890.java