error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1893.java
text:
```scala
S@@creenCaptureTest.class, BitmapFontTest.class, LabelScaleTest.class, GamepadTest.class, NetAPITest.class, TideMapAssetManagerTest.class, TideMapDirectLoaderTest.class, TiledMapAssetManagerTest.class, TiledMapBench.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1893.java