error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5223.java
text:
```scala
a@@dd(new Label("txt", "Demo"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5223.java