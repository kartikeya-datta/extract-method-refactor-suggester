error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5457.java
text:
```scala
r@@eturn METHODLIST.toArray(new String[METHODLIST.size()]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5457.java