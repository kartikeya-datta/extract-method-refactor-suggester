error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1371.java
text:
```scala
i@@f (method.typeVariables != NoTypeVariables && method2.typeVariables != NoTypeVariables)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1371.java