error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10650.java
text:
```scala
j@@msManager.removeQueueFromJNDI(queueName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10650.java