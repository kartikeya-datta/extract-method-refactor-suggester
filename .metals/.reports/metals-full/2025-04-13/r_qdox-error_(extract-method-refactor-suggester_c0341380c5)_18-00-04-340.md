error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/46.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/46.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/46.java
text:
```scala
N@@umericDocValues fooNorms = MultiDocValues.getNormValues(reader, "foo");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/46.java