error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6396.java
text:
```scala
M@@odelNode resolvedValue = attributeDefinition != null ? attributeDefinition.resolveModelAttribute(context, submodel) : newValue.resolve();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6396.java