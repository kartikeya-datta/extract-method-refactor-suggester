error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4786.java
text:
```scala
S@@ortedSpriteTest.class, ExternalMusicTest.class};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4786.java