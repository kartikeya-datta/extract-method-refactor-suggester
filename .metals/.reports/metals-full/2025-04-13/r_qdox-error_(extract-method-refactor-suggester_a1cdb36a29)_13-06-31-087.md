error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5578.java
text:
```scala
L@@abelDrawableSpan.setText(labels, filterLabels);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5578.java