error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10359.java
text:
```scala
a@@ssertFalse("child ["+ child + "] already has a score", childIdToScore.containsKey(child));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10359.java