error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5926.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5926.java
text:
```scala
final C@@omponentDescription componentDescription = new ComponentDescription(beanName, beanClassName, moduleDescription, deploymentUnit.getServiceName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5926.java