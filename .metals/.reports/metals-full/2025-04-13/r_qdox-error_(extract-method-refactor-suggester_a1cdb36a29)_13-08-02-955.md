error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8427.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8427.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8427.java
text:
```scala
public v@@oid testGetPropertySubstitutedResource()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8427.java