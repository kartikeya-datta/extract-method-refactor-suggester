error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6934.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6934.java
text:
```scala
r@@eturn new Array<Decal>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6934.java