error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11232.java
text:
```scala
D@@eployment osgiDeployment = OSGiDeploymentAttachment.getDeployment(phaseContext.getDeploymentUnit());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11232.java