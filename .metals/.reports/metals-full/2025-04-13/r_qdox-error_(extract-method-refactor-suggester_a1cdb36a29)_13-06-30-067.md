error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1934.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1934.java
text:
```scala
final i@@nt max = (j > Integer.MAX_VALUE - threshold) ? n : Math.min(n, j + threshold);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1934.java