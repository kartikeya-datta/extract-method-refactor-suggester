error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2315.java
text:
```scala
t@@able.put("antialiasing", ANTI_ALIASING_DISABLED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2315.java