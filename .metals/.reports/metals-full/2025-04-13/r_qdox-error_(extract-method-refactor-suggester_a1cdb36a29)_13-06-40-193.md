error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8685.java
text:
```scala
i@@f (true || page.isPageStateless() == false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8685.java