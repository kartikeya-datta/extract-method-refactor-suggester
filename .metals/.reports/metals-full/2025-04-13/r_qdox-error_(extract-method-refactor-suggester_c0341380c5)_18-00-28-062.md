error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9720.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9720.java
text:
```scala
public F@@rameMediator createInstance(String id) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9720.java