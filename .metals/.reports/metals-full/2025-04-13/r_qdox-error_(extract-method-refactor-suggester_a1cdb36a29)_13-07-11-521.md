error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/217.java
text:
```scala
S@@ourceElementParser parser = this.document.getParser();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/217.java