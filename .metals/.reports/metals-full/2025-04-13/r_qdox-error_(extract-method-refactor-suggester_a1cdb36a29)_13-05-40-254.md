error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/784.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/784.java
text:
```scala
public v@@oid setStereotype(Vector x);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/784.java