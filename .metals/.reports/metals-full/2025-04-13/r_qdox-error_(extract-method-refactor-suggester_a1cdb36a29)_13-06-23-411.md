error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8299.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8299.java
text:
```scala
public J@@MeterProperty clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8299.java