error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8425.java
text:
```scala
i@@temCount = lastIndexOf = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8425.java