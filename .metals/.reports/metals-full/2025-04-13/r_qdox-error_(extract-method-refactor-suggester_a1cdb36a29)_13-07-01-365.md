error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14118.java
text:
```scala
p@@roperties.add(array[0], ParseUtils.parsePossibleExpression(array[1]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14118.java