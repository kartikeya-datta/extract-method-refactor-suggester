error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6434.java
text:
```scala
n@@ew MessageSpec(null,null,null,newMessageList(new Message(xoptionText)),null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6434.java