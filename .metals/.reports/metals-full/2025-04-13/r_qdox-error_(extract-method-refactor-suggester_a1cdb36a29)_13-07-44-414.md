error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3156.java
text:
```scala
c@@ountRequest.query(request.content(), request.contentUnsafe());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3156.java