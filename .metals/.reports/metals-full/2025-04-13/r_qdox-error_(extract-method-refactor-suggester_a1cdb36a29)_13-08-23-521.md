error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1580.java
text:
```scala
c@@har[][] compoundName = type.getParameterizedTypeName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1580.java