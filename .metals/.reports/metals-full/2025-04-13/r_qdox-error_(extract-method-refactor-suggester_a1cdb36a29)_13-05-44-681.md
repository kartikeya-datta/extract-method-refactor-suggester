error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2097.java
text:
```scala
f@@or (int i=itemCount; i<count; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2097.java