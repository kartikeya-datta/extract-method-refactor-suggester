error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2926.java
text:
```scala
M@@enuFactory.SAMPLERS, MenuFactory.ASSERTIONS,MenuFactory.TIMERS, MenuFactory.CONFIG_ELEMENTS, MenuFactory.PRE_PROCESSORS,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2926.java