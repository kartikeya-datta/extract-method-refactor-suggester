error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16363.java
text:
```scala
i@@nt clrSelectionText = data.foreground;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16363.java