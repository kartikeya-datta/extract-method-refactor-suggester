error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1424.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,67]

error in qdox parser
file content:
```java
offset: 67
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1424.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1424.java