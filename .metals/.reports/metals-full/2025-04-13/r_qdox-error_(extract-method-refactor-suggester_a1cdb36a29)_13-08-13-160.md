error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8354.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8354.java
text:
```scala
private static final S@@tring ENDPOINT_NAME = "respawn-client-mgmt-endpoint";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8354.java