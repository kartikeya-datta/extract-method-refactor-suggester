error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5795.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5795.java
text:
```scala
public b@@oolean filterRoles = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5795.java