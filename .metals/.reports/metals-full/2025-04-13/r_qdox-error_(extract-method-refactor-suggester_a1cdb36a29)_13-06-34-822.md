error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7219.java
text:
```scala
i@@f (rcode == Rcode.NXDOMAIN || soa != null || ns == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7219.java