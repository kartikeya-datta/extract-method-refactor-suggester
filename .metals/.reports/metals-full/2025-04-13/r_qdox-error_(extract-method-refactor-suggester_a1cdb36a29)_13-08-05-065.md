error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4822.java
...
```java
offset: 28
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4822.java
text:
```scala
private transient volatile B@@eanShellInterpreter savedBsh = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4822.java