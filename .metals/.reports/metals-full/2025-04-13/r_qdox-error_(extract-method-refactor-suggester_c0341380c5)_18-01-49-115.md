error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3142.java
text:
```scala
i@@nt /*long*/ result = super.gtk_popup_menu (widget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3142.java