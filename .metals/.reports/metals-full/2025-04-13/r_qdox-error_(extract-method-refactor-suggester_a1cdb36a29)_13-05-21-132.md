error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9493.java
text:
```scala
a@@dd(new BookmarkablePageLink<Void>("start", Guess.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9493.java