error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11282.java
text:
```scala
p@@ublic class OrderByBorder extends Border
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11282.java