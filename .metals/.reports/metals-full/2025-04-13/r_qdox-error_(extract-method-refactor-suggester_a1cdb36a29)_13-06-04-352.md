error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5421.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5421.java
text:
```scala
a@@ctionSetsViewer.setComparator(new ActionSetSorter());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5421.java