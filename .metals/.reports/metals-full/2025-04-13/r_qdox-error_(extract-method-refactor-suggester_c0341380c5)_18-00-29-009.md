error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/206.java
text:
```scala
f@@or (int i = 0; i < 1000; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/206.java