error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8073.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8073.java
text:
```scala
final S@@tring executor = ThreadPool.Names.GENERIC;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8073.java