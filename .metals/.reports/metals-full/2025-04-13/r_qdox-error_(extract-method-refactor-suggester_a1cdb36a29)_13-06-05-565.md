error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14894.java
text:
```scala
n@@ew AjaxTabbedPanel(this, "tabs", tabs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14894.java