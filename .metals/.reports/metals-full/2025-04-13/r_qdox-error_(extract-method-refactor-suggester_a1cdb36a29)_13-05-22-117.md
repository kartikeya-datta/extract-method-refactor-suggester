error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1754.java
text:
```scala
i@@nt result = (int)type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1754.java