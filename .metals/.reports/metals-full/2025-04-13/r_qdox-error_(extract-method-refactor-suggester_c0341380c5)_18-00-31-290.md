error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7180.java
text:
```scala
c@@ontentTextArea = new JTextArea(10,20);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7180.java