error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5394.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5394.java
text:
```scala
protected v@@oid onAfterRender()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5394.java