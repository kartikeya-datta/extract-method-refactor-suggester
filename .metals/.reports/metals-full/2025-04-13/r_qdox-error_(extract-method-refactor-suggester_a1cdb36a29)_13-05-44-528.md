error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6640.java
text:
```scala
J@@avaElementInfo openableParentInfo = (JavaElementInfo) JavaModelManager.getJavaModelManager().getInfo(openableParent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6640.java