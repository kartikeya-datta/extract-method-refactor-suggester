error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7750.java
text:
```scala
v@@iew.title.setText(string.no_description_given);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7750.java