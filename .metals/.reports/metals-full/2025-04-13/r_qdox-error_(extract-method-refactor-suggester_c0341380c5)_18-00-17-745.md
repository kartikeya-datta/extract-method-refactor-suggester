error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8910.java
...
```java
offset: 872
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8910.java
text:
```scala
 ...
 *
 */
p@@ackage org.apache.tools.ant.listener;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8910.java