error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4993.java
text:
```scala
i@@nt index = scanner.getLineNumber(position);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4993.java