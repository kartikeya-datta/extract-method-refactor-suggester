error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5716.java
...
```java
offset: 819
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5716.java
text:
```scala
...
p@@ackage com.badlogic.gdx.scenes.scene2d.utils;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5716.java