error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7755.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7755.java
text:
```scala
W@@ildFlySecurityManager.setCurrentContextClassLoaderPrivileged(component.getComponentClass().getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7755.java