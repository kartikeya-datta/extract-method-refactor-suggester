error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7930.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7930.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7930.java
text:
```scala
.@@getResString("error_occurred"), JOptionPane.ERROR_MESSAGE);  // $NON-NLS-1$
    ...
    protected void startEngine() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(gui.getMainFrame(), e.getMessage(), JMeterUtils
                    .getResString("Error Occurred"), JOptionPane.ERROR_MESSAGE);  // $NON-NLS-1$
        }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7930.java