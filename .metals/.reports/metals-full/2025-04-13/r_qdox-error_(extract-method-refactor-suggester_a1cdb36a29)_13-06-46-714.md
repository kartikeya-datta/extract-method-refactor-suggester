error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9641.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9641.java
text:
```scala
public U@@nmappedTerms(String name, Terms.Order order, int requiredSize, int shardSize, long minDocCount) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9641.java