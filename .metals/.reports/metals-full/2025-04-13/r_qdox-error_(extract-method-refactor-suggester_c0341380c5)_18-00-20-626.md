error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6883.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6883.java
text:
```scala
private static M@@oduleIdentifier JAVAX_ANNOTATION_API_ID = ModuleIdentifier.create("javax.annotation.api");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6883.java