error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5283.java
text:
```scala
r@@equestCycle.setResponsePage(new EditPage(SearchPage.this, id));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5283.java