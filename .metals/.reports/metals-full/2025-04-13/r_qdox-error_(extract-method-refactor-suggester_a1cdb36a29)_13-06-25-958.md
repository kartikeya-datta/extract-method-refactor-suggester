error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12717.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12717.java
text:
```scala
public S@@impleSessionMetaData readObject(ObjectInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12717.java