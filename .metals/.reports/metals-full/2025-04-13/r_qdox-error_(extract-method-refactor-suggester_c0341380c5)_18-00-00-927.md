error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10756.java
text:
```scala
t@@argetID = IDFactory.getDefault().makeStringID(DEFAULT_SERVER_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10756.java