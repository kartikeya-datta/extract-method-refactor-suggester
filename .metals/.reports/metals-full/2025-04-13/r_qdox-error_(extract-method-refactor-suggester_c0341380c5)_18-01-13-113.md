error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17239.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17239.java
text:
```scala
public final v@@oid clearInput()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17239.java