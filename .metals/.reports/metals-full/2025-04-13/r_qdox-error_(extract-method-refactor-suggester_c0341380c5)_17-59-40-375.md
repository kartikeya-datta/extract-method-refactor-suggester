error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5994.java
text:
```scala
i@@f (name.toLowerCase().endsWith(extension)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5994.java