error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5079.java
text:
```scala
S@@tring servletURL = externalFormURL.substring(0, externalFormURL.length() - 1) + PolicyContextTestServlet.SERVLET_PATH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5079.java