error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/145.java
text:
```scala
f@@ormTester.setFile("file", new File(getBasedir() + "src/test/java/org/apache/wicket/util/tester/bg.jpg"), "image/jpeg");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/145.java