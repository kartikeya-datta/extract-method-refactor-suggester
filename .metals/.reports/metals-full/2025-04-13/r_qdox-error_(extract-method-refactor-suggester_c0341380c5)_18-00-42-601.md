error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14196.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14196.java
text:
```scala
static i@@nt MINOR_VERSION = 510;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14196.java