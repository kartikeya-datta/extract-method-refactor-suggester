error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5636.java
text:
```scala
n@@sColor = NSColor.textColor ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5636.java