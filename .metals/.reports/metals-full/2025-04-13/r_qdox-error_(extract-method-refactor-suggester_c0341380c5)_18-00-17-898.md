error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/318.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/318.java
text:
```scala
I@@nteger v = (Integer)args.get("setTermIndexDivisor");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/318.java