error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6287.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6287.java
text:
```scala
abstract protected I@@Model<T> model(T object);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6287.java