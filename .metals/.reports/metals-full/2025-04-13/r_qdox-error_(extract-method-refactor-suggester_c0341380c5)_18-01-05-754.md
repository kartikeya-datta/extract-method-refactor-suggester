error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/564.java
text:
```scala
r@@eturn querySource(queryBuilder.buildAsString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/564.java