error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10116.java
text:
```scala
s@@etBorderBodyContainer(boxBorder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10116.java