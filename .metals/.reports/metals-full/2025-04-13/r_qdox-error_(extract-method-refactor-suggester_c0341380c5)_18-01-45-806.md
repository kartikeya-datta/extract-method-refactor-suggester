error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8576.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8576.java
text:
```scala
private static final d@@ouble HALF_LOG_2_PI = 0.5 * Math.log(MathUtils.TWO_PI);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8576.java