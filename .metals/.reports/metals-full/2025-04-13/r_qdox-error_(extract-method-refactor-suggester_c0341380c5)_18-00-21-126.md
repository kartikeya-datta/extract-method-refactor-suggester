error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2326.java
text:
```scala
r@@eturn new ShortArrayAtomicFieldData.SingleFixedSet(new short[1], 0, new FixedBitSet(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2326.java