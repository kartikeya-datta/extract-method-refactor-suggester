error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4964.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4964.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4964.java
text:
```scala
c@@onfiguration.addPostConstructInterceptor(SessionBeanSetSessionContextMethodInvocationInterceptor.FACTORY, InterceptorOrder.ComponentPostConstruct.EJB_SET_CONTEXT_METHOD_INVOCATION_INTERCEPTOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4964.java