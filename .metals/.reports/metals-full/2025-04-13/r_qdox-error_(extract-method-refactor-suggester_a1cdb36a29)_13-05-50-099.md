error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7126.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7126.java
text:
```scala
public static final S@@tring version = "1.0 RC1-test4";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7126.java