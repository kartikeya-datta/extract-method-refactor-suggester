error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1466.java
text:
```scala
P@@latformMBeanDescriptions.getResolver(PlatformMBeanConstants.BUFFER_POOL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1466.java