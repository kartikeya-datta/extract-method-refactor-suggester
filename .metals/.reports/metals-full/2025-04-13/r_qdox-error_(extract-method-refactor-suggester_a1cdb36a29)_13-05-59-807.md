error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3426.java
text:
```scala
s@@uper("columns", "ColumnOptions", mediator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3426.java