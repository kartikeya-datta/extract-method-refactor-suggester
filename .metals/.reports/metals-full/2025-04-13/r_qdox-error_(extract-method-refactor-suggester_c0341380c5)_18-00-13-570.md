error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7560.java
text:
```scala
S@@treams.copy(input, new FileOutputStream(file));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7560.java