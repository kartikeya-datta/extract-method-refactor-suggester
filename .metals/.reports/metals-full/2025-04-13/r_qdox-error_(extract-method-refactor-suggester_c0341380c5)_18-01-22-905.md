error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4458.java
text:
```scala
r@@eturn  addLineBreak ?  HTML_BR_TAG + NEW_LINE : NEW_LINE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4458.java