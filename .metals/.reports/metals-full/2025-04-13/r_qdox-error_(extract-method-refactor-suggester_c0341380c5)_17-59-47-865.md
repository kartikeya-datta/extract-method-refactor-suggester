error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10463.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10463.java
text:
```scala
I@@PageManager pageManager = Application.get().internalGetPageManager();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10463.java