error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9336.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9336.java
text:
```scala
protected abstract v@@oid moveToSecondPhase() throws Exception;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9336.java