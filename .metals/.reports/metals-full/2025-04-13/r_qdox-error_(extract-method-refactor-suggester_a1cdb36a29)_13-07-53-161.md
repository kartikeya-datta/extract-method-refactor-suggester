error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8644.java
text:
```scala
q@@uery = smartNameFieldMappers.mapper().fieldQuery(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8644.java