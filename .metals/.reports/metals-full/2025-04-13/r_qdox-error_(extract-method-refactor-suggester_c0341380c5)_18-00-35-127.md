error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2553.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1297,2]

error in qdox parser
file content:
```java
offset: 37191
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2553.java
text:
```scala
{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2553.java