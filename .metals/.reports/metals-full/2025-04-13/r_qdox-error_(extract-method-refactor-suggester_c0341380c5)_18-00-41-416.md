error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8825.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8825.java
text:
```scala
d@@eclare parents : Tag implements INode<Tag,Tag>;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8825.java