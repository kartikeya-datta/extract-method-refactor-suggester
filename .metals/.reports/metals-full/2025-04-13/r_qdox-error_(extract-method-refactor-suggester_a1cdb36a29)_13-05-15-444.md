error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12892.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(MESSAGES.nameAndValueRequiredForAddMimeMapping()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12892.java