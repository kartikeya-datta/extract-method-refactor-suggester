error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6299.java
text:
```scala
r@@eturn ((X1Logger) Logger.getLogger(name, factory));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6299.java