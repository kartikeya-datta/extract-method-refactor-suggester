error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5916.java
text:
```scala
s@@etTooltipText("Context-specific help");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5916.java