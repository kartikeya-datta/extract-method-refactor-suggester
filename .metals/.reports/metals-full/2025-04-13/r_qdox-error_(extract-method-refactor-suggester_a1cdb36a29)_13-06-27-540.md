error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3092.java
text:
```scala
r@@eturn this.binding.isWildcard() && ((WildcardBinding) this.binding).kind == Wildcard.EXTENDS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3092.java