error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3219.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3219.java
text:
```scala
final i@@nt numberOfRuns = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3219.java