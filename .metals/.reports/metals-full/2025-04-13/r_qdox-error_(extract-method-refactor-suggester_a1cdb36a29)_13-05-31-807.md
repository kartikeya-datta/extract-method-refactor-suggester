error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2015.java
text:
```scala
a@@vatarView.setImageDrawable(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2015.java