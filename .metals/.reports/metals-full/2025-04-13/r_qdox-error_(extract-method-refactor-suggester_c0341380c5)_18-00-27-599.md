error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10428.java
text:
```scala
f@@ieldName = fieldMapper.names().indexName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10428.java