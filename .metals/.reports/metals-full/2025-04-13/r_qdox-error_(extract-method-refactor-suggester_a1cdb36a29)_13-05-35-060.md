error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2591.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2591.java
text:
```scala
public v@@oid setText (String text) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2591.java