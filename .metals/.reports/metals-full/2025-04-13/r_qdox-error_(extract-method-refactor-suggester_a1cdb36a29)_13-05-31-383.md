error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9914.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9914.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9914.java
text:
```scala
f@@ilter = parseContext.cacheFilter(filter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9914.java