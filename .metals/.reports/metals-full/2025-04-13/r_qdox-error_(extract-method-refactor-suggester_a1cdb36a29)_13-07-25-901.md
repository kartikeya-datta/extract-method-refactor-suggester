error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5082.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5082.java
text:
```scala
i@@nt end = this.scanner.eofPosition == Integer.MAX_VALUE ? this.scanner.eofPosition : this.scanner.eofPosition - 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5082.java