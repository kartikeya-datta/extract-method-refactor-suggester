error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2408.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2408.java
text:
```scala
c@@oreContainer.register(core, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2408.java