error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14566.java
text:
```scala
r@@eturn super.acceptsFirstResponder ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14566.java