error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5832.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5832.java
text:
```scala
d@@edup = settings.getAsBoolean("dedup", true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5832.java