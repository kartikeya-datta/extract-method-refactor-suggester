error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3567.java
text:
```scala
k@@eyBindings = Collections.unmodifiableList(Persistence.readKeyBindings(memento, Persistence.TAG_KEY_BINDING, null, 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3567.java