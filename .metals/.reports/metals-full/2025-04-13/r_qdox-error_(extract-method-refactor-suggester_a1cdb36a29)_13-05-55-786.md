error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2921.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2921.java
text:
```scala
S@@tringBuffer buf = new StringBuffer("ModifiedBuilderType("/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2921.java