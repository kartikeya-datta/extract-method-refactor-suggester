error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3534.java
text:
```scala
r@@esponse.setHeader("Cache-Control", "no-cache, max-age=0, must-revalidate"); // no-store
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3534.java