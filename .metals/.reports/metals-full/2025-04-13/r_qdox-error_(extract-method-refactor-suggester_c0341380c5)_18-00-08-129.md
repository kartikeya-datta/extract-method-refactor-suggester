error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2375.java
text:
```scala
s@@uper(parameters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2375.java