error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6537.java
text:
```scala
p@@ublic class TestAdvAnnot extends AnnotationTestCase
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6537.java