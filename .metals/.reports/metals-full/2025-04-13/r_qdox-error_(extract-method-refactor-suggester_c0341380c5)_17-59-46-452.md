error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3536.java
text:
```scala
t@@ag.put("src", Strings.replaceAll(RequestCycle.get().getOriginalResponse().encodeURL(url), "&", "&amp;"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3536.java