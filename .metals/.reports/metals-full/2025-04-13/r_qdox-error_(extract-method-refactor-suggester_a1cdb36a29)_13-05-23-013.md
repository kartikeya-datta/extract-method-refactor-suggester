error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1691.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1691.java
text:
```scala
T@@wlRenderer.updateSize(gui);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1691.java