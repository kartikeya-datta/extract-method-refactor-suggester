error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12892.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12892.java
text:
```scala
final C@@lassLoader classLoader = m_classLoaderManager.getClassLoader( file );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12892.java