error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6889.java
text:
```scala
b@@uilder.field("_type", StatisticalFacetCollectorParser.NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6889.java