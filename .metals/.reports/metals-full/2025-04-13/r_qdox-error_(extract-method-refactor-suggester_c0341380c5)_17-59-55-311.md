error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2544.java
text:
```scala
s@@uper(false, true, null, null, null, null, null, null, null, null, R_PATTERN_MATCH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2544.java