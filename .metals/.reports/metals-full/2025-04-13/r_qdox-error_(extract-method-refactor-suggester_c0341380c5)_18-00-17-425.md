error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10790.java
text:
```scala
c@@omparator = (AbstractFileComparator) SizeFileComparator.SIZE_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10790.java