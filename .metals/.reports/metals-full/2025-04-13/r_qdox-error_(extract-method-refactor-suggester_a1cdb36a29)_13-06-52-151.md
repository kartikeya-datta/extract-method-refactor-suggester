error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4744.java
text:
```scala
n@@ew JglfwApplication(test, config).start();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4744.java