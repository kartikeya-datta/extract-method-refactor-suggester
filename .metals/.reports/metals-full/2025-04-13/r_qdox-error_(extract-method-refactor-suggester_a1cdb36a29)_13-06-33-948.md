error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/627.java
text:
```scala
a@@ssertTitleEquals("Wicket Examples - springframework");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/627.java