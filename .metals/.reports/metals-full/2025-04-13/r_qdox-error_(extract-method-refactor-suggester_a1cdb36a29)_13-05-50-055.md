error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12219.java
text:
```scala
p@@roxy = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12219.java