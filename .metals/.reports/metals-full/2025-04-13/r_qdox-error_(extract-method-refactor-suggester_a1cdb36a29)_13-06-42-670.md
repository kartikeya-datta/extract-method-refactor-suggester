error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3957.java
text:
```scala
f@@ullRect.width = contentSize.width;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3957.java