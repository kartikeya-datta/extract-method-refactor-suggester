error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2153.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2153.java
text:
```scala
t@@hrow new OperationFailedException(MESSAGES.nameAndValueRequiredForAddMimeMapping());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2153.java