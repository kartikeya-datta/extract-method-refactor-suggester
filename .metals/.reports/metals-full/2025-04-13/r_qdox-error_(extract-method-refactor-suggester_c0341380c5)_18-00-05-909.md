error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17100.java
text:
```scala
r@@eturn application.getResourceSettings().getPropertiesFactory().get(application, clazz, style, locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17100.java