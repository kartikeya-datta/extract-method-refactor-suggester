error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7913.java
text:
```scala
e@@vent.pointer = pointer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7913.java