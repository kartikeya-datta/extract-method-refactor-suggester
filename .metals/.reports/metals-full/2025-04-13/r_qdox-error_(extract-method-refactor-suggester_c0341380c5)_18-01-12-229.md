error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14643.java
text:
```scala
t@@extFileChange.addEdit(AnnotationUtils.createAddImportTextEdit(field, WebServiceRef.class.getCanonicalName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14643.java