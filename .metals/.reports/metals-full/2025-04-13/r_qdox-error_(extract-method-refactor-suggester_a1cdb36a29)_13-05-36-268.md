error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5196.java
text:
```scala
r@@eturn nodeService.info(request.isSettings(), request.isOs(), request.isProcess(), request.isJvm(), request.isThreadPool(), request.isNetwork(), request.isTransport(), request.isHttp());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5196.java