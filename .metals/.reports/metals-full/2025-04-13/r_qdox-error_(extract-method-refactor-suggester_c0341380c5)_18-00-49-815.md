error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3149.java
text:
```scala
r@@eturn new DefaultOperationDescriptionProvider(getName(), resolver, attributeResolver, replyType, replyValueType, replyAllowNull, deprecationData, replyParameters, parameters, accessConstraints).getModelDescription(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3149.java