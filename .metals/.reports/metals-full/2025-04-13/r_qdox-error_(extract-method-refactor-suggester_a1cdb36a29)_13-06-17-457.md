error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8986.java
text:
```scala
r@@eturn ((loader!=null)?loader.getClass().getName()+"@"+Integer.toHexString(loader.hashCode()):"null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8986.java