error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17571.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[51,27]

error in qdox parser
file content:
```java
offset: 1713
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17571.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17571.java