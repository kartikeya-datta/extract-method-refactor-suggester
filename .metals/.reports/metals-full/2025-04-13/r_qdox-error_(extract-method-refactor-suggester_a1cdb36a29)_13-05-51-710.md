error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16570.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16570.java
text:
```scala
static i@@nt MINOR_VERSION = 438;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16570.java