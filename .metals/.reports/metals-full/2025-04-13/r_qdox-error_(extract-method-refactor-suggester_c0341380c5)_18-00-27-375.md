error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6863.java
text:
```scala
r@@oot = (IMAPRootFolder) subscribeReference.getSourceFolder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6863.java