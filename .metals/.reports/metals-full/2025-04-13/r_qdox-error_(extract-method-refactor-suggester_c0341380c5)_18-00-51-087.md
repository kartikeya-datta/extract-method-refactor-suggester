error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7967.java
text:
```scala
t@@his.resource = RequestCycle.get().getApplication().getResourceStreamLocator().locate(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7967.java