error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3319.java
text:
```scala
t@@his.resolvedType = lhsType.capture(scope, this.sourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3319.java