error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/945.java
text:
```scala
p@@arsedCmd.parse(ctx.getCurrentNodePath(), buffer, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/945.java