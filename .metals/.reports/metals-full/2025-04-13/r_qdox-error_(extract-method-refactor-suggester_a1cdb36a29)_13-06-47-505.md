error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6829.java
text:
```scala
s@@cope.problemReporter().needImplementation(invocationSite); //TODO (philippe) should improve local emulation failure reporting
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6829.java