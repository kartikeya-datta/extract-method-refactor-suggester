error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14038.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14038.java
text:
```scala
public  C@@ontent getContent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14038.java