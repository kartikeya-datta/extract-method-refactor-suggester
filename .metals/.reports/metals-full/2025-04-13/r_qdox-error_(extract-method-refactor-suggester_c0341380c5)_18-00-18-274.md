error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3262.java
text:
```scala
t@@arget.rotation = startRotation + rotation;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3262.java