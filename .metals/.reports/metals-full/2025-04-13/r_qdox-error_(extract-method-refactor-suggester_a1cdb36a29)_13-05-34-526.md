error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8266.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8266.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8266.java
text:
```scala
C@@lusterState.Builder builder = ClusterState.builder(currentState.getClusterName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8266.java