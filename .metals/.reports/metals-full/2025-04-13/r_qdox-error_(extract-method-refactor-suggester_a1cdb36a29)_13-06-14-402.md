error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/563.java
text:
```scala
i@@nitializationScope.problemReporter().annotationMissingForPublic(this.sourceStart, this.sourceEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/563.java