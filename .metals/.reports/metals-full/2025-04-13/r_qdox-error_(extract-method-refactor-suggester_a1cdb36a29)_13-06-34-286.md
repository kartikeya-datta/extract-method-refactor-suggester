error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13457.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13457.java
text:
```scala
final B@@icubicSplineInterpolator bsi = new BicubicSplineInterpolator(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13457.java