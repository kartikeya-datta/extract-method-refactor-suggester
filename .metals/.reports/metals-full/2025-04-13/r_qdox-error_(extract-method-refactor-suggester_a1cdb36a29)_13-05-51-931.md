error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2597.java
text:
```scala
n@@ew Object[] { new Integer(maxIterations) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2597.java