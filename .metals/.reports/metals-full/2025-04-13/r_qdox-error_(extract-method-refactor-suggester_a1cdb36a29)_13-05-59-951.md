error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7456.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7456.java
text:
```scala
public static final S@@tring READ_CHILDREN_NAMES_OPERATION = "read-children-names";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7456.java