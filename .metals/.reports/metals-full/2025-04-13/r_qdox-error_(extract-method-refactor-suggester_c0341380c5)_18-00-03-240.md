error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12731.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12731.java
text:
```scala
r@@eturn getDictionarySize(coder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12731.java