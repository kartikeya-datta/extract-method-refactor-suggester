error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5379.java
text:
```scala
s@@uper(layout.gist_item, inflater, elements);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5379.java