error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5563.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5563.java
text:
```scala
public v@@oid acceptImport(int declarationStart, int declarationEnd, char[] name, boolean onDemand, int modifiers) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5563.java