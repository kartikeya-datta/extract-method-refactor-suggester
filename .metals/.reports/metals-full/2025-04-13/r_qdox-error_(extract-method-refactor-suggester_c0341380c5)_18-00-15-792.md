error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8778.java
text:
```scala
c@@r = lookupRecords(name.wild(1), type, dclass,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8778.java