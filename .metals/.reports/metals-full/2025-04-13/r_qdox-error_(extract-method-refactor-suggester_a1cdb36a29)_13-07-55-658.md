error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/714.java
text:
```scala
S@@erviceName SERVICE_NAME_BASE = ConfigAdminService.SERVICE_NAME.append("listener");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/714.java