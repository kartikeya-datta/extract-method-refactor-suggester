error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8513.java
text:
```scala
s@@napshotStatus.index().totalSize());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8513.java