error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3296.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3296.java
text:
```scala
r@@eturn (fProblems.length == 0 ? ""/*nonNLS*/ : "*"/*nonNLS*/) + "ConvertedCompilationResult("/*nonNLS*/ + fPackageElement + ")"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3296.java