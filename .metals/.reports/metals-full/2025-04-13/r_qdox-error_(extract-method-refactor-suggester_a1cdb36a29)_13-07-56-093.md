error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9370.java
text:
```scala
s@@b.append("Unknown command: ").append(arg);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9370.java