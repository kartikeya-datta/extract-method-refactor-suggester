error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2892.java
text:
```scala
r@@ows, columns);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2892.java