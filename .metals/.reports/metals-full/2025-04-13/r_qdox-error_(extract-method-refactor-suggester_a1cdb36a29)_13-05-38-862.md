error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10372.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10372.java
text:
```scala
static final S@@tring AGENT_STRING = "Safari/522.0"; /* Safari version on OSX 10.5 initial release */ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10372.java