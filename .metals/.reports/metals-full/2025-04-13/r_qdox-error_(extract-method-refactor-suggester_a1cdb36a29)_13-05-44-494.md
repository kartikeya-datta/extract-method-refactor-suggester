error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6714.java
text:
```scala
s@@pinnerGroup.setLayoutData (new GridData (SWT.FILL, SWT.FILL, true, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6714.java