error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12704.java
text:
```scala
_@@properties.put (pd.getName(), new JavaBeansProperty (pd, this, ts.getRootTypesystem().findType (pd.getPropertyType())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12704.java