error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/909.java
text:
```scala
o@@p.runOperation(monitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/909.java