error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3634.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3634.java
text:
```scala
public b@@oolean isSuccess() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3634.java