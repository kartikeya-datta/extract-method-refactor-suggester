error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3394.java
text:
```scala
i@@nt interval = item.getInteger("mailcheck_interval", 10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3394.java