error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6005.java
text:
```scala
r@@eturn OS.objc_msgSend(this.id, OS.sel_resizingMask);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6005.java