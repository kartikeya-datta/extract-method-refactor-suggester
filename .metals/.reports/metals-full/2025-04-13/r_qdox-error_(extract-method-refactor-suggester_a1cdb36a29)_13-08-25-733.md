error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9505.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9505.java
text:
```scala
public static final A@@ttributeDefinition[] ATTRIBUTES = concat(Regular.ATTRIBUTES, getDefinitions(Common.ATTRIBUTES));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9505.java