error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3899.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3899.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3899.java
text:
```scala
public M@@yPageableListViewNavigator(final MarkupContainer parent, final String id,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3899.java