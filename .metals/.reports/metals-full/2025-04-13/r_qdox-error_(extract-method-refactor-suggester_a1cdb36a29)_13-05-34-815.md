error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2931.java
text:
```scala
S@@creenCaptureTest.class, BitmapFontTest.class, LabelScaleTest.class, GleedTest.class, GamepadTest.class, NetAPITest.class, TiledMapAssetManagerTest.class, TiledMapBench.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2931.java