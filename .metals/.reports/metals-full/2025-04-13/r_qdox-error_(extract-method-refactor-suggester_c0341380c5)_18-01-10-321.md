error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8554.java
text:
```scala
i@@f (!field.isNonDefaultMappingUsingJoinTableStrategy())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8554.java