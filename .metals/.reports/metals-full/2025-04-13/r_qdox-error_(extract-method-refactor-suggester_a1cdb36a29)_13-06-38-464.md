error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4060.java
text:
```scala
p@@ager.setAdapter(new RepositoryPagerAdapter(getSupportFragmentManager(), repository.isHasIssues()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4060.java