error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6409.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6409.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6409.java
text:
```scala
final I@@MenuManager menuManager = new MenuManager(Messages.ReferencesSearchGroup_Label, IContextMenuConstants.GROUP_SEARCH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6409.java