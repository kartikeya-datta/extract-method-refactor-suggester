error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1847.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1847.java
text:
```scala
public static final S@@tring NAME = "indices:admin/warmers/delete";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1847.java