error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2903.java
text:
```scala
t@@his(new StandardAnalyzer(Version.LUCENE_42), "text");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2903.java