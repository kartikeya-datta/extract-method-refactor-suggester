error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18022.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18022.java
text:
```scala
i@@f (gnome != OS.None && (OS.GTK_VERSION >= OS.VERSION (2, 2, 0)) && gnome_init()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18022.java