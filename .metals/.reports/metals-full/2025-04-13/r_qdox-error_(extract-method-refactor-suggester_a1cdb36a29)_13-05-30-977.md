error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9105.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,235]

error in qdox parser
file content:
```java
offset: 235
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9105.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9105.java