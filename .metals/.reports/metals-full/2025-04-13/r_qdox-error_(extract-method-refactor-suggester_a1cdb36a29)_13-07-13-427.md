error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7192.java
text:
```scala
n@@ew WicketTester();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7192.java