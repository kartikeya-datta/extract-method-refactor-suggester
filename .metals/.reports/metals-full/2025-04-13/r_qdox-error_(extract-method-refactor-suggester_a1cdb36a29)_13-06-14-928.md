error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9209.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9209.java
text:
```scala
H@@ttpRequest.NULL, NullResponse.getInstance()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9209.java