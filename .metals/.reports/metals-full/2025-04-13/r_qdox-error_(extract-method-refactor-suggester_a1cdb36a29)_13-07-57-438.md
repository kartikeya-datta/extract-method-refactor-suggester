error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10542.java
text:
```scala
I@@WrapModel wrapOnInheritance(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10542.java