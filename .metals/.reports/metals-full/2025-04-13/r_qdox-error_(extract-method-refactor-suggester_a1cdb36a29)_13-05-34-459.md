error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13396.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13396.java
text:
```scala
static final S@@tring FILEVERSION = "390699";// Expected $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13396.java