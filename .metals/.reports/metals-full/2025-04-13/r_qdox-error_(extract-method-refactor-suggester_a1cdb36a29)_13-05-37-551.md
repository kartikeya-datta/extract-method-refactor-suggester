error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12137.java
text:
```scala
c@@ase SWT.CURSOR_APPSTARTING: if (!OS.IsLinux) shape = OS.XC_left_ptr; break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12137.java