error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10938.java
text:
```scala
S@@tringBuilder buf = new StringBuilder(31);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10938.java