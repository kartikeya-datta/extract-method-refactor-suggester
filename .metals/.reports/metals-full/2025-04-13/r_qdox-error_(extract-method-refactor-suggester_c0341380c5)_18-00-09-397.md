error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/635.java
text:
```scala
I@@mmediateModeRendererTest.class, Scene2dTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/635.java