error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14037.java
...
```java
offset: 861
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14037.java
text:
```scala
...
p@@ackage org.apache.commons.codec.net;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14037.java