error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8817.java
text:
```scala
l@@ogger.trace("{} refresh request executed, force: [{}]", indexShard.shardId(), request.force());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8817.java