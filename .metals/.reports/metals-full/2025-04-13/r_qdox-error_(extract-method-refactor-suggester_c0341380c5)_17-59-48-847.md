error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8488.java
text:
```scala
r@@eturn new PrintWriter(System.out, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8488.java