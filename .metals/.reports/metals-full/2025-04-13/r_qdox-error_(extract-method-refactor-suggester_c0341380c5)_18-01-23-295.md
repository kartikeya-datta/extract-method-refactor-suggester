error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13880.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13880.java
text:
```scala
r@@egistration.registerSubModel(new BackupSiteResourceDefinition(this.runtimeRegistration));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13880.java