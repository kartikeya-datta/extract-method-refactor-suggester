error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10037.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10037.java
text:
```scala
n@@ew SendAllMessagesCommand(frameMediator, r);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10037.java