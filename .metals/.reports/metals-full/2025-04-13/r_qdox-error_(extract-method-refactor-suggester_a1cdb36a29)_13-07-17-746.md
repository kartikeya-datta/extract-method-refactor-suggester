error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18093.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18093.java
text:
```scala
O@@bject o = getReal(key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18093.java