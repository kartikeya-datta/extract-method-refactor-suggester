error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2999.java
...
```java
offset: 857
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2999.java
text:
```scala
...
p@@ackage org.elasticsearch.common.text;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2999.java