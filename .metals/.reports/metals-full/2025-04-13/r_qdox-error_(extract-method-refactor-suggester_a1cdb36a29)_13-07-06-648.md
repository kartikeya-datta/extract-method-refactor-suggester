error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5518.java
text:
```scala
r@@eturn Long.valueOf(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5518.java