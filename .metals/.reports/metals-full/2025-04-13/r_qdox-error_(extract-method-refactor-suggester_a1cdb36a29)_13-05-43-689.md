error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10188.java
text:
```scala
l@@istener.future = threadPool.schedule(request.timeout, ThreadPool.Names.SAME, new Runnable() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10188.java