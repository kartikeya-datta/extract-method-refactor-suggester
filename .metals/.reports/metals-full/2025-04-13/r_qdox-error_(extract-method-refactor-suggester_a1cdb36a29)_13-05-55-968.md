error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3690.java
text:
```scala
r@@eturn number.doubleValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3690.java