error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11926.java
text:
```scala
r@@eturn (Component) new Label(parent, componentId, getDisplayModel());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11926.java