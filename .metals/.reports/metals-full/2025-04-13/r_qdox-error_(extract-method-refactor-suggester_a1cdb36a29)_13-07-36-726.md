error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/744.java
text:
```scala
p@@age.render();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/744.java