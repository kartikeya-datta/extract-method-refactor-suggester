error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14251.java
text:
```scala
v@@oid emitBatch(TransactionAttempt tx, Object coordinatorMeta, TransactionalOutputCollector collector);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14251.java