error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1137.java
text:
```scala
p@@art = folder.getMimePart(uids[0], address);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1137.java