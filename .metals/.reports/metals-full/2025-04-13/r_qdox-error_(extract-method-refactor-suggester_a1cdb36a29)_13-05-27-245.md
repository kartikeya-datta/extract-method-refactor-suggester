error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3140.java
text:
```scala
r@@w.shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3140.java