error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14300.java
text:
```scala
r@@eturn "rollout";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14300.java