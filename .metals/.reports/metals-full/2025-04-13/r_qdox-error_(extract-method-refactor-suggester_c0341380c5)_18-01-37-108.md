error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1431.java
text:
```scala
i@@f(servlet.getServletClass().equals(JAVAX_FACES_WEBAPP_FACES_SERVLET)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1431.java