error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17346.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17346.java
text:
```scala
final L@@ink<Void> link = new Link<Void>("letter")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17346.java