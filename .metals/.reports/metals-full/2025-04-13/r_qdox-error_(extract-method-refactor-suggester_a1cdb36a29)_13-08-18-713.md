error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3356.java
text:
```scala
u@@i.draw();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3356.java