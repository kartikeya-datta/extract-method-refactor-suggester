error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1609.java
text:
```scala
t@@estGenerator.nextInt(-1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1609.java