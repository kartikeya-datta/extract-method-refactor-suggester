error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5.java
text:
```scala
a@@ppLock.notifyAll();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5.java