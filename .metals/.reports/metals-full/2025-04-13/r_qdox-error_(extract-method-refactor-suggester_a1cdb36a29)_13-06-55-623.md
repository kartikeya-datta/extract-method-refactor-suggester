error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2085.java
text:
```scala
b@@reak;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2085.java