error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7477.java
text:
```scala
R@@emotingServices.installChannelOpenListenerService(serviceTarget, "server", ServerToHostOperationHandler.SERVICE_NAME, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7477.java