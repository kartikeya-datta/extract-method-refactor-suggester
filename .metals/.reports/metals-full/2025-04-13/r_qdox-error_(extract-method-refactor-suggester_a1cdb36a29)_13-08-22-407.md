error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8677.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8677.java
text:
```scala
r@@eturn new ConcurrentMapCache(nativeCache, CACHE_NAME, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8677.java