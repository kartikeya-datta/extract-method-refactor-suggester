error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13415.java
text:
```scala
r@@eturn getAssociatedMarkup(true).getChildFragment(id, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13415.java