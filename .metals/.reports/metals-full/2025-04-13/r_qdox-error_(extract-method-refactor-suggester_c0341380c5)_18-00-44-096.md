error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9542.java
text:
```scala
i@@tem.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9542.java