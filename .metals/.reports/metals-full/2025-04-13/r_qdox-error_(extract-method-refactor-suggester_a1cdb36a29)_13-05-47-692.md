error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5258.java
text:
```scala
r@@eturn Long.compare(term, other.getKeyAsNumber().longValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5258.java