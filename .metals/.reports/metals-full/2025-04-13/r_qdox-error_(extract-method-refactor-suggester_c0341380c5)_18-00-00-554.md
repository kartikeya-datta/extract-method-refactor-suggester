error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7635.java
text:
```scala
i@@f ((methodBinding.declaringClass.modifiers & AccInterface) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7635.java