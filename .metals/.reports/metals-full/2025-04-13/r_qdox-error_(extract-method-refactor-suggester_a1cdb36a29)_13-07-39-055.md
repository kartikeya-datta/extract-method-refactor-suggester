error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12003.java
text:
```scala
B@@eanGroupEntry<I, T> existing = this.invoker.invoke(this.cache, new CreateOperation<>(id, entry), Flag.FORCE_SYNCHRONOUS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12003.java