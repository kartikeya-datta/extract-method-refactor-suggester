error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2281.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2281.java
text:
```scala
w@@ithoutUnicodeBuffer = new char[sourceLength]; // TODO (philippe) should only allocate when needed
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2281.java