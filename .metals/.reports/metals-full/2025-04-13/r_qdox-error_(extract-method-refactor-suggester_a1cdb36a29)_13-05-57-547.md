error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16300.java
text:
```scala
i@@f (!getDrawing ()) return result;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16300.java