error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7784.java
text:
```scala
E@@ngine.Searcher searcher = indexShard.acquireSearcher();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7784.java