error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2995.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2995.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2995.java
text:
```scala
i@@f (trackedId != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2995.java