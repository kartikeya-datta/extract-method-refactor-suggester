error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11927.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11927.java
text:
```scala
r@@eturn new Point(width + 2, height + 200);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11927.java