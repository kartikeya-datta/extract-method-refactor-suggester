error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9015.java
text:
```scala
a@@ddInitializationsFrom(assertWhenTrueInfo.discardInitializationInfo());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9015.java