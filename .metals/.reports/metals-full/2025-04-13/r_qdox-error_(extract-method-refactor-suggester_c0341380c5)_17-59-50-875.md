error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2852.java
text:
```scala
i@@f (!component.isEnableAllowed())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2852.java