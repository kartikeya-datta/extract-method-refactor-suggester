error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17558.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[315,80]

error in qdox parser
file content:
```java
offset: 9529
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17558.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17558.java