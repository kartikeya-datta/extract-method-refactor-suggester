error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/663.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/663.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/663.java
text:
```scala
r@@eturn "NamespaceNode("/*nonNLS*/ + fPackage.getName() + ")"/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/663.java