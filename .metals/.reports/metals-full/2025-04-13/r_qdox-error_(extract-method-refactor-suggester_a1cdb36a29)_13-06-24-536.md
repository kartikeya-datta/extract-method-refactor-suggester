error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1137.java
text:
```scala
f@@or (AttributeDefinition def : CustomLoadMetricDefinition.ATTRIBUTES) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1137.java