error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5424.java
text:
```scala
r@@eturn state.blocks().indicesBlockedException(ClusterBlockLevel.METADATA, state.metaData().concreteIndices(request.indicesOptions(), request.indices()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5424.java