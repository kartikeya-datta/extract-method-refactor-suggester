error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9049.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9049.java
text:
```scala
r@@eturn value ? "true" : "false";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9049.java