error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2395.java
text:
```scala
r@@eturn this.resolvedType = binding.returnType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2395.java