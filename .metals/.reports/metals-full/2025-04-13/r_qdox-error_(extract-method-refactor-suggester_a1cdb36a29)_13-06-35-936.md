error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15955.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15955.java
text:
```scala
private final i@@nt threshold;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15955.java