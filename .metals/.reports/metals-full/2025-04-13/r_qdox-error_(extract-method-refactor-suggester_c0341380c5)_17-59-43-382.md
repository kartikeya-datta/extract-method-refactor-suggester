error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5434.java
text:
```scala
m@@ap.getLayers().add(layer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5434.java