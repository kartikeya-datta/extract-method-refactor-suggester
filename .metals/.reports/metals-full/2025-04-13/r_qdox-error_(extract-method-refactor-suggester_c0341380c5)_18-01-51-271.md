error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/226.java
text:
```scala
I@@mmediateModeRendererTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/226.java