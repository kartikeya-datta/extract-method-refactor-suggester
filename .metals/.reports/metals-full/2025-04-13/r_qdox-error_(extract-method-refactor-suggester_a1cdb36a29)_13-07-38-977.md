error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11695.java
text:
```scala
r@@ootResource.registerOperationHandler(GenericSubsystemDescribeHandler.DEFINITION, GenericSubsystemDescribeHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11695.java