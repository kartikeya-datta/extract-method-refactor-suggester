error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4955.java
text:
```scala
S@@tring[] headers = {"src/bullet/", "src/custom/"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4955.java