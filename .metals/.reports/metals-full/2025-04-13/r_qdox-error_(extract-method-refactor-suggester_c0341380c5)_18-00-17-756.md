error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2176.java
text:
```scala
L@@ZFStreamOutput lzf = new LZFStreamOutput(bytes, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2176.java