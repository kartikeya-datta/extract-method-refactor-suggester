error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1654.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1654.java
...
```java
offset: 660
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1654.java
text:
```scala
...
p@@ackage org.springframework.web.servlet.mvc.method.condition;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1654.java