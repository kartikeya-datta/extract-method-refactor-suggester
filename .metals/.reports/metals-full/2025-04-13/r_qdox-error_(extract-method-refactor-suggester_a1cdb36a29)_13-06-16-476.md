error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2036.java
text:
```scala
t@@his.pkgName = key;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2036.java