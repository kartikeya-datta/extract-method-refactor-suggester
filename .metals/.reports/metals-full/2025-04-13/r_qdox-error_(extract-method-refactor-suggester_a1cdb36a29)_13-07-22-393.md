error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/429.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/429.java
text:
```scala
+ ":" + C@@lasses.simpleName(component.getClass()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/429.java