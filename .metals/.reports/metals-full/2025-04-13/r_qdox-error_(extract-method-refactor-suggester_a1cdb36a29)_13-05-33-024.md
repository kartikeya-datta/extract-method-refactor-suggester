error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10892.java
text:
```scala
p@@rops.put(IDistributionConstants.SERVICE_EXPORTED_INTERFACES, getInterfaces());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10892.java