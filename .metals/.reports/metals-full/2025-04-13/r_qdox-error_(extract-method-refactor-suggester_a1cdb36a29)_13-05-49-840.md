error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7431.java
text:
```scala
O@@bject[] uids = srcFolder.getUids();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7431.java