error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/45.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/45.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/45.java
text:
```scala
a@@dd(new BookmarkablePageLink("customLoadingPageLink", PageWithCustomLoading.class));
...
public class Index extends WicketExamplePage
{
	...
	public Index()
	{
		...
		new BookmarkablePageLink(this, "customLoadingPageLink", PageWithCustomLoading.class);
	}
}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/45.java