error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9576.java
text:
```scala
t@@hrow new IOException("Error creating endpoint description: " //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9576.java