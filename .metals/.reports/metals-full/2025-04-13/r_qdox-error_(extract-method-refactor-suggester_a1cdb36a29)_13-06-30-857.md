error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9021.java
text:
```scala
d@@ataSourceServiceBuilder.addListener(new DataSourceStatisticsListener(overrideRegistration, resource, managementName, false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9021.java