error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6657.java
text:
```scala
s@@hard.idCache().onRemoval(readerCache.sizeInBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6657.java