error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6923.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6923.java
text:
```scala
I@@ContextHandle getContextHandle(String contextId)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6923.java