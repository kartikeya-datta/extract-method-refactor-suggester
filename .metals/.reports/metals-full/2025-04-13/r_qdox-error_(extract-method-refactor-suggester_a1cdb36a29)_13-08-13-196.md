error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13328.java
text:
```scala
F@@ont oldFont = cellFont [index];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13328.java