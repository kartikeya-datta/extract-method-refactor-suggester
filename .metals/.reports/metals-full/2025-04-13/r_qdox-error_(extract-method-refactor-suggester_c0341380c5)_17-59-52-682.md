error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5912.java
text:
```scala
b@@uilder.clustering().cacheMode(CacheMode.valueOf(cache.require(ModelKeys.MODE).asString()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5912.java