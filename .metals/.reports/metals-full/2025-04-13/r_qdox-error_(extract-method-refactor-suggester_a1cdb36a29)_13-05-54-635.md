error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6216.java
text:
```scala
f@@ElementTraverser.traverseLocal (fParticle[i], currElem, currSchema, currGrammar, fAllContext[i], fParent[i], fLocalElemNamespaceContext[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6216.java