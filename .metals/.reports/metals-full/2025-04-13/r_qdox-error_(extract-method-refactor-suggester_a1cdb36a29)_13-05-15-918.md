error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15204.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15204.java
text:
```scala
private transient C@@alculator calc = new Calculator();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15204.java