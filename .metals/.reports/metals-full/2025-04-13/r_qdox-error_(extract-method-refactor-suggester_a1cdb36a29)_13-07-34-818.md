error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/734.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/734.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/734.java
text:
```scala
D@@istributedRowMatrix out = new DistributedRowMatrix(outPath, outputTmpPath, numCols, other.numCols());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/734.java