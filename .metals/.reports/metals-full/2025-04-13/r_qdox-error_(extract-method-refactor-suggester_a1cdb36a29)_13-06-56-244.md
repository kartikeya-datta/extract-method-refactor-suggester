error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2042.java
text:
```scala
s@@ = s + "break "/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2042.java