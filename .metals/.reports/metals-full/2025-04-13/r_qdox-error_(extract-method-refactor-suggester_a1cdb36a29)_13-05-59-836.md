error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8454.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8454.java
text:
```scala
final S@@erviceBuilder<ManagedQueueExecutorService> serviceBuilder = target.addService(serviceName, service);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8454.java