error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2361.java
text:
```scala
n@@ew SecurityRealmChildRemoveHandler(true, false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2361.java