error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3989.java
text:
```scala
r@@eturn new DeletionAwareConstantScoreQuery(Queries.MATCH_ALL_FILTER, true);  // no need to cache a MATCH ALL FILTER
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3989.java