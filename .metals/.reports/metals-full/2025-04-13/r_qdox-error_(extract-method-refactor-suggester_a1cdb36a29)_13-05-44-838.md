error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4187.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4187.java
text:
```scala
F@@ontMetrics fm = getFontMetrics(font);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4187.java