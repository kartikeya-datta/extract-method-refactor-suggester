error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8743.java
text:
```scala
S@@tringBuilder errorMessage = new StringBuilder("{").append(Version.CURRENT).append("}: ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8743.java