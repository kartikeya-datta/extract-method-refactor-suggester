error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7383.java
text:
```scala
L@@ist<SearchContextFacets.Entry> entries = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7383.java