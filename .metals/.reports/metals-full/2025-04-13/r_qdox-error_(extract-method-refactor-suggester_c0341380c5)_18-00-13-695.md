error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4480.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4480.java
text:
```scala
private final F@@ile directory;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4480.java