error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5026.java
text:
```scala
t@@hrow new Error("not implemented"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5026.java