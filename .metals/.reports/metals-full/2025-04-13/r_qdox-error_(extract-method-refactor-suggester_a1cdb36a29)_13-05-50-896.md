error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/866.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/866.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/866.java
text:
```scala
a@@ssert 1 <= responseCount && responseCount <= DatabaseDescriptor.getReplicationFactor(table)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/866.java