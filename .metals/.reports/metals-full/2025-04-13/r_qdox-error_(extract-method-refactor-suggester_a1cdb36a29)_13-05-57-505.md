error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8634.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8634.java
text:
```scala
.@@getServletContext();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8634.java