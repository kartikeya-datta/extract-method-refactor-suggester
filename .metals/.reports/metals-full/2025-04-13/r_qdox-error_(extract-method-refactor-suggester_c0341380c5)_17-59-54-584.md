error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7976.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7976.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7976.java
text:
```scala
private static final c@@har[] JAVA_LANG_OBJECT = "java.lang.Object".toCharArray(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7976.java