error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2841.java
text:
```scala
S@@tring query = "{ \"query\" : { \"match_all\": {}} , \"script_fields\" : { \"test1\" : { \"script_id\" : \"script1\", \"lang\":\"groovy\" }, \"test2\" : { \"script_id\" : \"script2\", \"lang\":\"groovy\", \"params\":{\"factor\":3}  }}, size:1}";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2841.java