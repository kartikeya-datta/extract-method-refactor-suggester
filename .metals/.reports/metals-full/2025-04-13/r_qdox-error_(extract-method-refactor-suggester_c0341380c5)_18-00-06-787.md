error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11631.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11631.java
text:
```scala
t@@hrow new SpelEvaluationException(SpelMessage.OPERATOR_NOT_SUPPORTED_BETWEEN_TYPES, op, leftType, rightType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11631.java