error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10012.java
text:
```scala
i@@f (this.type != null) // case of enum constant
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10012.java