error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2521.java
text:
```scala
I@@ActivityBindingDefinition contextBindingDefinition = Persistence.readContextBindingDefinition(new ConfigurationElementMemento(configurationElement), getPluginId(configurationElement));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2521.java