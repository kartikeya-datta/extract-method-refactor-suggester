error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1940.java
text:
```scala
i@@f (rgdispid != null) auto.setProperty(rgdispid[0], variant);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1940.java