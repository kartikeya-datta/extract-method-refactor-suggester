error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5439.java
text:
```scala
r@@eturn MapBackedSet.mapBackedSet(new LinkedMap<E, Object>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5439.java