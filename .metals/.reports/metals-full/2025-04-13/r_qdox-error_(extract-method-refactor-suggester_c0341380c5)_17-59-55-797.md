error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3924.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3924.java
text:
```scala
n@@ew PropertyDescriptor("tailing", LogFilePatternReceiver.class),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3924.java