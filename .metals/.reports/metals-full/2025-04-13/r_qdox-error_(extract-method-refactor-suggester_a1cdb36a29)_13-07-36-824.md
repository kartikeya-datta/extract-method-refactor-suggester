error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9741.java
text:
```scala
c@@lient.admin().indices().putMapping(putMappingRequest("test").source(mapping())).actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9741.java