error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9077.java
...
```java
offset: 895
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9077.java
text:
```scala
 ...
 * under the License.
 */
p@@ackage org.elasticsearch.common.util;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9077.java