error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5004.java
text:
```scala
t@@hrow new EvalError("Empty switch statement.", this, callstack );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5004.java