error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5292.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5292.java
text:
```scala
private C@@olor red = new Color(1, 0, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5292.java