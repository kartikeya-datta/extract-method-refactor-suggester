error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8553.java
text:
```scala
g@@etPage().setAllowReRender(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8553.java