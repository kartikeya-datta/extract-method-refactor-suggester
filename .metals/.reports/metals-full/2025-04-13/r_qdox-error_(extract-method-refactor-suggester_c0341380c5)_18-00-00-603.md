error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17882.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17882.java
text:
```scala
r@@eturn "BookmarkablePageEncoder[page=" + bookmarkablePageClassRef.get() + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17882.java