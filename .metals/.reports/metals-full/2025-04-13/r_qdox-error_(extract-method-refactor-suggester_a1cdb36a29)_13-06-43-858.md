error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9034.java
text:
```scala
i@@nt newSize = Math.max(1,jEdit.getIntegerProperty("history",25));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9034.java