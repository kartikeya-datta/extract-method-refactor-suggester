error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12963.java
text:
```scala
C@@omponent current = getParent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12963.java