error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2938.java
text:
```scala
G@@dx.gl.glActiveTexture(GL20.GL_TEXTURE0 + offset + i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2938.java