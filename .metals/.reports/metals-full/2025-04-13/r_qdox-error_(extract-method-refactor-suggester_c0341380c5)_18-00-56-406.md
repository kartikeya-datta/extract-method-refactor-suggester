error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6789.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6789.java
text:
```scala
final N@@etworkInterfaceService networkInterfaceService = new NetworkInterfaceService("test", true, false, true, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6789.java