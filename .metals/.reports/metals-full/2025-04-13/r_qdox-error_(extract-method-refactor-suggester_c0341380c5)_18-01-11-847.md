error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7974.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7974.java
text:
```scala
final T@@imerTask timerTask1 = mittfb.getObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7974.java