error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2149.java
text:
```scala
r@@eturn "indexing " + resource.getName(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2149.java