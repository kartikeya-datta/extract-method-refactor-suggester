error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5191.java
text:
```scala
i@@mmutableCluster().wipeIndices("_all");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5191.java