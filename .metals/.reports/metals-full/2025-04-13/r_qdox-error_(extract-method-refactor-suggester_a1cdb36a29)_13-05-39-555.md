error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1707.java
text:
```scala
b@@yte[] key_user_id = "1".getBytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1707.java