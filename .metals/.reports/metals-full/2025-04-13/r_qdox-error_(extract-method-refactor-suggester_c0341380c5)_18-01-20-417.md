error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6110.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6110.java
text:
```scala
private P@@roject project;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6110.java