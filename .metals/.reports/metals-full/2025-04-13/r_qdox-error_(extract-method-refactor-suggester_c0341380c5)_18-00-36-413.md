error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9717.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9717.java
text:
```scala
S@@tring[] nodesIds = clusterState.nodes().resolveNodesIds(request.nodesIds());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9717.java