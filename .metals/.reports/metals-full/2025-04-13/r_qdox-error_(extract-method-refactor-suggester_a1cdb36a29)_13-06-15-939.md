error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3264.java
text:
```scala
E@@ndPointSnitch endPointSnitch = (EndPointSnitch) StorageService.instance.getEndPointSnitch();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3264.java