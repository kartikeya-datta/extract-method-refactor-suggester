error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14566.java
text:
```scala
d@@ouble[] y = y0.clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14566.java