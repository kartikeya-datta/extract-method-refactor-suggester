error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6328.java
text:
```scala
t@@his.expression.bits &= ~IsReturnedValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6328.java