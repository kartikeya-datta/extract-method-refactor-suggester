error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8532.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,40]

error in qdox parser
file content:
```java
offset: 40
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8532.java
text:
```scala
"<ajax-response><redirect><![CDATA[" + u@@rl + "]]></redirect></ajax-response>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8532.java