error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9642.java
text:
```scala
t@@hrow new UnknownHostException("network interface not found");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9642.java