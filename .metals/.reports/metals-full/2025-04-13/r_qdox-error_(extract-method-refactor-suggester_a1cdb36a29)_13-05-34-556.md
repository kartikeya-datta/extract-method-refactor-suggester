error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2127.java
text:
```scala
S@@ourceElementParser parser = ((InternalSearchDocument) this.document).parser;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2127.java