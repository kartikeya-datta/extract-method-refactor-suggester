error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17489.java
text:
```scala
r@@eturn new Class[][] { { String.class } };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17489.java