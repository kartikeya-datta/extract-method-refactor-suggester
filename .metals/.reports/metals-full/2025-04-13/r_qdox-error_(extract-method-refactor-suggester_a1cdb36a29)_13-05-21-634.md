error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13906.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13906.java
text:
```scala
public v@@oid applyUpdateBootAction(final BootUpdateContext updateContext) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13906.java