error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3362.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3362.java
text:
```scala
A@@ssert.assertEquals("hello", ejb.getRemoteViaWrappedHandle());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3362.java