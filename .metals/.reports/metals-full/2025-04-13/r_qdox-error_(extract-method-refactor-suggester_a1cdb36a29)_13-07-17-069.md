error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2498.java
text:
```scala
t@@arget.add(models);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2498.java