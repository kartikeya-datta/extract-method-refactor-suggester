error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3240.java
text:
```scala
B@@loomFilter bf = BloomFilter.getFilter(columnCount, 4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3240.java