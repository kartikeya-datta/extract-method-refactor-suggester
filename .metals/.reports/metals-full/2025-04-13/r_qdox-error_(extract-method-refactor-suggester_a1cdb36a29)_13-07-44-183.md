error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7803.java
text:
```scala
o@@riginalField.isStatic() ? originalField.type : Scope.substitute(parameterizedDeclaringClass, originalField.type),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7803.java