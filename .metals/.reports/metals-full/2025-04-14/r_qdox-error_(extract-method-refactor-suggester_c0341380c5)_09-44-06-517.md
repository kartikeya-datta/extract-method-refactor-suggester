error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3485.java
text:
```scala
L@@ogLog.error("Could not find setter method for RollingFileAppender.", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3485.java