error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8020.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,224]

error in qdox parser
file content:
```java
offset: 224
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8020.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8020.java