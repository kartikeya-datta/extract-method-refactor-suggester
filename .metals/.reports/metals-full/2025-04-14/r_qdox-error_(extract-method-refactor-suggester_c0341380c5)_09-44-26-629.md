error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3887.java
text:
```scala
a@@ssertThat(nodesMap.size(), equalTo(cluster().size()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3887.java