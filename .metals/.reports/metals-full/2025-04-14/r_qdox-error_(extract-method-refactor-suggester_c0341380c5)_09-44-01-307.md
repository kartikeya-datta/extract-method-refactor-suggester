error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3260.java
text:
```scala
s@@uper("temp-folder-name", "temp", path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3260.java