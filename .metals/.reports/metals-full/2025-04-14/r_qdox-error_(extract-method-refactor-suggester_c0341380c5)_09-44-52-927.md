error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5007.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5007.java
text:
```scala
final C@@mpEntityBeanComponentInstance instance = (CmpEntityBeanComponentInstance) context.getPrivateData(ComponentInstance.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5007.java