error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/284.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/284.java
text:
```scala
protected v@@oid dumpStack(String msg, Throwable t) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/284.java