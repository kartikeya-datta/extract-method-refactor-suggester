error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9234.java
text:
```scala
t@@his.javadocParser.checkDocComment = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9234.java