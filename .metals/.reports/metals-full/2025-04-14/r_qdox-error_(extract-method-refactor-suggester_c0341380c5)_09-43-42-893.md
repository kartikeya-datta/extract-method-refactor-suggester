error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/683.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/683.java
text:
```scala
e@@xpressionString(primary), index.getBaseCFStore().metadata.getKeyValidator().getString(startKey)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/683.java