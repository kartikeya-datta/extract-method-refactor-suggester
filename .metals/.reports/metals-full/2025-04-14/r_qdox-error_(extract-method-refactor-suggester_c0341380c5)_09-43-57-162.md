error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2809.java
text:
```scala
i@@f (!unsafeBuffers.contains(buffer, true))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2809.java