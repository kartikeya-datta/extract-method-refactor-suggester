error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12003.java
text:
```scala
i@@f (gdkEvent.mode != OS.GDK_CROSSING_NORMAL && gdkEvent.mode != OS.GDK_CROSSING_UNGRAB) return 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12003.java