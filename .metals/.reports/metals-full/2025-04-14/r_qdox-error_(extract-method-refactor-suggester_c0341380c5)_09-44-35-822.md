error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7826.java
text:
```scala
c@@har[] mainTypeName = fileName.substring(0, fileName.length()-5).toCharArray(); //TODO (jerome) should not hardcode extension length
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7826.java