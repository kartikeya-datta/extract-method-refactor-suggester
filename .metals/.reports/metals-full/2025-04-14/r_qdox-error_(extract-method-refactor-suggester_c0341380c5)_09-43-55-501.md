error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7540.java
text:
```scala
i@@f (!TextUtils.isEmpty(text))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7540.java