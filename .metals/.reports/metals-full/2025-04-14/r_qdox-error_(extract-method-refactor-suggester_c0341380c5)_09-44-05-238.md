error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4131.java
text:
```scala
s@@uper(Arrays.asList(url), iterations);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4131.java