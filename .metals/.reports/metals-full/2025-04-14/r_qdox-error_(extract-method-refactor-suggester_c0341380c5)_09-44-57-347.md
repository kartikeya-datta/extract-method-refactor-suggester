error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2803.java
text:
```scala
p@@ublic interface IAssignmentAwareModel<T> extends IModel<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2803.java