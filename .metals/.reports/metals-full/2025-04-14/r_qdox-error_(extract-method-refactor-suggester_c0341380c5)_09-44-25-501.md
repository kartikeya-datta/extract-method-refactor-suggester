error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1773.java
text:
```scala
c@@heckComponentTag(tag, "thead");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1773.java