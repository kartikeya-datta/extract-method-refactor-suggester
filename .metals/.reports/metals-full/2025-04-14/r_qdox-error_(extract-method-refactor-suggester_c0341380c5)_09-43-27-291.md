error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3420.java
text:
```scala
Q@@ueryUtils.check(random, query, s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3420.java