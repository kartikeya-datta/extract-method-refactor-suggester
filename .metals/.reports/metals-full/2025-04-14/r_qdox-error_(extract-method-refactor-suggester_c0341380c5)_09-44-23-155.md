error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3741.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[49,2]

error in qdox parser
file content:
```java
offset: 2001
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3741.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3741.java