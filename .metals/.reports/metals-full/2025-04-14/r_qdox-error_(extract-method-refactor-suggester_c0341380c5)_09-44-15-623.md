error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6796.java
text:
```scala
t@@hrow new WicketRuntimeException("Invalid boolean value \"" + value + "\"", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6796.java