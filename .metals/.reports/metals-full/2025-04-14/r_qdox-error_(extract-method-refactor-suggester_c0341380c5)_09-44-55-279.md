error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1322.java
text:
```scala
i@@f (DatabaseDescriptor.getColumnFamilyType(tablename, values[0]).equals("Standard"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1322.java