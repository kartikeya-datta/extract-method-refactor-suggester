error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9706.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9706.java
text:
```scala
public static final C@@onnectorRefsAttribute BRIDGE_CONNECTORS = new ConnectorRefsAttribute(CommonAttributes.STATIC_CONNECTORS, true, true, RESTART_ALL_SERVICES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9706.java