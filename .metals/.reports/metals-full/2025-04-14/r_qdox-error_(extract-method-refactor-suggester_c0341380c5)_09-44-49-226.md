error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8259.java
text:
```scala
i@@f (checkedType.isTypeVariable() || checkedType.isBoundParameterizedType() || checkedType.isGenericType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8259.java