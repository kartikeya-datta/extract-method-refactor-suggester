error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7688.java
text:
```scala
r@@eturn clusterService.operationRouting().searchShards(clusterState, request.indices(), request.queryHint(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7688.java