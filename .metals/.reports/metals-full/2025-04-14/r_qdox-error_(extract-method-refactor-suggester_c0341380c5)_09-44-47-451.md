error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4290.java
...
```java
offset: 867
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4290.java
text:
```scala
...
p@@ackage org.elasticsearch.index.store.fs;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4290.java