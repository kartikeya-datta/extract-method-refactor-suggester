error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6087.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6087.java
text:
```scala
public static final i@@nt MANAGEMENT_MINOR_VERSION = 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6087.java