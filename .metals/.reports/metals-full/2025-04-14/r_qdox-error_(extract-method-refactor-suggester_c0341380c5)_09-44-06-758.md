error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14958.java
text:
```scala
...
public final class SignInSession extends WebSession
{
	 ...
	 */
	protected SignInSession(final WebApplication application, Request request)
	{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14958.java