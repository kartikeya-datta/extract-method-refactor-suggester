error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6522.java
text:
```scala
t@@his.interval = componentSettings.getAsTime("interval", timeValueSeconds(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6522.java