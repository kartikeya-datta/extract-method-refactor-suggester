error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8204.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8204.java
text:
```scala
i@@f (!resource.hasChild(RootLoggerResourceDefinition.ROOT_LOGGER_PATH)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8204.java