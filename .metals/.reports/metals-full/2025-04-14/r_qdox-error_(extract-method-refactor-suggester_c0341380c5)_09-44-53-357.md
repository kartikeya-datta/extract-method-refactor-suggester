error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1149.java
text:
```scala
i@@f (actionServiceListeners == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1149.java