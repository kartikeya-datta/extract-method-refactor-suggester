error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9222.java
text:
```scala
p@@rops.putAll((Map<?, ?>) value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9222.java