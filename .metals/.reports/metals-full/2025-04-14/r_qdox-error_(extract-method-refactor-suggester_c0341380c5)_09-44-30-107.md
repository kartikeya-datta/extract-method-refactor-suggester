error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9564.java
text:
```scala
i@@f (resolvedExceptionType.isGenericType() || resolvedExceptionType.isBoundParameterizedType()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9564.java