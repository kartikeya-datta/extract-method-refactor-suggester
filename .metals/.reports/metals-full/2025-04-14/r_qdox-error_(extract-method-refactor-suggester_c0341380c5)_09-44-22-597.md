error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8507.java
text:
```scala
e@@qualFile2 = new File(currentDir, "src/site/xdoc");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8507.java