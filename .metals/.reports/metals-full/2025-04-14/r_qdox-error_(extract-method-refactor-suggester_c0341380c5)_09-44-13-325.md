error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1000.java
text:
```scala
S@@WT.error(SWT.ERROR_NO_HANDLES, null, " [Unsupported platform]"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1000.java