error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4922.java
text:
```scala
D@@isplay display = new Display ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4922.java