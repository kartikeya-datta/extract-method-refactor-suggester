error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3356.java
text:
```scala
i@@f (upperScope.environment().options.targetJDK < ClassFileConstants.JDK_DEFERRED) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3356.java