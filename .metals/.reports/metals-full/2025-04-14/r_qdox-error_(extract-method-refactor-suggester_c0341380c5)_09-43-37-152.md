error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9532.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9532.java
text:
```scala
transient T@@estElement savedValue = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9532.java