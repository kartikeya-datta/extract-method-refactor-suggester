error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6868.java
text:
```scala
D@@ocIdSet docIdSet = parentDocs.get(reader.getCoreCacheKey());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6868.java