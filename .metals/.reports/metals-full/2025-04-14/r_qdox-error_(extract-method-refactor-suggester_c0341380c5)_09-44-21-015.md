error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/883.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/883.java
text:
```scala
public static final T@@ransportRequestOptions EMPTY = options();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/883.java