error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9205.java
text:
```scala
s@@b.append("]");//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9205.java