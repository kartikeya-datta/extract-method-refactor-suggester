error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1135.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1135.java
text:
```scala
public static R@@andomScoreFunctionBuilder randomFunction(int seed) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1135.java