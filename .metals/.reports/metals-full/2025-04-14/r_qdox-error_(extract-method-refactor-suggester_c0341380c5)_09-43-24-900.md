error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2992.java
text:
```scala
r@@esponse.flush();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2992.java