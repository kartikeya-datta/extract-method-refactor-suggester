error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8173.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8173.java
text:
```scala
t@@hrow new IllegalArgumentException(Util.bind("codeAssist.nullRequestor")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8173.java