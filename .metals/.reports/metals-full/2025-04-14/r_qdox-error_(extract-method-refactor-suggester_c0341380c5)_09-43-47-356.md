error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10880.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10880.java
text:
```scala
t@@hrow new IllegalArgumentException("Value for maxPageVersions must be >= 0");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10880.java