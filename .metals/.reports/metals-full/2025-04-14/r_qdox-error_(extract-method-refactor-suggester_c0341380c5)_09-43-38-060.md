error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11562.java
text:
```scala
t@@his.propertyValueList = new ArrayList<PropertyValue>(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11562.java