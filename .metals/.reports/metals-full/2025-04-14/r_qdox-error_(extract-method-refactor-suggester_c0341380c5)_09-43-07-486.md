error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6710.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6710.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6710.java
text:
```scala
l@@inkGroup.setLayoutData (new GridData (SWT.FILL, SWT.FILL, true, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6710.java