error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6259.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6259.java
text:
```scala
private S@@tring comment = "/** */";//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6259.java