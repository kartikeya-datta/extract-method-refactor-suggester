error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1492.java
text:
```scala
i@@f (!method.isStatic()) previous = method; // no ambiguity for static methods
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1492.java