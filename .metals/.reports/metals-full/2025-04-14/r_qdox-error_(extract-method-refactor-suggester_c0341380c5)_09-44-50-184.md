error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/717.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/717.java
text:
```scala
final S@@erviceName binderServiceName = ContextNames.bindInfoFor(jndiName).getBinderServiceName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/717.java