error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5743.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5743.java
text:
```scala
protected v@@oid doHandle(CommandContext ctx) throws CommandFormatException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5743.java