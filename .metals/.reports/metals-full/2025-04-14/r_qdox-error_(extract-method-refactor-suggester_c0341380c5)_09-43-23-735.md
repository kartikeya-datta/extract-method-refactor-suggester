error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1.java
text:
```scala
r@@eturn track.isPlaying();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1.java