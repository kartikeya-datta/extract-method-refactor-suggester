error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5811.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5811.java
text:
```scala
public C@@ircularFifoQueue(final Collection<? extends E> coll) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5811.java