error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6456.java
text:
```scala
c@@onf.setMergePolicy(NoMergePolicy.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6456.java