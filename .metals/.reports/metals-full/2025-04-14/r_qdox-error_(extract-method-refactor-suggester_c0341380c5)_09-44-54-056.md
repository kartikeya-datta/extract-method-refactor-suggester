error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4117.java
text:
```scala
O@@bject info = fgJavaModelManager.peekAtInfo(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4117.java