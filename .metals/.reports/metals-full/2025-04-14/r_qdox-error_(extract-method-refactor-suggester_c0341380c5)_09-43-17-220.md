error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15824.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15824.java
text:
```scala
public b@@oolean isEnabled(Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15824.java