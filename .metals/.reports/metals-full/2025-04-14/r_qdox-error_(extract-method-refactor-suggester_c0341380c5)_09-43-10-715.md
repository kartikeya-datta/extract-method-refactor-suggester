error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14016.java
text:
```scala
s@@witch ((int)/*64*/scroll) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14016.java