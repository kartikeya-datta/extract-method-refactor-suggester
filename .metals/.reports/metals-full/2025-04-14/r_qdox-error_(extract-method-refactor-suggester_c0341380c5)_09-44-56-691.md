error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2180.java
text:
```scala
p@@arent.sizeImage = new Image(parent.getDisplay(), itemHeight, itemHeight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2180.java