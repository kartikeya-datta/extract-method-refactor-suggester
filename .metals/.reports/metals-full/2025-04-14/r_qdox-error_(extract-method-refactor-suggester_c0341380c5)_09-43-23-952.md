error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3757.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3757.java
text:
```scala
r@@eturn "gateway_snapshot {[" + index + "][" + shardId + "]}";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3757.java