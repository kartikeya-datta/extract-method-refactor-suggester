error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14301.java
text:
```scala
c@@mdRegistry.registerHandler(new GenericTypeOperationHandler(ctx, nodePath, propName), cmdName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14301.java