error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/138.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/138.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/138.java
text:
```scala
...
import com.badlogic.gdx.hiero.unicodefont.HieroSettings;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/138.java