error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7795.java
text:
```scala
A@@ssert.state(getSockJsConfig() != null, "This transport requires SockJsConfiguration");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7795.java