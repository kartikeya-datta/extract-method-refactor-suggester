error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4766.java
text:
```scala
t@@hrow new CommandLineException("if request failed: " + Util.getFailureDescription(response));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4766.java