error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6922.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6922.java
text:
```scala
public b@@oolean supportsExtension(String extension);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6922.java