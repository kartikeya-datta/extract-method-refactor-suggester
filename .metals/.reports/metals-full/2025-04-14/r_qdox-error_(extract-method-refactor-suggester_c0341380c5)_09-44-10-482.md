error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1271.java
text:
```scala
s@@tages.put(RESPONSE_STAGE, multiThreadedStage(RESPONSE_STAGE, Math.max(2, Runtime.getRuntime().availableProcessors())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1271.java