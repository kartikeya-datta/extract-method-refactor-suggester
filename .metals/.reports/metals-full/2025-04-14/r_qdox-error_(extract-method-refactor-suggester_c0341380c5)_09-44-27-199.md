error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15477.java
text:
```scala
i@@nt mnemonic = parseMnemonics (buffer, Math.max (tagStart, linkStart), length, result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15477.java