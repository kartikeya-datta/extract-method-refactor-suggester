error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4317.java
text:
```scala
G@@ridData data = new GridData(GridData.FILL, GridData.CENTER, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4317.java