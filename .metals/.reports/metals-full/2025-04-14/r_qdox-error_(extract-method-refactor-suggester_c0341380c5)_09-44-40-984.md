error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3128.java
text:
```scala
G@@dx.gl.glGetIntegerv(GL20.GL_MAX_TEXTURE_UNITS, buffer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3128.java