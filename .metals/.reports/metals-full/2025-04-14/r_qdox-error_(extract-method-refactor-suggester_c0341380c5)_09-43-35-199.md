error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9418.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9418.java
text:
```scala
i@@f(line.substring(i,i+3).equals("{{{")) /* }}} */
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9418.java