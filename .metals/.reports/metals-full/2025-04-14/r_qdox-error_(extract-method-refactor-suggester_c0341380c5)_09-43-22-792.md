error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9726.java
text:
```scala
s@@uper(CombineFunction.REPLACE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9726.java