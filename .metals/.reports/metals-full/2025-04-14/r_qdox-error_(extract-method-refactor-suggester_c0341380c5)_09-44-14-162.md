error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1678.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1678.java
text:
```scala
M@@ouse.setCursorPosition(x, y - 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1678.java