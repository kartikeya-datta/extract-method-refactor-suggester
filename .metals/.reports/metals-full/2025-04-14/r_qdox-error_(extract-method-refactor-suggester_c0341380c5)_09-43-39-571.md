error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1504.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1504.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1504.java
text:
```scala
s@@uggestUseCompoundFile = DEFAULT_SUGGEST_USE_COMPOUND_FILE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1504.java