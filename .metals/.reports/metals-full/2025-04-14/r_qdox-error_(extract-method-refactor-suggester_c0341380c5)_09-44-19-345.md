error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10047.java
text:
```scala
i@@nt bottom = parentBounds.height;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10047.java