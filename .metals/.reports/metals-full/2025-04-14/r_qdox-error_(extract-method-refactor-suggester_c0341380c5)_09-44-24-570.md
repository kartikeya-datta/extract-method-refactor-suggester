error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15097.java
text:
```scala
c@@omponent.getInvocationMetrics().finishInvocation(context.getMethod(), waitTime, executionTime);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15097.java