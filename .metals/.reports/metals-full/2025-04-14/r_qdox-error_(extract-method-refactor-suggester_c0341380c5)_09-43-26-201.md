error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10332.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10332.java
text:
```scala
s@@amples[offset + j] = (short)((buffer[i + 1] << 8) | (buffer[i] & 0xff));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10332.java