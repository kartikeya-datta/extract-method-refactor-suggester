error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8872.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8872.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8872.java
text:
```scala
S@@tring url = urlFor(javascript);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8872.java