error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11191.java
text:
```scala
l@@ogger.debug(message + ", " + session);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11191.java