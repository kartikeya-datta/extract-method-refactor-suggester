error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9847.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9847.java
text:
```scala
final S@@tring NEW_CODE_FORMATTER_ACTIVATION = PLUGIN_ID + ".newformatter.activation";	//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9847.java