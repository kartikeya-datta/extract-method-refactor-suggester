error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4095.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4095.java
text:
```scala
E@@xecutableScript script = scriptService.executable(request.scriptLang, request.script, request.scriptType, request.scriptParams);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4095.java