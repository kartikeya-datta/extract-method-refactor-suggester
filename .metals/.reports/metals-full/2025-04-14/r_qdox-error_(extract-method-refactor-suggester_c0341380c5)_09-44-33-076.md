error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16012.java
text:
```scala
i@@f (evt.character == SWT.CR) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16012.java