error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1568.java
text:
```scala
W@@eakReference<AjType<T>> weakRefToAjType = (WeakReference<AjType<T>>) ajTypes.get(fromClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1568.java