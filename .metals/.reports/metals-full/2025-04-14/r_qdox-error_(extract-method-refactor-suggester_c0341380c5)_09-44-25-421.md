error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14574.java
text:
```scala
i@@f ((style & SWT.VIRTUAL) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14574.java