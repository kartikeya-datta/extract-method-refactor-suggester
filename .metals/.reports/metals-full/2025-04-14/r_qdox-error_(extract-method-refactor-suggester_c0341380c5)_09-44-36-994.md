error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8564.java
text:
```scala
t@@itle.add(StringValidator.maximumLength(30));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8564.java