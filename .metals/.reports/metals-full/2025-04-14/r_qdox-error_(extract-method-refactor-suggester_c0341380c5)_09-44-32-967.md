error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9350.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9350.java
text:
```scala
f@@ield = getDeclaringType().getDeclaredField(getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9350.java