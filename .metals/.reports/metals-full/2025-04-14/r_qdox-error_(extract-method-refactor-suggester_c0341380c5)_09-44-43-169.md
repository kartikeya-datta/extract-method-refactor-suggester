error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7494.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7494.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7494.java
text:
```scala
i@@f (shell != display.activeShell) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7494.java