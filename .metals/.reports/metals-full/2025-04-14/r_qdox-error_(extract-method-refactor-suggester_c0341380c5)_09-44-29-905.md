error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7133.java
text:
```scala
t@@his.tagBits |= TagBits.MemberTypeMask;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7133.java