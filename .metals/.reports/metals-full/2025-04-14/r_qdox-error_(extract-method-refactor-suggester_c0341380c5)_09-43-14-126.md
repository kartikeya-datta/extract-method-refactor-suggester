error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14776.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14776.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14776.java
text:
```scala
a@@dd(new PageLink("navigateBackLink", referer));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14776.java