error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3375.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3375.java
text:
```scala
@Override public F@@acetCollector parse(String facetName, XContentParser parser, SearchContext context) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3375.java