error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3550.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3550.java
text:
```scala
public b@@oolean isActionAuthorized(Component component, Action action)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3550.java