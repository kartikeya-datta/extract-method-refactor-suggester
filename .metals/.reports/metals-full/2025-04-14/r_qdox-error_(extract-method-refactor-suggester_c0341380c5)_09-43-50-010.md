error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5036.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5036.java
text:
```scala
private final C@@alendarBasedTimeout calendarTimeout;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5036.java