error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12987.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12987.java
text:
```scala
private static final S@@tring FILEVERSION = "656027"; // Expected value $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12987.java