error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6136.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6136.java
text:
```scala
public v@@oid testDirsetPathWithoutPackagenames() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6136.java