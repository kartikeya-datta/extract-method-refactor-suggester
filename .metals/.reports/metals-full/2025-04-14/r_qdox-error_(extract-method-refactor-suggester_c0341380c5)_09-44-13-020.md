error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5359.java
text:
```scala
r@@eturn 0.0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5359.java