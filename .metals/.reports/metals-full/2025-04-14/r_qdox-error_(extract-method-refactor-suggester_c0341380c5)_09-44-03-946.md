error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2669.java
text:
```scala
t@@his.isConstructor = this.isConstructor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2669.java