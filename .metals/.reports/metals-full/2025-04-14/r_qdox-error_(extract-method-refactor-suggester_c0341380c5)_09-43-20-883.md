error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/686.java
text:
```scala
A@@ndroidGL, LWJGL, Angle, WebGL, iOSGL
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/686.java