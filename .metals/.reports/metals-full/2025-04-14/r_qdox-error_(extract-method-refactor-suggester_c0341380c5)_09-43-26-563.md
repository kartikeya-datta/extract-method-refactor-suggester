error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3932.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3932.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3932.java
text:
```scala
G@@dxTest test = new IssueTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3932.java