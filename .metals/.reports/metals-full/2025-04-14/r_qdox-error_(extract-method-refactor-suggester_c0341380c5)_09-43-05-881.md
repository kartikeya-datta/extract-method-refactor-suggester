error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2188.java
text:
```scala
T@@oolRunner.run(getConf(), job, args);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2188.java