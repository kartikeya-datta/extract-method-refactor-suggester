error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12526.java
text:
```scala
r@@eturn new GrahamScan();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12526.java