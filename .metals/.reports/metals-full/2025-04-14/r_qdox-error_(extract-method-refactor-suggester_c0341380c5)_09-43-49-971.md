error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/773.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/773.java
text:
```scala
final B@@aseDirectoryWrapper dir = newDirectory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/773.java