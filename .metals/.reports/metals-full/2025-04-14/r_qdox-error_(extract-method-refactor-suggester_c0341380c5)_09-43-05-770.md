error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7575.java
text:
```scala
t@@hrow MESSAGES.failToLoadComponentClass(e, component.getComponentName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7575.java