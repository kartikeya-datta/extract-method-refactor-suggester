error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10196.java
text:
```scala
p@@rogress.dismiss();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10196.java