error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8605.java
text:
```scala
z@@In = new CBZip2InputStream(bis, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8605.java