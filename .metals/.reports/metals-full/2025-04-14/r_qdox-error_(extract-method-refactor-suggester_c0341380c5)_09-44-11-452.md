error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7352.java
text:
```scala
A@@rrayList<DumpContributionFailedException> failedContributors = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7352.java