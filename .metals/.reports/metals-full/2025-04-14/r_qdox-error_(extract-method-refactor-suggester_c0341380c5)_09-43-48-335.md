error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4732.java
text:
```scala
R@@aServicesFactory.createDeploymentService(registration, connectorXmlDescriptor, module, serviceTarget, deploymentUnitName, deploymentUnit.getServiceName(), deploymentUnitName, raxml, deploymentResource, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4732.java