error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11408.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11408.java
text:
```scala
public F@@reeMarkerConfigurer mvcFreeMarkerConfigurer() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11408.java