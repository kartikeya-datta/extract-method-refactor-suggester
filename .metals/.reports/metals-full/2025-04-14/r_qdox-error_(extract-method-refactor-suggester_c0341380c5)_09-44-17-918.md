error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8117.java
text:
```scala
g@@c.checkGC(GC.LINE_CAP | GC.LINE_JOIN | GC.LINE_STYLE | GC.LINE_WIDTH | GC.LINE_MITERLIMIT | GC.TRANSFORM);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8117.java