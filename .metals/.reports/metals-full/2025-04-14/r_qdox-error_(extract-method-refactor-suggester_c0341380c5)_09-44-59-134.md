error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13241.java
text:
```scala
S@@tring uri = DeploymentManagerImpl.DEPLOYER_URI + "?targetType=as7&serverHost=" + managementClient.getMgmtAddress() + "&serverPort=" + managementClient.getMgmtPort();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13241.java