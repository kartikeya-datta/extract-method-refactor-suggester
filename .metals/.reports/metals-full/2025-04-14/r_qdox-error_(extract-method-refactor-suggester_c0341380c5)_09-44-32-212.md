error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7174.java
text:
```scala
v@@iewer.setComparator(DataTransferWizardCollectionSorter.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7174.java