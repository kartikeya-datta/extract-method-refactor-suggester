error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7563.java
text:
```scala
T@@ create();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7563.java