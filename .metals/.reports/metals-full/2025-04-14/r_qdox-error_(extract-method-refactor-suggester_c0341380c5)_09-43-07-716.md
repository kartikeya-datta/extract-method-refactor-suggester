error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1109.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1109.java
text:
```scala
s@@izeItem = new SystemMenuSize((PartPane) getSelection());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1109.java