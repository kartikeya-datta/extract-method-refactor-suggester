error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/600.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/600.java
text:
```scala
@Override protected S@@hardReplicationPingResponse shardOperationOnPrimary(ClusterState clusterState, ShardOperationRequest shardRequest) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/600.java