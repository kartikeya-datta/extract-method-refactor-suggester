error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1114.java
text:
```scala
F@@ield field = newTextField("field", "testData", Field.Store.YES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1114.java