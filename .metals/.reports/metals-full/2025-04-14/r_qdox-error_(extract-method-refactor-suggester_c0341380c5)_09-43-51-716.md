error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9063.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9063.java
text:
```scala
public abstract M@@ap<String, ITagElement>  getTags();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9063.java