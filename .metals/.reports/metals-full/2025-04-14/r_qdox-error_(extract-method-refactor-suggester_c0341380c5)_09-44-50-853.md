error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2394.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2394.java
text:
```scala
r@@eturn new BookmarkablePageLink(id, getApplication().getHomePage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2394.java