error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12027.java
text:
```scala
R@@esource root = forRollback ? context.getOriginalRootResource() : context.getRootResource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12027.java