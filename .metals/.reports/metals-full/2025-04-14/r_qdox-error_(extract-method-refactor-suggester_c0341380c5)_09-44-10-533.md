error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3948.java
text:
```scala
i@@nt pen = data.pen;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3948.java