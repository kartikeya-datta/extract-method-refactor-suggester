error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7528.java
text:
```scala
f@@ilter = smartNameFieldMappers.mapper().rangeFilter(from, to, includeLower, includeUpper, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7528.java