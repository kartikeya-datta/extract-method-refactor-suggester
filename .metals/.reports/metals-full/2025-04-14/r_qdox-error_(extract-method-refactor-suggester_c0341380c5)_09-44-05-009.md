error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/772.java
text:
```scala
t@@his.pkgName = key; // decode into the pkg name, see matchesDecodedKey()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/772.java