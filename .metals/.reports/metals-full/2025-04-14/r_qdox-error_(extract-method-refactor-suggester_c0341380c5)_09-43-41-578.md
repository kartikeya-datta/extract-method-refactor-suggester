error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1047.java
text:
```scala
r@@esourceRegistration.registerReadOnlyAttribute(attr.definition, ReadStatisticHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1047.java