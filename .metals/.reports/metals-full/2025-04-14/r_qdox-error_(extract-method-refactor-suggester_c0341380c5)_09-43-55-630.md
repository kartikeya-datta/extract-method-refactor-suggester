error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17221.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17221.java
text:
```scala
public v@@oid testCreateServiceTypeIDWithProviderSpecificString() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17221.java