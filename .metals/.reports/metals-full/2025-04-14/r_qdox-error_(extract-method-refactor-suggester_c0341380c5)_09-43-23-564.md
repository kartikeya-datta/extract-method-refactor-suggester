error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10426.java
text:
```scala
t@@his.body = (body == null)?"":body;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10426.java