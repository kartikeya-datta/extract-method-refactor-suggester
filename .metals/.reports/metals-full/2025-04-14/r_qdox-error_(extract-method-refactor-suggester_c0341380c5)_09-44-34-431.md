error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2578.java
text:
```scala
b@@oolean hasMask = image.mask != 0 && OS.gdk_drawable_get_depth (image.mask) == 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2578.java