error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7605.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7605.java
text:
```scala
abstract a@@spect AA { declare precedence: AA, AA+; // CE, AA is matched by both pieces
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7605.java