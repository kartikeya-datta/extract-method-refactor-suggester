error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6683.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6683.java
text:
```scala
public S@@ervletWebRequest cloneWithUrl(Url url)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6683.java