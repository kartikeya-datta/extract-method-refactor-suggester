error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11201.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11201.java
text:
```scala
s@@etDefaultModel(new CompoundPropertyModel(this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11201.java