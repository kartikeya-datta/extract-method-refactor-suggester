error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10778.java
text:
```scala
v@@iew.selectTab(icms, itms, roster.getUser().getID(), entry.getUser().getID(), entry.getUser().getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10778.java