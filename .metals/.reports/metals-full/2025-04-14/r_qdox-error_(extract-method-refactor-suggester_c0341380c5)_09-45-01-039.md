error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1593.java
text:
```scala
r@@eturn 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1593.java