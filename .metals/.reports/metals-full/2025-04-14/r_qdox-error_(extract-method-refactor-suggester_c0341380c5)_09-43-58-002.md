error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/864.java
text:
```scala
i@@f( key.equalsIgnoreCase(EJB_ARGS_KEY) == true )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/864.java