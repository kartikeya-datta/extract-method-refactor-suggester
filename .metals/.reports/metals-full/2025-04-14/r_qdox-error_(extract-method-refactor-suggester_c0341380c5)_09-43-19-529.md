error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7653.java
text:
```scala
p@@rovider.refreshAll();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7653.java