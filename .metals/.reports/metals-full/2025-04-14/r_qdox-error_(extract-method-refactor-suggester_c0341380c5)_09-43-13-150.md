error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15330.java
text:
```scala
P@@ackageResource.bind(application, PackageResourceTest.class, Pattern.compile(".*\\.js"), false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15330.java