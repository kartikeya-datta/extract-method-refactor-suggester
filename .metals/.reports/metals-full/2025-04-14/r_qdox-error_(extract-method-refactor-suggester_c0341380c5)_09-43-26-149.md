error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6671.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6671.java
text:
```scala
r@@eturn new SourceElementParser(this, new DefaultProblemFactory(), new CompilerOptions(settings), false/*don't report local declarations*/, true/*optimize string literals*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6671.java