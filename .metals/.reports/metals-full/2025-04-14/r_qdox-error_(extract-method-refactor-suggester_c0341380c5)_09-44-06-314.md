error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/522.java
text:
```scala
L@@ogManager.getLoggerRepository().clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/522.java