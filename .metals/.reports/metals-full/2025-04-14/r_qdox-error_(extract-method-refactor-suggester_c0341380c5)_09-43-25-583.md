error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/530.java
text:
```scala
n@@ew ResolvedMemberImpl(Member.FIELD, declaringType,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/530.java