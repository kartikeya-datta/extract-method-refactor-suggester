error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10425.java
text:
```scala
c@@ontrol.fillBackground (view, context, rect, imgHeight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10425.java