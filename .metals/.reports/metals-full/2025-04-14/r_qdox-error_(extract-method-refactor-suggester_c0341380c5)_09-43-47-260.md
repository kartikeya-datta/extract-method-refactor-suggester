error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7661.java
text:
```scala
w@@ar.setWebXML(SimpleWebTestCase.class.getPackage(), "web.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7661.java