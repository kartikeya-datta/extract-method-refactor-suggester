error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4470.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4470.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4470.java
text:
```scala
P@@ageMap map = getSession().createAutoPageMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4470.java