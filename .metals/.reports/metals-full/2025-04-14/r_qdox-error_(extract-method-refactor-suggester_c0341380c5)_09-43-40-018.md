error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/314.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/314.java
text:
```scala
public S@@tring signIn(final RequestCycle cycle,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/314.java