error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3172.java
text:
```scala
a@@dd(new ListView("books", getLibrarySession().getUser(), "books")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3172.java