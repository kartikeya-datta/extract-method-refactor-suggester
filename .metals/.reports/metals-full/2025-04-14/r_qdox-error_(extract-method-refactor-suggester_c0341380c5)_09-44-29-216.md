error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18006.java
text:
```scala
i@@f (parent.ignoreRedraw || !isDrawing()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18006.java