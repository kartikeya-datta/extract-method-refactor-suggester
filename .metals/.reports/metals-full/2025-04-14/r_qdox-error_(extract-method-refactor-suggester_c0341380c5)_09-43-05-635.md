error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5669.java
text:
```scala
P@@arameterizedTypeBinding  superType = createParameterizedType(rootEnumType, new TypeBinding[]{ environment().convertToRawType(sourceType) } , null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5669.java