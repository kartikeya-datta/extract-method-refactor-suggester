error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15093.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15093.java
text:
```scala
public S@@treamingServerSockJsSession createSession(String sessionId, HandlerProvider<WebSocketHandler<?>> handler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15093.java