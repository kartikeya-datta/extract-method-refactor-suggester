error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8416.java
text:
```scala
r@@eturn new AS7DataSourceDeployer(dataSourceConfig.getValue().getUnModifiableInstance(), dataSourceConfig.getValue().getProfile());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8416.java