error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10167.java
text:
```scala
s@@tore = new WritableServiceBasedNamingStore(context.getController().getServiceContainer(), context.getController().getName(),context.getChildTarget());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10167.java