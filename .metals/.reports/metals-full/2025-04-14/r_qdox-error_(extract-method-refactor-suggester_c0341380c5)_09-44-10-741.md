error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5642.java
text:
```scala
r@@eturn ByteArrayAtomicFieldData.EMPTY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5642.java