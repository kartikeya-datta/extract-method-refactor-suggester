error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8664.java
text:
```scala
l@@istItem.add(new Label("id", Integer.toString(value.getId())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8664.java