error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13948.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13948.java
text:
```scala
I@@Message.Kind kind = IMessage.ERROR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13948.java