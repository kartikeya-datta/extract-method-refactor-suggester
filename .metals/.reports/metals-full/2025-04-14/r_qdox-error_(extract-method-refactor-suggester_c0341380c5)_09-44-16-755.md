error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12646.java
text:
```scala
s@@tate.cleanupBefore(txid);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12646.java