error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3852.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3852.java
text:
```scala
public static S@@tring JNDI_NAME = "java:/DatabaseRealmMapping";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3852.java