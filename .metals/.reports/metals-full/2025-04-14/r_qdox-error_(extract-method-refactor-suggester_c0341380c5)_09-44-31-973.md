error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10137.java
text:
```scala
e@@xpression = expression.substring(2, expression.length() -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10137.java