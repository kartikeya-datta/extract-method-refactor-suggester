error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1139.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1139.java
text:
```scala
public static final V@@ersion V_0_21_0_Beta1 = new Version(V_0_21_0_Beta1_ID, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1139.java