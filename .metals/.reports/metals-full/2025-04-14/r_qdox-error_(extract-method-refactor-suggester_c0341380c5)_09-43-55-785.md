error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4320.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4320.java
text:
```scala
static public R@@andom random = new RandomXS128();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4320.java