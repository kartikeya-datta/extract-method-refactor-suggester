error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3301.java
text:
```scala
c@@har[] argumentSource = CharOperation.NO_CHAR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3301.java