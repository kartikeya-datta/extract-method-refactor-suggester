error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10527.java
text:
```scala
i@@f ((OS.IsWin95 && i.depth == 1 && i.getTransparencyType() != SWT.TRANSPARENCY_MASK) || i.depth == 2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10527.java