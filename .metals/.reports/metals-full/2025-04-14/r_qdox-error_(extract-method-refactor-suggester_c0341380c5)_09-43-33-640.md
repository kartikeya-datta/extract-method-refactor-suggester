error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7068.java
text:
```scala
t@@hrow new SelectionNodeFound(this, binding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7068.java