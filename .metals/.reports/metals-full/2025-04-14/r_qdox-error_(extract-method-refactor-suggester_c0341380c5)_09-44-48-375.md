error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/376.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/376.java
text:
```scala
protected v@@oid update(final int position, final GistView view, final Gist gist) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/376.java