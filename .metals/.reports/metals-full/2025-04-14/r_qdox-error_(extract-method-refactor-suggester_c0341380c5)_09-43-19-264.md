error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12004.java
text:
```scala
i@@f (xEvent.mode != OS.NotifyNormal && xEvent.mode != OS.NotifyUngrab) return 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12004.java