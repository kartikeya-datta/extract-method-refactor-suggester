error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/772.java
text:
```scala
S@@tring selectedProtocol, Endpoint endpoint) throws Exception;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/772.java