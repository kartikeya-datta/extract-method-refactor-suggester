error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/600.java
text:
```scala
c@@reateEntityManagerFactory("testStrategy", System.getProperties());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/600.java