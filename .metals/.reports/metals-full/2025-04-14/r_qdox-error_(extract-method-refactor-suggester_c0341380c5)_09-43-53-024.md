error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15822.java
text:
```scala
s@@uper(id, markupId, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15822.java