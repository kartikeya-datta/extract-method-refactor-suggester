error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/24.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/24.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/24.java
text:
```scala
C@@ollection<WorkerSlot> availableSlots(Collection<SupervisorDetails> existingSupervisors, Collection<WorkerSlot> usedSlots, TopologyDetails topology);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/24.java