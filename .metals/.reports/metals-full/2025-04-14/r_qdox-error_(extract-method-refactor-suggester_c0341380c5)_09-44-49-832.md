error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2715.java
text:
```scala
a@@ssertTrue(mex.getMessage().contains("Expected close tag for "));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2715.java