error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2907.java
text:
```scala
t@@his.unit = new CompilationUnitDeclaration(this.problemReporter, compilationResult, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2907.java