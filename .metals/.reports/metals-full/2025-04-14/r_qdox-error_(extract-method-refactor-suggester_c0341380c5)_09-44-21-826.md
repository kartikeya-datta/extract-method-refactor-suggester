error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7315.java
text:
```scala
W@@orkbenchHelp.setHelp(shell, IWorkbenchHelpContextIds.DETACHED_WINDOW);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7315.java