error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7008.java
text:
```scala
g@@enerateCodeForArguments(mv, cf, method, this.children);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7008.java