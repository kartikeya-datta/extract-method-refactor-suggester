error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12400.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12400.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12400.java
text:
```scala
I@@PropertyReflectionAwareModel<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12400.java