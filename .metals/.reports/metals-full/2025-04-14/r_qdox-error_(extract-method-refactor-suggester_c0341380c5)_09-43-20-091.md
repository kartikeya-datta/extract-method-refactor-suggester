error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3814.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3814.java
text:
```scala
protected R@@eferenceCollection(char[][][] qualifiedReferences, char[][] simpleNameReferences) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3814.java