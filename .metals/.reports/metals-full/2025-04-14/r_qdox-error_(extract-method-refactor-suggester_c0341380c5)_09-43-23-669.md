error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5461.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5461.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5461.java
text:
```scala
s@@cope.problemReporter().duplicateCase((Case) statements[i], cst); //TODO: (philippe) could improve diagnosis to indicate colliding case
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5461.java