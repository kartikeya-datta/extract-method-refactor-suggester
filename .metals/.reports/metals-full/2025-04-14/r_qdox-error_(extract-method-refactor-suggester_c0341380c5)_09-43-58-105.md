error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1762.java
text:
```scala
c@@olumns = thriftClient_.get_slice(tableName, key, columnFamily, true, 0, 1000000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1762.java