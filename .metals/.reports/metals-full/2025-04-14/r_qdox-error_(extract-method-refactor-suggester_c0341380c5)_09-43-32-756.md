error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2638.java
text:
```scala
S@@treamReply reply = StreamReply.serializer.deserialize(new DataInputStream(bufIn), message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2638.java