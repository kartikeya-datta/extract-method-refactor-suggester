error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11020.java
text:
```scala
t@@hrow new NullPointerException("id cannot be null"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11020.java