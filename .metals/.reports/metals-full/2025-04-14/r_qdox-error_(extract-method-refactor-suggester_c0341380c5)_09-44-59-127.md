error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/119.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/119.java
text:
```scala
public S@@tring canvasId;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/119.java