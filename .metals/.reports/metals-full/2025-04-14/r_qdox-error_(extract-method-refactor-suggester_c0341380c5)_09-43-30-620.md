error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10540.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10540.java
text:
```scala
static final S@@tring STATISTICS_ENABLED = "statistics-enabled";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10540.java