error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9580.java
text:
```scala
s@@uper(TYPE_REF_PATTERN, matchMode, isCaseSensitive);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9580.java