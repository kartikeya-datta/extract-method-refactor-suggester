error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9979.java
text:
```scala
E@@xternalMusicTest.class, SoftKeyboardTest.class, DirtyRenderingTest.class, YDownTest.class, PathTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9979.java