error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6270.java
text:
```scala
r@@eturn SwitchingFunction.RESET_STATE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6270.java