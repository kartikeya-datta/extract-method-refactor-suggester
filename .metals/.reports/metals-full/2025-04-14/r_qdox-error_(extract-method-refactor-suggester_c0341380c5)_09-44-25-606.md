error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10383.java
text:
```scala
r@@eturn getBeanDefinition((ConfigurableListableBeanFactory)parent, name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10383.java