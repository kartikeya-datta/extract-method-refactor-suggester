error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3360.java
text:
```scala
S@@tepInterpolatorTestUtils.checkDerivativesConsistency(integ, pb, 1.1e-10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3360.java