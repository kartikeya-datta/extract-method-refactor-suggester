error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8794.java
text:
```scala
i@@f (m.getSourceLocation() != null && m.getSourceLocation().getLine() == line) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8794.java