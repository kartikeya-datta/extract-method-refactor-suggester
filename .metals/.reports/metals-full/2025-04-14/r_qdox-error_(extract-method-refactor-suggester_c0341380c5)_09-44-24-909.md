error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1836.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1836.java
text:
```scala
public static final S@@tring NAME = "indices:admin/optimize";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1836.java