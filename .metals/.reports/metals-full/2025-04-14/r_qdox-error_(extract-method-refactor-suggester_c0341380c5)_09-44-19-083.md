error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8728.java
text:
```scala
t@@his.jettyServer.setStopTimeout(5000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8728.java