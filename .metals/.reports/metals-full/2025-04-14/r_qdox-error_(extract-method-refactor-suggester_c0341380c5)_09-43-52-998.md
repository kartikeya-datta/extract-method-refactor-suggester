error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10003.java
text:
```scala
I@@mportReference reference = this.createAssistImportReference(subset, positions, AccDefault/*TODO (olivier) update for static imports*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10003.java