error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8310.java
text:
```scala
i@@nt width = (int)Math.ceil (size.width);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8310.java