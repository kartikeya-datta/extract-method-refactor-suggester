error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10060.java
text:
```scala
i@@f (StringUtils.isEmpty(str)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10060.java