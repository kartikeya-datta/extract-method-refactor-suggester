error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5260.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5260.java
text:
```scala
M@@yTree tree = new MyTree("tree", treeModel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5260.java