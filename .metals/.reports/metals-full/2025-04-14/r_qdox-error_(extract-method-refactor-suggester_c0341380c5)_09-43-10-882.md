error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/124.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/124.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/124.java
text:
```scala
i@@nt charSetStartPos = contentType.toLowerCase(java.util.Locale.ENGLISH).indexOf(CHARSET_EQ);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/124.java