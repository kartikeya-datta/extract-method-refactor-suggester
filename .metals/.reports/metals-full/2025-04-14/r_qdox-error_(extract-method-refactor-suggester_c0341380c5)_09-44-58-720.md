error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13672.java
text:
```scala
n@@ode = e.nextNode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13672.java