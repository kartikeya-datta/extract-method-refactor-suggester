error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9749.java
text:
```scala
m@@enu.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9749.java