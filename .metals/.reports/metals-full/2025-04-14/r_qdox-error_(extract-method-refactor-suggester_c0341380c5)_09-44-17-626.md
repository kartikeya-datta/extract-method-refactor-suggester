error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14130.java
text:
```scala
T@@estElement controller = GuiPackage.getInstance().createTestElement(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14130.java