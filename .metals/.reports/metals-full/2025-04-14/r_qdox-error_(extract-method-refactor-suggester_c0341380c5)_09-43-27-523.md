error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8935.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8935.java
text:
```scala
public I@@D createInstance(Object[] args) throws IDCreateException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8935.java