error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1096.java
...
```java
offset: 888
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1096.java
text:
```scala
 ...
 */
p@@ackage storm.kafka.bolt.mapper;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1096.java