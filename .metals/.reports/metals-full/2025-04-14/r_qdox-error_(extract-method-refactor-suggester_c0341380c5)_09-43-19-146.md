error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11035.java
text:
```scala
d@@os.write(Keytab.VERSION_52);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11035.java