error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6886.java
text:
```scala
M@@ARSHALLER_FACTORY = Marshalling.getMarshallerFactory("river", ModuleClassLoader.forModuleName("org.jboss.marshalling.jboss-marshalling-river"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6886.java