error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5250.java
text:
```scala
i@@f (!fadeScrollBars && scrollbarsOnTop && scrollX) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5250.java