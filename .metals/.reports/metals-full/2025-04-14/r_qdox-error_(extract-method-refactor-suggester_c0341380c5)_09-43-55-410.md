error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6397.java
text:
```scala
s@@uper(OperationContext.Type.SERVER, configurationPersister, processState, DESC_PROVIDER, null, ExpressionResolver.DEFAULT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6397.java