error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/110.java
text:
```scala
M@@ap<String, Deque<String>> props = QueryParameterUtils.parseQueryString(part.substring(index + 1), UTF_8);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/110.java