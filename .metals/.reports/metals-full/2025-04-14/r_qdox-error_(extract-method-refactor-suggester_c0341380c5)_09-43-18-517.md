error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2150.java
...
```java
offset: 882
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2150.java
text:
```scala
 ...
 */
p@@ackage org.apache.commons.math.stat;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2150.java