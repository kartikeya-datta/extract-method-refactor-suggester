error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6683.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6683.java
text:
```scala
public static final i@@nt DEFAULT_CONDITIONAL_EXPRESSION_ALIGNMENT = Alignment.M_ONE_PER_LINE_SPLIT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6683.java