error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2981.java
text:
```scala
I@@ndexSearcher searcher = new IndexSearcher(storeDirectory, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2981.java