error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/946.java
text:
```scala
s@@ubs[i] = atomicFD[i].getBytesValues().getTermsEnum();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/946.java