error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12474.java
text:
```scala
n@@ew TextField<String>(this, "input", new Model<String>("test äöüßéèê"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12474.java