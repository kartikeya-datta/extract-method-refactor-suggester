error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4121.java
text:
```scala
e@@nclosingType = (ReferenceBinding) scope.environment().convertToRawType(enclosingType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4121.java