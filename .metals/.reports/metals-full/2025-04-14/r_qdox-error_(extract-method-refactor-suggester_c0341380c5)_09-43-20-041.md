error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6721.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6721.java
text:
```scala
public b@@oolean tap (float x, float y, int count, int pointer, int button) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6721.java