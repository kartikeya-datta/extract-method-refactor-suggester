error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12757.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12757.java
text:
```scala
final S@@erviceController<?> service = updateContext.getServiceContainer().getService(ThreadsServices.threadFactoryName(name));
...
public final class ThreadFactoryGroupNameUpdate extends AbstractThreadsSubsystemUpdate<Void> {
    ...
    protected <P> void applyUpdate(final UpdateContext updateContext, final UpdateResultHandler<? super Void, P> handler, final P param) {
        final ServiceController<?> service = updateContext.getServiceContainer().getService(Services.threadFactoryName(name));
        if (service == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12757.java