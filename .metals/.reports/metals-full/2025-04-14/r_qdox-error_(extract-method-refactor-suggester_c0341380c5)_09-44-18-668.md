error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9643.java
text:
```scala
i@@nt bits = super.widgetStyle () | OS.LVS_SHAREIMAGELISTS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9643.java