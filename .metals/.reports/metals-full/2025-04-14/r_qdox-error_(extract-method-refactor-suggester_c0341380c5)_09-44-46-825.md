error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3158.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3158.java
text:
```scala
final S@@tring deploymentRootName = file.getName().toLowerCase();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3158.java