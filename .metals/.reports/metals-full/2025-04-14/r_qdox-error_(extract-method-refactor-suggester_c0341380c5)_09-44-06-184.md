error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/787.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/787.java
text:
```scala
I@@ClassFile classFile= ((IPackageFragment)fClassFile.getParent()).getClassFile(new String(ClassFile.unqualifiedName(binaryType.getName())) + ".class"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/787.java