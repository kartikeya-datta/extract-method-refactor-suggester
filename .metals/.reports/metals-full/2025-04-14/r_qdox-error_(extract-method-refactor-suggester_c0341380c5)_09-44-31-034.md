error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/847.java
text:
```scala
B@@inaryMessage message = new BinaryMessage(payload, offset, len, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/847.java