error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4754.java
text:
```scala
C@@odeSnippetEvaluator(char[] codeSnippet, EvaluationContext context, INameEnvironment environment, Map options, IRequestor requestor, IProblemFactory problemFactory) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4754.java