error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8471.java
text:
```scala
D@@EPLOYMENT_CONNECTOR_LOGGER.debugf("DEPLOYMENT name = %s",deploymentName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8471.java