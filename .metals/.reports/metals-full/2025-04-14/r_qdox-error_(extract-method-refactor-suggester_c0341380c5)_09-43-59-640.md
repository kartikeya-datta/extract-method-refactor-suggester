error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15128.java
text:
```scala
M@@oduleLoader loader = Module.getCallerModuleLoader();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15128.java