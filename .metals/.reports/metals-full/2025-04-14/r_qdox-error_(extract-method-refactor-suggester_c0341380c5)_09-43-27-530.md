error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14627.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14627.java
text:
```scala
final M@@arkupElement element = markupStream.next();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14627.java