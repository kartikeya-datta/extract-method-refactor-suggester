error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12454.java
text:
```scala
p@@ublic class WLSManagedRuntime extends AbstractManagedRuntime
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12454.java