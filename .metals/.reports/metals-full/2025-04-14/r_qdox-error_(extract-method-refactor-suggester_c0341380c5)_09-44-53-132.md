error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/743.java
text:
```scala
b@@uf.append("<i><font color='#333333'>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/743.java