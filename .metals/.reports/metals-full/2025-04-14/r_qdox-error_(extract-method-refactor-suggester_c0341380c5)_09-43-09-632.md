error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8669.java
text:
```scala
p@@ublic final class TreeState extends VariableHeightLayoutCache
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8669.java