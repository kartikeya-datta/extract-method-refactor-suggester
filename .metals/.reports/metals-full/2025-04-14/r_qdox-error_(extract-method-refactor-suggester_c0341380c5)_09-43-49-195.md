error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6373.java
text:
```scala
p@@age.redirectTo(page);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6373.java