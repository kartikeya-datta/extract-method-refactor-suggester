error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18195.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[69,2]

error in qdox parser
file content:
```java
offset: 1679
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18195.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18195.java