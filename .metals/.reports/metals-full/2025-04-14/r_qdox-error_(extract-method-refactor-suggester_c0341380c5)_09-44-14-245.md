error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2720.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2720.java
text:
```scala
public static final T@@imeValue TCP_DEFAULT_CONNECT_TIMEOUT = new TimeValue(30, TimeUnit.SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2720.java