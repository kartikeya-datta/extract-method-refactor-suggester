error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15003.java
text:
```scala
D@@eploymentScannerExtension.getResourceDescriptionResolver("deployment.scanner.subsystem"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15003.java