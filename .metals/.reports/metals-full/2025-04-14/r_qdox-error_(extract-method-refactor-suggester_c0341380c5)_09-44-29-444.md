error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2785.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2785.java
text:
```scala
public Q@@ueryStringJsonQueryBuilder defaultOperator(Operator defaultOperator) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2785.java