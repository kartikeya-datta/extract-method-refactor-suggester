error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6034.java
text:
```scala
i@@f (display.thread != Thread.currentThread ()) error (SWT.ERROR_THREAD_INVALID_ACCESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6034.java