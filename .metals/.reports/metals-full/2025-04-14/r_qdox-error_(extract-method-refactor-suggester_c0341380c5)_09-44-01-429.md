error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5483.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5483.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5483.java
text:
```scala
public static final A@@ttachmentKey<ModuleConfig> ATTACHMENT_KEY = new AttachmentKey<ModuleConfig>(ModuleConfig.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5483.java