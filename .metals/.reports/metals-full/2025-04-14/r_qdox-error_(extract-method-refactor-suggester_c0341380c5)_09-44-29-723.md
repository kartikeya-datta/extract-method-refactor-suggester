error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/960.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/960.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/960.java
text:
```scala
l@@og.debugf("cache %s removed for container %s", cacheName, containerName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/960.java