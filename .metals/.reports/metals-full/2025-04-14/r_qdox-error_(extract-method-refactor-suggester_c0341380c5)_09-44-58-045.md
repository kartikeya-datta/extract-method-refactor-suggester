error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6242.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6242.java
text:
```scala
r@@eturn cache(type.fieldDataClass(), reader, fieldName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6242.java