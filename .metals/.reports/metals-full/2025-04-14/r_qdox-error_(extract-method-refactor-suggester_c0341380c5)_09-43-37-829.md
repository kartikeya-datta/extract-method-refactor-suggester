error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6692.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6692.java
text:
```scala
public static S@@hell internal_new (Display display, int /*long*/ handle) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6692.java