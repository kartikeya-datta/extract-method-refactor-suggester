error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2534.java
text:
```scala
i@@f (keySpace.get() != null && !keySpace.get().equals(keyspace))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2534.java