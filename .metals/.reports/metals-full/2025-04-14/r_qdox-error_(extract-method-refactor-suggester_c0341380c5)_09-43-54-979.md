error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9664.java
text:
```scala
i@@nt /*long*/ enterExitHandle() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9664.java