error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12741.java
text:
```scala
T@@CHAR buffer = new TCHAR (cp, text, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12741.java