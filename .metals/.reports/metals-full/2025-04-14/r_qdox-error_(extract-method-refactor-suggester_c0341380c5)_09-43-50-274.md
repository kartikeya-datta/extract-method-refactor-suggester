error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3871.java
text:
```scala
X@@ContentParser parser = XContentFactory.xContent(contentType).createParser(source, offset, length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3871.java