error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10441.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10441.java
text:
```scala
public static final A@@ttachmentKey<Boolean> EJB_ANNOTATION_PROPERTY_REPLACEMENT = AttachmentKey.create(Boolean.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10441.java