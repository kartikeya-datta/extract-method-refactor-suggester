error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3041.java
text:
```scala
s@@ound = Gdx.audio.newSound(Gdx.files.getFileHandle("data/shotgun.mp3", FileType.Internal));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3041.java