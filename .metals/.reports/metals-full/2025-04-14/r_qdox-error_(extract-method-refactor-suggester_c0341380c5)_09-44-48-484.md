error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12374.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12374.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12374.java
text:
```scala
S@@tring url = ((SimpleTestPanel)page.get("testPanel")).getTimeBehavior().getCallbackUrl().toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12374.java