error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2530.java
text:
```scala
i@@nt v = data.metadata().getValueValidator(expression.column_name).compare(column.value(), expression.value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2530.java