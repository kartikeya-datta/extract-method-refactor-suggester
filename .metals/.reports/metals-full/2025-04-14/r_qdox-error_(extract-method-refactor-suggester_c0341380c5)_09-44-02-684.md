error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14580.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14580.java
text:
```scala
public I@@terator<URL> getEmbeddedResourceURLs(byte[] html, URL baseUrl, URLCollection urls) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14580.java