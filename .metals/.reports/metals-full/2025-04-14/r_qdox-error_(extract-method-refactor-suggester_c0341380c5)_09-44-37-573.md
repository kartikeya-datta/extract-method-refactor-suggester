error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1891.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1891.java
text:
```scala
public final static S@@tring ATT_OBJECTCLASS = "objectClass";//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1891.java