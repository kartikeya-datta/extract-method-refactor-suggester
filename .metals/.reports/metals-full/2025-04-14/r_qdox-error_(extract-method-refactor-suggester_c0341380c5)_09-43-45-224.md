error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16194.java
text:
```scala
b@@uff.append("}.bind(this), function() { ").append(failure).append("}.bind(this));");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16194.java