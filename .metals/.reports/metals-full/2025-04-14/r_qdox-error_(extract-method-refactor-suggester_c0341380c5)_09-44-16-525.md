error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15867.java
text:
```scala
r@@eturn Files.getLastModified(file);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15867.java