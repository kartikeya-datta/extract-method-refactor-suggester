error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16648.java
text:
```scala
N@@SAttributedString attribStr = createString(items[(int)/*64*/rowIndex], null, foreground, 0, false, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16648.java