error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5753.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5753.java
text:
```scala
l@@abel.setAlignment(Align.center);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5753.java