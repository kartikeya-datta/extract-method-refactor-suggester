error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11958.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11958.java
text:
```scala
final S@@tring oldVal = subsystemState.setProperty(propName, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11958.java