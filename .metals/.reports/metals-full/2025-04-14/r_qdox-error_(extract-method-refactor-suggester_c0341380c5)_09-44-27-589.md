error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15355.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15355.java
text:
```scala
a@@ssertEquals(expectedResourceUrl(), tester.getLastRequestCycle().urlFor(ref));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15355.java