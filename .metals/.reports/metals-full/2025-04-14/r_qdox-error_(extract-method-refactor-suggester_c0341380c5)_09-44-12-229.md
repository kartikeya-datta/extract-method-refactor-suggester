error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5566.java
text:
```scala
n@@sItem.initWithTitle(NSString.stringWith(str), 0, NSString.string());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5566.java