error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13808.java
text:
```scala
r@@eturn TxAnnotationDriven.DEFAULT_TRANSACTION_MANAGER_BEAN_NAME;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13808.java