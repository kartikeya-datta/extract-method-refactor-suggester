error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4038.java
text:
```scala
r@@eturn datatypeFactory.newDuration(sign == 1, null, null,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4038.java