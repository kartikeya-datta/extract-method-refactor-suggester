error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/366.java
text:
```scala
r@@eturn data;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/366.java