error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9315.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9315.java
text:
```scala
protected T@@imeValue masterNodeTimeout = DEFAULT_MASTER_NODE_TIMEOUT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9315.java