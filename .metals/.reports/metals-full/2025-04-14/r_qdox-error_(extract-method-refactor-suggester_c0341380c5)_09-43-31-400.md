error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/539.java
text:
```scala
e@@ntityManager1 = new ExtendedEntityManager(unitName, emf.createEntityManager(properties));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/539.java