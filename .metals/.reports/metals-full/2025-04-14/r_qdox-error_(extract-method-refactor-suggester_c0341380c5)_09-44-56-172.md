error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7802.java
text:
```scala
G@@lobalParamContext getGlobalParamContext ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7802.java