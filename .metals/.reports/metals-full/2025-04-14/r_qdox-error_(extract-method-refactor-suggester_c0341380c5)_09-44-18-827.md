error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9714.java
text:
```scala
l@@ine.open(format, 2048 * 10);// Math.min(2048*10, samplingRate / 5) * 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9714.java