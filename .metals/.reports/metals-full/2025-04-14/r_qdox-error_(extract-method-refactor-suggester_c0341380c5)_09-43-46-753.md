error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5787.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5787.java
text:
```scala
final E@@lasticsearch090PostingsFormat defaultFormat = new Elasticsearch090PostingsFormat();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5787.java