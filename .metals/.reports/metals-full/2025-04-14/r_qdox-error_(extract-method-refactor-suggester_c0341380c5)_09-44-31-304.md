error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6471.java
text:
```scala
M@@anagementResourceRegistration logStoreChild = registration.registerSubModel(new LogStoreDefinition(resource));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6471.java