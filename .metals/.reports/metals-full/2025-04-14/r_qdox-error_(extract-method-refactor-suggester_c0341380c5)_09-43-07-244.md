error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12762.java
text:
```scala
p@@ointcut setP(): set(int *.*) && !set(int *.xxx);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12762.java