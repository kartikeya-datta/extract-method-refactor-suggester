error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5618.java
text:
```scala
m@@essage = new MessageComposer(model).compose(worker, r.isAppendSignature());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5618.java