error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6756.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6756.java
text:
```scala
final P@@rogressMonitorDialog progressMonitorDialog = new StartupProgressMonitorDialog(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6756.java