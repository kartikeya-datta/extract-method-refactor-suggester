error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6031.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6031.java
text:
```scala
s@@uper(problemReporter, true, assertMode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6031.java