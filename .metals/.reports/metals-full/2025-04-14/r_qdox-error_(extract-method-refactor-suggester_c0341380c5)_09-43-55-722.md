error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/103.java
text:
```scala
c@@lient.admin().indices().flush(flushRequest, new ActionListener<FlushResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/103.java