error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10411.java
text:
```scala
Q@@uery childrenConstantScoreQuery = new ChildrenConstantScoreQuery(query, parentType, childType, parentFilter, shortCircuitParentDocSet);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10411.java