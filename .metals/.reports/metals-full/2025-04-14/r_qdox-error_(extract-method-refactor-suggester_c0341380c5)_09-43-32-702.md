error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6739.java
text:
```scala
P@@latformMBeanUtil.getResolver(PlatformMBeanConstants.MEMORY_MANAGER));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6739.java