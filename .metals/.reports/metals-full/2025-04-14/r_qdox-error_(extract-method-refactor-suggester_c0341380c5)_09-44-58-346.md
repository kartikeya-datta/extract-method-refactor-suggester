error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3054.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3054.java
text:
```scala
@Override public S@@hardRouting nextActiveOrNull() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3054.java