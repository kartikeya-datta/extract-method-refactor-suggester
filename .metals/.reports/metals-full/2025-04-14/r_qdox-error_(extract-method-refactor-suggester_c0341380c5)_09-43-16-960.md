error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1607.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1607.java
text:
```scala
i@@f (Gdx.app.getType() == ApplicationType.Android || Gdx.app.getType() == ApplicationType.WebGL || Gdx.app.getType() == ApplicationType.iOS) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1607.java