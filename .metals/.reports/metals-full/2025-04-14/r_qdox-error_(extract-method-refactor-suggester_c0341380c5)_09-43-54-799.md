error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/184.java
text:
```scala
c@@ert = base64.fromString(st.remainingTokens());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/184.java