error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2099.java
text:
```scala
F@@uture<Integer> ft = CompactionManager.instance().submit(store, 2, 32);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2099.java