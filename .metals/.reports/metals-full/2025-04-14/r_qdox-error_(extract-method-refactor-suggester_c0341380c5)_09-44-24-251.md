error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17601.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[136,27]

error in qdox parser
file content:
```java
offset: 2940
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17601.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17601.java