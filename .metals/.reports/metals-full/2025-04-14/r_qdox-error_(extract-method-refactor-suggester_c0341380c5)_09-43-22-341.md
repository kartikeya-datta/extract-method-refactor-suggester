error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7110.java
text:
```scala
i@@f (isFieldUseDeprecated(binding, scope, (this.bits & IsStrictlyAssignedMASK) !=0))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7110.java