error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2630.java
text:
```scala
S@@tring propName = operation.get(ModelDescriptionConstants.OP_ADDR).asObject().get(ModelConstants.PROPERTY).asString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2630.java