error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3323.java
text:
```scala
N@@ested nested = createNested(parentFilter, childFilter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3323.java