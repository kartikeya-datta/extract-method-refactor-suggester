error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14090.java
text:
```scala
i@@f (containerHelper != null) containerHelper.setRoomID(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14090.java