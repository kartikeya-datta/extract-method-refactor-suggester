error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/477.java
text:
```scala
H@@OSTNAME_REGEXP = "^[a-zA-Z0-9-]+\\.[a-zA-Z0-9-\\.]+\\.[a-zA-Z]{2,}+$",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/477.java