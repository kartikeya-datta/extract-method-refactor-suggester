error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1371.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1371.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1371.java
text:
```scala
C@@lass clazz = searchStack.get(i);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1371.java