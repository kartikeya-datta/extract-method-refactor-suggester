error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6821.java
text:
```scala
t@@estSupport = DomainTestSuite.createSupport(DatasourceTestCase.class.getSimpleName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6821.java