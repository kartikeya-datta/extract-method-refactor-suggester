error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1478.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1478.java
text:
```scala
static v@@oid registerTransformers111(ResourceTransformationDescriptionBuilder parentBuilder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1478.java