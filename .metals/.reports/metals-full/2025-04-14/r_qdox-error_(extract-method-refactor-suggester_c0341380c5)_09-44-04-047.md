error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2714.java
text:
```scala
p@@ublic interface IMarkupFragment extends Iterable<MarkupElement>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2714.java