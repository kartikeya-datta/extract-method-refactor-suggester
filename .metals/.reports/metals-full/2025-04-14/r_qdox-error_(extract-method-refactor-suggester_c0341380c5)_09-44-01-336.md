error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/676.java
...
```java
offset: 723
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/676.java
text:
```scala
...
p@@ackage org.apache.jmeter.gui.tree;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/676.java