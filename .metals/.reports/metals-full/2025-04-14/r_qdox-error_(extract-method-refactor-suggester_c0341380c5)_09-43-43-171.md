error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2957.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2957.java
text:
```scala
n@@et = new AndroidNet(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2957.java