error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7064.java
text:
```scala
i@@f (isClosing() || !advisor.openWindows()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7064.java