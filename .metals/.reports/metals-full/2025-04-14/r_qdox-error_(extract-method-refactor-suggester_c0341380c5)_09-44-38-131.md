error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12694.java
text:
```scala
T@@ag wicket = new Tag("wicket:panel");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12694.java