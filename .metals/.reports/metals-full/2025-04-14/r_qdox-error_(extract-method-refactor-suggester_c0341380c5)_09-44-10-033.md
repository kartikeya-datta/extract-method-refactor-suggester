error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15534.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15534.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15534.java
text:
```scala
f@@illBackground (view, context, rect, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15534.java