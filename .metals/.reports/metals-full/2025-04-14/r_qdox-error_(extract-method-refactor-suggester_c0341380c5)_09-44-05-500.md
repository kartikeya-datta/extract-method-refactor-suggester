error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/620.java
text:
```scala
p@@ublic class WildcardListModel<T> extends GenericBaseModel<List<? extends T>>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/620.java