error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10365.java
text:
```scala
f@@ail("should fail");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10365.java