error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8597.java
text:
```scala
s@@crollId = buildScrollId(request.searchType(), queryResults.values(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8597.java