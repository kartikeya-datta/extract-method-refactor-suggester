error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5110.java
...
```java
offset: 26
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5110.java
text:
```scala
@Test(timeout=10) public v@@oid snappyRetrievalOfAnnotatedMethods() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5110.java