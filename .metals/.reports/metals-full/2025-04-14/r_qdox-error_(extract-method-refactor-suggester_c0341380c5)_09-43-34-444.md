error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1871.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1871.java
text:
```scala
static i@@nt MINOR_VERSION = 330;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1871.java