error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/481.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/481.java
text:
```scala
N@@SAttributedString attribStr = parent.createString(text, font, null, 0, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/481.java