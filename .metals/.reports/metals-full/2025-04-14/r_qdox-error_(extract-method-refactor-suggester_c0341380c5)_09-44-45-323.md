error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9026.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9026.java
text:
```scala
private final C@@ollection<E> collection;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9026.java