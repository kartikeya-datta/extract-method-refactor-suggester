error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11607.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11607.java
text:
```scala
private v@@oid testUnarchive(StreamWrapper<CompressorInputStream> wrapper) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11607.java