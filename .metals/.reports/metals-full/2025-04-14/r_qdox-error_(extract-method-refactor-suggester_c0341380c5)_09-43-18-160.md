error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2925.java
text:
```scala
M@@enuFactory.ASSERTIONS, MenuFactory.CONFIG_ELEMENTS, MenuFactory.TIMERS, MenuFactory.LISTENERS, MenuFactory.PRE_PROCESSORS,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2925.java