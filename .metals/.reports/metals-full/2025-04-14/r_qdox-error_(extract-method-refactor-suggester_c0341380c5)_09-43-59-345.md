error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7592.java
text:
```scala
l@@ights[0].attenuation.set(1f, 0f, 0f);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7592.java