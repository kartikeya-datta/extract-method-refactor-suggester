error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1481.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1481.java
text:
```scala
L@@ist<InetAddress> endPoints = tester.ringCache.getEndPoint(row.getBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1481.java