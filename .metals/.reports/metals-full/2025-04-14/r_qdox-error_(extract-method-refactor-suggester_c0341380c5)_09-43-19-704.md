error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9384.java
text:
```scala
s@@ynchroVariable.useFlag = LocalVariableBinding.USED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9384.java