error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2516.java
text:
```scala
s@@etState(pgp.getBooleanWithDefault("always_encrypt", false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2516.java