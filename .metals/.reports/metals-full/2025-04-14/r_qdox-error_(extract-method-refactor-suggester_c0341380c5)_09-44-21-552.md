error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13609.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13609.java
text:
```scala
public i@@nt getLengthOfReplacedText() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13609.java