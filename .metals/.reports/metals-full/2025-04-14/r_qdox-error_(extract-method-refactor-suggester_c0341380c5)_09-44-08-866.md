error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13752.java
text:
```scala
i@@f (dataSourceCongServiceName.append("connection-properties").isParentOf(name)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13752.java