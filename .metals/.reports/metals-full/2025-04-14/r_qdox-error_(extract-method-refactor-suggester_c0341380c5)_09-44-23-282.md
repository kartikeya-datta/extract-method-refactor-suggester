error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9220.java
text:
```scala
s@@etManagedInstanceType(Class.forName(str.substring(0, dash), true, loader));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9220.java