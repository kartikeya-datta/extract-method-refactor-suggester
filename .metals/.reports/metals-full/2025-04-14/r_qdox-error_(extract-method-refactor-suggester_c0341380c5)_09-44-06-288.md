error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5779.java
text:
```scala
E@@ngine.Searcher searcher = shardToPurge.acquireSearcher("indices_ttl");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5779.java