error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7383.java
text:
```scala
r@@eplaceChild(this.qualifier, qualifier, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7383.java