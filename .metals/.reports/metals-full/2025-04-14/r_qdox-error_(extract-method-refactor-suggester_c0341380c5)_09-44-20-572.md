error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8099.java
text:
```scala
i@@nt result = opCompleter.doComplete(opBuffer, candidates, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8099.java