error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12349.java
text:
```scala
e@@nd = Math.min(content.getCharCount(), getWordNext(start, SWT.MOVEMENT_WORD_END));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12349.java