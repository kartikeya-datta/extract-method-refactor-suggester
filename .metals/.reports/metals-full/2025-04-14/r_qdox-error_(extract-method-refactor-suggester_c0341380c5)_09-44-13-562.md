error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5328.java
text:
```scala
g@@etApplication().getHomePage(), (PageParameters)null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5328.java