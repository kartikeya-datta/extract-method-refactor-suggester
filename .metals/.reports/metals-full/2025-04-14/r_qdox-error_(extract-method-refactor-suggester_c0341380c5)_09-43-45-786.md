error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9625.java
text:
```scala
t@@hrow new OperationFailedException(exceptionMessage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9625.java