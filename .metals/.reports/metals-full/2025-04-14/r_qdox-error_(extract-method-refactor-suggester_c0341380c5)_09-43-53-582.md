error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1593.java
text:
```scala
T@@able.open(ksm.name).initCf(cfm.cfId, cfm.cfName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1593.java