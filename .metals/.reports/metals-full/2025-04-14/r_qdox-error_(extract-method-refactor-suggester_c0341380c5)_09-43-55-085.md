error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1216.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1216.java
text:
```scala
B@@inaryTypeBinding binaryTypeBinding = this.lookupEnvironment.cacheBinaryType(binaryType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1216.java