error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9810.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9810.java
text:
```scala
public abstract v@@oid createContributionItems(List items);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9810.java