error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9810.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9810.java
text:
```scala
public F@@ixedGenerationCount(final int maxGenerations) throws NumberIsTooSmallException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9810.java