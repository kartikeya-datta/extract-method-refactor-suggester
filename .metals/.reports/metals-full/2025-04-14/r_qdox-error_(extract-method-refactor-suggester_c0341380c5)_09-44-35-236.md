error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17089.java
text:
```scala
r@@eturn (getApplication().getSecuritySettings().getAuthorizationStrategy().allowEnabledState(FormComponent.this) && FormComponent.this
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17089.java