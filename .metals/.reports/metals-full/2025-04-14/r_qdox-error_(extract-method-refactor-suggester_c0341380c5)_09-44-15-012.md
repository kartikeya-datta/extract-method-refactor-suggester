error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3990.java
text:
```scala
o@@p.get(CONTENT).set(state.get(CONTENT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3990.java