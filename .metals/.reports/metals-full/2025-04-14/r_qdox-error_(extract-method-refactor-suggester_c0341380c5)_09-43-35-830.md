error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/982.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[80,27]

error in qdox parser
file content:
```java
offset: 3431
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/982.java
text:
```scala
{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/982.java