error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8415.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8415.java
text:
```scala
: !w@@ithin(A1+) && !preinitialization(new(..)) && !initialization(new(..))//cflow(within(Target) && execution(* *(..))) && !within(A1+)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8415.java