error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13618.java
text:
```scala
r@@eturn FontMetrics.internal_new(ascent, descent, 0, 0, ascent + descent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13618.java