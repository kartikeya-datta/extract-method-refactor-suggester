error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3333.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3333.java
text:
```scala
public static L@@ocalizer get()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3333.java