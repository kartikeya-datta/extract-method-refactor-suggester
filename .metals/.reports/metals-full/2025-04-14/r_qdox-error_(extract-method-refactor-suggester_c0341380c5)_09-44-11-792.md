error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15356.java
text:
```scala
l@@og.warn("Thread won't die: " + t.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15356.java