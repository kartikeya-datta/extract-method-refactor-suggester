error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5620.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5620.java
text:
```scala
private S@@tring javaVmArguments = System.getProperty("jboss.options", "-Xmx512m -XX:MaxPermSize=256m");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5620.java