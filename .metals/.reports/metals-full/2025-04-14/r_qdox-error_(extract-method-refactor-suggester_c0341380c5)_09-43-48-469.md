error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10149.java
text:
```scala
s@@uper(RemoteOutboundConnnectionResourceDefinition.ATTRIBUTE_DEFINITIONS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10149.java