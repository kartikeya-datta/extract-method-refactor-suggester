error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12902.java
text:
```scala
a@@dd(new AjaxFallbackDefaultDataTable<Contact>("table", columns, new SortableContactDataProvider(), 8));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12902.java