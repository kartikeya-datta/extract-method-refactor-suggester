error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3377.java
text:
```scala
r@@eturn entity == null ? null : getVariableResolver().replaceTokens(entity.allAttributes.get(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3377.java