error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6560.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6560.java
text:
```scala
s@@houldReturn[0] = !hasAppMenu();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6560.java