error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4961.java
text:
```scala
e@@vent.detail = position < hPosition ? SWT.PAGE_UP : SWT.PAGE_DOWN;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4961.java