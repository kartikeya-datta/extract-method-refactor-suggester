error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2606.java
text:
```scala
c@@ontext.removeResource(PathAddress.EMPTY_ADDRESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2606.java