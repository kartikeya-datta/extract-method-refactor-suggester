error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4218.java
text:
```scala
r@@eturn new Rectangle (x, y, Math.max (0, width), Math.max (0, height));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4218.java