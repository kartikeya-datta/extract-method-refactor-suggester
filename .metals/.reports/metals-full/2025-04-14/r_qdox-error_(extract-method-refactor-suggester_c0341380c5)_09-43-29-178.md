error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7707.java
text:
```scala
m@@emberType = scope.environment().convertToRawType(memberType, false /*do not force conversion of enclosing types*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7707.java