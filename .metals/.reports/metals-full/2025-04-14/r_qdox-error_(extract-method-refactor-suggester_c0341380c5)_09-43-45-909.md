error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3093.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3093.java
text:
```scala
public static M@@odelNode processConnectors(XMLExtendedStreamReader reader) throws XMLStreamException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3093.java