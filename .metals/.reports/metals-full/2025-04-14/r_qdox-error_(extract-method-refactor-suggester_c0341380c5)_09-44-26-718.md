error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8649.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8649.java
text:
```scala
a@@bsoluteBaseUrl = LinkProcessor.removeLastSlash(baseUrl.trim());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8649.java