error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6325.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6325.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6325.java
text:
```scala
v@@oid setInitialBounds () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6325.java