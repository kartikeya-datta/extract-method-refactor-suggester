error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1370.java
text:
```scala
i@@f(JOrphanUtils.isBlank(contentEncoding)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1370.java