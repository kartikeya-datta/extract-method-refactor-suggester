error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7915.java
text:
```scala
g@@atewayFile = new File(environment.dataFile(), "gateway");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7915.java