error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14852.java
text:
```scala
b@@oolean locked = cache.getAdvancedCache().lock(Collections.singleton(this.key));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14852.java