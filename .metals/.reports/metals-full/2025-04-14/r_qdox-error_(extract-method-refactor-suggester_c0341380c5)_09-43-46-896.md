error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8038.java
text:
```scala
i@@f (!child.touchable || !child.visible) continue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8038.java