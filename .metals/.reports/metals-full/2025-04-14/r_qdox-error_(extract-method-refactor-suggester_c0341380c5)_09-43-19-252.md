error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5003.java
text:
```scala
m@@arker.setAttribute("ID"/*nonNLS*/, new Integer(problem.getID()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5003.java