error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7471.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7471.java
text:
```scala
final L@@ist<AllocationDecider> list = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7471.java