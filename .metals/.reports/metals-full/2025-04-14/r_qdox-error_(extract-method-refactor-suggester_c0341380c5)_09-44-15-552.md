error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4100.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4100.java
text:
```scala
protected A@@ccessTimeoutDetails fromAnnotation(final AnnotationInstance annotationInstance, final boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4100.java