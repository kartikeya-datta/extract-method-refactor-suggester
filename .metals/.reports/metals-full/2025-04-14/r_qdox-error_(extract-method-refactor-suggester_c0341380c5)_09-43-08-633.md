error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17731.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[73,80]

error in qdox parser
file content:
```java
offset: 1713
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17731.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17731.java