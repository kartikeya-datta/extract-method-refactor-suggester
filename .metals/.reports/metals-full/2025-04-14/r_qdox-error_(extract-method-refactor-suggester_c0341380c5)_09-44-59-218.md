error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15953.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15953.java
text:
```scala
private final F@@ile outputFile;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15953.java