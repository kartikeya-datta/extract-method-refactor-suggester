error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10765.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10765.java
text:
```scala
r@@eturn IDFactory.getDefault().makeID(XMPPID.PROTOCOL, new Object[] { connection
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10765.java