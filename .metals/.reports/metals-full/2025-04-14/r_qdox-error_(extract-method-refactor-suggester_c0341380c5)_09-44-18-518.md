error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3918.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3918.java
text:
```scala
private final C@@ontactsDatabase contactsDB = new ContactsDatabase(50);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3918.java