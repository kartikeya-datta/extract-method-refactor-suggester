error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5611.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5611.java
text:
```scala
c@@urrentState.enter(owner);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5611.java