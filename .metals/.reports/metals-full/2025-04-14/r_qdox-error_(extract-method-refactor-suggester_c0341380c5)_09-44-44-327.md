error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5918.java
text:
```scala
r@@eturn (this.targetDestination != null) ? this.targetDestination + sessionId : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5918.java