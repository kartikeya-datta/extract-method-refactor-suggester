error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11774.java
text:
```scala
d@@efaultDependencies.add("org.junit");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11774.java