error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2997.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2997.java
text:
```scala
public static final S@@tring FILE_ATTRIBUTE = "file";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2997.java