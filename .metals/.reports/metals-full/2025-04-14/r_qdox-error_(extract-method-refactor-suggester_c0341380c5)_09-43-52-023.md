error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13993.java
text:
```scala
e@@lse if (handleVar == VAR_PATH && !(val instanceof Path))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13993.java