error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12136.java
text:
```scala
c@@ase SWT.CURSOR_APPSTARTING:	if (!OS.IsLinux) shape = OS.GDK_LEFT_PTR; break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12136.java