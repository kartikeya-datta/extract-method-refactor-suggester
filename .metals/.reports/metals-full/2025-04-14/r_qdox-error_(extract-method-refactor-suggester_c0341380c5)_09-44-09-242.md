error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7762.java
text:
```scala
r@@eturn BackendFacade.createExecutionContext (new FunctionDefContextFactory (ts).create(), ts, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7762.java