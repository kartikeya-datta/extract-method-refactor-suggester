error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1219.java
text:
```scala
s@@erverImpl.setClientLocale( locale );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1219.java