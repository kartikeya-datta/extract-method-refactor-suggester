error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17240.java
text:
```scala
i@@nfo.hbmpItem = image != null ? OS.HBMMENU_CALLBACK : 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17240.java