error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/292.java
text:
```scala
l@@en = i;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/292.java