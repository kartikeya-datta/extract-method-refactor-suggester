error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14465.java
text:
```scala
r@@eturn new StringBuilder(funcName).append("('")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14465.java