error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6816.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6816.java
text:
```scala
i@@f (entry.getPath().equals(path)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6816.java