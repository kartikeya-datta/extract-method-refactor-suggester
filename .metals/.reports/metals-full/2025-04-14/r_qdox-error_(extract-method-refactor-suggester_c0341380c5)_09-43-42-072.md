error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2853.java
text:
```scala
a@@ssertEquals(1d / (totalTime / 1000d), calculator.getRate(),0.0001d); // Allow for some margin of error
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2853.java