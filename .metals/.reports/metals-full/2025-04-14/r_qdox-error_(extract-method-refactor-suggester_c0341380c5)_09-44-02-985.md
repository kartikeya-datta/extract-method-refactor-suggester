error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2619.java
text:
```scala
p@@article.velocity.scl((float) Math.pow(damping, delta));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2619.java