error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2851.java
text:
```scala
r@@eturn result.booleanValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2851.java