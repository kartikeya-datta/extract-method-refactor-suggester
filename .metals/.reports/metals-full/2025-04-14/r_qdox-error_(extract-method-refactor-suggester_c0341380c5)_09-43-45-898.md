error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6566.java
text:
```scala
i@@f (fileName == NO_SOURCE_FILE_NAME) return CharOperation.NO_CHAR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6566.java