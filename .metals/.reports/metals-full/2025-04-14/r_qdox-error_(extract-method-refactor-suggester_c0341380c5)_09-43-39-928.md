error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10634.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10634.java
text:
```scala
i@@f (OS.GetDataBrowserItems (handle, id, false, OS.kDataBrowserItemAnyState, ptr) == OS.noErr) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10634.java