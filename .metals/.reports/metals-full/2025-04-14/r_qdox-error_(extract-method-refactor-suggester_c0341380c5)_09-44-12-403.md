error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1828.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1828.java
text:
```scala
d@@efaultOptionsMap.put(JavaCore.CODEASSIST_CAMEL_CASE_MATCH, JavaCore.ENABLED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1828.java