error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1755.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1755.java
text:
```scala
final B@@inaryDocValues terms = cache.getTerms(readerContext.reader(), field, false, PackedInts.FAST);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1755.java