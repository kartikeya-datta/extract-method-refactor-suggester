error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5433.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5433.java
text:
```scala
public v@@oid setTarget (Actor targetActor) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5433.java