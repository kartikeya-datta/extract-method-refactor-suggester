error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4463.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4463.java
text:
```scala
M@@ap<String, ?> getJpaPropertyMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4463.java