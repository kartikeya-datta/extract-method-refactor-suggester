error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8090.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8090.java
text:
```scala
public v@@oid beforeIndexShardClosed(ShardId shardId, @Nullable IndexShard indexShard) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8090.java