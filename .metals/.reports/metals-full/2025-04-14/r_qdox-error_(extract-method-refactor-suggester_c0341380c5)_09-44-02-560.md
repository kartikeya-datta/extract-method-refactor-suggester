error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9232.java
...
```java
offset: 6491
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9232.java
text:
```scala
{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9232.java