error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9014.java
text:
```scala
E@@xpressionParser.class, ExpressionParser.class.getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9014.java