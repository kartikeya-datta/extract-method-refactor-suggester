error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1741.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1741.java
text:
```scala
r@@esult.getAndSetExpired();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1741.java