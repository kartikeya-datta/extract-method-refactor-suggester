error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/453.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/453.java
text:
```scala
public L@@ucene40DocValuesConsumer(PerDocWriteState state, String segmentSuffix) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/453.java