error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17636.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[77,80]

error in qdox parser
file content:
```java
offset: 2244
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17636.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17636.java