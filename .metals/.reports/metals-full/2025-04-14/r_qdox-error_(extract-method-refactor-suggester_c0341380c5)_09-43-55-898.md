error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15244.java
text:
```scala
i@@f (isAuthorized == false && isUserSignedIn() == false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15244.java