error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13902.java
text:
```scala
R@@ECT textRect = item.getBounds (index, true, false, false, false, true, hDC);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13902.java