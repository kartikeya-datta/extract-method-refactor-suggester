error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6408.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6408.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6408.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/template/put";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6408.java