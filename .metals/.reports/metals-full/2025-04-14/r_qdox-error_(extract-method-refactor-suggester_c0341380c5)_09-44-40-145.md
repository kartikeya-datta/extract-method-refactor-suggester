error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7275.java
text:
```scala
n@@ew Object[] { Double.valueOf(1234567) });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7275.java