error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9009.java
text:
```scala
B@@ox2DTest.class, InterpolationTest.class, TouchpadTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9009.java