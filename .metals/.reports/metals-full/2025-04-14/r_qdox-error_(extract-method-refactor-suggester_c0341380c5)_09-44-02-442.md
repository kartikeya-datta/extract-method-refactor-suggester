error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12778.java
text:
```scala
i@@f (!isActive ()) return 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12778.java