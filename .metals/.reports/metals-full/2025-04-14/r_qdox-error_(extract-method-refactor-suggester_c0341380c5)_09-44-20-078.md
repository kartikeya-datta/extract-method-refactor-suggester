error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/797.java
text:
```scala
i@@f (node.actor.getY() <= high && !selectedNodes.contains(node, true)) selectedNodes.add(node);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/797.java