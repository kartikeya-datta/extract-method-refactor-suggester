error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11940.java
text:
```scala
r@@eturn (SortedSet<E>) decorated();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11940.java