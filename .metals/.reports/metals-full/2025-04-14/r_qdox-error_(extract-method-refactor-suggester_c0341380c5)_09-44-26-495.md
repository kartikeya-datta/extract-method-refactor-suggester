error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6544.java
text:
```scala
J@@eremieRegistry.this.stop();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6544.java