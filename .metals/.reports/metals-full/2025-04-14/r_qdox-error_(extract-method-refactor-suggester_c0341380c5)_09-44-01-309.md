error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1257.java
text:
```scala
n@@odeSet.addMatch(node, this.pattern.mustResolve ? POSSIBLE_MATCH : ACCURATE_MATCH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1257.java