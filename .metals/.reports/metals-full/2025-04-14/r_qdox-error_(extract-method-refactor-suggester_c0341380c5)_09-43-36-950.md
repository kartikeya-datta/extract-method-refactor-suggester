error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16286.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16286.java
text:
```scala
public v@@oid setParent(ClassLoader parent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16286.java