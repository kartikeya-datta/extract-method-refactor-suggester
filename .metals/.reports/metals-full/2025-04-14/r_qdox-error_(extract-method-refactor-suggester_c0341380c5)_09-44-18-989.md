error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9539.java
text:
```scala
p@@rogress.setMessage(getString(string.creating_issue));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9539.java