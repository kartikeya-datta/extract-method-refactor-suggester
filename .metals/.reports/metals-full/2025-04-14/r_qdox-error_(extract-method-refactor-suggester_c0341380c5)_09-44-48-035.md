error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7301.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7301.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7301.java
text:
```scala
b@@uiltIn = new IntObjectOpenHashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7301.java