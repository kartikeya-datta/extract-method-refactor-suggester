error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4446.java
text:
```scala
s@@ervice.setTarget(Target.fromString(TargetValidator.properCase(target.asString())));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4446.java