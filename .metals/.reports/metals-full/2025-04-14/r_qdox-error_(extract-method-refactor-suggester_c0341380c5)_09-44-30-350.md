error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1889.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1889.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1889.java
text:
```scala
M@@oduleEntity module = getAttributeGroup().getModule();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1889.java