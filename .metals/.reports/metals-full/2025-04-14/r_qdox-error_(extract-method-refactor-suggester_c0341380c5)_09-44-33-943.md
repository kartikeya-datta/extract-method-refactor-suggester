error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7079.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7079.java
text:
```scala
private final i@@nt maximumAutoGrowSize;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7079.java