error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2319.java
text:
```scala
i@@con.setIcon(ImageLoader.getMiscIcon("out-of-office-48.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2319.java