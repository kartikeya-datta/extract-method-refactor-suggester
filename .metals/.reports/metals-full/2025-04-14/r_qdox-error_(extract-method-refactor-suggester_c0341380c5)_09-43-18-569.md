error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1096.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1096.java
text:
```scala
i@@f ((parent.style & SWT.VIRTUAL) != 0 && parent.currentItem == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1096.java