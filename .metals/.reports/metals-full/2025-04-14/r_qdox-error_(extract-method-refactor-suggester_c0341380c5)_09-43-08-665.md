error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/797.java
text:
```scala
M@@essageId.OBJECT_CLOSED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/797.java