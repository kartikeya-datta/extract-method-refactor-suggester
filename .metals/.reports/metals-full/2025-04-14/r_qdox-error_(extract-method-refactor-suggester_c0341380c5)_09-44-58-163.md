error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4166.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4166.java
text:
```scala
r@@eturn  "<subsystem xmlns=\"urn:jboss:domain:datasources:1.1\">" +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4166.java