error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11799.java
text:
```scala
p@@ublic class PagedTableNavigatorWithLabelProviderPage extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11799.java