error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/915.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/915.java
text:
```scala
public abstract M@@ap<String, ? extends Object> getParameterMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/915.java