error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4718.java
text:
```scala
n@@ew CodeSnippetParser(problemReporter, evaluationContext, this.options.parseLiteralExpressionsAsConstants, codeSnippetStart, codeSnippetEnd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4718.java