error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3423.java
text:
```scala
C@@heckHits.checkHitCollector(random, q, FIELD, searcher, expDocNrs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3423.java