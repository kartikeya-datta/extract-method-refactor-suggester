error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8982.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8982.java
text:
```scala
t@@hrow new WicketRuntimeException("Exception '" + e + "' occurred during validation "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8982.java