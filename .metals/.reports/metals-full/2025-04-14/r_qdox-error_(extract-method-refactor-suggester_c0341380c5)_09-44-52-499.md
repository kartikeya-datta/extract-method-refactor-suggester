error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/119.java
text:
```scala
t@@hrow ThreadsLogger.ROOT_LOGGER.unsupportedBoundedQueueThreadPoolMetric(attributeName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/119.java