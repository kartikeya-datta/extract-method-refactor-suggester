error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8033.java
text:
```scala
B@@oolean replacement = deploymentUnit.getAttachment(Attachments.ANNOTATION_PROPERTY_REPLACEMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8033.java