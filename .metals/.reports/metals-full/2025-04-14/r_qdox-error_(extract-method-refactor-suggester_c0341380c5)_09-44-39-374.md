error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17169.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17169.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17169.java
text:
```scala
a@@pplication.getPages().setHomePage(SimpleTablePage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17169.java