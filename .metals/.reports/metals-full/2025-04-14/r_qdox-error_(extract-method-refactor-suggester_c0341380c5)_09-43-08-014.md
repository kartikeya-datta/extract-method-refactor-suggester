error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7490.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7490.java
text:
```scala
protected A@@bstractLeastSquaresOptimizer(AbstractLeastSquaresOptimizer<OPTIM> other) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7490.java