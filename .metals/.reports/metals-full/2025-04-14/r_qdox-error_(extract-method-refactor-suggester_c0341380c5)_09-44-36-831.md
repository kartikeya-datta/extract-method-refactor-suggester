error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11551.java
text:
```scala
n@@ode.get(ModelDescriptionConstants.DESCRIPTION).set(OSGiDescriptionProviders.getResourceBundle(locale).getString("framework.property.remove"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11551.java