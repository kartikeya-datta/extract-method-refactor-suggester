error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5665.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5665.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5665.java
text:
```scala
t@@his.region = new AtlasRegion(region);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5665.java