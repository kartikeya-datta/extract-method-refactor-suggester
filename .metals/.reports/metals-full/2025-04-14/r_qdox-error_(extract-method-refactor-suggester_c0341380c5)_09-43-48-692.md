error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15265.java
text:
```scala
p@@ublic class AjaxPagingNavigationLink extends PagingNavigationLink<Void> implements IAjaxLink
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15265.java