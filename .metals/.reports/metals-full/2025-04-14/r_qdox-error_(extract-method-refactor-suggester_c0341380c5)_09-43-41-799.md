error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10839.java
text:
```scala
t@@hrow new RuntimeException("Pipe to subprocess seems to be broken!");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10839.java