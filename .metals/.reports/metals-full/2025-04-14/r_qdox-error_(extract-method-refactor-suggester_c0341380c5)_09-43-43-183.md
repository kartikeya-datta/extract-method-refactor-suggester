error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7205.java
text:
```scala
i@@f (memory >= 32 * 10024 * 1024) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7205.java