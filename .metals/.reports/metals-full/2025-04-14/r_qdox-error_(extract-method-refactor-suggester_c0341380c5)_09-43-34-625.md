error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9956.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9956.java
text:
```scala
: n@@ull;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9956.java