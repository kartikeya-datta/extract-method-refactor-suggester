error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6142.java
text:
```scala
i@@f (index.getAnnotations(MANAGED_BEAN_ANNOTATION_NAME) == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6142.java