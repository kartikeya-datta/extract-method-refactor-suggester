error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1065.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1065.java
text:
```scala
final F@@ile standalone = new File(getEnvironment().getServerConfigurationDir(), STANDALONE_XML);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1065.java