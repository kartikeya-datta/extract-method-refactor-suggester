error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10893.java
text:
```scala
O@@S.WS_EX_TRANSPARENT,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10893.java