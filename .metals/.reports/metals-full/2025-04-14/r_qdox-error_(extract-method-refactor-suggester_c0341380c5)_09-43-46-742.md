error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9827.java
text:
```scala
I@@ id = (I) key;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9827.java