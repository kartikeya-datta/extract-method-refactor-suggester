error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2563.java
text:
```scala
i@@f (fExists && this.isActivated()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2563.java