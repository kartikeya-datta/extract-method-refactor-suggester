error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9436.java
text:
```scala
u@@pdateSettingsService.updateSettings(request.settings(), request.indices(), request.masterNodeTimeout(), new MetaDataUpdateSettingsService.Listener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9436.java