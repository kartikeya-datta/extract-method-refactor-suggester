error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1752.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1752.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1752.java
text:
```scala
C@@omposerModel model = (ComposerModel) ((ComposerController)getFrameMediator()).getModel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1752.java