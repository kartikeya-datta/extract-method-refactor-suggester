error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8602.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8602.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8602.java
text:
```scala
l@@ogWhenWriting("Warning: selected " + archiveType
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8602.java