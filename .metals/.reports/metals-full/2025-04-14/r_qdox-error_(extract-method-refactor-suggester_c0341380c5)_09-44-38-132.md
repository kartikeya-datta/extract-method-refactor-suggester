error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2148.java
text:
```scala
r@@eturn camera.getPickRay(screenX, screenY, this.screenX, this.screenY, screenWidth, screenHeight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2148.java