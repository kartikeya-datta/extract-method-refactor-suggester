error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11909.java
text:
```scala
i@@f (display.thread != Thread.currentThread () && !display.isEmbedded) error (SWT.ERROR_THREAD_INVALID_ACCESS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11909.java