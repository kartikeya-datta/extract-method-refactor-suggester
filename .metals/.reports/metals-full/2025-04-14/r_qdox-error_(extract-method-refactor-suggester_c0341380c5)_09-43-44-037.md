error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9860.java
text:
```scala
B@@ytesHolder bytes = in.readBytesReference();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9860.java