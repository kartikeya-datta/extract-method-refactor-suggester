error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8412.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8412.java
text:
```scala
B@@uildConfig config = new BuildConfig("gdx", "../target/native", LIBS_DIR, JNI_DIR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8412.java