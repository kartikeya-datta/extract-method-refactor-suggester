error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9549.java
text:
```scala
v@@oid checkProxyClass(Class<?> proxyClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9549.java