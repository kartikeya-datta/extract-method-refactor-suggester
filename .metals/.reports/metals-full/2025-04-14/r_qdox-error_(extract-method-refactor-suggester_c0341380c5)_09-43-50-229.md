error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/15.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/15.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/15.java
text:
```scala
i@@f (left != null && !left.isVolatile() && left == getDirectBinding(this.expression)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/15.java