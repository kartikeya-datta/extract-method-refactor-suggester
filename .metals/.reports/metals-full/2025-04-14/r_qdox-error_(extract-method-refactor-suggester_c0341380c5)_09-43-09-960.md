error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7737.java
text:
```scala
S@@tring deploymentName = prefix + file.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7737.java