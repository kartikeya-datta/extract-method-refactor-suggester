error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5350.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5350.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5350.java
text:
```scala
private static final C@@SVFormat PRISTINE = new CSVFormat(DISABLED, null, null, null, null, false, false, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5350.java