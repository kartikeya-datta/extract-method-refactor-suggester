error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/595.java
text:
```scala
l@@ptvdi.iImage = lptvdi.iSelectedImage = OS.I_IMAGENONE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/595.java