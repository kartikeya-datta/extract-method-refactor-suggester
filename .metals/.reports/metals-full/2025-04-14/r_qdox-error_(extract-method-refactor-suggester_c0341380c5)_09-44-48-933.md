error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9662.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9662.java
text:
```scala
static i@@nt MINOR_VERSION = 535;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9662.java