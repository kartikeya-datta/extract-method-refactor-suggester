error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6126.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6126.java
text:
```scala
i@@f (operation.get(NAME).asString().equals(JPADefinition.DEFAULT_EXTENDEDPERSISTENCE_INHERITANCE.getName())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6126.java