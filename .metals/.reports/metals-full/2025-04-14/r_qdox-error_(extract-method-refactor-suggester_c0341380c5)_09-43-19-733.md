error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/14.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/14.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/14.java
text:
```scala
j@@sonTexture.fileName = materialDir + (materialDir.length() == 0 || materialDir.endsWith("/") ? "" : "/") + fileName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/14.java