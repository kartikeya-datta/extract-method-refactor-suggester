error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13232.java
text:
```scala
N@@STabView widget = (NSTabView)new SWTTabView().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13232.java