error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15341.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15341.java
text:
```scala
public static final S@@tring ERROR_FILE_AND_SRCDIR
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15341.java