error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3714.java
text:
```scala
r@@eturn view.getValue().createInstance(Collections.<Object, Object>singletonMap(SessionID.SESSION_ID_KEY, sessionID)).getInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3714.java