error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5779.java
text:
```scala
r@@esourceRegistration.registerSubModel(ApplicationClassificationTypeResourceDefinition.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5779.java