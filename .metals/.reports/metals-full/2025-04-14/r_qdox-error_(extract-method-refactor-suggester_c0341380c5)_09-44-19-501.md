error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1296.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1296.java
text:
```scala
I@@Folder f = folderFacade.getFolderByName(s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1296.java