error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2746.java
text:
```scala
B@@ytesRef type = parser.bytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2746.java