error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12091.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12091.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12091.java
text:
```scala
public S@@tring prepareEndpointAddress(IRemoteCall call, IRemoteCallable callable) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12091.java