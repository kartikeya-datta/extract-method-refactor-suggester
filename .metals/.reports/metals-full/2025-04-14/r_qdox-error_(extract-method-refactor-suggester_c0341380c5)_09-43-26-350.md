error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9058.java
text:
```scala
f@@ilter = FileFilterUtils.or(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9058.java