error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2659.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2659.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2659.java
text:
```scala
c@@ontroller.registerHandler(RestRequest.Method.GET, "/_cluster/nodes/{nodeId}", this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2659.java