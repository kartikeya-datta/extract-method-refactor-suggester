error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3263.java
text:
```scala
b@@ind(String.class).annotatedWith(IndexerIndexName.class).toInstance(IndexerIndexName.Conf.indexName(settings));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3263.java