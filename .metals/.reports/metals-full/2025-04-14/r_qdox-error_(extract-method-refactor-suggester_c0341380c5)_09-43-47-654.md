error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/530.java
text:
```scala
l@@ast.copyBytes(term);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/530.java