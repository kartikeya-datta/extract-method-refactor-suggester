error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6556.java
text:
```scala
g@@dxBulletJNI.ContactProcessedListenerByValue_onContactProcessed(swigCPtr, this, cp, userValue0, match0, userValue1, match1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6556.java