error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9820.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9820.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9820.java
text:
```scala
N@@ewSearchUI.runQueryInBackground(query);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9820.java