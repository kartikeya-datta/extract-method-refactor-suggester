error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1817.java
text:
```scala
d@@urationPanel.add(new JLabel("Duration"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1817.java