error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6564.java
text:
```scala
S@@tring txt = Application.get().getResourceSettings().getLocalizer().getString("ServerAndClientTimeFilter.statustext", null, Model.valueOf(map), Session.get().getLocale(), Session.get().getStyle(), defaultValue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6564.java