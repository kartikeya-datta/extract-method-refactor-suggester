error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3213.java
text:
```scala
c@@lient.admin().indices().prepareDelete("_all").execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3213.java