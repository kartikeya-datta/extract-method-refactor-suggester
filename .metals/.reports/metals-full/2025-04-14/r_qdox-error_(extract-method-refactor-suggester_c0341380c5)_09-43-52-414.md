error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5814.java
text:
```scala
r@@eturn new Location(this.declaringClass.getResource(), metadata);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5814.java