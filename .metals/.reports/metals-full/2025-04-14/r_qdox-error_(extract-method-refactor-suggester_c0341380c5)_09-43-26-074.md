error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6131.java
text:
```scala
s@@uper(WorkbenchMessages.PartPane_move);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6131.java