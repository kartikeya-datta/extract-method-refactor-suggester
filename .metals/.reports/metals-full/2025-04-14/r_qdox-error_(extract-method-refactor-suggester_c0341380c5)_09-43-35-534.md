error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17658.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[259,2]

error in qdox parser
file content:
```java
offset: 9335
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17658.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17658.java