error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4936.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4936.java
text:
```scala
S@@tatusUtil.handleStatus(errorStatus, StatusManager.SHOW, parent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4936.java