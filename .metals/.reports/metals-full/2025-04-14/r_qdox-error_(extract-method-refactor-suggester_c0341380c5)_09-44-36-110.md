error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13517.java
text:
```scala
R@@emoteOutboundConnectionAdd.INSTANCE, RemoteOutboundConnectionRemoveHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13517.java