error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8538.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8538.java
text:
```scala
public static final S@@tring ID = "PROP";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8538.java