error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/311.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/311.java
text:
```scala
public v@@oid clear() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/311.java