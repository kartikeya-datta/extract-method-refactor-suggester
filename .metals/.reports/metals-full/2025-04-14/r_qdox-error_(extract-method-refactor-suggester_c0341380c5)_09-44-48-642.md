error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8449.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8449.java
text:
```scala
S@@creenCaptureTest.class, BitmapFontTest.class, LabelScaleTest.class, GLEEDTest.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8449.java