error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/205.java
text:
```scala
t@@hrow new BuildException("Command or commandResource is required.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/205.java