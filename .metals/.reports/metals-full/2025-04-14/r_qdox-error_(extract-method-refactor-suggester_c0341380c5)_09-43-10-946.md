error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3163.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3163.java
text:
```scala
public I@@ResourceFinder newResourceFinder()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3163.java