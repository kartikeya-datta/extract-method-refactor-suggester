error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17808.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17808.java
text:
```scala
public b@@oolean isInputNullable()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17808.java