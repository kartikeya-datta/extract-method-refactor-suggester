error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14153.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14153.java
text:
```scala
private final A@@tomicReference<L> localContext = new AtomicReference<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14153.java