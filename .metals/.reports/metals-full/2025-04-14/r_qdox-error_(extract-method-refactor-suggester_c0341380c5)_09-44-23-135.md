error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15851.java
text:
```scala
i@@nt scrollRemainder, scrollHRemainder;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15851.java