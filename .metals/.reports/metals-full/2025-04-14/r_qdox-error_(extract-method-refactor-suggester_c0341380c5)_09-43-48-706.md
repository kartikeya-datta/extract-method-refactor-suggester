error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11454.java
text:
```scala
p@@ublic class FeedbackIndicatorFormPage extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11454.java