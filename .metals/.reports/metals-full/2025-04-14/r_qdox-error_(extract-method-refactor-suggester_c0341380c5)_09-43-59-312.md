error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11753.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11753.java
text:
```scala
public static A@@ttachmentKey<NestedMounts> ATTACHMENT_KEY = AttachmentKey.create(NestedMounts.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11753.java