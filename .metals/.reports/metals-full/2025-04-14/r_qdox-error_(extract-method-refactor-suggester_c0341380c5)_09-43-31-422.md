error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1139.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1139.java
text:
```scala
final C@@omponentConfiguration componentConfiguration = componentDescription.createConfiguration(moduleConfiguration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1139.java