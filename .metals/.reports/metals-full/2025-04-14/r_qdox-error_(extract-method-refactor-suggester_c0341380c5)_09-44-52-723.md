error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5893.java
text:
```scala
r@@eturn tabString(tab) + "Recovered import: "/*nonNLS*/ + importReference.toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5893.java