error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4313.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4313.java
text:
```scala
public b@@oolean isPostConstructCalled() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4313.java