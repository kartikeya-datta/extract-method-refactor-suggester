error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2978.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2978.java
text:
```scala
S@@earcher searcher = new IndexSearcher(dir, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2978.java