error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4648.java
text:
```scala
c@@ase id.m_apply:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4648.java