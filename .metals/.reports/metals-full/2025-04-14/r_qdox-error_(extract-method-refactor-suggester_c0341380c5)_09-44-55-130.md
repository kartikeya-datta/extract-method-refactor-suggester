error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7078.java
...
```java
offset: 37
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7078.java
text:
```scala
"' for method parameter of type " + p@@arameter.getParameterType().getSimpleName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7078.java