error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1346.java
text:
```scala
i@@f ((state & CANVAS) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1346.java