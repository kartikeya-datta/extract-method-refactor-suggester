error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3592.java
text:
```scala
r@@eturn new GwtFileHandle(preloader, path, FileType.Classpath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3592.java