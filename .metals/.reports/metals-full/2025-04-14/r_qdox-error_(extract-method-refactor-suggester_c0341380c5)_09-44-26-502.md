error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7781.java
text:
```scala
i@@f (this.declaringClass.getMetadata().isAnnotated(Configuration.class.getName()) && !getMetadata().isOverridable()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7781.java