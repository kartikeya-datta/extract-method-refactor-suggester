error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4014.java
text:
```scala
t@@hrow new GdxRuntimeException("couldn't load file '" + file.name() + "'", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4014.java