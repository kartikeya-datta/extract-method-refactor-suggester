error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/856.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/856.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/856.java
text:
```scala
b@@oolean enabled = ! operation.hasDefined(ENABLED.getName()) || ENABLED.resolveModelAttribute(context, model).asBoolean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/856.java