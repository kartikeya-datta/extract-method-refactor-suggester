error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1544.java
text:
```scala
w@@orld.dynamicsWorld.rayTest(rayFrom, rayTo, rayTestCB);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1544.java