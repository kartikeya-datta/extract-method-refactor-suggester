error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15157.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15157.java
text:
```scala
static final S@@erviceName PATH_BASE = MessagingServices.JBOSS_MESSAGING.append("paths");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15157.java