error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3797.java
text:
```scala
i@@f (previousOrgId != organization.getId())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3797.java