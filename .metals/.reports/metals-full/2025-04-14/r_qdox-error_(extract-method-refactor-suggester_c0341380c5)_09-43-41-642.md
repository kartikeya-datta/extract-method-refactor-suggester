error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13939.java
text:
```scala
C@@omponentAndInterface cai = directComponentRefs.get(uid);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13939.java