error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8687.java
text:
```scala
c@@ommentListView.modelChangedStructure();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8687.java