error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9252.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9252.java
text:
```scala
t@@ype = Class.forName(str.substring(0, dash), true, loader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9252.java