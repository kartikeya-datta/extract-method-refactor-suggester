error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1170.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1170.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1170.java
text:
```scala
i@@nt y = bottom.getBounds().y - BORDER_STRIPE - 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1170.java