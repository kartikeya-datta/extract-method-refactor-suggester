error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3781.java
text:
```scala
i@@f (QueryFilter.isRelevant(column, container, gcBefore))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3781.java