error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6933.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6933.java
text:
```scala
A@@rray<AssetDescriptor> dependencies = new Array<AssetDescriptor>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6933.java