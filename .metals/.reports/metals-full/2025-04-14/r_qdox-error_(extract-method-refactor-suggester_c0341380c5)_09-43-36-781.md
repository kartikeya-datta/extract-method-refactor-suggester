error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1261.java
text:
```scala
t@@his.mutated = cache.getCacheConfiguration().transaction().transactionMode().isTransactional() ? new AtomicBoolean(false) : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1261.java