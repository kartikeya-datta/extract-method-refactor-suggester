error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16926.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16926.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16926.java
text:
```scala
s@@etup.append(InstructionFactory.createDup(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16926.java