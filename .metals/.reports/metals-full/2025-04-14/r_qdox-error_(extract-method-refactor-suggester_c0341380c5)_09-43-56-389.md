error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6658.java
text:
```scala
r@@eturn new String[] {"Selection", "Text", "ToolTipText"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6658.java