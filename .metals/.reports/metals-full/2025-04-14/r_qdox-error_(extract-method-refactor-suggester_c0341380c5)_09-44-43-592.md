error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8970.java
text:
```scala
d@@eploymentUnit.removeAttachment(EjbDeploymentAttachmentKeys.APPLICATION_EXCEPTION_DETAILS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8970.java