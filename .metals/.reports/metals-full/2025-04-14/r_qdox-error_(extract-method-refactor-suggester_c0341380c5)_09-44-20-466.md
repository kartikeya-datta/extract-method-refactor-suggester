error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14467.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14467.java
text:
```scala
r@@eturn new StringBuilder().append("[SortParam property=").append(getProperty()).append(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14467.java