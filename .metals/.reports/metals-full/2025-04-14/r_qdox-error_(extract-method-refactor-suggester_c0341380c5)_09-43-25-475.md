error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6217.java
text:
```scala
r@@c = AppShell.Create(0, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6217.java