error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10442.java
text:
```scala
_@@typeCache.put(type, Integer.valueOf(_typeHash));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10442.java