error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6720.java
text:
```scala
B@@ytesStreamOutput out = CachedStreamOutput.popEntry().cachedBytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6720.java