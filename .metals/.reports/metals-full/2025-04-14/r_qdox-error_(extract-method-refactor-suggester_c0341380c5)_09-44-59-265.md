error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12009.java
...
```java
offset: 20
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12009.java
text:
```scala
protected abstract A@@bstractSubsystemAdd<E> getAdd();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12009.java