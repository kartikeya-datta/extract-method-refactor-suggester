error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2051.java
text:
```scala
D@@ocsEnum de = te.docs(null, null, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2051.java