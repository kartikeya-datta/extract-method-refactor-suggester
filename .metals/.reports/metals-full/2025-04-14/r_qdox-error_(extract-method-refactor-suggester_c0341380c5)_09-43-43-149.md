error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16637.java
text:
```scala
a@@ddComponent(component.getMarkupId(), component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16637.java