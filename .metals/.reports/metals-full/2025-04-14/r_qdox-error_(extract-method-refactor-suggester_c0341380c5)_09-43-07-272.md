error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2592.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2592.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2592.java
text:
```scala
i@@f ((superInterface.modifiers & AccInterface) == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2592.java