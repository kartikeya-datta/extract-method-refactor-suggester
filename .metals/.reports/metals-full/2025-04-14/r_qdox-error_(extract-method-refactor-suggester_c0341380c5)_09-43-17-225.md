error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/293.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/293.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/293.java
text:
```scala
r@@eturn (jlong) buffer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/293.java