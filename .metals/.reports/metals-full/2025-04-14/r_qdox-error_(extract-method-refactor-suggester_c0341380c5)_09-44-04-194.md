error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2691.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2691.java
text:
```scala
i@@f (i == 0 && this.resolvedType.isTypeVariable() && ((TypeVariableBinding) this.resolvedType).firstBound == null) { // cannot select from a type variable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2691.java