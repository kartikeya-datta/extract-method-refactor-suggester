error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6429.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6429.java
text:
```scala
i@@f (wrap) return 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6429.java