error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7590.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7590.java
text:
```scala
O@@bject uid = folder.addMessage(message.getSourceStream());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7590.java