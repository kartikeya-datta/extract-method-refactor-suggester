error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2195.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2195.java
text:
```scala
protected final V@@alidationState fValidationState = new ValidationState();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2195.java