error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7533.java
text:
```scala
b@@ean = (Stateful) new InitialContext().lookup("java:app/stateful/StatefulBean!" + Stateful.class.getCanonicalName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7533.java