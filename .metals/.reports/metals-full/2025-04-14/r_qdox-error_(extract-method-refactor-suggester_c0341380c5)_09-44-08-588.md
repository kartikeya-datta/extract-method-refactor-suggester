error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4025.java
text:
```scala
g@@etFrameMediator().getContainer().close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4025.java