error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17203.java
text:
```scala
i@@f (bundle != null) vector.addElement(getProgram(bundle));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17203.java