error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14641.java
text:
```scala
t@@extFileChange.addEdit(AnnotationUtils.createAddImportTextEdit(myPackage, XmlSchema.class.getCanonicalName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14641.java