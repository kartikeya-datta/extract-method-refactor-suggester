error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/96.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/96.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/96.java
text:
```scala
f@@.setStringValue(s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/96.java