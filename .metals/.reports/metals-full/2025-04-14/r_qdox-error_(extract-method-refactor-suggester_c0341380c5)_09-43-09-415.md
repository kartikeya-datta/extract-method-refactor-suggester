error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7903.java
text:
```scala
s@@uper.setY(y + region.offsetY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7903.java