error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1310.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1310.java
text:
```scala
protected b@@oolean isClosing() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1310.java