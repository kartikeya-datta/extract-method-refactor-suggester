error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5086.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5086.java
text:
```scala
...
/**
 */
class TransactionSubsystem13Parser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<SubsystemMarshallingContext> {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5086.java