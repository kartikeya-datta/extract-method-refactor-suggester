error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1766.java
text:
```scala
c@@omponentData.size = component.getSizeInBytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1766.java