error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8994.java
text:
```scala
p@@age.closePerspective(persp, true,true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8994.java