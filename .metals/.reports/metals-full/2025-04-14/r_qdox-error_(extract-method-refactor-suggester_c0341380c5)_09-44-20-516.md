error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15378.java
text:
```scala
r@@eturn matched.toArray(new Field[matched.size()]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15378.java