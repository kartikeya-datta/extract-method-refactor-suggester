error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2616.java
text:
```scala
s@@tate.directory, state.fieldInfos, state.segmentInfo,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2616.java