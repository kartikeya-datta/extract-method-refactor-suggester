error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3708.java
text:
```scala
E@@xternalMusicTest.class, SoftKeyboardTest.class, DirtyRenderingTest.class, YDownTest.class,  BatchRenderTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3708.java