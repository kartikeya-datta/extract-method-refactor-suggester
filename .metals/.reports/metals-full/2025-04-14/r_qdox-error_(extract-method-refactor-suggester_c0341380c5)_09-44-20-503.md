error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7552.java
text:
```scala
s@@uper(NAMESPACE, makeAttributeQName(prefix), namespaceURI, null, true, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7552.java