error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12479.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12479.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12479.java
text:
```scala
public static final C@@haracterHandler NOOP_CHARACTER_HANDLER = new CharacterHandler(){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12479.java