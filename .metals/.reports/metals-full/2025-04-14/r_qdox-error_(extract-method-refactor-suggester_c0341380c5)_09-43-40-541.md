error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5194.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5194.java
text:
```scala
protected T@@heoryAnchor invoke(TestMethod method) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5194.java