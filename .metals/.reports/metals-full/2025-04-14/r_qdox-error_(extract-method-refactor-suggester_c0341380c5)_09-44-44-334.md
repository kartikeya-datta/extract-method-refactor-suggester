error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9240.java
text:
```scala
T@@extButtonStyle style = skin.get(TextButtonStyle.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9240.java