error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7156.java
text:
```scala
i@@f (isPrimary || (root.isOnClasspath() && resource.isAccessible() && Util.isValidCompilationUnitName(workingCopy.getElementName()))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7156.java