error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5331.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5331.java
text:
```scala
r@@eturn cmdl.createClasspath().createPath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5331.java