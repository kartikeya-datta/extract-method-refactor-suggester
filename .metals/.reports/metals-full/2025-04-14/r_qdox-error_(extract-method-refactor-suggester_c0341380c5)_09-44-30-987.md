error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3778.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3778.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3778.java
text:
```scala
_@@initials[i] = nextValue(0, getJavaType(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3778.java