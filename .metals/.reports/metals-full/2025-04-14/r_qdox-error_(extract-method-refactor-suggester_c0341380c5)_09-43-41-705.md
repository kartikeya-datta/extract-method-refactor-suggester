error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3497.java
text:
```scala
p@@arent.gotError();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3497.java