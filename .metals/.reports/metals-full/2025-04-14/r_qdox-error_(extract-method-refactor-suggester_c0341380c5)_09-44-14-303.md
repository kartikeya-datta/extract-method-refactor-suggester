error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2532.java
text:
```scala
b@@oolean cache = true; // default to true, since anyhow NumericRangeFilter and TermFilter construct an OpenBitSet
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2532.java