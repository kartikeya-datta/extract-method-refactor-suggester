error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17574.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[56,80]

error in qdox parser
file content:
```java
offset: 1503
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17574.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17574.java