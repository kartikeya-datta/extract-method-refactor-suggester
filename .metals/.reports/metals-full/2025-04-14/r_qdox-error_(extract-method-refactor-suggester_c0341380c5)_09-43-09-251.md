error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5715.java
text:
```scala
r@@eturn !JavaModelManager.getJavaModelManager().getElementsOutOfSynchWithBuffers().contains(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5715.java