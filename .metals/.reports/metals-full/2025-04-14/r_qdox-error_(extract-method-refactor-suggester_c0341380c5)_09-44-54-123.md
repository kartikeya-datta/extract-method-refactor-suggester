error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5831.java
text:
```scala
p@@rofileNames = CLITestSuite.serverProfiles.keySet().toArray(new String[] {});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5831.java