error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5913.java
text:
```scala
r@@eturn isLocal(((ParameterizedTypeBinding)binding).genericType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5913.java