error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7516.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7516.java
text:
```scala
a@@ssertFalse(RFC4180.getIgnoreEmptyLines());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7516.java