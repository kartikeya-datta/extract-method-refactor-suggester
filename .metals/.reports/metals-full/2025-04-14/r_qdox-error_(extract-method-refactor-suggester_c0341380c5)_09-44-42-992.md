error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16388.java
...
```java
offset: 2
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16388.java
text:
```scala
!I@@mplHelper.isManagedType(_conf, cls))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16388.java