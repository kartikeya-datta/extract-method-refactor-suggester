error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/965.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/965.java
text:
```scala
public M@@essage getMessage(Integer protocolVersion) throws IOException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/965.java