error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2363.java
text:
```scala
u@@u = new UnicodeUnescaper(UnicodeUnescaper.OPTION.escapePlus);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2363.java