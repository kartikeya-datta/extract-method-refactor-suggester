error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6668.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6668.java
text:
```scala
private static final S@@tring fileRegexp = "[0-9]+~*";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6668.java