error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9123.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9123.java
text:
```scala
private static S@@tring className = "org.objectweb.jeremie.binding.moa.UnicastRemoteObject";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9123.java