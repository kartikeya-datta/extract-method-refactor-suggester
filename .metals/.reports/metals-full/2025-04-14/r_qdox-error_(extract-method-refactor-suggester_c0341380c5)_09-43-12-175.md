error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6234.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6234.java
text:
```scala
public final v@@oid add(FeedbackMessage message)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6234.java