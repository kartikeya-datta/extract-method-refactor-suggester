error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9539.java
text:
```scala
i@@f (((TreeSelectionChangedEvent) e).getSelected().length == 1 && ((TreeSelectionChangedEvent) e).getSelected()[0].getAllowsChildren()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9539.java