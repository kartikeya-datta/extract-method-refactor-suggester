error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14052.java
text:
```scala
Z@@ipFileIterator(ZipFile in) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14052.java