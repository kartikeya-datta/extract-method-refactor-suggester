error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6552.java
text:
```scala
r@@eturn gdxBulletJNI.ContactAddedListenerByObject_onContactAdded(swigCPtr, this, cp, btCollisionObject.getCPtr(colObj0), colObj0, partId0, index0, match0, btCollisionObject.getCPtr(colObj1), colObj1, partId1, index1, match1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6552.java