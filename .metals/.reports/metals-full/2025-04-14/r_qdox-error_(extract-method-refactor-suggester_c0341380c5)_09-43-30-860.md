error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7792.java
text:
```scala
g@@utterHighlight.getSelectedColor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7792.java