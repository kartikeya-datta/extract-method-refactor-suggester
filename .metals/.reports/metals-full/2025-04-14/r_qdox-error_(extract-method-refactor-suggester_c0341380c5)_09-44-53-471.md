error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7225.java
text:
```scala
o@@ldFlags.setRecent(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7225.java