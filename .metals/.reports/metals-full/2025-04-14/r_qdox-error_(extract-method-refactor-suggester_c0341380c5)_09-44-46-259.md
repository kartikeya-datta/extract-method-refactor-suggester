error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7.java
text:
```scala
final R@@ootDeploymentUnitService service = new RootDeploymentUnitService(deploymentUnitName, deploymentElement.getRuntimeName(), deploymentElement.getSha1Hash(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7.java