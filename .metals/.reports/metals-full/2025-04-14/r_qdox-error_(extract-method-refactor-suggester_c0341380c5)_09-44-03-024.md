error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/404.java
text:
```scala
A@@llocateDangledRequest request = new AllocateDangledRequest(clusterService.localNode(), indices);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/404.java