error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7957.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7957.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7957.java
text:
```scala
static M@@odelNode getOperation(ModelNode address) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7957.java