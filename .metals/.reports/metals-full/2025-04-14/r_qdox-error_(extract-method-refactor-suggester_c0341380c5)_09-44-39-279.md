error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10321.java
text:
```scala
h@@Item = OS.SendMessage (handle, OS.TVM_GETNEXTITEM, OS.TVGN_NEXTVISIBLE, hItem);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10321.java