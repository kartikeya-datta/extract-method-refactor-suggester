error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5672.java
text:
```scala
S@@erverXmlReader sxmlConf=new ServerXmlReader();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5672.java