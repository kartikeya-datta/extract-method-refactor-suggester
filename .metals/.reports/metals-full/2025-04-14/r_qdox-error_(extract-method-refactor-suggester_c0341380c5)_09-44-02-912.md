error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3785.java
text:
```scala
r@@eturn (long) buffer;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3785.java