error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11153.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11153.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11153.java
text:
```scala
t@@his(ModelControllerClient.Factory.create(InetAddress.getByName("localhost"), 9999, DemoAuthentication.getCallbackHandler()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11153.java