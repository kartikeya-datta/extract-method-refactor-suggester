error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5502.java
...
```java
offset: 10
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5502.java
text:
```scala
+ "!/" + n@@ame;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5502.java