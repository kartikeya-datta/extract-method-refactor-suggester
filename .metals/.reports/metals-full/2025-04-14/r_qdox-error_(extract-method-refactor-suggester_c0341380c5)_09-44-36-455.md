error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7550.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7550.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7550.java
text:
```scala
s@@uper(ENTITY_DECLARATION, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7550.java