error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8971.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8971.java
text:
```scala
"moduleClass=" + m@@oduleClass + " ClassLoader " + moduleClass.getClassLoader() +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8971.java