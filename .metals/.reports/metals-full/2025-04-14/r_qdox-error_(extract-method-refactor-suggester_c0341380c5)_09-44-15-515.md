error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4711.java
text:
```scala
p@@arser.parseCompilationUnit(compilationUnit, true/*full parse*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4711.java