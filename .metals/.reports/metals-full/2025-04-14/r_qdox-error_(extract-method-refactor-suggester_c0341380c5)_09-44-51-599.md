error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8518.java
text:
```scala
r@@eturn new StoreFilesMetaData(true, shardId, indexShard.store().list());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8518.java