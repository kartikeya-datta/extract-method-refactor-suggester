error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10469.java
text:
```scala
i@@nt cap = attributes.cap;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10469.java