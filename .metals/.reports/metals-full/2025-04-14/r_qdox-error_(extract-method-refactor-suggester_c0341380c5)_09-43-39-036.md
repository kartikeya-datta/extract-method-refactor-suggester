error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9738.java
text:
```scala
M@@ethod method = JmxTestBean.class.getMethod("dontExposeMe");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9738.java