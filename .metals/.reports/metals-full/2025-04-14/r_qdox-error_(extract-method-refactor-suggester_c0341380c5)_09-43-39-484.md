error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5757.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5757.java
text:
```scala
public i@@nt[] dashes;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5757.java