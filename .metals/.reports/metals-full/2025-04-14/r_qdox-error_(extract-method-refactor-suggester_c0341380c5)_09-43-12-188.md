error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14123.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14123.java
text:
```scala
private static final i@@nt FOUR_YEARS = 365 * 3 + 366;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14123.java