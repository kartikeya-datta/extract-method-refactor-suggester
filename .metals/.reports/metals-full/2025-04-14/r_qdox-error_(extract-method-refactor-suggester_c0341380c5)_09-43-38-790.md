error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7986.java
text:
```scala
i@@f (OS.IsWindowEnabled (handle) && !hooks (SWT.EraseItem)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7986.java