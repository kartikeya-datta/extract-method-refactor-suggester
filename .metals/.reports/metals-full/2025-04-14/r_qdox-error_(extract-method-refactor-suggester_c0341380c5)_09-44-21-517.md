error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5662.java
text:
```scala
r@@oot.add(new FlickScrollPane(list)).expandY().fillY().prefWidth((int)list.getPrefWidth());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5662.java