error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12921.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12921.java
text:
```scala
private static final S@@tring RESOURCE_NAME = CommonDescriptions.class.getPackage().getName() + ".LocalDescriptions";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12921.java