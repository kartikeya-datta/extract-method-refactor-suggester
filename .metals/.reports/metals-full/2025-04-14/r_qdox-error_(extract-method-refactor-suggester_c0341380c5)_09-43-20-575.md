error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9530.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9530.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9530.java
text:
```scala
e@@mitters.add(new ParticleEmitter(effect.emitters.get(i)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9530.java