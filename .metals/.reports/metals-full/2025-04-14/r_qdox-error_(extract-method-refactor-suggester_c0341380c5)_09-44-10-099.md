error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2299.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2299.java
text:
```scala
public static final S@@tring DISCOVERY_NAMING_AUTHORITY = "ecf.endpoint.discovery.namingauthority";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2299.java