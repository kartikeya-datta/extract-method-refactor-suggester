error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4080.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4080.java
text:
```scala
g@@istId.setText("Gist " + gist.getId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4080.java