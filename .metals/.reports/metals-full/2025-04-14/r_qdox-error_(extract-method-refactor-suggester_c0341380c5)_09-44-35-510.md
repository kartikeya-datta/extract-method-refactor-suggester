error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1680.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1680.java
text:
```scala
M@@essageFolder child = (MessageFolder) folder.getChildAt(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1680.java