error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1119.java
text:
```scala
r@@eturn new ContextWrapper(env);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1119.java