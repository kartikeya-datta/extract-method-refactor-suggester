error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1285.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1285.java
text:
```scala
public static final P@@athElement PATH = PathElement.pathElement(CommonAttributes.PARAM);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1285.java