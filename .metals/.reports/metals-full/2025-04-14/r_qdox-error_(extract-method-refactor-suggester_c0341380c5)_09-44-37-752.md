error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3979.java
text:
```scala
b@@oolean mouseEvent (int /*long*/ id, int /*long*/ sel, int /*long*/ theEvent, int type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3979.java