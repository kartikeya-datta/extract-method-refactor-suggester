error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7341.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7341.java
text:
```scala
B@@celWorld world = super.world;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7341.java