error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3783.java
text:
```scala
p@@arser.setRequestor(requestor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3783.java