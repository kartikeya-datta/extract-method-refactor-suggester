error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8731.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8731.java
text:
```scala
static final S@@tring VERSION = "1.9.20040211";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8731.java