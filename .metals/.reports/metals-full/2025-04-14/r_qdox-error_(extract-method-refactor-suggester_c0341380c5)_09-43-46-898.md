error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2942.java
text:
```scala
i@@f (monitor.isCanceled() || !isRunning()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2942.java