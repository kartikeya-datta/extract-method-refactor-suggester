error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16428.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16428.java
text:
```scala
private static final S@@tring SMACK_VERSION = "2.2.1";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16428.java