error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5733.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5733.java
text:
```scala
A@@nnotationComponentValue value = new AnnotationComponentValue(classFileBytes, constantPool, offset + this.readOffset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5733.java