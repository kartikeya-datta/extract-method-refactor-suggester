error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6763.java
text:
```scala
r@@eq = url.toExternalForm() + "secured/j_security_check";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6763.java