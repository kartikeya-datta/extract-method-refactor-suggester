error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14728.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14728.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14728.java
text:
```scala
s@@ingleton.setElectionPolicy(new PreferredSingletonElectionPolicy(new NamePreference(PREFERRED_NODE + "/" + SingletonService.DEFAULT_CONTAINER), new SimpleSingletonElectionPolicy()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14728.java