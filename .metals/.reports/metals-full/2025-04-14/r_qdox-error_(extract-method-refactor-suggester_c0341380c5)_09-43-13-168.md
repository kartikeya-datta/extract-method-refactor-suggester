error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2263.java
text:
```scala
l@@ogger.info(String.format("[repair #%s] Cannot proceed on repair because a neighbor (%s) is dead: session failed", getName(), endpoint));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2263.java