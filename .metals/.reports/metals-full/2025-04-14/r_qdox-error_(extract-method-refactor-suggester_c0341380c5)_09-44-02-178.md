error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/396.java
text:
```scala
C@@olumbaHeader strippedHeader = CachedHeaderfieldOwner.stripHeaders(h);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/396.java