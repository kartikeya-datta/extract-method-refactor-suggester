error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6867.java
text:
```scala
r@@eturn new Field(names.indexName(), value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6867.java