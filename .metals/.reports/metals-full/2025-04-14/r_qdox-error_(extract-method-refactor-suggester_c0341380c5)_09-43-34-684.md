error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4108.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4108.java
text:
```scala
public static final b@@yte[] EMPTY_BA = new byte[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4108.java