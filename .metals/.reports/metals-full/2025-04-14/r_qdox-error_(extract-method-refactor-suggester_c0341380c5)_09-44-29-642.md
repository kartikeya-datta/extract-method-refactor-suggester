error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11760.java
text:
```scala
p@@ublic class RadioGroupTestPage2 extends WebPage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11760.java