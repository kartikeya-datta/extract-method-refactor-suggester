error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11946.java
...
```java
offset: 709
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11946.java
text:
```scala
...
p@@ackage org.springframework.messaging.simp.handler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11946.java