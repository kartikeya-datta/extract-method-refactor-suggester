error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3792.java
text:
```scala
s@@m.setNextVersion(version);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3792.java