error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4759.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4759.java
text:
```scala
r@@eturn qualification.toString(0)+".this" ; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4759.java