error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1946.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1946.java
text:
```scala
public C@@omponent createComponent(String id, DebugBar debugBar) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1946.java