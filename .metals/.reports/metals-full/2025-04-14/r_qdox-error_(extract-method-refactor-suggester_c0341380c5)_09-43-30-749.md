error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10387.java
text:
```scala
s@@uper(request, nodeId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10387.java