error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9590.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9590.java
text:
```scala
t@@his.ast = workingCopy.makeConsistent(this.astLevel, this.resolveBindings, this.enableStatementsRecovery, this.problems, this.progressMonitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9590.java