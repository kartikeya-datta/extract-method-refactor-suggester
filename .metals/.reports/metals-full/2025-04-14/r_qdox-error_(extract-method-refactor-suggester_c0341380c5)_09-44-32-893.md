error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1230.java
text:
```scala
n@@ew PatternLayout("LOG4J-INTERNAL: %d %level [%t] %c#%M:%L)- %m%n"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1230.java