error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2040.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2040.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2040.java
text:
```scala
public S@@tring suffixRobovm = "-robovm";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2040.java