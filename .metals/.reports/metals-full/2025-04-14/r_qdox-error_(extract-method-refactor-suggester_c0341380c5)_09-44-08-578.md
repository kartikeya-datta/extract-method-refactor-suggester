error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5751.java
text:
```scala
A@@ssert.assertEquals(getCompareStackAsString(stack) + ": " + node1 + "\n" + node2, keys1.toString(), keys2.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5751.java