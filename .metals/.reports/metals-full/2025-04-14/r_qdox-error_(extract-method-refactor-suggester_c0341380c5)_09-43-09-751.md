error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12750.java
text:
```scala
i@@njectable.inject(new ValueManagedReferenceFactory(new ImmediateValue<Object>(value)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12750.java