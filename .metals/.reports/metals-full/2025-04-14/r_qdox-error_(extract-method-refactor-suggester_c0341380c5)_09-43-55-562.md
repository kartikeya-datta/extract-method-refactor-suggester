error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4034.java
text:
```scala
t@@his.runnable.run(this.progressMonitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4034.java