error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8013.java
text:
```scala
i@@f (lineRunCount == 1 && (i == allRuns.length - 1 || !run.softBreak)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8013.java