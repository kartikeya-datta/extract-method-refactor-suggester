error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3373.java
text:
```scala
S@@tring[] resolveMessageCodes(String errorCode, String objectName, String field, Class<?> fieldType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3373.java