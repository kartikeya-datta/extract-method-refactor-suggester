error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14033.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14033.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14033.java
text:
```scala
T@@oolTip toolTip = shell.findToolTip ((int)/*64*/hdr.idFrom);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14033.java