error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6446.java
text:
```scala
a@@dd(new ErrorIndicator("errorIndicator"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6446.java