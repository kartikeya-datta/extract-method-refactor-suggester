error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16958.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16958.java
text:
```scala
protected S@@tring getOnClickScript(CharSequence url)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16958.java