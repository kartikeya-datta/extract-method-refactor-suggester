error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5378.java
text:
```scala
i@@ndexShard.flush(new Engine.Flush().refresh(request.refresh()).type(request.full() ? Engine.Flush.Type.NEW_WRITER : Engine.Flush.Type.COMMIT_TRANSLOG).force(request.force()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5378.java