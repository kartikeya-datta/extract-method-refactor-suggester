error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14337.java
text:
```scala
i@@nt /*long*/ topHandle = topHandle ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14337.java