error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2917.java
text:
```scala
i@@f (!DocIdSets.isFastIterator(ApplyAcceptedDocsFilter.unwrap(docIdSet))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2917.java