error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7750.java
text:
```scala
f@@or (int i = memberTypes.length; --i >= 0;)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7750.java