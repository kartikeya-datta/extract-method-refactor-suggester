error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8839.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8839.java
text:
```scala
public final I@@StructureModelListener VIEW_LISTENER = new IStructureModelListener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8839.java