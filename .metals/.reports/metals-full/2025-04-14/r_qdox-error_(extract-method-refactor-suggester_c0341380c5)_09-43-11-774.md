error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2878.java
text:
```scala
a@@bscissa, i1, i2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2878.java