error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12065.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12065.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12065.java
text:
```scala
g@@etCallbackUrl(true), constructSettingsJS(), indicatorId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12065.java