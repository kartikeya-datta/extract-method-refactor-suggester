error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7014.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7014.java
text:
```scala
public S@@ession getSession()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7014.java