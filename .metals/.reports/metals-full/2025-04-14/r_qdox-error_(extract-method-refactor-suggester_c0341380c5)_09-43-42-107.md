error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1142.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1142.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1142.java
text:
```scala
c@@ontroller.updateComponents(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1142.java