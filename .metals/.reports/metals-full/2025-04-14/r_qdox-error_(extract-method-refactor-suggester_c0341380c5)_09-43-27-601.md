error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/843.java
text:
```scala
R@@esourceManager resourceManager = new ServletResourceManager(deploymentRoot, overlays, explodedDeployment, mergedMetaData.isSymbolicLinkingEnabled());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/843.java