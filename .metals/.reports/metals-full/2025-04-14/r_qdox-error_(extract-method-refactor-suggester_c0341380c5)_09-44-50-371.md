error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13230.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13230.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13230.java
text:
```scala
s@@croller = (NSScroller)new SWTScroller().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13230.java