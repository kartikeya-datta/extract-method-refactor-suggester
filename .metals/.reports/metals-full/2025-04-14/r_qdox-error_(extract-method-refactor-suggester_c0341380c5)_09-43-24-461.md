error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15209.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15209.java
text:
```scala
...
public class ColognePhoneticTest extends StringEncoderAbstractTest {
    ...
    public void testExamples() {
        ...
        String[][] data = { { "MÃ¼ller-LÃ¼denscheidt", "65752682" },
    ...
    public void testIsCologneEquals() {
        ...
        assertFalse("Cologne-phonetic encodings should not be equal",
                koellePhon.isCologneEqual("Meyer", "MÃ¼ller"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15209.java