error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1025.java
text:
```scala
a@@nonymousClassDeclaration.resolveBinding();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1025.java