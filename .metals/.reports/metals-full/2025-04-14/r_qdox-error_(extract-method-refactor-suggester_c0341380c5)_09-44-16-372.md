error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11027.java
text:
```scala
v@@oid emitBatch(TransactionAttempt tx, X coordinatorMeta, BatchOutputCollector collector);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11027.java