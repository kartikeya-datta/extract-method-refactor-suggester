error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12548.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12548.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12548.java
text:
```scala
p@@refix.append(".").append(kp);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12548.java