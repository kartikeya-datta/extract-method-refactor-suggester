error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6070.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6070.java
text:
```scala
static i@@nt MINOR_VERSION = 621;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6070.java