error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1092.java
text:
```scala
i@@f ((deploymentUnit.getName().contains(".") && ! deploymentUnit.getName().endsWith(".jar")) || driverNames.size() != 1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1092.java