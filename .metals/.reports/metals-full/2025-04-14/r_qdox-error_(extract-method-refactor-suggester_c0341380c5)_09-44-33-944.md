error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5410.java
text:
```scala
m@@enuItem.setText(WorkbenchMessages.getString("ViewPane.minimizeView")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5410.java