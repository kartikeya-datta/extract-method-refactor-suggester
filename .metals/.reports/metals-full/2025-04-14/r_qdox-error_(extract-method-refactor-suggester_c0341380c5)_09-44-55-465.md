error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1042.java
text:
```scala
A@@ssert.assertEquals(309, LocalizedFormats.values().length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1042.java