error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/389.java
text:
```scala
s@@canner.setSource(tokenSource);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/389.java