error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/44.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/44.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/44.java
text:
```scala
S@@erviceName clusteringServiceName = name.append("clustering");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/44.java