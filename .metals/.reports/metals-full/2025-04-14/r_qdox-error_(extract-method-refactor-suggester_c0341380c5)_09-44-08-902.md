error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1197.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1197.java
text:
```scala
r@@eturn Util.bind("operation.createImportsProgress"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1197.java