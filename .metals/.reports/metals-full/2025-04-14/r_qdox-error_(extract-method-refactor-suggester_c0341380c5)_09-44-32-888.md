error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1803.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1803.java
text:
```scala
public static final S@@tring NAME = "cluster:monitor/nodes/stats";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1803.java