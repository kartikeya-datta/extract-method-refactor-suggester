error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2746.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2746.java
text:
```scala
public static final S@@tring PLUGIN_SCOPE = "org.eclipse.ui.components.plugin"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2746.java