error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/47.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/47.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/47.java
text:
```scala
L@@ist allBreadCrumbParticipants();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/47.java