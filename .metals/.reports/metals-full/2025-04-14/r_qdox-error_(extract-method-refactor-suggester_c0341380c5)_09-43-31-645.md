error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9515.java
text:
```scala
m@@yBorder.addToBorderBody(new AjaxLink<Void>("ajaxLink")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9515.java