error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12366.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12366.java
text:
```scala
public v@@oid write(final CharSequence string)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12366.java