error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7361.java
text:
```scala
C@@ommandLine line = parser.parse(options, args, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7361.java