error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3879.java
text:
```scala
t@@hrow new IllegalStateException("Can only have one occurance of <?" + TemplateParser.EXTENSIONS_PI + "?>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3879.java