error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8044.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8044.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8044.java
text:
```scala
c@@odeFormatter = new DefaultCodeFormatter(options);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8044.java