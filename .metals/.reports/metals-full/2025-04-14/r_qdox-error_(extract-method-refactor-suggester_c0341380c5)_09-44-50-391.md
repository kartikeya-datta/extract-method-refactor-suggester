error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1274.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1274.java
text:
```scala
final b@@tRigidBody body = btRigidBody.upcast(obj);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1274.java