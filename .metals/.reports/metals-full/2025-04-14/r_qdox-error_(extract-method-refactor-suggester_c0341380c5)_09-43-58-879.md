error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6391.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6391.java
text:
```scala
final S@@tring configPropertyValue = CONNECTION_PROPERTY_VALUE.resolveModelAttribute(context, recoveryEnvModel).asString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6391.java