error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4869.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4869.java
text:
```scala
l@@ookup = project.getNameLookup();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4869.java