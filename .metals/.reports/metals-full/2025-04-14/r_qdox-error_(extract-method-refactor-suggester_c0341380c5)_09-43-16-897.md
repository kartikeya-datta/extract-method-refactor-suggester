error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10606.java
text:
```scala
t@@his.invoker.invoke(this.attributeCache, attributeOperation, Flag.IGNORE_RETURN_VALUES, Flag.SKIP_LOCKING);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10606.java