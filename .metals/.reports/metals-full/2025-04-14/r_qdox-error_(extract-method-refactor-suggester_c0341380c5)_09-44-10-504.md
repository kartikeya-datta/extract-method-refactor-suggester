error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1557.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1557.java
text:
```scala
public S@@tring androidMinSdkVersion = "8";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1557.java