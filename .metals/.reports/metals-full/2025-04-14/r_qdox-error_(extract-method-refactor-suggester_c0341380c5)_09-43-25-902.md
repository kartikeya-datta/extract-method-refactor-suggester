error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9265.java
text:
```scala
b@@oolean isClassReloadable(Class<?> clazz);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9265.java