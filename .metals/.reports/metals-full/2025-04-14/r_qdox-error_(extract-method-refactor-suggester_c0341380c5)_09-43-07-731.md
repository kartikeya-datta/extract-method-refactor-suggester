error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1568.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1568.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1568.java
text:
```scala
c@@lusterService.submitStateUpdateTask("indices_store", new ClusterStateNonMasterUpdateTask() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1568.java