error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17263.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17263.java
text:
```scala
public v@@oid setLength(float /*double*/ length) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17263.java