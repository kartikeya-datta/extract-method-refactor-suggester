error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1584.java
text:
```scala
E@@mbeddedXADataSource is Derby's XADataSource implementation for JDBC3.0 and JDBC2.0.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1584.java