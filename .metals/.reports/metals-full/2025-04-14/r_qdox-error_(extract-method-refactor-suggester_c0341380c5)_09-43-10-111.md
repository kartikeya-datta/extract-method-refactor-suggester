error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3813.java
text:
```scala
w@@ar.addAsWebInfResource(WebXml.get("<servlet-mapping>\n" +
 ...
 */
package org.jboss.as.testsuite.integration.jaxrs.atom;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3813.java