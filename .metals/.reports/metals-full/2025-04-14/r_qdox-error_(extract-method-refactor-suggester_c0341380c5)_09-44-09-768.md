error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3429.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3429.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3429.java
text:
```scala
public static final I@@nterceptorFactory FACTORY = new ImmediateInterceptorFactory(new SFSBPreCreateInterceptor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3429.java