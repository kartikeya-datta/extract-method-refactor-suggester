error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5546.java
text:
```scala
N@@inePatch patch = skin.getPatch("default-round");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5546.java