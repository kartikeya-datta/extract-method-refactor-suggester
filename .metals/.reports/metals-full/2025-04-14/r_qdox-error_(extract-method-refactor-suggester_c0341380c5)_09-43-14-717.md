error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2901.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2901.java
text:
```scala
1234567)@@;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2901.java