error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3693.java
text:
```scala
r@@eturn number.longValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3693.java