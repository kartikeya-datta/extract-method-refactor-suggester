error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8355.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8355.java
text:
```scala
public S@@hadowMunger concretize(ResolvedType fromType, World world, PerClause clause) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8355.java