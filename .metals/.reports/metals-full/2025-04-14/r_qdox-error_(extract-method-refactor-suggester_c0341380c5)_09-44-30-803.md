error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10475.java
text:
```scala
t@@his.resourcesCurrentlyBeingLoaded.remove();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10475.java