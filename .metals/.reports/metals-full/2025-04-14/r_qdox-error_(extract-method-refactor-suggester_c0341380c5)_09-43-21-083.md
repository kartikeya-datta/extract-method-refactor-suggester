error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/404.java
text:
```scala
b@@ehavior.getCallbackUrl(false).toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/404.java