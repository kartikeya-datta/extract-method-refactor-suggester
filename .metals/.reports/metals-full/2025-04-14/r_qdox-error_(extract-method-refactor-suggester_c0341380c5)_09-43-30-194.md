error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/972.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/972.java
text:
```scala
static A@@ttributeDefinition[] ATTRIBUTES = { SOCKET_BINDING };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/972.java