error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/977.java
text:
```scala
d@@etachedWindowShells = new ShellPool(shell, SWT.TOOL | SWT.TITLE | SWT.MAX | SWT.RESIZE | getDefaultOrientation());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/977.java