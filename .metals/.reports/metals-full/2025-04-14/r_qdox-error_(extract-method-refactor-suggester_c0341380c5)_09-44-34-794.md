error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15520.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15520.java
text:
```scala
public static final S@@tring DEFAULT_CLASS = "org.apache.jmeter.protocol.http.util.accesslog.TCLogParser"; // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15520.java