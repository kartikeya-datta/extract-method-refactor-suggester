error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6697.java
text:
```scala
I@@Type innerType = new BinaryType((JavaElement)parentClassFile, ClassFile.simpleName(binaryType.getName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6697.java