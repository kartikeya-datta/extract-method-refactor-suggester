error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4637.java
text:
```scala
k@@eyValues = keyIndexFieldData.load(context).getBytesValues(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4637.java