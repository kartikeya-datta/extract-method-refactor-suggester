error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9958.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9958.java
text:
```scala
static final A@@ttributeDefinition[] WRITABLE_ATTRIBUTES = Logging.join(DEFAULT_ATTRIBUTES, NAMED_FORMATTER, PROPERTIES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9958.java