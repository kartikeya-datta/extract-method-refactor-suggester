error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12958.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12958.java
text:
```scala
public P@@ollingServerSockJsSession createSession(String sessionId, WebSocketHandler handler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12958.java