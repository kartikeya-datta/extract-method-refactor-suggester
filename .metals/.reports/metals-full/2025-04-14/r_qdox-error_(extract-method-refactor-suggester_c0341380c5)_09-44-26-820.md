error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14334.java
text:
```scala
n@@ew SimpleListView<ListObject>(this, "rows2", data)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14334.java