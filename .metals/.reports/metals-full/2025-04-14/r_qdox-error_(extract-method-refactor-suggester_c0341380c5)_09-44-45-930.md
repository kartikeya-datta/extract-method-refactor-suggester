error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1721.java
text:
```scala
c@@reateIndex("test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1721.java