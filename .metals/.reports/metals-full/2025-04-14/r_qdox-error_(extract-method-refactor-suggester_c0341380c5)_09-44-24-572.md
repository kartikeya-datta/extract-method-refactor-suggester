error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1454.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1454.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1454.java
text:
```scala
r@@eturn qualification.toString(0)+".super" ; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1454.java