error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8464.java
text:
```scala
g@@lHandle = createGLHandle();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8464.java