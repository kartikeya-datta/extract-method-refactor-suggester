error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1513.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1513.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1513.java
text:
```scala
L@@ist<DoubleEntry> ordered = new ArrayList<DoubleEntry>(map.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1513.java