error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13466.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[76,2]

error in qdox parser
file content:
```java
offset: 2370
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13466.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13466.java