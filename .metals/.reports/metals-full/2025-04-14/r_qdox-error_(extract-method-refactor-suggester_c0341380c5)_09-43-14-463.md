error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8593.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8593.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8593.java
text:
```scala
i@@f ((importRef.bits & ASTNode.OnDemand) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8593.java