error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4616.java
text:
```scala
r@@eturn repository.isFork() || repository.getForks() > 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4616.java