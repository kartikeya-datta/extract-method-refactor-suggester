error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/520.java
text:
```scala
M@@odelNode classNameNode = HandlerResourceDefinition.CLASS_NAME.resolveModelAttribute(context, model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/520.java