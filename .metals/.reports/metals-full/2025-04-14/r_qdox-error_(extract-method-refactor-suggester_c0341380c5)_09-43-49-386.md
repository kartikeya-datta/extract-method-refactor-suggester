error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14384.java
text:
```scala
o@@peration.get(DESCRIPTION).set(bundle.getString("resource-adapter.add"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14384.java