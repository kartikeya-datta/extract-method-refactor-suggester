error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11226.java
text:
```scala
r@@eturn undertowHost.getServer().getListeners().get(0).getBinding().getValue().getAbsolutePort();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11226.java