error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18304.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18304.java
text:
```scala
private static final N@@umberFieldErrorListener listener = new NumberFieldErrorListener();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18304.java