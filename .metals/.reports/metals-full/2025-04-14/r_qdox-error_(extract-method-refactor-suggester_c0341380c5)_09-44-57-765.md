error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/197.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/197.java
text:
```scala
final O@@ptionMap connectionCreationOptions = ConnectorUtils.getOptions(context, fullModel.get(CommonAttributes.PROPERTY));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/197.java