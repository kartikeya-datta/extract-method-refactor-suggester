error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7168.java
text:
```scala
i@@f (children == null || file.isFile()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7168.java