error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/615.java
text:
```scala
p@@ublic class CollectionModel<T> extends GenericBaseModel<Collection<T>>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/615.java