error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8162.java
text:
```scala
J@@avaModelManager.getJavaModelManager().getDeltaProcessor().addForRefresh(javaBuilder.javaProject);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8162.java