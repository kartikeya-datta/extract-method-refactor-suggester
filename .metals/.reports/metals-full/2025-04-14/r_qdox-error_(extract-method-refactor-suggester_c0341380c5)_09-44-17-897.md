error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5155.java
text:
```scala
s@@uper(mapper, mapper.fieldType().stored() ? Numbers.doubleToBytes(number) : null, fieldType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5155.java