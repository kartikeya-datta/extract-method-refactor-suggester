error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7036.java
text:
```scala
r@@eturn this.factory.createBuffer(workingCopy); // TODO (jerome) change to use a org.eclipse.text buffer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7036.java