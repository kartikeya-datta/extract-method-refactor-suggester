error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9435.java
text:
```scala
s@@tateIndexService.openIndex(new MetaDataStateIndexService.Request(request.indices()).timeout(request.timeout()).masterTimeout(request.masterNodeTimeout()), new MetaDataStateIndexService.Listener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9435.java