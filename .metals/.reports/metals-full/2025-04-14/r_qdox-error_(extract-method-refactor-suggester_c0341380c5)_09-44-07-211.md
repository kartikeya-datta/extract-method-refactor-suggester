error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6587.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6587.java
text:
```scala
r@@eturn value != null?value.trim():null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6587.java