error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7750.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7750.java
text:
```scala
private final static b@@yte[] CRLF = { 0x0d, 0x0A };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7750.java