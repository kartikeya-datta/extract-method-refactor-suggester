error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4355.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4355.java
text:
```scala
i@@nt findTag(final String path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4355.java