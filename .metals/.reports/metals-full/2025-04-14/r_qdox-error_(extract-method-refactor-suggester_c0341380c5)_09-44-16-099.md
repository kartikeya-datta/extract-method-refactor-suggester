error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6737.java
text:
```scala
P@@latformMBeanUtil.getResolver("garbage-collectors"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6737.java