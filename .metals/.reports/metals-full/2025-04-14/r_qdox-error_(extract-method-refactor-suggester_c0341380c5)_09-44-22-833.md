error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17030.java
text:
```scala
s@@toreEx.setFatal(!recoverable);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17030.java