error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14921.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14921.java
text:
```scala
i@@f (TypedValue.NULL.equals(typedValue)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14921.java