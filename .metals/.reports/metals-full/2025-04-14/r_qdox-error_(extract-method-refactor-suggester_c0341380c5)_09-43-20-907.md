error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7878.java
text:
```scala
g@@etWizardModel().finish();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7878.java