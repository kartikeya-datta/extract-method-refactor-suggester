error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5099.java
text:
```scala
b@@igArrays, threadPool.estimatedTimeInMillisCounter()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5099.java