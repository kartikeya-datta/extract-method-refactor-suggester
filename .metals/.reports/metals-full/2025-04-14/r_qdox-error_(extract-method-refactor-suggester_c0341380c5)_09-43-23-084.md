error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7947.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7947.java
text:
```scala
t@@his.flushThresholdOperations = componentSettings.getAsInt(FLUSH_THRESHOLD_OPS_KEY, componentSettings.getAsInt("flush_threshold", 5000));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7947.java