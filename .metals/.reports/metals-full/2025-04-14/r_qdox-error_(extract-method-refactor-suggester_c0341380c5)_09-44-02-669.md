error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2130.java
text:
```scala
i@@f (styledText != null && styledText.isFixedLineHeight()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2130.java