error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2637.java
text:
```scala
i@@nputProcessor.touchDragged(event.x, event.y, event.pointer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2637.java