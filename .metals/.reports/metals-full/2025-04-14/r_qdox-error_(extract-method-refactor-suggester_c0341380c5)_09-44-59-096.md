error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9661.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9661.java
text:
```scala
protected O@@bject resolveStandardArgument(Class<?> parameterType, NativeWebRequest webRequest) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9661.java