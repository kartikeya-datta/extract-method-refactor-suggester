error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8974.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8974.java
text:
```scala
t@@mp = new File(homeDir, standalone ? "standalone" : "domain/servers/" + serverName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8974.java