error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9748.java
text:
```scala
i@@tem.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9748.java