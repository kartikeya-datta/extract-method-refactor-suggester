error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4418.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4418.java
text:
```scala
i@@f (enclosingType.sourceName != null && enclosingType.sourceName.length == 0) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4418.java