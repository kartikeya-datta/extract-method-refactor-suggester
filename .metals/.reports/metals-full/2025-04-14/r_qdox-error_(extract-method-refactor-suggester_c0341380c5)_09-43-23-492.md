error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7650.java
text:
```scala
s@@rcDir = getBaseDirectory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7650.java