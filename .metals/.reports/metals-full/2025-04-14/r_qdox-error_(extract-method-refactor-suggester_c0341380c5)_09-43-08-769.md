error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7061.java
text:
```scala
C@@olumbaLogger.log.error(e + ": "+ next.getAttribute("action"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7061.java