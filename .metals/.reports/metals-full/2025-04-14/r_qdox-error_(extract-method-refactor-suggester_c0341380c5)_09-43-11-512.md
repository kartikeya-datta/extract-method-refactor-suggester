error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2010.java
text:
```scala
i@@nt destIndentLevel= Indents.measureIndentUnits(this.destinationIndent, this.tabWidth, this.indentWidth);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2010.java