error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5536.java
text:
```scala
s@@tr.append("TypedValue: ").append(this.value).append(" of type ").append(this.getTypeDescriptor().asString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5536.java