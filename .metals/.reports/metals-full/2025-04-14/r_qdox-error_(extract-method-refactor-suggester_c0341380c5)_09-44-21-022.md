error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3526.java
text:
```scala
m@@odel.getBoundingBox(bbox);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3526.java