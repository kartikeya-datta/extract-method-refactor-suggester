error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1780.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1780.java
text:
```scala
@Override protected C@@reateIndexResponse masterOperation(CreateIndexRequest request, ClusterState state) throws ElasticSearchException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1780.java