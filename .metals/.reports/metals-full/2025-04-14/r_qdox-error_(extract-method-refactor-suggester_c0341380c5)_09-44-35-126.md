error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10781.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10781.java
text:
```scala
public M@@ap<String, ?> getProperties();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10781.java