error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15922.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15922.java
text:
```scala
private final C@@oncurrentReaderHashMap classes = new ConcurrentReaderHashMap();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15922.java