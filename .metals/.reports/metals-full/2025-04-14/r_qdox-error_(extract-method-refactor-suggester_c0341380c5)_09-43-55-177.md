error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3434.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3434.java
text:
```scala
public static final A@@ctivateOperationHandler INSTANCE = new ActivateOperationHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3434.java