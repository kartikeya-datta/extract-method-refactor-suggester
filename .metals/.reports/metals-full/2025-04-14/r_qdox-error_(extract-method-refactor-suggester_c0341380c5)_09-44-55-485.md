error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6968.java
text:
```scala
n@@ew Term(UidFieldMapper.NAME, hitContext.fieldVisitor().uid().toBytesRef())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6968.java