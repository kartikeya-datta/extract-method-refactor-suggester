error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5372.java
text:
```scala
i@@nt /*long*/ pszText = OS.HeapAlloc (hHeap, OS.HEAP_ZERO_MEMORY, byteCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5372.java