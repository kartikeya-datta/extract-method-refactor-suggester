error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1334.java
text:
```scala
i@@f (value == null) throw XtsAsMessages.MESSAGES.xtsServiceIsNotStarted();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1334.java