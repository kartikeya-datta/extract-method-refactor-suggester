error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11662.java
text:
```scala
C@@lass<? extends Page<?>> getPageClass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11662.java