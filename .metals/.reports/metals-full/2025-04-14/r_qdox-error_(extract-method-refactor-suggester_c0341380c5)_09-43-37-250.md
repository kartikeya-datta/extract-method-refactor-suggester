error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/295.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/295.java
text:
```scala
r@@m.add(new QueryPath(columnFamilyName, null, "0".getBytes()), new byte[0], new TimestampClock(j));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/295.java