error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6653.java
text:
```scala
r@@eturn ProgressManagerUtil.EMPTY_OBJECT_ARRAY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6653.java