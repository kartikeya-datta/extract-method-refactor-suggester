error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1627.java
text:
```scala
w@@aitForConnected(Long.MAX_VALUE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1627.java