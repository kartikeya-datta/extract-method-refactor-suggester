error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2458.java
text:
```scala
c@@ompositeManifest.put(Constants.IMPORT_PACKAGE, "org.osgi.service.blueprint;version=\"[1.0.0,2.0.0)\", org.osgi.service.blueprint.container;version=1.0");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2458.java