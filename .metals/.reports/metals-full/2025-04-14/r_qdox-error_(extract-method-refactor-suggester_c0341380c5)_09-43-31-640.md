error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6693.java
text:
```scala
i@@f (destination != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6693.java