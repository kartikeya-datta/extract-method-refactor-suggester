error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1634.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1634.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1634.java
text:
```scala
i@@f (image != null) size.width += parent.imageBounds.width + Tree.IMAGE_GAP;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1634.java