error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1332.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1332.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1332.java
text:
```scala
t@@hrow XtsAsMessages.MESSAGES.txBridgeInboundRecoveryServiceFailedToStart();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1332.java