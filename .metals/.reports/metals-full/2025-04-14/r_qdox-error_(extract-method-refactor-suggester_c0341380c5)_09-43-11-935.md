error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9327.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9327.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9327.java
text:
```scala
c@@mdl.addArgument( params[ i ] );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9327.java