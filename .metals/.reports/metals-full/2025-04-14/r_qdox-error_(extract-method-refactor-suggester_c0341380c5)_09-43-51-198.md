error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2465.java
text:
```scala
A@@jde.getDefault().getEditorAdapter().showSourceLine(message.getSourceLocation(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2465.java