error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9580.java
text:
```scala
l@@istener.canceled();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9580.java