error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6772.java
text:
```scala
r@@eturn enhancer.getPCBytecode().toByteArray();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6772.java