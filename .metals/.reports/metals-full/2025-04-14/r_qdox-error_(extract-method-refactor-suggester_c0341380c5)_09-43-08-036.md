error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17599.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17599.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[355,80]

error in qdox parser
file content:
```java
offset: 11783
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17599.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17599.java