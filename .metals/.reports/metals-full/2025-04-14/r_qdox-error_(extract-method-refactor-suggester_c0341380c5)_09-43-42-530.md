error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6428.java
text:
```scala
b@@oolean direct = theConsole.hasConsole();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6428.java