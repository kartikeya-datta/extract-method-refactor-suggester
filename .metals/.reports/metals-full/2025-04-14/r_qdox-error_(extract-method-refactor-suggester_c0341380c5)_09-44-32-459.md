error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13303.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13303.java
text:
```scala
private A@@ccountManager accountManager = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13303.java