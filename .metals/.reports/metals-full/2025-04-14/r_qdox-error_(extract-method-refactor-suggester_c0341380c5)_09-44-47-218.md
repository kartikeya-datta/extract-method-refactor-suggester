error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2529.java
text:
```scala
t@@arget.add(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2529.java