error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10343.java
text:
```scala
R@@ectangle itemBounds = items [i].getCellBounds (0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10343.java