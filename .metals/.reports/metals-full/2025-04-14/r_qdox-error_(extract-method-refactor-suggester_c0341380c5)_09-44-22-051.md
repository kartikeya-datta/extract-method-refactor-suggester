error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/762.java
text:
```scala
t@@ypeBinding = ((ProblemReferenceBinding) typeBinding).closestMatch;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/762.java