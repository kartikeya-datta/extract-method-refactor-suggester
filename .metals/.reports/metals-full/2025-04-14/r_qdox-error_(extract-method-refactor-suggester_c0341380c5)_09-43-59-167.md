error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7424.java
text:
```scala
r@@eturn Signature.createMethodSignature(fParameterTypes, Signature.createTypeSignature(info.getReturnTypeName(), false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7424.java