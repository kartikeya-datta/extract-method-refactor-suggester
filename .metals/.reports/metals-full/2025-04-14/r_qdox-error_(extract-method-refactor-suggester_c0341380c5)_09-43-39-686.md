error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10197.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10197.java
text:
```scala
public static final I@@nfinispanModel CURRENT = VERSION_2_0_0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10197.java