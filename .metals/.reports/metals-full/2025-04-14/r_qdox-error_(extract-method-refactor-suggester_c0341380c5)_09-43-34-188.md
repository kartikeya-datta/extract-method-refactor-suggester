error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3528.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3528.java
text:
```scala
public L@@ist<VEXNode> getChildNodes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3528.java