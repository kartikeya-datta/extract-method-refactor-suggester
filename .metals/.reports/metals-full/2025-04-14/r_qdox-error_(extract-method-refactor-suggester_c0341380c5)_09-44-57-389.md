error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8292.java
text:
```scala
c@@onfigureTabPager();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8292.java