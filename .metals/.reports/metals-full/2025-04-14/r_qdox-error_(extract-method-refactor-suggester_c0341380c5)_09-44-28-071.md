error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2958.java
text:
```scala
g@@etRequestCycle().setMetaData(FEEDBACK_LIST, (Serializable)feedbacks);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2958.java