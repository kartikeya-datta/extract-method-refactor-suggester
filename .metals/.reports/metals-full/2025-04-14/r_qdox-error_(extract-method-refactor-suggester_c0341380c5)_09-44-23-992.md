error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/178.java
text:
```scala
i@@nt /*long*/ state = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/178.java