error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9008.java
text:
```scala
t@@his(text, skin.get(styleName, LabelStyle.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9008.java