error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6687.java
...
```java
offset: 57
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6687.java
text:
```scala
class AddCompilationUnitToIndex extends IndexRequest {

p@@ackage org.eclipse.jdt.internal.core.search.indexing;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6687.java