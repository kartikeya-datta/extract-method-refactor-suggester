error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11321.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11321.java
text:
```scala
o@@nSelectionChanged(getDefaultModelObject());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11321.java