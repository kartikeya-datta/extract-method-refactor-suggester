error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4792.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4792.java
text:
```scala
protected i@@nt compare(final Object o1, final Object o2)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4792.java