error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9909.java
...
```java
offset: 870
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9909.java
text:
```scala
 ...
 */
p@@ackage org.apache.commons.math.stat.descriptive.moment;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9909.java