error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3162.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3162.java
text:
```scala
protected O@@bject[] state;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3162.java