error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15026.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15026.java
text:
```scala
private i@@nt requestsWindowSize = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15026.java