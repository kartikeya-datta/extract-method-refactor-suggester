error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9625.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9625.java
text:
```scala
protected b@@oolean needsResolve = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9625.java