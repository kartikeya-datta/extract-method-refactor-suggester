error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11655.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11655.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11655.java
text:
```scala
e@@jbJar.addClasses(ClusteredStatefulNodeNameEcho.class, CustomDeploymentNodeSelector.class, NonClusteredStatefulNodeNameEcho.class, NodeNameEcho.class, ApplicationSpecificClusterNodeSelector.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11655.java