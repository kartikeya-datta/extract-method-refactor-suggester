error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6813.java
text:
```scala
t@@extsToHighlight = (List) fieldVisitor.values();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6813.java