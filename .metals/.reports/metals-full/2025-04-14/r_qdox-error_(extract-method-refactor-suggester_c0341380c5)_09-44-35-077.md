error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/802.java
text:
```scala
a@@verage = datum;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/802.java