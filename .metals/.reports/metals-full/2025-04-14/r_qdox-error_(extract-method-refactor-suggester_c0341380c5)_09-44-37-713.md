error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18236.java
text:
```scala
r@@eturn new String[] {getParameter(key)};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18236.java