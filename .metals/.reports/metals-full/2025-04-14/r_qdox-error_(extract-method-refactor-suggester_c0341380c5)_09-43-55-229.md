error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3207.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3207.java
text:
```scala
final C@@lusterBlock NO_MASTER_BLOCK = new ClusterBlock(2, "no master", true, true, ClusterBlockLevel.ALL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3207.java