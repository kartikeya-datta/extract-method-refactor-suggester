error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2849.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2849.java
text:
```scala
m@@ltRequest.searchSource(request.contentByteArray(), request.contentByteArrayOffset(), request.contentLength(), request.contentUnsafe());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2849.java