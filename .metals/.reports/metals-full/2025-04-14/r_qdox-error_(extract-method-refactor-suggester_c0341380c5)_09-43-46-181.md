error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8669.java
text:
```scala
e@@scapeMementoName(buff, fParameterTypes[i]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8669.java