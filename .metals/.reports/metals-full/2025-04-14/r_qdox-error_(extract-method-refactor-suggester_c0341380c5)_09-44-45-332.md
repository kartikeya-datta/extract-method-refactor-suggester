error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14696.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14696.java
text:
```scala
i@@f ((i = filename.lastIndexOf('.')) > -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14696.java