error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4650.java
text:
```scala
V@@iew loginMenu = view(id.m_login);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4650.java