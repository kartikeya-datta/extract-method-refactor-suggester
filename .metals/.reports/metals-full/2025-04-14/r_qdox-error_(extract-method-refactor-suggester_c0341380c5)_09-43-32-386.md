error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16635.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16635.java
text:
```scala
final T@@ree tree = new Tree(shell, SWT.BORDER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16635.java