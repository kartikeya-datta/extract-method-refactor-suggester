error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/110.java
text:
```scala
t@@his.parser = new MatchLocatorParser(problemReporter, this.options.sourceLevel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/110.java