error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12156.java
...
```java
offset: 604
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12156.java
text:
```scala
 ...
 *****************************************************************************/
p@@ackage org.eclipse.ecf.presence.roster;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12156.java