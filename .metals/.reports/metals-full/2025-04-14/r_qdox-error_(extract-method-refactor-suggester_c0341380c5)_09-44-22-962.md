error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8597.java
text:
```scala
i@@f (classFile.isOpen()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8597.java