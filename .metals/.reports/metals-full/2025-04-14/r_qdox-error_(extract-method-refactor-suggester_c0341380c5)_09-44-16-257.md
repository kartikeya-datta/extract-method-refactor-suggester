error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6730.java
text:
```scala
r@@unClass("org.junit.tests.running.core.JUnitCoreTest$Succeed", 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6730.java