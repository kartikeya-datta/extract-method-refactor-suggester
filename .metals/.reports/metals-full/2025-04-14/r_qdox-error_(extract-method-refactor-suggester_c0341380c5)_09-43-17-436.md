error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9084.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9084.java
text:
```scala
static final b@@yte VERSION = 0x0011; // added discouraged access rules
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9084.java