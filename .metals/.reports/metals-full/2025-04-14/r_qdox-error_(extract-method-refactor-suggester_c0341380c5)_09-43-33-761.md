error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9940.java
text:
```scala
i@@f (!OS.HIVIEW) update ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9940.java