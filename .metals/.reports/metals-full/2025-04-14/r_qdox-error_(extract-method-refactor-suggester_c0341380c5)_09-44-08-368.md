error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9813.java
text:
```scala
c@@lass PageWindowColumn extends PropertyColumn<PageWindowDescription>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9813.java