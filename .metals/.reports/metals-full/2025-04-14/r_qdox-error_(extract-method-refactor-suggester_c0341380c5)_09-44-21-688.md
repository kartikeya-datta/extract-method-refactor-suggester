error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3139.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3139.java
text:
```scala
private i@@nt maxPageVersions = Integer.MAX_VALUE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3139.java