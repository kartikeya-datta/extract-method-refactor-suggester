error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5670.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5670.java
text:
```scala
public M@@ethodBinding getAccessMethod(boolean staticReference) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5670.java