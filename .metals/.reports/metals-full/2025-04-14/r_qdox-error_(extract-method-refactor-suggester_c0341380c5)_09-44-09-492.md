error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7037.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7037.java
text:
```scala
e@@xception.computeConversion(scope, exceptionType, exceptionType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7037.java