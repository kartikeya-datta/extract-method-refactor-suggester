error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9234.java
text:
```scala
t@@his(firstWidget, secondWidget, vertical, skin.get("default-horizontal", SplitPaneStyle.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9234.java