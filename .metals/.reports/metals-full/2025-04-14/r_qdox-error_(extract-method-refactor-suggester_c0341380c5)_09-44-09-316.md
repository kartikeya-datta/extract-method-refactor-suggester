error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3158.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3158.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3158.java
text:
```scala
m@@ultiGetRequest.add(request.param("index"), request.param("type"), sFields, request.content());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3158.java