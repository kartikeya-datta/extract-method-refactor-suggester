error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8002.java
text:
```scala
M@@ap.class, field.getType())) ? 1 : 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8002.java