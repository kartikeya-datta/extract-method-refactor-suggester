error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4323.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4323.java
text:
```scala
public static final S@@tring INTENT_PREFIX = "com.github.mobile.";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4323.java