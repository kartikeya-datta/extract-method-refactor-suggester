error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13917.java
text:
```scala
p@@ath = MessagingPathHandlers.PATHS.get(name).parse(value, reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13917.java