error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/892.java
text:
```scala
a@@dd(new PageLink(this,"start", Guess.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/892.java