error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7068.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7068.java
text:
```scala
m@@ergeContext.addConflict("Can't merge a non object mapping [" + mergeWith.name() + "] with an object mapping [" + name() + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7068.java