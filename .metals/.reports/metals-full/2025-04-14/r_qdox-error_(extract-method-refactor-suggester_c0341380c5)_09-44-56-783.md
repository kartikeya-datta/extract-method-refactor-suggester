error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12558.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12558.java
text:
```scala
public R@@ealMatrix copy() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12558.java