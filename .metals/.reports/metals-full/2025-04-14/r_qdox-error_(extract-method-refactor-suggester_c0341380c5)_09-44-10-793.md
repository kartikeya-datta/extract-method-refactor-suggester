error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10190.java
text:
```scala
L@@ong.class, String.class, String.class, String.class, Long.class, ImageIcon.class, Integer.class }, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10190.java