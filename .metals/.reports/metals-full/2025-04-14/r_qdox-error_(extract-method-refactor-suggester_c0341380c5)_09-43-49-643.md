error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9795.java
text:
```scala
l@@ogger.error(e.getTargetException(), e.getTargetException());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9795.java