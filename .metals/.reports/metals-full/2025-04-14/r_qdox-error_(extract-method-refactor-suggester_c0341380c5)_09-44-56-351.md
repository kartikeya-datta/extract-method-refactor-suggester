error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2458.java
text:
```scala
H@@andlesStreamInput in = new HandlesStreamInput(new BytesStreamInput(bytesOut.copiedByteArray(), false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2458.java