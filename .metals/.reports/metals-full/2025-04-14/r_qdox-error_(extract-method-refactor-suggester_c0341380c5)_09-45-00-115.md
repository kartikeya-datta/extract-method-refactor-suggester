error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14151.java
text:
```scala
r@@eturn findMarkupInAssociatedFileHeader(child);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14151.java