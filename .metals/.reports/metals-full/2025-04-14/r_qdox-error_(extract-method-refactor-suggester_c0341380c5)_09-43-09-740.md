error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/959.java
text:
```scala
t@@his.clustered = cache.getCacheConfiguration().clustering().cacheMode().isClustered();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/959.java