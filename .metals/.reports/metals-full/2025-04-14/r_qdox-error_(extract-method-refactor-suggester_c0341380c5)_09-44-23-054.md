error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/11.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/11.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/11.java
text:
```scala
Q@@uery query = new QueryParser("contents",analyzer).parse("test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/11.java