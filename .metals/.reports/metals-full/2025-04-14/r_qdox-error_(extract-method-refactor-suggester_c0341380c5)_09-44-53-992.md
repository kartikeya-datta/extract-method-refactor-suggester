error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7474.java
text:
```scala
i@@f (name.isAbsolute())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7474.java