error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6019.java
...
```java
offset: 38
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6019.java
text:
```scala
...
public class InfinispanSubsystemTestCase extends ClusteringSubsystemTest {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][] {
                ...
                { "subsystem-infinispan_1_5.xml", 78 },
        };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6019.java