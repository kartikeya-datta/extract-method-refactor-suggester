error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8682.java
text:
```scala
b@@oolean drawText = IMAGE_AND_TEXT /*&& text.length () != 0*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8682.java