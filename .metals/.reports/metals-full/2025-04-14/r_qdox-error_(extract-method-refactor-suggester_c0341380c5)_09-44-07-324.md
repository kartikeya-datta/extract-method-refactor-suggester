error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10214.java
text:
```scala
f@@loat boost = this.boost;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10214.java