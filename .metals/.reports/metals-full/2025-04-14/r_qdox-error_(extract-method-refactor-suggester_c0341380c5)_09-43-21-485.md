error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8232.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8232.java
text:
```scala
r@@eturn Long.valueOf(this.value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8232.java