error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8676.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8676.java
text:
```scala
S@@canner scanner = new Scanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/, assertMode, null/*task*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8676.java