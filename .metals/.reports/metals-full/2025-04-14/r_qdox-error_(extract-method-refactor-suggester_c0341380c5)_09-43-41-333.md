error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7768.java
text:
```scala
R@@esolvedMember realthing = AjcMemberMaker.interMethodDispatcher(rm.resolve(world),memberHostType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7768.java