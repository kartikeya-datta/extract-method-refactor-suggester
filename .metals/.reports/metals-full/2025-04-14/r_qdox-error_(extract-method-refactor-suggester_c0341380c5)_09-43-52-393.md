error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5538.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5538.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5538.java
text:
```scala
p@@alette.add(createToolButton(IMAGES+"LINE", "Line Tool", tool));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5538.java