error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1923.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1923.java
text:
```scala
protected static U@@RL getLibraryJavadocLocation(IClasspathEntry entry) throws JavaModelException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1923.java