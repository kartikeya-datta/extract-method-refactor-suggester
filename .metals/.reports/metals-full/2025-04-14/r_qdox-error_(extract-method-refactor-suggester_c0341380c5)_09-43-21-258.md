error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4026.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4026.java
text:
```scala
private static final S@@tring PROPVERSION = "1.6";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4026.java