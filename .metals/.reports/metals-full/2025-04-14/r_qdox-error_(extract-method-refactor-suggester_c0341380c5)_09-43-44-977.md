error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9290.java
text:
```scala
g@@etLogger().info( message + srcDir + " to " + destDir );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9290.java