error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13809.java
text:
```scala
r@@eturn "[" + getPath() + "." + Classes.name(getClass()) + " isVisible = " + isVisible()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13809.java