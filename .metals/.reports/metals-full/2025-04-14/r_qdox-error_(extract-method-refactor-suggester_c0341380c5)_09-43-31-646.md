error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10363.java
text:
```scala
a@@ssertTrue(totalChildren > 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10363.java