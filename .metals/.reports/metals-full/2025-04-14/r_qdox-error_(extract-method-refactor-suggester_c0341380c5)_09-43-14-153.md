error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5813.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5813.java
text:
```scala
r@@egistration.registerSubModel(new DeploymentScannerDefinition(context.getPathManager()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5813.java