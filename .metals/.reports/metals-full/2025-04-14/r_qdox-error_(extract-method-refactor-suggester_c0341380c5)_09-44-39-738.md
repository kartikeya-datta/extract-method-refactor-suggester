error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2810.java
text:
```scala
c@@har[][] tokens = this.simpleName == null ? CharOperation.NO_CHAR_CHAR : new char[][] {this.simpleName};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2810.java