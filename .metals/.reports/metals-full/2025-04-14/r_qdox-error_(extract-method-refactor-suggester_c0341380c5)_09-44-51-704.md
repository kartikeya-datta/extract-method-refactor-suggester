error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1096.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1096.java
text:
```scala
p@@arser.consumeMethodHeaderRightParen();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1096.java