error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2627.java
text:
```scala
p@@arser.parseCompilationUnit(compilationUnit, true/*full parse*/, null/*no progress*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2627.java