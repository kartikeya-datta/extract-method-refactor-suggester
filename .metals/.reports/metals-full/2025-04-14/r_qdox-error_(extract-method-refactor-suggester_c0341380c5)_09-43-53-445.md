error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8607.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8607.java
text:
```scala
i@@f (!Util.isExcluded(parentFolder, exclusionPatterns)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8607.java