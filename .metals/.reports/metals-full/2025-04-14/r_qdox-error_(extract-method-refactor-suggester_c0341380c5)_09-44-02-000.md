error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/614.java
text:
```scala
r@@eturn " " + Util.bind("problem.atLine"/*nonNLS*/,String.valueOf(line)) +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/614.java