error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4395.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4395.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4395.java
text:
```scala
W@@orkingCopy workingCopy = new WorkingCopy((IPackageFragment)getParent(), getElementName(), factory);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4395.java