error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14031.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14031.java
text:
```scala
private final I@@njectedValue<BundleContext> injectedBundleContext = new InjectedValue<BundleContext>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14031.java