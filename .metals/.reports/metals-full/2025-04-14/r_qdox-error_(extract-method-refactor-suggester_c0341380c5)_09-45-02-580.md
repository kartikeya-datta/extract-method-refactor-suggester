error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7344.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7344.java
text:
```scala
public b@@oolean didResolve = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7344.java