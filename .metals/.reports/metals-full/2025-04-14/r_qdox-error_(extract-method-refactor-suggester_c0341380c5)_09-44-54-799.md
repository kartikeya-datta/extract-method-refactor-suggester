error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8416.java
text:
```scala
b@@uffer.append(type.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8416.java