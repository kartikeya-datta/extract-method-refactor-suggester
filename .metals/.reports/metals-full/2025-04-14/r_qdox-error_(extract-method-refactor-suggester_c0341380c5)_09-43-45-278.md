error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1090.java
text:
```scala
l@@ogMsg(LINE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1090.java