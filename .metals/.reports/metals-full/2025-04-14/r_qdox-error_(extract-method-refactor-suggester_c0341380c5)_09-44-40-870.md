error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6716.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6716.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(false, true, ATTRIBUTE_DEFINITIONS), new SecurityRealmChildRemoveHandler(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6716.java