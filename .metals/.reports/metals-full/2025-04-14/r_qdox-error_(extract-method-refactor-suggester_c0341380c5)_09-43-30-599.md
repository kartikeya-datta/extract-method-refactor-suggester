error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14180.java
text:
```scala
n@@ew TextField<String>(this, "input", new Model<String>("test"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14180.java