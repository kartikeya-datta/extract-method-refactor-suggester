error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17993.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17993.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17993.java
text:
```scala
p@@age = versionManager.getVersion(getCurrentVersionNumber());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17993.java