error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10099.java
text:
```scala
i@@f (type instanceof Class && List.class.isAssignableFrom((Class<?>)type)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10099.java