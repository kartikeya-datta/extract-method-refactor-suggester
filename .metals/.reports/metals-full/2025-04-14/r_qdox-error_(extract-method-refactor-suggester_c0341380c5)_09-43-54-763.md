error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/385.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/385.java
text:
```scala
s@@etUp(UnenhancedPropertyAccess.class, CLEAR_TABLES, "openjpa.RuntimeUnenhancedClasses", "supported");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/385.java