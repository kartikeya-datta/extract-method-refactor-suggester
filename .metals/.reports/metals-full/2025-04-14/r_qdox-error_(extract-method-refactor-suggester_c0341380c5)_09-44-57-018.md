error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8838.java
text:
```scala
N@@AME(CommonAttributes.HANDLER_NAME),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8838.java