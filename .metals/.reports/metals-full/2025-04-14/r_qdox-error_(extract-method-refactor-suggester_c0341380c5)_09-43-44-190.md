error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/343.java
text:
```scala
a@@ssertEquals(4, cms.getMaxThreadCount());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/343.java