error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1760.java
text:
```scala
c@@ompilationResult.hasAnnotations = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1760.java