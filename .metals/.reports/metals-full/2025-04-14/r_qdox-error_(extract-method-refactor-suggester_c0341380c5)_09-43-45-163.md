error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12264.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12264.java
text:
```scala
r@@esult = Widget.createJavaString (ptr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12264.java