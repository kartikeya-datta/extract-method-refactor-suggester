error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4781.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4781.java
text:
```scala
private static final C@@oncurrentHashMap<Class<? extends Page>, Boolean> pageClassToBookmarkableCache = new ConcurrentHashMap<Class<? extends Page>, Boolean>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4781.java