error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/60.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/60.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/60.java
text:
```scala
r@@eturn segmentsName + "_" + fieldId;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/60.java