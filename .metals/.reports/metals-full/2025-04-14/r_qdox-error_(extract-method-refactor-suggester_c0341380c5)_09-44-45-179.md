error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/556.java
text:
```scala
i@@f (stage != null) stage.cancelTouchFocusExcept(flickScrollListener, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/556.java