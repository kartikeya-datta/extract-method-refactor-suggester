error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4032.java
text:
```scala
d@@ocMapper.parse(SourceToParse.source(getResponse.source()).type(request.type()).id(request.id()), new DocumentMapper.ParseListenerAdapter() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4032.java