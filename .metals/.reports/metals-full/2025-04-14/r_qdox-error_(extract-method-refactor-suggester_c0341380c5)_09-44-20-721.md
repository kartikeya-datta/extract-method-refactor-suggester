error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5037.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5037.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5037.java
text:
```scala
public L@@ist<String> getArgumentDesc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5037.java