error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9260.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9260.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9260.java
text:
```scala
public static final S@@tring SIGNATURE= "INDEX VERSION 1.107"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9260.java