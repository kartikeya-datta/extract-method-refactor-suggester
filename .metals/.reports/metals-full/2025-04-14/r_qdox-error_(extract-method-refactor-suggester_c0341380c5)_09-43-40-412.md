error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9196.java
text:
```scala
t@@hrow new IllegalArgumentException("Argument 'component' must be not null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9196.java