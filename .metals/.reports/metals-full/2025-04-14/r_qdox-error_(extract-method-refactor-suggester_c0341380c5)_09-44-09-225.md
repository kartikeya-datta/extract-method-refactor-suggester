error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6579.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6579.java
text:
```scala
b@@ody.applyCentralForce(tmpV1.set(0f, 8.0f + (float)(6.0 * Math.random()), 0f));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6579.java