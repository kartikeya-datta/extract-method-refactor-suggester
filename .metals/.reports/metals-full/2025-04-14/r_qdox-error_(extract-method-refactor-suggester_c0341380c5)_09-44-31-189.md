error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/399.java
text:
```scala
r@@eturn new NodeHotThreads(clusterService.localNode(), hotThreads.detect());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/399.java