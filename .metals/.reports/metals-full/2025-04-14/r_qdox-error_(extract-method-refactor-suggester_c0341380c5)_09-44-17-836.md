error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9174.java
text:
```scala
i@@f (stateValues.isSilent() == false && theConsole.getConsole() == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9174.java