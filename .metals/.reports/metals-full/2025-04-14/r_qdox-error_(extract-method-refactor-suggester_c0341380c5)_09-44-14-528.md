error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/358.java
text:
```scala
T@@hread.sleep(Math.max(0,25 -
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/358.java