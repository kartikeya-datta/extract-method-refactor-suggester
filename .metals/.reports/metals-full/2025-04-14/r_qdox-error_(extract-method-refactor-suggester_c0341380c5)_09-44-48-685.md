error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14626.java
text:
```scala
l@@ist.add(session.getAttribute(attribute));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14626.java