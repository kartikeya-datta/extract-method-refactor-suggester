error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6471.java
text:
```scala
m@@odules.add(new BenchmarkModule(settings));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6471.java