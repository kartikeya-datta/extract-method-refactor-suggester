error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14994.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14994.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14994.java
text:
```scala
i@@f (ws.getImplementation()!= null && ws.getImplementation().equals(implName))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14994.java