error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1736.java
text:
```scala
l@@og.warnf("Operation (%s) failed - address: (%s)", operation.get(OP), operation.get(OP_ADDR));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1736.java