error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12745.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12745.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12745.java
text:
```scala
b@@its24 |= octetString[i++] & BYTE_MASK;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12745.java