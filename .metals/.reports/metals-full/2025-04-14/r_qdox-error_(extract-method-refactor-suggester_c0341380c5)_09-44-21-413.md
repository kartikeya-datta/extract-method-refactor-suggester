error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12698.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12698.java
text:
```scala
r@@eturn true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12698.java