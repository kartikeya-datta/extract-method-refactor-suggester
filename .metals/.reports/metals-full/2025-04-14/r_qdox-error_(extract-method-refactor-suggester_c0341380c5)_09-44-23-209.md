error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1648.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1648.java
text:
```scala
r@@eturn console.readLine(prompt, (char) 0x00);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1648.java