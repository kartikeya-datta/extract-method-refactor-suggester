error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5468.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5468.java
...
```java
offset: 28
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5468.java
text:
```scala
public static synchronized v@@oid verbose(String log, PrintStream printStream) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5468.java