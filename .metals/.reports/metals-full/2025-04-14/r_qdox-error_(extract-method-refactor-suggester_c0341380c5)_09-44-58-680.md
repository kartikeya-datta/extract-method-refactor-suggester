error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3215.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3215.java
text:
```scala
i@@f (isClasspathEntry(member.getFullPath(), classpath))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3215.java