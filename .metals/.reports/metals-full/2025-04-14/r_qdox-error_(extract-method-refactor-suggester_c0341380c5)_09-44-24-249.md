error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13805.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13805.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13805.java
text:
```scala
r@@eturn "return Wicket.$('" + getComponent().getMarkupId() + "') != null;";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13805.java