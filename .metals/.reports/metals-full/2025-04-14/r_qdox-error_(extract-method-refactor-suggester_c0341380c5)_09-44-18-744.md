error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6784.java
text:
```scala
n@@ew String[] { extensionPoint, (String) itTarget.next(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6784.java