error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10661.java
text:
```scala
d@@eploymentUnit.addToAttachmentList(org.jboss.as.ee.component.Attachments.WEB_SETUP_ACTIONS, service);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10661.java