error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1132.java
text:
```scala
f@@or (int i = 0; i < 500; i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1132.java