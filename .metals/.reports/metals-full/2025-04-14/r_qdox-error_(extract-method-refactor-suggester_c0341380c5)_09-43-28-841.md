error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3062.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3062.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3062.java
text:
```scala
b@@uffer.append("intArrayPtr = " + intArrayPtr + "\n"); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3062.java