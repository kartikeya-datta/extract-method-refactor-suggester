error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/870.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/870.java
text:
```scala
public static final M@@etaData EMPTY_META_DATA = newMetaDataBuilder().build();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/870.java