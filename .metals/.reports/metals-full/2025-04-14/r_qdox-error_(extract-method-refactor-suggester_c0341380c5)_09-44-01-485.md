error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2662.java
text:
```scala
c@@Integer = Integer.valueOf(6);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2662.java