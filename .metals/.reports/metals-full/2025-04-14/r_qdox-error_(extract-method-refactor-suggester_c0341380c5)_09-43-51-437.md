error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13050.java
text:
```scala
s@@uper("batch-move-line");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13050.java