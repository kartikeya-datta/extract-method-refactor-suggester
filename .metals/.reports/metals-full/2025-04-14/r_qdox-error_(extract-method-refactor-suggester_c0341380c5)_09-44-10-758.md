error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7978.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7978.java
text:
```scala
r@@eturn CharOperation.concat(EvaluationContext.GLOBAL_VARS_CLASS_NAME_PREFIX, Integer.toString(EvaluationContext.VAR_CLASS_COUNTER + 1).toCharArray());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7978.java