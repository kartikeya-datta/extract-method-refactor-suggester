error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15182.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15182.java
text:
```scala
i@@f(type != null && value instanceof org.omg.CORBA.Object) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15182.java