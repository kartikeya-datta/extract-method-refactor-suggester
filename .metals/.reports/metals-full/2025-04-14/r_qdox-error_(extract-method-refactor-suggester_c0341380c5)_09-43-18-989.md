error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6529.java
text:
```scala
i@@f (action != null) action.restart();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6529.java