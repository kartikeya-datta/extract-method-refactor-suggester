error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/198.java
text:
```scala
c@@ontext.removeService(RemotingHttpUpgradeService.UPGRADE_SERVICE_NAME.append("management"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/198.java