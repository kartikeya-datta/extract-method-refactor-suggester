error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6651.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[47,2]

error in qdox parser
file content:
```java
offset: 1525
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6651.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6651.java