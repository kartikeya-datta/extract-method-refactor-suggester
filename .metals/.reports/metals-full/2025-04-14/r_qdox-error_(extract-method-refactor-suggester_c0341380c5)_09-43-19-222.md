error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8405.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8405.java
text:
```scala
final H@@ornetQServer server = AddressSettingAdd.getServer(context, operation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8405.java