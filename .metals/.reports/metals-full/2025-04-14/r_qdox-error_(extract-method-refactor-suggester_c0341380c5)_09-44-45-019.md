error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/498.java
text:
```scala
l@@ogger.trace("Sending mapping updated to master: index [{}] type [{}]", request.index(), request.type());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/498.java