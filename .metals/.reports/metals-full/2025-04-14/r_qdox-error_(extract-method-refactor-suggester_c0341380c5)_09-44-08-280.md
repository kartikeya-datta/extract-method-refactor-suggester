error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8867.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode().set(MESSAGES.cannotInstantiateDriverClass(driverClassName)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8867.java