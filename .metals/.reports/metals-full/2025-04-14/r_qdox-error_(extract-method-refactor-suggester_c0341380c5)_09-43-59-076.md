error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/73.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/73.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/73.java
text:
```scala
final S@@et<IntsRef> ref = XSpecialOperations.getFiniteStrings(automaton, -1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/73.java