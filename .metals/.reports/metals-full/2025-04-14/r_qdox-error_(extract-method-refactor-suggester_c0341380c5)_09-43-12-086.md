error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5207.java
text:
```scala
t@@ypeDeclaration.print(tab + 1, result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5207.java