error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2636.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2636.java
text:
```scala
static private b@@oolean isMac = System.getProperty("os.name").contains("Mac");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2636.java