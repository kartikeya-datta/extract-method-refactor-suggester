error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8974.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8974.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8974.java
text:
```scala
static final i@@nt RESIZE_LIMIT = 6;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8974.java