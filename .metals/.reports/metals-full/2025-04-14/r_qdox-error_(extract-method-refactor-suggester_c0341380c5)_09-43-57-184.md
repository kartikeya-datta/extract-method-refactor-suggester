error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2487.java
text:
```scala
i@@nt /*long*/ ptr = XPCOM.PR_Malloc(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2487.java