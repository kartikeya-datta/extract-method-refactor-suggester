error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3906.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3906.java
text:
```scala
public v@@oid testOtherJNDIbindingsAreAvailbleAtStartup() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3906.java