error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1816.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1816.java
text:
```scala
public static final S@@tring NAME = "cluster:monitor/state";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1816.java