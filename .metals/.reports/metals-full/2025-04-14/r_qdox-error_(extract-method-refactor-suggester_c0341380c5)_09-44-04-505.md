error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2636.java
text:
```scala
i@@f (markupStream.getPreviousTag().isOpen())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2636.java