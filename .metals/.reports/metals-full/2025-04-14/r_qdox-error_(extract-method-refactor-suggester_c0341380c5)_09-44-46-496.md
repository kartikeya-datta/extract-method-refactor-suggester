error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3191.java
text:
```scala
c@@lientSite  = new OleClientSite(frame, SWT.NONE, "PowerPoint.Slide");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3191.java