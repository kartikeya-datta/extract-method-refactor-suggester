error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12536.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12536.java
text:
```scala
static final O@@perationDefinition SETUP_OPERATION_DEF = new SimpleOperationDefinitionBuilder("setup", new NonResolvingResourceDescriptionResolver())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12536.java