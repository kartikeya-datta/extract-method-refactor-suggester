error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17757.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17757.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[57,80]

error in qdox parser
file content:
```java
offset: 1906
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17757.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17757.java