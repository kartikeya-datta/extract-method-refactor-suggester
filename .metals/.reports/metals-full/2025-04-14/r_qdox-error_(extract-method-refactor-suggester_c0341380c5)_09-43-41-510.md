error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15296.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15296.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15296.java
text:
```scala
public static final l@@ong PRIORITY = DeploymentPhases.MODULARIZE.plus(750L);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15296.java