error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7089.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7089.java
text:
```scala
i@@f (ixEnd <= ixSemiColon)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7089.java