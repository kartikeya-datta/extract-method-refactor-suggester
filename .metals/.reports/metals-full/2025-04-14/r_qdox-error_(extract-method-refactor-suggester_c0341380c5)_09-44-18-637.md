error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1870.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1870.java
text:
```scala
public b@@oolean supportsAddFolder(IMailFolder newFolder) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1870.java