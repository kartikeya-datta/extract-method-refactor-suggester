error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9133.java
text:
```scala
t@@ypeInfo.modifiers, CharOperation.charArrayToStringArray(typeInfo.superinterfaces), typeInfo.kind == IGenericType.CLASS_DECL); // TODO (jerome) should pass in kind
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9133.java