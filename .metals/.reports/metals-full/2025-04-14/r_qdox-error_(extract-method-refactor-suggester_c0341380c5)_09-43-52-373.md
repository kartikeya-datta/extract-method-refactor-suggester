error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4005.java
text:
```scala
A@@S7-3488 make default-cache a non-required attribute
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4005.java