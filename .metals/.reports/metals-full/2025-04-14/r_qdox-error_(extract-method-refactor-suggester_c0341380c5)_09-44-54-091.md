error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15219.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15219.java
text:
```scala
private static final L@@og log = LogFactory.getLog(ComponentStringResourceLoader.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15219.java