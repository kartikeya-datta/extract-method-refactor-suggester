error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5192.java
text:
```scala
r@@eturn new RequestReader(file, FORMAT_VERSION).read();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5192.java