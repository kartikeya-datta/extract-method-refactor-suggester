error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15126.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15126.java
text:
```scala
r@@eturn FontMetrics.wpf_new((int)baseline, (int)height - (int)baseline, 0, 0, (int)height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15126.java