error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5389.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5389.java
text:
```scala
public D@@ashboardIssueViewHolder(View v, int maxNumberCount) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5389.java