error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15196.java
text:
```scala
t@@hrow new RuntimeException("User object cannot be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15196.java