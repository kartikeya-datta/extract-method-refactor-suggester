error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2197.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2197.java
text:
```scala
static i@@nt MINOR_VERSION = 547;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2197.java