error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9527.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9527.java
text:
```scala
private transient i@@nt loopCount = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9527.java