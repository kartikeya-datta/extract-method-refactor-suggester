error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12743.java
text:
```scala
I@@Model<T> model(T object);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12743.java