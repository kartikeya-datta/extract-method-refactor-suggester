error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13051.java
text:
```scala
s@@uper("batch-line-remove");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13051.java