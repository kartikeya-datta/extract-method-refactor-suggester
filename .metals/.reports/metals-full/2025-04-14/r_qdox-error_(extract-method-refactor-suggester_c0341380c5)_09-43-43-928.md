error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1797.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1797.java
text:
```scala
public v@@oid readRegistry(IExtensionRegistry in, ActionSetRegistry out)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1797.java