error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1139.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1139.java
text:
```scala
r@@eturn ((NSTextView)view).textStorage().paragraphs().count() + 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1139.java