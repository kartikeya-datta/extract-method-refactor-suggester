error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14383.java
text:
```scala
r@@eturn message + ": \n" + toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14383.java