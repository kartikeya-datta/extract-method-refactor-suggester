error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1234.java
text:
```scala
i@@nternalTickCallback.dispose();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1234.java