error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4406.java
text:
```scala
i@@f (component.isStateful()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4406.java