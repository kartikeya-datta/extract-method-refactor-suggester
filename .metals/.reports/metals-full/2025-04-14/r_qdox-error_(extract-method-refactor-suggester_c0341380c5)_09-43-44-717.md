error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/870.java
text:
```scala
r@@eturn "return !"+super.getEventHandler();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/870.java