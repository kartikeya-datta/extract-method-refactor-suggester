error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2490.java
text:
```scala
p@@haseContext.addDeploymentDependency(serviceName, Attachments.SUB_DEPLOYMENTS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2490.java