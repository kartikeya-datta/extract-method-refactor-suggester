error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14928.java
text:
```scala
...
public class SecurityRealmResourceDefinition extends SimpleResourceDefinition {
    ...
    public void registerAttributes(ManagementResourceRegistration resourceRegistration) {
        OperationStepHandler writeHandler = new ReloadRequiredWriteAttributeHandler(MAP_GROUPS_TO_ROLES);
        resourceRegistration.registerReadWriteAttribute(MAP_GROUPS_TO_ROLES, null, writeHandler);
    }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14928.java