error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9624.java
text:
```scala
i@@f ((target != null) && (target != target.getDecoratedFigure())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9624.java