error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/120.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/120.java
text:
```scala
u@@daccel.nInc  = udaccel.nInc / first * value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/120.java