error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15015.java
text:
```scala
p@@ublic class SubListItem implements Serializable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15015.java