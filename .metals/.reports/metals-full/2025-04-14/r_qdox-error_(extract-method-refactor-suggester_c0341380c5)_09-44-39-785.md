error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4836.java
text:
```scala
P@@arameterizedTypeBinding parameterizedType = scope.environment().createParameterizedType((ReferenceBinding)currentType.erasure(), argTypes, enclosingType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4836.java