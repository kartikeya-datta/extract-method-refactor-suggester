error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12703.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12703.java
text:
```scala
M@@odelNode type = ProtocolResourceDefinition.TYPE.validateOperation(operation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12703.java