error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2353.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(true, NAME), new SecurityRealmChildRemoveHandler(true, true),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2353.java