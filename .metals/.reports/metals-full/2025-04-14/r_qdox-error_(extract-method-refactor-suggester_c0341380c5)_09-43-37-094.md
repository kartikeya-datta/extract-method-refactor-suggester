error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2381.java
text:
```scala
t@@rue);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2381.java