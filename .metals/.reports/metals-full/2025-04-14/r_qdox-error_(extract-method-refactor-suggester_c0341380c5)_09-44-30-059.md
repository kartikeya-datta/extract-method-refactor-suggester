error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1941.java
text:
```scala
m@@beanName = "org.apache.cassandra.db:type=" + type + ",keyspace=" + this.table.name + ",columnfamily=" + columnFamily;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1941.java