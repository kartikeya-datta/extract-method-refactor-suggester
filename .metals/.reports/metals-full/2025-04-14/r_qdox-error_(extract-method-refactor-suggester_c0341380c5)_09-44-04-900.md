error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14314.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14314.java
text:
```scala
static i@@nt MINOR_VERSION = 338;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14314.java