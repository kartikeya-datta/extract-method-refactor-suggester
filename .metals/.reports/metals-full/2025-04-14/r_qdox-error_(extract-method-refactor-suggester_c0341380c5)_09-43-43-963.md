error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12246.java
text:
```scala
D@@ebugOptions.PACKAGE_VERSION_COMPARATOR, this.getClass(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12246.java