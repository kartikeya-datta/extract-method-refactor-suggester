error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7439.java
text:
```scala
n@@ew JavaSearchParticipant(), // java search only
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7439.java