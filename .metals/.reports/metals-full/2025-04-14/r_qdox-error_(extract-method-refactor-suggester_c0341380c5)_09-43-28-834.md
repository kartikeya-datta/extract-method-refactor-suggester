error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1399.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh("refresh_flag_get").force(REFRESH_FORCE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1399.java