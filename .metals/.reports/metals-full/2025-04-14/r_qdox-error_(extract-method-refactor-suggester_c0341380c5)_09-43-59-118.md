error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6972.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6972.java
text:
```scala
t@@his.request.setAttribute(HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE, "resources/main.css");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6972.java