error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2613.java
text:
```scala
i@@f (enclosingTb.id == T_JavaLangObject) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2613.java