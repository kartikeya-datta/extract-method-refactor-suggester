error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3003.java
text:
```scala
a@@ssertSame(Connector.Type.HTTP, new UndertowConnector(new HttpListenerService("", "", 0)).getType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3003.java