error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10787.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10787.java
text:
```scala
protected static final S@@tring HTTPS_RETRIEVE = "https://www.eclipse.org/";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10787.java