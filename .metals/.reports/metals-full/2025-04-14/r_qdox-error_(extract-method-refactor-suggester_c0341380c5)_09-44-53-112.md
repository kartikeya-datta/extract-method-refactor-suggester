error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1324.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1324.java
text:
```scala
protected static M@@anagementClient managementClient;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1324.java