error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2150.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,207]

error in qdox parser
file content:
```java
offset: 207
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2150.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2150.java