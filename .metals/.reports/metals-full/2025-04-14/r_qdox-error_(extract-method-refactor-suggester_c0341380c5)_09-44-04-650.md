error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2742.java
text:
```scala
r@@eturn Assignments.allUnassigned(method, HasDateMethod.class, true)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2742.java