error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4713.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4713.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4713.java
text:
```scala
S@@tring signature = key.internalToSignature();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4713.java