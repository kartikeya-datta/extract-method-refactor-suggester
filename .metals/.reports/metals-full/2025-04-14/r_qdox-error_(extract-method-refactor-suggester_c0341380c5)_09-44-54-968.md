error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7711.java
text:
```scala
O@@rderComparator.sort(this.viewResolvers);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7711.java