error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2722.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2722.java
text:
```scala
protected N@@ame target;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2722.java