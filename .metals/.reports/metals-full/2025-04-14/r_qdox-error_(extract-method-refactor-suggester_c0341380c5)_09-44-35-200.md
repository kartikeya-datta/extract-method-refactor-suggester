error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/391.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/391.java
text:
```scala
private static final l@@ong serialVersionUID = -2407966402920578741L;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/391.java