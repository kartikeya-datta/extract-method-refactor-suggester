error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1963.java
text:
```scala
f@@iles = new AndroidFiles(this.getService().getAssets());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1963.java