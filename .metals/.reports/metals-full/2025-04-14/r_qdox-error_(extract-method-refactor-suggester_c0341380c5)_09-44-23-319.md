error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3396.java
text:
```scala
r@@k = new RemoteKey(spaceID, InetAddress.getLocalHost().getAddress());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3396.java