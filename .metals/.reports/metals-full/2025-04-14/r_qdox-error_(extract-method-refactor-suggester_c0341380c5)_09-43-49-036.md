error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9097.java
text:
```scala
w@@in.setVisible(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9097.java