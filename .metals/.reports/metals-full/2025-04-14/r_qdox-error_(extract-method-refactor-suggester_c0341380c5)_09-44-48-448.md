error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1440.java
text:
```scala
p@@rivileges = (PrivilegeNode) privileges.bind( new HashMap(), grantees, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1440.java