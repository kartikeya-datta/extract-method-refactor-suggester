error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5645.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5645.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5645.java
text:
```scala
r@@eturn GeoPointDoubleArrayAtomicFieldData.EMPTY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5645.java