error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7748.java
text:
```scala
I@@OException channelClosed(@Cause IOException cause);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7748.java