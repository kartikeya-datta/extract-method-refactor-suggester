error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8797.java
text:
```scala
r@@eturn CategorizedProblem.CAT_RESTRICTION;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8797.java