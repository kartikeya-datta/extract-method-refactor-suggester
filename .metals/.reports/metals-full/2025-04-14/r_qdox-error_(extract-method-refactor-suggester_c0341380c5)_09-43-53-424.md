error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4875.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4875.java
text:
```scala
public v@@oid addComponent(Component component)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4875.java