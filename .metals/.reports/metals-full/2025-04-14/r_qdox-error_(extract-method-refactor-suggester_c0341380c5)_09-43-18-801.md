error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2676.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2676.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2676.java
text:
```scala
private final L@@inkedMap<K, ?> parent;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2676.java