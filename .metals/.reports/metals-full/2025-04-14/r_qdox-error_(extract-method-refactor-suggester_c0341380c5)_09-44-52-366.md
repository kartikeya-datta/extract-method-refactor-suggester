error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4844.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4844.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4844.java
text:
```scala
v@@oid onSelectionChanged();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4844.java