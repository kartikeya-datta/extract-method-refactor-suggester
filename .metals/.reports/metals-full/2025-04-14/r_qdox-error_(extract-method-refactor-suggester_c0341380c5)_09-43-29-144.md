error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6793.java
text:
```scala
T@@ypeVariableBinding[] typeVariableBindings = this.methodBinding != null ? this.methodBinding.typeVariables() : this.typeBinding.typeVariables();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6793.java