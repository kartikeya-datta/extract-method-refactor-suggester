error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7733.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7733.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7733.java
text:
```scala
public b@@oolean isTemporary(Component c)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7733.java