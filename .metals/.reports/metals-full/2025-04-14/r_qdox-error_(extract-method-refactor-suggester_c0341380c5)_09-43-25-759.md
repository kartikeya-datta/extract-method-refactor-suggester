error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/422.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/422.java
text:
```scala
private v@@oid refill() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/422.java