error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14349.java
text:
```scala
t@@agWriter.writeAttribute("value", processFieldValue(getName(), "", getType()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14349.java