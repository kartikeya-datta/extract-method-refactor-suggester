error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8387.java
text:
```scala
c@@lusterService.submitStateUpdateTask("update-mapping [" + index + "][" + type + "] / node [" + nodeId + "], order [" + order + "]", Priority.HIGH, new ClusterStateUpdateTask() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8387.java