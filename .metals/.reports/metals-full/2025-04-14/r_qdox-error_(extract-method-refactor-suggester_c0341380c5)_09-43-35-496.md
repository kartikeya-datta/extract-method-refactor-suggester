error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7191.java
text:
```scala
h@@ud.getViewport().update(width, height, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7191.java