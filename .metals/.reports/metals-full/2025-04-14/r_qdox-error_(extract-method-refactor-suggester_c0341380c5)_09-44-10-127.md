error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2851.java
text:
```scala
S@@tatusManager.getManager().handle(errStatus, StatusManager.SHOW | StatusManager.LOG);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2851.java