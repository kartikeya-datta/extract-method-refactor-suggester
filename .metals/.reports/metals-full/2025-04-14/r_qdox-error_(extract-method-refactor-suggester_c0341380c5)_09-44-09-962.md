error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10793.java
...
```java
offset: 656
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10793.java
text:
```scala
...
p@@ackage org.springframework.cache;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10793.java