error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14956.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14956.java
text:
```scala
private final C@@omparator<E> comparator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14956.java