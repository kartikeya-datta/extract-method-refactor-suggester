error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9764.java
text:
```scala
n@@ew Class[] { String.class });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9764.java