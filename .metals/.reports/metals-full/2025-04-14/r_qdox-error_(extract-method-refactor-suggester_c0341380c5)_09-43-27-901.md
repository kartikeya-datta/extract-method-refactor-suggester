error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1416.java
text:
```scala
F@@ileSystemUtils.deleteRecursively(dataDirToClean.toArray(new File[dataDirToClean.size()]));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1416.java