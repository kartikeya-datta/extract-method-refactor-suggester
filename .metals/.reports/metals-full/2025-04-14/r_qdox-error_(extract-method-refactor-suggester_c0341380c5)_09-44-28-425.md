error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9329.java
text:
```scala
i@@f (myTotal != null && myDelta != null &&myTotal.getNumSamples() != myDelta.getNumSamples()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9329.java