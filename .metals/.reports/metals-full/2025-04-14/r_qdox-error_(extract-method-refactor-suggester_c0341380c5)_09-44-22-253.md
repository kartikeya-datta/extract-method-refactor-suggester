error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3481.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3481.java
text:
```scala
r@@eturn ""/*nonNLS*/;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3481.java