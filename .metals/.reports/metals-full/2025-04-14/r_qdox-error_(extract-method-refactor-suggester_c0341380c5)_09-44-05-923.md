error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2669.java
text:
```scala
b@@oolean isNestedType = classFile.enclosingClassFile != null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2669.java