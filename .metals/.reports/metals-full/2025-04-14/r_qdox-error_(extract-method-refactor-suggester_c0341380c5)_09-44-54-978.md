error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2555.java
text:
```scala
i@@f (memberType.isRawType() && (this.bits & IgnoreRawTypeCheck) == 0 && scope.compilerOptions().reportRawTypeReference) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2555.java