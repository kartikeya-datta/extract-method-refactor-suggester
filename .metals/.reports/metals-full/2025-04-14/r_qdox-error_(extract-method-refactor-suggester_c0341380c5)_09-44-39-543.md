error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/970.java
text:
```scala
M@@essagingExtension.getResourceDescriptionResolver(CommonAttributes.CONNECTOR_SERVICE, CommonAttributes.PARAM),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/970.java