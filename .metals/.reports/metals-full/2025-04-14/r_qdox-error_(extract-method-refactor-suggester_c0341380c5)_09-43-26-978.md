error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5620.java
text:
```scala
r@@esult.append("  "); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5620.java