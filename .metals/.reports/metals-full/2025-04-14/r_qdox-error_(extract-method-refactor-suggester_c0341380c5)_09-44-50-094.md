error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1274.java
text:
```scala
t@@argetClass="org.jboss.as.clustering.jgroups.subsystem.ProtocolStackRemove",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1274.java