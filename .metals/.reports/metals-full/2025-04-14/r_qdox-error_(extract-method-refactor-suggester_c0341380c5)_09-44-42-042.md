error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12791.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12791.java
text:
```scala
final V@@alueMap attributes = tag.getAttributes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12791.java