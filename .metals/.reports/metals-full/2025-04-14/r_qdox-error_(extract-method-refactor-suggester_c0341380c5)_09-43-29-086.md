error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2652.java
text:
```scala
a@@ppBeanName = new ObjectName(tempDomain + ":type=Application");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2652.java