error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14863.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14863.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14863.java
text:
```scala
r@@eturn new String[] { "zorba", "zorba_sausastore" };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14863.java