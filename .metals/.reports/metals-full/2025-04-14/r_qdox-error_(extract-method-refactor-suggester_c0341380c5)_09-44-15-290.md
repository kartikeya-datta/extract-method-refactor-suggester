error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7892.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7892.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7892.java
text:
```scala
a@@ssertAcked(prepareCreate("test").setSettings(settingsBuilder().put("index.number_of_shards", immutableCluster().dataNodes()+2).put("index.number_of_replicas", 0)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7892.java