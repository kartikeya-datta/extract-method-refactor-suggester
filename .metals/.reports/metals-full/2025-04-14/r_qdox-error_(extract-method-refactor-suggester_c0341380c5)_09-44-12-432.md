error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9264.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9264.java
text:
```scala
public S@@tring[] getParameterNames(Constructor<?> ctor) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9264.java