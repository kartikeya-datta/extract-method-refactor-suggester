error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2954.java
text:
```scala
C@@ontrol control = display.getFocusControl (window, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2954.java