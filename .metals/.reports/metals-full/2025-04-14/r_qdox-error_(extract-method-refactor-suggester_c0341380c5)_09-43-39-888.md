error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7708.java
text:
```scala
s@@etIcon(AjdeUIManager.getDefault().getIconRegistry().getInfoIcon());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7708.java