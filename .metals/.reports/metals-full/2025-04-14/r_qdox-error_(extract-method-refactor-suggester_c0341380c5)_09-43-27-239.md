error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14652.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14652.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14652.java
text:
```scala
S@@WT.error (SWT.ERROR_NO_HANDLES, e, " [MOZILLA_FIVE_HOME='" + mozillaPath + "']"); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14652.java