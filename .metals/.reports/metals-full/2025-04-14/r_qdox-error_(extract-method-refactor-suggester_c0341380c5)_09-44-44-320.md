error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6385.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6385.java
text:
```scala
r@@eturn (min.x < max.x && min.y < max.y && min.z < max.z);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6385.java