error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6341.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6341.java
text:
```scala
static final A@@ttributeDefinition[] ATTRIBUTES = new AttributeDefinition[] {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6341.java