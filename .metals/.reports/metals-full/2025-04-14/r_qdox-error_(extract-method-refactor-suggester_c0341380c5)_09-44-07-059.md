error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16334.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16334.java
text:
```scala
t@@ransform.translateXBy(0, -((2*y) + textStorage.size().height));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16334.java