error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9695.java
text:
```scala
t@@hrow new IOException("Malformed commit, missing length for [" + fileName + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9695.java