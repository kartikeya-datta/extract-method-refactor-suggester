error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7802.java
text:
```scala
c@@omparator = LastModifiedFileComparator.LASTMODIFIED_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7802.java