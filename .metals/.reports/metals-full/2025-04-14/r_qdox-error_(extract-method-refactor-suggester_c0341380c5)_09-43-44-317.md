error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/35.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/35.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/35.java
text:
```scala
u@@i = new Stage();;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/35.java