error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6885.java
text:
```scala
B@@readCrumbPanel create(MarkupContainer parent,String componentId, IBreadCrumbModel breadCrumbModel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6885.java