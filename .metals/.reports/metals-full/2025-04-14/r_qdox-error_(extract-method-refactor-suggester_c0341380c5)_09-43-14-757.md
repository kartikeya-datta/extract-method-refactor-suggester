error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10356.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10356.java
text:
```scala
public static final i@@nt DEFAULT_MAX_POOL_SIZE = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10356.java