error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12002.java
text:
```scala
i@@f (deps.contains(dependency.getIdentifier())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12002.java