error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5018.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5018.java
text:
```scala
public static final D@@istanceUnit DEFAULT = METERS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5018.java