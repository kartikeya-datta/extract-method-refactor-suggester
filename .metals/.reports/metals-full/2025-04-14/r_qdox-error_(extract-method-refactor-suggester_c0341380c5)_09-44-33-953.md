error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6488.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6488.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6488.java
text:
```scala
s@@etEmptyText(string.no_filters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6488.java