error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7717.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7717.java
...
```java
offset: 620
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7717.java
text:
```scala
 ...
 *****************************************************************************/
p@@ackage org.eclipse.ecf.tests.osgi.services.distribution.r_osgi;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7717.java