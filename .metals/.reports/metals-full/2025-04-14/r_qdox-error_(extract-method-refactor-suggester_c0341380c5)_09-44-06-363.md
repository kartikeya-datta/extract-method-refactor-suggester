error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1403.java
text:
```scala
a@@ssertEquals(10, lv.getViewSize());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1403.java