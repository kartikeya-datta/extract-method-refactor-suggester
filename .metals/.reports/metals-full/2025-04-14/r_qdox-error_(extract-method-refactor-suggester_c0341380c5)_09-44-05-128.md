error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/287.java
text:
```scala
c@@ollector.collect(new Text(this.getIdentifier()), new Text(point
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/287.java