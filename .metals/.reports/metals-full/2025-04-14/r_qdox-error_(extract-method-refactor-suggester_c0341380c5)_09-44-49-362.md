error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12797.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12797.java
text:
```scala
private S@@tring[] current;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12797.java