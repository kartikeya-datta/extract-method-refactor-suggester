error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13239.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13239.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13239.java
text:
```scala
i@@tem.sendSelectionEvent(SWT.Selection, event, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13239.java