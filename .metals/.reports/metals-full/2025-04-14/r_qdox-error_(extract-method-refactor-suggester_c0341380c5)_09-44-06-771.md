error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/867.java
text:
```scala
a@@ssert false : "AVG has its own collector";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/867.java