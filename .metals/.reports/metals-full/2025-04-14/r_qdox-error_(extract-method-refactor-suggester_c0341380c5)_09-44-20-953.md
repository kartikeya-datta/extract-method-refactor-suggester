error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10434.java
text:
```scala
a@@ddTestSuite(SpaceNormalizerTest.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10434.java