error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17183.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17183.java
text:
```scala
final C@@lass<? extends Dispatchable> c = dispatchable.getClass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17183.java