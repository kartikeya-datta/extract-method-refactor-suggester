error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9945.java
text:
```scala
W@@ebDeploymentActivator.activate(defaultHost, new SharedWebMetaDataBuilder(config), new SharedTldsMetaDataBuilder(config), context.getBatchBuilder());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9945.java