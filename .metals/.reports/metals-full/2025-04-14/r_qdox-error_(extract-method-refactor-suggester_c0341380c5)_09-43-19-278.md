error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2696.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2696.java
text:
```scala
I@@Model<String> goModel, IModel<String> clearModel)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2696.java