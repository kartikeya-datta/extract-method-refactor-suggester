error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3990.java
text:
```scala
Q@@uery query = new DeletionAwareConstantScoreQuery(Queries.MATCH_ALL_FILTER, true); // no need to cache a MATCH ALL FILTER
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3990.java