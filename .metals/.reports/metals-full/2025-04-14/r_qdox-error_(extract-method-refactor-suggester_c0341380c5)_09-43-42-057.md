error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/756.java
...
```java
offset: 805
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/756.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/756.java