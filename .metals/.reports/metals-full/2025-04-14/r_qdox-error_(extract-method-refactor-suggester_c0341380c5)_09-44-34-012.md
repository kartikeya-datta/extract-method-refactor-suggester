error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3947.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3947.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3947.java
text:
```scala
public T@@emplateTest(final String name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3947.java