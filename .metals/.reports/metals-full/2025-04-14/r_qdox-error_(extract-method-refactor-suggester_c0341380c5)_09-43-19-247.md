error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12480.java
text:
```scala
i@@f (ctx.getCharacter() == '}') {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12480.java