error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14692.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14692.java
text:
```scala
public F@@uture<?> schedule(TestEJBRunnable task, long delay, TimeUnit timeUnit) throws NamingException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14692.java