error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4968.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4968.java
text:
```scala
protected S@@tring patchId;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4968.java