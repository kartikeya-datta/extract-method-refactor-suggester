error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4753.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4753.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4753.java
text:
```scala
public final I@@Model getNestedModel()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4753.java