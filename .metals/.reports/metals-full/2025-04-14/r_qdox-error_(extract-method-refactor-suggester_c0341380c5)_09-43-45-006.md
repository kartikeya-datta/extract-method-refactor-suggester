error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1862.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1862.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1862.java
text:
```scala
I@@LabelProvider<String>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1862.java