error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12848.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12848.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12848.java
text:
```scala
x@@optionText = "non-standard options:"; //xoptionText.substring("{0}".length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12848.java