error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7966.java
text:
```scala
l@@ogger.debug("using concurrent_streams [{}], file_chunk_size [{}], translog_batch_size [{}], and compress [{}]", concurrentStreams, fileChunkSize, translogBatchSize, compress);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7966.java