error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11378.java
text:
```scala
p@@ublic class AjaxBehaviorAndMetaDataPage extends WebPage implements IAjaxIndicatorAware
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11378.java