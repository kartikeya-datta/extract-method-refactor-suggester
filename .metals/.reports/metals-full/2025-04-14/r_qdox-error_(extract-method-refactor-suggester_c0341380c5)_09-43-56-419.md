error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8596.java
text:
```scala
n@@ewCol.copy(pkCols[j]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8596.java