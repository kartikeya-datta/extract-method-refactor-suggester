error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14089.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14089.java
text:
```scala
protected I@@Model<T> getListItemModel(final IModel<List<T>> model, final int index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14089.java