error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/720.java
text:
```scala
S@@omeInterface bean = (SomeInterface) new InitialContext().lookup("java:global/testExtensions/testWar/WarSLSB");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/720.java