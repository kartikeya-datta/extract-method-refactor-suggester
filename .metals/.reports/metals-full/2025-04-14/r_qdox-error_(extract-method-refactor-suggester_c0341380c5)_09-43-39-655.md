error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10154.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10154.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10154.java
text:
```scala
I@@nternalIndexShard indexShard = (InternalIndexShard) indexService.shardSafe(request.shardId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10154.java