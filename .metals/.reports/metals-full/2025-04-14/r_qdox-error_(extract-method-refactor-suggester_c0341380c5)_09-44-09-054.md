error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6686.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6686.java
text:
```scala
S@@tring text = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6686.java