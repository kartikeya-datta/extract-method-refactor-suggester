error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3622.java
text:
```scala
c@@lient = (DistributedRPC.Iface) ServiceRegistry.getService(_local_drpc_id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3622.java