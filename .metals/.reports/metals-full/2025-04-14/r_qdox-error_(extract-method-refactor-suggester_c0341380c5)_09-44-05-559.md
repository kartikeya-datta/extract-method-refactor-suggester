error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9518.java
text:
```scala
a@@ddToBorder(new AjaxLink<Void>("hideLink")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9518.java