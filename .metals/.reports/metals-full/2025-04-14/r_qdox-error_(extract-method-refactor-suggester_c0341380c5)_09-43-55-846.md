error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4206.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4206.java
text:
```scala
 J@@avaModelManager.isResourceTreeLocked()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4206.java