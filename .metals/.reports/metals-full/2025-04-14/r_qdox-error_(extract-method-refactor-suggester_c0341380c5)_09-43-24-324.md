error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/463.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/463.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/463.java
text:
```scala
t@@ag.put("onclick", "location.href='" + url + "&" + getInputName()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/463.java