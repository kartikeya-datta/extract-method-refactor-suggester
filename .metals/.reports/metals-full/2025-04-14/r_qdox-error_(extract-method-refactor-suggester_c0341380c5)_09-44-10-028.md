error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9312.java
text:
```scala
P@@age page = application.getLastRenderedPage();
...
public class IncrementalTableNavigationTest extends WicketTestCase
{
	...
	public void testPagedTable() throws Exception
	{
		...
		Page page = (IncrementalTableNavigationPage)application.getLastRenderedPage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9312.java