error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2120.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2120.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2120.java
text:
```scala
r@@esponse.setCacheDuration(Integer.MAX_VALUE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2120.java