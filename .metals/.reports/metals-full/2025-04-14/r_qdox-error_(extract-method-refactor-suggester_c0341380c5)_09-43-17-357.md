error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7034.java
text:
```scala
c@@ontext.putPrivateData(InvocationType.class, InvocationType.DEPENDENCY_INJECTION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7034.java