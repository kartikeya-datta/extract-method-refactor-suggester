error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1548.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1548.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1548.java
text:
```scala
final C@@ollection<IColumn> filteredColumns = filter.reversed ? cf.getReverseSortedColumns() : cf.getSortedColumns();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1548.java