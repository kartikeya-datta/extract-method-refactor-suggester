error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10529.java
text:
```scala
C@@ollection<?> sourceCollection = (Collection<?>) source;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10529.java