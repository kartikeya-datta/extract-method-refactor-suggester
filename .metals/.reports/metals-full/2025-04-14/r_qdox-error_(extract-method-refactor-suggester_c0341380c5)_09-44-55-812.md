error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9902.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9902.java
text:
```scala
public static I@@con filesystemIcon = GUIUtilities.loadIcon("DriveSmall.png");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9902.java