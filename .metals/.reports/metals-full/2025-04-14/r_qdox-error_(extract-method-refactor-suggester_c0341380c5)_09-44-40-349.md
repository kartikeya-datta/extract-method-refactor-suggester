error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13410.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13410.java
text:
```scala
private volatile E@@ntityManagerFactory entityManagerFactory;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13410.java