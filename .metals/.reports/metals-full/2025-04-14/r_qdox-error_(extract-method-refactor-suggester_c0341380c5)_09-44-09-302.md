error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5525.java
text:
```scala
r@@eturn; // do not repoort against subsequent inherited methods
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5525.java