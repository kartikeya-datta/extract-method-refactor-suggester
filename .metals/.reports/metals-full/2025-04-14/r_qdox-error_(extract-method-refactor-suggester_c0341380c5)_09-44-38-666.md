error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5466.java
text:
```scala
p@@ublic abstract class AbstractLink extends HtmlContainer implements ILinkListener
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5466.java