error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1242.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1242.java
text:
```scala
r@@eturn rand.nextInt(gap) == 17;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1242.java