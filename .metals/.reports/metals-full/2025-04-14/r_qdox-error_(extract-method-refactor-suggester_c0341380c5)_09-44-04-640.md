error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16436.java
text:
```scala
i@@nt /*long*/ handle = table.handle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16436.java