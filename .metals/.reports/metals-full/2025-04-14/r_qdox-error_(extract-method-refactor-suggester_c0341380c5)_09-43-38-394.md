error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9064.java
text:
```scala
i@@f (!aMethod.getReturnType().getErasureSignature().equals(localReturnTypeESig) && !Modifier.isPrivate(aMethod.getModifiers())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9064.java