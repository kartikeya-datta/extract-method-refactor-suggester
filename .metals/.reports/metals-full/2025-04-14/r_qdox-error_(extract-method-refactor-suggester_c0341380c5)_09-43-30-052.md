error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2359.java
text:
```scala
n@@ew SubscribeDialog( getFrameMediator().getView().getFrame(), rootFolder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2359.java