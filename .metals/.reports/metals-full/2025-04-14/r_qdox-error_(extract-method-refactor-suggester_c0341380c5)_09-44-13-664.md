error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16384.java
text:
```scala
r@@eturn StoreException.LOCK;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16384.java