error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12376.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12376.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12376.java
text:
```scala
l@@ogin(get("username").getModelObjectAsString().toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12376.java