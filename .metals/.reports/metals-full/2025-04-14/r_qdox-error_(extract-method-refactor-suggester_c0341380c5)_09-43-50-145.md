error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/43.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/43.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/43.java
text:
```scala
S@@tring id = manager.createSessionId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/43.java