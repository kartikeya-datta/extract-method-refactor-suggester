error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1079.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1079.java
text:
```scala
A@@rray<btTypedConstraint> constraints = new Array<btTypedConstraint>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1079.java