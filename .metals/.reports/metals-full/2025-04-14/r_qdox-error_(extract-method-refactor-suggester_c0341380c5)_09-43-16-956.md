error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12016.java
text:
```scala
s@@etChoices(new AbstractReadOnlyModel<List< ? extends Locale>>()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12016.java