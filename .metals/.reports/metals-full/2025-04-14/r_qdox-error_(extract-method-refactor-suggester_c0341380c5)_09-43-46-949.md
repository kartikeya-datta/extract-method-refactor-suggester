error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7980.java
text:
```scala
d@@rawBackground (hDC, rect);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7980.java