error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6656.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6656.java
text:
```scala
t@@ag.append("class", (getIndex() % 2 == 0) ? CLASS_EVEN : CLASS_ODD, " ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6656.java