error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8176.java
...
```java
offset: 2083
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8176.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8176.java