error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8709.java
text:
```scala
r@@eturn "SessionDisconnectEvent[sessionId=" + this.sessionId + ", " +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8709.java