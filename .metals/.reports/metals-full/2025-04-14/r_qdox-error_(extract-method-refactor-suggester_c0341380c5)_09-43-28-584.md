error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13608.java
text:
```scala
p@@rocessorTarget.addDeploymentProcessor(Phase.DEPENDENCIES, Phase.POST_MODULE_POJO, new KernelDeploymentModuleProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13608.java