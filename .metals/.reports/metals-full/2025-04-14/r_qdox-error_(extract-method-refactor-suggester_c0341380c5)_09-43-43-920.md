error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14869.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14869.java
text:
```scala
p@@ublic class ResourceFinderResourceStreamLocator extends AbstractResourceStreamLocator
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14869.java