error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7714.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7714.java
text:
```scala
r@@eturn wtag;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7714.java