error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14657.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[369,2]

error in qdox parser
file content:
```java
offset: 7047
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14657.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14657.java