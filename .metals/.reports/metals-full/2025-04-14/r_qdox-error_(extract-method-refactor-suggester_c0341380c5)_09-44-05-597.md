error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7555.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7555.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7555.java
text:
```scala
s@@uper(START_DOCUMENT, location);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7555.java