error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/30.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/30.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/30.java
text:
```scala
S@@ecurityDomainReloadWriteHandler writeHandler = new SecurityDomainReloadWriteHandler(getAttributes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/30.java