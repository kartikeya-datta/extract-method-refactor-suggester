error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6284.java
text:
```scala
i@@f (!org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(fileName) || !packageFragment.getCompilationUnit(new String(fileName)).exists()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6284.java