error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12954.java
text:
```scala
T@@ime.millis(cookie.getMaxAge()).toDateString() + "(" + cookie.getMaxAge() + ")" + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12954.java