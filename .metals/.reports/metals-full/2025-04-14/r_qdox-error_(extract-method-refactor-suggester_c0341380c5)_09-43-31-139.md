error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5432.java
text:
```scala
a@@nonymousType.bits |= (ASTNode.IsAnonymousType|ASTNode.IsLocalType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5432.java