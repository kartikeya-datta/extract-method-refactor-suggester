error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2697.java
text:
```scala
i@@f (pVarResult == null || pVarResult.getType() == COM.VT_EMPTY) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2697.java