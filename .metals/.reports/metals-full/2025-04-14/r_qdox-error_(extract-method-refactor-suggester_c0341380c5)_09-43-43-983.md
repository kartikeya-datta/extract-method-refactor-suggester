error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4196.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4196.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4196.java
text:
```scala
i@@f (exceptionType == TypeBinding.NULL
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4196.java