error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5701.java
text:
```scala
L@@ist<T> decode(List<T> sequence);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5701.java