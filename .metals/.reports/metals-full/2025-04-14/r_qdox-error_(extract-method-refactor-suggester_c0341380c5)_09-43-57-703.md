error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2343.java
text:
```scala
S@@ystem.out.println("[JavaModelJarEntryFile.getContents()] Creating ZipFile on " + this.zipName); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2343.java