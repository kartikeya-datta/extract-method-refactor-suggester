error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7058.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7058.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7058.java
text:
```scala
I@@ndicesStatusResponse statusResponse = client("server1").admin().indices().prepareStatus().setRecovery(true).execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7058.java