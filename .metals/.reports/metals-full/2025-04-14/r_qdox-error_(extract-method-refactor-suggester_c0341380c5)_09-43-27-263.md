error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/175.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/175.java
text:
```scala
t@@his.slave = slave;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/175.java