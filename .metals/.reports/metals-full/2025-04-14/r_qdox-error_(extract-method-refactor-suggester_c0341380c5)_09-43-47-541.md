error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10769.java
text:
```scala
r@@eturn ((float) totalLag / (float) count);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10769.java