error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11549.java
text:
```scala
n@@ode.get(ModelDescriptionConstants.DESCRIPTION).set(OSGiDescriptionProviders.getResourceBundle(locale).getString("capability.remove"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11549.java