error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/227.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/227.java
text:
```scala
public I@@njector<ModifiableDataSource> getDSInjector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/227.java