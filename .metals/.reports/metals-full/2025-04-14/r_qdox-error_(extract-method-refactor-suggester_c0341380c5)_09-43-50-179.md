error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15357.java
text:
```scala
w@@indow = window.initWithContentRect(new NSRect(), styleMask, OS.NSBackingStoreBuffered, false, screen);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15357.java