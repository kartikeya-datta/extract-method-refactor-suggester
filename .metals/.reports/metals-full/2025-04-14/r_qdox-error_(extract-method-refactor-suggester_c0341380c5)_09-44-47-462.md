error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13944.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13944.java
text:
```scala
V@@ERSION = "8.0.0.Beta2-SNAPSHOT";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13944.java