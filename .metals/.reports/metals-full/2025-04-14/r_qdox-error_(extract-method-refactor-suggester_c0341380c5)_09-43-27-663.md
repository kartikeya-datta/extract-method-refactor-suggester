error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/368.java
text:
```scala
r@@esourceStream = Application.get().getResourceSettings().getResourceStreamFactory().newResourceStream(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/368.java