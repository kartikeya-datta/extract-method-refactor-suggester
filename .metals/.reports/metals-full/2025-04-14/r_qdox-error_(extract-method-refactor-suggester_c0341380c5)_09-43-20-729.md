error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7566.java
text:
```scala
c@@lassName = className.substring(className.lastIndexOf('.')+1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7566.java