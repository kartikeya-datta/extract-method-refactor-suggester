error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3515.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3515.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3515.java
text:
```scala
S@@tring str = new String(b, "ISO-8859-1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3515.java