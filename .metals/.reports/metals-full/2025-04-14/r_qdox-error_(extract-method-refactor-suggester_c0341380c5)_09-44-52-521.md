error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5474.java
text:
```scala
a@@ssertEquals("<wicket:panel>test</wicket:panel>", doc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5474.java