error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15966.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15966.java
text:
```scala
private final L@@ist validators = new ArrayList(2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15966.java