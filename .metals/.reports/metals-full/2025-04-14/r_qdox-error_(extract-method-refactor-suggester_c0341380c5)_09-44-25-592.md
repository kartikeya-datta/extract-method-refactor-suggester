error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3316.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3316.java
text:
```scala
public static R@@esolvedTypeMunger readMethod(VersionedDataInputStream s, ISourceContext context) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3316.java