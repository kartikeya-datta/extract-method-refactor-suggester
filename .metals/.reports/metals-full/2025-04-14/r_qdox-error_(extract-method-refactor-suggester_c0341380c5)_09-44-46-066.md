error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4788.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4788.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4788.java
text:
```scala
e@@xceptionType = exceptionType.resolveBindings(scope, bindings, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4788.java