error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3366.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3366.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3366.java
text:
```scala
i@@f (currentTransactionKey != null && status != Status.STATUS_COMMITTED) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3366.java