error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2255.java
text:
```scala
t@@hrow new SQLException("column 3 is NOT ai!");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2255.java