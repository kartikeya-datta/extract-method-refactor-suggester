error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8575.java
text:
```scala
n@@ew JoinGroupWizardAction(getURI().toString()).run(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8575.java