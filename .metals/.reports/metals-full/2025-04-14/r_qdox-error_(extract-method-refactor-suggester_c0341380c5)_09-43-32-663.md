error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18282.java
text:
```scala
i@@nt /*long*/ result = super.fixedSizeAllocateProc (widget, allocationPtr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18282.java