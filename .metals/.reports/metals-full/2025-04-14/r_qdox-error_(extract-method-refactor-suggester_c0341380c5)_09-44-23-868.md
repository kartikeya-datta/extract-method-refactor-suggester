error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/310.java
text:
```scala
l@@ayout.setSpacing(5, 5, 2, 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/310.java