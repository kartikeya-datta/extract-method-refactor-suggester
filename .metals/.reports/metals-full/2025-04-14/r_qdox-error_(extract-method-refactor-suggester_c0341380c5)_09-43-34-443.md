error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7345.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7345.java
text:
```scala
I@@D endpointID = IDUtil.createID(endpointDescription);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7345.java