error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1298.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1298.java
text:
```scala
s@@uper(desc.getLabel());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1298.java