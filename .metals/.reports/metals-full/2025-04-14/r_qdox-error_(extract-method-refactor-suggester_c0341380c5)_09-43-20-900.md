error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/79.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/79.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/79.java
text:
```scala
final S@@tring deploymentName = key.getName().replace('.', '_') + '_' + key.getSha1HashAsHexString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/79.java