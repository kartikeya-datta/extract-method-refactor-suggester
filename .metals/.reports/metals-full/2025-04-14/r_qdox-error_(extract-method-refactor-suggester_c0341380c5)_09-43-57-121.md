error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16118.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16118.java
text:
```scala
private static E@@mptyDataProvider<?> INSTANCE = new EmptyDataProvider<Void>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16118.java