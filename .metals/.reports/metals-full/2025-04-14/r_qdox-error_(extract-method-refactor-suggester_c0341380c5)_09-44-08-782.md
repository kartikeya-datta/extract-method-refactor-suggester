error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5363.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5363.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5363.java
text:
```scala
w@@idth = (int)(0.5f + size.width);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5363.java