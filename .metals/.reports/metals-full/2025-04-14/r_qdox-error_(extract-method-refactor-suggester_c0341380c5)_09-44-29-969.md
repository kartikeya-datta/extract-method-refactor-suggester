error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/958.java
text:
```scala
a@@rrayPool.free(usedArrays);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/958.java