error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1850.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1850.java
text:
```scala
final X@@mlTag xmlTag = (XmlTag)getParent().nextTag();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1850.java