error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2297.java
text:
```scala
i@@f (foundType != null && foundType != sourceType && foundType.problemId() != NotVisible)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2297.java