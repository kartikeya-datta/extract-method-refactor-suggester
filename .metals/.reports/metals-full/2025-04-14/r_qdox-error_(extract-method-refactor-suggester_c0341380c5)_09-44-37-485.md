error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14290.java
text:
```scala
r@@eturn getShell().getModalShell () == null && display.getModalDialog () == null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14290.java