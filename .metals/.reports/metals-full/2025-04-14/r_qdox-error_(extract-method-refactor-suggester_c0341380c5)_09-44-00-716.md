error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7048.java
text:
```scala
b@@oolean internalGetSetBooleanProperty(SimplePropertyDescriptor property, boolean get, boolean value) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7048.java