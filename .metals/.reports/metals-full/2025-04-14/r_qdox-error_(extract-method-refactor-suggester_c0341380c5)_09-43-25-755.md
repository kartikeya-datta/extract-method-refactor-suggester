error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6449.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6449.java
text:
```scala
i@@f (unit != null && unit.exists()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6449.java