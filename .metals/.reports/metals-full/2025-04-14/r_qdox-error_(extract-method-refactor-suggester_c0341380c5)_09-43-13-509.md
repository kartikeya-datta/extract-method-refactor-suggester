error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10441.java
text:
```scala
r@@eturn Character.valueOf(key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10441.java