error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16069.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16069.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16069.java
text:
```scala
protected B@@SFBeanInfoSupport(Class<?> beanClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16069.java