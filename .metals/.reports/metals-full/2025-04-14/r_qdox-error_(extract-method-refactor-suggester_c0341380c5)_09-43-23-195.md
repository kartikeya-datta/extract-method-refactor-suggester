error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15373.java
text:
```scala
A@@ssert.assertNull("Unknown resource should return null", loader.loadStringResource(component,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15373.java