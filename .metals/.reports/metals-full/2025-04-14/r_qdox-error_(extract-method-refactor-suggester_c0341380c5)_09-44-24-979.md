error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5988.java
text:
```scala
o@@utput.append('<');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5988.java