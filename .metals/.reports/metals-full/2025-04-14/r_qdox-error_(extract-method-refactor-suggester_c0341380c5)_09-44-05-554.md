error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6359.java
text:
```scala
t@@ransform.translate(0, 0, -3);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6359.java