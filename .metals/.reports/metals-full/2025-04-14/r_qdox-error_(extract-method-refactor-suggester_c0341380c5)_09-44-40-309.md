error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11204.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11204.java
text:
```scala
protected F@@astDateParser(final String pattern, final TimeZone timeZone, final Locale locale, final Date centuryStart) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11204.java