error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10420.java
text:
```scala
s@@uper(null, DomainResolver.getResolver(DOMAIN, false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10420.java