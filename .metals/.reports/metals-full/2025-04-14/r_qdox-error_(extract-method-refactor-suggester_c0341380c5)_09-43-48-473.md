error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9973.java
...
```java
offset: 789
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9973.java
text:
```scala
 ...
 ******************************************************************************/
p@@ackage com.badlogic.gdx.graphics.g3d.loaders;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9973.java