error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9464.java
text:
```scala
F@@lickScrollPaneLayoutTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9464.java