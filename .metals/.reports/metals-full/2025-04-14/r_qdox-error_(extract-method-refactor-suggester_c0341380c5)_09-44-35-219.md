error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4106.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4106.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4106.java
text:
```scala
s@@etText(WorkbenchMessages.ViewPane_fastView);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4106.java