error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3002.java
text:
```scala
i@@f (!indexMetaData.settings().getAsBoolean("index.warm.enabled", settings.getAsBoolean("index.warm.enabled", true))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3002.java