error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/605.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/605.java
text:
```scala
protected L@@istAdapter adapterFor(List<PullRequest> pullRequests) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/605.java