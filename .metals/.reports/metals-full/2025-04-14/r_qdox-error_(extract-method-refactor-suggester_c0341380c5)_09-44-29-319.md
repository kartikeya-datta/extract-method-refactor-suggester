error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2908.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2908.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2908.java
text:
```scala
t@@his.connectionsPerNode = componentSettings.getAsInt("connections_per_node", settings.getAsInt("transport.tcp.connection_per_node", 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2908.java