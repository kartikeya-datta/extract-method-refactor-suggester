error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1897.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1897.java
text:
```scala
S@@ession<L> session = this.factory.createSession(id, this.factory.createValue(id));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1897.java