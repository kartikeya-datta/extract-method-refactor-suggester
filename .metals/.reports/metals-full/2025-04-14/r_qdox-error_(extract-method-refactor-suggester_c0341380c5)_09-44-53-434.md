error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15297.java
...
```java
offset: 896
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15297.java
text:
```scala
 ...
 */
p@@ackage org.apache.commons.collections4.splitmap;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15297.java