error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2526.java
text:
```scala
t@@arget.add(fragmentContent);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2526.java