error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3611.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3611.java
text:
```scala
e@@ndpoint = Remoting.createEndpoint("cli-client", OptionMap.create(Options.THREAD_DAEMON, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3611.java