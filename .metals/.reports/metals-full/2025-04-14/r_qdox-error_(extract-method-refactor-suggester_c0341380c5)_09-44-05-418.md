error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1650.java
text:
```scala
T@@race.trace(ProviderPlugin.PLUGIN_ID, ECFProviderDebugOptions.DEBUG, "SOWrapper:oID=" + sharedObjectID + ":" + msg + ":cID=" + container.getID()); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1650.java