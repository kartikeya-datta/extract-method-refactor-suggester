error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5313.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5313.java
text:
```scala
public static v@@oid add(TableOwner frameController) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5313.java