error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3187.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3187.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3187.java
text:
```scala
final i@@nt srcFolderLength = sourceFolders[i].getLocation().addTrailingSeparator().toString().length();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3187.java