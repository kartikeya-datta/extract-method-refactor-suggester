error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/386.java
text:
```scala
P@@opupSettings settings = new PopupSettings(PageMap.forName("sources"), PopupSettings.RESIZABLE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/386.java