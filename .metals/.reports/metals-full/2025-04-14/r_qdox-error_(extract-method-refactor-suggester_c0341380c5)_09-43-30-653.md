error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6575.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6575.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6575.java
text:
```scala
i@@f (!active || !ClassReflection.isInstance(eventClass, event)) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6575.java