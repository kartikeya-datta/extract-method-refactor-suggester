error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1777.java
text:
```scala
t@@tl = TTL.parseTTL(s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1777.java