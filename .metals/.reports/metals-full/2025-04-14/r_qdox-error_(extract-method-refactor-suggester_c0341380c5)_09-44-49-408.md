error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9358.java
text:
```scala
t@@hrow new IllegalStateException("Can only have one occurrence of <?" + TemplateParser.EXTENSIONS_PI + "?>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9358.java