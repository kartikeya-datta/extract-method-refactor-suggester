error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5903.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5903.java
text:
```scala
final S@@tring type = JMeterUtils.getPropDefault("mode", MODE_STRIPPED_BATCH); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5903.java