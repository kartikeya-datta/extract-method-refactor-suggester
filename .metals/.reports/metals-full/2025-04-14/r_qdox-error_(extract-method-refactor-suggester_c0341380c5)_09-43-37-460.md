error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8062.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8062.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8062.java
text:
```scala
p@@aths.registerOperationHandler(REMOVE, PathRemoveHandler.NAMED_INSTANCE, PathRemoveHandler.NAMED_INSTANCE, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8062.java