error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8437.java
text:
```scala
i@@f (currentType == receiverErasure || receiverErasure.findSuperTypeWithSameErasure(currentType) != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8437.java