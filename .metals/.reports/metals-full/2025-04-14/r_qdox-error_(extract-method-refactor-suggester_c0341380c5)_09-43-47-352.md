error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/86.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/86.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/86.java
text:
```scala
c@@ontext.parsedFilter(filter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/86.java