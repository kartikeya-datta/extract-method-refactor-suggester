error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13747.java
text:
```scala
F@@ileUtils.close(r);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13747.java