error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9637.java
text:
```scala
s@@cope.problemReporter().javadocEmptyReturnTag(this.sourceStart, this.sourceEnd, scope.getDeclarationModifiers());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9637.java