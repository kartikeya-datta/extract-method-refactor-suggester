error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/760.java
text:
```scala
r@@eturn ThreadPool.Names.BULK;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/760.java