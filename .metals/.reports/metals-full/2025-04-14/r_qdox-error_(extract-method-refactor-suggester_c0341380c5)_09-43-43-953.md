error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2874.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2874.java
text:
```scala
i@@nt /*long*/ [] model = OS.GTK_VERSION < OS.VERSION (2, 2, 4) ? new int /*long*/ [1] : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2874.java