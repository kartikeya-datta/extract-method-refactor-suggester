error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5677.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5677.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5677.java
text:
```scala
R@@esult result= JUnitCore.runClasses(ParallelComputer.methods(), Example.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5677.java