error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10965.java
text:
```scala
D@@eploymentDescriptorEnvironment environment = new DeploymentDescriptorEnvironment("java:module/env/",data.getEnvironmentRefsGroupMetaData() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10965.java