error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10813.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10813.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10813.java
text:
```scala
private static final L@@ogger log = Logger.getLogger(ArquillianServiceDeployer.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10813.java