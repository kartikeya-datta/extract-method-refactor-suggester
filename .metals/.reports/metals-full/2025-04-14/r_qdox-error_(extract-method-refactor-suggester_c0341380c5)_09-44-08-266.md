error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1780.java
text:
```scala
p@@ublic class StaticWizard extends Wizard<String>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1780.java