error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3712.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3712.java
text:
```scala
private static final S@@tring FILE_ARGS = "HTTPsampler.Files"; // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3712.java