error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3013.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3013.java
text:
```scala
r@@eturn getWorkingCopies(BufferFactoryWrapper.create(factory));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3013.java