error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6522.java
text:
```scala
d@@atePriorToEpoch("/preepoch-star.tar");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6522.java