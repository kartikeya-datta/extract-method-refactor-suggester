error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7448.java
text:
```scala
M@@ap<String, Object> vars = new HashMap<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7448.java