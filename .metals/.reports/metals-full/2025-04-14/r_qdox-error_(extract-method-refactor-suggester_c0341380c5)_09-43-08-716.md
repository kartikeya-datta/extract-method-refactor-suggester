error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9747.java
text:
```scala
s@@etActionDefinitionId(IWorkbenchCommandConstants.WINDOW_SAVE_PERSPECTIVE_AS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9747.java