error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8482.java
text:
```scala
i@@nt len = sourceMethods.length;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8482.java