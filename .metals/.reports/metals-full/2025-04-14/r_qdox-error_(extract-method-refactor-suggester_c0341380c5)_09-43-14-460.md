error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7206.java
text:
```scala
c@@ontentRepo, hostControllerInfo, ignoredDomainResourceRegistry, authorizer.getWritableAuthorizerConfiguration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7206.java