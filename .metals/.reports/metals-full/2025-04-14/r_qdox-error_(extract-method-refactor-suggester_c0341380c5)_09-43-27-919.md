error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1216.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1216.java
text:
```scala
protected static l@@ong getCPtr(SWIGTYPE_p_f_r_btBroadphasePair_r_btCollisionDispatcher_r_q_const__btDispatcherInfo__void obj) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1216.java