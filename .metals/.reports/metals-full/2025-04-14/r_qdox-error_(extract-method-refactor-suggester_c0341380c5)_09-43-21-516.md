error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2004.java
text:
```scala
i@@f (reverse) return new SortField(fieldName, nullStringLastComparatorSource, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2004.java