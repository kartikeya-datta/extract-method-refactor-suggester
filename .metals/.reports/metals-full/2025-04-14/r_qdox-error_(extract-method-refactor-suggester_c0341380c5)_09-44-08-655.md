error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9300.java
text:
```scala
g@@etLogger().info( "Compiling " + filesToDo.size() + " JSP files" );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9300.java