error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/661.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/661.java
text:
```scala
public b@@oolean equals(final Object that)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/661.java