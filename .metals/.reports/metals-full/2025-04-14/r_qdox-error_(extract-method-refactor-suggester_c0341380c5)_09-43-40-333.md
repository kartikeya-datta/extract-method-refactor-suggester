error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2623.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2623.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2623.java
text:
```scala
S@@tringWriter writer = new StringWriter(input.length() * 2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2623.java