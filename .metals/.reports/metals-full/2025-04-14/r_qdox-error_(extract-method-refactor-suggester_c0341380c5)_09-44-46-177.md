error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2303.java
text:
```scala
c@@ore.getDirectoryFactory().remove(core.getDataDir(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2303.java