error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10801.java
text:
```scala
T@@hread.sleep(50);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10801.java