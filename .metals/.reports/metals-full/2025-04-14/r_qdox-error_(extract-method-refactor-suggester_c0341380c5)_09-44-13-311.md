error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/489.java
text:
```scala
r@@eturn !imapRootFolder.getAccountItem().getImapItem().getBoolean("exclude_from_checkall",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/489.java