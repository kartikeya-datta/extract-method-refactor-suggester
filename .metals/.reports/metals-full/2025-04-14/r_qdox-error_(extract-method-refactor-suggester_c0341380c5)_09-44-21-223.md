error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/273.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/273.java
text:
```scala
private static final Z@@ipShort HEADER_ID = new ZipShort(0x0001);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/273.java