error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9794.java
text:
```scala
a@@dd(queryParsersMap, new FilteredJsonQueryParser(index, indexSettings));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9794.java