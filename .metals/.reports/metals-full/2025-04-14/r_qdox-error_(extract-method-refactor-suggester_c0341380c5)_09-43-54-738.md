error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10334.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10334.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10334.java
text:
```scala
public static final V@@ersion V_1_0_0_RC1 = new Version(V_1_0_0_RC1_ID, false, org.apache.lucene.util.Version.LUCENE_46);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10334.java