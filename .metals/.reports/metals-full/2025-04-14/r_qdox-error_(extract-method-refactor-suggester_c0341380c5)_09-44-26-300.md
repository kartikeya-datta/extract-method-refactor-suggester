error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12460.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12460.java
text:
```scala
private final I@@SortState old = Objects.cloneModel(stateLocator.getSortState());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12460.java