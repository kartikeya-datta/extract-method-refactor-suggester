error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6698.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6698.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6698.java
text:
```scala
private O@@bject recursiveResolveProperty( final String content,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6698.java