error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9985.java
text:
```scala
E@@jbMessages.MESSAGES.annotationOnlyAllowedOnClass(sessionBeanAnnotation.name().toString(), target);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9985.java