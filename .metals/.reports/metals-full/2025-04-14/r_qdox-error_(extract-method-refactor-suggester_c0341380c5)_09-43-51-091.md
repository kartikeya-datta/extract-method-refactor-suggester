error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7781.java
text:
```scala
c@@reateIndexAction.execute(new CreateIndexRequest(request).index(request.index()).cause("auto(delete api)").masterNodeTimeout(request.timeout()), new ActionListener<CreateIndexResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7781.java