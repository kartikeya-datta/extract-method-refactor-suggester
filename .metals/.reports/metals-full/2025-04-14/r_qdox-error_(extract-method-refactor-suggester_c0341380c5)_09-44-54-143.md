error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13919.java
text:
```scala
r@@eturn new ServerSubsystemAdd(namespaceUri);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13919.java