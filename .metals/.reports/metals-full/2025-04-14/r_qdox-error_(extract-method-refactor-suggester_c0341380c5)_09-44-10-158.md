error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1225.java
text:
```scala
c@@reation versus setLength(0) approach for various message sizes and
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1225.java