error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2482.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2482.java
text:
```scala
public P@@atternKeywordMarkerFilter(TokenStream in, Pattern pattern) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2482.java