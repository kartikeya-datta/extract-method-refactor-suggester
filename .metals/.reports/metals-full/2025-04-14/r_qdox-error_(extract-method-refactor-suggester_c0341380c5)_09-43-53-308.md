error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15948.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15948.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15948.java
text:
```scala
private final M@@ap/*<Locale, NumberFormat>*/ numberFormats = new HashMap/*<Locale, NumberFormat>*/();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15948.java