error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6902.java
text:
```scala
l@@ist.add(DomainSubsystemUpdate.create(name, update));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6902.java