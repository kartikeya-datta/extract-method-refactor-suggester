error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8315.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8315.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8315.java
text:
```scala
a@@dd(new NavigationPanel("mainNavigation", "Charset encoding Example"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8315.java