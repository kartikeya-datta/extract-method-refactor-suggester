error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3798.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3798.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3798.java
text:
```scala
e@@ndpoints.add(metadata.getEndpoint(iter.next()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3798.java