error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1497.java
text:
```scala
i@@f (originalBinding != this.binding && originalBinding.type != this.binding.type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1497.java