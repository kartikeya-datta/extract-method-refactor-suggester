error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13799.java
text:
```scala
p@@haseServiceBuilder.addDependencies(Services.deploymentUnitName(deploymentUnit.getParent().getName(), nextPhase));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13799.java