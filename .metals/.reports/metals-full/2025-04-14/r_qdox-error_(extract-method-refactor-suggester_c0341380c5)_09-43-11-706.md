error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8216.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8216.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8216.java
text:
```scala
public v@@oid serviceFailed(ServiceController<?> serviceController, StartException reason) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8216.java