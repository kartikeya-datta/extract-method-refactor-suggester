error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2185.java
text:
```scala
D@@istance precision = Distance.parseDistance(pinFieldData.get("precision").toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2185.java