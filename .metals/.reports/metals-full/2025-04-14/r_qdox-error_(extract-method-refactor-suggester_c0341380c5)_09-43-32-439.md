error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2973.java
text:
```scala
t@@his( urls, Thread.currentThread().getContextClassLoader() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2973.java