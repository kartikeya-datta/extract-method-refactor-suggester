error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7051.java
text:
```scala
i@@f (org.eclipse.jdt.internal.compiler.util.Util.isJavaFileName(pathname)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7051.java