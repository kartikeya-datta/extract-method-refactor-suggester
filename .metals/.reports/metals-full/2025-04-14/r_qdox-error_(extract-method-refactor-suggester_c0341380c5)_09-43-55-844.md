error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2936.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2936.java
text:
```scala
final U@@ser user = LibrarySession.get().authenticate(username, password);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2936.java