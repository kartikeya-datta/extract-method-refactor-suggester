error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/864.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/864.java
text:
```scala
r@@esult [keys [i]] = items [keys [i]];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/864.java