error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7328.java
text:
```scala
a@@spect A pertarget(target(Interface)) { // was a warning in 1.0
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7328.java