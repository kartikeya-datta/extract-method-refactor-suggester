error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7299.java
text:
```scala
S@@et<String> scripts = new HashSet<>(Arrays.asList("han", "hiragana", "katakana", "hangul"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7299.java