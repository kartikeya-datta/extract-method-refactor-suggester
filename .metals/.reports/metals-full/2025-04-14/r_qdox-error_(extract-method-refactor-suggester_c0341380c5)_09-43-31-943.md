error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2787.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2787.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,94]

error in qdox parser
file content:
```java
offset: 94
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2787.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2787.java