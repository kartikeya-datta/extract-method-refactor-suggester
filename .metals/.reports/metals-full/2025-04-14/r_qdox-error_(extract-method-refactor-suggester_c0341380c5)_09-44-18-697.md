error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/894.java
text:
```scala
b@@order = new LibraryApplicationBorder(this,"border");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/894.java