error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5226.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5226.java
text:
```scala
a@@ssertThat(searchResponse.isTimedOut(), equalTo(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5226.java