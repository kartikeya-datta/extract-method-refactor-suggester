error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13238.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13238.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13238.java
text:
```scala
i@@f (line.length() == 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13238.java