error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2666.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2666.java
text:
```scala
C@@lass<? extends Page> internalErrorPageClass = application.getApplicationSettings()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2666.java