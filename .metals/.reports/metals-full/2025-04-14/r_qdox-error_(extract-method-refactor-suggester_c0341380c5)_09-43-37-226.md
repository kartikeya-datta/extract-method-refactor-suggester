error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11925.java
text:
```scala
d@@omainController.unregisterRemoteHost(hostId, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11925.java