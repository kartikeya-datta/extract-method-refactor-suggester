error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2024.java
...
```java
offset: 1004
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2024.java
text:
```scala
...
p@@ackage org.elasticsearch.action.delete.index;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2024.java