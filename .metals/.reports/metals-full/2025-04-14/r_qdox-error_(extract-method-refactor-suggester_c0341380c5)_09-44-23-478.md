error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15041.java
text:
```scala
n@@ew MyTree(this, "tree", treeModel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15041.java