error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10311.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10311.java
text:
```scala
public I@@mmutableMap<String, BlobMetaData> listBlobsByPrefix(String container, String keyPath, String prefix) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10311.java