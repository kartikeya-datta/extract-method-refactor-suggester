error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6630.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6630.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh().force(REFRESH_FORCE).source("refresh_flag_get"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6630.java