error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14228.java
text:
```scala
S@@erviceName DEPLOYMENT_PROCESSOR_SERVICE_NAME = ServiceName.JBOSS.append("deployment", "processor");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14228.java