error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1493.java
text:
```scala
r@@eturn (kb ? freeSpaceWindows(path, timeout) / FileUtils.ONE_KB : freeSpaceWindows(path, timeout));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1493.java