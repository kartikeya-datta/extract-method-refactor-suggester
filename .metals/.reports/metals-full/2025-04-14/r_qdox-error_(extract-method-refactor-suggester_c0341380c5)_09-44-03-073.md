error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5972.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5972.java
text:
```scala
i@@f (fields[fieldI] != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5972.java