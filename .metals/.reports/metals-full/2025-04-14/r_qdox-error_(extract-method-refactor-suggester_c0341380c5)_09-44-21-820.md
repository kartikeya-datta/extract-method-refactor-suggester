error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/253.java
text:
```scala
t@@hrow new DeploymentUnitProcessingException("Failed to get module attachment for deployment: " + context.getName(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/253.java