error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11275.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11275.java
text:
```scala
public static final A@@ttachmentKey<AttachmentList<ServiceName>> JNDI_DEPENDENCIES = AttachmentKey.createList(ServiceName.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11275.java