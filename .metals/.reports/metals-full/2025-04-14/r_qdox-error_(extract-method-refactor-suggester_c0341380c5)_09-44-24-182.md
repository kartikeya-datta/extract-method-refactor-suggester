error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14027.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14027.java
text:
```scala
private volatile S@@tring fileName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14027.java