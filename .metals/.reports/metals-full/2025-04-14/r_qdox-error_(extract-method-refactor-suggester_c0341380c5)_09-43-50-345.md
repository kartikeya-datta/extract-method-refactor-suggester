error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13032.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13032.java
text:
```scala
public v@@oid testExtXptID() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13032.java