error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4436.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4436.java
text:
```scala
final H@@ostRunningModeControl runningModeControl = environment.getRunningModeControl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4436.java