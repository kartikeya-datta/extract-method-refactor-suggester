error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9837.java
text:
```scala
E@@valuationContext createEvaluationContext(Collection<Cache> caches, Method method, Object[] args,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9837.java