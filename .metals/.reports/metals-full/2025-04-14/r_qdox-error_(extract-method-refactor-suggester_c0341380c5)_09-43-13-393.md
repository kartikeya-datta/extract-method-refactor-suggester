error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13219.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13219.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13219.java
text:
```scala
a@@pplication.getApplication().getPageSettings().addComponentResolver(new ScopedComponentResolver());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13219.java