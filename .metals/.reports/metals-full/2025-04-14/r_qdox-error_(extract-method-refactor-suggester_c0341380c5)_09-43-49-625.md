error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2985.java
text:
```scala
r@@eturn Strings.escapeMarkup(modelString, false, false).toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2985.java