error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6780.java
text:
```scala
U@@ndertowLogger.ROOT_LOGGER.failedToPersistSessionAttribute(sessionAttribute.getKey(), sessionAttribute.getValue(), sessionEntry.getKey(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6780.java