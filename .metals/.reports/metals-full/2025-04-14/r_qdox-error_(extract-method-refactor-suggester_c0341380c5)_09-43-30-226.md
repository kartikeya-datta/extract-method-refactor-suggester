error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8059.java
text:
```scala
l@@ogprop("user.dir",true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8059.java