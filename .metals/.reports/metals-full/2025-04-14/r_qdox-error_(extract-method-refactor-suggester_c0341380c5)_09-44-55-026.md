error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/827.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/827.java
text:
```scala
public static final S@@tring NAME = "child";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/827.java