error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7930.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7930.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7930.java
text:
```scala
S@@ystem.out.println("Indexed " + (i * BATCH) + " took " + stopWatch.stop().lastTaskTime());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7930.java