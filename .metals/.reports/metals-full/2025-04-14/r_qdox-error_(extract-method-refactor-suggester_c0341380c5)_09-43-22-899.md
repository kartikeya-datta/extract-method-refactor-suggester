error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2473.java
text:
```scala
i@@nt row = Math.max(0, Math.min(index, getLineCount() - 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2473.java