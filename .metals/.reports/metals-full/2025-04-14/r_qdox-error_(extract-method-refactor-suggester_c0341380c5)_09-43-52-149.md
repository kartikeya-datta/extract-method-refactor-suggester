error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4114.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4114.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4114.java
text:
```scala
r@@eturn MathUtils.radiansToDegrees * angle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4114.java