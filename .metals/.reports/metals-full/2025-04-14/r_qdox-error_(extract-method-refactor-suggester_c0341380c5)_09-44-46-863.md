error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6016.java
text:
```scala
R@@OOT_LOGGER.startingSubsystem("JCA", Version.FULL_VERSION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6016.java