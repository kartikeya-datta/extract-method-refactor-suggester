error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10161.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10161.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10161.java
text:
```scala
Q@@ueueConnectionFactory qcf = (QueueConnectionFactory)ctx.lookup("java:/ConnectionFactory");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10161.java