error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8076.java
text:
```scala
f@@alse, // no access rules to combine
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8076.java