error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1103.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1103.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1103.java
text:
```scala
r@@eturn new StringBuffer("TypeIndictment("/*nonNLS*/).append(fName).append(")"/*nonNLS*/).toString();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1103.java