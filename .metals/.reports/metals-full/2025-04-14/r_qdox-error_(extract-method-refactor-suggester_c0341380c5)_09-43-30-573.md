error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15828.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15828.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15828.java
text:
```scala
i@@f (argList [1] == (end - start + 1)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15828.java