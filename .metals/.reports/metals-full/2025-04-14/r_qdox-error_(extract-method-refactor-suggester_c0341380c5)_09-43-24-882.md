error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9858.java
text:
```scala
r@@eturn valuesSource == null ? 0 : sums.get(owningBucketOrd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9858.java