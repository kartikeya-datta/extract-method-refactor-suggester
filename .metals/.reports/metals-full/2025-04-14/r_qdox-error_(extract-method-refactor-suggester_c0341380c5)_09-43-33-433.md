error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5388.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5388.java
text:
```scala
f@@oundit = (next == fileNameMapper
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5388.java