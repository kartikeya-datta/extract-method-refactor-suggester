error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1821.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1821.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1821.java
text:
```scala
J@@avaModelManager manager = JavaModelManager.getJavaModelManager();
...
void removeBinaryChildren() throws JavaModelException {
	if (this.binaryChildren != null) {
		...
		this.binaryChildren = NO_CHILDREN;
	}
}
}
```
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1821.java