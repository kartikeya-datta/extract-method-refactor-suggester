error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14996.java
text:
```scala
d@@ependencyLoader = Module.getBootModuleLoader();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14996.java