error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12970.java
text:
```scala
f@@ormComponent.isVisible() && formComponent.isEnabledInHierarchy())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12970.java