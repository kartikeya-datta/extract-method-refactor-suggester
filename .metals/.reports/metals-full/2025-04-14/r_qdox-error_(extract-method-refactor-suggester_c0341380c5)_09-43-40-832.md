error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17549.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[950,81]

error in qdox parser
file content:
```java
offset: 27813
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17549.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17549.java