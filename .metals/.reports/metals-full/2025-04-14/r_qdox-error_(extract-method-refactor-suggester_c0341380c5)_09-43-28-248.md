error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1401.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1401.java
text:
```scala
public v@@oid testWithSlash() throws Exception
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1401.java