error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9300.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9300.java
text:
```scala
l@@ist.update(currentSelection, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9300.java