error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7020.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7020.java
text:
```scala
l@@ong count = Lucene.count(searcher, query);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7020.java