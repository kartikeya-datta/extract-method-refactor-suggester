error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4122.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4122.java
text:
```scala
 T@@YPE_ISSUES.equals(type) && ((IssuesPayload) payload).getIssue() != null //
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4122.java