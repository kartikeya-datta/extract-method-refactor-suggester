error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10797.java
text:
```scala
i@@f (destFile.getAbsolutePath().equals(sourceFile.getAbsolutePath())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10797.java