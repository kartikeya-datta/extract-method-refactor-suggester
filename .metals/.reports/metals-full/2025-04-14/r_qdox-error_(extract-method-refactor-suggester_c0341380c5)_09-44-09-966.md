error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11685.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11685.java
text:
```scala
protected S@@et<String> getMappingPathPatterns(String key) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11685.java