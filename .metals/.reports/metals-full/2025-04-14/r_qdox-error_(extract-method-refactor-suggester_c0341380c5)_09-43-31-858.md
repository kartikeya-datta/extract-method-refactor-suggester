error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/336.java
text:
```scala
i@@f (button.getForm() == Form.this
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/336.java