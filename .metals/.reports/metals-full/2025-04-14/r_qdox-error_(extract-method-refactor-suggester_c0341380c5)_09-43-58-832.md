error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3893.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3893.java
text:
```scala
private final L@@ist headerData;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3893.java