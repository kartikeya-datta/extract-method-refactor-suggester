error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16680.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16680.java
text:
```scala
C@@ontrol control = Display.GetFocusControl(window);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16680.java