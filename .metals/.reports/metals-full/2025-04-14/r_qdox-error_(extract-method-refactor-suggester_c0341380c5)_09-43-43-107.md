error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1469.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1469.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1469.java
text:
```scala
P@@latformMBeanDescriptions.getResolver("garbage-collectors"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1469.java