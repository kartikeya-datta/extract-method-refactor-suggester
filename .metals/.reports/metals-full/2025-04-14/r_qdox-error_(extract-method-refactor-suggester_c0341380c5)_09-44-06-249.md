error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1808.java
text:
```scala
i@@f (bundleClassName.startsWith("org.eclipse.osgi")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1808.java