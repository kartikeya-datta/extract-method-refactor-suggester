error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14562.java
text:
```scala
O@@S.TTS_NOPREFIX,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14562.java