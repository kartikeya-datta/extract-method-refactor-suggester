error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3670.java
text:
```scala
p@@ublic class Import
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3670.java