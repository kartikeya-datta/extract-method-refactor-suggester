error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15879.java
text:
```scala
t@@hrow new TimeoutException(CONNECT_TIMEOUT, NLS.bind(Messages.IRCChannelContainer_Exception_Connect_Timeout, connectID.getName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15879.java