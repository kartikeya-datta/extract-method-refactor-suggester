error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11339.java
...
```java
offset: 29
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11339.java
text:
```scala
public class ParamsUtils {

p@@ackage org.jboss.as.connector.subsystems.connector;

import org.jboss.dmr.ModelNode;

public class NewParamsUtils {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11339.java