error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1902.java
text:
```scala
i@@tem.add(new Label(componentId, createLabelModel(model)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1902.java