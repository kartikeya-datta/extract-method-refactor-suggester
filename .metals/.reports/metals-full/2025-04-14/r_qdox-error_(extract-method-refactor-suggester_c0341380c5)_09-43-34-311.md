error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3354.java
text:
```scala
i@@nt attributeNumber = classFile.generateMethodInfoAttribute(this.binding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3354.java