error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7625.java
text:
```scala
r@@eturn new SignificantStringTerms(subsetSize, supersetSize, getName(), requiredSize, minDocCount, buckets);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7625.java