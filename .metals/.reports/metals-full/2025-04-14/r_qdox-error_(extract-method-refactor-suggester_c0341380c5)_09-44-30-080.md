error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5084.java
text:
```scala
U@@RL iconURL = GuiMain.class.getResource("/icon/wildfly.png");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5084.java