error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3445.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3445.java
text:
```scala
public static final S@@erviceName SERVICE_NAME = Services.JBOSS_AS.append("weld", "singleton");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3445.java