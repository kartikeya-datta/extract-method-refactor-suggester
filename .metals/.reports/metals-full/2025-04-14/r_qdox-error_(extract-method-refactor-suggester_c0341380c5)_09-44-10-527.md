error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1939.java
text:
```scala
S@@tring STORE_DATA_SEG_BACKUP_COMPLETED  = "D006";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1939.java