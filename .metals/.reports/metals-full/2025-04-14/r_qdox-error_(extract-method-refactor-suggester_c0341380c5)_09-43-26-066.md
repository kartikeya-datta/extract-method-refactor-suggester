error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4651.java
text:
```scala
t@@his.progressMonitor.beginTask("", filePaths.length * (this.pattern.mustResolve ? 10 : 5)); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4651.java