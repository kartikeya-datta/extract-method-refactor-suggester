error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9237.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9237.java
text:
```scala
r@@eturn new Class<?>[] { Environment.class };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9237.java