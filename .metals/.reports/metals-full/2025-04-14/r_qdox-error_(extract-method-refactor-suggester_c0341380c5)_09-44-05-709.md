error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/878.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/878.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/878.java
text:
```scala
g@@etProject().enableLogging( getLogger() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/878.java