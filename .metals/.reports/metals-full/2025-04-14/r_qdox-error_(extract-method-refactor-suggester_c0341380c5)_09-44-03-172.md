error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10559.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10559.java
text:
```scala
private final C@@ontext context;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10559.java