error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10318.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10318.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10318.java
text:
```scala
m@@apperParser.putTypeParser(AttachmentMapper.CONTENT_TYPE, new AttachmentMapper.TypeParser());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10318.java