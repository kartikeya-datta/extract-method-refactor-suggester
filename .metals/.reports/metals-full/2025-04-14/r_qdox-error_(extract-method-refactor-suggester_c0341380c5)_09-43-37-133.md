error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/986.java
text:
```scala
p@@ushOnAstStack(new EmptyStatement(this.endPosition + 1, this.endStatementPosition));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/986.java