error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2904.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2904.java
text:
```scala
t@@hrow new InvalidMatrixException("incorrect dimensions");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2904.java