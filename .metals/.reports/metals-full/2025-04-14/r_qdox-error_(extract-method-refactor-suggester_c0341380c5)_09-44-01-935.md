error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4152.java
text:
```scala
I@@RequestTarget targetForRequest(ObsoleteRequestParameters requestParameters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4152.java