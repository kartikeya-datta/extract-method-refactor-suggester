error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6616.java
text:
```scala
Q@@uery query = new DeletionAwareConstantScoreQuery(context.filterCache().cache(Queries.MATCH_ALL_FILTER));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6616.java