error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2095.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2095.java
text:
```scala
r@@esult.setContentLength(content.getBytes().length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2095.java