error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12736.java
text:
```scala
S@@tring prefix = new String(bytes,0,Math.min(bytes.length, 2000)).toLowerCase(java.util.Locale.ENGLISH);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12736.java