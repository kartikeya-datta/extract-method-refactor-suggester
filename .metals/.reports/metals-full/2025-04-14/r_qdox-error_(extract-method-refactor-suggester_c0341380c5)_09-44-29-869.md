error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4916.java
text:
```scala
S@@tring[] names = org.eclipse.jdt.internal.core.Util.getTrimmedSimpleNames(newFragName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4916.java