error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10228.java
text:
```scala
r@@eturn size() == 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10228.java