error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9523.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9523.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9523.java
text:
```scala
r@@eturn part.getTitle();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9523.java