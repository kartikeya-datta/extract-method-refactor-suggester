error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6793.java
text:
```scala
S@@erverOperationResolver.addToDontPropagateToServersAttachment(context, operation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6793.java