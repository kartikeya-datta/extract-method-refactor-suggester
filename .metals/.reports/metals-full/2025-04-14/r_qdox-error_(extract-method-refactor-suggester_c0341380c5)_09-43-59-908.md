error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9838.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9838.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9838.java
text:
```scala
a@@ction="traceln(\"Injecting rollback fault via Byteman\");$1.setRollbackOnly()")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9838.java