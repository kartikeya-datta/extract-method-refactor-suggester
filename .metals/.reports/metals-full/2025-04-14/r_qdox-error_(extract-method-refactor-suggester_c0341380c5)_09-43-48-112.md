error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/937.java
...
```java
offset: 932
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/937.java
text:
```scala
 ...
 * under the License.
 */
p@@ackage org.elasticsearch.search.aggregations.metrics;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/937.java