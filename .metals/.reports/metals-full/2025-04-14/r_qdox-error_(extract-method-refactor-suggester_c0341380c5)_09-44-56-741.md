error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/143.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/143.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/143.java
text:
```scala
i@@f (currentJob != null && (jobFamily == null || currentJob.belongsTo(jobFamily))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/143.java