error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4115.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4115.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4115.java
text:
```scala
s@@earchLookup = new SearchLookup(mapperService(), fieldData(), request.types());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4115.java