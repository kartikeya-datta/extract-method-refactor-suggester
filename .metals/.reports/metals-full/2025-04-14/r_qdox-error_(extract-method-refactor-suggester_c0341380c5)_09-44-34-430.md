error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6656.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6656.java
text:
```scala
private final static S@@tring customDesktopLib = "D:\\Data\\code\\android\\libs\\libgdx\\extensions\\gdx-bullet\\jni\\vs\\gdxBullet\\x64\\Debug\\gdxBullet.dll";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6656.java