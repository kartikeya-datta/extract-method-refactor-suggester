error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3205.java
text:
```scala
S@@ourceElementParser parser = new SourceElementParser(requestor, problemFactory, true); // index local declarations
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3205.java