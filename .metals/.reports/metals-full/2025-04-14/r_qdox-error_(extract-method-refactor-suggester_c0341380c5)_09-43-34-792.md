error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3723.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3723.java
text:
```scala
public static final i@@nt PROP_DIRTY = WorkbenchPartConstants.PROP_DIRTY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3723.java