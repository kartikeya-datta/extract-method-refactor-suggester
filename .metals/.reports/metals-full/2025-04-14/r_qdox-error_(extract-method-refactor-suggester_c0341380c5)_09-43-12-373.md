error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15976.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15976.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15976.java
text:
```scala
private final M@@ockDomainObject domainObject;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15976.java