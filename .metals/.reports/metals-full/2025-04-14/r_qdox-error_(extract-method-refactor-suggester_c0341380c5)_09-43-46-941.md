error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5624.java
text:
```scala
f@@ail("failed to find mappings for index " + index + ", type " + type + ", fields " + fieldNames + ", on master node, mapping source [" + source + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5624.java