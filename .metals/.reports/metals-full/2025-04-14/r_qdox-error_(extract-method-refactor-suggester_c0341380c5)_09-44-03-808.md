error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4278.java
text:
```scala
s@@uite.addTestSuite(AnnotationsBinaryWeaving.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4278.java