error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1950.java
text:
```scala
f@@ixedBitSetFilterCache.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1950.java