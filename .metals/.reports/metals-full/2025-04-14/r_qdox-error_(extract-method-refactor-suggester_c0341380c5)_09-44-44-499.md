error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4700.java
text:
```scala
c@@reateIndexBasedOnFieldSettings("test", "alias", testFieldSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4700.java