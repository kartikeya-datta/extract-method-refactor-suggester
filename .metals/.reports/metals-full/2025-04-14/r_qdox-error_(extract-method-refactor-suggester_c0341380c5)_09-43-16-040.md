error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8183.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8183.java
text:
```scala
static i@@nt MINOR_VERSION = 126;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8183.java