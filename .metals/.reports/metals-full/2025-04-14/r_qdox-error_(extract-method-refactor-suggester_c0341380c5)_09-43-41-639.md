error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4119.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4119.java
text:
```scala
public L@@inearGroup (String name, float width, float height, LinearGroupLayout layout) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4119.java