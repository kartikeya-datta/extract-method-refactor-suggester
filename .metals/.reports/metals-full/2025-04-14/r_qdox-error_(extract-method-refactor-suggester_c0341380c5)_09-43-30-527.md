error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15012.java
text:
```scala
i@@f (re instanceof WicketRuntimeException || re instanceof AbortException)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15012.java