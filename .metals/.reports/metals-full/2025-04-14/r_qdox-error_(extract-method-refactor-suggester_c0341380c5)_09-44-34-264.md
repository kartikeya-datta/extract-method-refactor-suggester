error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11650.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11650.java
text:
```scala
public V@@oid getValue() throws IllegalStateException, IllegalArgumentException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11650.java