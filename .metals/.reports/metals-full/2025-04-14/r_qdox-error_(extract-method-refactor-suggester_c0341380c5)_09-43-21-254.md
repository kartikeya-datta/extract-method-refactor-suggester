error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5364.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5364.java
text:
```scala
public S@@tring[] projectPrerequisites(IClasspathEntry[] entries)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5364.java