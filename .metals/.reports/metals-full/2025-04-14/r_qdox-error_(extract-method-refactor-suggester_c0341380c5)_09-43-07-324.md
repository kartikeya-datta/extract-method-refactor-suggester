error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13446.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13446.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13446.java
text:
```scala
c@@onfiguration.addViewInterceptor(AccessCheckingInterceptor.getFactory(), InterceptorOrder.View.CHECKING_INTERCEPTOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13446.java