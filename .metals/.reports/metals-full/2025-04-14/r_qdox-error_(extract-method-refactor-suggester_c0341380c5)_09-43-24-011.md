error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12330.java
text:
```scala
C@@lassLoaderWeavingAdaptor clwAdaptor = new ClassLoaderWeavingAdaptor();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12330.java