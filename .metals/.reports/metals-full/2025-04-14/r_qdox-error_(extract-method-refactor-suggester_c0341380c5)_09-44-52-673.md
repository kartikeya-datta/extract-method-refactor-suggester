error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4779.java
text:
```scala
c@@onfiguration.addViewInterceptor(method, factory, InterceptorOrder.View.COMPONENT_DISPATCHER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4779.java