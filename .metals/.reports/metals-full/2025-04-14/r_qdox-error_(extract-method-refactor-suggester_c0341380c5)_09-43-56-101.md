error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7211.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7211.java
text:
```scala
q@@ueryExplanations = new ArrayList<>(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7211.java