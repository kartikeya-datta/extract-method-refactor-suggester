error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13269.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13269.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13269.java
text:
```scala
public v@@oid testBzipCreation()  throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13269.java