error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10653.java
text:
```scala
w@@idget.init ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10653.java