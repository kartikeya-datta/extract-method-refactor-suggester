error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1600.java
text:
```scala
s@@erver.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1600.java