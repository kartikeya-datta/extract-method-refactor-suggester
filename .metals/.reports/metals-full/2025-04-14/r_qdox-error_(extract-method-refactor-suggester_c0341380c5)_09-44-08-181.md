error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3125.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3125.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3125.java
text:
```scala
r@@olloutPlan.addValueConverter("content", new HeadersArgumentValueConverter(this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3125.java