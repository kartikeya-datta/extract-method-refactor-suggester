error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5396.java
text:
```scala
w@@hile ((parent != null) && (parent.isTransparentResolver()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5396.java