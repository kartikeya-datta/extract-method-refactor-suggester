error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5228.java
text:
```scala
s@@hortcutbarWasEnabled = shortcutBarControl.getEnabled();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5228.java