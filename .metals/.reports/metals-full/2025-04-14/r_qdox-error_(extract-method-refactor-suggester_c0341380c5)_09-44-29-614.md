error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/545.java
text:
```scala
s@@uper(settings, MultiTermVectorsAction.NAME, threadPool);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/545.java