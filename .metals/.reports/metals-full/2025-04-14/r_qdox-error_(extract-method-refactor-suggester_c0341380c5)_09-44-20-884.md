error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9553.java
text:
```scala
t@@exture = new Texture(Gdx.files.internal("data/badlogicsmall.jpg"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9553.java