error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2439.java
text:
```scala
a@@ssertTrue(Constants.LUCENE_VERSION + " should start with: "+version,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2439.java