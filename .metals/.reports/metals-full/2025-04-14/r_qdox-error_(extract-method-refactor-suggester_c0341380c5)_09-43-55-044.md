error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5966.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5966.java
text:
```scala
public v@@oid resetStateForCodeGeneration() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5966.java