error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1662.java
text:
```scala
m@@atcher = new StringMatcher("*" + patternString + "*", true, false); //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1662.java