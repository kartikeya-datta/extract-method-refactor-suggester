error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6477.java
text:
```scala
m@@etaRepositoryPlugin = addValue(new MetaDataRepositoryValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6477.java