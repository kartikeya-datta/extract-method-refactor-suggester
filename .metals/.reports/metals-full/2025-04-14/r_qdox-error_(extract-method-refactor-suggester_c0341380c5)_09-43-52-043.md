error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8739.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8739.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8739.java
text:
```scala
t@@his.type.resolvedType = typeBinding;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8739.java