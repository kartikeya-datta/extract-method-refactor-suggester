error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10835.java
text:
```scala
r@@eturn new URLResource(url, url.openConnection(), path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10835.java