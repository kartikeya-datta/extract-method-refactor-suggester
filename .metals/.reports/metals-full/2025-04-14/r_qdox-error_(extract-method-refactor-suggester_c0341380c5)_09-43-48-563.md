error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8358.java
text:
```scala
U@@nresolvedType anything = GenericsWildcardTypeX.GENERIC_WILDCARD;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8358.java