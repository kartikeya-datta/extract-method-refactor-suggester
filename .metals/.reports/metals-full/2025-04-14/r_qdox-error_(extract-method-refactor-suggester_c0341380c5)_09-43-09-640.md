error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3584.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3584.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3584.java
text:
```scala
t@@arget.appendJavaScript("alert('You can\\'t close this modal window using close button."
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3584.java