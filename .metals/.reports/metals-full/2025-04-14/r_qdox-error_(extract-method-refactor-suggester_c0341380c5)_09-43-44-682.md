error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9370.java
text:
```scala
O@@S.g_signal_connect_closure (handle, OS.switch_page, display.closures [SWITCH_PAGE], false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9370.java