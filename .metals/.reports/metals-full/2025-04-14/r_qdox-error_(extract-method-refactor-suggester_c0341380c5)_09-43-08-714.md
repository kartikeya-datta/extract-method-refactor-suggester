error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1246.java
text:
```scala
i@@ndexShard.flush(new Engine.Flush().refresh(request.refresh()).full(request.full()).force(request.force()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1246.java