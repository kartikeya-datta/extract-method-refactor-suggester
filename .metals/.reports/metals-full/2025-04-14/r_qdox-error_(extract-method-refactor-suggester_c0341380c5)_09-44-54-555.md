error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/870.java
text:
```scala
B@@inding existingVariable = scope.getBinding(name, BindingIds.VARIABLE, this, true /*resolve*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/870.java