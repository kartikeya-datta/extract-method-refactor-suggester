error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3226.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3226.java
text:
```scala
final S@@tring username = jabberURI.getNodename();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3226.java