error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2927.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2927.java
text:
```scala
d@@ateOfBirth = (dob == null || "".equals(dob)) ? null : new SimpleDateFormat("yyyy-MM-dd").parse(dob);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2927.java