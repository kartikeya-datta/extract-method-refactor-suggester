error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4401.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4401.java
text:
```scala
n@@odeSet.possibleMatchingNodesSet = new SimpleSet(3);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4401.java