error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11083.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11083.java
text:
```scala
i@@f (subModel.get(ENABLED).asBoolean() && context.isNormalServer()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11083.java