error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/612.java
text:
```scala
O@@bject getDisplayValue(Object object);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/612.java