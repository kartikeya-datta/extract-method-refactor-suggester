error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2443.java
text:
```scala
n@@ewState.remove(sourceLocation);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2443.java