error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12576.java
text:
```scala
r@@eturn new CauchyDistributionImpl(1.2, 2.1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12576.java