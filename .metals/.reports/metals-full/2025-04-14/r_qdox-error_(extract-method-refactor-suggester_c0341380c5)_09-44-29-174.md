error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4329.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4329.java
text:
```scala
public static final S@@tring text = DEVELOPMENT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4329.java