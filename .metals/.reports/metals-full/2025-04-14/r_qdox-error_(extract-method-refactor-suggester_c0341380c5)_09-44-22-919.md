error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5176.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5176.java
text:
```scala
private T@@estPlan variables;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5176.java