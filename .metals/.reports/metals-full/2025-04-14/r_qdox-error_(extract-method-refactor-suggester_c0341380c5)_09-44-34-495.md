error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10912.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10912.java
text:
```scala
protected S@@pecifiedInterfaceAddHandler() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10912.java