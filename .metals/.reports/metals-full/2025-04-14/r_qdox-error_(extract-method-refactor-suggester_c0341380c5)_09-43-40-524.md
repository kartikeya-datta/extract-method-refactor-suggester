error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10894.java
text:
```scala
U@@nivariateRealSolverUtils.solve(sin, -0.1, 4.0, 4.0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10894.java