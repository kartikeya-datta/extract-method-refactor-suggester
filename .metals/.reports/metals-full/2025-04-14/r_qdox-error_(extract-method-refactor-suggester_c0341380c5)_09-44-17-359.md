error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4126.java
...
```java
offset: 1100
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4126.java
text:
```scala
...
p@@ackage org.wildfly.extension.undertow.security;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4126.java