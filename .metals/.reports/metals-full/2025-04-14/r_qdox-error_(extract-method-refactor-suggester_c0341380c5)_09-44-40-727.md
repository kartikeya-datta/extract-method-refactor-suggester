error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6800.java
text:
```scala
i@@f( e.getResponse() != null && e.getResponse().isERR() ) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6800.java