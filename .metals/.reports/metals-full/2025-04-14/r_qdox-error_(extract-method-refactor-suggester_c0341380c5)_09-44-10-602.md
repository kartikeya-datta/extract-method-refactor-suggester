error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/707.java
text:
```scala
f@@iles.setHTTPFileArgs(newHTTPFileArgs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/707.java