error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5130.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5130.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5130.java
text:
```scala
S@@erviceRegistration endpointListenerRegistration = Activator.getDefault().getContext().registerService(EndpointListener.class.getName(), createEndpointListener(), props);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5130.java