error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1149.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1149.java
text:
```scala
c@@ase BINDING: return BindingAnnotationTypePattern.read(s, context);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1149.java