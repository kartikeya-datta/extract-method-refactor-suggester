error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6413.java
text:
```scala
i@@f (tagName.equals(IWorkbenchRegistryConstants.TAG_VIEWER_CONTRIBUTION)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6413.java