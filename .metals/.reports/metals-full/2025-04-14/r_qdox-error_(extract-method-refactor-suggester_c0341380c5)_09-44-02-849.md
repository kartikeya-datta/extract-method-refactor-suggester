error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1224.java
text:
```scala
i@@f (cfs.getColumnFamily(new SliceQueryFilter(current, new QueryPath(cfName), "", "", true, 1), Integer.MAX_VALUE) != null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1224.java