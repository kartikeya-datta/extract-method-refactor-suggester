error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11935.java
text:
```scala
r@@eturn (Bag<E>) decorated();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11935.java