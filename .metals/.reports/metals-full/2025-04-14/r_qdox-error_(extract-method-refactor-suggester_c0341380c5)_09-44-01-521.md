error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6418.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6418.java
text:
```scala
static i@@nt MINOR_VERSION = 343;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6418.java