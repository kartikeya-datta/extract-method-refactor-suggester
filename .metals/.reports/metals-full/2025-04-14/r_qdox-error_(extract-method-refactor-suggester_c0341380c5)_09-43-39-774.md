error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1447.java
text:
```scala
i@@nfoStream.message("IW", "after commitMerge: " + segString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1447.java