error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3233.java
text:
```scala
i@@nitializeIndexLocations();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3233.java