error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4762.java
text:
```scala
p@@rocessor.mouseMoved(e.x, e.y);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4762.java