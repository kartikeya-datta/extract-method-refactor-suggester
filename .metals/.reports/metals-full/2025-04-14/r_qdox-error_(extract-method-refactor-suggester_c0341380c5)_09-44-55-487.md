error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12368.java
text:
```scala
C@@harSequence encode(RequestCycle requestCycle, IRequestTarget requestTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12368.java