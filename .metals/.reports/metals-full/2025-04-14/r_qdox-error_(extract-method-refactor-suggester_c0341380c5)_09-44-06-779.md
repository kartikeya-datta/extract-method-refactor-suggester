error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6910.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6910.java
text:
```scala
final E@@JBClientContext clientContext = EJBClientContext.create(new LocalOnlyEjbClientConfiguration(), this.getClass().getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6910.java