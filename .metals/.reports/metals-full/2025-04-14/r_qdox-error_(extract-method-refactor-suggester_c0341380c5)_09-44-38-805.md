error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8502.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8502.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8502.java
text:
```scala
l@@ocalRootFolderIcon = ImageLoader.getSmallImageIcon("16_computer.png");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8502.java