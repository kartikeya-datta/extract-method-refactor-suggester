error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9289.java
text:
```scala
w@@ipeIndices(getConcreteIndexName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9289.java