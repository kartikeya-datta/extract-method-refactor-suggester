error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/762.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/762.java
text:
```scala
i@@mageList = display.getImageList (bounds.width, bounds.height);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/762.java