error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/817.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/817.java
text:
```scala
public D@@ecal () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/817.java