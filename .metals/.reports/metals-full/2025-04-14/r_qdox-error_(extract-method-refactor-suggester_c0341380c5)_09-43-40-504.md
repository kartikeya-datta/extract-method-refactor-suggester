error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8036.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8036.java
text:
```scala
final b@@oolean ejbAnnotationPropertyReplacement = EeSubsystemRootResource.ANNOTATION_PROPERTY_REPLACEMENT.resolveModelAttribute(context, model).asBoolean();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8036.java