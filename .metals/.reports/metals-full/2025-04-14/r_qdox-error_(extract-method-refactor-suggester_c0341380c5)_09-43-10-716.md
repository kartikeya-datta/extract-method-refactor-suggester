error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6041.java
text:
```scala
S@@hutdownManager.getInstance().register(this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6041.java