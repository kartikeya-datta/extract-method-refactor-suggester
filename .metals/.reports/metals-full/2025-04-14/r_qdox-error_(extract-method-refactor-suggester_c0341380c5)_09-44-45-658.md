error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/405.java
text:
```scala
c@@ontext.put("localNode", clusterService.localNode());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/405.java