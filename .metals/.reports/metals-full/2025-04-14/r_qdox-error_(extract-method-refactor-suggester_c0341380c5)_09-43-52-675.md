error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10017.java
text:
```scala
S@@tring typeNodeName = nodeName.substring(0, nodeName.lastIndexOf('.'));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10017.java