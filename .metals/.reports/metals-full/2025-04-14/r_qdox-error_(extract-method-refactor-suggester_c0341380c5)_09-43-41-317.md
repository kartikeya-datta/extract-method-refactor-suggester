error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8608.java
text:
```scala
L@@azyMethodGen clinit = gen.getAjcPreClinit(); //StaticInitializer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8608.java