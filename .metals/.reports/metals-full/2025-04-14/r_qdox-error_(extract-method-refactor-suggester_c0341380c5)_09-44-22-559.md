error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8298.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8298.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8298.java
text:
```scala
public I@@ntegerProperty clone() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8298.java