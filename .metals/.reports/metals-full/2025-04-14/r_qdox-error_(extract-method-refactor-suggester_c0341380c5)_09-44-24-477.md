error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12186.java
text:
```scala
p@@ublic abstract class RequestHandlerStack
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12186.java