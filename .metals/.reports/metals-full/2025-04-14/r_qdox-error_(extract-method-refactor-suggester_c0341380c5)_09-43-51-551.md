error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8727.java
text:
```scala
g@@etPassword(), isDestinationStatic());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8727.java