error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9368.java
text:
```scala
O@@S.g_signal_connect_closure_by_id (labelHandle, display.signalIds [MNEMONIC_ACTIVATE], 0, display.closures [MNEMONIC_ACTIVATE], false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9368.java