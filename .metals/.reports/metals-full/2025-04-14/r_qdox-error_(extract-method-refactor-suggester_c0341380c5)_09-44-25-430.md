error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6262.java
text:
```scala
i@@f (valueRequired) codeStream.iconst_0();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6262.java