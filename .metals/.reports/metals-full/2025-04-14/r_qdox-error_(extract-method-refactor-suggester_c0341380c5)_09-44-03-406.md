error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5379.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5379.java
text:
```scala
public v@@oid handleRequest(AbstractClient connection, TrunkRequest request)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5379.java