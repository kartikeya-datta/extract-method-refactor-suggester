error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1191.java
text:
```scala
b@@inding = new LocalVariableBinding(this, tb, modifiers, false); // argument decl, but local var  (where isArgument = false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1191.java