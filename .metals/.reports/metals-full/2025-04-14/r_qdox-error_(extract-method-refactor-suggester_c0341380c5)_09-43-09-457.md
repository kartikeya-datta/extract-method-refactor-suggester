error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14129.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14129.java
text:
```scala
public final static l@@ong WAIT_TIMEOUT = 30000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14129.java