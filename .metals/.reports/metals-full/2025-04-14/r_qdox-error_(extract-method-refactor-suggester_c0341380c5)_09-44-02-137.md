error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/459.java
text:
```scala
c@@ase OS.WM_SYSCHAR: wmSysChar (msg.hwnd, msg.wParam, msg.lParam); break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/459.java