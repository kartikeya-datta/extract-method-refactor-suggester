error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6936.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6936.java
text:
```scala
protected B@@uilder(String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6936.java