error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2697.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2697.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2697.java
text:
```scala
t@@his(Header.randomID());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2697.java