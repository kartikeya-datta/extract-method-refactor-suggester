error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13801.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13801.java
text:
```scala
O@@ldVersionCopier oldVersionCopier = OldVersionCopier.expandOldVersion(version);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13801.java