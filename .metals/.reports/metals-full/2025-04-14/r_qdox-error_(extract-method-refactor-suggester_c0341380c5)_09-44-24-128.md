error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14810.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14810.java
text:
```scala
final b@@yte[] hash = PatchUtils.copy(is, target);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14810.java