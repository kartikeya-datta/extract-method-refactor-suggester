error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8036.java
text:
```scala
t@@his.readerCleanerSchedule = componentSettings.getAsTime("reader_cleaner_schedule", TimeValue.timeValueSeconds(10));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8036.java