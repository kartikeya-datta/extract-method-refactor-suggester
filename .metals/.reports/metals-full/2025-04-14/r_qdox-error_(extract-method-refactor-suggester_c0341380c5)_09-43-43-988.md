error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5008.java
text:
```scala
B@@roadcastOperationThreading operationThreading = BroadcastOperationThreading.fromString(request.param("operation_threading"), BroadcastOperationThreading.THREAD_PER_SHARD);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5008.java