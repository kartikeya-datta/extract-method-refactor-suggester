error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2021.java
text:
```scala
i@@ndexSettingsBuilder.put(SETTING_AUTO_EXPAND_REPLICAS, "0-all");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2021.java