error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2289.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2289.java
text:
```scala
public static S@@tring version = "05-06-2003 cvs";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2289.java