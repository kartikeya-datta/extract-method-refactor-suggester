error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18168.java
text:
```scala
i@@nt /*long*/ ptr = OS.gtk_entry_get_text (handle);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18168.java