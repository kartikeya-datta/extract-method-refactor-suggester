error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9448.java
text:
```scala
v@@iewer.setComparator(DataTransferWizardCollectionComparator.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9448.java