error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1756.java
text:
```scala
I@@ObjectActivityManager activityManager = window.getWorkbench().getObjectActivityManager(IWorkbenchConstants.PL_PERSPECTIVES, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1756.java