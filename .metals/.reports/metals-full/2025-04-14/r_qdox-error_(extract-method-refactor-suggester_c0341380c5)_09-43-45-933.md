error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5423.java
text:
```scala
t@@his.location = new File(new File(new File(new File(nodeEnv.nodeLocation(), "indices"), shardId.index().name()), Integer.toString(shardId.id())), "translog");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5423.java