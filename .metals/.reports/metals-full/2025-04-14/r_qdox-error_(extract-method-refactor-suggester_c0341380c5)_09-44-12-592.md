error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1540.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1540.java
text:
```scala
l@@ogger_.info("Bootstrap/move completed! Now serving reads.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1540.java