error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5721.java
text:
```scala
t@@ypeInfo.declarationStart = typeDeclaration.allocation == null ? typeDeclaration.declarationSourceStart : typeDeclaration.allocation.sourceStart;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5721.java