error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/282.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/282.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/282.java
text:
```scala
t@@raceStack("Exception in connect", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/282.java