error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7218.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7218.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7218.java
text:
```scala
R@@esolvedType iter = world.getCoreType(UnresolvedType.forRawTypeName("java.util.Iterator"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7218.java