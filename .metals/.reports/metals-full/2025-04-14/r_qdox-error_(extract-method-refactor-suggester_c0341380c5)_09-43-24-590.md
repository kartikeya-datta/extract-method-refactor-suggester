error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/701.java
...
```java
offset: 807
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/701.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/701.java