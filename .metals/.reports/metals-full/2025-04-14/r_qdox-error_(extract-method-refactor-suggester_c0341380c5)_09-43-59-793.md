error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7223.java
text:
```scala
g@@etTypeBinding(scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7223.java