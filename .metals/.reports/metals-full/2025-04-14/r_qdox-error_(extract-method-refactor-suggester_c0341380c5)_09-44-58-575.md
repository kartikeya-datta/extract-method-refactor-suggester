error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6478.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6478.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6478.java
text:
```scala
X@@ContentBuilder builder = restContentBuilder(request, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6478.java