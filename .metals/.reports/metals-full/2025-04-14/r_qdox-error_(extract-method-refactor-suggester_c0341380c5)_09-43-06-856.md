error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6080.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6080.java
text:
```scala
t@@ypeBinding = qNameRef.actualReceiverType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6080.java