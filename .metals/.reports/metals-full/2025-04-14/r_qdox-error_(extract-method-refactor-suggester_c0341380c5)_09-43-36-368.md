error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13506.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13506.java
text:
```scala
static final S@@erviceName SERVICE_NAME = ServerInventoryService.SERVICE_NAME.append("callback");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13506.java