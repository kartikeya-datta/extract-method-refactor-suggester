error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17723.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[41,2]

error in qdox parser
file content:
```java
offset: 1533
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17723.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17723.java