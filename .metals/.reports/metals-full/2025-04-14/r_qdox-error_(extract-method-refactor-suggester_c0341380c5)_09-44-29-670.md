error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7812.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7812.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7812.java
text:
```scala
r@@eturn new RecoveryStatus(RecoveryStatus.Index.EMPTY, RecoveryStatus.Translog.EMPTY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7812.java