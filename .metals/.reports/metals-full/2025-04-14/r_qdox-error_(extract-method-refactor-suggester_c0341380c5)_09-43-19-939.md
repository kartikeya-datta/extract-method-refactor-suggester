error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11314.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11314.java
text:
```scala
F@@rameworkService.addService(batchBuilder, config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11314.java