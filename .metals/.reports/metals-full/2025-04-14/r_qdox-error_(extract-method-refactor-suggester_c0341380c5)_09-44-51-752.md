error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9207.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9207.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9207.java
text:
```scala
f@@or (Map.Entry<?, ?> entry : original.entrySet()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9207.java