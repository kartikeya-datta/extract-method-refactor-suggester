error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3083.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3083.java
text:
```scala
public static final P@@athElement BINARY_KEYED_JDBC_STORE_PATH = PathElement.pathElement(ModelKeys.BINARY_KEYED_JDBC_STORE, ModelKeys.BINARY_KEYED_JDBC_STORE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3083.java