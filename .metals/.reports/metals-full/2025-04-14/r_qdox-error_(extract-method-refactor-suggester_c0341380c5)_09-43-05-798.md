error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7793.java
text:
```scala
g@@l.glClientActiveTexture( GL10.GL_TEXTURE0 );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7793.java