error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9253.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9253.java
text:
```scala
private C@@lass<?> targetClass;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9253.java