error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13431.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13431.java
text:
```scala
public T@@ext(IContent content, int startOffset, int endOffset) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13431.java