error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8824.java
text:
```scala
S@@tring value = property.getAttribute("value", null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8824.java