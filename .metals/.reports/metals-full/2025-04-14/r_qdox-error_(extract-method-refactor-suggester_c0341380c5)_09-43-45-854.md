error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10480.java
text:
```scala
i@@nt index = providerMarkupStream.findComponentIndex(markupId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10480.java