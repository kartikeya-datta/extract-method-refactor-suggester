error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13167.java
text:
```scala
L@@ogger.getLogger("org.jboss.web.WebFragmentParsingDeploymentProcessor").info("parse " + resourceRoot.getName() + ": " + (System.currentTimeMillis() - time) + "ms");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13167.java