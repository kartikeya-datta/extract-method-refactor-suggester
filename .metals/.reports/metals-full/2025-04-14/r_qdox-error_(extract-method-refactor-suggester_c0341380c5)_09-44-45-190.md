error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2968.java
text:
```scala
P@@artPane activePane = activeWorkbook.getSelection();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2968.java