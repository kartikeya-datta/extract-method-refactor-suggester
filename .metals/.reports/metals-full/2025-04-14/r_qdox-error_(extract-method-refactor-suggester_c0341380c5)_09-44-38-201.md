error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4223.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4223.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4223.java
text:
```scala
i@@f (itemIndex < itemsCount && !items [itemIndex].isInViewport ()) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4223.java