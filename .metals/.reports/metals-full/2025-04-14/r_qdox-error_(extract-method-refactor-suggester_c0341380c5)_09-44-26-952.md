error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8034.java
text:
```scala
n@@ew PropertyDescriptor("fileURL", LogFilePatternReceiver.class),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8034.java