error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4959.java
text:
```scala
O@@bject batchCompilerInstance = batchCompilerConstructor.newInstance(new Object[] {new PrintWriter(System.out), new PrintWriter(System.err), Boolean.valueOf(true)});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4959.java