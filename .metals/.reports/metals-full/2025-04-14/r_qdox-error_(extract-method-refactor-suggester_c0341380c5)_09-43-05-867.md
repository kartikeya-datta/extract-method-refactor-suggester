error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5807.java
text:
```scala
S@@earchResponse searchResponse = client.prepareSearch().setQuery(QueryBuilders.idsQuery("type1").ids(Integer.toString(i))).execute().actionGet();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5807.java