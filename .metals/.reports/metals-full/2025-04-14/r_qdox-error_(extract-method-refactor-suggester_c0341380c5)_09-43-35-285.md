error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3311.java
text:
```scala
b@@uilder.startObject(getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3311.java