error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2859.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2859.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2859.java
text:
```scala
r@@eturn OS.eventNotHandledErr;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2859.java