error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2590.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2590.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2590.java
text:
```scala
public static final A@@ttributeDefinition PREDICATE = new SimpleAttributeDefinitionBuilder("predicate", ModelType.STRING)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2590.java