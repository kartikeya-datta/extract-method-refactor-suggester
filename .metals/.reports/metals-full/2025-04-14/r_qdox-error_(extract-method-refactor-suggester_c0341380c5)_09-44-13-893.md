error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2672.java
text:
```scala
f@@loat u = region.u, v = region.u;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2672.java