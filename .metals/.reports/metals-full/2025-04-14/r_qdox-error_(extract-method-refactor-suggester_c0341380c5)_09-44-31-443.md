error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3095.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3095.java
text:
```scala
public T@@ypeBinding receiverType, qualifyingType; // TODO (philippe) could remove this field, and simply reuse receiverType
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3095.java