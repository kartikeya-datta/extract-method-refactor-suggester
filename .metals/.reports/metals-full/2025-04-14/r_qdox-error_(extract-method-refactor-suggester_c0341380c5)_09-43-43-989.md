error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5687.java
text:
```scala
C@@lipboardManager.getInstance().setSelection((FolderCommandReference) ((MailFrameMediator)frameController).getTableSelection());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5687.java