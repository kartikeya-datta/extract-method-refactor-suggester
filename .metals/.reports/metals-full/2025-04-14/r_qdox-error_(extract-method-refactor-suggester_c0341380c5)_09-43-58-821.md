error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16459.java
text:
```scala
r@@c = delegate.createBaseWindow (baseWindow);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16459.java