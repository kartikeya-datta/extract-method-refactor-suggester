error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2716.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2716.java
text:
```scala
f@@loat avgPayloadScore =  (payloadsSeen > 0 ? (payloadScore / payloadsSeen) : 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2716.java