error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14436.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14436.java
text:
```scala
a@@rchive.addAsManifestResource(CallbackBeansTestCase.class.getPackage(), "callback-jboss-beans.xml", "callback-jboss-beans.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14436.java