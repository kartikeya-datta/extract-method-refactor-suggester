error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7898.java
text:
```scala
_@@hints.add("openjpa.FetchPlan.Isolation");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7898.java