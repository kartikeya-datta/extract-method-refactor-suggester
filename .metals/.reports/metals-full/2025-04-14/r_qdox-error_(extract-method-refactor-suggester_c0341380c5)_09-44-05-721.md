error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8827.java
text:
```scala
r@@edrawWidget (handle, children);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8827.java