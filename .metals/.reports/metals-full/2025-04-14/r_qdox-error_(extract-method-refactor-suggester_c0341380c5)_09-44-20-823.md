error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17742.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[87,80]

error in qdox parser
file content:
```java
offset: 2479
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17742.java
text:
```scala
...
/**
 * A Group is a piece of a regular expression (referenced by some Java field or local
...
public class Group extends MetaPattern
{
     ...
     * @param bindTo The group to bind to
     * @throws GroupAlreadyBoundException Thrown if this Group is already bound
     */
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17742.java