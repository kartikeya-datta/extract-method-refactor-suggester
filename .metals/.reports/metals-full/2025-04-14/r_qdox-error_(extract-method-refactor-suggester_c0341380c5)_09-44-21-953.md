error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7377.java
text:
```scala
r@@eturn super.getMatchingSyntheticMember(member, aspectType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7377.java