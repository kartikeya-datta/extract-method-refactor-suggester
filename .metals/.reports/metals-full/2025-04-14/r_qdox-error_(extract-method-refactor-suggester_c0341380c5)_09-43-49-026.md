error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7214.java
text:
```scala
t@@ypeToExpose = UnresolvedType.forSignature(typeToExpose.getErasureSignature());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7214.java