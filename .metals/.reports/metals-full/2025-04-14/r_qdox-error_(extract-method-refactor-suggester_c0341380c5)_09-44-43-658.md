error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7578.java
text:
```scala
t@@extsToHighlight = lookup.source().extractRawValues(mapper.names().fullName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7578.java