error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5465.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5465.java
text:
```scala
@Override public b@@oolean touchUp(int x, int y, int pointer, int button) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5465.java