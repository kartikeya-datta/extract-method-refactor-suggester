error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13674.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13674.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13674.java
text:
```scala
a@@dd(new AjaxFallbackOrderByLink.CssModifier(link, cssProvider));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13674.java