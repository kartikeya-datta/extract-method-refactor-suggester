error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10557.java
text:
```scala
t@@his.appName = appName == null ? "" : appName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10557.java