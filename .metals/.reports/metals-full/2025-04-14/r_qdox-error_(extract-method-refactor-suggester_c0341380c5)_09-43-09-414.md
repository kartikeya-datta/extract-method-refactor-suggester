error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12723.java
text:
```scala
c@@onsole.addCompletor(new CommandCompleter(handlers.keySet(), cmdCtx, opCompleter));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12723.java