error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8691.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8691.java
text:
```scala
t@@his.modelChangedStructure();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8691.java