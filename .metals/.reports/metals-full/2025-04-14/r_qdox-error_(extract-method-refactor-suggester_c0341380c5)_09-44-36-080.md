error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7830.java
...
```java
offset: 70
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7830.java
text:
```scala
public interface SubsystemTransformer extends ResourceTransformer {

p@@ackage org.jboss.as.controller.transform;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7830.java