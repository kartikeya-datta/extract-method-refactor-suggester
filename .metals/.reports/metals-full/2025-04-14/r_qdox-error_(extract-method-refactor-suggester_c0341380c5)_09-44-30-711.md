error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8198.java
text:
```scala
g@@etFrameMediator().getSelectionManager().setSelection("mail.tree", refs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8198.java