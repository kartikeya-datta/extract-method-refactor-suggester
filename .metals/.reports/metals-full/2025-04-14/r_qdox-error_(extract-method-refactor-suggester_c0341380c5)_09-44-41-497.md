error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3415.java
text:
```scala
A@@ssert.assertEquals("foo", metadata.getHeader(WebExtension.WEB_CONTEXTPATH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3415.java