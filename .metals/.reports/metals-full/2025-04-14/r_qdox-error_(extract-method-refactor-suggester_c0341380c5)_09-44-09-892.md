error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12339.java
...
```java
offset: 664
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12339.java
text:
```scala
...
p@@ackage org.springframework.beans.factory.parsing;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12339.java