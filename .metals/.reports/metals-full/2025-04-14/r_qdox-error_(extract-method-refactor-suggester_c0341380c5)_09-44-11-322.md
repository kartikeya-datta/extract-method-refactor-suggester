error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/968.java
text:
```scala
a@@ssertSQLState("8006", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/968.java