error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7453.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7453.java
text:
```scala
final A@@rrayList<Client> clientArray = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7453.java