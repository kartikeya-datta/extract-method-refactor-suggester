error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5300.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5300.java
text:
```scala
public static final S@@tring version = "0.11.0-cvs";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5300.java