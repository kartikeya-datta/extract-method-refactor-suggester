error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9520.java
text:
```scala
r@@eturn "MultiKey" + Arrays.toString(keys);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9520.java