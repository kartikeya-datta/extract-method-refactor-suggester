error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2518.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2518.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2518.java
text:
```scala
s@@uper(resourceDefinition, xmlElementName, xmlWrapperElement, attributes, children, useValueAsElementName, noAddOperation, additionalOperationsGenerator);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2518.java