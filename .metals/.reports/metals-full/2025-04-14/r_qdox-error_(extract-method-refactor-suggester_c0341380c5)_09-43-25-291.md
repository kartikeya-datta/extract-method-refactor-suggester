error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8476.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8476.java
text:
```scala
D@@eploymentHandlerUtil.replace(deployNode, toReplace, context, resultHandler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8476.java