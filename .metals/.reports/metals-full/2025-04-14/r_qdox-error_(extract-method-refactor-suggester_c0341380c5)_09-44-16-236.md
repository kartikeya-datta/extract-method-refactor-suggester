error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9477.java
text:
```scala
r@@eturn new DoubleTerms(terms.getName(), terms.order, terms.formatter, terms.requiredSize, terms.shardSize, terms.minDocCount, Arrays.asList(buckets), terms.showTermDocCountError, terms.docCountError, terms.otherDocCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9477.java