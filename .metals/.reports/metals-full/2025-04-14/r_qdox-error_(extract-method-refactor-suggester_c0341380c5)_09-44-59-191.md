error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11748.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11748.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11748.java
text:
```scala
f@@lights.getFlight().add(flight);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11748.java