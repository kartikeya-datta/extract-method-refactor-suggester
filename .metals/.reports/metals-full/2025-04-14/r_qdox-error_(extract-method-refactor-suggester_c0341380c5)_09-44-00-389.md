error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5553.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5553.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5553.java
text:
```scala
r@@eturn context.getString(string.bookmarks);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5553.java