error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7123.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7123.java
text:
```scala
I@@ContextBindingDefinition.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7123.java