error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6007.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6007.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6007.java
text:
```scala
public C@@ompletionParser(ProblemReporter problemReporter, long sourceLevel) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6007.java