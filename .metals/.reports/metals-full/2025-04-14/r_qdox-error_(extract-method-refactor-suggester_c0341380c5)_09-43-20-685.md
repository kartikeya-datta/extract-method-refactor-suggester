error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12679.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12679.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12679.java
text:
```scala
public final S@@tring getRelativeUrl()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12679.java