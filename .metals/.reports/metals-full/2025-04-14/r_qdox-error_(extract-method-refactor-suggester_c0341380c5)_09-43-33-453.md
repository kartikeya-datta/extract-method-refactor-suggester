error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10431.java
text:
```scala
A@@nalyzer analyzer = analysisService.analyzer("custom1").analyzer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10431.java