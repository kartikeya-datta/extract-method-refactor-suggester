error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1018.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1018.java
text:
```scala
t@@ypeDeclaration.methods[0] = typeDeclaration.createDefaultConstructor(false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1018.java