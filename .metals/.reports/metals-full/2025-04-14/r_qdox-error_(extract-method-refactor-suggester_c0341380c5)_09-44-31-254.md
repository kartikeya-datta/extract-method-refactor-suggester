error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/708.java
text:
```scala
Q@@uery facetQuery = indexQueryParser.parse(parser).query();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/708.java