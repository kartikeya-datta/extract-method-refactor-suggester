error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7379.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7379.java
text:
```scala
r@@esponse.renderJavascript(getJsTimeoutCall(updateInterval), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7379.java