error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13486.java
text:
```scala
i@@f(info.getReleasePatchID().equals(patchId)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13486.java