error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8442.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8442.java
text:
```scala
public H@@eadForceTagIdHandler(final Class< ? extends Component> markupFileClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8442.java