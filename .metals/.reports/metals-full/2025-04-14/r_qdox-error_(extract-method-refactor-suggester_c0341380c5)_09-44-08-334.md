error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16884.java
text:
```scala
p@@ublic interface IColumn<T> extends ICellPopulator<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16884.java