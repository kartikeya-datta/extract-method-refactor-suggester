error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17685.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[235,2]

error in qdox parser
file content:
```java
offset: 4780
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17685.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17685.java