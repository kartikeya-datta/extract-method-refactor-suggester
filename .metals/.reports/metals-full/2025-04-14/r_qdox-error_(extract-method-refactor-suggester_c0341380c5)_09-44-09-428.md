error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5627.java
text:
```scala
t@@exture = new Texture(Gdx.files.internal("data/resource1.jpg"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5627.java