error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9837.java
text:
```scala
s@@uper(mapper, number, fieldType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9837.java