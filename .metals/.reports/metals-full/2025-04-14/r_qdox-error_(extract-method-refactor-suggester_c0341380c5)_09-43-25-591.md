error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9843.java
text:
```scala
a@@ddDocValue(context, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9843.java