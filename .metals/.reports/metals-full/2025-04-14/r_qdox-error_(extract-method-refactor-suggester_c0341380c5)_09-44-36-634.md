error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2651.java
text:
```scala
l@@og.warn("Source folder " + folder.getAbsolutePath() + " does not exist.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2651.java