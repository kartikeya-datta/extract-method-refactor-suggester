error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13456.java
text:
```scala
p@@ath = resolvePath();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13456.java