error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5640.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[1,107]

error in qdox parser
file content:
```java
offset: 107
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5640.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5640.java