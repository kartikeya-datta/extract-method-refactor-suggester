error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/382.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/382.java
text:
```scala
public D@@ocIdSet getDocIdSet(AtomicReaderContext context, Bits acceptDocs) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/382.java