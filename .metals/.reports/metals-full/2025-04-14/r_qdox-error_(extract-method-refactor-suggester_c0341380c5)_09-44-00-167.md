error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13177.java
text:
```scala
G@@dip.GraphicsPath_AddPath(handle, path, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13177.java