error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3586.java
text:
```scala
l@@ogger.info("Loading settings from " + configFileName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3586.java