error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3274.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3274.java
text:
```scala
public E@@lementValuePair compilerElementPair = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3274.java