error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7018.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7018.java
text:
```scala
r@@eturn nodeService.stats(request.indices(), request.os(), request.process(), request.jvm(), request.threadPool(), request.network(), request.fs(), request.transport(), request.http());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7018.java