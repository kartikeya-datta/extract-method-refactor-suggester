error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1471.java
text:
```scala
J@@ComboBox comboBox = new JComboBox(new Level[] {Level.TRACE, Level.DEBUG, Level.INFO, Level.WARN, Level.ERROR, Level.FATAL, Level.OFF, Level.ALL});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1471.java