error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10157.java
text:
```scala
i@@f (operation.hasDefined(SUBHANDLERS)) for (final ModelNode handlerName : operation.get(SUBHANDLERS).asList()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10157.java