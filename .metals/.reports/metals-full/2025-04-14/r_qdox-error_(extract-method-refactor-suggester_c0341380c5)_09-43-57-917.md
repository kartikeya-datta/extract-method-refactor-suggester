error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14700.java
text:
```scala
r@@eturn (match != null) ? new RequestConditionHolder(match) : null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14700.java