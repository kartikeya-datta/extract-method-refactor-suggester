error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13931.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13931.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13931.java
text:
```scala
C@@heckGroup group = findParent(CheckGroup.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13931.java