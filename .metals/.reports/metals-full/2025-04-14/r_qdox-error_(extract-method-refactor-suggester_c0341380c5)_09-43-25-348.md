error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/766.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/766.java
text:
```scala
f@@ireMappingChanged(event.getProperty(), event.getOldValue(), event.getNewValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/766.java