error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/906.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/906.java
text:
```scala
b@@oolean success = syncStrategy.sync(zkController, core, new ZkNodeProps(props), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/906.java