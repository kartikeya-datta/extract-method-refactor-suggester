error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8443.java
text:
```scala
X@@ContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8443.java