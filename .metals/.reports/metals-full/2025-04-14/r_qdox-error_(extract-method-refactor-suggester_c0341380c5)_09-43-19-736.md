error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7041.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7041.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7041.java
text:
```scala
L@@ucene.KEYWORD_ANALYZER, Lucene.KEYWORD_ANALYZER, postingsFormat, docValuesFormat, null, null, fieldDataSettings, indexSettings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7041.java