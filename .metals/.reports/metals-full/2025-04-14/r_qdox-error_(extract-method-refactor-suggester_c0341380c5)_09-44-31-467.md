error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3436.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3436.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3436.java
text:
```scala
public static final i@@nt WINDOW_SIZE = ProtocolConnectionConfiguration.DEFAULT_WINDOW_SIZE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3436.java