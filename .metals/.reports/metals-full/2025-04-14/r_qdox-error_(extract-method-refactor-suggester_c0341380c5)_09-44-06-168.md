error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/82.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/82.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/82.java
text:
```scala
final V@@irtualFile deploymentRoot = deploymentUnitContext.getAttachment(Attachments.DEPLOYMENT_ROOT).getRoot();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/82.java