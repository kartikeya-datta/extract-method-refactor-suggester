error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8406.java
text:
```scala
D@@irectoryReader reader = DirectoryReader.open(indexWriter, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8406.java