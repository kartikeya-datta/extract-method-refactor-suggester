error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15299.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15299.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15299.java
text:
```scala
i@@f (MappingContextHolder.contains(source)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15299.java