error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11174.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11174.java
text:
```scala
public v@@oid createUnmarshaller() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11174.java