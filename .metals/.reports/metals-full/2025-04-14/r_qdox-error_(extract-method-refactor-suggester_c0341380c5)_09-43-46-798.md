error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2205.java
text:
```scala
p@@arser.javadocParser.checkDocComment = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2205.java