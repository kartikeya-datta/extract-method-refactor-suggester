error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/599.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/599.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/599.java
text:
```scala
public v@@oid registerOperations(final ManagementResourceRegistration registry) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/599.java