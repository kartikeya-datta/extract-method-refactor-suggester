error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12416.java
text:
```scala
g@@c.setForeground (parent.getConnectorColor ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12416.java