error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7368.java
text:
```scala
L@@ist<InternalAggregations> subAggregationsList = new ArrayList<>(aggregations.size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7368.java