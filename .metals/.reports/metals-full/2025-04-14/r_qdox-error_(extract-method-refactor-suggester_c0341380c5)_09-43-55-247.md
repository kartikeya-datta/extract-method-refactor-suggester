error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/507.java
text:
```scala
m@@enu.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/507.java