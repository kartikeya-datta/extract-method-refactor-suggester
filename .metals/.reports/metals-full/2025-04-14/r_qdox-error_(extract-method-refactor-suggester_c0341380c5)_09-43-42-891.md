error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1344.java
text:
```scala
P@@rovider provider = Provider.valueOf(newValue.asString().toUpperCase(Locale.ENGLISH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1344.java