error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12460.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12460.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12460.java
text:
```scala
e@@xpectedDisplayText(MESSAGES.isCorrectPrompt() + " " + MESSAGES.yes() + "/" + MESSAGES.no() + "?").
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12460.java