error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6171.java
text:
```scala
i@@f (size.x > maxSize)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6171.java