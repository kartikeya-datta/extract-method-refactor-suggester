error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9046.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9046.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9046.java
text:
```scala
r@@ange.length = end - start;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9046.java