error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3180.java
text:
```scala
A@@nalysis.parseStopWords(env, settings, DanishAnalyzer.getDefaultStopSet(), version),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3180.java