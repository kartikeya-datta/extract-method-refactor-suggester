error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1178.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1178.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1178.java
text:
```scala
S@@tring encoding = unit.getJavaProject().getOption(JavaCore.CORE_ENCODING, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1178.java