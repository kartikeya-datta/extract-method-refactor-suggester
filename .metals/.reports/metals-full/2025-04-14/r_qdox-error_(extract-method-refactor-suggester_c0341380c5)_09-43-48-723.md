error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2841.java
text:
```scala
r@@esult.setDescription("btq, product of:");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2841.java