error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9730.java
text:
```scala
i@@f (endpointMetaData.isWebservice()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9730.java