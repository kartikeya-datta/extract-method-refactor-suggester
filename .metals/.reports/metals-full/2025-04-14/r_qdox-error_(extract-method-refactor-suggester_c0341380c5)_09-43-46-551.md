error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13511.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13511.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13511.java
text:
```scala
public I@@njectedValue<ServletContainerService> getServletContainer() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13511.java