error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16763.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16763.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16763.java
text:
```scala
l@@og.warn("ERROR! Resource string not found: [" + key + "]",mre);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16763.java