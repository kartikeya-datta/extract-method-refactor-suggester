error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9225.java
text:
```scala
r@@eturn new ShardSuggestRequest(shard.shardId(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9225.java