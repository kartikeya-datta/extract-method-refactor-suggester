error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6835.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6835.java
text:
```scala
F@@ilter nestedFilter = Queries.wrap(new ToParentBlockJoinQuery(query, parentFilter, ScoreMode.None), parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6835.java