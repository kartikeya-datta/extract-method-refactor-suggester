error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7064.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7064.java
text:
```scala
public b@@oolean yUp = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7064.java