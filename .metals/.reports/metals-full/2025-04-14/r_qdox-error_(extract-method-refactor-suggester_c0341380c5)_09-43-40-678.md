error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1737.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1737.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1737.java
text:
```scala
u@@pperBound = Scope.substitute(methodSubstitute, ((TypeVariableBinding)substitutedReturnType).upperBound());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1737.java