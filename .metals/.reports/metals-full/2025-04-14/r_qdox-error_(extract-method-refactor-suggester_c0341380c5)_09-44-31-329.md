error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2061.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2061.java
text:
```scala
g@@cRect.width = fullRect.x + fullRect.width;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2061.java