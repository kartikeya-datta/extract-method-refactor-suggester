error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5287.java
text:
```scala
c@@ycle.setResponsePage(getPageFactory().newPage(BookDetails.class, parameters));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5287.java