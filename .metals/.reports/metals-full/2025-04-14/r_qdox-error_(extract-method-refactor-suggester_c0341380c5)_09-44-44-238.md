error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3879.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3879.java
text:
```scala
public M@@yFragment(final MarkupContainer parent, final String id, final String markupId)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3879.java