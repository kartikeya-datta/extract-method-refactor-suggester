error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14247.java
text:
```scala
i@@f (path.isEmpty()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14247.java