error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9471.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9471.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9471.java
text:
```scala
s@@etRedirect(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9471.java