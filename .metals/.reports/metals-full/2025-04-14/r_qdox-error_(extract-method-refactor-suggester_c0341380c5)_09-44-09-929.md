error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16860.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16860.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16860.java
text:
```scala
p@@ublic class SimplePageParametersEncoder implements IPageParametersEncoder
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16860.java