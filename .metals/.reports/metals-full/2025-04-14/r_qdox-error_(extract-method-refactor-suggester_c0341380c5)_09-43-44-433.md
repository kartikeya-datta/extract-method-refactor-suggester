error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7458.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7458.java
text:
```scala
i@@nt VERSION = 2; // The current protocol version
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7458.java