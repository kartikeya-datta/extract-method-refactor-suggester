error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12979.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12979.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12979.java
text:
```scala
r@@eturn getFlag(FLAG_RENDER_BODY_ONLY) && !getFlag(FLAG_OUTPUT_MARKUP_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12979.java