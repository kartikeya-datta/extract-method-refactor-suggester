error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/97.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/97.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/97.java
text:
```scala
c@@lient.admin().cluster().ping(broadcastPingRequest, new ActionListener<BroadcastPingResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/97.java