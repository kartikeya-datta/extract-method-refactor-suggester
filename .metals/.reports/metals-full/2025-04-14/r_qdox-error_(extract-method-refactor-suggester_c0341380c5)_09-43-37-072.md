error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7850.java
...
```java
offset: 26
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7850.java
text:
```scala
@Deprecated static final S@@tring BATCHING = "batching";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7850.java