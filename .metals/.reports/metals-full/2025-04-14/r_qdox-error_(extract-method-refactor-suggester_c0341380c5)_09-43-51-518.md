error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/26.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/26.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/26.java
text:
```scala
L@@ist<Repository> repos = cache.getRepos(org, isForceRefresh(args));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/26.java