error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2635.java
text:
```scala
G@@ossipDigestAckMessage gDigestAckMessage = GossipDigestAckMessage.serializer().deserialize(dis, message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2635.java