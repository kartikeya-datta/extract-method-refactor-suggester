error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15134.java
text:
```scala
i@@nt port = HttpMirrorControl.DEFAULT_PORT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15134.java