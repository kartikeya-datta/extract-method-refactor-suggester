error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3540.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3540.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3540.java
text:
```scala
public abstract b@@oolean isIndexTerm(long ord, int docFreq, boolean onlyLoaded) throws IOException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3540.java