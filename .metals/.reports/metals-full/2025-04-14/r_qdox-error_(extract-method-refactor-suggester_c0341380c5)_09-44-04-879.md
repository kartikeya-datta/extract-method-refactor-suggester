error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8466.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8466.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8466.java
text:
```scala
t@@hreadPool.stats(), transportService.stats());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8466.java