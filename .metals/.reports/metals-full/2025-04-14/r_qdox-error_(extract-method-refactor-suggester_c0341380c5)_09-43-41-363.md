error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2083.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2083.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2083.java
text:
```scala
r@@eturnCF = cfs.filterColumnFamily(cached, keyFilter, gcBefore);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2083.java