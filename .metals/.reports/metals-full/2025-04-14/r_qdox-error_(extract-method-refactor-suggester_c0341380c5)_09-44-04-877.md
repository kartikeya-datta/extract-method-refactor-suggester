error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8636.java
text:
```scala
r@@eturn this.trueLength;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8636.java