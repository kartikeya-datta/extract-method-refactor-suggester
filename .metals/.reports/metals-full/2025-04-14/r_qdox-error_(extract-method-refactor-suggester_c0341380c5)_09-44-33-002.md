error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3928.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3928.java
text:
```scala
S@@tringBuilder sb = new StringBuilder("elasticsearch/");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3928.java