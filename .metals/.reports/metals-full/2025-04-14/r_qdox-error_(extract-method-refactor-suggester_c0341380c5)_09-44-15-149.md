error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3190.java
text:
```scala
i@@w.shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3190.java