error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2897.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2897.java
text:
```scala
t@@hrow new DumpContributionFailedException(getName(), "Heap dump not enabled on this JVM");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2897.java