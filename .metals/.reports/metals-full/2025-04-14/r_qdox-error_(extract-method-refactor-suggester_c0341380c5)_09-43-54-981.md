error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1364.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1364.java
text:
```scala
i@@mageX += renderer.computeSize(CTabFolderRenderer.PART_CLOSE_BUTTON, SWT.NONE, gc, SWT.DEFAULT, SWT.DEFAULT).x;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1364.java