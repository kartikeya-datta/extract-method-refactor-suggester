error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7281.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7281.java
text:
```scala
public v@@oid setToolTip (ToolTip toolTip) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7281.java