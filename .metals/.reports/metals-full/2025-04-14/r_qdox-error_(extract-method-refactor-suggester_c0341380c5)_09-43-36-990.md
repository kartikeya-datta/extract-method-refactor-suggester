error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7197.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7197.java
text:
```scala
A@@rrayList<TermsAndField> termsAndFields = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7197.java