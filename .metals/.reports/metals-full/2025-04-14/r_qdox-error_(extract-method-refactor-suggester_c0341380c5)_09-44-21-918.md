error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9563.java
text:
```scala
r@@eturn ViewUtils.setGone(new View(getApplication()), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9563.java