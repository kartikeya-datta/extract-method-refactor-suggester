error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13694.java
text:
```scala
g@@et("amOrPmChoice").setVisibilityAllowed(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13694.java