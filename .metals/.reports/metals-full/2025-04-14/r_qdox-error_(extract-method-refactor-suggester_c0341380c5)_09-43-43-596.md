error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1283.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1283.java
text:
```scala
public static final P@@athElement PATH = PathElement.pathElement(CommonAttributes.BROADCAST_GROUP);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1283.java