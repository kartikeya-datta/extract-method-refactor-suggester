error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4690.java
text:
```scala
n@@ew ScriptModule(settings),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4690.java