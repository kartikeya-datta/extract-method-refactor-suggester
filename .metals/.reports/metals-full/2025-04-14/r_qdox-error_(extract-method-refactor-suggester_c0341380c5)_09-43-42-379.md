error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6660.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6660.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6660.java
text:
```scala
f@@or (FormatDateTimeFormatter dateTimeFormatter : context.root().dynamicDateTimeFormatters()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6660.java