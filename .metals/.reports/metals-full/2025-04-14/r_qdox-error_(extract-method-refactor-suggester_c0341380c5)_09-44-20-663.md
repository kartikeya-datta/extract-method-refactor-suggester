error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2330.java
text:
```scala
r@@eturn _repos.getMetaData(_meta.getDescribedType(), null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2330.java