error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12482.java
text:
```scala
t@@hrow new BuildException("error during FTP transfer: " + ex,ex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12482.java