error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13984.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13984.java
text:
```scala
r@@eturn parameters.isEmpty() ? null : parameters;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13984.java