error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1275.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1275.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1275.java
text:
```scala
s@@uper(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1275.java