error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/473.java
text:
```scala
t@@arget.addService(sname, service).install();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/473.java