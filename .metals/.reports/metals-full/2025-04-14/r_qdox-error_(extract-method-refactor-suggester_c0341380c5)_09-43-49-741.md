error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3222.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3222.java
text:
```scala
private b@@oolean assertMode;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3222.java