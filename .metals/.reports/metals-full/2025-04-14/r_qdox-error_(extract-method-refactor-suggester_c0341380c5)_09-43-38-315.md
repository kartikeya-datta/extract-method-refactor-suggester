error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5772.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5772.java
text:
```scala
i@@nt x = (int)(Gdx.input.getX(i) / (float)Gdx.graphics.getWidth() * 320);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5772.java