error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13481.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[73,2]

error in qdox parser
file content:
```java
offset: 1996
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13481.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13481.java