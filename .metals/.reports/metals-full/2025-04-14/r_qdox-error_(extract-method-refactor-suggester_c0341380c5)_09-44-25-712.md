error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5738.java
text:
```scala
s@@etVisible(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5738.java