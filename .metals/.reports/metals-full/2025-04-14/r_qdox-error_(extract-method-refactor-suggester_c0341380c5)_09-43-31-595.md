error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9501.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9501.java
text:
```scala
a@@dd(new BookmarkablePageLink<Void>("indexLink", Index.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9501.java