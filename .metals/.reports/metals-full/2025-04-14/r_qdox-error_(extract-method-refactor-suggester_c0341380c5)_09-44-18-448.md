error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7919.java
text:
```scala
F@@ile nodeWork = ((InternalNode) node).injector().getInstance(NodeEnvironment.class).nodeDataLocation();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7919.java