error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2827.java
text:
```scala
L@@ogs.reportMessage("CSLOOK_StoredProcHeader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2827.java