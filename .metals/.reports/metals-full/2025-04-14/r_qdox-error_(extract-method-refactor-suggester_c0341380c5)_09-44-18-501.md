error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5164.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5164.java
text:
```scala
public A@@rray<Region> getRegions () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5164.java