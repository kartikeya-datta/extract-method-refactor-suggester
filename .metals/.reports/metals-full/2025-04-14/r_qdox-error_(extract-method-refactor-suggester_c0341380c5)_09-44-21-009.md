error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7982.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7982.java
text:
```scala
r@@eturn "removing from index "/*nonNLS*/ + resourceName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7982.java