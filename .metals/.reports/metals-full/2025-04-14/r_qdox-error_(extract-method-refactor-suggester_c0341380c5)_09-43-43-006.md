error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4435.java
text:
```scala
c@@tx.handle("if result.value==\"true\" of " + this.getReadPropertyReq());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4435.java