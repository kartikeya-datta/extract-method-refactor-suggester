error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14177.java
text:
```scala
b@@order2.add(new AttributeModifier("testAttr", true, new Model<String>("myValue")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14177.java