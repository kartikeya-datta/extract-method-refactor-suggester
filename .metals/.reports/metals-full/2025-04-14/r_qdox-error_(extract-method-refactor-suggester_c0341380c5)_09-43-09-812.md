error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5459.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5459.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5459.java
text:
```scala
g@@etMarkup().getMarkupResourceStream().getWicketNamespace(), getEscapeModelStrings());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5459.java