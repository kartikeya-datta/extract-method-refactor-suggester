error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9836.java
text:
```scala
r@@eturn "org.eclipse.ui.textEditorScope"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9836.java