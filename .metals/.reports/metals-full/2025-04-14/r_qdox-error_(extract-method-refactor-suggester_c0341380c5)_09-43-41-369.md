error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9887.java
text:
```scala
l@@ogger.debug("cleaning shard content before creation");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9887.java