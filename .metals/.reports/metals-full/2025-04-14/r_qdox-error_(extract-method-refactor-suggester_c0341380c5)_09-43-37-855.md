error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7258.java
text:
```scala
r@@ecordSimpleReference(typeDecl.name); // needed to detect collision cases
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7258.java