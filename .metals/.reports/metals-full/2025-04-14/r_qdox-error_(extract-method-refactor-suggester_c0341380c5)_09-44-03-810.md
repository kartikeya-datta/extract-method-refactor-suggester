error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4834.java
...
```java
offset: 563
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4834.java
text:
```scala
class LineComment {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4834.java