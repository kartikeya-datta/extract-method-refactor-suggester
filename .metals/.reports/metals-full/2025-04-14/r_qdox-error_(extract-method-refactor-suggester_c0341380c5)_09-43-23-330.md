error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14047.java
text:
```scala
s@@ockJsSession.handleSuccessiveRequest(request, response, getFrameFormat(request));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14047.java