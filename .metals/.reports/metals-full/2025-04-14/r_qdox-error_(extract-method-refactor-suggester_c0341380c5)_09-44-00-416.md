error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8045.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8045.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8045.java
text:
```scala
r@@emoveSet(name, type, element);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8045.java