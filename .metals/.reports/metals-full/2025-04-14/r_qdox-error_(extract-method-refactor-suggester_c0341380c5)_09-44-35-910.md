error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7019.java
text:
```scala
i@@f (text.contains(":") || text.contains("-") || text.contains("/")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7019.java