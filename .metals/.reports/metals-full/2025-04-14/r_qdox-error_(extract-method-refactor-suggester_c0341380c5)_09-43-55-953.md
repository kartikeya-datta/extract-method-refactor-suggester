error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7319.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7319.java
text:
```scala
s@@ocontainer.connect(null,null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7319.java