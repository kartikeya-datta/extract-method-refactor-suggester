error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3802.java
text:
```scala
r@@eturn ""; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3802.java