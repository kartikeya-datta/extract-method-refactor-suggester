error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5766.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5766.java
...
```java
offset: 1113
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5766.java
text:
```scala
...
p@@ackage org.jboss.as.security.plugins;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5766.java