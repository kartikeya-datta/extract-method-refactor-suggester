error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6571.java
text:
```scala
A@@ssert.assertNotNull("Localizer should be available", dummy.getResourceSettings().getLocalizer());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6571.java