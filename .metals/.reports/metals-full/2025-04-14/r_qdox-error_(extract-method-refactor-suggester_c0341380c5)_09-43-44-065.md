error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2636.java
text:
```scala
G@@ossipDigestSynMessage gDigestMessage = GossipDigestSynMessage.serializer().deserialize(dis, message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2636.java