error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1646.java
text:
```scala
s@@b.append(getHeader() + "\n");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1646.java