error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/990.java
text:
```scala
r@@everseSubsystem = reverseCheckModelFixer.fixModel(reverseSubsystem);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/990.java