error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2060.java
text:
```scala
a@@ddress[k] = new InternetAddress(vEmails.get(k));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2060.java