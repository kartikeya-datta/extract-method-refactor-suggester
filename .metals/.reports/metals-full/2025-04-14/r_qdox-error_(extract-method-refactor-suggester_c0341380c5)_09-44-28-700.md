error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11754.java
text:
```scala
p@@rivate static class TestPage extends WebPage<Void>implements IMarkupResourceStreamProvider
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11754.java