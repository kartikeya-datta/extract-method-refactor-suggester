error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3891.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3891.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3891.java
text:
```scala
t@@hrow new ServletException("Cannot install the a certificate to the validator.", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3891.java