error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1331.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1331.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1331.java
text:
```scala
s@@witch (transition.getAfter()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1331.java