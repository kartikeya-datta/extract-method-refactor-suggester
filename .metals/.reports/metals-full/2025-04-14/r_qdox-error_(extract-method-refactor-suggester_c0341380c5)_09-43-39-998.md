error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4214.java
text:
```scala
l@@ogger.debug("Assuming daily rotation schedule");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4214.java