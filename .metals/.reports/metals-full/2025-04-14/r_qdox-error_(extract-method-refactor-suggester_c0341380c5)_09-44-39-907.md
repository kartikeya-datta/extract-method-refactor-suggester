error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13527.java
text:
```scala
v@@alues.setGroups(null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13527.java