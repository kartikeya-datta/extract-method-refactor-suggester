error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5262.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5262.java
text:
```scala
final S@@tring id = getIntent().getStringExtra(GIST_ID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5262.java