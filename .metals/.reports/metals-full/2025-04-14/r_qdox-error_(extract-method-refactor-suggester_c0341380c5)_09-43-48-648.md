error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7174.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7174.java
text:
```scala
i@@f (consoleHandler != null && "/".equals(exchange.getRequestPath())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7174.java