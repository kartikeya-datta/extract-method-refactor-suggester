error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2945.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2945.java
text:
```scala
static public b@@oolean disableAudio;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2945.java