error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13747.java
text:
```scala
r@@eturn requiresNew(invocation, component, getMethodIntf(invocation));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13747.java