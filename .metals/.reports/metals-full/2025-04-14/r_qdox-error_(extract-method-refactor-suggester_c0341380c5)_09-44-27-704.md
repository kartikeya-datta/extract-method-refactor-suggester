error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2632.java
text:
```scala
C@@ounterMutation cm = CounterMutation.serializer().deserialize(is, message.getVersion());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2632.java