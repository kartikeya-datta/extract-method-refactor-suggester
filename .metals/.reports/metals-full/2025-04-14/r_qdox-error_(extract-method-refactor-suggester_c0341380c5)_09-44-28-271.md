error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17168.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17168.java
text:
```scala
a@@pplication.getPages().setHomePage(PagedTablePage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17168.java