error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/719.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/719.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/719.java
text:
```scala
c@@heckShardConsistency("shard1", false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/719.java