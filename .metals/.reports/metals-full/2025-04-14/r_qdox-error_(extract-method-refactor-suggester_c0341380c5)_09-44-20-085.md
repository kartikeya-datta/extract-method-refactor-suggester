error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17879.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17879.java
text:
```scala
t@@hrow new UnsatisfiedLinkError ("no " + libName1 + " or " + libName2 + " in swt.library.path, java.library.path or the jar file"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17879.java