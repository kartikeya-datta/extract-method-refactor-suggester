error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7489.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7489.java
text:
```scala
A@@smRelationshipProvider.getDefault().checkerMunger(world.getModel(), shadow, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7489.java