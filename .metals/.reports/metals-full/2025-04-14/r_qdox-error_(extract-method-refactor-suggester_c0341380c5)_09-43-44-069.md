error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14066.java
text:
```scala
t@@his.raName = raxml.getArchive().substring(0, raxml.getArchive().indexOf(".rar"));
...
public final class ResourceAdapterXmlDeploymentService extends AbstractResourceAdapterDeploymentService implements
    ...
    public ResourceAdapterXmlDeploymentService(ConnectorXmlDescriptor connectorXmlDescriptor, ResourceAdapter raxml,
        ...
        this.raName = raxml.getArchive().substring(0, raxml.getArchive().indexOf(".rar")).toLowerCase();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14066.java