error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11047.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11047.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11047.java
text:
```scala
r@@eturn (element != null ? new DefaultValueWrapper(element.getObjectValue()) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11047.java