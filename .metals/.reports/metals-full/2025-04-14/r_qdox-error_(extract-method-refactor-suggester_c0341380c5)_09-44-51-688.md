error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3474.java
text:
```scala
r@@eturn RamUsageEstimator.sizeOf(values);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3474.java