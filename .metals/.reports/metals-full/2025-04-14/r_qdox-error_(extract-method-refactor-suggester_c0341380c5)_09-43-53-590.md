error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18227.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18227.java
text:
```scala
public abstract b@@oolean setText (String html, boolean trusted);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18227.java