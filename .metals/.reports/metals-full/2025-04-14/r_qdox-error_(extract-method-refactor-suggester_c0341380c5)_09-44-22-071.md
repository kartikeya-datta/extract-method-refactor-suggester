error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7983.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7983.java
text:
```scala
E@@ntityManager proxy = proxyFactoryBean.getObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7983.java