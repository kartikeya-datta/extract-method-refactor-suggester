error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3309.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3309.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3309.java
text:
```scala
n@@ew ConfigFrame(frameMediator, folder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3309.java