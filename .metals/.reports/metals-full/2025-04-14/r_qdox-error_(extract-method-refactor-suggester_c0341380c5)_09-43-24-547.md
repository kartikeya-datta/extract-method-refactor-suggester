error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2616.java
text:
```scala
t@@arget_fuzzy_pos.set(target.collisionCenter).add(random.scl(250));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2616.java