error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7382.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7382.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7382.java
text:
```scala
r@@eturn new ExecutionEvent(command, Collections.EMPTY_MAP, event, getCurrentState());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7382.java