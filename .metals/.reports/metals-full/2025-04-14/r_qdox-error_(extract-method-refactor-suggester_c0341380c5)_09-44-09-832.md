error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16685.java
text:
```scala
S@@tring id = tag.getId() + "-" + container.getPage().getAutoIndex();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16685.java