error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9262.java
text:
```scala
g@@etTabFolder().setVisible(isVisible);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9262.java