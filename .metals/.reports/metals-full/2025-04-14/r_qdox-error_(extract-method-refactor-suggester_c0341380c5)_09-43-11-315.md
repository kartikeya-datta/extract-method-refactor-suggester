error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1902.java
text:
```scala
s@@etString("markvariant", s);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1902.java