error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3493.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3493.java
text:
```scala
final S@@tring concreteIndex = clusterState.metaData().concreteSingleIndex(request.index());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3493.java