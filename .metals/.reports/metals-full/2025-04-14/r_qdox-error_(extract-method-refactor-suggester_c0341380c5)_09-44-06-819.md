error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/99.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/99.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/99.java
text:
```scala
c@@lient.admin().cluster().ping(singlePingRequest, new ActionListener<SinglePingResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/99.java