error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/506.java
text:
```scala
t@@hrow new RuntimeException("Couldn't load shared library '" + sharedLibName + "' for target: "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/506.java