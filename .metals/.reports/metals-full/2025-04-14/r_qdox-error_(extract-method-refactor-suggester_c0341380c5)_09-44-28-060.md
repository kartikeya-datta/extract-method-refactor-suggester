error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12770.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12770.java
text:
```scala
final S@@erviceController<?> service = context.getServiceRegistry().getService(JMSServices.JMS_TOPIC_BASE.append(topicName));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12770.java