error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17519.java
text:
```scala
i@@f (index == 0 || (index != -1 && signature.charAt(index-1) != '.') ) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17519.java