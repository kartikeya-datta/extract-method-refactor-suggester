error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9983.java
...
```java
offset: 872
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9983.java
text:
```scala
...
p@@ackage org.elasticsearch.index.mapper.update;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9983.java