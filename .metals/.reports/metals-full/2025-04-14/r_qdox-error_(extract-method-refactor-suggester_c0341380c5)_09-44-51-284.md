error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2119.java
text:
```scala
r@@eturn getXAConnection(getUser(), getPassword());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2119.java