error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5288.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5288.java
text:
```scala
public final static i@@nt MAX_INDEX_NAME_BYTES = 255;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5288.java