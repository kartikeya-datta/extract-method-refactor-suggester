error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11337.java
text:
```scala
t@@his.encapsulator = mapNullToDisabled(format.getQuoteChar());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11337.java