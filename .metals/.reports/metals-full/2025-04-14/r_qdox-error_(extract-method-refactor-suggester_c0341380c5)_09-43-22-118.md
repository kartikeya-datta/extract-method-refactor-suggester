error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2627.java
text:
```scala
c@@omponentsDir.mkdirs ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2627.java