error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9997.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9997.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9997.java
text:
```scala
S@@impleAttributeDefinitionBuilder.create(ModelDescriptionConstants.READ_ONLY, ModelType.BOOLEAN, true)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9997.java