error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10637.java
text:
```scala
A@@rquillianConfig arqConfig = phaseContext.getDeploymentUnit().getAttachment(ArquillianConfig.KEY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10637.java