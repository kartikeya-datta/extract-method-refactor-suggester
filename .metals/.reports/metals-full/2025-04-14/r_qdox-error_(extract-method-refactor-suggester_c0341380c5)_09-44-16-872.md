error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10026.java
text:
```scala
a@@ssertThat(result.getUnrunnableCount(), is(1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10026.java