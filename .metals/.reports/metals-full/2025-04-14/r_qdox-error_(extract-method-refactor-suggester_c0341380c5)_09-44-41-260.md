error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4059.java
text:
```scala
i@@f (formComponent.isPersistent() && formComponent.isVisibleInHierarchy())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4059.java