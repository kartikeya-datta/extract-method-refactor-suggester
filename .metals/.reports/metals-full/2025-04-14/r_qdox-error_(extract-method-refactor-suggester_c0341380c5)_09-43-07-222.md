error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4840.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4840.java
text:
```scala
public v@@oid onResourceRequested();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4840.java