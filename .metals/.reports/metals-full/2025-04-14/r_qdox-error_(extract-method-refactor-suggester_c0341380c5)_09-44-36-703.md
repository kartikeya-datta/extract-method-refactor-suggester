error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2127.java
text:
```scala
p@@arams.addArgument("SleepMask", "0x" + (Long.toHexString(DEFAULT_SLEEP_MASK)).toUpperCase(java.util.Locale.ENGLISH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2127.java