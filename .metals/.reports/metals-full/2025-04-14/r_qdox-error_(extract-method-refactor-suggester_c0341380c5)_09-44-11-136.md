error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15278.java
text:
```scala
t@@his.callable.setNext(new Callable<Object>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15278.java