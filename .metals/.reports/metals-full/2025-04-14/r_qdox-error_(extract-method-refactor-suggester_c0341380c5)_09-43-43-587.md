error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13963.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13963.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13963.java
text:
```scala
c@@heckVersion(SampleSaveConfigurationConverter.class,"392354"); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13963.java