error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8042.java
text:
```scala
c@@ommandService, bindingManager, commandImageManager,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8042.java