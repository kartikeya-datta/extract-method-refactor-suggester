error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12271.java
text:
```scala
M@@ap<String, String> variables = new HashMap<String, String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12271.java