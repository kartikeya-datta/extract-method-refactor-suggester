error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4026.java
text:
```scala
C@@olumbaLogger.log.info("saving folder: " + child.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4026.java