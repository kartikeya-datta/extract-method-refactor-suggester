error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6072.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6072.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6072.java
text:
```scala
p@@arent.imageIndex (image, index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6072.java