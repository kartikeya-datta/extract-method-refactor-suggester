error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4139.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4139.java
text:
```scala
V@@ersion indexVersion = Version.indexCreated(settings);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4139.java