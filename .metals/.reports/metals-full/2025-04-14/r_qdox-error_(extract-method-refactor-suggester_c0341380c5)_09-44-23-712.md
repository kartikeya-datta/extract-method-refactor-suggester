error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2619.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2619.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2619.java
text:
```scala
r@@eturn component.createLocalProxy(viewClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2619.java