error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6650.java
text:
```scala
s@@hapes.rect(getX(), getY(), getOriginX(), getOriginY(), getWidth(), getHeight(), getScaleX(), getScaleY(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6650.java