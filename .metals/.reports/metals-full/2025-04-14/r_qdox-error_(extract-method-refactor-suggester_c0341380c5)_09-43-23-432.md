error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3840.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3840.java
text:
```scala
t@@his.ast = AST.convertCompilationUnit(this.astLevel, unit, contents, options, true/*isResolved*/, workingCopy.owner, this.progressMonitor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3840.java