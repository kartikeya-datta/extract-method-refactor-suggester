error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5127.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5127.java
text:
```scala
public v@@oid addAll (int... array) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5127.java