error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3694.java
text:
```scala
r@@eturn number.shortValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3694.java