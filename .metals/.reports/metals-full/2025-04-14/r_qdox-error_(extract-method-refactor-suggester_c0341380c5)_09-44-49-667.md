error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/985.java
text:
```scala
G@@C gc = GC.cocoa_new (this, data);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/985.java