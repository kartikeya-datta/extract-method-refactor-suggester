error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10571.java
text:
```scala
i@@nt redrawY = y + Math.max (0, clientArea.height - startY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10571.java