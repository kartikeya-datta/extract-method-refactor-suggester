error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/854.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/854.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/854.java
text:
```scala
M@@yStringTokenizer st, dnsName origin) throws IOException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/854.java