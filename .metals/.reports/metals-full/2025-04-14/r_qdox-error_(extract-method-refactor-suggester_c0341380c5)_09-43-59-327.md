error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/220.java
text:
```scala
B@@ooleanQueryTst bqt = new BooleanQueryTst( query, expdnrs, db1, fieldName, this,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/220.java