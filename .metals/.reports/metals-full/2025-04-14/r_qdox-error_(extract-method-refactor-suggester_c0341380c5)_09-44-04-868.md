error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3824.java
text:
```scala
W@@indows system under <b>JDK 1.2</b> or above.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3824.java