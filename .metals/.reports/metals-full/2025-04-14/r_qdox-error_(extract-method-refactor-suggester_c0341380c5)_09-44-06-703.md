error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8862.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8862.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8862.java
text:
```scala
t@@hrow new ConverterNotFoundException(sourceElementType, targetElementType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8862.java