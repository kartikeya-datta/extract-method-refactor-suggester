error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12718.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12718.java
text:
```scala
public C@@oarseSessionCacheEntry<Object> readObject(ObjectInput input) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12718.java