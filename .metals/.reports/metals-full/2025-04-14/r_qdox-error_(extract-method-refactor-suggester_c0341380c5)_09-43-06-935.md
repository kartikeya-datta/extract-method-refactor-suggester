error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3549.java
text:
```scala
S@@ystem.out.println("*** SSQ path=" + defaultAppNib != null ? defaultAppNib.getString() : " defaultAppNib=null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3549.java