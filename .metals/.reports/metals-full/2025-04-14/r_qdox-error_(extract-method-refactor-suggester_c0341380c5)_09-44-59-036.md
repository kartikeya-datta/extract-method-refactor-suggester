error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/610.java
text:
```scala
L@@ocalizedOutput(OutputStream o, String enc) throws UnsupportedEncodingException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/610.java