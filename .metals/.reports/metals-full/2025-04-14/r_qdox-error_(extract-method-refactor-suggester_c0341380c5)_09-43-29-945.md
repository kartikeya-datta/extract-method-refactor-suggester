error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9467.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9467.java
...
```java
offset: 23
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9467.java
text:
```scala
+ ".prefs/lwjgl-tests")@@);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9467.java