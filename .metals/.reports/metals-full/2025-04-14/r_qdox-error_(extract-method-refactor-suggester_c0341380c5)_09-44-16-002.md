error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7612.java
text:
```scala
O@@S.SendMessage (msg.hwnd, OS.WM_CHANGEUISTATE, OS.UIS_INITIALIZE, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7612.java