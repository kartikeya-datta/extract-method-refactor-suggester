error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9231.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9231.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9231.java
text:
```scala
t@@his(widget, skin.get(ScrollPaneStyle.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9231.java