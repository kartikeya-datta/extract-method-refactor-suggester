error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5426.java
text:
```scala
r@@eturn PredicatedBuffer.predicatedBuffer(buffer, predicate);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5426.java