error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7286.java
text:
```scala
c@@ontext.removeService(ChannelService.getFactoryServiceName(ChannelService.DEFAULT));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7286.java