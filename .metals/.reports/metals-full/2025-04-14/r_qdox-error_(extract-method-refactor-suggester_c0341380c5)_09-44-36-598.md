error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/626.java
text:
```scala
a@@ssertNull(Util.cloneAndRemoveDeleted(retrieved, Integer.MAX_VALUE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/626.java