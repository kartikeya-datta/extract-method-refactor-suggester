error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4179.java
text:
```scala
p@@rintFixableError(annotationMirror.getPosition(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4179.java