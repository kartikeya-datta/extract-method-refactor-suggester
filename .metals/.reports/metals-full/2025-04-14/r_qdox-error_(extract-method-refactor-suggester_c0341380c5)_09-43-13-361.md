error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9945.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9945.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9945.java
text:
```scala
i@@f (myComponent.isEnabledInHierarchy())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9945.java