error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2758.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2758.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2758.java
text:
```scala
i@@f (contents == null) return null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2758.java