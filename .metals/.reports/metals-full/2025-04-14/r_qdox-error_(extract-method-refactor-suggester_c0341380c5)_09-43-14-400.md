error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1943.java
...
```java
offset: 878
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1943.java
text:
```scala
...
p@@ackage org.elasticsearch.index.cache.id;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1943.java