error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12184.java
text:
```scala
r@@eturn "<br/>\n";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12184.java