error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10150.java
text:
```scala
i@@nt utflen = readInt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10150.java