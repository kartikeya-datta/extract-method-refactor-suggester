error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3831.java
text:
```scala
r@@eturn LIMIT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3831.java