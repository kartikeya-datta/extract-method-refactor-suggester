error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12636.java
text:
```scala
i@@f (serverEnvironment.getLaunchType() == ServerEnvironment.LaunchType.STANDALONE)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12636.java