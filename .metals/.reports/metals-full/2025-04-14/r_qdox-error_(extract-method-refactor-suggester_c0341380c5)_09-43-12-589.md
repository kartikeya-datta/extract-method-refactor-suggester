error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9019.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9019.java
text:
```scala
public static i@@nt TRACK_STREAM = 999;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9019.java