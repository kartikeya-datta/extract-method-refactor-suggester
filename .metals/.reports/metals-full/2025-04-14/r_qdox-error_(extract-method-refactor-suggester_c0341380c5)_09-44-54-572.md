error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2918.java
text:
```scala
i@@ndex = name.lastIndexOf('.');
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2918.java