error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14180.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14180.java
text:
```scala
r@@eturn conversionService.convert(value, typeDescriptor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14180.java