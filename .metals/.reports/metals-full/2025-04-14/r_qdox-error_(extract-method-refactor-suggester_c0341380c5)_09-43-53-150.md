error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2190.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2190.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2190.java
text:
```scala
f@@TestMethod.getMethod(), getTestClass()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2190.java