error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5383.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5383.java
text:
```scala
s@@uper(layout.repo_item, inflater, elements);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5383.java