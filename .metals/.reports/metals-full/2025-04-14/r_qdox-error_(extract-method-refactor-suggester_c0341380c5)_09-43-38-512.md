error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2585.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2585.java
text:
```scala
 d@@ebugAttrib.equals("false") || debugAttrib.equals("null")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2585.java