error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6361.java
text:
```scala
I@@ntent intent = ViewGistsActivity.createIntent(gist);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6361.java