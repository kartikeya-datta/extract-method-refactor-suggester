error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5017.java
text:
```scala
o@@ffscreenGfx.setColor(new Color(225,225,239));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5017.java