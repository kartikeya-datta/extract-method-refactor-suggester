error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6105.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6105.java
text:
```scala
r@@eturn !imapRootFolder.getAccountItem().getImapItem().getBooleanWithDefault(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6105.java