error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13692.java
text:
```scala
i@@f (isVisible ()) OS.ShowWindow (handle, stateFlags);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13692.java