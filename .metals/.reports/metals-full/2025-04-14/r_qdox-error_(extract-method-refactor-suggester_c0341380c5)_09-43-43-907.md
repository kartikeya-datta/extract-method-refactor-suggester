error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9263.java
text:
```scala
t@@his.type.equals(((ParameterizedTypeReference<?>) obj).type)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9263.java