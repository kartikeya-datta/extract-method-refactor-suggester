error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3779.java
text:
```scala
r@@eturn wrapSmartNameQuery(query, smartNameFieldMappers, parseContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3779.java