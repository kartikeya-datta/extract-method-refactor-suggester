error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7206.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7206.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7206.java
text:
```scala
L@@ist<AliasMetaData> value = new ArrayList<>(valueSize);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7206.java