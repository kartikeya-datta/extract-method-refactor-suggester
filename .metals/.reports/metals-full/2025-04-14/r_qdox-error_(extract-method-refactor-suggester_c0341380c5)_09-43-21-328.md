error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1527.java
text:
```scala
i@@f (o == null || (o.getClass() !=  ReverseOrdFieldSource.class)) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1527.java