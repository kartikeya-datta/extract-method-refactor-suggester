error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9857.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9857.java
text:
```scala
r@@eturn valuesSource == null ? Double.POSITIVE_INFINITY : mins.get(owningBucketOrd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9857.java