error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1564.java
text:
```scala
C@@reateIndexClusterStateUpdateRequest updateRequest = new CreateIndexClusterStateUpdateRequest(cause, request.index())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1564.java