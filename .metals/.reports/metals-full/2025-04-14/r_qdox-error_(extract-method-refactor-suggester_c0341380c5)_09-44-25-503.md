error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14179.java
text:
```scala
t@@extField = new TextField<String>(form, "username", new Model<String>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14179.java