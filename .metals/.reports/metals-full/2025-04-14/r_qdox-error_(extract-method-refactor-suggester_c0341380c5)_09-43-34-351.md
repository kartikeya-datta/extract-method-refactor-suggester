error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8786.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8786.java
text:
```scala
protected v@@oid renderMesh() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8786.java