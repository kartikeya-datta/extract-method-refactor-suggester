error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10720.java
text:
```scala
i@@f (arguments != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10720.java