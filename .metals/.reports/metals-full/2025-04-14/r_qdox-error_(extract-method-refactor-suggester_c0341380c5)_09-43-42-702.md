error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9491.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9491.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9491.java
text:
```scala
n@@ew TableChangedEvent(TableChangedEvent.UPDATE, folder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9491.java