error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10625.java
text:
```scala
r@@eturn new String[] {"Alignment", "CaretOffset", "DoubleClickEnabled", "Editable", "HorizontalIndex", "HorizontalPixel", "Indent", "Orientation", "Selection", "Tabs", "Text", "TextLimit", "ToolTipText", "TopIndex", "TopPixel", "WordWrap"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10625.java