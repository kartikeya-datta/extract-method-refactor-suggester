error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7508.java
text:
```scala
n@@umDataNodes = 2,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7508.java