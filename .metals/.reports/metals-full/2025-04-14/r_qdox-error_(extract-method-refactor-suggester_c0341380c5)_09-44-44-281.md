error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7322.java
text:
```scala
r@@edeploy(context, runtimeName, name, resultHandler, contents);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7322.java