error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/975.java
...
```java
offset: 883
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/975.java
text:
```scala
...
p@@ackage org.elasticsearch.test.rest.test;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/975.java