error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1338.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1338.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1338.java
text:
```scala
b@@oolean isParameter = Boolean.valueOf(memento.nextToken()).booleanValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1338.java