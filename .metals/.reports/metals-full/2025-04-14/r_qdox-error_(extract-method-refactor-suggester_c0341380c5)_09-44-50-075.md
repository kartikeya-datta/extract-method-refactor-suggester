error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3184.java
text:
```scala
b@@ackingStore.closeForWriting();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3184.java