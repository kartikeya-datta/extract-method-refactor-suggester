error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14683.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14683.java
text:
```scala
r@@eturn HttpRequest.get(managementClient.getWebUri() + "/test/" + urlPattern + "?op=" + op, 10, SECONDS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14683.java