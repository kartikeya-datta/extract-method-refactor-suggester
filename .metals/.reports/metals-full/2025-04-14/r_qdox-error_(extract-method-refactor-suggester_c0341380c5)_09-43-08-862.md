error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8447.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8447.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8447.java
text:
```scala
b@@ox.add(createScopePanel(true, true, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8447.java