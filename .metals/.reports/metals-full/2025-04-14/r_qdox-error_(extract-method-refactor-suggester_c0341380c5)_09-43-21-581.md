error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6816.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6816.java
text:
```scala
A@@ssert.assertEquals(expectedDocument, document);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6816.java