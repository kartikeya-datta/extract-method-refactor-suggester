error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6401.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6401.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6401.java
text:
```scala
final l@@ong defaultAccessTimeout = EJB3SubsystemRootResourceDefinition.DEFAULT_STATEFUL_BEAN_ACCESS_TIMEOUT.resolveModelAttribute(context, model).asLong();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6401.java