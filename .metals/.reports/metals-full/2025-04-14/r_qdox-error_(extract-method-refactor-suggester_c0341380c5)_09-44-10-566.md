error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9117.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9117.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9117.java
text:
```scala
U@@rl currentUrl = requestCycle.getUrlRenderer().getBaseUrl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9117.java