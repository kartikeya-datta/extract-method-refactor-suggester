error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12932.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12932.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12932.java
text:
```scala
t@@his.contextSelector = new LazyConnectionContextSelector(hostUrl, callbackHandler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12932.java