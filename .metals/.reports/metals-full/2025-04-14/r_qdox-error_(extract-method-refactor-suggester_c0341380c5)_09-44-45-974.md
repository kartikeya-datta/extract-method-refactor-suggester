error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3922.java
text:
```scala
b@@uf = ChannelBuffers.wrappedBuffer(builder.underlyingBytes(), 0, builder.underlyingBytesLength());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3922.java