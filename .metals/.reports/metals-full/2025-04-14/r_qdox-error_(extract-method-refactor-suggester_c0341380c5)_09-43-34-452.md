error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7505.java
text:
```scala
_@@metricsConsumer.prepare(stormConf, _registrationArgument, context, collector);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7505.java