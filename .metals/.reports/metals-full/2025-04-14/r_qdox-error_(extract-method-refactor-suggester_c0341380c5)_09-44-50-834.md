error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3653.java
text:
```scala
F@@ileStoreResourceDefinition.RELATIVE_PATH.parseAndSetParameter(value, store, reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3653.java