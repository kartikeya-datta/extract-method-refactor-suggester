error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3084.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3084.java
text:
```scala
public static final P@@athElement FILE_STORE_PATH = PathElement.pathElement(ModelKeys.FILE_STORE, ModelKeys.FILE_STORE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3084.java