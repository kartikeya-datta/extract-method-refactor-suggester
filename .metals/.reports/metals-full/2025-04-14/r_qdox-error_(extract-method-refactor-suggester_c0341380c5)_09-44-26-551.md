error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14901.java
text:
```scala
A@@cceptingChannel<? extends ConnectedStreamChannel> streamServer = networkServerProvider.createServer(configuration.getBindAddress(), options, provider, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14901.java