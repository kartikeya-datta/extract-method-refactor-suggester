error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6674.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6674.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6674.java
text:
```scala
public static i@@nt passes = 10;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6674.java