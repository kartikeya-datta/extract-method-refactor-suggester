error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7950.java
text:
```scala
r@@eturn ThreadPool.Names.FLUSH;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7950.java