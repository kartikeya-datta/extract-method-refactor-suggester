error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3415.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3415.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3415.java
text:
```scala
t@@hrow new DfsPhaseExecutionException(context, "", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3415.java