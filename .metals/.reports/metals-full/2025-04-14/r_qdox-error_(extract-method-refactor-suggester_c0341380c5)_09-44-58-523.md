error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16983.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16983.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16983.java
text:
```scala
b@@uffer.append(SharedResources.path(RequestCycle.get().getApplication(), scope, name, locale, style));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16983.java