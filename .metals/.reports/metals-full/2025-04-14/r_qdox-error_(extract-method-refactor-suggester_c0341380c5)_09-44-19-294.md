error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4793.java
text:
```scala
i@@f (originalMethod.typeVariables == Binding.NO_TYPE_VARIABLES || originalMethod.isStatic()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4793.java