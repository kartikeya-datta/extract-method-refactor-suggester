error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12809.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12809.java
text:
```scala
public I@@D getContainerID() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12809.java