error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7514.java
text:
```scala
t@@abItem.setToolTipText(part.getTitleToolTipText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7514.java