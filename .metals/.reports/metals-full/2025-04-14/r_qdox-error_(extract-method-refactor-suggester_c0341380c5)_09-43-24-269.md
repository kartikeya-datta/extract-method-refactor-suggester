error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1693.java
text:
```scala
J@@Frame frame = new JFrame("GDX - LWJGL Test Launcher");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1693.java