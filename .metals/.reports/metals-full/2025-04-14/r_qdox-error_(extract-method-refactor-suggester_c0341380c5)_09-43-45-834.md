error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3134.java
text:
```scala
r@@iw.shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3134.java