error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9657.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9657.java
text:
```scala
s@@uper(Constants.ATTR_RUNTIME_INVISIBLE_PARAMETER_ANNOTATIONS,false,nameIndex,len,rvaData,cpool);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9657.java