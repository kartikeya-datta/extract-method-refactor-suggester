error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5567.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5567.java
text:
```scala
s@@uper(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5567.java