error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14166.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14166.java
text:
```scala
A@@ssert.assertEquals(8080, httpBinding.get(RESULT, "port").resolve().asInt());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14166.java