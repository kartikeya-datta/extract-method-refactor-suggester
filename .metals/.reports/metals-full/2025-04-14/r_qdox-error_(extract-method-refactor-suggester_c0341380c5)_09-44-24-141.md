error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6134.java
text:
```scala
R@@eferenceBinding match = ((ReferenceBinding)receiverErasure).findSuperTypeWithSameErasure(this.binding.declaringClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6134.java