error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9633.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9633.java
text:
```scala
t@@hrow new SockJsRuntimeException("Failed to write " + frame, ex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9633.java