error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/800.java
text:
```scala
e@@xisting.aliases.add(rect.name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/800.java