error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1027.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1027.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1027.java
text:
```scala
I@@ModelChange change = new DocumentChangeMessage(i + 150, newText.length(),	newText);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1027.java