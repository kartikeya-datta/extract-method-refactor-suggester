error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1492.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1492.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1492.java
text:
```scala
d@@elete[] verticesOut;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1492.java