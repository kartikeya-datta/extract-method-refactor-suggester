error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9720.java
text:
```scala
m@@ac.libraries = "-framework CoreServices -framework Carbon -framework IOKit -framework Cocoa";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9720.java