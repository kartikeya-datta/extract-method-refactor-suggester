error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10754.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10754.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10754.java
text:
```scala
t@@argetID = IDFactory.getDefault().makeStringID(targetString);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10754.java