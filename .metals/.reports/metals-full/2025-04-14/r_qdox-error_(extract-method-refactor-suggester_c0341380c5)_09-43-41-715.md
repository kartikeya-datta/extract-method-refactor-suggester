error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6462.java
text:
```scala
i@@f (!valid) throw new GdxRuntimeException("#iterator() cannot be used nested.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6462.java