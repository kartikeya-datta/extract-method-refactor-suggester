error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4959.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4959.java
text:
```scala
final S@@tring secondaryTestAddress = NetworkUtils.canonize(Utils.getSecondaryTestAddress(managementClient, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4959.java