error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7406.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7406.java
text:
```scala
private L@@ist<Object> values = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7406.java