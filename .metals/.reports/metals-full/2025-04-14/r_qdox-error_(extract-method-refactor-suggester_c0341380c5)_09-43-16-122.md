error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2814.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2814.java
text:
```scala
i@@os.headerDirs = new String[] { "iosgl" };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2814.java