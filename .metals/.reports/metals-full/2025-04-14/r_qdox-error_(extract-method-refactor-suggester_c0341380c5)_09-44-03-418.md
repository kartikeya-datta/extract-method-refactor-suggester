error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2664.java
text:
```scala
r@@eturn core.getNormValues(field);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2664.java