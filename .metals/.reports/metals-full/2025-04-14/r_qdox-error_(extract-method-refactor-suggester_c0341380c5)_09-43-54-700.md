error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6981.java
text:
```scala
i@@f ((operationTypeID = (implicitConversion & IMPLICIT_CONVERSION_MASK) >> 4) == T_String) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6981.java