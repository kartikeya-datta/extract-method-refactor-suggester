error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12262.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12262.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12262.java
text:
```scala
b@@aseDir = FILE_UTILS.resolveFile(getProject().getBaseDir(),".");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12262.java