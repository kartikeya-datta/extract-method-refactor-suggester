error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1326.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1326.java
text:
```scala
r@@eturn	operatorToString() + " " + expression.toStringExpression() ; } //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1326.java