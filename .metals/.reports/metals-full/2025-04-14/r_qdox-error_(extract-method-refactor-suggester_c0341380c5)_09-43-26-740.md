error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/111.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/111.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/111.java
text:
```scala
final C@@onvexHull2D hull = new MonotoneChain(true, 2).generate(points);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/111.java