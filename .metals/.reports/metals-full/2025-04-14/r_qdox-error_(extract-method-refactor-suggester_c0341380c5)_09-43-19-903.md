error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/110.java
text:
```scala
n@@ew Panel1(this, "panel1");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/110.java