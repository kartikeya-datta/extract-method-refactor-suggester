error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11783.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11783.java
text:
```scala
public A@@bstractPropertyUpdate getCompensatingUpdate(final PropertiesElement original) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11783.java