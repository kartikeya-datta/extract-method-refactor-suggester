error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11966.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11966.java
text:
```scala
s@@uper.onComponentTagBody(markupStream, openTag);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11966.java