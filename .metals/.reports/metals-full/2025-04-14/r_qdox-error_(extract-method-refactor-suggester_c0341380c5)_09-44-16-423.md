error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5422.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5422.java
text:
```scala
e@@vents = isDisposed () || runAsyncMessages (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5422.java