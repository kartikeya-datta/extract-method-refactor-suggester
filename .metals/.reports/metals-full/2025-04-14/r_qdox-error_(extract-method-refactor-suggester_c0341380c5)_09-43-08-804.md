error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3066.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3066.java
text:
```scala
p@@ublic abstract class AbstractResourceReferenceMapper extends AbstractComponentMapper
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3066.java