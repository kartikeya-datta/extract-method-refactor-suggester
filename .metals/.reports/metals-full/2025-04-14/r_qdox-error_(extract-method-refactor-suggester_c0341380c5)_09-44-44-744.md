error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6959.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6959.java
text:
```scala
final b@@oolean includeSettings = request.paramAsBoolean("settings", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6959.java