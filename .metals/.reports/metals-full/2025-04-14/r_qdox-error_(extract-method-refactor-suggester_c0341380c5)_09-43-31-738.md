error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/312.java
text:
```scala
i@@f(parameterNames != null) proposal.setParameterNames(parameterNames);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/312.java