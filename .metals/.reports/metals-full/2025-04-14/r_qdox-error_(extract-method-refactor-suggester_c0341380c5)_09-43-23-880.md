error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18082.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18082.java
text:
```scala
public static final S@@tring NAME = "ecf.namespace.r_osgi.remoteservice"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18082.java