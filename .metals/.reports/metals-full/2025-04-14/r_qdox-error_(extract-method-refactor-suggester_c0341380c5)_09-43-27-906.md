error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4096.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4096.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4096.java
text:
```scala
C@@lass<?> type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4096.java