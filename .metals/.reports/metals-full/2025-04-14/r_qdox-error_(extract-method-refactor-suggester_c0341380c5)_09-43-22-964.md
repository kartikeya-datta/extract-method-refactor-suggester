error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3287.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3287.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3287.java
text:
```scala
t@@his.searcher = new ContextIndexSearcher(this, engineSearcher);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3287.java