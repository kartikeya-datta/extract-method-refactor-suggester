error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2720.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2720.java
text:
```scala
public v@@oid setHeaders(URLConnection connection, HTTPSamplerBase sampler) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2720.java