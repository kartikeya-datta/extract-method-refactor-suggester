error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13868.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13868.java
text:
```scala
public static final S@@tring OPERATION_NAME = "add";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13868.java