error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17779.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[65,80]

error in qdox parser
file content:
```java
offset: 1794
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17779.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17779.java