error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5972.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5972.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5972.java
text:
```scala
S@@tringBuilder stringBuffer = new StringBuilder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5972.java