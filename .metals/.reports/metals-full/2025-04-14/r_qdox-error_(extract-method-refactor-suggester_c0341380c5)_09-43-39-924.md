error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1988.java
text:
```scala
c@@tx.handle("patch rollback --patch-id=" + patchID + " --distribution=" + env.getInstalledImage().getJbossHome() + " --reset-configuration=false");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1988.java