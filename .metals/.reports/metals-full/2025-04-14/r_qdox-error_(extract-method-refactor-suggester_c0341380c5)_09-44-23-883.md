error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9383.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9383.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9383.java
text:
```scala
public v@@oid testOtherJNDIbindingsAreAvailableAtStartup() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9383.java