error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/727.java
text:
```scala
i@@nt newHorizontalOffset = Math.max(0, renderer.getWidth() - clientAreaWidth);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/727.java