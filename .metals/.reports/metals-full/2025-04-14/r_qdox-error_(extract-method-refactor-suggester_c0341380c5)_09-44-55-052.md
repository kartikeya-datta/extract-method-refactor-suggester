error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/897.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/897.java
text:
```scala
r@@eturn userFeatures.length > 0 ? userFeatures[0].length : 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/897.java