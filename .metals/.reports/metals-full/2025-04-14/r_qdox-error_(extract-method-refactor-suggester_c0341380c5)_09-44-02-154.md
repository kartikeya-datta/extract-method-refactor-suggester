error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12014.java
text:
```scala
t@@his(LocalizedFormats.NULL_NOT_ALLOWED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12014.java