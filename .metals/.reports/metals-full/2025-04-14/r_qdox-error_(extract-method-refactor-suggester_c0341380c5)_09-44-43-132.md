error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15882.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15882.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15882.java
text:
```scala
public M@@ethodBinding syntheticAccessor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15882.java