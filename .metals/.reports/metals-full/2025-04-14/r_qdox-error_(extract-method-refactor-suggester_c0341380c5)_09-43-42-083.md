error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4201.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4201.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4201.java
text:
```scala
static S@@impleAttributeDefinition ALLOW_MULTIPLE_USERS = new SimpleAttributeDefinition(ALLOW_MULTIPLE_USERS_NAME, DsPool.Tag.ALLOW_MULTIPLE_USERS.getLocalName(), new ModelNode(Defaults.ALLOW_MULTIPLE_USERS), ModelType.BOOLEAN, true, false, MeasurementUnit.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4201.java