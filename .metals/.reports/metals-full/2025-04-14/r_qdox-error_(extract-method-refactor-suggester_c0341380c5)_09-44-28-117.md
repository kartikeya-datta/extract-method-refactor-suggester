error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9557.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9557.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9557.java
text:
```scala
C@@lass.forName("java.net.Proxy");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9557.java