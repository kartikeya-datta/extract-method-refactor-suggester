error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11144.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11144.java
text:
```scala
i@@nt[] percents = new int[] {50, 30, 5, 15};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11144.java