error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2690.java
text:
```scala
s@@uper(directory, 0L, 100, env, stdin, stdout, stderr);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2690.java