error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15489.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15489.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15489.java
text:
```scala
static i@@nt MINOR_VERSION = 201;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15489.java