error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2474.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2474.java
text:
```scala
s@@ervers.registerReadWriteAttribute(GROUP, null, ServerConfigGroupWriteAttributeHandler.INSTANCE, Storage.CONFIGURATION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2474.java