error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3578.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3578.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3578.java
text:
```scala
B@@loomFilter.Factory.buildFromString(postingsFormatSettings.get("fpp"))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3578.java