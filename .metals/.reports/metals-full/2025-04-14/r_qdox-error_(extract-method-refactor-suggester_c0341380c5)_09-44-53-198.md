error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/384.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/384.java
text:
```scala
protected v@@oid update(final int position, final NewsItemView view, final Event event) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/384.java