error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8133.java
text:
```scala
W@@ildcardBinding wildcard = scope.environment().createWildcard(genericType, rank, boundType, null /*no extra bound*/, this.kind);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8133.java