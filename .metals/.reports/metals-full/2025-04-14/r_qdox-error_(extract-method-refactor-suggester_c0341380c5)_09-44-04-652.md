error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8531.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8531.java
text:
```scala
c@@urrentType = currentType.superclass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8531.java