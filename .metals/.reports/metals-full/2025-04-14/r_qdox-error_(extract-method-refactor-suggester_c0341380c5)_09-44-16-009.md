error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14018.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14018.java
text:
```scala
i@@nt /*long*/ shellHandle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14018.java