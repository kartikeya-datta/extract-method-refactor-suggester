error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/116.java
text:
```scala
r@@eturn CharOperation.concat(Evaluator.this.getClassName(), ".java".toCharArray()); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/116.java