error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8967.java
text:
```scala
i@@f (value.getValue()!=null && !((value.getValue() instanceof String) && ((String)value.getValue()).length()==0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8967.java