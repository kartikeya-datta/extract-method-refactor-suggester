error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6661.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6661.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6661.java
text:
```scala
O@@bject[] listEntries = {"This is a list entry1", "And another one1", "The meaning of life1", "Is hard to come by1",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6661.java