error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10912.java
text:
```scala
r@@eturn new WebSession(WebApplication.this, request, response);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10912.java