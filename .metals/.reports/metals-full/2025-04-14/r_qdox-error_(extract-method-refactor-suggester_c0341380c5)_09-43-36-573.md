error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/646.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/646.java
text:
```scala
public S@@hort convertToObject(final String value, final Locale locale)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/646.java