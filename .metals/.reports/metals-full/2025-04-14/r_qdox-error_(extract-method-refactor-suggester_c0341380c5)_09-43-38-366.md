error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/372.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/372.java
text:
```scala
public static final S@@tring SIGNATURE= "INDEX VERSION 1.008"; //$NON-NLS-1$
...
public static final String SIGNATURE= "INDEX VERSION 1.007"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/372.java