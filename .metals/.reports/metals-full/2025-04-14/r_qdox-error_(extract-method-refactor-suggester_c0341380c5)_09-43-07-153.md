error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11922.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11922.java
text:
```scala
protected v@@oid updateRuntime(final ModelNode operation, final T handler) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11922.java