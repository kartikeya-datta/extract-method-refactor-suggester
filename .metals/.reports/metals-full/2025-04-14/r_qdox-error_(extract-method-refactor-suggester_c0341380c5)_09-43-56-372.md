error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16688.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16688.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16688.java
text:
```scala
s@@r.setDataType(SampleResult.TEXT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16688.java