error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3373.java
text:
```scala
i@@f (alg == DNSSEC.RSAMD5) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3373.java