error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10987.java
text:
```scala
d@@.solve(b, 1.0e-10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10987.java