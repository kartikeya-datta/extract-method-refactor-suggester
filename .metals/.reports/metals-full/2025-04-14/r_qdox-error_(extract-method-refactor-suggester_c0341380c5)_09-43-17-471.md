error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16660.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16660.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16660.java
text:
```scala
S@@hell shell = getShell ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16660.java