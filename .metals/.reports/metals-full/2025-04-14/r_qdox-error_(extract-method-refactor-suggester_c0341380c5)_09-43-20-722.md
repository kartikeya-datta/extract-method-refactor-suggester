error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16064.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16064.java
text:
```scala
public final S@@tring LEGEND_THREAD = JMeterUtils.getResString("monitor_legend_thread_per"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16064.java