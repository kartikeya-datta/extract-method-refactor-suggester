error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9773.java
text:
```scala
i@@f (host == null || port == 0) { throw new OperationFailedException(MESSAGES.needHostAndPort()); }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9773.java