error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7220.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7220.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7220.java
text:
```scala
I@@PackageFragment[] frags= ((JavaProject) project).getPackageFragmentsInRoots(fPackageFragmentRoots);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7220.java