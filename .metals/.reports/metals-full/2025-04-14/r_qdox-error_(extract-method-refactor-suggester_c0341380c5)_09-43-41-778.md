error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14606.java
text:
```scala
t@@mp = new File(serverDataDir, "content");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14606.java