error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4670.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4670.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4670.java
text:
```scala
r@@eturn new ClasspathJar(libraryPathname, lastModified, accessRuleSet);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4670.java