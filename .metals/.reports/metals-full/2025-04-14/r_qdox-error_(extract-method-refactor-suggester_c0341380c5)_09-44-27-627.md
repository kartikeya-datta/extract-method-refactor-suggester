error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1732.java
text:
```scala
r@@eturn new Term(indexName, value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1732.java