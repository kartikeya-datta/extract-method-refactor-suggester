error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/815.java
text:
```scala
i@@f (typeName == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/815.java