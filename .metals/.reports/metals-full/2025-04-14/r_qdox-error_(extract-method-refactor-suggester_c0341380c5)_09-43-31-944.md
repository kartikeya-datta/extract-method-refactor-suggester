error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6505.java
text:
```scala
p@@ost.setRequestHeader(HEADER_CONTENT_TYPE, DEFAULT_CONTENT_TYPE); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6505.java