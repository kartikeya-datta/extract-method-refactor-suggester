error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9455.java
text:
```scala
o@@utput.append("<CompleteOnJavadocSingleTypeReference:"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9455.java