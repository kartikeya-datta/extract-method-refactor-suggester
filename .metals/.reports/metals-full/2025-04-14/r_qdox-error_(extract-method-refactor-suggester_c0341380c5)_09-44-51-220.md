error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7783.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7783.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7783.java
text:
```scala
c@@reateIndexAction.execute(new CreateIndexRequest(request).index(request.index()).cause("auto(update api)").masterNodeTimeout(request.timeout()), new ActionListener<CreateIndexResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7783.java