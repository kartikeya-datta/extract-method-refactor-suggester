error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15978.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15978.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15978.java
text:
```scala
private final B@@ook book = new Book(null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15978.java