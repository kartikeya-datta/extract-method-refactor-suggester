error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1868.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1868.java
text:
```scala
public static final S@@tring NAME = "indices:data/write/script/put";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1868.java