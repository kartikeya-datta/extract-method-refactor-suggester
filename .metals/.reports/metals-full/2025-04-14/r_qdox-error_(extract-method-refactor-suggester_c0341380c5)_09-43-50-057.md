error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2082.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2082.java
...
```java
offset: 4
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2082.java
text:
```scala
 c@@opy.hasResourceChanged()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2082.java