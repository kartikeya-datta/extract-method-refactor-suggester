error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8442.java
text:
```scala
i@@f (boost != -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8442.java