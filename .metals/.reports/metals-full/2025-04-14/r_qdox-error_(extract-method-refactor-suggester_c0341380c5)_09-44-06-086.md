error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10802.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10802.java
text:
```scala
static final S@@tring EVENT_COMPONENT = "eventComponent";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10802.java