error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2422.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2422.java
text:
```scala
s@@etTooltipText(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2422.java