error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1851.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1851.java
text:
```scala
public static final S@@tring NAME = "indices:data/benchmark/start";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1851.java