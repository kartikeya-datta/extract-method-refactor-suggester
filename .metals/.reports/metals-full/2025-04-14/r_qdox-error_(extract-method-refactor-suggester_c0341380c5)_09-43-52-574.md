error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3775.java
text:
```scala
r@@eturn count;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3775.java