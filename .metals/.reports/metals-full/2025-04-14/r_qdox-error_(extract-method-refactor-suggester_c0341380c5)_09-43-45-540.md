error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1354.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1354.java
text:
```scala
S@@tring str = endpointDescription.getID().getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1354.java