error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1030.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1030.java
text:
```scala
i@@nt result = OperatorExpression.OperatorSignatures[operator][ (lhsId << 4) + expressionId];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1030.java