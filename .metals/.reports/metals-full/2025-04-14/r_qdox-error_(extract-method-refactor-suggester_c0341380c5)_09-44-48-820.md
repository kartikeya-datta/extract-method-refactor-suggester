error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3720.java
text:
```scala
H@@ttpManagementAddHandler.installHttpManagementServices(context.getRunningMode(), context.getServiceTarget(), hostControllerInfo, environment, verificationHandler, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3720.java