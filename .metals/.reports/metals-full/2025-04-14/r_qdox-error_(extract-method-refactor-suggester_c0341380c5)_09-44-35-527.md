error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5246.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5246.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5246.java
text:
```scala
s@@ource = Arrays.copyOfRange(source, sourceOffset, sourceOffset + sourceLength);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5246.java