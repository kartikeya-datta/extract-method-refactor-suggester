error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1279.java
text:
```scala
r@@eturn ch & 0x000000FF;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1279.java