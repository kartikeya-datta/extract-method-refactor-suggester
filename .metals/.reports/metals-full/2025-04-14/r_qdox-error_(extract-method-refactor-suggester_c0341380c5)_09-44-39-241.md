error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16814.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16814.java
text:
```scala
static final D@@OMImplementationImpl singleton = new DOMImplementationImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16814.java