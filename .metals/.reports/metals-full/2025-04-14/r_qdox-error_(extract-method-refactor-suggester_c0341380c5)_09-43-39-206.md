error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9092.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9092.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9092.java
text:
```scala
i@@f (!ret.exists() && (dir != null) && !ret.isAbsolute()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9092.java