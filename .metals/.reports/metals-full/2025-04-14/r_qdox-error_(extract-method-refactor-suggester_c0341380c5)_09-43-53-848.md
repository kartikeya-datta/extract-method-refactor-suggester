error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7490.java
text:
```scala
A@@smRelationshipProvider.getDefault().adviceMunger(world.getModel(), this, munger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7490.java