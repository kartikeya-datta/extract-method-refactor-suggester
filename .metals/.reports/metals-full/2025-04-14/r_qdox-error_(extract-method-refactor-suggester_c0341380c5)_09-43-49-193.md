error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9642.java
text:
```scala
i@@f (parent.imageBounds == null && image != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9642.java