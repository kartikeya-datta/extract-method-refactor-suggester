error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3883.java
text:
```scala
S@@tring encoding = JavaCore.create(file.getProject()).getOption(JavaCore.CORE_ENCODING, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3883.java