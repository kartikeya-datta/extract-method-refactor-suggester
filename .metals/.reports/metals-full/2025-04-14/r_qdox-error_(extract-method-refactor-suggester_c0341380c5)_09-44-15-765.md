error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3806.java
text:
```scala
r@@esult = flags.get(Flags.DELETED);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3806.java