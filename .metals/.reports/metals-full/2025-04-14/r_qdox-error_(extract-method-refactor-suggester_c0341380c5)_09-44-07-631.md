error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6304.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6304.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6304.java
text:
```scala
A@@bstractMethodDeclaration methodDecl = parsedType.declarationOf(method.original());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6304.java