error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3769.java
text:
```scala
i@@f (accessedType.isBaseType() && accessedType != NullBinding) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3769.java