error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2537.java
text:
```scala
S@@QLState.CANNOT_CONNECT_TO_DB_IN_SLAVE_MODE.startsWith(ss));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2537.java