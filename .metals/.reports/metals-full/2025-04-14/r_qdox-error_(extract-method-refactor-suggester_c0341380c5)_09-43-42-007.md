error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5229.java
text:
```scala
i@@f (CharOperation.prefixEquals(SyntheticArgumentBinding.EnclosingInstancePrefix, field.name)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5229.java