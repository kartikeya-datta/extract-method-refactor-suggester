error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6335.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6335.java
text:
```scala
n@@ame.foreground(repository.getOwner().getLogin(), prefixColor).foreground('/', prefixColor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6335.java