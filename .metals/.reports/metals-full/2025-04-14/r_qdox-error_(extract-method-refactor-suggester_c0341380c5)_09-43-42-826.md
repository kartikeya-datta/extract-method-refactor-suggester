error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7667.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7667.java
text:
```scala
public I@@AuthorizationStrategy getAuthorizationStrategy()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7667.java