error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9835.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9835.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9835.java
text:
```scala
public static S@@tring RUN_IN_BACKGROUND = "RUN_IN_BACKGROUND"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9835.java