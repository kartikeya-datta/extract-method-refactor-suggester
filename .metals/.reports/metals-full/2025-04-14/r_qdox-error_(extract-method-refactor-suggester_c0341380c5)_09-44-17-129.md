error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7916.java
text:
```scala
t@@his.location = new File(new File(nodeEnv.nodeDataLocation(), "indices"), index.name());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7916.java