error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9546.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9546.java
text:
```scala
public static R@@untimeExceptionTranslator getRollbackTranslator
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9546.java