error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13636.java
text:
```scala
i@@f (OS.COMCTL32_MAJOR >= 6) lpWndClass.style |= OS.CS_DROPSHADOW;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13636.java