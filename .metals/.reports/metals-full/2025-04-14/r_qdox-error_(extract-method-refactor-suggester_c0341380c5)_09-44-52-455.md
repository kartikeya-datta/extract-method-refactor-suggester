error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2759.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2759.java
text:
```scala
s@@uite.addTest(PrepareExecuteDDL.suite());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2759.java