error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6815.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6815.java
text:
```scala
private static final S@@tring VERSION = "2.1.2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6815.java