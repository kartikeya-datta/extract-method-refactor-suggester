error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18248.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18248.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18248.java
text:
```scala
final T@@ypeFactory factory = frame.getTypeManager().getFactory( Task.ROLE );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18248.java