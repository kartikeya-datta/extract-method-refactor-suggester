error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4616.java
text:
```scala
i@@nt /*long*/ gdipFont = GC.createGdipFont(hDC, font.handle, 0, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4616.java