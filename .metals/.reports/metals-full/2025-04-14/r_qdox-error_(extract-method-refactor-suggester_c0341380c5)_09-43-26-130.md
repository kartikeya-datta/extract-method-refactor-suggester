error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8565.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8565.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8565.java
text:
```scala
public static final S@@tring DEFAULT_CONNECTIONFACTORY_BINDING = "java:jboss/jaxr/ConnectionFactory";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8565.java