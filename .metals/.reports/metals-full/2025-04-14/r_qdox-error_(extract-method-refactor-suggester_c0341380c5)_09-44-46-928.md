error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6629.java
text:
```scala
i@@ndexShard.refresh(new Engine.Refresh().force(request.force()).source("api"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6629.java