error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2710.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2710.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2710.java
text:
```scala
n@@ew RefreshingView(this, "view")
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2710.java