error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10191.java
text:
```scala
S@@tring href = tag.getAttributes().getString("href");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10191.java