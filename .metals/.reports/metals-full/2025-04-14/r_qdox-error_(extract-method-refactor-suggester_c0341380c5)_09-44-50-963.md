error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14139.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14139.java
text:
```scala
public final T@@extTemplate interpolate(Map<String, ?> variables)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14139.java