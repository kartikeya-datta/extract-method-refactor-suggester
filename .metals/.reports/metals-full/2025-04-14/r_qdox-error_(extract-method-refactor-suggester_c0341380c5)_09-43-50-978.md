error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9217.java
text:
```scala
r@@eturn new ShardFlushRequest(shard.shardId(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9217.java