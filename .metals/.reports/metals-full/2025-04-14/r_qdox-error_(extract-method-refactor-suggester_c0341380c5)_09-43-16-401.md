error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9473.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9473.java
text:
```scala
f@@rameBuffer.getColorBufferTexture().getHeight(), false, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9473.java