error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/509.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/509.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/509.java
text:
```scala
i@@tem.release (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/509.java