error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15060.java
...
```java
offset: 1096
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15060.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.server.deployment.module;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15060.java