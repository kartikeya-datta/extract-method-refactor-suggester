error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3943.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3943.java
text:
```scala
public N@@iceUrlTest(final String name)

/*
 * $Id: NiceUrlTest.java 5395 2006-04-16 13:42:28 +0000 (Sun, 16 Apr 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3943.java