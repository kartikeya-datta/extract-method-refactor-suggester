error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3784.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3784.java
text:
```scala
private transient V@@irtualFile file;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3784.java