error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16850.java
text:
```scala
M@@essageAdmin.getAdmin().putReply(reply.getJMSCorrelationID(), reply);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16850.java