error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1840.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1840.java
text:
```scala
b@@ar.adoptView(ref, -1, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1840.java