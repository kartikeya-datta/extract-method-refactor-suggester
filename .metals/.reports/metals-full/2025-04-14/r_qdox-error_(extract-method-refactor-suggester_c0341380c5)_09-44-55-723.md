error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2998.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2998.java
text:
```scala
C@@ategory._default.clear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2998.java