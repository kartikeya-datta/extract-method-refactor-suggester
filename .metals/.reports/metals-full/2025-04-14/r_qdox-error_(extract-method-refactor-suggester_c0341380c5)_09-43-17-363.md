error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/326.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/326.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/326.java
text:
```scala
public T@@ getMedian() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/326.java