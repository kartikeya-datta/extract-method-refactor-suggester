error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9059.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9059.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9059.java
text:
```scala
C@@ollection<String> treePath = Arrays.asList(new String[] { "1", "2", "3", "4" });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9059.java