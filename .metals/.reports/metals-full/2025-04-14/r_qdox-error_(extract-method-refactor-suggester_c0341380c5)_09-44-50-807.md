error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16198.java
text:
```scala
b@@uffer.append(super.toString(true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16198.java