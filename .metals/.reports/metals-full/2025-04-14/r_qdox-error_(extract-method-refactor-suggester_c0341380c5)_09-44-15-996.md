error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5019.java
text:
```scala
F@@ileDialoger.promptToSaveFile("cookies.txt").getSelectedFile();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5019.java