error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2707.java
text:
```scala
r@@eturn output;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2707.java