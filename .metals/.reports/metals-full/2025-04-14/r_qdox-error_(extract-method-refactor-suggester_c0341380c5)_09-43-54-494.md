error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1594.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1594.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1594.java
text:
```scala
a@@ssertThat(docs.getOrd(i), equalTo(Ordinals.MISSING_ORDINAL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1594.java