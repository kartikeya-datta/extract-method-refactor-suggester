error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5202.java
text:
```scala
c@@ontext.removeService(ConnectorServices.RESOURCEADAPTERS_SERVICE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5202.java