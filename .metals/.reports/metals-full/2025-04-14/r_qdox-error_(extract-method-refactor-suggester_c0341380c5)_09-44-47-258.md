error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1521.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1521.java
text:
```scala
f@@or (Pair<String,Long> e : PFPGrowth.readFList(context.getConfiguration())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1521.java