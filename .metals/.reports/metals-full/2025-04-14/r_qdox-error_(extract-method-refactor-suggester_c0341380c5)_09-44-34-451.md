error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3237.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3237.java
text:
```scala
public static final i@@nt ELEMENT_NOT_ON_CLASSPATH	= 1006;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3237.java