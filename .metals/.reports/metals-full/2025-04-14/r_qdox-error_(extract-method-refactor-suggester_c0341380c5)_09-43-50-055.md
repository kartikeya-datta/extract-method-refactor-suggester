error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4855.java
text:
```scala
i@@f (exceptionType.findSuperTypeOriginatingFrom(TypeIds.T_JavaLangThrowable, true) == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4855.java