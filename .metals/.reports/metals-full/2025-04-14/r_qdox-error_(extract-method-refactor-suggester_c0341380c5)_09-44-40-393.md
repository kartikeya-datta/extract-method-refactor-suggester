error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7847.java
text:
```scala
E@@clipseFactory.fromLookupEnvironment(lookupEnvironment);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7847.java