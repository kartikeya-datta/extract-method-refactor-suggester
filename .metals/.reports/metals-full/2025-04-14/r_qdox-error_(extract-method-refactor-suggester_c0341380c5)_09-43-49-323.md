error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12664.java
text:
```scala
o@@peration.get(DESCRIPTION).set(bundle.getString("data-source.add"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12664.java