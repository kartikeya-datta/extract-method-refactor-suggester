error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1706.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1706.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1706.java
text:
```scala
t@@his.valueCast = this.binding.returnType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1706.java