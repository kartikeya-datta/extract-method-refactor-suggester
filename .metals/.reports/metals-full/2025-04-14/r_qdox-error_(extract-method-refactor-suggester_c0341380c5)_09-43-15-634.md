error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9708.java
text:
```scala
a@@ssertEquals("Pjava/lang/Comparable<Pjava/lang/Enum<Ljava/lang/Object;>;>;",comparable.getSignature());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9708.java