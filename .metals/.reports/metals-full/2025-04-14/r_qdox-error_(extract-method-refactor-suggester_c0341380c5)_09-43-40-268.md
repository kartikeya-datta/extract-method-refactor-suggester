error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6546.java
text:
```scala
p@@ublic class TestFlatInheritance extends AnnotationTestCase
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6546.java