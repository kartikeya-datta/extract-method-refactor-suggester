error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3685.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3685.java
text:
```scala
final i@@nt iters = scaledRandomIntBetween(2, 20);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3685.java