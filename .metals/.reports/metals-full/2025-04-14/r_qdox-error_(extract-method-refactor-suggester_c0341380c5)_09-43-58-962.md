error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11205.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11205.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11205.java
text:
```scala
t@@hrow new RuntimeException("Could not resolve method " + entry.getKey() + " on class " + c + " with annotations " + entry.getValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11205.java