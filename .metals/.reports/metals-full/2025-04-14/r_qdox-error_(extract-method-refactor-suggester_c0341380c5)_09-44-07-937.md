error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4581.java
text:
```scala
m@@odifiers &= org.eclipse.jdt.internal.compiler.lookup.CompilerModifiers.AccJustFlag;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4581.java