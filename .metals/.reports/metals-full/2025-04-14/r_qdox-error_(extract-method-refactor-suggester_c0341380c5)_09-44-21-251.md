error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4937.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4937.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4937.java
text:
```scala
public S@@tring getInput()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4937.java