error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17495.java
text:
```scala
e@@ndBounds.width = endOffset == caretOffset ? getCaretWidth() : 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17495.java