error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1390.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1390.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1390.java
text:
```scala
h@@elloServiceTracker.open();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1390.java