error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5936.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5936.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5936.java
text:
```scala
A@@smAdviceRelationshipProvider.nodeMunger(world.getModel(), this, munger);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5936.java