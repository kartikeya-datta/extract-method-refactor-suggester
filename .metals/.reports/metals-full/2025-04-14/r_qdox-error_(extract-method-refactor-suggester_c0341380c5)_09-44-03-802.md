error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2627.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2627.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2627.java
text:
```scala
c@@am.position.scl(30);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2627.java