error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8109.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8109.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8109.java
text:
```scala
n@@ew LwjglApplication(new AssetManagerTest(), config);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8109.java