error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2643.java
text:
```scala
X@@ContentType contentType = XContentType.fromRestContentType(request.param("format", request.header("Content-Type")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2643.java