error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9243.java
text:
```scala
n@@ew Class<?>[] { this.wsPreProcessorClass }, adapter);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9243.java