error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6696.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6696.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6696.java
text:
```scala
a@@ctionBar.setSubtitle(string.anonymous);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6696.java