error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9217.java
text:
```scala
L@@ink<X> AssociationSource<X>._target = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9217.java