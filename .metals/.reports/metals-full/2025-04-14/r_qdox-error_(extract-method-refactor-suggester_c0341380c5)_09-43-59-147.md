error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14261.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14261.java
text:
```scala
final M@@anagementChannel protocolChannel = new ManagementChannelFactory(operationHandlerValue.getValue()).create(channelName, channel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14261.java