error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5941.java
text:
```scala
r@@eturn true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5941.java