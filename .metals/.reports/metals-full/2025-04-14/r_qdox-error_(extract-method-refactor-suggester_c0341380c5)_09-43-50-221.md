error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8576.java
text:
```scala
W@@izardElement wizardElement = new WizardElement(wizards[i], this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8576.java