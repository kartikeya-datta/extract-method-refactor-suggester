error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11642.java
text:
```scala
r@@esult.add(context.getAttachmentStream(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11642.java