error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1118.java
text:
```scala
i@@nt /*long*/ widget = OS.objc_msgSend (OS.objc_msgSend (cls, OS.sel_alloc), OS.sel_initWithFrame_, new NSRect());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1118.java