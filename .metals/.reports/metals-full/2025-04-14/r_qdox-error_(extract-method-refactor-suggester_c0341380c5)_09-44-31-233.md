error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16880.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16880.java
text:
```scala
private final I@@Model title;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16880.java