error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4633.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4633.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4633.java
text:
```scala
public N@@extButton(final String id, final IWizard wizard)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4633.java