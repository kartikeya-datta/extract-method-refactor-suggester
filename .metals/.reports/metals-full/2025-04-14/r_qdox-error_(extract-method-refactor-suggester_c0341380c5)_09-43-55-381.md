error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2626.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2626.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2626.java
text:
```scala
r@@eturn Collections.singletonMap(allServers, serverOp);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2626.java