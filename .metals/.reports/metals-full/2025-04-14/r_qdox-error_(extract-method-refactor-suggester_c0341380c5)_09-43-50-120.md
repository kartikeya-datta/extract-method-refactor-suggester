error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5526.java
text:
```scala
r@@eturn termFactory.createTerm(uid);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5526.java