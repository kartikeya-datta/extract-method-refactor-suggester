error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17148.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17148.java
text:
```scala
public abstract C@@lass getHomePage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17148.java