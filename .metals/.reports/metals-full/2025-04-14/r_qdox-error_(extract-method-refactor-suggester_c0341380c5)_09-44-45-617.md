error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/796.java
text:
```scala
w@@riter.write(value.toString().replace("\\", "\\\\"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/796.java