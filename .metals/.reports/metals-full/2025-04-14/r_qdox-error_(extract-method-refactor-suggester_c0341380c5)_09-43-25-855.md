error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7774.java
text:
```scala
r@@eturn null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7774.java