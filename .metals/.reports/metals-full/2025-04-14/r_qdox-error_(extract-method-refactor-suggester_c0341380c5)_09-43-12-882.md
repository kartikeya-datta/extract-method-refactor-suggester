error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1127.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1127.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1127.java
text:
```scala
v@@oid apply(RowMutation mutation, Object serializedMutation, boolean writeCommitLog) throws IOException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1127.java