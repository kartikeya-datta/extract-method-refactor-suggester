error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7317.java
text:
```scala
l@@ong lastId = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7317.java