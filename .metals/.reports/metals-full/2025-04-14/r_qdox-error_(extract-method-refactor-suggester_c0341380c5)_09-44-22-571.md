error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3145.java
text:
```scala
p@@ort = "9990";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3145.java