error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6547.java
text:
```scala
p@@ublic class TestGenerators extends AnnotationTestCase
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6547.java