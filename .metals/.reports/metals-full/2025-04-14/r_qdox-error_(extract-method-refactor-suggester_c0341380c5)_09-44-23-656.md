error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8352.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8352.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8352.java
text:
```scala
T@@hreadInfo[] infos;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8352.java