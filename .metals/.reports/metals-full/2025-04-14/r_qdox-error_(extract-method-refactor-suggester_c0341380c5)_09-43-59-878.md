error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/297.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/297.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/297.java
text:
```scala
r@@eturn instance.model.checkFunctors(null,instance.getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/297.java