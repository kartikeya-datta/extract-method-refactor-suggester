error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1919.java
text:
```scala
r@@eturn (exposeWebAppRootParam == null || Boolean.valueOf(exposeWebAppRootParam));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1919.java