error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3596.java
text:
```scala
n@@ode.get(ATTRIBUTES, ModelConstants.STARTLEVEL, ModelDescriptionConstants.ACCESS_TYPE).set(AccessType.READ_ONLY.toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3596.java