error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12795.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12795.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12795.java
text:
```scala
p@@ublic class WebMarkupContainer extends MarkupContainer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12795.java