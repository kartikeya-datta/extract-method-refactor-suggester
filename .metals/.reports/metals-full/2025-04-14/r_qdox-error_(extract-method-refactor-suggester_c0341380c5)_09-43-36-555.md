error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3694.java
text:
```scala
o@@peration.get(ARCHIVE.getName()).set(archive);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3694.java