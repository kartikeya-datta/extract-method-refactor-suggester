error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1066.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1066.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1066.java
text:
```scala
public static L@@ist availableLocaleList() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1066.java