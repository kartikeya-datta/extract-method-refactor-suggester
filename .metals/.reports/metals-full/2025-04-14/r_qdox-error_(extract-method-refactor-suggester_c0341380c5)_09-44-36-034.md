error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5097.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5097.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5097.java
text:
```scala
S@@tring fileName = this.openable.getElementName(); // working copy on a .class file may not have a resource, so use the element name
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5097.java