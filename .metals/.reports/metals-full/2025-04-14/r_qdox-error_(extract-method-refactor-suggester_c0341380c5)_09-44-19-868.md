error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/536.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/536.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/536.java
text:
```scala
v@@alidateXsd("jboss-deployment-structure-1_0.xsd");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/536.java