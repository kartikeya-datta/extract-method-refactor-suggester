error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9316.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9316.java
text:
```scala
i@@f (!valid) throw new GdxRuntimeException("Array#iterator() cannot be used nested.");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9316.java