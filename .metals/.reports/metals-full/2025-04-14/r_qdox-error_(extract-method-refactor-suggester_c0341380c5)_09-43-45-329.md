error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6665.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6665.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6665.java
text:
```scala
protected I@@mage image;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6665.java