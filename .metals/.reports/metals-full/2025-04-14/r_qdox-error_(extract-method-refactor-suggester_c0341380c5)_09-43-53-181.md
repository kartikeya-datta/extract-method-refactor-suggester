error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18048.java
text:
```scala
c@@heckVersion(SampleResultConverter.class, "1.7");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18048.java