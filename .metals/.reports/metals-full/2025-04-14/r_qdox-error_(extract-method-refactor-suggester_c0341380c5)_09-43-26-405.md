error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7377.java
text:
```scala
L@@ist<InternalSignificantTerms.Bucket> buckets = new ArrayList<>(size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7377.java