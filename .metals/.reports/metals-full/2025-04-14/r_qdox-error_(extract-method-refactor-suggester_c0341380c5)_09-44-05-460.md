error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1183.java
text:
```scala
c@@heckRandomData(random(), new CatalanAnalyzer(TEST_VERSION_CURRENT), 1000*RANDOM_MULTIPLIER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1183.java