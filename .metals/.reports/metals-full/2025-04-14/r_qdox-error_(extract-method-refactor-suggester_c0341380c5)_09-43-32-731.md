error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6329.java
text:
```scala
c@@ontext.getServiceTarget().addService(WebSubsystemElement.JBOSS_WEB_CONNECTOR.append(name), service)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6329.java