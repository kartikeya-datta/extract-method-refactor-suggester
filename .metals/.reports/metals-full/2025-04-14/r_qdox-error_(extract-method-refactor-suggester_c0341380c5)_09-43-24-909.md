error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10413.java
text:
```scala
t@@op [0] = Math.max (0, Math.min (itemHeight * itemCount - getClientArea ().height, index * itemHeight));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10413.java