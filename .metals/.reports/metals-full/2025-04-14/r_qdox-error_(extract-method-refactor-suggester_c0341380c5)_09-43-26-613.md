error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10524.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10524.java
...
```java
offset: 686
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10524.java
text:
```scala
...
p@@ackage org.springframework.web.socket.sockjs.support;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10524.java