error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6796.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6796.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6796.java
text:
```scala
i@@f(time > model.skeleton.animations.get(animation).totalDuration) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6796.java