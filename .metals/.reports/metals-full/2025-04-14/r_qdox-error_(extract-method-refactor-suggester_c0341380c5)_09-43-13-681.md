error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8168.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8168.java
text:
```scala
static final L@@ist NUMBERS = Arrays.asList(new String[] { "1", "2", "3" });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8168.java