error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2716.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2716.java
text:
```scala
i@@f (srcIsProject || this.isClasspathEntryOrOutputLocation(resFullPath, classpath, projectOutput)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2716.java