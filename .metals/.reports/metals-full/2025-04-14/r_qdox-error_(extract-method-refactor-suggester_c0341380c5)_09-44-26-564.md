error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15316.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15316.java
text:
```scala
final M@@odelNode model = Resource.Tools.readModel(context.readResourceFromRoot(PathAddress.EMPTY_ADDRESS, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15316.java