error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/583.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/583.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/583.java
text:
```scala
t@@his.rootSearchNode = new DefaultMutableTreeNode(new HyperSearchOperationNode(searchString));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/583.java