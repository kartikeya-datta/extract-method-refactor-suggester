error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6764.java
text:
```scala
A@@ssert.assertTrue(LifecycleInterceptorWithProceed.postConstruct);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6764.java