error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6702.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6702.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6702.java
text:
```scala
final T@@ransformationRule.ChainedOperationContext context = new TransformationRule.ChainedOperationContext(ctx) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6702.java