error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10324.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10324.java
text:
```scala
S@@haderProgram.TEXCOORD_ATTRIBUTE + "0"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10324.java