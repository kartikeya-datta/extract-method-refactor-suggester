error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1991.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1991.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1991.java
text:
```scala
public B@@yteBuffer fromString(String source) throws MarshalException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1991.java