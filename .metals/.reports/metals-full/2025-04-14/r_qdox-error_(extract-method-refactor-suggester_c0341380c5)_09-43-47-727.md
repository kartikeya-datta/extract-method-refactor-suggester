error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6328.java
text:
```scala
i@@f (line.length() >= delta) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6328.java