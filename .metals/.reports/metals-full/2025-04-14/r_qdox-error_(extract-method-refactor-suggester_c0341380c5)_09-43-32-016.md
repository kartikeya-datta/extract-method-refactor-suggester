error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3580.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3580.java
text:
```scala
public abstract v@@oid writeSetSpecialRegister_(Section section, java.util.ArrayList sqlsttList) throws SqlException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3580.java