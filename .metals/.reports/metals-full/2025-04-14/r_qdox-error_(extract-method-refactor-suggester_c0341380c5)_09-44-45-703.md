error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4116.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4116.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4116.java
text:
```scala
I@@WorkbenchCommandConstants.WINDOW_SHOW_VIEW_MENU, handler,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4116.java