error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4104.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4104.java
text:
```scala
a@@ddInputSuffix(".java");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4104.java