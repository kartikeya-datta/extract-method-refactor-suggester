error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15833.java
text:
```scala
r@@eturn new SignIn2Session(SignIn2Application.this, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15833.java