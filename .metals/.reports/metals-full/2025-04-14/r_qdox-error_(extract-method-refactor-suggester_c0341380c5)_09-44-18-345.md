error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2435.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2435.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2435.java
text:
```scala
L@@ist<SSTableReader> sstables = CompactionManager.instance.submitAnticompaction(cfstore, ranges, remote).get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2435.java