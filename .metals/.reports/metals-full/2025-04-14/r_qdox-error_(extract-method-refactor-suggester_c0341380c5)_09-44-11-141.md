error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/870.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/870.java
text:
```scala
W@@riteResponseHandler responseHandler = new WriteResponseHandler(1, tableName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/870.java