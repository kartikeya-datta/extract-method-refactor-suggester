error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4605.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4605.java
text:
```scala
l@@ogger.debug("failed to clean thread locals", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4605.java