error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1738.java
text:
```scala
M@@ethod method = BeanWithProperties.class.getDeclaredMethod("getSomeIntegerValue", (Class[]) null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1738.java