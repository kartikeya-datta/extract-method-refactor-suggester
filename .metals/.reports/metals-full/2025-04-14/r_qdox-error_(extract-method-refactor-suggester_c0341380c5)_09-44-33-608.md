error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1450.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1450.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1450.java
text:
```scala
public static final S@@tring NAME = "span_not";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1450.java