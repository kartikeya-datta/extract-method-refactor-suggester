error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8539.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8539.java
text:
```scala
public static final S@@tring ID = "PROP_VALUE";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8539.java