error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7558.java
text:
```scala
S@@treams.copy(resourceStream.getInputStream(), out);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7558.java