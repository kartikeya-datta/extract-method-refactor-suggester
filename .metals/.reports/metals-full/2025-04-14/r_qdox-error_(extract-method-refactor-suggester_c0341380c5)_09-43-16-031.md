error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8769.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8769.java
text:
```scala
T@@ouchEvent event = input.usedTouchEvents.obtain();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8769.java