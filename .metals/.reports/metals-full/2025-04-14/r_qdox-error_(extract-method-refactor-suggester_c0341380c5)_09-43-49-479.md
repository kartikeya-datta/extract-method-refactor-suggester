error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2750.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2750.java
text:
```scala
public S@@tatement childBlock(TestMethod method) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2750.java