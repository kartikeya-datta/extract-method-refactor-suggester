error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7418.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7418.java
text:
```scala
r@@eturn this.factory.createBuffer(workingCopy);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7418.java