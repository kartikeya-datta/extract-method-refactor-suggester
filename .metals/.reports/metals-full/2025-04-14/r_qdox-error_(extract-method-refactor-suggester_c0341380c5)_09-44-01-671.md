error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2609.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2609.java
text:
```scala
private b@@oolean callEjbStoreOnClean = true;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2609.java