error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2160.java
text:
```scala
I@@ProblemRequestor problemRequestor = workingCopy.problemRequestor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2160.java