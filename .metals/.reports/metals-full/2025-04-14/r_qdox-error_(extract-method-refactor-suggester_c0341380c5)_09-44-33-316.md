error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13811.java
text:
```scala
i@@f (WSHelper.isJaxwsEjbDeployment(dep)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13811.java