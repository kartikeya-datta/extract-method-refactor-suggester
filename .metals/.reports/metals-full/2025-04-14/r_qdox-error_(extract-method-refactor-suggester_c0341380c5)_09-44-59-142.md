error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2893.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2893.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2893.java
text:
```scala
n@@ew PatternLayout("TEMPORARY CONSOLE APPPENDER: %d %level [%t] %c - %m%n"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2893.java