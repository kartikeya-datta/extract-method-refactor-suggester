error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/622.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/622.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/622.java
text:
```scala
s@@ettingsBuilder.loadFromUrl(environment.resolveConfig(System.getProperty("es.default.config")));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/622.java