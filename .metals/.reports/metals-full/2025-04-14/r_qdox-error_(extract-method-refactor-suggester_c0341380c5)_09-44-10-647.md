error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9314.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9314.java
text:
```scala
public b@@yte[] readInternal(Class<? extends byte[]> clazz, HttpInputMessage inputMessage) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9314.java