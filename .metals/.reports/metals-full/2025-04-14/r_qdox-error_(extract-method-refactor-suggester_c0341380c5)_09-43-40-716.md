error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9155.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9155.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9155.java
text:
```scala
t@@hrow ThreadsMessages.MESSAGES.unboundedQueueThreadPoolExecutorUninitialized();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9155.java