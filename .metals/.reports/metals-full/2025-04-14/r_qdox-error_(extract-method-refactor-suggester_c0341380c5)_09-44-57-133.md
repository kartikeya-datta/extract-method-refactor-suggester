error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3144.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3144.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3144.java
text:
```scala
S@@tring port = "9990";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3144.java