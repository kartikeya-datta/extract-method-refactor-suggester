error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2407.java
text:
```scala
a@@pplication.setHomePage(PagedTablePage.class);
...
public class PagedTableTest extends TestCase
{
	...
	public void testPagedTable() throws Exception
	{
		...
		application.getRequiredPageSettings().setHomePage(PagedTablePage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2407.java