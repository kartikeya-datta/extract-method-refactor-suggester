error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7546.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7546.java
text:
```scala
private C@@omparatorUtils() {}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7546.java