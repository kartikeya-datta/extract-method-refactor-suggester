error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2009.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2009.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2009.java
text:
```scala
C@@olumnDefinition old = cfs.metadata.getColumn_metadata().get(ByteBufferUtil.bytes("birthdate"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2009.java