error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3189.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3189.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3189.java
text:
```scala
r@@eturn "TypeNode(" + fType.getFileName() + ")"; //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3189.java