error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14449.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14449.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14449.java
text:
```scala
public v@@oid testStackTraceLineBreaks() throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14449.java