error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/721.java
text:
```scala
s@@etUp("openjpa.DetachState", "fetch-groups",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/721.java