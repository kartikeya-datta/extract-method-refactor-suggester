error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3396.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3396.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3396.java
text:
```scala
B@@yteArrayOutputStream bytes = new ByteArrayOutputStream(1024);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3396.java