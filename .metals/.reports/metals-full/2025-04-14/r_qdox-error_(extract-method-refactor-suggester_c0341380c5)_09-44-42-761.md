error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3506.java
text:
```scala
p@@ublic class Label<T> extends WebComponent<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3506.java