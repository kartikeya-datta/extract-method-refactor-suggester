error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6967.java
text:
```scala
l@@ong version = UidField.loadVersion(context, new Term(UidFieldMapper.NAME, uid.toBytesRef()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6967.java