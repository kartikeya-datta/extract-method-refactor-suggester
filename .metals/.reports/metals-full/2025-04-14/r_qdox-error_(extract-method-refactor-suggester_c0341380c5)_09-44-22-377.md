error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3247.java
text:
```scala
i@@nt /*long*/ result = OS.CallWindowProc (ComboProc, hwnd, msg, wParam, lParam);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3247.java