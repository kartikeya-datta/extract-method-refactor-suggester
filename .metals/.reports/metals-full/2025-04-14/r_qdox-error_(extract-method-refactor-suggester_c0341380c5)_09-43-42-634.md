error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9967.java
...
```java
offset: 842
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9967.java
text:
```scala
...
p@@ackage org.elasticsearch.benchmark.checksum;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9967.java