error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7559.java
text:
```scala
S@@treams.copy(in, getWebResponse().getHttpServletResponse()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7559.java