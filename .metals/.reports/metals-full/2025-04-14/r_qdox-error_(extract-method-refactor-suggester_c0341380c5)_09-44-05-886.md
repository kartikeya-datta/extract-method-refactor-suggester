error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7587.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7587.java
text:
```scala
P@@ostingsFormatProvider postingsFormatProvider();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7587.java