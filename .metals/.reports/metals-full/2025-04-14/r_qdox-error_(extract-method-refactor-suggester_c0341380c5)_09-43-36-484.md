error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2562.java
text:
```scala
H@@eader header = folder.getHeaderFields(uid, new String[] {"To", "Cc"});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2562.java