error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2398.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2398.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2398.java
text:
```scala
public abstract v@@oid files(Directory dir, SegmentInfo segmentInfo, String segmentSuffix, Set<String> files) throws IOException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2398.java