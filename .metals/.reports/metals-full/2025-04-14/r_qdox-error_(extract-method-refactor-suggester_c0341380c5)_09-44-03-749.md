error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1938.java
text:
```scala
s@@uper("org.columba.addressbook.folder", "org/columba/addressbook/folder/folder.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1938.java