error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2073.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2073.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2073.java
text:
```scala
i@@f (index >= size) throw new IndexOutOfBoundsException("index can't be >= size: " + index + " >= " + size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2073.java