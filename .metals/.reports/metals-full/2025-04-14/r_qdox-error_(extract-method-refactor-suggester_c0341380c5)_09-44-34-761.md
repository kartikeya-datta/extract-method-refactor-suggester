error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10910.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10910.java
text:
```scala
r@@esponse.println("\"></script>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10910.java