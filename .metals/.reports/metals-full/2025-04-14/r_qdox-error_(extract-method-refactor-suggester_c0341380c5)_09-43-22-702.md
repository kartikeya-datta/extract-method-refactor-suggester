error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5701.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5701.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5701.java
text:
```scala
i@@f (itsInterfaces != NoSuperInterfaces && itsInterfaces != null) { // can be null while connecting hierarchies
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5701.java