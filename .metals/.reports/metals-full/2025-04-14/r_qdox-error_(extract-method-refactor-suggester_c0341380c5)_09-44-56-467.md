error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7906.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7906.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7906.java
text:
```scala
final C@@omment comment = (Comment)getModelObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7906.java