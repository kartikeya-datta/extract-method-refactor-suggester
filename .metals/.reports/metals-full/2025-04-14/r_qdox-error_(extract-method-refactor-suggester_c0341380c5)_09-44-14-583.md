error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7487.java
text:
```scala
S@@creenCaptureTest.class, InternationalFontsTest.class, BitmapFontTest.class, LabelScaleTest.class};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7487.java