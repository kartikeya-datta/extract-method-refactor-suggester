error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/740.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/740.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/740.java
text:
```scala
public v@@oid close() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/740.java