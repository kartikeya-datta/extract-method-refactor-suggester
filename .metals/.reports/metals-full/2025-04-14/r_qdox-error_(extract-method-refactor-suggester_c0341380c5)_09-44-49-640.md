error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2973.java
text:
```scala
i@@f (isFieldUseDeprecated(this.binding, scope, (this.bits & IsStrictlyAssigned) !=0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2973.java