error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3705.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3705.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3705.java
text:
```scala
I@@ndexRequestBuilder[] builders = new IndexRequestBuilder[scaledRandomIntBetween(50, 100)];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3705.java