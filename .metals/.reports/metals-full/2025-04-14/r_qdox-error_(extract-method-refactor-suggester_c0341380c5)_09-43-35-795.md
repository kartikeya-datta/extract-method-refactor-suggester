error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12895.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12895.java
text:
```scala
n@@ewControllers.add(JMSService.addService(serviceTarget, hqServiceName, overrideInVMSecurity, verificationHandler));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12895.java