error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3025.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3025.java
text:
```scala
final l@@ong t = attr.type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3025.java