error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1244.java
text:
```scala
p@@ublic static class AuthTestPage1 extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1244.java