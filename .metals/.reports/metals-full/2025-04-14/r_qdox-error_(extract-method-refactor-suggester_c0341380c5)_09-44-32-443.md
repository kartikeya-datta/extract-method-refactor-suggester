error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14198.java
text:
```scala
c@@atch( final Exception e )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14198.java