error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1814.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1814.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1814.java
text:
```scala
public static final S@@tring NAME = "cluster:admin/snapshot/status";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1814.java