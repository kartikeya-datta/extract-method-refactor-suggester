error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1357.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1357.java
text:
```scala
private i@@nt maximumAutoGrowSize;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1357.java