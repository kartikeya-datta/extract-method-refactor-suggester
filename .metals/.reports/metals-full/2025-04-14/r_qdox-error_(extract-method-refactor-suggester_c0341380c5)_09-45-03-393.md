error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4954.java
...
```java
offset: 1082
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4954.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.test.spec.ejb3.security.lifecycle;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4954.java