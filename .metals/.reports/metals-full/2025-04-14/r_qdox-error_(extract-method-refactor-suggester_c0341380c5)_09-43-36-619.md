error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5630.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5630.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5630.java
text:
```scala
private final L@@ogger log = Logger.getLogger(MailSessionAdd.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5630.java