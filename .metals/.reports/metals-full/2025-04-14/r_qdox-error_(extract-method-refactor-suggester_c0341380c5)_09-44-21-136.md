error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5215.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5215.java
text:
```scala
b@@ulkRequest.add(new DeleteRequest().setIndex(shardToPurge.routingEntry().index()).setType(docToPurge.type).setId(docToPurge.id).setVersion(docToPurge.version).setRouting(docToPurge.routing));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5215.java