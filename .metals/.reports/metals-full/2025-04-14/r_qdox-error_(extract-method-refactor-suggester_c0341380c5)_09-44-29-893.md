error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15162.java
text:
```scala
r@@egenerate = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15162.java