error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6420.java
text:
```scala
L@@OG.warn("Topology submission exception", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6420.java