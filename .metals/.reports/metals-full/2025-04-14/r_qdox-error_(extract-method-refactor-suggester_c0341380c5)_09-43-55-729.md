error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12894.java
text:
```scala
H@@TTPAcceptorAdd.INSTANCE.launchServices(context, hornetqServerName, acceptorName, model, null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12894.java