error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9194.java
text:
```scala
r@@eturn "Locator for " + this.pattern.toString(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9194.java