error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9870.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9870.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9870.java
text:
```scala
public M@@ap<String, ? extends Property> getProperties (ExecutionContext ctx) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9870.java