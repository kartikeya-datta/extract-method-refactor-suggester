error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8228.java
text:
```scala
l@@ogger.info("Connected to {}/{} blob store service", type, account);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8228.java