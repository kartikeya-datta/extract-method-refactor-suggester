error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5184.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5184.java
text:
```scala
i@@f (model instanceof ICompoundModel)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5184.java