error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/718.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/718.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/718.java
text:
```scala
r@@ootFolder = (IMAPRootFolder) ((IMAPFolder) folder).getRootFolder();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/718.java