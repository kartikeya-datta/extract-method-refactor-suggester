error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5355.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5355.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5355.java
text:
```scala
public b@@oolean process()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5355.java