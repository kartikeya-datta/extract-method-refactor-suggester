error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1831.java
text:
```scala
a@@ssertSQLFragnments(_sql, "CREATE TABLE XML_EMBAMAP_3 .*" +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1831.java