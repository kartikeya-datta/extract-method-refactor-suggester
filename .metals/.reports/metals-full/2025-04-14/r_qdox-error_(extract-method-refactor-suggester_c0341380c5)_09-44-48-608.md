error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14548.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14548.java
...
```java
offset: 24
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14548.java
text:
```scala
protected static final L@@ogger log = Logger.getLogger("org.jboss.as.management");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14548.java