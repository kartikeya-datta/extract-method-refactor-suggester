error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6853.java
text:
```scala
s@@etEnabled(true);	// *20030531, karlpeder* Print functionality reactivated
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6853.java