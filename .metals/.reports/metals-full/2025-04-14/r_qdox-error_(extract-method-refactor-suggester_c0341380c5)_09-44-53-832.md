error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17276.java
text:
```scala
f@@loat /*double*/ delta = nsEvent.deltaY();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17276.java