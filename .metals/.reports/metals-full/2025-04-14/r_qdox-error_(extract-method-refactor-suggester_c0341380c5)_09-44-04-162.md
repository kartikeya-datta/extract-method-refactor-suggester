error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1330.java
text:
```scala
T@@he internal identifier of a cached statement matches the toString() method of a PreparedStatement object for a Derby database.
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1330.java