error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1123.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1123.java
text:
```scala
final E@@xtensionRegistry extensionRegistry = new ExtensionRegistry(ProcessType.STANDALONE_SERVER, new RunningModeControl(RunningMode.ADMIN_ONLY));
...
*/
package org.jboss.as.test.smoke.subsystem.parse;
...
public class ParseAndMarshalModelsTestCase {
    ...
    public static Archive<?> getDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addPackage(ParseAndMarshalModelsTestCase.class.getPackage())
...
//        System.out.println(ops);
        ...
        final ModelController controller = createController(ProcessType.HOST_CONTROLLER, model, new Setup() {
            public void setup(Resource resource, ManagementResourceRegistration root) {
                ...
                //server paths
                // TODO verify this can be removed - it looks like nonsense
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1123.java