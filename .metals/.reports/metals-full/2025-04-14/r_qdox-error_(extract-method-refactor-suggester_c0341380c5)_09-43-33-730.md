error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10499.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10499.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10499.java
text:
```scala
final private M@@ultiClassLoader _loader = AccessController
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10499.java