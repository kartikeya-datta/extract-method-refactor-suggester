error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9250.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9250.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9250.java
text:
```scala
a@@ppendJavascript("Wicket.Focus.setFocusOnId('" + id + "');");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9250.java