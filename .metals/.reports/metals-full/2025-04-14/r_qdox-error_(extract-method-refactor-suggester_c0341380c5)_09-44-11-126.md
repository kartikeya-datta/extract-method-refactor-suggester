error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8527.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8527.java
text:
```scala
private static final S@@tring TAG = "OrganizationLoader";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8527.java