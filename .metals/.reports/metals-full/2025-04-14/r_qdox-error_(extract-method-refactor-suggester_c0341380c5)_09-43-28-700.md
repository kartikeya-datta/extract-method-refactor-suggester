error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8986.java
text:
```scala
s@@uper(layout.repo_list_item, inflater, elements);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8986.java