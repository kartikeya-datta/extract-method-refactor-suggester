error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/694.java
text:
```scala
I@@ClassFile classFile= ((IPackageFragment)fClassFile.getParent()).getClassFile(new String(ClassFile.unqualifiedName(binaryType.getName())) + ".class"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/694.java