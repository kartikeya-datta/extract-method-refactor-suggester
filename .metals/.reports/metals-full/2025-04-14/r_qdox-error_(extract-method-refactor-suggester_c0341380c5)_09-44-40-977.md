error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16686.java
...
```java
offset: 57
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16686.java
text:
```scala
public class BasicSAXParser implements IMarkupParser {

p@@ackage wicked.markup.parser;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16686.java