error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10642.java
text:
```scala
g@@etLogger().warn( "'searchpath' element ignored. 'unused' attribute is disabled." );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10642.java