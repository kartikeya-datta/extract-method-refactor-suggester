error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3616.java
text:
```scala
I@@nitialContext ctx = new InitialContext(getEjbClientProperties(System.getProperty("node0", "127.0.0.1"), 4447));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3616.java