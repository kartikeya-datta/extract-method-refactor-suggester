error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3249.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3249.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3249.java
text:
```scala
r@@eturn defaultFactory.newInstance(prefix == null ? null : prefix.intern(), name.intern());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3249.java