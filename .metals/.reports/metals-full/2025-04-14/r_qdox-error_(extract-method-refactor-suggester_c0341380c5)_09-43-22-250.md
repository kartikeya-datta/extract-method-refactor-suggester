error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7559.java
...
```java
offset: 36
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7559.java
text:
```scala
+ "] while using version_type [" + r@@equest.versionType() + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7559.java