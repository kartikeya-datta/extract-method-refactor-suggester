error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12699.java
text:
```scala
n@@ew HornetQReloadRequiredHandlers.RemoveStepHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12699.java