error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11252.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11252.java
text:
```scala
f@@or (ModuleDependency dependency : moduleSpec.getSystemDependencies()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11252.java