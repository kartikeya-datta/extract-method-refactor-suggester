error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17923.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17923.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17923.java
text:
```scala
static final b@@oolean DEBUG = Device.DEBUG;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17923.java