error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6736.java
text:
```scala
P@@latformMBeanUtil.getResolver(PlatformMBeanConstants.BUFFER_POOL));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6736.java