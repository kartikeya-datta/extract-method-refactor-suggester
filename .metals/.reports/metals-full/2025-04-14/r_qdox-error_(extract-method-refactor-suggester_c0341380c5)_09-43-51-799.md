error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16336.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16336.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16336.java
text:
```scala
r@@enderItem(listItem, i == (size - 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16336.java