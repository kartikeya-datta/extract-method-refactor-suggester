error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7804.java
text:
```scala
i@@f (termsEnum.seekExact(term)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7804.java