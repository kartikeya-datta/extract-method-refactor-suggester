error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14749.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14749.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14749.java
text:
```scala
R@@eferenceTypeDelegate bootstrapLoaderDelegate = resolveReflectionTypeDelegate(ty, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14749.java