error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2344.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2344.java
text:
```scala
public v@@oid shiftBias(double factor) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2344.java