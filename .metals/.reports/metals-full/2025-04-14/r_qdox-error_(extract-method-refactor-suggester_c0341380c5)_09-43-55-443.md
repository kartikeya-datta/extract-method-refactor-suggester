error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5140.java
text:
```scala
r@@eturn Integer.parseInt(android.os.Build.VERSION.SDK);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5140.java