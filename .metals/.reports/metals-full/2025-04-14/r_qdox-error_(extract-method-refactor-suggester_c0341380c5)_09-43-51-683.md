error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15981.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15981.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15981.java
text:
```scala
s@@b.append(startLine); //"" + startLine + "-" + endLine);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15981.java