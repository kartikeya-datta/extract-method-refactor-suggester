error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3166.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3166.java
text:
```scala
final S@@tring word = parameters.getString("word");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3166.java