error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1000.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1000.java
text:
```scala
public synchronized i@@nt getMaxPermits() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1000.java