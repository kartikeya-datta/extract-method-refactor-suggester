error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4617.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4617.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4617.java
text:
```scala
c@@urrent.replaceAttibuteValue(this, tag);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4617.java