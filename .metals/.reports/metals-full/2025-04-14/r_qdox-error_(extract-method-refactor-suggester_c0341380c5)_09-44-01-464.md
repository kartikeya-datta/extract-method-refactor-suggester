error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10010.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10010.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10010.java
text:
```scala
l@@ink.setBody(Model.of(linkBody));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10010.java