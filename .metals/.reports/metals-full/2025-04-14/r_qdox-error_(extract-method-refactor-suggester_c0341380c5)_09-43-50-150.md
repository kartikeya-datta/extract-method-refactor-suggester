error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11781.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11781.java
text:
```scala
public H@@ostSystemPropertyUpdate getCompensatingUpdate(final HostModel original) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11781.java