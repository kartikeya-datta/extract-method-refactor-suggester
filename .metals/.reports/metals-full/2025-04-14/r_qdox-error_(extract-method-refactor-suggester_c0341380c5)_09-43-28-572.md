error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4042.java
text:
```scala
r@@eturn false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4042.java