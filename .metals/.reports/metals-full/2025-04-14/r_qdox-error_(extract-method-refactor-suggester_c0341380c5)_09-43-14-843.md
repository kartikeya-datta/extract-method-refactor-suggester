error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3051.java
text:
```scala
b@@uilder.addDependency(Services.FRAMEWORK_ACTIVATOR);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3051.java