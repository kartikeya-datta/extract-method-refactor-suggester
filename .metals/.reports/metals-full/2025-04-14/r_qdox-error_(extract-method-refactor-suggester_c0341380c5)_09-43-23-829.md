error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8793.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8793.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8793.java
text:
```scala
I@@SourceLocation loc = message.getSourceLocation();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8793.java