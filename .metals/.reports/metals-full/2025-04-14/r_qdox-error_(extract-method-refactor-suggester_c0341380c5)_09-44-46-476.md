error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3344.java
text:
```scala
p@@ublic interface IRequestEncoder extends IRequestTargetMounter
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3344.java