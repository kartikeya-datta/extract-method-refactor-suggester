error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3038.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3038.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3038.java
text:
```scala
r@@eturn "from_contains";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3038.java