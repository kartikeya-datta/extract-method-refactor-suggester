error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4087.java
text:
```scala
c@@onfig.useGL20 = useGL2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4087.java