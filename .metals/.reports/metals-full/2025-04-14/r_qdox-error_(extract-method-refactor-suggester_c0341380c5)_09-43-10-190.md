error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4786.java
text:
```scala
p@@atterns = patterns.resolveBindings(scope, Bindings.NONE, false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4786.java