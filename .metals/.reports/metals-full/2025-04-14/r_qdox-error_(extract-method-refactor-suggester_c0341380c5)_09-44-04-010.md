error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6274.java
text:
```scala
s@@ignature.setKeyName(tKeyName.getText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6274.java