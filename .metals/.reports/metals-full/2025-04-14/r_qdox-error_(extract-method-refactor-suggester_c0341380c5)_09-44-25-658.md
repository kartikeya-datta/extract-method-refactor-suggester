error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6902.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6902.java
text:
```scala
public P@@ageView(MarkupContainer parent,final String id, final Page page)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6902.java