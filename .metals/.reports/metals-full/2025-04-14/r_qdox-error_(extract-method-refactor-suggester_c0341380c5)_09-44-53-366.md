error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12756.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12756.java
text:
```scala
final B@@atchServiceBuilder<ThreadFactory> builder = batchBuilder.addService(ThreadsServices.threadFactoryName(name), service);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12756.java