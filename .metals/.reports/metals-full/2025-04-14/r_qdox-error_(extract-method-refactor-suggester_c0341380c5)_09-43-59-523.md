error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/73.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/73.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/73.java
text:
```scala
k@@rbServer1 = KDCServerAnnotationProcessor.getKdcServer(directoryService1, KERBEROS_PORT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/73.java