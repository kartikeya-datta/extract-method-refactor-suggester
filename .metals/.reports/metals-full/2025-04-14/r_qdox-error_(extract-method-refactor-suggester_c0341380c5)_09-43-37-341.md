error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2278.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2278.java
text:
```scala
L@@abel label = new Label(componentId, model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2278.java