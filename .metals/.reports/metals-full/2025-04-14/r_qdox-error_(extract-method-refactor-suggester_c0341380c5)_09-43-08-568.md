error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11126.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11126.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11126.java
text:
```scala
S@@ystem.out.println("RosterSharedObject.handleMessage(" + message + ")");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11126.java