error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16777.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16777.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16777.java
text:
```scala
O@@bject convert( Class destination, Object original, ConverterContext context )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16777.java