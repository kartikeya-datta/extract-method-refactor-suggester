error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9227.java
text:
```scala
t@@his(text, skin.get(CheckBoxStyle.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9227.java