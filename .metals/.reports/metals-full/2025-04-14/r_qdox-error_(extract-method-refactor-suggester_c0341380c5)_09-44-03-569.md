error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16385.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16385.java
text:
```scala
p@@ublic interface ICoverterLocatorFactory
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16385.java