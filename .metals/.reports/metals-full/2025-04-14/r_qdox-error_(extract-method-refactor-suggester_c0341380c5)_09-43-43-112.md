error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8034.java
text:
```scala
S@@tring ANNOTATION_PROPERTY_REPLACEMENT = "annotation-property-replacement";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8034.java