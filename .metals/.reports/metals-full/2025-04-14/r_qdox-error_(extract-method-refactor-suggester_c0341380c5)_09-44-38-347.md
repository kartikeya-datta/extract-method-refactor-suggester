error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12403.java
text:
```scala
I@@NestedModelContainer wrapOnAssignment(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12403.java