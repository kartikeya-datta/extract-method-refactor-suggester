error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5050.java
text:
```scala
e@@xecuteTest(HeaderSectionPage_4.class, "HeaderSectionPageExpectedResult_4.html");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5050.java