error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6393.java
text:
```scala
s@@tartActivity(ViewGistActivity.createIntent(gist));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6393.java