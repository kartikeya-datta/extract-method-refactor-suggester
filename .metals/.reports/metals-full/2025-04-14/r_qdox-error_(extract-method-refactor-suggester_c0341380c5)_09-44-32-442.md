error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9451.java
text:
```scala
r@@eturn liveDocs == null || liveDocs.get(doc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9451.java