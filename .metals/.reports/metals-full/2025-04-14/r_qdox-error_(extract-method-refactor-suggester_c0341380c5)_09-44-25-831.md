error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1477.java
text:
```scala
O@@bject postProcessBeforeInstantiation(Class<?> beanClass, String beanName) throws BeansException;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1477.java