error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1003.java
text:
```scala
e@@xpression.traverse(this, (BlockScope) null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1003.java