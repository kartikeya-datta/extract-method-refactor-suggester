error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7310.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7310.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7310.java
text:
```scala
v@@alues = new ArrayList<>(2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7310.java