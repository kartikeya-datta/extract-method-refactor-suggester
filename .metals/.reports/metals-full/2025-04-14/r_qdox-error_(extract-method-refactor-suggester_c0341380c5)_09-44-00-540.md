error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15283.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15283.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15283.java
text:
```scala
s@@uper(RESOURCE_PATH, HostResolver.getResolver("host.env"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15283.java