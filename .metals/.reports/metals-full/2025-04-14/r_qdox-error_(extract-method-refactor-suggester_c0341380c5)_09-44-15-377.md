error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5635.java
text:
```scala
r@@eturn (registration != null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5635.java