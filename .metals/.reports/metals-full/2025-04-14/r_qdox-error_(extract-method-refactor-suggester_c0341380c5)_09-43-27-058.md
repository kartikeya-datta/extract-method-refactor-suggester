error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7307.java
...
```java
offset: 35
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7307.java
text:
```scala
"', wicketSerialize(Wicket.$('" + g@@etComponent().getMarkupId()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7307.java