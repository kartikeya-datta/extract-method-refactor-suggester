error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7370.java
text:
```scala
r@@eturn TransformationTargetImpl.create(registry, version, Collections.<PathAddress, ModelVersion>emptyMap(), null, TransformationTarget.TransformationTargetType.HOST);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7370.java