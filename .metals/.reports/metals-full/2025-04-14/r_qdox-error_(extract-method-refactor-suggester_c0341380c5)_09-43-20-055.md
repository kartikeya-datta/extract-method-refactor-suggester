error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12229.java
text:
```scala
i@@f (getFlag(FLAG_OUTPUT_MARKUP_ID) && !tag.getAttributes().containsKey(MARKUP_ID_ATTR_NAME))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12229.java