error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13233.java
text:
```scala
N@@SScrollView scrollWidget = (NSScrollView)new SWTScrollView().alloc();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13233.java