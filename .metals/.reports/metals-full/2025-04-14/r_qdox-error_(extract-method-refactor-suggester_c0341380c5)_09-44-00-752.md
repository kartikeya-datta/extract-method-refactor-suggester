error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15247.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15247.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15247.java
text:
```scala
i@@f(controller != null && controller.getState() == ServiceController.State.UP) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15247.java