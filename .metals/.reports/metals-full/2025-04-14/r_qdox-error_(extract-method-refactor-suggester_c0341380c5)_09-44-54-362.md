error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11273.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11273.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11273.java
text:
```scala
S@@tate s = n.stateInfo.spec.stateFactory.makeState(conf, context.getThisTaskIndex(), thisComponentNumTasks);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11273.java