error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15829.java
text:
```scala
r@@eturn new RolesSession(this, request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15829.java