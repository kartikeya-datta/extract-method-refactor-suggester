error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14580.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14580.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14580.java
text:
```scala
r@@eturn MediaType.SPECIFICITY_COMPARATOR.compare(acceptType, produceType) <= 0 ? acceptType : produceType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14580.java