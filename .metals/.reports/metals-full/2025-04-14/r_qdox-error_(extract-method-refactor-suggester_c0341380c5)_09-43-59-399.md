error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5685.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5685.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5685.java
text:
```scala
i@@njectionPointStore.addInjectedValue(injectionTarget, resourceValue, bindingServiceName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5685.java