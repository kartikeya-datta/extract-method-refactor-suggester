error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7839.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7839.java
text:
```scala
public S@@electionParser(ProblemReporter problemReporter, long sourceLevel) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7839.java