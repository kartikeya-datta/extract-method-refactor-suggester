error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15968.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15968.java
text:
```scala
private final L@@ist changes = new ArrayList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15968.java