error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6970.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6970.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6970.java
text:
```scala
a@@dd(new BookmarkablePageLink(this, "customLoadingPageLink", PageWithCustomLoading.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6970.java