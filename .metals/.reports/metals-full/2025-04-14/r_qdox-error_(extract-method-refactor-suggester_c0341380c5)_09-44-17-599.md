error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16726.java
text:
```scala
v@@oid setBackgroundPixmap (int /*long*/ pixmap) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16726.java