error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7341.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7341.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7341.java
text:
```scala
private I@@Status fCurrStatus = new Status(IStatus.OK, PlatformUI.PLUGIN_ID, 0, "", null); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7341.java