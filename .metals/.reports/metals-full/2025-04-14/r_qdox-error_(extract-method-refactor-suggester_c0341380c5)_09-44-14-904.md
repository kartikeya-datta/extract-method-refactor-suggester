error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/455.java
text:
```scala
l@@ogFile = FILE_UTILS.createTempFile("spawn","log", project.getBaseDir(), false, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/455.java