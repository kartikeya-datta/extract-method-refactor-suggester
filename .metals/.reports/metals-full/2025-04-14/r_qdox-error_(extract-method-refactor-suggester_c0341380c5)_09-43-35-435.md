error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2455.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2455.java
text:
```scala
final b@@yte anotherVal = other.value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2455.java