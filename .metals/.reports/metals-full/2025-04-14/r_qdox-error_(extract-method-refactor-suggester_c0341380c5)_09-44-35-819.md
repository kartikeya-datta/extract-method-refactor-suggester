error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10166.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10166.java
text:
```scala
final P@@ersistenceUnitServiceImpl service = new PersistenceUnitServiceImpl(classLoader, pu, adaptor, provider, PersistenceUnitRegistryImpl.INSTANCE, deploymentUnit.getServiceName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10166.java