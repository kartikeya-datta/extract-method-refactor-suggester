error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7162.java
text:
```scala
i@@f (isVirtualInvoke(method, messageSend) && !(messageSend.actualReceiverType instanceof ArrayBinding)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7162.java