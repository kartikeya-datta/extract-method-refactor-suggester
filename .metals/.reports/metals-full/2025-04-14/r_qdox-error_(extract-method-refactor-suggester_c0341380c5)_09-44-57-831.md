error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9461.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9461.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9461.java
text:
```scala
i@@f (list == null || list.getParent() == null) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9461.java