error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13049.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13049.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13049.java
text:
```scala
e@@lse if (this.optionSource instanceof Class && ((Class) this.optionSource).isEnum()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13049.java