error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9541.java
text:
```scala
i@@nt numVertices, int vstride, int wstride)/*-{ }-*/; /*
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9541.java