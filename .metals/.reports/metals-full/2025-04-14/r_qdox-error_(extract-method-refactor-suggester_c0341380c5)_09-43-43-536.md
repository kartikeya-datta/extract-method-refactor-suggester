error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6693.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6693.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6693.java
text:
```scala
s@@uper(pageSize, null, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6693.java