error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/834.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/834.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/834.java
text:
```scala
M@@ethod mMul = ClassReflection.getMethod(Vector2.class, "mul", float.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/834.java