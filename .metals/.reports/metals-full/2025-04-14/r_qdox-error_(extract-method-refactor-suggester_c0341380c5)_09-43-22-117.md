error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3656.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3656.java
text:
```scala
public v@@oid initToolBar() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3656.java