error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12067.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12067.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12067.java
text:
```scala
final C@@harSequence url = getCallbackUrl(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12067.java