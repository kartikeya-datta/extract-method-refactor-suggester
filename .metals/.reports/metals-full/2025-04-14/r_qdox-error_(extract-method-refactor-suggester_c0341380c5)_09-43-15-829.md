error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10943.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10943.java
text:
```scala
S@@tringBuilder buf = new StringBuilder(20 * (trackers.length + 1));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10943.java