error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13279.java
text:
```scala
r@@eturn iValue == object;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13279.java