error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14535.java
text:
```scala
T@@hread thread = new Thread(receiver, Thread.currentThread().getName()+"-JMS-Receiver");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14535.java