error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13006.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13006.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13006.java
text:
```scala
b@@uilder.addListener(new AbstractResourceAdapterDeploymentServiceListener(registration, deploymentUnit.getName(), deploymentResource, bootstrapCtx, deploymentUnit.getName()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13006.java