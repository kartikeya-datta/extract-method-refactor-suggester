error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16647.java
text:
```scala
N@@SAttributedString attribStr = createString(text, null, foreground, style, (style & SWT.WRAP) != 0, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16647.java