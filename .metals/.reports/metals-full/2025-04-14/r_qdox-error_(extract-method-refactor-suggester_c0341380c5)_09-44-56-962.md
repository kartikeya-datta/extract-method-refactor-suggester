error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13910.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13910.java
text:
```scala
s@@b.append("yuiloader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13910.java