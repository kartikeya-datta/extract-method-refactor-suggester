error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2337.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2337.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2337.java
text:
```scala
i@@nt index = (point.y - getHeaderHeight ()) / itemHeight + topIndex;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2337.java