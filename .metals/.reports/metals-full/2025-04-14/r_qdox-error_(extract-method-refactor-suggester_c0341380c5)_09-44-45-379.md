error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13441.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13441.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13441.java
text:
```scala
w@@hile (reader.hasNext() && reader.nextTag() != END_ELEMENT) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13441.java