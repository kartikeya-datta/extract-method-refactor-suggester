error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11268.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11268.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11268.java
text:
```scala
a@@dd(new Panel1("panel1"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11268.java