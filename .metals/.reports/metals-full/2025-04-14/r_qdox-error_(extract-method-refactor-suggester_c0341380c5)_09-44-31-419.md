error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12965.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12965.java
text:
```scala
private final W@@ebSocketHandler webSocketHandler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12965.java