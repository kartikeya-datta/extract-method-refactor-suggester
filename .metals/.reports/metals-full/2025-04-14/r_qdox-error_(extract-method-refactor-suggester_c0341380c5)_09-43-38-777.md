error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/759.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/759.java
text:
```scala
private static S@@tring d_columnTimestamp_  = "COLUMN_TIMESTAMP";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/759.java