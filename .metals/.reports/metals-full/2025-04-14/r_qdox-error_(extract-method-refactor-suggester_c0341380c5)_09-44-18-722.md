error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2571.java
text:
```scala
s@@uper(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2571.java