error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9797.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9797.java
text:
```scala
public static final i@@nt DEPENDENCIES_JPA = 0x1000;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9797.java