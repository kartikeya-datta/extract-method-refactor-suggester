error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13308.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13308.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13308.java
text:
```scala
r@@eturn createApplication((additionalContext != null) ? additionalContext : ac, beanName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13308.java