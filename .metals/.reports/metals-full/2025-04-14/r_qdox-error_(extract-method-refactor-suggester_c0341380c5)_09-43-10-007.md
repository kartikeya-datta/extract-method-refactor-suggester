error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15934.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15934.java
text:
```scala
private final O@@bject[] array;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15934.java