error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2358.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2358.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2358.java
text:
```scala
s@@entList.add(message.getHeader().get("columba.uid"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2358.java