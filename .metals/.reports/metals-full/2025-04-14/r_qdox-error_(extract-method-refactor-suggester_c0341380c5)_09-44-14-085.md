error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4407.java
text:
```scala
S@@ystem.setProperty("Wicket_HeaderRenderStrategy", "");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4407.java