error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17242.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17242.java
text:
```scala
public static final S@@tring COMPILER_NAME = "weblogic";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17242.java