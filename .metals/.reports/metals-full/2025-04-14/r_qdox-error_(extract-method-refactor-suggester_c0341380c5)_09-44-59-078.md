error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10775.java
text:
```scala
i@@f (!ccevent.getTargetID().equals(getConnectedID())) sendHelloMessage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10775.java