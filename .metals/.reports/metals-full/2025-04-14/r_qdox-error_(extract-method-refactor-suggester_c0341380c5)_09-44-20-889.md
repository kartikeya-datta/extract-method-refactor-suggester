error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2574.java
text:
```scala
d@@ir.mul(-1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2574.java