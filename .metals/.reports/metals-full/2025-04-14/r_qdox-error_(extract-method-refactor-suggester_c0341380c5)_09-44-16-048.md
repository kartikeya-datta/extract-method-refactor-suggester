error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/751.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/751.java
text:
```scala
public D@@atatype getDatatype() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/751.java