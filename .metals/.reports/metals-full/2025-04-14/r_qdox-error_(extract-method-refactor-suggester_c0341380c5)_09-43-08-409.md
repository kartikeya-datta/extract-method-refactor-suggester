error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5013.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5013.java
text:
```scala
final N@@amingStoreService contextService = new NamingStoreService(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5013.java