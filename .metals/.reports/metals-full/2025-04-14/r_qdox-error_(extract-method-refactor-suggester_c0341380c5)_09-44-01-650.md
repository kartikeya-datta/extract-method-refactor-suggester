error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2975.java
text:
```scala
c@@olors [SWT.COLOR_WIDGET_HIGHLIGHT_SHADOW] = Color.wpf_new (this, OS.SystemColors_ControlLightLightColor ());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2975.java