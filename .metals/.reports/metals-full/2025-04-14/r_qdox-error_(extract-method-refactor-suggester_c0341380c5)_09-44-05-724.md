error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3971.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3971.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3971.java
text:
```scala
public S@@tatusLineManager getStatusLineManager() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3971.java