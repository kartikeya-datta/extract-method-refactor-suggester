error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9188.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9188.java
text:
```scala
t@@his.values = new String[variableNames.length];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9188.java