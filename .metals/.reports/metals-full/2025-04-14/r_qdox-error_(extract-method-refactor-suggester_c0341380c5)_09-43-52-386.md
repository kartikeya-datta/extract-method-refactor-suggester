error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13780.java
text:
```scala
S@@erviceName serviceName = DataSourceConfigService.SERVICE_NAME_BASE.append(jndiName).append("connetion-properties").append(configPropertyName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13780.java