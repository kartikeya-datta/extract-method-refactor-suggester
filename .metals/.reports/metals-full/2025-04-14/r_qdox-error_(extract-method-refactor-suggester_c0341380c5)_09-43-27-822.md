error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/13.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/13.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/13.java
text:
```scala
public static final S@@tring TOMCAT_VERSION = "3.3.2 Final";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/13.java