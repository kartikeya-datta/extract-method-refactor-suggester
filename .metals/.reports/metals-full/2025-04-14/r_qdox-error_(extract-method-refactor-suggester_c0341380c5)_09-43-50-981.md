error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/320.java
text:
```scala
l@@og.info("LDA Iteration {}", iteration);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/320.java