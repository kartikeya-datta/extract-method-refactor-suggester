error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15988.java
text:
```scala
_@@last = UUIDGenerator.nextString(UUIDGenerator.TYPE1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15988.java