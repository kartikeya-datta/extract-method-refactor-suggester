error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14956.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14956.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14956.java
text:
```scala
u@@rlProperty = new URL("http://wicket.apache.org");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14956.java