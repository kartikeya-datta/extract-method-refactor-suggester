error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5085.java
text:
```scala
r@@eturn readResource("undertow-2.0.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5085.java