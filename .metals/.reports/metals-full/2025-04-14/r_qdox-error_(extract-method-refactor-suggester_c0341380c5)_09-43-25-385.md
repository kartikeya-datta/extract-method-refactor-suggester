error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3380.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3380.java
text:
```scala
final I@@nteger position = map.put(obj, Integer.valueOf(counter++));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3380.java