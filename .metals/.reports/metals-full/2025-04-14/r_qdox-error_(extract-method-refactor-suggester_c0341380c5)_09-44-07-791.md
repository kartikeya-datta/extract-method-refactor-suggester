error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6799.java
text:
```scala
i@@f ((cacheKey != null) && cache.containsKey(cacheKey))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6799.java