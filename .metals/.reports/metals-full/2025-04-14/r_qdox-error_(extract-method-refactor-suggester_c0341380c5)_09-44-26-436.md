error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14551.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14551.java
text:
```scala
private C@@lass<?> type;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14551.java