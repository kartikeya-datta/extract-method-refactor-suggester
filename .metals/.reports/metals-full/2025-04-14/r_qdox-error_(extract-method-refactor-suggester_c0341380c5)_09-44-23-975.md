error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5498.java
text:
```scala
p@@rocessorDefinition.getPropertyValues().add("executor", executor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5498.java