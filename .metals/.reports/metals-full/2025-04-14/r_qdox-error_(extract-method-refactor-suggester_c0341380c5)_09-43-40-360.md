error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9636.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9636.java
text:
```scala
p@@rintCommands = commands.isPresent(ctx.getParsedCommandLine());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9636.java