error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7081.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7081.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7081.java
text:
```scala
p@@ublic interface ITestPanelSource extends IClusterable
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7081.java