error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4183.java
text:
```scala
p@@rintFixableError(mirror.getPosition(), JAXWSCoreMessages
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4183.java