error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8285.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8285.java
text:
```scala
S@@treamOutput stream = cachedEntry.handles(CompressorFactory.defaultCompressor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8285.java