error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3915.java
text:
```scala
e@@rrors.assertEmpty();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3915.java