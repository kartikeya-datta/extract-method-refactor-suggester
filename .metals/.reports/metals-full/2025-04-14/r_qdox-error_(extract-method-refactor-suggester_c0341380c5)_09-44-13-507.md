error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3711.java
text:
```scala
r@@eturn MVEL.compileExpression(script.trim(), new ParserContext(parserConfiguration));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3711.java