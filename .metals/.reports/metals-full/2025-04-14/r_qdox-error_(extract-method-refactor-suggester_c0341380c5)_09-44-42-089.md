error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6462.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6462.java
text:
```scala
private static L@@og logger = LogFactory.getLog(ResponseBodyAdviceChain.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6462.java