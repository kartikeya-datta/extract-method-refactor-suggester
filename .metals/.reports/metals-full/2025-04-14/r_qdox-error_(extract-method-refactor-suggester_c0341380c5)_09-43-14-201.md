error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11631.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11631.java
text:
```scala
private S@@tring fileDirParameter = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11631.java