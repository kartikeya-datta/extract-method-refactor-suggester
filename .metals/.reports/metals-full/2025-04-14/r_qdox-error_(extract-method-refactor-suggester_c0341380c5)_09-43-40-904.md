error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6465.java
text:
```scala
w@@riter.write(header + "\n" + content);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6465.java