error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10070.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10070.java
text:
```scala
final C@@mpEntityBeanContext entityContext = cmpInstance.getEjbContext();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10070.java