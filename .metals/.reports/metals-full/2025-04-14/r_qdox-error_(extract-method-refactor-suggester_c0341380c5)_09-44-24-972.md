error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/227.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/227.java
text:
```scala
t@@his.defaultLang = settings.get(DEFAULT_SCRIPTING_LANGUAGE_SETTING, "groovy");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/227.java