error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6506.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6506.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6506.java
text:
```scala
i@@f (page != 0 && (page < 0 || (page >= getPageCount() && getPageCount() > 0)))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6506.java