error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4756.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4756.java
text:
```scala
m@@appingsToUpdate.add(Tuple.tuple(indexRequest.index(), indexRequest.type()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4756.java