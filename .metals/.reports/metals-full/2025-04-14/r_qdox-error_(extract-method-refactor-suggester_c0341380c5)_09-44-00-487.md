error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9941.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9941.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9941.java
text:
```scala
i@@f (!OS.HIVIEW) parent.update (true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9941.java