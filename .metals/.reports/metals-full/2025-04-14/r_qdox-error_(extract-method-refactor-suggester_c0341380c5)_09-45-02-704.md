error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/911.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/911.java
text:
```scala
a@@ssertEquals(",\"origins\":[\"*:*\"],\"cookie_needed\":false,\"websocket\":true}",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/911.java