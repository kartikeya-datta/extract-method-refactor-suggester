error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8526.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8526.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8526.java
text:
```scala
i@@terateAssertCount(numShards, indexCounter.get(), 10);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8526.java