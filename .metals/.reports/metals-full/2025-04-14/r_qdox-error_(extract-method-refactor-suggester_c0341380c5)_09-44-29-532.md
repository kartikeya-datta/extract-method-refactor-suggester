error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6508.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6508.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6508.java
text:
```scala
b@@uilder.dateTimeFormatter(parseDateTimeFormatter(propNode));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6508.java