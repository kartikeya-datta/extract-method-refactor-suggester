error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2581.java
text:
```scala
t@@his.typeBinding = this.environment.createRawType((ReferenceBinding) this.typeBinding, this.typeBinding.enclosingType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2581.java