error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10076.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10076.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10076.java
text:
```scala
c@@har[][] previousIdentifiers = CharOperation.splitOn('.', typeName, 0, dot);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10076.java