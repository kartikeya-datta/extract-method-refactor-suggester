error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18214.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18214.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18214.java
text:
```scala
q@@uery = "SELECT c FROM LockEmployee c WHERE c.id = :id", lockMode = LockModeType.PESSIMISTIC_WRITE),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18214.java