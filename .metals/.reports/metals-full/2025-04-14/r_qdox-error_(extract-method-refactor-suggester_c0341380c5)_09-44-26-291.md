error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15168.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15168.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15168.java
text:
```scala
transient private F@@ilter filter;
      ...
      if (PARSER == null)
      {
         try
         {
                  ...
                  && this.getParserClassName().length() > 0)
            {
               ...
               {
                  PARSER = (LogParser) Class.forName(getParserClassName())
                        .newInstance();
   ...
   protected void initFilter()
   {
      if (filter == null && filterClassName != null)
      {
         ...
         catch (Exception e)
         {
            log
                  .warn(
                        "Couldn't instantiate filter '" + filterClassName + "'",
                        e);
         }
      }
   }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15168.java