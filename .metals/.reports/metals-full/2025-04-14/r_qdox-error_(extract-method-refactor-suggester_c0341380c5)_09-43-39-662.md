error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4620.java
text:
```scala
S@@tring template = Streams.copyToStringFromClasspath("/org/elasticsearch/indices/template/template" + randomInt(2) + ".json");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4620.java