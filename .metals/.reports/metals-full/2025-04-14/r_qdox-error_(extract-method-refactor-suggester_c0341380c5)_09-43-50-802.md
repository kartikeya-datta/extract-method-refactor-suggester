error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3182.java
...
```java
offset: 1037
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3182.java
text:
```scala
...
p@@ackage org.jboss.as.iiop.openjdk;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3182.java