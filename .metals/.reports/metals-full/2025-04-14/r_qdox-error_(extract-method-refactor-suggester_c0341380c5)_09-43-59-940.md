error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7402.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7402.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7402.java
text:
```scala
q@@ueryCollectors = new ArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7402.java