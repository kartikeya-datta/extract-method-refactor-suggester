error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1353.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1353.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1353.java
text:
```scala
c@@hannel.sendResponse(new StringRestResponse(INTERNAL_SERVER_ERROR));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1353.java