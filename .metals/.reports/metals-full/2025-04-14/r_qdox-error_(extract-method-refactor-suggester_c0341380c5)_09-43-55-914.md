error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4294.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4294.java
text:
```scala
synchronized (@@this) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4294.java