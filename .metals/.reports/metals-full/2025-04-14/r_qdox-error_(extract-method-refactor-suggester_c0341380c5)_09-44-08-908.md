error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9861.java
text:
```scala
i@@f (!(0 <= index && index < columnCount)) error (SWT.ERROR_INVALID_RANGE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9861.java