error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2192.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2192.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2192.java
text:
```scala
P@@ath input = new Path(this.getClass().getResource("/wdbc/").getPath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2192.java