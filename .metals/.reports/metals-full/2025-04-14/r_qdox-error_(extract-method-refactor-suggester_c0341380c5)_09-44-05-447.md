error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1774.java
text:
```scala
r@@enderComponentTag(markupStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1774.java