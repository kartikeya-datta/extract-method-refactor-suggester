error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/897.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/897.java
...
```java
offset: 778
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/897.java
text:
```scala
...
//
//All Rights Reserved.
p@@ackage org.columba.mail.gui.attachment;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/897.java