error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12386.java
text:
```scala
r@@eturn object == this || decorated().equals(object);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12386.java