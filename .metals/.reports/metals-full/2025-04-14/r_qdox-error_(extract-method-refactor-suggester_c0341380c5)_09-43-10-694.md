error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6500.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6500.java
text:
```scala
private final S@@tring contextPath;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6500.java