error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14551.java
text:
```scala
c@@tx.printColumns(Util.getDeployments(client));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14551.java