error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7549.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7549.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7549.java
text:
```scala
w@@hile (immutableCluster().size() != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7549.java