error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3928.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3928.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3928.java
text:
```scala
public W@@izardPage(final Class wizardClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3928.java