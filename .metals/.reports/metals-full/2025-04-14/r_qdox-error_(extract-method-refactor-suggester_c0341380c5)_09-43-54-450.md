error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2124.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2124.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2124.java
text:
```scala
r@@eturn this.environment.createRawType(originalParameterizedType.type, originalParameterizedType.enclosingType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2124.java