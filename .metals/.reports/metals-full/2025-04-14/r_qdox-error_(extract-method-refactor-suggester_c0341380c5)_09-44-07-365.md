error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1747.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1747.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1747.java
text:
```scala
i@@f (!couldHoldIncluded(path) || contentsExcluded(path)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1747.java