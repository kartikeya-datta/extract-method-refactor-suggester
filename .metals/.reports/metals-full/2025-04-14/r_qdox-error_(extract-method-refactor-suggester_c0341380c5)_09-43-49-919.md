error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10412.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10412.java
text:
```scala
q@@uery = new ChildrenConstantScoreQuery(innerQuery, parentType, childType, parentFilter, shortCircuitParentDocSet);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10412.java