error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5880.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5880.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5880.java
text:
```scala
r@@eturn constr.newInstance(new Object[] { Boolean.FALSE});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5880.java