error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8779.java
text:
```scala
i@@f (nextStart > start + 1) nextStart--;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8779.java