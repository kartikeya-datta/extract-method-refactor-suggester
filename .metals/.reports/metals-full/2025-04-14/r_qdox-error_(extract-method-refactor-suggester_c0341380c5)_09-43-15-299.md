error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2646.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2646.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2646.java
text:
```scala
t@@hrow MESSAGES.cannotCreateBundleDeployment(ex, deploymentUnit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2646.java