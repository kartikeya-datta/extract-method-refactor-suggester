error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5442.java
text:
```scala
r@@eturn SynchronizedSortedSet.synchronizedSortedSet(new TreeSet<E>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5442.java