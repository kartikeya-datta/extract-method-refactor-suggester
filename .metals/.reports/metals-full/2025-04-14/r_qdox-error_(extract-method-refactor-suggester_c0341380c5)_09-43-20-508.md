error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15817.java
text:
```scala
m@@etaData = (metaDataArray.length > 1) ? metaDataArray : metaDataArray[0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15817.java