error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6561.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6561.java
text:
```scala
c@@ontrol._getAccessible().addRelation(ACC.RELATION_LABELLED_BY, _getAccessible());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6561.java