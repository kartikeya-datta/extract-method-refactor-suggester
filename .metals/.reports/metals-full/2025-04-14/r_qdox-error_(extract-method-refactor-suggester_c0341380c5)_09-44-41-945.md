error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4779.java
text:
```scala
I@@WorkbenchGraphicConstants.IMG_ETOOL_DEF_PERSPECTIVE_HOVER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4779.java