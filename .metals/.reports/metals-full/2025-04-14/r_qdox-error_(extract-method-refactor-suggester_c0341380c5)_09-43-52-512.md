error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1532.java
text:
```scala
w@@ait(1000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1532.java