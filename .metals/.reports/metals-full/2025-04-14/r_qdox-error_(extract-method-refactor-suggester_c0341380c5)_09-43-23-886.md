error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3988.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3988.java
text:
```scala
final M@@odelNodeRegistration deployments = root.registerSubModel(PathElement.pathElement(DEPLOYMENT), DomainDescriptionProviders.DEPLOYMENT_PROVIDER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3988.java