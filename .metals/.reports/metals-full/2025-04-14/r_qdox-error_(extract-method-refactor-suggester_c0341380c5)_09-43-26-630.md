error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2529.java
text:
```scala
s@@tages.put(RESPONSE_STAGE, multiThreadedStage("RESPONSE-STAGE", Runtime.getRuntime().availableProcessors()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2529.java