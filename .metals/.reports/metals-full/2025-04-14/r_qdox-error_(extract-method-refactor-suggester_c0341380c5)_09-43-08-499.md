error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2545.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2545.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2545.java
text:
```scala
i@@f (page <= endPage && paintY > clientArea.y) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2545.java