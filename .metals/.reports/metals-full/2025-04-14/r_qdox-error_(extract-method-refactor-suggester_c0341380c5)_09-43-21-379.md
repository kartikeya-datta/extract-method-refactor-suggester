error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6385.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6385.java
text:
```scala
public v@@oid addFilter(final Filter newFilter) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6385.java