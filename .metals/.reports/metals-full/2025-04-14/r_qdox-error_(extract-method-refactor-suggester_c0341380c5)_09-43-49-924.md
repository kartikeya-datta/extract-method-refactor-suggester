error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4317.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4317.java
text:
```scala
v@@erifySameTokens(XContentFactory.xContent(XContentType.JSON).createParser(jsonOs.bytes().toBytes()), XContentFactory.xContent(XContentType.SMILE).createParser(xsonOs.bytes().toBytes()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4317.java