error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12373.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12373.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12373.java
text:
```scala
a@@pplication.getServletRequest().setRequestToRedirectString(behavior.getCallbackUrl(false).toString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12373.java