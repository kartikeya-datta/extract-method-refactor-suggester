error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1360.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1360.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1360.java
text:
```scala
s@@etCaretOffset(ime.getCaretOffset(), SWT.DEFAULT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1360.java