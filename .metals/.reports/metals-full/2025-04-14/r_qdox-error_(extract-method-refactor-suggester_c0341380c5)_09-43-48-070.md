error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3152.java
text:
```scala
i@@f(_prepareWasCalled && !"local".equals(stormConf.get(Config.STORM_CLUSTER_MODE))) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3152.java