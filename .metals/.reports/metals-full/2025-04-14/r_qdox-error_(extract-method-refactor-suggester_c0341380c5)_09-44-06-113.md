error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2613.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2613.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2613.java
text:
```scala
r@@eturn new Lucene41PostingsReader(state.directory, state.fieldInfos, state.segmentInfo, state.context, state.segmentSuffix);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2613.java