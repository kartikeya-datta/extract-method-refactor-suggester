error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13407.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13407.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13407.java
text:
```scala
m@@essage = msg;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13407.java