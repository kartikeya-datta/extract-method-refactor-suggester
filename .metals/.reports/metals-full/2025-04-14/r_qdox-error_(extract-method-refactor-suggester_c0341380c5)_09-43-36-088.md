error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15181.java
text:
```scala
d@@isplay.lastAscii = (int)/*64*/wParam;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15181.java