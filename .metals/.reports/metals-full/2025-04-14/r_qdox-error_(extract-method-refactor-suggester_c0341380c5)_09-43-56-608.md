error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3087.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3087.java
text:
```scala
public static final P@@athElement STORE_PROPERTY_PATH = PathElement.pathElement(ModelKeys.PROPERTY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3087.java