error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11167.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11167.java
text:
```scala
static i@@nt MINOR_VERSION = 444;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11167.java