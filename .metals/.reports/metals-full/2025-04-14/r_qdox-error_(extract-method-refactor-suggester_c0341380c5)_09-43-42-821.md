error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2404.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2404.java
text:
```scala
a@@pplication.setHomePage(PagedTableNavigatorPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2404.java