error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18025.java
text:
```scala
r@@eturn ((_flags & FLAG_EMBED_DEREF) == 0 ? false : true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18025.java