error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10064.java
text:
```scala
i@@f ((style & SWT.HIDE_SELECTION) == 0 || hasFocus ()) {
			...
			if (itemCount != 0) {
				...
				if (columnCount == 0) {
					...
					for (int i = 0; i < columnCount; i++) {
						if ((rc = OS.GetDataBrowserItemPartBounds (handle, itemCount, columns [i].id, OS.kDataBrowserPropertyEnclosingPart, itemRect)) == OS.noErr) {
							break;						
						}
					}
				}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10064.java