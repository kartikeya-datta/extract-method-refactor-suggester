error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12943.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12943.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12943.java
text:
```scala
r@@eturn new Well512a(101);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12943.java