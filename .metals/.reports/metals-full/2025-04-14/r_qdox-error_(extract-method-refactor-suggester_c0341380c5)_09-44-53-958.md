error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8639.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8639.java
text:
```scala
final D@@estination destination = (Destination) ctx.lookup("java:jboss/queue/test");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8639.java