error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9961.java
text:
```scala
l@@ong collectionTime = currentJvmStats.gc().collectionTime().millis() - lastJvmStats.gc().collectionTime().millis();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9961.java