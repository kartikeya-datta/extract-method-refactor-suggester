error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11804.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11804.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11804.java
text:
```scala
i@@f (context.isRollbackOnRuntimeFailure()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11804.java