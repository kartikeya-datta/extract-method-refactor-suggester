error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7362.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7362.java
...
```java
offset: 697
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7362.java
text:
```scala
...
p@@ackage org.apache.log4j.pattern;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7362.java