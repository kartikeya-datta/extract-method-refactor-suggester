error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7386.java
text:
```scala
L@@ist<InternalFullHistogramFacet.FullEntry> fullEntries = new ArrayList<>(entries.v().size());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7386.java