error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9669.java
text:
```scala
l@@ock.close();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9669.java