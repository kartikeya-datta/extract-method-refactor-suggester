error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1472.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1472.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1472.java
text:
```scala
i@@f (state.blocks().hasGlobalBlock(discoveryService.getNoMasterBlock())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1472.java