error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3163.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3163.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3163.java
text:
```scala
s@@crollId = request.content().toUtf8();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3163.java