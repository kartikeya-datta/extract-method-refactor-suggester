error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1535.java
text:
```scala
r@@eturn operationCounter.get();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1535.java