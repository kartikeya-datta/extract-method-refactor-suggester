error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14576.java
text:
```scala
O@@S.HIViewConvertPoint (pt, OS.HIViewGetSuperview (handle), contentView [0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14576.java