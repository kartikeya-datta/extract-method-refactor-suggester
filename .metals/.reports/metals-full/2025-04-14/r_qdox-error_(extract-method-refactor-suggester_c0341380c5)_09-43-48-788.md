error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15291.java
text:
```scala
r@@eturn new TypedValue(value, new TypeDescriptor(new MethodParameter(this.method, -1)).narrow(value));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15291.java