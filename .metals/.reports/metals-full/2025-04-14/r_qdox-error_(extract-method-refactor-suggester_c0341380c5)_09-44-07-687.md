error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12224.java
text:
```scala
D@@ate date = new Date(Version.getTime());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12224.java