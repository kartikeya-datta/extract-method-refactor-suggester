error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7682.java
text:
```scala
l@@ogger.debug("failed to send cluster state to [{}], should be detected as failed soon...", exp, node);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7682.java