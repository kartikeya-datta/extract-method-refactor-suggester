error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10193.java
text:
```scala
S@@tring bodyOnLoadUpdateScript = "Wicket.Event.add(window, \"load\", function(event) { " +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10193.java