error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12375.java
text:
```scala
g@@etResponse().write(str);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12375.java