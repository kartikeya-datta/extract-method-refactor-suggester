error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5874.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5874.java
...
```java
offset: 876
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5874.java
text:
```scala
...
p@@ackage org.apache.commons.math.optimization;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5874.java