error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3904.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3904.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3904.java
text:
```scala
public S@@ession newSession(final Request request)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3904.java