error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7714.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7714.java
...
```java
offset: 564
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7714.java
text:
```scala
static class Queue {
 ...
 *******************************************************************************/
p@@ackage org.eclipse.jdt.internal.core.hierarchy;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7714.java