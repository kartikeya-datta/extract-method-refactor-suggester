error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7359.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7359.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7359.java
text:
```scala
P@@ointValuePair optimize(int maxEval, FUNC f, GoalType goalType,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7359.java