error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10773.java
text:
```scala
g@@c.setLineAttributes(new LineAttributes(1/2f, SWT.CAP_FLAT, SWT.JOIN_MITER, SWT.LINE_DOT, null, 0, 10));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10773.java