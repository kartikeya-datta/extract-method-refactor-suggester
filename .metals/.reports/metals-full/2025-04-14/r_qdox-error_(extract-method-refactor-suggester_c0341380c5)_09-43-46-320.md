error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4973.java
text:
```scala
r@@eturn Boolean.valueOf(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4973.java