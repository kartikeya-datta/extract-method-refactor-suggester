error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9085.java
text:
```scala
r@@eturn ((PackageFragmentInfo) getElementInfo()).getNonJavaResources(getResource(), (PackageFragmentRoot)getPackageFragmentRoot());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9085.java