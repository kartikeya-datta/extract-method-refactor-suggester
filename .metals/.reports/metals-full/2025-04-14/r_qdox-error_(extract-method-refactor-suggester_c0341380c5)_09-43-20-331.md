error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13869.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13869.java
text:
```scala
static i@@nt MINOR_VERSION = 544;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13869.java