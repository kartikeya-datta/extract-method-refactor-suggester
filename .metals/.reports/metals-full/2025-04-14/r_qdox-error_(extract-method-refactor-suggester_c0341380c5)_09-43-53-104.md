error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7320.java
text:
```scala
t@@his.conf = new TreeMap<>(conf);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7320.java