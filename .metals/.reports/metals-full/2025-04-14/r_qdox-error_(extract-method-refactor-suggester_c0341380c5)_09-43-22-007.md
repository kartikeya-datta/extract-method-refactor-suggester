error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6392.java
text:
```scala
S@@hell shell = new Shell(Display.getCurrent(), SWT.NONE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6392.java