error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2563.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2563.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2563.java
text:
```scala
r@@eturn Double.NaN;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2563.java