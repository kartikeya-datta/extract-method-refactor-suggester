error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10669.java
text:
```scala
A@@ssert.assertTrue(error < 1.01 * FastMath.abs(previousValueError));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10669.java