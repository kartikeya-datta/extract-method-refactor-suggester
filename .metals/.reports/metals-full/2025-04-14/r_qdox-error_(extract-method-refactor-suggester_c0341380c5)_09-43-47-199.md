error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17204.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17204.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17204.java
text:
```scala
public static final S@@tring DEFAULT_COMM_NAME = org.eclipse.ecf.provider.comm.tcp.Client.class.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17204.java