error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15323.java
text:
```scala
t@@his.wsSessionInitializer.initialize(request, response, protocol, session);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15323.java