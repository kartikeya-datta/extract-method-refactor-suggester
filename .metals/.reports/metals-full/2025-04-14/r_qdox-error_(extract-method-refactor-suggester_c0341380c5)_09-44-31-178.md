error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2392.java
text:
```scala
b@@uffer = Converter.wcsToMbcs (getCodePage (), wrapped, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2392.java