error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2519.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2519.java
text:
```scala
final i@@o.undertow.servlet.api.ServletInfo jspServlet = new ServletInfo("Default JSP Servlet", JspServlet.class)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2519.java