error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3011.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3011.java
text:
```scala
protected v@@oid consolidate () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3011.java