error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4786.java
text:
```scala
r@@eturn "" + index; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4786.java