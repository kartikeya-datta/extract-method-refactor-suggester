error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3999.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3999.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3999.java
text:
```scala
m@@ethod.modifiers | ExtraCompilerModifiers.AccDefaultAbstract | ClassFileConstants.AccSynthetic,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3999.java