error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18089.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18089.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18089.java
text:
```scala
public v@@oid setAppletModel(final Object model)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18089.java