error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9940.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9940.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9940.java
text:
```scala
m@@ltQuery.setMinimumShouldMatch("100%");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9940.java