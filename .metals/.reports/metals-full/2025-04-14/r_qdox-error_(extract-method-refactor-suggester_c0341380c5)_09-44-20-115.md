error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1173.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1173.java
text:
```scala
public i@@nt getSpecificity() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1173.java