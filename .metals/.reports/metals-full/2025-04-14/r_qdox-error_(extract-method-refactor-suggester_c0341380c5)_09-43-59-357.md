error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5175.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5175.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5175.java
text:
```scala
private R@@eportFilePanel outputDirectory = new ReportFilePanel(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5175.java