error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11210.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11210.java
text:
```scala
public b@@oolean isEmpty() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11210.java