error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3025.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3025.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3025.java
text:
```scala
F@@ile dir = new File(fileUrl.toURI());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3025.java