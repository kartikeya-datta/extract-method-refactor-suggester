error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/288.java
text:
```scala
t@@ick((t - lastTick) * nano2seconds);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/288.java