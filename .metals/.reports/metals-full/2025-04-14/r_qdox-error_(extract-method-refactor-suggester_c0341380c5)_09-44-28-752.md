error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17858.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17858.java
text:
```scala
i@@f (id == accessibleHandle() && accessible != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17858.java