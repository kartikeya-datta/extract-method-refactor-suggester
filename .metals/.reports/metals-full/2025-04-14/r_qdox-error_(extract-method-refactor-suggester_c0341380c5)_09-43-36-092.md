error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16018.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16018.java
text:
```scala
protected S@@tring createToString(StringMaker sm) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16018.java