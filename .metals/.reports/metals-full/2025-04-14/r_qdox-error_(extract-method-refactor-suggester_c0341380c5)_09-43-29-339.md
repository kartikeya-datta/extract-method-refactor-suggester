error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3457.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3457.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3457.java
text:
```scala
i@@f (newFocusedActor != null && !newFocusedActor.isDescendantOf(Dialog.this)) event.cancel();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3457.java