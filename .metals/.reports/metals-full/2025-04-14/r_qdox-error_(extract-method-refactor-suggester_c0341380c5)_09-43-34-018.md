error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6221.java
text:
```scala
i@@f(pInterval != previousInterval && (intervalFlagsToSkip[previousInterval + 1] & Util.IGNORE) == 0){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6221.java