error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6564.java
text:
```scala
s@@tate = LocalGatewayStartedShards.Builder.readFrom(in);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6564.java