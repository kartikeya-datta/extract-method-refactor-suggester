error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3768.java
text:
```scala
i@@f ((this.modifiers & ExtraCompilerModifiers.AccSemicolonBody) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3768.java