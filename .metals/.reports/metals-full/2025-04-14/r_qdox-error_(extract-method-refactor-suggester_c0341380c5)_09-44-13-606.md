error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1368.java
text:
```scala
s@@uper((JFrame) mediator.getView().getFrame(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1368.java