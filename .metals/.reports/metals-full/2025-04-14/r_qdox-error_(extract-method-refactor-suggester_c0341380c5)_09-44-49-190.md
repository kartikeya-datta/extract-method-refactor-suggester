error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6368.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6368.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6368.java
text:
```scala
l@@abel3.setText(ControlExample.getResourceString("Example_string") + "\n" + ControlExample.getResourceString("One_Two_Three"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6368.java