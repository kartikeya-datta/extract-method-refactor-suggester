error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2967.java
text:
```scala
l@@ogger.debug("Can not run threaded action, execution rejected [{}] running on current thread", listener);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2967.java