error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8785.java
text:
```scala
p@@haseContext.getDeploymentUnitContext().putAttachment(ConnectorXmlDescriptor.ATTACHMENT_KEY, xmlDescriptor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8785.java