error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9495.java
text:
```scala
b@@adlogicSmall.flip(true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9495.java