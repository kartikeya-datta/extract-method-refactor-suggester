error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6647.java
text:
```scala
r@@eturn this.expressionType = arrayElementBinding = ((ArrayBinding) arrayTb).elementsType(scope);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6647.java