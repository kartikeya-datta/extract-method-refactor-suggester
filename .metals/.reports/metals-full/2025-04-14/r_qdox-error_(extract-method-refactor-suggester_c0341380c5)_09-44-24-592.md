error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5387.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5387.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5387.java
text:
```scala
h@@tml = html.replace("</p>", "<br><br>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5387.java