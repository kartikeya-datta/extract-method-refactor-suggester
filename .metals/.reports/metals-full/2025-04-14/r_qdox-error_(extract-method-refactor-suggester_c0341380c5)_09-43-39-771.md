error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2164.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2164.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2164.java
text:
```scala
a@@ction = SWT.getMessage ("SWT_Switch"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2164.java