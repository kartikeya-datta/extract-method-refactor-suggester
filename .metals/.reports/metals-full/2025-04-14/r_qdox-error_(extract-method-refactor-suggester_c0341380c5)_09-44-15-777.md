error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18013.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18013.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18013.java
text:
```scala
private final X@@MLElementDecl fTempElementDecl = new XMLElementDecl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18013.java