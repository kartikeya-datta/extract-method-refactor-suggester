error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4784.java
text:
```scala
T@@ypeVariable[] typeVariables = getDeclaringType().resolve(newDeclaringType.getWorld()).getTypeVariables();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4784.java