error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4121.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4121.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4121.java
text:
```scala
i@@f ((time - status.time) > inactiveTime.millis() && indexShard.mergeStats().current() == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4121.java