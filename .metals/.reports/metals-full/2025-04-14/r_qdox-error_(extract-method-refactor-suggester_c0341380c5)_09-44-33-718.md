error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8817.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8817.java
text:
```scala
m@@enuManager.update(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8817.java