error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5768.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5768.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5768.java
text:
```scala
v@@ersionString.indexOf("Ant version")+17);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5768.java