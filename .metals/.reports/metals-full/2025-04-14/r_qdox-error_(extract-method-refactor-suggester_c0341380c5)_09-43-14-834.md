error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11968.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11968.java
text:
```scala
i@@tem.render();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11968.java