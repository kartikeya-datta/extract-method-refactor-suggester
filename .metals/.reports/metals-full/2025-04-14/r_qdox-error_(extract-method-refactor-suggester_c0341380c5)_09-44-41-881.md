error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8825.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8825.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8825.java
text:
```scala
h@@older.handler().handleException(new ReceiveTimeoutTransportException(holder.node(), holder.action(), "request_id [" + requestId + "]"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8825.java