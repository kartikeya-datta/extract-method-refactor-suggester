error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7881.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7881.java
text:
```scala
i@@ndicesLifecycle.afterIndexShardClosed(sId, indexShard);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7881.java