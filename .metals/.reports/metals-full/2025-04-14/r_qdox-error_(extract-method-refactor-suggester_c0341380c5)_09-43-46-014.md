error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/954.java
text:
```scala
L@@ist<String> arguments = ctx.getOtherArguments();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/954.java