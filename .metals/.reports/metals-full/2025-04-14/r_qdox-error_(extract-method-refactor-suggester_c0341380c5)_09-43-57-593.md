error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1864.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1864.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1864.java
text:
```scala
private static final S@@tring ACTION_NAME = MultiGetAction.NAME + "[shard]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1864.java