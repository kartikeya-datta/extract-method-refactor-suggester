error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4883.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4883.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4883.java
text:
```scala
W@@orkbenchJob animationStartJob = new WorkbenchJob(ProgressMessages
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4883.java