error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2016.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2016.java
text:
```scala
synchronized v@@oid close() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2016.java