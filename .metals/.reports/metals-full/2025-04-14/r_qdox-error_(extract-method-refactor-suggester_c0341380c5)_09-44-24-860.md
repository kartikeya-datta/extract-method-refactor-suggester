error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1708.java
text:
```scala
s@@erver.createContext(ConsoleHandler.CONTEXT, new ConsoleHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1708.java