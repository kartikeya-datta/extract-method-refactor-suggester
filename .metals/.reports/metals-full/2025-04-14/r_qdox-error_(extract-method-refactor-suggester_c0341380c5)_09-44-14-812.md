error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10707.java
text:
```scala
r@@eturn (String[]) getExternalContext().getRequestParameterValuesMap().get(paramName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10707.java