error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3671.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3671.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3671.java
text:
```scala
T@@extAreaEditor {@Override PropertyEditor getInstance(PropertyDescriptor descriptor) { return new TextAreaEditor(descriptor); }},
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3671.java