error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/896.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/896.java
text:
```scala
public J@@avaElementInfo getElementInfo() throws JavaModelException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/896.java