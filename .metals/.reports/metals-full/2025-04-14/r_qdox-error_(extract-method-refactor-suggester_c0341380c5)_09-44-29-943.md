error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5186.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5186.java
text:
```scala
public static final C@@ompilationResult RESTART_IN_WIDE_MODE = new CompilationResult((char[])null, 0, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5186.java