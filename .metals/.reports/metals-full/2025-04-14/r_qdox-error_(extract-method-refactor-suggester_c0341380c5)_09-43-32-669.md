error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3261.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3261.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3261.java
text:
```scala
r@@eturn "YAHOO.org.apache.wicket." + getJavascriptId();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3261.java