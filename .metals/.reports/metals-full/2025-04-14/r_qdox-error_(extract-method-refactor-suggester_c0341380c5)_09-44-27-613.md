error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10614.java
text:
```scala
v@@oid validate(final FormComponent component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10614.java