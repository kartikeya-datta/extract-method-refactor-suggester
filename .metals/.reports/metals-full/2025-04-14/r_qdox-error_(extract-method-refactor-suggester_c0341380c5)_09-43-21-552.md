error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13165.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13165.java
text:
```scala
public v@@oid addContent( String msg )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13165.java