error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15917.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15917.java
text:
```scala
private final S@@tring typeName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15917.java