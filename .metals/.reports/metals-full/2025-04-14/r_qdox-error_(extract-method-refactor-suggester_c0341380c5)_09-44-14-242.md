error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14385.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14385.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14385.java
text:
```scala
s@@uper(ejbName, new InjectedValue<EJBComponent>(), componentViews, null, deploymentClassLoader, new InjectedValue<EjbIIOPService>());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14385.java