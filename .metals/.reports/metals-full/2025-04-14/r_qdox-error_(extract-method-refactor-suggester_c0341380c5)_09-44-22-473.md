error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10061.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10061.java
...
```java
offset: 1112
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10061.java
text:
```scala
...
p@@ackage org.jboss.as.jpa.hibernate;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10061.java