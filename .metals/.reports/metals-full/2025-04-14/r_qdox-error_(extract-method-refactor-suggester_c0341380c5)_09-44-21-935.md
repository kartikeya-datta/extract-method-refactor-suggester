error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2725.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2725.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2725.java
text:
```scala
r@@eturn !isNullType() && binding.isBaseType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2725.java