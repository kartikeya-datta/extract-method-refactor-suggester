error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17982.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17982.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17982.java
text:
```scala
protected v@@oid reInitialize() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17982.java