error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17759.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17759.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[43,80]

error in qdox parser
file content:
```java
offset: 1556
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17759.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17759.java