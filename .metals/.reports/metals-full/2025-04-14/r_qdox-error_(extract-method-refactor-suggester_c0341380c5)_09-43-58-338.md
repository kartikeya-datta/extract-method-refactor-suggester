error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5888.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5888.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5888.java
text:
```scala
public i@@nt oInst;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5888.java