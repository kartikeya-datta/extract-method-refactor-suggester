error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5610.java
text:
```scala
n@@otifyMasterFailure(masterToPing, "not master");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5610.java