error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4357.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4357.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4357.java
text:
```scala
i@@f (enclosingTb.id == T_Object) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4357.java