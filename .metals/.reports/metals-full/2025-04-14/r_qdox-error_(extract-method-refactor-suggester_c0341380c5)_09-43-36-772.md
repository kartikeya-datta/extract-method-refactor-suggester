error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6680.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6680.java
text:
```scala
public O@@bject createTarget(Object source, TypeDescriptor sourceType, TypeDescriptor targetType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6680.java