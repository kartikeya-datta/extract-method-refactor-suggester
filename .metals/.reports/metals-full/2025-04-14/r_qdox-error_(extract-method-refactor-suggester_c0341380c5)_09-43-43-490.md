error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3365.java
text:
```scala
r@@eturn new TSIG(name, key);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3365.java