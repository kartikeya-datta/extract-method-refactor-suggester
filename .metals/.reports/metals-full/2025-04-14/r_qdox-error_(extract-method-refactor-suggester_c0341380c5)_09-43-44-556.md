error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3574.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3574.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3574.java
text:
```scala
s@@tate |= GRAB | THEME_BACKGROUND;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3574.java