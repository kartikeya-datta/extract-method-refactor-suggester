error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17008.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17008.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17008.java
text:
```scala
i@@f ((style & SWT.CALENDAR) != 0) return bits | OS.MCS_NOTODAY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17008.java