error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/200.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/200.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/200.java
text:
```scala
r@@eturn targetTheme.getBoolean(propertyId) ? Boolean.TRUE : Boolean.FALSE;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/200.java