error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7727.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7727.java
text:
```scala
public v@@oid addTimeoutHandler(Runnable runnable) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7727.java