error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/531.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/531.java
text:
```scala
M@@etaData.Builder metaDataBuilder = MetaData.builder(newState.metaData()).removeAllIndices();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/531.java