error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11346.java
text:
```scala
C@@omponent getTarget();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11346.java