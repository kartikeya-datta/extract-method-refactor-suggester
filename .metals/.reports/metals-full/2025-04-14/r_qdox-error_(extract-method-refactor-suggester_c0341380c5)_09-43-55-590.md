error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13623.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13623.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13623.java
text:
```scala
M@@ap<String, String> m = new HashMap<String, String>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13623.java