error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13312.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13312.java
text:
```scala
r@@esponse.write("</ul>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13312.java