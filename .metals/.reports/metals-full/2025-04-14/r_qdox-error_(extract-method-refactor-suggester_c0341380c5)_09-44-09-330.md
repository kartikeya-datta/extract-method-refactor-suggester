error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7335.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7335.java
text:
```scala
private static T@@hreadLocal<String[]> typesContext = new ThreadLocal<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7335.java