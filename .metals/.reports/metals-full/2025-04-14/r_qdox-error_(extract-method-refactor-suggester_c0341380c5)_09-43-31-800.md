error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6517.java
text:
```scala
b@@uilder.startObject("version").field("number", Version.number()).field("date", Version.date()).field("snapshotBuild", Version.snapshotBuild()).endObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6517.java