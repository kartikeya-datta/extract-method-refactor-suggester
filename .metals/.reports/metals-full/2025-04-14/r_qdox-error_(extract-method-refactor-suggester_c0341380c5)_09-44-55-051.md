error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6167.java
text:
```scala
T@@ypeBinding[] argumentTypes = Binding.NO_PARAMETERS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6167.java