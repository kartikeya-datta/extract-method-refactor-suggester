error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7730.java
text:
```scala
h@@ostRegistration.registerOperationHandler(HostShutdownHandler.OPERATION_NAME, hsh, hsh, EnumSet.of(Flag.HOST_CONTROLLER_ONLY));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7730.java