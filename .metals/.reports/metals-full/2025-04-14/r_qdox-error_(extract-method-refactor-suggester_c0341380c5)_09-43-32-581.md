error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10517.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10517.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10517.java
text:
```scala
g@@c.setBackground(gc.getDevice().getSystemColor(SWT.COLOR_YELLOW));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10517.java