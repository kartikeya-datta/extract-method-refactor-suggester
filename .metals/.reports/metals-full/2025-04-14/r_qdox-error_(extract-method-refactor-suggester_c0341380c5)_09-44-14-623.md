error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4070.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4070.java
text:
```scala
U@@til.setReadOnly(copiedResource, false); // just in case the original was read only
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4070.java