error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6802.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6802.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6802.java
text:
```scala
s@@uper("Not authorized to instantiate class " + componentClass.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6802.java