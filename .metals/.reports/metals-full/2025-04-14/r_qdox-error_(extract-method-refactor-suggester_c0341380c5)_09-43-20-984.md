error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10669.java
text:
```scala
p@@ublic interface ICompoundModel<T> extends IInhertanceAware<T>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10669.java