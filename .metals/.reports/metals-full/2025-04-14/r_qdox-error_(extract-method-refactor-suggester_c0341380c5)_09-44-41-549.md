error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2558.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2558.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2558.java
text:
```scala
i@@f(current.getItemCount() >= 20 && i != markers.size() - 1)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2558.java