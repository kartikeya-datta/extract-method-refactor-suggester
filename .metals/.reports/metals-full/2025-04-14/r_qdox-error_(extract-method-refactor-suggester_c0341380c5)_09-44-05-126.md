error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7004.java
text:
```scala
r@@eturn pattern2.length() - pattern1.length();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7004.java