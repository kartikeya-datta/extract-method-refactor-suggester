error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3817.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3817.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3817.java
text:
```scala
public T@@extureRegion region;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3817.java