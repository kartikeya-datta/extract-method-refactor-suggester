error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2672.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2672.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2672.java
text:
```scala
L@@ogs.reportMessage("DBLOOK_ChecksHeader");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2672.java