error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5439.java
text:
```scala
S@@ystem.err.println("createModule unable to create " + jarDir);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5439.java