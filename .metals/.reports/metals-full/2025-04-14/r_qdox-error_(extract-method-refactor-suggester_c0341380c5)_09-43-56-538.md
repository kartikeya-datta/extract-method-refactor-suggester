error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16709.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16709.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16709.java
text:
```scala
c@@hild.detach();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16709.java