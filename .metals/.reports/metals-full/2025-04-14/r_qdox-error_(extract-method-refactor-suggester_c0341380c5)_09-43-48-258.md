error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/831.java
text:
```scala
S@@tring errorMessage;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/831.java