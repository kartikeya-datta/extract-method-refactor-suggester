error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5708.java
text:
```scala
i@@f ((_query == null && _language.endsWith("JPQL")) || _compiling || _broker == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5708.java