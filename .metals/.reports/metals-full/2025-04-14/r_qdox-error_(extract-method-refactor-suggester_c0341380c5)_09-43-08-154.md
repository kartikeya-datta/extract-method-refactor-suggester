error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2591.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2591.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2591.java
text:
```scala
a@@ssertEquals(302, response.getStatus());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2591.java