error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3179.java
text:
```scala
A@@nalysis.parseStopWords(env, settings, CzechAnalyzer.getDefaultStopSet(), version),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3179.java