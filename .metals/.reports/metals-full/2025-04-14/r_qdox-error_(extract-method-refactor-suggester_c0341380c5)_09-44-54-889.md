error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14171.java
text:
```scala
r@@edirect.add(new AttributeModifier("content", new Model<String>(content)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14171.java