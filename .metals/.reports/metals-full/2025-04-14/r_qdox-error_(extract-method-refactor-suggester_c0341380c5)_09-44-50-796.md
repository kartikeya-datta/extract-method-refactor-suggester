error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11194.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11194.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11194.java
text:
```scala
l@@ist.addAll(Arrays.asList(getFullElements()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11194.java