error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5428.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5428.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5428.java
text:
```scala
r@@eturn new InternalRangeFacet(facetName, entries);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5428.java