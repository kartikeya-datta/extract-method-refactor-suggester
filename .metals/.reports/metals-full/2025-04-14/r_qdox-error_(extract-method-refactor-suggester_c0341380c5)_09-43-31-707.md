error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9148.java
text:
```scala
i@@f (hooks (SWT.Paint) || filters (SWT.Paint)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9148.java