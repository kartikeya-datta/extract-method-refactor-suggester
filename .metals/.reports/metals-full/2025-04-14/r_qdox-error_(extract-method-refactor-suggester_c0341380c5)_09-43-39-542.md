error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2944.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2944.java
text:
```scala
P@@ixmap pixmap = new Pixmap(Gdx.files.internal("data/stone2.png"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2944.java