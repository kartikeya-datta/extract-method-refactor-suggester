error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1650.java
text:
```scala
r@@eturn new StatefulSessionObjectReferenceImpl((EjbDescriptorImpl<?>) ejbDescriptor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1650.java