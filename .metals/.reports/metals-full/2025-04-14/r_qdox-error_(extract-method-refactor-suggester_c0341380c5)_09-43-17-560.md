error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16815.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16815.java
text:
```scala
static final D@@eferredDOMImplementationImpl singleton = new DeferredDOMImplementationImpl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16815.java