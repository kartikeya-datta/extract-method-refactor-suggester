error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1477.java
text:
```scala
r@@m = new RowMutation("Keyspace1", "key1".getBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1477.java