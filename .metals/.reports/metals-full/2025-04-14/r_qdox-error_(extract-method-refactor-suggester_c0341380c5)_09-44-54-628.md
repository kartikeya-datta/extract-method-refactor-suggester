error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10172.java
text:
```scala
i@@f (!(component instanceof StatefulSessionComponent)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10172.java