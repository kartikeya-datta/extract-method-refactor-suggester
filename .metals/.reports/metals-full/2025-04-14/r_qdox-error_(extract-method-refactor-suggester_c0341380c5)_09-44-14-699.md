error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2915.java
text:
```scala
S@@ingletonProvider.initialize(new ModuleGroupSingletonProvider());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2915.java