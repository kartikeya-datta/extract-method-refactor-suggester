error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1799.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1799.java
text:
```scala
public static final S@@tring NAME = "cluster:monitor/nodes/hot_threads";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1799.java