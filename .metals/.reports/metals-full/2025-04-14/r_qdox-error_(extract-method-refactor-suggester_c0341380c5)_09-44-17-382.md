error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6935.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6935.java
text:
```scala
w@@sdlLocation = "META-INF/wsdl/EndpointService.wsdl",//"http://localhost:8080/ws-example?wsdl",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6935.java