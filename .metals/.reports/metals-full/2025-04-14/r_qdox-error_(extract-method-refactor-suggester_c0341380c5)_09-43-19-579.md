error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7347.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7347.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7347.java
text:
```scala
public final v@@oid error(Collection/* <String> */resourceKeys, Map/* <String,String> */args)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7347.java