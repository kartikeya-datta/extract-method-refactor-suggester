error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8445.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8445.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8445.java
text:
```scala
s@@uper(new StringLengthValidator(0, Integer.MAX_VALUE, true, true), new StringLengthValidator(0, Integer.MAX_VALUE, true, false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8445.java