error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/462.java
text:
```scala
i@@nt cls = OS.objc_allocateClassPair(OS.class_NSObject, className, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/462.java