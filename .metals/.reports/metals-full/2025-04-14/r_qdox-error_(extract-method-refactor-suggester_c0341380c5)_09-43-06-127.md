error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3780.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3780.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3780.java
text:
```scala
a@@ppendValue(1, _pkColumn);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3780.java