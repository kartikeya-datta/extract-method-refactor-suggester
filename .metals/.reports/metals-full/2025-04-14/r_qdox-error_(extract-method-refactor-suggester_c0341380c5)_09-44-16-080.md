error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10434.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10434.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10434.java
text:
```scala
s@@uper(ModelType.STRING, nullable, allowExpressions, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10434.java