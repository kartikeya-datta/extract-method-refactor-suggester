error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1980.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1980.java
text:
```scala
private static L@@og log = LogFactory.getLog(ResourceFinderResourceStreamLocator.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1980.java