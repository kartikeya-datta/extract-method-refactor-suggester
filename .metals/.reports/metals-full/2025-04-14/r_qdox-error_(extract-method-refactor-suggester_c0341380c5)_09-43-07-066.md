error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16576.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16576.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16576.java
text:
```scala
s@@ocontainer = ContainerFactory.getDefault().createContainer(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16576.java