error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3281.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3281.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3281.java
text:
```scala
public C@@lass<?> getTestClass() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3281.java