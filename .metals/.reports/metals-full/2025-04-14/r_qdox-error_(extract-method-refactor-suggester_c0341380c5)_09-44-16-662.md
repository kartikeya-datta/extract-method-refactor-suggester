error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9781.java
text:
```scala
s@@uper("create-jms-queue", true, new SimpleTabCompleter(new String[]{"name=", "entries=", "selector=", "durable=", "--help"}));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9781.java