error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12165.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12165.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12165.java
text:
```scala
A@@ntClassLoader loader = p.createClassLoader(path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12165.java