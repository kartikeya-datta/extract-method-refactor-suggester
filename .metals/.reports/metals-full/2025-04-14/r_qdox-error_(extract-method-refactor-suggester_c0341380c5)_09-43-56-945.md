error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6079.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6079.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6079.java
text:
```scala
protected L@@istItem newItem(final int index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6079.java