error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12424.java
text:
```scala
m@@oduleSpecification.addSystemDependency(new ModuleDependency(loader, CORBA_ID, false, true, true, false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12424.java