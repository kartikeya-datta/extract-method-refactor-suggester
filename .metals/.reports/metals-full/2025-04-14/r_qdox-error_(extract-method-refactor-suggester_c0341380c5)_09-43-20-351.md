error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15944.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15944.java
text:
```scala
private final S@@tring bundleName;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15944.java