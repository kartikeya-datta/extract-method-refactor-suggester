error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2313.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2313.java
text:
```scala
public synchronized D@@ocData getNextDocData(DocData docData) throws NoMoreDataException, IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2313.java