error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9585.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9585.java
text:
```scala
s@@ound = Gdx.audio.newSound(Gdx.files.getFileHandle("data/test2_notwork.wav", FileType.Internal));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9585.java