error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6186.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6186.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6186.java
text:
```scala
i@@f ((enumConstant.modifiers & ClassFileConstants.AccEnum) == 0) continue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6186.java