error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8961.java
text:
```scala
i@@f(OperatingSystem.isDOSDerived() || OperatingSystem.isMacOS())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8961.java