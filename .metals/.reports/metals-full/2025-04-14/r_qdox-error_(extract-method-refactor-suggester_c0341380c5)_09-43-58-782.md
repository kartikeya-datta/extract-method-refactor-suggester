error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14279.java
text:
```scala
m@@_configurer.configureElement( task, taskModel, taskContext );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14279.java