error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10084.java
text:
```scala
s@@cope.problemReporter().unsafeTypeConversion(this.expression, rhsType, lhsType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10084.java