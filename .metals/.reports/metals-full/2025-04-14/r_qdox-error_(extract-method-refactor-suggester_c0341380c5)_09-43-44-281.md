error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6797.java
text:
```scala
l@@ong count = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6797.java