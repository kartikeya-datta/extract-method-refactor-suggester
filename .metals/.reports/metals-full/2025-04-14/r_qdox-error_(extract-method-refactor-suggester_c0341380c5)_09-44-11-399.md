error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6992.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6992.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6992.java
text:
```scala
I@@ntArray hashes = BigArrays.NON_RECYCLING_INSTANCE.newIntArray(ordinals.getMaxOrd());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6992.java