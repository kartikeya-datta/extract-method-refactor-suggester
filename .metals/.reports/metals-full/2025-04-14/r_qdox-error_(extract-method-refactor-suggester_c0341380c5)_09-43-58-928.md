error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6770.java
text:
```scala
r@@eturn "EmailAddressValidator";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6770.java