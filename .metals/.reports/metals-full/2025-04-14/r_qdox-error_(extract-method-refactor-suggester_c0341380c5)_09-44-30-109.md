error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3723.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3723.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3723.java
text:
```scala
b@@uilder.startObject(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3723.java