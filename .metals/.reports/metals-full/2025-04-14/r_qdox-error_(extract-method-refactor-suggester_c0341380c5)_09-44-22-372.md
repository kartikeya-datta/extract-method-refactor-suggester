error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6105.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6105.java
text:
```scala
A@@ttributeConverter NAME_FROM_ADDRESS = new AttributeConverter() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6105.java