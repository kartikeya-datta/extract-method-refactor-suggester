error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1715.java
text:
```scala
s@@uper(SecurityExtension.PATH_JASPI_AUTH,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1715.java