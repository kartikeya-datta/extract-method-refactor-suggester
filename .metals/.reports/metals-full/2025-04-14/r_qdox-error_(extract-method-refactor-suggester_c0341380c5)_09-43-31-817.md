error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9537.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9537.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9537.java
text:
```scala
l@@ogger.warn("[{}] failed to read template [{}] from config", e, request.index, templatesFile.getAbsolutePath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9537.java