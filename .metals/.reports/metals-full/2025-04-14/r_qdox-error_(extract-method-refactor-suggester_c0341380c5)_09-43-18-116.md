error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11285.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11285.java
text:
```scala
C@@omponent getFilter(String componentId, FilterForm form);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11285.java