error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11317.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11317.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11317.java
text:
```scala
private B@@yteArrayOutputStream bufferedOutput = new ByteArrayOutputStream(1024);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11317.java