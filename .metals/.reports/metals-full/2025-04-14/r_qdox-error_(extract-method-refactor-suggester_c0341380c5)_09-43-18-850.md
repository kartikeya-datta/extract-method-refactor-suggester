error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9806.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9806.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9806.java
text:
```scala
t@@his.addWithoutBreaking(-bytes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9806.java