error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6135.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6135.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6135.java
text:
```scala
n@@ew ConfigFrame(frameMediator.getView().getFrame(), folder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6135.java