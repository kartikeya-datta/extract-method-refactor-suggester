error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10911.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10911.java
text:
```scala
public v@@oid write(final byte[] b, final int off, final int len)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10911.java