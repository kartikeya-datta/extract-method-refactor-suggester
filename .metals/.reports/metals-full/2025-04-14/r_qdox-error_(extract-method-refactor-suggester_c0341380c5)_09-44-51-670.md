error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2811.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2811.java
text:
```scala
static final H@@ashtable fBuiltInTypes = new Hashtable();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2811.java