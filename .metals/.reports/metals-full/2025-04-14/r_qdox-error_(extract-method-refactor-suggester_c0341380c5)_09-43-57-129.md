error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12562.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12562.java
text:
```scala
public v@@oid handle(CommandContext ctx) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12562.java