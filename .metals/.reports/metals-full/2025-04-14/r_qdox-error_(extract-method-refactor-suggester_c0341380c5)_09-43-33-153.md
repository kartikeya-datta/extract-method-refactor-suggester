error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1521.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1521.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1521.java
text:
```scala
final M@@odelNode address = createCustomHandlerAddress(profileName, "CONSOLE2").toModelNode();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1521.java