error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9826.java
text:
```scala
b@@uffer.append(cycle.getApplication().getPages().getBookmarkablePageName(pageClass));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9826.java