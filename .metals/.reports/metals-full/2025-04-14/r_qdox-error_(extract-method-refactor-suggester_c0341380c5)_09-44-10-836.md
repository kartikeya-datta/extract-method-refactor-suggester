error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4055.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4055.java
text:
```scala
s@@etText(WorkbenchMessages.SystemMenuMovePane_PaneName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4055.java