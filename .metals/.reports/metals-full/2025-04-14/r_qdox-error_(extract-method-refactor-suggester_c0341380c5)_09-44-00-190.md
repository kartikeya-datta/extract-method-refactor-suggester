error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9000.java
text:
```scala
r@@eturn Index.class;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9000.java