error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14642.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14642.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14642.java
text:
```scala
t@@extFileChange.addEdit(AnnotationUtils.createRemoveImportTextEdit(myPackage, XmlSchema.class.getCanonicalName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14642.java