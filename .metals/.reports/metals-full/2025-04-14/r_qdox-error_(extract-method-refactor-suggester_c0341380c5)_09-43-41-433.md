error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9193.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9193.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9193.java
text:
```scala
t@@hrow new IllegalArgumentException("Argument session must me not null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9193.java