error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/843.java
text:
```scala
r@@eturn XPathUtil.makeDocument(in,false,false,useNameSpace(),isTolerant(),isQuiet(),showWarnings(),reportErrors(),true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/843.java