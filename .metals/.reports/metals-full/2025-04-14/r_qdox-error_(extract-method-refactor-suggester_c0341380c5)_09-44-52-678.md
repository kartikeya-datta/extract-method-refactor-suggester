error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4265.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4265.java
text:
```scala
final C@@lass<?> factoryClass = Class.forName(factoryClassName, true, classLoader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4265.java