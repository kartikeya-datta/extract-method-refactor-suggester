error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1839.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1839.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1839.java
text:
```scala
e@@ncoding = resource.getCharset();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1839.java