error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6842.java
text:
```scala
c@@ache.setText(text, 0, cache.getFont().isFlipped() ? 0 : cache.getFont().getCapHeight());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6842.java