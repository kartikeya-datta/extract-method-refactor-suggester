error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7876.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7876.java
text:
```scala
s@@tringReplaceAll(buffer, '>', "&gt;");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7876.java