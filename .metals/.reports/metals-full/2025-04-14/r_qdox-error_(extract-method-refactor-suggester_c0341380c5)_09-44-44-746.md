error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11751.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11751.java
text:
```scala
private static final A@@ttachmentKey<ResourceAdapters> ATTACHMENT_KEY = AttachmentKey.create(ResourceAdapters.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11751.java