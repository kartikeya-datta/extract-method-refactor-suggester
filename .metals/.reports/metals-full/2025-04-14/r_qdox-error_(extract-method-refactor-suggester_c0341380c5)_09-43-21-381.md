error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12916.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12916.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12916.java
text:
```scala
T@@ypeX.forNames(formalTypes),false)),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12916.java