error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2274.java
text:
```scala
s@@endEvent(SWT.OpenDocument, event);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2274.java