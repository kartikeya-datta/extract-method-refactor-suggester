error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1831.java
text:
```scala
H@@ostModelUtil.createRootRegistry(rootRegistration, environment, ignoredRegistry, this, processType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1831.java