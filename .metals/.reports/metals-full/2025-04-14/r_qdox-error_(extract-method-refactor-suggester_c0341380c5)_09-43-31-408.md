error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1637.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1637.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1637.java
text:
```scala
i@@f(model.hasDefined(RemoteTransportDefinition.SOCKET_BINDING.getName())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1637.java