error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/432.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/432.java
text:
```scala
t@@his.binding.useFlag = used ? LocalVariableBinding.USED : LocalVariableBinding.UNUSED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/432.java