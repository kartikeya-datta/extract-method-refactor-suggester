error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9209.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9209.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9209.java
text:
```scala
r@@eturn new String[]{NAME, "in"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9209.java