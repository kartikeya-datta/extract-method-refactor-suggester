error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8340.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8340.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8340.java
text:
```scala
t@@arget.appendJavascript(getJsTimeoutCall(updateInterval));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8340.java