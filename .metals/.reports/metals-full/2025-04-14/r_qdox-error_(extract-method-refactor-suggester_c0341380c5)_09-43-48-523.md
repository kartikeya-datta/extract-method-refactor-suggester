error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4426.java
text:
```scala
r@@eturn IWorkbenchConstants.DEFAULT_ACCELERATOR_SCOPE_ID;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4426.java