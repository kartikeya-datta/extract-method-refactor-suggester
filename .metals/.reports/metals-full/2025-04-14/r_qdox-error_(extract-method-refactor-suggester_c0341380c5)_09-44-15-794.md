error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3988.java
text:
```scala
i@@nt version = 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3988.java