error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/321.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/321.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/321.java
text:
```scala
static final S@@tring VERSION = "2.0.20040714";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/321.java