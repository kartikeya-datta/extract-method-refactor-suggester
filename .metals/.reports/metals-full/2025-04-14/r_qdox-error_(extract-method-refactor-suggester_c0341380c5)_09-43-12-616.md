error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14921.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14921.java
text:
```scala
r@@eturn new ClassStringResourceLoader(application.getClass());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14921.java