error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10666.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10666.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10666.java
text:
```scala
public static final A@@ttachmentKey<DeploymentJaxws> JAXWS_ENDPOINTS_KEY = AttachmentKey.create(DeploymentJaxws.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10666.java