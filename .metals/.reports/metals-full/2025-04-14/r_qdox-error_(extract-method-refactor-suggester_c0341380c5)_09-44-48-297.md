error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13388.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13388.java
text:
```scala
public final C@@lass resolveClass(final String classname)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13388.java