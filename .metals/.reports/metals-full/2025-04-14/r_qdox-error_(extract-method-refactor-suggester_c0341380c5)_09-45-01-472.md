error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7909.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7909.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7909.java
text:
```scala
n@@ode = nodeBuilder().local(true).node();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7909.java