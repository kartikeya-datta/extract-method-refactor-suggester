error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13833.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13833.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13833.java
text:
```scala
S@@tringBuilder buf = new StringBuilder("{dependselector targetdir: ");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13833.java