error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1560.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1560.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1560.java
text:
```scala
public v@@oid testRuleLanguageMatches() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1560.java