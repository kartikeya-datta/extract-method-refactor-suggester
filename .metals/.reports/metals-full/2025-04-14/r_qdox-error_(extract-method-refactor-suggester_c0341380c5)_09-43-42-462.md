error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13577.java
...
```java
offset: 706
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13577.java
text:
```scala
...
p@@ackage org.springframework.websocket.server.endpoint;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13577.java