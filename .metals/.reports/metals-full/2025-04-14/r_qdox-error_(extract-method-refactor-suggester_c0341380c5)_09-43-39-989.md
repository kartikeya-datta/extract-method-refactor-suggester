error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14773.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14773.java
text:
```scala
n@@ew Object[]{context.getDefaultRuntimeType(), context.getDefaultRuntimeVersion()});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14773.java