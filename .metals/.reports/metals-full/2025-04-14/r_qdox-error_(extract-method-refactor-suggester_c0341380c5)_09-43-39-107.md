error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3680.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3680.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3680.java
text:
```scala
static private final c@@har[][] noException = CharOperation.NO_CHAR_CHAR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3680.java