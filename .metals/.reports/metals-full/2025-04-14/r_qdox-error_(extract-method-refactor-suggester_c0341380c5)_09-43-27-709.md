error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11229.java
text:
```scala
p@@ublic class Home extends HangmanPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11229.java