error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1887.java
text:
```scala
b@@order = new LibraryApplicationBorder("border");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1887.java