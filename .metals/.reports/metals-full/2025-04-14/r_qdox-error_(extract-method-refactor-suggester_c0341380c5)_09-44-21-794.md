error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8500.java
text:
```scala
t@@hrow new FacetPhaseExecutionException(facetName, "No mapping found for value_field [" + valueField + "]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8500.java