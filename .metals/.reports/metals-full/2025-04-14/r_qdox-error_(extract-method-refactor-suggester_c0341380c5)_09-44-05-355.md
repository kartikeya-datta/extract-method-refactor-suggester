error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9377.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9377.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9377.java
text:
```scala
b@@oolean ignoreFocus, delayDispose;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9377.java