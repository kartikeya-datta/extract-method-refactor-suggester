error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7675.java
text:
```scala
g@@etListAdapter().addHeader(filterHeader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7675.java