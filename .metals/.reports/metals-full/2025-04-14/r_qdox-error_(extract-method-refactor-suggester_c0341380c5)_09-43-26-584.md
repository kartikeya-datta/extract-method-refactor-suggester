error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5885.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5885.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5885.java
text:
```scala
c@@omponentConfiguration.setAccessTimeout( new AccessTimeoutDetails(method.getAccessTimeout().getTimeout(), method.getAccessTimeout().getUnit()), methodIdentifier);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5885.java