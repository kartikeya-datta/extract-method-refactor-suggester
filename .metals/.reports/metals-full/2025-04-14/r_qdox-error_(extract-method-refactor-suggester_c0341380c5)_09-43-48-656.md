error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/587.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/587.java
text:
```scala
r@@eturn new MemoryMapState(_id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/587.java