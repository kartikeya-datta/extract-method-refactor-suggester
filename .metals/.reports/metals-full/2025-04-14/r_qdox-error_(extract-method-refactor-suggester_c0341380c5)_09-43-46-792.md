error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12658.java
text:
```scala
i@@f (existingModel.hasDefined(connectionPropertiesProp)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12658.java