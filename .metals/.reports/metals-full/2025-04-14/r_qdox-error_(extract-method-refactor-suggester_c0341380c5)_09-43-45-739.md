error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5695.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5695.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5695.java
text:
```scala
b@@uilder.field("type", type.toString().toLowerCase(Locale.ENGLISH));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5695.java