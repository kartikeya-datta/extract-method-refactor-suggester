error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/497.java
text:
```scala
r@@eturn "[" + index.name() + "][" + shardId + "]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/497.java