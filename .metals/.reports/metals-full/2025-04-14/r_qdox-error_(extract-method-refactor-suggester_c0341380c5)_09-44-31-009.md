error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/215.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/215.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/215.java
text:
```scala
static S@@tring classDir = "../weaver/bin";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/215.java