error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7662.java
text:
```scala
S@@hardDeleteResponse response = new ShardDeleteResponse(delete.version(), delete.found());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7662.java