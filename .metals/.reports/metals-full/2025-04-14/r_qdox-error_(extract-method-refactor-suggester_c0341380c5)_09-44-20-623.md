error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10263.java
text:
```scala
A@@ssert.assertTrue("Schedule timer is not alive after overlapped invocation!",ScheduleRetryFailSingletonBean.aliveLatch().await(5, TimeUnit.SECONDS));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10263.java