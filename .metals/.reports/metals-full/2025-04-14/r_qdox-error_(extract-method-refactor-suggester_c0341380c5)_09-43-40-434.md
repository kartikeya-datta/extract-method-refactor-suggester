error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17651.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[146,2]

error in qdox parser
file content:
```java
offset: 3981
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17651.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17651.java