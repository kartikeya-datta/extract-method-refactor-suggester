error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6542.java
text:
```scala
x@@h.addRule( "ContextManager/Connector", xh.setParent( "setServer", "java.lang.Object") );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6542.java