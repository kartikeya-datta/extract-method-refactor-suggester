error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2162.java
text:
```scala
t@@his.subReaders = (IndexReader[]) subReaders.clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2162.java