error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3917.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3917.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3917.java
text:
```scala
r@@eturn "(" + type.toString(0)+ ") " + //$NON-NLS-2$ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3917.java