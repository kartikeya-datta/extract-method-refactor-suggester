error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/263.java
text:
```scala
t@@his.executor = configurer.getAsyncExecutor();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/263.java