error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6477.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6477.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6477.java
text:
```scala
t@@his.audio = new IOSAudio();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6477.java