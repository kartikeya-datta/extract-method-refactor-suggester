error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2915.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2915.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2915.java
text:
```scala
i@@gnoreMalformed(context));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2915.java