error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17294.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17294.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17294.java
text:
```scala
S@@tring.valueOf(startIdx), String.valueOf(endIdx)).getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17294.java