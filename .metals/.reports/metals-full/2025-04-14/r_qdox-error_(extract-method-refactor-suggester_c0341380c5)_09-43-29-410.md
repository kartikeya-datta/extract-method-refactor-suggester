error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10808.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10808.java
text:
```scala
c@@atch (Exception ex) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10808.java