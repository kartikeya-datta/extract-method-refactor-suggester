error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1640.java
text:
```scala
t@@his.connectOnNetworkDisconnect = componentSettings.getAsBoolean("connect_on_network_disconnect", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1640.java