error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9532.java
text:
```scala
i@@f (isSupported("STLS") || isSupported("STARTTLS") || (capabilities.length == 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9532.java