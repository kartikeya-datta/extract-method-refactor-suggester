error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1243.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1243.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1243.java
text:
```scala
s@@qlerrmc += args[i] + separator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1243.java