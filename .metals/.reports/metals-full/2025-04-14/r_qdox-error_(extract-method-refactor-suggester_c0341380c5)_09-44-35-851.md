error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4290.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4290.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4290.java
text:
```scala
S@@tring s;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4290.java