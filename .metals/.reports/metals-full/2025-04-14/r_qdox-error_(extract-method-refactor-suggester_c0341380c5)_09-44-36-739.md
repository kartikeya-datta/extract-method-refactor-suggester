error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/18.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/18.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/18.java
text:
```scala
b@@tRigidBody body = (btRigidBody)(objs.at(i));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/18.java