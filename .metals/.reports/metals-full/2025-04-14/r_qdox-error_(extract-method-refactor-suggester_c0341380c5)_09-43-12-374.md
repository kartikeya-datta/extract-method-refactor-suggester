error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1464.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1464.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1464.java
text:
```scala
A@@ssert.notNull(factory, "WebSocketServerFactory must not be null");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1464.java