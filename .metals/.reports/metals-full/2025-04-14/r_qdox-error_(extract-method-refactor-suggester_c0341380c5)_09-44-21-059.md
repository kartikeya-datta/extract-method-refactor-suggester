error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2128.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2128.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2128.java
text:
```scala
r@@eturn -result;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2128.java