error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4016.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4016.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4016.java
text:
```scala
i@@f (currentType.hasMemberTypes()) // avoid resolving member types eagerly
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4016.java