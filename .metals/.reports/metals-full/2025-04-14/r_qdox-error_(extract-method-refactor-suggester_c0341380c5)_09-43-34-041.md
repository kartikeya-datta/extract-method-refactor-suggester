error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/554.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/554.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/554.java
text:
```scala
t@@his.segments = qualification == null ? ONE_STAR_CHAR : CharOperation.splitOn('.', qualification);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/554.java