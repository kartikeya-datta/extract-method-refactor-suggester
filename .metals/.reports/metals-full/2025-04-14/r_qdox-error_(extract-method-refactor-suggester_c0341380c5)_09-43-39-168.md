error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/343.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/343.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/343.java
text:
```scala
u@@i = new Stage(480, 320, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/343.java