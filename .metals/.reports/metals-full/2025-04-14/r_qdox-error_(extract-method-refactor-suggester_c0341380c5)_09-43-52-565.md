error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/148.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/148.java
text:
```scala
p@@age.getPageMap().put(page);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/148.java