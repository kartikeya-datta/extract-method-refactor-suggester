error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9251.java
text:
```scala
F@@ieldMapper fieldMapper = context.smartNameFieldMapper(field);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9251.java