error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3658.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3658.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3658.java
text:
```scala
f@@or (Property containerProp : subsystem.get(CacheContainerResourceDefinition.WILDCARD_PATH.getKey()).asPropertyList()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3658.java