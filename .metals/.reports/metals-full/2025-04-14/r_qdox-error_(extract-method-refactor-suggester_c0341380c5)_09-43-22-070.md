error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1480.java
text:
```scala
A@@ndroid, Desktop, HeadlessDesktop, Applet, WebGL, iOS
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1480.java