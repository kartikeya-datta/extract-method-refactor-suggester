error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9433.java
text:
```scala
d@@eleteIndexService.deleteIndex(new MetaDataDeleteIndexService.Request(index).timeout(request.timeout()).masterTimeout(request.masterNodeTimeout()), new MetaDataDeleteIndexService.Listener() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9433.java