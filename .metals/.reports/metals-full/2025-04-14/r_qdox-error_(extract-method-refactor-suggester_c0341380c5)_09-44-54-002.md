error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11274.java
text:
```scala
p@@ublic class StaticWizard extends Wizard
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11274.java