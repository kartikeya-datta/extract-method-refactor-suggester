error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7647.java
text:
```scala
o@@ptions.put(CompilerOptions.OPTION_Compliance, CompilerOptions.VERSION_1_4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7647.java