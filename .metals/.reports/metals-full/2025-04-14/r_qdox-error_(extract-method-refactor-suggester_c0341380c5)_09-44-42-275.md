error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7448.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7448.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7448.java
text:
```scala
L@@ocalizedFormats.UNPARSEABLE_REAL_VECTOR, source);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7448.java