error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1843.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1843.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1843.java
text:
```scala
r@@eturnType, name, nameStart, nameEnd, parameterTypes,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1843.java