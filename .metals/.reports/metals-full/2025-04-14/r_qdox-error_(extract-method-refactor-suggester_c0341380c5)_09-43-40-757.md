error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7493.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7493.java
text:
```scala
@Nullable V@@alueFormatter formatter;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7493.java