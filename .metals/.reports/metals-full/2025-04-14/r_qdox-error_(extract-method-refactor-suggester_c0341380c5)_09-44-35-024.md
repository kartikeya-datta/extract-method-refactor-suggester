error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1581.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1581.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1581.java
text:
```scala
i@@f (match.isProvablyDistinctFrom(isNarrowing ? expressionType : castType, 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1581.java