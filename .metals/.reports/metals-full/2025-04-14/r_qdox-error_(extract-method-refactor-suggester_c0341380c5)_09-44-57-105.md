error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9099.java
text:
```scala
c@@omposerController.getHeaderController().getView().cleanupHeaderItemList();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9099.java