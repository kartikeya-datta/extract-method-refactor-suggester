error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6197.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6197.java
text:
```scala
r@@eturn getXmlData().getBytes().length;// so we don't generate chunked encoding
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6197.java