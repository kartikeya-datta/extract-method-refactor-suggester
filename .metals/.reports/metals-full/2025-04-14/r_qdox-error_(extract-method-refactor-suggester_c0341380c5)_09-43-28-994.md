error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1561.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1561.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1561.java
text:
```scala
r@@eturn endpoint.connect(this.destination, this.connectionCreationOptions, getCallbackHandler());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1561.java