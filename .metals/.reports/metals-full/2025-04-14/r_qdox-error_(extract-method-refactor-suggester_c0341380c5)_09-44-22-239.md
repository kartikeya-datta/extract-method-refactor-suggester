error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10244.java
text:
```scala
E@@XCLUSIVE };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10244.java