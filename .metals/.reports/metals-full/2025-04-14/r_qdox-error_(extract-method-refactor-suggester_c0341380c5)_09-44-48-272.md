error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3257.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3257.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3257.java
text:
```scala
s@@uper.setPopupMenuVisible(b);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3257.java