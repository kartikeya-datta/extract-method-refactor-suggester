error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1490.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1490.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1490.java
text:
```scala
s@@hell.add(GeoUtils.parseGeoPoint(parser));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1490.java