error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9547.java
text:
```scala
n@@ewCol.add((JMeterProperty) iter.next().clone());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9547.java