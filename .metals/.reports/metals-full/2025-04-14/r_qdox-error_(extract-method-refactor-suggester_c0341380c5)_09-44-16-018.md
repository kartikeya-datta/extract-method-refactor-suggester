error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3364.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3364.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3364.java
text:
```scala
d@@efaultFramebufferHandle = intbuf.get(0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3364.java