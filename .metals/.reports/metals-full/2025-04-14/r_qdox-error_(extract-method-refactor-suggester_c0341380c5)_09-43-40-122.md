error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1987.java
text:
```scala
f@@or (AttributeDefinition attribute : DiscoveryGroupDefinition.ATTRIBUTES) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1987.java