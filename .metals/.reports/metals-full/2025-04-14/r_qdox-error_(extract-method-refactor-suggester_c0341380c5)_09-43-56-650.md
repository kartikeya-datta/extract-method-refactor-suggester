error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6424.java
text:
```scala
i@@f(methodIntf != MethodIntf.REMOTE && methodIntf != MethodIntf.HOME) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6424.java