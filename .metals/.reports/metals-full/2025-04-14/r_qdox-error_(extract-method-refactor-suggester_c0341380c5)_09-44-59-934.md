error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10884.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10884.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10884.java
text:
```scala
T@@ypeDescriptor.valueOf(this.ctor.getDeclaringClass()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10884.java