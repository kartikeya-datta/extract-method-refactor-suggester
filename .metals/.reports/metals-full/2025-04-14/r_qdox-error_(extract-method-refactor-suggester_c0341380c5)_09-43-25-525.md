error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11271.java
text:
```scala
S@@essionManager<LocalSessionContext> manager = this.factory.createSessionManager(context, factory, new LocalSessionContextFactory());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11271.java