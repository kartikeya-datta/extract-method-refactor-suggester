error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15221.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15221.java
text:
```scala
static S@@tring getVERSION() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15221.java