error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13430.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13430.java
...
```java
offset: 604
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13430.java
text:
```scala
 ...
 *******************************************************************************/
p@@ackage org.eclipse.wst.xml.vex.core.internal.dom;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13430.java