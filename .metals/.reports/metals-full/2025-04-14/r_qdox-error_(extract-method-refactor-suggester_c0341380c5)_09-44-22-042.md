error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2307.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2307.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2307.java
text:
```scala
c@@atch (Exception e)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2307.java