error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3365.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3365.java
text:
```scala
r@@eturn getVisible () && parent.isVisible ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3365.java