error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10032.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10032.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10032.java
text:
```scala
F@@lowInfo.DEAD_END);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/10032.java