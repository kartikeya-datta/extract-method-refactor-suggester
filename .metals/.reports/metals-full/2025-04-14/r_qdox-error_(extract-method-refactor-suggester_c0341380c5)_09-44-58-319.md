error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11052.java
text:
```scala
r@@eturn container.contains(message.getReporter(), true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11052.java