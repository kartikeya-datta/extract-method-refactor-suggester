error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3211.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3211.java
text:
```scala
c@@aption.setBorder(new EmptyBorder(0,0,6,0));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3211.java