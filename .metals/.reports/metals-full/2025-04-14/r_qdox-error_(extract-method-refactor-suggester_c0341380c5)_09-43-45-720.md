error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6875.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6875.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6875.java
text:
```scala
public B@@readCrumbPanel create(MarkupContainer parent,String componentId,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6875.java