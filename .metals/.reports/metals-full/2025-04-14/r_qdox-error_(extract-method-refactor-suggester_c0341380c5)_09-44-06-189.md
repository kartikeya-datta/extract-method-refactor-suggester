error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/258.java
text:
```scala
i@@f(info.getCumulativePatchID().equals(patchId)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/258.java