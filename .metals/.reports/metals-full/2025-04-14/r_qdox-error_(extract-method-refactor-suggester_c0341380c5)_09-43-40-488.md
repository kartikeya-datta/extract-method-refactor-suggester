error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5090.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5090.java
text:
```scala
F@@ile location = ((FsIndexStore) indexStore).shardIndexLocation(shardId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5090.java