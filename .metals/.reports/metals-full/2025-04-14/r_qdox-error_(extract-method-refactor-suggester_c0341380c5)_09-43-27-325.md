error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11938.java
text:
```scala
i@@f (pointcutDef == null && onType == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11938.java