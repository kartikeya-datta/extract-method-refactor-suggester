error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4632.java
text:
```scala
r@@eturn new ScriptDocValues.Strings(getBytesValues(false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4632.java