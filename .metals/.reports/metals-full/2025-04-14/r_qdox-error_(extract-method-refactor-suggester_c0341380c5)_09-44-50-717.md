error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4765.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4765.java
text:
```scala
L@@ong collectionTimeP = _gcBean.getCollectionTime();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4765.java