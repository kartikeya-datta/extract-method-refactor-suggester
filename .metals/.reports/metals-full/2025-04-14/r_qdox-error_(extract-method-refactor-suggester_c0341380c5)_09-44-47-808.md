error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7522.java
text:
```scala
d@@ebug("createClientConnection:" + remoteSpace + ":" + data);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7522.java