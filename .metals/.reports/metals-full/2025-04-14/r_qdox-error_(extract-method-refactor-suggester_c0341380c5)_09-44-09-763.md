error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2078.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2078.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2078.java
text:
```scala
S@@ystem.out.println("Usage : java org.apache.cassandra.tools.ThreadListBuilder <directory containing files to be processed> <directory to dump the bloom filter in.>");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2078.java