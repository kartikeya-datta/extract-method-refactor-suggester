error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9384.java
text:
```scala
l@@og.info("Server was successfully reloaded");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9384.java