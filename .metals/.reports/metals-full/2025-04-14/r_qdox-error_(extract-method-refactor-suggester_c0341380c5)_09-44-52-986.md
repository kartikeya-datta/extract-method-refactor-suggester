error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3048.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3048.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3048.java
text:
```scala
t@@his.set(right, tmpUp, tmpForward.scl(-1), position);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3048.java