error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3829.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3829.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3829.java
text:
```scala
w@@ar.addAsWebInfResource(WebXml.get("<servlet>" +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3829.java