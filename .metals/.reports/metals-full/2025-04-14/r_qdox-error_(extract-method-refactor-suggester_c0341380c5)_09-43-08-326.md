error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5760.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5760.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5760.java
text:
```scala
t@@his(listener, new LwjglApplicationConfiguration());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5760.java