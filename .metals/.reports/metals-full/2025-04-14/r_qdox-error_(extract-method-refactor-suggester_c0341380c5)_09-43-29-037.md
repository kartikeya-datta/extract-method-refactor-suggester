error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/156.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/156.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/156.java
text:
```scala
p@@rocessorTarget.addDeploymentProcessor(JSFExtension.SUBSYSTEM_NAME, Phase.PARSE, Phase.POST_MODULE_JSF_MANAGED_BEANS, new JSFManagedBeanProcessor());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/156.java