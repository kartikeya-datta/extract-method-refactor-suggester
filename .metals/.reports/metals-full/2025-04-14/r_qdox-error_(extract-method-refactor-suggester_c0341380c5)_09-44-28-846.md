error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2122.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2122.java
text:
```scala
public v@@oid rename(String newName, boolean force, IProgressMonitor monitor) throws JavaModelException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2122.java