error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7785.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7785.java
text:
```scala
n@@ull, indexShard.acquireSearcher(), indexService, indexShard,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7785.java