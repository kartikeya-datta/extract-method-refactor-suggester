error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/987.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/987.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/987.java
text:
```scala
r@@egister (new BuiltinProperty (this, this, "length", ReflectionHelper.getKnownMethod (CharSequence.class, "length"), null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/987.java