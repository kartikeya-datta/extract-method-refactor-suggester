error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17876.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17876.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17876.java
text:
```scala
static final S@@tring VERSION = "1.9.20031118";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17876.java