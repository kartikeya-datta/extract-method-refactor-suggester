error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10042.java
text:
```scala
t@@his.webSocketSession = new JettyWebSocketSession(null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10042.java