error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9211.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9211.java
text:
```scala
public B@@eanIsNotAFactoryException(String name, Class<?> actualType) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9211.java