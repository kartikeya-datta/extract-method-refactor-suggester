error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8123.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8123.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8123.java
text:
```scala
r@@eturn this.docsToReferences.elementSize >= this.NUM_CHANGES;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8123.java