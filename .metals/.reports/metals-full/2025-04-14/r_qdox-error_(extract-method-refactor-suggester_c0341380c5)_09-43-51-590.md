error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3938.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3938.java
text:
```scala
d@@ocument.add(new StoredField(UidFieldMapper.NAME, uid));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3938.java