error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1840.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1840.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1840.java
text:
```scala
public static final S@@tring NAME = "indices:monitor/settings/get";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1840.java