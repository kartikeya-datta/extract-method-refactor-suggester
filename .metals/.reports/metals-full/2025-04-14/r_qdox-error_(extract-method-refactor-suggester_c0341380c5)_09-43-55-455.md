error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/577.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/577.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/577.java
text:
```scala
c@@tx.error(e.getLocalizedMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/577.java