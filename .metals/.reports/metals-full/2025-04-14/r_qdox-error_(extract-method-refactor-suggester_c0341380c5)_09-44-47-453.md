error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3195.java
text:
```scala
A@@nalysis.parseStopWords(env, settings, PersianAnalyzer.getDefaultStopSet(), version));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3195.java