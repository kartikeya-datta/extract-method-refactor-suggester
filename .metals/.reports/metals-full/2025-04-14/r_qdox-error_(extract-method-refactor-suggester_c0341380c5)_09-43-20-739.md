error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2202.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2202.java
text:
```scala
i@@f (typeOrPackageCache != null && (mask & Binding.PACKAGE) != 0) // only put not found types in cache if you know its not a package
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2202.java