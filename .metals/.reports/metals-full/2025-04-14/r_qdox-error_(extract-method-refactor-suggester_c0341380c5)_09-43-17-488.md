error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/786.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/786.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/786.java
text:
```scala
g@@amePanel.add(new LwjglCanvas(new Renderer()).getCanvas());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/786.java