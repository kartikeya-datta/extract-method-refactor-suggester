error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3522.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3522.java
text:
```scala
public v@@oid renderHead(final HtmlHeaderContainer< ? > container)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3522.java