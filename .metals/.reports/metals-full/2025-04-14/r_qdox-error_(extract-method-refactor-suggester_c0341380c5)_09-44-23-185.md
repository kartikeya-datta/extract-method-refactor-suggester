error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16762.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16762.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16762.java
text:
```scala
public I@@ResourceStream newMarkupResourceStream(Class containerClass)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16762.java