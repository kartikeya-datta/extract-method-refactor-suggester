error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4824.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4824.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4824.java
text:
```scala
s@@uper(msg, nested == null ? null : nested[0], failed);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4824.java