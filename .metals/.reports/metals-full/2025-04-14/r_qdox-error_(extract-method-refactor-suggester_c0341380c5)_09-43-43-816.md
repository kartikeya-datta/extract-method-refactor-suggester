error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5244.java
text:
```scala
q@@uerySource = Arrays.copyOfRange(querySource, querySourceOffset, querySourceOffset + querySourceLength);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5244.java