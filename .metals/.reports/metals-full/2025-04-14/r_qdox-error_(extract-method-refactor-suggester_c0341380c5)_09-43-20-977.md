error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10525.java
text:
```scala
A@@VAILABLE_LOCALE_SET = Collections.unmodifiableSet(new HashSet<Locale>(list));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10525.java