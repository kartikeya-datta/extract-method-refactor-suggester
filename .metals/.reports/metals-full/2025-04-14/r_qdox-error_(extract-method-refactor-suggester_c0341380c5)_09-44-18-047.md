error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5136.java
text:
```scala
M@@enuItem parentItem = parent.getItem(parent.getItemCount() - 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5136.java