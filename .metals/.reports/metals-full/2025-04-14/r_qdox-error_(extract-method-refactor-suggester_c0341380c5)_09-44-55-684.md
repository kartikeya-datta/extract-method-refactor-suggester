error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2989.java
text:
```scala
r@@eturn new UITest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2989.java