error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3643.java
text:
```scala
v@@iew.setToolTip(string != null ? NSString.stringWith(string) : null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3643.java