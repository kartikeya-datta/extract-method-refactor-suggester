error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2596.java
text:
```scala
r@@eturn liveDocs.cardinality();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2596.java