error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3410.java
text:
```scala
A@@jpOpenListener ajpOpenListener = new AjpOpenListener(getBufferPool().getValue(), OptionMap.builder().addAll(commonOptions).addAll(listenerOptions).set(UndertowOptions.ENABLE_CONNECTOR_STATISTICS, getUndertowService().isStatisticsEnabled()).getMap(), getBufferSize());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3410.java