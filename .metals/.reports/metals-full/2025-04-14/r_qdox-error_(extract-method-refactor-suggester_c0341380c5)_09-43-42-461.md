error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9017.java
text:
```scala
c@@ase SWT.CURSOR_WAIT: 			handle = NSCursor.arrowCursor(); break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9017.java