error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7746.java
text:
```scala
i@@f (this.indexes.addIfNotIncluded(index) == index)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7746.java