error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9424.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9424.java
text:
```scala
final S@@tring failureMessage = EjbMessages.MESSAGES.notStatefulSessionBean(beanName, appName, moduleName, distinctName).getLocalizedMessage();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9424.java