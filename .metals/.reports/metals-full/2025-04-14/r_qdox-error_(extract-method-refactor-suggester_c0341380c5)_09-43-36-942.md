error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1393.java
text:
```scala
i@@f (parameter == null || parameter.textureData == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1393.java