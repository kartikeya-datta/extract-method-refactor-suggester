error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7730.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7730.java
text:
```scala
private v@@oid copyQueryResults(HashtableOfObject categoryToWords, int newPosition) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7730.java