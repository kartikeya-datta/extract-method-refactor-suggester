error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8703.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8703.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8703.java
text:
```scala
protected static v@@oid checkOnlyOneOfElements(XMLExtendedStreamReader reader, Set<Element> seen, Element element1, Element element2) throws XMLStreamException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8703.java