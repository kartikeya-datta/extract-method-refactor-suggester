error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12354.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12354.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12354.java
text:
```scala
final C@@harSequence body = Strings.toMultilineMarkup(getModelObjectAsString());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12354.java