error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5217.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5217.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5217.java
text:
```scala
m@@ultiSearchRequest.setListenerThreaded(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5217.java