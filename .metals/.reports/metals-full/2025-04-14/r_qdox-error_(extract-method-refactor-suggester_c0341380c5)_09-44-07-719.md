error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6632.java
text:
```scala
i@@f (contextPath == null && RequestCycle.get() != null && RequestCycle.get().getRequest() instanceof WebRequest)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6632.java