error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7794.java
text:
```scala
a@@ssertTrue(isTestCaseClassLoader(getClass().getClassLoader()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7794.java