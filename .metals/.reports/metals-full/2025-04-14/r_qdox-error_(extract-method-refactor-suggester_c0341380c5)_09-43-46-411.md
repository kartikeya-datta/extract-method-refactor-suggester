error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1024.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1024.java
text:
```scala
b@@ody.applyCentralForce(Vector3.tmp.set(0f, 8.0f + (float)(6.0 * Math.random()), 0f));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1024.java