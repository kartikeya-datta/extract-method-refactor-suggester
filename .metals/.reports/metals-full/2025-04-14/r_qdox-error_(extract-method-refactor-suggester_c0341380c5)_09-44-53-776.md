error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9494.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9494.java
...
```java
offset: 1057
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9494.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.test.integration.osgi.resource;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9494.java