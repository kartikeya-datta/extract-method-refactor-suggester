error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15036.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15036.java
text:
```scala
r@@eturn availableLocaleList().contains(locale);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15036.java