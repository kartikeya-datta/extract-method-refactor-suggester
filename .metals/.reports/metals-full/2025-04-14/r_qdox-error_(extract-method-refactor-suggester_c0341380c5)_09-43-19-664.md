error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14571.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14571.java
text:
```scala
g@@etRequestCycle().setResponsePage(StatefulPage.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14571.java