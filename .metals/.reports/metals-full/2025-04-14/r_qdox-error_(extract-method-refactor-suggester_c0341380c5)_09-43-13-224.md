error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5699.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5699.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5699.java
text:
```scala
i@@f (getApplication().usesDevelopmentConfig())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5699.java