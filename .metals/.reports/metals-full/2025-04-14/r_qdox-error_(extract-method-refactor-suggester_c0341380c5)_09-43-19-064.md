error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8562.java
text:
```scala
c@@lonedElement.setProperty((JMeterProperty)iter.next().clone());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8562.java