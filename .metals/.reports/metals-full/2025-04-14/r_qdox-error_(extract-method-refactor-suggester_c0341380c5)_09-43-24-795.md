error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6420.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6420.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6420.java
text:
```scala
i@@f (sig == null) sig = methodBinding.signature();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6420.java