error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14036.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14036.java
text:
```scala
public synchronized O@@utboundBridgeRecoveryManager getValue() throws IllegalStateException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14036.java