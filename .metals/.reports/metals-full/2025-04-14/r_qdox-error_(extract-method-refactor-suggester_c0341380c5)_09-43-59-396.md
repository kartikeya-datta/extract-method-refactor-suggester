error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8607.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8607.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8607.java
text:
```scala
r@@eturn ThreadPool.Names.CACHED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8607.java