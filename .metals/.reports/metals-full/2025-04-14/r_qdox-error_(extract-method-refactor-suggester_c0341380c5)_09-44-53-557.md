error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6566.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6566.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6566.java
text:
```scala
S@@tring value = Application.get().getResourceSettings().getLocalizer().getString(messageKey,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6566.java