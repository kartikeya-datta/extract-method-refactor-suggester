error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/497.java
text:
```scala
i@@tem.setText(WorkbenchMessages.PartPane_size);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/497.java