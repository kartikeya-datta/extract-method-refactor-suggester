error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6259.java
text:
```scala
s@@uper(Integer.toString(index).intern(), model);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6259.java