error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11306.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11306.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11306.java
text:
```scala
v@@oid onUnauthorizedInstantiation(Component component);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11306.java