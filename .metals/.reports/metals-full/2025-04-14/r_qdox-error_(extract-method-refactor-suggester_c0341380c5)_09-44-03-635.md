error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2531.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2531.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2531.java
text:
```scala
r@@fa.activate();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2531.java