error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9145.java
text:
```scala
S@@tring[] actualIndices = currentState.metaData().concreteIndices(request.indices(), IndicesOptions.strictExpand());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9145.java