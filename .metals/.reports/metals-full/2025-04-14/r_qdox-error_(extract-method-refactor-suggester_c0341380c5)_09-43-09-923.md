error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4529.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4529.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4529.java
text:
```scala
v@@alue = new Primitive(new Character(ch).charValue());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4529.java