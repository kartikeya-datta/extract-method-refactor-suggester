error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9743.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9743.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9743.java
text:
```scala
b@@uilder = new CSVFormatBuilder('+', Character.valueOf('!'), null, Character.valueOf('#'), Character.valueOf('!'), true, true, CRLF, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9743.java