error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17091.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17091.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17091.java
text:
```scala
S@@tring value = Application.get().getMarkupSettings().getLocalizer().getString(messageKey,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17091.java