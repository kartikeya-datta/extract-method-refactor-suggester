error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11295.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11295.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11295.java
text:
```scala
public C@@omponent restoreComponent(String id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11295.java