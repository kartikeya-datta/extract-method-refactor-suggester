error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3150.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3150.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3150.java
text:
```scala
p@@utMappingRequest.source(request.content().toUtf8());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3150.java