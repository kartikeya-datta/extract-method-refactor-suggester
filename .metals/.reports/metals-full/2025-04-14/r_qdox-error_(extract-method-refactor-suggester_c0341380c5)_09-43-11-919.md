error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3784.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3784.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3784.java
text:
```scala
r@@equestBuilder.setField("document.simple");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3784.java