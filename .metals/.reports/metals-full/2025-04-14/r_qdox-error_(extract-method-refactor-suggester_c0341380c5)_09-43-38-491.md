error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7635.java
text:
```scala
r@@eturn "swt-xulrunner"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7635.java