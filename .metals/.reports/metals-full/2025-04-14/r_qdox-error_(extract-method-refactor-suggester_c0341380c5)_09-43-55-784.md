error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8950.java
text:
```scala
c@@odeStream.newArray(binding);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8950.java