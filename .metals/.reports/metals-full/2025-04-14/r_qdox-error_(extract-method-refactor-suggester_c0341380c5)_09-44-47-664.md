error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5256.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5256.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5256.java
text:
```scala
r@@eturn Long.compare(v1, v2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5256.java