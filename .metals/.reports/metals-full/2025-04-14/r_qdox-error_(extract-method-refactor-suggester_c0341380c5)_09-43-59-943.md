error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2070.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2070.java
text:
```scala
i@@f (commentString.indexOf("@deprecated") >= 0) { //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2070.java