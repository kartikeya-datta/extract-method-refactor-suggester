error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10157.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10157.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10157.java
text:
```scala
s@@etModelObject(getConverter().convert(getInput(), type));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10157.java