error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9183.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9183.java
text:
```scala
protected b@@oolean isInfrastructureClass(Class<?> beanClass) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9183.java