error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1345.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1345.java
text:
```scala
public v@@oid update (E entity);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1345.java