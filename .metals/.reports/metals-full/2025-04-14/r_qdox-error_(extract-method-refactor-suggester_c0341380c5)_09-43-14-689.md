error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/647.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/647.java
text:
```scala
public T@@ime convertToObject(final String value, Locale locale)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/647.java