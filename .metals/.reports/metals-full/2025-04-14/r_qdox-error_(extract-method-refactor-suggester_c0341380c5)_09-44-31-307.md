error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6562.java
text:
```scala
i@@f ( !(behaviorOwner instanceof Page) && behaviorOwner.findParent(Page.class) == null)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6562.java