error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17356.java
text:
```scala
N@@SBezierPath.bezierPathWithRect(rect).addClip();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17356.java