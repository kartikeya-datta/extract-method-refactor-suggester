error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13237.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13237.java
text:
```scala
static M@@odelNode createOperation(ModelNode address, ModelNode model) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13237.java