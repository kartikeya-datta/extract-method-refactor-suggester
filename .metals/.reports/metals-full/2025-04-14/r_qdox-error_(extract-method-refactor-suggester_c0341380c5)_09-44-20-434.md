error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9826.java
text:
```scala
W@@orkbenchHelp.setHelp(this, IWorkbenchHelpContextIds.ACTIVATE_EDITOR_ACTION);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9826.java