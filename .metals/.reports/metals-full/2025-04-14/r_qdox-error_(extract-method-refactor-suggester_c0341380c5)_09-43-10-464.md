error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1439.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1439.java
text:
```scala
p@@rivileges = (PrivilegeNode) privileges.bind( new HashMap(), grantees, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1439.java