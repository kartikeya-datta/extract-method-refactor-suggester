error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16675.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16675.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16675.java
text:
```scala
i@@f (columns.length == 0) updateHorizontalBar ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16675.java