error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8505.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8505.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8505.java
text:
```scala
t@@his.clipboard = Clipboard.getDefaultKeyboard();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8505.java