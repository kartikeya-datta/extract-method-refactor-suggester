error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4647.java
text:
```scala
c@@ase id.m_edit:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4647.java