error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7962.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7962.java
text:
```scala
t@@his.registry = new ServletStompEndpointRegistry(webSocketHandler, queueSuffixResolver, taskScheduler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7962.java