error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7344.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7344.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7344.java
text:
```scala
c@@ase ST.BULLET_NUMBER: string = String.valueOf(index + 1); break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7344.java