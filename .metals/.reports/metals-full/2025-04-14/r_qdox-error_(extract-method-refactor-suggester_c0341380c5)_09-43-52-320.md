error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6535.java
text:
```scala
S@@tring fileName = "data/models/ninja.mesh.xml";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6535.java