error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15938.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15938.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15938.java
text:
```scala
private final S@@tring value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15938.java