error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4431.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4431.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4431.java
text:
```scala
R@@equestCycle.registerRequestListenerInterface(new RequestListenerInterface(IResourceListener.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4431.java