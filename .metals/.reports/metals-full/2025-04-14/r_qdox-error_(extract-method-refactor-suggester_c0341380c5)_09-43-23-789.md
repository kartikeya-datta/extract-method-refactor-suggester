error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8443.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8443.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8443.java
text:
```scala
i@@f ((style & SWT.VIRTUAL) == 0) customDraw = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8443.java