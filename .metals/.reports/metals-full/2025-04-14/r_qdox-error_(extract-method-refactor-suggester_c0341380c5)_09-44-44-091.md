error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2465.java
text:
```scala
r@@eturn getKey(this, true/*with access flags*/, forceOpen);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2465.java