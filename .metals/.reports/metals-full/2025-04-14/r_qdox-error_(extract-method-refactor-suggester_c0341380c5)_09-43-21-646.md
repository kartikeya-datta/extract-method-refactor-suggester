error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8600.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8600.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8600.java
text:
```scala
i@@f (!ignoreDrawBackground && !ignoreDrawSelection && clrTextBk != -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8600.java