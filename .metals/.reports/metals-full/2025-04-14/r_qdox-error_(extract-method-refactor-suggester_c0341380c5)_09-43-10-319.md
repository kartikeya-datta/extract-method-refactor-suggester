error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4110.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4110.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4110.java
text:
```scala
i@@f (time != null && time.getMilliseconds() != -1)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4110.java