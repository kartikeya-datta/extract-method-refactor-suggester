error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8597.java
text:
```scala
r@@eturn CollectionFactory.createLinkedCaseInsensitiveMapIfPossible(columnCount);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8597.java