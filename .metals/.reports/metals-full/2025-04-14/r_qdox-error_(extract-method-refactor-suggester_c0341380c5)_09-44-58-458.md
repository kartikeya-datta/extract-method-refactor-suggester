error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13781.java
text:
```scala
S@@erviceName serviceName = XADataSourceConfigService.SERVICE_NAME_BASE.append(jndiName).append("xa-datasource-properties").append(configPropertyName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13781.java