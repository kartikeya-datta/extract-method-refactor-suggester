error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3086.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3086.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3086.java
text:
```scala
public static final P@@athElement REMOTE_STORE_PATH = PathElement.pathElement(ModelKeys.REMOTE_STORE, ModelKeys.REMOTE_STORE_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3086.java