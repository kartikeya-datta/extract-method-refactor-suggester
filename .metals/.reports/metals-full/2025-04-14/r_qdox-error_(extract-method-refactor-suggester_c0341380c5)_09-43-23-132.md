error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/222.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/222.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/222.java
text:
```scala
M@@anagementResourceRegistration deployments = resourceRegistration.registerSubModel(ServerDeploymentResourceDefinition.create(contentRepository, vaultReader));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/222.java