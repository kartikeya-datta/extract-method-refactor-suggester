error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3388.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3388.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3388.java
text:
```scala
final M@@arkupElement tag = getNextFilter().nextTag();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3388.java