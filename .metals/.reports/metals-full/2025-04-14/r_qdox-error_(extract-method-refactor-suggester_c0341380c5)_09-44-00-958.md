error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13966.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13966.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13966.java
text:
```scala
final S@@erviceTarget target = context.getServiceTarget();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13966.java