error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1305.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1305.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1305.java
text:
```scala
U@@UID("uuid", "com.arjuna.ats.internal.arjuna.utils.UuidProcessId"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1305.java