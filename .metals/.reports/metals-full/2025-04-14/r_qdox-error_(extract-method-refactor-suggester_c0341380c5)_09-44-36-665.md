error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5755.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5755.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5755.java
text:
```scala
protected v@@oid onBeforeRenderChildren()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5755.java