error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1093.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1093.java
text:
```scala
S@@electFolderDialog dialog = new SelectFolderDialog(frameController);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1093.java