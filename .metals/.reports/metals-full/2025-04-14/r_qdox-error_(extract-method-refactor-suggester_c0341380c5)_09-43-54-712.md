error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7704.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7704.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7704.java
text:
```scala
n@@ew Label(item, componentId, createLabelModel(model));

/*
 * $Id: PropertyColumn.java 5840 2006-05-24 20:49:09 +0000 (Wed, 24 May 2006)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7704.java