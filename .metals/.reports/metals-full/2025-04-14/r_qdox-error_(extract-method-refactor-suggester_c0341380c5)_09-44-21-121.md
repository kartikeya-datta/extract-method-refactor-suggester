error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3689.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3689.java
text:
```scala
final i@@nt iters = scaledRandomIntBetween(10000, 100000);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3689.java