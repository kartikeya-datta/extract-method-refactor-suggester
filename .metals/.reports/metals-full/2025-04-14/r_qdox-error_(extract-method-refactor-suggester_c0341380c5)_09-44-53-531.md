error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15071.java
text:
```scala
c@@ontainer.getVariation(), container.getMarkupType().getExtension());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15071.java