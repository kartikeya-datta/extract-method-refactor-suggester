error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9378.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9378.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9378.java
text:
```scala
L@@OGGER.info("Testing successful authentication - " + servletURL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9378.java