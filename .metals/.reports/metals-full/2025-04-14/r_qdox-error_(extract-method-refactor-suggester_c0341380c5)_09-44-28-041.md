error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/112.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/112.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/112.java
text:
```scala
c@@lient.get(getRequest, new ActionListener<GetResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/112.java