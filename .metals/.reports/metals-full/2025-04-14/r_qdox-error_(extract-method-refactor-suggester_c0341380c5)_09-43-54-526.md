error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16841.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16841.java
text:
```scala
final I@@Crypt crypt = application.newCrypt();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16841.java