error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17782.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17782.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[120,80]

error in qdox parser
file content:
```java
offset: 3697
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17782.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17782.java