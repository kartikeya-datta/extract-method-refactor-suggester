error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3160.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3160.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3160.java
text:
```scala
i@@f (virtualFile.getName().toLowerCase().endsWith(EAR_EXTENSION)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3160.java