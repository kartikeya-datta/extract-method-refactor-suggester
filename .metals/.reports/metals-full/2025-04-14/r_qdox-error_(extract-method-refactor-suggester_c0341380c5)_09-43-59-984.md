error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6668.java
text:
```scala
t@@extsToHighlight = lookup.source().extractRawValues(mapper.names().sourcePath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6668.java