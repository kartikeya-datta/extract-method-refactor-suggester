error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1285.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1285.java
text:
```scala
W@@orkbenchPlugin.log(getClass(), "show(Job)", e); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1285.java