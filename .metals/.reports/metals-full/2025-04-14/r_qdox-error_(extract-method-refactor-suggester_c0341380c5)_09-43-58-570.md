error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5480.java
text:
```scala
c@@ompressedData = BufferUtils.newDisposableByteBuffer((int)pkmFile.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5480.java