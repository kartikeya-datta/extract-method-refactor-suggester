error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/322.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/322.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/322.java
text:
```scala
f@@ont.drawMultiLine(batch, message, 20, Gdx.graphics.getHeight() - 20);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/322.java