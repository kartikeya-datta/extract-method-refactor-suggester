error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6567.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6567.java
...
```java
offset: 795
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6567.java
text:
```scala
...
p@@ackage com.badlogic.gdx.tests.android;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6567.java