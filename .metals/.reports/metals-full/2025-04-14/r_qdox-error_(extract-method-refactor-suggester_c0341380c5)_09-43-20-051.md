error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9372.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9372.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9372.java
text:
```scala
t@@hrow new RuntimeException("Expected an EJBTransactionRequiredException");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9372.java