error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4453.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4453.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4453.java
text:
```scala
I@@ClasspathEntry[] entries= getJavaProject().getExpandedClasspath(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4453.java