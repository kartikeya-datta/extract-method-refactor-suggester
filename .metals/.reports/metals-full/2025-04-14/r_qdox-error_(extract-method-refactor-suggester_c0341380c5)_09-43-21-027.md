error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2077.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2077.java
text:
```scala
s@@essionState.out.println("      Compaction Strategy Options:");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2077.java