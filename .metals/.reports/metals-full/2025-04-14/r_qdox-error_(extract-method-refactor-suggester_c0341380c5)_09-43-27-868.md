error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1953.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1953.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1953.java
text:
```scala
l@@ogger.debug("{}: failed to execute [{}]", t, shard != null ? shard.shortSummary() : shardIt.shardId(), request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1953.java