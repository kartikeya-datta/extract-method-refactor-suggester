error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3277.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3277.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3277.java
text:
```scala
i@@f (parentFieldMapper.active()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3277.java