error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2673.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2673.java
text:
```scala
i@@nt adjustYear(int twoDigitYear) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2673.java