error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5582.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5582.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5582.java
text:
```scala
p@@rocessController.addProcess(HOST_CONTROLLER_PROCESS_NAME, initialCommand, Collections.<String, String>emptyMap(), currentWorkingDir, true, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5582.java