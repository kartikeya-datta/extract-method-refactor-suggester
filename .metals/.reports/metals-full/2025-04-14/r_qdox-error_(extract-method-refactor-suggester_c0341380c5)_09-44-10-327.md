error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5850.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5850.java
text:
```scala
final S@@tring enc = mock.calculateHttpEncoding(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5850.java