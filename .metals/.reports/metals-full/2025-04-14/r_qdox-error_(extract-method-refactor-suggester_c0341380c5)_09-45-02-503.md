error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8421.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8421.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8421.java
text:
```scala
s@@uper(numericTokenStream, reader);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8421.java