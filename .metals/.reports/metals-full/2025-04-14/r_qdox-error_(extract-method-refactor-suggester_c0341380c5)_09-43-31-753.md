error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/43.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/43.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/43.java
text:
```scala
S@@ortedDocValues docValues = MultiDocValues.getSortedValues(reader, "field");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/43.java