error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10174.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10174.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10174.java
text:
```scala
final static S@@tring[] GDX_VERSIONS = {"0.9.9", "1.0-SNAPSHOT"};
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10174.java