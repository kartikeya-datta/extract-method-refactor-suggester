error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4767.java
text:
```scala
t@@hrow new ECFException(NLS.bind(Messages.RegistrySharedObject_19, Long.toString(call.getTimeout())), new TimeoutException(call.getTimeout()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4767.java