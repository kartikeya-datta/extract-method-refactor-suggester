error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7564.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7564.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7564.java
text:
```scala
t@@ypeBinding = nameRef.actualReceiverType;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7564.java