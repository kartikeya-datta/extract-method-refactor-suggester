error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10442.java
text:
```scala
B@@oolean replacement = deploymentUnit.getAttachment(Attachments.EJB_ANNOTATION_PROPERTY_REPLACEMENT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10442.java