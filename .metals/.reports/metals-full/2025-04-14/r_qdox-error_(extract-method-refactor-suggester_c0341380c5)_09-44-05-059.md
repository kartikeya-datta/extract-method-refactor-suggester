error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4411.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4411.java
text:
```scala
public I@@Folder getFolderByName(String name) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4411.java