error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3910.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3910.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3910.java
text:
```scala
f@@or (int i = 0; i < (cluster().size() * 5); i++) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3910.java