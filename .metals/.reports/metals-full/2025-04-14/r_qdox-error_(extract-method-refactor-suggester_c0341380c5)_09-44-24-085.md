error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2292.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2292.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2292.java
text:
```scala
f@@or (int i = 2; i < pointArray.length; i += 2) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2292.java