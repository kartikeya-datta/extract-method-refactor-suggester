error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2641.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2641.java
text:
```scala
d@@os.write(Keytab.VERSION_0X502_BYTES);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2641.java