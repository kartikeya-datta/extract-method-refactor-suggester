error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7183.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7183.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7183.java
text:
```scala
t@@hrow new AbortMethod(scope.referenceCompilationUnit().compilationResult, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7183.java