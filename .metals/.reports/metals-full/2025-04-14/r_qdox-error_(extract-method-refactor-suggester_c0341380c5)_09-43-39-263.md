error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3439.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3439.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3439.java
text:
```scala
public final i@@nt getLineNumber(int position) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3439.java