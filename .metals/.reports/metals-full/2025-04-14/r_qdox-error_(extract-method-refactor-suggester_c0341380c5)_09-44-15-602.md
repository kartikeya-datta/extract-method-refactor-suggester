error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17090.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17090.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17090.java
text:
```scala
final I@@ResourceFactory factory = application.getResourceSettings().getResourceFactory(factoryName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17090.java