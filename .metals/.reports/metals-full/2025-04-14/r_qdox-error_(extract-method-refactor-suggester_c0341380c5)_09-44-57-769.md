error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3789.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3789.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3789.java
text:
```scala
public static final c@@har JEM_PACKAGEFRAGMENTROOT= IPath.SEPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3789.java