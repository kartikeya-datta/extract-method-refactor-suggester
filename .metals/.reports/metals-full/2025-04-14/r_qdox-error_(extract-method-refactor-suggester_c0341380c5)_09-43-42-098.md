error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6.java
text:
```scala
r@@eturn Util.bind("operation.renameResourceProgress"/*nonNLS*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6.java