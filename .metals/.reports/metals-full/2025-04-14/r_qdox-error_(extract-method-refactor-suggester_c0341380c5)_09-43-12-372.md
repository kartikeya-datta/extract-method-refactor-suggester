error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2770.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2770.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2770.java
text:
```scala
S@@tring file = DatabaseDescriptor.getDataFileLocation() + File.separator + newFileName + "-Data.db";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2770.java