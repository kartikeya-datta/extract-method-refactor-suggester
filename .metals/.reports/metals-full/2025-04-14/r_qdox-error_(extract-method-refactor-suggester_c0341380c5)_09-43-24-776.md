error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10171.java
text:
```scala
r@@esult.get("content").get(0).get("input-stream-index").set(index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10171.java