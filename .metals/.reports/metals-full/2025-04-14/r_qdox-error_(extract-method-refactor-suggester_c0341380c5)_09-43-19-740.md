error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3379.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3379.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3379.java
text:
```scala
public static R@@GB getColorValue(String rawValue) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3379.java