error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13822.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13822.java
text:
```scala
n@@ew CallAS7("dump-services").operation("dump-services").resource("core-service", "service-container"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13822.java