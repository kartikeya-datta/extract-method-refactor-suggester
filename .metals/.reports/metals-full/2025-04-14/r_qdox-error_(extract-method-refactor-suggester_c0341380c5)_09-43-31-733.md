error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3562.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3562.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3562.java
text:
```scala
s@@hardStatus.docs = new DocsStatus();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3562.java