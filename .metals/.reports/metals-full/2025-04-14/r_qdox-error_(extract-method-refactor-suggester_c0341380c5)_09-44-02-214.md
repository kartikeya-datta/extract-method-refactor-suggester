error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3608.java
text:
```scala
i@@f (receiverType.id != T_JavaLangObject
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3608.java