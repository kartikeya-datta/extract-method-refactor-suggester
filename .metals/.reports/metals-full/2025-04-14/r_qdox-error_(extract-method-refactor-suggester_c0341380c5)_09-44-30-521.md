error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5939.java
text:
```scala
b@@uildFileForReadableName(READABLE_NAMES_FILE+".props", newLhs, newNonTerminalIndex, newName, tokens);//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5939.java