error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17837.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17837.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17837.java
text:
```scala
i@@f (requestCycle.isRedirect())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17837.java