error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6232.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6232.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6232.java
text:
```scala
public static v@@oid unbind () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6232.java