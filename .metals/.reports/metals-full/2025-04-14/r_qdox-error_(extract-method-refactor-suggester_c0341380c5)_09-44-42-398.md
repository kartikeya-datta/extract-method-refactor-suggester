error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1868.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1868.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1868.java
text:
```scala
M@@ARSHALLER_FACTORY = Marshalling.getMarshallerFactory("river", Module.getModuleFromCallerModuleLoader(ModuleIdentifier.fromString("org.jboss.marshalling.river")).getClassLoader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1868.java