error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7030.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7030.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7030.java
text:
```scala
static final S@@tring URL_JAVA = "http://java.sun.com/products/plugin/"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7030.java