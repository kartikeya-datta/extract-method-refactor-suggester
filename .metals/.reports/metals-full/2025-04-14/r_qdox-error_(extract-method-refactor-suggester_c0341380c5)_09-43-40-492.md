error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5195.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5195.java
text:
```scala
public S@@tring getHotThreads() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5195.java