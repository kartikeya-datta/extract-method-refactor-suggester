error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5722.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5722.java
text:
```scala
r@@eturn (int)/*64*/((NSComboBox)view).indexOfSelectedItem();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5722.java