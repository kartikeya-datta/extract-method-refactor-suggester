error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7673.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7673.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7673.java
text:
```scala
public static final C@@lass<? extends MergeSchedulerProvider> DEFAULT = SerialMergeSchedulerProvider.class;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7673.java