error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2595.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2595.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2595.java
text:
```scala
p@@ublic class AdminInternalPage extends BasePage<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2595.java