error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13952.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13952.java
text:
```scala
private v@@oid setCharsetName(String charsetName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13952.java