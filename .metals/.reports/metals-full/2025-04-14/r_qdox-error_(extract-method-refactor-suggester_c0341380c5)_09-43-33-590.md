error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4440.java
text:
```scala
F@@uzzyBoolean matches = ap.matchesRuntimeType(someArgs[argsIndex]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4440.java