error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/265.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/265.java
text:
```scala
private static final T@@imestampReconciler reconciler = TimestampReconciler.instance;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/265.java