error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16894.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16894.java
text:
```scala
final I@@ResourceStream resource = Application.get().getResourceSettings().getResourceStreamFactory().locate(this.getClass(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16894.java