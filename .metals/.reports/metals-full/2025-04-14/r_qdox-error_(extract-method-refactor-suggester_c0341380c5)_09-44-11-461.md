error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6270.java
text:
```scala
n@@ew ConfigFrame(getFrameMediator().getView().getFrame(), vfolder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6270.java