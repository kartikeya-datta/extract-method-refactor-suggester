error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7272.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7272.java
text:
```scala
e@@rror = SlaveRegistrationError.formatHostAlreadyExists(e.getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7272.java