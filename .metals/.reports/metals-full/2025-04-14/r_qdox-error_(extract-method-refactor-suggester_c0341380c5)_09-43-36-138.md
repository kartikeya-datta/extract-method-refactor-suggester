error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9134.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9134.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9134.java
text:
```scala
c@@ountRequest.query(RestActions.parseQuerySource(request));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9134.java