error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11271.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11271.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11271.java
text:
```scala
p@@ublic class DynamicPage extends WicketExamplePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11271.java