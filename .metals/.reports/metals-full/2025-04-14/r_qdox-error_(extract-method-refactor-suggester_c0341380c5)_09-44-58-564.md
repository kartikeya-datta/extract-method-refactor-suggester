error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17657.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17657.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[150,80]

error in qdox parser
file content:
```java
offset: 3893
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17657.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17657.java