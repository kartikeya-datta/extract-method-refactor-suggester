error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1077.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1077.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1077.java
text:
```scala
public H@@andler handler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1077.java