error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7274.java
text:
```scala
r@@et = Double.valueOf(value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7274.java