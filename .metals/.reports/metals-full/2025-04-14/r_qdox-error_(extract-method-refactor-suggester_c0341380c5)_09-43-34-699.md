error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/212.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/212.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/212.java
text:
```scala
E@@xposeModelResourceExpression(JmxManagedAuditLogger auditLoggerInfo) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/212.java