error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2587.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2587.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2587.java
text:
```scala
protected M@@essaging20SubsystemParser() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2587.java