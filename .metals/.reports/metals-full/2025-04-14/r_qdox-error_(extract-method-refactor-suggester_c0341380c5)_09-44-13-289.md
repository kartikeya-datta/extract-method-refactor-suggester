error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12773.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12773.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12773.java
text:
```scala
public v@@oid testVarargsNPE_pr120826() { runTest("varargs NPE");}
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12773.java