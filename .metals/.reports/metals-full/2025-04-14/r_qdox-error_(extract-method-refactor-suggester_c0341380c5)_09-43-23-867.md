error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3808.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3808.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3808.java
text:
```scala
public S@@erverCommunicationHandler getServerCommunicationHandler(ServerEnvironment environment, MessageHandler handler) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3808.java