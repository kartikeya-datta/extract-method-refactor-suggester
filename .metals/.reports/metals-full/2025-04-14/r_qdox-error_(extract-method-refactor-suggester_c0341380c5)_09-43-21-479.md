error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/559.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/559.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/559.java
text:
```scala
f@@or (int i = memberTypes.length; --i >= 0;)//TODO: (kent) should iterate in syntactical order
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/559.java