error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/746.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/746.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/746.java
text:
```scala
n@@ew AnonymousLocalTypeDeclaration(this.compilationUnit.compilationResult);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/746.java