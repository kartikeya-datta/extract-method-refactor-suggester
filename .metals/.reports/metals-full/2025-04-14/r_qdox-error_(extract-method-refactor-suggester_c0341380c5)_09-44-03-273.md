error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9988.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9988.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9988.java
text:
```scala
S@@erverMessages.MESSAGES.missingModulePrefix(identifier, ServiceModuleLoader.MODULE_PREFIX);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9988.java