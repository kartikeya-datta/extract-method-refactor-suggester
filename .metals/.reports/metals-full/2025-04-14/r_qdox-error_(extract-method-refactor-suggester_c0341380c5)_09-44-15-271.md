error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6799.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6799.java
text:
```scala
private static final f@@loat CORNER_RADIUS_IN_DIP = 6;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6799.java