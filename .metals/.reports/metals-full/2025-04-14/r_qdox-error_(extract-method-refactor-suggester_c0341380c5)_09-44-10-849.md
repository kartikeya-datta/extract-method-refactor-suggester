error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3152.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3152.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3152.java
text:
```scala
p@@utRequest.source(request.content());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3152.java