error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7629.java
text:
```scala
i@@f (this.pattern.parameterSimpleNames != null && !this.pattern.varargs) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7629.java