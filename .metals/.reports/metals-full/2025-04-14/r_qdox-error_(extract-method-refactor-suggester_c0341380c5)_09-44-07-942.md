error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4129.java
text:
```scala
L@@ist<String> gets = Arrays.asList("/app1/wicket/bookmarkable/org.apache.wicket.threadtest.apps.app1.Home");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4129.java