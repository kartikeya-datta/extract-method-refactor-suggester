error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1924.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1924.java
text:
```scala
i@@f (other.type != other.type) return false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1924.java