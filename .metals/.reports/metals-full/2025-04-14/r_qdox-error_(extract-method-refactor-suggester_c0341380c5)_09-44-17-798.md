error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14486.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14486.java
text:
```scala
final S@@erviceController<?> controller = updateContext.getServiceRegistry().getService(ThreadsServices.executorName(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14486.java