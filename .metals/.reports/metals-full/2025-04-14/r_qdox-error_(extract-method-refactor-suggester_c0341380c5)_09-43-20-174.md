error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7381.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7381.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7381.java
text:
```scala
w@@indow.setFrame(frame, isVisible());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7381.java