error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17291.java
text:
```scala
t@@hrow getException(_loc.get("invalid-class", name).getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17291.java