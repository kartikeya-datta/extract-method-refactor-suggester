error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6913.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6913.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6913.java
text:
```scala
f@@inalConfirm, false, w);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6913.java