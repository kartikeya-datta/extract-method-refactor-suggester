error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4830.java
text:
```scala
p@@ublic interface IBookmarkablePageRequestTarget extends IRequestTarget, ISessionSynchronizable, IAccessCheckingTarget
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4830.java