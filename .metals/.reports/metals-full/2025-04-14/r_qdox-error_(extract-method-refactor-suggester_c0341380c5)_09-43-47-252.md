error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/976.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/976.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/976.java
text:
```scala
final S@@tring beanName = this.context.getBeanClass().getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/976.java