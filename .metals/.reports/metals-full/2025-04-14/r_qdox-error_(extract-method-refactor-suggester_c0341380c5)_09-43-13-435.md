error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/221.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/221.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/221.java
text:
```scala
S@@tring m = ExceptionQueryTst.getFailQueries(exceptionQueries, verbose);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/221.java