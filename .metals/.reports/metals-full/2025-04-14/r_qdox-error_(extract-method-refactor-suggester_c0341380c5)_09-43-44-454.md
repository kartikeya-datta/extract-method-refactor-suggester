error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/589.java
text:
```scala
s@@erver.enqueue(msgs);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/589.java