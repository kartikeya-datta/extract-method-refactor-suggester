error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5632.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5632.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5632.java
text:
```scala
C@@ontext ctx=contextM.createContext();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5632.java