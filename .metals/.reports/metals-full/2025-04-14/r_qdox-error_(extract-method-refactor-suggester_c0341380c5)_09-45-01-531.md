error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8080.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8080.java
text:
```scala
r@@eturn new FieldDataType("float", getFieldDataSettings());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8080.java