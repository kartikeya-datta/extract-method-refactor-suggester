error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/596.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/596.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/596.java
text:
```scala
c@@reateErrorFor(resource, Util.bind("build.duplicateResource")); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/596.java