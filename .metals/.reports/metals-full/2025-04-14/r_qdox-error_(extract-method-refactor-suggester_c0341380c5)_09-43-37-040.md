error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2475.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2475.java
text:
```scala
f@@or (
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2475.java