error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/319.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/319.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/319.java
text:
```scala
public final static i@@nt COMMENT_ARRAYS_SIZE = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/319.java