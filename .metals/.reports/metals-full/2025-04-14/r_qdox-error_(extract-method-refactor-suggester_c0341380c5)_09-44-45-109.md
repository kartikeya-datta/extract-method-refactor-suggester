error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9895.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9895.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9895.java
text:
```scala
e@@ntry.execute(message, sender);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9895.java