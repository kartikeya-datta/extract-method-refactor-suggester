error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16432.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16432.java
...
```java
offset: 44
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16432.java
text:
```scala
+ "|(?:IMG|SCRIPT|FRAME|IFRAME|BGSOUND)" + S@@EP + "SRC" + VALUE
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16432.java