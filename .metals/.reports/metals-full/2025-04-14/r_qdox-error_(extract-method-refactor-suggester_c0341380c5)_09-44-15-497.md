error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5285.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5285.java
text:
```scala
c@@ontacts[i++] = (long long)contact;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5285.java