error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4015.java
text:
```scala
w@@riteLong(Double.doubleToLongBits(v));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4015.java