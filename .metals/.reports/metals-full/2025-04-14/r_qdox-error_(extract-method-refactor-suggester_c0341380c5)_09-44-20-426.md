error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11663.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11663.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11663.java
text:
```scala
private final S@@tring PATCH_ID = PatchResourceDefinition.PATCH_ID.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11663.java