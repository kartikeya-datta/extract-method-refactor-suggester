error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7832.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7832.java
text:
```scala
o@@ut.print(usage("appclient"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7832.java