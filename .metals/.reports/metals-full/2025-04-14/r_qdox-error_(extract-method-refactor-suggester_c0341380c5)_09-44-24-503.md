error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15314.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15314.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15314.java
text:
```scala
final R@@esource deploymentResource = context.readResourceFromRoot(PathAddress.pathAddress(PathElement.pathElement(DEPLOYMENT, name)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15314.java