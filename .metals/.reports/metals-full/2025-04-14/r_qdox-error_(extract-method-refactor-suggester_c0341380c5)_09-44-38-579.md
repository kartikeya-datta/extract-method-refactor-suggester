error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13894.java
text:
```scala
r@@eader.seek(position); // cannot be null here
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13894.java