error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8764.java
text:
```scala
H@@OST_CONTROLLER_LOGGER.tracef("ParsedResult for remote host %s is %s", entry.getKey(), result);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8764.java