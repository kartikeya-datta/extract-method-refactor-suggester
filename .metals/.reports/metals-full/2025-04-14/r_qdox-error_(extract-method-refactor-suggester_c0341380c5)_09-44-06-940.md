error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12031.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12031.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12031.java
text:
```scala
private static S@@TSType toSAMLConfig(OperationContext context, ModelNode fromModel) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12031.java