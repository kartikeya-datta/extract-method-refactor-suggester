error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/113.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/113.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/113.java
text:
```scala
protected F@@astIDSet doGetCandidateItems(long[] preferredItemIDs, DataModel dataModel) throws TasteException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/113.java