error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3790.java
text:
```scala
r@@eturn new Object[]{ p.x, p.y };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3790.java