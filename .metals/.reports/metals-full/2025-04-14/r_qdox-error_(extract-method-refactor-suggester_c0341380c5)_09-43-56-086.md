error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17898.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17898.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17898.java
text:
```scala
i@@f (accessibleTextListeners.size() > 0 || accessibleTextExtendedListeners.size() > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17898.java