error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5726.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5726.java
text:
```scala
c@@mdRegistry.registerHandler(new HelpHandler(cmdRegistry), "help", "h");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5726.java