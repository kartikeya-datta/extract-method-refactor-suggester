error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10234.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10234.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10234.java
text:
```scala
S@@tring url = "/" + getRequest().getUrl();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10234.java