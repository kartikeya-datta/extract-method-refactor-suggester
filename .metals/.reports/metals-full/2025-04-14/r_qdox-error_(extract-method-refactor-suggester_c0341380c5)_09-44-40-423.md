error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6071.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6071.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6071.java
text:
```scala
h@@dItem.iImage = parent.imageIndex (image, index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6071.java