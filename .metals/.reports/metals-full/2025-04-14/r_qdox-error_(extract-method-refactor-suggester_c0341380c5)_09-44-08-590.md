error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3635.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3635.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3635.java
text:
```scala
i@@nt size = buffer.capacity();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3635.java