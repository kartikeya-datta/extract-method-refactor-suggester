error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7166.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7166.java
text:
```scala
G@@eoDistance distanceType = GeoDistance.DEFAULT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7166.java