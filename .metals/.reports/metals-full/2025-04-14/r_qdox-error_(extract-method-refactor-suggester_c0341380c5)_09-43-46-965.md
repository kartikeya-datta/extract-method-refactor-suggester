error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17849.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17849.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17849.java
text:
```scala
static final T@@CHAR LinkClass = new TCHAR (0, OS.WC_LINK, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17849.java