error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4099.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4099.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4099.java
text:
```scala
E@@xecutableScript executable = scriptService.executable("native", "my", ScriptService.ScriptType.INLINE, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4099.java