error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6411.java
text:
```scala
M@@essageDialog.openError(shell, Messages.AbstractCoreModelTransformerAction_PluginName, e.getMessage());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6411.java