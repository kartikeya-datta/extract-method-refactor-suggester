error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/973.java
text:
```scala
m@@odel.setEmptyObject();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/973.java