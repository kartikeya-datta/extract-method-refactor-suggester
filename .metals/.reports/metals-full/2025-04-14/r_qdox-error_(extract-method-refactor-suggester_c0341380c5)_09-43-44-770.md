error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1826.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1826.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1826.java
text:
```scala
f@@or (ModuleDependency dependency : moduleSpec.getAllDependencies()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1826.java