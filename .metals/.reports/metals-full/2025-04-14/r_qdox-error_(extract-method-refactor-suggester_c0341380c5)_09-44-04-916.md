error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1516.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1516.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1516.java
text:
```scala
final P@@ostingsFormat defaultFormat = new Elasticsearch090PostingsFormat();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1516.java