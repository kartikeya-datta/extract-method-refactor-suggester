error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/384.java
text:
```scala
r@@eturn getDeclaringClass().getName() + "." + getName(); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/384.java