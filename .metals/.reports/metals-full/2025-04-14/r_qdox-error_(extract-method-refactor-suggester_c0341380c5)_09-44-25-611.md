error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4902.java
text:
```scala
t@@his.blockExit = (flowInfo.tagBits & FlowInfo.UNREACHABLE) != 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4902.java