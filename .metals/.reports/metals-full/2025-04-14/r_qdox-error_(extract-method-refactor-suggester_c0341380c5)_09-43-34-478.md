error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8498.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8498.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8498.java
text:
```scala
r@@eturn buffer.limit() / (attributes.vertexSize / 4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8498.java