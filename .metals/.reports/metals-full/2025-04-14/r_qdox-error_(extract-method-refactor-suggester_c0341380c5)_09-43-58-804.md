error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1785.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1785.java
...
```java
offset: 12
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1785.java
text:
```scala
/*public*/ i@@nt getPosition (Point point) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1785.java