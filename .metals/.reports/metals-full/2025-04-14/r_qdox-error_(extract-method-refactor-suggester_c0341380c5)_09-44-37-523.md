error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12830.java
...
```java
offset: 1082
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12830.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.test.integration.web.security;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12830.java