error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11556.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11556.java
text:
```scala
public static final O@@bject TOPOLOGY_KRYO_REGISTER_SCHEMA = ConfigValidation.KryoRegValidator;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11556.java