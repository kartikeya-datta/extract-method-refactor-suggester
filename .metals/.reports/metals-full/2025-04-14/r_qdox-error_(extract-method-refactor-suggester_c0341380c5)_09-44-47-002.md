error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11276.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11276.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11276.java
text:
```scala
r@@eturn delegate.getInvocationTimeout();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11276.java