error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/245.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/245.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/245.java
text:
```scala
E@@jbLogger.ROOT_LOGGER.debug("Trying to recover an imported transaction for Xid " + this.xidTransactionID.getXid());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/245.java