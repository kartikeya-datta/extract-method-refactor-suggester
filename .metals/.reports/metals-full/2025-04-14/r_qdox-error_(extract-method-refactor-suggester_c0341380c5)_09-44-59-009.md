error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2528.java
text:
```scala
t@@arget.add(submit);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2528.java