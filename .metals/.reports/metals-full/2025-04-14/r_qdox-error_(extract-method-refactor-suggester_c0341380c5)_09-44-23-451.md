error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10179.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10179.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10179.java
text:
```scala
l@@ogger.warn("received ping response {} with no matching id [{}]", pingResponse, response.id);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10179.java