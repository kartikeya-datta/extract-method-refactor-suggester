error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2500.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2500.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2500.java
text:
```scala
t@@arget.add(outer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2500.java