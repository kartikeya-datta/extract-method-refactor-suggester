error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9411.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9411.java
text:
```scala
i@@f (!StringUtils.hasLength(mbd.getScope())) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9411.java