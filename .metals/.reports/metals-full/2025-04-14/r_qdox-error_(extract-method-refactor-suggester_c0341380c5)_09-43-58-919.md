error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1480.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1480.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1480.java
text:
```scala
a@@ssert Arrays.equals(rr.rows.get(0).key.key, "key".getBytes());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1480.java