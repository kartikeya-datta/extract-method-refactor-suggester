error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2162.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2162.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2162.java
text:
```scala
r@@eplaceComponentTagBody(markupStream, openTag, getModelObjectAsString(label.getObject()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2162.java