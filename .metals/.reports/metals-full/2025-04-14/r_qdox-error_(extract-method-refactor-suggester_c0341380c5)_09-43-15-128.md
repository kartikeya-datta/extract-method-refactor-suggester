error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6519.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6519.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6519.java
text:
```scala
r@@eturn returnValue;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6519.java