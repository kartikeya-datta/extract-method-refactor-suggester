error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13265.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13265.java
text:
```scala
c@@ontext.addStep(targetOperation, CustomLoadMetricAdd.INSTANCE, OperationContext.Stage.MODEL, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13265.java