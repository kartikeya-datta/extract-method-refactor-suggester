error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3816.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3816.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3816.java
text:
```scala
c@@lientConnectionManager.setMaxTotal(cfg.getMaxUpdateConnections());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3816.java