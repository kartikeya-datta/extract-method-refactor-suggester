error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10084.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10084.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10084.java
text:
```scala
S@@cheduledThreadPoolExecutor.class, "setRemoveOnCancelPolicy", boolean.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10084.java