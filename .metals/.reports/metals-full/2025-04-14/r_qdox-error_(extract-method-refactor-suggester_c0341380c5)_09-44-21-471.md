error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1751.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1751.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1751.java
text:
```scala
i@@nt maxWidth = control.getBounds().width - 5;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1751.java