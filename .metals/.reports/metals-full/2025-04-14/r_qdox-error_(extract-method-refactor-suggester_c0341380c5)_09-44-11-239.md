error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2170.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2170.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2170.java
text:
```scala
i@@f (o == null || getClass() != o.getClass())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2170.java