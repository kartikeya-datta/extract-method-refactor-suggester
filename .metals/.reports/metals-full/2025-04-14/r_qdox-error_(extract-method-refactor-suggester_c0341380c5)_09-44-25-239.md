error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1921.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1921.java
...
```java
offset: 74
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1921.java
text:
```scala
public final class NestedPulsingPostingsFormat extends PostingsFormat {

p@@ackage org.apache.lucene.codecs.nestedpulsing;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1921.java