error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5750.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5750.java
text:
```scala
public static v@@oid checkModelParams(ModelNode node,Properties params){
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5750.java