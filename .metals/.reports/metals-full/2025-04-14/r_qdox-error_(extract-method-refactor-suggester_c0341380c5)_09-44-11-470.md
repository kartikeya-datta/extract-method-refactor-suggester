error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11485.java
text:
```scala
p@@ublic class BookmarkableHomePageLinksPage extends WebPage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11485.java