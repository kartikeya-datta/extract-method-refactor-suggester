error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7252.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7252.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7252.java
text:
```scala
I@@GroupModelPartial groupPartial = new GroupModelPartial(folder.getId(), group
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7252.java