error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5020.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5020.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5020.java
text:
```scala
public static final C@@omponentTypeIdentityInterceptorFactory INSTANCE = new ComponentTypeIdentityInterceptorFactory();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5020.java