error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7426.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7426.java
text:
```scala
private final L@@ist<ResourceWatcher> watchers = new CopyOnWriteArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7426.java