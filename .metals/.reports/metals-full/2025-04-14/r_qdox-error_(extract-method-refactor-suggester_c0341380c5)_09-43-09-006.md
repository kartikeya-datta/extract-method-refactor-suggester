error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9965.java
text:
```scala
i@@nt lineEnd = start + font.computeVisibleGlyphs(str, start, BitmapFont.indexOf(str, '\n', start), wrapWidth);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9965.java