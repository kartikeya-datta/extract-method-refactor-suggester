error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9975.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9975.java
text:
```scala
public static final C@@lusterBlock NOT_RECOVERED_FROM_GATEWAY_BLOCK = new ClusterBlock(1, "not recovered from gateway", ClusterBlockLevel.ALL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9975.java