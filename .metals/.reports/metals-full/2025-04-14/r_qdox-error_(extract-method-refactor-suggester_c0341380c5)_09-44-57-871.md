error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/650.java
text:
```scala
i@@f (failureMsg != null && failureMsg.contains("JBAS013456")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/650.java