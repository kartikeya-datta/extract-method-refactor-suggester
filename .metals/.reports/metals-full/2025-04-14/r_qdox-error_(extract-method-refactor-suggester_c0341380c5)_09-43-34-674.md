error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11609.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11609.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11609.java
text:
```scala
o@@utput.write(this.currentVersion);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11609.java