error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6406.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6406.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6406.java
text:
```scala
c@@lone.selectedNode = selectedNode; // TODO ?? (JMeterTreeNode) selectedNode.clone();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6406.java