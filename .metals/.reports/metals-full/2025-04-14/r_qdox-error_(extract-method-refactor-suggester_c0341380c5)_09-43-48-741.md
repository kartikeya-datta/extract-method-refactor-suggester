error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1442.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1442.java
text:
```scala
b@@uilder.field("index_name", names.indexNameClean());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1442.java