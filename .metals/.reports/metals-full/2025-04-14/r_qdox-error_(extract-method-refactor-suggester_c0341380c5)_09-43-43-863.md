error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/618.java
text:
```scala
p@@ublic class SetModel<T> extends GenericBaseModel<Set<T>>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/618.java