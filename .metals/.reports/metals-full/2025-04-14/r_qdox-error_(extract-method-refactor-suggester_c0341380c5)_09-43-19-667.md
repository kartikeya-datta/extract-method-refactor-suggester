error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8270.java
text:
```scala
p@@ublic abstract class CommonsAttributeSpringWebApplication extends SpringWebApplication
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8270.java