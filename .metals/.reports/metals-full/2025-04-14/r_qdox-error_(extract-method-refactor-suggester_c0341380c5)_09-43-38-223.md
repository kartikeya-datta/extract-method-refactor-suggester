error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13026.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13026.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13026.java
text:
```scala
t@@extUI.setLanguage((String) descriptor.getValue(GenericTestBeanCustomizer.TEXT_LANGUAGE));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13026.java