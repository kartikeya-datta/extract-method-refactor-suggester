error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15389.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15389.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15389.java
text:
```scala
i@@f (methodName.startsWith("ajc$inlineAccessMethod") || methodName.startsWith("ajc$superDispatch")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15389.java