error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6356.java
text:
```scala
l@@ogger.info("Adding two nodes and performing rerouting");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6356.java