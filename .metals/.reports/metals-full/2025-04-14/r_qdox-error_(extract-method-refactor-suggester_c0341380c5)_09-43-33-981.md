error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14171.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14171.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14171.java
text:
```scala
A@@ssert.assertFalse("key=" + key + "\n with child1 undefined has child2 \n" + child2.asString(), child2.isDefined());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14171.java