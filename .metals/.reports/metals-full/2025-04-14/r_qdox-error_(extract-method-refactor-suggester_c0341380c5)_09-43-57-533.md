error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6014.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6014.java
text:
```scala
s@@uper(serviceTarget, url, deploymentName, root, cl, cmd, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6014.java