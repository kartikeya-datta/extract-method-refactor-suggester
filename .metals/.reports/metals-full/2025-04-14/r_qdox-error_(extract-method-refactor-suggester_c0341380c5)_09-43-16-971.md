error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13313.java
text:
```scala
l@@vColumn.mask = OS.LVCF_FMT;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13313.java