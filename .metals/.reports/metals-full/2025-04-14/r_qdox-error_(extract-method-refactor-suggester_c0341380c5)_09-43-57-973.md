error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8180.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8180.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8180.java
text:
```scala
public v@@oid init()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8180.java