error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9140.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9140.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9140.java
text:
```scala
i@@f (line.contains("JBAS011509")) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9140.java