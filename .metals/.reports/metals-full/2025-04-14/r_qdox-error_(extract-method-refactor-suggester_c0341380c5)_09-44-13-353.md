error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14052.java
text:
```scala
c@@ase OS.FocusOut:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14052.java