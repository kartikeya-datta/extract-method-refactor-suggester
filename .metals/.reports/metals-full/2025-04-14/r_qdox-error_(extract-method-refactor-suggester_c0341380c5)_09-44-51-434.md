error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3456.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3456.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3456.java
text:
```scala
O@@S.TrackMouseLocationWithOptions (port, OS.kTrackMouseLocationOptionDontConsumeMouseUp, 10 / 1000.0, outPt, outModifiers, outResult);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3456.java