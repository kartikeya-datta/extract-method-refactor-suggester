error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17404.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17404.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17404.java
text:
```scala
private static final F@@ile c_cwd;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17404.java