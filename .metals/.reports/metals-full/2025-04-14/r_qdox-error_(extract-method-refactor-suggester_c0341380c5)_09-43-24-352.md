error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16527.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16527.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16527.java
text:
```scala
i@@f (cp.load(resource, name, m))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16527.java