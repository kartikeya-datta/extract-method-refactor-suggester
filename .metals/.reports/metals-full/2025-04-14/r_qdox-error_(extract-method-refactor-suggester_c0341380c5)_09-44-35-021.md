error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10949.java
text:
```scala
r@@eturn new StringBuilder(_op.toString())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10949.java