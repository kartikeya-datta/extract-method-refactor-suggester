error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2003.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2003.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2003.java
text:
```scala
S@@tringBuffer buffer = new StringBuffer((this.parameters.length + 1) * 20);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2003.java