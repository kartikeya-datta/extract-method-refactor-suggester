error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6391.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6391.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6391.java
text:
```scala
p@@kgName= Util.splitOn('.', qualifiedTypeName, 0, index);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6391.java