error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2481.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2481.java
text:
```scala
r@@eturn resources.getString(string.repositories);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2481.java