error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12330.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12330.java
text:
```scala
public static final S@@tring VALUE_KEY = "value";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12330.java