error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1520.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1520.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1520.java
text:
```scala
s@@ubsystem.registerXMLElementWriter(WeldSubsystemPersister.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1520.java