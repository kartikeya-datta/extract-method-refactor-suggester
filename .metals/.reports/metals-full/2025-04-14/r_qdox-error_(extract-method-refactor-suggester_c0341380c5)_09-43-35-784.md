error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15881.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15881.java
...
```java
offset: 846
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15881.java
text:
```scala
...
p@@ackage org.apache.jmeter.protocol.http.sampler;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15881.java