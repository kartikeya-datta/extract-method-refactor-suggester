error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3229.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3229.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3229.java
text:
```scala
L@@ist as = BcelAttributes.readAjAttributes(attributes, context,null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3229.java