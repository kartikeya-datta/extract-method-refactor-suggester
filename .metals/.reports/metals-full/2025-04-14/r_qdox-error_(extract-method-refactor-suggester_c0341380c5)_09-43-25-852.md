error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1522.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1522.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1522.java
text:
```scala
t@@hrow new IllegalArgumentException("Lucene directory: " + file.getAbsolutePath() +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1522.java