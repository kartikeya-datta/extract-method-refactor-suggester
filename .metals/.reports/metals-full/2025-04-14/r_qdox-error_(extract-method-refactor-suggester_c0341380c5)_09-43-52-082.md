error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1686.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1686.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1686.java
text:
```scala
public static v@@oid debugBytecodes(BCClass bc) throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1686.java