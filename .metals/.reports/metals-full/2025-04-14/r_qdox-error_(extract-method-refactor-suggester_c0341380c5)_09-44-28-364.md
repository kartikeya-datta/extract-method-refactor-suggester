error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13903.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13903.java
text:
```scala
protected final U@@niqueOrKey fKey;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13903.java