error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1954.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1954.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1954.java
text:
```scala
e@@xecution(* foo(*,*)) &&
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1954.java