error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5427.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5427.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5427.java
text:
```scala
r@@eturn new InternalCountAndTotalHistogramFacet(facetName, comparatorType, counts, totals);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5427.java