error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2818.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2818.java
text:
```scala
A@@dvice.makeCflowEntry(world, concreteEntry, isBelow, cflowField, freeVars.length, innerCflowEntries,inAspect));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2818.java