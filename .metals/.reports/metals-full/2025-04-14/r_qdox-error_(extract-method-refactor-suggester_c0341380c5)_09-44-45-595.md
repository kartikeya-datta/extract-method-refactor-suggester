error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7316.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7316.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7316.java
text:
```scala
private final L@@ist<DocumentTypeListener> typeListeners = new CopyOnWriteArrayList<>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7316.java