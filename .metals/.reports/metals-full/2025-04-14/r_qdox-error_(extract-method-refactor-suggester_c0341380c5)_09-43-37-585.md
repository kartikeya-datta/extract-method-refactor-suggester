error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3335.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3335.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3335.java
text:
```scala
N@@SNumber value = NSNumber.numberWithBool(getEnabled());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3335.java