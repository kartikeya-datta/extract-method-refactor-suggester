error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1394.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1394.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1394.java
text:
```scala
public O@@bject getParent() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1394.java