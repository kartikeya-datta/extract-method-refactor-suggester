error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3475.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3475.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3475.java
text:
```scala
public static final A@@ttachmentKey<Map<String, MountedDeploymentOverlay>> DEPLOYMENT_OVERLAY_LOCATIONS = AttachmentKey.create(Map.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3475.java