error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6080.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6080.java
text:
```scala
r@@eturn Optional.ofNullable(target);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6080.java