error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3731.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3731.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3731.java
text:
```scala
private final N@@umberFormat format;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3731.java