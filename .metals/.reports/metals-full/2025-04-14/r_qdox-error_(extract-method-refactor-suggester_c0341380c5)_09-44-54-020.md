error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/571.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/571.java
...
```java
offset: 13
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/571.java
text:
```scala
"Option " + o@@ptions[i] + "=[" + (value == null? "N/A" : value)+"].");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/571.java