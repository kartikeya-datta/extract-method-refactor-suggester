error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4224.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4224.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4224.java
text:
```scala
C@@hannel channel = openExecChannel("scp -r -d -t " + remotePath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4224.java