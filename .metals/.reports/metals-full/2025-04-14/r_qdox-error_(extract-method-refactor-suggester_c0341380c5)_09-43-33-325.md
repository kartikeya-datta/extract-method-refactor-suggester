error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9662.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9662.java
text:
```scala
F@@ilePermission permission = new FilePermission(file.getAbsolutePath() + "/-", "read");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9662.java