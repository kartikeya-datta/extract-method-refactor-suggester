error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5136.java
text:
```scala
a@@ssertArrayEquals(new String[]{String.class.getName()}, (String[])nestedAnno.getStringArray("classArray"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5136.java