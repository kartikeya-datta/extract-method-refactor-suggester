error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12050.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12050.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12050.java
text:
```scala
r@@eturn breadCrumbPanelFactory.create(getParent(), componentId, breadCrumbModel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12050.java