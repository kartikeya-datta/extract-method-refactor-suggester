error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/939.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/939.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/939.java
text:
```scala
M@@anualBindTest.class, MatrixJNITest.class, MD5Test.class, MeshMultitextureTest.class, MeshShaderTest.class, MeshTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/939.java