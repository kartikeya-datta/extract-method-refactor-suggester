error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/641.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/641.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/641.java
text:
```scala
public C@@haracter convertToObject(final String value, final Locale locale)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/641.java