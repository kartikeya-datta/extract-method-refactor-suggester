error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4965.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4965.java
text:
```scala
O@@bject cacheKey();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4965.java