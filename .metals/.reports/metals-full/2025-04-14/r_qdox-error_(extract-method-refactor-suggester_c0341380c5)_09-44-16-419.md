error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17570.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[101,2]

error in qdox parser
file content:
```java
offset: 2598
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17570.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17570.java