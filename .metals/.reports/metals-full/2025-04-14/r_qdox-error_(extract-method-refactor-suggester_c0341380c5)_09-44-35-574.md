error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6546.java
text:
```scala
r@@equest.indices(clusterService.state().metaData().concreteIndices(request.indices(), request.indicesOptions()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6546.java