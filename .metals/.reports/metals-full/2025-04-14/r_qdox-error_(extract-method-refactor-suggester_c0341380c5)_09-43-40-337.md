error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7023.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7023.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7023.java
text:
```scala
private static final S@@tring TAG = "ImageUtils";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7023.java