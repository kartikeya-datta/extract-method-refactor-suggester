error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12708.java
text:
```scala
c@@omponent.render(markupStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12708.java