error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4278.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4278.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4278.java
text:
```scala
public static final i@@nt DEFAULT_MULTIPLE_FIELDS_ALIGNMENT = Alignment.M_COMPACT_SPLIT;//$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4278.java