error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7690.java
text:
```scala
r@@eturn clusterService.operationRouting().deleteByQueryShards(clusterService.state(), request.index(), request.routing());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7690.java