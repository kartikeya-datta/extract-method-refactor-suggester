error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4629.java
text:
```scala
n@@ew String[] { buffer.getName() });
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4629.java