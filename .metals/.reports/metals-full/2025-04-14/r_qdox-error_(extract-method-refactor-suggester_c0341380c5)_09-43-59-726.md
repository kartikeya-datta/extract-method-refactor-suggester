error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3496.java
text:
```scala
r@@eturn interfaceType.cast(iniCtx.lookup("ejb:" + ARCHIVE_NAME + "/" + ARCHIVE_NAME + "//" + beanName + "!" + interfaceType.getName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3496.java