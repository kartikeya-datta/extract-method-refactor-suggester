error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15300.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15300.java
...
```java
offset: 31
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15300.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15300.java