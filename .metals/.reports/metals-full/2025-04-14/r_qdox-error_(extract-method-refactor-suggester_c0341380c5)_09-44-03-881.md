error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1172.java
text:
```scala
c@@heckRandomData(random(), new HungarianAnalyzer(TEST_VERSION_CURRENT), 1000*RANDOM_MULTIPLIER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1172.java