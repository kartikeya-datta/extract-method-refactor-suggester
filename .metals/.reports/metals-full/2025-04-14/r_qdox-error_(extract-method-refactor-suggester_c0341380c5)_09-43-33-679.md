error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3339.java
text:
```scala
A@@ccount account = new Account(user.getLogin(), GITHUB_ACCOUNT_TYPE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3339.java