error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13605.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13605.java
text:
```scala
public static final S@@impleTabCompleter BOOLEAN = new SimpleTabCompleter(new String[]{"false", "true"});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13605.java