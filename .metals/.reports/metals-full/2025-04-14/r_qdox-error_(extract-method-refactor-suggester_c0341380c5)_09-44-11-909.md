error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7181.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7181.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7181.java
text:
```scala
b@@uf.append(", "); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7181.java