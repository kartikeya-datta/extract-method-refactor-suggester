error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12894.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12894.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12894.java
text:
```scala
a@@ssertEquals("test/param0/param1?foo=fooval&test=testval1&test=testval2", url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12894.java