error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13616.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13616.java
text:
```scala
public I@@Model<T> getModel(T value);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13616.java