error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3694.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3694.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3694.java
text:
```scala
i@@nt iters = scaledRandomIntBetween(5, 100);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3694.java