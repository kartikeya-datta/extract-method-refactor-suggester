error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12437.java
text:
```scala
u@@rl = httpServletResponse.encodeRedirectURL(url);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12437.java