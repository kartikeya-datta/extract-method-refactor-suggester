error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1989.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1989.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1989.java
text:
```scala
f@@eedbackMessages = new FeedbackMessages(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1989.java