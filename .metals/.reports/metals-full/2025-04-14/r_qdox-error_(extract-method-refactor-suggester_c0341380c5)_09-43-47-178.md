error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/444.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/444.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/444.java
text:
```scala
r@@eturn "[Warning: String resource for '" + key + "' not found]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/444.java