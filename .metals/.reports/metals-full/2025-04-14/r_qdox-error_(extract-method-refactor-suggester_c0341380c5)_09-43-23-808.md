error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15002.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15002.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15002.java
text:
```scala
c@@ontextResult.set(getDomainResults(operation));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15002.java