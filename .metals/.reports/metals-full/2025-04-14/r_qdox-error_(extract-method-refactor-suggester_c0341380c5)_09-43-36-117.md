error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/950.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/950.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/950.java
text:
```scala
L@@ist<String> args = ctx.getOtherArguments();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/950.java