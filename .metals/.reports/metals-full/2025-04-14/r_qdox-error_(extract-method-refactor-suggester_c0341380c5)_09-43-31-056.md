error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7433.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7433.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7433.java
text:
```scala
n@@ew HashSet<>(Arrays.asList(new SameShardAllocationDecider(ImmutableSettings.EMPTY),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7433.java