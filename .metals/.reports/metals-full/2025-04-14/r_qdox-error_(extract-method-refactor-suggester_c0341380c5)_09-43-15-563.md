error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8651.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8651.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8651.java
text:
```scala
p@@ersister.registerAdditionalRootElement(new QName(Namespace.DOMAIN_1_0.getUriString(), "server"), parser);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8651.java