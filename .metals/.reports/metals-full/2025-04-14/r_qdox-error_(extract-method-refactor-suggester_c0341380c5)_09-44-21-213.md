error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/727.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/727.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/727.java
text:
```scala
u@@nit.setLineEndTable(compilationUnitDeclaration.compilationResult.getLineSeparatorPositions());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/727.java