error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5060.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5060.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5060.java
text:
```scala
s@@uper(indices);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5060.java