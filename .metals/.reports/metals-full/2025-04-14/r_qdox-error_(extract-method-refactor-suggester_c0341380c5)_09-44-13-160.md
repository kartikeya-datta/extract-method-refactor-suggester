error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3333.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3333.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3333.java
text:
```scala
t@@hrow new SolrException(SolrException.ErrorCode.BAD_REQUEST, "Sorting not supported on PointType " + field.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3333.java