error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16195.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16195.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16195.java
text:
```scala
p@@arent.updateScrollBarValue (this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16195.java