error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10258.java
text:
```scala
t@@his.writeOptional(writer, Attribute.SEGMENTS, distributedCache, ModelKeys.SEGMENTS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10258.java