error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12730.java
text:
```scala
r@@eturn getOptionsFromCoder(coder);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12730.java