error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12240.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12240.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12240.java
text:
```scala
f@@or(double[] array : array2d) { // "double array[]" causes PMD parsing error
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12240.java