error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17605.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17605.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[64,27]

error in qdox parser
file content:
```java
offset: 1791
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17605.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17605.java