error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7286.java
text:
```scala
i@@pcHelper.executeCommand(ExternalToolsHelper.getSALearn()+" --spam --dir" + path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7286.java