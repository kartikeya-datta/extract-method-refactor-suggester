error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/543.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/543.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/543.java
text:
```scala
p@@revious = CharsRef.deepCopyOf(current);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/543.java