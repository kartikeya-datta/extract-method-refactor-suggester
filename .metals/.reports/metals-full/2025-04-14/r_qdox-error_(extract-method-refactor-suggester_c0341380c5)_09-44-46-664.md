error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8035.java
text:
```scala
E@@eSubsystemRootResource.ANNOTATION_PROPERTY_REPLACEMENT.marshallAsElement(eeSubSystem, writer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8035.java