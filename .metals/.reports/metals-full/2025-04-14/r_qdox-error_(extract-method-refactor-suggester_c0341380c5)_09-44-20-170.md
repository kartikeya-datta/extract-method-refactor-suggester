error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9791.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9791.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9791.java
text:
```scala
final M@@ap<DeploymentModuleIdentifier, ModuleDeployment> modules = this.deploymentRepository.getStartedModules();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9791.java