error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4579.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4579.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4579.java
text:
```scala
t@@hrow new IDCreateException(Messages.DnsSdNamespace_Wrong_Parameters);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4579.java