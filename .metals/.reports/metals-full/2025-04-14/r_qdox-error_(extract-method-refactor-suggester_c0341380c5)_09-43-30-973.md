error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2028.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2028.java
text:
```scala
r@@eturn "ping_response{target [" + target + "], master [" + master + "], cluster_name[" + clusterName.value() + "]}";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2028.java