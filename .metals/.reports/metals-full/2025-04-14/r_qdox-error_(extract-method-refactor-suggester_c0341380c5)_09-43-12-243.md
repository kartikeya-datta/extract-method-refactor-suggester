error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4351.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4351.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4351.java
text:
```scala
t@@hrows IDCreateException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4351.java