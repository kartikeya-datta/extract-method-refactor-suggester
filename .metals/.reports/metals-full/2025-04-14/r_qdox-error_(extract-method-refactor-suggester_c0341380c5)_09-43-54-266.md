error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6284.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6284.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6284.java
text:
```scala
i@@nt lParam = OS.MAKELPARAM (OS.SB_THUMBPOSITION, oldInfo.nPos);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6284.java