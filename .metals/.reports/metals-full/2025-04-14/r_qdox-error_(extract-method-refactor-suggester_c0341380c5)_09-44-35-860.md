error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5493.java
text:
```scala
p@@rivate class ToggleLink extends Link<Void>
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5493.java