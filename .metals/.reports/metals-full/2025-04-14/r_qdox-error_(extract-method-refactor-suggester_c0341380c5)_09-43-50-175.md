error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11119.java
text:
```scala
C@@harSequence encode(IRequestTarget requestTarget);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11119.java