error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/648.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/648.java
text:
```scala
public C@@achingSunJceCryptFactory(final String encryptionKey)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/648.java