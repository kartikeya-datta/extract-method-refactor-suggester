error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/356.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/356.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/356.java
text:
```scala
r@@eturn request.headers().get(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/356.java