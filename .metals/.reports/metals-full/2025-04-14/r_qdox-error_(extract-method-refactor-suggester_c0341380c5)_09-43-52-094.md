error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13228.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13228.java
text:
```scala
r@@esult.get(ModelDescriptionConstants.NILLABLE).set(valueType.isAllowNull());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13228.java