error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3028.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3028.java
text:
```scala
public static S@@tring getHandlerType(OperationContext context, ModelNode elementNode) throws OperationFailedException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3028.java