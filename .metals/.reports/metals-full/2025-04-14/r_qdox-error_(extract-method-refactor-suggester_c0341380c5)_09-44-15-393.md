error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6085.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6085.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6085.java
text:
```scala
n@@ew Label(this, "label1", new Model<String>("Label 1"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6085.java