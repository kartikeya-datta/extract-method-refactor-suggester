error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13815.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13815.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13815.java
text:
```scala
C@@ONFIG_PROPERTIES, BEANVALIDATIONGROUPS, CONNECTIONDEFINITIONS, ADMIN_OBJECTS };
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13815.java