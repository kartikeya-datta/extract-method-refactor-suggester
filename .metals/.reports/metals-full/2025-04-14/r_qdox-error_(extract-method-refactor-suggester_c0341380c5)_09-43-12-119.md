error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8716.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8716.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8716.java
text:
```scala
public v@@oid beforeGroup(int group, Array<Decal> contents) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8716.java