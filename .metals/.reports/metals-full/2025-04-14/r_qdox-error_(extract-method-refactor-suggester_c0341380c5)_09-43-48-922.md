error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17769.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17769.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[160,2]

error in qdox parser
file content:
```java
offset: 5170
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17769.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17769.java