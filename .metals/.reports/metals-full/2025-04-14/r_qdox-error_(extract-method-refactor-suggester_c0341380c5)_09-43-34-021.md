error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17259.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17259.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17259.java
text:
```scala
i@@nt /*long*/ result = OS.objc_msgSend(OS.class_NSOpenGLContext, OS.sel_currentContext);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17259.java