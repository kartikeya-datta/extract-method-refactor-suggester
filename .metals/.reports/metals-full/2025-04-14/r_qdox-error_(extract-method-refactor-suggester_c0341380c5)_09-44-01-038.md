error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13133.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13133.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13133.java
text:
```scala
e@@xecuteDeleteSQL(batchCascadeDeleteSql, ctx.getPrimaryKeyUnchecked());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13133.java