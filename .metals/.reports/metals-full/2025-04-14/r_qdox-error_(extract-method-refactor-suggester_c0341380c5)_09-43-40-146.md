error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8533.java
text:
```scala
i@@nt /*long*/ margins = OS.SendMessage (handle, OS.EM_GETMARGINS, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8533.java