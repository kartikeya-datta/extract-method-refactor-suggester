error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1781.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1781.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1781.java
text:
```scala
S@@treamOut.transferRangesForRequest(session, srm.ranges, srm.type);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1781.java