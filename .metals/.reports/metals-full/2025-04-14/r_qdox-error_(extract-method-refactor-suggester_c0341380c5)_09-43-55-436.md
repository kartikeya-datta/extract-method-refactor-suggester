error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/305.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/305.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/305.java
text:
```scala
b@@inding.original().modifiers |= AccPrivateUsed;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/305.java