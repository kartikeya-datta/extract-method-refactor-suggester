error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2424.java
text:
```scala
i@@f (lastCompletedOffset != lastCompletedOffset) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2424.java