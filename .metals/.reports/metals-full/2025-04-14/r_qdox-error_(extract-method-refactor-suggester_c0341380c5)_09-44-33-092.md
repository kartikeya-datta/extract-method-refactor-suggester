error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12903.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12903.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12903.java
text:
```scala
t@@hrow new OperationFailedException(new ModelNode(getFallbackMessage() + ": " + e.getMessage()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12903.java