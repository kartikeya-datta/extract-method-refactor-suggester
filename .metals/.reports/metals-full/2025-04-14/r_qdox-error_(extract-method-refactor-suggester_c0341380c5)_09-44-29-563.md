error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2244.java
text:
```scala
d@@isassemble(stackMapFrames[j], buffer, lineSeparator, tabNumber + 3, mode);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2244.java