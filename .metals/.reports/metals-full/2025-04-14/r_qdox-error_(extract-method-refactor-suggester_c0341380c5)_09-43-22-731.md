error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6324.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6324.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6324.java
text:
```scala
public static final i@@nt PORT = 9988;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6324.java