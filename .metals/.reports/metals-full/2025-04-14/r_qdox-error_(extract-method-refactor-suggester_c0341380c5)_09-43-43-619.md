error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4896.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4896.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4896.java
text:
```scala
p@@opItem.getBoolean("enable_ssl", false));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4896.java