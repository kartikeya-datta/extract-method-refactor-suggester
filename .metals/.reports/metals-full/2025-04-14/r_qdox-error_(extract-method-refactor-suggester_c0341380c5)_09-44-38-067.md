error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12977.java
text:
```scala
e@@rror(component, resourceKey(component), messageModel(component, input, e));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12977.java