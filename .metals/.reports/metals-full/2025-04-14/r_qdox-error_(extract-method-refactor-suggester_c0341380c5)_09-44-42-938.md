error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7100.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7100.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7100.java
text:
```scala
B@@oolean.valueOf(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7100.java