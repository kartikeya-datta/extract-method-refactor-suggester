error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17000.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17000.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17000.java
text:
```scala
b@@uf.append(sm.makePrimaryTypeName(getDeclaringType(),getDeclaringTypeName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17000.java