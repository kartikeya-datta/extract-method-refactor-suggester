error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5105.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5105.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5105.java
text:
```scala
i@@f (this.extensionRegistry != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5105.java