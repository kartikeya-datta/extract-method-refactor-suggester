error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14227.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14227.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14227.java
text:
```scala
private static final c@@har componentPathSeparator = '.';
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14227.java