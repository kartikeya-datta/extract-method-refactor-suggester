error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15131.java
text:
```scala
i@@f (item != null && !item.isDisposed ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15131.java