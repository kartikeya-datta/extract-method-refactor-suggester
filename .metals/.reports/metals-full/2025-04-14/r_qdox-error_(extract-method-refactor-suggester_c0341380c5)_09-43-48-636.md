error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7532.java
text:
```scala
I@@PageFactory pageFactory = requestCycle.getApplication().getSessionSettings()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7532.java