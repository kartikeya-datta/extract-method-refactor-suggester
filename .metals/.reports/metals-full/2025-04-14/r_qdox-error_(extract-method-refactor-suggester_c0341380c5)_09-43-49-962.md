error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11649.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11649.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11649.java
text:
```scala
public R@@egistryCollector<K, V> getValue() throws IllegalStateException, IllegalArgumentException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11649.java