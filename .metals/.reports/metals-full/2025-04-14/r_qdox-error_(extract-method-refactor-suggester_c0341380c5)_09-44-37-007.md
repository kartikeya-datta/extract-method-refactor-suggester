error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8137.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8137.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8137.java
text:
```scala
F@@ieldData fieldData = fieldDataCache.get(fieldName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8137.java