error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6822.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6822.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6822.java
text:
```scala
public S@@tatement methodBlock(FrameworkMethod method) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6822.java