error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8625.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8625.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8625.java
text:
```scala
t@@his.argument = new Argument(name, pos, typeRef, IConstants.AccDefault);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8625.java