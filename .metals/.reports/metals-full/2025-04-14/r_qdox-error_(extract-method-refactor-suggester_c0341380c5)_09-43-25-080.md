error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6918.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6918.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6918.java
text:
```scala
r@@eturn new InetSocketAddress(getLocalAddress(), getPort());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6918.java