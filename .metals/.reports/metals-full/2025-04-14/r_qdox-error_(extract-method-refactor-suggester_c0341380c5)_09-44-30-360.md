error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11264.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11264.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11264.java
text:
```scala
public static S@@et<Locale> availableLocaleSet() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11264.java