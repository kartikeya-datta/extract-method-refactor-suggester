error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3.java
text:
```scala
a@@ssertEquals(similar[1], "oneword");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3.java