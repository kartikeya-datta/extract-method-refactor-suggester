error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7198.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7198.java
text:
```scala
...
public class MultipleActivationTestCase extends ArquillianResourceMgmtTestBase {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7198.java