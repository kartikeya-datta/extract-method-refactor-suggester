error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2481.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2481.java
text:
```scala
public static final M@@etaDataKey INSTANTIATION_PERMISSIONS = new MetaDataKey(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2481.java