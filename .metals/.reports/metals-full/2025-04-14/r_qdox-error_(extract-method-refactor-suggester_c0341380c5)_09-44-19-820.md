error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5380.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5380.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5380.java
text:
```scala
A@@ssert.isTrue(false, "Completion requestor cannot be null"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5380.java