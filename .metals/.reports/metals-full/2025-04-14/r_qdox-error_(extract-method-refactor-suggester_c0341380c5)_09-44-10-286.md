error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9510.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9510.java
text:
```scala
p@@age.add(new AjaxLink<Void>(MockPageWithLinkAndComponent.LINK_ID)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9510.java