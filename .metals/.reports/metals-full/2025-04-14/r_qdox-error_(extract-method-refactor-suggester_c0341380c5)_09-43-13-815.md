error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16922.java
text:
```scala
s@@etOverwrite( true );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16922.java