error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3700.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3700.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3700.java
text:
```scala
t@@hrow new RuntimeException("Error when launching multilang subprocess\n" + _process.getErrorsString(), e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3700.java