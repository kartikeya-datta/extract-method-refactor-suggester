error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13487.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13487.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13487.java
text:
```scala
i@@f (patchType == Patch.PatchType.UPGRADE) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13487.java