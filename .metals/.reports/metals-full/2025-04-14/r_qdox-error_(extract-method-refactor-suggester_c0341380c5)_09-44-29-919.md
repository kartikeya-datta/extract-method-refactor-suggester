error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16039.java
text:
```scala
i@@f (value != null && value.size() > 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16039.java