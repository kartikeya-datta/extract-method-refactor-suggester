error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3873.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3873.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3873.java
text:
```scala
M@@appingMetaData mappingMd = clusterState.metaData().index(request.index()).mappingOrDefault(indexRequest.type());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3873.java