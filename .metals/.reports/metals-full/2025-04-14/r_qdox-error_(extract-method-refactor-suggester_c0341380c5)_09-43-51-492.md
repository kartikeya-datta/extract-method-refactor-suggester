error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4631.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4631.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4631.java
text:
```scala
public C@@ancelButton(final String id, final IWizard wizard)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4631.java