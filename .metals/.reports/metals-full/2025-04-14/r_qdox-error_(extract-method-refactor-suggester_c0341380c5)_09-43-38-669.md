error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2667.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2667.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2667.java
text:
```scala
p@@ageClass = (Class<? extends Page>)session.getClassResolver().resolveClass(bookmarkablePageClass);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2667.java