error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7927.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7927.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7927.java
text:
```scala
O@@ptionMap optionMap = ConnectorResource.getFullOptions(context, fullModel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7927.java