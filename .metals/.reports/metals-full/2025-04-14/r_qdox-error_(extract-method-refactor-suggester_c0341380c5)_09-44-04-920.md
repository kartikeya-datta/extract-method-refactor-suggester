error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3172.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3172.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3172.java
text:
```scala
A@@nalysis.parseStopWords(env, settings, ArabicAnalyzer.getDefaultStopSet(), version),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3172.java