error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12742.java
text:
```scala
O@@S.gtk_tree_view_scroll_to_cell (handle, path, 0, false, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12742.java