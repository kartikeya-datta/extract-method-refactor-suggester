error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7879.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7879.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7879.java
text:
```scala
private static final S@@tring Base16 = "0123456789ABCDEF";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7879.java