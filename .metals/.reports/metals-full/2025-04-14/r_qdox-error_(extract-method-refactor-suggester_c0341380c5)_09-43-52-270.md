error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/365.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/365.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/365.java
text:
```scala
public static final c@@har ICON_PRIVATE = '\uf26a';
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/365.java