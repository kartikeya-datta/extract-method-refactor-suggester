error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10148.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10148.java
text:
```scala
final S@@erverConfigImpl config = ServerConfigImpl.newInstance();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10148.java