error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12258.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12258.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12258.java
text:
```scala
r@@eturn markup.find(child.getId());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12258.java