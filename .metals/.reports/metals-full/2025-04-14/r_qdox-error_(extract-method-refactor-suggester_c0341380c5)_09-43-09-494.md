error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4654.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4654.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4654.java
text:
```scala
i@@f (data.cairo == 0) return 0xFF;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4654.java