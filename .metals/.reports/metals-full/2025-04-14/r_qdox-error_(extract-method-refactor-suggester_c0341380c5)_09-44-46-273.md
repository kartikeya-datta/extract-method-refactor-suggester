error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3036.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3036.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3036.java
text:
```scala
private final S@@tring PATCH_ID = Constants.PATCH_ID.getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3036.java