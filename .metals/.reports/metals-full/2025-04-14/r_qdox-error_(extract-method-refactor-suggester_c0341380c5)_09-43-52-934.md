error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18361.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18361.java
text:
```scala
O@@S.gdk_gc_set_dashes(handle, 0, dash_list, dash_list.length);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18361.java