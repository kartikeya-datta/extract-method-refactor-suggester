error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3416.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3416.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3416.java
text:
```scala
C@@heckHits.checkHits(random, q, FIELD, searcher, new int[] {0,1});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3416.java