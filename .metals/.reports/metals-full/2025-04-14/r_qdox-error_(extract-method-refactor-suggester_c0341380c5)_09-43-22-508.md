error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4019.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4019.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4019.java
text:
```scala
M@@ap map = new HashMap(parameters.size(),1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4019.java