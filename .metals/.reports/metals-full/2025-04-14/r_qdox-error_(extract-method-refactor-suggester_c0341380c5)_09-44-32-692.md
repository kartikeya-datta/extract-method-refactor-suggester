error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2707.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2707.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2707.java
text:
```scala
i@@f (r2 != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2707.java