error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16149.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16149.java
...
```java
offset: 16
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16149.java
text:
```scala
private static F@@ileServer FSERVER = FileServer.getFileServer();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16149.java