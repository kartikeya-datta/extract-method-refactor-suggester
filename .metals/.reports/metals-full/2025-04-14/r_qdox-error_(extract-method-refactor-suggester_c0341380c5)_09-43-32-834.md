error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9274.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9274.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9274.java
text:
```scala
s@@hardStatus.translogOperations = indexShard.translog().estimatedNumberOfOperations();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9274.java