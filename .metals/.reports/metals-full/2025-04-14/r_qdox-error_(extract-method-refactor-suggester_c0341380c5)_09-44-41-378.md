error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9211.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9211.java
text:
```scala
r@@eturn Boolean.valueOf(rootElement.getAttribute("visible")).booleanValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9211.java