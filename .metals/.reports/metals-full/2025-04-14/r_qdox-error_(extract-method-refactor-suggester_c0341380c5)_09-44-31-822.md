error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4028.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4028.java
text:
```scala
i@@nt size = C.PTR_SIZEOF, align = C.PTR_SIZEOF == 4 ? 2 : 3;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4028.java