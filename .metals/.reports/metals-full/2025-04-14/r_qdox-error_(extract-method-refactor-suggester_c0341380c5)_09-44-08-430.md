error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3852.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3852.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3852.java
text:
```scala
S@@STableWriter writer = new SSTableWriter(path, sortedKeys.size(), cfs.metadata, cfs.partitioner);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3852.java