error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4004.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4004.java
text:
```scala
f@@loat projX = verts1[(j + 1) % length1] - verts1[i + 1];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4004.java