error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17129.java
text:
```scala
t@@oolTipShell = new Shell (getShell(), SWT.ON_TOP | SWT.TOOL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17129.java