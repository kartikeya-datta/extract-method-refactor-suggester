error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2474.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2474.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2474.java
text:
```scala
public static S@@tring invalidXml, noDocument, noSignaturesInDocument, signaturesView;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2474.java