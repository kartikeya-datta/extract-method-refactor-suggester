error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14628.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14628.java
text:
```scala
public static final S@@tring MANAGEMENT_INTERFACE = "management-interface";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14628.java