error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18094.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18094.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18094.java
text:
```scala
i@@f (columnCount != 0 && index != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18094.java