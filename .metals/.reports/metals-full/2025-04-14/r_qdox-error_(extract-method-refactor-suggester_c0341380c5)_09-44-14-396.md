error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4653.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4653.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4653.java
text:
```scala
i@@nt inset = 1;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4653.java