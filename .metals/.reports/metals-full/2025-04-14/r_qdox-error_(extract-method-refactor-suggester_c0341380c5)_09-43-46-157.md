error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14546.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14546.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14546.java
text:
```scala
r@@eturn new DomainControllerImpl(scheduledExecutorService.getValue(), domainModel, localHostName, localFileRepository, deploymentRepository);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14546.java