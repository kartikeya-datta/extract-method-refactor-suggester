error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/510.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/510.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/510.java
text:
```scala
static public final S@@tring RELATIVE_TIME_PAT = "^\\d{1,10}";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/510.java