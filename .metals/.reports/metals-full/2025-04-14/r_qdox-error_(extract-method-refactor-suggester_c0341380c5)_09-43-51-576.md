error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3742.java
text:
```scala
e@@lse if (dict instanceof DB2Dictionary) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3742.java