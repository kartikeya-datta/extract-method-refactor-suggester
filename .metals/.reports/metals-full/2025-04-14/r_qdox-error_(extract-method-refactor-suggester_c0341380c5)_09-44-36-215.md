error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10159.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10159.java
...
```java
offset: 659
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10159.java
text:
```scala
...
p@@ackage org.aspectj.tools.ajdoc;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10159.java