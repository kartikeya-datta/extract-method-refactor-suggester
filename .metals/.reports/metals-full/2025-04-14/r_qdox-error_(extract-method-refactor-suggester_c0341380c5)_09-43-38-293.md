error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/535.java
text:
```scala
s@@trbuf = new StringBuffer((int)fromFile.length());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/535.java