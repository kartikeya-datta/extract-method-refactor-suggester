error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5203.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5203.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5203.java
text:
```scala
r@@equest.setWaitForOperations(waitForOperations);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5203.java