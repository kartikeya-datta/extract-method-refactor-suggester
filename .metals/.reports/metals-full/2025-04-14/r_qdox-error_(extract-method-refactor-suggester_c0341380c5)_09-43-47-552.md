error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4129.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4129.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4129.java
text:
```scala
s@@uper(shardId, indexSettings, indexStore);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4129.java