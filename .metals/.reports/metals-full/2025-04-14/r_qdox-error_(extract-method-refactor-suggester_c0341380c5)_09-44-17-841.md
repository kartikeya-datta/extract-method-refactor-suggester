error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11775.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11775.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11775.java
text:
```scala
A@@ssert.assertTrue(deps.contains("org.junit"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11775.java