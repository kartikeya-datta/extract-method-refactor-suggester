error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8585.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8585.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8585.java
text:
```scala
protected S@@tring defaultSchemaName = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8585.java