error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2660.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2660.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2660.java
text:
```scala
c@@reateIndexAction.execute(new CreateIndexRequest(indexRequest.index()).cause("auto(index api)"), new ActionListener<CreateIndexResponse>() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2660.java