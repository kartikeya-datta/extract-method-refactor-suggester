error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9933.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9933.java
text:
```scala
N@@ameLookup lookup = ((JavaProject) getJavaProject()).getNameLookup();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9933.java