error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6021.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6021.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6021.java
text:
```scala
c@@lientSite.doVerb(OLE.OLEIVERB_INPLACEACTIVATE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6021.java