error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14990.java
text:
```scala
i@@f (formComponent.isVisibleInHierarchy() && formComponent.isEnabled() && formComponent.isValid())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14990.java