error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5493.java
text:
```scala
n@@ativesLoaded = loadLibrary("gdx.dll", "gdx-64.dll");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5493.java