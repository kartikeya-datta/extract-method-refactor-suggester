error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6255.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6255.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6255.java
text:
```scala
r@@eturn getImportContainer().getImport(importName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6255.java