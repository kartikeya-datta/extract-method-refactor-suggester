error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11586.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11586.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11586.java
text:
```scala
s@@ubsystem.get(OP_ADDR).add(ModelDescriptionConstants.SUBSYSTEM, SUBSYSTEM_NAME);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11586.java