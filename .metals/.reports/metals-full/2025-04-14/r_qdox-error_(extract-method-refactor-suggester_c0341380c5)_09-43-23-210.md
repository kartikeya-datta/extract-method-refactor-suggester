error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9639.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9639.java
text:
```scala
public final v@@oid write(final String string) throws IOException
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9639.java