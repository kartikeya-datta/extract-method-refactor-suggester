error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/809.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/809.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/809.java
text:
```scala
l@@istener.onFailure(new ReduceSearchPhaseException("query_fetch", "", e, buildShardFailures()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/809.java