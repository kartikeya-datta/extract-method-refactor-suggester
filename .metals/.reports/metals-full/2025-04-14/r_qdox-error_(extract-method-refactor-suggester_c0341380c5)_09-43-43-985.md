error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4620.java
text:
```scala
b@@oolean hasKeyboardFocus(int /*long*/ inId) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4620.java