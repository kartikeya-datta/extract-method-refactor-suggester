error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7968.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7968.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7968.java
text:
```scala
final I@@ResourceStream resource = application.getResourceStreamLocator().locate(application.getClass(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7968.java