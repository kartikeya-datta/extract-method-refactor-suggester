error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18263.java
text:
```scala
i@@nputs.mouseData = event.count * OS.WHEEL_DELTA / value [0];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18263.java