error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6051.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6051.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6051.java
text:
```scala
c@@odeStream = new CodeStream(this, this.targetJDK);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6051.java