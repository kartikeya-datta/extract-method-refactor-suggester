error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12774.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12774.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12774.java
text:
```scala
r@@eturn new MonotoneChain(includeCollinearPoints);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12774.java