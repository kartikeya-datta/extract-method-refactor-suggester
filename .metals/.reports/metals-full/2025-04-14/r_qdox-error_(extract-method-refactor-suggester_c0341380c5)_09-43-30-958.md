error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/167.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/167.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/167.java
text:
```scala
e@@xtensionRegistry.removeExtension(context.readResourceFromRoot(PathAddress.EMPTY_ADDRESS), module);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/167.java