error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1611.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1611.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1611.java
text:
```scala
native static public v@@oid consoleLog(String message) /*-{
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1611.java