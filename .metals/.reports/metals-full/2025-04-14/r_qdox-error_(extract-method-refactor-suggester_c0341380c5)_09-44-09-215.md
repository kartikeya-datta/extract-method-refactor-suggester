error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7136.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7136.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7136.java
text:
```scala
I@@File sourceResource = (IFile)source.getResource();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7136.java