error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2612.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2612.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2612.java
text:
```scala
v@@el.sub(pos).nor().scl(VELOCITY);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2612.java