error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13984.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13984.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13984.java
text:
```scala
protected B@@ooleanDiff(final String fieldName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13984.java