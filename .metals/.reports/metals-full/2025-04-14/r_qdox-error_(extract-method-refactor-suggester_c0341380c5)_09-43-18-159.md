error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9656.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9656.java
text:
```scala
C@@lass<?> elementType = ClassUtils.resolvePrimitiveIfNecessary(op.getTypeDescriptor().getElementTypeDescriptor().getType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9656.java