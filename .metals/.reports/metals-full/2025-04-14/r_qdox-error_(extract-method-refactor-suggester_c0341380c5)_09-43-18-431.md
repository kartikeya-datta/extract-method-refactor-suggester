error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3410.java
text:
```scala
S@@ourceElementParser parser;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3410.java