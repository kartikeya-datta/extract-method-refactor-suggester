error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5339.java
text:
```scala
A@@ssert.isTrue(node != null, "Failed to locate " + e.getElementName() + " in " + cuDOM.getName()); //$NON-NLS-1$//$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5339.java