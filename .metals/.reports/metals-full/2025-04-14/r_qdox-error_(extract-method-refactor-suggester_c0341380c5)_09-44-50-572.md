error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/720.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/720.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/720.java
text:
```scala
c@@ase DETACH_FETCH_GROUPS:
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/720.java