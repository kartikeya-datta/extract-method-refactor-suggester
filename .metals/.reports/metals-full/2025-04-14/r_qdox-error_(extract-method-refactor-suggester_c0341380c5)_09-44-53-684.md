error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9807.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9807.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9807.java
text:
```scala
T@@ypeBinding rawType = environment.convertToRawType(receiverType.erasure(), false /*do not force conversion of enclosing types*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9807.java