error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13887.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13887.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13887.java
text:
```scala
P@@roperties load(final Class< ? > clazz, final String path);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13887.java