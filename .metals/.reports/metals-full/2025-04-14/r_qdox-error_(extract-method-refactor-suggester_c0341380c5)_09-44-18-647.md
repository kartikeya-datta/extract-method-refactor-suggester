error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2458.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2458.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2458.java
text:
```scala
final l@@ong anotherVal = other.value;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2458.java