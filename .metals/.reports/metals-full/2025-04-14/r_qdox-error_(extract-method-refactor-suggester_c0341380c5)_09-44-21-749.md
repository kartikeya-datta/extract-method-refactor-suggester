error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3392.java
text:
```scala
i@@nt PARAM_LOCATION = 0x62;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3392.java