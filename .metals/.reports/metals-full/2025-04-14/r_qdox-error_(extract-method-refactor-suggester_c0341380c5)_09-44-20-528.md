error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12572.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12572.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12572.java
text:
```scala
c@@mdRegistry.registerHandler(provider.createCommandHandler(this), provider.isTabComplete(), provider.getNames());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12572.java