error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1015.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1015.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1015.java
text:
```scala
i@@f (rootBeansXml.exists() && rootBeansXml.isFile() && classesRoot != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1015.java