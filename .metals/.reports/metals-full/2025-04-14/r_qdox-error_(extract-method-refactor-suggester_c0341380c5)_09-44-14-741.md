error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/836.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/836.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/836.java
text:
```scala
i@@f (count != 0 && (bits & OS.TVS_NOHSCROLL) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/836.java