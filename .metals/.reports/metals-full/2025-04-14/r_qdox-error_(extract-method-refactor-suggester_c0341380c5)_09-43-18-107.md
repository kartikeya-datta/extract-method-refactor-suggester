error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7853.java
text:
```scala
g@@etSettings().getDefaultPageFactory().setChildFactory(new GroovyPageFactory(this));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7853.java