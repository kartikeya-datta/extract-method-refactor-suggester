error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/831.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/831.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/831.java
text:
```scala
i@@f (s == null || (s.length() > _maxSize && !field.getColumns()[0].isNotNull()))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/831.java