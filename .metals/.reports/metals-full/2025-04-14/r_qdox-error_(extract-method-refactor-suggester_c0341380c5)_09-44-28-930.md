error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9794.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9794.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9794.java
text:
```scala
t@@his(window, ((Workbench)window.getWorkbench()).getDefaultPageInput());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9794.java