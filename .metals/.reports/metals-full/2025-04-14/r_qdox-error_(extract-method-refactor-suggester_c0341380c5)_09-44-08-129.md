error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10339.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10339.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10339.java
text:
```scala
i@@f(stage != null) stage.cancelTouchFocus(gestureListener, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10339.java