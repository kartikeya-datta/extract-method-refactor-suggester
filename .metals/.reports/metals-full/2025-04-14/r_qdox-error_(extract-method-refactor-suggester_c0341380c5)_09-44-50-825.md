error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10772.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10772.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10772.java
text:
```scala
public I@@njector<Executor> getExecutorInjector() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10772.java