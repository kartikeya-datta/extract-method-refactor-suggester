error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/228.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/228.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/228.java
text:
```scala
public R@@esource getRootResource() {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/228.java