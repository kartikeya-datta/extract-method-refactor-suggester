error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1311.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1311.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1311.java
text:
```scala
r@@es.setResponseData(myStringProperty.toUpperCase(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1311.java