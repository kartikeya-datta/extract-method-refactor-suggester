error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6541.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6541.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6541.java
text:
```scala
F@@ilePermission permission = new FilePermission(file.getAbsolutePath() + File.separatorChar + "-", "read");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6541.java