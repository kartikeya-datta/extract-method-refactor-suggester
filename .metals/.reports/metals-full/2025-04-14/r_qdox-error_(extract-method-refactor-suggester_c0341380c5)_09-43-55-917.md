error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17726.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17726.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[95,2]

error in qdox parser
file content:
```java
offset: 3229
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17726.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17726.java