error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8647.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8647.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8647.java
text:
```scala
s@@creen = new GameOver(Gdx.app);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8647.java