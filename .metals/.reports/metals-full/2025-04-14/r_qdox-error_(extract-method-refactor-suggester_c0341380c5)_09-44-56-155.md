error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4610.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4610.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4610.java
text:
```scala
R@@OOT_LOGGER.debugf("Timer task was cancelled for %s", timer);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4610.java