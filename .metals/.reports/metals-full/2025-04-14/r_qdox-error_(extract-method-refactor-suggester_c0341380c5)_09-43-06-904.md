error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8497.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8497.java
text:
```scala
i@@ndexMdLocks = new Semaphore[500];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8497.java