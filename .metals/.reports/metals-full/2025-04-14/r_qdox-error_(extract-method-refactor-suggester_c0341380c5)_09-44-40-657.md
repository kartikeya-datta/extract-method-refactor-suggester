error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6323.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6323.java
text:
```scala
public abstract v@@oid setStripWicketParamTag(boolean remove);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6323.java