error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/629.java
text:
```scala
t@@ry { getDeployer().deployType( DataType.ROLE, name, file ); }
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/629.java