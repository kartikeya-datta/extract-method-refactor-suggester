error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2845.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2845.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2845.java
text:
```scala
c@@fStore.storeLocation(writer.closeAndOpenReader());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/2845.java