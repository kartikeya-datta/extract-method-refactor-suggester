error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2640.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2640.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2640.java
text:
```scala
c@@lear();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2640.java