error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12691.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12691.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12691.java
text:
```scala
protected final Q@@Name fQName = new QName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12691.java