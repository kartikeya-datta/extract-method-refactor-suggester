error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3644.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3644.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3644.java
text:
```scala
r@@eturn frameRate;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3644.java