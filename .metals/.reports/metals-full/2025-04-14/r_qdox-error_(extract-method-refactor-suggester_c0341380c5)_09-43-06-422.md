error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2708.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2708.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2708.java
text:
```scala
n@@ew NestedList(listItem, "nested", (List)modelObject);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2708.java