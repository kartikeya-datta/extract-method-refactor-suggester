error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6496.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6496.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6496.java
text:
```scala
G@@dxTest test = new VoxelTest();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6496.java