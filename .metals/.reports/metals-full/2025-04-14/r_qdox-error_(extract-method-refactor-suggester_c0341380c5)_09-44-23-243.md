error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5375.java
text:
```scala
p@@artIndices[k] = (short)indices.getInt(k);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5375.java