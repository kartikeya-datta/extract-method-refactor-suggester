error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6547.java
text:
```scala
S@@tring[] concreteIndices = clusterState.metaData().concreteIndices(searchRequest.indices(), searchRequest.indicesOptions());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6547.java