error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9902.java
text:
```scala
n@@ew ListenerList<ISelectionChangedListener, SelectionChangedEvent>(ISelectionChangedListener.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9902.java