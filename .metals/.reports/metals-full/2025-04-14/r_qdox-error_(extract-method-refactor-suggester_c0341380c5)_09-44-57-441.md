error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11614.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11614.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11614.java
text:
```scala
s@@ubsystem.registerSubsystemModel(new InfinispanSubsystemRootResourceDefinition(resolvePathHandler, context.isRuntimeOnlyRegistrationValid()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11614.java