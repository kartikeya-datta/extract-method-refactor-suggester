error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4990.java
text:
```scala
b@@oolean perThread = Boolean.parseBoolean(((CompoundVariable) variables[0]).execute());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4990.java