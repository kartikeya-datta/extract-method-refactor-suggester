error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9132.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9132.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9132.java
text:
```scala
r@@enderBatch.render(instances.get(i).model, instances.get(i).transform, lights);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9132.java