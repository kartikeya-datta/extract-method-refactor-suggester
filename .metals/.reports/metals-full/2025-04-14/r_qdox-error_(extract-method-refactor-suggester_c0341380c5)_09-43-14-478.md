error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/493.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/493.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/493.java
text:
```scala
r@@eturn "Switch flow context"; //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/493.java