error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2952.java
text:
```scala
w@@indow.setFrame(frame, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2952.java