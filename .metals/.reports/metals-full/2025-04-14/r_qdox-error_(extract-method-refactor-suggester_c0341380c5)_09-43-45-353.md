error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14629.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14629.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14629.java
text:
```scala
C@@omponent c = getComponentFromLastRenderedPage(componentPath);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14629.java