error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9054.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9054.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9054.java
text:
```scala
private final J@@Label dragIcon = new JLabel(JMeterUtils.getImage("leafnode.gif")); // $NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9054.java