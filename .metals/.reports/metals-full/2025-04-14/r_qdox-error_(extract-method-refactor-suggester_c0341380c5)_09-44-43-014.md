error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1986.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1986.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1986.java
text:
```scala
e@@xecutors.put(Names.MANAGEMENT, build(Names.MANAGEMENT, "scaling", groupSettings.get(Names.MANAGEMENT), settingsBuilder().put("keep_alive", "30s").put("size", 20).build()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1986.java