error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/732.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/732.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/732.java
text:
```scala
i@@f ((returnTypeBinding == TypeBinding.VOID) || isAbstract()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/732.java