error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1692.java
text:
```scala
e@@xtends BaseAttributeValue
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1692.java