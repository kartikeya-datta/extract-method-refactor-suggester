error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14053.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14053.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14053.java
text:
```scala
t@@hrow new WicketRuntimeException("OGNL Exception: expression='" + expression + "'; path='" + component.getPath() + "'", e);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14053.java