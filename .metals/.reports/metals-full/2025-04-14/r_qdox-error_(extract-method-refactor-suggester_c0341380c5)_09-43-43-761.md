error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1858.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1858.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1858.java
text:
```scala
private static final S@@tring ACTION_NAME = DeleteByQueryAction.NAME + "[index]";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1858.java