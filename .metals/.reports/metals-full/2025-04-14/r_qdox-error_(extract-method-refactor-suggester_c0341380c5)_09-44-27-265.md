error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7942.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7942.java
text:
```scala
final R@@esourceRoot deploymentRoot = phaseContext.getDeploymentUnit().getAttachment(Attachments.DEPLOYMENT_ROOT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7942.java