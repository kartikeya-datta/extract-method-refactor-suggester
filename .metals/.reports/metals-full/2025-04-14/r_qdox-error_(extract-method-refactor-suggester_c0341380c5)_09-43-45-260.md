error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/620.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/620.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/620.java
text:
```scala
i@@f (this.focusType == null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/620.java