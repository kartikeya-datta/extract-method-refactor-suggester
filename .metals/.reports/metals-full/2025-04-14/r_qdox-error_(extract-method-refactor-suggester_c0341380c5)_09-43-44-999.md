error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14668.java
text:
```scala
a@@ssertEquals(null, permissions.rolesFor(mambo));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14668.java