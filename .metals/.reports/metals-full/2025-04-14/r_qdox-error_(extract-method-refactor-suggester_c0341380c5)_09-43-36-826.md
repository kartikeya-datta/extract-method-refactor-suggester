error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2901.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2901.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2901.java
text:
```scala
s@@etCompactElseIfMode(setting.getValueIndex() == 1);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2901.java