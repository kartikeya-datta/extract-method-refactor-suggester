error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10689.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10689.java
text:
```scala
S@@copedProxyMode proxyMode = attributes.getEnum("proxyMode");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10689.java