error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9440.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9440.java
text:
```scala
public b@@oolean canReadEntryData(ZipArchiveEntry ze) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9440.java