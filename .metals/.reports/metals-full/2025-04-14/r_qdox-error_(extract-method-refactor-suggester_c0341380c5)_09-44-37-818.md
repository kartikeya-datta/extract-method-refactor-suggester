error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15935.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15935.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15935.java
text:
```scala
private final I@@terator delegate;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15935.java