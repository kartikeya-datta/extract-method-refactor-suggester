error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2977.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2977.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2977.java
text:
```scala
r@@es.setSamplerData(request);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2977.java