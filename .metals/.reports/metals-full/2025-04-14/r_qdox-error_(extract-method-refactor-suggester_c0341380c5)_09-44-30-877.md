error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6270.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6270.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6270.java
text:
```scala
p@@arent.setItemHeight (image, null, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6270.java