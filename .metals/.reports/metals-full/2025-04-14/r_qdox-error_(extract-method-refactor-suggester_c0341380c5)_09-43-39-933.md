error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7721.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7721.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7721.java
text:
```scala
i@@f (controller != null && controller.getState() == ServiceController.State.UP && controller.getSubstate().isRestState()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7721.java