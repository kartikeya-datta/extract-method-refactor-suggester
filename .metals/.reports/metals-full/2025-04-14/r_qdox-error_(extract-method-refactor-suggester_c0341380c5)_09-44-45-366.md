error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11547.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11547.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11547.java
text:
```scala
S@@tring startLevelServiceNotAvailable();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11547.java