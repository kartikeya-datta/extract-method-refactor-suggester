error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12413.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12413.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12413.java
text:
```scala
s@@uper(true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12413.java