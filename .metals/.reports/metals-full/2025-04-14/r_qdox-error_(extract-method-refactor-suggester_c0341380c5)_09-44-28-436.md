error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5455.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5455.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5455.java
text:
```scala
f@@alse, // never consider opt false case for DO loop, since break can always occur (47776)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5455.java