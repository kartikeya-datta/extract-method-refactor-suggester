error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/689.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/689.java
text:
```scala
I@@ndexWriter modifier = new IndexWriter(directory, autoCommit, ANALYZER, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/689.java