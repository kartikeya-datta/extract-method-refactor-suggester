error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9850.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9850.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9850.java
text:
```scala
r@@eturn new FieldDataBreakerStats(-1, -1, 0, 0);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9850.java