error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9185.java
text:
```scala
n@@ew AspectJExpressionPointcut(candidateAspectClass, new String[0], new Class<?>[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9185.java