error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8070.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8070.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8070.java
text:
```scala
M@@ailInterface.config.getComposerOptionsConfig().getSpellcheckItem();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8070.java