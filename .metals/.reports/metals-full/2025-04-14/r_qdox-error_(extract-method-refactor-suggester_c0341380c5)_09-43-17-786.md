error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3946.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3946.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3946.java
text:
```scala
i@@ndexOutput = shard.store().createOutputRaw(name);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3946.java