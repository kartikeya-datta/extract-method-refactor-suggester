error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2424.java
text:
```scala
w@@hile (!channel.isClosed()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2424.java