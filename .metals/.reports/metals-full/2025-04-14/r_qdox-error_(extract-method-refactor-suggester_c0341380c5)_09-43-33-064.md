error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4442.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4442.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4442.java
text:
```scala
+ C@@onfigurator.INSTANCE.getID().getName();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4442.java