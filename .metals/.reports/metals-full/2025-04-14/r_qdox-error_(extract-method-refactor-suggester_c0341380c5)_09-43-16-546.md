error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9533.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9533.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9533.java
text:
```scala
s@@etActionDefinitionId(IWorkbenchCommandConstants.FILE_SAVE_AS);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9533.java