error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16601.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16601.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16601.java
text:
```scala
private D@@ateFormat dateFormat;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16601.java