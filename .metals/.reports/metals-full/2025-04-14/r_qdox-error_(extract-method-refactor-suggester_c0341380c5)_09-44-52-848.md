error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5185.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5185.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5185.java
text:
```scala
t@@his.tab_size = 8;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5185.java