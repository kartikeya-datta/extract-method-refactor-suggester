error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7131.java
text:
```scala
o@@ut.writeString(names.length == 0 ? "*" : names[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7131.java