error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5029.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5029.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5029.java
text:
```scala
F@@ieldBinding[] newFieldBindings = new FieldBinding[fieldBindings.length];
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5029.java