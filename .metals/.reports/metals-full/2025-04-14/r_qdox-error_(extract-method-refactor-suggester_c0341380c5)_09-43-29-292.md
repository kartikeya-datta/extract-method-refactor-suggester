error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2412.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2412.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2412.java
text:
```scala
i@@f (sortColumn != null && !sortColumn.isDisposed ()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2412.java