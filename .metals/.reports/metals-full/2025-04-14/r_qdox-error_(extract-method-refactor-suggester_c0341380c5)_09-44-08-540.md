error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2687.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2687.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2687.java
text:
```scala
i@@nt compareTerm(Terms.Bucket other) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2687.java