error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17251.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17251.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17251.java
text:
```scala
i@@nt /*long*/ result = OS.objc_msgSend(OS.class_NSInputManager, OS.sel_currentInputManager);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17251.java