error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6616.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6616.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6616.java
text:
```scala
c@@atch (Throwable ex) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6616.java