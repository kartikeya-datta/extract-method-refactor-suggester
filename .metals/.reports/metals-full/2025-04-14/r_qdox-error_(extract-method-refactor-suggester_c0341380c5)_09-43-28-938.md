error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17486.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17486.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17486.java
text:
```scala
r@@eturn new LongID(ns, (Long) args[0]);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17486.java