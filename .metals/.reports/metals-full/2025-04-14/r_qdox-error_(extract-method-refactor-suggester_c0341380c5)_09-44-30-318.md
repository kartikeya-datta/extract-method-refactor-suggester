error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9624.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9624.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9624.java
text:
```scala
P@@ooledConnectionFactoryService.installService(serviceTarget, pcfName, getHornetQServerName(), connectors,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9624.java