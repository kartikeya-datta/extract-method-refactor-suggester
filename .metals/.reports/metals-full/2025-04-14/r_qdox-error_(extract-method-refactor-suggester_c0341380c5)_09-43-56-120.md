error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7289.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7289.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7289.java
text:
```scala
r@@eturn HttpRequest.get(url, 10, TimeUnit.MINUTES); // TODO (jrp) way to long only set for debugging
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7289.java