error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4912.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4912.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4912.java
text:
```scala
i@@f (feature.isChangeable() && !feature.isDerived() && !feature.isMany()) { // !feature.isUnsettable()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4912.java