error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14476.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14476.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14476.java
text:
```scala
final S@@erviceController<?> controller = updateContext.getServiceRegistry().getRequiredService(LogServices.handlerName(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14476.java