error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10393.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10393.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10393.java
text:
```scala
l@@ogger.info(String.format("Could not detect default resource locations for test class [%s]: "
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10393.java