error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3370.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3370.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3370.java
text:
```scala
n@@ew String[0], new String[0], "i686-w64-mingw32-", "-c -Wall -O2 -mfpmath=sse -msse2 -fmessage-length=0 -m32",
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3370.java