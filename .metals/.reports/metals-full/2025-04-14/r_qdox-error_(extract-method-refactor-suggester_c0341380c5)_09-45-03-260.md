error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1919.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1919.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1919.java
text:
```scala
i@@f (!workbench.isStarting() && !workbench.isClosing() && count <= 1 && workbench.getWorkbenchConfigurer().getExitOnLastWindowClose()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1919.java