error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2014.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2014.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2014.java
text:
```scala
static S@@tring roboVMVersion = "0.0.12";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2014.java