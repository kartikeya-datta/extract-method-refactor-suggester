error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3738.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3738.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3738.java
text:
```scala
r@@eturn (FormComponent.this.isActionAuthorized(ENABLE) && FormComponent.this.isEnabled())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3738.java