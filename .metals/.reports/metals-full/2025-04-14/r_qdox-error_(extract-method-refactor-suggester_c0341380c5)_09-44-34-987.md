error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9851.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9851.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9851.java
text:
```scala
C@@olumbaLogger.log.fine("using already cached message..");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9851.java