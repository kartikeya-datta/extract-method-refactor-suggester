error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15272.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15272.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15272.java
text:
```scala
g@@c.drawString (text, x, y + (height - extent.y) / 2, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15272.java