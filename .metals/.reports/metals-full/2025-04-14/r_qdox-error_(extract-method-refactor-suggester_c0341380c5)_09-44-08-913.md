error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15744.java
text:
```scala
S@@tring [] headerLines=headers.split(NEW_LINE, 0); // drop empty trailing content
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15744.java