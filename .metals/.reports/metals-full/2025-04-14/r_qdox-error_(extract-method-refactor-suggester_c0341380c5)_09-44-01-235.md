error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3104.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3104.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3104.java
text:
```scala
static final S@@impleAttributeDefinition TYPE = new SimpleAttributeDefinitionBuilder(ModelKeys.TYPE, ModelType.STRING, false)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3104.java