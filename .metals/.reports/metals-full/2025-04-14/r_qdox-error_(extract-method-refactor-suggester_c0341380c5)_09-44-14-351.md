error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2147.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2147.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2147.java
text:
```scala
.@@addVersionHash("/**");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2147.java