error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11197.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11197.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11197.java
text:
```scala
p@@ublic class AdminBookmarkablePage extends BasePage
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11197.java