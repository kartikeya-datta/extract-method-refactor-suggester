error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1361.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1361.java
...
```java
offset: 1117
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1361.java
text:
```scala
...
p@@ackage org.jboss.as.clustering.service;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1361.java