error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3961.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3961.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3961.java
text:
```scala
s@@hortSignature.toString(),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3961.java