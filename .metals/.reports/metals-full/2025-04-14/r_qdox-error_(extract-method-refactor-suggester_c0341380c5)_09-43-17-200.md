error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/313.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/313.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/313.java
text:
```scala
i@@ndexShard.flush(new Engine.Flush().type(request.full() ? Engine.Flush.Type.NEW_WRITER : Engine.Flush.Type.COMMIT_TRANSLOG).force(request.force()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/313.java