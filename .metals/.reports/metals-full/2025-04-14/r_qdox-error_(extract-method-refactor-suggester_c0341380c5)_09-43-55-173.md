error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/742.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/742.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/742.java
text:
```scala
c@@omponent.render();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/742.java