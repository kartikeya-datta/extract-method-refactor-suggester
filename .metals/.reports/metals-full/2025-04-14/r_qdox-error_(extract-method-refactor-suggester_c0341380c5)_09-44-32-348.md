error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4119.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4119.java
text:
```scala
protected T@@ransactionAttributeType fromAnnotation(final AnnotationInstance annotationInstance, final boolean replacement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4119.java