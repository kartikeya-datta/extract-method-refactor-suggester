error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8797.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8797.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8797.java
text:
```scala
r@@eturn buffer.capacity();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8797.java