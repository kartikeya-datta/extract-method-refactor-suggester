error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7055.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7055.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7055.java
text:
```scala
protected W@@ebApplicationContext createWebApplicationContext(ApplicationContext parent) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7055.java