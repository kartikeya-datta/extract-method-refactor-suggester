error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8017.java
text:
```scala
r@@eturn new SecondLevelCacheSessionStore(new FilePageStore());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8017.java