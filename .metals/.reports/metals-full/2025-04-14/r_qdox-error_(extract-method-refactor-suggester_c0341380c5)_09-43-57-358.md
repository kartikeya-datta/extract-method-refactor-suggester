error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8689.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8689.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[136,2]

error in qdox parser
file content:
```java
offset: 4409
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8689.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8689.java