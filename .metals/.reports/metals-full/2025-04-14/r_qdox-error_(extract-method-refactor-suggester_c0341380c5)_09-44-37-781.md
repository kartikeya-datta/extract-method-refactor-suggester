error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5024.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5024.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5024.java
text:
```scala
private final S@@et<StatefulRemoveMethod> removeMethods = new HashSet<StatefulRemoveMethod>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5024.java