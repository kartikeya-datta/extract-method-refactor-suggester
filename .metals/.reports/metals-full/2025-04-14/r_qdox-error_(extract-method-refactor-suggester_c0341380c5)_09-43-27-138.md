error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1399.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1399.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1399.java
text:
```scala
l@@abel.setText("<user>@<xmppserver>[:port]");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1399.java