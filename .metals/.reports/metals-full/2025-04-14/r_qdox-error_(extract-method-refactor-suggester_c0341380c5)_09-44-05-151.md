error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13952.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13952.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13952.java
text:
```scala
g@@etDataCacheManagerInstance().getDataCache(cacheName, true));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13952.java