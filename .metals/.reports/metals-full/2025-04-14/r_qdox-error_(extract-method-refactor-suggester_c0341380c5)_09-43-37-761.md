error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13669.java
text:
```scala
t@@hrow new WicketRuntimeException("Unable to load class with name: " + classname, ex);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13669.java