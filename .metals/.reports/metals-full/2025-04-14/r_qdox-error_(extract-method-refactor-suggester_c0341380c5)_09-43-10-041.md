error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12303.java
text:
```scala
d@@eclarer.declareStream(TRANSACTION_BATCH_STREAM_ID, new Fields("tx", "tx-meta", "committed-txid"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12303.java