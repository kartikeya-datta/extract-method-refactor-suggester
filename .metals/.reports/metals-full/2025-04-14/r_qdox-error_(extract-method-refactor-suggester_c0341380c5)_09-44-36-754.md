error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9279.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9279.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9279.java
text:
```scala
r@@eturn new FsTranslog(shardId, EMPTY_SETTINGS, new File("work/fs-translog"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9279.java