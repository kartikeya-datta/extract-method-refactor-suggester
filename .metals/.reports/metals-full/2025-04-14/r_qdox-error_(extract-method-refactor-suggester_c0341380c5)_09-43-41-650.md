error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/535.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/535.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/535.java
text:
```scala
r@@et.add(ResolvedMemberImpl.readResolvedMember(s, null));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/535.java