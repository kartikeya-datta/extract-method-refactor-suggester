error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7907.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7907.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7907.java
text:
```scala
P@@ercolatorExecutor.Response percolate = percolatorService.percolate(new PercolatorExecutor.SourceRequest(request.source()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7907.java