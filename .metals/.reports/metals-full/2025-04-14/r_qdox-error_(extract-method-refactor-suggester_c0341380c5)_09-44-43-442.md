error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1539.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1539.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1539.java
text:
```scala
i@@f ((getStyle () & SWT.SHEET) != 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1539.java