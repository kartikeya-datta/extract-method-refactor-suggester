error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3017.java
text:
```scala
r@@eturn !t.isAlive() || time!=null && currentTimeMillis() < time.longValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3017.java