error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3532.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3532.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3532.java
text:
```scala
M@@ethodScope methodScope,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3532.java