error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10736.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10736.java
text:
```scala
public static D@@iscardTransformationDescriptionBuilder createDiscardInstance(PathElement pathElement) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10736.java