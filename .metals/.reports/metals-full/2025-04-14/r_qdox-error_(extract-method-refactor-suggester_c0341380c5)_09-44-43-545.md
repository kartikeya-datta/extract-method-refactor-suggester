error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5392.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5392.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5392.java
text:
```scala
i@@ntent.putExtra(GitHubIntents.EXTRA_COMMENT_BODY, comment);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5392.java