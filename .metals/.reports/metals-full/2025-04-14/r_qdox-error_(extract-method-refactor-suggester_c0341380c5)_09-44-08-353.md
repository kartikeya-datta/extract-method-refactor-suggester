error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3779.java
text:
```scala
s@@essionID = statefulSessionComponent.createSession();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3779.java