error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12944.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12944.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12944.java
text:
```scala
M@@ockito.verify(context).stepCompleted();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12944.java