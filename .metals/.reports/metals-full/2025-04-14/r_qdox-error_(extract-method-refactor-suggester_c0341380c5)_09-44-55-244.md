error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4803.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4803.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4803.java
text:
```scala
t@@his.lookupEnvironment.completeTypeBindings(parsedUnit, true); // TODO (jerome) build fields and methods only for super types of local types
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4803.java