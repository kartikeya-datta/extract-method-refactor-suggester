error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2525.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2525.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2525.java
text:
```scala
t@@his.position = codeStream.getPosition();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2525.java