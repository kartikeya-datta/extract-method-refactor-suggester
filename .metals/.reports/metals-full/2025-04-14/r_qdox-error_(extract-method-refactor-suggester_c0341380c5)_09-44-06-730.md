error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1035.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1035.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1035.java
text:
```scala
i@@nt /*long*/ drawLabelInRectProc = OS.CALLBACK_drawLabel_inRect_ (proc4);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1035.java