error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9573.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9573.java
text:
```scala
public b@@oolean isEnumConstant;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9573.java