error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13911.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13911.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13911.java
text:
```scala
static i@@nt MINOR_VERSION = 328;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13911.java