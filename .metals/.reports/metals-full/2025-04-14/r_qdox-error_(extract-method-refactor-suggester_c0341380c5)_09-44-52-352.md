error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9643.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9643.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9643.java
text:
```scala
t@@sig.apply(query, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9643.java