error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/346.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/346.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/346.java
text:
```scala
e@@xpression.checkNullStatus(currentScope, flowContext, flowInfo, FlowInfo.NON_NULL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/346.java