error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2462.java
text:
```scala
a@@ctionSetSourceProvider = new ActionSetSourceProvider();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2462.java