error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17662.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17662.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[57,27]

error in qdox parser
file content:
```java
offset: 1754
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17662.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17662.java