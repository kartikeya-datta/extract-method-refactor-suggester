error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4998.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4998.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4998.java
text:
```scala
final d@@ouble[] x = b.toArray();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4998.java