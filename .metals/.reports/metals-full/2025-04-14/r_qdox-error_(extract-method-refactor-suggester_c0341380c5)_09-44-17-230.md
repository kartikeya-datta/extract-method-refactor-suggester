error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6597.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6597.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6597.java
text:
```scala
t@@argetString, username, null, workspace,false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6597.java