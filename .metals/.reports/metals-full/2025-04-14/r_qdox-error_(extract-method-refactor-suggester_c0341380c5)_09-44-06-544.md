error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2236.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2236.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2236.java
text:
```scala
i@@f (latestTimeOffset == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/2236.java