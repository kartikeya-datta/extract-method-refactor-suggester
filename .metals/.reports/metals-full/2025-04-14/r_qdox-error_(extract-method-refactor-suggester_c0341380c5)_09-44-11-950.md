error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4451.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4451.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4451.java
text:
```scala
D@@efaultSearchEngine engine = parentFolder.getSearchEngine();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4451.java