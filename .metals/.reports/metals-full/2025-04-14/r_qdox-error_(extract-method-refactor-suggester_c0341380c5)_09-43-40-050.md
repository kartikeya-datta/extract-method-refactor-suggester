error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17018.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17018.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17018.java
text:
```scala
I@@SharedObjectContainer result =  SharedObjectContainerFactory.getDefault().createSharedObjectContainer(contd,new Object[] { newContainerID, new Integer(DEFAULT_TIMEOUT)});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17018.java