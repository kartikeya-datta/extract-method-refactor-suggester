error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/122.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/122.java
text:
```scala
p@@attern = new Text(content, SWT.SINGLE | SWT.BORDER | SWT.SEARCH | SWT.ICON_CANCEL);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/122.java