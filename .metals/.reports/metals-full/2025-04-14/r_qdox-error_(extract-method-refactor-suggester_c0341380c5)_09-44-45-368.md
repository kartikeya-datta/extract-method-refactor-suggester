error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5424.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5424.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5424.java
text:
```scala
r@@eturn isDisposed () || runAsyncMessages (false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5424.java