error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16375.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16375.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16375.java
text:
```scala
i@@nterface ObjectConfigurer
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16375.java