error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5711.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5711.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5711.java
text:
```scala
d@@ouble[] inversetransform(double f[])
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5711.java