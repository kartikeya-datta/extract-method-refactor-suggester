error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18074.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18074.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18074.java
text:
```scala
private S@@tructureViewProperties.Granularity granularity = StructureViewProperties.Granularity.DECLARED_ELEMENTS;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18074.java