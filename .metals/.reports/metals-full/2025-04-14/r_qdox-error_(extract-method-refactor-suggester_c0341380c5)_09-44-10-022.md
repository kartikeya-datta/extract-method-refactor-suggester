error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1095.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1095.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1095.java
text:
```scala
r@@enderer.begin(ShapeType.Filled);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1095.java