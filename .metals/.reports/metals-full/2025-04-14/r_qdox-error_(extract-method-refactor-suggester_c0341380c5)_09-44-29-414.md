error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5397.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5397.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5397.java
text:
```scala
i@@f (fieldMapping == null && indexCreatedVersion.onOrAfter(Version.V_1_4_0_Beta1)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5397.java