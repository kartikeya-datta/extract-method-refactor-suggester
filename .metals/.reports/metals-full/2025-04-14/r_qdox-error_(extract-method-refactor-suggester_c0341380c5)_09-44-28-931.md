error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1211.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1211.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1211.java
text:
```scala
t@@hrow new UnavailableException();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1211.java