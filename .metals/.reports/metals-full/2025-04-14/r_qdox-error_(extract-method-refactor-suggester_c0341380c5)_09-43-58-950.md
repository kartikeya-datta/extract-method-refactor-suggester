error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1145.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1145.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1145.java
text:
```scala
v@@oid assignSlots(Collection<TopologyDetails> topologies, Collection<WorkerSlot> newSlots);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1145.java