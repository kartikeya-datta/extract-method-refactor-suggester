error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8291.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8291.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8291.java
text:
```scala
B@@ytesStreamOutput out = CachedStreamOutput.popEntry().bytes();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8291.java