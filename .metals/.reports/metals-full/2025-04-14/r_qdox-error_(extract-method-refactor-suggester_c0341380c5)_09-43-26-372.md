error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12779.java
...
```java
offset: 3
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12779.java
text:
```scala
+ f@@mt.format(rand.nextInt(Integer.MAX_VALUE)) + suffix);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12779.java