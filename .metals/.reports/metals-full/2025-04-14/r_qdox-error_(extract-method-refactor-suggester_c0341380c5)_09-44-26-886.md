error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5949.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5949.java
text:
```scala
P@@ageMap pageMap = pageMapForName(pageMapName, pageMapName.equals(PageMap.DEFAULT_NAME));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5949.java