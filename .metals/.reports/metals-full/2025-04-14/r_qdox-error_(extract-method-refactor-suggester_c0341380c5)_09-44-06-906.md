error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10225.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10225.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10225.java
text:
```scala
r@@eturn new LongValuesComparator(indexFieldData, dMissingValue, numHits, reversed);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10225.java