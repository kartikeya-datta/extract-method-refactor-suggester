error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/405.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/405.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/405.java
text:
```scala
c@@atchInfo.setReachMode(FlowInfo.UNREACHABLE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/405.java