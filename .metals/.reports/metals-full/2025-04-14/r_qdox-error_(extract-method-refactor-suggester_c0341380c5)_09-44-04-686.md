error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5712.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5712.java
text:
```scala
o@@ptions.sourceLevel);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5712.java