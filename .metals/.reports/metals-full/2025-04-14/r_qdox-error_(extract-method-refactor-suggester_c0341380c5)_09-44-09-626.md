error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5573.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5573.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5573.java
text:
```scala
r@@eturn Math.max(0, Math.min(length, untranslateOffset(offset)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5573.java