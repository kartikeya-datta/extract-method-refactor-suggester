error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/177.java
text:
```scala
i@@nt /*long*/ scrolledHandle = scrolledHandle ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/177.java