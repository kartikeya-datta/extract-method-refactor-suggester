error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5022.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5022.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5022.java
text:
```scala
public W@@izardButtonBar(final String id, final IWizard wizard)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5022.java