error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17810.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17810.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17810.java
text:
```scala
p@@ublic interface IPageParametersEncoder
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17810.java