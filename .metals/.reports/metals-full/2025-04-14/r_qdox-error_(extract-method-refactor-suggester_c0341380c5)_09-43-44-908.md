error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18182.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18182.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18182.java
text:
```scala
private static final S@@tring PROPVERSION = "1.5";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18182.java