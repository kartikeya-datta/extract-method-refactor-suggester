error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8975.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8975.java
text:
```scala
r@@eturn _key.getType();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8975.java