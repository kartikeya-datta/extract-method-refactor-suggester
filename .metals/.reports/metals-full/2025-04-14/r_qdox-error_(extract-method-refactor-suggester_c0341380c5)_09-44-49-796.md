error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1801.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1801.java
text:
```scala
public F@@ieldConfig getFieldConfig(String fieldName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1801.java