error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1962.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1962.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1962.java
text:
```scala
V@@ERSION = "8.0.0.Alpha2-SNAPSHOT";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1962.java