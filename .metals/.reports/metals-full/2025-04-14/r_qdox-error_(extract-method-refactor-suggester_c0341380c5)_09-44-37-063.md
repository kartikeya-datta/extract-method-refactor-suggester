error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6501.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6501.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6501.java
text:
```scala
private volatile C@@lusteredSessionNotificationCapability capability;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6501.java