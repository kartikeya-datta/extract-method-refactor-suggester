error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5965.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5965.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5965.java
text:
```scala
public S@@ynchronizedListTest(final String testName) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5965.java