error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5811.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5811.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5811.java
text:
```scala
W@@icketTagIdentifier.registerWellKnownTagName("head");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/5811.java