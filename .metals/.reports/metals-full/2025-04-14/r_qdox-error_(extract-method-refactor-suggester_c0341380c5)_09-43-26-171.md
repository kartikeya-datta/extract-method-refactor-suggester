error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16925.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16925.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16925.java
text:
```scala
O@@S.CGPathAddArc(handle, cmt, 0, 0, 1, -(startAngle + arcAngle) * (float)Compatibility.PI / 180,  -startAngle * (float)Compatibility.PI / 180, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16925.java