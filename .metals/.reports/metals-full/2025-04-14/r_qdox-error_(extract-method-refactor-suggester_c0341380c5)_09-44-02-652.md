error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2012.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2012.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2012.java
text:
```scala
t@@ext.setText("file://"+Snippet186.class.getResource("Snippet186.html").getFile());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2012.java