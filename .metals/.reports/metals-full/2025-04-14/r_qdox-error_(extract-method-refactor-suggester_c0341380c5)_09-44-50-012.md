error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/312.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/312.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/312.java
text:
```scala
protected O@@bject newInstance (Class type) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/312.java