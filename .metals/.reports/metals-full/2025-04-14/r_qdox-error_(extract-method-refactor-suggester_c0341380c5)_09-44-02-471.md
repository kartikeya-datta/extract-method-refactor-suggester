error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4151.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4151.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4151.java
text:
```scala
i@@f (f instanceof VirtualFolder && f.getUid() != 106 && ((IMailFolder)f.getParent()).getUid() != 106) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4151.java