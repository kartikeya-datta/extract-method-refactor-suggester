error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2932.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2932.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2932.java
text:
```scala
i@@sPainting = isPainting.initWithCapacity(12);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2932.java