error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6886.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6886.java
text:
```scala
public C@@omponent getHeader(MarkupContainer parent, String componentId)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6886.java