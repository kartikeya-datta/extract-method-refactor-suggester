error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2929.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2929.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2929.java
text:
```scala
T@@extButtonTest.class, TextButtonTestGL2.class, TextureBindTest.class, SortedSpriteTest.class, DelaunayTriangulatorTest.class,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2929.java