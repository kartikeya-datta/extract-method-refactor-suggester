error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2437.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2437.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2437.java
text:
```scala
r@@eadOffset = decodeAnnotation(readOffset);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2437.java