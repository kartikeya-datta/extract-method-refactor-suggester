error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1148.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1148.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1148.java
text:
```scala
public static final S@@erviceName HC_EXECUTOR_SERVICE_NAME = HC_SERVICE_NAME.append("executor");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1148.java