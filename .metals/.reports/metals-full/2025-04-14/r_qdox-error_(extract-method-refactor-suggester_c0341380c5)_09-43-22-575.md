error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6792.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6792.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6792.java
text:
```scala
S@@erviceName raServiceName = ConnectorServices.getResourceAdapterServiceName(raName, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6792.java