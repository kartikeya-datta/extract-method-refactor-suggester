error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/108.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/108.java
text:
```scala
O@@S.Pen_Thickness(pen, width == 0 ? 1 : width);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/108.java