error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3589.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3589.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3589.java
text:
```scala
i@@f(!contentRepository.syncContent(hash)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3589.java