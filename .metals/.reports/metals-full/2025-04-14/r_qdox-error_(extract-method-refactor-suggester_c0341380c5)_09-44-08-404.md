error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1690.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1690.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1690.java
text:
```scala
i@@f ((style & SWT.FULL_SELECTION) == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1690.java