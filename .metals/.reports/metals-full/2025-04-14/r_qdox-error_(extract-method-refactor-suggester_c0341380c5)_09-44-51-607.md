error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/942.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/942.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/942.java
text:
```scala
T@@ypefaceUtils.setOcticons(pullRequestIcon, (TextView) view.findViewById(id.tv_comment_icon));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/942.java