error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8485.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8485.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8485.java
text:
```scala
b@@adlogic = spriteSheet.get("badlogicslice");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8485.java