error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6483.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6483.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6483.java
text:
```scala
private final O@@penIntToDoubleHashMap entries;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6483.java