error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17265.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17265.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17265.java
text:
```scala
public v@@oid drawSortIndicatorWithFrame(NSRect cellFrame, NSView controlView, boolean ascending, int /*long*/ priority) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17265.java