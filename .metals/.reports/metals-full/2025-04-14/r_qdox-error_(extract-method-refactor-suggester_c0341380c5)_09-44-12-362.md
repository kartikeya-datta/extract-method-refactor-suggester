error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16847.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16847.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16847.java
text:
```scala
I@@Converter converter = null;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16847.java