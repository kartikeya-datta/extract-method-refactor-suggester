error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/286.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/286.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/286.java
text:
```scala
a@@ction.restart();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/286.java