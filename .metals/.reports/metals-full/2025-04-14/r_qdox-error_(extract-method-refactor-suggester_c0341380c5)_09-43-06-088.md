error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3118.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3118.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3118.java
text:
```scala
S@@canner scanner = new Scanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/, assertMode, null/*taskTags*/, null/*taskPriorities*/);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3118.java