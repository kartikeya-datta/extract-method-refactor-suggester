error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1080.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1080.java
...
```java
offset: 2097
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1080.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1080.java