error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/61.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/61.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/61.java
text:
```scala
I@@ndexFileNames.segmentFileName(id, Bytes.DV_SEGMENT_SUFFIX, Writer.DATA_EXTENSION),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/61.java