error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9933.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9933.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9933.java
text:
```scala
l@@ogger.trace("Get for [{}#{}] returned [{}]", type, id, doc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9933.java