error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3345.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3345.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3345.java
text:
```scala
public static V@@ersion fromId(int id) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3345.java