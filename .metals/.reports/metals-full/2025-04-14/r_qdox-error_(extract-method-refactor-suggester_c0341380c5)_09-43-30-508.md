error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3715.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3715.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3715.java
text:
```scala
r@@eturn new SessionObjectReferenceImpl((EjbDescriptorImpl<?>) ejbDescriptor);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3715.java