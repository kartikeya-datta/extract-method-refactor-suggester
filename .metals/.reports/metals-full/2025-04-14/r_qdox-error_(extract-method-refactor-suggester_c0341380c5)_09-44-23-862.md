error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6990.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6990.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6990.java
text:
```scala
I@@nteger.valueOf(index), Integer.valueOf(sz)));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6990.java