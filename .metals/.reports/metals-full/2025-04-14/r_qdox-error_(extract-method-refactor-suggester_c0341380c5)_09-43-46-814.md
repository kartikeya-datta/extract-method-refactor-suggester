error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/544.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/544.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/544.java
text:
```scala
i@@nt setter = OS.gcnew_SetterVisibility (dp, OS.Visibility_Collapsed);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/544.java