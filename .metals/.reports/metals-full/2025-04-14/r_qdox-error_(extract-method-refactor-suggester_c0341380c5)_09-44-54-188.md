error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5638.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5638.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5638.java
text:
```scala
m@@ergeFactor, minMergeDocs, maxMergeDocs, useCompoundFile, calibrateSizeByDeletes);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5638.java