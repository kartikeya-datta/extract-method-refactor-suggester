error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5801.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5801.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5801.java
text:
```scala
public R@@everseComparator(final Comparator<? super E> comparator) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5801.java