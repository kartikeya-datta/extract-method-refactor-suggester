error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13004.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13004.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13004.java
text:
```scala
final C@@lass<? extends Page> pageClass = requestTarget.getPageClass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13004.java