error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6959.java
text:
```scala
C@@lass markupClass = ((WicketTag)markupStream.getTag()).getMarkupClass();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6959.java