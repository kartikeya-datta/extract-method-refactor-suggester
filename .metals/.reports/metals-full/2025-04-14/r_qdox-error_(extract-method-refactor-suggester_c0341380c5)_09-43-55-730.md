error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7664.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7664.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7664.java
text:
```scala
O@@ptionalPackage getOptionalPackage( Extension extension );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7664.java