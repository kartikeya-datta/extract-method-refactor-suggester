error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17650.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[169,80]

error in qdox parser
file content:
```java
offset: 4647
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17650.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17650.java