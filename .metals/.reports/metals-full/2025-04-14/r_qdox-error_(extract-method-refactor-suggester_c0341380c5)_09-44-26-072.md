error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12199.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12199.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12199.java
text:
```scala
S@@ingleSignOnManagerService.build(target, managerServiceName, virtualHostServiceName)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12199.java