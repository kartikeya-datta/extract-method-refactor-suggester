error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3503.java
text:
```scala
i@@f (flags != 0 && (hasSelection || (flags & 4) != 0)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3503.java