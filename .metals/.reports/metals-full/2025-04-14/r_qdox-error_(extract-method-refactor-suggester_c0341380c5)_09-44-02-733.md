error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2063.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2063.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2063.java
text:
```scala
i@@nt SPRITES = 336 / 2;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2063.java