error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9052.java
text:
```scala
J@@avascriptUtils.writeJavascript(response, "wicketAjaxDebugEnable=true;", "wicket-ajax-debug-enable");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9052.java