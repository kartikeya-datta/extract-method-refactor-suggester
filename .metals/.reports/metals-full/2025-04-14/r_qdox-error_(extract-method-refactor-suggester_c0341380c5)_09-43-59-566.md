error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4741.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4741.java
...
```java
offset: 1107
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4741.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.testsuite.integration.ejb.descriptor;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/4741.java