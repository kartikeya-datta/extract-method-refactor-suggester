error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6955.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6955.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6955.java
text:
```scala
b@@inaryType = new HierarchyBinaryType(record.modifiers, record.pkgName, typeName, enclosingTypeName, record.typeParameterSignatures, record.classOrInterface);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6955.java