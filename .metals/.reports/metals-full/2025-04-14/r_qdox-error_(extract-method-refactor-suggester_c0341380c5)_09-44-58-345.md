error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7973.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7973.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7973.java
text:
```scala
t@@his.registrar = this.context.getBeansOfType(
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7973.java