error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7556.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7556.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7556.java
text:
```scala
l@@ogger.trace("{}: {}",  component, message);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7556.java