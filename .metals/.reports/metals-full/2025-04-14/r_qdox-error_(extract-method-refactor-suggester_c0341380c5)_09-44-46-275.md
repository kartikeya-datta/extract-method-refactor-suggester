error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8119.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8119.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8119.java
text:
```scala
r@@eturn compareMin <= 0 && compareMax >= 0;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8119.java