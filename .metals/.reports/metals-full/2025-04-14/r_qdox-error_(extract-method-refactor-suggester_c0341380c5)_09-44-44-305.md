error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2403.java
text:
```scala
C@@olumbaLogger.log.info("start encryption...");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2403.java