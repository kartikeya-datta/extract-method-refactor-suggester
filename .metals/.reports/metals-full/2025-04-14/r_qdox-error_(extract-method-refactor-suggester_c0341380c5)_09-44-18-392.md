error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7052.java
text:
```scala
t@@hrow new Error(Util.bind("error.undefinedBaseType",String.valueOf(signature[start]))); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7052.java