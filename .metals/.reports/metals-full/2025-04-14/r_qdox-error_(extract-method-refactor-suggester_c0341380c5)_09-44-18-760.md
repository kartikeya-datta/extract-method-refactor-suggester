error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8615.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8615.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8615.java
text:
```scala
S@@tring server = twoUp.getLastElement().getValue();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8615.java