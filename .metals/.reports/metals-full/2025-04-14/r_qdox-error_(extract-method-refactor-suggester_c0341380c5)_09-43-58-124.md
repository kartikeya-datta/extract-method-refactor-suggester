error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4683.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4683.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4683.java
text:
```scala
public static final i@@nt sizeof = OS.DROPFILES_sizeof ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4683.java