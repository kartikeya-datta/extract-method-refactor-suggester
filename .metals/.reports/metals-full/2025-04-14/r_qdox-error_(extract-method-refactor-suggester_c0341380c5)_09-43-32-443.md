error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1668.java
text:
```scala
p@@ublic interface IAccessCheck
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1668.java