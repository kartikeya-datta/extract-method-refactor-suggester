error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8253.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8253.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8253.java
text:
```scala
r@@eturn Boolean.getBoolean("java.security.krb5.debug"); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8253.java