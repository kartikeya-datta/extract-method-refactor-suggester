error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13426.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13426.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13426.java
text:
```scala
p@@ublic abstract class WicketWebTestCase extends WebTestCase
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13426.java