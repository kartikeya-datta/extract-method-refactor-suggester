error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/122.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/122.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/122.java
text:
```scala
s@@ession = getSessionFactory().newSession();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/122.java