error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6384.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6384.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6384.java
text:
```scala
a@@ssertThat(response.getStatus(), equalTo(Status.CREATED));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6384.java