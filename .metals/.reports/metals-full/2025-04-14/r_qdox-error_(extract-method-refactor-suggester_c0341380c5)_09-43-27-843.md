error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9210.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9210.java
...
```java
offset: 14
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9210.java
text:
```scala
static final S@@tring AGENT_STRING = "Safari/412.0"; /* Safari version on OSX 10.4 initial release */ //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9210.java