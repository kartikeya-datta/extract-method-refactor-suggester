error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4871.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4871.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4871.java
text:
```scala
r@@eturn "("/*nonNLS*/ + type.toString(0)+ ") "/*nonNLS*/ +
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4871.java