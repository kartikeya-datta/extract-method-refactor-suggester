error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3867.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3867.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3867.java
text:
```scala
i@@f (type == null || !type.isValidBinding() || type == TypeBinding.NULL) return;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3867.java