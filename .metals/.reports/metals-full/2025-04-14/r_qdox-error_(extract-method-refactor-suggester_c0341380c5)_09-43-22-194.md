error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8985.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8985.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8985.java
text:
```scala
i@@nt imageSize = Math.round(context.getResources().getDisplayMetrics().density * size + 0.5F);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8985.java