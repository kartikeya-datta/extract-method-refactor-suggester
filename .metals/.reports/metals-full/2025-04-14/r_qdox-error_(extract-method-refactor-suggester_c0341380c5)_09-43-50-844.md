error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7841.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7841.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7841.java
text:
```scala
a@@ssertTrue(Compare.compare(FILTERED, "witness/customLogger."+number));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7841.java