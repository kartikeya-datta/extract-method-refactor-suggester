error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15191.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15191.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15191.java
text:
```scala
t@@his.createFile = createFile;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15191.java