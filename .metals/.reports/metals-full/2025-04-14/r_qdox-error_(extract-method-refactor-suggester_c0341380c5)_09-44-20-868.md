error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5750.java
text:
```scala
s@@tore.setDefault(IPreferenceConstants.COLOR_ICONS, true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5750.java