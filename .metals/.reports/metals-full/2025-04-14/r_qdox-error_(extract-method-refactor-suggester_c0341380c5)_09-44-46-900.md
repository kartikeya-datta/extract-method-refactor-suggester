error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10650.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10650.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10650.java
text:
```scala
t@@extView.init ();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10650.java