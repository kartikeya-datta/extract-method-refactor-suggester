error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8039.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8039.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8039.java
text:
```scala
r@@eturn new BufferFormat(8, 8, 8, 0, 16, config.stencil?8:0, 0, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/8039.java