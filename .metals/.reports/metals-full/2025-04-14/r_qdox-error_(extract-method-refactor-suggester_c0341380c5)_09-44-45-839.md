error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15551.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15551.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15551.java
text:
```scala
i@@f (off == 0 && len == b.length)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/15551.java