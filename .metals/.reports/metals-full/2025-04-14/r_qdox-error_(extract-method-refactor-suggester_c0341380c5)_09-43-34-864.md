error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4226.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4226.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4226.java
text:
```scala
public v@@oid removeMessage(Object uid) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4226.java