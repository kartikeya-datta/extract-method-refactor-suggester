error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17648.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17648.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[397,80]

error in qdox parser
file content:
```java
offset: 12725
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17648.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17648.java