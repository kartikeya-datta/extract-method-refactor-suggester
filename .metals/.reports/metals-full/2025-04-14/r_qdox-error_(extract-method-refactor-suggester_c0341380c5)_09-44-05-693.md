error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5462.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5462.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5462.java
text:
```scala
n@@ew JUnitCore().runMain(new String[]{"org.junit.tests.running.core.CommandLineTest$Example"});
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5462.java