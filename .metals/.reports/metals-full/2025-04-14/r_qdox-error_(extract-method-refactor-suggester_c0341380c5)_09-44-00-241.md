error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/76.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/76.java
...
```java
offset: 17
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/76.java
text:
```scala
public abstract b@@oolean hasSubscription(MessageHandler handler);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/76.java