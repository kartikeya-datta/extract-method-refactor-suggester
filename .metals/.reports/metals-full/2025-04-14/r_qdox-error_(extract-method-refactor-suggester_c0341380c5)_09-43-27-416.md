error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9057.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9057.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9057.java
text:
```scala
r@@esourceRegistration.registerReadWriteAttribute(parameter.getAttribute(), null, JcaCachedConnectionManagerWriteHandler.INSTANCE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9057.java