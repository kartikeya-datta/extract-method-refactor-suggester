error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13832.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13832.java
text:
```scala
final d@@ouble root = (ta <= tb) ? solver.solve(ta, tb) : solver.solve(tb, ta);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/13832.java