error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3305.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3305.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3305.java
text:
```scala
n@@ew JUnit4ClassRunner(getTestClass()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3305.java