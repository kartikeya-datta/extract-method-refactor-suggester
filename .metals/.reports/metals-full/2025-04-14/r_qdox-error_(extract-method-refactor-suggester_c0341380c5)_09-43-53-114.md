error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9139.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9139.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9139.java
text:
```scala
M@@essages.bind(Messages.build_duplicateResource, id),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9139.java