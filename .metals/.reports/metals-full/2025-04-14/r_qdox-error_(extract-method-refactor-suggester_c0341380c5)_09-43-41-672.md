error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5280.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5280.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5280.java
text:
```scala
r@@eturn TransportActions.Admin.Indices.Validate.QUERY;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5280.java