error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1386.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1386.java
text:
```scala
h@@andleElementText(reader, element, ClusterConnectionDefinition.ADDRESS.getName(), clusterConnectionAdd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1386.java