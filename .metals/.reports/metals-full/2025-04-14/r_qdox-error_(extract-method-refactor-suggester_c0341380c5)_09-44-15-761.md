error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3980.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3980.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3980.java
text:
```scala
r@@esult.getInterceptor().handleTimeout(null, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3980.java