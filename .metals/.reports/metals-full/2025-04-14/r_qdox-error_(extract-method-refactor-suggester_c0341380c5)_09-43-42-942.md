error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2330.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2330.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2330.java
text:
```scala
v@@iewer.openWith(header, tempFile, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/2330.java