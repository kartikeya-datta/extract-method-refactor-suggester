error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8750.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8750.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8750.java
text:
```scala
a@@ssertTrue(getBuildException().getMessage().endsWith(" does not exist."));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/8750.java