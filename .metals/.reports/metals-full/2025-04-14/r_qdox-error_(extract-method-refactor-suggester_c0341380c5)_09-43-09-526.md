error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9328.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9328.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9328.java
text:
```scala
F@@ileRegistry(File file) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9328.java