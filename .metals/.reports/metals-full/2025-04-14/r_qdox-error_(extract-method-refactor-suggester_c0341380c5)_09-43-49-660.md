error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7570.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7570.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7570.java
text:
```scala
I@@llegalStateException illegalStateFailedToRegisterModule(@Cause Throwable th, Module module);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7570.java