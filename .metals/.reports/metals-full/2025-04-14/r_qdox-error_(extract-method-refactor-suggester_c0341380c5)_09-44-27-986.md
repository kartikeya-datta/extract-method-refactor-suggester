error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10886.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10886.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10886.java
text:
```scala
t@@c.convertValue(3, TypeDescriptor.forObject(3), TypeDescriptor.valueOf(Double.class));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10886.java