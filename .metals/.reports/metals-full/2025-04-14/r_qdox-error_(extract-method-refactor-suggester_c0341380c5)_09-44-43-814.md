error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/41.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/41.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/41.java
text:
```scala
i@@f (keyspace == null || !DatabaseDescriptor.getNonSystemTables().contains(keyspace))
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/41.java