error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/323.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/323.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/323.java
text:
```scala
i@@f( key.equalsIgnoreCase(SEI_ARGS_KEY) == true )
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/323.java