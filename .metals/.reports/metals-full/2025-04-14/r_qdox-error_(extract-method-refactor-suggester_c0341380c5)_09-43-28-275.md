error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12949.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12949.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12949.java
text:
```scala
public N@@SOpenGLPixelFormat initWithAttributes(int[] attribs) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12949.java