error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6440.java
text:
```scala
e@@nclosure.render(markupStream);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6440.java