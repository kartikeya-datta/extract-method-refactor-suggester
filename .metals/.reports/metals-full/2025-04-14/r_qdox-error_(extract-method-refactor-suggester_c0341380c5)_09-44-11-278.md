error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3756.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3756.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3756.java
text:
```scala
final i@@nt iterations = size();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3756.java