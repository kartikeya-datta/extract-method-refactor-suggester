error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11765.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11765.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11765.java
text:
```scala
public static final A@@ttachmentKey<ScisMetaData> ATTACHMENT_KEY = AttachmentKey.create(ScisMetaData.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/11765.java