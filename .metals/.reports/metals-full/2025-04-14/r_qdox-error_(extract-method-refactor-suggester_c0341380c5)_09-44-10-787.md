error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5241.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5241.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5241.java
text:
```scala
c@@lusterStateRequest.clear().blocks(true);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5241.java