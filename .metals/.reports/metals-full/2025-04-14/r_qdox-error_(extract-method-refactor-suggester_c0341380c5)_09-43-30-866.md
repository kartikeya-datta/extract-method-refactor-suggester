error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1108.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1108.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1108.java
text:
```scala
private L@@ist<Class> classes = new ArrayList<Class>(2);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1108.java