error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5827.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5827.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5827.java
text:
```scala
n@@ew SecurityRealmChildAddHandler(false, VALUE), new SecurityRealmChildRemoveHandler(false),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5827.java