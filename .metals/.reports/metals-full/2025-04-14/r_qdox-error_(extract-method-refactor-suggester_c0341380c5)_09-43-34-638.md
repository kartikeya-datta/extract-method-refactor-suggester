error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3166.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3166.java
text:
```scala
final S@@tring fileName = file.getName().toLowerCase();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3166.java