error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6779.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6779.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6779.java
text:
```scala
i@@f (toolTip.length() == 0) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6779.java