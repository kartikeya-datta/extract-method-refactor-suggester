error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/514.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/514.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/514.java
text:
```scala
r@@eturn (float)Math.sqrt( sum / values.length );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/514.java