error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4005.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4005.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4005.java
text:
```scala
s@@uper("org.columba.addressbook.folder", "org/columba/addressbook/plugin/folder.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4005.java