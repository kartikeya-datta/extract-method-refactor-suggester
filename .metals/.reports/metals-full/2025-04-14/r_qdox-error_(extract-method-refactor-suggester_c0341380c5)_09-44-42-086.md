error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8244.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8244.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8244.java
text:
```scala
i@@f (null != iter && iter.hasNext()) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8244.java