error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7320.java
text:
```scala
D@@iscoveryStartup.registerService(cont.getID().toURI());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7320.java