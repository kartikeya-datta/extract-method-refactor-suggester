error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8403.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8403.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8403.java
text:
```scala
r@@ec.strings.add(nextString(st));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8403.java