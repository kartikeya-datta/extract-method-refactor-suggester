error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5166.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5166.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5166.java
text:
```scala
final C@@lusterState nodeSpecificClusterState = ClusterState.Builder.fromBytes(clusterStateBytes, discovery.localNode, clusterName);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/5166.java