error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3064.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3064.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3064.java
text:
```scala
i@@writer.shutdown();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3064.java