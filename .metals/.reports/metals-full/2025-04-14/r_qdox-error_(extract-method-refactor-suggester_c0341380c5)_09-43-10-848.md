error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8608.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8608.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8608.java
text:
```scala
i@@f (flowInfo != FlowInfo.DEAD_END) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8608.java