error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10177.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10177.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10177.java
text:
```scala
s@@priteBatch.draw( frameBuffer.getColorBufferTexture(), 0, 0, 256, 256, 0, 0, frameBuffer.getColorBufferTexture().getWidth(), frameBuffer.getColorBufferTexture().getHeight(), Color.WHITE, false, true );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/10177.java