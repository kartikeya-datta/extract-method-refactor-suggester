error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10842.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10842.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10842.java
text:
```scala
i@@nt read = IOUtils.readFully(this, namebuffer, 0, bufflen);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10842.java