error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5418.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5418.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5418.java
text:
```scala
private S@@tring selectedLeaf = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/5418.java