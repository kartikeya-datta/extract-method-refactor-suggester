error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7411.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7411.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7411.java
text:
```scala
public v@@oid handleError(Throwable exception, WebSocketSession webSocketSession) throws Exception {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7411.java