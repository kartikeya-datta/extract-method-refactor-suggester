error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6818.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6818.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6818.java
text:
```scala
i@@f (maxPending != null) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6818.java