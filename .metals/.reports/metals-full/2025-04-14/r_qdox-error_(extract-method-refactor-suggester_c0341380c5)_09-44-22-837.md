error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/790.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/790.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/790.java
text:
```scala
a@@ssertTrue("Cant find required type Aspect",!rtx.isMissing());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/790.java