error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6996.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6996.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6996.java
text:
```scala
a@@ssertSame(Connector.Type.HTTP, new UndertowConnector(new HttpListenerService("", "", options, false)).getType());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6996.java