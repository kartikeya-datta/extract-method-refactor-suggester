error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14440.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14440.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14440.java
text:
```scala
s@@ar.addAsManifestResource(SarInjectionTestCase.class.getPackage(), "jboss-service.xml", "jboss-service.xml");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14440.java