error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12924.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12924.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12924.java
text:
```scala
C@@ommonDescriptions.getResourceDescriptionResolver("core", "management", "security-realm", "server-identity", "secret"),
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12924.java