error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14081.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14081.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14081.java
text:
```scala
c@@lient = (DistributedRPC.Iface) ServiceRegistry.getService(host);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14081.java