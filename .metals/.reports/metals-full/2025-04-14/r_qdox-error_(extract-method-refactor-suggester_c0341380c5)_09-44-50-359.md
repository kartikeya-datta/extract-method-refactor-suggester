error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4320.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4320.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4320.java
text:
```scala
i@@nt lastEventTime, visibleCount = 30;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4320.java