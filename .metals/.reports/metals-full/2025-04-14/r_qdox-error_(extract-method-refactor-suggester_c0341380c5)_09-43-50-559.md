error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4975.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4975.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4975.java
text:
```scala
public K@@eys<K> keys () {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/4975.java