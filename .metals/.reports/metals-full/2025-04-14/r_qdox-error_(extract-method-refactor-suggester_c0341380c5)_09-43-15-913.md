error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10832.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10832.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10832.java
text:
```scala
final T@@ransaction transaction = this.transactionsRepository.getImportedTransaction(this.xidTransactionID);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/10832.java