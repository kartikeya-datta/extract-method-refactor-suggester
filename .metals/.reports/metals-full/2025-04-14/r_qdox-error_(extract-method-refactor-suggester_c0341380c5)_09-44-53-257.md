error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13628.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13628.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13628.java
text:
```scala
private I@@sSigned isSigned = new IsSigned();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/13628.java