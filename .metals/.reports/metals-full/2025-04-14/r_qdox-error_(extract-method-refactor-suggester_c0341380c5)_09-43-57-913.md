error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1922.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1922.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1922.java
text:
```scala
d@@ateTimeFormatter.parser().parseMillis(jsonContext.jp().getText());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1922.java