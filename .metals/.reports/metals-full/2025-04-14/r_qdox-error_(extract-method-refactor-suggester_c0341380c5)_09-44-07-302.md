error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/33.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/33.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/33.java
text:
```scala
t@@hrow ManagedDMRContentMessages.MESSAGES.nullParent();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/33.java