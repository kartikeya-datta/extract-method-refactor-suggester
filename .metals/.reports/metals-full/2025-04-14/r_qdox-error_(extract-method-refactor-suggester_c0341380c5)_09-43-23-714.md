error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/730.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/730.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/730.java
text:
```scala
C@@ounterColumn col = client.get(key, cpath, cl).counter_column;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/730.java