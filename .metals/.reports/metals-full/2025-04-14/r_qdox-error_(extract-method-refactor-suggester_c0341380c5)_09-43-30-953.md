error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/213.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/213.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/213.java
text:
```scala
E@@xposeModelResourceResolved(JmxManagedAuditLogger auditLoggerInfo) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/213.java