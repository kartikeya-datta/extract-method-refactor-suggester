error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14131.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14131.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14131.java
text:
```scala
n@@ew JMeterTreeNode(component, this);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14131.java