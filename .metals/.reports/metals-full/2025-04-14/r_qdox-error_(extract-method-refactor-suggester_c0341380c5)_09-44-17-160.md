error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9967.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9967.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9967.java
text:
```scala
m@@arker.setAttribute(IMarker.MESSAGE, Util.bind("build.inconsistentProject", e.getLocalizedMessage())); //$NON-NLS-1$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9967.java