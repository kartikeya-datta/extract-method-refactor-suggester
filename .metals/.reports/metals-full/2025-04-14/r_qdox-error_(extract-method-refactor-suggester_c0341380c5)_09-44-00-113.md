error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9482.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9482.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9482.java
text:
```scala
i@@f (glyphs[i] == fp.wgDefault || glyphs[i] == fp.wgInvalid) break;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/9482.java