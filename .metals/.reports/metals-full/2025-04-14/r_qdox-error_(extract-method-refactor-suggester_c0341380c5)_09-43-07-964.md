error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6668.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6668.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6668.java
text:
```scala
S@@ingleSignOnManagerService.build(target, managerServiceName, serverName, hostName)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6668.java