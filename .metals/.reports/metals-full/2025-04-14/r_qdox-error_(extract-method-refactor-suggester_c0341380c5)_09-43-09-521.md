error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16068.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16068.java
...
```java
offset: 15
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16068.java
text:
```scala
private final L@@inkedList<Object> stack = new LinkedList<Object>();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16068.java