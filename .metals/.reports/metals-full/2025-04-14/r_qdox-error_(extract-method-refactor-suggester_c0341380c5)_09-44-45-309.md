error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1329.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1329.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1329.java
text:
```scala
r@@eturn new DictionaryCompoundWordTokenFilter(version, tokenStream, wordList,
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1329.java