error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6606.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6606.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6606.java
text:
```scala
S@@tring filterPath = "", fileName = "";  //$NON-NLS-1$//$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6606.java