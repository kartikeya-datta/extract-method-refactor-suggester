error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1176.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1176.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1176.java
text:
```scala
c@@heckRandomData(random(), new RomanianAnalyzer(TEST_VERSION_CURRENT), 1000*RANDOM_MULTIPLIER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/1176.java