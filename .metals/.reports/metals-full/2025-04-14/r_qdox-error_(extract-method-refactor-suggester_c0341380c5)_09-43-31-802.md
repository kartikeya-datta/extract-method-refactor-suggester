error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16528.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16528.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16528.java
text:
```scala
l@@oadGlobals();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16528.java