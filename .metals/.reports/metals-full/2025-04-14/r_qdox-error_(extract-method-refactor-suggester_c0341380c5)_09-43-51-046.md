error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9902.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9902.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9902.java
text:
```scala
i@@nitialize(new FsBlobStore(componentSettings, gatewayFile), clusterName, null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9902.java