error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5481.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5481.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5481.java
text:
```scala
public static final A@@ttachmentKey<VirtualFile> KEY = new AttachmentKey<VirtualFile>(VirtualFile.class);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5481.java