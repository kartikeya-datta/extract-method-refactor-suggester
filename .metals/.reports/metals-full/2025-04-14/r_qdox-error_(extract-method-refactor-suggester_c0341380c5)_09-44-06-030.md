error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12959.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12959.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12959.java
text:
```scala
S@@tring url = tag.getAttributes().getString("src");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12959.java