error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3242.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3242.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3242.java
text:
```scala
public static final B@@loomCalculations.BloomSpecification spec = BloomCalculations.computeBloomSpec(15, MAX_FAILURE_RATE);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/3242.java