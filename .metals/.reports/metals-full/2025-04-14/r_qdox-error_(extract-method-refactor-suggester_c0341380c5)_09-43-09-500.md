error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6618.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6618.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6618.java
text:
```scala
c@@atch (Throwable ex) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/6618.java