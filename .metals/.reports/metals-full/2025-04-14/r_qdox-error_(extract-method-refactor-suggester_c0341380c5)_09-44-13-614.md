error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17017.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17017.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17017.java
text:
```scala
I@@ManageablePage manageablePage = Session.get().getPageManager().getPage(pageId);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/17017.java