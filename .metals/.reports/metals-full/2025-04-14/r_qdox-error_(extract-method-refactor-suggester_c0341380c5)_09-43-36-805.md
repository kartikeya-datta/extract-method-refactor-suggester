error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2969.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2969.java
...
```java
offset: 21
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2969.java
text:
```scala
public static final S@@tring VERSION = "1.0.2";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2969.java