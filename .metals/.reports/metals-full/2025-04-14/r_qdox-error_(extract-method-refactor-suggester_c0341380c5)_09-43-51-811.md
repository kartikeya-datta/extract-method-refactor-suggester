error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2034.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2034.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2034.java
text:
```scala
r@@eturn bottom - currentFieldData.byteValue(doc);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2034.java