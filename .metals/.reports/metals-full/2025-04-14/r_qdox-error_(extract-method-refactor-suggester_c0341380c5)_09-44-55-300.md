error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1744.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1744.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1744.java
text:
```scala
S@@tring displayText = "";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1744.java