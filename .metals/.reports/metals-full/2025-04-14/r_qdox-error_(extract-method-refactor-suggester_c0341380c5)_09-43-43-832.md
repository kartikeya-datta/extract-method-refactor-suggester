error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4410.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4410.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4410.java
text:
```scala
d@@esc.getId(), miscCategory.getLabel() }));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4410.java