error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4303.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4303.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4303.java
text:
```scala
t@@ag.put("onclick", "window.location.href='" + url + "&" + getInputName()
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/4303.java