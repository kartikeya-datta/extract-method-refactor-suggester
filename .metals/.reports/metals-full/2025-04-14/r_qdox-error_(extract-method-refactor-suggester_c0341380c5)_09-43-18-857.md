error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3830.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3830.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3830.java
text:
```scala
S@@tring rateLimitingType = settings.get(INDEX_STORE_THROTTLE_TYPE, AbstractIndexStore.this.rateLimitingType);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3830.java