error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3188.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3188.java
...
```java
offset: 1145
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3188.java
text:
```scala
 ...
 */
p@@ackage org.jboss.as.ee.concurrent.deployers;
 ...
 */
public class EEConcurrentDefaultManagedScheduledExecutorServiceProcessor extends EEConcurrentAbstractProcessor {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3188.java