error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5503.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5503.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5503.java
text:
```scala
w@@riter.writeAttribute(Attribute.TYPE.getLocalName(), property.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/5503.java