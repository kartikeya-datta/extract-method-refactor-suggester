error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9093.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9093.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9093.java
text:
```scala
O@@bject[] uids = r[0].getUids();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9093.java