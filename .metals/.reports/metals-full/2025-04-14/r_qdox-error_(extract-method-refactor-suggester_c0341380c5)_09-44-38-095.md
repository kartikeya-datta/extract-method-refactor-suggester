error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12052.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12052.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12052.java
text:
```scala
i@@f (workbenchPartReference == null || workbenchPartReference.getId().equals(getViewSite().getId())
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12052.java