error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6636.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6636.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6636.java
text:
```scala
public d@@ouble factor(int docId) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6636.java