error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9656.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9656.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9656.java
text:
```scala
c@@urrentScope.problemReporter().cannotAssignToFinalField(fieldBinding, this, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/9656.java