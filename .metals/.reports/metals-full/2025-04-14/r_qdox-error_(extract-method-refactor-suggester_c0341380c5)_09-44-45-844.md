error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15184.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15184.java
...
```java
offset: 9
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15184.java
text:
```scala
private U@@RL deploymentUrl;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/15184.java