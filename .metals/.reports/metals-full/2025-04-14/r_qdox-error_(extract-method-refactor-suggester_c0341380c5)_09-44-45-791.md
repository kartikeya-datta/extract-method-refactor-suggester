error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8202.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8202.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8202.java
text:
```scala
final M@@oduleIdentifier moduleIdentifier = ModuleIdentifier.create("deployment." + deploymentRoot.getName());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8202.java