error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2237.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2237.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2237.java
text:
```scala
final O@@bject objectValue = getContext().resolveValue( value.toString() );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/2237.java