error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7263.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7263.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7263.java
text:
```scala
a@@syncAppender.activateOptions();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7263.java