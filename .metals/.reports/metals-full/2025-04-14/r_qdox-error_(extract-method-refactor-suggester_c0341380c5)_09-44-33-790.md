error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3764.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3764.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3764.java
text:
```scala
E@@mbeddedRungeKuttaIntegrator integ =
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3764.java