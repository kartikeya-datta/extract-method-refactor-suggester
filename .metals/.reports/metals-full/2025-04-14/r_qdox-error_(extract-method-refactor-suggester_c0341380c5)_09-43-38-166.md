error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16233.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16233.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16233.java
text:
```scala
u@@rlConfig = new UrlConfigGui(false, true, false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/16233.java