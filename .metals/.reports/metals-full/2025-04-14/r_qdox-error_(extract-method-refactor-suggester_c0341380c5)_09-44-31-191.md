error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4767.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4767.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4767.java
text:
```scala
p@@roposal.nameLookup = this.nameEnvironment.nameLookup;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/4767.java