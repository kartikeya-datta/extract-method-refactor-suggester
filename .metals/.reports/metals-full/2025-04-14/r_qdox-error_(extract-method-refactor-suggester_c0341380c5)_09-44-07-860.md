error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3639.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3639.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3639.java
text:
```scala
s@@erviceBuilder.addAliases(ServiceName.of("jbosgi", "xservice", TransactionManager.class.getName()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/3639.java