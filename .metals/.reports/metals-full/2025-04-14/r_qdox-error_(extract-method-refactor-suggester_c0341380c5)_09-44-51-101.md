error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8288.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8288.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8288.java
text:
```scala
a@@ddPage(workingSetEditPage);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8288.java