error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1552.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1552.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1552.java
text:
```scala
n@@ew AccountWizardLauncher().launchWizard(false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/1552.java