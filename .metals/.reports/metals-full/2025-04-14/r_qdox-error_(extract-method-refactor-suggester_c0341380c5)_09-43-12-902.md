error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14473.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14473.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14473.java
text:
```scala
final S@@erviceController<?> controller = context.getServiceRegistry().getService(AbstractPathService.pathNameOf(name));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/14473.java