error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12736.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12736.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12736.java
text:
```scala
h@@ostOp.get(OP_ADDR).setEmptyList().add(HOST, "master");
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/12736.java