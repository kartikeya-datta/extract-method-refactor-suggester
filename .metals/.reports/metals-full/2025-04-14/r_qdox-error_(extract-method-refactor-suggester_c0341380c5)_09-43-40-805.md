error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1799.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1799.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1799.java
text:
```scala
l@@ogger.trace("Handling " + message + " in " + session);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/1799.java