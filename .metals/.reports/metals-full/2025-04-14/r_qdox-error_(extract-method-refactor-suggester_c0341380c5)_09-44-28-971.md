error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/425.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/425.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/425.java
text:
```scala
t@@his.waitForMappingChange = settings.getAsBoolean("action.wait_on_mapping_change", false);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/425.java