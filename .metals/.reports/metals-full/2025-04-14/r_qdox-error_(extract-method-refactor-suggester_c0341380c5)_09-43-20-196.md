error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2423.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2423.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2423.java
text:
```scala
r@@eturn clusterService.operationRouting().searchShards(clusterState, request.indices(), request.queryHint(), request.routing(), null);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/2423.java