error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3692.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3692.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3692.java
text:
```scala
i@@nt numDocs = scaledRandomIntBetween(10, 100);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/3692.java