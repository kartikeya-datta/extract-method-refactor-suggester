error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10011.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10011.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10011.java
text:
```scala
l@@inkWithLabel.setBody(Model.of("A link that provides its body with Link.setBodyLabel(someModel)"));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10011.java