error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/76.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/76.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/76.java
text:
```scala
t@@ableLengthPairs.add(new Pair<SSTableReader, Long>(table, table.onDiskLength()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset1/Tasks/76.java