error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6712.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6712.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6712.java
text:
```scala
protected v@@oid doPostCollection() throws IOException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6712.java