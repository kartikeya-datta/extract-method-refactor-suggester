error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9465.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9465.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9465.java
text:
```scala
i@@f (minimumNumberShouldMatch != -1) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9465.java