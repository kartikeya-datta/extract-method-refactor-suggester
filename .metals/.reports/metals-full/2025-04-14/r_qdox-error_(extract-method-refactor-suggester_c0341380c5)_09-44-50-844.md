error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6958.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6958.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6958.java
text:
```scala
t@@his.inputColumn = scribe.getCurrentColumn(sourceRestart);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/6958.java