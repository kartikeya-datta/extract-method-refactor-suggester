error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18285.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18285.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18285.java
text:
```scala
public A@@pplication(final org.apache.wicket.Application application)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/18285.java