error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11173.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11173.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11173.java
text:
```scala
final M@@arkupStream associatedMarkupStream = new MarkupStream(getMarkupFragment());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/11173.java