error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7495.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7495.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7495.java
text:
```scala
i@@f (style != null && (style.underline || style.strikeout || style.borderStyle != SWT.NONE)) drawTab = false;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/7495.java