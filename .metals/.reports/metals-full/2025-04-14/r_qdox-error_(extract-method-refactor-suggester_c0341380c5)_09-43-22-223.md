error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7722.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7722.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7722.java
text:
```scala
v@@oid printOptions(PrintWriter out, Logger cat) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/7722.java