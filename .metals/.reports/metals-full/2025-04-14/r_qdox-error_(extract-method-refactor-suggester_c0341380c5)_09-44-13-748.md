error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12422.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12422.java
...
```java
offset: 19
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12422.java
text:
```scala
"'<wicket:panel>'")@@;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/12422.java