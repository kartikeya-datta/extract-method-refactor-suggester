error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/198.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/198.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/198.java
text:
```scala
z@@oomed = ((EditorStack)editors[j]).getState() == IStackPresentationSite.STATE_MAXIMIZED;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/198.java