error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9855.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9855.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9855.java
text:
```scala
r@@eturn valuesSource == null ? Double.NaN : sums.get(owningBucketOrd) / counts.get(owningBucketOrd);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/9855.java