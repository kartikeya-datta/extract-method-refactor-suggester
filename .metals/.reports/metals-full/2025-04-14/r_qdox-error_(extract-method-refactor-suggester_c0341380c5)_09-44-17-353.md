error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7934.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7934.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7934.java
text:
```scala
final R@@esourceRoot resourceRoot = phaseContext.getDeploymentUnit().getAttachment(Attachments.DEPLOYMENT_ROOT);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7934.java