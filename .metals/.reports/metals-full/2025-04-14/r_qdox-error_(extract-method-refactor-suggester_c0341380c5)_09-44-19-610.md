error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/507.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/507.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/507.java
text:
```scala
r@@eturn "UnmodifiedBuilderType(" + fNewTSEntry.getType().getName() + ")"; //$NON-NLS-1$ //$NON-NLS-2$
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/507.java