error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6669.java
text:
```scala
L@@ist<Object> values = lookup.source().extractRawValues(mapper.names().sourcePath());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6669.java