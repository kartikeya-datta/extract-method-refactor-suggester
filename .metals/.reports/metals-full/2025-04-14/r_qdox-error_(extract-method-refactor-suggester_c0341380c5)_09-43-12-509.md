error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7800.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7800.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7800.java
text:
```scala
c@@omparator = DirectoryFileComparator.DIRECTORY_COMPARATOR;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/7800.java