error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8497.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8497.java
...
```java
offset: 8
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8497.java
text:
```scala
public i@@nt elementSize; // number of elements in the table
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/8497.java