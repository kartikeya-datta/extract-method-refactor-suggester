error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8087.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8087.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8087.java
text:
```scala
c@@onfiguration.addViewInterceptor(method, EntityBeanHomeRemoveInterceptorFactory.instance(!localHome), InterceptorOrder.View.COMPONENT_DISPATCHER);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8087.java