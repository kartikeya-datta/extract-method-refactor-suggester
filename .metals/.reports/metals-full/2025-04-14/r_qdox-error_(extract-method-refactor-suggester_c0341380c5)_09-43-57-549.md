error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6349.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6349.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6349.java
text:
```scala
&@@& newVal.length() > 0)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/6349.java