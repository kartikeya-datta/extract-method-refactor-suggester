error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10042.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10042.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10042.java
text:
```scala
c@@md.addLine( command );
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/10042.java