error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3028.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3028.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3028.java
text:
```scala
t@@his.elements[this.size++] = newElement;
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3028.java