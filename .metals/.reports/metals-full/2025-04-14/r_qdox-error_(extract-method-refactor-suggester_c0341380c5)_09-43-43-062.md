error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8682.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8682.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8682.java
text:
```scala
s@@erverInventory.reconnectServer(serverName, domainModel, info.isRunning(), info.isStopping());
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/8682.java