error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7678.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7678.java
...
```java
offset: 18
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7678.java
text:
```scala
@Override public v@@oid recover(boolean indexShouldExists, RecoveryStatus recoveryStatus) throws IndexShardGatewayRecoveryException {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/7678.java