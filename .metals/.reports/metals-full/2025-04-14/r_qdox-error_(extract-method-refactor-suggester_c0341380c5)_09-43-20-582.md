error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3869.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3869.java
...
```java
offset: 11
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3869.java
text:
```scala
protected C@@harSequence getOnClickScript(final CharSequence url)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/3869.java