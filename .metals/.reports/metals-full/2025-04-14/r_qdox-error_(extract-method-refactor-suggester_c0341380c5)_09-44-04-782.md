error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1861.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1861.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1861.java
text:
```scala
F@@orm<?> getForm();
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/1861.java