error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3857.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3857.java
...
```java
offset: 7
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3857.java
text:
```scala
@see #s@@etMaxFileSize(String)
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset2/Tasks/3857.java