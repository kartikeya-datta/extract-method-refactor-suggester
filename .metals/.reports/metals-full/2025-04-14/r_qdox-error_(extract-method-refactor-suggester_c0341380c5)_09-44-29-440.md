error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14386.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14386.java
...
```java
offset: 22
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14386.java
text:
```scala
private static final S@@tring PROPVERSION = "1.7";
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset5/Tasks/14386.java