error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6542.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6542.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6542.java
text:
```scala
r@@equest.indices(state.metaData().concreteIndices(indicesOrAliases, request.indicesOptions()));
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/6542.java