error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9853.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9853.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9853.java
text:
```scala
t@@hrow MailLogger.ROOT_LOGGER.outboundSocketBindingNotAvailable(ref);
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset3/Tasks/9853.java