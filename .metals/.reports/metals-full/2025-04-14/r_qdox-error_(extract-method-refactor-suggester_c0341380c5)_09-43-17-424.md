error id: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1669.java
file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1669.java
...
```java
offset: 1
uri: file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1669.java
text:
```scala
i@@f (state.metaData().aliases().containsKey(request.index)) {
...
QDox parse error in file://<WORKSPACE>/data/code-rep-dataset/Dataset4/Tasks/1669.java